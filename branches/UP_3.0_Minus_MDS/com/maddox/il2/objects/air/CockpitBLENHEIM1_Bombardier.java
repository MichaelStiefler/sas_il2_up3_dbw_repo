...
//            CockpitPilot, BLENHEIM1, Cockpit

public class CockpitBLENHEIM1_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.BLENHEIM1)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.BLENHEIM1)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.BLENHEIM1)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.BLENHEIM1)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
