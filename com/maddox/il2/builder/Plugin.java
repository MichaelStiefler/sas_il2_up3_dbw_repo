...
public abstract class Plugin
{
    ...
    protected static void loadAll(com.maddox.rts.SectFile sectfile, java.lang.String s, com.maddox.il2.builder.Builder builder1)
    {
        ...
        for(int i1 = 0; i1 < l; i1++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(i1)).configure();
    ...
    protected static void doRender3D()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).render3D();
    ...
    protected static void doPreRenderMap2D()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).preRenderMap2D();
    ...
    protected static void doRenderMap2DBefore()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).renderMap2DBefore();
    ...
    protected static void doRenderMap2D()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).renderMap2D();
    ...
    protected static void doRenderMap2DAfter()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).renderMap2DAfter();
    ...
    protected static void doCreateGUI()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).createGUI();
    ...
    protected static void doStart()
    {
        ...
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).start();
    ...
    protected static void doInsert(com.maddox.il2.engine.Loc loc, boolean flag)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).insert(loc, flag);

    }

    protected static java.lang.String mis_doGetProperties(com.maddox.il2.engine.Actor actor)
    {
        java.lang.String s = "";
        for(int i = 0; i < all.size(); i++)
            s = s + ((com.maddox.il2.builder.Plugin)all.get(i)).mis_getProperties(actor);

        return s;
    }

    protected static com.maddox.il2.engine.Actor mis_doInsert(com.maddox.il2.engine.Loc loc, java.lang.String s)
    {
        com.maddox.il2.engine.Actor actor = null;
        for(int i = 0; i < all.size(); i++)
        {
            actor = ((com.maddox.il2.builder.Plugin)all.get(i)).mis_insert(loc, s);
            if(actor != null)
                return actor;
        }
    ...
    protected static boolean mis_doValidateSelected(int i, int j)
    {
        boolean flag = false;
        for(int k = 0; k < all.size(); k++)
            flag = flag || ((com.maddox.il2.builder.Plugin)all.get(k)).mis_validateSelected(i, j);
    ...
    protected static void doFillPopUpMenu(com.maddox.gwindow.GWindowMenuPopUp gwindowmenupopup, com.maddox.JGP.Point3d point3d)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).fillPopUpMenu(gwindowmenupopup, point3d);
    ...
    protected static void doBeginFill(com.maddox.JGP.Point3d point3d)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).beginFill(point3d);
    ...
    protected static void doFill(com.maddox.JGP.Point3d point3d)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).fill(point3d);
    ...
    protected static void doEndFill(com.maddox.JGP.Point3d point3d)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).endFill(point3d);
    ...
    protected static void doDelete(com.maddox.il2.engine.Loc loc)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).delete(loc);
    ...
    protected static void doDeleteAll()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).deleteAll();
    ...
    protected static void doAfterDelete()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).afterDelete();
    ...
    protected static void doSelectAll()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).selectAll();
    ...
    protected static void doChangeType(boolean flag, boolean flag1)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).changeType(flag, flag1);
    ...
    protected static void doViewTypeAll(boolean flag)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).viewTypeAll(flag);
    ...
    protected static void doLoad(com.maddox.rts.SectFile sectfile)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).load(sectfile);
    ...
    protected static boolean doSave(com.maddox.rts.SectFile sectfile)
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            if(!((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).save(sectfile))
                return false;
    ...
    protected static void doMapLoaded()
    {
        ...
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).mapLoaded();
    ...
    protected static void doFreeResources()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            ((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).freeResources();
    ...
    protected static boolean doExitBuilder()
    {
        int i = all.size();
        for(int j = 0; j < i; j++)
            if(!((com.maddox.il2.builder.Plugin)(com.maddox.il2.builder.Plugin)all.get(j)).exitBuilder())
                return false;

        return true;
    }

    public static java.util.ArrayList zutiGetAllActors()
    {
        return all;
    }
