...
public class CockpitDXXI_SARJA4 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitDXXI_SARJA4()
    {
        ...
        setRevi();
        com.maddox.il2.engine.HookNamed hooknamed = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "LAMPHOOK01");
        ...
        pos.base().draw.lightMap().put("LAMPHOOK01", ((java.lang.Object) (light1)));
        hooknamed = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "LAMPHOOK02");
        loc = new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
        hooknamed.computePos(((com.maddox.il2.engine.Actor) (this)), new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F), loc);
        light2 = new LightPointActor(new LightPoint(), loc.getPoint());
        light2.light.setColor(126F, 232F, 245F);
        light2.light.setEmit(0.0F, 0.0F);
        pos.base().draw.lightMap().put("LAMPHOOK02", ((java.lang.Object) (light2)));
        hooknamed = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "LAMPHOOK03");
        loc = new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
        hooknamed.computePos(((com.maddox.il2.engine.Actor) (this)), new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F), loc);
        light3 = new LightPointActor(new LightPoint(), loc.getPoint());
        light3.light.setColor(126F, 232F, 245F);
        light3.light.setEmit(0.0F, 0.0F);
        pos.base().draw.lightMap().put("LAMPHOOK03", ((java.lang.Object) (light3)));
        hooknamed = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "LAMPHOOK04");
        loc = new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
        hooknamed.computePos(((com.maddox.il2.engine.Actor) (this)), new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F), loc);
        light4 = new LightPointActor(new LightPoint(), loc.getPoint());
        light4.light.setColor(126F, 232F, 245F);
        light4.light.setEmit(0.0F, 0.0F);
        pos.base().draw.lightMap().put("LAMPHOOK04", ((java.lang.Object) (light4)));
        hooknamed = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "LAMPHOOK05");
        loc = new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
        hooknamed.computePos(((com.maddox.il2.engine.Actor) (this)), new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F), loc);
        light5 = new LightPointActor(new LightPoint(), loc.getPoint());
        light5.light.setColor(126F, 232F, 245F);
        light5.light.setEmit(0.0F, 0.0F);
        pos.base().draw.lightMap().put("LAMPHOOK05", ((java.lang.Object) (light5)));
