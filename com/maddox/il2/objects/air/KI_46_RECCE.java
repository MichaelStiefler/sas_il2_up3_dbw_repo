    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.KI_46_RECCE.weaponTriggersRegister(class1, new int[] {
            0
        });
        com.maddox.il2.objects.air.KI_46_RECCE.weaponHooksRegister(class1, new java.lang.String[] {
            "_Clip04"
        });
        com.maddox.il2.objects.air.KI_46_RECCE.weaponsRegister(class1, "default", new java.lang.String[] {
            null
        });
        com.maddox.il2.objects.air.KI_46_RECCE.weaponsRegister(class1, "none", new java.lang.String[] {
            null
        });
    }
}
