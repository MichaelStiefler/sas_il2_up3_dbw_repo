...
public class SPITFIRE5A extends SPITFIRE
{
  ...
  static
  {
    Class localClass = SPITFIRE5A.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Spit");
    Property.set(localClass, "meshName", "3DO/Plane/Spitfiremkva(Multi1)/Spitfire5a.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());
    Property.set(localClass, "yearService", 1941.0F);
    Property.set(localClass, "yearExpired", 1946.5F);
    Property.set(localClass, "FlightModel", "FlightModels/SpitfireVa.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitSPIT5.class });
