...
public class CockpitG4M2E_Bombardier extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bEntered)
        {
            super.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((G4M)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitG4M2E_Bombardier.class, "astatePilotIndx", 0);
    }
