...
public class CockpitJU_87D3 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel = World.getPlayerFM();
      if (CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitJU_87D3.this.setNew.altimeter = CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        ...
        CockpitJU_87D3.this.setNew.throttle = ((10.0F * CockpitJU_87D3.this.setOld.throttle + CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitJU_87D3.this.setNew.azimuth = CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
        if ((CockpitJU_87D3.this.setOld.azimuth > 270.0F) && (CockpitJU_87D3.this.setNew.azimuth < 90.0F)) CockpitJU_87D3.this.setOld.azimuth -= 360.0F;
        if ((CockpitJU_87D3.this.setOld.azimuth < 90.0F) && (CockpitJU_87D3.this.setNew.azimuth > 270.0F)) CockpitJU_87D3.this.setOld.azimuth += 360.0F;
        CockpitJU_87D3.this.setNew.waypointAzimuth = ((10.0F * CockpitJU_87D3.this.setOld.waypointAzimuth + (CockpitJU_87D3.this.waypointAzimuth() - CockpitJU_87D3.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitJU_87D3.this.setNew.vspeed = ((499.0F * CockpitJU_87D3.this.setOld.vspeed + CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 500.0F);
        if (CockpitJU_87D3.this.buzzerFX != null) {
          if ((CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < 750.0D) && (((JU_87)CockpitJU_87D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1))
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitJU_87D3.1 arg2) { this();
    }
  }
}