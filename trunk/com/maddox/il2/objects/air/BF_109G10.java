  ...
  implements TypeBNZFighter
{
  ...
  static
  {
    ...
    Aircraft.weaponTriggersRegister(localClass, new int[] { 0, 0, 0, 1, 1, 1, 1, 1, 9, 9, 9, 9 });

    Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_CANNON05", "_ExternalDev02", "_ExternalDev03", "_ExternalDev01", "_ExternalDev01" });

    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "R3-DROPTANK", new String[] { "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, null, null, "PylonETC900", "FuelTankGun_Type_D" });

    Aircraft.weaponsRegister(localClass, "R4-MK108", new String[] { "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, "MGunMK108kh 35", "MGunMK108kh 35", "PylonMk108", "PylonMk108", null, null });

    Aircraft.weaponsRegister(localClass, "R6-151-20", new String[] { "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 65", null, "MGunMG15120kh 140 ", "MGunMG15120kh 140", null, null, "PylonMG15120", "PylonMG15120", null, null });

    Aircraft.weaponsRegister(localClass, "U4-MK108", new String[] { "MGunMG131si 300", "MGunMG131si 300", null, "MGunMK108ki 65", null, null, null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "U4R3-MK108-DROPTANK", new String[] { "MGunMG131si 300", "MGunMG131si 300", null, "MGunMK108ki 65", null, null, null, null, null, null, "PylonETC900", "FuelTankGun_Type_D" });
