...
public class PlMisRocket extends com.maddox.il2.builder.Plugin
{
    ...
    public void renderMap2DAfter()
    {
        ...
        for(int j = 0; j < i; j++)
        {
            ...
            if(builder.isMiltiSelected(rocket))
    ...
    {
        if(com.maddox.il2.builder.PlMisRocket.getPlugin("Mission") == null)
            throw new RuntimeException("PlMisRocket: plugin 'Mission' not found");
        pluginMission = (com.maddox.il2.builder.PlMission)com.maddox.il2.builder.PlMisRocket.getPlugin("Mission");
        if(sectFile == null)
        ...
        com.maddox.rts.Property.set(com.maddox.il2.builder.PlMisRocket$Rocket.class, "i18nName", com.maddox.il2.builder.PlMisRocket.i18n("Rocket"));
    ...
    private void fillComboBox2(int i, int j)
    {
        ...
        if(builder.wSelect.curFilledType != i)
        {
            ...
            for(int k = 0; k < item.length; k++)
                builder.wSelect.comboBox2.add(item[k].i18nName);
    ...
    {
        com.maddox.il2.builder.Rocket rocket = (com.maddox.il2.builder.Rocket)builder.selectedActor();
    ...
    public void createGUI()
    {
        ...
        builder.wSelect.comboBox1.add(com.maddox.il2.builder.PlMisRocket.i18n("Rocket"));
        ...
        if(--i >= 0)
        {
            viewType = builder.mDisplayFilter.subMenu.addItem(i, new com.maddox.gwindow.GWindowMenuItem(builder.mDisplayFilter.subMenu, com.maddox.il2.builder.PlMisRocket.i18n("showRocket"), null) {
        ...
        tabTarget = builder.wSelect.tabsClient.createTab(com.maddox.il2.builder.PlMisRocket.i18n("Rocket"), gwindowdialogclient);
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 1.0F, 7F, 1.3F, com.maddox.il2.builder.PlMisRocket.i18n("Name"), null));
        gwindowdialogclient.addLabel(wName = new GWindowLabel(gwindowdialogclient, 9F, 1.0F, 7F, 1.3F, "", null));
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 3F, 7F, 1.3F, com.maddox.il2.builder.PlMisRocket.i18n("Army"), null));
        ...
        gwindowdialogclient1.addLabel(wLTimeOutH = new GWindowLabel(gwindowdialogclient1, 1.0F, 5F, 7F, 1.3F, com.maddox.il2.builder.PlMisRocket.i18n("TimeOut"), null));
        ...
        gwindowdialogclient1.addLabel(wLCount = new GWindowLabel(gwindowdialogclient1, 1.0F, 7F, 7F, 1.3F, com.maddox.il2.builder.PlMisRocket.i18n("Count"), null));
        ...
        gwindowdialogclient1.addLabel(wLPeriodH = new GWindowLabel(gwindowdialogclient1, 1.0F, 9F, 7F, 1.3F, com.maddox.il2.builder.PlMisRocket.i18n("Period"), null));
        ...
        gwindowdialogclient1.addLabel(new GWindowLabel(gwindowdialogclient1, 1.0F, 11F, 7F, 1.3F, com.maddox.il2.builder.PlMisRocket.i18n("Target"), null));
        gwindowdialogclient1.addControl(wTargetSet = new com.maddox.gwindow.GWindowButton(gwindowdialogclient1, 1.0F, 13F, 5F, 1.6F, com.maddox.il2.builder.PlMisRocket.i18n("&Set"), null) {
        ...
        gwindowdialogclient1.addControl(wTargetClear = new com.maddox.gwindow.GWindowButton(gwindowdialogclient1, 9F, 13F, 5F, 1.6F, com.maddox.il2.builder.PlMisRocket.i18n("&Clear"), null) {
    ...
    public java.lang.String mis_getProperties(com.maddox.il2.engine.Actor actor)
    {
        ...
        } else
        {
            ...
            orient.set(orient1);
            orient.wrap360();
            java.lang.String s1 = " 1_" + rocket.name() + " " + rocket.item.name + " " + rocket.getArmy() + " " + formatPos(point3d.x, point3d.y, orient.azimut()) + " " + rocket.timeout + " " + rocket.count + " " + rocket.period + " " + (rocket.target != null ? formatValue(rocket.target.x) + " " + formatValue(rocket.target.y) : "");
            return s1;
        }
    }
    ...
    public com.maddox.il2.engine.Actor mis_insert(com.maddox.il2.engine.Loc loc, java.lang.String s)
    {
        ...
        if(numbertokenizer.hasMoreTokens())
        {
            ...
            if(numbertokenizer.hasMoreTokens())
            {
                ...
                if(numbertokenizer.hasMoreTokens())
                {
                    com.maddox.il2.builder.Item item1 = (com.maddox.il2.builder.Item)itemMap.get(s2);
                    if(item1 != null)
                    {
                        int k = numbertokenizer.next(1, 1, 2);
                        point3d.x = numbertokenizer.next(0.0D);
                        ...
                        if(numbertokenizer.hasMoreTokens())
                        {
                            ...
                            if(numbertokenizer.hasMoreTokens())
                            {
                                com.maddox.il2.builder.Rocket rocket = insert(item1, null, point3d, false);
                                if(rocket != null)
                                {
                                    rocket.setArmy(k);
                                    orient.set(numbertokenizer.next(0.0F), 0.0F, 0.0F);
