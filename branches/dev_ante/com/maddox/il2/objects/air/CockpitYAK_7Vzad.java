...
public class CockpitYAK_7Vzad extends CockpitPilot
{
  ...
  protected void reflectPlaneToModel() {
    ...
    this.mesh.chunkVisible("Blister1_D0.msh", false);
    this.mesh.chunkVisible("Blister2_D0.msh", false);
    this.mesh.chunkVisible("Blister3_D0.msh", false);
    this.mesh.chunkVisible("Pilot1_D0.msh", false);
    this.mesh.chunkVisible("Pilot1_D1.msh", false);
    this.mesh.chunkVisible("CF_D0", false);
    this.mesh.chunkVisible("CF_D1", false);
    this.mesh.chunkVisible("CF_D2", false);
    this.mesh.chunkVisible("CF_D3", false);
  }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_7Vzad this$0;
    ...
    Variables(CockpitYAK_7Vzad.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_7Vzad.this.fm != null) {
        CockpitYAK_7Vzad.access$102(CockpitYAK_7Vzad.this, CockpitYAK_7Vzad.this.setOld);
        CockpitYAK_7Vzad.access$202(CockpitYAK_7Vzad.this, CockpitYAK_7Vzad.this.setNew);
        CockpitYAK_7Vzad.access$302(CockpitYAK_7Vzad.this, CockpitYAK_7Vzad.this.setTmp);
        CockpitYAK_7Vzad.this.setNew.throttle = ((10.0F * CockpitYAK_7Vzad.this.setOld.throttle + CockpitYAK_7Vzad.this.fm.CT.PowerControl) / 11.0F);

        CockpitYAK_7Vzad.this.setNew.prop = ((10.0F * CockpitYAK_7Vzad.this.setOld.prop + CockpitYAK_7Vzad.this.fm.EI.engines[0].getControlProp()) / 11.0F);

        CockpitYAK_7Vzad.this.setNew.altimeter = CockpitYAK_7Vzad.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_7Vzad.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_7Vzad.this.setNew.azimuth = ((35.0F * CockpitYAK_7Vzad.this.setOld.azimuth + CockpitYAK_7Vzad.this.fm.Or.azimut()) / 36.0F);
        }
        if ((CockpitYAK_7Vzad.this.setOld.azimuth > 270.0F) && (CockpitYAK_7Vzad.this.setNew.azimuth < 90.0F))
          CockpitYAK_7Vzad.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_7Vzad.this.setOld.azimuth < 90.0F) && (CockpitYAK_7Vzad.this.setNew.azimuth > 270.0F))
          CockpitYAK_7Vzad.this.setOld.azimuth += 360.0F;
        CockpitYAK_7Vzad.this.setNew.vspeed = ((199.0F * CockpitYAK_7Vzad.this.setOld.vspeed + CockpitYAK_7Vzad.this.fm.getVertSpeed()) / 200.0F);
      }
