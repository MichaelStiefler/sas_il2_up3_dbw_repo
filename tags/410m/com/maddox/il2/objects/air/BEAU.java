...
public abstract class BEAU extends com.maddox.il2.objects.air.Scheme2
{
    ...
    {
        hierMesh().chunkSetAngles("Blister1_D0", 0.0F, com.maddox.il2.objects.air.BEAU.cvt(f, 0.01F, 0.99F, 0.0F, -120F), 0.0F);
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.BEAU.cvt(f, 0.01F, 0.89F, 0.0F, -103F), 0.0F);
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, com.maddox.il2.objects.air.BEAU.cvt(f, 0.01F, 0.29F, 0.0F, -63F), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.BEAU.cvt(f, 0.01F, 0.29F, 0.0F, -58F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.BEAU.cvt(f, 0.11F, 0.99F, 0.0F, -103F), 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, com.maddox.il2.objects.air.BEAU.cvt(f, 0.11F, 0.39F, 0.0F, -63F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.BEAU.cvt(f, 0.11F, 0.39F, 0.0F, -58F), 0.0F);
    }
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.BEAU.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.2F, 0.0F, 0.165F);
        hierMesh().chunkSetLocate("GearL25_D0", xyz, ypr);
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.BEAU.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.2F, 0.0F, 0.165F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                if(s.endsWith("e1"))
                    getEnergyPastArmor(12.100000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                if(s.endsWith("e2"))
                    getEnergyPastArmor(12.100000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                if(s.endsWith("p1"))
            ...
            if(s.startsWith("xxoil"))
            {
                ...
                com.maddox.il2.objects.air.BEAU.debugprintln(this, "*** Engine (" + l + ") Module: Oil Tank Pierced..");
                return;
            }
            if(s.startsWith("xxprop1") && getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.8F)
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.BEAU.debugprintln(this, "*** Engine1 Module: Prop Governor Hit, Disabled..");
                } else
                {
                    FM.AS.setEngineSpecificDamage(shot.initiator, 0, 4);
                    com.maddox.il2.objects.air.BEAU.debugprintln(this, "*** Engine1 Module: Prop Governor Hit, Damaged..");
                }
            if(s.startsWith("xxprop2") && getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.8F)
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.BEAU.debugprintln(this, "*** Engine2 Module: Prop Governor Hit, Disabled..");
                } else
                {
                    FM.AS.setEngineSpecificDamage(shot.initiator, 1, 4);
                    com.maddox.il2.objects.air.BEAU.debugprintln(this, "*** Engine2 Module: Prop Governor Hit, Damaged..");
                }
