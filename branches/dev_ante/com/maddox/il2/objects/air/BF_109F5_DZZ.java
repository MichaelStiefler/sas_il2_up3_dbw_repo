...
public class BF_109F5_DZZ extends BF_109
{
  ...
  static
  {
    Class localClass = BF_109F5_DZZ.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3DO/Plane/Bf-109F-4/hier_dzzmod.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar03());
    Property.set(localClass, "meshName_sk", "3DO/Plane/Bf-109F-4(sk)/hier_dzzmod.him");
    ...
    Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_ExternalDev01", "_ExternalDev01" });

    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15120MGki 200" });
    ...
    try
    {
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(9, "PylonETC900", 1);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(9, "FuelTankGun_Type_D", 1);
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
      str = "none";
