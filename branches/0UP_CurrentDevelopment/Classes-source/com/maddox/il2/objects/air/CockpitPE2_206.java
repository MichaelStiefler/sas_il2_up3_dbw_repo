...
// Source File Name:   CockpitPE2_206.java
...
public class CockpitPE2_206 extends com.maddox.il2.objects.air.CockpitPilot
{
            ...
            if(fm != null)
            {
                ...
                if(fm.CT.Weapons[3] != null)
                {
                    if(fm.CT.Weapons[3].length > 0)
                        bBombs[0] = !fm.CT.Weapons[3][0].haveBullets();
                    if(fm.CT.Weapons[3].length > 2)
                        bBombs[1] = !fm.CT.Weapons[3][2].haveBullets();
                    if(fm.CT.Weapons[3].length > 4)
                        bBombs[2] = !fm.CT.Weapons[3][4].haveBullets();
                    if(fm.CT.Weapons[3].length > 6)
                        bBombs[3] = !fm.CT.Weapons[3][6].haveBullets();
                    if(fm.CT.Weapons[3].length > 8)
                        bBombs[4] = !fm.CT.Weapons[3][8].haveBullets();
                    if(fm.CT.Weapons[3].length > 10)
                        bBombs[5] = !fm.CT.Weapons[3][10].haveBullets();
                    if(fm.CT.Weapons[3].length > 12)
                        bBombs[4] = bBombs[5] || !fm.CT.Weapons[3][12].haveBullets();
                    if(fm.CT.Weapons[3].length > 14)
                        bBombs[5] = bBombs[4] || !fm.CT.Weapons[3][14].haveBullets();
                    if(fm.CT.Weapons[3].length > 16)
                        bBombs[6] = !fm.CT.Weapons[3][16].haveBullets();
                    if(fm.CT.Weapons[3].length > 18)
                        bBombs[7] = !fm.CT.Weapons[3][18].haveBullets();
                }
