// Source File Name: CockpitKI_46_OTSUHEI.java
...
public class CockpitKI_46_OTSUHEI extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitKI_46_OTSUHEI.this.fm != null) {
				...
				CockpitKI_46_OTSUHEI.this.setNew.flap = (0.88F * CockpitKI_46_OTSUHEI.this.setOld.flap)
						+ (0.12F * CockpitKI_46_OTSUHEI.this.fm.CT.FlapsControl);
				CockpitKI_46_OTSUHEI.this.setNew.tlock = (0.7F * CockpitKI_46_OTSUHEI.this.setOld.tlock)
						+ (0.3F * (CockpitKI_46_OTSUHEI.this.fm.Gears.bTailwheelLocked ? 1.0F
								: 0.0F));
				...
				if ((CockpitKI_46_OTSUHEI.this.fm.CT.GearControl < 0.5F)
						&& (CockpitKI_46_OTSUHEI.this.setNew.gear < 1.0F)) {
					CockpitKI_46_OTSUHEI.this.setNew.gear = CockpitKI_46_OTSUHEI.this.setOld.gear + 0.02F;
				}
				if ((CockpitKI_46_OTSUHEI.this.fm.CT.GearControl > 0.5F)
						&& (CockpitKI_46_OTSUHEI.this.setNew.gear > 0.0F)) {
					CockpitKI_46_OTSUHEI.this.setNew.gear = CockpitKI_46_OTSUHEI.this.setOld.gear - 0.02F;
				}
				CockpitKI_46_OTSUHEI.this.setNew.throttle = (0.9F * CockpitKI_46_OTSUHEI.this.setOld.throttle)
						+ (0.1F * CockpitKI_46_OTSUHEI.this.fm.CT.PowerControl);
				CockpitKI_46_OTSUHEI.this.setNew.manifold = (0.8F * CockpitKI_46_OTSUHEI.this.setOld.manifold)
						+ (0.2F * CockpitKI_46_OTSUHEI.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitKI_46_OTSUHEI.this.setNew.pitch = (0.9F * CockpitKI_46_OTSUHEI.this.setOld.pitch)
						+ (0.1F * CockpitKI_46_OTSUHEI.this.fm.EI.engines[0]
								.getControlProp());
				CockpitKI_46_OTSUHEI.this.setNew.mix = (0.9F * CockpitKI_46_OTSUHEI.this.setOld.mix)
						+ (0.1F * CockpitKI_46_OTSUHEI.this.fm.EI.engines[0]
								.getControlMix());
				CockpitKI_46_OTSUHEI.this.setNew.altimeter = CockpitKI_46_OTSUHEI.this.fm
						.getAltitude();
				CockpitKI_46_OTSUHEI.this.setNew.azimuth.setDeg(
						CockpitKI_46_OTSUHEI.this.setOld.azimuth.getDeg(1.0F),
						CockpitKI_46_OTSUHEI.this.fm.Or.azimut());
				CockpitKI_46_OTSUHEI.this.setNew.vspeed = ((199F * CockpitKI_46_OTSUHEI.this.setOld.vspeed) + CockpitKI_46_OTSUHEI.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("FBoxSW_Starter", 0.0F, 0.0F,
				this.fm.EI.engines[0].getStage() > 0 ? 50F : 0.0F);
		...
		this.mesh.chunkSetAngles("NeedFuelPress", this.cvt(
				this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.6F, 0.0F, 305F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("NeedVMPress", this.cvt(
				this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3F, 0.0F, 300F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles(
				"IgnitionSwitch",
				this.fm.EI.engines[0].getStage() == 0 ? 0.0F : this.cvt(
