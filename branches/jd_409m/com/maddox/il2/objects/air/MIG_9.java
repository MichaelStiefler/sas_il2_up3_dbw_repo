  ...
  implements TypeFighter, TypeBNZFighter
{
  ...
  public void update(float paramFloat)
  {
    ...
    if (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.isMaster()) {
      float f = this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getThrustOutput() * this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle();
      if ((this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() == 6) && (f > 0.75F)) {
        if (f > 0.92F)
      ...
      if ((this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getStage() == 6) && (f > 0.75F)) {
        if (f > 0.92F)
  ...
  {
    paramHierMesh.chunkSetAngles("GearC2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.05F, 0.75F, 0.0F, -70.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC8_D0", 0.0F, 0.0F, 0.0F);
    paramHierMesh.chunkSetAngles("GearC5_D0", 0.0F, Aircraft.cvt(paramFloat, 0.05F, 0.75F, 0.0F, -95.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC6_D0", 0.0F, Aircraft.cvt(paramFloat, 0.05F, 0.15F, 0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC7_D0", 0.0F, Aircraft.cvt(paramFloat, 0.05F, 0.15F, 0.0F, -90.0F), 0.0F);

    paramHierMesh.chunkSetAngles("GearL4_D0", 0.0F, Aircraft.cvt(paramFloat, 0.02F, 0.12F, 0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.05F, 0.75F, 0.0F, -87.0F), 0.0F);

    paramHierMesh.chunkSetAngles("GearR4_D0", 0.0F, Aircraft.cvt(paramFloat, 0.22F, 0.32F, 0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.25F, 0.95F, 0.0F, -87.0F), 0.0F);
  }
  protected void moveGear(float paramFloat) { moveGear(hierMesh(), paramFloat); } 
  public void moveSteering(float paramFloat) {
    hierMesh().chunkSetAngles("GearC8_D0", 0.0F, -Aircraft.cvt(paramFloat, -40.0F, 40.0F, -40.0F, 40.0F), 0.0F);
  }
  public void moveWheelSink() {
    float f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[2], 0.0F, 0.11295F, 0.0F, -25.0F);
    hierMesh().chunkSetAngles("GearC4_D0", 0.0F, f, 0.0F);
    hierMesh().chunkSetAngles("GearC3_D0", 0.0F, f, 0.0F);

    f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.1293F, 0.0F, -26.0F);
    hierMesh().chunkSetAngles("GearL3_D0", 0.0F, f, 0.0F);
    f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.1293F, 0.0F, -30.0F);
    hierMesh().chunkSetAngles("GearL5_D0", 0.0F, f, 0.0F);
    f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.1293F, 0.0F, -4.0F);
    hierMesh().chunkSetAngles("GearL8_D0", 0.0F, f, 0.0F);

    f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.1293F, 0.0F, -26.0F);
    hierMesh().chunkSetAngles("GearR3_D0", 0.0F, f, 0.0F);
    f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.1293F, 0.0F, -30.0F);
    hierMesh().chunkSetAngles("GearR5_D0", 0.0F, f, 0.0F);
    f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.1293F, 0.0F, -4.0F);
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxammo")) {
        if ((World.Rnd().nextFloat(0.0F, 20000.0F) < paramShot.power) && (World.Rnd().nextFloat() < 0.25F)) {
          this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.setJamBullets(0, World.Rnd().nextInt(0, 1));
        }
      ...
      if (paramString.startsWith("xxarmor")) {
        ...
        if (paramString.startsWith("xxarmorg")) {
          ...
          getEnergyPastArmor(56.259998321533203D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot);
      ...
      if (paramString.startsWith("xxEng")) {
        ...
        if (paramPoint3d.jdField_x_of_type_Double > 1.203D) {
    ...
    if (paramString.startsWith("xcockpit")) {
      if (paramPoint3d.jdField_z_of_type_Double > 0.5D) {
  ...
  private final void doHitMeATank(Shot paramShot, int paramInt) {
    if (getEnergyPastArmor(0.2F, paramShot) > 0.0F)
      if (paramShot.power < 14100.0F) {
        ...
        this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.hitTank(paramShot.initiator, paramInt, World.Rnd().nextInt(0, (int)(paramShot.power / 58899.0F)));
      }
  }
  ...
  public void moveCockpitDoor(float paramFloat)
  {
    ...
    if (paramFloat < 0.1F)
      ...
      Aircraft.xyz[1] = Aircraft.cvt(paramFloat, 0.17F, 0.99F, -0.1F, -0.6F);
    }
