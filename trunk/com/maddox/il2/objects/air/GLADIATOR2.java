...
public class GLADIATOR2 extends GLADIATOR
{
  static
  {
    Class localClass = GLADIATOR2.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Gladiator");
    Property.set(localClass, "meshName", "3DO/Plane/GladiatorMkII(Multi1)/hier.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/GladiatorMkII.fmd");
    ...
    weaponsRegister(localClass, "default", new String[] { "MGunBrowning303sipzl 600", "MGunBrowning303sipzl 600", "MGunBrowning303k 400", "MGunBrowning303k 400" });
