...
//            CockpitPilot, Do217, Do217_K1, Aircraft, 
//            Cockpit

public class CockpitDo217_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            setOld = setNew;
            setNew = setTmp;
            float f = ((com.maddox.il2.objects.air.Do217)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.Do217)aircraft()).fSightCurSideslip;
            com.maddox.il2.objects.air.CockpitDo217_Bombardier.calibrAngle = 360F - fm.Or.getPitch();
            mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, com.maddox.il2.objects.air.CockpitDo217_Bombardier.calibrAngle + f);
            if(bEntered)
            {
                com.maddox.il2.engine.hotkey.HookPilot hookpilot = com.maddox.il2.engine.hotkey.HookPilot.current;
                hookpilot.setSimpleAimOrient(aAim + 10F * f1, tAim + com.maddox.il2.objects.air.CockpitDo217_Bombardier.calibrAngle + f, 0.0F);
            }
    ...
    public CockpitDo217_Bombardier()
    {
        ...
        try
        {
            ...
            com.maddox.il2.engine.HookNamed hooknamed1 = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "LAMPHOOK1");
            com.maddox.il2.engine.Loc loc1 = new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
            hooknamed1.computePos(((com.maddox.il2.engine.Actor) (this)), new Loc(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F), loc1);
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.Do217)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.Do217)aircraft()).fSightCurReadyness > 0.93F;
        ...
        } else
        {
            ...
            resetYPRmodifier();
            com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.CT.getRudder(), -1F, 1.0F, 0.08F, -0.08F);
            mesh.chunkSetLocate("PedalRbar", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
            com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.CT.getRudder(), -1F, 1.0F, -0.08F, 0.08F);
            mesh.chunkSetLocate("PedalLbar", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (((java.lang.Object) (com.maddox.il2.objects.air.CockpitDo217_Bombardier.class)))), "astatePilotIndx", 0);
    }
