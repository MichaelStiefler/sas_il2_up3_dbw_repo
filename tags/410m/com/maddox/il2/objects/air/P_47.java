...
public abstract class P_47 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeStormovik
{
    ...
    {
        float f1 = java.lang.Math.max(-f * 980F, -98F);
    ...
    {
        com.maddox.il2.objects.air.P_47.moveGear(hierMesh(), f);
    }
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.P_47.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.2F, 0.0F, 0.2F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p1"))
                {
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(20F, 40F) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                ...
                if(s.endsWith("p3"))
                    getEnergyPastArmor(12.560000419616699D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p4"))
                    getEnergyPastArmor(12.560000419616699D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("f1"))
                {
                    getEnergyPastArmor(2.0999999046325684D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    if(shot.powerType == 3)
                        shot.powerType = 2;
                }
                return;
            ...
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.0049F)
                {
            ...
            if(s.startsWith("xxtank"))
            {
                ...
                if(getEnergyPastArmor(1.8F, shot) > 0.0F)
                {
                    ...
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.04F || shot.powerType == 3 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.6F)
                    {
        ...
        if(s.startsWith("xcf") || s.startsWith("xcockpit"))
        {
            ...
            {
                if(point3d.z > 0.7160000205039978D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
    ...
    {
        float f1 = com.maddox.il2.objects.air.P_47.cvt(FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 0.0F, -5F);
        for(int i = 1; i < 13; i++)
            hierMesh().chunkSetAngles("Cowflap" + i + "_D0", 0.0F, f1, 0.0F);

        f1 = com.maddox.il2.objects.air.P_47.cvt(FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 25F, 0.0F);
    ...
    public void onAircraftLoaded()
    {
        ...
        for(int j = 0; j < aobj.length; j++)
            if(aobj[j] instanceof com.maddox.il2.objects.weapons.Bomb)
            {
                hierMesh().chunkVisible("Rack_D0", true);
                return;
            }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.P_47.class;
