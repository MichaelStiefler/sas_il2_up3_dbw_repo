...
public class CockpitFW_190D15 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.1F, 0.99F, 0.0F, 0.35F);
        ...
        if(gun[0] != null)
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[0].countBullets(), 0.0F, 250F, -0.044F, 0.0F);
            mesh.chunkSetLocate("RC_MG17_L", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        }
        if(gun[1] != null)
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[1].countBullets(), 0.0F, 250F, -0.044F, 0.0F);
        ...
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[2].countBullets(), 0.0F, 125F, -0.017F, 0.0F);
        ...
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[3].countBullets(), 0.0F, 125F, -0.017F, 0.0F);
        ...
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt((float)gun[4].countBullets() + (float)gun[5].countBullets(), 0.0F, 250F, -0.018F, 0.0F);
            mesh.chunkSetLocate("RC_MG151_L", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        }
        if(gun[6] != null && (float)gun[6].countBullets() > 0.0F && gun[7] != null && (float)gun[7].countBullets() > 0.0F)
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt((float)gun[6].countBullets() + (float)gun[7].countBullets(), 0.0F, 250F, -0.018F, 0.0F);
            mesh.chunkSetLocate("RC_MG151_R", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        }
        if(gun[8] != null && (float)gun[8].countBullets() > 0.0F)
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[8].countBullets(), 0.0F, 35F, -0.017F, 0.0F);
            mesh.chunkSetLocate("RC_MG151_L", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        }
        if(gun[9] != null && (float)gun[9].countBullets() > 0.0F)
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[9].countBullets(), 0.0F, 35F, -0.017F, 0.0F);
            mesh.chunkSetLocate("RC_MG151_R", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        }
        if(gun[10] != null && (float)gun[10].countBullets() > 0.0F)
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[10].countBullets(), 0.0F, 55F, -0.017F, 0.0F);
            mesh.chunkSetLocate("RC_MG151_L", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        }
        if(gun[11] != null && (float)gun[11].countBullets() > 0.0F)
        {
            com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(gun[11].countBullets(), 0.0F, 55F, -0.017F, 0.0F);
            mesh.chunkSetLocate("RC_MG151_R", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        }
