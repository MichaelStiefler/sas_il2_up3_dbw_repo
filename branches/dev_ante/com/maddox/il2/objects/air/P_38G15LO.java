...
public class P_38G15LO extends P_38mod
{
  static Class _mthclass$(String paramString)
  {
    ...
    return localClass; } 
  static { Class localClass = P_38G15LO.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "P-38");
    Property.set(localClass, "meshNameDemo", "3DO/Plane/P-38G-15-LO(USA)/hier.him");
    Property.set(localClass, "meshName", "3DO/Plane/P-38G-15-LO(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());
    Property.set(localClass, "meshName_us", "3DO/Plane/P-38G-15-LO(USA)/hier.him");
    Property.set(localClass, "PaintScheme_us", new PaintSchemeFMPar04());
    Property.set(localClass, "noseart", 1);
    Property.set(localClass, "yearService", 1943.0F);
    Property.set(localClass, "yearExpired", 1945.5F);
    Property.set(localClass, "FlightModel", "FlightModels/P-38G-15-LO.fmd");

    Property.set(localClass, "cockpitClass", new Class[] { CockpitP_38G15LO.class });
    ...
    {
      System.out.println("Error P38G-15-LO Weapons 'default ' NOT initialized:" + localException1.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons 'droptanks ' NOT initialized:" + localException2.getMessage());
    }
    ...
    {
      System.out.println("Error P38G15LO Weapons '1xdroptank1x500 ' NOT initialized:" + localException3.getMessage());
    }
    ...
    {
      System.out.println("Error P38G15LO Weapons '1xdroptank1x1000 ' NOT initialized:" + localException4.getMessage());
    }
    ...
    {
      System.out.println("Error P38G15LO Weapons '1xdroptank1x1600 ' NOT initialized:" + localException5.getMessage());
    }
    ...
    {
      System.out.println("Error P38G15LO Weapons '2x175Napalm ' NOT initialized:" + localException6.getMessage());
    }
    ...
    {
      System.out.println("Error P38G15LO Weapons 'droptanks2x3 ' NOT initialized:" + localException7.getMessage());
    }
    ...
    {
      System.out.println("Error P38G15LO Weapons 'droptanks4x3 ' NOT initialized:" + localException8.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '2x250 ' NOT initialized:" + localException9.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '2x500 ' NOT initialized:" + localException10.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '2x1000 ' NOT initialized:" + localException11.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '2x1600 ' NOT initialized:" + localException12.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '2x3 ' NOT initialized:" + localException13.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '2x3n2x500 ' NOT initialized:" + localException14.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '2x3n2x1000 ' NOT initialized:" + localException15.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons '4x3 ' NOT initialized:" + localException16.getMessage());
    }

    try
    {
      str = "1xdroptankn1xmk13";
      arrayOf_WeaponSlot = new Aircraft._WeaponSlot[i];
      arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(0, "MGunBrowning50kAPIT", 500);
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(0, "MGunBrowning50kAPIT", 500);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(0, "MGunBrowning50kAPIT", 500);
      ...
      arrayOf_WeaponSlot[6] = null;
      arrayOf_WeaponSlot[7] = null;
      arrayOf_WeaponSlot[8] = new Aircraft._WeaponSlot(3, "BombGunTorpMk13", 1);
      arrayOf_WeaponSlot[9] = null;
      arrayOf_WeaponSlot[10] = null;
      arrayOf_WeaponSlot[11] = null;
      arrayOf_WeaponSlot[12] = null;
    ...
    {
      System.out.println("Error P38G15LO Weapons '1xdroptank1xMk13 ' NOT initialized:" + localException17.getMessage());
    }
    ...
    try
    {
      ...
      arrayOf_WeaponSlot[5] = null;
      arrayOf_WeaponSlot[6] = null;
      arrayOf_WeaponSlot[7] = new Aircraft._WeaponSlot(3, "BombGunTorpMk13", 1);
      arrayOf_WeaponSlot[8] = new Aircraft._WeaponSlot(3, "BombGunTorpMk13", 1);
      arrayOf_WeaponSlot[9] = null;
      arrayOf_WeaponSlot[10] = null;
      arrayOf_WeaponSlot[11] = null;
    ...
    {
      System.out.println("Error P38G15LO Weapons '2xMk13 ' NOT initialized:" + localException18.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-15-LO Weapons 'none ' NOT initialized:" + localException19.getMessage());
    }
  }
}