...
public class CockpitKI_43_II extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RPM1", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getRPM(), 0.0F, 3200.0F, 0.0F, 360.0F), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Gunpres1", 0.0F, 148.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitKI_43_II.access$102(CockpitKI_43_II.this, CockpitKI_43_II.this.setOld); CockpitKI_43_II.access$202(CockpitKI_43_II.this, CockpitKI_43_II.this.setNew); CockpitKI_43_II.access$302(CockpitKI_43_II.this, CockpitKI_43_II.this.setTmp);

        if (CockpitKI_43_II.this.cockpitDimControl) {
          if (CockpitKI_43_II.this.setNew.dimPos < 1.0F) CockpitKI_43_II.this.setNew.dimPos = (CockpitKI_43_II.this.setOld.dimPos + 0.03F);
        }
        else if (CockpitKI_43_II.this.setNew.dimPos > 0.0F) CockpitKI_43_II.this.setNew.dimPos = (CockpitKI_43_II.this.setOld.dimPos - 0.03F);

        if ((CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) {
        ...
        CockpitKI_43_II.this.setNew.manifold = (0.8F * CockpitKI_43_II.this.setOld.manifold + 0.2F * CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitKI_43_II.this.setNew.throttle = (0.8F * CockpitKI_43_II.this.setOld.throttle + 0.2F * CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitKI_43_II.this.setNew.prop = (0.8F * CockpitKI_43_II.this.setOld.prop + 0.2F * CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitKI_43_II.this.setNew.mix = (0.8F * CockpitKI_43_II.this.setOld.mix + 0.2F * CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());

        CockpitKI_43_II.this.setNew.man = (0.92F * CockpitKI_43_II.this.setOld.man + 0.08F * CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitKI_43_II.this.setNew.altimeter = CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        float f = CockpitKI_43_II.this.waypointAzimuth();
        CockpitKI_43_II.this.setNew.azimuth.setDeg(CockpitKI_43_II.this.setOld.azimuth.getDeg(1.0F), CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitKI_43_II.this.setNew.waypointDeviation.setDeg(CockpitKI_43_II.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitKI_43_II.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-5.0F, 5.0F));
        CockpitKI_43_II.this.setNew.waypointAzimuth.setDeg(CockpitKI_43_II.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitKI_43_II.this.setNew.vspeed = (0.5F * CockpitKI_43_II.this.setOld.vspeed + 0.5F * CockpitKI_43_II.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed());
      }
  ...
  private class Variables
  {
    ...
    private final CockpitKI_43_II this$0;
    ...
    Variables(CockpitKI_43_II.1 arg2)
    {
      this();
    }
  }
