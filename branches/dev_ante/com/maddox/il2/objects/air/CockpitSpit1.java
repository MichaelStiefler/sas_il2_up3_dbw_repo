...
public class CockpitSpit1 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit1.this.fm != null) {
        CockpitSpit1.access$102(CockpitSpit1.this, CockpitSpit1.this.setOld);
        CockpitSpit1.access$202(CockpitSpit1.this, CockpitSpit1.this.setNew);
        CockpitSpit1.access$302(CockpitSpit1.this, CockpitSpit1.this.setTmp);
        ...
        if (Math.abs(CockpitSpit1.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit1.this.setNew.azimuth = (0.97F * CockpitSpit1.this.setOld.azimuth + 0.03F * -CockpitSpit1.this.fm.Or.getYaw());
        }
        if ((CockpitSpit1.this.setOld.azimuth > 270.0F) && (CockpitSpit1.this.setNew.azimuth < 90.0F))
          CockpitSpit1.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit1.this.setOld.azimuth < 90.0F) && (CockpitSpit1.this.setNew.azimuth > 270.0F))
          CockpitSpit1.this.setOld.azimuth += 360.0F;
        CockpitSpit1.this.setNew.waypointAzimuth = (0.91F * CockpitSpit1.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit1.this.waypointAzimuth() - CockpitSpit1.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));
  ...
  private class Variables
  {
    ...
    private final CockpitSpit1 this$0;
