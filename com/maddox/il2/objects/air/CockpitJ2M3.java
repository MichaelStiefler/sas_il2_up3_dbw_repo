...
public class CockpitJ2M3 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Gear2", this.pictGear > 0.0F ? 5.0F : 0.0F, 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJ2M3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitJ2M3.access$102(CockpitJ2M3.this, CockpitJ2M3.this.setOld); CockpitJ2M3.access$202(CockpitJ2M3.this, CockpitJ2M3.this.setNew); CockpitJ2M3.access$302(CockpitJ2M3.this, CockpitJ2M3.this.setTmp);

        CockpitJ2M3.this.setNew.throttle = (0.85F * CockpitJ2M3.this.setOld.throttle + CockpitJ2M3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitJ2M3.this.setNew.prop = (0.85F * CockpitJ2M3.this.setOld.prop + CockpitJ2M3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitJ2M3.this.setNew.altimeter = CockpitJ2M3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitJ2M3.this.waypointAzimuth();
        CockpitJ2M3.this.setNew.waypointAzimuth.setDeg(CockpitJ2M3.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJ2M3.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitJ2M3.this.setNew.azimuth.setDeg(CockpitJ2M3.this.setOld.azimuth.getDeg(1.0F), CockpitJ2M3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitJ2M3.this.setNew.vspeed = ((199.0F * CockpitJ2M3.this.setOld.vspeed + CockpitJ2M3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        CockpitJ2M3.this.setNew.manifold = (0.8F * CockpitJ2M3.this.setOld.manifold + 0.2F * CockpitJ2M3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getManifoldPressure());
      }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float manifold;
    private final CockpitJ2M3 this$0;
