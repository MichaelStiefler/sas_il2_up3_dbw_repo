...
public class Fulmar1 extends Fulmar
{
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "cockpitClass", CockpitFulmar.class);
        Fulmar1.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0, 0, 0, 0, 0, 3, 3, 
            9
        });
        Fulmar1.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_ExternalBomb01", "_ExternalBomb02", 
            "_ExternalDev01"
        });
        Fulmar1.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        Fulmar1.weaponsRegister(class1, "2x250lb", new java.lang.String[] {
        ...
        Fulmar1.weaponsRegister(class1, "1xDropTank", new java.lang.String[] {
            "MGunBrowning303k 350", "MGunBrowning303k 350", "MGunBrowning303k 350", "MGunBrowning303k 350", "MGunBrowning303k 350", "MGunBrowning303k 350", "MGunBrowning303k 350", "MGunBrowning303k 350", null, null, 
            "FuelTankGun_Tank60gal 1"
        });
        Fulmar1.weaponsRegister(class1, "none", new java.lang.String[] {
