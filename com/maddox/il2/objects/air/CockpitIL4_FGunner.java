...
public class CockpitIL4_FGunner extends CockpitGunner
{
  ...
  public CockpitIL4_FGunner() {
    super("3DO/Cockpit/He-111H-6-NGun/FGunnerIL4.him", "he111_gunner");
  }
  ...
  static
  {
    Property.set(CockpitIL4_FGunner.class, "aiTuretNum", 0);

    Property.set(CockpitIL4_FGunner.class, "weaponControlNum", 10);

    Property.set(CockpitIL4_FGunner.class, "astatePilotIndx", 2);
  }
}