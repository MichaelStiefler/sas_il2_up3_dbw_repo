...
public class Cockpit410DNJ_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((ME_410DNJ)aircraft()).fSightCurForwardAngle;
            float f1 = ((ME_410DNJ)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bBAiming)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((ME_410DNJ)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((ME_410DNJ)aircraft()).fSightCurReadyness > 0.93F;
