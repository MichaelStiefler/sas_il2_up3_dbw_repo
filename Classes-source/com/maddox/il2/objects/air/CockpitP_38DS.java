...
// Source File Name:   CockpitP_38DS.java
...
//            CockpitPilot, P_38DroopSnoot, Cockpit, Aircraft

public class CockpitP_38DS extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(((com.maddox.il2.objects.air.P_38DroopSnoot)aircraft()).bChangedPit)
            {
                reflectPlaneToModel();
                ((com.maddox.il2.objects.air.P_38DroopSnoot)aircraft()).bChangedPit = false;
            }
            if(fm != null)
            {
                setTmp = setOld;
