...
public class CmdRawConsole extends com.maddox.rts.Cmd
{
    ...
    {
        if(com.maddox.rts.cmd.CmdRawConsole.exist(map, "LOG"))
            if(com.maddox.rts.cmd.CmdRawConsole.nargs(map, "LOG") == 1)
            {
                java.lang.String s = com.maddox.rts.cmd.CmdRawConsole.arg(map, "LOG", 0);
        ...
        if(com.maddox.rts.cmd.CmdRawConsole.exist(map, "LOGFILE"))
            if(com.maddox.rts.cmd.CmdRawConsole.nargs(map, "LOGFILE") == 1)
            {
                java.lang.String s1 = com.maddox.rts.cmd.CmdRawConsole.arg(map, "LOGFILE", 0);
