...
//            Scheme1, P_51B, P_51C, TypeFighter, 
//            TypeBNZFighter, TypeStormovik, PaintScheme

public abstract class P_51 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeStormovik
{
    ...
    {
        float f1 = f <= 0.5F ? com.maddox.il2.objects.air.P_51.cvt(f, 0.0F, 0.2F, 0.0F, 95F) : com.maddox.il2.objects.air.P_51.cvt(f, 0.8F, 1.0F, 95F, 0.0F);
    ...
    {
        com.maddox.il2.objects.air.P_51.moveGear(hierMesh(), f);
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.P_51.cvt(f, 0.0F, 0.4F, 0.0F, -0.1F);
        hierMesh().chunkSetLocate("GearL9_D0", xyz, ypr);
        if((this instanceof com.maddox.il2.objects.air.P_51B) || (this instanceof com.maddox.il2.objects.air.P_51C))
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.P_51.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.2F, 0.0F, 0.2F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p2"))
                    getEnergyPastArmor(13.350000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p3"))
                {
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.P_51.class;
