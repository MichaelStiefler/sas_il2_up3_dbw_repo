...
public class F4F3 extends F4F
{
  ...
  static
  {
    ...
    weaponsRegister(localClass, "default", new String[] { "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", null, null, null, null, null, null, null, null });

    weaponsRegister(localClass, "2x58dt", new String[] { "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", "PylonF4FPLN1", "PylonF4FPLN1", "FuelTankGun_TankF4F", "FuelTankGun_TankF4F", null, null, null, null });

    weaponsRegister(localClass, "2x100", new String[] { "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", null, null, null, null, "PylonF4FPLN2", "PylonF4FPLN2", "BombGunFAB50 1", "BombGunFAB50 1" });

    weaponsRegister(localClass, "2x1002x58dt", new String[] { "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", "PylonF4FPLN1", "PylonF4FPLN1", "FuelTankGun_TankF4F", "FuelTankGun_TankF4F", "PylonF4FPLN2", "PylonF4FPLN2", "BombGunFAB50 1", "BombGunFAB50 1" });
