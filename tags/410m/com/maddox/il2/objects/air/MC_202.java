    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MC_202.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0
        });
        com.maddox.il2.objects.air.MC_202.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04"
        });
        com.maddox.il2.objects.air.MC_202.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBredaSAFAT127si 370", "MGunBredaSAFAT127si 370", "MGunBredaSAFAT77k 500", "MGunBredaSAFAT77k 500"
        });
        com.maddox.il2.objects.air.MC_202.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
