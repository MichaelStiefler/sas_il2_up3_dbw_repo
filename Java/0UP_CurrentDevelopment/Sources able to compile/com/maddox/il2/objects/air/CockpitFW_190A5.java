...
public class CockpitFW_190A5 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(gun[0] == null)
        {
            ...
            gun[4] = ((Aircraft)fm.actor).getGunByHookName("_CANNON01");
            gun[5] = ((Aircraft)fm.actor).getGunByHookName("_CANNON02");
        }
        if(bomb[0] == null)
        {
        ...
        mesh.chunkSetLocate("Revi16Tinter", Cockpit.xyz, Cockpit.ypr);
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitFW_190A5.class, "normZN", 0.72F);
        com.maddox.rts.Property.set(CockpitFW_190A5.class, "gsZN", 0.66F);
    }
