...
public class CannonRocketSimpleM13 extends CannonRocketSimple
{
  ...
  public void launch(Point3d paramPoint3d, Orient paramOrient, float paramFloat, Actor paramActor) {
    RocketSimpleM13 localRocketSimpleM13 = new RocketSimpleM13(paramPoint3d, paramOrient, paramActor);
    localRocketSimpleM13.start(paramFloat);
  }
}