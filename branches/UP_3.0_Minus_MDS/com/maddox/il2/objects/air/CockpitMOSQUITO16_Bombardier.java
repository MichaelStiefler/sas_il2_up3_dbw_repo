...
// Source File Name:   CockpitMOSQUITO16_Bombardier.java
...
//            CockpitPilot, MOSQUITO16, Cockpit

public class CockpitMOSQUITO16_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.MOSQUITO16)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.MOSQUITO16)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.MOSQUITO16)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.MOSQUITO16)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
