...
public abstract class IL_4 extends Scheme2
{
  ...
  public void rareAction(float paramFloat, boolean paramBoolean) {
    ...
    if (paramBoolean) {
      ...
      if ((this.FM.AS.astateTankStates[0] > 5) && (World.Rnd().nextFloat() < 0.03F))
      {
        nextDMGLevel(this.FM.AS.astateEffectChunks[0] + "0", 0, this);
      }if ((this.FM.AS.astateTankStates[1] > 5) && (World.Rnd().nextFloat() < 0.03F))
      {
      ...
      {
        this.FM.AS.hitTank(this, 1, 1);
      }if ((this.FM.AS.astateTankStates[2] > 5) && (World.Rnd().nextFloat() < 0.03F))
      {
        nextDMGLevel(this.FM.AS.astateEffectChunks[2] + "0", 0, this);
      }if ((this.FM.AS.astateTankStates[3] > 5) && (World.Rnd().nextFloat() < 0.03F))
      {
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxarmor")) {
        ...
        if ((paramString.startsWith("xxsparli")) && (chunkDamageVisible("WingLIn") > 2) && (getEnergyPastArmor(26.799999237060547D / (1.000100016593933D - Math.abs(Aircraft.v1.y)), paramShot) > 0.0F))
        {
          debuggunnery("*** WingLIn Spars Damaged..");
          nextDMGLevels(1, 2, "WingLIn_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparri")) && (chunkDamageVisible("WingRIn") > 2) && (getEnergyPastArmor(26.799999237060547D / (1.000100016593933D - Math.abs(Aircraft.v1.y)), paramShot) > 0.0F))
        {
          debuggunnery("*** WingRIn Spars Damaged..");
          nextDMGLevels(1, 2, "WingRIn_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparlm")) && (chunkDamageVisible("WingLMid") > 2) && (getEnergyPastArmor(26.799999237060547D / (1.000100016593933D - Math.abs(Aircraft.v1.y)), paramShot) > 0.0F))
        {
          debuggunnery("*** WingLMid Spars Damaged..");
          nextDMGLevels(1, 2, "WingLMid_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparrm")) && (chunkDamageVisible("WingRMid") > 2) && (getEnergyPastArmor(26.799999237060547D / (1.000100016593933D - Math.abs(Aircraft.v1.y)), paramShot) > 0.0F))
        {
          debuggunnery("*** WingRMid Spars Damaged..");
          nextDMGLevels(1, 2, "WingRMid_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparlo")) && (chunkDamageVisible("WingLOut") > 2) && (getEnergyPastArmor(26.799999237060547D / (1.000100016593933D - Math.abs(Aircraft.v1.y)), paramShot) > 0.0F))
        {
          debuggunnery("*** WingLOut Spars Damaged..");
          nextDMGLevels(1, 2, "WingLOut_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparro")) && (chunkDamageVisible("WingROut") > 2) && (getEnergyPastArmor(26.799999237060547D / (1.000100016593933D - Math.abs(Aircraft.v1.y)), paramShot) > 0.0F))
        {
          debuggunnery("*** WingROut Spars Damaged..");
          nextDMGLevels(1, 2, "WingROut_D3", paramShot.initiator);
        }
        if (((paramString.endsWith("e1")) || (paramString.endsWith("e2"))) && (getEnergyPastArmor(32.0F, paramShot) > 0.0F))
        {
          debuggunnery("*** Engine1 Suspension Broken in Half..");
          nextDMGLevels(3, 2, "Engine1_D0", paramShot.initiator);
        }
        if (((paramString.endsWith("e3")) || (paramString.endsWith("e4"))) && (getEnergyPastArmor(32.0F, paramShot) > 0.0F))
        {
        ...
        } else if ((paramString.startsWith("xxlockr")) && (getEnergyPastArmor(4.32F, paramShot) > 0.0F))
        {
          debuggunnery("*** Rudder1 Lock Damaged..");
          nextDMGLevels(1, 2, "Rudder1_D0", paramShot.initiator);
        }
      } else if (paramString.startsWith("xxbomb")) {
        ...
        if ((paramString.endsWith("prop")) && (getEnergyPastArmor(1.2F, paramShot) > 0.0F))
        {
        ...
        if (paramString.endsWith("eqpt")) {
          if (getEnergyPastArmor(0.1F, paramShot) > 0.0F) {
            if ((Aircraft.Pd.y > 0.0D) && (Aircraft.Pd.z < 0.1889999955892563D) && (World.Rnd().nextFloat(0.0F, 16000.0F) < paramShot.power))
            {
      ...
      } else if (paramString.startsWith("xxammo")) {
        if (World.Rnd().nextFloat() < 0.1F)
      ...
      if ((paramString.endsWith("2")) && (World.Rnd().nextFloat() < 0.1F) && (getEnergyPastArmor(World.Rnd().nextFloat(12.88F, 16.959999F), paramShot) > 0.0F))
      {
  ...
  private void setRadist(int paramInt1, int paramInt2) {
    ...
    if (this.FM.AS.astatePilotStates[paramInt1] <= 90)
      switch (paramInt1) {
      case 1:
        hierMesh().chunkVisible("Pilot2_D0", false);
        hierMesh().chunkVisible("Pilot2a_D0", false);
