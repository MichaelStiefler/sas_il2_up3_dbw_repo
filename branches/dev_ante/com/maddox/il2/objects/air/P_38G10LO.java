...
public class P_38G10LO extends P_38mod
{
  static Class _mthclass$(String paramString)
  {
    ...
    return localClass; } 
  static { Class localClass = P_38G10LO.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "P-38");
    Property.set(localClass, "meshNameDemo", "3DO/Plane/P-38G-10-LO(USA)/hier.him");
    Property.set(localClass, "meshName", "3DO/Plane/P-38G-10-LO(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());
    Property.set(localClass, "meshName_us", "3DO/Plane/P-38G-10-LO(USA)/hier.him");
    Property.set(localClass, "PaintScheme_us", new PaintSchemeFMPar04());
    Property.set(localClass, "noseart", 1);
    Property.set(localClass, "yearService", 1943.0F);
    Property.set(localClass, "yearExpired", 1945.5F);
    Property.set(localClass, "FlightModel", "FlightModels/P-38G-10-LO.fmd");

    Property.set(localClass, "cockpitClass", new Class[] { CockpitP_38G10LO.class });
    ...
    {
      System.out.println("Error P38G-10-LO Weapons 'default ' NOT initialized:" + localException1.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-10-LO Weapons 'droptanks ' NOT initialized:" + localException2.getMessage());
    }
    ...
    {
      System.out.println("Error P38G10LO Weapons '1xdroptank1x500 ' NOT initialized:" + localException3.getMessage());
    }
    ...
    {
      System.out.println("Error P38G10LO Weapons '1xdroptank1x1000 ' NOT initialized:" + localException4.getMessage());
    }
    ...
    {
      System.out.println("Error P38G10LO Weapons '1xdroptank1x1600 ' NOT initialized:" + localException5.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-10-LO Weapons '2x250 ' NOT initialized:" + localException6.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-10-LO Weapons '2x500 ' NOT initialized:" + localException7.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-10-LO Weapons '2x1000 ' NOT initialized:" + localException8.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-10-LO Weapons '2x1600 ' NOT initialized:" + localException9.getMessage());
    }
    ...
    {
      System.out.println("Error P38G10LO Weapons '2x175Napalm ' NOT initialized:" + localException10.getMessage());
    }
    ...
    {
      System.out.println("Error P38G-10-LO Weapons 'none ' NOT initialized:" + localException11.getMessage());
    }
  }
}