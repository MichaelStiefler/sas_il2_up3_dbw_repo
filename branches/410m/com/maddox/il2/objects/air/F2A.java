...
//            Scheme1, TypeFighter, TypeTNBFighter, NetAircraft
    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.F2A.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.2225F, 0.0F, 0.2225F);
        hierMesh().chunkSetLocate("GearL15_D0", xyz, ypr);
        xyz[2] = com.maddox.il2.objects.air.F2A.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.2225F, 0.0F, 0.2225F);
    ...
    public void update(float f)
    {
        ...
        if(f2 > 0.01F)
            ...
            {
                arrestor = com.maddox.il2.objects.air.F2A.cvt(FM.Gears.arrestorVAngle, -f3, f3, -f3, f3);
                moveArrestorHook(f2);
