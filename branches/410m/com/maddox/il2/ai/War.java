...
public class War
{
    ...
    public boolean isActive()
    {
        ...
        if(com.maddox.il2.game.Mission.isSingle())
            return true;
        return com.maddox.il2.game.Mission.isServer() && (com.maddox.il2.game.Mission.isCoop() || com.maddox.il2.game.Mission.isDogfight());
    }
    ...
    public static com.maddox.il2.objects.air.Aircraft GetNearestEnemyAircraft(com.maddox.il2.engine.Actor actor, float f, int i)
    {
        ...
        if(actor1 != null && (actor1 instanceof com.maddox.il2.objects.air.Aircraft))
            return (com.maddox.il2.objects.air.Aircraft)actor1;
        actor1 = com.maddox.il2.ai.War.GetNearestEnemy(actor, -1, f, 9);
        if(actor1 != null && (actor1 instanceof com.maddox.il2.objects.air.Aircraft))
            return (com.maddox.il2.objects.air.Aircraft)actor1;
        else
            return null;
