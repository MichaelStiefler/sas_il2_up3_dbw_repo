...
public abstract class PZL37 extends com.maddox.il2.objects.air.Scheme2
{
    ...
    {
        com.maddox.il2.objects.air.PZL37.moveGear(hierMesh(), f);
    }
    ...
    protected boolean cutFM(int i, int j, com.maddox.il2.engine.Actor actor)
    {
        ...
        case 34: // '"'
            FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 0, 2);
            if(com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 66)
                FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 0, 2);
            break;

        case 37: // '%'
            FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 1, 2);
            if(com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 66)
                FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 1, 2);
            break;
        }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                if(s.startsWith("xxsparli") && chunkDamageVisible("WingLIn") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLIn Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparri") && chunkDamageVisible("WingRIn") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingRIn Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlm") && chunkDamageVisible("WingLMid") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparrm") && chunkDamageVisible("WingRMid") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingRMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlo") && chunkDamageVisible("WingLOut") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLOut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if(s.startsWith("xxsparro") && chunkDamageVisible("WingROut") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y)), shot) > 0.0F)
                {
        ...
        if(com.maddox.rts.Time.current() > tme)
        {
            ...
            if(FM.turret.length != 0)
            {
                ...
                if(FM.turret[0].bIsOperable != (radist[1] == 0))
                {
                    ...
                    {
                        com.maddox.il2.engine.Actor actor3 = FM.turret[1].target;
                        if(actor3 == null)
                ...
                if(FM.turret[1].bIsOperable)
                {
                    ...
                    if(actor1 != null && com.maddox.il2.engine.Actor.isValid(actor1))
                    {
                        ...
                        actor1.pos.getAbs(com.maddox.il2.objects.air.Aircraft.tmpLoc3);
                ...
                {
                    com.maddox.il2.engine.Actor actor2 = FM.turret[2].target;
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.PZL37.class;
