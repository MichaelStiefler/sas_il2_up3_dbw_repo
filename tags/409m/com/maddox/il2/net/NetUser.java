        ...
        if(isMirror() && netmsginput.channel() == masterChannel)
            ...
            case 14: // '\016'
                ...
                if(netuser2 == null)
                    return true;
                netuser2.place = i;
                if(i >= 0 && com.maddox.il2.game.Mission.cur() != null && com.maddox.il2.game.Main.cur().missionLoading == null)
                    netuser2.setArmy(com.maddox.il2.gui.GUINetAircraft.getItem(i).reg.getArmy());
                ...
                if(isMirrored())
                    ...
                    {
                        com.maddox.rts.NetObj.printDebug(exception2);
                    }
                return true;
