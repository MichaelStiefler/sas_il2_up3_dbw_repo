...
// Source File Name:   CockpitSB2M103_Bombardier.java
...
//            CockpitPilot, SB_2M103, Cockpit

public class CockpitSB2M103_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.SB_2M103)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.SB_2M103)aircraft()).fSightCurSideslip;
    ...
    {
        super("3DO/Cockpit/Pe-2-Bombardier/BombardierSB2M103.him", "he111");
        bEntered = false;
        try
        {
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.SB_2M103)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.SB_2M103)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
