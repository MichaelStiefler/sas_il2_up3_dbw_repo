...
// Source File Name:   BombTIOrange.java
...
public class BombTIOrange extends com.maddox.il2.objects.weapons.Bomb
{
    ...
    private void doFireContaineds()
    {
        ...
        if((double)charge < 1.01D)
        {
            ...
            if(com.maddox.il2.engine.Actor.isValid(actor))
            {
                ...
                pos.getCurrent(loc);
                findHook(((java.lang.Object) ("_Spawn0" + charge))).computePos(((com.maddox.il2.engine.Actor) (this)), loc, loc1);
                getSpeed(vector3d1);
                for(int i = 0; i < 60; i++)
                {
                    loc1.get(((com.maddox.JGP.Tuple3d) (point3d)), orient);
                    ...
                    orient.transform(((com.maddox.JGP.Tuple3d) (vector3d)));
                    vector3d.scale(com.maddox.il2.ai.World.Rnd().nextDouble(5D, 12.199999999999999D));
                    vector3d.add(((com.maddox.JGP.Tuple3d) (vector3d1)));
                    com.maddox.il2.objects.weapons.BombTiOn bombtion = new BombTiOn();
                    bombtion.pos.setUpdateEnable(true);
                    bombtion.pos.setAbs(point3d, orient);
                    bombtion.pos.reset();
                    bombtion.start();
                    bombtion.setOwner(actor, false, false, false);
                    bombtion.setSpeed(vector3d);
                }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.weapons.BombTIOrange.class;
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "mesh", "3DO/Arms/Flare/mono.sim");
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "massa", 125F);
