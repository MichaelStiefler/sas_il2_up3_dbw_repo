...
// Source File Name:   CockpitIL4late_Bombardier.java
...
//            CockpitPilot, IL_4_IL4late, Cockpit

public class CockpitIL4late_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.IL_4_IL4late)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.IL_4_IL4late)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.IL_4_IL4late)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.IL_4_IL4late)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
