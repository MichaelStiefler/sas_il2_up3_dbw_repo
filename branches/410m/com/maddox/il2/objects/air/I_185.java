    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC3_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(f, 0.02F, 0.1F, 0.0F, -65F), 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(f, 0.02F, 0.1F, 0.0F, -65F), 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, 87F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL7_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(f, 0.02F, 0.1F, 0.0F, -85F), 0.0F);
        hiermesh.chunkSetAngles("GearL8_D0", 0.0F, -90F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 87F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR7_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(f, 0.02F, 0.1F, 0.0F, -85F), 0.0F);
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.I_185.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.15F, 0.0F, 0.15F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(xyz[1], 0.0F, 0.15F, 0.0F, -30F), 0.0F);
        hierMesh().chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(xyz[1], 0.0F, 0.15F, 0.0F, -60F), 0.0F);
        xyz[1] = com.maddox.il2.objects.air.I_185.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.15F, 0.0F, 0.15F);
        hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(xyz[1], 0.0F, 0.15F, 0.0F, -30F), 0.0F);
        hierMesh().chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.I_185.cvt(xyz[1], 0.0F, 0.15F, 0.0F, -60F), 0.0F);
    }
    ...
    public void update(float f)
    {
        ...
        {
            resetYPRmodifier();
            xyz[0] = com.maddox.il2.objects.air.I_185.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -0.025F);
            xyz[2] = com.maddox.il2.objects.air.I_185.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.0125F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p2"))
                    getEnergyPastArmor(8.05F / (1E-005F + (float)java.lang.Math.abs(v1.x)), shot);
                return;
            }
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** StabL Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** StabR Spars Damaged..");
            ...
            if(s.startsWith("xxlock"))
            {
                if(s.endsWith("al"))
                {
                    ...
                    {
                        com.maddox.il2.objects.air.I_185.debugprintln(this, "*** AroneL Lock Damaged..");
                ...
                if(s.endsWith("ar"))
                {
                    if(getEnergyPastArmor(0.35F, shot) > 0.0F)
                    {
                        com.maddox.il2.objects.air.I_185.debugprintln(this, "*** AroneR Lock Damaged..");
                ...
                if(s.endsWith("vl1") || s.endsWith("vl2"))
                {
                    if(getEnergyPastArmor(0.35F, shot) > 0.0F)
                    {
                        com.maddox.il2.objects.air.I_185.debugprintln(this, "*** VatorL Lock Damaged..");
                ...
                if(s.endsWith("vr1") || s.endsWith("vr2"))
                {
                    if(getEnergyPastArmor(0.35F, shot) > 0.0F)
                    {
                        com.maddox.il2.objects.air.I_185.debugprintln(this, "*** VatorR Lock Damaged..");
                        nextDMGLevels(1, 2, "VatorR_D0", shot.initiator);
                    }
                } else
                if((s.endsWith("r1") || s.endsWith("r2")) && getEnergyPastArmor(0.35F, shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.I_185.debugprintln(this, "*** Rudder1 Lock Damaged..");
            ...
            if(s.startsWith("xxeng1"))
            {
                ...
                if(s.endsWith("base"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.I_185.debugprintln(this, "*** Engine Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.I_185.debugprintln(this, "*** Engine Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.I_185.debugprintln(this, "*** Engine Crank Case Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(6.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.I_185.debugprintln(this, "*** Engine Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.I_185.debugprintln(this, "*** Engine Cylinders Hit - Engine Fires..");
                        }
                    }
