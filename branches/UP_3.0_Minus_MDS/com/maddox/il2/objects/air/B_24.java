            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        ...
                        {
                            FM.AS.setEngineStuck(shot.initiator, l);
                    ...
                    {
                        FM.EI.engines[l].setCyliderKnockOut(shot.initiator, 1);
                    } else
                    {
                        FM.EI.engines[l].setReadyness(shot.initiator, FM.EI.engines[l].getReadyness() - 0.00082F);
                        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + l + ") Crank Case Hit - Readyness Reduced to " + FM.EI.engines[l].getReadyness() + "..");
                    }
                    getEnergyPastArmor(12F, shot);
                }
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[l].getCylindersRatio() * 0.75F)
                    {
                        FM.EI.engines[l].setCyliderKnockOut(shot.initiator, com.maddox.il2.ai.World.Rnd().nextInt(1, (int)(shot.power / 19000F)));
                        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + l + ") Cylinders Hit, " + FM.EI.engines[l].getCylindersOperable() + "/" + FM.EI.engines[l].getCylinders() + " Left..");
                ...
                {
                    FM.AS.setOilState(shot.initiator, l, 1);
            ...
            if(s.startsWith("xxtank"))
            {
                ...
                if(getEnergyPastArmor(0.06F, shot) > 0.0F)
                {
                    ...
                    if(shot.powerType == 3)
                    {
                        ...
                        {
                            if(FM.AS.astateTankStates[j1] < 4 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.21F)
                                FM.AS.hitTank(shot.initiator, j1, 1);
                        } else
                        {
                            FM.AS.hitTank(shot.initiator, j1, com.maddox.il2.ai.World.Rnd().nextInt(1, 1 + (int)(shot.power / 16100F)));
                        }
                    } else
                    if(shot.power > 16100F)
                        FM.AS.hitTank(shot.initiator, j1, com.maddox.il2.ai.World.Rnd().nextInt(1, 1 + (int)(shot.power / 16100F)));
