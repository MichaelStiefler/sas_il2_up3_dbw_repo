...
// Source File Name:   CockpitAR_234B2.java
...
//            CockpitPilot, AR_234B2, AircraftLH, Aircraft

public class CockpitAR_234B2 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("zAltWheel", 0.0F, cvt(((com.maddox.il2.objects.air.AR_234B2)aircraft()).fSightCurAltitude, 0.0F, 6000F, 0.0F, 225F), 0.0F);
        mesh.chunkSetAngles("zAnglePointer", 0.0F, cvt(((com.maddox.il2.objects.air.AR_234B2)aircraft()).fSightCurForwardAngle, 0.0F, 60F, 105F, 0.0F), 0.0F);
        mesh.chunkSetAngles("zAngleWheel", 0.0F, -10F * ((com.maddox.il2.objects.air.AR_234B2)aircraft()).fSightCurForwardAngle, 0.0F);
        mesh.chunkSetAngles("zSpeedPointer", 0.0F, cvt(((com.maddox.il2.objects.air.AR_234B2)aircraft()).fSightCurSpeed, 150F, 600F, 0.0F, 60F), 0.0F);
        mesh.chunkSetAngles("zSpeedWheel", 0.0F, 0.333F * ((com.maddox.il2.objects.air.AR_234B2)aircraft()).fSightCurSpeed, 0.0F);
        resetYPRmodifier();
        xyz[1] = cvt(fm.CT.getRudder(), -1F, 1.0F, -0.03F, 0.03F);
        ...
        if(cockpitLightControl)
            xyz[2] = 0.00365F;
        mesh.chunkSetLocate("Z_lightSW", xyz, ypr);
        xyz[2] = fm.CT.saveWeaponControl[0] ? 0.0059F : 0.0F;
        mesh.chunkSetLocate("r_one", xyz, ypr);
        xyz[2] = fm.CT.saveWeaponControl[3] ? 0.0059F : 0.0F;
        mesh.chunkSetLocate("r_two", xyz, ypr);
        resetYPRmodifier();
        xyz[1] = cvt(-fm.CT.trimElevator, -0.5F, 0.5F, -0.0475F, 0.0475F);
        mesh.chunkSetLocate("Need_ETrim", xyz, ypr);
        resetYPRmodifier();
        xyz[0] = cvt(-fm.CT.trimRudder, -0.5F, 0.5F, -0.029F, 0.029F);
        mesh.chunkSetLocate("Need_RTrim", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.Or.getTangage(), -45F, 45F, 0.025F, -0.025F);
        mesh.chunkSetLocate("zHorizon1a", xyz, ypr);
