...
public class CockpitJU_88A4torp_BGunner extends CockpitGunner
{
  ...
  public CockpitJU_88A4torp_BGunner()
  {
  ...
  static
  {
    ...
    Property.set(CockpitJU_88A4torp_BGunner.class, "normZN", 0.2F);
    Property.set(CockpitJU_88A4torp_BGunner.class, "gsZN", 0.2F);
  }
  ...
  private class Variables
  {
    ...
    private final CockpitJU_88A4torp_BGunner this$0;
    ...
    Variables(CockpitJU_88A4torp_BGunner.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitJU_88A4torp_BGunner.this.fm != null)
      {
        CockpitJU_88A4torp_BGunner.access$002(CockpitJU_88A4torp_BGunner.this, CockpitJU_88A4torp_BGunner.this.setOld);
        CockpitJU_88A4torp_BGunner.access$102(CockpitJU_88A4torp_BGunner.this, CockpitJU_88A4torp_BGunner.this.setNew);
        CockpitJU_88A4torp_BGunner.access$202(CockpitJU_88A4torp_BGunner.this, CockpitJU_88A4torp_BGunner.this.setTmp);
        CockpitJU_88A4torp_BGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A4torp_BGunner.this.setOld.throttle1 + CockpitJU_88A4torp_BGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4torp_BGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A4torp_BGunner.this.setOld.prop1 + CockpitJU_88A4torp_BGunner.this.fm.EI.engines[0].getControlProp() * 0.15F);
        CockpitJU_88A4torp_BGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A4torp_BGunner.this.setOld.throttle2 + CockpitJU_88A4torp_BGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4torp_BGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A4torp_BGunner.this.setOld.prop2 + CockpitJU_88A4torp_BGunner.this.fm.EI.engines[1].getControlProp() * 0.15F);
        CockpitJU_88A4torp_BGunner.this.setNew.altimeter = CockpitJU_88A4torp_BGunner.this.fm.getAltitude();
        float f1 = CockpitJU_88A4torp_BGunner.this.waypointAzimuth();
        if (CockpitJU_88A4torp_BGunner.this.useRealisticNavigationInstruments())
        {
          CockpitJU_88A4torp_BGunner.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4torp_BGunner.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4torp_BGunner.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A4torp_BGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A4torp_BGunner.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A4torp_BGunner.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
          CockpitJU_88A4torp_BGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4torp_BGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A4torp_BGunner.this.setOld.azimuth.getDeg(1.0F));
        }
        CockpitJU_88A4torp_BGunner.this.setNew.azimuth.setDeg(CockpitJU_88A4torp_BGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4torp_BGunner.this.fm.Or.azimut());

        CockpitJU_88A4torp_BGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A4torp_BGunner.this.setOld.vspeed + CockpitJU_88A4torp_BGunner.this.fm.getVertSpeed()) / 200.0F);
        if (CockpitJU_88A4torp_BGunner.this.cockpitDimControl)
        {
          if (CockpitJU_88A4torp_BGunner.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A4torp_BGunner.this.setNew.dimPosition -= 0.05F;
        }
        else if (CockpitJU_88A4torp_BGunner.this.setNew.dimPosition < 1.0F)
          CockpitJU_88A4torp_BGunner.this.setNew.dimPosition += 0.05F;
        float f2 = CockpitJU_88A4torp_BGunner.this.prevFuel - CockpitJU_88A4torp_BGunner.this.fm.M.fuel;
        CockpitJU_88A4torp_BGunner.access$302(CockpitJU_88A4torp_BGunner.this, CockpitJU_88A4torp_BGunner.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A4torp_BGunner.this.setNew.cons = (0.91F * CockpitJU_88A4torp_BGunner.this.setOld.cons + 0.09F * f2);
      }
