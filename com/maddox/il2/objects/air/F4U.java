  ...
  implements TypeFighter, TypeDiveBomber
{
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat, FlightModel paramFlightModel)
  {
    ...
    if (paramFlightModel != null)
      paramFloat = 10.0F * Math.max(paramFloat, paramFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getAirBrake());
    else {
      paramFloat = f3;
    }
    ...
    if (bGearExtending)
    {
      paramHierMesh.chunkSetAngles("GearL9_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 3.0F, 0.0F, 95.0F), 0.0F);
      paramHierMesh.chunkSetAngles("GearL10_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 3.0F, 0.0F, 60.0F), 0.0F);
      paramHierMesh.chunkSetAngles("GearR9_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 3.0F, 0.0F, 95.0F), 0.0F);
      paramHierMesh.chunkSetAngles("GearR10_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 3.0F, 0.0F, 60.0F), 0.0F);

      if (paramFlightModel == null) {
        f1 = Aircraft.cvt(f3, 0.0F, 1.0F, 0.0F, 0.7071068F);
        f1 = 2.0F * f1 * f1;
        paramHierMesh.chunkSetAngles("GearC2_D0", 0.0F, 41.0F * f1, 0.0F);
        paramHierMesh.chunkSetAngles("Hook1_D0", 0.0F, Aircraft.cvt(f1, 0.0F, 1.0F, 0.0F, -64.5F), 0.0F);
        f1 = Aircraft.cvt(f3, 0.0F, 0.25F, 0.0F, 1.0F);
        paramHierMesh.chunkSetAngles("GearC4_D0", 0.0F, 140.0F * f1, 0.0F);
        paramHierMesh.chunkSetAngles("GearC5_D0", 0.0F, 140.0F * f1, 0.0F);
      }
      float f2;
      if (paramFloat < 4.0F) {
        f1 = f2 = Aircraft.cvt(paramFloat, 3.0F, 4.0F, 0.0F, 0.4F);
      } else {
        f1 = Aircraft.cvt(paramFloat, 4.0F, 8.0F, 0.75F, 2.0F);
        f1 = (float)Math.sqrt(f1);
        f1 = Aircraft.cvt(f1, (float)Math.sqrt(0.75D), (float)Math.sqrt(2.0D), 0.4F, 1.0F);
        f2 = Aircraft.cvt(paramFloat, 4.0F, 8.5F, 0.75F, 2.0F);
        f2 = (float)Math.sqrt(f2);
        f2 = Aircraft.cvt(f2, (float)Math.sqrt(0.75D), (float)Math.sqrt(2.0D), 0.4F, 1.0F);
      }
    ...
    {
      if (paramFlightModel == null) {
        f1 = Aircraft.cvt(f3, 8.5F, 10.0F, 0.0F, 1.0F);
        paramHierMesh.chunkSetAngles("GearC2_D0", 0.0F, 41.0F * f1, 0.0F);
        f1 = Aircraft.cvt(f3, 8.5F, 8.75F, 0.0F, 1.0F);
        paramHierMesh.chunkSetAngles("GearC4_D0", 0.0F, 140.0F * f1, 0.0F);
        paramHierMesh.chunkSetAngles("GearC5_D0", 0.0F, 140.0F * f1, 0.0F);
        paramHierMesh.chunkSetAngles("Hook1_D0", 0.0F, Aircraft.cvt(f3, 8.5F, 10.0F, 0.0F, -64.5F), 0.0F);
      }

      if (paramFloat > 7.5F)
        f1 = Aircraft.cvt(paramFloat, 7.5F, 8.5F, 0.9F, 1.0F);
      else {
        f1 = Aircraft.cvt(paramFloat, 3.0F, 7.5F, 0.0F, 0.9F);
      }
      paramHierMesh.chunkSetAngles("GearL2_D0", 0.0F, 81.0F * f1, 0.0F);
      paramHierMesh.chunkSetAngles("GearL3_D0", 0.0F, 84.0F * f1, 0.0F);
      paramHierMesh.chunkSetAngles("GearL8_D0", 0.0F, 83.0F * f1, 0.0F);
      ...
      paramHierMesh.chunkSetAngles("GearL9_D0", 0.0F, Aircraft.cvt(paramFloat, 1.5F, 3.7F, 0.0F, 95.0F), 0.0F);
      paramHierMesh.chunkSetAngles("GearL10_D0", 0.0F, Aircraft.cvt(paramFloat, 1.5F, 3.7F, 0.0F, 60.0F), 0.0F);
      paramHierMesh.chunkSetAngles("GearR9_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 3.7F, 0.0F, 95.0F), 0.0F);
      paramHierMesh.chunkSetAngles("GearR10_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 3.7F, 0.0F, 60.0F), 0.0F);
    }
  }
  ...
  protected void moveGear(float paramFloat) {
    ...
    moveGear(hierMesh(), paramFloat, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel);

    paramFloat *= 10.0F;
    if (bGearExtending) {
      float f = Aircraft.cvt(paramFloat, 0.0F, 1.0F, 0.0F, 0.7071068F);
      this.cGearPos = (2.0F * f * f);
    }
    else
    {
      this.cGearPos = Aircraft.cvt(paramFloat, 8.5F, 10.0F, 0.0F, 1.0F);
    }
  }
  ...
  public void moveWheelSink() {
    resetYPRmodifier();
    Aircraft.xyz[1] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.231F, 0.0F, 0.231F);
    hierMesh().chunkSetLocate("GearL7_D0", Aircraft.xyz, Aircraft.ypr);
    Aircraft.xyz[1] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.231F, 0.0F, -0.231F);
  ...
  protected void moveWingFold(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    if (bGearExtending) {
      if (paramFloat < 1.5F) {
        paramHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 1.5F, 0.0F, 2.6F), 0.0F);
        paramHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 1.5F, 0.0F, 2.6F), 0.0F);
      } else if (paramFloat < 2.5F) {
        paramHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, Aircraft.cvt(paramFloat, 1.5F, 2.5F, 2.6F, 5.1F), 0.0F);
        paramHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, Aircraft.cvt(paramFloat, 1.5F, 2.5F, 2.6F, 5.1F), 0.0F);
      } else {
        paramHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, Aircraft.cvt(paramFloat, 2.5F, 17.9F, 5.1F, 105.0F), 0.0F);
        paramHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, Aircraft.cvt(paramFloat, 2.5F, 16.0F, 5.1F, 105.0F), 0.0F);
      }
    }
    else if (paramFloat < 9.0F) {
      if (paramFloat < 6.8F)
        paramHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 6.8F, 0.0F, 45.0F), 0.0F);
      else {
        paramHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, Aircraft.cvt(paramFloat, 6.8F, 9.0F, 45.0F, 50.0F), 0.0F);
      }
      if (paramFloat < 7.5F)
        paramHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, Aircraft.cvt(paramFloat, 0.75F, 7.5F, 0.0F, 45.0F), 0.0F);
      else
        paramHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, Aircraft.cvt(paramFloat, 7.5F, 9.0F, 45.0F, 50.0F), 0.0F);
    }
    else if (paramFloat < 11.0F) {
      paramHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, Aircraft.cvt(paramFloat, 9.0F, 11.0F, 50.0F, 60.0F), 0.0F);
      paramHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, Aircraft.cvt(paramFloat, 9.0F, 11.0F, 50.0F, 60.0F), 0.0F);
    } else {
      paramHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, Aircraft.cvt(paramFloat, 11.0F, 15.75F, 60.0F, 105.0F), 0.0F);
      paramHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, Aircraft.cvt(paramFloat, 11.0F, 15.75F, 60.0F, 105.0F), 0.0F);
    }
  }
  ...
  public void update(float paramFloat)
  {
    ...
    if (this.bNeedSetup) {
      this.cGear = this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl;
      this.bNeedSetup = false;
    }

    this.cGear = filter(paramFloat, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl, this.cGear, 999.90002F, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.dvGear);
    ...
    if (bGearExtending2) {
      f1 = Aircraft.cvt(f2, 0.0F, 1.0F, 0.0F, 0.7071068F);
      this.cGearPos = (2.0F * f1 * f1);

      hierMesh().chunkSetAngles("GearC2_D0", 0.0F, 41.0F * this.cGearPos, 0.0F);

      f1 = Aircraft.cvt(f2, 0.0F, 0.25F, 0.0F, 1.0F);
      hierMesh().chunkSetAngles("GearC4_D0", 0.0F, 140.0F * f1, 0.0F);
      hierMesh().chunkSetAngles("GearC5_D0", 0.0F, 140.0F * f1, 0.0F);
    }
    else
    {
      this.cGearPos = Aircraft.cvt(f2, 8.5F, 10.0F, 0.0F, 1.0F);

      hierMesh().chunkSetAngles("GearC2_D0", 0.0F, 41.0F * this.cGearPos, 0.0F);
      f1 = Aircraft.cvt(f2, 8.5F, 8.75F, 0.0F, 1.0F);
      hierMesh().chunkSetAngles("GearC4_D0", 0.0F, 140.0F * f1, 0.0F);
      hierMesh().chunkSetAngles("GearC5_D0", 0.0F, 140.0F * f1, 0.0F);
    }

    if (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.arrestorVAngle != 0.0F) {
      f1 = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.arrestorVAngle, -43.0F, 21.5F, 0.0F, -64.5F);
      ...
      if (this.arrestorVel >= -0.1F) {
        if (Engine.cur.land.isWater(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.jdField_x_of_type_Double, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y))
          f1 = 0.0F;
        else {
          f1 = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.getSpeedKMH(), 0.0F, 250.0F, 0.0F, 0.75F);
        }
        f1 = -47.5F * World.Rnd().nextFloat(1.0F - f1, 1.0F + f1 + f1) * this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.arrestorVSink;
      }
      else {
        f1 = 0.0F;
      }
      ...
      if (this.arrestorPos > -64.5F * this.cGearPos * (1.0F - this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getArrestor()))
      {
        this.arrestorPos = (-64.5F * this.cGearPos * (1.0F - this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getArrestor()));
    ...
    float f1 = Math.min(0.98F, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getAirBrake());
    f1 = Math.max(f1, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear());
    this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.setGear(f1);

    f1 = this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlRadiator();
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxarmor")) {
        ...
        if (paramString.endsWith("f1")) {
          getEnergyPastArmor(World.Rnd().nextFloat(8.0F, 12.0F) / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
    ...
    if ((paramString.startsWith("xcf")) || (paramString.startsWith("xblister"))) {
      ...
      if (paramString.startsWith("xcf2")) {
        if ((paramPoint3d.jdField_x_of_type_Double > -2.313D) && (paramPoint3d.jdField_x_of_type_Double < -1.455D) && (paramPoint3d.jdField_z_of_type_Double > 0.669D)) {
        ...
        if (paramPoint3d.jdField_z_of_type_Double > 1.125D) {
      ...
      else if ((paramPoint3d.jdField_x_of_type_Double > -1.489D) && (paramPoint3d.jdField_x_of_type_Double < -1.2D) && (paramPoint3d.jdField_z_of_type_Double > 0.34D)) {
