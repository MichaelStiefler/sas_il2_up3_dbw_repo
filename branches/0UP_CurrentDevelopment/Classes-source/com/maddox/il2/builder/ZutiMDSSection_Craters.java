...
public class ZutiMDSSection_Craters extends GWindowFramed
{
	...
	public void loadVariables(SectFile sectfile)
	{
		try
		{
			zutiCraters_Bombs250_Visibility = sectfile.get(SECTION_ID, "ZutiCraters_Bombs250_Visibility", 80, 1, 99999);
			zutiCraters_Bombs500_Visibility = sectfile.get(SECTION_ID, "ZutiCraters_Bombs500_Visibility", 80, 1, 99999);
			zutiCraters_Bombs1000_Visibility = sectfile.get(SECTION_ID, "ZutiCraters_Bombs1000_Visibility", 80, 1, 99999);
			zutiCraters_Bombs2000_Visibility = sectfile.get(SECTION_ID, "ZutiCraters_Bombs2000_Visibility", 80, 1, 99999);
			zutiCraters_Bombs5000_Visibility = sectfile.get(SECTION_ID, "ZutiCraters_Bombs5000_Visibility", 450, 1, 99999);
			zutiCraters_Bombs9999_Visibility = sectfile.get(SECTION_ID, "ZutiCraters_Bombs9999_Visibility", 900, 1, 99999);
			...
			System.out.println("Visibility: " + zutiCraters_Bombs250_Visibility);
	...
	public void saveVariables(SectFile sectfile)
	{
		try
		{
			...
			sectfile.lineAdd(sectionIndex, "ZutiCraters_Bombs250_Visibility", new Integer(zutiCraters_Bombs250_Visibility).toString());
			sectfile.lineAdd(sectionIndex, "ZutiCraters_Bombs500_Visibility", new Integer(zutiCraters_Bombs500_Visibility).toString());
			sectfile.lineAdd(sectionIndex, "ZutiCraters_Bombs1000_Visibility", new Integer(zutiCraters_Bombs1000_Visibility).toString());
			sectfile.lineAdd(sectionIndex, "ZutiCraters_Bombs2000_Visibility", new Integer(zutiCraters_Bombs2000_Visibility).toString());
			sectfile.lineAdd(sectionIndex, "ZutiCraters_Bombs5000_Visibility", new Integer(zutiCraters_Bombs5000_Visibility).toString());
			sectfile.lineAdd(sectionIndex, "ZutiCraters_Bombs9999_Visibility", new Integer(zutiCraters_Bombs9999_Visibility).toString());
