...
public class CockpitP_51D30K14 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    int i = ((P_51D30NA)aircraft()).k14Mode;
    boolean bool = i < 2;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_51D30K14.this.fm != null) {
        CockpitP_51D30K14.access$102(CockpitP_51D30K14.this, CockpitP_51D30K14.this.setOld);
        CockpitP_51D30K14.access$202(CockpitP_51D30K14.this, CockpitP_51D30K14.this.setNew);
        CockpitP_51D30K14.access$302(CockpitP_51D30K14.this, CockpitP_51D30K14.this.setTmp);
        ...
        CockpitP_51D30K14.this.setNew.azimuth = ((35.0F * CockpitP_51D30K14.this.setOld.azimuth + -CockpitP_51D30K14.this.fm.Or.getYaw()) / 36.0F);

        if ((CockpitP_51D30K14.this.setOld.azimuth > 270.0F) && (CockpitP_51D30K14.this.setNew.azimuth < 90.0F))
          CockpitP_51D30K14.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_51D30K14.this.setOld.azimuth < 90.0F) && (CockpitP_51D30K14.this.setNew.azimuth > 270.0F))
          CockpitP_51D30K14.this.setOld.azimuth += 360.0F;
        CockpitP_51D30K14.this.setNew.waypointAzimuth = ((10.0F * CockpitP_51D30K14.this.setOld.waypointAzimuth + CockpitP_51D30K14.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

        CockpitP_51D30K14.this.setNew.vspeed = ((199.0F * CockpitP_51D30K14.this.setOld.vspeed + CockpitP_51D30K14.this.fm.getVertSpeed()) / 200.0F);

        float f1 = ((P_51D30NA)CockpitP_51D30K14.this.aircraft()).k14Distance;

        CockpitP_51D30K14.this.setNew.k14w = (5.0F * CockpitP_51D30K14.k14TargetWingspanScale[((P_51D30NA)CockpitP_51D30K14.this.aircraft()).k14WingspanType] / f1);
        ...
        Vector3d localVector3d = CockpitP_51D30K14.this.aircraft().FM.getW();

        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitP_51D30K14.this.floatindex((f1 - 200.0F) * 0.04F, CockpitP_51D30K14.k14BulletDrop) - CockpitP_51D30K14.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitP_51D30K14.this.setNew.k14x = (0.92F * CockpitP_51D30K14.this.setOld.k14x + 0.08F * f2);
        CockpitP_51D30K14.this.setNew.k14y = (0.92F * CockpitP_51D30K14.this.setOld.k14y + 0.08F * f3);
        if (CockpitP_51D30K14.this.setNew.k14x > 7.0F)
          CockpitP_51D30K14.this.setNew.k14x = 7.0F;
        if (CockpitP_51D30K14.this.setNew.k14x < -7.0F)
          CockpitP_51D30K14.this.setNew.k14x = -7.0F;
        if (CockpitP_51D30K14.this.setNew.k14y > 7.0F)
          CockpitP_51D30K14.this.setNew.k14y = 7.0F;
        if (CockpitP_51D30K14.this.setNew.k14y < -7.0F)
          CockpitP_51D30K14.this.setNew.k14y = -7.0F;
      }
      return true;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitP_51D30K14 this$0;
    ...
    Variables(CockpitP_51D30K14.1 arg2)
    {
      this();
    }
  }
