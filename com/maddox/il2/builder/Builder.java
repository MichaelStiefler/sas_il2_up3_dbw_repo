...
//            ActorBorn, Pathes, CursorMesh, PlMapLoad, 
//            BldConfig, WSelect, WViewLand, WSnap, 
//            PlMission, PlMisRocket
...
public class Builder
{
    ...
    public void align(com.maddox.il2.engine.Actor actor)
    {
        ...
        {
            ((com.maddox.il2.objects.ActorAlign)actor).align();
        } else
        {
    ...
    public int countSelectedActors()
    {
        ...
        {
            return com.maddox.il2.engine.Actor.isValid(selectedActor) ? 1 : 0;
        }
    }
    ...
    public com.maddox.il2.engine.Actor[] selectedActors()
    {
        if(bMultiSelect)
        {
            ...
            com.maddox.il2.engine.Actor aactor1[] = _selectedActors(i <= 0 ? 1 : i);
            int j = 0;
            if(com.maddox.il2.engine.Actor.isValid(selectedActor))
                aactor1[j++] = selectedActor;
        ...
        com.maddox.il2.engine.Actor aactor[] = _selectedActors(1);
        if(com.maddox.il2.engine.Actor.isValid(selectedActor))
        {
            aactor[0] = selectedActor;
            if(aactor.length > 1)
                aactor[1] = null;
        } else
        {
            ...
            } else
            {
                ...
                try
                {
                    if(movedActor instanceof com.maddox.il2.builder.PPoint)
                    {
                        ...
                        ((com.maddox.il2.builder.Path)ppoint.getOwner()).pointMoved(ppoint);
                        com.maddox.il2.builder.PlMission.setChanged();
                    } else
                    ...
                    if(bMultiSelect && selectedActors.containsKey(movedActor))
                    {
                        com.maddox.il2.engine.Actor aactor[] = selectedActors();
                        for(int k = 0; k < aactor.length; k++)
                        {
                            ...
                            if(com.maddox.il2.engine.Actor.isValid(actor1) && actor1 != movedActor)
                            {
                                if(actor1 instanceof com.maddox.il2.objects.ActorAlign)
                                {
                                    ...
                                    ((com.maddox.il2.objects.ActorAlign)actor1).align();
                                } else
                                {
                                    actor1.pos.getAbs(__pi);
                                    __pi.x += d2;
    ...
    private void drawGrid3D()
    {
        ...
        for(int j1 = 0; j1 <= i1; j1++)
        {
            ...
            for(int l1 = 0; l1 <= l; l1++)
            {
                ...
                float f3 = com.maddox.il2.engine.Landscape.HQ(f2 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsX(), f - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsY());
                ...
                if(!flag)
                {
                    project2d(f2 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsX(), f - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsY(), f3, projectPos2d);
        ...
        for(int k1 = 0; k1 <= l; k1++)
        {
            ...
            for(int i2 = 0; i2 <= i1; i2++)
            {
                float f4 = (i2 + k) * i;
                com.maddox.il2.engine.Engine.land();
                float f5 = com.maddox.il2.engine.Landscape.HQ(f1 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsX(), f4 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsY());
                lineNXYZ[lineNCounter * 3 + 0] = f1 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsX();
                lineNXYZ[lineNCounter * 3 + 1] = f4 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsY();
                lineNXYZ[lineNCounter * 3 + 2] = f5;
                lineNCounter++;
                if(!flag1)
                {
                    project2d(f1 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsX(), f4 - (float)com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsY(), f5, projectPos2d);
    ...
    private void drawInfoOverActor()
    {
        ...
        float f3 = smallFont.height();
        float f4 = (float)i * (f3 + f1) + f1;
        ...
        for(int l = 0; l < as.length; l++)
        {
            ...
            if(s1 == null)
                break;
            smallFont.output(0xff000000 | ~k, (float)(projectPos2d.x + (double)f1), (float)(projectPos2d.y + (double)(conf.iconSize / 2) + (double)f1 + (double)((float)(i - l - 1) * (f1 + f3)) + (double)f1), 0.0F, s1);
        }
    ...
    private void initHotKeys()
    {
        ...
        {
            com.maddox.rts.HotKeyCmdEnv.addCmd(new com.maddox.rts.HotKeyCmd(true, "beginSelectTarget") {
...
;
    ...
    private void stepAzimut(int i)
    {
        ...
        if(bMultiSelect && !isFreeView() && countSelectedActors() > 0)
        {
            com.maddox.JGP.Point3d point3d = posScreenToLand(mousePosX, mousePosY, 0.0D, 0.10000000000000001D);
    ...
    public void leave()
    {
        ...
        if(bMultiSelect && wSnap.isVisible())
            wSnap.hideWindow();
    ...
    public Builder(com.maddox.gwindow.GWindowRootMenu gwindowrootmenu, java.lang.String s)
    {
        ...
        envName = s;
        ((com.maddox.il2.engine.GUIWindowManager)gwindowrootmenu.manager).setUseGMeshs(true);
        ...
        mFile.subMenu = (com.maddox.gwindow.GWindowMenu)mFile.create(new GWindowMenu());
        ...
        mEdit.subMenu = (com.maddox.gwindow.GWindowMenu)mEdit.create(new GWindowMenu());
        mEdit.subMenu.close(false);
        if(bMultiSelect)
        {
            mEdit.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mEdit.subMenu, "&Select All", null) {
            ...
            mEdit.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mEdit.subMenu, "&Unselect All", null) {
            ...
            com.maddox.gwindow.GWindowMenuItem gwindowmenuitem = mEdit.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mEdit.subMenu, "&Enable Select", null) {
        ...
        {
            mEdit.subMenu.addItem("-", null);
            com.maddox.gwindow.GWindowMenuItem gwindowmenuitem1 = mEdit.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mEdit.subMenu, "&Rotate Objects", null) {
        ...
        if(bMultiSelect)
            mSnap = mView.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mView.subMenu, "&Snap", null) {
        ...
        mDisplayFilter.subMenu = (com.maddox.gwindow.GWindowMenu)mDisplayFilter.create(new GWindowMenu());
        mDisplayFilter.subMenu.close(false);
        mView.subMenu.addItem("-", null);
        com.maddox.gwindow.GWindowMenuItem gwindowmenuitem2 = mView.subMenu.addItem(new GWindowMenuItem(mView.subMenu, com.maddox.il2.builder.Plugin.i18n("&IconSize"), com.maddox.il2.builder.Plugin.i18n("TIPIconSize")));
        gwindowmenuitem2.subMenu = (com.maddox.gwindow.GWindowMenu)gwindowmenuitem2.create(new GWindowMenu());
        gwindowmenuitem2.subMenu.close(false);
        mIcon8 = gwindowmenuitem2.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(gwindowmenuitem2.subMenu, "&8", null) {
        ...
        mIcon16 = gwindowmenuitem2.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(gwindowmenuitem2.subMenu, "&16", null) {
        ...
        mIcon32 = gwindowmenuitem2.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(gwindowmenuitem2.subMenu, "&32", null) {
        ...
        mIcon64 = gwindowmenuitem2.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(gwindowmenuitem2.subMenu, "&64", null) {
        ...
        com.maddox.il2.engine.IconDraw.setScrSize(conf.iconSize, conf.iconSize);
        gwindowmenuitem2 = mView.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mView.subMenu, com.maddox.il2.builder.Plugin.i18n("Save&ViewHLand"), com.maddox.il2.builder.Plugin.i18n("TIPSaveViewHLand")) {
        ...
        gwindowmenuitem2.bChecked = conf.bSaveViewHLand;
        gwindowmenuitem2 = mView.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mView.subMenu, com.maddox.il2.builder.Plugin.i18n("Show&Grid"), com.maddox.il2.builder.Plugin.i18n("TIPShowGrid")) {
        ...
        gwindowmenuitem2.bChecked = conf.bShowGrid;
        gwindowmenuitem2 = mView.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(mView.subMenu, com.maddox.il2.builder.Plugin.i18n("&AnimateCamera"), com.maddox.il2.builder.Plugin.i18n("TIPAnimateCamera")) {
        ...
        gwindowmenuitem2.bChecked = conf.bAnimateCamera;
