...
public class AircraftHotKeys
{
    ...
    private void setRadiatorControl(float f)
    {
        ...
        if(FM.CT.getRadiatorControlAuto())
        {
            ...
            if(com.maddox.il2.ai.World.cur().diffCur.ComplexEManagement)
            {
                ...
                com.maddox.il2.game.HUD.log(hudLogPowerId, "Radiator {0}%", new java.lang.Object[] {
                    new Integer(java.lang.Math.round(FM.CT.getRadiatorControl() * 100F))
                });
            } else
            {
    ...
    private void doCmdPilot(int i, boolean flag)
    {
        ...
        case 19: // '\023'
            ...
            hudWeapon(flag, 3);
            if((aircraft instanceof com.maddox.il2.objects.air.TypeHasToKG) && FM.CT.Weapons[3] != null && (FM.CT.Weapons[3][0] instanceof com.maddox.il2.objects.weapons.TorpedoGun) && FM.CT.Weapons[3][0].haveBullets())
            {
...
;
    ...
    private com.maddox.il2.engine.Actor nextViewActor(boolean flag)
    {
        ...
        int j = 0;
        for(java.lang.String s = actor.name(); namedAll[j] != null && !s.equals(namedAll[j]); j++);
        if(namedAll[j] == null)
            return com.maddox.il2.game.Selector.setCurRecordArg0(null);
        j++;
