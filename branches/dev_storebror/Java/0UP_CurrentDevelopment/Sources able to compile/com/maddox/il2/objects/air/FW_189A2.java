    ...
    implements TypeScout, TypeBomber
{
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        if(shot.chunkName.startsWith("WingLIn"))
        {
            ...
            if(Aircraft.v1.x < 0.25D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F && com.maddox.il2.ai.World.Rnd().nextFloat(0.01F, 0.121F) < shot.mass)
        ...
        {
            if(Aircraft.v1.x > -0.5D || (double)shot.power * -Aircraft.v1.x > 12800D)
            {
    ...
    static 
    {
        java.lang.Class class1 = FW_189A2.class;
        ...
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            CockpitFw189.class, CockpitFw189_RGunner.class
        });
