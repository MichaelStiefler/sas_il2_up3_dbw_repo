...
public class AirGroup
{
    ...
    {
        com.maddox.il2.ai.air.Maneuver maneuver;
        if(i > nOfAirc - 1)
            return;
        if(i < 0)
            return;
        maneuver = (com.maddox.il2.ai.air.Maneuver)airc[i].FM;
        grTask;
        JVM INSTR tableswitch 1 6: default 2726
    //                   1 72
    //                   2 2397
    //                   3 1961
    //                   4 447
...
_L2:
        ...
        j = 0;
_L19:
        com.maddox.il2.ai.air.Maneuver maneuver3;
        if(j >= nOfAirc)
            break; /* Loop/switch isn't completed */
        maneuver3 = (com.maddox.il2.ai.air.Maneuver)airc[j].FM;
        if(!(airc[j] instanceof com.maddox.il2.objects.air.TypeGlider)) goto _L9; else goto _L8
_L8:
        maneuver3.accurate_set_FOLLOW();
          goto _L10
_L9:
        tmpV.add(maneuver3.Offset);
        if(maneuver3.isBusy() && (!(maneuver3 instanceof com.maddox.il2.fm.RealFlightModel) || !((com.maddox.il2.fm.RealFlightModel)maneuver3).isRealMode() || !maneuver3.isOk())) goto _L10; else goto _L11
_L11:
        int k;
        ...
        k = j + 1;
_L17:
        com.maddox.il2.ai.air.Maneuver maneuver1;
        if(k >= nOfAirc)
            break; /* Loop/switch isn't completed */
        maneuver1 = (com.maddox.il2.ai.air.Maneuver)airc[k].FM;
        tmpV.add(maneuver1.Offset);
        if(maneuver1.isBusy()) goto _L13; else goto _L12
_L12:
        maneuver1.accurate_set_FOLLOW();
        if(!(airc[k] instanceof com.maddox.il2.objects.air.TypeGlider)) goto _L15; else goto _L14
_L15:
        if(obj4 == null)
        {
...
_L5:
        ...
        if((maneuver.target_ground instanceof com.maddox.il2.ai.ground.Prey) && (((com.maddox.il2.ai.ground.Prey)maneuver.target_ground).HitbyMask() & 1) == 0)
        {
            ...
            for(int i1 = 0; i1 < 4; i1++)
            {
                if(maneuver.CT.Weapons[i1] == null)
                    continue;
                for(int i2 = 0; i2 < maneuver.CT.Weapons[i1].length; i2++)
                    if(maneuver.CT.Weapons[i1][i2] != null && maneuver.CT.Weapons[i1][i2].countBullets() != 0 && maneuver.CT.Weapons[i1][i2].bulletMassa() > f)
                        f = maneuver.CT.Weapons[i1][i2].bulletMassa();
        ...
        if(maneuver.CT.Weapons[3] != null)
        {
            ...
            {
                if(maneuver.CT.Weapons[3][l] == null || (maneuver.CT.Weapons[3][l] instanceof com.maddox.il2.objects.weapons.BombGunNull) || maneuver.CT.Weapons[3][l].countBullets() == 0)
                    continue;
                if(maneuver.CT.Weapons[3][l] instanceof com.maddox.il2.objects.weapons.ParaTorpedoGun)
                {
                    maneuver.set_task(7);
                    maneuver.clear_stack();
                ...
                if(maneuver.CT.Weapons[3][l] instanceof com.maddox.il2.objects.weapons.TorpedoGun)
                    if(maneuver.target_ground instanceof com.maddox.il2.ai.ground.TgtShip)
                    {
                        maneuver.set_task(7);
                        maneuver.clear_stack();
                        if(maneuver.target_ground instanceof com.maddox.il2.objects.ships.BigshipGeneric)
                        {
                            com.maddox.il2.objects.ships.BigshipGeneric bigshipgeneric = (com.maddox.il2.objects.ships.BigshipGeneric)maneuver.target_ground;
                            if((airc[i] instanceof com.maddox.il2.objects.air.TypeHasToKG) && !bigshipgeneric.zutiIsStatic() && airc[i].FM.Skill >= 2 && bigshipgeneric.collisionR() > 50F)
                            {
                ...
                if((airc[i] instanceof com.maddox.il2.objects.air.TypeGuidedBombCarrier) && (maneuver.CT.Weapons[3][l] instanceof com.maddox.il2.objects.weapons.RocketGunHS_293))
                {
                    maneuver.set_task(7);
                    maneuver.clear_stack();
                ...
                if((airc[i] instanceof com.maddox.il2.objects.air.TypeGuidedBombCarrier) && (maneuver.CT.Weapons[3][l] instanceof com.maddox.il2.objects.weapons.RocketGunFritzX))
                {
                    maneuver.set_task(7);
                    maneuver.clear_stack();
                ...
                if(maneuver.CT.Weapons[3][l] instanceof com.maddox.il2.objects.weapons.BombGunPara)
                {
                ...
                if(maneuver.CT.Weapons[3][l].bulletMassa() < 10F && !(maneuver.CT.Weapons[3][l] instanceof com.maddox.il2.objects.weapons.BombGunParafrag8))
                {
                    maneuver.set_task(7);
                    maneuver.clear_stack();
        ...
        if(airc[i] instanceof com.maddox.il2.objects.air.R_5xyz)
        {
            if(((com.maddox.il2.objects.air.R_5xyz)airc[i]).strafeWithGuns)
            {
                maneuver.set_task(7);
                maneuver.clear_stack();
                maneuver.set_maneuver(43);
...
_L3:
        ...
        do
        {
            if(l1 >= nOfAirc)
                break; /* Loop/switch isn't completed */
            com.maddox.il2.ai.air.Maneuver maneuver4 = (com.maddox.il2.ai.air.Maneuver)airc[l1].FM;
            tmpV.add(maneuver4.Offset);
            if(!maneuver4.isBusy() || l1 == nOfAirc - 1 || (maneuver4 instanceof com.maddox.il2.fm.RealFlightModel) && ((com.maddox.il2.fm.RealFlightModel)maneuver4).isRealMode())
            {
                ...
                do
                {
                    if(j2 >= nOfAirc)
                        break; /* Loop/switch isn't completed */
                    com.maddox.il2.ai.air.Maneuver maneuver2 = (com.maddox.il2.ai.air.Maneuver)airc[j2].FM;
...
_L1:
    ...
    public void update()
    {
        ...
        if(maneuver.AP.way.curr().isRadioSilence() || com.maddox.il2.game.Main.cur().mission.zutiMisc_DisableAIRadioChatter)
        {
...
label0:
            ...
            case 3: // '\003'
                ...
                if(grTask == 4)
                {
                    ...
                    if(!flag1 || flag6 || gTargDestroyed)
                    {
                        ...
                        if(flag6)
                        {
                            for(int j3 = 0; j3 < nOfAirc; j3++)
                                ((com.maddox.il2.ai.air.Maneuver)airc[j3].FM).gattackCounter = 0;
            ...
            case 2: // '\002'
                ...
                if(grTask == 4)
                {
                    ...
                    {
                        com.maddox.il2.ai.air.Maneuver maneuver5 = (com.maddox.il2.ai.air.Maneuver)airc[k3].FM;
                    ...
                    {
                        com.maddox.il2.ai.air.Maneuver maneuver6 = (com.maddox.il2.ai.air.Maneuver)airc[l3].FM;
                        maneuver6.push(57);
                        maneuver6.pop();
                    }
                    ...
                    for(int i4 = 0; i4 < nOfAirc; i4++)
                        ((com.maddox.il2.ai.air.Maneuver)airc[i4].FM).gattackCounter = 0;
                ...
                if(com.maddox.il2.ai.air.AirGroupList.length(enemies[0]) > 0)
                {
                    ...
                    {
                        int j4 = com.maddox.il2.ai.air.AirGroupList.length(enemies[0]);
                        int l4 = 0;
                        do
                        {
                            if(l4 >= j4)
                                break;
                            com.maddox.il2.ai.air.AirGroup airgroup1 = com.maddox.il2.ai.air.AirGroupList.getGroup(enemies[0], l4);
                    ...
                    if(!flag8 && (airc[0] instanceof com.maddox.il2.objects.air.TypeFighter))
                    {
                        for(int k4 = 0; k4 < nOfAirc; k4++)
                            if(((com.maddox.il2.ai.air.Maneuver)airc[k4].FM).canAttack())
                                flag8 = true;
