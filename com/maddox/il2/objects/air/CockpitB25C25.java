...
public class CockpitB25C25 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitB25C25 this$0;
    ...
    Variables(CockpitB25C25.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB25C25.this.fm != null) {
        CockpitB25C25.access$102(CockpitB25C25.this, CockpitB25C25.this.setOld);
        CockpitB25C25.access$202(CockpitB25C25.this, CockpitB25C25.this.setNew);
        CockpitB25C25.access$302(CockpitB25C25.this, CockpitB25C25.this.setTmp);
        ...
        CockpitB25C25.this.setNew.waypointAzimuth.setDeg(CockpitB25C25.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitB25C25.this.setNew.waypointDeviation.setDeg(CockpitB25C25.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB25C25.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitB25C25.this.setNew.vspeed = ((199.0F * CockpitB25C25.this.setOld.vspeed + CockpitB25C25.this.fm.getVertSpeed()) / 200.0F);
      }
