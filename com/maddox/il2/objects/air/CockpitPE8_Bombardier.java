...
public class CockpitPE8_Bombardier extends CockpitPilot
{
  ...
  public CockpitPE8_Bombardier() {
    super("3DO/Cockpit/Pe-2-Bombardier/BombardierPE8.him", "he111");
    try {
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((PE_8)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((PE_8)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE8_Bombardier.this.bEntered) {
        float f1 = ((PE_8)CockpitPE8_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((PE_8)CockpitPE8_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitPE8_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitPE8_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
