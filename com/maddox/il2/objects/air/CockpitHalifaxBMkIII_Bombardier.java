...
// Source File Name:   CockpitHalifaxBMkIII_Bombardier.java
...
//            CockpitPilot, HalifaxBMkIII

public class CockpitHalifaxBMkIII_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.HalifaxBMkIII)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.HalifaxBMkIII)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.HalifaxBMkIII)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.HalifaxBMkIII)aircraft()).fSightCurReadyness > 0.93F;
