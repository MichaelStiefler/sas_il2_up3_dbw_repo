...
// Source File Name:   CockpitTBM1_Bombardier.java
...
//            CockpitPilot, TBM1, Aircraft

public class CockpitTBM1_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.TBM1)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.TBM1)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            waypoint.getP(P1);
            V.sub(((com.maddox.JGP.Tuple3d) (P1)), ((com.maddox.JGP.Tuple3d) (fm.Loc)));
            float f1 = (float)(57.295779513082323D * java.lang.Math.atan2(V.x, V.y));
            mesh.chunkSetAngles("zCompass2", 0.0F, 90F + f1, 0.0F);
        }
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.TBM1)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.TBM1)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (((java.lang.Object) (com.maddox.il2.objects.air.CockpitTBM1_Bombardier.class)))), "astatePilotIndx", 0);
    }
