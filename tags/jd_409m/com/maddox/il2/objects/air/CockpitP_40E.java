...
public class CockpitP_40E extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_40E.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitP_40E.access$102(CockpitP_40E.this, CockpitP_40E.this.setOld); CockpitP_40E.access$202(CockpitP_40E.this, CockpitP_40E.this.setNew); CockpitP_40E.access$302(CockpitP_40E.this, CockpitP_40E.this.setTmp);

        CockpitP_40E.this.setNew.throttle = ((10.0F * CockpitP_40E.this.setOld.throttle + CockpitP_40E.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        CockpitP_40E.this.setNew.prop = ((8.0F * CockpitP_40E.this.setOld.prop + CockpitP_40E.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl()) / 9.0F);
        CockpitP_40E.this.setNew.altimeter = CockpitP_40E.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitP_40E.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 45.0F) {
          CockpitP_40E.this.setNew.azimuth = ((35.0F * CockpitP_40E.this.setOld.azimuth + -CockpitP_40E.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        if ((CockpitP_40E.this.setOld.azimuth > 270.0F) && (CockpitP_40E.this.setNew.azimuth < 90.0F)) CockpitP_40E.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_40E.this.setOld.azimuth < 90.0F) && (CockpitP_40E.this.setNew.azimuth > 270.0F)) CockpitP_40E.this.setOld.azimuth += 360.0F;
        CockpitP_40E.this.setNew.waypointAzimuth = ((10.0F * CockpitP_40E.this.setOld.waypointAzimuth + (CockpitP_40E.this.waypointAzimuth() - CockpitP_40E.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitP_40E.this.setNew.vspeed = ((199.0F * CockpitP_40E.this.setOld.vspeed + CockpitP_40E.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    private final CockpitP_40E this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitP_40E.1 arg2) { this();
    }
  }
}