...
public class CockpitJU_88C6 extends CockpitPilot
{
  ...
  {
    super("3DO/Cockpit/Ju-88A-4/C6hier.him", "he111");
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    resetYPRmodifier();
    float tmp279_278 = (0.85F * this.pictFlap + 0.00948F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.FlapsControl); this.pictFlap = tmp279_278; Cockpit.xyz[2] = tmp279_278;
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetLocate("zFlaps1", Cockpit.xyz, Cockpit.ypr);
    float tmp325_324 = (0.85F * this.pictGear + 0.007095F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl); this.pictGear = tmp325_324; Cockpit.xyz[2] = tmp325_324;
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("z_Object20", cvt(((JU_88C6)aircraft()).fSightCurSpeed, 400.0F, 800.0F, 87.0F, -63.5F), 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAlt3", ((JU_88C6)aircraft()).fDiveRecoveryAlt * 360.0F / 6000.0F, 0.0F, 0.0F);
  ...
  private class Variables
  {
    ...
    float cons;
    float alpha;
    private final CockpitJU_88C6 this$0;
    ...
    Variables(CockpitJU_88C6.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      JU_88C6 localJU_88C61 = (JU_88C6)CockpitJU_88C6.this.aircraft();
      if (JU_88C6.bChangedPit)
      {
        CockpitJU_88C6.this.reflectPlaneToModel();
        JU_88C6 localJU_88C62 = (JU_88C6)CockpitJU_88C6.this.aircraft();
        JU_88C6.bChangedPit = false;
      }
      if (CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitJU_88C6.access$002(CockpitJU_88C6.this, CockpitJU_88C6.this.setOld);
        CockpitJU_88C6.access$102(CockpitJU_88C6.this, CockpitJU_88C6.this.setNew);
        CockpitJU_88C6.access$202(CockpitJU_88C6.this, CockpitJU_88C6.this.setTmp);
        CockpitJU_88C6.this.setNew.throttle1 = (0.85F * CockpitJU_88C6.this.setOld.throttle1 + CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88C6.this.setNew.prop1 = (0.85F * CockpitJU_88C6.this.setOld.prop1 + CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitJU_88C6.this.setNew.throttle2 = (0.85F * CockpitJU_88C6.this.setOld.throttle2 + CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88C6.this.setNew.prop2 = (0.85F * CockpitJU_88C6.this.setOld.prop2 + CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitJU_88C6.this.setNew.altimeter = CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f1 = CockpitJU_88C6.this.waypointAzimuth();
        CockpitJU_88C6.this.setNew.waypointAzimuth.setDeg(CockpitJU_88C6.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88C6.this.setOld.azimuth.getDeg(1.0F));
        CockpitJU_88C6.this.setNew.azimuth.setDeg(CockpitJU_88C6.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        float f2 = CockpitJU_88C6.this.prevFuel - CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel;
        CockpitJU_88C6.access$302(CockpitJU_88C6.this, CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88C6.this.setNew.cons = (0.91F * CockpitJU_88C6.this.setOld.cons + 0.09F * f2);
        if (CockpitJU_88C6.this.buzzerFX != null)
          if ((CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < ((JU_88C6)CockpitJU_88C6.this.aircraft()).fDiveRecoveryAlt) && (((JU_88C6)CockpitJU_88C6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1)) {
            CockpitJU_88C6.this.buzzerFX.play();
          }
          else if (CockpitJU_88C6.this.buzzerFX.isPlaying())
            CockpitJU_88C6.this.buzzerFX.stop();
        f2 = ((JU_88C6)CockpitJU_88C6.this.aircraft()).fDiveRecoveryAlt;
        float f3 = -(((JU_88C6)CockpitJU_88C6.this.aircraft()).fDiveVelocity * 0.27777F * (float)Math.sin(Math.toRadians(((JU_88C6)CockpitJU_88C6.this.aircraft()).fDiveAngle))) * 0.1019F;
        f3 += (float)Math.sqrt(f3 * f3 + 2.0F * f2 * 0.1019F);
        float f4 = ((JU_88C6)CockpitJU_88C6.this.aircraft()).fDiveVelocity * 0.27777F * (float)Math.cos(Math.toRadians(((JU_88C6)CockpitJU_88C6.this.aircraft()).fDiveAngle));
        float f5 = f4 * f3 + 10.0F - 10.0F;
        CockpitJU_88C6.this.setNew.alpha = (90.0F - ((JU_88C6)CockpitJU_88C6.this.aircraft()).fDiveAngle - (float)Math.toDegrees(Math.atan(f5 / f2)));
      }
      return true;
    }
