...
public class CockpitSpit9CCLP extends CockpitPilot
{
  ...
  public CockpitSpit9CCLP() {
    super("3DO/Cockpit/SpitfireMkIXc/spitCCLP.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    int i = ((SPITFIRE9CCLP)aircraft()).k14Mode;
    boolean bool = i < 2;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitSpit9CCLP this$0;
    ...
    Variables(CockpitSpit9CCLP.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit9CCLP.this.bNeedSetUp) {
        CockpitSpit9CCLP.this.reflectPlaneMats();
        CockpitSpit9CCLP.access$102(CockpitSpit9CCLP.this, false);
      }
      if (CockpitSpit9CCLP.this.fm != null) {
        CockpitSpit9CCLP.access$202(CockpitSpit9CCLP.this, CockpitSpit9CCLP.this.setOld);
        CockpitSpit9CCLP.access$302(CockpitSpit9CCLP.this, CockpitSpit9CCLP.this.setNew);
        CockpitSpit9CCLP.access$402(CockpitSpit9CCLP.this, CockpitSpit9CCLP.this.setTmp);
        CockpitSpit9CCLP.this.setNew.throttle = (0.92F * CockpitSpit9CCLP.this.setOld.throttle + 0.08F * CockpitSpit9CCLP.this.fm.CT.PowerControl);

        CockpitSpit9CCLP.this.setNew.prop = (0.92F * CockpitSpit9CCLP.this.setOld.prop + 0.08F * CockpitSpit9CCLP.this.fm.EI.engines[0].getControlProp());

        CockpitSpit9CCLP.this.setNew.mix = (0.92F * CockpitSpit9CCLP.this.setOld.mix + 0.08F * CockpitSpit9CCLP.this.fm.EI.engines[0].getControlMix());

        CockpitSpit9CCLP.this.setNew.altimeter = CockpitSpit9CCLP.this.fm.getAltitude();
        if (Math.abs(CockpitSpit9CCLP.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit9CCLP.this.setNew.azimuth = (0.97F * CockpitSpit9CCLP.this.setOld.azimuth + 0.03F * -CockpitSpit9CCLP.this.fm.Or.getYaw());
        }
        if ((CockpitSpit9CCLP.this.setOld.azimuth > 270.0F) && (CockpitSpit9CCLP.this.setNew.azimuth < 90.0F))
          CockpitSpit9CCLP.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit9CCLP.this.setOld.azimuth < 90.0F) && (CockpitSpit9CCLP.this.setNew.azimuth > 270.0F))
          CockpitSpit9CCLP.this.setOld.azimuth += 360.0F;
        CockpitSpit9CCLP.this.setNew.waypointAzimuth = (0.91F * CockpitSpit9CCLP.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit9CCLP.this.waypointAzimuth() - CockpitSpit9CCLP.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitSpit9CCLP.this.setNew.vspeed = (0.99F * CockpitSpit9CCLP.this.setOld.vspeed + 0.01F * CockpitSpit9CCLP.this.fm.getVertSpeed());

        float f1 = ((SPITFIRE9CCLP)CockpitSpit9CCLP.this.aircraft()).k14Distance;

        CockpitSpit9CCLP.this.setNew.k14w = (5.0F * CockpitSpit9CCLP.k14TargetWingspanScale[((SPITFIRE9CCLP)CockpitSpit9CCLP.this.aircraft()).k14WingspanType] / f1);

        CockpitSpit9CCLP.this.setNew.k14w = (0.9F * CockpitSpit9CCLP.this.setOld.k14w + 0.1F * CockpitSpit9CCLP.this.setNew.k14w);
        CockpitSpit9CCLP.this.setNew.k14wingspan = (0.9F * CockpitSpit9CCLP.this.setOld.k14wingspan + 0.1F * CockpitSpit9CCLP.k14TargetMarkScale[((SPITFIRE9CCLP)CockpitSpit9CCLP.this.aircraft()).k14WingspanType]);

        CockpitSpit9CCLP.this.setNew.k14mode = (0.8F * CockpitSpit9CCLP.this.setOld.k14mode + 0.2F * ((SPITFIRE9CCLP)CockpitSpit9CCLP.this.aircraft()).k14Mode);

        Vector3d localVector3d = CockpitSpit9CCLP.this.aircraft().FM.getW();

        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitSpit9CCLP.this.floatindex((f1 - 200.0F) * 0.04F, CockpitSpit9CCLP.k14BulletDrop) - CockpitSpit9CCLP.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitSpit9CCLP.this.setNew.k14x = (0.92F * CockpitSpit9CCLP.this.setOld.k14x + 0.08F * f2);
        CockpitSpit9CCLP.this.setNew.k14y = (0.92F * CockpitSpit9CCLP.this.setOld.k14y + 0.08F * f3);
        if (CockpitSpit9CCLP.this.setNew.k14x > 7.0F)
          CockpitSpit9CCLP.this.setNew.k14x = 7.0F;
        if (CockpitSpit9CCLP.this.setNew.k14x < -7.0F)
          CockpitSpit9CCLP.this.setNew.k14x = -7.0F;
        if (CockpitSpit9CCLP.this.setNew.k14y > 7.0F)
          CockpitSpit9CCLP.this.setNew.k14y = 7.0F;
        if (CockpitSpit9CCLP.this.setNew.k14y < -7.0F)
          CockpitSpit9CCLP.this.setNew.k14y = -7.0F;
      }
      return true;
