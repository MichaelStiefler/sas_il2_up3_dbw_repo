...
//            Scheme5, PaintSchemeBMPar02, TypeTransport, NetAircraft, 
//            PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeTransport
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                if(s.endsWith("p1") || s.endsWith("p6"))
                {
                    ...
                    if(v1.x > 0.93969261646270752D)
                        getEnergyPastArmor((10D / v1.x) * (double)com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot);
                } else
                if(s.endsWith("p2") || s.endsWith("p7"))
                    getEnergyPastArmor(5D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p3a") || s.endsWith("p3b") || s.endsWith("p8a") || s.endsWith("p8b"))
                    getEnergyPastArmor(8D / (java.lang.Math.abs(v1.x) * (double)com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p4") || s.endsWith("p9"))
                {
                    if(v1.x > 0.70710676908493042D)
                        getEnergyPastArmor(8D / (v1.x * (double)com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F) + 0.0010000000474974513D), shot);
                    else
                    if(v1.x > -0.70710676908493042D)
                ...
                if(s.endsWith("o1") || s.endsWith("o2") || s.endsWith("o3") || s.endsWith("o4") || s.endsWith("o5"))
                    if(v1.x > 0.70710676908493042D)
                        getEnergyPastArmor(8D / (v1.x * (double)com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F) + 9.9999997473787516E-005D), shot);
                    else
            ...
            {
                if((s.endsWith("ta1") || s.endsWith("ta2")) && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(12.9F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F)
                {
                    debuggunnery("Tail1 Spars Broken in Half..");
                    nextDMGLevels(3, 2, "Tail1_D3", shot.initiator);
                }
                if((s.endsWith("ta3") || s.endsWith("ta4")) && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("Tail2") > 2 && getEnergyPastArmor(12.9F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F)
                {
                    debuggunnery("Tail2 Spars Broken in Half..");
                    nextDMGLevels(3, 2, "Tail2_D3", shot.initiator);
                }
                if((s.endsWith("li1") || s.endsWith("li2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.92000001668930054D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingLIn") > 2 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    debuggunnery("WingLIn Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if((s.endsWith("ri1") || s.endsWith("ri2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.92000001668930054D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingRIn") > 2 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    debuggunnery("WingRIn Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if((s.endsWith("lm1") || s.endsWith("lm2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.86000001430511475D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingLMid") > 2 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    debuggunnery("WingLMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if((s.endsWith("rm1") || s.endsWith("rm2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.86000001430511475D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingRMid") > 2 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    debuggunnery("WingRMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if((s.endsWith("lo1") || s.endsWith("lo2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingLOut") > 2 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    debuggunnery("WingLOut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if((s.endsWith("ro1") || s.endsWith("ro2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingROut") > 2 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    debuggunnery("WingROut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if((s.endsWith("k1") || s.endsWith("k2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(v1.x) && chunkDamageVisible("Keel1") > 1 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    debuggunnery("Keel1 Spars Damaged..");
                    nextDMGLevels(1, 2, "Keel1_D2", shot.initiator);
                }
                if((s.endsWith("k3") || s.endsWith("k4")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(v1.x) && chunkDamageVisible("Keel1") > 1 && getEnergyPastArmor(12.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.HE_111Z.weaponTriggersRegister(class1, new int[] {
            10, 11, 12, 13, 14, 15, 16, 17
        });
        com.maddox.il2.objects.air.HE_111Z.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08"
        });
        com.maddox.il2.objects.air.HE_111Z.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG15t 150", "MGunMG15t 1000", "MGunMG15t 750", "MGunMG15t 750", "MGunMGFFt 450", "MGunMG15t 1000", "MGunMG15t 750", "MGunMG15t 750"
        });
        com.maddox.il2.objects.air.HE_111Z.weaponsRegister(class1, "none", new java.lang.String[] {
