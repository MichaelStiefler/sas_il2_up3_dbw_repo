    ...
    implements TypeBNZFighter
{
        ...
        if((double)((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getCockpitDoor() > 0.20000000000000001D && bHasBlister && super.FM.getSpeedKMH() > fMaxKMHSpeedForOpenCanopy && hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
                if(this == com.maddox.il2.ai.World.getPlayerAircraft())
                    ((CockpitBF_109G6LATE)com.maddox.il2.game.Main3D.cur3D().cockpitCur).removeCanopy();
            }
    ...
    static 
    {
        java.lang.Class class1 = BF_109G6AS.class;
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Bf-109G-6ASN.fmd");
        ...
        Aircraft.weaponsRegister(class1, "R1-SC250", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "R1-AB250", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900 1", null, 
            null, null, null, null, null, null, "BombGunAB250 1", null, null, null, 
            null, null, null, null, null
        });
        Aircraft.weaponsRegister(class1, "R1-SC500", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900 1", null, 
            null, null, null, null, null, null, "BombGunSC500 1", null, null, null, 
            null, null, null, null, null
        });
        Aircraft.weaponsRegister(class1, "R1-AB500", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900 1", null, 
            null, null, null, null, null, null, "BombGunAB500 1", null, null, null, 
            null, null, null, null, null
        });
        Aircraft.weaponsRegister(class1, "R2-SC50", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "R6-MG151-20", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "R2R3-TANKWfrGr21", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900 1", "FuelTankGun_Type_D 1", 
            null, null, "RocketGunWfrGr21 1", "RocketGunWfrGr21 1", "PylonRO_WfrGr21 1", "PylonRO_WfrGr21 1", null, null, null, null, 
            null, null, null, null, null
        });
        Aircraft.weaponsRegister(class1, "R3R6-MG151-20", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "R3R4-2XMK108", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "U4R3R6-MK1082XMG151-20", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "G8-NOMG151", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, "PylonRECO1BF109 1"
        });
        Aircraft.weaponsRegister(class1, "G8R3-TANK-NOMG151", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, null, null, null, null, null, "PylonETC900 1", "FuelTankGun_Type_D 1", 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, "PylonRECO1BF109 1"
        });
        Aircraft.weaponsRegister(class1, "G8R1-2XTANK-NOMG151", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, "FuelTankGun_Type_D 1", "FuelTankGun_Type_D 1", "PylonRECO1BF109 1"
        });
        Aircraft.weaponsRegister(class1, "G8-NOMG131", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120ki 200", null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, "PylonRECO1BF109 1"
        });
        Aircraft.weaponsRegister(class1, "G8R3-TANK-NOMG131", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120ki 200", null, null, null, null, "PylonETC900 1", "FuelTankGun_Type_D 1", 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, "PylonRECO1BF109 1"
        });
        Aircraft.weaponsRegister(class1, "G8R1-2xTANK-NOMG131", new java.lang.String[] {
