...
public class CockpitSU_2_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((SU_2)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((SU_2)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSU_2_Bombardier.this.bEntered) {
        float f1 = ((SU_2)CockpitSU_2_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((SU_2)CockpitSU_2_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitSU_2_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitSU_2_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
