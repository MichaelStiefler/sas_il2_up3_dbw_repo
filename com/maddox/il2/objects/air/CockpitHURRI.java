  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      if (CockpitHURRI.this.fm != null) {
        ...
        CockpitHURRI.this.setNew.throttle = ((10.0F * CockpitHURRI.this.setOld.throttle + CockpitHURRI.this.fm.CT.PowerControl) / 11.0F);
        CockpitHURRI.this.setNew.altimeter = CockpitHURRI.this.fm.getAltitude();
        if (Math.abs(CockpitHURRI.this.fm.Or.getKren()) < 30.0F) {
          CockpitHURRI.this.setNew.azimuth = ((35.0F * CockpitHURRI.this.setOld.azimuth + -CockpitHURRI.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        CockpitHURRI.this.setNew.vspeed = ((199.0F * CockpitHURRI.this.setOld.vspeed + CockpitHURRI.this.fm.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
