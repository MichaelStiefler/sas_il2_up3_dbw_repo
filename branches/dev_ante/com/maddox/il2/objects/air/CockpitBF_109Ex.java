...
public class CockpitBF_109Ex extends CockpitPilot
{
  ...
  private static final int TYPE_E4_Trop = 2;
  private static final int TYPE_E4N = 3;
  private static final int TYPE_E7B = 4;
  private static final int TYPE_E7NZ = 5;
  private static final int TYPE_E7BN_Trop = 6;
  private static final int TYPE_E7N = 7;
  ...
  protected boolean doFocusEnter()
  {
    ...
    {
      aircraft().hierMesh().chunkVisible("mirror", false);
      return true;
    }
  ...
  {
    aircraft().hierMesh().chunkVisible("mirror", true);
    super.doFocusLeave();
  }
  ...
  protected void reflectPlaneMats()
  {
    ...
    {
      if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E4)) {
        this.type = 0;
      }
      else if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E4B)) {
        this.type = 1;
      }
      else if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E4_Trop)) {
        this.type = 2;
      }
      else if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E4N)) {
        this.type = 3;
      }
      else if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E7)) {
        this.type = 4;
      }
      else if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E7NZ)) {
        this.type = 5;
      }
      else if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E7N_Trop)) {
        this.type = 6;
      }
      else if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109E7N))
        this.type = 7;
      switch (this.type)
      {
      case 0:
      ...
      case 1:
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Body", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("BodyE4", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Top", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("TopE4", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE4_D0", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE4B_D0", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE7_D0", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("oxigen-7", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("oxigen-7z", false);
        break;
      case 2:
        ...
        break;
      case 3:
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Body", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("BodyE4", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Top", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("TopE4", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE4_D0", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE4B_D0", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE7_D0", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("oxigen-7", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("oxigen-7z", false);
        break;
      case 4:
        ...
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE4B_D0", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("PanelE7_D0", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("oxigen-7", false);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("oxigen-7z", true);
        break;
      case 5:
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Body", true);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("BodyE4", false);
  ...
  static
  {
    Property.set(CockpitBF_109Ex.class, "normZN", 0.43F);
    Property.set(CockpitBF_109Ex.class, "gsZN", 0.43F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitBF_109Ex.this.bNeedSetUp)
      {
        ...
        CockpitBF_109Ex.access$002(CockpitBF_109Ex.this, false);
      }
      CockpitBF_109Ex.access$102(CockpitBF_109Ex.this, CockpitBF_109Ex.this.setOld);
      CockpitBF_109Ex.access$202(CockpitBF_109Ex.this, CockpitBF_109Ex.this.setNew);
      CockpitBF_109Ex.access$302(CockpitBF_109Ex.this, CockpitBF_109Ex.this.setTmp);
      CockpitBF_109Ex.this.setNew.altimeter = CockpitBF_109Ex.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_109Ex.this.cockpitDimControl)
      {
        ...
        CockpitBF_109Ex.this.setNew.dimPosition = (CockpitBF_109Ex.this.setOld.dimPosition + 0.05F);
      CockpitBF_109Ex.this.setNew.throttle = ((10.0F * CockpitBF_109Ex.this.setOld.throttle + CockpitBF_109Ex.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109Ex.this.setNew.mix = ((8.0F * CockpitBF_109Ex.this.setOld.mix + CockpitBF_109Ex.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109Ex.this.setNew.azimuth = CockpitBF_109Ex.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109Ex.this.setOld.azimuth > 270.0F) && (CockpitBF_109Ex.this.setNew.azimuth < 90.0F))
        CockpitBF_109Ex.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_109Ex.this.setOld.azimuth < 90.0F) && (CockpitBF_109Ex.this.setNew.azimuth > 270.0F))
        CockpitBF_109Ex.this.setOld.azimuth += 360.0F;
      CockpitBF_109Ex.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_109Ex.this.setOld.waypointAzimuth + (CockpitBF_109Ex.this.waypointAzimuth() - CockpitBF_109Ex.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitBF_109Ex.this.buzzerFX((CockpitBF_109Ex.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.999999F) && (CockpitBF_109Ex.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.0F));
      return true;
    }
