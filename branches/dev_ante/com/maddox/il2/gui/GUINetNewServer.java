...
public class GUINetNewServer extends GameState
{
  ...
  public void _enter()
  {
    ...
    if (Config.cur.netServerChannels > 127)
      Config.cur.netServerChannels = 127;
    fillPlayers();
  ...
  public GUINetNewServer(GWindowRoot paramGWindowRoot)
  {
    ...
    this.dialogClient = ((GUIDialogClient)this.client.create(new DialogClient()));
  ...
  public class DlgPassword extends GWindowFramed
  {
    ...
    public boolean doOk()
    {
      String str1 = this.pw0.getValue();
      String str2 = this.pw1.getValue();
      if (str1.equals(str2))
      {
        if ("".equals(str1))
          GUINetNewServer.access$002(GUINetNewServer.this, null);
        else
          GUINetNewServer.access$002(GUINetNewServer.this, str1);
        return true;
      }
