...
public class CockpitSB2M103_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((SB_2M103)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((SB_2M103)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSB2M103_Bombardier.this.bEntered) {
        float f1 = ((SB_2M103)CockpitSB2M103_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((SB_2M103)CockpitSB2M103_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitSB2M103_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitSB2M103_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
