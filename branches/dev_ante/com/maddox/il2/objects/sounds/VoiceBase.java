...
public class VoiceBase
{
  ...
  static {
    ...
    vbStr[''] = "Mission_accomplished_Excellent_Just_like_the_movies";
    vbStr[''] = "My_guns_are_empty";
    vbStr[''] = "Negative_I_m_going_in";
    vbStr[''] = "Nine";
    vbStr[''] = "Okay_we_are_finished_here_Let_s_go_home";
    vbStr[''] = "One";
    vbStr[''] = "On_final_requesting_permission_to_land";
    vbStr[''] = "On_the_go_around";
    vbStr[''] = "Over";
    vbStr[''] = "Pull_up_Pull_up";
    vbStr[''] = "Repeat_attack";
    vbStr[''] = "Return_to_base_I_repeat_return_to_home_base";
    vbStr[''] = "Return_to_base_immediately";
    vbStr[''] = "Rockets_gone";
    vbStr[''] = "Second_Para";
    vbStr[''] = "Seven";
    vbStr[''] = "Six";
    vbStr[''] = "Sixteen";
    vbStr[''] = "Somebody";
    vbStr[''] = "Stand_by_for_my_orders";
    vbStr[''] = "Stay_in_formation";
    vbStr[''] = "Stay_on_course";
    vbStr[''] = "Stay_on_leader_s_course";
    vbStr[''] = "Stay_with_me";
    vbStr[''] = "Tanks";
    vbStr[''] = "Target_destroyed";
    vbStr[''] = "Target_in_fire_Direct_hit";
    vbStr[''] = "Ten";
    vbStr[''] = "Third_Para";
    vbStr[''] = "Thirteen";
    vbStr[''] = "This_is_One";
    ...
    vbStr[' '] = "Torpedo_boats";
    vbStr['¡'] = "Train";
    vbStr['¢'] = "Transport_column";
    vbStr['£'] = "Twelve";
    vbStr['¤'] = "Two";
    vbStr['¥'] = "Vector";
    vbStr['¦'] = "Watch_it_You_re_shooting_at_one_of_ours";
    vbStr['§'] = "Watch_the_ground_Pull_up";
    vbStr['¨'] = "We_are_heading_home";
    vbStr['©'] = "We_are_on_target_starting_our_attack_run";
    vbStr['ª'] = "What_the_Hell";
    vbStr['«'] = "Where_are_you";
    vbStr['¬'] = "You_re_getting_too_close_Pull_up";
    vbStr['­'] = "your_1_o_clock";
    vbStr['®'] = "your_1_o_clock_high";
    vbStr['¯'] = "your_1_o_clock_low";
    vbStr['°'] = "your_10_o_clock";
    vbStr['±'] = "your_10_o_clock_high";
    vbStr['²'] = "your_10_o_clock_low";
    vbStr['³'] = "your_11_o_clock";
    vbStr['´'] = "your_11_o_clock_high";
    vbStr['µ'] = "your_11_o_clock_low";
    vbStr['¶'] = "your_2_o_clock";
    vbStr['·'] = "your_2_o_clock_high";
    vbStr['¸'] = "your_2_o_clock_low";
    vbStr['¹'] = "your_3_o_clock";
    vbStr['º'] = "your_3_o_clock_high";
    vbStr['»'] = "your_3_o_clock_low";
    vbStr['¼'] = "your_4_o_clock";
    vbStr['½'] = "your_4_o_clock_high";
    vbStr['¾'] = "your_4_o_clock_low";
    vbStr['¿'] = "your_5_o_clock";
    vbStr['À'] = "your_5_o_clock_high";
    vbStr['Á'] = "your_5_o_clock_low";
    vbStr['Â'] = "your_6_o_clock";
    vbStr['Ã'] = "your_6_o_clock_high";
    vbStr['Ä'] = "your_6_o_clock_low";
    vbStr['Å'] = "your_7_o_clock";
    vbStr['Æ'] = "your_7_o_clock_high";
    vbStr['Ç'] = "your_7_o_clock_low";
    vbStr['È'] = "your_8_o_clock";
    vbStr['É'] = "your_8_o_clock_high";
    vbStr['Ê'] = "your_8_o_clock_low";
    vbStr['Ë'] = "your_9_o_clock";
    vbStr['Ì'] = "your_9_o_clock_high";
    vbStr['Í'] = "your_9_o_clock_low";
    vbStr['Î'] = "your_12_o_clock";
    vbStr['Ï'] = "your_12_o_clock_high";
    vbStr['Ð'] = "your_12_o_clock_low";
    vbStr['Ñ'] = "Zveno_1";
    vbStr['Ò'] = "Zveno_2";
    vbStr['Ó'] = "Zveno_3";
    vbStr['Ô'] = "Zveno_4";
    ...
    vbStr['×'] = "Hell1";
    vbStr['Ø'] = "Hell3";
    vbStr['Ù'] = "What_the_Hell1";
    vbStr['Ú'] = "Anybody";
    vbStr['Û'] = "Hello_guys";
    vbStr['Ü'] = "Nice_to_see_you";
    vbStr['Ý'] = "Thanks_for_joining_us";
    vbStr['Þ'] = "Thanks_for_the_cover";
    vbStr['ß'] = "Thanks_for_the_cover_see_you_back_at_home_base";
    vbStr['à'] = "Thanks_for_the_support_have_a_good_trip_home";
    vbStr['á'] = "We_are_coming_under_attack_request_assistance_over";
    vbStr['â'] = "We_are_under_attack_requesting_immediate_assistance";
    vbStr['ã'] = "We_are_under_attack_we_need_assistance_over";
    vbStr['ä'] = "Where_are_you_fighters_We_need_immediate_assistance";
    vbStr['å'] = "They_are_chopping_us_up_We_have_lost_one_more_aircraft_Request_immediate_assistance";
    vbStr['æ'] = "We_are_under_attack_Repeat_we_are_under_attack_We_have_lost_aircraft";
    vbStr['ç'] = "Commencing_bomb_run_now";
    vbStr['è'] = "We_are_at_IP_commencing_bomb_run";
    vbStr['é'] = "Negative_all_available_fighters_are_busy_at_this_time_Sorry";
    vbStr['ê'] = "Negative_no_other_fighters_are_near_by_Good_luck";
    vbStr['ë'] = "This_is_Home_base";
    vbStr['ì'] = "This_is_tower_Abort_approach_Abort_approach";
    vbStr['í'] = "Vectoring_fighters_to_your_area_Hang_on_tight";
    vbStr['î'] = "Wave_off_Wave_off";
    vbStr['ï'] = "We_are_sending_fighters_to_your_location_Hang_on";
    vbStr['ð'] = "You_re_cleared_for_full_stop_Watch_the_traffic";
    vbStr['ñ'] = "You_re_cleared_for_take_off";
    vbStr['ò'] = "You_are_ready_to_go_Sir";
    vbStr['ó'] = "Control_tower_confirm_you_re_cleared_to_land";
    vbStr['ô'] = "Eight";
    vbStr['õ'] = "Warning_Traffic_is_on_the_runway_Go_round_repeat_go_round";
    vbStr['ö'] = "This_is_control_tower_Repeat_this_is_control_tower_You_re_not_cleared_hold_the_pattern";
    vbStr['÷'] = "Watch_the_traffic_You_re_not_cleared_to_land_Fly_the_holding_pattern";
    vbStr['ø'] = "Approach_control_here_Proceed_you_re_cleared_to_land";
    vbStr['ù'] = "Are_you_sure_You_re_clear_there_are_no_bandits_in_your_area";
    vbStr['ú'] = "Attention_Traffic_is_on_the_runway_Go_round_repeat_go_round";
    vbStr['û'] = "Clear_you_have_no_contact_with_the_enemy";
    vbStr['ü'] = "Good_luck";
    vbStr['ý'] = "Ground_control_here_Stand_by";
    vbStr['þ'] = "Break_right";
    vbStr['ÿ'] = "Break_left";
