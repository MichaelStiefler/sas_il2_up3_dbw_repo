...
// Source File Name:   CockpitP_38L.java
...
//            CockpitPilot, P_38L, Aircraft, Cockpit

public class CockpitP_38L extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(((com.maddox.il2.objects.air.P_38L)aircraft()).bChangedPit)
            {
                reflectPlaneToModel();
                ((com.maddox.il2.objects.air.P_38L)aircraft()).bChangedPit = false;
            }
            if(fm != null)
            {
                setTmp = setOld;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(fm.CT.saveWeaponControl[0])
            com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.01065F;
        ...
        mesh.chunkSetAngles("Priceltarg1", setNew.k14wingspan, 0.0F, 0.0F);
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, 0.031F, -0.031F);
        mesh.chunkSetLocate("Z_TurnBank2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
