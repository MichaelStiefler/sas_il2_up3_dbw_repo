...
public class CockpitTU_2S_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((TU_2S)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((TU_2S)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitTU_2S_Bombardier.this.bEntered) {
        float f1 = ((TU_2S)CockpitTU_2S_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((TU_2S)CockpitTU_2S_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitTU_2S_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitTU_2S_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
