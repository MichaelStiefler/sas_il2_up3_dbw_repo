...
public class CannonUS_5_38Mk12 extends CannonAntiAirGeneric
{
  ...
  {
    paramGunProperties.aimMaxDist = 15903.0F;
    ...
    localBulletProperties.powerRadius = 136.0F;
    ...
    localBulletProperties.power = 0.9F;
    localBulletProperties.powerType = 0;
    localBulletProperties.powerRadius = 122.0F;

    localBulletProperties.kalibr = 0.127F;
    localBulletProperties.massa = 24.5F;
    localBulletProperties.speed = 792.0F;
