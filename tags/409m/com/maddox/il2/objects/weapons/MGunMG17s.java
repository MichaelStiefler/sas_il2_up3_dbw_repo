...
// Source File Name:   MGunMG17s.java
...
public class MGunMG17s extends com.maddox.il2.objects.weapons.MGunAircraftGeneric
{
    ...
    public com.maddox.il2.engine.GunProperties createProperties()
    {
        ...
        gunproperties.bullet[2].speed = 810F;
        ...
        gunproperties.bullet[3].speed = 810F;
        ...
        gunproperties.bullet[4].speed = 810F;
        ...
        gunproperties.bullet[6].massa = 0.01F;
        gunproperties.bullet[6].kalibr = 4.35483E-005F;
        gunproperties.bullet[6].speed = 810F;
        gunproperties.bullet[6].power = 0.002F;
        ...
        gunproperties.bullet[6].traceColor = 0xd2002eff;
        gunproperties.bullet[6].timeLife = 2.0F;
        gunproperties.bullet[7].massa = 0.01F;
        gunproperties.bullet[7].kalibr = 4.35483E-005F;
        gunproperties.bullet[7].speed = 810F;
        gunproperties.bullet[7].power = 0.002F;
        ...
        gunproperties.bullet[8].massa = 0.01F;
        gunproperties.bullet[8].kalibr = 4.35483E-005F;
        gunproperties.bullet[8].speed = 810F;
        gunproperties.bullet[8].power = 0.002F;
        ...
        gunproperties.bullet[8].traceColor = 0xd2002eff;
        gunproperties.bullet[8].timeLife = 2.0F;
        gunproperties.bullet[9].massa = 0.01F;
        gunproperties.bullet[9].kalibr = 4.35483E-005F;
        gunproperties.bullet[9].speed = 810F;
        gunproperties.bullet[9].power = 0.002F;
        gunproperties.bullet[9].powerType = 0;
        gunproperties.bullet[9].powerRadius = 0.1F;
        gunproperties.bullet[9].traceMesh = "3DO/Effects/Tracers/20mmRed/mono.sim";
        gunproperties.bullet[9].traceTrail = "Effects/Smokes/SmokeBlack_BuletteTrail.eff";
