...
public class CockpitSpit12 extends CockpitPilot
{
  ...
  public CockpitSpit12() {
    super("3DO/Cockpit/SpitfireMkXII/hier.him", "bf109");
  ...
  private class Variables
  {
    ...
    private final CockpitSpit12 this$0;
    ...
    Variables(CockpitSpit12.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit12.this.fm != null) {
        CockpitSpit12.access$102(CockpitSpit12.this, CockpitSpit12.this.setOld);
        CockpitSpit12.access$202(CockpitSpit12.this, CockpitSpit12.this.setNew);
        CockpitSpit12.access$302(CockpitSpit12.this, CockpitSpit12.this.setTmp);
        ...
        if (Math.abs(CockpitSpit12.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit12.this.setNew.azimuth = (0.97F * CockpitSpit12.this.setOld.azimuth + 0.03F * -CockpitSpit12.this.fm.Or.getYaw());
        }
        if ((CockpitSpit12.this.setOld.azimuth > 270.0F) && (CockpitSpit12.this.setNew.azimuth < 90.0F))
          CockpitSpit12.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit12.this.setOld.azimuth < 90.0F) && (CockpitSpit12.this.setNew.azimuth > 270.0F))
          CockpitSpit12.this.setOld.azimuth += 360.0F;
        CockpitSpit12.this.setNew.waypointAzimuth = (0.91F * CockpitSpit12.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit12.this.waypointAzimuth() - CockpitSpit12.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));
