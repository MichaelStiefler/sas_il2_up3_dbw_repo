    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                if(s.endsWith("1"))
                {
                    ...
                    if(getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(30F, 90F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) < 0.0F)
                        doRicochet(shot);
                } else
                if(s.endsWith("2"))
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 1: // '\001'
                    if(getEnergyPastArmor(2.2F / (float)java.lang.Math.sqrt(com.maddox.il2.objects.air.Aircraft.v1.y * com.maddox.il2.objects.air.Aircraft.v1.y + com.maddox.il2.objects.air.Aircraft.v1.z * com.maddox.il2.objects.air.Aircraft.v1.z), shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                        FM.AS.setControlsDamage(shot.initiator, 2);
                    break;

                case 2: // '\002'
                    if(getEnergyPastArmor(2.2F / (float)java.lang.Math.sqrt(com.maddox.il2.objects.air.Aircraft.v1.y * com.maddox.il2.objects.air.Aircraft.v1.y + com.maddox.il2.objects.air.Aircraft.v1.z * com.maddox.il2.objects.air.Aircraft.v1.z), shot) <= 0.0F)
                        break;
            ...
            {
                if(s.startsWith("xxsparli") && chunkDamageVisible("WingLIn") > 2 && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.92000001668930054D * java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) && getEnergyPastArmor(17.799999237060547D / (1.0001000165939331D - java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y)), shot) > 0.0F)
                {
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                case 1: // '\001'
                    ...
                    if(com.maddox.il2.objects.air.Aircraft.Pd.x < -2.7000000476837158D)
        ...
        if(s.startsWith("xcf"))
        {
            if(com.maddox.il2.objects.air.Aircraft.Pd.x > 2.0099999999999998D && getEnergyPastArmor(11.11F / ((float)java.lang.Math.sqrt(com.maddox.il2.objects.air.Aircraft.v1.y * com.maddox.il2.objects.air.Aircraft.v1.y + com.maddox.il2.objects.air.Aircraft.v1.z * com.maddox.il2.objects.air.Aircraft.v1.z) + 0.0001F), shot) <= 0.0F)
            {
                doRicochet(shot);
                return;
            }
            if(com.maddox.il2.objects.air.Aircraft.Pd.x > 0.80000000000000004D && com.maddox.il2.objects.air.Aircraft.Pd.x < 2D)
                if(com.maddox.il2.objects.air.Aircraft.Pd.z > 0.42499999999999999D)
                {
    ...
    protected void moveGear(float f)
    {
        ...
        {
            resetYPRmodifier();
            com.maddox.il2.objects.air.Aircraft.xyz[1] = -0.3F + 0.1125F * f;
            com.maddox.il2.objects.air.Aircraft.ypr[1] = 88F;
            hiermesh.chunkSetLocate("Cart_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        }
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, -45F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, -45F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, -45F * f, 0.0F);
    ...
    public void moveWheelSink()
    {
        ...
        {
            float f = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.066F, -45F, 0.0F);
