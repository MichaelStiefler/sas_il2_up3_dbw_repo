...
public class CockpitKI_21_II extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        float f2 = (com.maddox.il2.fm.Atmosphere.temperature((float)fm.Loc.z) - 273.09F) + 44.4F * fm.EI.engines[0].getPowerOutput();
        if(f2 < 0.0F)
        ...
        f2 = (com.maddox.il2.fm.Atmosphere.temperature((float)fm.Loc.z) - 273.09F) + 44.4F * fm.EI.engines[1].getPowerOutput();
        if(f2 < 0.0F)
