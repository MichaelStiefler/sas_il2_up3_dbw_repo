...
public abstract class RadarGeneric extends ActorHMesh
  implements MsgExplosionListener, MsgShotListener, Prey, Obstacle, ActorAlign
{
  ...
  protected RadarGeneric() {
    this(constr_arg1, constr_arg2);
  }

  private RadarGeneric(StationaryProperties paramStationaryProperties, ActorSpawnArg paramActorSpawnArg)
  {
    ...
    public boolean netInput(NetMsgInput paramNetMsgInput) throws IOException {
      if (paramNetMsgInput.isGuaranted())
      {
        ...
        case 73:
          ...
          if ((i > 0) && (RadarGeneric.this.dying != 1))
            RadarGeneric.this.Die(null, 1, false);
          return true;
        case 68:
          if (isMirrored()) {
          ...
          if (RadarGeneric.this.dying != 1) {
            ...
            RadarGeneric.this.Die(localActor, 1, true);
          }
          return true;
        case 100:
          localObject = new NetMsgGuaranted(paramNetMsgInput, 1);
  ...
  {
    public Class cls;
    public RadarGeneric.StationaryProperties proper;
    ...
    private static RadarGeneric.StationaryProperties LoadStationaryProperties(SectFile paramSectFile, String paramString, Class paramClass)
    {
      RadarGeneric.StationaryProperties localStationaryProperties = new RadarGeneric.StationaryProperties();
    ...
    public Actor actorSpawn(ActorSpawnArg paramActorSpawnArg) {
      ...
      RadarGeneric localRadarGeneric;
      try { RadarGeneric.access$002(this.proper);
        RadarGeneric.access$102(paramActorSpawnArg);
        localRadarGeneric = (RadarGeneric)this.cls.newInstance();
        RadarGeneric.access$002(null);
        RadarGeneric.access$102(null);
      } catch (Exception localException) {
        RadarGeneric.access$002(null);
        RadarGeneric.access$102(null);
        System.out.println(localException.getMessage());
