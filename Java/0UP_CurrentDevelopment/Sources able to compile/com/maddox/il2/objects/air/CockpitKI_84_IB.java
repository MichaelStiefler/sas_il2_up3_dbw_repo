...
public class CockpitKI_84_IB extends CockpitPilot
{
    ...
    {
        Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.649F);
        Cockpit.xyz[2] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, -0.034F);
        mesh.chunkSetLocate("CanopyB", Cockpit.xyz, Cockpit.ypr);
