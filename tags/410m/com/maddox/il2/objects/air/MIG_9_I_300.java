...
//            MIG_9, PaintSchemeFMPar06, NetAircraft
...
public class MIG_9_I_300 extends com.maddox.il2.objects.air.MIG_9
{
    ...
    public void update(float f)
    {
        ...
        if(FM.AS.isMaster() && FM.CT.Weapons[1] != null && FM.CT.Weapons[1][0] != null)
        {
            ...
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < com.maddox.il2.objects.air.MIG_9_I_300.cvt(FM.getAltitude(), 3000F, 7000F, 0.0F, 0.1F))
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MIG_9_I_300.weaponTriggersRegister(class1, new int[] {
            0, 0, 1
        });
        com.maddox.il2.objects.air.MIG_9_I_300.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02", "_CANNON03"
        });
        com.maddox.il2.objects.air.MIG_9_I_300.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunVYak 80", "MGunVYak 80", "MGunN57ki 21"
        });
        com.maddox.il2.objects.air.MIG_9_I_300.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
}
