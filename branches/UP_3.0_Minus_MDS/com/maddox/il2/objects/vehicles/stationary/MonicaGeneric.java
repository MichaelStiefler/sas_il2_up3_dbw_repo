...
public abstract class MonicaGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.MonicaGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.MonicaGeneric.Rnd(10F, 10F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.MonicaGeneric monicageneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.MonicaGeneric.constr_arg2 = actorspawnarg;
                monicageneric = (com.maddox.il2.objects.vehicles.stationary.MonicaGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.MonicaGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create MonicaGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (monicageneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.MonicaGeneric.mesh_name);
            cls = class1;
    ...
    private MonicaGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    public void startMove()
    {
        if(!interpEnd("move"))
        {
            ...
            engineSTimer = -(int)com.maddox.il2.objects.vehicles.stationary.MonicaGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.MonicaGeneric.Rnd(5F, 5F));
        }
    }
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if((actor instanceof com.maddox.il2.objects.air.Aircraft) && actor != com.maddox.il2.ai.World.getPlayerAircraft() && actor.getSpeed(vector3d) > 20D)
            {
                ...
                if((double)k1 <= 6400D && (double)k1 >= 308D && i2 >= 255 && i2 <= 285 && java.lang.Math.sqrt(j1 * j1) >= 120D)
