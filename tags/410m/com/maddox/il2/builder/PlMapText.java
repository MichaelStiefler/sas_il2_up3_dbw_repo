...
_L2:
        ...
        i1 = 0;
        for(j1 = s2.length() - 1; i1 < j1 && s2.charAt(i1) <= ' '; i1++);
        for(; i1 < j1 && s2.charAt(j1) <= ' '; j1--);
        if(i1 == j1)
            return;
...
_L1:
    ...
    public void selectAll()
    {
        ...
        {
            com.maddox.il2.builder.ActorText actortext = (com.maddox.il2.builder.ActorText)allActors.get(j);
            builder.selectActorsAdd(actortext);
        }
    ...
    public void renderMap2D()
    {
        ...
        com.maddox.il2.builder.ActorText.setRenderClip(0.0D, 0.0D, builder.clientWindow.win.dx, builder.clientWindow.win.dy);
        int i = allActors.size();
        for(int j = 0; j < i; j++)
        {
            com.maddox.il2.builder.ActorText actortext = (com.maddox.il2.builder.ActorText)allActors.get(j);
    ...
    {
        com.maddox.il2.builder.ActorText actortext = (com.maddox.il2.builder.ActorText)builder.selectedActor();
        fillComboBox2(startComboBox1);
        builder.wSelect.tabsClient.addTab(1, tabText);
    ...
    {
        if(com.maddox.il2.builder.PlMapText.getPlugin("MapActors") == null)
        {
            throw new RuntimeException("PlMisStatic: plugin 'MapActors' not found");
        } else
        {
            pluginActors = (com.maddox.il2.builder.PlMapActors)com.maddox.il2.builder.PlMapText.getPlugin("MapActors");
            return;
        }
    }
    ...
    public void createGUI()
    {
        ...
        if(--i >= 0)
        {
            viewType = builder.mDisplayFilter.subMenu.addItem(i, new com.maddox.gwindow.GWindowMenuItem(builder.mDisplayFilter.subMenu, "show Text", null) {
        ...
        tabText = builder.wSelect.tabsClient.createTab("Text", gwindowdialogclient);
