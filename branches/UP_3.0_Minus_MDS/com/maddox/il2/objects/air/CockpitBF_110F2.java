...
// Source File Name:   CockpitBF_110F2.java
...
//            CockpitPilot, Aircraft, Cockpit, BF_110F2

public class CockpitBF_110F2 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if((com.maddox.il2.objects.air.BF_110F2)aircraft() != null);
            if(com.maddox.il2.objects.air.BF_110F2.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.BF_110F2)aircraft() != null);
                com.maddox.il2.objects.air.BF_110F2.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
