...
public class PlMisAir extends com.maddox.il2.builder.Plugin
{
    ...
    public void load(com.maddox.rts.SectFile sectfile)
    {
        ...
        for(int k = 0; k < j; k++)
        {
            ...
            {
                com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: Section '" + s + "' not found");
                continue;
            }
            int l = sectfile.sectionIndex(s1);
            if(l < 0)
            {
                com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: Section '" + s1 + "' not found");
                continue;
            }
            int i1 = sectfile.vars(l);
            if(i1 == 0)
            {
                com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: Section '" + s1 + "' is empty");
                continue;
            }
            java.lang.String s2 = sectfile.get(s, "Class", (java.lang.String)null);
            if(s2 == null)
            {
                com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: In section '" + s + "' field 'Class' not present");
                continue;
            }
            ...
            {
                com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: In section '" + s + "' field 'Class' contains unknown class");
                continue;
            }
            int j1 = 0;
            int k1 = 0;
            ...
            } else
            {
                ...
                if(l4 < 0)
                    l4 = 0;
                com.maddox.il2.builder.PathAir pathair = new PathAir(com.maddox.il2.builder.Plugin.builder.pathes, j1, k1);
                ...
                {
                    pathair.destroy();
                    com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: Section '" + s + "', regiment table very small");
                } else
                {
                    ...
                    for(int i5 = 0; i5 < i1; i5++)
                    {
                        ...
                        {
                            com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: Section '" + s1 + "' contains unknown type waypoint");
                            pathair.destroy();
                            continue;
                        }
                        ...
                        {
                            com.maddox.il2.builder.Plugin.builder.tipErr("MissionLoad: Section '" + s1 + "' type '" + s5 + "' is empty");
                            pathair.destroy();
                        } else
                        {
    ...
    public void insert(com.maddox.il2.engine.Loc loc, boolean flag)
    {
        ...
        com.maddox.il2.builder.PAir pair1 = (com.maddox.il2.builder.PAir)com.maddox.il2.builder.Plugin.builder.selectedPoint();
        if(pair1.type() == 2)
            return;
        com.maddox.il2.builder.PAir pair;
        pair = new PAir(com.maddox.il2.builder.Plugin.builder.selectedPath(), com.maddox.il2.builder.Plugin.builder.selectedPoint(), point3d, 0, defaultHeight, defaultSpeed);
        ...
        if(j < 0 || j >= type[i].item.length)
            return;
        pathair = new PathAir(com.maddox.il2.builder.Plugin.builder.pathes, i, j);
        ...
        com.maddox.il2.builder.Plugin.builder.setSelected(pair);
    ...
    void viewUpdate()
    {
        ...
        if(com.maddox.il2.builder.Plugin.builder.selectedPath() != null)
        {
            ...
            if(path instanceof com.maddox.il2.builder.PathAir)
            {
                com.maddox.il2.builder.PathAir pathair1 = (com.maddox.il2.builder.PathAir)path;
    ...
    private void fillComboBox2(int i, int j)
    {
        ...
        if(com.maddox.il2.builder.Plugin.builder.wSelect.curFilledType != i)
        {
            ...
            for(int k = 0; k < type[i - startComboBox1].item.length; k++)
                com.maddox.il2.builder.Plugin.builder.wSelect.comboBox2.add(com.maddox.il2.game.I18N.plane(type[i - startComboBox1].item[k].name));
    ...
    public java.lang.String[] actorInfo(com.maddox.il2.engine.Actor actor)
    {
        ...
        _actorInfo[1] = "(" + i + ") " + com.maddox.il2.builder.Plugin.timeSecToString(pair.time + (double)(int)(com.maddox.il2.ai.World.getTimeofDay() * 60F * 60F));
        return _actorInfo;
    }
    ...
    public void syncSelector()
    {
        ...
        fillDialogWay();
        com.maddox.il2.builder.PathAir pathair1 = (com.maddox.il2.builder.PathAir)com.maddox.il2.builder.Plugin.builder.selectedPath();
        for(int i = 0; i < pathair1.planes; i++)
        {
            com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.addTab(i + 3, tabSkin[i]);
            fillEditSkin(i);
        }
    ...
    public void updateSelectorMesh()
    {
        ...
        if(paintscheme != null)
        {
            com.maddox.il2.engine.HierMesh hiermesh = com.maddox.il2.builder.Plugin.builder.wSelect.getHierMesh();
            if(hiermesh != null)
    ...
    public void initEditActor()
    {
        ...
        tabActor = com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.createTab(com.maddox.il2.builder.Plugin.i18n("AircraftActor"), gwindowdialogclient);
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 1.0F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Army"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 5F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Squadron"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 7F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Wing"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 9F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Weapons"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 11F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Fuel"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 13F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Planes"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 15F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Skill"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 17F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("OnlyAI"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 19F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Parachute"), null));
    ...
    public void fillEditActor()
    {
        ...
        if(pathair.skill != -1)
            ...
            wSkill.setValue(com.maddox.il2.builder.Plugin.i18n("Custom"));
    ...
    public void initEditWay()
    {
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 3F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Height"), null));
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 15F, 3F, 4F, 1.3F, com.maddox.il2.builder.Plugin.i18n("[M]"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 5F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Speed"), null));
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 15F, 5F, 4F, 1.3F, com.maddox.il2.builder.Plugin.i18n("[kM/H]"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 7F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Time"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 9F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("lType"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 11F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("RadioSilence"), null));
        ...
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 13F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Target"), null));
        gwindowdialogclient.addLabel(wTarget = new GWindowLabel(gwindowdialogclient, 9F, 13F, 7F, 1.3F, "", null));
        gwindowdialogclient.addControl(wTargetSet = new com.maddox.gwindow.GWindowButton(gwindowdialogclient, 1.0F, 15F, 5F, 1.6F, com.maddox.il2.builder.Plugin.i18n("&Set"), null) {
        ...
        gwindowdialogclient.addControl(wTargetClear = new com.maddox.gwindow.GWindowButton(gwindowdialogclient, 9F, 15F, 5F, 1.6F, com.maddox.il2.builder.Plugin.i18n("&Clear"), null) {
    ...
    private void fillSkins()
    {
        for(int i = 0; i < 4; i++)
        {
            ...
            wSkins[i].add(com.maddox.il2.builder.Plugin.i18n("Default"));
        }

        java.lang.String s;
        int j;
        s = com.maddox.il2.game.Main.cur().netFileServerSkin.primaryPath();
        j = com.maddox.il2.builder.Plugin.builder.wSelect.comboBox1.getSelected();
        if(j < startComboBox1 || j >= startComboBox1 + type.length)
            return;
        try
        {
            j -= startComboBox1;
            int k = com.maddox.il2.builder.Plugin.builder.wSelect.comboBox2.getSelected();
    ...
    {
        if(!(com.maddox.il2.builder.Plugin.builder.selectedPath() instanceof com.maddox.il2.builder.PathAir))
            return;
        com.maddox.il2.builder.PathAir pathair = (com.maddox.il2.builder.PathAir)com.maddox.il2.builder.Plugin.builder.selectedPath();
        if(pathair == null)
            return;
    ...
    private void fillNoseart()
    {
        for(int i = 0; i < 4; i++)
        {
            ...
            wNoseart[i].add(com.maddox.il2.builder.Plugin.i18n("None"));
        }
    ...
    private void fillPilots()
    {
        for(int i = 0; i < 4; i++)
        {
            ...
            wPilots[i].add(com.maddox.il2.builder.Plugin.i18n("Default"));
        }
    ...
    {
        com.maddox.il2.builder.PathAir pathair = (com.maddox.il2.builder.PathAir)com.maddox.il2.builder.Plugin.builder.selectedPath();
        int i = com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.sizeTabs();
        ...
        if(pathair.planes > i - 3)
        {
            ...
            {
                com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.addTab(j + 3, tabSkin[j]);
                fillEditSkin(j);
            }

        } else
        {
            int k = com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.current;
            for(; com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.sizeTabs() - 3 > pathair.planes; com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.removeTab(com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.sizeTabs() - 1));
            com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.setCurrent(k, false);
    ...
    private void initEditSkin()
    {
        for(_planeIndx = 0; _planeIndx < 4; _planeIndx++)
        {
            ...
            tabSkin[_planeIndx] = com.maddox.il2.builder.Plugin.builder.wSelect.tabsClient.createTab(com.maddox.il2.builder.Plugin.i18n("Plane" + (1 + _planeIndx)), gwindowdialogclient);
            gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 1.0F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Player"), null));
            ...
            gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 3F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Skill"), null));
            ...
            gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 5F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Skin"), null));
            ...
            gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 7F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Noseart"), null));
            ...
            gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 9F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("Pilot"), null));
            ...
            gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 11F, 7F, 1.3F, com.maddox.il2.builder.Plugin.i18n("NumberOn"), null));
