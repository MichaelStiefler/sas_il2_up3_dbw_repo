  ...
  implements TypeBNZFighter
{
  ...
  static
  {
    Class localClass = BF_109K6.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3do/plane/Bf-109K-6/hier.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/Bf-109K-6.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitBF_109K4.class });

    Property.set(localClass, "LOSElevation", 0.7498F);
    Aircraft.weaponTriggersRegister(localClass, new int[] { 0, 0, 1, 1, 1, 9, 3, 9 });

    Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON02", "_CANNON03", "_ExternalDev01", "_ExternalBomb01", "_ExternalDev01" });
    try
    {
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMK108ki", 65);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMK108ki", 45);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(1, "MGunMK108ki", 45);
      for (int j = 5; j < i; j++) {
      ...
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(0, "MGunMG131si", 300);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMK108ki", 65);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMG15120MGki", 100);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(1, "MGunMG15120MGki", 100);
      for (int k = 5; k < i; k++) {
      ...
      arrayOf_WeaponSlot[7] = new Aircraft._WeaponSlot(9, "FuelTankGun_Type_D", 1);
