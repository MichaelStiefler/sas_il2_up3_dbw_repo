...
public class TBF1C extends TBF
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = TBF1C.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= TBF1C.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / TBF1C.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)TBF1C.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(TBF1C.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = TBF1C.class;
        ...
        Aircraft.weaponsRegister(class1, "1xmk13_late", new java.lang.String[] {
            "MGunBrowning50kWF 600", "MGunBrowning50kWF 600", "MGunBrowning50t 400", "MGunBrowning303t 500", null, null, null, null, null, null, 
