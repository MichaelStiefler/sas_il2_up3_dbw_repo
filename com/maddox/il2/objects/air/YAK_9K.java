    ...
    implements com.maddox.il2.objects.air.TypeStormovik
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.YAK_9K.weaponTriggersRegister(class1, new int[] {
            0, 1
        });
        com.maddox.il2.objects.air.YAK_9K.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_CANNON01"
        });
        com.maddox.il2.objects.air.YAK_9K.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunUBsi 200", "MGunNS45ki 29"
        });
        com.maddox.il2.objects.air.YAK_9K.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
