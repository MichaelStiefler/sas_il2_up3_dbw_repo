...
// Source File Name:   CockpitJU523E_Bombardier.java
...
//            CockpitPilot, JU_52_3MG3E, Aircraft

public class CockpitJU523E_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurSideslip;
    ...
    protected boolean doFocusEnter()
    {
        ...
        {
            ((com.maddox.il2.objects.air.JU_52_3MG3E)fm.actor).bPitUnfocused = false;
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurReadyness > 0.93F;
        ...
        mesh.chunkSetAngles("zAltWheel", 0.0F, cvt(((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurAltitude, 0.0F, 10000F, 0.0F, 375.8333F), 0.0F);
        mesh.chunkSetAngles("zAnglePointer", 0.0F, ((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurForwardAngle, 0.0F);
        mesh.chunkSetAngles("zAngleWheel", 0.0F, -10F * ((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurForwardAngle, 0.0F);
        ...
        mesh.chunkSetAngles("zSpeedPointer", 0.0F, cvt(((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurSpeed, 150F, 600F, 0.0F, 60F), 0.0F);
        mesh.chunkSetAngles("zSpeedWheel", 0.0F, 0.333F * ((com.maddox.il2.objects.air.JU_52_3MG3E)aircraft()).fSightCurSpeed, 0.0F);
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (((java.lang.Object) (com.maddox.il2.objects.air.CockpitJU523E_Bombardier.class)))), "astatePilotIndx", 0);
    }
