    ...
    protected void explode(com.maddox.il2.engine.Actor actor)
    {
        new com.maddox.rts.MsgAction(0.0D, this) {
            ...
            public void doAction(java.lang.Object obj)
            {
                ...
                com.maddox.il2.engine.Eff3DActor.New(wagon, new HookNamed(wagon, "Select1"), null, 1.0F, "Effects/Smokes/SmokeBlack_Locomotive.eff", 10F);
            }

        }
;
        new com.maddox.rts.MsgAction(4D) {
...
;
        new com.maddox.rts.MsgAction(5.5D, new Pair(this, actor)) {
