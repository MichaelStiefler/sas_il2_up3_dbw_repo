...
// Source File Name:   CockpitI_16TYPE24_SPB.java
...
//            CockpitPilot, TypeDockable, I_16TYPE24DRONE

public class CockpitI_16TYPE24_SPB extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(((com.maddox.il2.objects.air.TypeDockable)aircraft()).typeDockableIsDocked() != bDocked)
        {
            ...
            if(bDocked)
            {
                com.maddox.il2.engine.HierMesh hiermesh = ((com.maddox.il2.engine.ActorHMesh)((com.maddox.il2.objects.air.I_16TYPE24DRONE)aircraft()).typeDockableGetQueen()).hierMesh();
                ...
                if(((com.maddox.il2.objects.air.I_16TYPE24DRONE)aircraft()).typeDockableGetDockport() == 0)
        ...
        mesh.chunkSetAngles("Fire2", 0.0F, -20F * (float)(fm.CT.WeaponControl[1] ? 1 : 0), 0.0F);
    ...
    {
        mesh.chunkVisible("ritedoor", true);
    }
