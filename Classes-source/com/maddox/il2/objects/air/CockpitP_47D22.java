...
// Source File Name:   CockpitP_47D22.java
...
public class CockpitP_47D22 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                {
                    float f = (float)java.lang.Math.sin(1.0F * cvt(fm.getOverload(), 1.0F, 8F, 1.0F, 0.45F) * cvt(((com.maddox.il2.fm.FlightModelMain) (fm)).AS.astatePilotStates[0], 0.0F, 100F, 1.0F, 0.1F) * (0.001F * (float)com.maddox.rts.Time.current()));
                    if(f > 0.0F)
                    {
                        pictBlinker+= = 0.3F;
                        if(pictBlinker > 1.0F)
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        super.mesh.chunkSetLocate("zBlink1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        super.mesh.chunkSetLocate("zBlink2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
