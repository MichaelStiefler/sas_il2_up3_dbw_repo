...
public class CockpitLAGG_3SERIES66 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLAGG_3SERIES66.this.fm != null) {
        ...
        {
          CockpitLAGG_3SERIES66.this.setNew.waypointAzimuth.setDeg(CockpitLAGG_3SERIES66.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitLAGG_3SERIES66.this.waypointAzimuth() - CockpitLAGG_3SERIES66.this.fm.Or.azimut());
        }
  ...
  private class Variables
  {
    ...
    Variables(CockpitLAGG_3SERIES66.1 arg2)
    {
      this();
    }
  }
