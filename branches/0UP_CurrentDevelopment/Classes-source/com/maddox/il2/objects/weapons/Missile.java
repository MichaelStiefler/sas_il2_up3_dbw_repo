...
public class Missile extends com.maddox.il2.objects.weapons.Rocket
{
        ...
        implements com.maddox.rts.NetUpdate
    {
        ...
        public void netUpdate()
        {
            try
            {
                ...
                out.writeFloat((float)((com.maddox.JGP.Tuple3d) (theMissilePoint3d)).x);
                out.writeFloat((float)((com.maddox.JGP.Tuple3d) (theMissilePoint3d)).y);
                out.writeFloat((float)((com.maddox.JGP.Tuple3d) (theMissilePoint3d)).z);
    ...
    private void endAllFlame()
    {
        if(iExhausts < 2)
        {
            com.maddox.rts.ObjState.destroy(super.flame);
        } else
        {
            for(int i = 0; i < iExhausts; i++)
                if(flames[i] != null)
                    com.maddox.rts.ObjState.destroy(flames[i]);
    ...
    public boolean stepTargetHoming()
    {
        ...
        float fSpeed = (float)getSpeed((com.maddox.JGP.Vector3d)null);
        if(theFailState == 3)
            fTimeFire = 0.0F;
        ...
        if(victim != null)
        {
            ...
            double victimDistance = com.maddox.il2.objects.weapons.GuidedMissileUtils.distanceBetween(this, victim);
            double theVictimSpeed = victimSpeed.length();
            double speedRel = (double)fSpeed / theVictimSpeed;
            double gamma = com.maddox.il2.objects.weapons.GuidedMissileUtils.angleActorBetween(victim, this);
        ...
        if(com.maddox.rts.Time.current() > tStart + 2L * lTrackDelay)
            if(com.maddox.il2.engine.Actor.isValid(victim))
            {
                ...
                if((victim instanceof com.maddox.il2.objects.air.Aircraft) && f2 > prevd && prevd != 1000F)
                {
                    ...
                    if(getSpeed((com.maddox.JGP.Vector3d)null) > victim.getSpeed((com.maddox.JGP.Vector3d)null))
                        victim = null;
                }
                prevd = f2;
            } else
    ...
    public boolean stepBeamRider()
    {
        ...
        com.maddox.il2.engine.Actor myOwner = getOwner();
    ...
    {
        if(com.maddox.il2.engine.Actor.isValid(actor) && !com.maddox.il2.engine.Actor.isValid(getOwner()))
            setOwner(actor);
        d = 0.10000000000000001D;
        victim = null;
        fm = null;
    ...
    {
        com.maddox.il2.engine.Actor actor = super.pos.base();
        ...
        {
            com.maddox.il2.game.NetSafeLog.log(getOwner(), "Missile launch cancelled (system error):" + exception.getMessage());
            destroy();
        }
        doStart(f);
        return;
    ...
    {
        java.lang.Class localClass = super.getClass();
        ...
        sEffSmoke = com.maddox.rts.Property.stringValue(localClass, "smoke", null);
        sEffSprite = com.maddox.rts.Property.stringValue(localClass, "sprite", null);
        sSimFlame = com.maddox.rts.Property.stringValue(localClass, "flame", null);
    ...
    private void createAdditionalSmokes()
    {
        ...
        for(int i = 1; i < iExhausts; i++)
        {
            ...
            smokes[i] = com.maddox.il2.engine.Eff3DActor.New(this, theHook, null, 1.0F, sEffSmoke, -1F);
            if(smokes[i] != null)
    ...
    private void createAdditionalSprites()
    {
        ...
        for(int i = 1; i < iExhausts; i++)
        {
            ...
            sprites[i] = com.maddox.il2.engine.Eff3DActor.New(this, theHook, null, fKalibr, sEffSprite, -1F);
            if(sprites[i] != null)
    ...
    private void createAdditionalFlames()
    {
        ...
        for(int i = 1; i < iExhausts; i++)
        {
            ...
            if(flames[i] != null)
            {
                ((com.maddox.il2.objects.ActorSimpleMesh)flames[i]).mesh().setScale(1.0F);
    ...
    private void createNamedNavLights(java.lang.String theNavLightHookName, java.lang.String theEffectName)
    {
        ...
        for(int i = 0; i < numNavLights; i++)
        {
            ...
            com.maddox.il2.objects.weapons.MissileNavLight theNavLight = new MissileNavLight(com.maddox.il2.engine.Eff3DActor.New(this, theHook, null, 1.0F, theEffectName, -1F));
    ...
    private void doStart(float f)
    {
        ...
        {
            createNavLights();
            ((com.maddox.il2.objects.ActorSimpleMesh)super.flame).mesh().setScale(1.0F);
            super.flame.drawing(true);
        }
        fMissileBaseSpeed = (float)getSpeed((com.maddox.JGP.Vector3d)null);
        if(isNet() && isNetMirror())
            return;
        fm = ((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)getOwner())).FM;
        switch(iLaunchType)
        {
        case 1: // '\001'
        ...
        case 2: // '\002'
            launchKren = java.lang.Math.toRadians(or.getKren());
            launchYaw = or.getYaw() + fm.getAOA() * (float)java.lang.Math.sin(launchKren);
            launchPitch = or.getPitch() - fm.getAOA() * (float)java.lang.Math.cos(launchKren);
        ...
        if((getOwner() != com.maddox.il2.ai.World.getPlayerAircraft() || !((com.maddox.il2.fm.RealFlightModel)fm).isRealMode()) && (fm instanceof com.maddox.il2.ai.air.Pilot))
        {
            ...
            {
                victim = ((com.maddox.il2.objects.air.TypeGuidedMissileCarrier)getOwner()).getMissileTarget();
                pVictimOffset = ((com.maddox.il2.objects.air.TypeGuidedMissileCarrier)getOwner()).getMissileTargetOffset();
            } else
            if(getOwner() instanceof com.maddox.il2.objects.air.TypeFighter)
            {
        ...
        try
        {
            ...
            if(com.maddox.il2.engine.Config.isUSE_RENDER())
            {
                victim = com.maddox.il2.game.Selector.look(true, false, com.maddox.il2.game.Main3D.cur3D()._camera3D[com.maddox.il2.game.Main3D.cur3D().getRenderIndx()], com.maddox.il2.ai.World.getPlayerAircraft().getArmy(), -1, com.maddox.il2.ai.World.getPlayerAircraft(), false);
                if(victim == null)
        ...
        {
            com.maddox.il2.ai.EventLog.type("Missile doStart Exception: " + exception.getMessage());
        }
    }
    ...
    private boolean isSunTracking()
    {
        if(fSunRayAngle == 0.0F)
            return false;
        float sunAngle = com.maddox.il2.objects.weapons.GuidedMissileUtils.angleBetween(this, com.maddox.il2.ai.World.Sun().ToSun);
        ...
        throws java.io.IOException
    {
        ...
        com.maddox.JGP.Point3d point3d = super.pos.getAbsPoint();
        netmsgspawn.writeFloat((float)((com.maddox.JGP.Tuple3d) (point3d)).x);
        netmsgspawn.writeFloat((float)((com.maddox.JGP.Tuple3d) (point3d)).y);
        netmsgspawn.writeFloat((float)((com.maddox.JGP.Tuple3d) (point3d)).z);
        com.maddox.il2.engine.Orient orient = super.pos.getAbsOrient();
