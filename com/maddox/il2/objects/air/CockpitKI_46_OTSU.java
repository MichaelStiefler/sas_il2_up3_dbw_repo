...
public class CockpitKI_46_OTSU extends CockpitPilot
{
  ...
  {
    super("3DO/Cockpit/J2M3/KI_46_OTSU.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Gear2", this.pictGear <= 0.0F ? 0.0F : 5.0F, 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Trigger", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.saveWeaponControl[0] == 0) && (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.saveWeaponControl[1] == 0) ? 0.0F : -16.5F, 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Overboost", 0.0F, 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPres1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel <= 1.0F ? 0.0F : 0.32F, 0.0F, 1.0F, 0.0F, -278.0F), 0.0F, 0.0F);
    ...
    resetYPRmodifier();
    Cockpit.xyz[0] = cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap(), 0.0F, 1.0F, 0.0F, 0.045F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetLocate("Z_Flap_Ind", Cockpit.xyz, Cockpit.ypr);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Trim1a", 0.0F, 0.0F, 27.0F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getTrimElevatorControl());
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Trim2a", 0.0F, 0.0F, 27.0F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getTrimRudderControl());
  ...
  private class Variables
  {
    ...
    float vspeed;
    float manifold;
    private final CockpitKI_46_OTSU this$0;
    ...
    Variables(CockpitKI_46_OTSU.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitKI_46_OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitKI_46_OTSU.access$002(CockpitKI_46_OTSU.this, CockpitKI_46_OTSU.this.setOld);
        CockpitKI_46_OTSU.access$102(CockpitKI_46_OTSU.this, CockpitKI_46_OTSU.this.setNew);
        CockpitKI_46_OTSU.access$202(CockpitKI_46_OTSU.this, CockpitKI_46_OTSU.this.setTmp);
        CockpitKI_46_OTSU.this.setNew.throttle = (0.85F * CockpitKI_46_OTSU.this.setOld.throttle + CockpitKI_46_OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitKI_46_OTSU.this.setNew.prop = (0.85F * CockpitKI_46_OTSU.this.setOld.prop + CockpitKI_46_OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitKI_46_OTSU.this.setNew.altimeter = CockpitKI_46_OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitKI_46_OTSU.this.waypointAzimuth();
        CockpitKI_46_OTSU.this.setNew.waypointAzimuth.setDeg(CockpitKI_46_OTSU.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitKI_46_OTSU.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitKI_46_OTSU.this.setNew.azimuth.setDeg(CockpitKI_46_OTSU.this.setOld.azimuth.getDeg(1.0F), CockpitKI_46_OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitKI_46_OTSU.this.setNew.vspeed = ((199.0F * CockpitKI_46_OTSU.this.setOld.vspeed + CockpitKI_46_OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        CockpitKI_46_OTSU.this.setNew.manifold = (0.8F * CockpitKI_46_OTSU.this.setOld.manifold + 0.2F * CockpitKI_46_OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getManifoldPressure());
      }
      return true;
    }
