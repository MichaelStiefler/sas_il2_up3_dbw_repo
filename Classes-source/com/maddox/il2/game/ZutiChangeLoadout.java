	...
	public int updateTimer() 
	{
		...
		try
		{
			if( Time.current()-startTime > maxTime )
			{
				...
				long bullets = ZutiSupportMethods_GameOrder.getNrOfBulletsForAircraft(playerAC);
				ZutiSupportMethods_NetSend.requestBullets(bullets);
				
				long rockets = ZutiSupportMethods_GameOrder.getNrOfRocketsForAircraft(playerAC);
				ZutiSupportMethods_NetSend.requestRockets(rockets);
				
				int[] bombs = ZutiSupportMethods_GameOrder.getNrOfBombsForAircraft(playerAC);
