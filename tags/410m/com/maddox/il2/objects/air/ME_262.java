    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.ME_262.cvt(f, 0.01F, 0.11F, 0.0F, 90F), 0.0F);
    ...
    public void moveWheelSink()
    {
        ...
        xyz[1] = com.maddox.il2.objects.air.ME_262.cvt(f, 0.0F, 0.19F, 0.0F, 0.19F);
        hierMesh().chunkSetLocate("GearC22_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.ME_262.cvt(f, 0.0F, 19F, 0.0F, 30F);
    ...
    public void update(float f)
    {
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL0_D0", 0.0F, com.maddox.il2.objects.air.ME_262.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -1F), 0.0F);
            hierMesh().chunkSetAngles("SlatL1_D0", 0.0F, com.maddox.il2.objects.air.ME_262.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -1F), 0.0F);
            hierMesh().chunkSetAngles("SlatR0_D0", 0.0F, com.maddox.il2.objects.air.ME_262.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -1F), 0.0F);
            hierMesh().chunkSetAngles("SlatR1_D0", 0.0F, com.maddox.il2.objects.air.ME_262.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -1F), 0.0F);
            if(!(this instanceof com.maddox.il2.objects.air.ME_262HGII))
            {
                hierMesh().chunkSetAngles("SlatL2_D0", 0.0F, com.maddox.il2.objects.air.ME_262.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -1F), 0.0F);
                hierMesh().chunkSetAngles("SlatR2_D0", 0.0F, com.maddox.il2.objects.air.ME_262.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -1F), 0.0F);
            }
        }
        if(FM.AS.isMaster())
        {
