...
public class CockpitFW_190D11 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(gun[4] != null)
        {
            ...
            mesh.chunkSetLocate("RC_MGFF_WingL", Cockpit.xyz, Cockpit.ypr);
        }
        if(gun[5] != null)
        {
            Cockpit.xyz[0] = cvt(gun[5].countBullets(), 0.0F, 55F, -0.018F, 0.0F);
            mesh.chunkSetLocate("RC_MGFF_WingR", Cockpit.xyz, Cockpit.ypr);
        }
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitFW_190D11.class, "normZN", 0.72F);
        com.maddox.rts.Property.set(CockpitFW_190D11.class, "gsZN", 0.66F);
    }
