// Source File Name: CockpitPBY.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitPBY.this.fm != null) {
				...
				CockpitPBY.this.setNew.throttle1 = (0.85F * CockpitPBY.this.setOld.throttle1)
						+ (CockpitPBY.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitPBY.this.setNew.throttle2 = (0.85F * CockpitPBY.this.setOld.throttle2)
						+ (CockpitPBY.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitPBY.this.setNew.prop1 = (0.85F * CockpitPBY.this.setOld.prop1)
						+ (CockpitPBY.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitPBY.this.setNew.prop2 = (0.85F * CockpitPBY.this.setOld.prop2)
						+ (CockpitPBY.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitPBY.this.setNew.altimeter = CockpitPBY.this.fm
						.getAltitude();
				float f = CockpitPBY.this.waypointAzimuth();
				CockpitPBY.this.setNew.azimuth.setDeg(
						CockpitPBY.this.setOld.azimuth.getDeg(1.0F),
						CockpitPBY.this.fm.Or.azimut());
				CockpitPBY.this.setNew.waypointAzimuth.setDeg(
						CockpitPBY.this.setOld.waypointAzimuth.getDeg(1.0F), f);
				CockpitPBY.this.setNew.waypointDeviation.setDeg(
						CockpitPBY.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitPBY.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitPBY.this.setNew.vspeed = ((199F * CockpitPBY.this.setOld.vspeed) + CockpitPBY.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
