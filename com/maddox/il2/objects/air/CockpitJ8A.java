...
// Source File Name:   CockpitJ8A.java
...
//            CockpitPilot, GLADIATOR1J8A, Aircraft

public class CockpitJ8A extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(((com.maddox.il2.objects.air.GLADIATOR1J8A)aircraft()).bChangedPit)
            {
                reflectPlaneToModel();
                ((com.maddox.il2.objects.air.GLADIATOR1J8A)aircraft()).bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_ReVi", 0.0F, 90F * setNew.stbyPosition, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Altimeter1", 0.0F, 0.0F, cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F, 16000F, 0.0F, -720F));
        float f1 = com.maddox.il2.fm.Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH());
        mesh.chunkSetAngles("Z_Speedometer1", 0.0F, 0.0F, cvt(f1, 60F, 450F, 0.0F, -340.5F));
        ...
        resetYPRmodifier();
        xyz[0] = -cvt(fm.Or.getTangage(), -20F, 20F, 0.042F, -0.042F);
        mesh.chunkSetLocate("Z_AoA1", xyz, ypr);
        ...
        com.maddox.il2.objects.air.Aircraft.xyz[1] = fm.CT.getCockpitDoor() * -0.6F;
        mesh.chunkSetLocate("XGlassDamage3", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        com.maddox.il2.objects.air.Aircraft.xyz[1] = fm.CT.getCockpitDoor() * 0.6F;
        mesh.chunkSetLocate("Canopy", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        mesh.chunkSetLocate("CanopyGlass", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        mesh.chunkSetLocate("XGlassDamage2", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
