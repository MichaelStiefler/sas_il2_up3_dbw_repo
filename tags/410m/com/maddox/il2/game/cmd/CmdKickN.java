...
public class CmdKickN extends com.maddox.rts.Cmd
{
    ...
    private void fillUsers(java.util.Map map, java.util.List list)
    {
        ...
        {
            int i = com.maddox.il2.game.cmd.CmdKickN.nargs(map, "_$$");
            for(int j = 0; j < i; j++)
            {
                java.lang.String s = com.maddox.il2.game.cmd.CmdKickN.arg(map, "_$$", j);
                if(s.charAt(0) < '0' || s.charAt(0) > '9')
                    continue;
                int k = com.maddox.il2.game.cmd.CmdKickN.arg(map, "_$$", j, 1000, 0, 1000);
