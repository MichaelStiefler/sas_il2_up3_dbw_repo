...
public class CockpitB29SP_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((B_29SP)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((B_29SP)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB29SP_Bombardier.this.bEntered) {
        float f1 = ((B_29SP)CockpitB29SP_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((B_29SP)CockpitB29SP_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitB29SP_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitB29SP_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
