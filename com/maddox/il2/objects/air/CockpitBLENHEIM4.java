...
public class CockpitBLENHEIM4 extends CockpitPilot
{
  ...
  {
    super("3DO/Cockpit/BlenheimMkIV/CockpitBLENHEIM4.him", "he111");
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitBLENHEIM4 this$0;
    ...
    Variables(CockpitBLENHEIM4.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitBLENHEIM4.access$002(CockpitBLENHEIM4.this, CockpitBLENHEIM4.this.setOld);
        CockpitBLENHEIM4.access$102(CockpitBLENHEIM4.this, CockpitBLENHEIM4.this.setNew);
        CockpitBLENHEIM4.access$202(CockpitBLENHEIM4.this, CockpitBLENHEIM4.this.setTmp);
        if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3] != null)
        {
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 0)
            CockpitBLENHEIM4.this.bBombs[1] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 1)
            CockpitBLENHEIM4.this.bBombs[0] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 2)
            CockpitBLENHEIM4.this.bBombs[3] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 3)
            CockpitBLENHEIM4.this.bBombs[2] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 4)
            CockpitBLENHEIM4.this.bBombs[5] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 5)
            CockpitBLENHEIM4.this.bBombs[4] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 6)
            CockpitBLENHEIM4.this.bBombs[5] = ((CockpitBLENHEIM4.this.bBombs[5] != 0) || (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][6].haveBullets()) ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 7)
            CockpitBLENHEIM4.this.bBombs[4] = ((CockpitBLENHEIM4.this.bBombs[4] != 0) || (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][7].haveBullets()) ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 8)
            CockpitBLENHEIM4.this.bBombs[7] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 9)
            CockpitBLENHEIM4.this.bBombs[6] = (!CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        CockpitBLENHEIM4.this.setNew.throttle1 = (0.9F * CockpitBLENHEIM4.this.setOld.throttle1 + 0.1F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitBLENHEIM4.this.setNew.prop1 = (0.9F * CockpitBLENHEIM4.this.setOld.prop1 + 0.1F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitBLENHEIM4.this.setNew.mix1 = (0.8F * CockpitBLENHEIM4.this.setOld.mix1 + 0.2F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitBLENHEIM4.this.setNew.man1 = (0.92F * CockpitBLENHEIM4.this.setOld.man1 + 0.08F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitBLENHEIM4.this.setNew.throttle2 = (0.9F * CockpitBLENHEIM4.this.setOld.throttle2 + 0.1F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitBLENHEIM4.this.setNew.prop2 = (0.9F * CockpitBLENHEIM4.this.setOld.prop2 + 0.1F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
        CockpitBLENHEIM4.this.setNew.mix2 = (0.8F * CockpitBLENHEIM4.this.setOld.mix2 + 0.2F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
        CockpitBLENHEIM4.this.setNew.man2 = (0.92F * CockpitBLENHEIM4.this.setOld.man2 + 0.08F * CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitBLENHEIM4.this.setNew.altimeter = CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitBLENHEIM4.this.setNew.azimuth.setDeg(CockpitBLENHEIM4.this.setOld.azimuth.getDeg(1.0F), CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitBLENHEIM4.this.setNew.vspeed = ((100.0F * CockpitBLENHEIM4.this.setOld.vspeed + CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);
        float f = CockpitBLENHEIM4.this.waypointAzimuth();
        CockpitBLENHEIM4.this.setNew.waypointAzimuth.setDeg(CockpitBLENHEIM4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBLENHEIM4.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitBLENHEIM4.this.setNew.waypointDirection.setDeg(CockpitBLENHEIM4.this.setOld.waypointDirection.getDeg(1.0F), f);
        CockpitBLENHEIM4.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RTurret", CockpitBLENHEIM4.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[0], 0.0F, 0.0F);
        CockpitBLENHEIM4.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RGun", -CockpitBLENHEIM4.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[1], 0.0F, 0.0F);
        CockpitBLENHEIM4.this.setNew.inert = (0.999F * CockpitBLENHEIM4.this.setOld.inert + 0.001F * (CockpitBLENHEIM4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
      return true;
    }
