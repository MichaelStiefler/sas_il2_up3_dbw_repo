...
public abstract class CAR extends Scheme1
    implements TypeFighter
{
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        if(shot.chunkName.startsWith("Engine1") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.06F && ((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > 0.47999998927116394D)
        {
        ...
        {
            if((double)shot.power * java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).x) > 12070D)
                ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.hitPilot(shot.initiator, 0, (int)(shot.mass * 1000F * 0.5F));
            if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > 1.0117499828338623D)
            {
    ...
    static 
    {
        java.lang.Class class1 = CAR.class;
