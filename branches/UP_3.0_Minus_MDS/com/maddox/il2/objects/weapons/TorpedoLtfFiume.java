...
public class TorpedoLtfFiume extends com.maddox.il2.objects.weapons.Bomb
{
    ...
    public void start()
    {
        ...
        setSpeed(spd);
        collide(true);
        interpPut(((com.maddox.il2.engine.Interpolate) (new Bomb.Interpolater(((com.maddox.il2.objects.weapons.Bomb) (this))))), ((java.lang.Object) (null)), com.maddox.rts.Time.current(), ((com.maddox.rts.Message) (null)));
        drawing(true);
        ...
        sound = newSound(com.maddox.rts.Property.stringValue(var_class, "sound", ((java.lang.String) (null))), false);
        if(sound != null)
            sound.play();
    }
