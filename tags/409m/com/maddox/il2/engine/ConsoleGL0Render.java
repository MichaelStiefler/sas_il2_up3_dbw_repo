...
class ConsoleGL0Render extends com.maddox.il2.engine.Render
{
    ...
    public void render()
    {
        ...
        {
            com.maddox.il2.engine.Render.drawTile(0.0F, 0.0F, com.maddox.il2.engine.RendersMain.getViewPortWidth(), com.maddox.il2.engine.RendersMain.getViewPortHeight(), 0.0F, com.maddox.il2.engine.ConsoleGL0.backgroundMat, -1, 0.0F, 1.0F, 1.0F, -1F);
            if(sstep != null)
            {
                ...
                {
                    com.maddox.il2.engine.TTFont.font[2].output(i, (float)com.maddox.il2.engine.RendersMain.getViewPortWidth() * 0.083F, (float)com.maddox.il2.engine.RendersMain.getViewPortHeight() * 0.045F, 0.0F, sstep);
                    com.maddox.il2.engine.TTFont.font[2].output(i, (float)com.maddox.il2.engine.RendersMain.getViewPortWidth() * 0.083F, ((float)com.maddox.il2.engine.RendersMain.getViewPortHeight() * 0.045F + (float)com.maddox.il2.engine.TTFont.font[2].height()) - (float)com.maddox.il2.engine.TTFont.font[2].descender(), 0.0F, "V 4.09m");
                } else
                {
                    ...
                    com.maddox.il2.engine.TTFont.font[2].output(i, (float)com.maddox.il2.engine.RendersMain.getViewPortWidth() * 0.02F, ((float)com.maddox.il2.engine.RendersMain.getViewPortHeight() * 0.17F + (float)com.maddox.il2.engine.TTFont.font[2].height()) - (float)com.maddox.il2.engine.TTFont.font[2].descender(), 0.0F, "V 4.09m");
                }
            }
            return;
        }
            ...
            if(com.maddox.rts.RTSConf.cur.console.bWrap)
            {
                ...
                for(; k > 0 && i1 < list.size(); i1++)
                {
                    ...
                    if(j2 > 0)
                    {
                        ...
                        int i3 = 0;
                        int j3 = j2;
                        for(ofs[l2] = i3; j3 > 0 && com.maddox.il2.engine.ConsoleGL0.font.width(s1, i3, j3) > 0.0F; ofs[l2] = i3)
                        {
                            int k3 = j3;
                            while(com.maddox.il2.engine.ConsoleGL0.font.width(s1, i3, j3) + com.maddox.il2.engine.ConsoleGL0.typeOffset > (float)getViewPortWidth()) 
                            {
                                while(--j3 > 0) 
                                    if(s1.charAt(i3 + j3) == ' ')
                                        break;
                            ...
                            if(j3 == 0)
                                for(j3 = k3; com.maddox.il2.engine.ConsoleGL0.font.width(s1, i3, j3) + com.maddox.il2.engine.ConsoleGL0.typeOffset > (float)getViewPortWidth();)
                                    if(--j3 == 0)
                                        break;
