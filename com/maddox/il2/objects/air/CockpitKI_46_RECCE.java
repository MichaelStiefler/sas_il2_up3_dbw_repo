...
public class CockpitKI_46_RECCE extends CockpitPilot
{
  ...
  {
    super("3DO/Cockpit/J2M3/KI46recce.him", "bf109");
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitKI_46_RECCE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitKI_46_RECCE.access$002(CockpitKI_46_RECCE.this, CockpitKI_46_RECCE.this.setOld);
        CockpitKI_46_RECCE.access$102(CockpitKI_46_RECCE.this, CockpitKI_46_RECCE.this.setNew);
        CockpitKI_46_RECCE.access$202(CockpitKI_46_RECCE.this, CockpitKI_46_RECCE.this.setTmp);
        CockpitKI_46_RECCE.this.setNew.throttle = (0.85F * CockpitKI_46_RECCE.this.setOld.throttle + CockpitKI_46_RECCE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitKI_46_RECCE.this.setNew.prop = (0.85F * CockpitKI_46_RECCE.this.setOld.prop + CockpitKI_46_RECCE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitKI_46_RECCE.this.setNew.altimeter = CockpitKI_46_RECCE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitKI_46_RECCE.this.waypointAzimuth();
        CockpitKI_46_RECCE.this.setNew.waypointAzimuth.setDeg(CockpitKI_46_RECCE.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitKI_46_RECCE.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitKI_46_RECCE.this.setNew.azimuth.setDeg(CockpitKI_46_RECCE.this.setOld.azimuth.getDeg(1.0F), CockpitKI_46_RECCE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitKI_46_RECCE.this.setNew.vspeed = ((199.0F * CockpitKI_46_RECCE.this.setOld.vspeed + CockpitKI_46_RECCE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        CockpitKI_46_RECCE.this.setNew.manifold = (0.8F * CockpitKI_46_RECCE.this.setOld.manifold + 0.2F * CockpitKI_46_RECCE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getManifoldPressure());
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float manifold;
    private final CockpitKI_46_RECCE this$0;
    ...
    Variables(CockpitKI_46_RECCE.1 arg2)
    {
      this();
    }
  }
