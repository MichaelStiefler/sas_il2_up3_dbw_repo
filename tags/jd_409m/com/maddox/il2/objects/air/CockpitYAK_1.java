...
public class CockpitYAK_1 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitYAK_1.this.setNew.throttle = ((10.0F * CockpitYAK_1.this.setOld.throttle + CockpitYAK_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_1.this.setNew.prop = ((10.0F * CockpitYAK_1.this.setOld.prop + CockpitYAK_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_1.this.setNew.altimeter = CockpitYAK_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_1.this.setNew.azimuth = ((35.0F * CockpitYAK_1.this.setOld.azimuth + CockpitYAK_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        ...
        CockpitYAK_1.this.setNew.vspeed = ((199.0F * CockpitYAK_1.this.setOld.vspeed + CockpitYAK_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
