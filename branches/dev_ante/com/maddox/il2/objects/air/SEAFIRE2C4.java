...
public class SEAFIRE2C4 extends SPITFIRE
{
  ...
  static
  {
    Class localClass = SEAFIRE2C4.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Seafire");
    Property.set(localClass, "meshName", "3DO/Plane/SeafireMkII4xH(Multi1)/hier.him");
    ...
    Property.set(localClass, "cockpitClass", new Class[] { CockpitSea2.class });

    Property.set(localClass, "LOSElevation", 0.5926F);
    Aircraft.weaponTriggersRegister(localClass, new int[] { 1, 1, 1, 1, 9, 3 });

    Aircraft.weaponHooksRegister(localClass, new String[] { "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_ExternalDev01", "_ExternalBomb01" });
    try
    {
      ...
      arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(9, "PylonSpitC", 1);
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(9, "FuelTankGun_TankSpit30", 1);
      arrayOf_WeaponSlot[5] = null;
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
      str = "1x45dt";
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(9, "FuelTankGun_TankSpit45", 1);
      arrayOf_WeaponSlot[5] = null;
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
      str = "1x90dt";
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 120);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(9, "FuelTankGun_TankSpit90", 1);
      arrayOf_WeaponSlot[5] = null;
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
      str = "none";
