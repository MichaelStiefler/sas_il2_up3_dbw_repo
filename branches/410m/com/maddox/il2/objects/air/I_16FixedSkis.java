...
// Source File Name:   I_16FixedSkis.java
...
public abstract class I_16FixedSkis extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p1"))
                    getEnergyPastArmor(8.26F / (java.lang.Math.abs((float)com.maddox.il2.objects.air.Aircraft.v1.x) + 1E-005F), shot);
            } else
            {
                ...
                if(s.startsWith("xxeng"))
                {
                    ...
                    if(s.endsWith("prop"))
                    {
                        if(getEnergyPastArmor(0.45F / (java.lang.Math.abs((float)com.maddox.il2.objects.air.Aircraft.v1.x) + 0.0001F), shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.05F)
                        {
    ...
    protected void moveFan(float f)
    {
        if(com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            ...
            hierMesh().chunkSetAngles("Stick_D0", 0.0F, 12F * f1, com.maddox.il2.objects.air.I_16FixedSkis.cvt(f2, -1F, 1.0F, -12F, 18F));
            hierMesh().chunkSetAngles("pilotarm2_d0", com.maddox.il2.objects.air.I_16FixedSkis.cvt(f1, -1F, 1.0F, 14F, -16F), 0.0F, com.maddox.il2.objects.air.I_16FixedSkis.cvt(f1, -1F, 1.0F, 6F, -8F) - (com.maddox.il2.objects.air.I_16FixedSkis.cvt(f2, -1F, 0.0F, -36F, 0.0F) + com.maddox.il2.objects.air.I_16FixedSkis.cvt(f2, 0.0F, 1.0F, 0.0F, 32F)));
            hierMesh().chunkSetAngles("pilotarm1_d0", 0.0F, 0.0F, com.maddox.il2.objects.air.I_16FixedSkis.cvt(f1, -1F, 1.0F, -16F, 14F) + com.maddox.il2.objects.air.I_16FixedSkis.cvt(f2, -1F, 0.0F, -62F, 0.0F) + com.maddox.il2.objects.air.I_16FixedSkis.cvt(f2, 0.0F, 1.0F, 0.0F, 44F));
            float f3 = com.maddox.il2.objects.air.Aircraft.cvt(FM.getSpeed(), 30F, 80F, 1.0F, 0.0F);
            ...
            if(FM.Gears.gWheelSinking[0] > 0.0F)
            {
                ...
                hierMesh().chunkSetAngles("SkiL1_D0", com.maddox.il2.ai.World.Rnd().nextFloat(-f4, f4), com.maddox.il2.ai.World.Rnd().nextFloat(-f4 * 2.0F, f4 * 2.0F) - skiAngleL, com.maddox.il2.ai.World.Rnd().nextFloat(f4, f4));
            } else
            {
            ...
            if(FM.Gears.gWheelSinking[1] > 0.0F)
            {
                ...
                hierMesh().chunkSetAngles("SkiR1_D0", com.maddox.il2.ai.World.Rnd().nextFloat(-f4, f4), com.maddox.il2.ai.World.Rnd().nextFloat(-f4 * 2.0F, f4 * 2.0F) + skiAngleR, com.maddox.il2.ai.World.Rnd().nextFloat(f4, f4));
            ...
            } else
            {
                float f6 = 1.0F;
                if(f5 < 0.5F)
                    f6 = com.maddox.il2.objects.air.Aircraft.cvt(f5, 0.0F, 0.5F, 1.0F, 0.95F);
                else
                    f6 = com.maddox.il2.objects.air.Aircraft.cvt(f5, 0.5F, 1.0F, 0.95F, 1.0F);
            ...
            } else
            {
                float f7 = 1.0F;
                if(f5 < 0.5F)
                    f7 = com.maddox.il2.objects.air.Aircraft.cvt(f5, 0.0F, 0.5F, 1.0F, 0.95F);
                else
                    f7 = com.maddox.il2.objects.air.Aircraft.cvt(f5, 0.5F, 1.0F, 0.95F, 1.0F);
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.I_16FixedSkis.class;
