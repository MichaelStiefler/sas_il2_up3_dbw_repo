...
public class CockpitB17F extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitB17F this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB17F.this.fm != null) {
        CockpitB17F.access$102(CockpitB17F.this, CockpitB17F.this.setOld);
        CockpitB17F.access$202(CockpitB17F.this, CockpitB17F.this.setNew);
        CockpitB17F.access$302(CockpitB17F.this, CockpitB17F.this.setTmp);
        ...
        CockpitB17F.this.setNew.waypointAzimuth.setDeg(CockpitB17F.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitB17F.this.setNew.waypointDeviation.setDeg(CockpitB17F.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB17F.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitB17F.this.setNew.vspeed = ((199.0F * CockpitB17F.this.setOld.vspeed + CockpitB17F.this.fm.getVertSpeed()) / 200.0F);
      }
