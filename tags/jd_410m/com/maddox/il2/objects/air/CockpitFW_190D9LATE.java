  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW_190D9LATE.this.fm != null) {
        ...
        CockpitFW_190D9LATE.this.setNew.throttle = ((10.0F * CockpitFW_190D9LATE.this.setOld.throttle + CockpitFW_190D9LATE.this.fm.CT.PowerControl) / 11.0F);
        CockpitFW_190D9LATE.this.setNew.vspeed = ((499.0F * CockpitFW_190D9LATE.this.setOld.vspeed + CockpitFW_190D9LATE.this.fm.getVertSpeed()) / 500.0F);

        float f = CockpitFW_190D9LATE.this.waypointAzimuth();
        if (CockpitFW_190D9LATE.this.useRealisticNavigationInstruments())
        {
          CockpitFW_190D9LATE.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
          CockpitFW_190D9LATE.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
        }
        else
        {
        ...
        CockpitFW_190D9LATE.this.setNew.turn = ((12.0F * CockpitFW_190D9LATE.this.setOld.turn + CockpitFW_190D9LATE.this.w.z) / 13.0F);

        CockpitFW_190D9LATE.this.setNew.beaconDirection = ((10.0F * CockpitFW_190D9LATE.this.setOld.beaconDirection + CockpitFW_190D9LATE.this.getBeaconDirection()) / 11.0F);
        CockpitFW_190D9LATE.this.setNew.beaconRange = ((10.0F * CockpitFW_190D9LATE.this.setOld.beaconRange + CockpitFW_190D9LATE.this.getBeaconRange()) / 11.0F);
      }
      return true;
    }
  }
