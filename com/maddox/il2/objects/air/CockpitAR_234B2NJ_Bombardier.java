...
// Source File Name:   CockpitAR_234B2NJ_Bombardier.java
...
//            CockpitPilot, AR_234B2NJ

public class CockpitAR_234B2NJ_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.AR_234B2NJ)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.AR_234B2NJ)aircraft()).fSightCurSideslip;
    ...
    {
        super("3DO/Cockpit/Ar-234B-2-Bombardier/234NJbom.him", "he111");
        bEntered = false;
        bBAiming = false;
        try
        {
        ...
        try
        {
            ...
            com.maddox.il2.engine.HookNamed hooknamed1 = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "CAMERA");
            hooknamed1.computePos(((com.maddox.il2.engine.Actor) (this)), pos.getAbs(), loc1);
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bBAiming)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.AR_234B2NJ)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.AR_234B2NJ)aircraft()).fSightCurReadyness > 0.93F;
