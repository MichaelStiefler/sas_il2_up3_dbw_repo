...
public class CockpitHS129 extends CockpitPilot
{
  private float tmp;
  ...
  public CockpitHS129()
  {
    super("3DO/Cockpit/HS129/hier.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPress2", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3.0F, 0.0F, 135.0F), 0.0F, 0.0F);
    ...
    if (this.gun[1] != null)
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_AmmoCounter2", cvt(this.gun[2].countBullets(), 0.0F, 125.0F, 15.0F, 0.0F), 0.0F, 0.0F);
    if (this.gun[2] != null)
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_AmmoCounter3", cvt(this.gun[1].countBullets(), 0.0F, 500.0F, 15.0F, 0.0F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      CockpitHS129.access$002(CockpitHS129.this, CockpitHS129.this.setOld);
      CockpitHS129.access$102(CockpitHS129.this, CockpitHS129.this.setNew);
      CockpitHS129.access$202(CockpitHS129.this, CockpitHS129.this.setTmp);
      CockpitHS129.this.setNew.altimeter = CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitHS129.this.cockpitDimControl)
      {
        if (CockpitHS129.this.setNew.dimPosition > 0.0F)
          CockpitHS129.this.setNew.dimPosition = (CockpitHS129.this.setOld.dimPosition - 0.05F);
      }
      else if (CockpitHS129.this.setNew.dimPosition < 1.0F)
        CockpitHS129.this.setNew.dimPosition = (CockpitHS129.this.setOld.dimPosition + 0.05F);
      CockpitHS129.this.setNew.throttle1 = (0.91F * CockpitHS129.this.setOld.throttle1 + 0.09F * CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitHS129.this.setNew.throttle2 = (0.91F * CockpitHS129.this.setOld.throttle2 + 0.09F * CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitHS129.this.setNew.mix1 = (0.88F * CockpitHS129.this.setOld.mix1 + 0.12F * CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitHS129.this.setNew.mix2 = (0.88F * CockpitHS129.this.setOld.mix2 + 0.12F * CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitHS129.this.setNew.azimuth = CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitHS129.this.setOld.azimuth > 270.0F) && (CockpitHS129.this.setNew.azimuth < 90.0F))
        CockpitHS129.this.setOld.azimuth -= 360.0F;
      if ((CockpitHS129.this.setOld.azimuth < 90.0F) && (CockpitHS129.this.setNew.azimuth > 270.0F))
        CockpitHS129.this.setOld.azimuth += 360.0F;
      CockpitHS129.this.setNew.waypointAzimuth = ((10.0F * CockpitHS129.this.setOld.waypointAzimuth + (CockpitHS129.this.waypointAzimuth() - CockpitHS129.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitHS129.this.buzzerFX((CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.999999F) && (CockpitHS129.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.0F));
      return true;
    }
  ...
  private class Variables
  {
    ...
    float mix1;
    float mix2;
    private final CockpitHS129 this$0;
