...
public class SPITFIRE8CLP extends com.maddox.il2.objects.air.SPITFIRE
{
    ...
    {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.SPITFIRE8CLP.cvt(f, 0.0F, 0.6F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.SPITFIRE8CLP.cvt(f, 0.2F, 1.0F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, com.maddox.il2.objects.air.SPITFIRE8CLP.cvt(f, 0.01F, 0.99F, 0.0F, -75F), 0.0F);
        hiermesh.chunkSetAngles("GearC3_D0", 0.0F, 0.0F, 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.SPITFIRE8CLP.cvt(f, 0.01F, 0.09F, 0.0F, -75F), 0.0F);
        hiermesh.chunkSetAngles("GearC5_D0", 0.0F, com.maddox.il2.objects.air.SPITFIRE8CLP.cvt(f, 0.01F, 0.09F, 0.0F, -75F), 0.0F);
    }
    ...
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.SPITFIRE8CLP.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.247F, 0.0F, -0.247F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        xyz[2] = com.maddox.il2.objects.air.SPITFIRE8CLP.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.247F, 0.0F, 0.247F);
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Spitfire-LF-VIII-M66-18-CW.fmd");
        ...
        com.maddox.il2.objects.air.SPITFIRE8CLP.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0, 1, 1, 9
        });
        com.maddox.il2.objects.air.SPITFIRE8CLP.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02", "_ExternalDev08"
        });
        com.maddox.il2.objects.air.SPITFIRE8CLP.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SPITFIRE8CLP.weaponsRegister(class1, "30gal", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SPITFIRE8CLP.weaponsRegister(class1, "45gal", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SPITFIRE8CLP.weaponsRegister(class1, "90gal", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SPITFIRE8CLP.weaponsRegister(class1, "none", new java.lang.String[] {
