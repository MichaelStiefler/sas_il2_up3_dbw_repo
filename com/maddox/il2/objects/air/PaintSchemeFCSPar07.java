    ...
    public void prepareNum(java.lang.Class class1, com.maddox.il2.engine.HierMesh hiermesh, com.maddox.il2.ai.Regiment regiment, int i, int j, int k)
    {
        ...
        if(regiment.country() == com.maddox.il2.objects.air.PaintScheme.countryRussia)
        {
            ...
            if(i1 == 1)
                ...
                f = 0.9F;
            if(k < 10)
                changeMat(hiermesh, "Overlay1", "psFCS01RUSCNUM" + l + i + "0" + k + i1, "Russian/0" + k + ".tga", f, f, f);
            else
        ...
        if(regiment.country() != com.maddox.il2.objects.air.PaintScheme.countryNoName)
        {
            ...
            if(j1 == 1)
                ...
                f1 = 0.9F;
            if(k < 10)
                changeMat(hiermesh, "Overlay8", "psFCS01RUSCNUM" + l + i + "0" + k + j1, "Russian/0" + k + ".tga", f1, f1, f1);
            else
