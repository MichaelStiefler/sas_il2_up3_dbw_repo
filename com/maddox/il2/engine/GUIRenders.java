...
public class GUIRenders extends com.maddox.gwindow.GWindow
{
    public class WinRenders extends com.maddox.il2.engine.Renders
    {
        ...
        {
            parentRender = com.maddox.il2.engine.Renders.currentRender;
            parentCamera = com.maddox.il2.engine.Renders.currentCamera;
            parentLightEnv = com.maddox.il2.engine.Renders.currentLightEnv;
            com.maddox.il2.engine.Renders.currentRenders = this;
        }

        protected void popRenders(boolean flag)
        {
            com.maddox.il2.engine.Renders.currentRender = parentRender;
            com.maddox.il2.engine.Renders.currentCamera = parentCamera;
            com.maddox.il2.engine.Renders.currentLightEnv = parentLightEnv;
            com.maddox.il2.engine.Renders.currentRenders = parentRender.renders();
            parentRender = null;
            com.maddox.il2.engine.Renders.currentCamera.activate(1.0F, com.maddox.il2.engine.RendersMain.width(), com.maddox.il2.engine.RendersMain.height(), rootViewX, rootViewY, rootViewDX, rootViewDY);
            if(!flag)
                com.maddox.il2.engine.Renders.currentLightEnv.activate();
        }

        protected void activateCamera()
        {
            com.maddox.il2.engine.Renders.currentCamera.activate(1.0F, com.maddox.il2.engine.RendersMain.width(), com.maddox.il2.engine.RendersMain.height(), wViewX, wViewY, wViewDX, wViewDY, wClipX, wClipY, wClipDX, wClipDY);
        }
        ...
        public void doPreRender()
        {
            ...
            for(int i = 0; i < j; i++)
            {
                com.maddox.il2.engine.Renders.currentRender = (com.maddox.il2.engine.Render)renderArray[i];
                if(com.maddox.il2.engine.Renders.currentRender == null)
                    break;
                com.maddox.il2.engine.Renders.currentCamera = com.maddox.il2.engine.Renders.currentRender.getCamera();
                if(com.maddox.il2.engine.Renders.currentRender.isShow() && com.maddox.il2.engine.Renders.currentCamera != null && com.maddox.il2.engine.RenderContext.bPreRenderEnable)
                {
                    computeClip();
                    if(!bWClipped)
                    {
                        activateCamera();
                        com.maddox.il2.engine.Renders.currentRender.preRender();
                    }
                }
            }
        ...
        public void doRender()
        {
            ...
            for(int i = 0; i < j; i++)
            {
                ...
                if(com.maddox.il2.engine.Renders.currentRender == null)
                    break;
                com.maddox.il2.engine.Renders.currentCamera = com.maddox.il2.engine.Renders.currentRender.getCamera();
                if(com.maddox.il2.engine.Renders.currentRender.isShow() && com.maddox.il2.engine.Renders.currentCamera != null)
                {
                    computeClip();
                    if(!bWClipped)
                    {
                        _clearViewPort();
                        activateCamera();
                        com.maddox.il2.engine.Renders.currentLightEnv = com.maddox.il2.engine.Renders.currentRender.getLightEnv();
                        if(com.maddox.il2.engine.Renders.currentLightEnv == null)
                            com.maddox.il2.engine.Renders.currentLightEnv = com.maddox.il2.engine.Engine.cur.lightEnv;
                        com.maddox.il2.engine.Renders.currentLightEnv.activate();
                        com.maddox.il2.engine.Render.prepareStates();
                        com.maddox.il2.engine.Renders.currentRender.render();
                        com.maddox.il2.engine.Render.flush();
                    }
                    if(com.maddox.rts.Time.isPaused())
                        com.maddox.il2.engine.Renders.currentCamera.pos.updateCurrent();
                }
            }
        ...
        {
            if(com.maddox.il2.engine.Renders.currentRender.isClearColor() || com.maddox.il2.engine.Renders.currentRender.isClearDepth() || com.maddox.il2.engine.Renders.currentRender.isClearStencil())
            {
                ...
                com.maddox.opengl.gl.LoadIdentity();
                if(com.maddox.il2.engine.Renders.currentRender.isClearColor())
                {
                    com.maddox.JGP.Color4f color4f = com.maddox.il2.engine.Renders.currentRender.getClearColor();
                ...
                float f;
                if(com.maddox.il2.engine.Renders.currentRender.isClearDepth())
                {
                    f = -com.maddox.il2.engine.Renders.currentRender.getClearDepth();
                ...
                if(com.maddox.il2.engine.Renders.currentRender.bClearStencil && com.maddox.il2.engine.Config.cur.windowStencilBits != 0)
                {
