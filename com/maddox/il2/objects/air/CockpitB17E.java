...
public class CockpitB17E extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitB17E this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB17E.this.fm != null) {
        CockpitB17E.access$102(CockpitB17E.this, CockpitB17E.this.setOld);
        CockpitB17E.access$202(CockpitB17E.this, CockpitB17E.this.setNew);
        CockpitB17E.access$302(CockpitB17E.this, CockpitB17E.this.setTmp);
        ...
        CockpitB17E.this.setNew.waypointAzimuth.setDeg(CockpitB17E.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitB17E.this.setNew.waypointDeviation.setDeg(CockpitB17E.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB17E.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitB17E.this.setNew.vspeed = ((199.0F * CockpitB17E.this.setOld.vspeed + CockpitB17E.this.fm.getVertSpeed()) / 200.0F);
      }
