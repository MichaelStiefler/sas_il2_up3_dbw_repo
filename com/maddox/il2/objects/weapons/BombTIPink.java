...
// Source File Name:   BombTIPink.java
...
public class BombTIPink extends com.maddox.il2.objects.weapons.Bomb
{
        ...
        if((double)charge < 1.01D)
        {
            ...
            if(com.maddox.il2.engine.Actor.isValid(actor))
            {
                ...
                for(int i = 0; i < 60; i++)
                {
                    ...
                    com.maddox.il2.objects.weapons.BombTiPk bombtipk = new BombTiPk();
                    bombtipk.pos.setUpdateEnable(true);
                    bombtipk.pos.setAbs(point3d, orient);
                    bombtipk.pos.reset();
                    bombtipk.start();
                    bombtipk.setOwner(actor, false, false, false);
                    bombtipk.setSpeed(vector3d);
                }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.weapons.BombTIPink.class;
