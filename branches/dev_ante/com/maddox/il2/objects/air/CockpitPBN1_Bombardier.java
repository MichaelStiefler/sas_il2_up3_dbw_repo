...
public class CockpitPBN1_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((PBN1)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((PBN1)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPBN1_Bombardier.this.bEntered) {
        float f1 = ((PBN1)CockpitPBN1_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((PBN1)CockpitPBN1_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitPBN1_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitPBN1_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
