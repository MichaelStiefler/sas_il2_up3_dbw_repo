...
public class CockpitI_16TYPE6 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    {
      f = cvt(interp(this.setNew.dimPos, this.setOld.dimPos, paramFloat), 0.0F, 1.0F, 0.0F, 90.0F);
      this.mesh.chunkSetAngles("DarkGlass", 0.0F, f, 0.0F);
    }
  }
  ...
  public void setTubeSight(boolean paramBoolean)
  {
    ...
    this.mesh.chunkVisible("Z_sight_cap", paramBoolean);
    this.mesh.chunkVisible("tubeSight", paramBoolean);
    this.mesh.chunkVisible("tubeSightLens", paramBoolean);
    this.mesh.chunkVisible("tube_inside", paramBoolean);
    this.mesh.chunkVisible("TubeSightEyePiece", paramBoolean);
    this.mesh.chunkVisible("tube_mask", paramBoolean);
    this.mesh.chunkVisible("Z_sight_cap_inside", paramBoolean);
    this.mesh.chunkVisible("SightCapSwitch", paramBoolean);

    this.mesh.chunkVisible("Z_Z_RETICLE", !paramBoolean);
    this.mesh.chunkVisible("Z_Z_MASK", !paramBoolean);
    this.mesh.chunkVisible("pricel", !paramBoolean);
    this.mesh.chunkVisible("DarkGlass", !paramBoolean);
    this.mesh.chunkVisible("target", !paramBoolean);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick() { if (CockpitI_16TYPE6.this.fm != null) {
        ...
        CockpitI_16TYPE6.this.setNew.throttle = ((10.0F * CockpitI_16TYPE6.this.setOld.throttle + CockpitI_16TYPE6.this.fm.CT.PowerControl) / 11.0F);

        CockpitI_16TYPE6.this.setNew.prop = ((10.0F * CockpitI_16TYPE6.this.setOld.prop + CockpitI_16TYPE6.this.fm.EI.engines[0].getControlProp()) / 11.0F);

        CockpitI_16TYPE6.this.setNew.altimeter = CockpitI_16TYPE6.this.fm.getAltitude();
        if (Math.abs(CockpitI_16TYPE6.this.fm.Or.getKren()) < 30.0F) {
          CockpitI_16TYPE6.this.setNew.azimuth = ((35.0F * CockpitI_16TYPE6.this.setOld.azimuth + -CockpitI_16TYPE6.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        CockpitI_16TYPE6.this.setNew.vspeed = ((199.0F * CockpitI_16TYPE6.this.setOld.vspeed + CockpitI_16TYPE6.this.fm.getVertSpeed()) / 200.0F);
