...
public class CockpitLanc_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((LANCASTER)aircraft()).fSightCurForwardAngle;
                float f1 = -((LANCASTER)aircraft()).fSightCurSideslip;
    ...
    {
        super.mesh.chunkSetAngles("zMark1", ((LANCASTER)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((LANCASTER)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
