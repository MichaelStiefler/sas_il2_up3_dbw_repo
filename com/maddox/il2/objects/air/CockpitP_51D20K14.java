...
public class CockpitP_51D20K14 extends CockpitPilot
{
  ...
  {
    int i = ((P_51D20NA)aircraft()).k14Mode;
    boolean bool = i < 2;
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Mode1", -90.0F * this.setNew.k14mode, 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Altimeter3", cvt(interp(this.setNew.altimeter, this.setOld.altimeter, paramFloat), 0.0F, 30480.0F, 0.0F, 360.0F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitP_51D20K14.access$102(CockpitP_51D20K14.this, CockpitP_51D20K14.this.setOld); CockpitP_51D20K14.access$202(CockpitP_51D20K14.this, CockpitP_51D20K14.this.setNew); CockpitP_51D20K14.access$302(CockpitP_51D20K14.this, CockpitP_51D20K14.this.setTmp);

        CockpitP_51D20K14.this.setNew.throttle = (0.85F * CockpitP_51D20K14.this.setOld.throttle + CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitP_51D20K14.this.setNew.prop = (0.85F * CockpitP_51D20K14.this.setOld.prop + CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitP_51D20K14.this.setNew.stage = (0.85F * CockpitP_51D20K14.this.setOld.stage + CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor() * 0.15F);
        CockpitP_51D20K14.this.setNew.mix = (0.85F * CockpitP_51D20K14.this.setOld.mix + CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix() * 0.15F);
        CockpitP_51D20K14.this.setNew.altimeter = CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitP_51D20K14.this.setNew.azimuth = ((35.0F * CockpitP_51D20K14.this.setOld.azimuth + -CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw()) / 36.0F);
        if ((CockpitP_51D20K14.this.setOld.azimuth > 270.0F) && (CockpitP_51D20K14.this.setNew.azimuth < 90.0F)) CockpitP_51D20K14.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_51D20K14.this.setOld.azimuth < 90.0F) && (CockpitP_51D20K14.this.setNew.azimuth > 270.0F)) CockpitP_51D20K14.this.setOld.azimuth += 360.0F;
        CockpitP_51D20K14.this.setNew.waypointAzimuth = ((10.0F * CockpitP_51D20K14.this.setOld.waypointAzimuth + CockpitP_51D20K14.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitP_51D20K14.this.setNew.vspeed = ((199.0F * CockpitP_51D20K14.this.setOld.vspeed + CockpitP_51D20K14.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);

        float f4 = ((P_51D20NA)CockpitP_51D20K14.this.aircraft()).k14Distance;
        CockpitP_51D20K14.this.setNew.k14w = (5.0F * CockpitP_51D20K14.k14TargetWingspanScale[((P_51D20NA)CockpitP_51D20K14.this.aircraft()).k14WingspanType] / f4);
        ...
        float f3 = CockpitP_51D20K14.this.floatindex((f4 - 200.0F) * 0.04F, CockpitP_51D20K14.k14BulletDrop) - CockpitP_51D20K14.k14BulletDrop[0];
        f2 += (float)Math.toDegrees(Math.atan(f3 / f4));

        CockpitP_51D20K14.this.setNew.k14x = (0.92F * CockpitP_51D20K14.this.setOld.k14x + 0.08F * f1);
        CockpitP_51D20K14.this.setNew.k14y = (0.92F * CockpitP_51D20K14.this.setOld.k14y + 0.08F * f2);
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitP_51D20K14 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitP_51D20K14.1 arg2) { this();
    }
  }
}