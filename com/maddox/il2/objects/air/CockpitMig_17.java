...
public class CockpitMig_17 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float f) {
    if (Mig_17.bChangedPit)
    {
      Mig_17.bChangedPit = false;
    }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMig_17.this.fm != null) {
        CockpitMig_17.access$102(CockpitMig_17.this, CockpitMig_17.this.setOld);
        CockpitMig_17.access$202(CockpitMig_17.this, CockpitMig_17.this.setNew);
        CockpitMig_17.access$302(CockpitMig_17.this, CockpitMig_17.this.setTmp);
        CockpitMig_17.this.setNew.throttle = (0.9F * CockpitMig_17.this.setOld.throttle + CockpitMig_17.this.fm.CT.PowerControl * 0.1F);
        CockpitMig_17.this.setNew.starter = (0.94F * CockpitMig_17.this.setOld.starter + 0.06F * ((CockpitMig_17.this.fm.EI.engines[0].getStage() > 0) && (CockpitMig_17.this.fm.EI.engines[0].getStage() < 6) ? 1.0F : 0.0F));
        ...
        float f = CockpitMig_17.this.waypointAzimuth();
        CockpitMig_17.this.setNew.waypointAzimuth.setDeg(CockpitMig_17.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitMig_17.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitMig_17.this.setNew.vspeed = ((199.0F * CockpitMig_17.this.setOld.vspeed + CockpitMig_17.this.fm.getVertSpeed()) / 200.0F);
        if (CockpitMig_17.this.tFX != null)
          if (((Mig_17)CockpitMig_17.this.aircraft()).ist()) {
            if (!CockpitMig_17.this.tFX.isPlaying())
              CockpitMig_17.this.tFX.play();
          }
          else CockpitMig_17.this.tFX.stop();
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    private final CockpitMig_17 this$0;
