...
public abstract class Scheme5 extends AircraftLH
{
  ...
  {
    hierMesh().chunkSetAngles("Rudder1_D0", 0.0F, -40.0F * paramFloat, 0.0F);
    hierMesh().chunkSetAngles("Rudder2_D0", 0.0F, -40.0F * paramFloat, 0.0F);
  }

  protected void moveElevator(float paramFloat)
  {
    hierMesh().chunkSetAngles("VatorL_D0", 0.0F, -40.0F * paramFloat, 0.0F);
    hierMesh().chunkSetAngles("VatorR_D0", 0.0F, -40.0F * paramFloat, 0.0F);
  }
}