    ...
    implements com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeAcePlane
{
    ...
    public void update(float f)
    {
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL_D0", 0.0F, com.maddox.il2.objects.air.BF_109G6HEPPES.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F), 0.0F);
            hierMesh().chunkSetAngles("SlatR_D0", 0.0F, com.maddox.il2.objects.air.BF_109G6HEPPES.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F), 0.0F);
        }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 1, 1, 1, 1, 1, 9, 9, 
            9, 9, 3, 3, 3, 3, 3
        });
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, null, null, 
            null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "U3-MK108", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMK108ki 65", null, null, null, null, null, null, 
            null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "R1-SC250", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "R1-SC500", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900", null, 
            null, null, "BombGunSC500 1", null, null, null, null
        });
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "R2-SC50", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "R3-DROPTANK", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900", "FuelTankGun_Type_D", 
            null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "R5-MK108", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "R6-MG151-20", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "U3R6-MG151-20", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 65", null, "MGunMG15120MGk 135", "MGunMG15120MGk 135", null, null, null, null, 
            "PylonMG15120", "PylonMG15120", null, null, null, null, null
        });
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "R3R6-MG151-20", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109G6HEPPES.weaponsRegister(class1, "none", new java.lang.String[] {
