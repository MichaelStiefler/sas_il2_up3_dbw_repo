...
// Source File Name:   CockpitG4M2E_LGunner.java
...
public class CockpitG4M2E_LGunner extends com.maddox.il2.objects.air.CockpitGunner
{
    ...
    public void moveGun(com.maddox.il2.engine.Orient orient)
    {
        ...
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetAngles("Turret5A", 0.0F, f, 0.0F);
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetAngles("Turret5B", 0.0F, f1, 0.0F);
    }
    ...
    public void clipAnglesGun(com.maddox.il2.engine.Orient orient)
    {
        ...
        if(f < 0.0F)
        {
            if(f1 < ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, -30F, 0.0F, -6F, -23F))
                f1 = ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, -30F, 0.0F, -6F, -23F);
            if(f1 > ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, -30F, 0.0F, 22F, 33F))
                f1 = ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, -30F, 0.0F, 22F, 33F);
        } else
        if(f < 30F)
        {
            if(f1 < ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, 0.0F, 30F, -23F, -16F))
                f1 = ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, 0.0F, 30F, -23F, -16F);
            if(f1 > ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, 0.0F, 10F, 33F, 45F))
                f1 = ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, 0.0F, 10F, 33F, 45F);
        } else
        if(f1 < ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, 30F, 60F, -16F, -10F))
            f1 = ((com.maddox.il2.objects.air.Cockpit)this).cvt(f, 30F, 60F, -16F, -10F);
    ...
    {
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetAngles("Turret4A", 0.0F, -((com.maddox.il2.objects.sounds.SndAircraft) (((com.maddox.il2.objects.air.Cockpit)this).aircraft())).FM.turret[3].tu[0], 0.0F);
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetAngles("Turret4B", 0.0F, ((com.maddox.il2.objects.sounds.SndAircraft) (((com.maddox.il2.objects.air.Cockpit)this).aircraft())).FM.turret[3].tu[1], 0.0F);
        if(!((com.maddox.il2.objects.air.CockpitGunner)this).isRealMode())
            return;
        ...
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetLocate("Turret5C", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
    }
    ...
    {
        super("3DO/Cockpit/G4M2E-LGun/hier.him", "he111_gunner");
        curMat = null;
        iCocking = 0;
    }
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (com.maddox.rts.CLASS.THIS())), "aiTuretNum", 3);
        com.maddox.rts.Property.set(((java.lang.Object) (com.maddox.rts.CLASS.THIS())), "weaponControlNum", 13);
