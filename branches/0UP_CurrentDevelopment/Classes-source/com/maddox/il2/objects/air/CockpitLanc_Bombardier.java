...
public class CockpitLanc_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    {
        super.mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.LANCASTER)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.LANCASTER)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
