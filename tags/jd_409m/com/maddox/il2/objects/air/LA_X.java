  ...
  implements TypeFighter
{
  ...
  public void moveSteering(float paramFloat) { if (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.CT.getGear() < 0.98F) return;
    hierMesh().chunkSetAngles("GearC2_D0", 0.0F, paramFloat, 0.0F); }

  public void moveWheelSink() {
    resetYPRmodifier();
    Aircraft.xyz[2] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.22F, 0.0F, 0.2F);
    hierMesh().chunkSetLocate("GearL8_D0", Aircraft.xyz, Aircraft.ypr);
    Aircraft.xyz[2] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.22F, 0.0F, 0.2F);
  ...
  protected boolean cutFM(int paramInt1, int paramInt2, Actor paramActor)
  {
    switch (paramInt1) {
    case 33:
      if (World.Rnd().nextFloat() < 0.233F) this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.hitTank(this, 1, 6);
      return super.cutFM(34, paramInt2, paramActor);
    case 36:
      if (World.Rnd().nextFloat() < 0.233F) this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.hitTank(this, 2, 6);
  ...
  public void update(float paramFloat)
  {
    if (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.getSpeed() > 5.0F) {
      resetYPRmodifier();
      Aircraft.xyz[1] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.getAOA(), 6.8F, 11.0F, 0.0F, -0.05F);
      Aircraft.xyz[2] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.getAOA(), 6.8F, 11.0F, 0.0F, 0.025F);
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxarmor")) {
        if (paramString.endsWith("p1")) {
          ...
          getEnergyPastArmor(18.150002F / (1.0E-005F + (float)Math.abs(Aircraft.v1.jdField_x_of_type_Double)), paramShot);
        } else if (paramString.endsWith("g2")) {
          getEnergyPastArmor(21.780001F / (1.0E-005F + (float)Math.abs(Aircraft.v1.jdField_x_of_type_Double)), paramShot);
        }
        return;
      }
      if (paramString.startsWith("xxcontrols")) {
        if (Aircraft.Pd.jdField_x_of_type_Double > -0.3549999892711639D) {
        ...
        else if (Aircraft.Pd.jdField_x_of_type_Double > -1.284999966621399D) {
    ...
    if ((paramString.startsWith("xcf")) || ((paramString.startsWith("xcockpit")) && (Aircraft.Pd.jdField_z_of_type_Double > 0.7329999804496765D))) {
    ...
    if (paramString.startsWith("xxcockpit")) {
      ...
      if ((Aircraft.Pd.jdField_z_of_type_Double > 0.6389999985694885D) && (Aircraft.Pd.jdField_x_of_type_Double < -1.041000008583069D))
