...
public class CockpitAR_196A3 extends CockpitPilot
{
    ...
    {
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.7F);
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getTangage(), -45F, 45F, 0.025F, -0.025F);
        ...
        super.mesh.chunkSetAngles("Z_FuelPres1", 0.0F, cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 0.3F, 0.0F, -180F), 0.0F);
        ...
        {
            resetYPRmodifier();
            Cockpit.xyz[0] = -0.133F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGear();
        ...
        resetYPRmodifier();
        Cockpit.xyz[0] = -0.118F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getFlap();
        super.mesh.chunkSetLocate("Z_Flap1", Cockpit.xyz, Cockpit.ypr);
        super.mesh.chunkSetAngles("Z_EnginePrim", 0.0F, ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getStage() <= 0 ? 0.0F : -36F, 0.0F);
