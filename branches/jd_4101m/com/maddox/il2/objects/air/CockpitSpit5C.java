...
public class CockpitSpit5C extends CockpitPilot
{
  ...
  public CockpitSpit5C()
  {
    ...
    if ((aircraft() instanceof SPITFIRE5C216LBS)) {
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_Throtle1", -51.799999F * interp(this.setNew.throttle, this.setOld.throttle, paramFloat), 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_Prop1", -57.0F * this.setNew.prop, 0.0F, 0.0F);
    this.mesh.chunkSetAngles("Z_Mixture1", -57.0F * this.setNew.mix, 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit5C.this.fm != null) {
        ...
        if (Math.abs(CockpitSpit5C.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit5C.this.setNew.azimuth = (0.97F * CockpitSpit5C.this.setOld.azimuth + 0.03F * -CockpitSpit5C.this.fm.Or.getYaw());
        }
