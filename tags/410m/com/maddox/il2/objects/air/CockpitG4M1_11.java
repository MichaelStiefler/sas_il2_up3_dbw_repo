...
public class CockpitG4M1_11 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        float f3 = floatindex(cvt(0.539957F * com.maddox.il2.fm.Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), speedometerScale);
        mesh.chunkSetAngles("Z_Speedometer1", f3, 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Speedometer2", f3, 0.0F, 0.0F);
        ...
        resetYPRmodifier();
        xyz[2] = cvt(setNew.vspeed, -15F, 15F, -0.055F, 0.055F);
        mesh.chunkSetLocate("Z_Climb1", xyz, ypr);
