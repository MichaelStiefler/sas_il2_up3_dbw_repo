    ...
    implements com.maddox.il2.ai.BulletEmitter
{
    ...
    public com.maddox.il2.objects.weapons.Bullet createNextBullet(com.maddox.JGP.Vector3d vector3d, int i, com.maddox.il2.engine.GunGeneric gungeneric, com.maddox.il2.engine.Loc loc1, com.maddox.JGP.Vector3d vector3d1, long l)
    {
    ...
    public void doStartBullet(double d)
    {
        ...
        if(actor instanceof com.maddox.il2.objects.air.Aircraft)
        {
            ...
            if(com.maddox.il2.ai.World.cur().diffCur.Wind_N_Turbulence)
            {
                ...
                pos.getAbs(point3d);
                com.maddox.il2.ai.World.wind().getVectorWeapon(point3d, vWind);
        ...
        if((actor instanceof com.maddox.il2.objects.air.NetGunner) && com.maddox.il2.ai.World.isPlayerGunner())
            com.maddox.il2.ai.World.cur().scoreCounter.bulletsFire += prop.bulletsCluster;
        com.maddox.il2.objects.weapons.Bullet bullet = createNextBullet(vWind, i, this, loc1, v1, com.maddox.rts.Time.current() + (long)(int)(prop.bullet[i].timeLife * 1000F));
        ...
        if(com.maddox.il2.engine.Config.isUSE_RENDER() && bulletNum % prop.traceFreq == 0)
        {
            ...
            if(prop.bullet[i].traceTrail != null)
            {
                ...
                if(com.maddox.il2.engine.Actor.isValid(camera3d))
                {
                    ...
                    p1.add(point3d1, v1);
                    com.maddox.JGP.Point3d point3d2 = ((com.maddox.il2.engine.Actor) (camera3d)).pos.getAbsPoint();
    ...
    private static com.maddox.JGP.Vector3d vWind = new Vector3d();
