...
public class CockpitA_20G extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitA_20G.this.setNew.throttle1 = (0.9F * CockpitA_20G.this.setOld.throttle1 + 0.1F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitA_20G.this.setNew.prop1 = (0.9F * CockpitA_20G.this.setOld.prop1 + 0.1F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitA_20G.this.setNew.mix1 = (0.8F * CockpitA_20G.this.setOld.mix1 + 0.2F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitA_20G.this.setNew.throttle2 = (0.9F * CockpitA_20G.this.setOld.throttle2 + 0.1F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitA_20G.this.setNew.prop2 = (0.9F * CockpitA_20G.this.setOld.prop2 + 0.1F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
        CockpitA_20G.this.setNew.mix2 = (0.8F * CockpitA_20G.this.setOld.mix2 + 0.2F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
        CockpitA_20G.this.setNew.man1 = (0.92F * CockpitA_20G.this.setOld.man1 + 0.08F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitA_20G.this.setNew.man2 = (0.92F * CockpitA_20G.this.setOld.man2 + 0.08F * CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitA_20G.this.setNew.altimeter = CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitA_20G.this.setNew.azimuth.setDeg(CockpitA_20G.this.setOld.azimuth.getDeg(1.0F), CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitA_20G.this.setNew.vspeed = ((199.0F * CockpitA_20G.this.setOld.vspeed + CockpitA_20G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
