...
public class CockpitL2D extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitL2D.access$002(CockpitL2D.this, CockpitL2D.this.setOld);
        CockpitL2D.access$102(CockpitL2D.this, CockpitL2D.this.setNew);
        CockpitL2D.access$202(CockpitL2D.this, CockpitL2D.this.setTmp);
        CockpitL2D.this.setNew.throttle1 = (0.85F * CockpitL2D.this.setOld.throttle1 + CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitL2D.this.setNew.throttle2 = (0.85F * CockpitL2D.this.setOld.throttle2 + CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitL2D.this.setNew.prop1 = (0.85F * CockpitL2D.this.setOld.prop1 + CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitL2D.this.setNew.prop2 = (0.85F * CockpitL2D.this.setOld.prop2 + CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitL2D.this.setNew.altimeter = CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitL2D.this.waypointAzimuth();
        CockpitL2D.this.setNew.azimuth.setDeg(CockpitL2D.this.setOld.azimuth.getDeg(1.0F), CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitL2D.this.setNew.waypointAzimuth.setDeg(CockpitL2D.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitL2D.this.setNew.waypointDeviation.setDeg(CockpitL2D.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitL2D.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitL2D.this.setNew.vspeed = ((199.0F * CockpitL2D.this.setOld.vspeed + CockpitL2D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitL2D this$0;
