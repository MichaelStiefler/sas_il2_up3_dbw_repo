...
public class GUINetMission extends com.maddox.il2.game.GameState
{
    ...
    public static void setReflyTimer(com.maddox.il2.game.ZutiTimer_Refly zutitimer_refly)
    {
        reflyTimer = zutitimer_refly;
    }
    ...
    public static boolean isEnableReFly()
    {
        ...
        if(com.maddox.il2.game.Main.cur().mission.zutiMisc_DisableReflyForMissionDuration)
            return false;
        if(com.maddox.il2.game.Main.cur().mission.zutiMisc_EnableReflyOnlyIfBailedOrDied)
        {
            if(com.maddox.il2.game.ZutiSupportMethods.ZUTI_KIA_COUNTER > com.maddox.il2.game.Main.cur().mission.zutiMisc_MaxAllowedKIA)
                return false;
            if(com.maddox.il2.game.ZutiSupportMethods.ZUTI_KIA_DELAY_CLEARED || com.maddox.il2.gui.GUINetMission.isOkToReFly())
            {
                reflyTimer = null;
                return true;
            } else
        ...
        if(com.maddox.il2.ai.World.isPlayerParatrooper())
            return true;
        com.maddox.il2.objects.air.Aircraft aircraft = com.maddox.il2.ai.World.getPlayerAircraft();
        if(aircraft != null && (aircraft.FM.brakeShoe || com.maddox.il2.gui.GUINetMission.isStationaryOnCarrierDeck()))
            return true;
        return aircraft != null && aircraft.FM.Gears.isAnyDamaged() && aircraft.FM.Gears.onGround();
    }
    ...
    protected static com.maddox.il2.game.ZutiTimer_Refly reflyTimer = null;
