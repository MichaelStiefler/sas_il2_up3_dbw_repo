...
public class CockpitFW_190D9LATE extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    float f = this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.nitro / this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.maxNitro;
    f = (float)Math.sqrt(f);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW_190D9LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitFW_190D9LATE.access$102(CockpitFW_190D9LATE.this, CockpitFW_190D9LATE.this.setOld); CockpitFW_190D9LATE.access$202(CockpitFW_190D9LATE.this, CockpitFW_190D9LATE.this.setNew); CockpitFW_190D9LATE.access$302(CockpitFW_190D9LATE.this, CockpitFW_190D9LATE.this.setTmp);
        ...
        if (CockpitFW_190D9LATE.this.cockpitDimControl) {
          if (CockpitFW_190D9LATE.this.setNew.dimPosition > 0.0F) CockpitFW_190D9LATE.this.setNew.dimPosition = (CockpitFW_190D9LATE.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitFW_190D9LATE.this.setNew.dimPosition < 1.0F) CockpitFW_190D9LATE.this.setNew.dimPosition = (CockpitFW_190D9LATE.this.setOld.dimPosition + 0.05F);
        ...
        if ((CockpitFW_190D9LATE.this.setOld.azimuth > 270.0F) && (CockpitFW_190D9LATE.this.setNew.azimuth < 90.0F)) CockpitFW_190D9LATE.this.setOld.azimuth -= 360.0F;
        if ((CockpitFW_190D9LATE.this.setOld.azimuth < 90.0F) && (CockpitFW_190D9LATE.this.setNew.azimuth > 270.0F)) CockpitFW_190D9LATE.this.setOld.azimuth += 360.0F;
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitFW_190D9LATE.1 arg2) { this();
    }
  }
}