...
public class CockpitSpit8 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit8.this.fm != null) {
        CockpitSpit8.access$102(CockpitSpit8.this, CockpitSpit8.this.setOld); CockpitSpit8.access$202(CockpitSpit8.this, CockpitSpit8.this.setNew); CockpitSpit8.access$302(CockpitSpit8.this, CockpitSpit8.this.setTmp);
        ...
        if (Math.abs(CockpitSpit8.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit8.this.setNew.azimuth = (0.97F * CockpitSpit8.this.setOld.azimuth + 0.03F * -CockpitSpit8.this.fm.Or.getYaw());
        }
        if ((CockpitSpit8.this.setOld.azimuth > 270.0F) && (CockpitSpit8.this.setNew.azimuth < 90.0F)) CockpitSpit8.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit8.this.setOld.azimuth < 90.0F) && (CockpitSpit8.this.setNew.azimuth > 270.0F)) CockpitSpit8.this.setOld.azimuth += 360.0F;
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitSpit8.1 arg2) { this();
    }
  }
}