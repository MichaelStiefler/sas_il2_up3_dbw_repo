// Source File Name: CockpitKI_21_II.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitKI_21_II.this.fm != null) {
				...
				CockpitKI_21_II.this.setNew.throttle1 = (0.9F * CockpitKI_21_II.this.setOld.throttle1)
						+ (0.1F * CockpitKI_21_II.this.fm.EI.engines[0]
								.getControlThrottle());
				CockpitKI_21_II.this.setNew.prop1 = (0.9F * CockpitKI_21_II.this.setOld.prop1)
						+ (0.1F * CockpitKI_21_II.this.fm.EI.engines[0]
								.getControlProp());
				CockpitKI_21_II.this.setNew.mix1 = (0.8F * CockpitKI_21_II.this.setOld.mix1)
						+ (0.2F * CockpitKI_21_II.this.fm.EI.engines[0]
								.getControlMix());
				CockpitKI_21_II.this.setNew.throttle2 = (0.9F * CockpitKI_21_II.this.setOld.throttle2)
						+ (0.1F * CockpitKI_21_II.this.fm.EI.engines[1]
								.getControlThrottle());
				CockpitKI_21_II.this.setNew.prop2 = (0.9F * CockpitKI_21_II.this.setOld.prop2)
						+ (0.1F * CockpitKI_21_II.this.fm.EI.engines[1]
								.getControlProp());
				CockpitKI_21_II.this.setNew.mix2 = (0.8F * CockpitKI_21_II.this.setOld.mix2)
						+ (0.2F * CockpitKI_21_II.this.fm.EI.engines[1]
								.getControlMix());
				CockpitKI_21_II.this.setNew.man1 = (0.92F * CockpitKI_21_II.this.setOld.man1)
						+ (0.08F * CockpitKI_21_II.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitKI_21_II.this.setNew.man2 = (0.92F * CockpitKI_21_II.this.setOld.man2)
						+ (0.08F * CockpitKI_21_II.this.fm.EI.engines[1]
								.getManifoldPressure());
				CockpitKI_21_II.this.setNew.altimeter = CockpitKI_21_II.this.fm
						.getAltitude();
				CockpitKI_21_II.this.setNew.azimuth.setDeg(
						CockpitKI_21_II.this.setOld.azimuth.getDeg(1.0F),
						CockpitKI_21_II.this.fm.Or.azimut());
				CockpitKI_21_II.this.setNew.vspeed = ((199F * CockpitKI_21_II.this.setOld.vspeed) + CockpitKI_21_II.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
				...
				.chunkVisible(
						...
						this.aircraft().hierMesh().isChunkVisible("CF_D0")
								|| this.aircraft().hierMesh()
										.isChunkVisible("CF_D1")
								|| this.aircraft().hierMesh()
										.isChunkVisible("CF_D2")
								|| this.aircraft().hierMesh()
										.isChunkVisible("CF_D3"));
		super.doFocusLeave();
	}
