...
public class CockpitYP_80 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f4 = ((com.maddox.il2.objects.air.P_80A)aircraft()).k14Distance;
                setNew.k14w = (5F * com.maddox.il2.objects.air.CockpitYP_80.k14TargetWingspanScale[((com.maddox.il2.objects.air.P_80A)aircraft()).k14WingspanType]) / f4;
                ...
                float f3 = floatindex((f4 - 200F) * 0.04F, com.maddox.il2.objects.air.CockpitYP_80.k14BulletDrop) - com.maddox.il2.objects.air.CockpitYP_80.k14BulletDrop[0];
                f2 += (float)java.lang.Math.toDegrees(java.lang.Math.atan(f3 / f4));
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Compass3", 90F + setNew.azimuth.getDeg(f1), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Compass2", setNew.waypointAzimuth.getDeg(0.1F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Compass1", setNew.azimuth.getDeg(f1), 0.0F, 0.0F);
