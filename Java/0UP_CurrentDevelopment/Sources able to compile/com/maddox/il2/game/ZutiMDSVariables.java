...
public class ZutiMDSVariables
{
	...
	public boolean enabledResourcesManagement_RedSide = false;
	public boolean enabledResourcesManagement_BlueSide = false;
	...
	private void loadMiscellaneousVariables(SectFile sectfile)
	{
		try
		{
			...
			ZutiSupportMethods_GUI.MISSION_FLY_DELAY = sectfile.get(ZutiMDSSection_Miscellaneous.SECTION_ID, "ZutiMisc_MissionFlyDelay", 0, 0, 99999);
		}
		catch(Exception ex)
		{
			ex.printStackTrace();
	...
	public void resetVariables()
	{
		...
		objectsMap_Red = null;
		enabledResourcesManagement_RedSide = false;
		enabledResourcesManagement_BlueSide = false;
	...
	public static void loadResources(SectFile sectfile, boolean printResults)
	{
		...
		if (sectionId >= 0)
		{
			Mission.MDS_VARIABLES().enabledResourcesManagement_RedSide = true;
		...
		if (sectionId >= 0)
		{
			Mission.MDS_VARIABLES().enabledResourcesManagement_BlueSide = true;
