// Source File Name: CockpitB25C25.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB25C25.this.fm != null) {
				...
				CockpitB25C25.this.setNew.throttle1 = (0.85F * CockpitB25C25.this.setOld.throttle1)
						+ (CockpitB25C25.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitB25C25.this.setNew.throttle2 = (0.85F * CockpitB25C25.this.setOld.throttle2)
						+ (CockpitB25C25.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitB25C25.this.setNew.prop1 = (0.85F * CockpitB25C25.this.setOld.prop1)
						+ (CockpitB25C25.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitB25C25.this.setNew.prop2 = (0.85F * CockpitB25C25.this.setOld.prop2)
						+ (CockpitB25C25.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitB25C25.this.setNew.altimeter = CockpitB25C25.this.fm
						.getAltitude();
				float f = CockpitB25C25.this.waypointAzimuth();
				CockpitB25C25.this.setNew.azimuth.setDeg(
						CockpitB25C25.this.setOld.azimuth.getDeg(1.0F),
						CockpitB25C25.this.fm.Or.azimut());
				CockpitB25C25.this.setNew.waypointAzimuth.setDeg(
						CockpitB25C25.this.setOld.waypointAzimuth.getDeg(1.0F),
						f);
				CockpitB25C25.this.setNew.waypointDeviation.setDeg(
						CockpitB25C25.this.setOld.waypointDeviation
								.getDeg(0.1F),
						(f - CockpitB25C25.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitB25C25.this.setNew.vspeed = ((199F * CockpitB25C25.this.setOld.vspeed) + CockpitB25C25.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
