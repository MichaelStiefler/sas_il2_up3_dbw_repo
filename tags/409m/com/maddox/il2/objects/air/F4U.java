...
//            Scheme1, TypeFighter, TypeDiveBomber, Aircraft, 
//            Cockpit, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeDiveBomber
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f, com.maddox.il2.fm.FlightModel flightmodel)
    {
        ...
        if(bGearExtending)
        {
            hiermesh.chunkSetAngles("GearL9_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 3F, 0.0F, 95F), 0.0F);
            hiermesh.chunkSetAngles("GearL10_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 3F, 0.0F, 60F), 0.0F);
            hiermesh.chunkSetAngles("GearR9_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 3F, 0.0F, 95F), 0.0F);
            hiermesh.chunkSetAngles("GearR10_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 3F, 0.0F, 60F), 0.0F);
            if(flightmodel == null)
            {
                float f1 = com.maddox.il2.objects.air.Aircraft.cvt(f6, 0.0F, 1.0F, 0.0F, 0.7071068F);
                f1 = 2.0F * f1 * f1;
                hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 41F * f1, 0.0F);
                hiermesh.chunkSetAngles("Hook1_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f1, 0.0F, 1.0F, 0.0F, -64.5F), 0.0F);
                f1 = com.maddox.il2.objects.air.Aircraft.cvt(f6, 0.0F, 0.25F, 0.0F, 1.0F);
            ...
            if(f < 4F)
            {
                f2 = f5 = com.maddox.il2.objects.air.Aircraft.cvt(f, 3F, 4F, 0.0F, 0.4F);
            } else
            {
                f2 = com.maddox.il2.objects.air.Aircraft.cvt(f, 4F, 8F, 0.75F, 2.0F);
                f2 = (float)java.lang.Math.sqrt(f2);
                f2 = com.maddox.il2.objects.air.Aircraft.cvt(f2, (float)java.lang.Math.sqrt(0.75D), (float)java.lang.Math.sqrt(2D), 0.4F, 1.0F);
                f5 = com.maddox.il2.objects.air.Aircraft.cvt(f, 4F, 8.5F, 0.75F, 2.0F);
                f5 = (float)java.lang.Math.sqrt(f5);
                f5 = com.maddox.il2.objects.air.Aircraft.cvt(f5, (float)java.lang.Math.sqrt(0.75D), (float)java.lang.Math.sqrt(2D), 0.4F, 1.0F);
            }
        ...
        } else
        {
            if(flightmodel == null)
            {
                float f3 = com.maddox.il2.objects.air.Aircraft.cvt(f6, 8.5F, 10F, 0.0F, 1.0F);
                hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 41F * f3, 0.0F);
                f3 = com.maddox.il2.objects.air.Aircraft.cvt(f6, 8.5F, 8.75F, 0.0F, 1.0F);
                hiermesh.chunkSetAngles("GearC4_D0", 0.0F, 140F * f3, 0.0F);
                hiermesh.chunkSetAngles("GearC5_D0", 0.0F, 140F * f3, 0.0F);
                hiermesh.chunkSetAngles("Hook1_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f6, 8.5F, 10F, 0.0F, -64.5F), 0.0F);
            }
            float f4;
            if(f > 7.5F)
                f4 = com.maddox.il2.objects.air.Aircraft.cvt(f, 7.5F, 8.5F, 0.9F, 1.0F);
            else
                f4 = com.maddox.il2.objects.air.Aircraft.cvt(f, 3F, 7.5F, 0.0F, 0.9F);
            ...
            hiermesh.chunkSetAngles("GearL9_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 1.5F, 3.7F, 0.0F, 95F), 0.0F);
            hiermesh.chunkSetAngles("GearL10_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 1.5F, 3.7F, 0.0F, 60F), 0.0F);
            hiermesh.chunkSetAngles("GearR9_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 3.7F, 0.0F, 95F), 0.0F);
            hiermesh.chunkSetAngles("GearR10_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 3.7F, 0.0F, 60F), 0.0F);
        }
    }
    ...
    protected void moveWingFold(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        if(bGearExtending)
        {
            if(f < 1.5F)
            {
                hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 1.5F, 0.0F, 2.6F), 0.0F);
                hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 1.5F, 0.0F, 2.6F), 0.0F);
            } else
            if(f < 2.5F)
            {
                hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 1.5F, 2.5F, 2.6F, 5.1F), 0.0F);
                hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 1.5F, 2.5F, 2.6F, 5.1F), 0.0F);
            } else
            {
                hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 2.5F, 17.9F, 5.1F, 105F), 0.0F);
                hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 2.5F, 16F, 5.1F, 105F), 0.0F);
            }
        } else
        if(f < 9F)
        {
            if(f < 6.8F)
                hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 6.8F, 0.0F, 45F), 0.0F);
            else
                hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 6.8F, 9F, 45F, 50F), 0.0F);
            if(f < 7.5F)
                hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.75F, 7.5F, 0.0F, 45F), 0.0F);
            else
                hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 7.5F, 9F, 45F, 50F), 0.0F);
        } else
        if(f < 11F)
        {
            hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 9F, 11F, 50F, 60F), 0.0F);
            hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 9F, 11F, 50F, 60F), 0.0F);
        } else
        {
            hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 11F, 15.75F, 60F, 105F), 0.0F);
            hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 11F, 15.75F, 60F, 105F), 0.0F);
        }
    }
    ...
    public void update(float f)
    {
        ...
        {
            cGearPos = com.maddox.il2.objects.air.Aircraft.cvt(f6, 8.5F, 10F, 0.0F, 1.0F);
            hierMesh().chunkSetAngles("GearC2_D0", 0.0F, 41F * cGearPos, 0.0F);
            float f2 = com.maddox.il2.objects.air.Aircraft.cvt(f6, 8.5F, 8.75F, 0.0F, 1.0F);
            hierMesh().chunkSetAngles("GearC4_D0", 0.0F, 140F * f2, 0.0F);
            hierMesh().chunkSetAngles("GearC5_D0", 0.0F, 140F * f2, 0.0F);
        }
        if(FM.Gears.arrestorVAngle != 0.0F)
        {
            float f3 = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.arrestorVAngle, -43F, 21.5F, 0.0F, -64.5F);
        ...
        } else
        {
            ...
            if(arrestorVel >= -0.1F)
            {
                if(com.maddox.il2.engine.Engine.cur.land.isWater(FM.Loc.x, FM.Loc.y))
                    ...
                    f4 = com.maddox.il2.objects.air.Aircraft.cvt(FM.getSpeedKMH(), 0.0F, 250F, 0.0F, 0.75F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("f1"))
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(8F, 12F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.z) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p1"))
                {
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(16F, 36F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                    FM.AS.setCockpitState(shot.initiator, FM.AS.astateCockpitState | 2);
                    if(shot.power <= 0.0F)
                        doRicochetBack(shot);
                } else
                if(s.endsWith("p2"))
                    getEnergyPastArmor(11D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p3"))
                    getEnergyPastArmor(11.5D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
