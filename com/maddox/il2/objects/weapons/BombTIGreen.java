...
// Source File Name:   BombTIGreen.java
...
public class BombTIGreen extends com.maddox.il2.objects.weapons.Bomb
{
        ...
        if((double)charge < 1.01D)
        {
            ...
            if(com.maddox.il2.engine.Actor.isValid(actor))
            {
                ...
                for(int i = 0; i < 60; i++)
                {
                    ...
                    com.maddox.il2.objects.weapons.BombTiGr bombtigr = new BombTiGr();
                    bombtigr.pos.setUpdateEnable(true);
                    bombtigr.pos.setAbs(point3d, orient);
                    bombtigr.pos.reset();
                    bombtigr.start();
                    bombtigr.setOwner(actor, false, false, false);
                    bombtigr.setSpeed(vector3d);
                }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.weapons.BombTIGreen.class;
