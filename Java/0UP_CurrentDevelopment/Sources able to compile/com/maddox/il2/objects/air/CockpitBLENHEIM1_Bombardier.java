...
public class CockpitBLENHEIM1_Bombardier extends CockpitPilot
{
    ...
    {
        mesh.chunkSetAngles("zMark1", ((BLENHEIM1)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((BLENHEIM1)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
