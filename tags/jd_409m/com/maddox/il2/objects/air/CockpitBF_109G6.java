...
public class CockpitBF_109G6 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitBF_109G6.access$102(CockpitBF_109G6.this, CockpitBF_109G6.this.setOld); CockpitBF_109G6.access$202(CockpitBF_109G6.this, CockpitBF_109G6.this.setNew); CockpitBF_109G6.access$302(CockpitBF_109G6.this, CockpitBF_109G6.this.setTmp);
      ...
      CockpitBF_109G6.this.setNew.throttle = ((10.0F * CockpitBF_109G6.this.setOld.throttle + CockpitBF_109G6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109G6.this.setNew.mix = ((8.0F * CockpitBF_109G6.this.setOld.mix + CockpitBF_109G6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109G6.this.setNew.azimuth = CockpitBF_109G6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109G6.this.setOld.azimuth > 270.0F) && (CockpitBF_109G6.this.setNew.azimuth < 90.0F)) CockpitBF_109G6.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_109G6.this.setOld.azimuth < 90.0F) && (CockpitBF_109G6.this.setNew.azimuth > 270.0F)) CockpitBF_109G6.this.setOld.azimuth += 360.0F;
      CockpitBF_109G6.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_109G6.this.setOld.waypointAzimuth + (CockpitBF_109G6.this.waypointAzimuth() - CockpitBF_109G6.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitBF_109G6.1 arg2) { this();
    }
  }
}