  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  {
    resetYPRmodifier();
    xyz[1] = cvt(paramFloat, 0.01F, 0.99F, 0.0F, 0.6F);
  ...
  {
    for (int i = 1; i < 9; i++) {
      hierMesh().chunkSetAngles("Water" + i + "_D0", 0.0F, -32.0F * this.FM.EI.engines[0].getControlRadiator(), 0.0F);
    }
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    paramHierMesh.chunkSetAngles("GearR2_D0", 0.0F, cvt(paramFloat, 0.0F, 0.55F, 0.0F, 80.5F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(paramFloat, 0.0F, 0.05F, 0.0F, 90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL2_D0", 0.0F, cvt(paramFloat, 0.45F, 1.0F, 0.0F, -80.5F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL7_D0", 0.0F, cvt(paramFloat, 0.45F, 0.5F, 0.0F, -90.0F), 0.0F);
  }
  ...
  {
    resetYPRmodifier();
    float f = cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.16015F, 0.0F, 0.16015F);
    xyz[2] = f;
    hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
    f = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.16015F, 0.0F, 0.16015F);
    xyz[2] = f;
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if ((paramString.startsWith("xcf")) || (paramString.startsWith("xblister"))) {
      ...
      if ((paramPoint3d.x > -2.42D) && (paramPoint3d.x < 0.32D)) {
        ...
        if ((paramPoint3d.x < -0.27D) && (paramPoint3d.z > 0.7D)) {
      ...
      if (getEnergyPastArmor(0.05F, paramShot) > 0.0F) {
        if (this.FM.AS.astateTankStates[3] == 0) {
          ...
          this.FM.AS.doSetTankState(paramShot.initiator, 3, 2);
        }
