...
// Source File Name:   FW_190NEW.java
...
public abstract class FW_190NEW extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    {
        com.maddox.il2.objects.air.FW_190NEW.moveGear(hierMesh(), f);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxradiat"))
            {
                ...
                com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine Module: Radiator Hit, Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
            }
            return;
        }
        ...
        {
            com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Ammo: Hit..");
            if(s.endsWith("05"))
                getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(50F, 50F), shot);
