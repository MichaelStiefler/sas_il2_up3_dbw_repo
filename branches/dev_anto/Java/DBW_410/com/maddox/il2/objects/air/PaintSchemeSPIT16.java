// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 25/07/2010 1:38:11 PM
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   PaintSchemeSPIT5A.java
...
public class PaintSchemeSPIT16 extends PaintScheme
{

    public PaintSchemeSPIT16()
    {
    }
    ...
    public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k)
    {
        ...
        } else
        {
            ...
            if(regiment.country() == PaintScheme.countryBritain)
            {
                ...
                {
                    k = clampToReality(k);
                    changeMat(hiermesh, "Overlay1", "psSPIT1BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/" + regiment.aid()[1] + ".tga", psBritishGrayColor[0], psBritishGrayColor[1], psBritishGrayColor[2], psBritishGrayColor[0], psBritishGrayColor[1], psBritishGrayColor[2]);
                    changeMat(hiermesh, "Overlay3", "psSPIT1BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/" + regiment.aid()[1] + ".tga", psBritishGrayColor[0], psBritishGrayColor[1], psBritishGrayColor[2], psBritishGrayColor[0], psBritishGrayColor[1], psBritishGrayColor[2]);
                    changeMat(hiermesh, "Overlay2", "psSPIT1BRILNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char)k + ".tga", "null.tga", psBritishGrayColor[0], psBritishGrayColor[1], psBritishGrayColor[2], 1.0F, 1.0F, 1.0F);
                    changeMat(hiermesh, "Overlay4", "psSPIT1BRIRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char)k + ".tga", "null.tga", 1.0F, 1.0F, 1.0F, psBritishGrayColor[0], psBritishGrayColor[1], psBritishGrayColor[2]);
