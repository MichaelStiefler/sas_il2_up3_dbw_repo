...
public class CockpitLA_7R extends CockpitPilot
{
  ...
  {
    this.mesh.chunkSetAngles("zKerosin", cvt(this.fm.M.nitro, 0.0F, 250.0F, 0.0F, 270.0F), 0.0F, 0.0F);
    this.mesh.chunkSetAngles("zAzotKislota", cvt(this.fm.M.nitro, 0.0F, 250.0F, 0.0F, 270.0F), 0.0F, 0.0F);
    this.mesh.chunkSetAngles("zPVRD_Temp", cvt(this.setNew.preved, 0.0F, 900.0F, 0.0F, 118.0F), 0.0F, 0.0F);
    this.mesh.chunkSetAngles("SW_PVRD", this.fm.EI.engines[1].getStage() > 0 ? 45.0F : 0.0F, 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_7R.this.fm != null) {
        ...
        CockpitLA_7R.this.setNew.throttle = ((10.0F * CockpitLA_7R.this.setOld.throttle + CockpitLA_7R.this.fm.CT.PowerControl) / 11.0F);
        CockpitLA_7R.this.setNew.prop = ((8.0F * CockpitLA_7R.this.setOld.prop + CockpitLA_7R.this.fm.CT.getStepControl()) / 9.0F);
        CockpitLA_7R.this.setNew.altimeter = CockpitLA_7R.this.fm.getAltitude();
        if (Math.abs(CockpitLA_7R.this.fm.Or.getKren()) < 30.0F) {
          CockpitLA_7R.this.setNew.azimuth = ((35.0F * CockpitLA_7R.this.setOld.azimuth + -CockpitLA_7R.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        {
          CockpitLA_7R.this.setNew.waypointAzimuth = 0.0F;
        }
        else
        {
          CockpitLA_7R.this.setNew.waypointAzimuth = ((10.0F * CockpitLA_7R.this.setOld.waypointAzimuth + (CockpitLA_7R.this.waypointAzimuth() - CockpitLA_7R.this.setOld.azimuth)) / 11.0F);
        }

        CockpitLA_7R.this.setNew.vspeed = ((199.0F * CockpitLA_7R.this.setOld.vspeed + CockpitLA_7R.this.fm.getVertSpeed()) / 200.0F);
        if (CockpitLA_7R.this.fm.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitLA_7R.this.cvt(CockpitLA_7R.this.fm.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitLA_7R.this.cvt(CockpitLA_7R.this.fm.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
        ...
        CockpitLA_7R.access$502(CockpitLA_7R.this, 0.8F * CockpitLA_7R.this.pictStage + 0.1F * CockpitLA_7R.this.fm.EI.engines[0].getControlCompressor());
        CockpitLA_7R.this.setNew.preved = (0.99F * CockpitLA_7R.this.setOld.preved + 0.01F * (CockpitLA_7R.this.fm.EI.engines[1].getStage() == 6 ? 800.0F : 55.0F));
      }
      return true;
    }
  }
