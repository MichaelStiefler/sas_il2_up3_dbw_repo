...
public class RocketSimpleRS150 extends RocketSimple
{
  public RocketSimpleRS150(Point3d paramPoint3d, Orient paramOrient, Actor paramActor)
  {
  ...
  static
  {
    Class localClass = RocketSimpleRS150.class;
    ...
    Property.set(localClass, "power", 2.8F);
    Property.set(localClass, "powerType", 0);
    Property.set(localClass, "kalibr", 0.15F);
    Property.set(localClass, "massa", 28.1F);
    Property.set(localClass, "massaEnd", 14.1F);
  }
}