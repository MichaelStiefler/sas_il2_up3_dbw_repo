...
public class CockpitBLENHEIM1_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bEntered)
    {
      this.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((BLENHEIM1)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);
      boolean bool = ((BLENHEIM1)aircraft()).fSightCurReadyness > 0.93F;
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      float f1 = ((BLENHEIM1)CockpitBLENHEIM1_Bombardier.this.aircraft()).fSightCurForwardAngle;
      float f2 = ((BLENHEIM1)CockpitBLENHEIM1_Bombardier.this.aircraft()).fSightCurSideslip;
      CockpitBLENHEIM1_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitBLENHEIM1_Bombardier.this.bEntered)
      {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitBLENHEIM1_Bombardier.this.aAim + f2, CockpitBLENHEIM1_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
