...
public class CockpitTA_183 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(interp(setNew.dimPosition, setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, -0.07115F);
        mesh.chunkSetLocate("EZ42Dimm", xyz, ypr);
        ...
        resetYPRmodifier();
        ypr[0] = interp(setNew.throttle, setOld.throttle, f) * 59.09091F;
        ...
        mesh.chunkSetAngles("NeedleAHBank", cvt(setNew.turn, -0.23562F, 0.23562F, 25F, -25F), 0.0F, 0.0F);
        ...
        resetYPRmodifier();
        xyz[2] = cvt(gun[0].countBullets(), 0.0F, 500F, -0.039F, 0.0F);
        mesh.chunkSetLocate("RC_MG17_L", xyz, ypr);
        xyz[2] = cvt(gun[2].countBullets(), 0.0F, 500F, -0.039F, 0.0F);
        mesh.chunkSetLocate("RC_MG17_R", xyz, ypr);
        xyz[2] = cvt(gun[1].countBullets(), 0.0F, 500F, -0.039F, 0.0F);
        mesh.chunkSetLocate("RC_MG151_L", xyz, ypr);
        xyz[2] = cvt(gun[3].countBullets(), 0.0F, 500F, -0.039F, 0.0F);
