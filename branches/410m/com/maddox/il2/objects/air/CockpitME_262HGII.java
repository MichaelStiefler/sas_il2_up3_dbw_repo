...
// Source File Name:   CockpitME_262HGII.java
...
//            CockpitPilot, Aircraft, ME_262A1AU4, AircraftLH

public class CockpitME_262HGII extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = fm.CT.GearControl != 0.0F || fm.CT.getGear() == 0.0F ? 0.0F : -0.0107F;
        mesh.chunkSetLocate("Z_GearEin", xyz, ypr);
        xyz[1] = fm.CT.GearControl != 1.0F || fm.CT.getGear() == 1.0F ? 0.0F : -0.0107F;
        mesh.chunkSetLocate("Z_GearAus", xyz, ypr);
        resetYPRmodifier();
        xyz[1] = fm.CT.FlapsControl >= fm.CT.getFlap() ? 0.0F : -0.0107F;
        mesh.chunkSetLocate("Z_FlapEin", xyz, ypr);
        xyz[1] = fm.CT.FlapsControl <= fm.CT.getFlap() ? 0.0F : -0.0107F;
        mesh.chunkSetLocate("Z_FlapAus", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[1] = 0.03675F * fm.CT.getTrimElevatorControl();
        mesh.chunkSetLocate("Z_TailTrim", xyz, ypr);
