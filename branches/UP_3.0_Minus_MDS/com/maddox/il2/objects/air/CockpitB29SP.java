...
// Source File Name:   CockpitB29SP.java
...
//            CockpitPilot, B_29SP, AircraftLH, Cockpit

public class CockpitB29SP extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(b29SP != null)
                    setNew.PDI = b29SP.fSightCurSideslip;
    ...
    public CockpitB29SP()
    {
        ...
        setNightMats(false);
        if(aircraft() instanceof com.maddox.il2.objects.air.B_29SP)
            b29SP = (com.maddox.il2.objects.air.B_29SP)aircraft();
    ...
    private com.maddox.il2.objects.air.B_29SP b29SP;
