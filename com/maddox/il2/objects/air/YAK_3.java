...
public class YAK_3 extends com.maddox.il2.objects.air.YAK
{
    ...
    {
        com.maddox.il2.objects.air.YAK_3.moveGear(hierMesh(), f);
    }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.YAK_3.class;
        ...
        com.maddox.il2.objects.air.YAK_3.weaponTriggersRegister(class1, new int[] {
            0, 0, 1
        });
        com.maddox.il2.objects.air.YAK_3.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_CANNON01"
        });
        com.maddox.il2.objects.air.YAK_3.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunUBsi 150", "MGunUBsi 150", "MGunShVAKki 120"
        });
        com.maddox.il2.objects.air.YAK_3.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
}
