...
public class CockpitTB_3_TGunner1 extends com.maddox.il2.objects.air.CockpitGunner
{
    ...
    protected boolean doFocusEnter()
    {
        ...
        {
            ((com.maddox.il2.engine.ActorHMesh)(com.maddox.il2.engine.ActorHMesh)fm.actor).hierMesh().chunkVisible("Turret3C_D0", false);
            return true;
        } else
        {
            return false;
    ...
    {
        ((com.maddox.il2.engine.ActorHMesh)(com.maddox.il2.engine.ActorHMesh)fm.actor).hierMesh().chunkVisible("Turret3C_D0", ((com.maddox.il2.engine.ActorHMesh)(com.maddox.il2.engine.ActorHMesh)fm.actor).hierMesh().isChunkVisible("Turret3B_D0"));
        super.doFocusLeave();
    }
