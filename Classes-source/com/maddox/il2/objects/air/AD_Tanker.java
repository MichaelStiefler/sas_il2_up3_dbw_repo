...
//            Scheme1, TypeTransport, TypeTankerDrogue, Aircraft, 
//            NetAircraft, Cockpit, AircraftLH, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeTransport, com.maddox.il2.objects.air.TypeTankerDrogue
{
    ...
    {
        com.maddox.il2.objects.air.AD_Tanker.moveGear(hiermesh, f, null);
    }
    ...
    protected void moveGear(float f)
    {
        if(prevGear > f)
            ...
            bGearExtending = true;
        prevGear = f;
        com.maddox.il2.objects.air.AD_Tanker.moveGear(hierMesh(), f, super.FM);
        f *= 10F;
        if(bGearExtending)
        {
    ...
    {
        resetYPRmodifier();
        com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.gWheelSinking[0], 0.0F, 0.231F, 0.0F, 0.231F);
        hierMesh().chunkSetLocate("GearL7_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.gWheelSinking[1], 0.0F, 0.231F, 0.0F, -0.231F);
    ...
    public void update(float f)
    {
        ...
        if(bNeedSetup)
        {
            cGear = ((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.GearControl;
            bNeedSetup = false;
        }
        cGear = com.maddox.il2.objects.air.AD_Tanker.filter(f, ((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.GearControl, cGear, 999.9F, ((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.dvGear);
        if(prevGear2 > cGear)
        ...
        if(super.FM.getAltitude() < 1000F || (double)((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getGear() > 0.0D || (double)((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getArrestor() > 0.0D)
        {
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("g2"))
                    getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(30F, 50F) / (1E-005F + (float)java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (com.maddox.il2.objects.air.Aircraft.v1)).x)), shot);
            } else
            ...
            if(s.startsWith("xxeng1"))
            {
                ...
                if(s.endsWith("cyl") && getEnergyPastArmor(0.45F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getCylindersRatio() * 1.75F)
                {
            ...
            } else
            {
                ...
                if(s.startsWith("xxmgunl2") && getEnergyPastArmor(4.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.75F)
                    ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.setJamBullets(0, 2);
                if(s.startsWith("xxmgunr2") && getEnergyPastArmor(4.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.75F)
                    ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.setJamBullets(0, 3);
        ...
        {
            if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.astateEngineStates[0] == 0)
            {
            ...
            if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.astateEngineStates[0] == 1)
            {
                debuggunnery("Engine Module: Water Radiator Pierced..");
                ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.hitEngine(shot.initiator, 0, 1);
                ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.doSetEngineState(shot.initiator, 0, 2);
            }
        } else
