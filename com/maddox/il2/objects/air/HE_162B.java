...
public class HE_162B extends com.maddox.il2.objects.air.HE_162
{
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.HE_162B.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.0632F, 0.0F, 0.0632F);
        if(FM.CT.getGear() > 0.99F)
            ypr[1] = 40F * FM.CT.getRudder();
        hierMesh().chunkSetLocate("GearC25_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearC27_D0", 0.0F, com.maddox.il2.objects.air.HE_162B.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.0632F, 0.0F, -15F), 0.0F);
        hierMesh().chunkSetAngles("GearC28_D0", 0.0F, com.maddox.il2.objects.air.HE_162B.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.0632F, 0.0F, 30F), 0.0F);
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.HE_162B.weaponTriggersRegister(class1, new int[] {
            0, 0
        });
        com.maddox.il2.objects.air.HE_162B.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02"
        });
        com.maddox.il2.objects.air.HE_162B.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMK108k 100", "MGunMK108k 100"
        });
        com.maddox.il2.objects.air.HE_162B.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
