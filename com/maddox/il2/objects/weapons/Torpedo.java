...
public class Torpedo extends Bomb
{
  ...
  public void msgCollision(Actor paramActor, String paramString1, String paramString2)
  {
    ...
    if ((paramActor instanceof ActorLand)) {
      ...
      if (World.land().isWater(P.jdField_x_of_type_Double, P.jdField_y_of_type_Double)) return;
    }
  ...
  private void surface() {
    ...
    if (World.land().isWater(P.jdField_x_of_type_Double, P.jdField_y_of_type_Double))
    {
      ...
      double d = spd.length();
      if (d > 0.001D) d = spd.jdField_z_of_type_Double / spd.length(); else
        d = -1.0D;
      if (d < -0.47D) {
        sendexplosion();
      }
  ...
  public void interpolateTick() {
    ...
    if (P.jdField_z_of_type_Double <= -0.1000000014901161D) surface();
  ...
  public void start()
  {
    ...
    getSpeed(spd); this.jdField_pos_of_type_ComMaddoxIl2EngineActorPos.getAbs(P, Or);
