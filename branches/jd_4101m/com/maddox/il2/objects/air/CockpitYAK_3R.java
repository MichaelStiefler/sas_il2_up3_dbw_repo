...
public class CockpitYAK_3R extends CockpitPilot
{
  ...
  {
    this.mesh.chunkSetAngles("zKerosin", 0.0F, cvt(this.fm.M.nitro, 0.0F, 250.0F, 0.0F, -270.0F), 0.0F);
    this.mesh.chunkSetAngles("zAzotKislota", 0.0F, cvt(this.fm.M.nitro, 0.0F, 250.0F, 0.0F, -270.0F), 0.0F);
    this.mesh.chunkSetAngles("zPVRD_Temp", 0.0F, cvt(this.setNew.preved, 0.0F, 900.0F, 0.0F, -118.0F), 0.0F);
    this.mesh.chunkSetAngles("SW_PVRD", 0.0F, this.fm.EI.engines[1].getStage() > 0 ? -45.0F : 0.0F, 0.0F);
    ...
    this.mesh.chunkVisible("Z_Red2", this.fm.EI.engines[0].getRPM() < 650.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_3R.this.fm != null) {
        ...
        CockpitYAK_3R.this.setNew.throttle = ((10.0F * CockpitYAK_3R.this.setOld.throttle + CockpitYAK_3R.this.fm.CT.PowerControl) / 11.0F);
        CockpitYAK_3R.this.setNew.prop = ((10.0F * CockpitYAK_3R.this.setOld.prop + CockpitYAK_3R.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_3R.this.setNew.altimeter = CockpitYAK_3R.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_3R.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_3R.this.setNew.azimuth = ((35.0F * CockpitYAK_3R.this.setOld.azimuth + CockpitYAK_3R.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitYAK_3R.this.setNew.vspeed = ((199.0F * CockpitYAK_3R.this.setOld.vspeed + CockpitYAK_3R.this.fm.getVertSpeed()) / 200.0F);
        CockpitYAK_3R.this.setNew.preved = (0.99F * CockpitYAK_3R.this.setOld.preved + 0.01F * (CockpitYAK_3R.this.fm.EI.engines[1].getStage() == 6 ? 800.0F : 55.0F));
      }
