...
public class CockpitMOSQUITO16_Bombardier extends CockpitPilot
{
  ...
  public CockpitMOSQUITO16_Bombardier() {
    super("3DO/Cockpit/Pe-2-Bombardier/BombardierMOSQUITO16.him", "he111");
    try {
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((MOSQUITO16)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((MOSQUITO16)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMOSQUITO16_Bombardier.this.bEntered) {
        float f1 = ((MOSQUITO16)CockpitMOSQUITO16_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((MOSQUITO16)CockpitMOSQUITO16_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitMOSQUITO16_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitMOSQUITO16_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
