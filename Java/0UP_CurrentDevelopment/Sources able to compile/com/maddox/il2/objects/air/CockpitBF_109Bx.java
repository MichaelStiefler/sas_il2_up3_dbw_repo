...
public class CockpitBF_109Bx extends CockpitPilot
{
    ...
    protected void reflectPlaneMats()
    {
        ...
        {
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109B1)
                type = 0;
            else
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109B2)
                type = 1;
            else
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109C1)
                type = 2;
            else
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109D1)
                type = 3;
            else
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109D1L)
                type = 4;
            switch(type)
            {
            case 0: // '\0'
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitBF_109Bx.class, "normZN", 0.43F);
        com.maddox.rts.Property.set(CockpitBF_109Bx.class, "gsZN", 0.43F);
    }
