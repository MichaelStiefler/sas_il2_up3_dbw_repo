...
//            Scheme4, TypeTransport, TypeBomber, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeTransport, com.maddox.il2.objects.air.TypeBomber
{
    ...
    {
        resetYPRmodifier();
        float f = com.maddox.il2.objects.air.TB_3.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.5F, 0.0F, 0.5F);
        ...
        f = com.maddox.il2.objects.air.TB_3.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.5F, 0.0F, 0.5F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxcontrols"))
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.12F)
                {
                    ...
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Evelator Controls Out..");
                }
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.12F)
                {
                    FM.AS.setControlsDamage(shot.initiator, 2);
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Rudder Controls Out..");
                }
            }
            if(s.startsWith("xxspar"))
            {
                if((s.endsWith("t1") || s.endsWith("t2") || s.endsWith("t3") || s.endsWith("t4")) && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(12.9F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Tail1 Spars Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** WingROut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if(s.endsWith("e1") && getEnergyPastArmor(28F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.45F)
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine1 Suspension Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine2 Suspension Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine3 Suspension Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine4 Suspension Broken in Half..");
            ...
            {
                com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Bomb Payload Detonates..");
                ...
                if(s.endsWith("base"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 200000F)
                        {
                            ...
                            com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine" + (i + 1) + " Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                        {
                            FM.AS.hitEngine(shot.initiator, i, 2);
                            com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine" + (i + 1) + " Crank Case Hit - Engine Damaged..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 14000F)
                        {
                            FM.EI.engines[i].setCyliderKnockOut(shot.initiator, 1);
                            com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine" + (i + 1) + " Crank Case Hit - Cylinder Feed Out, " + FM.EI.engines[i].getCylindersOperable() + "/" + FM.EI.engines[i].getCylinders() + " Left..");
                        }
                        ...
                        com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine" + (i + 1) + " Crank Case Hit - Readyness Reduced to " + FM.EI.engines[i].getReadyness() + "..");
                    }
                } else
                if(s.endsWith("cyl"))
                {
                    if(getEnergyPastArmor(0.5F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[i].getCylindersRatio())
                    {
                        ...
                        com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine" + (i + 1) + " Cylinders Hit, " + FM.EI.engines[i].getCylindersOperable() + "/" + FM.EI.engines[i].getCylinders() + " Left..");
                        ...
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 24000F)
                        {
                            ...
                            com.maddox.il2.objects.air.TB_3.debugprintln(this, "*** Engine" + (i + 1) + " Cylinders Hit - Engine Fires..");
                        }
        ...
        if(s.startsWith("xcf"))
        {
            ...
            if(point3d.x > 1.0D)
            {
                ...
                if(v1.x < -0.89999997615814209D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.2F)
