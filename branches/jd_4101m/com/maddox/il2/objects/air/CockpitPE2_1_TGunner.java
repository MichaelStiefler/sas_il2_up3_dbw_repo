...
public class CockpitPE2_1_TGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.mesh.chunkSetAngles("TurrelC", 0.0F, -cvt(paramOrient.getYaw(), -45.0F, 27.0F, -45.0F, 27.0F), 0.0F);
    this.mesh.chunkSetAngles("TurrelD", 0.0F, paramOrient.getTangage(), 0.0F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_1_TGunner.this.fm != null)
      {
        ...
        CockpitPE2_1_TGunner.this.setNew.man1 = (0.92F * CockpitPE2_1_TGunner.this.setOld.man1 + 0.08F * CockpitPE2_1_TGunner.this.fm.EI.engines[0].getManifoldPressure());

        CockpitPE2_1_TGunner.this.setNew.man2 = (0.92F * CockpitPE2_1_TGunner.this.setOld.man2 + 0.08F * CockpitPE2_1_TGunner.this.fm.EI.engines[1].getManifoldPressure());
        CockpitPE2_1_TGunner.this.setNew.altimeter = CockpitPE2_1_TGunner.this.fm.getAltitude();

        CockpitPE2_1_TGunner.this.setNew.azimuth.setDeg(CockpitPE2_1_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_1_TGunner.this.fm.Or.azimut());

        CockpitPE2_1_TGunner.this.setNew.vspeed = ((100.0F * CockpitPE2_1_TGunner.this.setOld.vspeed + CockpitPE2_1_TGunner.this.fm.getVertSpeed()) / 101.0F);

        if (CockpitPE2_1_TGunner.this.useRealisticNavigationInstruments())
        {
          CockpitPE2_1_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE2_1_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_1_TGunner.this.getBeaconDirection());
        }
        else
        {
          CockpitPE2_1_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE2_1_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_1_TGunner.this.waypointAzimuth() - CockpitPE2_1_TGunner.this.setOld.azimuth.getDeg(1.0F));
        }

        CockpitPE2_1_TGunner.this.setNew.inert = (0.999F * CockpitPE2_1_TGunner.this.setOld.inert + 0.001F * (CockpitPE2_1_TGunner.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
