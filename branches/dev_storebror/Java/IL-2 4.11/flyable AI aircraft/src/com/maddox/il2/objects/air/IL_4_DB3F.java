...
public class IL_4_DB3F extends IL_4 implements TypeBomber {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitDB3F.class,
				CockpitDB3F_Bombardier.class, CockpitDB3F_FGunner.class,
				CockpitDB3F_TGunner.class, CockpitDB3F_BGunner.class });
