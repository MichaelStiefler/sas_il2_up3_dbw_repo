...
// Source File Name:   RocketRS132.java
...
public class RocketRS132 extends com.maddox.il2.objects.weapons.Rocket
{
    ...
    protected void doExplosion(com.maddox.il2.engine.Actor actor, java.lang.String s)
    {
        ...
        com.maddox.il2.ai.MsgExplosion.send(actor, s, p, getOwner(), 10.1F, 2.1F, 1, 500F);
    ...
    {
        pos.getTime(com.maddox.rts.Time.current(), p);
        com.maddox.il2.ai.MsgExplosion.send(null, null, p, getOwner(), 10.1F, 2.1F, 1, 500F);
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.weapons.RocketRS132.class;
