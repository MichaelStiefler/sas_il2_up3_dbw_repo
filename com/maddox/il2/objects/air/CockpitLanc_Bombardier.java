...
// Source File Name:   CockpitLanc_Bombardier.java
...
//            CockpitPilot, LANCASTER, Cockpit

public class CockpitLanc_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.LANCASTER)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.LANCASTER)aircraft()).fSightCurSideslip;
    ...
    {
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.LANCASTER)((com.maddox.il2.objects.air.Cockpit)this).aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = ((com.maddox.il2.objects.air.Cockpit)this).cvt(((com.maddox.il2.objects.air.LANCASTER)((com.maddox.il2.objects.air.Cockpit)this).aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
