...
//            P_40, PaintSchemeFMPar05, PaintSchemeFMPar06, NetAircraft
...
public class P_40M extends com.maddox.il2.objects.air.P_40
{
    ...
    {
        super.update(f1);
        f = com.maddox.il2.objects.air.P_40M.cvt(FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 5F, -17F);
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.P_40M.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0, 0, 0, 3, 9
        });
        com.maddox.il2.objects.air.P_40M.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_ExternalBomb01", "_ExternalBomb01"
        });
        com.maddox.il2.objects.air.P_40M.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.P_40M.weaponsRegister(class1, "500lb", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.P_40M.weaponsRegister(class1, "1000lb", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.P_40M.weaponsRegister(class1, "droptank", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.P_40M.weaponsRegister(class1, "none", new java.lang.String[] {
