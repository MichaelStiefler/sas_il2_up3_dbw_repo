...
public class CockpitSpit9EHF extends CockpitPilot
{
  ...
  public CockpitSpit9EHF() {
    super("3DO/Cockpit/SpitfireMkIXc/spitEHF.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    int i = ((SPITFIRE9EHF)aircraft()).k14Mode;
    boolean bool = i < 2;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitSpit9EHF this$0;
    ...
    Variables(CockpitSpit9EHF.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit9EHF.this.bNeedSetUp) {
        CockpitSpit9EHF.this.reflectPlaneMats();
        CockpitSpit9EHF.access$102(CockpitSpit9EHF.this, false);
      }
      if (CockpitSpit9EHF.this.fm != null) {
        CockpitSpit9EHF.access$202(CockpitSpit9EHF.this, CockpitSpit9EHF.this.setOld);
        CockpitSpit9EHF.access$302(CockpitSpit9EHF.this, CockpitSpit9EHF.this.setNew);
        CockpitSpit9EHF.access$402(CockpitSpit9EHF.this, CockpitSpit9EHF.this.setTmp);
        CockpitSpit9EHF.this.setNew.throttle = (0.92F * CockpitSpit9EHF.this.setOld.throttle + 0.08F * CockpitSpit9EHF.this.fm.CT.PowerControl);

        CockpitSpit9EHF.this.setNew.prop = (0.92F * CockpitSpit9EHF.this.setOld.prop + 0.08F * CockpitSpit9EHF.this.fm.EI.engines[0].getControlProp());

        CockpitSpit9EHF.this.setNew.mix = (0.92F * CockpitSpit9EHF.this.setOld.mix + 0.08F * CockpitSpit9EHF.this.fm.EI.engines[0].getControlMix());

        CockpitSpit9EHF.this.setNew.altimeter = CockpitSpit9EHF.this.fm.getAltitude();
        if (Math.abs(CockpitSpit9EHF.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit9EHF.this.setNew.azimuth = (0.97F * CockpitSpit9EHF.this.setOld.azimuth + 0.03F * -CockpitSpit9EHF.this.fm.Or.getYaw());
        }
        if ((CockpitSpit9EHF.this.setOld.azimuth > 270.0F) && (CockpitSpit9EHF.this.setNew.azimuth < 90.0F))
          CockpitSpit9EHF.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit9EHF.this.setOld.azimuth < 90.0F) && (CockpitSpit9EHF.this.setNew.azimuth > 270.0F))
          CockpitSpit9EHF.this.setOld.azimuth += 360.0F;
        CockpitSpit9EHF.this.setNew.waypointAzimuth = (0.91F * CockpitSpit9EHF.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit9EHF.this.waypointAzimuth() - CockpitSpit9EHF.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitSpit9EHF.this.setNew.vspeed = (0.99F * CockpitSpit9EHF.this.setOld.vspeed + 0.01F * CockpitSpit9EHF.this.fm.getVertSpeed());

        float f1 = ((SPITFIRE9EHF)CockpitSpit9EHF.this.aircraft()).k14Distance;

        CockpitSpit9EHF.this.setNew.k14w = (5.0F * CockpitSpit9EHF.k14TargetWingspanScale[((SPITFIRE9EHF)CockpitSpit9EHF.this.aircraft()).k14WingspanType] / f1);

        CockpitSpit9EHF.this.setNew.k14w = (0.9F * CockpitSpit9EHF.this.setOld.k14w + 0.1F * CockpitSpit9EHF.this.setNew.k14w);
        CockpitSpit9EHF.this.setNew.k14wingspan = (0.9F * CockpitSpit9EHF.this.setOld.k14wingspan + 0.1F * CockpitSpit9EHF.k14TargetMarkScale[((SPITFIRE9EHF)CockpitSpit9EHF.this.aircraft()).k14WingspanType]);

        CockpitSpit9EHF.this.setNew.k14mode = (0.8F * CockpitSpit9EHF.this.setOld.k14mode + 0.2F * ((SPITFIRE9EHF)CockpitSpit9EHF.this.aircraft()).k14Mode);

        Vector3d localVector3d = CockpitSpit9EHF.this.aircraft().FM.getW();

        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitSpit9EHF.this.floatindex((f1 - 200.0F) * 0.04F, CockpitSpit9EHF.k14BulletDrop) - CockpitSpit9EHF.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitSpit9EHF.this.setNew.k14x = (0.92F * CockpitSpit9EHF.this.setOld.k14x + 0.08F * f2);
        CockpitSpit9EHF.this.setNew.k14y = (0.92F * CockpitSpit9EHF.this.setOld.k14y + 0.08F * f3);
        if (CockpitSpit9EHF.this.setNew.k14x > 7.0F)
          CockpitSpit9EHF.this.setNew.k14x = 7.0F;
        if (CockpitSpit9EHF.this.setNew.k14x < -7.0F)
          CockpitSpit9EHF.this.setNew.k14x = -7.0F;
        if (CockpitSpit9EHF.this.setNew.k14y > 7.0F)
          CockpitSpit9EHF.this.setNew.k14y = 7.0F;
        if (CockpitSpit9EHF.this.setNew.k14y < -7.0F)
          CockpitSpit9EHF.this.setNew.k14y = -7.0F;
      }
      return true;
