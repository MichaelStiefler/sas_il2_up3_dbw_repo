...
public class BombParaFlareUK extends Bomb
{
  ...
  static
  {
    Class localClass = BombParaFlareUK.class;
    Property.set(localClass, "mesh", "3DO/Arms/paraFlareUK/mono.sim");
    Property.set(localClass, "emitColor", new Color3f(1.0F, 1.0F, 0.95F));
