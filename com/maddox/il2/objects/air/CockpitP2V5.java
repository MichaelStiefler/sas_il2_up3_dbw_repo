...
public class CockpitP2V5 extends CockpitPilot
{
  ...
  public CockpitP2V5()
  {
    super("3DO/Cockpit/B-25J/CockpitP2V5.him", "he111_gunner");
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitP2V5.access$002(CockpitP2V5.this, CockpitP2V5.this.setOld);
        CockpitP2V5.access$102(CockpitP2V5.this, CockpitP2V5.this.setNew);
        CockpitP2V5.access$202(CockpitP2V5.this, CockpitP2V5.this.setTmp);
        CockpitP2V5.this.setNew.throttle1 = (0.85F * CockpitP2V5.this.setOld.throttle1 + CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitP2V5.this.setNew.throttle2 = (0.85F * CockpitP2V5.this.setOld.throttle2 + CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitP2V5.this.setNew.prop1 = (0.85F * CockpitP2V5.this.setOld.prop1 + CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitP2V5.this.setNew.prop2 = (0.85F * CockpitP2V5.this.setOld.prop2 + CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitP2V5.this.setNew.altimeter = CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitP2V5.this.waypointAzimuth();
        CockpitP2V5.this.setNew.azimuth.setDeg(CockpitP2V5.this.setOld.azimuth.getDeg(1.0F), CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitP2V5.this.setNew.waypointAzimuth.setDeg(CockpitP2V5.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitP2V5.this.setNew.waypointDeviation.setDeg(CockpitP2V5.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitP2V5.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitP2V5.this.setNew.vspeed = ((199.0F * CockpitP2V5.this.setOld.vspeed + CockpitP2V5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitP2V5 this$0;
