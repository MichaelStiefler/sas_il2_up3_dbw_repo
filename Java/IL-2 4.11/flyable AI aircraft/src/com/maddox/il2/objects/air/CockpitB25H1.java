// Source File Name: CockpitB25H1.java
...
public class CockpitB25H1 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB25H1.this.fm != null) {
				...
				CockpitB25H1.this.setNew.throttle1 = (0.85F * CockpitB25H1.this.setOld.throttle1)
						+ (CockpitB25H1.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitB25H1.this.setNew.throttle2 = (0.85F * CockpitB25H1.this.setOld.throttle2)
						+ (CockpitB25H1.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitB25H1.this.setNew.prop1 = (0.85F * CockpitB25H1.this.setOld.prop1)
						+ (CockpitB25H1.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitB25H1.this.setNew.prop2 = (0.85F * CockpitB25H1.this.setOld.prop2)
						+ (CockpitB25H1.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitB25H1.this.setNew.altimeter = CockpitB25H1.this.fm
						.getAltitude();
				float f = CockpitB25H1.this.waypointAzimuth();
				CockpitB25H1.this.setNew.azimuth.setDeg(
						CockpitB25H1.this.setOld.azimuth.getDeg(1.0F),
						CockpitB25H1.this.fm.Or.azimut());
				CockpitB25H1.this.setNew.waypointAzimuth.setDeg(
						CockpitB25H1.this.setOld.waypointAzimuth.getDeg(1.0F),
						f);
				CockpitB25H1.this.setNew.waypointDeviation
						.setDeg(CockpitB25H1.this.setOld.waypointDeviation
								.getDeg(0.1F),
								(f - CockpitB25H1.this.setOld.azimuth
										.getDeg(1.0F))
										+ World.Rnd().nextFloat(-10F, 10F));
				CockpitB25H1.this.setNew.vspeed = ((199F * CockpitB25H1.this.setOld.vspeed) + CockpitB25H1.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public CockpitB25H1() {
		super("3DO/Cockpit/B-25J/CockpitB25H1.him", "bf109");
