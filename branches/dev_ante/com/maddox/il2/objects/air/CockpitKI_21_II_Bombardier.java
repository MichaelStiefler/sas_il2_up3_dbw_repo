...
public class CockpitKI_21_II_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    if (this.bEntered)
    {
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((KI_21_II)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);
      boolean bool = ((KI_21_II)aircraft()).fSightCurReadyness > 0.93F;
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      float f1 = ((KI_21_II)CockpitKI_21_II_Bombardier.this.aircraft()).fSightCurForwardAngle;
      float f2 = ((KI_21_II)CockpitKI_21_II_Bombardier.this.aircraft()).fSightCurSideslip;
      CockpitKI_21_II_Bombardier.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitKI_21_II_Bombardier.this.bEntered)
      {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitKI_21_II_Bombardier.this.aAim + f2, CockpitKI_21_II_Bombardier.this.tAim + f1, 0.0F);
      }
      CockpitKI_21_II_Bombardier.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Turret1A", 0.0F, -CockpitKI_21_II_Bombardier.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[0], 0.0F);
      CockpitKI_21_II_Bombardier.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Turret1B", 0.0F, CockpitKI_21_II_Bombardier.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[1], 0.0F);
      return true;
    }
