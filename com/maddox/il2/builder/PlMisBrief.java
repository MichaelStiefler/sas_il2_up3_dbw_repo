...
public class PlMisBrief extends com.maddox.il2.builder.Plugin
{
    ...
    {
        if(com.maddox.il2.builder.PlMisBrief.getPlugin("Mission") == null)
        {
            throw new RuntimeException("PlMisTarget: plugin 'Mission' not found");
        } else
        {
            pluginMission = (com.maddox.il2.builder.PlMission)com.maddox.il2.builder.PlMisBrief.getPlugin("Mission");
            return;
        }
    }
    ...
    {
        mEditor = builder.mEdit.subMenu.addItem(0, new com.maddox.gwindow.GWindowMenuItem(builder.mEdit.subMenu, com.maddox.il2.builder.PlMisBrief.i18n("&Texts"), com.maddox.il2.builder.PlMisBrief.i18n("TIPTexts")) {
