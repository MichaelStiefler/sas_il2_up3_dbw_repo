    ...
    implements com.maddox.il2.engine.MsgDreamListener
{
    ...
    public void Detach(com.maddox.il2.engine.Actor actor, com.maddox.il2.engine.Actor actor1)
    {
        ...
        int j;
        for(j = 0; j < i; j++)
            if(actor == (com.maddox.il2.engine.Actor)aobj[j])
                break;
    ...
    public com.maddox.il2.ai.ground.UnitMove AskMoveCommand(com.maddox.il2.engine.Actor actor, com.maddox.JGP.Point3d point3d, com.maddox.il2.ai.ground.StaticObstacle staticobstacle)
    {
        ...
        com.maddox.JGP.Vector3d vector3d;
        for(vector3d = new Vector3d(roadsegment.dir2D.x, roadsegment.dir2D.y, 0.0D); !flag && staticobstacle.updateState();)
        {
                    ...
                    } else
                    {
                        ...
                        } else
                        {
                            for(int j = 0; j < 6; j++)
                            {
                                ...
                                if(com.maddox.il2.ai.ground.ChiefGround.intersectCircle(staticobstacle.pos, d17, point3d1, d14, f7))
                            ...
                            vector3d.set(com.maddox.JGP.Geom.cosDeg(f8), com.maddox.JGP.Geom.sinDeg(f8), d14);
                        }
                    }
                }
            }
