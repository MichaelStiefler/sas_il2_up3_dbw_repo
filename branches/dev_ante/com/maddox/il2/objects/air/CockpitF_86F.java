...
public class CockpitF_86F extends CockpitPilot
{
  ...
  public CockpitF_86F() {
    super("3DO/Cockpit/YP-80/hier2.him", "bf109");
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitF_86F this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF_86F.this.fm != null) {
        CockpitF_86F.access$102(CockpitF_86F.this, CockpitF_86F.this.setOld);
        CockpitF_86F.access$202(CockpitF_86F.this, CockpitF_86F.this.setNew);
        CockpitF_86F.access$302(CockpitF_86F.this, CockpitF_86F.this.setTmp);
        ...
        CockpitF_86F.this.setNew.azimuth = ((35.0F * CockpitF_86F.this.setOld.azimuth + -CockpitF_86F.this.fm.Or.getYaw()) / 36.0F);

        if ((CockpitF_86F.this.setOld.azimuth > 270.0F) && (CockpitF_86F.this.setNew.azimuth < 90.0F))
          CockpitF_86F.this.setOld.azimuth -= 360.0F;
        if ((CockpitF_86F.this.setOld.azimuth < 90.0F) && (CockpitF_86F.this.setNew.azimuth > 270.0F))
          CockpitF_86F.this.setOld.azimuth += 360.0F;
        CockpitF_86F.this.setNew.waypointAzimuth = ((10.0F * CockpitF_86F.this.setOld.waypointAzimuth + CockpitF_86F.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

        CockpitF_86F.this.setNew.vspeed = ((199.0F * CockpitF_86F.this.setOld.vspeed + CockpitF_86F.this.fm.getVertSpeed()) / 200.0F);

        float f = ((F_86F)CockpitF_86F.this.aircraft()).k14Distance;
        CockpitF_86F.this.setNew.k14w = (5.0F * CockpitF_86F.k14TargetWingspanScale[((F_86F)CockpitF_86F.this.aircraft()).k14WingspanType] / f);
        ...
        if (CockpitF_86F.this.tFX != null)
          if (((F_86F)CockpitF_86F.this.aircraft()).ist()) {
            if (!CockpitF_86F.this.tFX.isPlaying())
              CockpitF_86F.this.tFX.play();
          } else CockpitF_86F.this.tFX.stop();
        Vector3d vector3d = CockpitF_86F.this.aircraft().FM.getW();
        double d = 0.00125D * f;
        float f_0_ = (float)Math.toDegrees(d * vector3d.z);
        float f_1_ = -(float)Math.toDegrees(d * vector3d.y);
        float f_2_ = CockpitF_86F.this.floatindex((f - 200.0F) * 0.04F, CockpitF_86F.k14BulletDrop) - CockpitF_86F.k14BulletDrop[0];
        f_1_ += (float)Math.toDegrees(Math.atan(f_2_ / f));
        CockpitF_86F.this.setNew.k14x = (0.92F * CockpitF_86F.this.setOld.k14x + 0.08F * f_0_);
        CockpitF_86F.this.setNew.k14y = (0.92F * CockpitF_86F.this.setOld.k14y + 0.08F * f_1_);
        if (CockpitF_86F.this.setNew.k14x > 7.0F)
          CockpitF_86F.this.setNew.k14x = 7.0F;
        if (CockpitF_86F.this.setNew.k14x < -7.0F)
          CockpitF_86F.this.setNew.k14x = -7.0F;
        if (CockpitF_86F.this.setNew.k14y > 7.0F)
          CockpitF_86F.this.setNew.k14y = 7.0F;
        if (CockpitF_86F.this.setNew.k14y < -7.0F)
          CockpitF_86F.this.setNew.k14y = -7.0F;
      }
      return true;
