...
// Source File Name:   CockpitDXXI_SARJA3_LATE.java
...
//            CockpitPilot, DXXI_SARJA3_LATE, Cockpit, Aircraft

public class CockpitDXXI_SARJA3_LATE extends com.maddox.il2.objects.air.CockpitPilot
{
    private class Variables
    {
        ...
        private Variables()
        {
            ...
            compassPoint[0] = new Vector3d(0.0D, java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
            compassPoint[1] = new Vector3d(-java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), 0.0D, com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
            compassPoint[2] = new Vector3d(0.0D, -java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
            compassPoint[3] = new Vector3d(java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), 0.0D, com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
            cP[0] = new Vector3d(0.0D, java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
            cP[1] = new Vector3d(-java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), 0.0D, com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
            cP[2] = new Vector3d(0.0D, -java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
            cP[3] = new Vector3d(java.lang.Math.sqrt(1.0D - com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ * com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ), 0.0D, com.maddox.il2.objects.air.CockpitDXXI_SARJA3_LATE.compassZ);
        }
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(useRealisticNavigationInstruments())
                setNew.azimuth.setDeg(setOld.azimuth.getDeg(1.0F), fm.Or.azimut() + ac.gyroDelta);
            else
    ...
    public CockpitDXXI_SARJA3_LATE()
    {
        ...
        oilPressure = 0.0F;
        compassFirst = 0;
        ac = (com.maddox.il2.objects.air.DXXI_SARJA3_LATE)aircraft();
        ac.registerPit(this);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(((com.maddox.il2.objects.air.DXXI_SARJA3_LATE)aircraft()).bChangedPit)
        {
            reflectPlaneToModel();
            ((com.maddox.il2.objects.air.DXXI_SARJA3_LATE)aircraft()).bChangedPit = false;
        }
    ...
    private com.maddox.il2.objects.air.DXXI_SARJA3_LATE ac;
