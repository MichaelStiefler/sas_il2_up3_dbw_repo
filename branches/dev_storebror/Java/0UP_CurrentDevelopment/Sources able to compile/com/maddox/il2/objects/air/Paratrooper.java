...
public class Paratrooper extends ActorMesh implements MsgCollisionRequestListener, MsgCollisionListener, MsgExplosionListener, MsgShotListener
{
	...
	static
	{
		Spawn.add((class$com$maddox$il2$objects$air$Paratrooper == null ? (class$com$maddox$il2$objects$air$Paratrooper = class$zutiParatrooper("Paratrooper")) : class$com$maddox$il2$objects$air$Paratrooper), new SPAWN());
	}
