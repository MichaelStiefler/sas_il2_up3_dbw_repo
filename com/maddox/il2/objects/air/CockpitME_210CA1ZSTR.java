...
public class CockpitME_210CA1ZSTR extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Fuelpress1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.77F : 0.0F, 0.0F, 2.0F, 0.0F, 160.0F), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Fuelpress2", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.77F : 0.0F, 0.0F, 2.0F, 0.0F, 160.0F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (((ME_210CA1ZSTR)CockpitME_210CA1ZSTR.this.aircraft() == null) || 
        (ME_210CA1ZSTR.bChangedPit))
      {
        CockpitME_210CA1ZSTR.this.reflectPlaneToModel();
        if ((ME_210CA1ZSTR)CockpitME_210CA1ZSTR.this.aircraft() != null);
        ME_210CA1ZSTR.bChangedPit = false;
      }
      CockpitME_210CA1ZSTR.access$002(CockpitME_210CA1ZSTR.this, CockpitME_210CA1ZSTR.this.setOld);
      CockpitME_210CA1ZSTR.access$102(CockpitME_210CA1ZSTR.this, CockpitME_210CA1ZSTR.this.setNew);
      CockpitME_210CA1ZSTR.access$202(CockpitME_210CA1ZSTR.this, CockpitME_210CA1ZSTR.this.setTmp);
      CockpitME_210CA1ZSTR.this.setNew.altimeter = CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitME_210CA1ZSTR.this.cockpitDimControl)
      {
        if (CockpitME_210CA1ZSTR.this.setNew.dimPosition > 0.0F)
          CockpitME_210CA1ZSTR.this.setNew.dimPosition -= 0.05F;
      }
      else if (CockpitME_210CA1ZSTR.this.setNew.dimPosition < 1.0F)
        CockpitME_210CA1ZSTR.this.setNew.dimPosition += 0.05F;
      CockpitME_210CA1ZSTR.this.setNew.throttle1 = (0.91F * CockpitME_210CA1ZSTR.this.setOld.throttle1 + 0.09F * CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitME_210CA1ZSTR.this.setNew.throttle2 = (0.91F * CockpitME_210CA1ZSTR.this.setOld.throttle2 + 0.09F * CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitME_210CA1ZSTR.this.setNew.mix1 = (0.88F * CockpitME_210CA1ZSTR.this.setOld.mix1 + 0.12F * CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitME_210CA1ZSTR.this.setNew.mix2 = (0.88F * CockpitME_210CA1ZSTR.this.setOld.mix2 + 0.12F * CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitME_210CA1ZSTR.this.setNew.azimuth = CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitME_210CA1ZSTR.this.setOld.azimuth > 270.0F) && (CockpitME_210CA1ZSTR.this.setNew.azimuth < 90.0F))
        CockpitME_210CA1ZSTR.this.setOld.azimuth -= 360.0F;
      if ((CockpitME_210CA1ZSTR.this.setOld.azimuth < 90.0F) && (CockpitME_210CA1ZSTR.this.setNew.azimuth > 270.0F))
        CockpitME_210CA1ZSTR.this.setOld.azimuth += 360.0F;
      CockpitME_210CA1ZSTR.this.setNew.waypointAzimuth = ((10.0F * CockpitME_210CA1ZSTR.this.setOld.waypointAzimuth + (CockpitME_210CA1ZSTR.this.waypointAzimuth() - CockpitME_210CA1ZSTR.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitME_210CA1ZSTR.Variables localVariables = CockpitME_210CA1ZSTR.this.setNew;
      float f1 = 0.9F * CockpitME_210CA1ZSTR.this.setOld.radioalt;
      float f2 = 0.1F;
      float f3 = CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      World.cur();
      World.land();
      localVariables.radioalt = (f1 + f2 * (f3 - Landscape.HQ_Air((float)CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.x, (float)CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y)));
      CockpitME_210CA1ZSTR.this.setNew.vspeed = ((199.0F * CockpitME_210CA1ZSTR.this.setOld.vspeed + CockpitME_210CA1ZSTR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitME_210CA1ZSTR.access$302(CockpitME_210CA1ZSTR.this, CockpitME_210CA1ZSTR.this.middleAngleTarget * 0.05F + 0.95F * CockpitME_210CA1ZSTR.this.middleAngle);
      return true;
    }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float radioalt;
    private final CockpitME_210CA1ZSTR this$0;
    ...
    Variables(CockpitME_210CA1ZSTR.1 arg2)
    {
      this();
    }
  }
