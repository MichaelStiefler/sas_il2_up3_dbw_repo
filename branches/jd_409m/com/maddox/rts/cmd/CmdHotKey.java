...
public class CmdHotKey extends Cmd
{
  ...
  public Object exec(CmdEnv paramCmdEnv, Map paramMap)
  {
    if (Cmd.exist(paramMap, "_$$")) {
      ...
      if (Cmd.nargs(paramMap, "_$$") > 1) {
        i = VK.getKeyFromText(Cmd.arg(paramMap, "_$$", 0));
        k = 1;
      }
      int j = VK.getKeyFromText(Cmd.arg(paramMap, "_$$", k));
      if (j == 0) {
        ERR_SOFT("unknown HotKey - " + Cmd.arg(paramMap, "_$$", k));
        return null;
      }
      String str1 = Cmd.args(paramMap, "ENV");
      if (str1 == null) str1 = "default";
      if (Cmd.nargs(paramMap, "CMD") > 0) {
        HotKeyEnv.addHotKey(str1, i, j, Cmd.args(paramMap, "CMD"));
      } else if (Cmd.nargs(paramMap, "CMDRUN") > 0) {
        String str2 = Cmd.args(paramMap, "CMDRUN");
        HotKeyEnv.addHotKey(str1, i, j, str2);
        HotKeyCmdEnv.addCmd("cmdrun", new HotKeyCmdRun(paramCmdEnv, Cmd.exist(paramMap, "REALTIME"), str2));
      } else {
  ...
  public CmdHotKey() {
    this.jdField_param_of_type_JavaUtilTreeMap.put("CMD", null);
    this.jdField_param_of_type_JavaUtilTreeMap.put("ENV", null);
    this.jdField_param_of_type_JavaUtilTreeMap.put("CMDRUN", null);
    this.jdField_param_of_type_JavaUtilTreeMap.put("REALTIME", null);
