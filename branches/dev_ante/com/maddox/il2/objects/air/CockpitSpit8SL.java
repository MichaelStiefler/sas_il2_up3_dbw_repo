...
public class CockpitSpit8SL extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitSpit8SL this$0;
    ...
    Variables(CockpitSpit8SL.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitSpit8SL.access$002(CockpitSpit8SL.this, CockpitSpit8SL.this.setOld);
        CockpitSpit8SL.access$102(CockpitSpit8SL.this, CockpitSpit8SL.this.setNew);
        CockpitSpit8SL.access$202(CockpitSpit8SL.this, CockpitSpit8SL.this.setTmp);
        CockpitSpit8SL.this.setNew.throttle = (0.92F * CockpitSpit8SL.this.setOld.throttle + 0.08F * CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitSpit8SL.this.setNew.prop = (0.92F * CockpitSpit8SL.this.setOld.prop + 0.08F * CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitSpit8SL.this.setNew.mix = (0.92F * CockpitSpit8SL.this.setOld.mix + 0.08F * CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitSpit8SL.this.setNew.altimeter = CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
        {
          CockpitSpit8SL.this.setNew.azimuth = (0.97F * CockpitSpit8SL.this.setOld.azimuth + 0.03F * -CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw());
        }
        if ((CockpitSpit8SL.this.setOld.azimuth > 270.0F) && (CockpitSpit8SL.this.setNew.azimuth < 90.0F))
        {
          CockpitSpit8SL.this.setOld.azimuth -= 360.0F;
        }
        if ((CockpitSpit8SL.this.setOld.azimuth < 90.0F) && (CockpitSpit8SL.this.setNew.azimuth > 270.0F))
        {
          CockpitSpit8SL.this.setOld.azimuth += 360.0F;
        }
        CockpitSpit8SL.this.setNew.waypointAzimuth = (0.91F * CockpitSpit8SL.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit8SL.this.waypointAzimuth() - CockpitSpit8SL.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitSpit8SL.this.setNew.vspeed = (0.99F * CockpitSpit8SL.this.setOld.vspeed + 0.01F * CockpitSpit8SL.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed());
      }
      return true;
    }
