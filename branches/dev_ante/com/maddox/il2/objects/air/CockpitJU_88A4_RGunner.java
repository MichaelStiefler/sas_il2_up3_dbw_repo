...
public class CockpitJU_88A4_RGunner extends CockpitGunner
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitJU_88A4_RGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_RGunner.this.setOld.throttle1 + CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_RGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A4_RGunner.this.setOld.prop1 + CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);

        CockpitJU_88A4_RGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_RGunner.this.setOld.throttle2 + CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_RGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A4_RGunner.this.setOld.prop2 + CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);

        CockpitJU_88A4_RGunner.this.setNew.altimeter = CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        ...
        CockpitJU_88A4_RGunner.this.setNew.azimuth.setDeg(CockpitJU_88A4_RGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitJU_88A4_RGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_RGunner.this.setOld.vspeed + CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        ...
        float f2 = CockpitJU_88A4_RGunner.this.prevFuel - CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel;
        CockpitJU_88A4_RGunner.access$402(CockpitJU_88A4_RGunner.this, CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        ...
        if (CockpitJU_88A4_RGunner.this.buzzerFX != null) {
          if ((CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < ((JU_88A4)CockpitJU_88A4_RGunner.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4)CockpitJU_88A4_RGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1))
