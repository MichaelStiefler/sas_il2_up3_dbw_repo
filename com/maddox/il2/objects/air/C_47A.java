...
public class C_47A extends Scheme2
  implements TypeTransport, TypeBomber
{
  ...
  static {
    ...
    Property.set(localClass, "FlightModel", "FlightModels/C-47A.fmd");
    ...
    {
      System.out.println("Error C-47A Weapons 'default ' NOT initialized:" + localException1.getMessage());
    }
    try
    {
      String str2 = "18xPara";
    ...
    {
      System.out.println("Error C-47A Weapons '18xPara ' NOT initialized:" + localException2.getMessage());
    }
    try
    {
    ...
    {
      System.out.println("Error C-47A Weapons '5xCargoA' NOT initialized:" + localException3.getMessage());
    }
    try
    {
      String str4 = "none";
    ...
    {
      System.out.println("Error C-47A Weapons 'none ' NOT initialized:" + localException4.getMessage());
    }
  }
}