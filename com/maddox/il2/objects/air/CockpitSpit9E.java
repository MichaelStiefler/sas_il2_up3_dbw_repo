...
public class CockpitSpit9E extends CockpitPilot
{
  ...
  public CockpitSpit9E() {
    super("3DO/Cockpit/SpitfireMkIXc/spitE.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    int i = ((SPITFIRE9E)aircraft()).k14Mode;
    boolean bool = i < 2;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitSpit9E this$0;
    ...
    Variables(CockpitSpit9E.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit9E.this.bNeedSetUp) {
        CockpitSpit9E.this.reflectPlaneMats();
        CockpitSpit9E.access$102(CockpitSpit9E.this, false);
      }
      if (CockpitSpit9E.this.fm != null) {
        CockpitSpit9E.access$202(CockpitSpit9E.this, CockpitSpit9E.this.setOld);
        CockpitSpit9E.access$302(CockpitSpit9E.this, CockpitSpit9E.this.setNew);
        CockpitSpit9E.access$402(CockpitSpit9E.this, CockpitSpit9E.this.setTmp);
        CockpitSpit9E.this.setNew.throttle = (0.92F * CockpitSpit9E.this.setOld.throttle + 0.08F * CockpitSpit9E.this.fm.CT.PowerControl);

        CockpitSpit9E.this.setNew.prop = (0.92F * CockpitSpit9E.this.setOld.prop + 0.08F * CockpitSpit9E.this.fm.EI.engines[0].getControlProp());

        CockpitSpit9E.this.setNew.mix = (0.92F * CockpitSpit9E.this.setOld.mix + 0.08F * CockpitSpit9E.this.fm.EI.engines[0].getControlMix());

        CockpitSpit9E.this.setNew.altimeter = CockpitSpit9E.this.fm.getAltitude();
        if (Math.abs(CockpitSpit9E.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit9E.this.setNew.azimuth = (0.97F * CockpitSpit9E.this.setOld.azimuth + 0.03F * -CockpitSpit9E.this.fm.Or.getYaw());
        }
        if ((CockpitSpit9E.this.setOld.azimuth > 270.0F) && (CockpitSpit9E.this.setNew.azimuth < 90.0F))
          CockpitSpit9E.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit9E.this.setOld.azimuth < 90.0F) && (CockpitSpit9E.this.setNew.azimuth > 270.0F))
          CockpitSpit9E.this.setOld.azimuth += 360.0F;
        CockpitSpit9E.this.setNew.waypointAzimuth = (0.91F * CockpitSpit9E.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit9E.this.waypointAzimuth() - CockpitSpit9E.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitSpit9E.this.setNew.vspeed = (0.99F * CockpitSpit9E.this.setOld.vspeed + 0.01F * CockpitSpit9E.this.fm.getVertSpeed());

        float f1 = ((SPITFIRE9E)CockpitSpit9E.this.aircraft()).k14Distance;

        CockpitSpit9E.this.setNew.k14w = (5.0F * CockpitSpit9E.k14TargetWingspanScale[((SPITFIRE9E)CockpitSpit9E.this.aircraft()).k14WingspanType] / f1);

        CockpitSpit9E.this.setNew.k14w = (0.9F * CockpitSpit9E.this.setOld.k14w + 0.1F * CockpitSpit9E.this.setNew.k14w);
        CockpitSpit9E.this.setNew.k14wingspan = (0.9F * CockpitSpit9E.this.setOld.k14wingspan + 0.1F * CockpitSpit9E.k14TargetMarkScale[((SPITFIRE9E)CockpitSpit9E.this.aircraft()).k14WingspanType]);

        CockpitSpit9E.this.setNew.k14mode = (0.8F * CockpitSpit9E.this.setOld.k14mode + 0.2F * ((SPITFIRE9E)CockpitSpit9E.this.aircraft()).k14Mode);

        Vector3d localVector3d = CockpitSpit9E.this.aircraft().FM.getW();

        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitSpit9E.this.floatindex((f1 - 200.0F) * 0.04F, CockpitSpit9E.k14BulletDrop) - CockpitSpit9E.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitSpit9E.this.setNew.k14x = (0.92F * CockpitSpit9E.this.setOld.k14x + 0.08F * f2);
        CockpitSpit9E.this.setNew.k14y = (0.92F * CockpitSpit9E.this.setOld.k14y + 0.08F * f3);
        if (CockpitSpit9E.this.setNew.k14x > 7.0F)
          CockpitSpit9E.this.setNew.k14x = 7.0F;
        if (CockpitSpit9E.this.setNew.k14x < -7.0F)
          CockpitSpit9E.this.setNew.k14x = -7.0F;
        if (CockpitSpit9E.this.setNew.k14y > 7.0F)
          CockpitSpit9E.this.setNew.k14y = 7.0F;
        if (CockpitSpit9E.this.setNew.k14y < -7.0F)
          CockpitSpit9E.this.setNew.k14y = -7.0F;
      }
      return true;
