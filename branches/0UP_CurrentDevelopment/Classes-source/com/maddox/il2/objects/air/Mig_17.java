...
;
    ...
    {
        com.maddox.il2.objects.air.Mig_17.moveGear(hierMesh(), paramFloat);
    }
    ...
    private final void umnr()
    {
        ...
        mig_17.mn = f / com.maddox.il2.fm.Atmosphere.sonicSpeed((float)((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (super.FM)).Loc)).z);
        if(mn >= lteb)
            ts = true;
        else
            ts = false;
    ...
    public void doSetSootState(int paramInt1, int paramInt2)
    {
        ...
        case 5: // '\005'
            ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.astateSootEffects[paramInt1][0] = com.maddox.il2.engine.Eff3DActor.New(this, findHook("_Engine1EF_01"), null, 0.75F, "3DO/Effects/Aircraft/TurboZippo.eff", -1F);
            ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.astateSootEffects[paramInt1][1] = com.maddox.il2.engine.Eff3DActor.New(this, findHook("_Engine1EF_02"), null, 2.0F, "3DO/Effects/Aircraft/TurboJRD1100F.eff", -1F);
            break;
        }
    }
