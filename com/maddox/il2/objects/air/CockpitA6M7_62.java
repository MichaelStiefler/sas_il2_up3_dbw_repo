...
public class CockpitA6M7_62 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Turn3", 0.0F, 68.0F * cvt(interp(this.setNew.mix, this.setOld.mix, paramFloat), 1.0F, 1.2F, 0.5F, 1.0F), 0.0F);
    this.mesh.chunkSetAngles("Turn3_rod", 0.0F, -68.0F * cvt(interp(this.setNew.mix, this.setOld.mix, paramFloat), 1.0F, 1.2F, 0.5F, 1.0F), 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, floatindex(cvt(Pitot.Indicator((float)this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20.0F), speedometerScale), 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_Revolution", 0.0F, cvt(this.fm.EI.engines[0].getRPM(), 500.0F, 4500.0F, 0.0F, 720.0F), 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_PressMixt1a", 0.0F, cvt((float)Math.sqrt(Math.sqrt(this.fm.M.nitro)), 0.0F, 2.783F, 0.0F, 330.0F), 0.0F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M7_62.this.fm != null) {
        ...
        if ((CockpitA6M7_62.this.fm.AS.astateCockpitState & 0x2) != 0) {
        ...
        CockpitA6M7_62.this.setNew.vspeed = ((199.0F * CockpitA6M7_62.this.setOld.vspeed + CockpitA6M7_62.this.fm.getVertSpeed()) / 200.0F);
        ...
        else
        {
          ...
          CockpitA6M7_62.this.setNew.waypointDirection.setDeg(CockpitA6M7_62.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M7_62.this.fm.Or.azimut() + 90.0F);
        }
