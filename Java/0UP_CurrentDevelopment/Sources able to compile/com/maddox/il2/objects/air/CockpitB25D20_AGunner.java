...
public class CockpitB25D20_AGunner extends CockpitGunner
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if((B_25D20)aircraft() != null);
        if(B_25D20.bChangedPit)
        {
            reflectPlaneToModel();
            if((B_25D20)aircraft() != null);
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitB25D20_AGunner.class, "aiTuretNum", 2);
        com.maddox.rts.Property.set(CockpitB25D20_AGunner.class, "weaponControlNum", 12);
        com.maddox.rts.Property.set(CockpitB25D20_AGunner.class, "astatePilotIndx", 4);
    }
}
