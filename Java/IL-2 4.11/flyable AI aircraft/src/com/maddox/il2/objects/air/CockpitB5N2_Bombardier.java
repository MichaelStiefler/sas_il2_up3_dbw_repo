// Source File Name: CockpitB5N2_Bombardier.java
...
public class CockpitB5N2_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB5N2_Bombardier.this.bEntered) {
				float f = ((B5N2) CockpitB5N2_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((B5N2) CockpitB5N2_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitB5N2_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1,
						0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitB5N2_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public CockpitB5N2_Bombardier() {
		super("3DO/Cockpit/Pe-2-Bombardier/BombardierB5N2.him", "he111");
		enteringAim = false;
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((B5N2) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F,
				0.0F);
		float f1 = this.cvt(((B5N2) this.aircraft()).fSightSetForwardAngle,
				-15F, 75F, -15F, 75F);
