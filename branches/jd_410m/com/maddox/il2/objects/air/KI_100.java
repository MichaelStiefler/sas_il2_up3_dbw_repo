  ...
  implements TypeFighter
{
  ...
  {
    resetYPRmodifier();
    xyz[1] = cvt(paramFloat, 0.16F, 0.98F, 0.0F, 0.65F);
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    paramHierMesh.chunkSetAngles("GearL6_D0", 0.0F, cvt(paramFloat, 0.1F, 0.82F, 0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL7_D0", 0.0F, cvt(paramFloat, 0.1F, 0.12F, 0.0F, -86.0F), 0.0F);

    paramHierMesh.chunkSetAngles("GearR2_D0", 0.0F, cvt(paramFloat, 0.34F, 0.91F, 0.0F, -82.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR6_D0", 0.0F, cvt(paramFloat, 0.34F, 0.91F, 0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(paramFloat, 0.34F, 0.36F, 0.0F, -86.0F), 0.0F);
  }
    ...
    if (paramString.startsWith("xx")) {
      ...
      if (paramString.startsWith("xxcontrols")) {
        ...
        case 2:
          ...
          debugprintln(this, "*** Throttle Quadrant: Hit, Prop Controls Disabled.."); break;
        case 3:
        case 4:
