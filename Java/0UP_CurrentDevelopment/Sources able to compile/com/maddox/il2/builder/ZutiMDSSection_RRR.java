...
public class ZutiMDSSection_RRR extends GWindowFramed
{
	...
	public GWindowCheckBox wZutiReload_EnableResourcesManagement_Red;
	public GWindowCheckBox wZutiReload_EnableResourcesManagement_Blue;
	...
	private GWindowBoxSeparate 	bSeparate_Resources_Red;
	private GWindowLabel 		lSeparate_Resources_Red;
	private GWindowBoxSeparate 	bSeparate_Resources_Blue;
	private GWindowLabel 		lSeparate_Resources_Blue;
	
	public ZutiMDSSection_RRR()
	{
		doNew(Plugin.builder.clientWindow, 2.0F, 2.0F, 40.0F, 39.0F, true);
		bSizable = false;
	}
	...
	public void created()
	{
		...
		//TODO: 
		gwindowdialogclient.addLabel(lSeparate_Resources_Red = new GWindowLabel(gwindowdialogclient, 2.0F, 29.5F, 15.0F, 1.6F, Plugin.i18n("mds.RRR.resourcesRed"), null));
		bSeparate_Resources_Red = new GWindowBoxSeparate(gwindowdialogclient, 1.0F, 30.0F, 18.0F, 6.0F);
		bSeparate_Resources_Red.exclude = lSeparate_Resources_Red;
		
		gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 3.0F, 31.0F, 35.0F, 1.3F, Plugin.i18n("mds.RRR.enableResourcesMng"), null));
		gwindowdialogclient.addControl(wZutiReload_EnableResourcesManagement_Red = new GWindowCheckBox(gwindowdialogclient, 16.0F, 31.0F, null)
		{
			public void preRender()
			{
				super.preRender();
		...
		//RED team resources
		gwindowdialogclient.addControl(new GWindowButton(gwindowdialogclient, 2.0F, 33.0F, 16.0F, 2.0F, Plugin.i18n("mds.RRR.setResourcesRed"), null)
		{
			public void preRender()
			{
				super.preRender();
				
				this.setEnable(wZutiReload_EnableResourcesManagement_Red.isChecked());
				if( !this.isEnable() )
		...
		gwindowdialogclient.addLabel(lSeparate_Resources_Blue = new GWindowLabel(gwindowdialogclient, 21.0F, 29.5F, 15.0F, 1.6F, Plugin.i18n("mds.RRR.resourcesBlue"), null));
		bSeparate_Resources_Blue = new GWindowBoxSeparate(gwindowdialogclient, 20.0F, 30.0F, 18.0F, 6.0F);
		bSeparate_Resources_Blue.exclude = lSeparate_Resources_Blue;
		
		gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 22.0F, 31.0F, 35.0F, 1.3F, Plugin.i18n("mds.RRR.enableResourcesMng"), null));
		gwindowdialogclient.addControl(wZutiReload_EnableResourcesManagement_Blue = new GWindowCheckBox(gwindowdialogclient, 36.0F, 31.0F, null)
		{
			public void preRender()
			{
				super.preRender();
		...
		//BLUE team resources
		gwindowdialogclient.addControl(new GWindowButton(gwindowdialogclient, 21.0F, 33.0F, 16.0F, 2.0F, Plugin.i18n("mds.RRR.setResourcesBlue"), null)
		{
			public void preRender()
			{
				super.preRender();
				
				this.setEnable(wZutiReload_EnableResourcesManagement_Blue.isChecked());
				if( !this.isEnable() )
