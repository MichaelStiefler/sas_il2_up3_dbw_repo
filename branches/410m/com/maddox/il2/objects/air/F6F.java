...
public abstract class F6F extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.F6F.cvt(f, 0.01F, 0.99F, 0.0F, 0.625F);
    ...
    {
        com.maddox.il2.objects.air.F6F.moveGear(hierMesh(), f);
    }

    public void moveWheelSink()
    {
        resetYPRmodifier();
        float f = com.maddox.il2.objects.air.F6F.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.3575F, 0.0F, 0.3575F);
        xyz[1] = f;
        hierMesh().chunkSetLocate("GearL99_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.F6F.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.3575F, 0.0F, -40F);
        hierMesh().chunkSetAngles("GearL77_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.F6F.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.3575F, 0.0F, -80F);
        hierMesh().chunkSetAngles("GearL88_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.F6F.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.3575F, 0.0F, 0.3575F);
        xyz[1] = f;
        hierMesh().chunkSetLocate("GearR99_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.F6F.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.3575F, 0.0F, -40F);
        hierMesh().chunkSetAngles("GearR77_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.F6F.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.3575F, 0.0F, -80F);
    ...
    public void update(float f)
    {
        ...
        if(FM.CT.getArrestor() > 0.9F)
            ...
            {
                arrestor2 = com.maddox.il2.objects.air.F6F.cvt(FM.Gears.arrestorVAngle, -65F, 3F, 45F, -23F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("f1"))
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(8F, 12F) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p1"))
                {
            ...
            {
                com.maddox.il2.objects.air.F6F.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.F6F.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.F6F.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.F6F.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.F6F.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.F6F.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.F6F.debugprintln(this, "*** WingROut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(14.8F * com.maddox.il2.ai.World.Rnd().nextFloat(0.99F, 1.8F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.F6F.debugprintln(this, "*** Tail1 Spars Damaged..");
        ...
        if(s.startsWith("xcf") || s.startsWith("xblister"))
        {
            if(chunkDamageVisible("CF") < 3)
                hitChunk("CF", shot);
            if((s.startsWith("xcf2") || s.startsWith("xblister")) && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                FM.AS.setCockpitState(shot.initiator, FM.AS.astateCockpitState | 1);
            if(s.startsWith("xcf3") && point3d.x > -0.64500000000000002D && point3d.x < 0.40600000000000003D && point3d.z > 0.29999999999999999D)
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.F6F.class;
