...
public class CockpitBF_109Z extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_ATA1", cvt(this.pictManifold1 = 0.75F * this.pictManifold1 + 0.25F * this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 329.0F), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_ATA2", cvt(this.pictManifold2 = 0.75F * this.pictManifold2 + 0.25F * this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 329.0F), 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_EngTemp2", cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 160.0F, 0.0F, 58.5F), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_FuelPress1", cvt(this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3.0F, 0.0F, 135.0F), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_FuelPress2", cvt(this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3.0F, 0.0F, 135.0F), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_OilPress1", cvt(1.0F + 0.05F * this.fm.EI.engines[0].tOilOut, 0.0F, 15.0F, 0.0F, 135.0F), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_OilPress2", cvt(1.0F + 0.05F * this.fm.EI.engines[1].tOilOut, 0.0F, 15.0F, 0.0F, 135.0F), 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_PropPitch3", 270.0F - (float)Math.toDegrees(this.fm.EI.engines[1].getPropPhi() - this.fm.EI.engines[1].getPropPhiMin()) * 60.0F, 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_PropPitch4", 105.0F - (float)Math.toDegrees(this.fm.EI.engines[1].getPropPhi() - this.fm.EI.engines[1].getPropPhiMin()) * 5.0F, 0.0F, 0.0F);
    ...
    if (this.gun[0] != null) {
      this.mesh.chunkSetAngles("Z_AmmoCounter1", cvt(this.gun[0].countBullets(), 0.0F, 250.0F, 15.0F, 0.0F), 0.0F, 0.0F);
    }
    if (this.gun[1] != null) {
      this.mesh.chunkSetAngles("Z_AmmoCounter2", cvt(this.gun[1].countBullets(), 0.0F, 250.0F, 15.0F, 0.0F), 0.0F, 0.0F);
    }
    if (this.gun[2] != null) {
      this.mesh.chunkSetAngles("Z_AmmoCounter3", cvt(this.gun[2].countBullets(), 0.0F, 250.0F, 15.0F, 0.0F), 0.0F, 0.0F);
    }
    ...
    if ((this.fm.AS.astateCockpitState & 0x8) == 0) {
      this.mesh.chunkSetAngles("Z_Throttle", interp(this.setNew.throttle1, this.setOld.throttle1, paramFloat) * 68.181816F, 0.0F, 0.0F);
    }
    if ((this.fm.AS.astateCockpitState & 0x8) == 0) {
      this.mesh.chunkSetAngles("Z_Throttle2", interp(this.setNew.throttle2, this.setOld.throttle2, paramFloat) * 68.181816F, 0.0F, 0.0F);
    }
    this.mesh.chunkSetAngles("Z_Mix", interp(this.setNew.mix1, this.setOld.mix2, paramFloat) * 62.5F, 0.0F, 0.0F);
    this.mesh.chunkSetAngles("Z_Mix2", interp(this.setNew.mix1, this.setOld.mix2, paramFloat) * 62.5F, 0.0F, 0.0F);
    this.mesh.chunkSetAngles("Z_MagnetoSwitch", -45.0F + 28.333F * this.fm.EI.engines[0].getControlMagnetos(), 0.0F, 0.0F);
    this.mesh.chunkSetAngles("Z_MagnetoSwit1", -45.0F + 28.333F * this.fm.EI.engines[1].getControlMagnetos(), 0.0F, 0.0F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      {
        CockpitBF_109Z.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
        CockpitBF_109Z.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
      }
      else
      {
      ...
      CockpitBF_109Z.this.setNew.turn = ((12.0F * CockpitBF_109Z.this.setOld.turn + CockpitBF_109Z.this.w.z) / 13.0F);
