...
// Source File Name:   ASGGeneric.java
...
public abstract class ASGGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.ASGGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.ASGGeneric.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.ASGGeneric asggeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.ASGGeneric.constr_arg2 = actorspawnarg;
                asggeneric = (com.maddox.il2.objects.vehicles.stationary.ASGGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.ASGGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create ASGGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (asggeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.ASGGeneric.mesh_name);
            cls = class1;
    ...
    private ASGGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
