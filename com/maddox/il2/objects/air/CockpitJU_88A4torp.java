...
public class CockpitJU_88A4torp extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    Variables(CockpitJU_88A4torp.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      ...
      if (CockpitJU_88A4torp.this.fm != null)
      {
        ...
        {
          CockpitJU_88A4torp.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4torp.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4torp.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A4torp.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A4torp.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A4torp.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
        ...
        CockpitJU_88A4torp.this.setNew.vspeed = ((199.0F * CockpitJU_88A4torp.this.setOld.vspeed + CockpitJU_88A4torp.this.fm.getVertSpeed()) / 200.0F);
        if (CockpitJU_88A4torp.this.cockpitDimControl)
        {
          if (CockpitJU_88A4torp.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A4torp.this.setNew.dimPosition -= 0.05F;
        }
        else if (CockpitJU_88A4torp.this.setNew.dimPosition < 1.0F)
          CockpitJU_88A4torp.this.setNew.dimPosition += 0.05F;
        float f2 = CockpitJU_88A4torp.this.prevFuel - CockpitJU_88A4torp.this.fm.M.fuel;
        CockpitJU_88A4torp.access$302(CockpitJU_88A4torp.this, CockpitJU_88A4torp.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
      ...
      CockpitJU_88A4torp.this.setNew.beaconDirection = ((10.0F * CockpitJU_88A4torp.this.setOld.beaconDirection + CockpitJU_88A4torp.this.getBeaconDirection()) / 11.0F);
      CockpitJU_88A4torp.this.setNew.beaconRange = ((10.0F * CockpitJU_88A4torp.this.setOld.beaconRange + CockpitJU_88A4torp.this.getBeaconRange()) / 11.0F);
