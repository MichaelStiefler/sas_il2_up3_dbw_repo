...
// Source File Name:   CockpitJU_87D5.java
...
public class CockpitJU_87D5 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(fm != null)
            {
                ...
                if(buzzerFX != null)
                    if(fm.Loc.z < (double)((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveRecoveryAlt && ((com.maddox.il2.objects.air.JU_87)(com.maddox.il2.objects.air.JU_87)fm.actor).diveMechStage == 1)
                        buzzerFX.play();
                    else
                    if(buzzerFX.isPlaying())
                        buzzerFX.stop();
                float f1 = ((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveRecoveryAlt;
                float f2 = -(((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.sin(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float)java.lang.Math.sqrt(f2 * f2 + 2.0F * f1 * 0.1019F);
                float f3 = ((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.cos(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveAngle));
                float f4 = (f3 * f2 + 10F) - 10F;
                setNew.alpha = 90F - ((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveAngle - (float)java.lang.Math.toDegrees(java.lang.Math.atan(f4 / f1));
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[2] = -(10.27825F * (float)java.lang.Math.tan(java.lang.Math.toRadians(setNew.alpha)));
        if(xyz[2] < -2.2699F)
            xyz[2] = -2.2699F;
        mesh.chunkSetLocate("Z_Z_RETICLE1", xyz, ypr);
        ...
        mesh.chunkSetAngles("zproppitch1", cvt(setNew.beaconDirection, -45F, 45F, 20F, -20F), 0.0F, 0.0F);
        mesh.chunkSetAngles("zproppitch2", cvt(setNew.beaconRange, 0.0F, 1.0F, -20F, 20F), 0.0F, 0.0F);
