        ...
        private com.maddox.il2.engine.Actor _actorSpawn(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
        {
            ...
            try
            {
                ...
                if(_netUser != null)
                {
                    ...
                    {
                        java.lang.String s2 = actorspawnarg.name.substring(0, j - 4);
                        obj1 = (com.maddox.il2.ai.Regiment)com.maddox.il2.engine.Actor.getByName(s2);
                    }
                ...
                } else
                {
                    ...
                    i += j1 * 16 + l * 4;
                    java.lang.String s3 = actorspawnarg.name.substring(0, j - 3);
            ...
            if(_netUser != null)
            {
                if(com.maddox.il2.game.Main.cur().netServerParams != null && com.maddox.il2.game.Main.cur().netServerParams.isMaster())
                {
                    try
                    {
                        if(_netUser.masterChannel() != null)
                        {
                            java.lang.String s = ((com.maddox.il2.net.NetUser)com.maddox.rts.NetEnv.host()).uniqueName();
                            java.lang.String s1 = _netUser.masterChannel().remoteAddress().getHostAddress().toString();
                            if(com.maddox.il2.game.ZutiSupportMethods.isPlayerBanned(s, s1))
                            {
                                com.maddox.il2.game.ZutiNetSendMethods.playerBanned(_netUser);
                                flag = true;
                            }
                        }
                    }
                    ...
                    {
                        java.lang.System.out.println("NetAircraft error ID_01: " + exception1.toString());
                    }
                    if(!netaircraft.zutiCheckIfSelectedPlaneIsAvailable(_netUser))
                    {
                        com.maddox.il2.game.ZutiNetSendMethods.aircraftNotAvailable(_netUser);
                        flag = true;
                    }
                }
                actorspawnarg.name = null;
            ...
            {
                com.maddox.il2.objects.air.NetAircraft.printDebug(exception2);
            }
            ...
            if(actorspawnarg.bornPlaceExist)
            {
                ...
                com.maddox.il2.engine.Loc loc1 = bornplace.getAircraftPlace((com.maddox.il2.objects.air.Aircraft)netaircraft, actorspawnarg.stayPlace);
                actorspawnarg.point = loc1.getPoint();
                actorspawnarg.orient = loc1.getOrient();
                actorspawnarg.armyExist = true;
                actorspawnarg.army = bornplace.army;
                actorspawnarg.speed = new Vector3d();
                if(bornplace.zutiAirspawnOnly || !com.maddox.il2.ai.World.cur().diffCur.Takeoff_N_Landing || actorspawnarg.stayPlace >= com.maddox.il2.ai.World.cur().airdrome.stayHold.length && !netaircraft.FM.brakeShoe)
                {
                    actorspawnarg.point.z = bornplace.zutiSpawnHeight;
                    actorspawnarg.orient = new Orient((float)bornplace.zutiSpawnOrient - 86F, 0.0F, 0.0F);
                    actorspawnarg.speed.x = 1.0D;
                    actorspawnarg.orient.transform(actorspawnarg.speed);
                    actorspawnarg.speed.normalize();
                    actorspawnarg.speed.scale((double)bornplace.zutiSpawnSpeed / 3.3999999999999999D);
                    flag1 = true;
                } else
                {
    ...
    public class Mirror extends com.maddox.il2.objects.air.AircraftNet
    {
        ...
        public void makeFirstUnderDeck()
        {
            if(FM.brakeShoe)
            {
                ...
                if(!(actor instanceof com.maddox.il2.objects.ships.BigshipGeneric) && (com.maddox.il2.game.Mission.isCoop() && com.maddox.rts.Time.current() < 60000L || com.maddox.il2.game.Mission.isDogfight()))
        ...
        public void fmUpdate(float f)
        {
            ...
            float f1 = FM.Gears.getSteeringAngle();
            moveSteering(f1);
            if(FM.Gears.nearGround())
                moveWheelSink();
            FM.EI.netupdate(f, isFMTrackMirror());
            FM.FMupdate(f);
            for(tint = tcur - tlag; tint > _t; _t += f1)
            {
                f1 = tint - _t;
                if(f1 > (long)com.maddox.rts.Time.tickConstLen())
                    f1 = (long)com.maddox.rts.Time.tickConstLen();
                float f3 = (float)f1 * 0.001F;
                _p.x += _v.x * f3;
                _p.y += _v.y * f3;
                _p.z += _v.z * f3;
            ...
            f1 = com.maddox.il2.engine.Landscape.HQ(_p.x, _p.y);
...
label0:
        ...
        throws java.io.IOException
    {
        ...
        } else
        {
            ...
            com.maddox.rts.NetObj netobj = netmsginput.readNetObj();
            hitProp(i, j, netobj == null ? null : (com.maddox.il2.engine.Actor)(com.maddox.il2.engine.Actor)netobj.superObj());
            return true;
        }
    }
        ...
        throws java.io.IOException
    {
        ...
        } else
        {
            int j = netmsginput.readUnsignedByte();
            com.maddox.rts.NetObj netobj = netmsginput.readNetObj();
            nextCUTLevel(com.maddox.il2.objects.air.NetAircraft.partNames()[i] + "_D0", j, netobj == null ? null : (com.maddox.il2.engine.Actor)(com.maddox.il2.engine.Actor)netobj.superObj());
            return true;
        }
    }
    ...
    public void netFirstUpdate(com.maddox.rts.NetChannel netchannel)
        throws java.io.IOException
    {
        if((!com.maddox.il2.game.Mission.isCoop() || !isNetPlayer()) && ((netchannel instanceof com.maddox.rts.NetChannelOutStream) || com.maddox.il2.game.Mission.isDogfight()))
        {
            com.maddox.rts.NetMsgGuaranted netmsgguaranted = new NetMsgGuaranted();
...
;
    ...
    public static int netCockpitAstatePilotIndx(java.lang.Class class1, int i)
    {
        ...
        java.lang.Class aclass[] = (java.lang.Class[])(java.lang.Class[])obj;
        if(i >= aclass.length)
            return -1;
        else
...
;
        ...
        throws java.lang.Exception
    {
        ...
        {
            java.lang.System.out.println("NetAircraft error, ID_03: " + exception.toString());
        }
    }
...
;
    ...
    private boolean zutiCheckIfSelectedPlaneIsAvailable(com.maddox.il2.net.NetUser netuser)
    {
        if(netuser == null)
            return false;
        java.lang.String s;
        com.maddox.il2.net.BornPlace bornplace;
        s = com.maddox.rts.Property.stringValue(((com.maddox.il2.objects.air.Aircraft)this).getClass(), "keyName");
        bornplace = (com.maddox.il2.net.BornPlace)com.maddox.il2.ai.World.cur().bornPlaces.get(netuser.getBornPlace());
        if(bornplace != null && (!bornplace.zutiEnablePlaneLimits || bornplace.zutiIsAcAvailable(s)))
            return true;
        break MISSING_BLOCK_LABEL_91;
        java.lang.Exception exception;
        exception;
        java.lang.System.out.println("NetAircraft error, ID_04: " + exception.toString());
        return false;
    }
