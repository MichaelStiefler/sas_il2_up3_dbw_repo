...
public class CmdMusic extends com.maddox.rts.Cmd
{
    ...
    {
        if(com.maddox.sound.CmdMusic.nargs(map, "LIST") == 0)
            return;
        list = new java.lang.String[com.maddox.sound.CmdMusic.nargs(map, "LIST")];
        for(int i = 0; i < list.length; i++)
            list[i] = com.maddox.sound.CmdMusic.arg(map, "LIST", i);
    ...
    public java.lang.Object exec(com.maddox.rts.CmdEnv cmdenv, java.util.Map map)
    {
        ...
        {
            java.lang.System.out.println("Unknown command :" + com.maddox.sound.CmdMusic.arg(map, "_$$", 0));
        } else
        {
            ...
            {
                if(com.maddox.sound.CmdMusic.arg(map, "PATH", 0) == null)
                {
                    java.lang.System.out.println("ERROR: path name expected");
                } else
                {
                    bList = false;
                    com.maddox.sound.CmdMusic.setPath(com.maddox.sound.CmdMusic.arg(map, "PATH", 0), false);
                }
            } else
            if(map.containsKey("RAND"))
            {
                if(com.maddox.sound.CmdMusic.arg(map, "RAND", 0) == null)
                {
                    java.lang.System.out.println("ERROR: path name expected");
                } else
                {
                    bList = false;
                    com.maddox.sound.CmdMusic.setPath(com.maddox.sound.CmdMusic.arg(map, "RAND", 0), true);
                }
            } else
            if(map.containsKey("FILE"))
            {
                if(com.maddox.sound.CmdMusic.arg(map, "FILE", 0) == null)
                {
                ...
                } else
                {
                    pathRandName = null;
                    bList = false;
                    com.maddox.sound.CmdMusic.setFile(com.maddox.sound.CmdMusic.arg(map, "FILE", 0) + ".wav", false);
                }
            } else
            if(map.containsKey("LIST"))
                if(com.maddox.sound.CmdMusic.arg(map, "LIST", 0) == null)
                {
            ...
            {
                java.lang.String s = com.maddox.sound.CmdMusic.arg(map, "PLAY", 0);
                if(s == null)
                {
