...
public class CockpitP2V5_TGunner extends CockpitGunner
{
  ...
  static
  {
    Property.set(CockpitP2V5_TGunner.class, "aiTuretNum", 1);

    Property.set(CockpitP2V5_TGunner.class, "weaponControlNum", 11);

    Property.set(CockpitP2V5_TGunner.class, "astatePilotIndx", 3);
  }
}