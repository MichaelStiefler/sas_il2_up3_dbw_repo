...
public class CockpitB_24J_FGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.mesh.chunkSetAngles("TurretA", -12.0F, -paramOrient.getYaw(), 0.0F);
    this.mesh.chunkSetAngles("TurretB", 0.0F, paramOrient.getTangage(), 0.0F);
    this.mesh.chunkSetAngles("TurretC", -12.0F, -cvt(paramOrient.getYaw(), -17.0F, 17.0F, -17.0F, 17.0F), 0.0F);
  ...
  public CockpitB_24J_FGunner()
  {
    super("3DO/Cockpit/B-25J-FGun/FGunnerB24Jnew.him", "bf109");
  ...
  static
  {
    Property.set(CockpitB_24J_FGunner.class, "aiTuretNum", 0);
    Property.set(CockpitB_24J_FGunner.class, "weaponControlNum", 10);
    Property.set(CockpitB_24J_FGunner.class, "astatePilotIndx", 2);
  }
}