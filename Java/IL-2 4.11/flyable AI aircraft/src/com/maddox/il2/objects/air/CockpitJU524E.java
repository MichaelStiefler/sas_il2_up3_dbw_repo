// Source File Name: CockpitJU524E.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitJU524E.this.fm != null) {
				...
				CockpitJU524E.this.setNew.throttle1 = (0.85F * CockpitJU524E.this.setOld.throttle1)
						+ (CockpitJU524E.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitJU524E.this.setNew.prop1 = (0.85F * CockpitJU524E.this.setOld.prop1)
						+ (CockpitJU524E.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitJU524E.this.setNew.throttle2 = (0.85F * CockpitJU524E.this.setOld.throttle2)
						+ (CockpitJU524E.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitJU524E.this.setNew.prop2 = (0.85F * CockpitJU524E.this.setOld.prop2)
						+ (CockpitJU524E.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitJU524E.this.setNew.throttle3 = (0.85F * CockpitJU524E.this.setOld.throttle3)
						+ (CockpitJU524E.this.fm.EI.engines[2]
								.getControlThrottle() * 0.15F);
				CockpitJU524E.this.setNew.prop3 = (0.85F * CockpitJU524E.this.setOld.prop3)
						+ (CockpitJU524E.this.fm.EI.engines[2].getControlProp() * 0.15F);
				CockpitJU524E.this.setNew.altimeter = CockpitJU524E.this.fm
						.getAltitude();
				float f = CockpitJU524E.this.waypointAzimuth();
				CockpitJU524E.this.setNew.waypointAzimuth.setDeg(
						CockpitJU524E.this.setOld.waypointAzimuth.getDeg(0.1F),
						f - CockpitJU524E.this.setOld.azimuth.getDeg(1.0F));
				CockpitJU524E.this.setNew.azimuth.setDeg(
						CockpitJU524E.this.setOld.azimuth.getDeg(1.0F),
						CockpitJU524E.this.fm.Or.azimut());
				CockpitJU524E.this.setNew.vspeed = (0.99F * CockpitJU524E.this.setOld.vspeed)
						+ (0.01F * CockpitJU524E.this.fm.getVertSpeed());
			}
			return true;
		}
	}
