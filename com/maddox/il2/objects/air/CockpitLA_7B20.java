...
public class CockpitLA_7B20 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitLA_7B20.this.setNew.throttle = ((10.0F * CockpitLA_7B20.this.setOld.throttle + CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        CockpitLA_7B20.this.setNew.prop = ((8.0F * CockpitLA_7B20.this.setOld.prop + CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl()) / 9.0F);
        CockpitLA_7B20.this.setNew.altimeter = CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitLA_7B20.this.setNew.azimuth = ((35.0F * CockpitLA_7B20.this.setOld.azimuth + -CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        ...
        CockpitLA_7B20.this.setNew.waypointAzimuth = ((10.0F * CockpitLA_7B20.this.setOld.waypointAzimuth + (CockpitLA_7B20.this.waypointAzimuth() - CockpitLA_7B20.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);
        CockpitLA_7B20.this.setNew.vspeed = ((199.0F * CockpitLA_7B20.this.setOld.vspeed + CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitLA_7B20.this.cvt(CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitLA_7B20.this.cvt(CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
        ...
        CockpitLA_7B20.access$502(CockpitLA_7B20.this, 0.8F * CockpitLA_7B20.this.pictStage + 0.1F * CockpitLA_7B20.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlCompressor());
      }
      return true;
    }
  }
