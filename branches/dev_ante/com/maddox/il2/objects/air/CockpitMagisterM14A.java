...
public class CockpitMagisterM14A extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitMagisterM14A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitMagisterM14A.access$002(CockpitMagisterM14A.this, CockpitMagisterM14A.this.setOld);
        CockpitMagisterM14A.access$102(CockpitMagisterM14A.this, CockpitMagisterM14A.this.setNew);
        CockpitMagisterM14A.access$202(CockpitMagisterM14A.this, CockpitMagisterM14A.this.setTmp);
        CockpitMagisterM14A.this.setNew.throttle = ((10.0F * CockpitMagisterM14A.this.setOld.throttle + CockpitMagisterM14A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitMagisterM14A.this.setNew.altimeter = CockpitMagisterM14A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitMagisterM14A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
          CockpitMagisterM14A.this.setNew.azimuth = ((35.0F * CockpitMagisterM14A.this.setOld.azimuth + -CockpitMagisterM14A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        if ((CockpitMagisterM14A.this.setOld.azimuth > 270.0F) && (CockpitMagisterM14A.this.setNew.azimuth < 90.0F))
          CockpitMagisterM14A.this.setOld.azimuth -= 360.0F;
        if ((CockpitMagisterM14A.this.setOld.azimuth < 90.0F) && (CockpitMagisterM14A.this.setNew.azimuth > 270.0F))
          CockpitMagisterM14A.this.setOld.azimuth += 360.0F;
        CockpitMagisterM14A.this.setNew.waypointAzimuth = ((10.0F * CockpitMagisterM14A.this.setOld.waypointAzimuth + (CockpitMagisterM14A.this.waypointAzimuth() - CockpitMagisterM14A.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);
        CockpitMagisterM14A.this.setNew.vspeed = ((199.0F * CockpitMagisterM14A.this.setOld.vspeed + CockpitMagisterM14A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitMagisterM14A this$0;
    ...
    Variables(CockpitMagisterM14A.1 arg2)
    {
      this();
    }
  }
