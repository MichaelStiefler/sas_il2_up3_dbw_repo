...
// Source File Name:   YAK_3VK107.java
...
//            YAK, PaintSchemeFMPar06, TypeBNZFighter, NetAircraft

public class YAK_3VK107 extends com.maddox.il2.objects.air.YAK
    implements com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    {
        com.maddox.il2.objects.air.YAK_3VK107.moveGear(hierMesh(), f);
    }
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/Yak-3_VK107(Multi1)/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Yak-3VK-107.fmd");
        com.maddox.rts.Property.set(class1, "cockpitClass", com.maddox.il2.objects.air.CockpitYAK_3VK107.class);
        com.maddox.rts.Property.set(class1, "LOSElevation", 0.6576F);
        com.maddox.il2.objects.air.YAK_3VK107.weaponTriggersRegister(class1, new int[] {
            0, 1
        });
        com.maddox.il2.objects.air.YAK_3VK107.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_CANNON01"
        });
        com.maddox.il2.objects.air.YAK_3VK107.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunUBsi 200", "MGunShVAKki 120"
        });
        com.maddox.il2.objects.air.YAK_3VK107.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
