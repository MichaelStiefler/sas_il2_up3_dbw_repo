...
// Source File Name:   JU_88C6NEW.java
...
public abstract class JU_88C6NEW extends com.maddox.il2.objects.air.Scheme2
{
    ...
    {
        com.maddox.il2.objects.air.JU_88C6NEW.moveGear(hierMesh(), f);
    }
    ...
    protected boolean cutFM(int i, int j, com.maddox.il2.engine.Actor actor)
    {
        ...
        case 3: // '\003'
            FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 0, 99);
            break;

        case 4: // '\004'
            FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 1, 99);
            break;
        }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.JU_88C6NEW.class;
