...
// Source File Name:   CockpitB17E_Bombardier.java
...
//            CockpitPilot, B_17E, AircraftLH, Aircraft

public class CockpitB17E_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            setOld = setNew;
            setNew = setTmp;
            float f = ((com.maddox.il2.objects.air.B_17E)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.B_17E)aircraft()).fSightCurSideslip;
            com.maddox.il2.objects.air.CockpitB17E_Bombardier.calibrAngle = 360F - fm.Or.getPitch();
            mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, com.maddox.il2.objects.air.CockpitB17E_Bombardier.calibrAngle + f);
            if(bEntered)
            {
                com.maddox.il2.engine.hotkey.HookPilot hookpilot = com.maddox.il2.engine.hotkey.HookPilot.current;
                hookpilot.setSimpleAimOrient(aAim + 10F * f1, tAim + com.maddox.il2.objects.air.CockpitB17E_Bombardier.calibrAngle + f, 0.0F);
            }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.B_17E)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.B_17E)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (((java.lang.Object) (com.maddox.il2.objects.air.CockpitB17E_Bombardier.class)))), "astatePilotIndx", 0);
    }
