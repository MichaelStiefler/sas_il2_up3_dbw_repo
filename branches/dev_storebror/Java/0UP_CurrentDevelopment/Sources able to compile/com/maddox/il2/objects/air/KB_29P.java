    ...
    implements TypeBomber, TypeDockable
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = KB_29P.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= KB_29P.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / KB_29P.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)KB_29P.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(KB_29P.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = KB_29P.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "KB-29");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/KB-29/hier.him");
        com.maddox.rts.Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        com.maddox.rts.Property.set(class1, "yearService", 1948.5F);
        com.maddox.rts.Property.set(class1, "yearExpired", 1960.9F);
        ...
        Aircraft.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning50t 0", "MGunBrowning50t 0", null
        });
