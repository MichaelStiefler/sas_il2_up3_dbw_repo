/*4.10.1 class*/
/*THIS CLASS HANDLES ALL CARRIER BASED SPAWN PLACE ALLOCATION FOR CLIENTS!!!!*/
		...
		VisibilityLong
{
	...
	private void SetEffectsIntens(float f)
	{
		...
		// TODO: Added by |ZUTI|
		// -----------------------------------------
		if (f < 0.0F && zutiReportResources && zutiReportFinalDestination && cachedSeg == path.size() - 1)
		{
	...
	//TODO: Comment by |ZUTI|: carrier deck operations!
	...
	private void zutiHasShipReachedFinalDestination()
	{
		...
		if (resultX < 40 && resultY < 40)
		{
			...
			//System.out.println("SHIP " + zutiShipName + " has reached it's final destination.");
