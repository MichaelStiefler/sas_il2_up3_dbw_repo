...
public class TBF1 extends TBF
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = TBF1.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= TBF1.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / TBF1.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)TBF1.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(TBF1.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = TBF1.class;
