...
public abstract class FW_190 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    {
        com.maddox.il2.objects.air.FW_190.moveGear(hierMesh(), f);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Armor: Hit..");
                if(s.endsWith("p1"))
                {
                    ...
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Armor Glass: Hit..");
                    if(shot.power <= 0.0F)
                    {
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 4: // '\004'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Aileron Controls: Control Crank Destroyed..");
                    }
                    break;
                ...
                case 3: // '\003'
                    ...
                    {
                        FM.AS.setControlsDamage(shot.initiator, 0);
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Aileron Controls: Disabled..");
                    }
                    break;
                ...
                case 5: // '\005'
                    if(getEnergyPastArmor(0.12F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Elevator Controls: Disabled / Strings Broken..");
                    }
                    break;
                ...
                case 6: // '\006'
                    if(getEnergyPastArmor(0.12F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Rudder Controls: Disabled / Strings Broken..");
                    }
                    break;
                ...
                case 8: // '\b'
                    ...
                    {
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        FM.AS.setControlsDamage(shot.initiator, 1);
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
            ...
            {
                com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Spar Construction: Hit..");
                if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(2.4F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Tail1 Spars Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** WingROut Spars Damaged..");
            ...
            {
                com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Hit..");
                if(s.endsWith("pipe"))
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && FM.EI.engines[0].getType() == 0 && FM.CT.Weapons[1] != null && FM.CT.Weapons[1].length != 2)
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Nose Nozzle Pipe Bent..");
                    }
                ...
                if(s.endsWith("prop"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.8F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Prop Governor Hit, Disabled..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 4);
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Prop Governor Hit, Damaged..");
                        }
                } else
                if(s.endsWith("gear"))
                {
                    if(getEnergyPastArmor(4.6F, shot) > 0.0F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Bullet Jams Reductor Gear..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 3);
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 4);
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Reductor Gear Damaged, Prop Governor Failed..");
                        }
                } else
                if(s.endsWith("supc"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Supercharger Disabled..");
                    }
                ...
                if(s.endsWith("feed"))
                {
                    if(getEnergyPastArmor(8.9F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F && FM.EI.engines[0].getPowerOutput() > 0.7F && FM.EI.engines[0].getType() == 0)
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Pressurized Fuel Line Pierced, Fuel Flamed..");
                    }
                ...
                if(s.endsWith("fuel"))
                {
                    if(getEnergyPastArmor(1.1F, shot) > 0.0F && FM.EI.engines[0].getType() == 0)
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Fuel Line Stalled, Engine Stalled..");
                    }
                    getEnergyPastArmor(1.0F, shot);
                } else
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(4.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 175000F)
                        {
                            ...
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Bullet Jams Crank Ball Bearing..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F && FM.EI.engines[0].getType() == 0)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Crank Case Hit, Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                        }
                ...
                if(s.startsWith("xxeng1cyl"))
                {
                    if(getEnergyPastArmor(2.4F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * (FM.EI.engines[0].getType() != 0 ? 0.5F : 1.75F))
                    {
                        ...
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 96000F && FM.EI.engines[0].getType() == 0)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 3);
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Cylinders Hit, Engine Fires..");
                        }
                        ...
                        {
                            FM.AS.setEngineStuck(shot.initiator, 0);
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Bullet Jams Piston Head..");
                        }
                ...
                if(s.startsWith("xxeng1mag"))
                {
                    ...
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Magneto " + j + " Destroyed..");
                } else
                if(s.endsWith("sync"))
                {
                    if(getEnergyPastArmor(2.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Gun Synchronized Hit, Nose Guns Lose Authority..");
                } else
                if(s.endsWith("oil1") && getEnergyPastArmor(2.4F, shot) > 0.0F)
                {
                    FM.AS.hitOil(shot.initiator, 0);
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Oil Radiator Hit..");
                }
                return;
            }
            if(s.startsWith("xxtank"))
            {
                ...
                case 1: // '\001'
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                    {
                        ...
                        {
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Fuel Tank: Pierced..");
                        ...
                        if(shot.powerType == 3 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.9F || com.maddox.il2.ai.World.Rnd().nextFloat() < 0.03F)
                        {
                            ...
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Fuel Tank: Hit..");
                        }
                        if(shot.power > 200000F)
                        {
                            FM.AS.hitTank(shot.initiator, 2, 99);
                            com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Fuel Tank: Major Hit..");
                        }
                    }
                    break;
            ...
            if(s.startsWith("xxmw50"))
            {
                ...
                {
                    com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** MW50 Tank: Pierced..");
            ...
            {
                com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Nose Cannon: Disabled..");
            ...
            if(s.startsWith("xxradiat"))
            {
                ...
                com.maddox.il2.objects.air.FW_190.debugprintln(this, "*** Engine Module: Radiator Hit, Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
            }
            return;
        }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.FW_190.class;
