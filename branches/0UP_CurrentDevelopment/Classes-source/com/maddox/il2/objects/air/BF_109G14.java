...
//            BF_109, CockpitBF_109G14, PaintSchemeFMPar05, TypeBNZFighter, 
    ...
    implements com.maddox.il2.objects.air.TypeBNZFighter
{
        ...
        if((double)((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getCockpitDoor() > 0.20000000000000001D && bHasBlister && super.FM.getSpeedKMH() > fMaxKMHSpeedForOpenCanopy && hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
                if(this == com.maddox.il2.ai.World.getPlayerAircraft())
                    ((com.maddox.il2.objects.air.CockpitBF_109G14)com.maddox.il2.game.Main3D.cur3D().cockpitCur).removeCanopy();
            }
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitBF_109G14.class
        });
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "R1-SC50", new java.lang.String[] {
