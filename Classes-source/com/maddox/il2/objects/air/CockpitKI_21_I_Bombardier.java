...
// Source File Name:   CockpitKI_21_I_Bombardier.java
...
//            CockpitPilot, KI_21_I, Aircraft

public class CockpitKI_21_I_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.KI_21_I)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.KI_21_I)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.KI_21_I)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.KI_21_I)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitKI_21_I_Bombardier.class, "astatePilotIndx", 0);
    }
