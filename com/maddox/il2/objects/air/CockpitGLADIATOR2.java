...
public class CockpitGLADIATOR2 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (((GLADIATOR2)aircraft()).jdField_bChangedPit_of_type_Boolean)
    {
      reflectPlaneToModel();
      ((GLADIATOR2)aircraft()).jdField_bChangedPit_of_type_Boolean = false;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitGLADIATOR2 this$0;
    ...
    Variables(CockpitGLADIATOR2.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitGLADIATOR2.this.bNeedSetUp)
      {
        ...
        CockpitGLADIATOR2.access$002(CockpitGLADIATOR2.this, false);
      }
      if (((GLADIATOR2)CockpitGLADIATOR2.this.aircraft()).jdField_bChangedPit_of_type_Boolean)
      {
        CockpitGLADIATOR2.this.reflectPlaneToModel();
        ((GLADIATOR2)CockpitGLADIATOR2.this.aircraft()).jdField_bChangedPit_of_type_Boolean = false;
      }
      CockpitGLADIATOR2.access$102(CockpitGLADIATOR2.this, CockpitGLADIATOR2.this.setOld);
      CockpitGLADIATOR2.access$202(CockpitGLADIATOR2.this, CockpitGLADIATOR2.this.setNew);
      CockpitGLADIATOR2.access$302(CockpitGLADIATOR2.this, CockpitGLADIATOR2.this.setTmp);
      if (((CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) && (CockpitGLADIATOR2.this.setNew.stbyPosition < 1.0F))
      {
      ...
      CockpitGLADIATOR2.this.setNew.altimeter = CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (Math.abs(CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
        CockpitGLADIATOR2.this.setNew.azimuth = ((21.0F * CockpitGLADIATOR2.this.setOld.azimuth + CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 22.0F);
      if ((CockpitGLADIATOR2.this.setOld.azimuth > 270.0F) && (CockpitGLADIATOR2.this.setNew.azimuth < 90.0F))
        CockpitGLADIATOR2.this.setOld.azimuth -= 360.0F;
      if ((CockpitGLADIATOR2.this.setOld.azimuth < 90.0F) && (CockpitGLADIATOR2.this.setNew.azimuth > 270.0F))
        CockpitGLADIATOR2.this.setOld.azimuth += 360.0F;
      CockpitGLADIATOR2.this.setNew.throttle = ((10.0F * CockpitGLADIATOR2.this.setOld.throttle + CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle()) / 11.0F);
      CockpitGLADIATOR2.this.setNew.mix = ((10.0F * CockpitGLADIATOR2.this.setOld.mix + CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix()) / 11.0F);
      CockpitGLADIATOR2.this.setNew.prop = CockpitGLADIATOR2.this.setOld.prop;
      if (CockpitGLADIATOR2.this.setNew.prop < CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() - 0.01F)
        CockpitGLADIATOR2.this.setNew.prop += 0.0025F;
      if (CockpitGLADIATOR2.this.setNew.prop > CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() + 0.01F)
        CockpitGLADIATOR2.this.setNew.prop -= 0.0025F;
      CockpitGLADIATOR2.this.w.set(CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getW());
      CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transform(CockpitGLADIATOR2.this.w);
      CockpitGLADIATOR2.this.setNew.turn = ((12.0F * CockpitGLADIATOR2.this.setOld.turn + CockpitGLADIATOR2.this.w.z) / 13.0F);
      CockpitGLADIATOR2.this.setNew.vspeed = ((199.0F * CockpitGLADIATOR2.this.setOld.vspeed + CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitGLADIATOR2.access$502(CockpitGLADIATOR2.this, 0.8F * CockpitGLADIATOR2.this.pictSupc + 0.2F * CockpitGLADIATOR2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor());
      return true;
    }
