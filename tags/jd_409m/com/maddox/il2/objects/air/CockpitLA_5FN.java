...
public class CockpitLA_5FN extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitLA_5FN.access$102(CockpitLA_5FN.this, CockpitLA_5FN.this.setOld); CockpitLA_5FN.access$202(CockpitLA_5FN.this, CockpitLA_5FN.this.setNew); CockpitLA_5FN.access$302(CockpitLA_5FN.this, CockpitLA_5FN.this.setTmp);

        CockpitLA_5FN.this.setNew.throttle = ((10.0F * CockpitLA_5FN.this.setOld.throttle + CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        CockpitLA_5FN.this.setNew.prop = ((8.0F * CockpitLA_5FN.this.setOld.prop + CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl()) / 9.0F);
        CockpitLA_5FN.this.setNew.altimeter = CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitLA_5FN.this.setNew.azimuth = ((35.0F * CockpitLA_5FN.this.setOld.azimuth + -CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        ...
        CockpitLA_5FN.this.setNew.waypointAzimuth = ((10.0F * CockpitLA_5FN.this.setOld.waypointAzimuth + (CockpitLA_5FN.this.waypointAzimuth() - CockpitLA_5FN.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);
        CockpitLA_5FN.this.setNew.vspeed = ((199.0F * CockpitLA_5FN.this.setOld.vspeed + CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitLA_5FN.this.cvt(CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitLA_5FN.this.cvt(CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
            CockpitLA_5FN.access$416(CockpitLA_5FN.this, 0.3F);
            if (CockpitLA_5FN.this.pictBlinker > 1.0F)
              CockpitLA_5FN.access$402(CockpitLA_5FN.this, 1.0F);
          }
          else {
            CockpitLA_5FN.access$424(CockpitLA_5FN.this, 0.3F);
            if (CockpitLA_5FN.this.pictBlinker < 0.0F) {
              CockpitLA_5FN.access$402(CockpitLA_5FN.this, 0.0F);
            }
          }
        }
        CockpitLA_5FN.access$502(CockpitLA_5FN.this, 0.8F * CockpitLA_5FN.this.pictStage + 0.1F * CockpitLA_5FN.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlCompressor());
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    Variables(CockpitLA_5FN.1 arg2)
    {
      this();
    }
  }
