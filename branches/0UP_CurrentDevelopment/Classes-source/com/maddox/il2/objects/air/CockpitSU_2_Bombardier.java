...
// Source File Name:   CockpitSU_2_Bombardier.java
...
//            CockpitPilot, SU_2, Cockpit

public class CockpitSU_2_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.SU_2)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.SU_2)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.SU_2)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.SU_2)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
