...
public class BombCargoA extends Bomb
{
	...
	static Class class$com$maddox$il2$objects$weapons$BombCargoA;
	...
	static Class class$ZutiCargo1(String string)
	{
		Class var_class;
		try
		{
	...
	static
	{
		Class var_class = (class$com$maddox$il2$objects$weapons$BombCargoA == null ? (class$com$maddox$il2$objects$weapons$BombCargoA = class$ZutiCargo1("com.maddox.il2.objects.weapons.BombCargoA")) : class$com$maddox$il2$objects$weapons$BombCargoA);
