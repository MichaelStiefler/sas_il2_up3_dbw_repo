...
public class CockpitF_80C extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Pres1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure(), 0.338638F, 2.370465F, 0.0F, 320.0F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitF_80C.access$002(CockpitF_80C.this, CockpitF_80C.this.setOld);
        CockpitF_80C.access$102(CockpitF_80C.this, CockpitF_80C.this.setNew);
        CockpitF_80C.access$202(CockpitF_80C.this, CockpitF_80C.this.setTmp);
        CockpitF_80C.this.setNew.throttle = (0.85F * CockpitF_80C.this.setOld.throttle + CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitF_80C.this.setNew.prop = (0.85F * CockpitF_80C.this.setOld.prop + CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitF_80C.this.setNew.stage = (0.85F * CockpitF_80C.this.setOld.stage + CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor() * 0.15F);
        CockpitF_80C.this.setNew.mix = (0.85F * CockpitF_80C.this.setOld.mix + CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix() * 0.15F);
        CockpitF_80C.this.setNew.altimeter = CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitF_80C.this.setNew.azimuth = ((35.0F * CockpitF_80C.this.setOld.azimuth + -CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw()) / 36.0F);
        if ((CockpitF_80C.this.setOld.azimuth > 270.0F) && (CockpitF_80C.this.setNew.azimuth < 90.0F))
          CockpitF_80C.this.setOld.azimuth -= 360.0F;
        if ((CockpitF_80C.this.setOld.azimuth < 90.0F) && (CockpitF_80C.this.setNew.azimuth > 270.0F))
          CockpitF_80C.this.setOld.azimuth += 360.0F;
        CockpitF_80C.this.setNew.waypointAzimuth = ((10.0F * CockpitF_80C.this.setOld.waypointAzimuth + CockpitF_80C.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitF_80C.this.setNew.vspeed = ((199.0F * CockpitF_80C.this.setOld.vspeed + CockpitF_80C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f1 = ((F_80C)CockpitF_80C.this.aircraft()).k14Distance;
        CockpitF_80C.this.setNew.k14w = (5.0F * CockpitF_80C.k14TargetWingspanScale[((F_80C)CockpitF_80C.this.aircraft()).jdField_k14WingspanType_of_type_Int] / f1);
        CockpitF_80C.this.setNew.k14w = (0.9F * CockpitF_80C.this.setOld.k14w + 0.1F * CockpitF_80C.this.setNew.k14w);
        CockpitF_80C.this.setNew.k14wingspan = (0.9F * CockpitF_80C.this.setOld.k14wingspan + 0.1F * CockpitF_80C.k14TargetMarkScale[((F_80C)CockpitF_80C.this.aircraft()).jdField_k14WingspanType_of_type_Int]);
        CockpitF_80C.this.setNew.k14mode = (0.8F * CockpitF_80C.this.setOld.k14mode + 0.2F * ((F_80C)CockpitF_80C.this.aircraft()).k14Mode);
        Vector3d localVector3d = CockpitF_80C.this.aircraft().FM.getW();
        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitF_80C.this.floatindex((f1 - 200.0F) * 0.04F, CockpitF_80C.k14BulletDrop) - CockpitF_80C.k14BulletDrop[0];
        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitF_80C.this.setNew.k14x = (0.92F * CockpitF_80C.this.setOld.k14x + 0.08F * f2);
        CockpitF_80C.this.setNew.k14y = (0.92F * CockpitF_80C.this.setOld.k14y + 0.08F * f3);
        if (CockpitF_80C.this.setNew.k14x > 7.0F)
          CockpitF_80C.this.setNew.k14x = 7.0F;
        if (CockpitF_80C.this.setNew.k14x < -7.0F)
          CockpitF_80C.this.setNew.k14x = -7.0F;
        if (CockpitF_80C.this.setNew.k14y > 7.0F)
          CockpitF_80C.this.setNew.k14y = 7.0F;
        if (CockpitF_80C.this.setNew.k14y < -7.0F)
          CockpitF_80C.this.setNew.k14y = -7.0F;
      }
      return true;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitF_80C this$0;
