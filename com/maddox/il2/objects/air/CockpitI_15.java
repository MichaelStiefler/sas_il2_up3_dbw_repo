...
public class CockpitI_15 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitI_15.this.bNeedSetUp)
      {
        ...
        CockpitI_15.access$002(CockpitI_15.this, false);
      }
      if (((I_15_m22)CockpitI_15.this.aircraft() != null) || 
        (I_15_m22.bChangedPit))
      {
        CockpitI_15.this.reflectPlaneToModel();
        if ((I_15_m22)CockpitI_15.this.aircraft() == null);
        I_15_m22.bChangedPit = false;
      }
      CockpitI_15.access$102(CockpitI_15.this, CockpitI_15.this.setOld);
      CockpitI_15.access$202(CockpitI_15.this, CockpitI_15.this.setNew);
      CockpitI_15.access$302(CockpitI_15.this, CockpitI_15.this.setTmp);
      CockpitI_15.this.setNew.altimeter = CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (Math.abs(CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
        CockpitI_15.this.setNew.azimuth = ((21.0F * CockpitI_15.this.setOld.azimuth + CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 22.0F);
      if ((CockpitI_15.this.setOld.azimuth > 270.0F) && (CockpitI_15.this.setNew.azimuth < 90.0F))
        CockpitI_15.this.setOld.azimuth -= 360.0F;
      if ((CockpitI_15.this.setOld.azimuth < 90.0F) && (CockpitI_15.this.setNew.azimuth > 270.0F))
        CockpitI_15.this.setOld.azimuth += 360.0F;
      CockpitI_15.this.setNew.throttle = ((10.0F * CockpitI_15.this.setOld.throttle + CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle()) / 11.0F);
      CockpitI_15.this.setNew.mix = ((10.0F * CockpitI_15.this.setOld.mix + CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix()) / 11.0F);
      CockpitI_15.this.setNew.prop = CockpitI_15.this.setOld.prop;
      if (CockpitI_15.this.setNew.prop < CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() - 0.01F)
        CockpitI_15.this.setNew.prop += 0.0025F;
      if (CockpitI_15.this.setNew.prop > CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() + 0.01F)
        CockpitI_15.this.setNew.prop -= 0.0025F;
      CockpitI_15.this.w.set(CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getW());
      CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transform(CockpitI_15.this.w);
      CockpitI_15.this.setNew.turn = ((12.0F * CockpitI_15.this.setOld.turn + CockpitI_15.this.w.z) / 13.0F);
      CockpitI_15.this.setNew.vspeed = ((299.0F * CockpitI_15.this.setOld.vspeed + CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 300.0F);
      CockpitI_15.access$502(CockpitI_15.this, 0.8F * CockpitI_15.this.pictSupc + 0.2F * CockpitI_15.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor());
      return true;
    }
  ...
  private class Variables
  {
    ...
    float turn;
    float vspeed;
    private final CockpitI_15 this$0;
