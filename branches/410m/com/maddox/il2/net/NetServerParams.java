    ...
    implements com.maddox.rts.NetUpdate
{
        ...
        implements com.maddox.rts.NetSpawn
    {
        ...
        public void netSpawn(int i, com.maddox.rts.NetMsgInput netmsginput)
        {
            try
            {
                ...
                {
                    netserverparams.netStat_DisableStatistics = netmsginput.readBoolean();
                    netserverparams.netStat_ShowPilotNumber = netmsginput.readBoolean();
                    netserverparams.netStat_ShowPilotPing = netmsginput.readBoolean();
                    netserverparams.netStat_ShowPilotName = netmsginput.readBoolean();
                    netserverparams.netStat_ShowPilotScore = netmsginput.readBoolean();
                    netserverparams.netStat_ShowPilotArmy = netmsginput.readBoolean();
                    netserverparams.netStat_ShowPilotACDesignation = netmsginput.readBoolean();
                    netserverparams.netStat_ShowPilotACType = netmsginput.readBoolean();
                    netserverparams.filterUserNames = netmsginput.readBoolean();
                    netserverparams.reflyKIADelay = netmsginput.readInt();
                    netserverparams.maxAllowedKIA = netmsginput.readInt();
                    netserverparams.reflyKIADelayMultiplier = netmsginput.readFloat();
                    netserverparams.reflyDisabled = netmsginput.readBoolean();
                }
            ...
            {
                com.maddox.il2.net.NetServerParams.printDebug(exception);
            }
        }
    ...
    {
        if(com.maddox.il2.game.Main.cur() != null && com.maddox.il2.game.Main.cur().netServerParams != null && com.maddox.il2.game.Main.cur().netServerParams.isDogfight() && (com.maddox.il2.net.NetMissionTrack.isPlaying() || com.maddox.il2.game.Main.cur().netServerParams.isMirror() && !com.maddox.rts.Time.isPaused()))
        {
        ...
        if(com.maddox.il2.net.NetMissionTrack.isPlaying())
            ...
            {
                long l1 = com.maddox.rts.Time.current() - com.maddox.il2.game.Main.cur().netServerParams.serverDeltaTime;
                if(l1 < 0L)
                    l1 = 0L;
                if(l1 > com.maddox.il2.game.Main.cur().netServerParams.lastServerTime)
                    com.maddox.il2.game.Main.cur().netServerParams.lastServerTime = l1;
        ...
        {
            long l2 = com.maddox.il2.game.Main.cur().netServerParams.masterChannel().remoteClockOffset();
            long l3 = com.maddox.rts.Time.current() - (l2 - com.maddox.il2.game.Main.cur().netServerParams.serverClockOffset0);
            if(l3 < 0L)
                l3 = 0L;
            if(l3 > com.maddox.il2.game.Main.cur().netServerParams.lastServerTime)
                com.maddox.il2.game.Main.cur().netServerParams.lastServerTime = l3;
            return com.maddox.il2.game.Main.cur().netServerParams.lastServerTime;
        } else
        {
            return com.maddox.rts.Time.current();
    ...
    public void doMissionCoopEnter()
    {
        ...
        if(!isMaster())
            ...
            {
                com.maddox.il2.net.NetServerParams.printDebug(exception1);
            }
    }
        ...
        throws java.io.IOException
    {
        ...
        case 3: // '\003'
            ...
            {
                long l2 = (long)j1 + com.maddox.rts.Message.currentRealTime();
                if(syncTime > l2)
                    syncTime = l2;
            }
            if(isMirrored())
        ...
        case 7: // '\007'
            if(inSync && !com.maddox.il2.net.NetMissionTrack.isRecording())
                return true;
            serverDeltaTime = ((long)(((com.maddox.il2.net.NetUser)com.maddox.rts.NetEnv.host()).ping / 2) + netmsginput.readLong()) - com.maddox.rts.Time.current();
            long l1 = java.lang.Math.abs(previousDeltaTime - serverDeltaTime);
            if(l1 < 500L)
            {
                syncCounter++;
                if(syncCounter > 4 && l1 < (long)(syncCounter * 2))
                    inSync = true;
            } else
            {
                syncCounter = 0;
            }
            previousDeltaTime = serverDeltaTime;
            if(!com.maddox.il2.net.NetMissionTrack.isRecording())
                break;
            try
            {
                com.maddox.rts.NetMsgGuaranted netmsgguaranted2 = new NetMsgGuaranted();
                netmsgguaranted2.writeByte(7);
                netmsgguaranted2.writeLong(serverDeltaTime);
                postTo(com.maddox.il2.net.NetMissionTrack.netChannelOut(), netmsgguaranted2);
            }
            catch(java.lang.Exception exception1)
            {
    ...
    public void netUpdate()
    {
        if(!com.maddox.il2.net.NetMissionTrack.isPlaying())
        {
            if(isMaster() && isDogfight())
            {
                ...
                if(l > serverDeltaTime_lastUpdate + 2000L)
                {
                    serverDeltaTime_lastUpdate = l;
                    try
                    {
                        com.maddox.rts.NetMsgGuaranted netmsgguaranted1 = new NetMsgGuaranted();
                        netmsgguaranted1.writeByte(7);
                        netmsgguaranted1.writeLong(serverDeltaTime_lastUpdate);
                        post(netmsgguaranted1);
                    }
                    catch(java.io.IOException ioexception)
                    {
                        com.maddox.rts.NetObj.printDebug(ioexception);
                    }
                }
            }
            doCheckMaxLag();
        ...
        if(isMirror() && isCoop() && !com.maddox.rts.Time.isPaused() && com.maddox.il2.net.NetMissionTrack.isRecording() && !com.maddox.il2.net.NetMissionTrack.isPlaying())
        {
            ...
            if(l1 > serverDeltaTime_lastUpdate + 3000L)
            {
                serverDeltaTime_lastUpdate = l1;
                try
                {
                    com.maddox.rts.NetMsgGuaranted netmsgguaranted2 = new NetMsgGuaranted();
                    netmsgguaranted2.writeByte(6);
                    long l2 = com.maddox.il2.game.Main.cur().netServerParams.masterChannel().remoteClockOffset();
                    long l3 = l2 - com.maddox.il2.game.Main.cur().netServerParams.serverClockOffset0;
                    netmsgguaranted2.writeLong(l3);
                    postTo(com.maddox.il2.net.NetMissionTrack.netChannelOut(), netmsgguaranted2);
                }
                catch(java.lang.Exception exception2)
                {
                    com.maddox.il2.net.NetServerParams.printDebug(exception2);
                }
            }
        }
        if(isMirror() && isDogfight() && !com.maddox.rts.Time.isPaused() && com.maddox.il2.net.NetMissionTrack.isRecording() && !com.maddox.il2.net.NetMissionTrack.isPlaying())
            try
            {
                com.maddox.rts.NetMsgGuaranted netmsgguaranted = new NetMsgGuaranted();
                netmsgguaranted.writeByte(7);
                netmsgguaranted.writeLong(com.maddox.rts.Time.current() + com.maddox.il2.game.Main.cur().netServerParams.serverDeltaTime);
                postTo(com.maddox.il2.net.NetMissionTrack.netChannelOut(), netmsgguaranted);
            }
            catch(java.lang.Exception exception)
            {
...
;
    ...
    private void doCheckMaxLag()
    {
        ...
        if(isMaster())
        {
            ...
            for(int j = 0; j < i; j++)
            {
                ...
                if((actor instanceof com.maddox.il2.objects.air.Aircraft) && com.maddox.il2.engine.Actor.isAlive(actor) && actor.net != null && !actor.net.isMaster())
                {
    ...
    public NetServerParams()
    {
        ...
        serverClockOffset0 = 0L;
        lastServerTime = 0L;
        netStat_DisableStatistics = false;
        netStat_ShowPilotNumber = true;
        netStat_ShowPilotPing = true;
        netStat_ShowPilotName = true;
        netStat_ShowPilotScore = true;
        netStat_ShowPilotArmy = true;
        netStat_ShowPilotACDesignation = true;
        netStat_ShowPilotACType = true;
        reflyKIADelay = 0;
        maxAllowedKIA = -1;
        reflyKIADelayMultiplier = 0.0F;
        reflyDisabled = false;
        filterUserNames = false;
        previousDeltaTime = 0L;
        syncCounter = 0;
        _lastCheckMaxLag = -1L;
        checkRuntime = 0;
        checkTimeUpdate = 0L;
        ...
        netStat_DisableStatistics = com.maddox.il2.engine.Config.cur.ini.get("NET", "disableNetStatStatistics", false);
        netStat_ShowPilotNumber = com.maddox.il2.engine.Config.cur.ini.get("NET", "showPilotNumber", true);
        netStat_ShowPilotPing = com.maddox.il2.engine.Config.cur.ini.get("NET", "showPilotPing", true);
        netStat_ShowPilotName = com.maddox.il2.engine.Config.cur.ini.get("NET", "showPilotName", true);
        netStat_ShowPilotScore = com.maddox.il2.engine.Config.cur.ini.get("NET", "showPilotScore", true);
        netStat_ShowPilotArmy = com.maddox.il2.engine.Config.cur.ini.get("NET", "showPilotArmy", true);
        netStat_ShowPilotACDesignation = com.maddox.il2.engine.Config.cur.ini.get("NET", "showPilotACDesignation", true);
        netStat_ShowPilotACType = com.maddox.il2.engine.Config.cur.ini.get("NET", "showPilotACType", true);
        filterUserNames = com.maddox.il2.engine.Config.cur.ini.get("NET", "filterUserNames", false);
        reflyKIADelay = com.maddox.il2.engine.Config.cur.ini.get("NET", "reflyKIADelay", 0);
        maxAllowedKIA = com.maddox.il2.engine.Config.cur.ini.get("NET", "maxAllowedKIA", -1);
        reflyKIADelayMultiplier = com.maddox.il2.engine.Config.cur.ini.get("NET", "reflyKIADelayMultiplier", 0.0F);
        reflyDisabled = com.maddox.il2.engine.Config.cur.ini.get("NET", "reflyDisabled", false);
    }
        ...
        throws java.io.IOException
    {
        ...
        netmsgspawn.writeBoolean(netStat_DisableStatistics);
        netmsgspawn.writeBoolean(netStat_ShowPilotNumber);
        netmsgspawn.writeBoolean(netStat_ShowPilotPing);
        netmsgspawn.writeBoolean(netStat_ShowPilotName);
        netmsgspawn.writeBoolean(netStat_ShowPilotScore);
        netmsgspawn.writeBoolean(netStat_ShowPilotArmy);
        netmsgspawn.writeBoolean(netStat_ShowPilotACDesignation);
        netmsgspawn.writeBoolean(netStat_ShowPilotACType);
        netmsgspawn.writeBoolean(filterUserNames);
        netmsgspawn.writeInt(reflyKIADelay);
        netmsgspawn.writeInt(maxAllowedKIA);
        netmsgspawn.writeFloat(reflyKIADelayMultiplier);
        netmsgspawn.writeBoolean(reflyDisabled);
    ...
    private void checkUpdate()
    {
        ...
        if(i != checkUsers.size())
            ...
            {
                flag = false;
                java.util.Map.Entry entry1 = checkUsers.nextEntry(null);
                do
                {
                    if(entry1 == null)
                        break;
                    ...
                    entry1 = checkUsers.nextEntry(entry1);
                } while(true);
            } while(flag);
    ...
    public boolean netStat_DisableStatistics;
    public boolean netStat_ShowPilotNumber;
    public boolean netStat_ShowPilotPing;
    public boolean netStat_ShowPilotName;
    public boolean netStat_ShowPilotScore;
    public boolean netStat_ShowPilotArmy;
    public boolean netStat_ShowPilotACDesignation;
    public boolean netStat_ShowPilotACType;
    public int reflyKIADelay;
    public int maxAllowedKIA;
    public float reflyKIADelayMultiplier;
    public boolean reflyDisabled;
