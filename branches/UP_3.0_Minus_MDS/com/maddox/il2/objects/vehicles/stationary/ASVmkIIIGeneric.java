...
// Source File Name:   ASVmkIIIGeneric.java
...
public abstract class ASVmkIIIGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.ASVmkIIIGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.ASVmkIIIGeneric.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.ASVmkIIIGeneric asvmkiiigeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.ASVmkIIIGeneric.constr_arg2 = actorspawnarg;
                asvmkiiigeneric = (com.maddox.il2.objects.vehicles.stationary.ASVmkIIIGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.ASVmkIIIGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create ASVmkIIIGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (asvmkiiigeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.ASVmkIIIGeneric.mesh_name);
            cls = class1;
    ...
    private ASVmkIIIGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if(((actor instanceof com.maddox.il2.objects.ships.BigshipGeneric) || (actor instanceof com.maddox.il2.objects.ships.ShipGeneric)) && actor.getArmy() != myArmy && actor != com.maddox.il2.ai.World.getPlayerAircraft())
            {
                ...
                if((actor instanceof com.maddox.il2.objects.ships.Ship.SubTypeVIIC_Srf) || (actor instanceof com.maddox.il2.objects.ships.Ship.USSGatoSS212_Srf) || (actor instanceof com.maddox.il2.objects.ships.Ship.USSGreenlingSS213_Srf))
                    byte0 = 30;
                if(k1 <= byte0 && i2 >= 210 && i2 <= 270 && java.lang.Math.sqrt(j1 * j1) <= 60D)
                    com.maddox.il2.game.HUD.logCenter("                                              " + s + " bearing " + i1 + "\260" + ", range " + j2 + " miles");
            }
        }
