...
// Source File Name:   CockpitME_410B.java
...
//            CockpitPilot, Aircraft, Cockpit, ME_410B

public class CockpitME_410B extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if((com.maddox.il2.objects.air.ME_410B)aircraft() != null);
            if(com.maddox.il2.objects.air.ME_410B.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.ME_410B)aircraft() != null);
                com.maddox.il2.objects.air.ME_410B.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
