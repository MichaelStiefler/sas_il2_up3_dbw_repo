...
// Source File Name:   CockpitMosquito16.java
...
public class CockpitMosquito16 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Columnbase", 0.0F, (pictElev = 0.85F * pictElev + 0.15F * fm.CT.ElevatorControl) * 8F, 0.0F);
        mesh.chunkSetAngles("Column", 0.0F, (pictAiler = 0.85F * pictAiler + 0.15F * fm.CT.AileronControl) * 57F, 0.0F);
        ...
        mesh.chunkSetAngles("STRELKA_FUEL3", cvt((float)java.lang.Math.sqrt(fm.M.fuel), 0.0F, (float)java.lang.Math.sqrt(88.379997253417969D), 0.0F, 301F), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("STRELK_V_LONG", floatindex(cvt(com.maddox.il2.fm.Pitot.Indicator((float)fm.Loc.z, fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), speedometerScale), 0.0F, 0.0F);
        mesh.chunkVisible("STRELK_V_SHORT", false);
        mesh.chunkSetAngles("STRELKA_GOS", -fm.Or.getKren(), 0.0F, 0.0F);
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.Or.getTangage(), -45F, 45F, 0.02355F, -0.02355F);
        mesh.chunkSetLocate("STRELKA_GOR", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
