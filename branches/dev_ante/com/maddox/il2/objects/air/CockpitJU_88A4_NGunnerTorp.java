...
public class CockpitJU_88A4_NGunnerTorp extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zTurret1A", 0.0F, f1, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zTurret1B", 0.0F, f2, 0.0F);
    if (f1 > 10.0F)
      f1 = 10.0F;
    if (f1 < -10.0F)
      f1 = -10.0F;
  ...
  public CockpitJU_88A4_NGunnerTorp()
  {
    super("3DO/Cockpit/Ju-88A-4-NGun/torphier.him", "he111");
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    resetYPRmodifier();
    float tmp346_345 = (0.85F * this.pictFlap + 0.00948F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.FlapsControl); this.pictFlap = tmp346_345; Cockpit.xyz[2] = tmp346_345;
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetLocate("zFlaps1", Cockpit.xyz, Cockpit.ypr);
    float tmp392_391 = (0.85F * this.pictGear + 0.007095F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl); this.pictGear = tmp392_391; Cockpit.xyz[2] = tmp392_391;
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zFuelPress1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel <= 1.0F ? 0.0F : 0.32F, 0.0F, 0.5F, 0.0F, 90.0F), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zFuelPress2", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel <= 1.0F ? 0.0F : 0.32F, 0.0F, 0.5F, 0.0F, 90.0F), 0.0F, 0.0F);
  ...
  private class Variables
  {
    ...
    float vspeed;
    float cons;
    private final CockpitJU_88A4_NGunnerTorp this$0;
    ...
    Variables(CockpitJU_88A4_NGunnerTorp.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitJU_88A4_NGunnerTorp.access$002(CockpitJU_88A4_NGunnerTorp.this, CockpitJU_88A4_NGunnerTorp.this.setOld);
        CockpitJU_88A4_NGunnerTorp.access$102(CockpitJU_88A4_NGunnerTorp.this, CockpitJU_88A4_NGunnerTorp.this.setNew);
        CockpitJU_88A4_NGunnerTorp.access$202(CockpitJU_88A4_NGunnerTorp.this, CockpitJU_88A4_NGunnerTorp.this.setTmp);
        CockpitJU_88A4_NGunnerTorp.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_NGunnerTorp.this.setOld.throttle1 + CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_NGunnerTorp.this.setNew.prop1 = (0.85F * CockpitJU_88A4_NGunnerTorp.this.setOld.prop1 + CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitJU_88A4_NGunnerTorp.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_NGunnerTorp.this.setOld.throttle2 + CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_NGunnerTorp.this.setNew.prop2 = (0.85F * CockpitJU_88A4_NGunnerTorp.this.setOld.prop2 + CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitJU_88A4_NGunnerTorp.this.setNew.altimeter = CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f1 = CockpitJU_88A4_NGunnerTorp.this.waypointAzimuth();
        CockpitJU_88A4_NGunnerTorp.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4_NGunnerTorp.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A4_NGunnerTorp.this.setOld.azimuth.getDeg(1.0F));
        CockpitJU_88A4_NGunnerTorp.this.setNew.azimuth.setDeg(CockpitJU_88A4_NGunnerTorp.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitJU_88A4_NGunnerTorp.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_NGunnerTorp.this.setOld.vspeed + CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f2 = CockpitJU_88A4_NGunnerTorp.this.prevFuel - CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel;
        CockpitJU_88A4_NGunnerTorp.access$302(CockpitJU_88A4_NGunnerTorp.this, CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A4_NGunnerTorp.this.setNew.cons = (0.91F * CockpitJU_88A4_NGunnerTorp.this.setOld.cons + 0.09F * f2);
        if (CockpitJU_88A4_NGunnerTorp.this.buzzerFX != null)
          if ((CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < ((JU_88A4torp)CockpitJU_88A4_NGunnerTorp.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4torp)CockpitJU_88A4_NGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1)) {
            CockpitJU_88A4_NGunnerTorp.this.buzzerFX.play();
          }
          else if (CockpitJU_88A4_NGunnerTorp.this.buzzerFX.isPlaying())
            CockpitJU_88A4_NGunnerTorp.this.buzzerFX.stop();
      }
      return true;
    }
