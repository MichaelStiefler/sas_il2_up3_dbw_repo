...
//            Preset, Sample, Emitter, BaseObject, 
//            AudioDevice, VGroup, ControlInfo, SoundControl
...
public class SoundPreset extends com.maddox.sound.Preset
{
    ...
    public SoundPreset(java.lang.String s)
    {
        ...
        try
        {
            ...
            handle = com.maddox.sound.Preset.jniGet(s);
            if(handle == 0)
                handle = jniCreate(s);
            onCreate();
            load(sectfile, "");
        ...
        {
            com.maddox.sound.BaseObject.printf("Cannot load sound preset " + s + " (" + exception + ")");
            handle = 0;
        }
        return;
    }
        ...
        throws java.lang.Exception
    {
        ...
        if(s3 != null)
        {
            ...
            for(java.util.StringTokenizer stringtokenizer = new StringTokenizer(s3); stringtokenizer.hasMoreTokens();)
            {
    ...
    protected int createObject()
    {
        if(handle == 0)
            return 0;
        int i = com.maddox.sound.Preset.jniGetFreeObject(handle, fxCaps);
        if(i == 0)
            i = com.maddox.sound.Preset.jniCreateObject(handle, fxCaps);
        return i;
    }
