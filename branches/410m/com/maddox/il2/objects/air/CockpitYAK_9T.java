...
// Source File Name:   CockpitYAK_9T.java
...
public class CockpitYAK_9T extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitYAK_9T()
    {
        ...
        pictAiler = 0.0F;
        pictElev = 0.0F;
        light1 = new LightPointActor(new LightPoint(), new Point3d(-0.75109999999999999D, 0.3392D, 0.29920000000000002D));
        light2 = new LightPointActor(new LightPoint(), new Point3d(-0.66169999999999995D, 0.28420000000000001D, 0.2591D));
        light3 = new LightPointActor(new LightPoint(), new Point3d(-0.48919999999999997D, 0.20100000000000001D, 0.1981D));
        light4 = new LightPointActor(new LightPoint(), new Point3d(-0.75109999999999999D, -0.3392D, 0.29920000000000002D));
        light5 = new LightPointActor(new LightPoint(), new Point3d(-0.66169999999999995D, -0.28420000000000001D, 0.2591D));
        light6 = new LightPointActor(new LightPoint(), new Point3d(-0.48919999999999997D, -0.20100000000000001D, 0.1981D));
