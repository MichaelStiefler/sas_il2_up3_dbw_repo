...
public class F4F3 extends F4F
{
    ...
    static 
    {
        java.lang.Class class1 = F4F3.class;
        ...
        com.maddox.rts.Property.set(class1, "cockpitClass", CockpitF4F3.class);
        com.maddox.rts.Property.set(class1, "LOSElevation", 1.28265F);
        F4F3.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0, 9, 9, 9, 9, 9, 9, 
            3, 3
        });
        F4F3.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        F4F3.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", "MGunBrowning50k 430", null, null, null, null, null, null, 
            null, null
        });
        F4F3.weaponsRegister(class1, "2x58dt", new java.lang.String[] {
        ...
        F4F3.weaponsRegister(class1, "2x100", new java.lang.String[] {
        ...
        F4F3.weaponsRegister(class1, "2x1002x58dt", new java.lang.String[] {
        ...
        F4F3.weaponsRegister(class1, "none", new java.lang.String[] {
