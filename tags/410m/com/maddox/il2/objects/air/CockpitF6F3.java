...
// Source File Name:   CockpitF6F3.java
...
//            CockpitPilot, F6F, AircraftLH, Aircraft

public class CockpitF6F3 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Compass2", 270F + setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
        ...
        if((fm.AS.astateCockpitState & 0x40) == 0)
            ...
            mesh.chunkSetAngles("Z_RPM1", cvt(fm.EI.engines[0].getRPM(), 0.0F, 7000F, 0.0F, 278F), 0.0F, 0.0F);
