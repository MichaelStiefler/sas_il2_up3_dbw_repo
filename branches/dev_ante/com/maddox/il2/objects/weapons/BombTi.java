...
public class BombTi extends Bomb
{
  private long t1;
  private long t2;
  ...
  public void start()
  {
    ...
    Eff3DActor.New(this, null, new Loc(), 1.0F, "3DO/Effects/Fireworks/TIRed.eff", (float)(this.t1 - Time.current()) / 1000.0F);
  }
