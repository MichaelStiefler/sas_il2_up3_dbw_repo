...
public class CmdSound extends com.maddox.rts.Cmd
{
    ...
    public java.lang.Object exec(com.maddox.rts.CmdEnv cmdenv, java.util.Map map)
    {
        ...
        if(!map.isEmpty())
            ...
            {
                java.lang.System.out.println("Unknown command :" + com.maddox.sound.CmdSound.arg(map, "_$$", 0));
            } else
            {
                ...
                {
                    java.lang.String s = com.maddox.sound.CmdSound.arg(map, "select", 0);
                ...
                if(map.containsKey("set"))
                    if(prs == null)
                        ...
                        prs.set(com.maddox.sound.CmdSound.arg(map, "set", 0), com.maddox.sound.CmdSound.arg(map, "set", 1));
            }
