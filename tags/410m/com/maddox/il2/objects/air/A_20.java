...
public abstract class A_20 extends com.maddox.il2.objects.air.Scheme2
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC5_D0", 0.0F, com.maddox.il2.objects.air.A_20.cvt(f, 0.0F, 0.1F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearC6_D0", 0.0F, com.maddox.il2.objects.air.A_20.cvt(f, 0.0F, 0.1F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, 116.5F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, -135F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.A_20.cvt(f, 0.0F, 0.1F, 0.0F, -70F), 0.0F);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, com.maddox.il2.objects.air.A_20.cvt(f, 0.0F, 0.1F, 0.0F, -72.5F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 116.5F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -135F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.A_20.cvt(f, 0.0F, 0.1F, 0.0F, -70F), 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, com.maddox.il2.objects.air.A_20.cvt(f, 0.0F, 0.1F, 0.0F, -72.5F), 0.0F);
    }

    protected void moveGear(float f)
    {
        com.maddox.il2.objects.air.A_20.moveGear(hierMesh(), f);
    }

    public void moveWheelSink()
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.A_20.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.288F, 0.0F, 0.288F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.A_20.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.288F, 0.0F, 0.288F);
        hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.A_20.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.122F, 0.0F, 0.122F);
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxammo0"))
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                    FM.AS.setJamBullets(0, com.maddox.il2.ai.World.Rnd().nextInt(0, 5));
            ...
            {
                if(s.endsWith("p1"))
                    getEnergyPastArmor(12.100000381469727D / java.lang.Math.abs(v1.x), shot);
                if(s.endsWith("p2"))
                {
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(20F, 60F) / java.lang.Math.abs(v1.x), shot);
                    if(shot.power <= 0.0F)
                    {
                        com.maddox.il2.objects.air.A_20.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
                        doRicochetBack(shot);
                    }
                }
                if(s.endsWith("p3"))
                ...
                if(s.endsWith("p5"))
                    getEnergyPastArmor(12.699999809265137D / (java.lang.Math.abs(v1.z) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("p6"))
                    getEnergyPastArmor(4.0999999046325684D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("p8"))
            ...
            {
                com.maddox.il2.objects.air.A_20.debugprintln(this, "*** Lock Construction: Hit..");
                if(s.startsWith("xxlockk1") && getEnergyPastArmor(6.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 3F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.A_20.debugprintln(this, "*** Rudder1 Lock Shot Off..");
                    nextDMGLevels(3, 2, "Rudder1_D" + chunkDamageVisible("Rudder1"), shot.initiator);
                }
                if(s.startsWith("xxlocksl") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.A_20.debugprintln(this, "*** VatorL Lock Shot Off..");
                    nextDMGLevels(3, 2, "VatorL_D" + chunkDamageVisible("VatorL"), shot.initiator);
                }
                if(s.startsWith("xxlocksr") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.A_20.debugprintln(this, "*** VatorR Lock Shot Off..");
                    nextDMGLevels(3, 2, "VatorR_D" + chunkDamageVisible("VatorR"), shot.initiator);
                }
                if(s.startsWith("xxlockal") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.A_20.debugprintln(this, "*** AroneL Lock Shot Off..");
                    nextDMGLevels(3, 2, "AroneL_D" + chunkDamageVisible("AroneL"), shot.initiator);
                }
                if(s.startsWith("xxlockar") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.A_20.debugprintln(this, "*** AroneR Lock Shot Off..");
            ...
            if(s.startsWith("xxoil"))
            {
                ...
                com.maddox.il2.objects.air.A_20.debugprintln(this, "*** Engine (" + k + ") Module: Oil Tank Pierced..");
                return;
            }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.A_20.class;
