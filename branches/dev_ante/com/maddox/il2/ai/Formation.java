...
public class Formation
{
  ...
  private static final float scaleCoeff(Aircraft paramAircraft) {
    if ((paramAircraft instanceof ME_323))
      return 5.0F;
    if (((paramAircraft instanceof PE_8)) || ((paramAircraft instanceof TB_3)) || ((paramAircraft instanceof B_17)) || ((paramAircraft instanceof B_29)))
    {
      return 3.5F;
    }if ((paramAircraft instanceof TA_152H1))
      return 2.0F;
    if ((paramAircraft instanceof SBD))
      return 1.8F;
    if ((paramAircraft instanceof TBF))
      return 1.9F;
    if ((paramAircraft instanceof FW_190))
      return 1.4F;
  ...
  public static final void gather(FlightModel paramFlightModel, byte paramByte, Vector3d paramVector3d)
  {
    ...
    switch (paramByte) {
    case 0:
      if (((localAircraft instanceof BF_109)) || ((localAircraft instanceof BF_110)) || ((localAircraft instanceof FW_190)) || ((localAircraft instanceof SPITFIRE)) || ((localAircraft instanceof P_38)) || ((localAircraft instanceof P_38)) || ((localAircraft instanceof P_40)) || ((localAircraft instanceof P_47)) || ((localAircraft instanceof P_51)) || ((localAircraft instanceof F2A)) || ((localAircraft instanceof F4F)) || ((localAircraft instanceof F4U)) || ((localAircraft instanceof F6F)) || ((localAircraft instanceof SBD)))
      {
  ...
  private static final void gen(Aircraft[] paramArrayOfAircraft, Vector3f paramVector3f) {
    ...
    int i = 0;
    for (int j = 1; j < paramArrayOfAircraft.length; j++)
      if (Actor.isValid(paramArrayOfAircraft[j])) {
        paramArrayOfAircraft[j].FM.Offset.set(paramVector3f);
        paramArrayOfAircraft[j].FM.Leader = paramArrayOfAircraft[i].FM;
        paramArrayOfAircraft[i].FM.Wingman = paramArrayOfAircraft[j].FM;
        paramArrayOfAircraft[i].pos.getAbs(Pd);
        Pd.sub(dd);
        paramArrayOfAircraft[j].pos.setAbs(Pd);
        i = j;
      }
  }
}