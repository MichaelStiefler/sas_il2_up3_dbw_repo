...
public class CockpitBF_110G4 extends CockpitPilot
{
  ...
  public CockpitBF_110G4() {
    super("3DO/Cockpit/Bf-110G/BF_110G4.him", "bf109");
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (((BF_110G4)CockpitBF_110G4.this.aircraft() != null) || 
        (BF_110G4.bChangedPit)) {
        CockpitBF_110G4.this.reflectPlaneToModel();
        if ((BF_110G4)CockpitBF_110G4.this.aircraft() == null);
        BF_110G4.bChangedPit = false;
      }
      CockpitBF_110G4.access$102(CockpitBF_110G4.this, CockpitBF_110G4.this.setOld);
      CockpitBF_110G4.access$202(CockpitBF_110G4.this, CockpitBF_110G4.this.setNew);
      CockpitBF_110G4.access$302(CockpitBF_110G4.this, CockpitBF_110G4.this.setTmp);
      ...
      if (CockpitBF_110G4.this.cockpitDimControl) {
        if (CockpitBF_110G4.this.setNew.dimPosition > 0.0F)
          CockpitBF_110G4.this.setNew.dimPosition -= 0.05F;
      ...
      CockpitBF_110G4.this.setNew.azimuth = CockpitBF_110G4.this.fm.Or.getYaw();
      if ((CockpitBF_110G4.this.setOld.azimuth > 270.0F) && (CockpitBF_110G4.this.setNew.azimuth < 90.0F))
        CockpitBF_110G4.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_110G4.this.setOld.azimuth < 90.0F) && (CockpitBF_110G4.this.setNew.azimuth > 270.0F))
        CockpitBF_110G4.this.setOld.azimuth += 360.0F;
      CockpitBF_110G4.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_110G4.this.setOld.waypointAzimuth + (CockpitBF_110G4.this.waypointAzimuth() - CockpitBF_110G4.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

      CockpitBF_110G4.Variables localVariables = CockpitBF_110G4.this.setNew;
      float f1 = 0.9F * CockpitBF_110G4.this.setOld.radioalt;
      float f2 = 0.1F;
      float f3 = CockpitBF_110G4.this.fm.getAltitude();
      World.cur();
      World.land();
      localVariables.radioalt = (f1 + f2 * (f3 - Landscape.HQ_Air((float)CockpitBF_110G4.this.fm.Loc.x, (float)CockpitBF_110G4.this.fm.Loc.y)));

      CockpitBF_110G4.this.setNew.vspeed = ((199.0F * CockpitBF_110G4.this.setOld.vspeed + CockpitBF_110G4.this.fm.getVertSpeed()) / 200.0F);
  ...
  private class Variables
  {
    ...
    float vspeed;
    float radioalt;
    private final CockpitBF_110G4 this$0;
    ...
    Variables(CockpitBF_110G4.1 arg2)
    {
      this();
    }
  }
