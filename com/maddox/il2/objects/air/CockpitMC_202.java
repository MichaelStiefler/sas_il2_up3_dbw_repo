...
// Source File Name:   CockpitMC_202.java
...
public class CockpitMC_202 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitMC_202()
    {
        ...
        cockpitNightMats = (new java.lang.String[] {
            "gs_lthr", "mat2_tr", "strum1dmg", "strum2dmg", "strum3dmg", "strum4dmg", "strum1", "strum2", "strum3", "strum4", 
            "strumsxdmg", "strumsx"
        });
        setNightMats(false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Throttle", 29.54F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_PropPitch1", 33.5F * interp(setNew.prop, setOld.prop, f), 0.0F, 0.0F);
        ...
        resetYPRmodifier();
        xyz[2] = cvt(fm.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 0.0F, -0.06325F);
        mesh.chunkSetLocate("Z_OilRad1", xyz, ypr);
        xyz[2] = cvt(fm.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 0.0F, -0.01625F);
        mesh.chunkSetLocate("Z_OilRad2", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[2] = cvt(fm.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 0.0F, -0.06055F);
        mesh.chunkSetLocate("Z_Cooling", xyz, ypr);
        resetYPRmodifier();
        xyz[2] = cvt(fm.CT.getFlap(), 0.0F, 1.0F, 0.0F, 0.05475F);
        mesh.chunkSetLocate("Z_FlapPos", xyz, ypr);
        ...
        mesh.chunkSetAngles("Z_ManfoldPress", 0.0F, pictManf = 0.9F * pictManf + 0.1F * cvt(fm.EI.engines[0].getManifoldPressure(), 0.5F, 2.0F, 0.0F, 300F), 0.0F);
        ...
        mesh.chunkSetAngles("Z_FuelQuantity1", cvt(fm.M.fuel / fm.M.maxFuel, 0.0F, 1.0F, 0.0F, 244F), 0.0F, 0.0F);
        resetYPRmodifier();
        xyz[0] = cvt(fm.Or.getTangage(), -45F, 45F, 0.0135F, -0.0135F);
        mesh.chunkSetLocate("Z_Horison1c", xyz, ypr);
