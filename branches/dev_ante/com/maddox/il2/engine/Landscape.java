...
public class Landscape
{
  ...
  public final int WORLD2PIXX(float paramFloat)
  {
    return (int)(paramFloat * 0.005F);
  }

  public final int WORLD2PIXY(double paramDouble)
  {
    return (int)(getSizeYpix() - 1.0F - paramDouble * 0.00499999988824129D);
  }

  public final int WORLD2PIXY(float paramFloat)
  {
    return (int)(getSizeYpix() - 1.0F - paramFloat * 0.005F);
  }
  ...
  private final float WORLD2PIXYf(float paramFloat)
  {
    return getSizeYpix() - 1.0F - paramFloat * 0.005F;
  }

  public final float PIX2WORLDX(float paramFloat)
  {
    return paramFloat * 200.0F;
  }

  public final float PIX2WORLDY(float paramFloat)
  {
    return (getSizeYpix() - 1 - paramFloat) * 200.0F; } 
  ...
  public float getSizeX() { return 200.0F * getSizeXpix();
  }
  ...
  public final double Hmin(double paramDouble1, double paramDouble2)
  {
    return Hmin((float)paramDouble1, (float)paramDouble2);
  }
  ...
  public static final float Hmax(float paramFloat1, float paramFloat2)
  {
    if (meshMapXY != null)
    {
      ...
      int j = (int)(paramFloat2 * 0.005F);
      MeshCell localMeshCell = (MeshCell)meshMapXY.get(j, i);
      if ((localMeshCell != null) && (Actor.isValid(localMeshCell.m))) return localMeshCell.hMax;
    }
  ...
  public static final float Hmin(float paramFloat1, float paramFloat2)
  {
    if (meshMapXY != null)
    {
      ...
      int j = (int)(paramFloat2 * 0.005F);
      MeshCell localMeshCell = (MeshCell)meshMapXY.get(j, i);
      if ((localMeshCell != null) && (Actor.isValid(localMeshCell.m))) return localMeshCell.hMin;
    }
  ...
  public final void N(double paramDouble1, double paramDouble2, Vector3f paramVector3f) {
    if (meshMapXY != null)
    {
      ...
      if ((localMeshCell != null) && (Actor.isValid(localMeshCell.m)))
      {
        ...
        if ((f2 >= f1) && (localMeshCell.m.cNormal(paramDouble1, paramDouble2, EQNBuf)))
        {
    ...
    EQNBuf[0] = (float)paramDouble1;
    EQNBuf[1] = (float)paramDouble2;
    EQNBuf[2] = -1.0F;
    cEQN(EQNBuf);
    paramVector3f.set(EQNBuf);
  }
  ...
  public final void N(float paramFloat1, float paramFloat2, Vector3f paramVector3f)
  {
    if (meshMapXY != null)
    {
      ...
      if ((localMeshCell != null) && (Actor.isValid(localMeshCell.m)))
      {
        float f1 = cHQ(paramFloat1, paramFloat2);
        float f2 = localMeshCell.m.cHQ(paramFloat1, paramFloat2);
        if ((f2 >= f1) && (localMeshCell.m.cNormal(paramFloat1, paramFloat2, EQNBuf)))
        {
    ...
    EQNBuf[0] = paramFloat1;
    EQNBuf[1] = paramFloat2;
    EQNBuf[2] = -1.0F;
    cEQN(EQNBuf);
    paramVector3f.set(EQNBuf[0], EQNBuf[1], EQNBuf[2]);
  }
  ...
  public final double EQN(double paramDouble1, double paramDouble2, Vector3d paramVector3d)
  {
    if (meshMapXY != null)
    {
      ...
      if ((localMeshCell != null) && (Actor.isValid(localMeshCell.m)))
      {
        float f1 = cHQ((float)paramDouble1, (float)paramDouble2);
        float f2 = localMeshCell.m.cHQ(paramDouble1, paramDouble2);
        if ((f2 >= f1) && (localMeshCell.m.cPlane(paramDouble1, paramDouble2, EQNBufD)))
        {
  ...
  public final float EQN(float paramFloat1, float paramFloat2, Vector3f paramVector3f)
  {
    if (meshMapXY != null)
    {
      ...
      if ((localMeshCell != null) && (Actor.isValid(localMeshCell.m)))
      {
        float f1 = cHQ(paramFloat1, paramFloat2);
        float f2 = localMeshCell.m.cHQ(paramFloat1, paramFloat2);
        if ((f2 >= f1) && (localMeshCell.m.cPlane(paramFloat1, paramFloat2, EQNBufD)))
        {
  ...
  {
    _RayStart[0] = (float)paramPoint3d1.x;
    _RayStart[1] = (float)paramPoint3d1.y;
    _RayStart[2] = (float)paramPoint3d1.z;
    _RayEnd[0] = (float)paramPoint3d2.x;
    _RayEnd[1] = (float)paramPoint3d2.y;
    _RayEnd[2] = (float)paramPoint3d2.z;
    boolean bool = cRayHitHQ(_RayStart, _RayEnd, _RayHit);
    paramPoint3d3.x = _RayHit[0];
    paramPoint3d3.y = _RayHit[1];
    paramPoint3d3.z = _RayHit[2];
    if (meshMakeMapRay(paramPoint3d1, paramPoint3d2))
    {
      ...
      if (bool)
      {
        ...
        if (d1 > 0.0D) f1 = (float)(d2 / d1);
      }
      _RayHitD[0] = paramPoint3d1.x;
      _RayHitD[1] = paramPoint3d1.y;
      _RayHitD[2] = paramPoint3d1.z;
      _RayHitD[3] = paramPoint3d2.x;
      _RayHitD[4] = paramPoint3d2.y;
      _RayHitD[5] = paramPoint3d2.z;
      int i = 0;
      for (Map.Entry localEntry = meshMapRay.nextEntry(null); localEntry != null; localEntry = meshMapRay.nextEntry(localEntry))
      {
  ...
  public void renderBridgeRoad(Mat paramMat, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, float paramFloat) { cRenderBridgeRoad(paramMat.cppObject(), paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramFloat); }
  ...
  {
    if (!"".equals(this.MapName)) LoadMap(this.MapName, null, false); 
  }
    ...
    throws Exception
  {
    ...
    if (Config.isUSE_RENDER()) setAstronomic(this.config.declin, this.config.month, 15, World.getTimeofDay(), World.Sun().MoonPhase);
    if (!cLoadMap(paramString, paramArrayOfInt, i, paramBoolean)) throw new RuntimeException("Landscape '" + paramString + "' loading error");
  }

  public void cubeFullUpdate()
  {
    Actor localActor = Actor.getByName("camera");
    if (Actor.isValid(localActor)) preRender((float)localActor.pos.getAbsPoint().z, true);
  }
  ...
  {
    float f1 = (float)Math.toRadians(90 - this.config.declin);
    float f2 = (float)Math.cos(f1);
    float f3 = (float)Math.sin(f1);
    float f4 = (float)Math.toRadians(this.config.month * 30 + 15 - 80);
    int i = 0;
    int j = 0;
    while (true)
    {
      ...
      float f8 = (float)Math.sin((float)Math.toRadians(22.5D) * (float)Math.sin(f4));
      this.sunRise.set(f6, f7 * f2 + f8 * f3, f8 * f2 - f7 * f3);
  ...
  public void preRender(float paramFloat, boolean paramBoolean)
  {
    ...
    _sunmoon[0] = localSun.ToSun.x;
    _sunmoon[1] = localSun.ToSun.y;
    _sunmoon[2] = localSun.ToSun.z;
    _sunmoon[3] = localSun.ToMoon.x;
    _sunmoon[4] = localSun.ToMoon.y;
    _sunmoon[5] = localSun.ToMoon.z;
  ...
  public static boolean isExistMeshs() { return meshMapXY != null;
  }

  public static boolean isExistMesh(int paramInt1, int paramInt2)
  {
    return meshMapXY.get(paramInt2, paramInt1) != null;
  }
  ...
  private static boolean meshMakeMapRay(Point3d paramPoint3d1, Point3d paramPoint3d2)
  {
    ...
    {
      int m = 1;
      if (paramPoint3d2.x < paramPoint3d1.x) m = -1;
      int n = 1;
      if (paramPoint3d2.y < paramPoint3d1.y) n = -1;
      double d1;
      double d2;
      int i1;
  ...
  static class MeshCell
  {
    ...
    {
      this.m = paramActorLandMesh;
      this.hMin = paramFloat1;
      this.hMax = paramFloat2;
    }
  }
}