...
public class BLENHEIM4 extends com.maddox.il2.objects.air.BLENHEIM
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = com.maddox.il2.objects.air.BLENHEIM4.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= com.maddox.il2.objects.air.BLENHEIM4.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / com.maddox.il2.objects.air.BLENHEIM4.toMeters(fSightCurAltitude)));
            calibDistance = com.maddox.il2.objects.air.BLENHEIM4.toMetersPerSecond(fSightCurSpeed) * floatindex(com.maddox.il2.objects.air.Aircraft.cvt(com.maddox.il2.objects.air.BLENHEIM4.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)com.maddox.il2.objects.air.BLENHEIM4.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(com.maddox.il2.objects.air.BLENHEIM4.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", "3DO/Plane/BlenheimMkIV(Multi1)/hier.him");
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "cockpitClass", ((java.lang.Object) (new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitBLENHEIM1F.class, com.maddox.il2.objects.air.CockpitBLENHEIM4_Bombardier.class, com.maddox.il2.objects.air.CockpitBLENHEIM_TGunner.class
        })));
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "LOSElevation", 0.73425F);
        com.maddox.il2.objects.air.BLENHEIM4.weaponTriggersRegister(class1, new int[] {
            0, 10, 3, 3
        });
        com.maddox.il2.objects.air.BLENHEIM4.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_BombSpawn01", "_BombSpawn02"
        });
        com.maddox.il2.objects.air.BLENHEIM4.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning303k 500", "MGunVikkersKt 2600", null, null
        });
        com.maddox.il2.objects.air.BLENHEIM4.weaponsRegister(class1, "4x250", new java.lang.String[] {
            "MGunBrowning303k 500", "MGunVikkersKt 2600", "BombGun250lbs 2", "BombGun250lbs 2"
        });
        com.maddox.il2.objects.air.BLENHEIM4.weaponsRegister(class1, "2x500", new java.lang.String[] {
            "MGunBrowning303k 500", "MGunVikkersKt 2600", "BombGun500lbs 1", "BombGun500lbs 1"
        });
        com.maddox.il2.objects.air.BLENHEIM4.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
