...
public class CockpitMig_17PF extends CockpitPilot
{
	...
	Mig_17 Mig_17 = (Mig_17) (Object) aircraft();
	if (Mig_17.bChangedPit) {
	    Mig_17 Mig_17_3_ = (Mig_17) (Object) aircraft();
	...
	resetYPRmodifier();
	Cockpit.xyz[1]
	    = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, -0.49F, 0.0F);
	Cockpit.xyz[2]
	    = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, -0.065F, 0.0F);
	...
	resetYPRmodifier();
	Cockpit.xyz[2]
	    = cvt(fm.Or.getTangage(), -45.0F, 45.0F, 0.0328F, -0.0328F);
