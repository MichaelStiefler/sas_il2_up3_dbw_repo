...
// Source File Name:   SPRGeneric.java
...
public abstract class SPRGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.SPRGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SPRGeneric.Rnd(45F, 45F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.SPRGeneric sprgeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.SPRGeneric.constr_arg2 = actorspawnarg;
                sprgeneric = (com.maddox.il2.objects.vehicles.stationary.SPRGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.SPRGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create SPRGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (sprgeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.SPRGeneric.mesh_name);
            cls = class1;
    ...
    private SPRGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    public void startMove()
    {
        if(!interpEnd("move"))
        {
            ...
            engineSTimer = -(int)com.maddox.il2.objects.vehicles.stationary.SPRGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SPRGeneric.Rnd(5F, 5F));
        }
    }
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if((pilot.Wingman != null || pilot.crew > 1) && com.maddox.il2.engine.Actor.isAlive(actor) && ((actor instanceof com.maddox.il2.objects.vehicles.tanks.TankGeneric) || (actor instanceof com.maddox.il2.objects.trains.Wagon) || (actor instanceof com.maddox.il2.objects.vehicles.artillery.ArtilleryGeneric) || (actor instanceof com.maddox.il2.objects.ships.BigshipGeneric) || (actor instanceof com.maddox.il2.objects.ships.ShipGeneric) || (actor instanceof com.maddox.il2.objects.vehicles.cars.CarGeneric)) && actor.getArmy() != myArmy)
            {
                pos.getAbs(point3d);
                ...
                double d12 = d - d3;
                double d13 = d1 - d4;
                double d14 = java.lang.Math.ceil(java.lang.Math.sqrt(d13 * d13 + d12 * d12));
                if(d14 <= d8)
                    com.maddox.il2.game.HUD.logCenter("                                          Enemy " + s + " spotted at " + l + " o'clock!");
            }
        }
