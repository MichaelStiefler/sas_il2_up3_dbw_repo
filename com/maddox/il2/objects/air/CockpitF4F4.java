...
public class CockpitF4F4 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, -110.0F * f, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, -110.0F * f, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick() { if (CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitF4F4.this.setNew.throttle = (0.85F * CockpitF4F4.this.setOld.throttle + CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitF4F4.this.setNew.prop = (0.85F * CockpitF4F4.this.setOld.prop + CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitF4F4.this.setNew.mix = (0.85F * CockpitF4F4.this.setOld.mix + CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix() * 0.15F);
        CockpitF4F4.this.setNew.altimeter = CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitF4F4.this.waypointAzimuth();
        CockpitF4F4.this.setNew.azimuth.setDeg(CockpitF4F4.this.setOld.azimuth.getDeg(1.0F), CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitF4F4.this.setNew.waypointAzimuth.setDeg(CockpitF4F4.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitF4F4.this.setNew.vspeed = ((199.0F * CockpitF4F4.this.setOld.vspeed + CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }

      boolean bool = false;

      if (CockpitF4F4.this.setNew.gCrankAngle < CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() - 0.05F) {
        if ((Math.abs(CockpitF4F4.this.setNew.gCrankAngle - CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) > 0.05F) && (Math.abs(CockpitF4F4.this.setNew.gCrankAngle - CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) < 0.9F)) {
          CockpitF4F4.this.setNew.gCrankAngle += 0.0025F;
          bool = true;
        } else {
          CockpitF4F4.this.setNew.gCrankAngle = CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear();
          CockpitF4F4.this.setOld.gCrankAngle = CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear();
        }
      }
      if (CockpitF4F4.this.setNew.gCrankAngle > CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() + 0.05F) {
        if ((Math.abs(CockpitF4F4.this.setNew.gCrankAngle - CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) > 0.05F) && (Math.abs(CockpitF4F4.this.setNew.gCrankAngle - CockpitF4F4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) < 0.9F)) {
