...
public class CockpitBLENHEIM1 extends CockpitPilot
{
  ...
  {
    super("3DO/Cockpit/BlenheimMkI/CockpitBLENHEIM1.him", "he111");
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_SupL", 0.0F, -65.0F * this.setNew.stage1, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_SupR", 0.0F, -65.0F * this.setNew.stage2, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XBomb9", this.bBombs[8]);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XBomb10", this.bBombs[9]);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitBLENHEIM1.access$002(CockpitBLENHEIM1.this, CockpitBLENHEIM1.this.setOld);
        CockpitBLENHEIM1.access$102(CockpitBLENHEIM1.this, CockpitBLENHEIM1.this.setNew);
        CockpitBLENHEIM1.access$202(CockpitBLENHEIM1.this, CockpitBLENHEIM1.this.setTmp);
        if (CockpitBLENHEIM1.this.eBombs[0] == null)
        {
          CockpitBLENHEIM1.this.eBombs[0] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb01");
          CockpitBLENHEIM1.this.eBombs[1] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb02");
          CockpitBLENHEIM1.this.eBombs[2] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb03");
          CockpitBLENHEIM1.this.eBombs[3] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb04");
          CockpitBLENHEIM1.this.eBombs[4] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_BombSpawn01");
          CockpitBLENHEIM1.this.eBombs[5] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_BombSpawn02");
          CockpitBLENHEIM1.this.eBombs[6] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_BombSpawn03");
          CockpitBLENHEIM1.this.eBombs[7] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_BombSpawn04");
          CockpitBLENHEIM1.this.eBombs[8] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_BombSpawn05");
          CockpitBLENHEIM1.this.eBombs[9] = CockpitBLENHEIM1.this.aircraft().getBulletEmitterByHookName("_BombSpawn06");
        }
        for (int i = 0; i < 10; i++) {
          CockpitBLENHEIM1.this.bBombs[i] = (!CockpitBLENHEIM1.this.eBombs[i].haveBullets() ? 1 : 0);
        }
        CockpitBLENHEIM1.this.setNew.throttle1 = (0.9F * CockpitBLENHEIM1.this.setOld.throttle1 + 0.1F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitBLENHEIM1.this.setNew.prop1 = (0.9F * CockpitBLENHEIM1.this.setOld.prop1 + 0.1F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitBLENHEIM1.this.setNew.mix1 = (0.8F * CockpitBLENHEIM1.this.setOld.mix1 + 0.2F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitBLENHEIM1.this.setNew.man1 = (0.92F * CockpitBLENHEIM1.this.setOld.man1 + 0.08F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitBLENHEIM1.this.setNew.throttle2 = (0.9F * CockpitBLENHEIM1.this.setOld.throttle2 + 0.1F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitBLENHEIM1.this.setNew.prop2 = (0.9F * CockpitBLENHEIM1.this.setOld.prop2 + 0.1F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
        CockpitBLENHEIM1.this.setNew.mix2 = (0.8F * CockpitBLENHEIM1.this.setOld.mix2 + 0.2F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
        CockpitBLENHEIM1.this.setNew.man2 = (0.92F * CockpitBLENHEIM1.this.setOld.man2 + 0.08F * CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitBLENHEIM1.this.setNew.altimeter = CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitBLENHEIM1.this.setNew.stage1 = (0.85F * CockpitBLENHEIM1.this.setOld.stage1 + CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor() * 0.15F);
        CockpitBLENHEIM1.this.setNew.stage2 = (0.85F * CockpitBLENHEIM1.this.setOld.stage2 + CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlCompressor() * 0.15F);
        CockpitBLENHEIM1.this.setNew.azimuth.setDeg(CockpitBLENHEIM1.this.setOld.azimuth.getDeg(1.0F), CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitBLENHEIM1.this.setNew.vspeed = ((100.0F * CockpitBLENHEIM1.this.setOld.vspeed + CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);
        float f = CockpitBLENHEIM1.this.waypointAzimuth();
        CockpitBLENHEIM1.this.setNew.waypointAzimuth.setDeg(CockpitBLENHEIM1.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBLENHEIM1.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitBLENHEIM1.this.setNew.waypointDirection.setDeg(CockpitBLENHEIM1.this.setOld.waypointDirection.getDeg(1.0F), f);
        CockpitBLENHEIM1.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RTurret", CockpitBLENHEIM1.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[0], 0.0F, 0.0F);
        CockpitBLENHEIM1.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RGun", CockpitBLENHEIM1.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[1], 0.0F, 0.0F);
        CockpitBLENHEIM1.this.setNew.inert = (0.999F * CockpitBLENHEIM1.this.setOld.inert + 0.001F * (CockpitBLENHEIM1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() != 6 ? 0.0F : 0.867F));
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    float stage1;
    float stage2;
    private final CockpitBLENHEIM1 this$0;
    ...
    Variables(CockpitBLENHEIM1.1 arg2)
    {
      this();
    }
  }
