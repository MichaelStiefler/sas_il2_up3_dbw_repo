...
public class HE_111H6t extends HE_111
{
  ...
  private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int paramInt)
  {
    ...
    try
    {
      ...
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(13, "MGunMG15t", 750);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(14, "MGunMG15t", 750);
      arrayOf_WeaponSlot[5] = new Aircraft._WeaponSlot(15, "MGunMG15t", 750);
  ...
  static
  {
    Class localClass = HE_111H6t.class;
    ...
    try
    {
      ...
      str = "2SC2000";
      arrayOf_WeaponSlot = GenerateDefaultConfig(i);
      arrayOf_WeaponSlot[6] = new Aircraft._WeaponSlot(3, "BombGunSC2000", 1);
      arrayOf_WeaponSlot[7] = new Aircraft._WeaponSlot(3, "BombGunSC2000", 1);
      arrayOf_WeaponSlot[8] = null;
      arrayOf_WeaponSlot[9] = null;
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
