...
public class BF_109F2_RLP extends BF_109
{
  ...
  static
  {
    Class localClass = BF_109F2_RLP.class;
    ...
    Property.set(localClass, "FlightModel", "FlightModels/bf-109f-2_Db601N.fmd");
    ...
    try
    {
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMG151ki", 200);
      for (int j = 3; j < i; j++) {
