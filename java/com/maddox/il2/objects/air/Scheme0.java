// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 14/12/2009 14.31.32
...
public abstract class Scheme0 extends com.maddox.il2.objects.air.Aircraft
{
    ...
    public void update(float f)
    {
        ...
        {
        	//_ITAF_Radar
        	//com.maddox.il2.game.HUD.log("_ITAF_Radar ~ Unlock Glider Debug Session ");
        	///////////////////////////
            setGliderToTraktor();
            ploughFM = FM;
        }
...
// _ITAF_Radar
//        if(startX == true){
//    		HUD.log(this.toString());
//    		startX = false;
//    	}
        if(this.bAttached && this.FM.CT.PowerControl > 0.9F){
        	try {
        		HUD.log("Cutting Tow Cable");
...
//_ITAF_Radar
//	  protected boolean bAttached;
//    private boolean startX = true;
///////////////       
