...
public class CR_32 extends Scheme1
  implements TypeFighter, TypeTNBFighter
{
  ...
  static
  {
    ...
    Property.set(localClass, "FlightModel", "FlightModels/CR32.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitCR32.class });
