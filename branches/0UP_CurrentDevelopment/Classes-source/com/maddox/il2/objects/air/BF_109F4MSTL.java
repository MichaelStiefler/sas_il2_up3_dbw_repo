    ...
    private void onCoopMasterSpawned()
    {
        ...
        if(com.maddox.il2.engine.Actor.isValid(actor) && (actor instanceof com.maddox.il2.objects.air.JU_88MSTL))
            try
            {
                ...
                java.lang.String s1 = "spawn " + actor.getClass().getName() + " NAME net" + actor.name() + " FUEL " + f + " WEAPONS " + ((com.maddox.il2.objects.air.NetAircraft) (aircraft)).thisWeaponsName + (((com.maddox.il2.objects.air.NetAircraft) (aircraft)).bPaintShemeNumberOn ? "" : " NUMBEROFF") + " OVR";
