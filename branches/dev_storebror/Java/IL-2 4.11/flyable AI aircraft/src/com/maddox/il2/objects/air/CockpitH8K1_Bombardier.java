...
public class CockpitH8K1_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			float f = ((H8K1) CockpitH8K1_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((H8K1) CockpitH8K1_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitH8K1_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F,
					-f1, f);
			if (CockpitH8K1_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitH8K1_Bombardier.this.aAim
						+ f1, CockpitH8K1_Bombardier.this.tAim + f, 0.0F);
			}
			CockpitH8K1_Bombardier.this.mesh.chunkSetAngles("Turret1A", 0.0F,
					-CockpitH8K1_Bombardier.this.aircraft().FM.turret[0].tu[0],
					0.0F);
			CockpitH8K1_Bombardier.this.mesh.chunkSetAngles("Turret1B", 0.0F,
					CockpitH8K1_Bombardier.this.aircraft().FM.turret[0].tu[1],
					0.0F);
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(
					((H8K1) this.aircraft()).fSightCurForwardAngle, 7F, 140F,
					0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((H8K1) this.aircraft()).fSightCurReadyness > 0.93F;
