...
//            AR_234, PaintSchemeBMPar05, NetAircraft
...
public class AR_234B2 extends com.maddox.il2.objects.air.AR_234
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.AR_234B2.weaponTriggersRegister(class1, new int[] {
            0, 0, 3, 3, 3, 9, 9
        });
        com.maddox.il2.objects.air.AR_234B2.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalDev01", "_ExternalDev02"
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", null, null, null, null, null
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "2xtyped", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", null, null, null, "FuelTankGun_Type_D", "FuelTankGun_Type_D"
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "3xsc500", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", "BombGunSC500 1", "BombGunSC500 1", "BombGunSC500 1", null, null
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "3xsd500", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", "BombGunSD500 1", "BombGunSD500 1", "BombGunSD500 1", null, null
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "1xsc1000", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", null, null, "BombGunSC1000 1", null, null
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "1xsc10002xsc250", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", "BombGunSC250 1", "BombGunSC250 1", "BombGunSC1000 1", null, null
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "3xab250", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", "BombGunAB250 1", "BombGunAB250 1", "BombGunAB250 1", null, null
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "3xab500", new java.lang.String[] {
            "MGunMG15120k 200", "MGunMG15120k 200", "BombGunAB500 1", "BombGunAB500 1", "BombGunAB500 1", null, null
        });
        com.maddox.il2.objects.air.AR_234B2.weaponsRegister(class1, "none", new java.lang.String[] {
