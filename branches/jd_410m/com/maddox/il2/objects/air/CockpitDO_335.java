  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitDO_335.this.fm != null) {
        ...
        {
          CockpitDO_335.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
          CockpitDO_335.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
        }
        else
        {
        ...
        CockpitDO_335.this.setNew.vspeed = ((199.0F * CockpitDO_335.this.setOld.vspeed + CockpitDO_335.this.fm.getVertSpeed()) / 200.0F);
        ...
        World.cur(); World.land(); CockpitDO_335.this.setNew.radioalt = (0.9F * CockpitDO_335.this.setOld.radioalt + 0.1F * (CockpitDO_335.this.fm.getAltitude() - Landscape.HQ_Air((float)CockpitDO_335.this.fm.Loc.x, (float)CockpitDO_335.this.fm.Loc.y)));

        CockpitDO_335.this.setNew.beaconDirection = ((10.0F * CockpitDO_335.this.setOld.beaconDirection + CockpitDO_335.this.getBeaconDirection()) / 11.0F);
        CockpitDO_335.this.setNew.beaconRange = ((10.0F * CockpitDO_335.this.setOld.beaconRange + CockpitDO_335.this.getBeaconRange()) / 11.0F);
      }
