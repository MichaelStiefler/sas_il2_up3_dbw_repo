...
public class A6M3_22 extends A6M
{
  static
  {
    Class var_class = A6M3_22.class;

    new NetAircraft.SPAWN(var_class);
    Property.set(var_class, "iconFar_shortClassName", "A6M");

    Property.set(var_class, "meshName", "3DO/Plane/A6M3-22(Multi1)/hier.him");
    Property.set(var_class, "PaintScheme", new PaintSchemeFMPar01());
    Property.set(var_class, "meshName_ja", "3DO/Plane/A6M3-22(ja)/hier.him");
    ...
    try
    {
      ...
      a_lweaponslot[2] = new Aircraft._WeaponSlot(1, "MGunMGFFk", 100);
      a_lweaponslot[3] = new Aircraft._WeaponSlot(1, "MGunMGFFk", 100);
