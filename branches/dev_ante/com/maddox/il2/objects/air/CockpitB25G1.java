...
public class CockpitB25G1 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitB25G1 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB25G1.this.fm != null) {
        CockpitB25G1.access$102(CockpitB25G1.this, CockpitB25G1.this.setOld);
        CockpitB25G1.access$202(CockpitB25G1.this, CockpitB25G1.this.setNew);
        CockpitB25G1.access$302(CockpitB25G1.this, CockpitB25G1.this.setTmp);
        ...
        CockpitB25G1.this.setNew.waypointAzimuth.setDeg(CockpitB25G1.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitB25G1.this.setNew.waypointDeviation.setDeg(CockpitB25G1.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB25G1.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitB25G1.this.setNew.vspeed = ((199.0F * CockpitB25G1.this.setOld.vspeed + CockpitB25G1.this.fm.getVertSpeed()) / 200.0F);
      }
