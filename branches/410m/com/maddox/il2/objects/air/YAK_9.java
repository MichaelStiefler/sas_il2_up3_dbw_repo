    ...
    implements com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.YAK_9.weaponTriggersRegister(class1, new int[] {
            0, 1
        });
        com.maddox.il2.objects.air.YAK_9.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_CANNON01"
        });
        com.maddox.il2.objects.air.YAK_9.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunUBsi 200", "MGunShVAKki 120"
        });
        com.maddox.il2.objects.air.YAK_9.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
