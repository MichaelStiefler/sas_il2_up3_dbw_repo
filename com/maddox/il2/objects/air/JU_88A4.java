  ...
  implements TypeBomber, TypeDiveBomber, TypeScout
{
    ...
    if ((this == World.getPlayerAircraft()) && ((this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel instanceof RealFlightModel)))
    {
      if (((RealFlightModel)this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel).isRealMode()) { switch (this.diveMechStage) {
        ...
        case 2:
          ...
          if ((this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.AirBrakeControl != 0.0F) && (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getTangage() <= 0.0F)) break; this.diveMechStage += 1; break;
        case 3:
  ...
  public void msgShot(Shot paramShot)
  {
    ...
    if ((paramShot.chunkName.startsWith("WingLMid")) && 
      (World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F) && (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 750.0F))
    ...
    if (paramShot.chunkName.startsWith("Turret4A")) {
      killPilot(paramShot.initiator, 3);
    }
