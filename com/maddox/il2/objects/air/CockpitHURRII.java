...
public class CockpitHURRII extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      if (CockpitHURRII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitHURRII.this.setNew.throttle = ((10.0F * CockpitHURRII.this.setOld.throttle + CockpitHURRII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitHURRII.this.setNew.altimeter = CockpitHURRII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitHURRII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitHURRII.this.setNew.azimuth = ((35.0F * CockpitHURRII.this.setOld.azimuth + -CockpitHURRII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        ...
        CockpitHURRII.this.setNew.vspeed = ((199.0F * CockpitHURRII.this.setOld.vspeed + CockpitHURRII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
