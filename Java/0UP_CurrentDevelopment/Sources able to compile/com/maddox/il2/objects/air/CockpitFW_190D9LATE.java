...
public class CockpitFW_190D9LATE extends CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f1 = ((FW_190D9LATE)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitFW_190D9LATE.k14TargetWingspanScale[((FW_190D9LATE)aircraft()).k14WingspanType]) / f1;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitFW_190D9LATE.k14TargetMarkScale[((FW_190D9LATE)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((FW_190D9LATE)aircraft()).k14Mode;
                ...
                float f4 = floatindex((f1 - 200F) * 0.04F, CockpitFW_190D9LATE.k14BulletDrop) - CockpitFW_190D9LATE.k14BulletDrop[0];
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bomb[0] == null)
        {
            ...
            if(((Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalBomb05") != com.maddox.il2.objects.weapons.GunEmpty.get())
            {
                bomb[1] = ((Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalBomb05");
                bomb[2] = ((Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalBomb05");
            } else
            if(((Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalDev02") != com.maddox.il2.objects.weapons.GunEmpty.get())
            {
                bomb[1] = ((Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalDev02");
                bomb[2] = ((Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalDev02");
            }
        ...
        if(gun[3] != null)
        {
            Cockpit.xyz[0] = cvt(gun[3].countBullets(), 0.0F, 200F, -0.017F, 0.0F);
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitFW_190D9LATE.class, "normZN", 0.72F);
        com.maddox.rts.Property.set(CockpitFW_190D9LATE.class, "gsZN", 0.66F);
    }
