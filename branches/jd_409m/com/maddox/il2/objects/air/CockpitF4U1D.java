...
public class CockpitF4U1D extends CockpitPilot
{
  ...
  protected void reflectPlaneMats()
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("1A_Bars", false);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF4U1D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitF4U1D.this.setNew.throttle = (0.85F * CockpitF4U1D.this.setOld.throttle + CockpitF4U1D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitF4U1D.this.setNew.prop = (0.85F * CockpitF4U1D.this.setOld.prop + CockpitF4U1D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitF4U1D.this.setNew.altimeter = CockpitF4U1D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitF4U1D.this.waypointAzimuth();
        CockpitF4U1D.this.setNew.azimuth.setDeg(CockpitF4U1D.this.setOld.azimuth.getDeg(1.0F), CockpitF4U1D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitF4U1D.this.setNew.waypointAzimuth.setDeg(CockpitF4U1D.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitF4U1D.this.setNew.vspeed = ((199.0F * CockpitF4U1D.this.setOld.vspeed + CockpitF4U1D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
