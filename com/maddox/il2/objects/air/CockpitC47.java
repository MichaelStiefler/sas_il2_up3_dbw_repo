...
public class CockpitC47 extends CockpitPilot
{
  ...
  public CockpitC47() {
    super("3DO/Cockpit/B-25J/CockpitC47.him", "bf109");
  ...
  private class Variables
  {
    ...
    private final CockpitC47 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitC47.this.fm != null) {
        CockpitC47.access$102(CockpitC47.this, CockpitC47.this.setOld);
        CockpitC47.access$202(CockpitC47.this, CockpitC47.this.setNew);
        CockpitC47.access$302(CockpitC47.this, CockpitC47.this.setTmp);
        ...
        CockpitC47.this.setNew.waypointDeviation.setDeg(CockpitC47.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitC47.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitC47.this.setNew.vspeed = ((199.0F * CockpitC47.this.setOld.vspeed + CockpitC47.this.fm.getVertSpeed()) / 200.0F);
      }
