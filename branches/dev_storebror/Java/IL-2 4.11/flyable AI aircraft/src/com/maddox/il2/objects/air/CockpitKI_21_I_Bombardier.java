...
public class CockpitKI_21_I_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			float f = ((KI_21_I) CockpitKI_21_I_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((KI_21_I) CockpitKI_21_I_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitKI_21_I_Bombardier.this.mesh.chunkSetAngles("BlackBox",
					0.0F, -f1, f);
			if (CockpitKI_21_I_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitKI_21_I_Bombardier.this.aAim
						+ f1, CockpitKI_21_I_Bombardier.this.tAim + f, 0.0F);
			}
			CockpitKI_21_I_Bombardier.this.mesh
					.chunkSetAngles(
							"Turret1A",
							0.0F,
							-CockpitKI_21_I_Bombardier.this.aircraft().FM.turret[0].tu[0],
							0.0F);
			CockpitKI_21_I_Bombardier.this.mesh
					.chunkSetAngles(
							"Turret1B",
							0.0F,
							CockpitKI_21_I_Bombardier.this.aircraft().FM.turret[0].tu[1],
							0.0F);
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(
					((KI_21_I) this.aircraft()).fSightCurForwardAngle, 7F,
					140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((KI_21_I) this.aircraft()).fSightCurReadyness > 0.93F;
