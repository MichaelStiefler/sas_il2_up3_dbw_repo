...
public class CockpitSB2M103_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((SB_2M103)aircraft()).fSightCurForwardAngle;
                float f1 = -((SB_2M103)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((SB_2M103)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((SB_2M103)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
