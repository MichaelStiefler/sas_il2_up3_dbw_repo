...
public class CockpitA6M5a extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitA6M5a.access$102(CockpitA6M5a.this, CockpitA6M5a.this.setOld); CockpitA6M5a.access$202(CockpitA6M5a.this, CockpitA6M5a.this.setNew); CockpitA6M5a.access$302(CockpitA6M5a.this, CockpitA6M5a.this.setTmp);

        if (CockpitA6M5a.this.cockpitDimControl) {
          if (CockpitA6M5a.this.setNew.dimPosition > 0.0F) CockpitA6M5a.this.setNew.dimPosition = (CockpitA6M5a.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitA6M5a.this.setNew.dimPosition < 1.0F) CockpitA6M5a.this.setNew.dimPosition = (CockpitA6M5a.this.setOld.dimPosition + 0.05F);

        if ((CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) {
          if (CockpitA6M5a.this.setNew.stbyPosition > 0.0F) CockpitA6M5a.this.setNew.stbyPosition = (CockpitA6M5a.this.setOld.stbyPosition - 0.025F);
        }
        else if (CockpitA6M5a.this.setNew.stbyPosition < 1.0F) CockpitA6M5a.this.setNew.stbyPosition = (CockpitA6M5a.this.setOld.stbyPosition + 0.025F);

        CockpitA6M5a.this.setNew.throttle = (0.9F * CockpitA6M5a.this.setOld.throttle + 0.1F * CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitA6M5a.this.setNew.prop = (0.9F * CockpitA6M5a.this.setOld.prop + 0.1F * CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitA6M5a.this.setNew.mix = (0.8F * CockpitA6M5a.this.setOld.mix + 0.2F * CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitA6M5a.this.setNew.man = (0.92F * CockpitA6M5a.this.setOld.man + 0.08F * CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitA6M5a.this.setNew.altimeter = CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitA6M5a.this.setNew.azimuth.setDeg(CockpitA6M5a.this.setOld.azimuth.getDeg(1.0F), CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitA6M5a.this.setNew.vspeed = ((199.0F * CockpitA6M5a.this.setOld.vspeed + CockpitA6M5a.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f = CockpitA6M5a.this.waypointAzimuth();

        CockpitA6M5a.this.setNew.waypointAzimuth.setDeg(CockpitA6M5a.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M5a.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-5.0F, 5.0F));

        CockpitA6M5a.this.setNew.waypointDirection.setDeg(CockpitA6M5a.this.setOld.waypointDirection.getDeg(0.5F), f);
      }
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float stbyPosition;
    private final CockpitA6M5a this$0;
