...
public class TA_152H1 extends com.maddox.il2.objects.air.FW_190
{
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.TA_152H1.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.44F, 0.0F, 0.44F);
        hierMesh().chunkSetLocate("GearL2a_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.TA_152H1.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.44F, 0.0F, 0.44F);
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.TA_152H1.weaponTriggersRegister(class1, new int[] {
            0, 1, 1
        });
        com.maddox.il2.objects.air.TA_152H1.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON03", "_CANNON04"
        });
        com.maddox.il2.objects.air.TA_152H1.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMK108k 90", "MGunMG15120s  175", "MGunMG15120s  175"
        });
        com.maddox.il2.objects.air.TA_152H1.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
}
