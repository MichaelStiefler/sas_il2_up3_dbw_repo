...
public class MBV2AA extends com.maddox.il2.objects.trains.Wagon
    implements com.maddox.il2.engine.MsgCollisionRequestListener, com.maddox.il2.ai.MsgExplosionListener, com.maddox.il2.ai.MsgShotListener, com.maddox.il2.ai.ground.Predator, com.maddox.il2.ai.ground.HunterInterface
{
    ...
    private static java.lang.String getMeshName(int i)
    {
        ...
        return "3do/Trains/MBV2" + (i == 1 ? "_Dmg" : "AA") + "/" + s + "/hier.him";
    }

    public static java.lang.String getMeshNameForEditor()
    {
        return com.maddox.il2.objects.trains.MBV2AA.getMeshName(0);
    }
    ...
    public MBV2AA(com.maddox.il2.objects.trains.Train train)
    {
        super(train, com.maddox.il2.objects.trains.MBV2AA.getMeshName(0), com.maddox.il2.objects.trains.MBV2AA.getMeshName(1));
        arms = new com.maddox.il2.objects.trains.FiringDevice[10];
        try
        {
            life = 0.036F;
            ignoreTNT = 16F;
            ...
            for(int j = 3; j < 10; j++)
            {
                ...
                {
                    if(j == 7 || j == 9)
                        arms[j].gunClass = java.lang.Class.forName("com.maddox.il2.objects.weapons.MGunDA762t");
                    else
            ...
            fillGunProperties(3, com.maddox.il2.objects.weapons.Gun.getProperties(arms[3].gunClass).weaponType, false, 2200F, 2200F, 2200F, 1, 0.0F, new AnglesRange(-45F, 45F), 0.0F, -45F, 0.0F, 45F, 38F, 18F, 1.5F, 6.5F);
            fillGunProperties(4, com.maddox.il2.objects.weapons.Gun.getProperties(arms[4].gunClass).weaponType, false, 2200F, 2200F, 2200F, 1, 0.0F, new AnglesRange(-45F, 45F), 0.0F, -45F, 0.0F, 45F, 38F, 18F, 1.5F, 6.5F);
            fillGunProperties(5, com.maddox.il2.objects.weapons.Gun.getProperties(arms[5].gunClass).weaponType, false, 2200F, 2200F, 2200F, 1, 0.0F, new AnglesRange(-45F, 45F), 0.0F, -45F, 0.0F, 45F, 38F, 18F, 1.5F, 6.5F);
            fillGunProperties(6, com.maddox.il2.objects.weapons.Gun.getProperties(arms[6].gunClass).weaponType, false, 2200F, 2200F, 2200F, 1, 0.0F, new AnglesRange(-45F, 45F), 0.0F, -45F, 0.0F, 45F, 38F, 18F, 1.5F, 6.5F);
            fillGunProperties(7, com.maddox.il2.objects.weapons.Gun.getProperties(arms[7].gunClass).weaponType, false, 2200F, 2200F, 2200F, 1, 0.0F, new AnglesRange(-180F, 180F), 0.0F, -5F, 0.0F, 80F, 38F, 18F, 1.5F, 6.5F);
            fillGunProperties(8, com.maddox.il2.objects.weapons.Gun.getProperties(arms[8].gunClass).weaponType, false, 3000F, 3000F, 3000F, 1, 0.0F, new AnglesRange(-180F, 180F), 0.0F, 0.0F, 0.0F, 82F, 38F, 18F, 0.375F, 6.5F);
            fillGunProperties(9, com.maddox.il2.objects.weapons.Gun.getProperties(arms[9].gunClass).weaponType, false, 2200F, 2200F, 2200F, 1, 0.0F, new AnglesRange(-180F, 180F), 0.0F, -5F, 0.0F, 80F, 38F, 18F, 1.5F, 6.5F);
        }
    ...
    private final com.maddox.il2.objects.trains.FiringDevice GetGunProperties(com.maddox.il2.ai.ground.Aim aim)
    {
        ...
        java.lang.System.out.println("Internal error 2: Can't find train gun.");
        return null;
    }
    ...
    public float chainFireTime(com.maddox.il2.ai.ground.Aim aim)
    {
        ...
        return f <= 0.0F ? 0.0F : f * com.maddox.il2.objects.trains.MBV2AA.Rnd(0.75F, 1.25F);
    }
    ...
    public com.maddox.il2.engine.Actor findEnemy(com.maddox.il2.ai.ground.Aim aim)
    {
        ...
        {
        case 0: // '\0'
            com.maddox.il2.ai.ground.NearestEnemies.set(arms[i].WEAPONS_MASK, -9999.9F, com.maddox.il2.objects.trains.MBV2AA.KmHourToMSec(100F));
            break;
        ...
        default:
            com.maddox.il2.ai.ground.NearestEnemies.set(arms[i].WEAPONS_MASK, com.maddox.il2.objects.trains.MBV2AA.KmHourToMSec(100F), 9999.9F);
            break;
        }
    ...
    public int targetGun(com.maddox.il2.ai.ground.Aim aim, com.maddox.il2.engine.Actor actor, float f, boolean flag)
    {
        ...
        if(!flag1)
            return 0;
        float f1 = f * com.maddox.il2.objects.trains.MBV2AA.Rnd(0.8F, 1.2F);
        ...
        point3d.scale(com.maddox.il2.objects.trains.MBV2AA.Rnd(0.97999999999999998D, 1.02D));
        ...
        if(firingdevice.id == 7)
        {
            com.maddox.il2.engine.Loc loc = new Loc();
            hierMesh().setCurChunk("Head1");
            hierMesh().getChunkLocObj(loc);
            orient.add(loc.getOrient(), pos.getAbs().getOrient());
        } else
        if(firingdevice.id == 9)
        {
            com.maddox.il2.engine.Loc loc1 = new Loc();
            hierMesh().setCurChunk("Head2");
            hierMesh().getChunkLocObj(loc1);
            orient.add(loc1.getOrient(), pos.getAbs().getOrient());
        } else
        {
    ...
    {
        com.maddox.il2.objects.trains.FiringDevice firingdevice = GetFiringDevice(aim);
        if(!blockTrigger(firingdevice) && !firingdevice.TRACKING_ONLY)
            firingdevice.gun.shots(-1);
    }

    private boolean blockTrigger(com.maddox.il2.objects.trains.FiringDevice firingdevice)
    {
        float f = firingdevice.headYaw;
        float f1 = firingdevice.gunPitch;
        switch(firingdevice.id)
        {
        default:
            break;

        case 7: // '\007'
            for(f += arms[1].headYaw; f >= 360F; f -= 360F);
            for(; f < 0.0F; f += 360F);
            for(; f1 >= 360F; f1 -= 360F);
            for(; f1 < 0.0F; f1 += 360F);
            if(f > 175F && f < 185F && (f1 < 5F || f1 > 355F))
                return true;
            break;
        ...
        case 8: // '\b'
            ...
            for(; f1 >= 360F; f1 -= 360F);
            for(; f1 < 0.0F; f1 += 360F);
            if((f > 324F || f < 36F) && f1 < 32F)
                return true;
            if(f > 145F && f < 215F && f1 < 35F)
                return true;
            break;

        case 9: // '\t'
            for(f += arms[2].headYaw; f >= 360F; f -= 360F);
            for(; f < 0.0F; f += 360F);
            for(; f1 >= 360F; f1 -= 360F);
            for(; f1 < 0.0F; f1 += 360F);
            if(f > 170F && f < 190F && (f1 < 5F || f1 > 355F))
                return true;
            break;
        }
        return false;
    ...
    static 
    {
        cls = com.maddox.il2.objects.trains.MBV2AA.class;
        cls = com.maddox.il2.objects.trains.MBV2AA.class;
