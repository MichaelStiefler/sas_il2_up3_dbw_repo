...
public class CockpitB29SP extends CockpitPilot
{
  ...
  public CockpitB29SP()
  {
    super("3DO/Cockpit/B-29-sp/CockpitB29SP.him", "bf109");
  ...
  private class Variables
  {
    ...
    private final CockpitB29SP this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitB29SP.access$002(CockpitB29SP.this, CockpitB29SP.this.setOld);
        CockpitB29SP.access$102(CockpitB29SP.this, CockpitB29SP.this.setNew);
        CockpitB29SP.access$202(CockpitB29SP.this, CockpitB29SP.this.setTmp);
        CockpitB29SP.this.setNew.throttle1 = (0.85F * CockpitB29SP.this.setOld.throttle1 + CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitB29SP.this.setNew.throttle2 = (0.85F * CockpitB29SP.this.setOld.throttle2 + CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitB29SP.this.setNew.prop1 = (0.85F * CockpitB29SP.this.setOld.prop1 + CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitB29SP.this.setNew.prop2 = (0.85F * CockpitB29SP.this.setOld.prop2 + CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitB29SP.this.setNew.altimeter = CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitB29SP.this.waypointAzimuth();
        CockpitB29SP.this.setNew.azimuth.setDeg(CockpitB29SP.this.setOld.azimuth.getDeg(1.0F), CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitB29SP.this.setNew.waypointAzimuth.setDeg(CockpitB29SP.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitB29SP.this.setNew.waypointDeviation.setDeg(CockpitB29SP.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB29SP.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitB29SP.this.setNew.vspeed = ((199.0F * CockpitB29SP.this.setOld.vspeed + CockpitB29SP.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
