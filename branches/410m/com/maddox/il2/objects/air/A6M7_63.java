...
public class A6M7_63 extends com.maddox.il2.objects.air.A6M
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.equals("xxarmorg"))
            {
                ...
                com.maddox.il2.objects.air.A6M7_63.debugprintln(this, "*** Armor Glass: Hit..");
                if(shot.power <= 0.0F)
                {
                    com.maddox.il2.objects.air.A6M7_63.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.A6M7_63.class;
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/A6M7_Model63.fmd");
        com.maddox.rts.Property.set(class1, "cockpitClass", com.maddox.il2.objects.air.CockpitA6M7_63.class);
        com.maddox.rts.Property.set(class1, "LOSElevation", 1.01885F);
        com.maddox.il2.objects.air.A6M7_63.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 1, 1, 9, 9, 3, 9, 9, 
            2, 2, 2, 2
        });
        com.maddox.il2.objects.air.A6M7_63.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.A6M7_63.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131ki 240", "MGunMG131ki 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, 
            null, null, null, null
        });
        com.maddox.il2.objects.air.A6M7_63.weaponsRegister(class1, "2x150dt", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.A6M7_63.weaponsRegister(class1, "1xwdt4s", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131ki 240", "MGunMG131ki 240", "MGunMGFFk 125", "MGunMGFFk 125", "FuelTankGun_Tank0Centre", null, null, null, null, 
            null, null, null, null
        });
        com.maddox.il2.objects.air.A6M7_63.weaponsRegister(class1, "4xtype3", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131ki 240", "MGunMG131ki 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, 
            "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27"
        });
        com.maddox.il2.objects.air.A6M7_63.weaponsRegister(class1, "1x250", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131ki 240", "MGunMG131ki 240", "MGunMGFFk 125", "MGunMGFFk 125", null, "PylonA6MPLN1", "BombGun250kg", null, null, 
            null, null, null, null
        });
        com.maddox.il2.objects.air.A6M7_63.weaponsRegister(class1, "none", new java.lang.String[] {
