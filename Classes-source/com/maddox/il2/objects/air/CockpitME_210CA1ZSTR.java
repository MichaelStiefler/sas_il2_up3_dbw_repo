...
//            CockpitPilot, Aircraft, Cockpit, ME_210CA1ZSTR

public class CockpitME_210CA1ZSTR extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if((com.maddox.il2.objects.air.ME_210CA1ZSTR)aircraft() != null);
            if(com.maddox.il2.objects.air.ME_210CA1ZSTR.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.ME_210CA1ZSTR)aircraft() != null);
                com.maddox.il2.objects.air.ME_210CA1ZSTR.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
