...
public class CockpitP_40E extends CockpitPilot
{
  ...
  {
    resetYPRmodifier();
    Cockpit.xyz[2] = cvt(this.fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, -0.63F);
    ...
    resetYPRmodifier();
    Cockpit.xyz[1] = cvt(this.fm.Or.getTangage(), -45.0F, 45.0F, 0.0321F, -0.0321F);
    ...
    this.mesh.chunkSetAngles("Z_Fuel1", cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 4.0F, 0.0F, -180.0F), 0.0F, 0.0F);
    ...
    {
      this.mesh.chunkSetAngles("Z_Pres1", cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.338638F, 2.539784F, 0.0F, 343.5F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      ...
      {
        CockpitP_40E.access$002(CockpitP_40E.this, CockpitP_40E.this.setOld);
        CockpitP_40E.access$102(CockpitP_40E.this, CockpitP_40E.this.setNew);
        CockpitP_40E.access$202(CockpitP_40E.this, CockpitP_40E.this.setTmp);
        CockpitP_40E.this.setNew.throttle = ((10.0F * CockpitP_40E.this.setOld.throttle + CockpitP_40E.this.fm.CT.PowerControl) / 11.0F);
        CockpitP_40E.this.setNew.prop = ((8.0F * CockpitP_40E.this.setOld.prop + CockpitP_40E.this.fm.CT.getStepControl()) / 9.0F);
        CockpitP_40E.this.setNew.altimeter = CockpitP_40E.this.fm.getAltitude();
        if (Math.abs(CockpitP_40E.this.fm.Or.getKren()) < 45.0F)
          CockpitP_40E.this.setNew.azimuth = ((35.0F * CockpitP_40E.this.setOld.azimuth + -CockpitP_40E.this.fm.Or.getYaw()) / 36.0F);
        if ((CockpitP_40E.this.setOld.azimuth > 270.0F) && (CockpitP_40E.this.setNew.azimuth < 90.0F))
          CockpitP_40E.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_40E.this.setOld.azimuth < 90.0F) && (CockpitP_40E.this.setNew.azimuth > 270.0F))
          CockpitP_40E.this.setOld.azimuth += 360.0F;
        ...
        CockpitP_40E.this.setNew.vspeed = ((199.0F * CockpitP_40E.this.setOld.vspeed + CockpitP_40E.this.fm.getVertSpeed()) / 200.0F);
      }
      return true;
    }
