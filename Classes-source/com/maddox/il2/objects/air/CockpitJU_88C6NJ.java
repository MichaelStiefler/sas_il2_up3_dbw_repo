...
// Source File Name:   CockpitJU_88C6NJ.java
...
//            CockpitPilot, JU_88C6NJ, Aircraft, Cockpit

public class CockpitJU_88C6NJ extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            com.maddox.il2.objects.air.JU_88C6NJ ju_88c6nj = (com.maddox.il2.objects.air.JU_88C6NJ)aircraft();
            if(com.maddox.il2.objects.air.JU_88C6NJ.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.JU_88C6NJ ju_88c6nj1 = (com.maddox.il2.objects.air.JU_88C6NJ)aircraft();
                com.maddox.il2.objects.air.JU_88C6NJ.bChangedPit = false;
            }
            if(fm != null)
            {
                setTmp = setOld;
                ...
                if(buzzerFX != null)
                    if(fm.Loc.z < (double)((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveRecoveryAlt && ((com.maddox.il2.objects.air.JU_88C6NJ)fm.actor).diveMechStage == 1)
                        buzzerFX.play();
                    else
                    if(buzzerFX.isPlaying())
                        buzzerFX.stop();
                f1 = ((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveRecoveryAlt;
                float f2 = -(((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.sin(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float)java.lang.Math.sqrt(f2 * f2 + 2.0F * f1 * 0.1019F);
                float f3 = ((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.cos(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveAngle));
                float f4 = (f3 * f2 + 10F) - 10F;
                setNew.alpha = 90F - ((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveAngle - (float)java.lang.Math.toDegrees(java.lang.Math.atan(f4 / f1));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("z_Object20", cvt(((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fSightCurSpeed, 400F, 800F, 87F, -63.5F), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("zAlt3", (((com.maddox.il2.objects.air.JU_88C6NJ)aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
