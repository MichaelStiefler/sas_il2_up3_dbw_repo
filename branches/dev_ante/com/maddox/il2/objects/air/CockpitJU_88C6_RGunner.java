...
public class CockpitJU_88C6_RGunner extends CockpitGunner
{
  ...
  public CockpitJU_88C6_RGunner() {
    super("3DO/Cockpit/Ju-88A-4-RGun/C6hier.him", "he111");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    this.mesh.chunkSetAngles("z_Object20", cvt(((JU_88C6)aircraft()).fSightCurSpeed, 400.0F, 800.0F, 87.0F, -63.5F), 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("zAlt3", ((JU_88C6)aircraft()).fDiveRecoveryAlt * 360.0F / 6000.0F, 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_Compass2", this.setNew.waypointAzimuth.getDeg(paramFloat), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_Compass3", this.setNew.waypointAzimuth.getDeg(paramFloat), 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_Compass8", this.setNew.waypointAzimuth.getDeg(paramFloat) + this.setNew.azimuth.getDeg(paramFloat) + 90.0F, 0.0F, 0.0F);
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float cons;
    private final CockpitJU_88C6_RGunner this$0;
    ...
    Variables(CockpitJU_88C6_RGunner.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88C6_RGunner.this.fm != null) {
        CockpitJU_88C6_RGunner.access$102(CockpitJU_88C6_RGunner.this, CockpitJU_88C6_RGunner.this.setOld);
        CockpitJU_88C6_RGunner.access$202(CockpitJU_88C6_RGunner.this, CockpitJU_88C6_RGunner.this.setNew);
        CockpitJU_88C6_RGunner.access$302(CockpitJU_88C6_RGunner.this, CockpitJU_88C6_RGunner.this.setTmp);
        CockpitJU_88C6_RGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88C6_RGunner.this.setOld.throttle1 + CockpitJU_88C6_RGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F);

        CockpitJU_88C6_RGunner.this.setNew.prop1 = (0.85F * CockpitJU_88C6_RGunner.this.setOld.prop1 + CockpitJU_88C6_RGunner.this.fm.EI.engines[0].getControlProp() * 0.15F);

        CockpitJU_88C6_RGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88C6_RGunner.this.setOld.throttle2 + CockpitJU_88C6_RGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F);

        CockpitJU_88C6_RGunner.this.setNew.prop2 = (0.85F * CockpitJU_88C6_RGunner.this.setOld.prop2 + CockpitJU_88C6_RGunner.this.fm.EI.engines[1].getControlProp() * 0.15F);

        CockpitJU_88C6_RGunner.this.setNew.altimeter = CockpitJU_88C6_RGunner.this.fm.getAltitude();
        float f1 = CockpitJU_88C6_RGunner.this.waypointAzimuth();
        CockpitJU_88C6_RGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88C6_RGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88C6_RGunner.this.setOld.azimuth.getDeg(1.0F));

        CockpitJU_88C6_RGunner.this.setNew.azimuth.setDeg(CockpitJU_88C6_RGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88C6_RGunner.this.fm.Or.azimut());

        CockpitJU_88C6_RGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88C6_RGunner.this.setOld.vspeed + CockpitJU_88C6_RGunner.this.fm.getVertSpeed()) / 200.0F);

        if (CockpitJU_88C6_RGunner.this.cockpitDimControl) {
          if (CockpitJU_88C6_RGunner.this.setNew.dimPosition > 0.0F)
            CockpitJU_88C6_RGunner.this.setNew.dimPosition = (CockpitJU_88C6_RGunner.this.setOld.dimPosition - 0.05F);
        } else if (CockpitJU_88C6_RGunner.this.setNew.dimPosition < 1.0F)
          CockpitJU_88C6_RGunner.this.setNew.dimPosition = (CockpitJU_88C6_RGunner.this.setOld.dimPosition + 0.05F);
        float f2 = CockpitJU_88C6_RGunner.this.prevFuel - CockpitJU_88C6_RGunner.this.fm.M.fuel;
        CockpitJU_88C6_RGunner.access$402(CockpitJU_88C6_RGunner.this, CockpitJU_88C6_RGunner.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88C6_RGunner.this.setNew.cons = (0.91F * CockpitJU_88C6_RGunner.this.setOld.cons + 0.09F * f2);
        if (CockpitJU_88C6_RGunner.this.buzzerFX != null) {
          if ((CockpitJU_88C6_RGunner.this.fm.Loc.z < ((JU_88C6)CockpitJU_88C6_RGunner.this.aircraft()).fDiveRecoveryAlt) && (((JU_88C6)CockpitJU_88C6_RGunner.this.fm.actor).diveMechStage == 1))
          {
            CockpitJU_88C6_RGunner.this.buzzerFX.play();
          } else if (CockpitJU_88C6_RGunner.this.buzzerFX.isPlaying())
            CockpitJU_88C6_RGunner.this.buzzerFX.stop();
        }
      }
      return true;
    }
