...
public class CockpitJU_88A17_NGunner extends CockpitGunner
{
  ...
  public CockpitJU_88A17_NGunner() {
    super("3DO/Cockpit/Ju-88A-4-NGun/A17hier.him", "he111");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    resetYPRmodifier();
    float tmp342_341 = (0.85F * this.pictFlap + 0.00948F * this.fm.CT.FlapsControl); this.pictFlap = tmp342_341; Cockpit.xyz[2] = tmp342_341;

    this.mesh.chunkSetLocate("zFlaps1", Cockpit.xyz, Cockpit.ypr);
    float tmp388_387 = (0.85F * this.pictGear + 0.007095F * this.fm.CT.GearControl); this.pictGear = tmp388_387; Cockpit.xyz[2] = tmp388_387;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A17_NGunner.this.fm != null) {
        CockpitJU_88A17_NGunner.access$102(CockpitJU_88A17_NGunner.this, CockpitJU_88A17_NGunner.this.setOld);
        CockpitJU_88A17_NGunner.access$202(CockpitJU_88A17_NGunner.this, CockpitJU_88A17_NGunner.this.setNew);
        CockpitJU_88A17_NGunner.access$302(CockpitJU_88A17_NGunner.this, CockpitJU_88A17_NGunner.this.setTmp);
        CockpitJU_88A17_NGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A17_NGunner.this.setOld.throttle1 + CockpitJU_88A17_NGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F);

        CockpitJU_88A17_NGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A17_NGunner.this.setOld.prop1 + CockpitJU_88A17_NGunner.this.fm.EI.engines[0].getControlProp() * 0.15F);

        CockpitJU_88A17_NGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A17_NGunner.this.setOld.throttle2 + CockpitJU_88A17_NGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F);

        CockpitJU_88A17_NGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A17_NGunner.this.setOld.prop2 + CockpitJU_88A17_NGunner.this.fm.EI.engines[1].getControlProp() * 0.15F);

        CockpitJU_88A17_NGunner.this.setNew.altimeter = CockpitJU_88A17_NGunner.this.fm.getAltitude();
        float f1 = CockpitJU_88A17_NGunner.this.waypointAzimuth();
        if (CockpitJU_88A17_NGunner.this.useRealisticNavigationInstruments())
        {
          CockpitJU_88A17_NGunner.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A17_NGunner.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A17_NGunner.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A17_NGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A17_NGunner.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A17_NGunner.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
          CockpitJU_88A17_NGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A17_NGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A17_NGunner.this.setOld.azimuth.getDeg(1.0F));
        }
        CockpitJU_88A17_NGunner.this.setNew.azimuth.setDeg(CockpitJU_88A17_NGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A17_NGunner.this.fm.Or.azimut());

        CockpitJU_88A17_NGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A17_NGunner.this.setOld.vspeed + CockpitJU_88A17_NGunner.this.fm.getVertSpeed()) / 200.0F);

        if (CockpitJU_88A17_NGunner.this.cockpitDimControl)
        {
          if (CockpitJU_88A17_NGunner.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A17_NGunner.this.setNew.dimPosition -= 0.05F;
        }
        else if (CockpitJU_88A17_NGunner.this.setNew.dimPosition < 1.0F)
          CockpitJU_88A17_NGunner.this.setNew.dimPosition += 0.05F;
        float f2 = CockpitJU_88A17_NGunner.this.prevFuel - CockpitJU_88A17_NGunner.this.fm.M.fuel;
        CockpitJU_88A17_NGunner.access$402(CockpitJU_88A17_NGunner.this, CockpitJU_88A17_NGunner.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A17_NGunner.this.setNew.cons = (0.91F * CockpitJU_88A17_NGunner.this.setOld.cons + 0.09F * f2);
      }

      CockpitJU_88A17_NGunner.this.setNew.beaconDirection = ((10.0F * CockpitJU_88A17_NGunner.this.setOld.beaconDirection + CockpitJU_88A17_NGunner.this.getBeaconDirection()) / 11.0F);
      CockpitJU_88A17_NGunner.this.setNew.beaconRange = ((10.0F * CockpitJU_88A17_NGunner.this.setOld.beaconRange + CockpitJU_88A17_NGunner.this.getBeaconRange()) / 11.0F);
  ...
  private class Variables
  {
    ...
    float beaconRange;
    private final CockpitJU_88A17_NGunner this$0;
    ...
    Variables(CockpitJU_88A17_NGunner.1 arg2)
    {
      this();
    }
  }
