...
public abstract class P_38mod extends Scheme2a
  implements TypeFighter, TypeBNZFighter, TypeStormovik
{
  ...
  public void moveWheelSink()
  {
    ...
    hierMesh().chunkSetAngles("GearC4_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.24F, 0.0F, -50.0F), 0.0F);
    hierMesh().chunkSetAngles("GearC5_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.24F, 0.0F, -105.0F), 0.0F);
    resetYPRmodifier();
    Aircraft.xyz[1] = Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -0.3206F);
    hierMesh().chunkSetLocate("GearL3_D0", Aircraft.xyz, Aircraft.ypr);
    hierMesh().chunkSetAngles("GearL4_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -60.0F), 0.0F);
    hierMesh().chunkSetAngles("GearL5_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -117.5F), 0.0F);
    resetYPRmodifier();
    Aircraft.xyz[1] = Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, 0.3206F);
    hierMesh().chunkSetLocate("GearR3_D0", Aircraft.xyz, Aircraft.ypr);
    hierMesh().chunkSetAngles("GearR4_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -60.0F), 0.0F);
    hierMesh().chunkSetAngles("GearR5_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -117.5F), 0.0F);
  }
  ...
  public void update(float paramFloat)
  {
    ...
    if ((this.FM.isPlayers()) && (this.FM.Sq.squareElevators > 0.0F))
    {
      ...
      if ((localRealFlightModel.RealMode) && (localRealFlightModel.indSpeed > 135.0F))
      {
        ...
        if (localRealFlightModel.indSpeed > 155.0F)
          this.FM.producedAM.y -= 6000.0F * (155.0F - localRealFlightModel.indSpeed);
      }
      else {
    ...
    if (paramString.startsWith("xx"))
    {
      if (paramString.startsWith("xxarmor"))
      {
        ...
        if (paramString.endsWith("2"))
          getEnergyPastArmor(12.7F / (1.0E-005F + (float)Math.abs(Aircraft.v1.x)), paramShot);
        if (paramString.endsWith("3"))
          getEnergyPastArmor(12.7F / (1.0E-005F + (float)Math.abs(Aircraft.v1.x)), paramShot);
        if (paramString.endsWith("4"))
          getEnergyPastArmor(8.9F / (1.0E-005F + (float)Math.abs(Aircraft.v1.x)), paramShot);
      ...
      if (paramString.startsWith("xxspar"))
      {
        ...
        if ((paramString.startsWith("xxpark1")) && (chunkDamageVisible("Keel1") > 1) && (getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** Keel1 Spars Damaged..");
          nextDMGLevels(1, 2, "Keel1_D2", paramShot.initiator);
        }
        if ((paramString.startsWith("xxpark2")) && (chunkDamageVisible("Keel2") > 1) && (getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** Keel2 Spars Damaged..");
          nextDMGLevels(1, 2, "Keel2_D2", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparsl")) && (chunkDamageVisible("StabL") > 1) && (getEnergyPastArmor(12.7F * World.Rnd().nextFloat(1.0F, 1.2F), paramShot) > 0.0F))
        {
      ...
      if (paramString.startsWith("xxlock"))
      {
        ...
        if (((paramString.startsWith("xxlockk1")) || (paramString.startsWith("xxlockk2"))) && (getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 1.2F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** Rudder1 Lock Shot Off..");
          nextDMGLevels(3, 2, "Rudder1_D" + chunkDamageVisible("Rudder1"), paramShot.initiator);
        }
        if (((paramString.startsWith("xxlockk3")) || (paramString.startsWith("xxlockk4"))) && (getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 1.2F), paramShot) > 0.0F))
        {
        ...
        if ((paramString.startsWith("xxlocksl")) && (getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 1.2F), paramShot) > 0.0F))
        {
  ...
  protected boolean cutFM(int paramInt1, int paramInt2, Actor paramActor)
  {
    ...
    case 31:
      ...
      break;
    case 33:
      Wreckage localWreckage1 = new Wreckage(this, hierMesh().chunkFind("Flap03_D0"));
      localWreckage1.collide(false);
      localVector3d.set(this.FM.Vwld);
      localWreckage1.setSpeed(localVector3d);
      ...
      this.FM.cut(32, paramInt2, paramActor);
    case 34:
      Wreckage localWreckage2 = new Wreckage(this, hierMesh().chunkFind("Flap02_D0"));
      localWreckage2.collide(false);
      localVector3d.set(this.FM.Vwld);
      localWreckage2.setSpeed(localVector3d);
      hierMesh().chunkVisible("Flap02_D0", false);
      break;
    case 36:
      this.FM.cut(20, paramInt2, paramActor);
      Wreckage localWreckage3 = new Wreckage(this, hierMesh().chunkFind("Flap05_D0"));
      localWreckage3.collide(false);
      localVector3d.set(this.FM.Vwld);
      localWreckage3.setSpeed(localVector3d);
      ...
      this.FM.cut(32, paramInt2, paramActor);
    case 37:
      Wreckage localWreckage4 = new Wreckage(this, hierMesh().chunkFind("Flap04_D0"));
      localWreckage4.collide(false);
      localVector3d.set(this.FM.Vwld);
      localWreckage4.setSpeed(localVector3d);
  ...
  static
  {
    Class localClass = P_38mod.class;
