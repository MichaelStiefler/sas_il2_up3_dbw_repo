...
// Source File Name:   SPITFIRE5BCLP.java
...
public class SPITFIRE5BCLP extends com.maddox.il2.objects.air.SPITFIRE5
{
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.SPITFIRE5BCLP.class;
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Spitfire-F-Vb-M45-16-CW.fmd");
        ...
        com.maddox.il2.objects.air.SPITFIRE5BCLP.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0, 1, 1
        });
        com.maddox.il2.objects.air.SPITFIRE5BCLP.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02"
        });
        com.maddox.il2.objects.air.SPITFIRE5BCLP.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SPITFIRE5BCLP.weaponsRegister(class1, "none", new java.lang.String[] {
