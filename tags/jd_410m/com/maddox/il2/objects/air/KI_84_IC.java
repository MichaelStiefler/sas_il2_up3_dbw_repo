...
public class KI_84_IC extends KI_84
{
  static
  {
    ...
    weaponsRegister(localClass, "default", new String[] { "MGunHo5s 150", "MGunHo5s 150", "MGunHo115k 65", "MGunHo115k 65", null, null, null, null, null, null });

    weaponsRegister(localClass, "2x100", new String[] { "MGunHo5s 150", "MGunHo5s 150", "MGunHo115k 65", "MGunHo115k 65", "BombGun100kgJ 1", "BombGun100kgJ 1", "PylonKI84PLN2", "PylonKI84PLN2", null, null });

    weaponsRegister(localClass, "2x250", new String[] { "MGunHo5s 150", "MGunHo5s 150", "MGunHo115k 65", "MGunHo115k 65", "BombGun250kgJ 1", "BombGun250kgJ 1", "PylonKI84PLN2", "PylonKI84PLN2", null, null });

    weaponsRegister(localClass, "2tank200", new String[] { "MGunHo5s 150", "MGunHo5s 150", "MGunHo115k 65", "MGunHo115k 65", null, null, "PylonKI84PLN2", "PylonKI84PLN2", "FuelTankGun_TankKi84", "FuelTankGun_TankKi84" });
