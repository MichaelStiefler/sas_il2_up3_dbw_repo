...
public class GUINetAircraft extends com.maddox.il2.game.GameState
{
    public class DialogClient extends com.maddox.il2.gui.GUIDialogClient
    {
        ...
        {
            super.render();
            com.maddox.il2.gui.GUISeparate.draw(this, com.maddox.gwindow.GColor.Gray, x1024(32F), y1024(624F), x1024(924F), 2.5F);
            ...
            setCanvasFont(0);
            draw(x1024(680F), y1024(633F), x1024(176F), y1024(48F), 1, i18n("netair.Arming"));
            draw(x1024(427F), y1024(633F), x1024(170F), y1024(48F), 1, i18n("netair.Fly"));
            draw(x1024(15F), y1024(633F), x1024(140F), y1024(48F), 1, i18n("netair.Brief"));
        }
    ...
    public static com.maddox.il2.gui.Item getItem(int i)
    {
        if(i < 0)
            return null;
        com.maddox.il2.gui.GUINetAircraft guinetaircraft = (com.maddox.il2.gui.GUINetAircraft)com.maddox.il2.gui.GUINetAircraft.get(44);
...
label0:
        for(int i1 = 0; i1 < k; i1++)
        {
            ...
            for(int j3 = 0; j3 < crewFunction.length; j3++)
                crewFunction[j3] = sectfile1.get("Aircraft", "CrewFunction" + j3, crewFunction[j3], 1, com.maddox.il2.fm.AircraftState.astateHUDPilotHits.length);
            ...
            do
            {
                ...
                {
                    if(k3 > 0 && (com.maddox.il2.objects.air.CockpitPilot.class).isAssignableFrom(aclass[k3]))
                        continue;
                    ...
                    if(aclass != null)
                    {
                        int l3 = com.maddox.rts.Property.intValue(aclass[k3], "astatePilotIndx", 0);
                        if(l3 < j2)
                        {
                            l3 = crewFunction[l3];
