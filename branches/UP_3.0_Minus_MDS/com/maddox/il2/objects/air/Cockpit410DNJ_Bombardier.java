...
// Source File Name:   Cockpit410DNJ_Bombardier.java
...
//            CockpitPilot, ME_410DNJ

public class Cockpit410DNJ_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.ME_410DNJ)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.ME_410DNJ)aircraft()).fSightCurSideslip;
    ...
    public Cockpit410DNJ_Bombardier()
    {
        super("3DO/Cockpit/Ar-234B-2-Bombardier/410DNJ.him", "he111");
        bEntered = false;
        bBAiming = false;
        try
        {
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bBAiming)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.ME_410DNJ)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.ME_410DNJ)aircraft()).fSightCurReadyness > 0.93F;
