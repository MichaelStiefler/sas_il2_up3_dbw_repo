...
public class CockpitB25J22_AGunner extends CockpitGunner
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if((B_25J22)aircraft() != null);
        if(B_25J22.bChangedPit)
        {
            reflectPlaneToModel();
            if((B_25J22)aircraft() != null);
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitB25J22_AGunner.class, "aiTuretNum", 2);
        com.maddox.rts.Property.set(CockpitB25J22_AGunner.class, "weaponControlNum", 12);
        com.maddox.rts.Property.set(CockpitB25J22_AGunner.class, "astatePilotIndx", 4);
    }
}
