...
// Source File Name:   CockpitFW_190F8.java
...
public class CockpitFW_190F8 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(t1 < com.maddox.rts.Time.current())
        {
            ...
            mesh.chunkVisible("XLampBomb_LWOut", bomb[2].haveBullets());
            mesh.chunkVisible("XLampBomb_LWIn", bomb[0].haveBullets());
            mesh.chunkVisible("XLampBomb_CFF_L", bomb[4].haveBullets());
            mesh.chunkVisible("XLampBomb_CFF_R", bomb[4].haveBullets());
            mesh.chunkVisible("XLampBomb_RWIn", bomb[1].haveBullets());
            mesh.chunkVisible("XLampBomb_RWOut", bomb[3].haveBullets());
            mesh.chunkVisible("XLampBomb_CFA_L", bomb[4].haveBullets());
            mesh.chunkVisible("XLampBomb_CFA_R", bomb[4].haveBullets());
        }
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitFW_190F8.class, "normZN", 0.72F);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitFW_190F8.class, "gsZN", 0.66F);
    }
