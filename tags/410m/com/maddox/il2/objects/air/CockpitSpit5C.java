...
// Source File Name:   CockpitSpit5C.java
...
//            CockpitPilot, SPITFIRE5C216LBS

public class CockpitSpit5C extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitSpit5C()
    {
        ...
        tmpP = new Point3d();
        tmpV = new Vector3d();
        if(aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE5C216LBS)
        {
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Throtle1", -51.8F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Prop1", -57F * setNew.prop, 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Mixture1", -57F * setNew.mix, 0.0F, 0.0F);
