...
public abstract class BulletAntiAirGeneric extends com.maddox.il2.objects.weapons.Bullet
{
    ...
    public BulletAntiAirGeneric(com.maddox.JGP.Vector3d vector3d, int i, com.maddox.il2.engine.GunGeneric gungeneric, com.maddox.il2.engine.Loc loc, com.maddox.JGP.Vector3d vector3d1, long l, 
    ...
    public void timeOut()
    {
        ...
        } else
        {
            ...
            com.maddox.il2.ai.MsgExplosion.send(null, null, tmpP, owner, bulletproperties.massa, bulletproperties.power, bulletproperties.powerType, bulletproperties.powerRadius);
