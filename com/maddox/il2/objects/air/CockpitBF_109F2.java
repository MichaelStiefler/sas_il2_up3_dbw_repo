...
public class CockpitBF_109F2 extends CockpitPilot
{
  ...
  {
    if ((Actor.isValid(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor)) && ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109F4)))
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_ArmorGlass1", true);
  }

  static
  {
    Property.set(CockpitBF_109F2.class, "normZN", 0.43F);
    Property.set(CockpitBF_109F2.class, "gsZN", 0.43F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitBF_109F2.this.bNeedSetUp)
      {
        ...
        CockpitBF_109F2.access$002(CockpitBF_109F2.this, false);
      }
      CockpitBF_109F2.access$102(CockpitBF_109F2.this, CockpitBF_109F2.this.setOld);
      CockpitBF_109F2.access$202(CockpitBF_109F2.this, CockpitBF_109F2.this.setNew);
      CockpitBF_109F2.access$302(CockpitBF_109F2.this, CockpitBF_109F2.this.setTmp);
      CockpitBF_109F2.this.setOld.altimeter = CockpitBF_109F2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_109F2.this.cockpitDimControl)
      {
        if (CockpitBF_109F2.this.setOld.dimPosition > 0.0F)
          CockpitBF_109F2.this.setOld.dimPosition = (CockpitBF_109F2.this.setTmp.dimPosition - 0.05F);
      }
      else if (CockpitBF_109F2.this.setOld.dimPosition < 1.0F)
        CockpitBF_109F2.this.setOld.dimPosition = (CockpitBF_109F2.this.setTmp.dimPosition + 0.05F);
      CockpitBF_109F2.this.setOld.throttle = ((10.0F * CockpitBF_109F2.this.setTmp.throttle + CockpitBF_109F2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109F2.this.setOld.mix = ((8.0F * CockpitBF_109F2.this.setTmp.mix + CockpitBF_109F2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109F2.this.setOld.azimuth = CockpitBF_109F2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109F2.this.setTmp.azimuth > 270.0F) && (CockpitBF_109F2.this.setOld.azimuth < 90.0F))
        CockpitBF_109F2.this.setTmp.azimuth -= 360.0F;
      if ((CockpitBF_109F2.this.setTmp.azimuth < 90.0F) && (CockpitBF_109F2.this.setOld.azimuth > 270.0F))
        CockpitBF_109F2.this.setTmp.azimuth += 360.0F;
      CockpitBF_109F2.this.setOld.waypointAzimuth = ((10.0F * CockpitBF_109F2.this.setTmp.waypointAzimuth + (CockpitBF_109F2.this.waypointAzimuth() - CockpitBF_109F2.this.setTmp.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
  ...
  private class Variables
  {
    ...
    Variables(CockpitBF_109F2.1 arg2)
    {
      this();
    }
  }
