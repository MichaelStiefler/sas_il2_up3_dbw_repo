...
public class Mig_15bislate extends Mig_15F {
  ...
  if((actor instanceof Aircraft) && actor.getArmy() != World.getPlayerArmy() && ((actor instanceof TypeFighterAceMaker) && (actor instanceof TypeSupersonic))&& actor != World.getPlayerAircraft() && actor.getSpeed(vector3d) > 20D)
  {
  pos.getAbs(point3d);
  ...
  if((double)k1 <= 600D && (double)k1 >= 50D && i2 >= 255 && i2 <= 285 && Math.sqrt(j1 * j1) >= 120D)
  HUD.logCenter("SPO-2: Enemy on Six! Evade!");
  }
  }
