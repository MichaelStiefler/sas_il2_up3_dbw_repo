...
// Source File Name:   CockpitJU_88A4torp.java
...
//            CockpitPilot, JU_88A4torp, Aircraft, AircraftLH, 
//            Cockpit

public class CockpitJU_88A4torp extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(com.maddox.il2.objects.air.JU_88A4torp.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.JU_88A4torp.bChangedPit = false;
            }
            if(fm != null)
            {
                setTmp = setOld;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        float f1 = ((com.maddox.il2.objects.air.JU_88A4torp)aircraft()).fAOB;
        float f2 = ((com.maddox.il2.objects.air.JU_88A4torp)aircraft()).fShipSpeed;
        float f3 = ((com.maddox.il2.objects.air.JU_88A4torp)aircraft()).FM.AS.getGyroAngle();
