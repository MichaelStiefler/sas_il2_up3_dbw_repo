...
public class CockpitHE_219 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(gun[0] == null)
        {
            gun[0] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_MGUN02");
            gun[1] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_MGUN03");
            gun[2] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_MGUN01");
            gun[3] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_MGUN04");
            gun[4] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_MGUN05");
        }
        ...
        super.mesh.chunkSetLocate("Z_Columnbutton3", Cockpit.xyz, Cockpit.ypr);
        resetYPRmodifier();
        super.mesh.chunkSetLocate("Z_Columnbutton4", Cockpit.xyz, Cockpit.ypr);
        resetYPRmodifier();
        super.mesh.chunkSetLocate("Z_Columnbutton5", Cockpit.xyz, Cockpit.ypr);
        resetYPRmodifier();
        ...
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getTangage(), -45F, 45F, 0.024F, -0.024F);
        super.mesh.chunkSetLocate("Z_TurnBank2a", Cockpit.xyz, Cockpit.ypr);
