...
public class CockpitKI_61 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    {
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.16F, 0.99F, 0.0F, -0.54F);
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(fm.CT.getFlap(), 0.0F, 1.0F, 0.0F, 0.0567F);
        mesh.chunkSetLocate("NeedFlap", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(fm.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 0.0F, -0.0567F);
