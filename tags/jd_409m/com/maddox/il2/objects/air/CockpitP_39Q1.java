...
public class CockpitP_39Q1 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_39Q1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitP_39Q1.access$102(CockpitP_39Q1.this, CockpitP_39Q1.this.setOld); CockpitP_39Q1.access$202(CockpitP_39Q1.this, CockpitP_39Q1.this.setNew); CockpitP_39Q1.access$302(CockpitP_39Q1.this, CockpitP_39Q1.this.setTmp);

        CockpitP_39Q1.this.setNew.throttle = ((10.0F * CockpitP_39Q1.this.setOld.throttle + CockpitP_39Q1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitP_39Q1.this.setNew.altimeter = CockpitP_39Q1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        if (Math.abs(CockpitP_39Q1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 45.0F) {
          CockpitP_39Q1.this.setNew.azimuthMag = ((349.0F * CockpitP_39Q1.this.setOld.azimuthMag + CockpitP_39Q1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 350.0F);
        }
        if ((CockpitP_39Q1.this.setOld.azimuthMag > 270.0F) && (CockpitP_39Q1.this.setNew.azimuthMag < 90.0F)) CockpitP_39Q1.this.setOld.azimuthMag -= 360.0F;
        if ((CockpitP_39Q1.this.setOld.azimuthMag < 90.0F) && (CockpitP_39Q1.this.setNew.azimuthMag > 270.0F)) CockpitP_39Q1.this.setOld.azimuthMag += 360.0F;

        CockpitP_39Q1.this.setNew.azimuth = CockpitP_39Q1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut();
        if ((CockpitP_39Q1.this.setOld.azimuth > 270.0F) && (CockpitP_39Q1.this.setNew.azimuth < 90.0F)) CockpitP_39Q1.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_39Q1.this.setOld.azimuth < 90.0F) && (CockpitP_39Q1.this.setNew.azimuth > 270.0F)) CockpitP_39Q1.this.setOld.azimuth += 360.0F;

        CockpitP_39Q1.this.setNew.vspeed = ((499.0F * CockpitP_39Q1.this.setOld.vspeed + CockpitP_39Q1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 500.0F);
        CockpitP_39Q1.this.setNew.waypointAzimuth = ((10.0F * CockpitP_39Q1.this.setOld.waypointAzimuth + CockpitP_39Q1.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      }
  ...
  private class Variables
  {
    ...
    private final CockpitP_39Q1 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitP_39Q1.1 arg2) { this();
    }
  }
}