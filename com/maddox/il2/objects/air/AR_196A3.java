...
//            AR_196, PaintSchemeBMPar00, NetAircraft
...
public class AR_196A3 extends com.maddox.il2.objects.air.AR_196
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.AR_196A3.weaponTriggersRegister(class1, new int[] {
            0, 1, 1, 10, 3, 3
        });
        com.maddox.il2.objects.air.AR_196A3.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_CANNON01", "_CANNON02", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02"
        });
        com.maddox.il2.objects.air.AR_196A3.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG17si 500", "MGunMGFFki 60", "MGunMGFFki 60", "MGunMG15t 525", null, null
        });
        com.maddox.il2.objects.air.AR_196A3.weaponsRegister(class1, "2sc50", new java.lang.String[] {
            "MGunMG17si 500", "MGunMGFFki 60", "MGunMGFFki 60", "MGunMG15t 525", "BombGunSC50 1", "BombGunSC50 1"
        });
        com.maddox.il2.objects.air.AR_196A3.weaponsRegister(class1, "none", new java.lang.String[] {
