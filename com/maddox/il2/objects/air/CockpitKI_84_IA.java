...
public class CockpitKI_84_IA extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitKI_84_IA.access$102(CockpitKI_84_IA.this, CockpitKI_84_IA.this.setOld); CockpitKI_84_IA.access$202(CockpitKI_84_IA.this, CockpitKI_84_IA.this.setNew); CockpitKI_84_IA.access$302(CockpitKI_84_IA.this, CockpitKI_84_IA.this.setTmp);

        CockpitKI_84_IA.this.setNew.flap = (0.88F * CockpitKI_84_IA.this.setOld.flap + 0.12F * CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.FlapsControl);
        CockpitKI_84_IA.this.setNew.tlock = (0.7F * CockpitKI_84_IA.this.setOld.tlock + 0.3F * (CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Gears.bTailwheelLocked ? 1.0F : 0.0F));

        if (CockpitKI_84_IA.this.cockpitDimControl) {
          if (CockpitKI_84_IA.this.setNew.dimPosition > 0.0F) CockpitKI_84_IA.this.setNew.dimPosition = (CockpitKI_84_IA.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitKI_84_IA.this.setNew.dimPosition < 1.0F) CockpitKI_84_IA.this.setNew.dimPosition = (CockpitKI_84_IA.this.setOld.dimPosition + 0.05F);

        if ((CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl < 0.5F) && (CockpitKI_84_IA.this.setNew.gear < 1.0F)) {
          CockpitKI_84_IA.this.setNew.gear = (CockpitKI_84_IA.this.setOld.gear + 0.02F);
        }
        if ((CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl > 0.5F) && (CockpitKI_84_IA.this.setNew.gear > 0.0F)) {
          CockpitKI_84_IA.this.setNew.gear = (CockpitKI_84_IA.this.setOld.gear - 0.02F);
        }
        CockpitKI_84_IA.this.setNew.throttle = (0.9F * CockpitKI_84_IA.this.setOld.throttle + 0.1F * CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl);
        CockpitKI_84_IA.this.setNew.manifold = (0.8F * CockpitKI_84_IA.this.setOld.manifold + 0.2F * CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitKI_84_IA.this.setNew.pitch = (0.9F * CockpitKI_84_IA.this.setOld.pitch + 0.1F * CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitKI_84_IA.this.setNew.mix = (0.9F * CockpitKI_84_IA.this.setOld.mix + 0.1F * CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitKI_84_IA.this.setNew.altimeter = CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitKI_84_IA.this.setNew.azimuth.setDeg(CockpitKI_84_IA.this.setOld.azimuth.getDeg(1.0F), CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitKI_84_IA.this.setNew.vspeed = ((199.0F * CockpitKI_84_IA.this.setOld.vspeed + CockpitKI_84_IA.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float dimPosition;
    private final CockpitKI_84_IA this$0;
    ...
    Variables(CockpitKI_84_IA.1 arg2)
    {
      this();
    }
  }
