...
public class CockpitA6M2N extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        if ((CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) {
        ...
        CockpitA6M2N.this.setNew.throttle = (0.9F * CockpitA6M2N.this.setOld.throttle + 0.1F * CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitA6M2N.this.setNew.prop = (0.9F * CockpitA6M2N.this.setOld.prop + 0.1F * CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitA6M2N.this.setNew.mix = (0.8F * CockpitA6M2N.this.setOld.mix + 0.2F * CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitA6M2N.this.setNew.man = (0.92F * CockpitA6M2N.this.setOld.man + 0.08F * CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitA6M2N.this.setNew.altimeter = CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitA6M2N.this.setNew.azimuth.setDeg(CockpitA6M2N.this.setOld.azimuth.getDeg(1.0F), CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitA6M2N.this.setNew.vspeed = ((199.0F * CockpitA6M2N.this.setOld.vspeed + CockpitA6M2N.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f = CockpitA6M2N.this.waypointAzimuth();

        CockpitA6M2N.this.setNew.waypointAzimuth.setDeg(CockpitA6M2N.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M2N.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-5.0F, 5.0F));

        CockpitA6M2N.this.setNew.waypointDirection.setDeg(CockpitA6M2N.this.setOld.waypointDirection.getDeg(0.5F), f);
      }
