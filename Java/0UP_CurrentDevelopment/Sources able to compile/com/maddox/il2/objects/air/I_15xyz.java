        ...
        if(s.startsWith("xx"))
        {
            ...
            } else
            {
                ...
                if(s.startsWith("xxeng"))
                {
                    ...
                    if(s.endsWith("prop"))
                    {
                        if(getEnergyPastArmor(0.44999998807907104D / (java.lang.Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.05F)
                        {
