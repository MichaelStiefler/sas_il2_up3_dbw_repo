...
public class CockpitBF_110D3 extends CockpitPilot
{
  private float tmp;
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (((BF_110D3)CockpitBF_110D3.this.aircraft() != null) || 
        (BF_110D3.bChangedPit))
      {
        CockpitBF_110D3.this.reflectPlaneToModel();
        if ((BF_110D3)CockpitBF_110D3.this.aircraft() == null);
        BF_110D3.bChangedPit = false;
      }
      CockpitBF_110D3.access$002(CockpitBF_110D3.this, CockpitBF_110D3.this.setOld);
      CockpitBF_110D3.access$102(CockpitBF_110D3.this, CockpitBF_110D3.this.setNew);
      CockpitBF_110D3.access$202(CockpitBF_110D3.this, CockpitBF_110D3.this.setTmp);
      CockpitBF_110D3.this.setNew.altimeter = CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_110D3.this.cockpitDimControl)
      {
        if (CockpitBF_110D3.this.setNew.dimPosition > 0.0F)
          CockpitBF_110D3.this.setNew.dimPosition -= 0.05F;
      }
      else if (CockpitBF_110D3.this.setNew.dimPosition < 1.0F)
        CockpitBF_110D3.this.setNew.dimPosition += 0.05F;
      CockpitBF_110D3.this.setNew.throttle1 = (0.91F * CockpitBF_110D3.this.setOld.throttle1 + 0.09F * CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitBF_110D3.this.setNew.throttle2 = (0.91F * CockpitBF_110D3.this.setOld.throttle2 + 0.09F * CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitBF_110D3.this.setNew.mix1 = (0.88F * CockpitBF_110D3.this.setOld.mix1 + 0.12F * CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitBF_110D3.this.setNew.mix2 = (0.88F * CockpitBF_110D3.this.setOld.mix2 + 0.12F * CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitBF_110D3.this.setNew.azimuth = CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_110D3.this.setOld.azimuth > 270.0F) && (CockpitBF_110D3.this.setNew.azimuth < 90.0F))
        CockpitBF_110D3.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_110D3.this.setOld.azimuth < 90.0F) && (CockpitBF_110D3.this.setNew.azimuth > 270.0F))
        CockpitBF_110D3.this.setOld.azimuth += 360.0F;
      CockpitBF_110D3.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_110D3.this.setOld.waypointAzimuth + (CockpitBF_110D3.this.waypointAzimuth() - CockpitBF_110D3.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitBF_110D3.Variables localVariables = CockpitBF_110D3.this.setNew;
      float f1 = 0.9F * CockpitBF_110D3.this.setOld.radioalt;
      float f2 = 0.1F;
      float f3 = CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      World.cur();
      World.land();
      localVariables.radioalt = (f1 + f2 * (f3 - Landscape.HQ_Air((float)CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.x, (float)CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y)));
      CockpitBF_110D3.this.setNew.vspeed = ((199.0F * CockpitBF_110D3.this.setOld.vspeed + CockpitBF_110D3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      return true;
    }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float radioalt;
    private final CockpitBF_110D3 this$0;
    ...
    Variables(CockpitBF_110D3.1 arg2)
    {
      this();
    }
  }
