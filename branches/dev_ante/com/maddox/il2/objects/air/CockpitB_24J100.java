...
public class CockpitB_24J100 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zFlaps1", 0.0F, 38.0F * (this.pictFlap = 0.75F * this.pictFlap + 0.25F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.FlapsControl), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zOilFlap3", 0.0F, -35.0F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getControlRadiator(), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zOilFlap4", 0.0F, -35.0F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getControlRadiator(), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zMix3", 0.0F, -45.799999F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getControlMix(), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zMix4", 0.0F, -45.799999F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getControlMix(), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zPitch3", 0.0F, -54.0F * interp(this.setNew.prop3, this.setOld.prop3, paramFloat), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zPitch4", 0.0F, -54.0F * interp(this.setNew.prop4, this.setOld.prop4, paramFloat), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zThrottle3", 0.0F, -49.0F * interp(this.setNew.throttle3, this.setOld.throttle3, paramFloat), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zThrottle4", 0.0F, -49.0F * interp(this.setNew.throttle4, this.setOld.throttle4, paramFloat), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zCompressor3", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zCompressor4", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50.0F), 0.0F);
    if (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.cgear)
    {
      resetYPRmodifier();
      Cockpit.xyz[1] = cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear(), 0.0F, 1.0F, 0.0F, 0.0135F);
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetLocate("Z_Gearc1", Cockpit.xyz, Cockpit.ypr);
    }
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zFlaps2", 0.0F, 90.0F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap(), 0.0F);
    ...
    if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x40) == 0)
    {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zRPM3", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getRPM(), 0.0F, 4500.0F, 0.0F, 323.0F), 0.0F);
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zRPM4", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getRPM(), 0.0F, 4500.0F, 0.0F, 323.0F), 0.0F);
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Pres3", 0.0F, this.pictManf3 = 0.9F * this.pictManf3 + 0.1F * cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getManifoldPressure(), 0.338638F, 2.539784F, 0.0F, 346.5F), 0.0F);
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Pres4", 0.0F, this.pictManf4 = 0.9F * this.pictManf4 + 0.1F * cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getManifoldPressure(), 0.338638F, 2.539784F, 0.0F, 346.5F), 0.0F);
    }
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPres1", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPres2", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPres3", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPres4", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270.0F), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Oilpres3", 0.0F, cvt(1.0F + 0.05F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].tOilOut * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getReadyness(), 0.0F, 13.49F, 0.0F, 270.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Oilpres4", 0.0F, cvt(1.0F + 0.05F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].tOilOut * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getReadyness(), 0.0F, 13.49F, 0.0F, 270.0F), 0.0F);
  ...
  public void reflectCockpitState()
  {
    ...
    if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x40) != 0)
    {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_FuelPres3", false);
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_FuelPres4", false);
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_Oilpres3", false);
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_Oilpres4", false);
  ...
  private class Variables
  {
    ...
    private final CockpitB_24J100 this$0;
    ...
    Variables(CockpitB_24J100.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitB_24J100.access$002(CockpitB_24J100.this, CockpitB_24J100.this.setOld);
        CockpitB_24J100.access$102(CockpitB_24J100.this, CockpitB_24J100.this.setNew);
        CockpitB_24J100.access$202(CockpitB_24J100.this, CockpitB_24J100.this.setTmp);
        CockpitB_24J100.this.setNew.throttle1 = (0.85F * CockpitB_24J100.this.setOld.throttle1 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitB_24J100.this.setNew.throttle2 = (0.85F * CockpitB_24J100.this.setOld.throttle2 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitB_24J100.this.setNew.throttle3 = (0.85F * CockpitB_24J100.this.setOld.throttle3 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getControlThrottle() * 0.15F);
        CockpitB_24J100.this.setNew.throttle4 = (0.85F * CockpitB_24J100.this.setOld.throttle4 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getControlThrottle() * 0.15F);
        CockpitB_24J100.this.setNew.prop1 = (0.85F * CockpitB_24J100.this.setOld.prop1 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitB_24J100.this.setNew.prop2 = (0.85F * CockpitB_24J100.this.setOld.prop2 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitB_24J100.this.setNew.prop3 = (0.85F * CockpitB_24J100.this.setOld.prop3 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[2].getControlProp() * 0.15F);
        CockpitB_24J100.this.setNew.prop4 = (0.85F * CockpitB_24J100.this.setOld.prop4 + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[3].getControlProp() * 0.15F);
        CockpitB_24J100.this.setNew.altimeter = CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitB_24J100.this.waypointAzimuth();
        CockpitB_24J100.this.setNew.azimuth.setDeg(CockpitB_24J100.this.setOld.azimuth.getDeg(1.0F), CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitB_24J100.this.setNew.waypointAzimuth.setDeg(CockpitB_24J100.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitB_24J100.this.setNew.waypointDeviation.setDeg(CockpitB_24J100.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB_24J100.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitB_24J100.this.setNew.vspeed = ((199.0F * CockpitB_24J100.this.setOld.vspeed + CockpitB_24J100.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
