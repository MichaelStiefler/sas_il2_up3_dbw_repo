...
public class CockpitDB3B_BGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Turret1A", 15.0F, -paramOrient.getYaw(), 0.0F);
  ...
  static
  {
    ...
    Property.set(CockpitDB3B_BGunner.class, "astatePilotIndx", 2);
  }
}