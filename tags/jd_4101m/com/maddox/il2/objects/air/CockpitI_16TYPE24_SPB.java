...
public class CockpitI_16TYPE24_SPB extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick() { if (CockpitI_16TYPE24_SPB.this.fm != null) {
        ...
        CockpitI_16TYPE24_SPB.this.setNew.throttle = ((10.0F * CockpitI_16TYPE24_SPB.this.setOld.throttle + CockpitI_16TYPE24_SPB.this.fm.CT.PowerControl) / 11.0F);
        CockpitI_16TYPE24_SPB.this.setNew.prop = ((10.0F * CockpitI_16TYPE24_SPB.this.setOld.prop + CockpitI_16TYPE24_SPB.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitI_16TYPE24_SPB.this.setNew.altimeter = CockpitI_16TYPE24_SPB.this.fm.getAltitude();
        if (Math.abs(CockpitI_16TYPE24_SPB.this.fm.Or.getKren()) < 30.0F) {
          CockpitI_16TYPE24_SPB.this.setNew.azimuth = ((35.0F * CockpitI_16TYPE24_SPB.this.setOld.azimuth + -CockpitI_16TYPE24_SPB.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        CockpitI_16TYPE24_SPB.this.setNew.vspeed = ((199.0F * CockpitI_16TYPE24_SPB.this.setOld.vspeed + CockpitI_16TYPE24_SPB.this.fm.getVertSpeed()) / 200.0F);
