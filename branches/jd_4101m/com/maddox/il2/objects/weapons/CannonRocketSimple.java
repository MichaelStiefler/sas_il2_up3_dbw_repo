  ...
  implements BulletAimer
{
  ...
  public float TravelTime(Point3d paramPoint3d1, Point3d paramPoint3d2)
  {
    ...
    if ((f6 < this.prop.aimMinDist) || (f6 > this.prop.aimMaxDist)) {
      return -1.0F;
    }
    float f2 = f6;
    float f3 = f1;
  ...
  {
    float f3 = (float)(paramPoint3d2.x - paramPoint3d1.x);
    float f4 = (float)(paramPoint3d2.y - paramPoint3d1.y);
    float f5 = (float)(paramPoint3d2.z - paramPoint3d1.z);
    float f6 = (float)Math.sqrt(f3 * f3 + f4 * f4);
    float f1 = f6;
    float f2 = (float)(paramPoint3d2.z - paramPoint3d1.z);
    ...
    float f7 = this.prop.bullet[0].speed;
  ...
  public void doStartBullet(double paramDouble)
  {
    ...
    launch(tmpP, tmpO, this.prop.bullet[0].speed, getOwner());
  }
