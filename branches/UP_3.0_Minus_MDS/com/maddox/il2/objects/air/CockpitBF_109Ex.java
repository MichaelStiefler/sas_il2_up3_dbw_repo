...
//            CockpitPilot, Cockpit, AircraftLH, BF_109E4, 
//            BF_109E4N, BF_109E7N, BF_109E7, BF_109E1, 
//            BF_109E3, BF_109E4B, BF_109E7NZ
...
public class CockpitBF_109Ex extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    {
        hasCanopy = false;
        if(((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkFindCheck("Top") >= 0)
            ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("TopOpen", false);
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("TopE1", false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetAngles("Z_ATA1", 15.5F + ((com.maddox.il2.objects.air.Cockpit)this).cvt(pictManifold = 0.75F * pictManifold + 0.25F * ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.air.Cockpit)this).fm)).EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 336F), 0.0F, 0.0F);
        ...
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_FuelRed1", ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.air.Cockpit)this).fm)).M.fuel < 36F);
    ...
    public void reflectCockpitState()
    {
        ...
        {
            ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_Armor_D1", true);
            ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_HullDamage1", true);
        }
        if((((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.air.Cockpit)this).fm)).AS.astateCockpitState & 1) != 0)
            if(type == 0 || type == 1)
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_Holes1E4_D1", true);
            else
        ...
        if((((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.air.Cockpit)this).fm)).AS.astateCockpitState & 4) != 0)
            ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_HullDamage4", true);
    ...
    {
        if(com.maddox.il2.engine.Actor.isValid(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor))
        {
            if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E4)
                type = 0;
            else
            if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E4N)
                type = 1;
            else
            if((((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E7N) || (((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E7))
                type = 2;
            else
            if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E1)
                type = 3;
            else
            if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E3)
                type = 4;
            else
            if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E4B)
                type = 5;
            else
            if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.BF_109E7NZ)
                type = 6;
            switch(type)
            {
            case 0: // '\0'
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Body", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("BodyE4", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4_D0", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4B_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE7_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("oxigen-7", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("oxigen-7z", false);
                break;
            ...
            case 2: // '\002'
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Body", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("BodyE4", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4B_D0", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE7_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("oxigen-7", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("oxigen-7z", false);
                break;
            ...
            case 3: // '\003'
                ...
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("BodyE4", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("TopOpen", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("TopE1", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4_D0", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4B_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE7_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("oxigen-7", true);
            ...
            case 4: // '\004'
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Body", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("BodyE4", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("TopOpen", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("TopE1", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4_D0", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4B_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE7_D0", false);
            ...
            case 6: // '\006'
                ...
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE4B_D0", true);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("PanelE7_D0", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("oxigen-7", false);
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("oxigen-7z", true);
                break;
            }
        }
    }
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (com.maddox.il2.objects.air.CockpitBF_109Ex.class)), "normZN", 0.8F);
        com.maddox.rts.Property.set(((java.lang.Object) (com.maddox.il2.objects.air.CockpitBF_109Ex.class)), "gsZN", 0.85F);
    }
