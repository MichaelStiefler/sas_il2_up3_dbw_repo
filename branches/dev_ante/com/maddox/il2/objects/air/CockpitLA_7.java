...
public class CockpitLA_7 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitLA_7.access$102(CockpitLA_7.this, CockpitLA_7.this.setOld); CockpitLA_7.access$202(CockpitLA_7.this, CockpitLA_7.this.setNew); CockpitLA_7.access$302(CockpitLA_7.this, CockpitLA_7.this.setTmp);

        CockpitLA_7.this.setNew.throttle = ((10.0F * CockpitLA_7.this.setOld.throttle + CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        CockpitLA_7.this.setNew.prop = ((8.0F * CockpitLA_7.this.setOld.prop + CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl()) / 9.0F);
        CockpitLA_7.this.setNew.altimeter = CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitLA_7.this.setNew.azimuth = ((35.0F * CockpitLA_7.this.setOld.azimuth + -CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        if ((CockpitLA_7.this.setOld.azimuth > 270.0F) && (CockpitLA_7.this.setNew.azimuth < 90.0F)) CockpitLA_7.this.setOld.azimuth -= 360.0F;
        if ((CockpitLA_7.this.setOld.azimuth < 90.0F) && (CockpitLA_7.this.setNew.azimuth > 270.0F)) CockpitLA_7.this.setOld.azimuth += 360.0F;
        CockpitLA_7.this.setNew.waypointAzimuth = ((10.0F * CockpitLA_7.this.setOld.waypointAzimuth + (CockpitLA_7.this.waypointAzimuth() - CockpitLA_7.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);
        CockpitLA_7.this.setNew.vspeed = ((199.0F * CockpitLA_7.this.setOld.vspeed + CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitLA_7.this.cvt(CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitLA_7.this.cvt(CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
            CockpitLA_7.access$416(CockpitLA_7.this, 0.3F);
            if (CockpitLA_7.this.pictBlinker > 1.0F)
              CockpitLA_7.access$402(CockpitLA_7.this, 1.0F);
          }
          else {
            CockpitLA_7.access$424(CockpitLA_7.this, 0.3F);
            if (CockpitLA_7.this.pictBlinker < 0.0F) {
              CockpitLA_7.access$402(CockpitLA_7.this, 0.0F);
            }
          }
        }
        CockpitLA_7.access$502(CockpitLA_7.this, 0.8F * CockpitLA_7.this.pictStage + 0.1F * CockpitLA_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlCompressor());
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    float[] xyz;
    float[] ypr;
    private final CockpitLA_7 this$0;
