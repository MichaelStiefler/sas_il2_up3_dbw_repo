  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M5b.this.fm != null) {
        ...
        if ((CockpitA6M5b.this.fm.AS.astateCockpitState & 0x2) != 0) {
        ...
        CockpitA6M5b.this.setNew.vspeed = ((199.0F * CockpitA6M5b.this.setOld.vspeed + CockpitA6M5b.this.fm.getVertSpeed()) / 200.0F);
        ...
        else
        {
          ...
          CockpitA6M5b.this.setNew.waypointDirection.setDeg(CockpitA6M5b.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M5b.this.fm.Or.azimut() + 90.0F);
        }
