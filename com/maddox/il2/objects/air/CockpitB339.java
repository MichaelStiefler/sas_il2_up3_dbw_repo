...
public class CockpitB339 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    resetYPRmodifier();
    float tmp539_538 = (0.9F * this.pictProp + 0.1F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp()); this.pictProp = tmp539_538; Cockpit.xyz[1] = cvt(tmp539_538, 0.0F, 1.0F, 0.0F, -0.035F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB339.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitB339.this.setNew.throttle = ((10.0F * CockpitB339.this.setOld.throttle + CockpitB339.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitB339.this.setNew.altimeter = CockpitB339.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitB339.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitB339.this.setNew.azimuth = ((35.0F * CockpitB339.this.setOld.azimuth + -CockpitB339.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        ...
        CockpitB339.this.setNew.vspeed = ((199.0F * CockpitB339.this.setOld.vspeed + CockpitB339.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
