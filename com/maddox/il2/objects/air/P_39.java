    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        if(shot.chunkName.startsWith("Engine1") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.06F && com.maddox.il2.objects.air.Aircraft.Pd.z > 0.47999998927116394D)
        {
        ...
        {
            if((double)shot.power * java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) > 12070D)
                FM.AS.hitPilot(shot.initiator, 0, (int)(shot.mass * 1000F * 0.5F));
            if(com.maddox.il2.objects.air.Aircraft.Pd.z > 1.0117499828338623D)
            {
