...
//            Main3D, Main, GameTrack, AircraftHotKeys, 
//            I18N, Mission
...
public class HUD
{
    ...
    private void renderOrder()
    {
        ...
        if(s != null)
            drawOrder(s, i, l, 0, i1);
    }

    private void drawOrder(java.lang.String s, int i, int j, int k, int l)
    {
        int i1 = 0xff0000ff;
        if((l & 1) != 0)
            i1 = 0xff00007f;
