...
public class P_80 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeFighterAceMaker
{
    ...
    {
        com.maddox.il2.objects.air.P_80.moveGear(hierMesh(), f);
    }

    public void moveWheelSink()
    {
        float f = com.maddox.il2.objects.air.P_80.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.19075F, 0.0F, 1.0F);
        resetYPRmodifier();
        xyz[0] = -0.19075F * f;
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("g1"))
                {
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(40F, 60F) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
        ...
        if(FM.AS.isMaster())
            ...
            } else
            {
                ...
                if(curctl < 1.05F)
                {
                    ...
                    if((curctl - oldctl) / f < -3F && (curctl - oldctl) / f > -7.5F && FM.EI.engines[0].getRPM() < 4800F && FM.EI.engines[0].getStage() == 6)
                    {
                        ...
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.05F && (FM instanceof com.maddox.il2.fm.RealFlightModel) && ((com.maddox.il2.fm.RealFlightModel)FM).isRealMode())
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.P_80.class;
