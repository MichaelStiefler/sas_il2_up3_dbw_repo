...
public abstract class BEAU_EARLY extends Scheme2
{
  ...
  public boolean turretAngles(int paramInt, float[] paramArrayOfFloat)
  {
    ...
    case 0:
      ...
      f2 = Aircraft.cvt(Math.abs(f1), 0.0F, 50.0F, -10.0F, -3.5F);
    }
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    paramHierMesh.chunkSetAngles("GearL2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 0.89F, 0.0F, -103.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL3_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 0.29F, 0.0F, -63.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL4_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 0.29F, 0.0F, -58.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.11F, 0.99F, 0.0F, -103.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR3_D0", 0.0F, Aircraft.cvt(paramFloat, 0.11F, 0.39F, 0.0F, -63.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR4_D0", 0.0F, Aircraft.cvt(paramFloat, 0.11F, 0.39F, 0.0F, -58.0F), 0.0F);
  }
  ...
  {
    resetYPRmodifier();
    Aircraft.xyz[1] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.2F, 0.0F, 0.165F);
    hierMesh().chunkSetLocate("GearL25_D0", Aircraft.xyz, Aircraft.ypr);
    resetYPRmodifier();
    Aircraft.xyz[1] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.2F, 0.0F, 0.165F);
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx"))
    {
      if (paramString.startsWith("xxarmor"))
      {
        ...
        if (paramString.endsWith("p1"))
          getEnergyPastArmor(8.0F, paramShot);
      ...
      else if (paramString.startsWith("xxcontrols"))
      {
        ...
        case 2:
          ...
          if (World.Rnd().nextFloat() >= 0.15F)
            break;
          this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.setEngineSpecificDamage(paramShot.initiator, 1, 7);
        ...
        case 5:
        case 6:
          if ((getEnergyPastArmor(1.5F, paramShot) <= 0.0F) || (World.Rnd().nextFloat() >= 0.25F))
            break;
      ...
      else if (paramString.startsWith("xxengine"))
      {
        i = 0;
        ...
        getEnergyPastArmor(18.0F, paramShot);
      }
      ...
      else if (paramString.startsWith("xxoil"))
      {
        ...
        if ((paramString.startsWith("xxprop1")) && (getEnergyPastArmor(0.1F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.8F))
          if (World.Rnd().nextFloat() < 0.5F)
          {
        ...
        if ((paramString.startsWith("xxprop2")) && (getEnergyPastArmor(0.1F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.8F))
          if (World.Rnd().nextFloat() < 0.5F)
          {
            this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.setEngineSpecificDamage(paramShot.initiator, 1, 3);
            Aircraft.debugprintln(this, "*** Engine2 Module: Prop Governor Hit, Disabled..");
          }
          else {
            this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.setEngineSpecificDamage(paramShot.initiator, 1, 4);
            Aircraft.debugprintln(this, "*** Engine2 Module: Prop Governor Hit, Damaged..");
          }
        if (paramString.startsWith("xxspar"))
        {
          if ((paramString.startsWith("xxsparli")) && (chunkDamageVisible("WingLIn") > 2) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** WingLIn Spars Damaged..");
            nextDMGLevels(1, 2, "WingLIn_D3", paramShot.initiator);
          }
          if ((paramString.startsWith("xxsparri")) && (chunkDamageVisible("WingRIn") > 2) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** WingRIn Spars Damaged..");
            nextDMGLevels(1, 2, "WingRIn_D3", paramShot.initiator);
          }
          if ((paramString.startsWith("xxsparlm")) && (chunkDamageVisible("WingLMid") > 2) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** WingLMid Spars Damaged..");
            nextDMGLevels(1, 2, "WingLMid_D3", paramShot.initiator);
          }
          if ((paramString.startsWith("xxsparrm")) && (chunkDamageVisible("WingRMid") > 2) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** WingRMid Spars Damaged..");
            nextDMGLevels(1, 2, "WingRMid_D3", paramShot.initiator);
          }
          if ((paramString.startsWith("xxsparlo")) && (chunkDamageVisible("WingLOut") > 2) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** WingLOut Spars Damaged..");
            nextDMGLevels(1, 2, "WingLOut_D3", paramShot.initiator);
          }
          if ((paramString.startsWith("xxsparro")) && (chunkDamageVisible("WingROut") > 2) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** WingROut Spars Damaged..");
            nextDMGLevels(1, 2, "WingROut_D3", paramShot.initiator);
          }
          if ((paramString.startsWith("xxspark")) && (chunkDamageVisible("Keel1") > 1) && (getEnergyPastArmor(9.6F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** Keel1 Spars Damaged..");
            nextDMGLevels(1, 2, "Keel1_D2", paramShot.initiator);
          }
        }
        else if (paramString.startsWith("xxstruts"))
        {
          if ((paramString.startsWith("xxstruts1")) && (chunkDamageVisible("Engine1") > 1) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 8.0F), paramShot) > 0.0F))
          {
            debuggunnery("*** Engine1 Spars Damaged..");
            nextDMGLevels(1, 2, "Engine1_D2", paramShot.initiator);
          }
          if ((paramString.startsWith("xxstruts2")) && (chunkDamageVisible("Engine2") > 1) && (getEnergyPastArmor(14.5F * World.Rnd().nextFloat(1.0F, 8.0F), paramShot) > 0.0F))
          {
    ...
    else if (paramString.startsWith("xcf"))
    {
      ...
      {
        if (paramPoint3d.jdField_z_of_type_Double > 0.913D)
        ...
        if (paramPoint3d.jdField_z_of_type_Double > 0.341D)
        {
          if (paramPoint3d.jdField_x_of_type_Double < 1.402D)
          {
        ...
        if ((paramPoint3d.jdField_x_of_type_Double > 1.691D) && (paramPoint3d.jdField_x_of_type_Double < 1.98D))
  ...
  static
  {
    Class localClass = BEAU_EARLY.class;
