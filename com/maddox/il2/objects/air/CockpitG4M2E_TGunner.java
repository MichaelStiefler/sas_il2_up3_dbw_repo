...
public class CockpitG4M2E_TGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Turret1C", -paramOrient.getYaw(), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Turret1D", 0.0F, paramOrient.getTangage(), 0.0F);
  }
  ...
  protected void interpTick()
  {
    if (isRealMode())
    {
      ...
      {
        if (this.hook1 == null)
          this.hook1 = new HookNamed(aircraft(), "_CANNON01");
        doHitMasterAircraft(aircraft(), this.hook1, "_CANNON01");
      }
    }
  }
