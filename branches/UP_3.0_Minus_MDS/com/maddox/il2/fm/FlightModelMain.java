...
public class FlightModelMain extends com.maddox.il2.fm.FMMath
{
    ...
    {
        return (float)(((com.maddox.JGP.Tuple3d) (Vflow)).x * 3.6000000000000001D);
    }

    public float getSpeed()
    {
        return (float)((com.maddox.JGP.Tuple3d) (Vflow)).x;
    }

    public void getSpeed(com.maddox.JGP.Vector3d vector3d)
    {
        ((com.maddox.JGP.Tuple3d) (vector3d)).set(((com.maddox.JGP.Tuple3d) (Vair)));
    }

    public float getVertSpeed()
    {
        return (float)((com.maddox.JGP.Tuple3d) (Vair)).z;
    }

    public float getAltitude()
    {
        return (float)((com.maddox.JGP.Tuple3d) (Loc)).z;
    }
    ...
    {
        ((com.maddox.JGP.Tuple3f) (point3f)).set(((com.maddox.JGP.Tuple3d) (Loc)));
    }

    public void getLoc(com.maddox.JGP.Point3d point3d)
    {
        ((com.maddox.JGP.Tuple3d) (point3d)).set(((com.maddox.JGP.Tuple3d) (Loc)));
    }

    public void getOrient(com.maddox.il2.engine.Orientation orientation)
    {
        orientation.set(((com.maddox.il2.engine.Orient) (Or)));
    }
    ...
    {
        ((com.maddox.JGP.Tuple3d) (TmpV)).set(((com.maddox.JGP.Tuple3d) (LocalAccel)));
        if(Vwld.lengthSquared() < 10D)
        {
            double d = Vwld.lengthSquared() - 5D;
            if(d < 0.0D)
                d = 0.0D;
            ((com.maddox.JGP.Tuple3d) (TmpV)).scale(0.20000000000000001D * d);
        }
        ((com.maddox.JGP.Tuple3d) (TmpA)).set(0.0D, 0.0D, -com.maddox.il2.fm.Atmosphere.g());
        Or.transformInv(((com.maddox.JGP.Tuple3d) (TmpA)));
        ((com.maddox.JGP.Tuple3d) (TmpA)).sub(((com.maddox.JGP.Tuple3d) (TmpV)));
        return TmpA;
    }
    ...
    public void load(java.lang.String s)
    {
        ...
        Sq.load(sectfile);
        Arms.load(sectfile);
        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Interpolate)this).actor, "Calling engines interface to resolve file '" + ((java.lang.Object) (sectfile)).toString() + "'....");
    ...
    public void drawSpeed(java.lang.String s)
    {
        ...
        {
            java.lang.System.out.println("File save failed: " + ((java.lang.Throwable) (ioexception)).getMessage());
            ((java.lang.Throwable) (ioexception)).printStackTrace();
        }
    }
    ...
    {
        ((com.maddox.il2.engine.Interpolate)this).actor.pos.setAbs(loc);
        ((com.maddox.JGP.Tuple3d) (Vwld)).set(((com.maddox.JGP.Tuple3f) (vector3f)));
        loc.get(((com.maddox.JGP.Tuple3d) (Loc)), ((com.maddox.il2.engine.Orient) (Or)));
    }

    public void set(com.maddox.JGP.Point3d point3d, com.maddox.il2.engine.Orient orient, com.maddox.JGP.Vector3f vector3f)
    {
        ((com.maddox.il2.engine.Interpolate)this).actor.pos.setAbs(point3d, orient);
        ((com.maddox.JGP.Tuple3d) (Vwld)).set(((com.maddox.JGP.Tuple3f) (vector3f)));
        ((com.maddox.JGP.Tuple3d) (Loc)).set(((com.maddox.JGP.Tuple3d) (point3d)));
        Or.set(orient);
    }

    public void update(float f)
    {
        ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor).update(f);
    }

    public boolean tick()
    {
        float f = com.maddox.rts.Time.tickLenFs();
        float f1 = (float)(((com.maddox.JGP.Tuple3d) (Loc)).z - com.maddox.il2.engine.Engine.land().HQ_Air(((com.maddox.JGP.Tuple3d) (Loc)).x, ((com.maddox.JGP.Tuple3d) (Loc)).y));
        ((com.maddox.il2.engine.Interpolate)this).actor.pos.getAbs(Loc, ((com.maddox.il2.engine.Orient) (Or)));
        int i = (int)(f / 0.05F) + 1;
        float f2 = f / (float)i;
        for(int j = 0; j < i; j++)
            update(f2);
        ...
        if(((com.maddox.il2.engine.Interpolate)this).actor.pos.base() == null)
        {
            ((com.maddox.il2.engine.Interpolate)this).actor.pos.setAbs(Loc, ((com.maddox.il2.engine.Orient) (Or)));
        } else
        {
            if(((com.maddox.il2.engine.Interpolate)this).actor.pos.base() instanceof com.maddox.il2.objects.air.Aircraft)
            {
                ((com.maddox.JGP.Tuple3d) (Vwld)).set(((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor.pos.base())).FM)).Vwld)));
            } else
            {
                ((com.maddox.il2.engine.Interpolate)this).actor.pos.speed(actVwld);
                Vwld.x = (float)((com.maddox.JGP.Tuple3d) (actVwld)).x;
                Vwld.y = (float)((com.maddox.JGP.Tuple3d) (actVwld)).y;
                Vwld.z = (float)((com.maddox.JGP.Tuple3d) (actVwld)).z;
            }
            ((com.maddox.il2.engine.Interpolate)this).actor.pos.getAbs(((com.maddox.il2.engine.Orient) (Or)));
            producedAF.z += 9.81F * M.mass;
        }
        Energy = com.maddox.il2.fm.Atmosphere.g() * (float)((com.maddox.JGP.Tuple3d) (Loc)).z + V2 * 0.5F;
        return true;
    }

    public float getOverload()
    {
        return (float)((com.maddox.JGP.Tuple3d) (ACmeter)).z;
    }

    public float getForwAccel()
    {
        return (float)((com.maddox.JGP.Tuple3d) (ACmeter)).x;
    }

    public float getRollAcceleration()
    {
        return (float)((com.maddox.JGP.Tuple3d) (AM)).x / Gravity;
    }

    public void gunPulse(com.maddox.JGP.Vector3d vector3d)
    {
        ((com.maddox.JGP.Tuple3d) (GPulse)).set(((com.maddox.JGP.Tuple3d) (vector3d)));
        ((com.maddox.JGP.Tuple3d) (GPulse)).scale(1.0F / M.mass);
        ((com.maddox.JGP.Tuple3d) (Vwld)).sub(((com.maddox.JGP.Tuple3d) (GPulse)));
    }
    ...
    {
        return ((com.maddox.il2.engine.Interpolate)this).actor != null && ((com.maddox.il2.engine.Interpolate)this).actor == com.maddox.il2.ai.World.getPlayerAircraft();
    }
    ...
    private void checkDamaged()
    {
        ...
        {
            bDamaged = true;
            if(((com.maddox.il2.engine.Interpolate)this).actor != damagedInitiator)
                com.maddox.il2.ai.EventLog.onDamaged(((com.maddox.il2.engine.Interpolate)this).actor, damagedInitiator);
            damagedInitiator = null;
        }
        ...
        {
            bDamagedGround = true;
            com.maddox.il2.ai.EventLog.onDamagedGround(((com.maddox.il2.engine.Interpolate)this).actor);
        }
    }
    ...
    public final void setCapableOfBMP(boolean flag, com.maddox.il2.engine.Actor actor)
    {
        ...
        if(isCapableOfBMP() && com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 25)
            com.maddox.il2.objects.sounds.Voice.speakMayday((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor);
        if(flag)
        {
            flags0 |= 16L;
        } else
    ...
    public final void setReadyToDie(boolean flag)
    {
        ...
        if(!isReadyToDie())
        {
            if(com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 75)
                com.maddox.il2.objects.sounds.Voice.speakMayday((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor);
            com.maddox.il2.objects.effects.Explosions.generateComicBulb(((com.maddox.il2.engine.Interpolate)this).actor, "OnFire", 9F);
        }
        if(flag)
        {
            flags0 |= 4L;
    ...
    public final void setReadyToReturn(boolean flag)
    {
        if(isReadyToReturn() == flag)
            return;
        if(!isReadyToReturn())
            com.maddox.il2.objects.effects.Explosions.generateComicBulb(((com.maddox.il2.engine.Interpolate)this).actor, "RTB", 9F);
        if(flag)
            flags0 |= 2L;
        else
            flags0 &= -3L;
        com.maddox.il2.objects.sounds.Voice.speakToReturn((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor);
    }
    ...
    public final void setTakenMortalDamage(boolean flag, com.maddox.il2.engine.Actor actor)
    {
        ...
        if(flag && ((com.maddox.il2.engine.Interpolate)this).actor != com.maddox.il2.ai.World.getPlayerAircraft() && ((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor)).FM.turret.length > 0)
        {
            for(int i = 0; i < ((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor)).FM.turret.length; i++)
                ((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor)).FM.turret[i].bIsOperable = false;
    ...
    public final void setStationedOnGround(boolean flag)
    {
        ...
        {
            flags0 |= 128L;
            com.maddox.il2.ai.EventLog.onAirLanded((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate)this).actor);
            checkDamaged();
        } else
        {
            flags0 &= -129L;
    ...
    {
        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Interpolate)this).actor, "Detected NDL in " + com.maddox.il2.objects.air.Aircraft.partNames()[i] + "..");
        if(i < 0 || i >= 44)
            return;
        ...
        case 33: // '!'
            ...
            ((java.lang.Object) (Sq)).getClass();
            Sq.dragProducedCx += 0.12F;
            if(((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.09F)
    ...
    public void cut(int i, int j, com.maddox.il2.engine.Actor actor)
    {
        if(i < 0 || i >= 44)
            return;
        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Interpolate)this).actor, "cutting part #" + i + " (" + com.maddox.il2.objects.air.Aircraft.partNames()[i] + ")");
        if(!getOp(i))
        {
            com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Interpolate)this).actor, "part #" + i + " (" + com.maddox.il2.objects.air.Aircraft.partNames()[i] + ") already cut off");
            return;
        }
        cutOp(i);
        switch(i)
        ...
        case 2: // '\002'
            ...
            for(int k = 0; k < EI.getNum(); k++)
                EI.engines[k].setReadyness(((com.maddox.il2.engine.Interpolate)this).actor, 0.0F);
        ...
        case 11: // '\013'
            ...
            if(com.maddox.il2.ai.World.Rnd().nextInt(-1, 16) < Skill)
                setReadyToDie(true);
            if((((com.maddox.il2.engine.Interpolate)this).actor instanceof com.maddox.il2.objects.air.Scheme2a) || (((com.maddox.il2.engine.Interpolate)this).actor instanceof com.maddox.il2.objects.air.Scheme5) || (((com.maddox.il2.engine.Interpolate)this).actor instanceof com.maddox.il2.objects.air.Scheme7))
        ...
        case 33: // '!'
            ...
            ((com.maddox.il2.engine.ActorHMesh)((com.maddox.il2.engine.Interpolate)this).actor).destroyChildFiltered(com.maddox.il2.objects.weapons.BombGun.class);
            ((com.maddox.il2.engine.ActorHMesh)((com.maddox.il2.engine.Interpolate)this).actor).destroyChildFiltered(com.maddox.il2.objects.weapons.RocketBombGun.class);
            cut(9, j, actor);
            cutOp(34);
            // fall through
        ...
        case 34: // '"'
            ...
            Sq.liftWingLIn *= 0.9F;
            ((com.maddox.il2.engine.ActorHMesh)((com.maddox.il2.engine.Interpolate)this).actor).destroyChildFiltered(com.maddox.il2.objects.weapons.RocketGun.class);
            cutOp(35);
            // fall through
        ...
        case 3: // '\003'
            if(EI.engines.length <= 0)
                break;
            setCapableOfTaxiing(false);
            if(!(((com.maddox.il2.engine.Interpolate)this).actor instanceof com.maddox.il2.objects.air.Scheme1))
                setReadyToDie(true);
            EI.engines[0].setEngineDies(((com.maddox.il2.engine.Interpolate)this).actor);
        ...
        case 4: // '\004'
            if(EI.engines.length > 1)
            {
                setCapableOfTaxiing(false);
                setReadyToDie(true);
                EI.engines[1].setEngineDies(((com.maddox.il2.engine.Interpolate)this).actor);
        ...
        case 5: // '\005'
            if(EI.engines.length > 2)
            {
                setCapableOfTaxiing(false);
                setReadyToDie(true);
                EI.engines[2].setEngineDies(((com.maddox.il2.engine.Interpolate)this).actor);
        ...
        case 6: // '\006'
            if(EI.engines.length > 3)
            {
                setCapableOfTaxiing(false);
                setReadyToDie(true);
                EI.engines[3].setEngineDies(((com.maddox.il2.engine.Interpolate)this).actor);
    ...
    public static com.maddox.rts.SectFile sectFile(java.lang.String s)
    {
        ...
        try
        {
            java.lang.Object obj = com.maddox.rts.Property.value(((java.lang.Object) (s)), "stream", ((java.lang.Object) (null)));
            ...
            inputstream.mark(0);
            sectfile = new SectFile(new InputStreamReader(((java.io.InputStream) (new KryptoInputFilter(inputstream, com.maddox.il2.fm.FlightModelMain.getSwTbl(com.maddox.rts.Finger.Int(s1 + "ogh9"), inputstream.available())))), "Cp1252"));
            inputstream.reset();
            if(obj == null)
                com.maddox.rts.Property.set(((java.lang.Object) (s)), "stream", ((java.lang.Object) (inputstream)));
        }
    ...
    private static int[] getSwTbl(int i, int j)
    {
        ...
        for(int i1 = 0; i1 < k; i1++)
            ai[i1] = ((int) (com.maddox.rts.Finger.kTable[(l + i1) % com.maddox.rts.Finger.kTable.length]));
    ...
    public com.maddox.il2.fm.Supersonic Ss;
