...
public class KI_61_IKO extends KI_61
{
  ...
  {
    paramHierMesh.chunkSetAngles("GearC2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 0.9F, 0.0F, 72.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC5_D0", 0.0F, 0.0F, 0.0F);
    paramHierMesh.chunkSetAngles("GearC3_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 0.21F, 0.0F, 57.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC4_D0", 0.0F, Aircraft.cvt(paramFloat, 0.01F, 0.21F, 0.0F, -57.0F), 0.0F);
  ...
  static
  {
    ...
    Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalDev01", "_ExternalDev02" });

    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunHo103si 250", "MGunHo103si 250", "MGunBrowning303k_jap 500", "MGunBrowning303k_jap 500", null, null, null, null });

    Aircraft.weaponsRegister(localClass, "2x250", new String[] { "MGunHo103si 250", "MGunHo103si 250", "MGunBrowning303k_jap 500", "MGunBrowning303k_jap 500", "BombGun250kgJ 1", "BombGun250kgJ 1", null, null });

    Aircraft.weaponsRegister(localClass, "2x150dt", new String[] { "MGunHo103si 250", "MGunHo103si 250", "MGunBrowning303k_jap 500", "MGunBrowning303k_jap 500", null, null, "FuelTankGun_TankKi61Underwing", "FuelTankGun_TankKi61Underwing" });
