...
public class CockpitTemp5 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[2] = cvt(pictAiler, -1F, 1.0F, -0.027F, 0.027F);
        mesh.chunkSetLocate("Z_Shlang01", xyz, ypr);
        xyz[2] = -xyz[2];
        mesh.chunkSetLocate("Z_Shlang02", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.Or.getTangage(), -45F, 45F, 0.022F, -0.022F);
