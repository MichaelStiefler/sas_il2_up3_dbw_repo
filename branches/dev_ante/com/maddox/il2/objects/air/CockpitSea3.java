...
public class CockpitSea3 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("WingLMid_D0", 0.0F, -112.0F * f, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("WingLOut_D0", 0.0F, -112.0F * f, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("WingRMid_D0", 0.0F, -112.0F * f, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("WingROut_D0", 0.0F, -112.0F * f, 0.0F);
    ...
    f = this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getAileron();
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("AroneL_D0", 0.0F, -30.0F * f, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("AroneR_D0", 0.0F, -30.0F * f, 0.0F);
  ...
  protected void reflectPlaneToModel()
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("AroneL_D0", localHierMesh.isChunkVisible("AroneL_D0"));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("AroneL_D1", localHierMesh.isChunkVisible("AroneL_D1"));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("AroneR_D0", localHierMesh.isChunkVisible("AroneR_D0"));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("AroneR_D1", localHierMesh.isChunkVisible("AroneR_D1"));
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitSea3.this.setNew.throttle = (0.92F * CockpitSea3.this.setOld.throttle + 0.08F * CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitSea3.this.setNew.prop = (0.92F * CockpitSea3.this.setOld.prop + 0.08F * CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitSea3.this.setNew.mix = (0.92F * CockpitSea3.this.setOld.mix + 0.08F * CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitSea3.this.setNew.altimeter = CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitSea3.this.setNew.azimuth = (0.97F * CockpitSea3.this.setOld.azimuth + 0.03F * -CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw());
        }
        ...
        CockpitSea3.this.setNew.vspeed = (0.99F * CockpitSea3.this.setOld.vspeed + 0.01F * CockpitSea3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed());
      }
      return true;
    }
  }
