...
public class CockpitTBX1 extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				setOld = setNew;
				setNew = setTmp;
				setNew.throttle = 0.85F * setOld.throttle + fm.CT.PowerControl
						* 0.15F;
				setNew.prop = 0.85F * setOld.prop + fm.CT.getStepControl()
						* 0.15F;
	...
	public CockpitTBX1() {
		...
		pictManf = 1.0F;
		bNeedSetUp = true;
		cockpitNightMats = (new String[] { "aigtemp", "instru01", "instru01_D",
				"instru02", "instru02_D", "instru03", "instru03_D", "instru04",
				"instru04_D", "instru05", "instru05_D" });
		setNightMats(false);
	...
	public void reflectWorldToInstruments(float f) {
		...
		Cockpit.xyz[2] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F,
				0.06845F);
		Cockpit.ypr[2] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 1.0F);
		mesh.chunkSetLocate("Canopy", Cockpit.xyz, Cockpit.ypr);
		mesh.chunkSetAngles("Z_Trim1", 0.0F,
				722F * fm.CT.getTrimAileronControl(), 0.0F);
		mesh.chunkSetAngles("Z_Trim2", 0.0F,
				722F * fm.CT.getTrimRudderControl(), 0.0F);
		mesh.chunkSetAngles("Z_Trim3", 0.0F,
				722F * fm.CT.getTrimElevatorControl(), 0.0F);
		mesh.chunkSetAngles("Z_Flaps1", 0.0F, -37F
				* (pictFlap = 0.75F * pictFlap + 0.25F * fm.CT.FlapsControl),
				0.0F);
		mesh.chunkSetAngles("Z_Gear1", 0.0F, 46F * (pictGear = 0.8F * pictGear
				+ 0.2F * fm.CT.GearControl), 0.0F);
		mesh.chunkSetAngles("Z_Throtle1", 0.0F,
				51.8F * interp(setNew.throttle, setOld.throttle, f), 0.0F);
		mesh.chunkSetAngles("Z_Prop1", 0.0F,
				35F - 35F * interp(setNew.prop, setOld.prop, f), 0.0F);
		mesh.chunkSetAngles("Z_Mixture1", 0.0F,
				47F * fm.EI.engines[0].getControlMix(), 0.0F);
		mesh.chunkSetAngles("Z_Supercharger1", 0.0F, -15F
				* (float) fm.EI.engines[0].getControlCompressor(), 0.0F);
		...
		mesh.chunkSetAngles("Z_Columnbase", 0.0F, (pictAiler = 0.85F
				* pictAiler + 0.15F * fm.CT.AileronControl) * 8F, 0.0F);
		mesh.chunkSetAngles("Z_Column", 0.0F, 0.0F, (pictElev = 0.85F
				* pictElev + 0.15F * fm.CT.ElevatorControl) * 8F);
		...
		mesh.chunkSetAngles(
				...
				floatindex(
						cvt(Pitot.Indicator((float) fm.Loc.z, fm.getSpeedKMH()),
								0.0F, 796.3598F, 0.0F, 11F), speedometerScale),
				0.0F);
		w.set(fm.getW());
		fm.Or.transform(w);
		...
		mesh.chunkSetAngles("Z_TurnBank2", 0.0F,
				cvt(getBall(7D), -7F, 7F, -10F, 10F), 0.0F);
		...
		mesh.chunkSetAngles("Z_Compass1", 0.0F,
				-90F + setNew.waypointAzimuth.getDeg(f), 0.0F);
		...
		mesh.chunkSetAngles("Z_RPM1", 0.0F,
				cvt(fm.EI.engines[0].getRPM(), 0.0F, 10000F, 0.0F, 3600F), 0.0F);
		mesh.chunkSetAngles("Z_RPM2", 0.0F,
				cvt(fm.EI.engines[0].getRPM(), 0.0F, 10000F, 0.0F, 360F), 0.0F);
		mesh.chunkSetAngles("Z_Minute1", 0.0F,
				cvt(World.getTimeofDay(), 0.0F, 24F, 0.0F, 360F), 0.0F);
		mesh.chunkSetAngles("Z_Hour1", 0.0F,
				cvt(World.getTimeofDay() % 1.0F, 0.0F, 1.0F, 0.0F, 360F), 0.0F);
		mesh.chunkSetAngles("Z_Fuel1", 0.0F,
				cvt(fm.M.fuel, 0.0F, 600F, 0.0F, 300F), 0.0F);
		mesh.chunkSetAngles("Z_FuelPres1", 0.0F,
				cvt(fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 1.0F, 0.0F, 255F),
				0.0F);
		mesh.chunkSetAngles("Z_TankPres1", 0.0F,
				cvt(fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 1.0F, 0.0F, 255F),
				0.0F);
		mesh.chunkSetAngles("Z_HydPres1", 0.0F,
				fm.Gears.bIsHydroOperable ? 200F : 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Temp1", 0.0F,
				cvt(fm.EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 97.5F), 0.0F);
			...
			mesh.chunkSetAngles(
					...
					pictManf = 0.9F
							...
							* cvt(fm.EI.engines[0].getManifoldPressure(),
									0.3386378F, 2.539784F, 0.0F, 344.5F), 0.0F);
		mesh.chunkSetAngles("Z_Oil1", 0.0F,
				cvt(fm.EI.engines[0].tOilOut, 20F, 120F, 0.0F, 78F), 0.0F);
		mesh.chunkSetAngles(
				"Z_Oilpres1",
				0.0F,
				cvt(1.0F + 0.05F * fm.EI.engines[0].tOilOut
						* fm.EI.engines[0].getReadyness(), 0.0F, 7.45F, 0.0F,
						256F), 0.0F);
		resetYPRmodifier();
		if (fm.Gears.cgear)
		...
		mesh.chunkVisible("Z_WaterInjL1",
				fm.EI.engines[0].getControlAfterburner());
	...
	private static final float speedometerScale[] = { 0.0F, 15.5F, 77F, 175F,
			275F, 360F, 412F, 471F, 539F, 610.5F, 669.75F, 719F };
	private static final float variometerScale[] = { -175.5F, -160.5F, -145.5F,
			-128F, -100F, -65.5F, 0.0F, 65.5F, 100F, 128F, 145.5F, 160.5F,
			175.5F };
