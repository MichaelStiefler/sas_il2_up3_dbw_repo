  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_7.this.fm != null) {
        ...
        {
          CockpitLA_7.this.setNew.waypointAzimuth.setDeg(CockpitLA_7.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitLA_7.this.waypointAzimuth() - CockpitLA_7.this.fm.Or.azimut());
        }
