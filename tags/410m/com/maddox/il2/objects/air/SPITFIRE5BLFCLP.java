...
public class SPITFIRE5BLFCLP extends com.maddox.il2.objects.air.SPITFIRE5
{
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Spitfire-LF-Vb-M45M-18-CW.fmd");
        ...
        com.maddox.il2.objects.air.SPITFIRE5BLFCLP.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0, 1, 1
        });
        com.maddox.il2.objects.air.SPITFIRE5BLFCLP.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02"
        });
        com.maddox.il2.objects.air.SPITFIRE5BLFCLP.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SPITFIRE5BLFCLP.weaponsRegister(class1, "none", new java.lang.String[] {
