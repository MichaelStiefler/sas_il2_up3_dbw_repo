...
// Source File Name:   CockpitP2V5_Bombardier.java
...
public class CockpitP2V5_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.P2V5)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.P2V5)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.P2V5)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.P2V5)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (((java.lang.Object) (com.maddox.il2.objects.air.CockpitP2V5_Bombardier.class)))), "astatePilotIndx", 0);
    }
