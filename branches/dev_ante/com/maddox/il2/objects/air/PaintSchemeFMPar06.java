...
public class PaintSchemeFMPar06 extends PaintScheme
{
  ...
  public void prepareNum(Class paramClass, HierMesh paramHierMesh, Regiment paramRegiment, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramRegiment.country() == PaintScheme.countryGermany)
    {
      ...
      changeMat(paramHierMesh, "Overlay7", "balken3black", "German/balken3.tga", 0.0F, 0.0F, 0.0F);
      changeMat(paramHierMesh, "Overlay8", "haken3", "German/" + (World.cur().isHakenAllowed() ? "haken3.tga" : "hakenfake.tga"), 1.0F, 1.0F, 1.0F);
      if ((paramInt3 <= 1) && (paramInt1 == 0))
      {
        changeMat(paramHierMesh, "Overlay1", "psFM06GERCOML0000", "German/00c.tga", 1.0F, 1.0F, 1.0F);
        changeMat(paramHierMesh, "Overlay4", "psFM06GERCOMR0000", "German/00c2.tga", 1.0F, 1.0F, 1.0F);
        if ((k == 1) || (k == 5))
        {
          ...
          changeMat(paramHierMesh, "Overlay2", "psFM06GERCOMCGID" + k, "German/00cG" + k + ".tga", 1.0F, 1.0F, 1.0F);
          changeMat(paramHierMesh, "Overlay3", "psFM06GERCOMCGID" + k, "German/00cG" + k + ".tga", 1.0F, 1.0F, 1.0F);
        }
        return;
      }
      if (paramInt3 < 10)
      {
        changeMat(paramHierMesh, "Overlay1", "psFM06GERLNUM" + i + paramInt1 + "0" + paramInt3, "German/1" + j + paramInt3 % 10 + ".tga", 1.0F, 1.0F, 1.0F);
      ...
      if ((k == 1) || (k == 5))
      {
        ...
        changeMat(paramHierMesh, "Overlay2", "psFM06GERGRUPP" + k + "S" + j, "German/1" + j + "0G" + k + ".tga", 1.0F, 1.0F, 1.0F);
        changeMat(paramHierMesh, "Overlay3", "psFM06GERGRUPP" + k + "S" + j, "German/1" + j + "0G" + k + ".tga", 1.0F, 1.0F, 1.0F);
      }
      return;
    }
    if (paramRegiment.country() == PaintScheme.countryNetherlands)
    ...
    if (paramRegiment.country() == PaintScheme.countryFinland)
    {
      ...
      if (paramInt1 == 3) {
        changeMat(paramHierMesh, "Overlay8", "psFM06FINCNUM" + i + paramInt1 + "_" + (char)(65 + (paramInt3 % 10 - 1)), "Finnish/" + (char)(65 + (paramInt3 % 10 - 1)) + ".tga", PaintScheme.psFinnishFighterColor[paramInt1][0], PaintScheme.psFinnishFighterColor[paramInt1][1], PaintScheme.psFinnishFighterColor[paramInt1][2]);
      }
      else if (paramInt3 < 10)
        changeMat(paramHierMesh, "Overlay8", "psFM06FINCNUM" + i + paramInt1 + "0" + paramInt3, "Finnish/0" + paramInt3 + ".tga", PaintScheme.psFinnishFighterColor[paramInt1][0], PaintScheme.psFinnishFighterColor[paramInt1][1], PaintScheme.psFinnishFighterColor[paramInt1][2]);
      else
        changeMat(paramHierMesh, "Overlay8", "psFM06FINCNUM" + i + paramInt1 + paramInt3, "Finnish/" + paramInt3 / 10 + ".tga", "Finnish/" + paramInt3 % 10 + ".tga", PaintScheme.psFinnishFighterColor[paramInt1][0], PaintScheme.psFinnishFighterColor[paramInt1][1], PaintScheme.psFinnishFighterColor[paramInt1][2], PaintScheme.psFinnishFighterColor[paramInt1][0], PaintScheme.psFinnishFighterColor[paramInt1][1], PaintScheme.psFinnishFighterColor[paramInt1][2]);
    ...
    if (paramRegiment.country() == PaintScheme.countryFrance)
    {
      if (paramInt3 < 10)
      {
        changeMat(paramHierMesh, "Overlay2", "psFM06FRALNUM" + i + paramInt1 + paramInt3, "Finnish/" + paramInt3 % 10 + ".tga", 1.0F, 1.0F, 1.0F);
    ...
    if (paramRegiment.country() == PaintScheme.countryBritain)
    {
      ...
      {
        paramInt3 = clampToLiteral(paramInt3);
        changeMat(paramHierMesh, "Overlay1", "psFM06BRINAVYREGI" + paramRegiment.id(), "British/" + paramRegiment.aid()[0] + ".tga", "British/" + paramRegiment.aid()[1] + ".tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
        changeMat(paramHierMesh, "Overlay3", "psFM06BRINAVYREGI" + paramRegiment.id(), "British/" + paramRegiment.aid()[0] + ".tga", "British/" + paramRegiment.aid()[1] + ".tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
        changeMat(paramHierMesh, "Overlay2", "psFM06BRINAVYLNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "British/" + (char)(65 + paramInt3 - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
        changeMat(paramHierMesh, "Overlay4", "psFM06BRINAVYRNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "null.tga", "British/" + (char)(65 + paramInt3 - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
        ...
        paramInt3 = clampToLiteral(paramInt3);
        changeMat(paramHierMesh, "Overlay1", "psFM06BRIREGI" + paramRegiment.id(), "British/" + paramRegiment.aid()[0] + ".tga", "British/" + paramRegiment.aid()[1] + ".tga", PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2], PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2]);
        changeMat(paramHierMesh, "Overlay3", "psFM06BRIREGI" + paramRegiment.id(), "British/" + paramRegiment.aid()[0] + ".tga", "British/" + paramRegiment.aid()[1] + ".tga", PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2], PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2]);
        changeMat(paramHierMesh, "Overlay2", "psFM06BRILNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "British/" + (char)(65 + paramInt3 - 1) + ".tga", "null.tga", PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2], 1.0F, 1.0F, 1.0F);
        changeMat(paramHierMesh, "Overlay4", "psFM06BRIRNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "null.tga", "British/" + (char)(65 + paramInt3 - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2]);
    ...
    if (paramRegiment.country() == PaintScheme.countryCroatia)
    {
      ...
      changeMat(paramHierMesh, "Overlay2", "psBM00HUNCNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "German/" + paramInt3 / 10 + ".tga", "German/" + paramInt3 % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
      changeMat(paramHierMesh, "Overlay4", "psBM00HUNCNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "German/" + paramInt3 / 10 + ".tga", "German/" + paramInt3 % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
      changeMat(paramHierMesh, "Overlay6", "Croatia", "Croatia/balken.tga", 1.0F, 1.0F, 1.0F);
      changeMat(paramHierMesh, "Overlay7", "Croatia", "Croatia/balken.tga", 1.0F, 1.0F, 1.0F);
    ...
    if (paramRegiment.country() == PaintScheme.countryItaly)
    {
      if (paramInt3 < 10)
      {
        changeMat(paramHierMesh, "Overlay2", "psFM06ITALNUM" + i + paramInt1 + paramInt3, "Russian/1" + paramInt3 % 10 + ".tga", 1.0F, 1.0F, 1.0F);
    ...
    {
      paramInt3 = clampToLiteral(paramInt3);
      changeMat(paramHierMesh, "Overlay1", "psFM00RZLNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "British/" + (char)(65 + paramInt3 - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
      changeMat(paramHierMesh, "Overlay4", "psFM00RZRNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "null.tga", "British/" + (char)(65 + paramInt3 - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
    ...
    if (paramRegiment.country() == PaintScheme.countrySlovakia)
    {
      if (paramInt3 < 10)
      {
        changeMat(paramHierMesh, "Overlay4", "psFM06SLVKLNUM" + i + paramInt1 + "0" + paramInt3, "Slovakian/" + paramInt3 + ".tga", 1.0F, 1.0F, 1.0F);
