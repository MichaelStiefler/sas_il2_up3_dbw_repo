...
public class CockpitJU_88A4_RGunnerTorp extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zTurret3A", 0.0F, -f1, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zTurret3B", 0.0F, f2, 0.0F);
    if (f1 > 10.0F)
      f1 = 10.0F;
    if (f1 < -25.0F)
      f1 = -25.0F;
  ...
  public CockpitJU_88A4_RGunnerTorp()
  {
    super("3DO/Cockpit/Ju-88A-4-RGun/torphier.him", "he111");
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitJU_88A4_RGunnerTorp.access$002(CockpitJU_88A4_RGunnerTorp.this, CockpitJU_88A4_RGunnerTorp.this.setOld);
        CockpitJU_88A4_RGunnerTorp.access$102(CockpitJU_88A4_RGunnerTorp.this, CockpitJU_88A4_RGunnerTorp.this.setNew);
        CockpitJU_88A4_RGunnerTorp.access$202(CockpitJU_88A4_RGunnerTorp.this, CockpitJU_88A4_RGunnerTorp.this.setTmp);
        CockpitJU_88A4_RGunnerTorp.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_RGunnerTorp.this.setOld.throttle1 + CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_RGunnerTorp.this.setNew.prop1 = (0.85F * CockpitJU_88A4_RGunnerTorp.this.setOld.prop1 + CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitJU_88A4_RGunnerTorp.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_RGunnerTorp.this.setOld.throttle2 + CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_RGunnerTorp.this.setNew.prop2 = (0.85F * CockpitJU_88A4_RGunnerTorp.this.setOld.prop2 + CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitJU_88A4_RGunnerTorp.this.setNew.altimeter = CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f1 = CockpitJU_88A4_RGunnerTorp.this.waypointAzimuth();
        CockpitJU_88A4_RGunnerTorp.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4_RGunnerTorp.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A4_RGunnerTorp.this.setOld.azimuth.getDeg(1.0F));
        CockpitJU_88A4_RGunnerTorp.this.setNew.azimuth.setDeg(CockpitJU_88A4_RGunnerTorp.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitJU_88A4_RGunnerTorp.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_RGunnerTorp.this.setOld.vspeed + CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f2 = CockpitJU_88A4_RGunnerTorp.this.prevFuel - CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel;
        CockpitJU_88A4_RGunnerTorp.access$302(CockpitJU_88A4_RGunnerTorp.this, CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A4_RGunnerTorp.this.setNew.cons = (0.91F * CockpitJU_88A4_RGunnerTorp.this.setOld.cons + 0.09F * f2);
        if (CockpitJU_88A4_RGunnerTorp.this.buzzerFX != null)
          if ((CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < ((JU_88A4torp)CockpitJU_88A4_RGunnerTorp.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4torp)CockpitJU_88A4_RGunnerTorp.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1)) {
            CockpitJU_88A4_RGunnerTorp.this.buzzerFX.play();
          }
          else if (CockpitJU_88A4_RGunnerTorp.this.buzzerFX.isPlaying())
            CockpitJU_88A4_RGunnerTorp.this.buzzerFX.stop();
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float cons;
    private final CockpitJU_88A4_RGunnerTorp this$0;
    ...
    Variables(CockpitJU_88A4_RGunnerTorp.1 arg2)
    {
      this();
    }
  }
