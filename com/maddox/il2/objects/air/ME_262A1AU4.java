...
//            ME_262, PaintSchemeFMPar05, TypeStormovik, NetAircraft
    ...
    implements com.maddox.il2.objects.air.TypeStormovik
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC5_D0", 0.0F, com.maddox.il2.objects.air.ME_262A1AU4.cvt(f, 0.01F, 0.11F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearC6_D0", 0.0F, com.maddox.il2.objects.air.ME_262A1AU4.cvt(f, 0.01F, 0.11F, 0.0F, -90F), 0.0F);
    ...
    public void moveWheelSink()
    {
        ...
        xyz[1] = com.maddox.il2.objects.air.ME_262A1AU4.cvt(f, 0.0F, 0.19F, 0.0F, 0.19F);
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.ME_262A1AU4.weaponTriggersRegister(class1, new int[] {
            1
        });
        com.maddox.il2.objects.air.ME_262A1AU4.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01"
        });
        com.maddox.il2.objects.air.ME_262A1AU4.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMK214A 28"
        });
        com.maddox.il2.objects.air.ME_262A1AU4.weaponsRegister(class1, "none", new java.lang.String[] {
            null
        });
    }
}
