...
public class CockpitBF_109K4 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPress1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3.0F, 0.0F, 120.0F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitBF_109K4.access$102(CockpitBF_109K4.this, CockpitBF_109K4.this.setOld); CockpitBF_109K4.access$202(CockpitBF_109K4.this, CockpitBF_109K4.this.setNew); CockpitBF_109K4.access$302(CockpitBF_109K4.this, CockpitBF_109K4.this.setTmp);
      ...
      CockpitBF_109K4.this.setNew.throttle = ((10.0F * CockpitBF_109K4.this.setOld.throttle + CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109K4.this.setNew.mix = ((8.0F * CockpitBF_109K4.this.setOld.mix + CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109K4.this.setNew.azimuth = CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109K4.this.setOld.azimuth > 270.0F) && (CockpitBF_109K4.this.setNew.azimuth < 90.0F)) CockpitBF_109K4.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_109K4.this.setOld.azimuth < 90.0F) && (CockpitBF_109K4.this.setNew.azimuth > 270.0F)) CockpitBF_109K4.this.setOld.azimuth += 360.0F;
      CockpitBF_109K4.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_109K4.this.setOld.waypointAzimuth + (CockpitBF_109K4.this.waypointAzimuth() - CockpitBF_109K4.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

      CockpitBF_109K4.this.setNew.vspeed = ((199.0F * CockpitBF_109K4.this.setOld.vspeed + CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitBF_109K4.1 arg2) { this();
    }
  }
}