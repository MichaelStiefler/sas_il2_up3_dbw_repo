    ...
    implements TypeFighter, TypeBNZFighter, TypeStormovik
{
        ...
        if((double)((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getCockpitDoor() > 0.20000000000000001D && bHasBlister && super.FM.getSpeedKMH() > fMaxKMHSpeedForOpenCanopy && hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
                if(this == com.maddox.il2.ai.World.getPlayerAircraft())
                    ((CockpitBF_109K4)com.maddox.il2.game.Main3D.cur3D().cockpitCur).removeCanopy();
            }
    ...
    static 
    {
        java.lang.Class class1 = BF_109K14.class;
        ...
        Aircraft.weaponsRegister(class1, "1xMG151", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMG15120MGki 200", "MGunMK108ki 57", "MGunMK108ki 57", null, null, null, null, null, 
            null
        });
        Aircraft.weaponsRegister(class1, "1xMK108", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 67", "MGunMK108ki 57", "MGunMK108ki 57", null, null, null, null, null, 
            null
        });
