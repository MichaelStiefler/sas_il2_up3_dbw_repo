...
public class MissileKS1 extends Missile
{
  static
  {
...
//    Property.set(class1, "smoke", "3DO/Effects/Aircraft/BlackHeavyTSPD.eff");
//    Property.set(class1, "sprite", "3do/Effects/RocketKS1/RocketKS1SpriteBlack.eff");
    ...
    Property.set(class1, "warmupTime", 5000.0F); // Rocket Engine Warmup Time before release
    Property.set(class1, "dragCoefficient", 0.5F); // Aerodynamic Drag Coefficient
    Property.set(class1, "powerType", 0);
    Property.set(class1, "power", 101.5F); // RL Data: 1015kg HE warhead, for realism reduced to 1/10th of it's RL weight
