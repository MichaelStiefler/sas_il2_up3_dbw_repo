...
public class CAC_Sabre_Mk31 extends com.maddox.il2.objects.air.F_86F
    implements com.maddox.il2.objects.air.TypeGuidedMissileCarrier, com.maddox.il2.objects.air.TypeCountermeasure, com.maddox.il2.objects.air.TypeThreatDetector, com.maddox.il2.objects.air.TypeGSuit
{
    ...
    public void engineSurge(float f)
    {
        if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.isMaster())
            ...
            } else
            {
                ...
                if(curthrl < 1.05F)
                {
                    if((curthrl - oldthrl) / f > 10F && ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getRPM() < 3200F && ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getStage() == 6 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.4F)
                    {
                        ...
                        engineSurgeDamage += ((float) (0.01D * (double)(((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getRPM() / 1000F)));
                        ...
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.05F && (super.FM instanceof com.maddox.il2.fm.RealFlightModel) && ((com.maddox.il2.fm.RealFlightModel)super.FM).isRealMode())
                            ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 0, 100);
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.05F && (super.FM instanceof com.maddox.il2.fm.RealFlightModel) && ((com.maddox.il2.fm.RealFlightModel)super.FM).isRealMode())
                            ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].setEngineDies(((com.maddox.il2.engine.Actor) (this)));
                    }
                    if((curthrl - oldthrl) / f < -10F && (curthrl - oldthrl) / f > -100F && ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getRPM() < 3200F && ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getStage() == 6)
                    {
                        super.playSound("weapon.MGunMk108s", true);
                        engineSurgeDamage += ((float) (0.001D * (double)(((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getRPM() / 1000F)));
                        ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].doSetReadyness(((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getReadyness() - engineSurgeDamage);
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.4F && (super.FM instanceof com.maddox.il2.fm.RealFlightModel) && ((com.maddox.il2.fm.RealFlightModel)super.FM).isRealMode())
                        {
                            ...
                            ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].setEngineStops(((com.maddox.il2.engine.Actor) (this)));
                        } else
                        if(((com.maddox.il2.engine.Interpolate) (super.FM)).actor == com.maddox.il2.ai.World.getPlayerAircraft())
                            com.maddox.il2.game.HUD.log("Compressor Stall!");
                    }
        ...
        if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.WeaponControl[1] && ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getStage() == 6 && ((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.Weapons[0][0].countBullets() != 0 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.005F)
        {
            super.playSound("weapon.MGunMk108s", true);
            engineSurgeDamage += ((float) (0.001D * (double)(((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getRPM() / 1000F)));
            ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].doSetReadyness(((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getReadyness() - engineSurgeDamage);
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "iconFar_shortClassName", "CAC_Sabre");
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName_gb", "3DO/Plane/CAC_Sabre_Mk32(Multi1)/hier.him");
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "PaintScheme_gb", ((java.lang.Object) (new PaintSchemeFMPar1956())));
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", "3DO/Plane/CAC_Sabre_Mk32(Multi1)/hier.him");
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "FlightModel", "FlightModels/CAC_Sabre_Mk31.fmd");
        try
        {
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "16xRP3", new java.lang.String[] {
            "MGunADEN30ki 150", "MGunADEN30ki 150", null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "8xRP3+2x200dt", new java.lang.String[] {
            "MGunADEN30ki 150", "MGunADEN30ki 150", "PylonF86_Outboard 1", "PylonF86_Outboard 1", "FuelTankGun_200galL 1", "FuelTankGun_200galR 1", null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "24xSURA_D_HE", new java.lang.String[] {
            "MGunADEN30ki 150", "MGunADEN30ki 150", null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "24xSURA_D_AP", new java.lang.String[] {
            "MGunADEN30ki 150", "MGunADEN30ki 150", null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "2xAIM9B", new java.lang.String[] {
            "MGunADEN30ki 150", "MGunADEN30ki 150", null, null, null, null, null, null, null, null, 
            null, null, "PylonF86_Sidewinder 1", "RocketGunAIM9B 1", "BombGunNull 1", "PylonF86_Sidewinder 1", "RocketGunAIM9B 1", "BombGunNull 1", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
