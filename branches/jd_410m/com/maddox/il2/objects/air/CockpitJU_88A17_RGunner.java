...
public class CockpitJU_88A17_RGunner extends CockpitGunner
{
  ...
  public CockpitJU_88A17_RGunner() {
    super("3DO/Cockpit/Ju-88A-4-RGun/A17hier.him", "he111");
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float cons;
    private final CockpitJU_88A17_RGunner this$0;
    ...
    Variables(CockpitJU_88A17_RGunner.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A17_RGunner.this.fm != null) {
        CockpitJU_88A17_RGunner.access$102(CockpitJU_88A17_RGunner.this, CockpitJU_88A17_RGunner.this.setOld);
        CockpitJU_88A17_RGunner.access$202(CockpitJU_88A17_RGunner.this, CockpitJU_88A17_RGunner.this.setNew);
        CockpitJU_88A17_RGunner.access$302(CockpitJU_88A17_RGunner.this, CockpitJU_88A17_RGunner.this.setTmp);
        CockpitJU_88A17_RGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A17_RGunner.this.setOld.throttle1 + CockpitJU_88A17_RGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F);

        CockpitJU_88A17_RGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A17_RGunner.this.setOld.prop1 + CockpitJU_88A17_RGunner.this.fm.EI.engines[0].getControlProp() * 0.15F);

        CockpitJU_88A17_RGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A17_RGunner.this.setOld.throttle2 + CockpitJU_88A17_RGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F);

        CockpitJU_88A17_RGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A17_RGunner.this.setOld.prop2 + CockpitJU_88A17_RGunner.this.fm.EI.engines[1].getControlProp() * 0.15F);

        CockpitJU_88A17_RGunner.this.setNew.altimeter = CockpitJU_88A17_RGunner.this.fm.getAltitude();
        float f1 = CockpitJU_88A17_RGunner.this.waypointAzimuth();
        if (CockpitJU_88A17_RGunner.this.useRealisticNavigationInstruments())
        {
          CockpitJU_88A17_RGunner.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A17_RGunner.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A17_RGunner.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A17_RGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A17_RGunner.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A17_RGunner.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
          CockpitJU_88A17_RGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A17_RGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A17_RGunner.this.setOld.azimuth.getDeg(1.0F));
        }
        CockpitJU_88A17_RGunner.this.setNew.azimuth.setDeg(CockpitJU_88A17_RGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A17_RGunner.this.fm.Or.azimut());

        CockpitJU_88A17_RGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A17_RGunner.this.setOld.vspeed + CockpitJU_88A17_RGunner.this.fm.getVertSpeed()) / 200.0F);

        if (CockpitJU_88A17_RGunner.this.cockpitDimControl)
        {
          if (CockpitJU_88A17_RGunner.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A17_RGunner.this.setNew.dimPosition -= 0.05F;
        }
        else if (CockpitJU_88A17_RGunner.this.setNew.dimPosition < 1.0F)
          CockpitJU_88A17_RGunner.this.setNew.dimPosition += 0.05F;
        float f2 = CockpitJU_88A17_RGunner.this.prevFuel - CockpitJU_88A17_RGunner.this.fm.M.fuel;
        CockpitJU_88A17_RGunner.access$402(CockpitJU_88A17_RGunner.this, CockpitJU_88A17_RGunner.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A17_RGunner.this.setNew.cons = (0.91F * CockpitJU_88A17_RGunner.this.setOld.cons + 0.09F * f2);
      }
