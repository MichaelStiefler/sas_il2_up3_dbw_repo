...
public class BF_109G2 extends BF_109
{
        ...
        if((double)((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getCockpitDoor() > 0.20000000000000001D && bHasBlister && super.FM.getSpeedKMH() > fMaxKMHSpeedForOpenCanopy && hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
                if(this == com.maddox.il2.ai.World.getPlayerAircraft())
                    ((CockpitBF_109G2)com.maddox.il2.game.Main3D.cur3D().cockpitCur).removeCanopy();
            }
    ...
    static 
    {
        java.lang.Class class1 = BF_109G2.class;
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Bf-109G-2trop.fmd");
        ...
        Aircraft.weaponsRegister(class1, "R1-2XDROPTANK", new java.lang.String[] {
            "MGunMG17si 500", "MGunMG17si 500", null, "MGunMG15120MGki 200", null, null, null, null, null, null, 
            null, null, null, null, null, null, null, "FuelTankGun_Type_D 1", "FuelTankGun_Type_D 1", null
        });
        Aircraft.weaponsRegister(class1, "R1-2XDROPTANK_SC500", new java.lang.String[] {
            "MGunMG17si 500", "MGunMG17si 500", null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900 1", null, 
        ...
        Aircraft.weaponsRegister(class1, "R2-RECON-2xDROPTANK", new java.lang.String[] {
            "MGunMG17si 500", "MGunMG17si 500", null, "MGunMG15120MGki 200", null, null, null, null, null, null, 
