    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    {
        com.maddox.il2.objects.air.CAR.moveGear(((com.maddox.il2.engine.ActorHMesh)this).hierMesh(), f);
    }

    protected void moveRudder(float f)
    {
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("Rudder1_D0", 0.0F, -31F * f, 0.0F);
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearC2", 0.0F, 0.0F, 40F * f);
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearC1", 0.0F, 0.0F, 40F * f);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xxtank"))
        {
            ...
            case 1: // '\001'
                if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(0.2F, shot) > 0.0F && ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.5F)
                {
                    ...
                    if(shot.powerType == 3 && ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.9F || ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.03F)
                    {
                    ...
                    {
                        ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitTank(shot.initiator, 2, 99);
            ...
            case 2: // '\002'
                if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.2F, shot) <= 0.0F || ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() >= 0.25F)
                    break;
                if(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.astateTankStates[1] == 0)
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Fuel Tank: Pierced..");
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitTank(shot.initiator, 1, 1);
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.doSetTankState(shot.initiator, 1, 1);
                } else
                if(shot.powerType == 3 && ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.8F || ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.03F)
                {
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitTank(shot.initiator, 1, 2);
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Fuel Tank: Hit..");
                }
                if(shot.power > 200000F)
                {
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitTank(shot.initiator, 1, 99);
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Fuel Tank: Major Hit..");
                }
                break;
            ...
            case 3: // '\003'
                if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.2F, shot) <= 0.0F || ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() >= 0.25F)
                    break;
                if(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.astateTankStates[0] == 0)
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Fuel Tank: Pierced..");
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitTank(shot.initiator, 0, 1);
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.doSetTankState(shot.initiator, 0, 1);
                } else
                if(shot.powerType == 3 && ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.8F || ((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.03F)
                {
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitTank(shot.initiator, 0, 2);
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Fuel Tank: Hit..");
                }
                if(shot.power > 200000F)
                {
                    ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitTank(shot.initiator, 0, 99);
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Fuel Tank: Major Hit..");
                }
                break;
            }
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        if(shot.chunkName.startsWith("CF"))
        {
            if(com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.3F)
                ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitEngine(shot.initiator, 0, 1);
            if(((java.util.Random) (com.maddox.il2.ai.World.Rnd())).nextFloat() < 0.03F)
        ...
        if(shot.chunkName.startsWith("Pilot"))
        {
            if((double)shot.power * java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (com.maddox.il2.objects.air.Aircraft.v1)).x) > 12070D)
                ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).AS.hitPilot(shot.initiator, 0, (int)(shot.mass * 1000F * 0.5F));
