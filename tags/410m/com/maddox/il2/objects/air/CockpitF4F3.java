...
// Source File Name:   CockpitF4F3.java
...
//            CockpitPilot, F4F, Aircraft, AircraftLH, 
//            PaintScheme

public class CockpitF4F3 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.69F);
        mesh.chunkSetLocate("Canopy", xyz, ypr);
        mesh.chunkSetLocate("XGlassDamage2", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[1] = 0.065F * setNew.prop;
        mesh.chunkSetLocate("Z_Prop1", xyz, ypr);
        ...
        mesh.chunkSetAngles("Z_Speedometer1", 0.0F, floatindex(cvt(com.maddox.il2.fm.Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 692.018F, 0.0F, 11F), speedometerScale), 0.0F);
        w.set(fm.getW());
        fm.Or.transform(w);
        ...
        resetYPRmodifier();
        xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, -0.0285F, 0.0285F);
        ...
        resetYPRmodifier();
        xyz[1] = 0.0301F * fm.CT.getGear();
        mesh.chunkSetLocate("Z_GearInd1", xyz, ypr);
        resetYPRmodifier();
        if(fm.Gears.bTailwheelLocked)
            xyz[1] = -0.05955F;
        mesh.chunkSetLocate("Z_TWheel_Lock", xyz, ypr);
    }
    ...
    protected void reflectPlaneMats()
    {
        ...
        if(com.maddox.il2.objects.air.PaintScheme.countryUSA.equals(aircraft().getRegiment().country()))
        {
            com.maddox.il2.engine.Mat mat1 = hiermesh.material(hiermesh.materialFind("Overlay1"));
            mesh.materialReplace("Overlay1", mat1);
            mat1 = hiermesh.material(hiermesh.materialFind("OverlayD1o"));
            mesh.materialReplace("OverlayD1o", mat1);
            mat1 = hiermesh.material(hiermesh.materialFind("OverlayD2o"));
            mesh.materialReplace("OverlayD2o", mat1);
        }
    }
