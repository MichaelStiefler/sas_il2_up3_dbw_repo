...
//            Scheme1, PaintSchemeFMPar01, TypeFighter, NetAircraft, 
//            PaintScheme

public class BI_1 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    {
        com.maddox.il2.objects.air.BI_1.moveGear(hierMesh(), f);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 5: // '\005'
                    if(getEnergyPastArmor(1.5F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.45F)
                    {
    ...
    protected boolean cutFM(int i, int j, com.maddox.il2.engine.Actor actor)
    {
        ...
        case 19: // '\023'
            ...
            return cut(com.maddox.il2.objects.air.BI_1.partNames()[i]);
        }
    ...
    public void update(float f)
    {
        ...
        {
            v.x = v.z = 0.0D;
            v.y = com.maddox.il2.objects.air.BI_1.cvt(com.maddox.il2.fm.Pitot.Indicator((float)FM.Loc.z, FM.getSpeedKMH()), 750F, 950F, 0.0F, 400000F);
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.BI_1.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "BI-1");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/BI-1/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/BI-1.fmd");
        com.maddox.rts.Property.set(class1, "cockpitClass", com.maddox.il2.objects.air.CockpitBI_1.class);
        com.maddox.rts.Property.set(class1, "LOSElevation", 0.87325F);
        com.maddox.il2.objects.air.BI_1.weaponTriggersRegister(class1, new int[] {
            0, 0
        });
        com.maddox.il2.objects.air.BI_1.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02"
        });
        com.maddox.il2.objects.air.BI_1.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShVAKki 45", "MGunShVAKki 45"
        });
        com.maddox.il2.objects.air.BI_1.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
