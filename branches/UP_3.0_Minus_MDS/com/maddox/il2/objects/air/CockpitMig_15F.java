...
public class CockpitMig_15F extends com.maddox.il2.objects.air.CockpitPilot
{
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(setNew.stbyPosition3 < 1.0F)
                    setNew.stbyPosition3 = setOld.stbyPosition3 + 0.005F;
                float f = ((com.maddox.il2.objects.air.Mig_15F)aircraft()).k14Distance;
                setNew.k14w = (5F * com.maddox.il2.objects.air.CockpitMig_15F.k14TargetWingspanScale[((com.maddox.il2.objects.air.Mig_15F)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * com.maddox.il2.objects.air.CockpitMig_15F.k14TargetMarkScale[((com.maddox.il2.objects.air.Mig_15F)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((com.maddox.il2.objects.air.Mig_15F)aircraft()).k14Mode;
                ...
                float f_2_ = floatindex((f - 200F) * 0.04F, com.maddox.il2.objects.air.CockpitMig_15F.k14BulletDrop) - com.maddox.il2.objects.air.CockpitMig_15F.k14BulletDrop[0];
    ...
    {
        return ((com.maddox.il2.objects.air.Mig_15F)((com.maddox.il2.objects.air.Cockpit)this).aircraft()).calculateMach();
    }

    public void reflectWorldToInstruments(float f)
    {
        com.maddox.il2.objects.air.Mig_15F Mig_15F = (com.maddox.il2.objects.air.Mig_15F)((com.maddox.il2.objects.air.Cockpit)this).aircraft();
        if(com.maddox.il2.objects.air.Mig_15F.bChangedPit)
        {
            com.maddox.il2.objects.air.Mig_15F Mig_15F_3_ = (com.maddox.il2.objects.air.Mig_15F)((com.maddox.il2.objects.air.Cockpit)this).aircraft();
        ...
        {
            int i = ((com.maddox.il2.objects.air.Mig_15F)((com.maddox.il2.objects.air.Cockpit)this).aircraft()).k14Mode;
            boolean bool = i < 2;
        ...
        if(((com.maddox.il2.objects.air.Mig_15F)((com.maddox.il2.objects.air.Cockpit)this).aircraft()).k14Mode == 2)
        {
