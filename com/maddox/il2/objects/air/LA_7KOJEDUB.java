  ...
  implements TypeAcePlane
{
  ...
  static
  {
    ...
    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunShVAKANTIMATTERs 340", "MGunShVAKANTIMATTERs 340", null, null, null, null });

    Aircraft.weaponsRegister(localClass, "2xFAB50", new String[] { "MGunShVAKANTIMATTERs 340", "MGunShVAKANTIMATTERs 340", "BombGunFAB50 1", "BombGunFAB50 1", null, null });

    Aircraft.weaponsRegister(localClass, "2xFAB100", new String[] { "MGunShVAKANTIMATTERs 340", "MGunShVAKANTIMATTERs 340", "BombGunFAB100 1", "BombGunFAB100 1", null, null });

    Aircraft.weaponsRegister(localClass, "2xDROPTANK", new String[] { "MGunShVAKANTIMATTERs 340", "MGunShVAKANTIMATTERs 340", null, null, "FuelTankGun_Tank80", "FuelTankGun_Tank80" });
