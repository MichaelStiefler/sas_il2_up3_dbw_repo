...
public class Cockpit_BombsightOPB extends CockpitPilot
{
  ...
  public Cockpit_BombsightOPB()
  {
    super("3DO/Cockpit/Pe-2-Bombardier/OPB.him", "he111");
    this.bEntered = false;
    try
    {
  ...
  {
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zMark1", BombsightOPB.fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
    float f = cvt(BombsightOPB.fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);

    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zMark2", f * 3.675F, 0.0F, 0.0F);
    resetYPRmodifier();
    Cockpit.xyz[0] = cvt(-this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren(), -13.0F, 13.0F, -0.23F, 0.23F);
    Cockpit.xyz[1] = cvt(-this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getTangage(), -13.0F, 13.0F, 0.23F, -0.23F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (Cockpit_BombsightOPB.this.bEntered)
      {
        float f1 = BombsightOPB.fSightCurForwardAngle;
        float f2 = BombsightOPB.fSightCurSideslip;

        Cockpit_BombsightOPB.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, Cockpit_BombsightOPB.this.tAim + f1, 0.0F);
      }
      return true;
    }
