...
public class CmdMusic extends Cmd
{
  ...
  {
    if ((fileName != null) && (paramString != null) && 
      (fileName.compareToIgnoreCase(paramString) == 0)) return;
    ...
    if (fileName == null) {
      ...
      if (musFX != null)
      {
        ...
        musFX.add(curMusic);
        musFX.play();
        if (prevMusic != null) prevMusic.stop();
        bPlaying = true;
        apply();
      }
    }
  ...
  public static boolean isPathEnabled(String paramString)
  {
    ...
    if (paramString == null)
      return true;
    if (paramString.compareToIgnoreCase("music/takeoff") == 0) i = 0;
    else if (paramString.compareToIgnoreCase("music/inflight") == 0) i = 1;
    else if (paramString.compareToIgnoreCase("music/crash") == 0) i = 2;
    else
      return true;
  ...
  public static void setPath(String paramString, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (pathRandName != null) && 
      (paramString.compareToIgnoreCase(pathRandName) == 0)) return;
  ...
  public static void push()
  {
    ...
    if (bList)
      ...
      localPlayInfo = new PlayInfo(pathRandName == null ? fileName : pathRandName, pathRandName != null);
  ...
  {
    PlayInfo localPlayInfo = null;
    if (stack.empty()) System.out.println("ERROR: stack is empty."); else
  ...
  public Object exec(CmdEnv paramCmdEnv, Map paramMap)
  {
    ...
    if (paramMap.isEmpty()) {
      ...
      if (paramMap.containsKey("BREAK")) cancel();
      if (paramMap.containsKey("PUSH")) push();
      ...
      if (paramMap.containsKey("VOL")) {
        ...
        if (str == null) { System.out.println("ERROR: volume gain (0..1) expected");
          ...
          if ((f < 0.0F) || (f > 1.0F)) System.out.println("ERROR: value must be between 0.0 - 1.0"); else
            setVolume(f);
        }
      }
    }
    ...
    implements FileFilter
  {
    ...
    {
      if ((!paramFile.isFile()) || (paramFile.isHidden())) return false;
      String str1 = paramFile.getName();
      if (str1 == null) return false;
      int i = str1.length();
      if (i < 5) return false;
      String str2 = str1.substring(i - 3);
      if ((str2.compareToIgnoreCase("wav") != 0) && (str2.compareToIgnoreCase("mp3") != 0)) return false;
