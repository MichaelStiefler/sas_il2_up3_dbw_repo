...
public class P_38F1LO extends P_38mod
{
  static Class _mthclass$(String paramString)
  {
    ...
    return localClass; } 
  static { Class localClass = P_38F1LO.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "P-38");
    Property.set(localClass, "meshNameDemo", "3DO/Plane/P-38F-1-LO(USA)/hier.him");
    Property.set(localClass, "meshName", "3DO/Plane/P-38F-1-LO(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());
    Property.set(localClass, "meshName_us", "3DO/Plane/P-38F-1-LO(USA)/hier.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/P-38F-1-LO.fmd");

    Property.set(localClass, "cockpitClass", new Class[] { CockpitP_38F1LO.class });
    ...
    {
      System.out.println("Error P38F-1-LO Weapons 'default ' NOT initialized:" + localException1.getMessage());
    }
    ...
    {
      System.out.println("Error P38F-1-LO Weapons 'droptanks ' NOT initialized:" + localException2.getMessage());
    }
    ...
    {
      System.out.println("Error P38F-1-LO Weapons '1xdroptank1x500 ' NOT initialized:" + localException3.getMessage());
    }
    ...
    {
      System.out.println("Error P38F-1-LO Weapons '1xdroptank1x1000 ' NOT initialized:" + localException4.getMessage());
    }
    ...
    try
    {
      ...
      arrayOf_WeaponSlot = new Aircraft._WeaponSlot[i];
      arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(0, "MGunBrowning50kAPIT", 500);
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(0, "MGunBrowning50APIT", 500);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(0, "MGunBrowning50kAPIT", 500);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(0, "MGunBrowning50APIT", 500);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(1, "MGunHispanoMkIki", 150);
      arrayOf_WeaponSlot[5] = null;
      arrayOf_WeaponSlot[6] = null;
    ...
    {
      System.out.println("Error P38F-1-LO Weapons '2x250 ' NOT initialized:" + localException5.getMessage());
    }
    ...
    {
      System.out.println("Error P38F-1-LO Weapons '2x500 ' NOT initialized:" + localException6.getMessage());
    }
    ...
    {
      System.out.println("Error P38F-1-LO Weapons '2x1000 ' NOT initialized:" + localException7.getMessage());
    }
    ...
    {
      System.out.println("Error P38F Weapons 'none ' NOT initialized:" + localException8.getMessage());
    }
  }
}