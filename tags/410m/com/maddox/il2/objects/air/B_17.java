    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p9"))
                    getEnergyPastArmor(16.870000839233398D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 2: // '\002'
                    ...
                    {
                        com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                ...
                case 10: // '\n'
                    ...
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + k1 + ") Controls: Hit, Engine Controls (Partially) Disabled..");
                    break;
                ...
                case 12: // '\f'
                    ...
                    {
                        FM.AS.setControlsDamage(shot.initiator, 0);
                        com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Aileron Controls Out..");
                    }
                    break;
                ...
                case 14: // '\016'
                    ...
                    {
                        FM.AS.setControlsDamage(shot.initiator, 1);
                        com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Elevator Controls Out..");
                    }
                    break;
                ...
                case 16: // '\020'
                    ...
                    {
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Rudder Controls Out..");
                    }
                    break;
                }
                return;
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Keel1 Spars Damaged..");
            ...
            if(s.startsWith("xxbomb"))
            {
                ...
                {
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Bomb Payload Detonates..");
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, j, 2);
                            com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Crank Case Hit - Readyness Reduced to " + FM.EI.engines[j].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[j].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Cylinders Hit, " + FM.EI.engines[j].getCylindersOperable() + "/" + FM.EI.engines[j].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 18000F)
                        {
                            FM.AS.hitEngine(shot.initiator, j, 2);
                            com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Cylinders Hit - Engine Fires..");
                        }
                    }
                ...
                if(s.endsWith("mag1"))
                {
                    ...
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Module: Magneto #0 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
                if(s.endsWith("mag2"))
                {
                    FM.EI.engines[j].setMagnetoKnockOut(shot.initiator, 1);
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Module: Magneto #1 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
                if(s.endsWith("prop") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Module: Prop Governor Fails..");
                }
                if(s.endsWith("oil1") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Module: Oil Filter Pierced..");
                }
                if(s.endsWith("supc") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + j + ") Module: Compressor Stops..");
            ...
            if(s.startsWith("xxoiltank"))
            {
                ...
                com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Engine (" + byte0 + ") Module: Oil Tank Pierced..");
                return;
            }
        ...
        if(s.startsWith("xgear"))
        {
            ...
            {
                com.maddox.il2.objects.air.B_17.debugprintln(this, "*** Gear Hydro Failed..");
