...
// Source File Name:   Cockpit410B_Bombardier.java
...
//            CockpitPilot, ME_410B

public class Cockpit410B_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.ME_410B)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.ME_410B)aircraft()).fSightCurSideslip;
    ...
    public Cockpit410B_Bombardier()
    {
        super("3DO/Cockpit/Ar-234B-2-Bombardier/410.him", "he111");
        bEntered = false;
        bBAiming = false;
        try
        {
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bBAiming)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.ME_410B)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.ME_410B)aircraft()).fSightCurReadyness > 0.93F;
