...
public class CockpitHE_111H6 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitHE_111H6.this.setNew.altimeter = CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      CockpitHE_111H6.this.setNew.throttlel = ((10.0F * CockpitHE_111H6.this.setOld.throttlel + CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle()) / 11.0F);
      CockpitHE_111H6.this.setNew.throttler = ((10.0F * CockpitHE_111H6.this.setOld.throttler + CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle()) / 11.0F);
      CockpitHE_111H6.this.setNew.azimuth = CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitHE_111H6.this.setOld.azimuth > 270.0F) && (CockpitHE_111H6.this.setNew.azimuth < 90.0F)) CockpitHE_111H6.this.setOld.azimuth -= 360.0F;
      if ((CockpitHE_111H6.this.setOld.azimuth < 90.0F) && (CockpitHE_111H6.this.setNew.azimuth > 270.0F)) CockpitHE_111H6.this.setOld.azimuth += 360.0F;
      CockpitHE_111H6.this.setNew.waypointAzimuth = ((10.0F * CockpitHE_111H6.this.setOld.waypointAzimuth + (CockpitHE_111H6.this.waypointAzimuth() - CockpitHE_111H6.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitHE_111H6.this.setNew.vspeed = ((499.0F * CockpitHE_111H6.this.setOld.vspeed + CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 500.0F);
      if (CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.isTick(12, 0)) {
        Airport localAirport = Airport.nearest(CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d, -1, 1);
        if ((localAirport != null) && (localAirport.nearestRunway(CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d, CockpitHE_111H6.this.tmpLoc))) {
          CockpitHE_111H6.this.tmpLoc.transformInv(CockpitHE_111H6.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d, CockpitHE_111H6.this.tmpP);
          CockpitHE_111H6.this.tmpV.jdField_x_of_type_Double = CockpitHE_111H6.this.tmpP.jdField_x_of_type_Double;
          CockpitHE_111H6.this.tmpV.jdField_y_of_type_Double = CockpitHE_111H6.this.tmpP.jdField_y_of_type_Double;
          CockpitHE_111H6.this.tmpV.jdField_z_of_type_Double = CockpitHE_111H6.this.tmpP.jdField_z_of_type_Double;
          CockpitHE_111H6.this.tmpV.normalize();

          CockpitHE_111H6.this.tmpV.jdField_z_of_type_Double -= 0.03489900007843971D;
          if (CockpitHE_111H6.this.tmpV.jdField_x_of_type_Double > 0.9599999785423279D)
          {
            if (CockpitHE_111H6.this.tmpV.jdField_y_of_type_Double > 0.0D)
              CockpitHE_111H6.this.setNew.blindDotX = (1.889F * (float)Math.sqrt(CockpitHE_111H6.this.tmpV.jdField_y_of_type_Double));
            else {
              CockpitHE_111H6.this.setNew.blindDotX = (-1.889F * (float)Math.sqrt(-CockpitHE_111H6.this.tmpV.jdField_y_of_type_Double));
            }
            if (CockpitHE_111H6.this.tmpV.jdField_z_of_type_Double > 0.0D)
              CockpitHE_111H6.this.setNew.blindDotY = (1.889F * (float)Math.sqrt(CockpitHE_111H6.this.tmpV.jdField_z_of_type_Double));
            else
              CockpitHE_111H6.this.setNew.blindDotY = (-1.889F * (float)Math.sqrt(-CockpitHE_111H6.this.tmpV.jdField_z_of_type_Double));
          }
          else {
            CockpitHE_111H6.this.setNew.blindDotX = 0.0F;
            CockpitHE_111H6.this.setNew.blindDotY = 0.0F;
          }
        }
      }
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitHE_111H6.1 arg2) { this();
    }
  }
}