...
//            BF_109, PaintSchemeFMPar02, Aircraft, CockpitBF_109Ex, 
//            Cockpit, NetAircraft
...
public class BF_109E7NZ extends com.maddox.il2.objects.air.BF_109
{
    ...
    public void update(float f)
    {
        ...
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("SlatL_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).getAOA(), 6.8F, 11F, 0.0F, 1.5F));
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("SlatR_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).getAOA(), 6.8F, 11F, 0.0F, 1.5F));
        }
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("WaterL_D0", 0.0F, -38F * kangle, 0.0F);
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("WaterR_D0", 0.0F, -38F * kangle, 0.0F);
        kangle = 0.95F * kangle + 0.05F * ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).EI.engines[0].getControlRadiator();
        if(kangle > 1.0F)
            kangle = 1.0F;
        super.update(f);
        if((double)((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).CT.getCockpitDoor() > 0.20000000000000001D && bHasBlister && ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).getSpeedKMH() > fMaxKMHSpeedForOpenCanopy && ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
        ...
        if(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).isPlayers())
            if(!com.maddox.il2.game.Main3D.cur3D().isViewOutside())
                ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkVisible("CF_D0", false);
            else
                ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkVisible("CF_D0", true);
        if(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).isPlayers())
        {
            if(!com.maddox.il2.game.Main3D.cur3D().isViewOutside())
                ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkVisible("CF_D1", false);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkVisible("CF_D2", false);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkVisible("CF_D3", false);
        }
        if(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).isPlayers())
        {
            if(!com.maddox.il2.game.Main3D.cur3D().isViewOutside())
                ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkVisible("Blister1_D0", false);
            else
            if(bHasBlister)
                ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkVisible("Blister1_D0", true);
    ...
    {
        float f1 = 0.9F - (float)((com.maddox.il2.ai.Wing)((com.maddox.il2.engine.Actor)this).getOwner()).aircIndex(((com.maddox.il2.objects.air.Aircraft) (this))) * 0.1F;
        float f2 = -0.5F * (float)java.lang.Math.cos((double)(f / f1) * 3.1415926535897931D) + 0.5F;
        if(f <= f1)
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearL3_D0", 0.0F, -78F * f2, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearL2_D0", -24F * f2, 0.0F, 0.0F);
        }
        f2 = -0.5F * (float)java.lang.Math.cos((double)((f - (1.0F - f1)) / f1) * 3.1415926535897931D) + 0.5F;
        if(f >= 1.0F - f1)
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearR3_D0", 0.0F, 78F * f2, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearR2_D0", 24F * f2, 0.0F, 0.0F);
        }
        if(f > 0.99F)
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearL3_D0", 0.0F, -78F, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearL2_D0", -24F, 0.0F, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearR3_D0", 0.0F, 78F, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearR2_D0", 24F, 0.0F, 0.0F);
        }
    }
    ...
    public void moveSteering(float f)
    {
        ...
        {
            f = 77.5F;
            ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).Gears.steerAngle = f;
        }
        if(f < -77.5F)
        {
            f = -77.5F;
        ...
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("GearC2_D0", 0.0F, -f, 0.0F);
    }
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", "3DO/Plane/Bf-109E-7NZ/hier.him");
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "FlightModel", "FlightModels/Bf-109E-7NZ.fmd");
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "none", new java.lang.String[4]);
    }
}
