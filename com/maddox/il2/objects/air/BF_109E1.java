  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int paramInt)
  {
    ...
    try
    {
      arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(0, "MGunMG17si", 1007);
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(0, "MGunMG17si", 993);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMG17k", 748);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMG17k", 753);
  ...
  static
  {
    Class localClass = BF_109E1.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3DO/Plane/Bf-109E-1/hier.him");
