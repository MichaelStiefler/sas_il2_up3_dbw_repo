...
public class CockpitMC_200_VII_new extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMC_200_VII_new.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitMC_200_VII_new.this.setNew.throttle = (0.85F * CockpitMC_200_VII_new.this.setOld.throttle + CockpitMC_200_VII_new.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);

        CockpitMC_200_VII_new.this.setNew.prop = (0.85F * CockpitMC_200_VII_new.this.setOld.prop + CockpitMC_200_VII_new.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);

        CockpitMC_200_VII_new.this.setNew.altimeter = CockpitMC_200_VII_new.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        ...
        CockpitMC_200_VII_new.this.setNew.azimuth.setDeg(CockpitMC_200_VII_new.this.setOld.azimuth.getDeg(1.0F), CockpitMC_200_VII_new.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitMC_200_VII_new.this.setNew.vspeed = ((199.0F * CockpitMC_200_VII_new.this.setOld.vspeed + CockpitMC_200_VII_new.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
