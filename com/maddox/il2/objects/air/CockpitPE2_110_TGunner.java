...
public class CockpitPE2_110_TGunner extends CockpitGunner
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        ...
        if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3] != null) {
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 0) {
            CockpitPE2_110_TGunner.this.bBombs[1] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][0].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 1) {
            CockpitPE2_110_TGunner.this.bBombs[0] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][1].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 2) {
            CockpitPE2_110_TGunner.this.bBombs[3] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][2].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 3) {
            CockpitPE2_110_TGunner.this.bBombs[2] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][3].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 4) {
            CockpitPE2_110_TGunner.this.bBombs[5] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][4].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 5) {
            CockpitPE2_110_TGunner.this.bBombs[4] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][5].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 6) {
            CockpitPE2_110_TGunner.this.bBombs[5] = ((CockpitPE2_110_TGunner.this.bBombs[5] != 0) || (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 7) {
            CockpitPE2_110_TGunner.this.bBombs[4] = ((CockpitPE2_110_TGunner.this.bBombs[4] != 0) || (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 8) {
            CockpitPE2_110_TGunner.this.bBombs[7] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][8].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 9) {
            CockpitPE2_110_TGunner.this.bBombs[6] = (!CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][9].haveBullets() ? 1 : 0);
          }

        }

        CockpitPE2_110_TGunner.this.setNew.man1 = (0.92F * CockpitPE2_110_TGunner.this.setOld.man1 + 0.08F * CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());

        CockpitPE2_110_TGunner.this.setNew.man2 = (0.92F * CockpitPE2_110_TGunner.this.setOld.man2 + 0.08F * CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitPE2_110_TGunner.this.setNew.altimeter = CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitPE2_110_TGunner.this.setNew.azimuth.setDeg(CockpitPE2_110_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitPE2_110_TGunner.this.setNew.vspeed = ((100.0F * CockpitPE2_110_TGunner.this.setOld.vspeed + CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);

        float f = CockpitPE2_110_TGunner.this.waypointAzimuth();

        CockpitPE2_110_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE2_110_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitPE2_110_TGunner.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitPE2_110_TGunner.this.setNew.waypointDirection.setDeg(CockpitPE2_110_TGunner.this.setOld.waypointDirection.getDeg(1.0F), f);

        CockpitPE2_110_TGunner.this.setNew.inert = (0.999F * CockpitPE2_110_TGunner.this.setOld.inert + 0.001F * (CockpitPE2_110_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
