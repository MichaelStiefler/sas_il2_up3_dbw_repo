...
public class CockpitF84G2 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitF84G2 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF84G2.this.fm != null) {
        CockpitF84G2.access$102(CockpitF84G2.this, CockpitF84G2.this.setOld);
        CockpitF84G2.access$202(CockpitF84G2.this, CockpitF84G2.this.setNew);
        CockpitF84G2.access$302(CockpitF84G2.this, CockpitF84G2.this.setTmp);
        ...
        CockpitF84G2.this.setNew.azimuth = ((35.0F * CockpitF84G2.this.setOld.azimuth + -CockpitF84G2.this.fm.Or.getYaw()) / 36.0F);

        if ((CockpitF84G2.this.setOld.azimuth > 270.0F) && (CockpitF84G2.this.setNew.azimuth < 90.0F))
          CockpitF84G2.this.setOld.azimuth -= 360.0F;
        if ((CockpitF84G2.this.setOld.azimuth < 90.0F) && (CockpitF84G2.this.setNew.azimuth > 270.0F))
          CockpitF84G2.this.setOld.azimuth += 360.0F;
        CockpitF84G2.this.setNew.waypointAzimuth = ((10.0F * CockpitF84G2.this.setOld.waypointAzimuth + CockpitF84G2.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

        CockpitF84G2.this.setNew.vspeed = ((199.0F * CockpitF84G2.this.setOld.vspeed + CockpitF84G2.this.fm.getVertSpeed()) / 200.0F);

        float f1 = ((F84G2)CockpitF84G2.this.aircraft()).k14Distance;
        CockpitF84G2.this.setNew.k14w = (5.0F * CockpitF84G2.k14TargetWingspanScale[((F84G2)CockpitF84G2.this.aircraft()).k14WingspanType] / f1);
        ...
        Vector3d localVector3d = CockpitF84G2.this.aircraft().FM.getW();
        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitF84G2.this.floatindex((f1 - 200.0F) * 0.04F, CockpitF84G2.k14BulletDrop) - CockpitF84G2.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitF84G2.this.setNew.k14x = (0.92F * CockpitF84G2.this.setOld.k14x + 0.08F * f2);
        CockpitF84G2.this.setNew.k14y = (0.92F * CockpitF84G2.this.setOld.k14y + 0.08F * f3);
        if (CockpitF84G2.this.setNew.k14x > 7.0F)
          CockpitF84G2.this.setNew.k14x = 7.0F;
        if (CockpitF84G2.this.setNew.k14x < -7.0F)
          CockpitF84G2.this.setNew.k14x = -7.0F;
        if (CockpitF84G2.this.setNew.k14y > 7.0F)
          CockpitF84G2.this.setNew.k14y = 7.0F;
        if (CockpitF84G2.this.setNew.k14y < -7.0F)
          CockpitF84G2.this.setNew.k14y = -7.0F;
      }
      return true;
