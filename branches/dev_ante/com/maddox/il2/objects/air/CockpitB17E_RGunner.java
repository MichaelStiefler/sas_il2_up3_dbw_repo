...
public class CockpitB17E_RGunner extends CockpitGunner
{
  ...
  {
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretLA", 0.0F, aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[5].tu[0], 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretLB", 0.0F, aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[5].tu[1], 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretLC", 0.0F, aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[5].tu[1], 0.0F);
  ...
  static
  {
    ...
    Property.set(CockpitB17E_RGunner.class, "weaponControlNum", 15);
