...
public class KI_61_IOTSU extends com.maddox.il2.objects.air.KI_61
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 1, 3, 3, 9, 9
        });
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalDev01", "_ExternalDev02"
        });
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunHo103si 250", "MGunHo103si 250", "MGunHo103k 250", "MGunHo103k 250", null, null, null, null
        });
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponsRegister(class1, "1x250", new java.lang.String[] {
            "MGunHo103si 250", "MGunHo103si 250", "MGunHo103k 250", "MGunHo103k 250", null, "BombGun250kgJ 1", null, null
        });
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponsRegister(class1, "2x250", new java.lang.String[] {
            "MGunHo103si 250", "MGunHo103si 250", "MGunHo103k 250", "MGunHo103k 250", "BombGun250kgJ 1", "BombGun250kgJ 1", null, null
        });
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponsRegister(class1, "2x150dt", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponsRegister(class1, "1x150dt", new java.lang.String[] {
            "MGunHo103si 250", "MGunHo103si 250", "MGunHo103k 250", "MGunHo103k 250", null, null, null, "FuelTankGun_TankKi61Underwing"
        });
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponsRegister(class1, "1x150dt+1x250kg", new java.lang.String[] {
            "MGunHo103si 250", "MGunHo103si 250", "MGunHo103k 250", "MGunHo103k 250", null, "BombGun250kgJ 1", "FuelTankGun_TankKi61Underwing", null
        });
        com.maddox.il2.objects.air.KI_61_IOTSU.weaponsRegister(class1, "none", new java.lang.String[] {
