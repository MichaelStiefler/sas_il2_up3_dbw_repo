...
// Source File Name:   ASDGeneric.java
...
public abstract class ASDGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.ASDGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.ASDGeneric.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.ASDGeneric asdgeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.ASDGeneric.constr_arg2 = actorspawnarg;
                asdgeneric = (com.maddox.il2.objects.vehicles.stationary.ASDGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.ASDGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create ASDGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (asdgeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.ASDGeneric.mesh_name);
            cls = class1;
    ...
    private ASDGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
