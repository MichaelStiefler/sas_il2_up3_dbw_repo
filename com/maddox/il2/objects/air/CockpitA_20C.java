...
// Source File Name:   CockpitA_20C.java
...
public class CockpitA_20C extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetLocate("Z_LeftPedal1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[1] = 0.1F * fm.CT.getRudder();
        mesh.chunkSetLocate("Z_RightPedal1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, -0.025F, 0.025F);
        mesh.chunkSetLocate("Z_AH2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        mesh.chunkSetAngles("zFreeAir", 0.0F, floatindex(cvt(com.maddox.il2.fm.Atmosphere.temperature((float)fm.Loc.z), 223.09F, 323.09F, 0.0F, 4F), temperatureScale), 0.0F);
        ...
        mesh.chunkSetAngles("Z_Second1", 0.0F, cvt(((com.maddox.il2.ai.World.getTimeofDay() % 1.0F) * 60F) % 1.0F, 0.0F, 1.0F, 0.0F, 360F), 0.0F);
