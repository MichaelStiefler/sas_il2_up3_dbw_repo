...
// Source File Name:   CockpitDB3F_Bombardier.java
...
//            CockpitPilot, IL_4_DB3F, Cockpit

public class CockpitDB3F_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.IL_4_DB3F)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.IL_4_DB3F)aircraft()).fSightCurSideslip;
    ...
    {
        super("3DO/Cockpit/Pe-2-Bombardier/BombardierDB3F.him", "he111");
        bEntered = false;
        try
        {
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.IL_4_DB3F)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.IL_4_DB3F)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
