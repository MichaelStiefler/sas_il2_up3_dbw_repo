// Source File Name: CockpitB6N2.java
...
public class CockpitB6N2 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB6N2.this.fm != null) {
				...
				CockpitB6N2.this.setNew.flap = (0.88F * CockpitB6N2.this.setOld.flap)
						+ (0.12F * CockpitB6N2.this.fm.CT.FlapsControl);
				CockpitB6N2.this.setNew.tlock = (0.7F * CockpitB6N2.this.setOld.tlock)
						+ (0.3F * (CockpitB6N2.this.fm.Gears.bTailwheelLocked ? 1.0F
								: 0.0F));
				...
				if ((CockpitB6N2.this.fm.CT.GearControl < 0.5F)
						&& (CockpitB6N2.this.setNew.gear < 1.0F)) {
					CockpitB6N2.this.setNew.gear = CockpitB6N2.this.setOld.gear + 0.02F;
				}
				if ((CockpitB6N2.this.fm.CT.GearControl > 0.5F)
						&& (CockpitB6N2.this.setNew.gear > 0.0F)) {
					CockpitB6N2.this.setNew.gear = CockpitB6N2.this.setOld.gear - 0.02F;
				}
				CockpitB6N2.this.setNew.throttle = (0.9F * CockpitB6N2.this.setOld.throttle)
						+ (0.1F * CockpitB6N2.this.fm.CT.PowerControl);
				CockpitB6N2.this.setNew.manifold = (0.8F * CockpitB6N2.this.setOld.manifold)
						+ (0.2F * CockpitB6N2.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitB6N2.this.setNew.pitch = (0.9F * CockpitB6N2.this.setOld.pitch)
						+ (0.1F * CockpitB6N2.this.fm.EI.engines[0]
								.getControlProp());
				CockpitB6N2.this.setNew.mix = (0.9F * CockpitB6N2.this.setOld.mix)
						+ (0.1F * CockpitB6N2.this.fm.EI.engines[0]
								.getControlMix());
				CockpitB6N2.this.setNew.altimeter = CockpitB6N2.this.fm
						.getAltitude();
				CockpitB6N2.this.setNew.azimuth.setDeg(
						CockpitB6N2.this.setOld.azimuth.getDeg(1.0F),
						CockpitB6N2.this.fm.Or.azimut());
				float f = CockpitB6N2.this.waypointAzimuth();
				CockpitB6N2.this.setNew.waypointAzimuth.setDeg(
						CockpitB6N2.this.setOld.waypointAzimuth.getDeg(0.1F),
						(f - CockpitB6N2.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-3F, 3F));
				CockpitB6N2.this.setNew.vspeed = ((199F * CockpitB6N2.this.setOld.vspeed) + CockpitB6N2.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("NeedFuelPress", this.cvt(
				this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.6F, 0.0F, -180F),
				0.0F, 0.0F);
