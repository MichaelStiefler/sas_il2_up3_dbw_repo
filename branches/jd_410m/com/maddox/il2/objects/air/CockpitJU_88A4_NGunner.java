...
public class CockpitJU_88A4_NGunner extends CockpitGunner
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    resetYPRmodifier();
    float tmp385_384 = (0.85F * this.pictFlap + 0.00948F * this.fm.CT.FlapsControl); this.pictFlap = tmp385_384; xyz[2] = tmp385_384;
    this.mesh.chunkSetLocate("zFlaps1", xyz, ypr);
    float tmp431_430 = (0.85F * this.pictGear + 0.007095F * this.fm.CT.GearControl); this.pictGear = tmp431_430; xyz[2] = tmp431_430;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A4_NGunner.this.fm != null) {
        ...
        CockpitJU_88A4_NGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.throttle1 + CockpitJU_88A4_NGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_NGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.prop1 + CockpitJU_88A4_NGunner.this.fm.EI.engines[0].getControlProp() * 0.15F);

        CockpitJU_88A4_NGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.throttle2 + CockpitJU_88A4_NGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_NGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.prop2 + CockpitJU_88A4_NGunner.this.fm.EI.engines[1].getControlProp() * 0.15F);

        CockpitJU_88A4_NGunner.this.setNew.altimeter = CockpitJU_88A4_NGunner.this.fm.getAltitude();

        float f1 = CockpitJU_88A4_NGunner.this.waypointAzimuth();
        if (CockpitJU_88A4_NGunner.this.useRealisticNavigationInstruments())
        {
          CockpitJU_88A4_NGunner.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4_NGunner.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4_NGunner.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A4_NGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A4_NGunner.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A4_NGunner.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
        ...
        CockpitJU_88A4_NGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_NGunner.this.setOld.vspeed + CockpitJU_88A4_NGunner.this.fm.getVertSpeed()) / 200.0F);
        ...
        float f2 = CockpitJU_88A4_NGunner.this.prevFuel - CockpitJU_88A4_NGunner.this.fm.M.fuel;
        CockpitJU_88A4_NGunner.access$402(CockpitJU_88A4_NGunner.this, CockpitJU_88A4_NGunner.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        ...
        if (CockpitJU_88A4_NGunner.this.buzzerFX != null) {
          if ((CockpitJU_88A4_NGunner.this.fm.Loc.z < ((JU_88A4)CockpitJU_88A4_NGunner.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4)(JU_88A4)CockpitJU_88A4_NGunner.this.fm.actor).diveMechStage == 1))
        ...
        CockpitJU_88A4_NGunner.this.setNew.beaconDirection = ((10.0F * CockpitJU_88A4_NGunner.this.setOld.beaconDirection + CockpitJU_88A4_NGunner.this.getBeaconDirection()) / 11.0F);
        CockpitJU_88A4_NGunner.this.setNew.beaconRange = ((10.0F * CockpitJU_88A4_NGunner.this.setOld.beaconRange + CockpitJU_88A4_NGunner.this.getBeaconRange()) / 11.0F);
      }
