...
public class CockpitDB3B extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitDB3B this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitDB3B.this.fm != null) {
        CockpitDB3B.access$102(CockpitDB3B.this, CockpitDB3B.this.setOld);
        CockpitDB3B.access$202(CockpitDB3B.this, CockpitDB3B.this.setNew);
        CockpitDB3B.access$302(CockpitDB3B.this, CockpitDB3B.this.setTmp);
        if (CockpitDB3B.this.fm.CT.Weapons[3] != null) {
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 0)
            CockpitDB3B.this.bBombs[1] = (!CockpitDB3B.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 1)
            CockpitDB3B.this.bBombs[0] = (!CockpitDB3B.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 2)
            CockpitDB3B.this.bBombs[3] = (!CockpitDB3B.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 3)
            CockpitDB3B.this.bBombs[2] = (!CockpitDB3B.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 4)
            CockpitDB3B.this.bBombs[5] = (!CockpitDB3B.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 5)
            CockpitDB3B.this.bBombs[4] = (!CockpitDB3B.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 6) {
            CockpitDB3B.this.bBombs[5] = ((CockpitDB3B.this.bBombs[5] != 0) || (!CockpitDB3B.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 7) {
            CockpitDB3B.this.bBombs[4] = ((CockpitDB3B.this.bBombs[4] != 0) || (!CockpitDB3B.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 8)
            CockpitDB3B.this.bBombs[7] = (!CockpitDB3B.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitDB3B.this.fm.CT.Weapons[3].length > 9)
            CockpitDB3B.this.bBombs[6] = (!CockpitDB3B.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        ...
        CockpitDB3B.this.setNew.vspeed = ((100.0F * CockpitDB3B.this.setOld.vspeed + CockpitDB3B.this.fm.getVertSpeed()) / 101.0F);

        float f = CockpitDB3B.this.waypointAzimuth();
        CockpitDB3B.this.setNew.waypointAzimuth.setDeg(CockpitDB3B.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitDB3B.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitDB3B.this.setNew.waypointDirection.setDeg(CockpitDB3B.this.setOld.waypointDirection.getDeg(1.0F), f);
