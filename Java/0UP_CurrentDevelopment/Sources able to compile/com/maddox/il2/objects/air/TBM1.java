...
public class TBM1 extends TBF
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = TBM1.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= TBM1.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / TBM1.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)TBM1.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(TBM1.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = TBM1.class;
        ...
        Aircraft.weaponsRegister(class1, "6x100", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "1xtorp", new java.lang.String[] {
