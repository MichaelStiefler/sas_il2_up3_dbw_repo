...
public class Config
{
    ...
    private void saveNet()
    {
        ...
        if(com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            ...
            for(int i = 0; i < zutiServerNames.size(); i++)
            {
                ...
                ini.setValue("NET", "remoteHost_" + s, (java.lang.String)zutiServerNames.get(i));
            }
    ...
    {
        windowTitle = s;
        return createGlContext(((com.maddox.opengl.GLContext) (null)), windowChangeScreenRes, windowFullScreen, windowWidth, windowHeight, windowColourBits, windowDepthBits, windowStencilBits);
    }
    ...
    public static void typeGLCaps()
    {
        ...
        for(int i = 0; i < aglcaps.length; i++)
        {
            ...
            java.lang.System.err.print(aglcaps[i].getDevice() == 1 ? "  DRAW_TO_WINDOW" : "  DRAW_TO_BITMAP");
            ...
            java.lang.System.err.println(aglcaps[i].getPixelType() == 1 ? "  TYPE_RGBA" : "  TYPE_COLOURINDEX");
    ...
    public static java.lang.String engineDllName()
    {
        ...
        {
            if(com.maddox.rts.Cpu86ID.getVendor() == 1 && com.maddox.rts.Cpu86ID.isSSE4())
                return "il2corSSE4";
            if(com.maddox.rts.Cpu86ID.getVendor() == 1 && com.maddox.rts.Cpu86ID.isSSE3())
                return "il2corSSE3";
    ...
    private void zutiLoadServers()
    {
        for(int i = 0; i < 255; i++)
        {
            ...
            if(i > 99)
                s = (new Integer(i)).toString();
            java.lang.String s1 = ini.get("NET", "remoteHost_" + s, "");
            if(s1.trim().length() > 0)
                zutiServerNames.add(((java.lang.Object) (s1)));
        }

    }

    public java.util.ArrayList zutiGetServerNames()
    {
        return zutiServerNames;
    }

    public void zutiAddServerName(java.lang.String s)
    {
        if(!zutiServerNames.contains(((java.lang.Object) (s))))
            zutiServerNames.add(((java.lang.Object) (s)));
    }
    ...
    private static final java.lang.String _VERSION = "4.10.1";
    ...
    public static final java.lang.String VERSION = "4.10.1m";
    public static final java.lang.String NET_VERSION = "FB_PF_v_4.10.1m";
    public static final int TRACK_SINGLE_VERSION = 130;
    public static java.lang.String LOCALE = "RU";
    ...
    public java.util.ArrayList zutiServerNames;
