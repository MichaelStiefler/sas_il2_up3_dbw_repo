    ...
    implements TypeDiveBomber, TypeStormovik
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f, com.maddox.il2.fm.FlightModel flightmodel)
    {
        ...
        if(bGearExtending)
        {
            ...
            } else
            {
                ...
                f3 = Aircraft.cvt(f3, (float)java.lang.Math.sqrt(0.75D), (float)java.lang.Math.sqrt(2D), 0.4F, 1.0F);
                f6 = Aircraft.cvt(f, 4F, 8.5F, 0.75F, 2.0F);
                f6 = (float)java.lang.Math.sqrt(f6);
                f6 = Aircraft.cvt(f6, (float)java.lang.Math.sqrt(0.75D), (float)java.lang.Math.sqrt(2D), 0.4F, 1.0F);
            }
    ...
    public void update(float f)
    {
        ...
        cGear = AD.filter(f, FM.CT.GearControl, cGear, 999.9F, FM.CT.dvGear);
        if(prevGear2 > cGear)
    ...
    static 
    {
        java.lang.Class class1 = AD.class;
