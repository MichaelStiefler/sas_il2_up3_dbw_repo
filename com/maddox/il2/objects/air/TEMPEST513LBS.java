  ...
  implements TypeFighter, TypeBNZFighter
{
  ...
  private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int paramInt)
  {
    ...
    try
    {
      arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(1, "MGunHispanoMKVk", 200);
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(0, "MGunHispanoMKVk", 200);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(0, "MGunHispanoMKVk", 200);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunHispanoMKVk", 200);
  ...
  static
  {
    Class localClass = TEMPEST513LBS.class;
    ...
    Property.set(localClass, "FlightModel", "FlightModels/TempestMkV13.fmd");
