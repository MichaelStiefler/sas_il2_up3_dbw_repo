...
public class CockpitYAK_9D extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel = World.getPlayerFM();
      if (CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitYAK_9D.this.setNew.throttle = ((10.0F * CockpitYAK_9D.this.setOld.throttle + CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_9D.this.setNew.prop = ((10.0F * CockpitYAK_9D.this.setOld.prop + CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_9D.this.setNew.altimeter = CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_9D.this.setNew.azimuth = ((35.0F * CockpitYAK_9D.this.setOld.azimuth + CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        ...
        CockpitYAK_9D.this.setNew.vspeed = ((199.0F * CockpitYAK_9D.this.setOld.vspeed + CockpitYAK_9D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
