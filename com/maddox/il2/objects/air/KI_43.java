    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.KI_43.cvt(f, 0.01F, 0.99F, 0.0F, 0.59F);
    ...
    {
        resetYPRmodifier();
        float f = com.maddox.il2.objects.air.KI_43.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.245F, 0.0F, 0.245F);
        xyz[1] = f;
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.KI_43.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.245F, 0.0F, 0.245F);
        xyz[1] = f;
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxeng1"))
            {
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Engine Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Engine Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Engine Crank Case Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Engine Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Engine Cylinders Hit - Engine Fires..");
                        }
                    }
                ...
                if(s.endsWith("mag1"))
                {
                    ...
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Engine Module: Magneto #0 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
                if(s.endsWith("mag2"))
                {
                    FM.EI.engines[0].setMagnetoKnockOut(shot.initiator, 1);
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Engine Module: Magneto #1 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
                if(s.endsWith("oil1"))
                {
            ...
            {
                com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** StabL Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** StabR Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_43.debugprintln(this, "*** Keel Spars Damaged..");
