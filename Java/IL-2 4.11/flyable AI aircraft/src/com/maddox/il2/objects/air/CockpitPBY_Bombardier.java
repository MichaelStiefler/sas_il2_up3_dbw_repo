// Source File Name: CockpitPBY_Bombardier.java
...
public class CockpitPBY_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitPBY_Bombardier.this.bEntered) {
				...
				CockpitPBY_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1,
						0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1, CockpitPBY_Bombardier.this.tAim
						+ f, 0.0F);
			}
			return true;
		}
	...
	public void reflectWorldToInstruments(float f) {
		super.mesh.chunkSetAngles("zMark1",
				((PBY) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F,
				0.0F);
		float f1 = this.cvt(((PBY) this.aircraft()).fSightSetForwardAngle,
				-15F, 75F, -15F, 75F);
		super.mesh.chunkSetAngles("zMark2", f1 * 3.675F, 0.0F, 0.0F);
		this.resetYPRmodifier();
		Cockpit.xyz[0] = this.cvt(((FlightModelMain) (super.fm)).Or.getKren()
				* Math.abs(((FlightModelMain) (super.fm)).Or.getKren()),
				-1225F, 1225F, -0.23F, 0.23F);
		Cockpit.xyz[1] = this.cvt(
				(((FlightModelMain) (super.fm)).Or.getTangage() - 1.0F)
						* Math.abs(((FlightModelMain) (super.fm)).Or
								.getTangage() - 1.0F), -1225F, 1225F, 0.23F,
				-0.23F);
		Cockpit.ypr[0] = this.cvt(((FlightModelMain) (super.fm)).Or.getKren(),
				-45F, 45F, -180F, 180F);
