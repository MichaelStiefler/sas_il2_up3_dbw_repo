...
public class G56 extends Centauroxyz
  implements TypeFighter, TypeBNZFighter
{
  ...
  static
  {
    ...
    Property.set(class1, "iconFar_shortClassName", "G.56");
    ...
    Property.set(class1, "FlightModel", "FlightModels/G56.fmd");
    ...
    try
    {
      ...
      a_lweaponslot[2] = new Aircraft._WeaponSlot(0, "MGunMG15120t", 200);
  ...
  public void onAircraftLoaded()
  {
    ...
    this.FM.SensPitch = 0.629F;
    this.FM.SensRoll = 0.37F;
    this.FM.SensYaw = 0.59F;
  ...
  public void update(float f) {
    ...
    {
      this.FM.EI.engines[0].addVside *= 1.04323D;
      this.FM.EI.engines[0].addVflow *= 1.00776D;
    }
    ...
    if (this.FM.EI.engines[0].getControlThrottle() > 1.0F) {
      HUD.logRightBottom("Start und Notleistung");
    }
    if ((!this.FM.isPlayers()) && (this.FM.Gears.onGround()))
    {
      if (this.FM.EI.engines[0].getRPM() < 1400.0F)
  ...
  private void calcg()
  {
    ...
    else if ((this.FM.EI.engines[0].getRPM() > 2500.0F) && (this.FM.EI.engines[0].getRPM() <= 2500.0F)) {
      this.FM.VmaxAllowed = (this.FM.getSpeed() + 16.5F);
    }
    else if (this.FM.EI.engines[0].getRPM() > 2500.0F) {
      this.FM.VmaxAllowed = (this.FM.getSpeed() + 15.0F);
    }
    else if (this.FM.getSpeed() > 197.2F) {
