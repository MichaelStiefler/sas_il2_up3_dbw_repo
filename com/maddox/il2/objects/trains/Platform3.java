...
// Source File Name:   Platform3.java
...
public class Platform3 extends com.maddox.il2.objects.trains.Wagon
    implements com.maddox.il2.engine.MsgCollisionRequestListener, com.maddox.il2.ai.MsgExplosionListener, com.maddox.il2.ai.MsgShotListener
{
    ...
    public Platform3(com.maddox.il2.objects.trains.Train train)
    {
        super(train, com.maddox.il2.objects.trains.Platform3.getMeshName(0), com.maddox.il2.objects.trains.Platform3.getMeshName(1));
        life = 0.012F;
        ignoreTNT = 0.4F;
        killTNT = 3F;
        bodyMaterial = 2;
    ...
    private static java.lang.String getMeshName(int i)
    {
        ...
        case 2: // '\002'
        default:
            return "3do/Trains/Platform3" + (i != 1 ? "" : "_Dmg") + "/hier.him";
        }
    }

    public static java.lang.String getMeshNameForEditor()
    {
        return com.maddox.il2.objects.trains.Platform3.getMeshName(0);
    }
    ...
    static 
    {
        cls = com.maddox.il2.objects.trains.Platform3.class;
