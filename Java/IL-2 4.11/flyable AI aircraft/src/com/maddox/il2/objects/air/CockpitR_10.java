...
public class CockpitR_10 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitR_10.this.fm != null) {
				...
				if (CockpitR_10.this.cockpitDimControl) {
					if (CockpitR_10.this.setNew.dimPos < 1.0F) {
						CockpitR_10.this.setNew.dimPos = CockpitR_10.this.setOld.dimPos + 0.03F;
					}
				} else if (CockpitR_10.this.setNew.dimPos > 0.0F) {
					CockpitR_10.this.setNew.dimPos = CockpitR_10.this.setOld.dimPos - 0.03F;
				}
				CockpitR_10.this.setNew.manifold = (0.8F * CockpitR_10.this.setOld.manifold)
						+ (0.2F * CockpitR_10.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitR_10.this.setNew.throttle = (0.8F * CockpitR_10.this.setOld.throttle)
						+ (0.2F * CockpitR_10.this.fm.CT.PowerControl);
				CockpitR_10.this.setNew.prop = (0.8F * CockpitR_10.this.setOld.prop)
						+ (0.2F * CockpitR_10.this.fm.EI.engines[0]
								.getControlProp());
				CockpitR_10.this.setNew.mix = (0.8F * CockpitR_10.this.setOld.mix)
						+ (0.2F * CockpitR_10.this.fm.EI.engines[0]
								.getControlMix());
				CockpitR_10.this.setNew.man = (0.92F * CockpitR_10.this.setOld.man)
						+ (0.08F * CockpitR_10.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitR_10.this.setNew.altimeter = CockpitR_10.this.fm
						.getAltitude();
				float f = CockpitR_10.this.waypointAzimuth();
				CockpitR_10.this.setNew.azimuth.setDeg(
						CockpitR_10.this.setOld.azimuth.getDeg(1.0F),
						CockpitR_10.this.fm.Or.azimut());
				CockpitR_10.this.setNew.waypointDeviation.setDeg(
						CockpitR_10.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitR_10.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-5F, 5F));
				CockpitR_10.this.setNew.waypointAzimuth
						.setDeg(CockpitR_10.this.setOld.waypointAzimuth
								.getDeg(1.0F), f);
				CockpitR_10.this.setNew.vspeed = (0.5F * CockpitR_10.this.setOld.vspeed)
						+ (0.5F * CockpitR_10.this.fm.getVertSpeed());
			}
			return true;
		}
	}
	...
	public CockpitR_10() {
		super("3DO/Cockpit/Ki-27(Otsu)/CockpitR10.him", "bf109");
	...
	public void reflectWorldToInstruments(float f) {
		...
		f2 = this.cvt(1.0F + (0.05F * this.fm.EI.engines[0].tOilOut), 0.0F,
				8.1F, 0.0F, 20F);
		for (int i = 1; i < 20; i++) {
			this.mesh.chunkVisible("Z_OilP" + (i >= 10 ? "" + i : "0" + i),
					f2 > (20 - i));
		}
		...
		this.mesh.chunkSetAngles("Z_RPM1", this.cvt(
				...
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_Fuelpres",
				this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 2.0F,
						0.0F, -360F), 0.0F, 0.0F);
