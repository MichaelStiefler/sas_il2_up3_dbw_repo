...
public class CockpitAR_234B2NJ extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAltWheel", 0.0F, cvt(((AR_234B2NJ)aircraft()).fSightCurAltitude, 0.0F, 6000.0F, 0.0F, 225.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAnglePointer", 0.0F, cvt(((AR_234B2NJ)aircraft()).fSightCurForwardAngle, 0.0F, 60.0F, 105.0F, 0.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAngleWheel", 0.0F, -10.0F * ((AR_234B2NJ)aircraft()).fSightCurForwardAngle, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zSpeedPointer", 0.0F, cvt(((AR_234B2NJ)aircraft()).fSightCurSpeed, 150.0F, 600.0F, 0.0F, 60.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zSpeedWheel", 0.0F, 0.333F * ((AR_234B2NJ)aircraft()).fSightCurSpeed, 0.0F);
    resetYPRmodifier();
  ...
  private class Variables
  {
    ...
    float vspeed;
    private final CockpitAR_234B2NJ this$0;
    ...
    Variables(CockpitAR_234B2NJ.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitAR_234B2NJ.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitAR_234B2NJ.access$002(CockpitAR_234B2NJ.this, CockpitAR_234B2NJ.this.setOld);
        CockpitAR_234B2NJ.access$102(CockpitAR_234B2NJ.this, CockpitAR_234B2NJ.this.setNew);
        CockpitAR_234B2NJ.access$202(CockpitAR_234B2NJ.this, CockpitAR_234B2NJ.this.setTmp);
        CockpitAR_234B2NJ.this.setNew.altimeter = CockpitAR_234B2NJ.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitAR_234B2NJ.this.setNew.throttle1 = (0.92F * CockpitAR_234B2NJ.this.setOld.throttle1 + 0.08F * CockpitAR_234B2NJ.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitAR_234B2NJ.this.setNew.throttle2 = (0.92F * CockpitAR_234B2NJ.this.setOld.throttle2 + 0.08F * CockpitAR_234B2NJ.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitAR_234B2NJ.this.setNew.vspeed = ((499.0F * CockpitAR_234B2NJ.this.setOld.vspeed + CockpitAR_234B2NJ.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 500.0F);
        CockpitAR_234B2NJ.this.setNew.azimuth = CockpitAR_234B2NJ.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
        if ((CockpitAR_234B2NJ.this.setOld.azimuth > 270.0F) && (CockpitAR_234B2NJ.this.setNew.azimuth < 90.0F))
        {
          CockpitAR_234B2NJ.this.setOld.azimuth -= 360.0F;
        }
        if ((CockpitAR_234B2NJ.this.setOld.azimuth < 90.0F) && (CockpitAR_234B2NJ.this.setNew.azimuth > 270.0F))
        {
          CockpitAR_234B2NJ.this.setOld.azimuth += 360.0F;
        }
        CockpitAR_234B2NJ.this.setNew.waypointAzimuth = ((10.0F * CockpitAR_234B2NJ.this.setOld.waypointAzimuth + (CockpitAR_234B2NJ.this.waypointAzimuth() - CockpitAR_234B2NJ.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      }
      return true;
    }
