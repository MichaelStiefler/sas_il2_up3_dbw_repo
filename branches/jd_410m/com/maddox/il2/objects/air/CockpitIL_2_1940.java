  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitIL_2_1940.this.fm != null) {
        ...
        CockpitIL_2_1940.this.setNew.throttle = ((10.0F * CockpitIL_2_1940.this.setOld.throttle + CockpitIL_2_1940.this.fm.CT.PowerControl) / 11.0F);
        if (CockpitIL_2_1940.this.fm.Gears.isHydroOperable()) CockpitIL_2_1940.this.setNew.undercarriage = ((10.0F * CockpitIL_2_1940.this.setOld.undercarriage + CockpitIL_2_1940.this.fm.CT.GearControl) / 11.0F);
        CockpitIL_2_1940.this.setNew.flaps = ((10.0F * CockpitIL_2_1940.this.setOld.flaps + (CockpitIL_2_1940.this.fm.CT.FlapsControl > 0.0F ? 0.0F : 1.0F)) / 11.0F);

        CockpitIL_2_1940.this.setNew.altimeter = CockpitIL_2_1940.this.fm.getAltitude();
        if (Math.abs(CockpitIL_2_1940.this.fm.Or.getKren()) < 30.0F) {
          CockpitIL_2_1940.this.setNew.azimuth = ((35.0F * CockpitIL_2_1940.this.setOld.azimuth + CockpitIL_2_1940.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitIL_2_1940.this.setNew.vspeed = ((199.0F * CockpitIL_2_1940.this.setOld.vspeed + CockpitIL_2_1940.this.fm.getVertSpeed()) / 200.0F);

        if (CockpitIL_2_1940.this.fm.CT.saveWeaponControl[2] != 0) {
        ...
        if (CockpitIL_2_1940.this.fm.CT.saveWeaponControl[3] != 0) {
