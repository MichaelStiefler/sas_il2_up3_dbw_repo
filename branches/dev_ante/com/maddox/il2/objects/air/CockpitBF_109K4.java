...
public class CockpitBF_109K4 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_EngTemp1", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].tOilOut, 20.0F, 120.0F, 13.0F, 53.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_EngTemp2", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].tWaterOut, 20.0F, 120.0F, 13.0F, 53.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPress1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 3.0F, 0.0F, 120.0F), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_OilPress1", cvt(1.0F + 0.05F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].tOilOut, 0.0F, 15.0F, 0.0F, 120.0F), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Variometr", 0.0F, 0.0F, -floatindex(cvt(this.setNew.vspeed, -30.0F, 30.0F, 0.0F, 12.0F), variometerScale));
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearHRed1", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() == 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearHGreen1", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() == 1.0F);
    if (this.gun[0] != null)
    ...
    if (this.gun[2] != null)
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_AmmoCounter2", cvt(this.gun[2].countBullets(), 0.0F, 500.0F, 15.0F, 0.0F), 0.0F, 0.0F);
  ...
  static
  {
    Property.set(CockpitBF_109K4.class, "normZN", 0.4F);
    Property.set(CockpitBF_109K4.class, "gsZN", 0.4F);
  }
  ...
  private class Variables
  {
    ...
    float mix;
    float vspeed;
    private final CockpitBF_109K4 this$0;
    ...
    Variables(CockpitBF_109K4.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      CockpitBF_109K4.access$002(CockpitBF_109K4.this, CockpitBF_109K4.this.setOld);
      CockpitBF_109K4.access$102(CockpitBF_109K4.this, CockpitBF_109K4.this.setNew);
      CockpitBF_109K4.access$202(CockpitBF_109K4.this, CockpitBF_109K4.this.setTmp);
      CockpitBF_109K4.this.setNew.altimeter = CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_109K4.this.cockpitDimControl)
      {
        if (CockpitBF_109K4.this.setOld.dimPosition > 0.0F)
          CockpitBF_109K4.this.setOld.dimPosition = (CockpitBF_109K4.this.setTmp.dimPosition - 0.05F);
      }
      else if (CockpitBF_109K4.this.setOld.dimPosition < 1.0F)
        CockpitBF_109K4.this.setOld.dimPosition = (CockpitBF_109K4.this.setTmp.dimPosition + 0.05F);
      CockpitBF_109K4.this.setOld.throttle = ((10.0F * CockpitBF_109K4.this.setTmp.throttle + CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109K4.this.setOld.mix = ((8.0F * CockpitBF_109K4.this.setTmp.mix + CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109K4.this.setOld.azimuth = CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109K4.this.setTmp.azimuth > 270.0F) && (CockpitBF_109K4.this.setOld.azimuth < 90.0F))
        CockpitBF_109K4.this.setTmp.azimuth -= 360.0F;
      if ((CockpitBF_109K4.this.setTmp.azimuth < 90.0F) && (CockpitBF_109K4.this.setOld.azimuth > 270.0F))
        CockpitBF_109K4.this.setTmp.azimuth += 360.0F;
      CockpitBF_109K4.this.setOld.waypointAzimuth = ((10.0F * CockpitBF_109K4.this.setTmp.waypointAzimuth + (CockpitBF_109K4.this.waypointAzimuth() - CockpitBF_109K4.this.setTmp.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitBF_109K4.this.setOld.vspeed = ((199.0F * CockpitBF_109K4.this.setTmp.vspeed + CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitBF_109K4.this.buzzerFX((CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.999999F) && (CockpitBF_109K4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.0F));
      return true;
    }
