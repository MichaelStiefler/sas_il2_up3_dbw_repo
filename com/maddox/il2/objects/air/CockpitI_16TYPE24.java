...
public class CockpitI_16TYPE24 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick() { if (CockpitI_16TYPE24.this.fm != null) {
        ...
        CockpitI_16TYPE24.this.setNew.throttle = ((10.0F * CockpitI_16TYPE24.this.setOld.throttle + CockpitI_16TYPE24.this.fm.CT.PowerControl) / 11.0F);
        CockpitI_16TYPE24.this.setNew.prop = ((10.0F * CockpitI_16TYPE24.this.setOld.prop + CockpitI_16TYPE24.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitI_16TYPE24.this.setNew.altimeter = CockpitI_16TYPE24.this.fm.getAltitude();
        if (Math.abs(CockpitI_16TYPE24.this.fm.Or.getKren()) < 30.0F) {
          CockpitI_16TYPE24.this.setNew.azimuth = ((35.0F * CockpitI_16TYPE24.this.setOld.azimuth + -CockpitI_16TYPE24.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        CockpitI_16TYPE24.this.setNew.vspeed = ((199.0F * CockpitI_16TYPE24.this.setOld.vspeed + CockpitI_16TYPE24.this.fm.getVertSpeed()) / 200.0F);
