...
public class CockpitME_410A extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float radioalt;
    private final CockpitME_410A this$0;
    ...
    Variables(CockpitME_410A.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      ...
      CockpitME_410A.access$002(CockpitME_410A.this, CockpitME_410A.this.setOld);
      CockpitME_410A.access$102(CockpitME_410A.this, CockpitME_410A.this.setNew);
      CockpitME_410A.access$202(CockpitME_410A.this, CockpitME_410A.this.setTmp);
      CockpitME_410A.this.setNew.altimeter = CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitME_410A.this.cockpitDimControl)
      {
        if (CockpitME_410A.this.setNew.dimPosition > 0.0F)
          CockpitME_410A.this.setNew.dimPosition -= 0.05F;
      }
      else if (CockpitME_410A.this.setNew.dimPosition < 1.0F)
        CockpitME_410A.this.setNew.dimPosition += 0.05F;
      CockpitME_410A.this.setNew.throttle1 = (0.91F * CockpitME_410A.this.setOld.throttle1 + 0.09F * CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitME_410A.this.setNew.throttle2 = (0.91F * CockpitME_410A.this.setOld.throttle2 + 0.09F * CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitME_410A.this.setNew.mix1 = (0.88F * CockpitME_410A.this.setOld.mix1 + 0.12F * CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitME_410A.this.setNew.mix2 = (0.88F * CockpitME_410A.this.setOld.mix2 + 0.12F * CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitME_410A.this.setNew.azimuth = CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitME_410A.this.setOld.azimuth > 270.0F) && (CockpitME_410A.this.setNew.azimuth < 90.0F))
        CockpitME_410A.this.setOld.azimuth -= 360.0F;
      if ((CockpitME_410A.this.setOld.azimuth < 90.0F) && (CockpitME_410A.this.setNew.azimuth > 270.0F))
        CockpitME_410A.this.setOld.azimuth += 360.0F;
      CockpitME_410A.this.setNew.waypointAzimuth = ((10.0F * CockpitME_410A.this.setOld.waypointAzimuth + (CockpitME_410A.this.waypointAzimuth() - CockpitME_410A.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitME_410A.Variables localVariables = CockpitME_410A.this.setNew;
      float f1 = 0.9F * CockpitME_410A.this.setOld.radioalt;
      float f2 = 0.1F;
      float f3 = CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      World.cur();
      World.land();
      localVariables.radioalt = (f1 + f2 * (f3 - Landscape.HQ_Air((float)CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.x, (float)CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y)));
      CockpitME_410A.this.setNew.vspeed = ((199.0F * CockpitME_410A.this.setOld.vspeed + CockpitME_410A.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitME_410A.access$302(CockpitME_410A.this, CockpitME_410A.this.middleAngleTarget * 0.05F + 0.95F * CockpitME_410A.this.middleAngle);
      return true;
    }
