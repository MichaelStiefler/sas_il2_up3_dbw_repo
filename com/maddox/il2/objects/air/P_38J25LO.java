...
public class P_38J25LO extends P_38
{
  ...
  static
  {
    Class localClass = P_38J25LO.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "P-38");

    Property.set(localClass, "meshNameDemo", "3DO/Plane/P-38J-25-LO(USA)/hier.him");

    Property.set(localClass, "meshName", "3DO/Plane/P-38J-25-LO(Multi1)/hier.him");

    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());

    Property.set(localClass, "meshName_us", "3DO/Plane/P-38J-25-LO(USA)/hier.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/P-38J-25-LO.fmd");
    ...
    {
      System.out.println("Error P38J25LO Weapons 'default ' NOT initialized:" + localException1.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons 'droptanks ' NOT initialized:" + localException2.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons 'droptanks2x3 ' NOT initialized:" + localException3.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons 'droptanks4x3 ' NOT initialized:" + localException4.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '1xdroptank1x500 ' NOT initialized:" + localException5.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '1xdroptank1x1000 ' NOT initialized:" + localException6.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '1xdroptank1x1600 ' NOT initialized:" + localException7.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '1xdroptank1x2000 ' NOT initialized:" + localException8.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '1xdroptank5x500 ' NOT initialized:" + localException9.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons 'droptanks 2x500 ' NOT initialized:" + localException10.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons 'droptanks 2x5002x250 ' NOT initialized:" + localException11.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons 'droptanks 4x500 ' NOT initialized:" + localException12.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '4x250 ' NOT initialized:" + localException13.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '6x250 ' NOT initialized:" + localException14.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x500 ' NOT initialized:" + localException15.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '4x500 ' NOT initialized:" + localException16.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '6x500 ' NOT initialized:" + localException17.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x1000 ' NOT initialized:" + localException18.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x10002x500 ' NOT initialized:" + localException19.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x10004x500 ' NOT initialized:" + localException20.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x1600 ' NOT initialized:" + localException21.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x2000 ' NOT initialized:" + localException22.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x175Napalm ' NOT initialized:" + localException23.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '2x3 ' NOT initialized:" + localException24.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons '4x3 ' NOT initialized:" + localException25.getMessage());
    }
    ...
    {
      System.out.println("Error P38J25LO Weapons 'none ' NOT initialized:" + localException26.getMessage());
    }
  }
}