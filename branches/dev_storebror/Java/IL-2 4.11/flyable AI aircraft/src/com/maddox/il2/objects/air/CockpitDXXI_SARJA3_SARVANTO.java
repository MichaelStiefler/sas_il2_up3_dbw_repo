// Source File Name: CockpitDXXI_SARJA3_SARVANTO.java
...
public class CockpitDXXI_SARJA3_SARVANTO extends CockpitPilot {
	private class Variables {
		...
		private Variables() {
			...
			cP = new Vector3d[4];
			compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ),
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
			compassPoint[1] = new Vector3d(-Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ), 0.0D,
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
			compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ),
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
			compassPoint[3] = new Vector3d(Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ), 0.0D,
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
			cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ),
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
			cP[1] = new Vector3d(-Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ), 0.0D,
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
			cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ),
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
			cP[3] = new Vector3d(Math.sqrt(1.0D
					- CockpitDXXI_SARJA3_SARVANTO.compassZ
					* CockpitDXXI_SARJA3_SARVANTO.compassZ), 0.0D,
					CockpitDXXI_SARJA3_SARVANTO.compassZ);
		}
		...
		public boolean tick() {
			...
			if (useRealisticNavigationInstruments())
				setNew.azimuth.setDeg(setOld.azimuth.getDeg(1.0F),
						fm.Or.azimut() + ac.gyroDelta);
			else
				setNew.azimuth.setDeg(setOld.azimuth.getDeg(1.0F),
						fm.Or.azimut());
			setNew.throttle = (10F * setOld.throttle + fm.EI.engines[0]
			...
			pictSupc = 0.8F * pictSupc + 0.2F
					* (float) fm.EI.engines[0].getControlCompressor();
	...
	public CockpitDXXI_SARJA3_SARVANTO() {
		...
		cockpitNightMats = (new String[] { "gyro", "gauge_speed", "gauge_alt",
				"gauge_fuel", "gauges_various_1", "gauges_various_2",
				"LABELS1", "gauges_various_3", "gauges_various_4",
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (((DXXI_SARJA3_SARVANTO) aircraft()).bChangedPit) {
			reflectPlaneToModel();
			((DXXI_SARJA3_SARVANTO) aircraft()).bChangedPit = false;
		}
		mesh.chunkSetAngles("Z_reviIron", 90F * setNew.stbyPosition, 0.0F, 0.0F);
		mesh.chunkSetAngles(
				"Z_Need_manifold",
				cvt(pictManifold = 0.85F * pictManifold + 0.15F
						* fm.EI.engines[0].getManifoldPressure() * 76F, 30F,
						120F, 22F, 296F), 0.0F, 0.0F);
		f1 = -15F
				* (pictAiler = 0.85F * pictAiler + 0.15F * fm.CT.AileronControl);
		...
		mesh.chunkSetAngles("Z_Throttle",
				-70F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Mixture",
				-70F * interp(setNew.mix, setOld.mix, f), 0.0F, 0.0F);
		mesh.chunkSetAngles(
				"Z_Need_alt1",
				cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F,
						10000F, 0.0F, 7200F), 0.0F, 0.0F);
		mesh.chunkSetAngles(
				"Z_Need_alt2",
				cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F,
						10000F, 0.0F, 720F), 0.0F, 0.0F);
		float f4 = Pitot.Indicator((float) fm.Loc.z, fm.getSpeedKMH());
		if (f4 < 80F)
			mesh.chunkSetAngles("Z_Need_speed", cvt(f4, 0.0F, 80F, 0.0F, -11F),
					0.0F, 0.0F);
		else if (f4 < 120F)
			mesh.chunkSetAngles("Z_Need_speed", cvt(f4, 80F, 120F, -11F, -40F),
					0.0F, 0.0F);
		else if (f4 < 160F)
			mesh.chunkSetAngles("Z_Need_speed",
					cvt(f4, 120F, 160F, -40F, -78.5F), 0.0F, 0.0F);
		else if (f4 < 200F)
			mesh.chunkSetAngles("Z_Need_speed",
					cvt(f4, 160F, 200F, -78.5F, -130.5F), 0.0F, 0.0F);
		else if (f4 < 360F)
			mesh.chunkSetAngles("Z_Need_speed",
					cvt(f4, 200F, 360F, -130.5F, -329F), 0.0F, 0.0F);
		else
			mesh.chunkSetAngles("Z_Need_speed",
					cvt(f4, 360F, 600F, -329F, -550F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_gyro", setNew.azimuth.getDeg(f), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_clock_hour",
				-cvt(World.getTimeofDay(), 0.0F, 24F, 0.0F, -720F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_clock_minute",
				-cvt(World.getTimeofDay() % 1.0F, 0.0F, 1.0F, 0.0F, -360F),
				0.0F, 0.0F);
		mesh.chunkSetAngles(
				"Z_Need_clock_sec",
				-cvt(((World.getTimeofDay() % 1.0F) * 60F) % 1.0F, 0.0F, 1.0F,
						0.0F, -360F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_fuel",
				-cvt(fm.M.fuel, 0.0F, 300F, 0.0F, 52F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_oiltemp",
				cvt(fm.EI.engines[0].tOilIn, 0.0F, 100F, 0.0F, 329F), 0.0F,
				0.0F);
		f1 = fm.EI.engines[0].getRPM();
		mesh.chunkSetAngles("Z_Need_rpm", cvt(f1, 440F, 3320F, 0.0F, -332F),
				0.0F, 0.0F);
		if (fm.Or.getKren() < -110F || fm.Or.getKren() > 110F)
			rpmGeneratedPressure = rpmGeneratedPressure - 2.0F;
		else if (f1 < rpmGeneratedPressure)
			rpmGeneratedPressure = rpmGeneratedPressure
					- (rpmGeneratedPressure - f1) * 0.01F;
		else
			rpmGeneratedPressure = rpmGeneratedPressure
					+ (f1 - rpmGeneratedPressure) * 0.001F;
		...
		float f5 = 0.0F;
		if (fm.EI.engines[0].tOilIn > 90F)
			f5 = cvt(fm.EI.engines[0].tOilIn, 90F, 110F, 1.1F, 1.5F);
		else if (fm.EI.engines[0].tOilIn < 50F)
			f5 = cvt(fm.EI.engines[0].tOilIn, 0.0F, 50F, 2.0F, 0.9F);
		else
			f5 = cvt(fm.EI.engines[0].tOilIn, 50F, 90F, 0.9F, 1.1F);
		float f6 = f5 * fm.EI.engines[0].getReadyness() * oilPressure;
		mesh.chunkSetAngles("Z_Need_oilpressure",
				cvt(f6, 0.0F, 7F, 0.0F, 315F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_cylheadtemp",
				cvt(fm.EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 110F), 0.0F,
				0.0F);
		mesh.chunkSetAngles("Z_Need_fuelpressure",
				cvt(rpmGeneratedPressure, 0.0F, 1800F, 0.0F, 65F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_magneto",
				-30F * (float) fm.EI.engines[0].getControlMagnetos(), 0.0F,
				0.0F);
		resetYPRmodifier();
		Cockpit.xyz[1] = -cvt(fm.Or.getTangage(), -20F, 20F, 0.04F, -0.04F);
		mesh.chunkSetLocate("Z_Need_red_liquid", Cockpit.xyz, Cockpit.ypr);
		mesh.chunkSetAngles("Z_Need_Turn",
				-cvt(setNew.turn, -0.2F, 0.2F, -30F, 30F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_bank",
				-cvt(getBall(8D), -8F, 8F, 14F, -14F), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Need_variometer",
				-cvt(setNew.vspeed, -20F, 20F, 180F, -180F), 0.0F, 0.0F);
		...
		if (ac.tiltCanopyOpened) {
			...
			mesh.chunkSetAngles("Z_sliding_window_L",
					cvt(ac.canopyF, 0.0F, 1.0F, 0.0F, 0.75F), 0.0F, 0.0F);
		}
		...
		mesh.chunkSetAngles("Z_trim_indicator",
				1.9F * -fm.CT.getTrimElevatorControl(), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_trim_wheel",
				600F * fm.CT.getTrimElevatorControl(), 0.0F, 0.0F);
		if (fm.CT.bHasBrakeControl) {
			float f2 = fm.CT.getBrake();
			mesh.chunkSetAngles("Z_break_handle", f2 * 12F + 12F, 0.0F, 0.0F);
			mesh.chunkSetAngles("Z_Need_breakpressureR",
					cvt(f2 + f2 * fm.CT.getRudder(), 0.0F, 1.5F, 0.0F, 148F),
					0.0F, 0.0F);
			mesh.chunkSetAngles("Z_Need_breakpressureL",
					-cvt(f2 - f2 * fm.CT.getRudder(), 0.0F, 1.5F, 0.0F, 148F),
					0.0F, 0.0F);
			mesh.chunkSetAngles("Z_Need_breakpressure1", -150F + f2 * 20F,
					0.0F, 0.0F);
		}
		...
		if (tailWheelLock >= 1.0F) {
			...
			mesh.chunkSetAngles("Z_tailwheel_lever_wire", tailWheelLock * 57F,
					0.0F, 7F);
		} else {
		...
		mesh.chunkSetAngles("Z_Need_extinguisher",
				(float) fm.EI.engines[0].getExtinguishers() * 95F, 0.0F, 0.0F);
		if (hasRevi) {
			mesh.chunkSetAngles(
					"Z_reviDimmer",
					-cvt(interp(setNew.dimPos, setOld.dimPos, f), 0.0F, 1.0F,
							0.0F, -90F), 0.0F, 0.0F);
			mesh.chunkSetAngles(
					"Z_reviDimmerLever",
					-cvt(interp(setNew.dimPos, setOld.dimPos, f), 0.0F, 1.0F,
							0.0F, 0.004F), 0.0F, 0.0F);
		} else {
			float f3 = cvt(interp(setNew.dimPos, setOld.dimPos, f), 0.0F, 1.0F,
					0.0F, -130F);
		...
		mesh.chunkSetAngles("Z_trigger",
				1.6F * (float) (fm.CT.saveWeaponControl[0] ? 1 : 0), 0.0F, 0.0F);
	}
	...
	private void initCompass() {
		...
		compassNorth = new Vector3d(0.0D,
				Math.cos(0.017452777777777779D * (double) f1),
				-Math.sin(0.017452777777777779D * (double) f1));
		compassSouth = new Vector3d(0.0D,
				-Math.cos(0.017452777777777779D * (double) f1),
				Math.sin(0.017452777777777779D * (double) f1));
		...
		compassSc = 0.10193679899999999D / (double) Time.tickLenFs()
	...
	private void updateCompass() {
		...
		vector3d4.normalize();
		float f = (float) (vector3d4.x * vector3d4.x + vector3d4.y
				* vector3d4.y);
		...
		mesh.chunkSetAngles("Z_Need_compassBase",
				-(float) ((d2 * 180D) / 3.1415926000000001D),
				-(float) ((d3 * 180D) / 3.1415926000000001D), 0.0F);
		mesh.chunkSetAngles("Z_Need_compass", 0.0F,
	...
	private DXXI_SARJA3_SARVANTO ac;
	...
	private final Point3d reviAimPoint = new Point3d(-0.87D, 0.0028D,
			0.80279999999999996D);
