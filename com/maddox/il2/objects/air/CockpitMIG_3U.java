...
public class CockpitMIG_3U extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMIG_3U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitMIG_3U.access$102(CockpitMIG_3U.this, CockpitMIG_3U.this.setOld); CockpitMIG_3U.access$202(CockpitMIG_3U.this, CockpitMIG_3U.this.setNew); CockpitMIG_3U.access$302(CockpitMIG_3U.this, CockpitMIG_3U.this.setTmp);

        CockpitMIG_3U.this.setNew.throttle = ((10.0F * CockpitMIG_3U.this.setOld.throttle + CockpitMIG_3U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitMIG_3U.this.setNew.prop = ((10.0F * CockpitMIG_3U.this.setOld.prop + CockpitMIG_3U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitMIG_3U.this.setNew.altimeter = CockpitMIG_3U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitMIG_3U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitMIG_3U.this.setNew.azimuth = ((35.0F * CockpitMIG_3U.this.setOld.azimuth + CockpitMIG_3U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitMIG_3U.this.setOld.azimuth > 270.0F) && (CockpitMIG_3U.this.setNew.azimuth < 90.0F)) CockpitMIG_3U.this.setOld.azimuth -= 360.0F;
        if ((CockpitMIG_3U.this.setOld.azimuth < 90.0F) && (CockpitMIG_3U.this.setNew.azimuth > 270.0F)) CockpitMIG_3U.this.setOld.azimuth += 360.0F;
        CockpitMIG_3U.this.setNew.vspeed = ((199.0F * CockpitMIG_3U.this.setOld.vspeed + CockpitMIG_3U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitMIG_3U this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitMIG_3U.1 arg2) { this();
    }
  }
}