...
public class IL_4_DB3M extends IL_4 implements TypeBomber {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitDB3M.class,
				CockpitDB3M_Bombardier.class, CockpitDB3M_FGunner.class,
				CockpitDB3M_TGunner.class, CockpitDB3M_BGunner.class });
