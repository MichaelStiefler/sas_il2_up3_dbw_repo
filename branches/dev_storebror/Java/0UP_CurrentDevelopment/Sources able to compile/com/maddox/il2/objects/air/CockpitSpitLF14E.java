...
public class CockpitSpitLF14E extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f = ((SPITFIRELF14E)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitSpitLF14E.k14TargetWingspanScale[((SPITFIRELF14E)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSpitLF14E.k14TargetMarkScale[((SPITFIRELF14E)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((SPITFIRELF14E)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, CockpitSpitLF14E.k14BulletDrop) - CockpitSpitLF14E.k14BulletDrop[0];
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitSpitLF14E.class, "normZN", 0.72F);
        com.maddox.rts.Property.set(CockpitSpitLF14E.class, "gsZN", 0.66F);
    }
