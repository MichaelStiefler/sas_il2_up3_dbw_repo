  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      if (CockpitSpit9C.this.fm != null) {
        ...
        if (Math.abs(CockpitSpit9C.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit9C.this.setNew.azimuth = (0.97F * CockpitSpit9C.this.setOld.azimuth + 0.03F * -CockpitSpit9C.this.fm.Or.getYaw());
        }
