...
// Source File Name:   CockpitBLENHEIM4F_TGunner.java
...
public class CockpitBLENHEIM4F_TGunner extends com.maddox.il2.objects.air.CockpitGunner
{
    ...
    protected void interpTick()
    {
        if(isRealMode())
        {
            ...
            if(bGunFire)
            {
                ...
                if(hook2 == null)
                    hook2 = ((com.maddox.il2.engine.Hook) (new HookNamed(((com.maddox.il2.engine.ActorMesh) (aircraft())), "_MGUN07")));
    ...
    static java.lang.Class class$com$maddox$il2$objects$air$CockpitBLENHEIM4F_TGunner;
