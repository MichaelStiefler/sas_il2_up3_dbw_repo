...
public class CockpitFW_190A1 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(gun[0] == null)
        {
            ...
            gun[2] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON03");
            gun[3] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON04");
            gun[4] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON01");
            gun[5] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON02");
        }
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.43F);
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, -0.33F);
        ...
        if(gun[2] != null)
        {
            ...
            super.mesh.chunkSetLocate("RC_MGFF_WingL", Cockpit.xyz, Cockpit.ypr);
        }
        if(gun[3] != null)
        {
            Cockpit.xyz[0] = cvt(gun[3].countBullets(), 0.0F, 55F, -0.018F, 0.0F);
            super.mesh.chunkSetLocate("RC_MGFF_WingR", Cockpit.xyz, Cockpit.ypr);
        }
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = cvt(interp(setNew.dimPosition, setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 0.058F);
        super.mesh.chunkSetLocate("Revi16Tinter", Cockpit.xyz, Cockpit.ypr);
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitFW_190A1.class, "normZN", 0.72F);
        com.maddox.rts.Property.set(CockpitFW_190A1.class, "gsZN", 0.66F);
    }
