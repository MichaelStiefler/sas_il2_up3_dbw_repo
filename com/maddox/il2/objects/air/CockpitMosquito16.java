...
public class CockpitMosquito16 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    this.mesh.chunkSetAngles("Columnbase", 0.0F, (this.pictElev = 0.85F * this.pictElev + 0.15F * this.fm.CT.ElevatorControl) * 8.0F, 0.0F);

    this.mesh.chunkSetAngles("Column", 0.0F, (this.pictAiler = 0.85F * this.pictAiler + 0.15F * this.fm.CT.AileronControl) * 57.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_Compass2", this.setNew.azimuth.getDeg(paramFloat) + this.setNew.waypointAzimuth.getDeg(paramFloat) + 90.0F, 0.0F, 0.0F);
    ...
    resetYPRmodifier();
    Cockpit.xyz[1] = cvt(this.fm.Or.getTangage(), -45.0F, 45.0F, 0.02355F, -0.02355F);
  ...
  private class Variables
  {
    ...
    float wiper;
    private final CockpitMosquito16 this$0;
    ...
    Variables(CockpitMosquito16.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMosquito16.this.fm != null) {
        CockpitMosquito16.access$102(CockpitMosquito16.this, CockpitMosquito16.this.setOld);
        CockpitMosquito16.access$202(CockpitMosquito16.this, CockpitMosquito16.this.setNew);
        CockpitMosquito16.access$302(CockpitMosquito16.this, CockpitMosquito16.this.setTmp);
        ...
        case 0:
          if ((Mission.curCloudsType() <= 4) || (CockpitMosquito16.this.fm.getSpeedKMH() >= 220.0F) || (CockpitMosquito16.this.fm.getAltitude() >= Mission.curCloudsHeight() + 300.0F))
          {
            break;
          }
          CockpitMosquito16.access$402(CockpitMosquito16.this, 1); break;
        case 1:
          ...
          if (CockpitMosquito16.this.setNew.wiper < -1.03F)
            CockpitMosquito16.access$408(CockpitMosquito16.this);
          if (CockpitMosquito16.this.wiState >= 2) break;
          if (CockpitMosquito16.this.wiState == 0) {
            if (CockpitMosquito16.this.fxw == null) {
              CockpitMosquito16.access$602(CockpitMosquito16.this, CockpitMosquito16.this.aircraft().newSound("aircraft.wiper", false));
          ...
          if (CockpitMosquito16.this.fxw == null) break;
          CockpitMosquito16.this.fxw.play(CockpitMosquito16.this.wiRun);
          CockpitMosquito16.access$502(CockpitMosquito16.this, 2); break;
        case 2:
          CockpitMosquito16.this.setNew.wiper = (CockpitMosquito16.this.setOld.wiper + 0.05F);
          if (CockpitMosquito16.this.setNew.wiper > 1.03F)
            CockpitMosquito16.access$408(CockpitMosquito16.this);
          if (CockpitMosquito16.this.wiState <= 1) break;
          CockpitMosquito16.access$502(CockpitMosquito16.this, 1); break;
        case 3:
          CockpitMosquito16.this.setNew.wiper = (CockpitMosquito16.this.setOld.wiper - 0.05F);
          if (CockpitMosquito16.this.setNew.wiper >= 0.02F) break;
          if ((CockpitMosquito16.this.fm.getSpeedKMH() > 250.0F) || (CockpitMosquito16.this.fm.getAltitude() > Mission.curCloudsHeight() + 400.0F))
          {
            CockpitMosquito16.access$408(CockpitMosquito16.this);
          }
          else CockpitMosquito16.access$402(CockpitMosquito16.this, 1); break;
        case 4:
          CockpitMosquito16.this.setNew.wiper = CockpitMosquito16.this.setOld.wiper;
          CockpitMosquito16.access$402(CockpitMosquito16.this, 0);
          CockpitMosquito16.access$502(CockpitMosquito16.this, 0);
          if (CockpitMosquito16.this.fxw == null) break;
