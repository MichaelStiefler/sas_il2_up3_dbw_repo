    ...
    implements com.maddox.il2.objects.ActorAlign
{
    ...
    private SmokeGeneric(com.maddox.il2.objects.vehicles.stationary.SmokeProperties smokeproperties, com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        ...
        eff = com.maddox.il2.engine.Eff3DActor.New(this, null, new Loc(0.0D, 0.0D, 0.0D, 0.0F, 90F, 0.0F), 1.0F, prop.effectName, -1F);
    }
    ...
    public void setVisible(boolean flag)
    {
        setArmy(0);
        if(flag)
            eff._setIntesity(1.0F);
        else
            eff._setIntesity(0.0F);
    }
    ...
    private com.maddox.il2.engine.Eff3DActor eff;
