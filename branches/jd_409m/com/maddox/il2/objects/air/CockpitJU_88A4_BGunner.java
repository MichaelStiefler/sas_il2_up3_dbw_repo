  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitJU_88A4_BGunner.access$102(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.setOld); CockpitJU_88A4_BGunner.access$202(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.setNew); CockpitJU_88A4_BGunner.access$302(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.setTmp);
        ...
        if (CockpitJU_88A4_BGunner.this.cockpitDimControl) {
          if (CockpitJU_88A4_BGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88A4_BGunner.this.setNew.dimPosition = (CockpitJU_88A4_BGunner.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitJU_88A4_BGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88A4_BGunner.this.setNew.dimPosition = (CockpitJU_88A4_BGunner.this.setOld.dimPosition + 0.05F);
        ...
        CockpitJU_88A4_BGunner.access$402(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
