...
public class CockpitF6F3 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if ((this.fm.AS.astateCockpitState & 0x40) == 0)
      ...
      this.mesh.chunkSetAngles("Z_RPM1", cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 7000.0F, 0.0F, 278.0F), 0.0F, 0.0F);
    }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF6F3.this.fm != null) {
        ...
        float f = CockpitF6F3.this.waypointAzimuth(10.0F);
        ...
        CockpitF6F3.this.setNew.vspeed = ((199.0F * CockpitF6F3.this.setOld.vspeed + CockpitF6F3.this.fm.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
