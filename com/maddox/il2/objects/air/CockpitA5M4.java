...
public class CockpitA5M4 extends CockpitPilot
{
  ...
  public CockpitA5M4() {
    super("3DO/Cockpit/Ki-27(Otsu)/CockpitA5M4.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    if (Math.abs(f2) < 5.0F) {
      this.mesh.chunkSetAngles("Z_Climb1", cvt(f2, -5.0F, 5.0F, 90.0F, -90.0F), 0.0F, 0.0F);
    }
    else if (f2 > 0.0F) {
      this.mesh.chunkSetAngles("Z_Climb1", cvt(f2, 5.0F, 30.0F, -90.0F, -180.0F), 0.0F, 0.0F);
    }
    else
    {
      this.mesh.chunkSetAngles("Z_Climb1", cvt(f2, -30.0F, -5.0F, 180.0F, 90.0F), 0.0F, 0.0F);
    }
    ...
    f2 = cvt(1.0F + 0.05F * this.fm.EI.engines[0].tOilOut, 0.0F, 8.1F, 0.0F, 20.0F);

    for (int i = 1; i < 20; i++) {
      this.mesh.chunkVisible("Z_OilP" + (i < 10 ? "0" + i : new StringBuffer().append("").append(i).toString()), f2 > 20 - i);
    }
  ...
  private class Variables
  {
    ...
    private final CockpitA5M4 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA5M4.this.fm != null) {
        CockpitA5M4.access$102(CockpitA5M4.this, CockpitA5M4.this.setOld);
        CockpitA5M4.access$202(CockpitA5M4.this, CockpitA5M4.this.setNew);
        CockpitA5M4.access$302(CockpitA5M4.this, CockpitA5M4.this.setTmp);
        ...
        CockpitA5M4.this.setNew.waypointDeviation.setDeg(CockpitA5M4.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitA5M4.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-5.0F, 5.0F));
