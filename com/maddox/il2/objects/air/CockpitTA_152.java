...
public class CockpitTA_152 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(fm.CT.GearControl == 0.0F)
            com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.02F;
        ...
        float f2 = fm.M.nitro / fm.M.maxNitro;
        f2 = (float)java.lang.Math.sqrt(f2);
        mesh.chunkSetAngles("NeedleMW50Press", cvt(f2, 0.0F, 0.5F, 0.0F, 260F), 0.0F, 0.0F);
        resetYPRmodifier();
        if(gun[0] != null)
        {
