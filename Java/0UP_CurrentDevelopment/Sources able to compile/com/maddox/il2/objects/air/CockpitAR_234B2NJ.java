...
public class CockpitAR_234B2NJ extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("zAltWheel", 0.0F, cvt(((AR_234B2NJ)aircraft()).fSightCurAltitude, 0.0F, 6000F, 0.0F, 225F), 0.0F);
        mesh.chunkSetAngles("zAnglePointer", 0.0F, cvt(((AR_234B2NJ)aircraft()).fSightCurForwardAngle, 0.0F, 60F, 105F, 0.0F), 0.0F);
        mesh.chunkSetAngles("zAngleWheel", 0.0F, -10F * ((AR_234B2NJ)aircraft()).fSightCurForwardAngle, 0.0F);
        mesh.chunkSetAngles("zSpeedPointer", 0.0F, cvt(((AR_234B2NJ)aircraft()).fSightCurSpeed, 150F, 600F, 0.0F, 60F), 0.0F);
        mesh.chunkSetAngles("zSpeedWheel", 0.0F, 0.333F * ((AR_234B2NJ)aircraft()).fSightCurSpeed, 0.0F);
        resetYPRmodifier();
