...
public class Chat extends com.maddox.rts.NetObj
{
        ...
        implements com.maddox.rts.NetSpawn
    {
        ...
        public void netSpawn(int i, com.maddox.rts.NetMsgInput netmsginput)
        {
            ...
            {
                com.maddox.il2.net.Chat.printDebug(exception);
            }
        }
    ...
    private void addMsg(com.maddox.il2.net.ChatMessage chatmessage)
    {
        ...
        if(chatmessage.msg != null && (chatmessage.msg.startsWith("Morse:") || chatmessage.msg.startsWith("morse:")))
        {
            try
            {
                if(!com.maddox.il2.ai.World.cur().blockMorseChat)
                    com.maddox.il2.ai.World.getPlayerAircraft().playChatMsgAsMorse(chatmessage.msg);
            }
            catch(java.lang.Exception exception)
            {
