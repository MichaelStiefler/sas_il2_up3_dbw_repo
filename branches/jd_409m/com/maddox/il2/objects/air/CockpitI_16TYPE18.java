...
public class CockpitI_16TYPE18 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick() { if (CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitI_16TYPE18.this.setNew.throttle = ((10.0F * CockpitI_16TYPE18.this.setOld.throttle + CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        CockpitI_16TYPE18.this.setNew.prop = ((10.0F * CockpitI_16TYPE18.this.setOld.prop + CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitI_16TYPE18.this.setNew.altimeter = CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitI_16TYPE18.this.setNew.azimuth = ((35.0F * CockpitI_16TYPE18.this.setOld.azimuth + -CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        ...
        CockpitI_16TYPE18.this.setNew.vspeed = ((199.0F * CockpitI_16TYPE18.this.setOld.vspeed + CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);

        boolean bool = false;

        if (CockpitI_16TYPE18.this.setNew.gCrankAngle < CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() - 0.005F) {
          if (Math.abs(CockpitI_16TYPE18.this.setNew.gCrankAngle - CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) < 0.33F) {
            CockpitI_16TYPE18.this.setNew.gCrankAngle += 0.0025F;
            bool = true;
          } else {
            CockpitI_16TYPE18.this.setNew.gCrankAngle = CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear();
            CockpitI_16TYPE18.this.setOld.gCrankAngle = CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear();
          }
        }
        if (CockpitI_16TYPE18.this.setNew.gCrankAngle > CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() + 0.005F) {
          if (Math.abs(CockpitI_16TYPE18.this.setNew.gCrankAngle - CockpitI_16TYPE18.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) < 0.33F) {
