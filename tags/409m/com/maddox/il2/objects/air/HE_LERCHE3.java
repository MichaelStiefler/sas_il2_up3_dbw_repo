    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeX4Carrier
{
    ...
    {
        resetYPRmodifier();
        com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.63F, 0.0F, 0.63F);
        hierMesh().chunkSetLocate("GearL2_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.63F, 0.0F, 0.63F);
        hierMesh().chunkSetLocate("GearR2_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.63F, 0.0F, 0.63F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                if(s.endsWith("p1"))
                {
                    getEnergyPastArmor(65.989997863769531D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                    if(shot.power <= 0.0F)
                        doRicochetBack(shot);
                } else
                if(s.endsWith("p2"))
                ...
                if(s.endsWith("g1"))
                {
                    getEnergyPastArmor(34.209999084472656D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
            ...
            {
                int i = s.charAt(5) - 49;
                com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine Module (" + i + "): Hit..");
                if(s.endsWith("prop"))
                {
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(2.1F, shot) > 0.0F)
                    {
                        ...
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                        {
                            ...
                            com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine Module: Crank Case Hit, Readyness Reduced to " + FM.EI.engines[i].getReadyness() + "..");
                        }
                ...
                if(s.startsWith("xxeng1cyl") || s.startsWith("xxeng2cyl"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[i].getCylindersRatio() * 1.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine Module: Cylinders Hit, " + FM.EI.engines[i].getCylindersOperable() + "/" + FM.EI.engines[i].getCylinders() + " Left..");
            ...
            if(s.startsWith("xxrad"))
            {
                if(getEnergyPastArmor(2.2F, shot) > 0.0F)
                {
                    ...
                    if(k < 3)
                    {
                        ...
                        com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine Module A: Oil Radiator Hit..");
                    } else
                    {
                        FM.AS.hitOil(shot.initiator, 1);
                        com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine Module B: Oil Radiator Hit..");
                    }
                }
                return;
            }
    ...
    public void update(float f)
    {
        boolean flag = false;
        super.update(f);
        FM.setGCenter(com.maddox.il2.objects.air.Aircraft.cvt(FM.getSpeedKMH(), 0.0F, 240F, -10.5F, 0.0F));
        float f1 = FM.CT.getAirBrake();
        if(java.lang.Math.abs(pictVBrake - f1) > 0.001F)
        {
            pictVBrake = f1;
            resetYPRmodifier();
            com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(pictVBrake, 0.0F, 1.0F, 0.0F, 0.525F);
            for(int i = 1; i < 10; i++)
                hierMesh().chunkSetLocate("Flap0" + i + "A_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        ...
        float f4 = FM.EI.getPowerOutput() * com.maddox.il2.objects.air.Aircraft.cvt(FM.getSpeedKMH(), 0.0F, 600F, 2.0F, 0.0F);
        if(FM.CT.getAirBrake() > 0.5F)
        {
            if(FM.Or.getTangage() > 5F)
            {
                ...
                if(java.lang.Math.abs(FM.Or.getKren()) > 90F)
                    f3 = 90F + (90F - f3);
                float f5 = f3 - 90F;
                FM.CT.trimElevator = com.maddox.il2.objects.air.Aircraft.cvt(f5, -20F, 20F, 0.5F, -0.5F);
                f5 = FM.Or.getKren();
                if(java.lang.Math.abs(f5) > 90F)
                    if(f5 > 0.0F)
                        ...
                        f5 = -180F - f5;
                FM.CT.trimAileron = com.maddox.il2.objects.air.Aircraft.cvt(f5, -20F, 20F, 0.5F, -0.5F);
                FM.CT.trimRudder = com.maddox.il2.objects.air.Aircraft.cvt(f5, -15F, 15F, 0.04F, -0.04F);
            }
        } else
        {
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "3x4", new java.lang.String[] {
