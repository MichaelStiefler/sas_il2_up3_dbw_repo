...
public class CockpitFW_190F8 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW_190F8.this.fm != null) {
        ...
        CockpitFW_190F8.this.setNew.throttle = ((10.0F * CockpitFW_190F8.this.setOld.throttle + CockpitFW_190F8.this.fm.CT.PowerControl) / 11.0F);
        CockpitFW_190F8.this.setNew.vspeed = ((499.0F * CockpitFW_190F8.this.setOld.vspeed + CockpitFW_190F8.this.fm.getVertSpeed()) / 500.0F);

        float f = CockpitFW_190F8.this.waypointAzimuth();
        if (CockpitFW_190F8.this.useRealisticNavigationInstruments())
        {
          CockpitFW_190F8.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
          CockpitFW_190F8.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
        }
        else
        {
        ...
        CockpitFW_190F8.this.setNew.turn = ((12.0F * CockpitFW_190F8.this.setOld.turn + CockpitFW_190F8.this.w.z) / 13.0F);

        CockpitFW_190F8.this.setNew.beaconDirection = ((10.0F * CockpitFW_190F8.this.setOld.beaconDirection + CockpitFW_190F8.this.getBeaconDirection()) / 11.0F);
        CockpitFW_190F8.this.setNew.beaconRange = ((10.0F * CockpitFW_190F8.this.setOld.beaconRange + CockpitFW_190F8.this.getBeaconRange()) / 11.0F);
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    Variables(CockpitFW_190F8.1 arg2)
    {
      this();
    }
  }
