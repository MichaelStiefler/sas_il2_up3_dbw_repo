...
// Source File Name:   CockpitA6M7_63.java
...
public class CockpitA6M7_63 extends com.maddox.il2.objects.air.CockpitPilot
{
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(useRealisticNavigationInstruments())
                {
                    ...
                    setNew.waypointDirection.setDeg(setOld.waypointDirection.getDeg(0.1F), f);
                } else
                {
    ...
    {
        return super.waypointAzimuth(5F);
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Navigation", 0.0F, cvt(setNew.waypointAzimuth.getDeg(f * 0.2F) - 90F, -25F, 25F, -45F, 45F), 0.0F);
