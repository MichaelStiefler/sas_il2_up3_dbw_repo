      ...
      if (CockpitPE2_110.this.fm != null) {
        ...
        if (CockpitPE2_110.this.fm.CT.Weapons[3] != null) {
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 0) {
            CockpitPE2_110.this.bBombs[1] = (!CockpitPE2_110.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 1) {
            CockpitPE2_110.this.bBombs[0] = (!CockpitPE2_110.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 2) {
            CockpitPE2_110.this.bBombs[3] = (!CockpitPE2_110.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 3) {
            CockpitPE2_110.this.bBombs[2] = (!CockpitPE2_110.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 4) {
            CockpitPE2_110.this.bBombs[5] = (!CockpitPE2_110.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 5) {
            CockpitPE2_110.this.bBombs[4] = (!CockpitPE2_110.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 6) {
            CockpitPE2_110.this.bBombs[5] = ((CockpitPE2_110.this.bBombs[5] != 0) || (!CockpitPE2_110.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 7) {
            CockpitPE2_110.this.bBombs[4] = ((CockpitPE2_110.this.bBombs[4] != 0) || (!CockpitPE2_110.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 8) {
            CockpitPE2_110.this.bBombs[7] = (!CockpitPE2_110.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_110.this.fm.CT.Weapons[3].length > 9) {
            CockpitPE2_110.this.bBombs[6] = (!CockpitPE2_110.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
          }
        }
        ...
        CockpitPE2_110.this.setNew.vspeed = ((100.0F * CockpitPE2_110.this.setOld.vspeed + CockpitPE2_110.this.fm.getVertSpeed()) / 101.0F);
        ...
        CockpitPE2_110.this.setNew.inert = (0.999F * CockpitPE2_110.this.setOld.inert + 0.001F * (CockpitPE2_110.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
