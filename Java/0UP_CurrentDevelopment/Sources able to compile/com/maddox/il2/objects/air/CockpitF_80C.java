    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f = ((F_80C)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitF_80C.k14TargetWingspanScale[((F_80C)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitF_80C.k14TargetMarkScale[((F_80C)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((F_80C)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, CockpitF_80C.k14BulletDrop) - CockpitF_80C.k14BulletDrop[0];
