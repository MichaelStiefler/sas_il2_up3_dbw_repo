...
public class MC_200_3 extends com.maddox.il2.objects.air.MC_200xyz
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MC_200_3.weaponTriggersRegister(class1, new int[] {
            0, 0
        });
        com.maddox.il2.objects.air.MC_200_3.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02"
        });
        com.maddox.il2.objects.air.MC_200_3.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBredaSAFAT127siMC200 350", "MGunBredaSAFAT127siMC200 350"
        });
        com.maddox.il2.objects.air.MC_200_3.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
