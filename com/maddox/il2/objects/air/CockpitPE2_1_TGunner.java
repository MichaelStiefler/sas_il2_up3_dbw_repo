...
public class CockpitPE2_1_TGunner extends CockpitGunner
{
  ...
  public CockpitPE2_1_TGunner()
  {
    super("3DO/Cockpit/Pe-2series1-TGun/hier.him", "he111");
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_1_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitPE2_1_TGunner.access$102(CockpitPE2_1_TGunner.this, CockpitPE2_1_TGunner.this.setOld); CockpitPE2_1_TGunner.access$202(CockpitPE2_1_TGunner.this, CockpitPE2_1_TGunner.this.setNew); CockpitPE2_1_TGunner.access$302(CockpitPE2_1_TGunner.this, CockpitPE2_1_TGunner.this.setTmp);
        if (CockpitPE2_1_TGunner.this.eBombs[0] == null) {
          CockpitPE2_1_TGunner.this.eBombs[0] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_ExternalBomb01");
          CockpitPE2_1_TGunner.this.eBombs[1] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_ExternalBomb02");
          CockpitPE2_1_TGunner.this.eBombs[2] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_ExternalBomb03");
          CockpitPE2_1_TGunner.this.eBombs[3] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_ExternalBomb04");
          CockpitPE2_1_TGunner.this.eBombs[4] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_BombSpawn01");
          CockpitPE2_1_TGunner.this.eBombs[5] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_BombSpawn02");
          CockpitPE2_1_TGunner.this.eBombs[6] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_BombSpawn03");
          CockpitPE2_1_TGunner.this.eBombs[7] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_BombSpawn04");
          CockpitPE2_1_TGunner.this.eBombs[8] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_BombSpawn05");
          CockpitPE2_1_TGunner.this.eBombs[9] = CockpitPE2_1_TGunner.this.aircraft().getBulletEmitterByHookName("_BombSpawn06");
        }
        for (int i = 0; i < 10; i++) {
          CockpitPE2_1_TGunner.this.bBombs[i] = (!CockpitPE2_1_TGunner.this.eBombs[i].haveBullets() ? 1 : 0);
        }

        CockpitPE2_1_TGunner.this.setNew.man1 = (0.92F * CockpitPE2_1_TGunner.this.setOld.man1 + 0.08F * CockpitPE2_1_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());

        CockpitPE2_1_TGunner.this.setNew.man2 = (0.92F * CockpitPE2_1_TGunner.this.setOld.man2 + 0.08F * CockpitPE2_1_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitPE2_1_TGunner.this.setNew.altimeter = CockpitPE2_1_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitPE2_1_TGunner.this.setNew.azimuth.setDeg(CockpitPE2_1_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_1_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitPE2_1_TGunner.this.setNew.vspeed = ((100.0F * CockpitPE2_1_TGunner.this.setOld.vspeed + CockpitPE2_1_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);

        float f = CockpitPE2_1_TGunner.this.waypointAzimuth();

        CockpitPE2_1_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE2_1_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitPE2_1_TGunner.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitPE2_1_TGunner.this.setNew.waypointDirection.setDeg(CockpitPE2_1_TGunner.this.setOld.waypointDirection.getDeg(1.0F), f);

        CockpitPE2_1_TGunner.this.setNew.inert = (0.999F * CockpitPE2_1_TGunner.this.setOld.inert + 0.001F * (CockpitPE2_1_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitPE2_1_TGunner this$0;
    ...
    Variables(CockpitPE2_1_TGunner.1 arg2)
    {
      this();
    }
  }
