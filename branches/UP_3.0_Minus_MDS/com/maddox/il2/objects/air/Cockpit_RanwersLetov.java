...
public class Cockpit_RanwersLetov extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    private void updateCompass()
    {
        ...
        setNew.planeMove.set(((com.maddox.JGP.Tuple3d) (setNew.planeLoc)));
        setNew.planeMove.sub(((com.maddox.JGP.Tuple3d) (setOld.planeLoc)));
        accel.set(((com.maddox.JGP.Tuple3d) (setNew.planeMove)));
        accel.sub(((com.maddox.JGP.Tuple3d) (setOld.planeMove)));
        ...
        for(int i = 0; i < 4; i++)
        {
            compassSpeed[i].set(((com.maddox.JGP.Tuple3d) (setOld.compassPoint[i])));
            compassSpeed[i].sub(((com.maddox.JGP.Tuple3d) (setNew.compassPoint[i])));
        }
        ...
        vector3d.set(((com.maddox.JGP.Tuple3d) (setOld.compassPoint[0])));
        vector3d.add(((com.maddox.JGP.Tuple3d) (setOld.compassPoint[1])));
        vector3d.add(((com.maddox.JGP.Tuple3d) (setOld.compassPoint[2])));
        vector3d.add(((com.maddox.JGP.Tuple3d) (setOld.compassPoint[3])));
        vector3d.normalize();
        for(int k = 0; k < 4; k++)
        {
            com.maddox.JGP.Vector3d vector3d1 = new Vector3d();
            double d1 = vector3d.dot(((com.maddox.JGP.Tuple3d) (compassSpeed[k])));
            vector3d1.set(((com.maddox.JGP.Tuple3d) (vector3d)));
            d1 *= 0.28000000000000003D;
            vector3d1.scale(-d1);
            compassSpeed[k].add(((com.maddox.JGP.Tuple3d) (vector3d1)));
        }

        for(int l = 0; l < 4; l++)
            compassSpeed[l].add(((com.maddox.JGP.Tuple3d) (accel)));

        compassSpeed[0].add(((com.maddox.JGP.Tuple3d) (compassNorth)));
        compassSpeed[2].add(((com.maddox.JGP.Tuple3d) (compassSouth)));
        for(int i1 = 0; i1 < 4; i1++)
        {
            setNew.compassPoint[i1].set(((com.maddox.JGP.Tuple3d) (setOld.compassPoint[i1])));
            setNew.compassPoint[i1].add(((com.maddox.JGP.Tuple3d) (compassSpeed[i1])));
        }

        vector3d.set(((com.maddox.JGP.Tuple3d) (setNew.compassPoint[0])));
        vector3d.add(((com.maddox.JGP.Tuple3d) (setNew.compassPoint[1])));
        vector3d.add(((com.maddox.JGP.Tuple3d) (setNew.compassPoint[2])));
        vector3d.add(((com.maddox.JGP.Tuple3d) (setNew.compassPoint[3])));
        ...
        vector3d2.sub(((com.maddox.JGP.Tuple3d) (vector3d)));
        for(int j1 = 0; j1 < 4; j1++)
            setNew.compassPoint[j1].add(((com.maddox.JGP.Tuple3d) (vector3d2)));
        ...
        {
            setNew.cP[k2].set(((com.maddox.JGP.Tuple3d) (setNew.compassPoint[k2])));
            orientation.transformInv(((com.maddox.JGP.Tuple3d) (setNew.cP[k2])));
        }

        com.maddox.JGP.Vector3d vector3d3 = new Vector3d();
        vector3d3.set(((com.maddox.JGP.Tuple3d) (setNew.cP[0])));
        vector3d3.add(((com.maddox.JGP.Tuple3d) (setNew.cP[1])));
        vector3d3.add(((com.maddox.JGP.Tuple3d) (setNew.cP[2])));
        vector3d3.add(((com.maddox.JGP.Tuple3d) (setNew.cP[3])));
        vector3d3.scale(0.25D);
        com.maddox.JGP.Vector3d vector3d4 = new Vector3d();
        vector3d4.set(((com.maddox.JGP.Tuple3d) (vector3d3)));
        vector3d4.normalize();
        ...
        if((double)f > compassLimit || vector3d3.z > 0.0D)
        {
            ...
            {
                setNew.cP[l2].set(((com.maddox.JGP.Tuple3d) (setOld.cP[l2])));
                setNew.compassPoint[l2].set(((com.maddox.JGP.Tuple3d) (setOld.cP[l2])));
        ...
        vector3d4.set(((com.maddox.JGP.Tuple3d) (setNew.cP[0])));
        vector3d4.sub(((com.maddox.JGP.Tuple3d) (vector3d3)));
    ...
    private void compassDist(com.maddox.JGP.Vector3d vector3d, com.maddox.JGP.Vector3d vector3d1, double d)
    {
        ...
        vector3d2.set(((com.maddox.JGP.Tuple3d) (vector3d)));
        vector3d2.sub(((com.maddox.JGP.Tuple3d) (vector3d1)));
        double d1 = vector3d2.length();
        if(d1 < 9.9999999999999995E-007D)
            d1 = 9.9999999999999995E-007D;
        d1 = (d - d1) / d1 / 2D;
        vector3d2.scale(d1);
        vector3d.add(((com.maddox.JGP.Tuple3d) (vector3d2)));
        vector3d1.sub(((com.maddox.JGP.Tuple3d) (vector3d2)));
    }
