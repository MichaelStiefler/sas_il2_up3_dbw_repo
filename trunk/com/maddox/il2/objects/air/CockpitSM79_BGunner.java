...
public class CockpitSM79_BGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.mesh.chunkSetAngles("Zturret2A", 0.0F, paramOrient.getYaw(), 0.0F);
    this.mesh.chunkSetAngles("Zturret2B", 0.0F, paramOrient.getTangage(), 0.0F);
  }
  ...
  protected void interpTick()
  {
    ...
    if (this.emitter != null)
    {
      ...
      this.mesh.chunkVisible("ZTurret3B-Bullet0", bool);
      this.mesh.chunkVisible("ZTurret3B-Bullet1", !bool);
    }
  }
