    ...
    implements TypeTransport, TypeBomber
{
        ...
        if(shot.chunkName.startsWith("CF"))
        {
            if(Aircraft.Pd.x > 4.5500001907348633D && Aircraft.Pd.x < 7.1500000953674316D && Aircraft.Pd.z > 0.57999998331069946D)
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.233F)
                    if(Aircraft.Pd.z > 1.2100000381469727D)
                    {
            ...
            if(Aircraft.Pd.x > 9.5299997329711914D && Aircraft.Pd.z < 0.14000000059604645D && Aircraft.Pd.z > -0.62999999523162842D)
                FM.AS.hitPilot(shot.initiator, 2, (int)(shot.power * 0.002F));
            if(Aircraft.Pd.x > 2.4749999046325684D && Aircraft.Pd.x < 4.4899997711181641D && Aircraft.Pd.z > 0.61000001430511475D && (double)shot.power * java.lang.Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z) > 11900D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.45F)
            {
                for(int i = 0; i < 4; i++)
    ...
    static 
    {
        java.lang.Class class1 = PE_8.class;
        ...
        Aircraft.weaponsRegister(class1, "40fab100", new java.lang.String[] {
            "MGunShKASt 1500", "MGunShKASt 1500", "MGunShVAKt 750", "MGunShVAKt 750", "MGunUBt 1200", "MGunUBt 1200", null, null, null, null, 
        ...
        Aircraft.weaponsRegister(class1, "12fab250", new java.lang.String[] {
            "MGunShKASt 1500", "MGunShKASt 1500", "MGunShVAKt 750", "MGunShVAKt 750", "MGunUBt 1200", "MGunUBt 1200", null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        Aircraft.weaponsRegister(class1, "4fab1000", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "1fab20002fab1000", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "1fab5000", new java.lang.String[] {
