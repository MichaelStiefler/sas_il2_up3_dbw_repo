    ...
    implements java.lang.Cloneable, java.io.Serializable
{
    ...
    public int size()
    {
        ...
        for(com.maddox.util.HashMapIntEntry hashmapintentry = mapY.nextEntry(null); hashmapintentry != null; hashmapintentry = mapY.nextEntry(hashmapintentry))
            i += ((com.maddox.util.HashMapInt)(com.maddox.util.HashMapInt)hashmapintentry.getValue()).size();
    ...
    {
        for(com.maddox.util.HashMapIntEntry hashmapintentry = mapY.nextEntry(null); hashmapintentry != null; hashmapintentry = mapY.nextEntry(hashmapintentry))
            if(((com.maddox.util.HashMapInt)(com.maddox.util.HashMapInt)hashmapintentry.getValue()).containsValue(obj))
                return true;
    ...
    {
        for(com.maddox.util.HashMapIntEntry hashmapintentry = mapY.nextEntry(null); hashmapintentry != null; hashmapintentry = mapY.nextEntry(hashmapintentry))
            ((com.maddox.util.HashMapInt)(com.maddox.util.HashMapInt)hashmapintentry.getValue()).clear();
