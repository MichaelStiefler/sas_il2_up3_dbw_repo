...
public class CockpitA6M7_62 extends CockpitPilot
{
  ...
  private static final float[] speedometerScale = { 45.0F, 48.5F, 51.5F, 80.0F, 129.0F, 180.0F, 227.0F, 270.5F, 315.0F, 360.0F, 401.0F, 440.0F, 476.0F, 512.0F, 546.40002F, 579.0F, 608.0F, 637.5F, 666.5F, 696.5F, 726.0F };

  private static final float[] oilScale = { 0.0F, -27.5F, 12.0F, 59.5F, 127.0F, 212.5F, 311.5F };

  protected float waypointAzimuth()
  {
    float f = super.waypointAzimuth();
    while (f <= -180.0F) {
      f += 180.0F;
    }
    while (f > 180.0F) {
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Azimuth1a", 0.0F, -this.setNew.waypointDirection.getDeg(paramFloat), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_AirSpeed", 0.0F, floatindex(cvt(Pitot.Indicator((float)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z, this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20.0F), speedometerScale), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_PressMixt1a", 0.0F, cvt((float)Math.sqrt(Math.sqrt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.nitro)), 0.0F, 2.783F, 0.0F, 330.0F), 0.0F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitA6M7_62.access$102(CockpitA6M7_62.this, CockpitA6M7_62.this.setOld); CockpitA6M7_62.access$202(CockpitA6M7_62.this, CockpitA6M7_62.this.setNew); CockpitA6M7_62.access$302(CockpitA6M7_62.this, CockpitA6M7_62.this.setTmp);

        if (CockpitA6M7_62.this.cockpitDimControl) {
          if (CockpitA6M7_62.this.setNew.dimPosition > 0.0F) CockpitA6M7_62.this.setNew.dimPosition = (CockpitA6M7_62.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitA6M7_62.this.setNew.dimPosition < 1.0F) CockpitA6M7_62.this.setNew.dimPosition = (CockpitA6M7_62.this.setOld.dimPosition + 0.05F);

        if ((CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) {
          if (CockpitA6M7_62.this.setNew.stbyPosition > 0.0F) CockpitA6M7_62.this.setNew.stbyPosition = (CockpitA6M7_62.this.setOld.stbyPosition - 0.025F);
        }
        else if (CockpitA6M7_62.this.setNew.stbyPosition < 1.0F) CockpitA6M7_62.this.setNew.stbyPosition = (CockpitA6M7_62.this.setOld.stbyPosition + 0.025F);

        CockpitA6M7_62.this.setNew.throttle = (0.9F * CockpitA6M7_62.this.setOld.throttle + 0.1F * CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitA6M7_62.this.setNew.prop = (0.9F * CockpitA6M7_62.this.setOld.prop + 0.1F * CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitA6M7_62.this.setNew.mix = (0.8F * CockpitA6M7_62.this.setOld.mix + 0.2F * CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitA6M7_62.this.setNew.man = (0.92F * CockpitA6M7_62.this.setOld.man + 0.08F * CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitA6M7_62.this.setNew.altimeter = CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitA6M7_62.this.setNew.azimuth.setDeg(CockpitA6M7_62.this.setOld.azimuth.getDeg(1.0F), CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitA6M7_62.this.setNew.vspeed = ((199.0F * CockpitA6M7_62.this.setOld.vspeed + CockpitA6M7_62.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f = CockpitA6M7_62.this.waypointAzimuth();

        CockpitA6M7_62.this.setNew.waypointAzimuth.setDeg(CockpitA6M7_62.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M7_62.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-5.0F, 5.0F));
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float stbyPosition;
    private final CockpitA6M7_62 this$0;
    ...
    Variables(CockpitA6M7_62.1 arg2)
    {
      this();
    }
  }
