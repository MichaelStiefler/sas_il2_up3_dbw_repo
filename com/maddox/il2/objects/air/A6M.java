  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  {
    paramHierMesh.chunkSetAngles("GearC2_D0", 0.0F, 46.5F * paramFloat, 0.0F);
    paramHierMesh.chunkSetAngles("GearC3_D0", 0.0F, 0.0F, 0.0F);
    paramHierMesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 0.55F, 0.0F, 80.5F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR7_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 0.05F, 0.0F, 90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.45F, 1.0F, 0.0F, -80.5F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL7_D0", 0.0F, Aircraft.cvt(paramFloat, 0.45F, 0.5F, 0.0F, -90.0F), 0.0F);
  }
  ...
  {
    resetYPRmodifier();
    float f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.16015F, 0.0F, 0.16015F);
    Aircraft.xyz[2] = f;
    hierMesh().chunkSetLocate("GearL3_D0", Aircraft.xyz, Aircraft.ypr);
    f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.16015F, 0.0F, 0.16015F);
    Aircraft.xyz[2] = f;
    hierMesh().chunkSetLocate("GearR3_D0", Aircraft.xyz, Aircraft.ypr);
  }
  public void moveSteering(float paramFloat) {
    if (paramFloat > 77.5F) { paramFloat = 77.5F; this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.steerAngle = paramFloat; }
    if (paramFloat < -77.5F) { paramFloat = -77.5F; this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.steerAngle = paramFloat; }
  ...
  {
    hierMesh().chunkSetAngles("Flap01_D0", 0.0F, -60.0F * paramFloat, 0.0F);
    hierMesh().chunkSetAngles("Flap02_D0", 0.0F, -60.0F * paramFloat, 0.0F);
  }
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx")) {
      ...
      if (paramString.startsWith("xxammo")) {
        if ((paramString.startsWith("xxammol")) && 
        ...
        if (paramString.startsWith("xxammowl")) {
        ...
        if (paramString.startsWith("xxammowr")) {
          if (World.Rnd().nextFloat() < 0.01F) {
      ...
      if (paramString.startsWith("xxtank")) {
        ...
        if ((i < 3) && 
          (getEnergyPastArmor(0.1F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.45F)) {
      ...
      if (paramString.startsWith("xxspar")) {
        ...
        if ((paramString.startsWith("xxspart")) && 
          (chunkDamageVisible("Tail1") > 2) && (getEnergyPastArmor(3.859999895095825D / Math.sqrt(Aircraft.v1.jdField_y_of_type_Double * Aircraft.v1.jdField_y_of_type_Double + Aircraft.v1.jdField_z_of_type_Double * Aircraft.v1.jdField_z_of_type_Double), paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.25F)) {
    ...
    if ((paramString.startsWith("xcf")) || (paramString.startsWith("xblister"))) {
      ...
      if ((paramPoint3d.jdField_x_of_type_Double > -2.42D) && (paramPoint3d.jdField_x_of_type_Double < 0.32D)) {
        ...
        if ((paramPoint3d.jdField_x_of_type_Double < -0.27D) && (paramPoint3d.jdField_z_of_type_Double > 0.7D)) {
      ...
      if (getEnergyPastArmor(0.05F, paramShot) > 0.0F) {
        ...
        if ((World.Rnd().nextFloat() < 0.37F) && (paramShot.powerType == 3)) {
          this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.hitTank(paramShot.initiator, 3, 2);
