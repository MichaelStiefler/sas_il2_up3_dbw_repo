    ...
    implements TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = HalifaxBMkIII.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= HalifaxBMkIII.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / HalifaxBMkIII.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)HalifaxBMkIII.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(HalifaxBMkIII.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = HalifaxBMkIII.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "Halifax");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/HALIFAX-B-Mk3(Multi1)/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/HalifaxBMkIII.fmd");
