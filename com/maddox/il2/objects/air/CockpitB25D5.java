...
public class CockpitB25D5 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitB25D5 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB25D5.this.fm != null) {
        CockpitB25D5.access$102(CockpitB25D5.this, CockpitB25D5.this.setOld);
        CockpitB25D5.access$202(CockpitB25D5.this, CockpitB25D5.this.setNew);
        CockpitB25D5.access$302(CockpitB25D5.this, CockpitB25D5.this.setTmp);
        ...
        CockpitB25D5.this.setNew.waypointAzimuth.setDeg(CockpitB25D5.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitB25D5.this.setNew.waypointDeviation.setDeg(CockpitB25D5.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB25D5.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitB25D5.this.setNew.vspeed = ((199.0F * CockpitB25D5.this.setOld.vspeed + CockpitB25D5.this.fm.getVertSpeed()) / 200.0F);
      }
