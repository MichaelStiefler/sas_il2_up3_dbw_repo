...
public class CockpitI_185M82 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        if (CockpitI_185M82.this.bNeedSetUp) {
          CockpitI_185M82.this.reflectPlaneMats();
          CockpitI_185M82.access$102(CockpitI_185M82.this, false);
        }
        CockpitI_185M82.access$202(CockpitI_185M82.this, CockpitI_185M82.this.setOld); CockpitI_185M82.access$302(CockpitI_185M82.this, CockpitI_185M82.this.setNew); CockpitI_185M82.access$402(CockpitI_185M82.this, CockpitI_185M82.this.setTmp);

        CockpitI_185M82.this.setNew.throttle = ((10.0F * CockpitI_185M82.this.setOld.throttle + CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitI_185M82.this.setNew.prop = (0.85F * CockpitI_185M82.this.setOld.prop + CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitI_185M82.this.setNew.altimeter = CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitI_185M82.this.setNew.azimuth = ((35.0F * CockpitI_185M82.this.setOld.azimuth + -CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        if ((CockpitI_185M82.this.setOld.azimuth > 270.0F) && (CockpitI_185M82.this.setNew.azimuth < 90.0F)) CockpitI_185M82.this.setOld.azimuth -= 360.0F;
        if ((CockpitI_185M82.this.setOld.azimuth < 90.0F) && (CockpitI_185M82.this.setNew.azimuth > 270.0F)) CockpitI_185M82.this.setOld.azimuth += 360.0F;
        CockpitI_185M82.this.setNew.waypointAzimuth = ((10.0F * CockpitI_185M82.this.setOld.waypointAzimuth + (CockpitI_185M82.this.waypointAzimuth() - CockpitI_185M82.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);
        CockpitI_185M82.this.setNew.vspeed = ((199.0F * CockpitI_185M82.this.setOld.vspeed + CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitI_185M82.this.cvt(CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitI_185M82.this.cvt(CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
            CockpitI_185M82.access$516(CockpitI_185M82.this, 0.3F);
            if (CockpitI_185M82.this.pictBlinker > 1.0F)
              CockpitI_185M82.access$502(CockpitI_185M82.this, 1.0F);
          }
          else {
            CockpitI_185M82.access$524(CockpitI_185M82.this, 0.3F);
            if (CockpitI_185M82.this.pictBlinker < 0.0F) {
              CockpitI_185M82.access$502(CockpitI_185M82.this, 0.0F);
            }
          }
        }
        CockpitI_185M82.access$602(CockpitI_185M82.this, 0.8F * CockpitI_185M82.this.pictStage + 0.1F * CockpitI_185M82.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor());
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    float[] xyz;
    float[] ypr;
    private final CockpitI_185M82 this$0;
    ...
    Variables(CockpitI_185M82.1 arg2)
    {
      this();
    }
  }
