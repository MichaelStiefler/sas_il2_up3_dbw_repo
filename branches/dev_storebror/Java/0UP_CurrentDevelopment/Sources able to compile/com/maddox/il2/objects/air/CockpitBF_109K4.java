...
public class CockpitBF_109K4 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(gun[0] == null)
        {
            ...
            gun[2] = ((Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_MGUN02");
        }
        resetYPRmodifier();
        ...
        super.mesh.chunkSetAngles("Z_EngTemp1", 0.0F, cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, 75F), 0.0F);
        super.mesh.chunkSetAngles("Z_EngTemp2", 0.0F, cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tWaterOut, 0.0F, 130F, 0.0F, 75F), 0.0F);
        super.mesh.chunkSetAngles("Z_FuelPress1", cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3F, 0.0F, 120F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_OilPress1", cvt(1.0F + 0.05F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tOilOut, 0.0F, 15F, 0.0F, 120F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Variometr", 0.0F, 0.0F, -floatindex(cvt(setNew.vspeed, -30F, 30F, 0.0F, 12F), variometerScale));
        if(useRealisticNavigationInstruments())
        {
        ...
        super.mesh.chunkVisible("Z_GearHRed1", ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGear() == 0.0F);
        ...
        super.mesh.chunkVisible("Z_GearHGreen1", ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGear() == 1.0F);
        if(gun[0] != null)
            super.mesh.chunkSetAngles("Z_AmmoCounter1", cvt(gun[0].countBullets(), 0.0F, 500F, 15F, 0.0F), 0.0F, 0.0F);
        if(gun[2] != null)
            super.mesh.chunkSetAngles("Z_AmmoCounter2", cvt(gun[2].countBullets(), 0.0F, 500F, 15F, 0.0F), 0.0F, 0.0F);
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitBF_109K4.class, "normZN", 0.5F);
        com.maddox.rts.Property.set(CockpitBF_109K4.class, "gsZN", 0.5F);
    }
