...
//            B_17, PaintSchemeBMPar03, TypeBomber, Aircraft, 
//            NetAircraft
    ...
    implements com.maddox.il2.objects.air.TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = com.maddox.il2.objects.air.B_17E.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= com.maddox.il2.objects.air.B_17E.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / com.maddox.il2.objects.air.B_17E.toMeters(fSightCurAltitude)));
            calibDistance = com.maddox.il2.objects.air.B_17E.toMetersPerSecond(fSightCurSpeed) * floatindex(com.maddox.il2.objects.air.Aircraft.cvt(com.maddox.il2.objects.air.B_17E.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)com.maddox.il2.objects.air.B_17E.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(com.maddox.il2.objects.air.B_17E.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", "3DO/Plane/B-17E(Multi1)/hier.him");
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "PaintScheme", ((java.lang.Object) (new PaintSchemeBMPar03())));
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName_us", "3DO/Plane/B-17E(USA)/hier.him");
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "FlightModel", "FlightModels/B-17E.fmd");
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "cockpitClass", ((java.lang.Object) (new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitB17E.class, com.maddox.il2.objects.air.CockpitB17E_Bombardier.class, com.maddox.il2.objects.air.CockpitB17E_TGunner.class, com.maddox.il2.objects.air.CockpitB17E_LGunner.class, com.maddox.il2.objects.air.CockpitB17E_RGunner.class, com.maddox.il2.objects.air.CockpitB17E_AGunner.class
        })));
        com.maddox.il2.objects.air.B_17E.weaponTriggersRegister(class1, new int[] {
            11, 12, 13, 13, 14, 14, 15, 16, 17, 17, 
            3, 3
        });
        com.maddox.il2.objects.air.B_17E.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_MGUN10", "_MGUN11", "_MGUN12", 
            "_BombSpawn01", "_BombSpawn02"
        });
        com.maddox.il2.objects.air.B_17E.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.B_17E.weaponsRegister(class1, "16x500", new java.lang.String[] {
            "MGunBrowning50t 610", "MGunBrowning50t 610", "MGunBrowning50t 375", "MGunBrowning50t 375", "MGunBrowning50t 500", "MGunBrowning50t 500", "MGunBrowning50t 600", "MGunBrowning50t 600", "MGunBrowning50t 500", "MGunBrowning50t 500", 
            "BombGun500lbs 8", "BombGun500lbs 8"
        });
        com.maddox.il2.objects.air.B_17E.weaponsRegister(class1, "8x1000", new java.lang.String[] {
            "MGunBrowning50t 610", "MGunBrowning50t 610", "MGunBrowning50t 375", "MGunBrowning50t 375", "MGunBrowning50t 500", "MGunBrowning50t 500", "MGunBrowning50t 600", "MGunBrowning50t 600", "MGunBrowning50t 500", "MGunBrowning50t 500", 
            "BombGun1000lbs 4", "BombGun1000lbs 4"
        });
        com.maddox.il2.objects.air.B_17E.weaponsRegister(class1, "none", new java.lang.String[] {
