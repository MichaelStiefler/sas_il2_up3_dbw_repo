...
public abstract class KI_21 extends com.maddox.il2.objects.air.Scheme2
{
    ...
    public void moveWheelSink()
    {
        ...
        {
            resetYPRmodifier();
            hierMesh().chunkSetAngles("GearL10_D0", 0.0F, com.maddox.il2.objects.air.KI_21.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.35F, -38F, -27.5F), 0.0F);
            hierMesh().chunkSetAngles("GearL11_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.KI_21.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.35F, -45F, -48.25F));
            xyz[2] = com.maddox.il2.objects.air.KI_21.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.35F, 0.0F, -0.325F);
            hierMesh().chunkSetLocate("GearL12_D0", xyz, ypr);
            hierMesh().chunkSetAngles("GearR10_D0", 0.0F, com.maddox.il2.objects.air.KI_21.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.35F, -38F, -27.5F), 0.0F);
            hierMesh().chunkSetAngles("GearR11_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.KI_21.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.35F, -45F, -48.25F));
            xyz[2] = com.maddox.il2.objects.air.KI_21.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.35F, 0.0F, -0.325F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxbomb"))
            {
                ...
                {
                    com.maddox.il2.objects.air.KI_21.debugprintln(this, "*** Bomb Payload Detonates..");
