    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    public void moveCockpitDoor(float f)
    {
        ...
        com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, -0.05735F);
    ...
    {
        com.maddox.il2.objects.air.F4F.moveGear(hiermesh, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.91F, 0.0F, 1.0F), 0, true);
        com.maddox.il2.objects.air.F4F.moveGear(hiermesh, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.09F, 0.98F, 0.0F, 1.0F), 1, true);
        hiermesh.chunkSetAngles("LampGear_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, -90F), 0.0F);
    }
    ...
    public void moveWheelSink()
    {
        ...
        {
            com.maddox.il2.objects.air.F4F.moveGear(hierMesh(), com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.5F, 1.0F, 0.57F), 0, false);
            com.maddox.il2.objects.air.F4F.moveGear(hierMesh(), com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.5F, 1.0F, 0.57F), 1, false);
        }
    }
    ...
    {
        resetYPRmodifier();
        com.maddox.il2.objects.air.Aircraft.xyz[0] = -1.045F * f;
    ...
    public void update(float f)
    {
        ...
        if(f3 > 0.01F)
            ...
            {
                arrestor = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.arrestorVAngle, -f4, f4, -f4, f4);
                moveArrestorHook(f3);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("f1"))
                {
                    if(getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(8F, 12F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F && point3d.y > -0.442D && point3d.y < 0.442D && point3d.z > 0.54400000000000004D)
