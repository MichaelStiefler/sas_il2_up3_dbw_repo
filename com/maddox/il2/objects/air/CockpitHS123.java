...
public class CockpitHS123 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float turn;
    float vspeed;
    private final CockpitHS123 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitHS123.this.bNeedSetUp) {
        ...
        CockpitHS123.access$102(CockpitHS123.this, false);
      }
      ...
      CockpitHS123.access$202(CockpitHS123.this, CockpitHS123.this.setOld);
      CockpitHS123.access$302(CockpitHS123.this, CockpitHS123.this.setNew);
      CockpitHS123.access$402(CockpitHS123.this, CockpitHS123.this.setTmp);
      CockpitHS123.this.setNew.altimeter = CockpitHS123.this.fm.getAltitude();
      if (Math.abs(CockpitHS123.this.fm.Or.getKren()) < 30.0F) {
        CockpitHS123.this.setNew.azimuth = ((21.0F * CockpitHS123.this.setOld.azimuth + CockpitHS123.this.fm.Or.azimut()) / 22.0F);
      }
      if ((CockpitHS123.this.setOld.azimuth > 270.0F) && (CockpitHS123.this.setNew.azimuth < 90.0F))
        CockpitHS123.this.setOld.azimuth -= 360.0F;
      if ((CockpitHS123.this.setOld.azimuth < 90.0F) && (CockpitHS123.this.setNew.azimuth > 270.0F))
        CockpitHS123.this.setOld.azimuth += 360.0F;
      CockpitHS123.this.setNew.throttle = ((10.0F * CockpitHS123.this.setOld.throttle + CockpitHS123.this.fm.EI.engines[0].getControlThrottle()) / 11.0F);

      CockpitHS123.this.setNew.mix = ((10.0F * CockpitHS123.this.setOld.mix + CockpitHS123.this.fm.EI.engines[0].getControlMix()) / 11.0F);

      CockpitHS123.this.setNew.prop = CockpitHS123.this.setOld.prop;
      if (CockpitHS123.this.setNew.prop < CockpitHS123.this.fm.EI.engines[0].getControlProp() - 0.01F)
        CockpitHS123.this.setNew.prop += 0.0025F;
      if (CockpitHS123.this.setNew.prop > CockpitHS123.this.fm.EI.engines[0].getControlProp() + 0.01F)
        CockpitHS123.this.setNew.prop -= 0.0025F;
      CockpitHS123.this.w.set(CockpitHS123.this.fm.getW());
      CockpitHS123.this.fm.Or.transform(CockpitHS123.this.w);
      CockpitHS123.this.setNew.turn = ((12.0F * CockpitHS123.this.setOld.turn + CockpitHS123.this.w.z) / 13.0F);
      CockpitHS123.this.setNew.vspeed = ((299.0F * CockpitHS123.this.setOld.vspeed + CockpitHS123.this.fm.getVertSpeed()) / 300.0F);

      CockpitHS123.access$602(CockpitHS123.this, 0.8F * CockpitHS123.this.pictSupc + 0.2F * CockpitHS123.this.fm.EI.engines[0].getControlCompressor());
