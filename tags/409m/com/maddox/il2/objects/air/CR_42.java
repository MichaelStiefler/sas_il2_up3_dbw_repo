...
public class CR_42 extends com.maddox.il2.objects.air.CR_42X
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", null, null
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "2sc50", new java.lang.String[] {
            "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGunSC50 1", "BombGunSC50 1"
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "2sc70", new java.lang.String[] {
            "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGunSC70 1", "BombGunSC70 1"
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "2x50", new java.lang.String[] {
            "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGun50kg 1", "BombGun50kg 1"
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "2x100", new java.lang.String[] {
            "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGun100kg 1", "BombGun100kg 1"
        });
