...
public class CockpitA6M2 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Turn3", 0.0F, 68.0F * interp(this.setNew.mix, this.setOld.mix, paramFloat), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Turn3_rod", 0.0F, -68.0F * interp(this.setNew.mix, this.setOld.mix, paramFloat), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Revolution", 0.0F, cvt(f, 500.0F, 4500.0F, 0.0F, 720.0F), 0.0F);
    if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x4) == 0) {
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitA6M2.access$102(CockpitA6M2.this, CockpitA6M2.this.setOld); CockpitA6M2.access$202(CockpitA6M2.this, CockpitA6M2.this.setNew); CockpitA6M2.access$302(CockpitA6M2.this, CockpitA6M2.this.setTmp);

        if (CockpitA6M2.this.cockpitDimControl) {
          if (CockpitA6M2.this.setNew.dimPosition > 0.0F) CockpitA6M2.this.setNew.dimPosition = (CockpitA6M2.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitA6M2.this.setNew.dimPosition < 1.0F) CockpitA6M2.this.setNew.dimPosition = (CockpitA6M2.this.setOld.dimPosition + 0.05F);

        if ((CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) {
          if (CockpitA6M2.this.setNew.stbyPosition > 0.0F) CockpitA6M2.this.setNew.stbyPosition = (CockpitA6M2.this.setOld.stbyPosition - 0.025F);
        }
        else if (CockpitA6M2.this.setNew.stbyPosition < 1.0F) CockpitA6M2.this.setNew.stbyPosition = (CockpitA6M2.this.setOld.stbyPosition + 0.025F);

        CockpitA6M2.this.setNew.throttle = (0.9F * CockpitA6M2.this.setOld.throttle + 0.1F * CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitA6M2.this.setNew.prop = (0.9F * CockpitA6M2.this.setOld.prop + 0.1F * CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitA6M2.this.setNew.mix = (0.8F * CockpitA6M2.this.setOld.mix + 0.2F * CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitA6M2.this.setNew.man = (0.92F * CockpitA6M2.this.setOld.man + 0.08F * CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitA6M2.this.setNew.altimeter = CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitA6M2.this.setNew.azimuth.setDeg(CockpitA6M2.this.setOld.azimuth.getDeg(1.0F), CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitA6M2.this.setNew.vspeed = ((199.0F * CockpitA6M2.this.setOld.vspeed + CockpitA6M2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f = CockpitA6M2.this.waypointAzimuth();

        CockpitA6M2.this.setNew.waypointAzimuth.setDeg(CockpitA6M2.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M2.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-5.0F, 5.0F));

        CockpitA6M2.this.setNew.waypointDirection.setDeg(CockpitA6M2.this.setOld.waypointDirection.getDeg(0.5F), f);
      }
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float stbyPosition;
    private final CockpitA6M2 this$0;
