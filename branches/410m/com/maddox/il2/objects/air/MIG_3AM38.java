...
public class MIG_3AM38 extends com.maddox.il2.objects.air.MIG_3
{
    ...
    public void update(float f)
    {
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL_D0", 0.0F, com.maddox.il2.objects.air.MIG_3AM38.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.9F), 0.0F);
            hierMesh().chunkSetAngles("SlatR_D0", 0.0F, com.maddox.il2.objects.air.MIG_3AM38.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.9F), 0.0F);
        }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MIG_3AM38.weaponTriggersRegister(class1, new int[] {
            0, 0, 1
        });
        com.maddox.il2.objects.air.MIG_3AM38.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03"
        });
        com.maddox.il2.objects.air.MIG_3AM38.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShKASs 750", "MGunShKASs 750", "MGunUBk 310"
        });
        com.maddox.il2.objects.air.MIG_3AM38.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
}
