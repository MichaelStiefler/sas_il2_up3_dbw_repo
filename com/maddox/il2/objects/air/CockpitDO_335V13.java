...
public class CockpitDO_335V13 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetLocate("Z_Columnbutton3", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        mesh.chunkSetLocate("Z_Columnbutton4", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        mesh.chunkSetLocate("Z_Columnbutton5", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.12F * fm.CT.getRudder();
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = 0.065F * fm.CT.BayDoorControl;
        mesh.chunkSetLocate("Z_BombBay", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(gun[0].countBullets(), 0.0F, 500F, -0.00465F, 0.04175F);
        mesh.chunkSetLocate("Z_AmmoCounter1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(gun[2].countBullets(), 0.0F, 100F, -0.00465F, 0.04175F);
        mesh.chunkSetLocate("Z_AmmoCounter2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(gun[1].countBullets(), 0.0F, 500F, -0.00465F, 0.04175F);
        mesh.chunkSetLocate("Z_AmmoCounter3", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(gun[3].countBullets(), 0.0F, 100F, -0.00465F, 0.04175F);
        mesh.chunkSetLocate("Z_AmmoCounter4", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(gun[4].countBullets(), 0.0F, 100F, -0.00465F, 0.04175F);
        mesh.chunkSetLocate("Z_AmmoCounter5", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
