...
public class CockpitB17E_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			float f = ((B_17E) CockpitB17E_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((B_17E) CockpitB17E_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitB17E_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F,
					-f1, f);
			if (CockpitB17E_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitB17E_Bombardier.this.aAim
						+ f1, CockpitB17E_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(
					((B_17E) this.aircraft()).fSightCurForwardAngle, 7F, 140F,
					0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((B_17E) this.aircraft()).fSightCurReadyness > 0.93F;
