...
// Source File Name:   CockpitP_26.java
...
//            CockpitPilot, P_26x, Aircraft, Cockpit

public class CockpitP_26 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if((com.maddox.il2.objects.air.P_26x)aircraft() != null);
        if(com.maddox.il2.objects.air.P_26x.bChangedPit)
        {
            reflectPlaneToModel();
            if((com.maddox.il2.objects.air.P_26x)aircraft() != null);
            com.maddox.il2.objects.air.P_26x.bChangedPit = false;
        }
        resetYPRmodifier();
