...
public class GUIAirArming extends com.maddox.il2.game.GameState
{
    ...
    public class DialogClient extends com.maddox.il2.gui.GUIDialogClient
    {
        ...
        public boolean notify(com.maddox.gwindow.GWindow gwindow, int i, int j)
        {
            ...
            if(gwindow == cFuel)
            {
                if(bEnableWeaponChange)
                    if(isNet())
                        usercfg.fuel = (cFuel.getSelected() + 1) * 25;
                    else
                    if(com.maddox.il2.gui.GUIAirArming.stateId == 4)
                        quikFuel = (cFuel.getSelected() + 1) * 25;
                    else
                        com.maddox.il2.game.Main.cur().currentMissionFile.set(planeName, "Fuel", (cFuel.getSelected() + 1) * 25);
            } else
            {
        ...
        {
            super.render();
            com.maddox.il2.gui.GUISeparate.draw(this, com.maddox.gwindow.GColor.Gray, x1024(628F), y1024(176F), x1024(364F), 2.0F);
            com.maddox.il2.gui.GUISeparate.draw(this, com.maddox.gwindow.GColor.Gray, x1024(628F), y1024(320F), x1024(364F), 2.0F);
    ...
    public void _enter()
    {
        ...
        stateId;
        JVM INSTR tableswitch 0 4: default 3469
    //                   0 280
    //                   1 280
    //                   2 1097
    //                   3 746
...
_L2:
        ...
        java.lang.Class class3 = com.maddox.rts.ObjIO.classForName(s4);
        java.lang.String s7 = com.maddox.rts.Property.stringValue(class3, "keyName", null);
        airNames.add(s7);
        cAircraft.add(com.maddox.il2.game.I18N.plane(s7));
        ...
        java.util.ArrayList arraylist4 = new ArrayList();
        ...
        int j3 = sectfile1.get(planeName, "Fuel", 100, 0, 100);
        if(j3 <= 25)
...
_L3:
        ...
        {
            java.util.ArrayList arraylist2 = bornplace.airNames;
            for(int i1 = 0; i1 < arraylist2.size(); i1++)
            {
                java.lang.String s5 = (java.lang.String)arraylist2.get(i1);
                java.lang.Class class4 = (java.lang.Class)com.maddox.rts.Property.value(s5, "airClass", null);
                if(class4 != null)
                {
                    airNames.add(s5);
                    cAircraft.add(com.maddox.il2.game.I18N.plane(s5));
                }
            }
        ...
        if(airNames.size() == 0)
        {
            java.util.ArrayList arraylist3 = com.maddox.il2.game.Main.cur().airClasses;
            for(int j1 = 0; j1 < arraylist3.size(); j1++)
            {
                java.lang.Class class2 = (java.lang.Class)arraylist3.get(j1);
                java.lang.String s6 = com.maddox.rts.Property.stringValue(class2, "keyName");
        ...
        {
            com.maddox.il2.ai.Regiment regiment2 = (com.maddox.il2.ai.Regiment)list1.get(j2);
            java.lang.String s11 = regiment2.name();
            if(regHash.containsKey(s11))
                continue;
            regHash.put(s11, regiment2);
            java.util.ArrayList arraylist6 = (java.util.ArrayList)regList.get(regiment2.branch());
            if(arraylist6 == null)
            {
                ...
                regList.put(regiment2.branch(), arraylist6);
                treemap1.put(s16, regiment2.branch());
            }
            arraylist6.add(regiment2);
        }

        java.lang.String s8;
        java.io.File afile[];
        s8 = com.maddox.il2.game.Main.cur().netFileServerReg.primaryPath();
        java.io.File file = new File(com.maddox.rts.HomePath.toFileSystemName(s8, 0));
...
_L11:
        ...
        java.io.File file1 = afile[i4];
        if(!file1.isFile())
            continue; /* Loop/switch isn't completed */
        s17 = file1.getName();
        if(regHash.containsKey(s17))
            continue; /* Loop/switch isn't completed */
        java.lang.String s18 = s17.toLowerCase();
        if(s18.endsWith(".bmp") || s18.endsWith(".tga") || s18.length() > 123)
            continue; /* Loop/switch isn't completed */
        int l4 = com.maddox.il2.engine.BmpUtils.squareSizeBMP8Pal(s8 + "/" + s18 + ".bmp");
        if(l4 != 64 && l4 != 128)
        {
            java.lang.System.out.println("File " + s8 + "/" + s18 + ".bmp NOT loaded");
            continue; /* Loop/switch isn't completed */
        }
        ...
        arraylist9 = (java.util.ArrayList)regList.get(userregiment.branch);
        if(arraylist9 != null) goto _L10; else goto _L9
_L9:
...
_L10:
        ...
        i4++;
_L8:
        if(i4 < afile.length) goto _L11; else goto _L7
...
_L7:
        ...
        for(java.util.Iterator iterator1 = treemap1.keySet().iterator(); iterator1.hasNext(); cCountry.add(s12))
        {
            s12 = (java.lang.String)iterator1.next();
            countryLst.add(treemap1.get(s12));
        }
        ...
        if(usercfg.netRegiment != null)
        {
            ...
            if(obj1 != null)
            {
                ...
                if(obj1 instanceof com.maddox.il2.ai.Regiment)
                    s14 = ((com.maddox.il2.ai.Regiment)obj1).branch();
                else
                    s14 = ((com.maddox.il2.gui.UserRegiment)obj1).branch;
                int j4;
                for(j4 = 0; j4 < countryLst.size(); j4++)
                    if(s14.equals(countryLst.get(j4)))
                        break;
                ...
                if(j4 < countryLst.size())
                {
                    ...
                    fillRegiments();
                    java.util.ArrayList arraylist8 = (java.util.ArrayList)regList.get(countryLst.get(j4));
                    if(arraylist8 != null)
                    {
                        for(int k4 = 0; k4 < arraylist8.size(); k4++)
                        {
                            if(!obj1.equals(arraylist8.get(k4)))
                                continue;
        ...
        try
        {
            for(int i3 = 0; i3 < airNames.size(); i3++)
            {
                if(!usercfg.netAirName.equals(airNames.get(i3)))
                    continue;
                cAircraft.setSelected(i3, true, false);
                break;
            }
...
_L5:
        ...
        {
            com.maddox.il2.ai.Regiment regiment1 = (com.maddox.il2.ai.Regiment)list.get(i2);
            if(regiment1.getArmy() != quikArmy)
                continue;
            java.lang.String s9 = regiment1.name();
        ...
        for(java.util.Iterator iterator = treemap.keySet().iterator(); iterator.hasNext(); cCountry.add(s10))
        {
            s10 = (java.lang.String)iterator.next();
            countryLst.add(treemap.get(s10));
        }
        ...
        if(quikRegiment != null)
        {
            ...
            if(obj != null)
            {
                java.lang.String s13 = ((com.maddox.il2.ai.Regiment)obj).branch();
                int k3;
                for(k3 = 0; k3 < countryLst.size(); k3++)
                    if(s13.equals(countryLst.get(k3)))
                        break;

                if(k3 < countryLst.size())
                {
                    cCountry.setSelected(k3, true, false);
                    fillRegiments();
                    java.util.ArrayList arraylist7 = (java.util.ArrayList)regList.get(countryLst.get(k3));
                    if(arraylist7 != null)
                    {
                        for(int l3 = 0; l3 < arraylist7.size(); l3++)
                        {
                            if(!obj.equals(arraylist7.get(l3)))
                                continue;
                            cRegiment.setSelected(l3, true, false);
                            break;
                        }
        ...
        try
        {
            for(int k2 = 0; k2 < airNames.size(); k2++)
            {
                if(!quikPlane.equals(airNames.get(k2)))
                    continue;
                cAircraft.setSelected(k2, true, false);
                break;
            }
        ...
        preparePilot();
        prepareNoseart();
        break MISSING_BLOCK_LABEL_3551;
