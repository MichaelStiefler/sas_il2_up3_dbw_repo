...
public class CockpitJU_88C6NJ extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            JU_88C6NJ ju_88c6nj = (JU_88C6NJ)aircraft();
            if(JU_88C6NJ.bChangedPit)
            {
                reflectPlaneToModel();
                JU_88C6NJ ju_88c6nj1 = (JU_88C6NJ)aircraft();
            ...
            if(fm != null)
            {
                ...
                if(buzzerFX != null)
                    if(fm.Loc.z < (double)((JU_88C6NJ)aircraft()).fDiveRecoveryAlt && ((JU_88C6NJ)fm.actor).diveMechStage == 1)
                        buzzerFX.play();
                    else
                    if(buzzerFX.isPlaying())
                        buzzerFX.stop();
                f1 = ((JU_88C6NJ)aircraft()).fDiveRecoveryAlt;
                float f2 = -(((JU_88C6NJ)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.sin(java.lang.Math.toRadians(((JU_88C6NJ)aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float)java.lang.Math.sqrt(f2 * f2 + 2.0F * f1 * 0.1019F);
                float f3 = ((JU_88C6NJ)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.cos(java.lang.Math.toRadians(((JU_88C6NJ)aircraft()).fDiveAngle));
                float f4 = (f3 * f2 + 10F) - 10F;
                setNew.alpha = 90F - ((JU_88C6NJ)aircraft()).fDiveAngle - (float)java.lang.Math.toDegrees(java.lang.Math.atan(f4 / f1));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = pictFlap = 0.85F * pictFlap + 0.00948F * fm.CT.FlapsControl;
        mesh.chunkSetLocate("zFlaps1", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = pictGear = 0.85F * pictGear + 0.007095F * fm.CT.GearControl;
        mesh.chunkSetLocate("zGear1", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = -0.1134F * setNew.prop1;
        mesh.chunkSetLocate("zPitch1", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = -0.1134F * setNew.prop2;
        mesh.chunkSetLocate("zPitch2", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = -0.1031F * setNew.throttle1;
        mesh.chunkSetLocate("zThrottle1", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = -0.1031F * setNew.throttle2;
        mesh.chunkSetLocate("zThrottle2", Cockpit.xyz, Cockpit.ypr);
        mesh.chunkSetAngles("z_Object20", cvt(((JU_88C6NJ)aircraft()).fSightCurSpeed, 400F, 800F, 87F, -63.5F), 0.0F, 0.0F);
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = -(10.27825F * (float)java.lang.Math.tan(java.lang.Math.toRadians(setNew.alpha)));
        ...
        mesh.chunkSetAngles("zAlt3", (((JU_88C6NJ)aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
