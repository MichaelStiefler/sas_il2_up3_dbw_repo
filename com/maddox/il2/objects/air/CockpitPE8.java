...
public class CockpitPE8 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitPE8 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE8.this.fm != null) {
        CockpitPE8.access$102(CockpitPE8.this, CockpitPE8.this.setOld);
        CockpitPE8.access$202(CockpitPE8.this, CockpitPE8.this.setNew);
        CockpitPE8.access$302(CockpitPE8.this, CockpitPE8.this.setTmp);
        if (CockpitPE8.this.fm.CT.Weapons[3] != null) {
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 0)
            CockpitPE8.this.bBombs[1] = (!CockpitPE8.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 1)
            CockpitPE8.this.bBombs[0] = (!CockpitPE8.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 2)
            CockpitPE8.this.bBombs[3] = (!CockpitPE8.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 3)
            CockpitPE8.this.bBombs[2] = (!CockpitPE8.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 4)
            CockpitPE8.this.bBombs[5] = (!CockpitPE8.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 5)
            CockpitPE8.this.bBombs[4] = (!CockpitPE8.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 6) {
            CockpitPE8.this.bBombs[5] = ((CockpitPE8.this.bBombs[5] != 0) || (!CockpitPE8.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 7) {
            CockpitPE8.this.bBombs[4] = ((CockpitPE8.this.bBombs[4] != 0) || (!CockpitPE8.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 8)
            CockpitPE8.this.bBombs[7] = (!CockpitPE8.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitPE8.this.fm.CT.Weapons[3].length > 9)
            CockpitPE8.this.bBombs[6] = (!CockpitPE8.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        ...
        CockpitPE8.this.setNew.vspeed = ((100.0F * CockpitPE8.this.setOld.vspeed + CockpitPE8.this.fm.getVertSpeed()) / 101.0F);

        float f = CockpitPE8.this.waypointAzimuth();
        CockpitPE8.this.setNew.waypointAzimuth.setDeg(CockpitPE8.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitPE8.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        ...
        CockpitPE8.this.setNew.inert = (0.999F * CockpitPE8.this.setOld.inert + 0.001F * (CockpitPE8.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
