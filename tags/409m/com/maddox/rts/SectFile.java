...
public class SectFile
{
    ...
    public boolean saveFile(java.lang.String s)
    {
        ...
        if(bUseUnicodeTo8bit)
        {
            ...
            {
                printwriter.println('[' + com.maddox.util.UnicodeTo8bit.save((java.lang.String)sectNames.get(i), false) + ']');
        ...
        } else
        {
            ...
            {
                printwriter.println('[' + (java.lang.String)sectNames.get(j) + ']');
