...
public class CockpitSEAHURRICANE1 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.arrestorControl, 0.01F, 0.99F, 0.0F, 0.03F);
        super.mesh.chunkSetLocate("Arrester1", Cockpit.xyz, Cockpit.ypr);
        ...
        Cockpit.xyz[2] = 0.01625F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getAileron();
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = 0.05865F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getControlRadiator();
