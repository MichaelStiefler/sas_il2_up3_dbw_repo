...
//            Scheme2, PaintSchemeFMPar04, TypeFighter, NetAircraft, 
//            PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    public void update(float f)
    {
        ...
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL_D0", 0.0F, com.maddox.il2.objects.air.BF_109Z.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F), 0.0F);
            hierMesh().chunkSetAngles("SlatR_D0", 0.0F, com.maddox.il2.objects.air.BF_109Z.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F), 0.0F);
        }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Armor: Hit..");
                if(s.endsWith("p1"))
                {
                    getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(20F, 30F), shot);
                    FM.AS.setCockpitState(shot.initiator, FM.AS.astateCockpitState | 2);
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Armor Glass: Hit..");
                    if(shot.power <= 0.0F)
                    {
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                            doRicochetBack(shot);
                    }
                } else
                ...
                if(s.endsWith("p3"))
                {
                    if(point3d.z < -0.27000000000000002D)
                        getEnergyPastArmor(4.0999999046325684D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-006D), shot);
                    else
                        getEnergyPastArmor(8.1000003814697266D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
                } else
                if(s.endsWith("p4"))
                    getEnergyPastArmor(10.100000381469727D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-006D), shot);
                else
                if(s.endsWith("p5"))
                    getEnergyPastArmor(10.100000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
                else
                if(s.endsWith("p6"))
                    getEnergyPastArmor(12.100000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
                else
                if(s.endsWith("a1"))
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 4: // '\004'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Aileron Controls: Control Crank Destroyed..");
                    }
                    break;
                ...
                case 8: // '\b'
                    ...
                    {
                        FM.AS.setControlsDamage(shot.initiator, 0);
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Aileron Controls: Disabled..");
                    }
                    break;
                ...
                case 11: // '\013'
                    if(getEnergyPastArmor(0.002F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Elevator Controls: Disabled / Strings Broken..");
                    }
                    break;
                ...
                case 9: // '\t'
                    if(getEnergyPastArmor(2.3F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.2F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Rudder Controls: Disabled..");
                    }
                    break;
                ...
                case 12: // '\f'
                    ...
                    {
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        FM.AS.setControlsDamage(shot.initiator, 1);
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                ...
                case 13: // '\r'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                    }
                    break;
                }
                return;
            ...
            {
                com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Spar Construction: Hit..");
                if(s.startsWith("xxspart1") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(3.5F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Tail1 Spars Broken in Half..");
                    nextDMGLevels(1, 2, "Tail1_D3", shot.initiator);
                }
                if(s.startsWith("xxspart2") && chunkDamageVisible("Tail2") > 2 && getEnergyPastArmor(3.5F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Tail2 Spars Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingROut Spars Damaged..");
            ...
            if(s.startsWith("xxwj"))
            {
                if(getEnergyPastArmor(12.5F, shot) > 0.0F)
                {
                    if(s.endsWith("l1"))
                    {
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingL Console Lock Destroyed..");
                        nextDMGLevels(4, 2, "WingLIn_D" + chunkDamageVisible("WingLIn"), shot.initiator);
                    }
                    if(s.endsWith("l2") || s.endsWith("r2"))
                    {
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingR Console Lock Destroyed..");
                        nextDMGLevels(4, 2, "WingRIn_D" + chunkDamageVisible("WingRIn"), shot.initiator);
                    }
                    if(s.endsWith("r1"))
                    {
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** WingR Outer Console Lock Destroyed..");
            ...
            if(s.startsWith("xxlock"))
            {
                ...
                {
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** VatorR Lock Shot Off..");
            ...
            {
                int j = s.charAt(5) - 49;
                com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine Module: Hit..");
                if(s.endsWith("pipe"))
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && FM.CT.Weapons[0] != null)
                    {
                        FM.AS.setJamBullets(0, j);
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Nose Nozzle Pipe Bent..");
                    }
                ...
                if(s.endsWith("prop"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.8F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Prop Governor Hit, Disabled..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, j, 4);
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Prop Governor Hit, Damaged..");
                        }
                } else
                if(s.endsWith("gear"))
                {
                    if(getEnergyPastArmor(4.6F, shot) > 0.0F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Bullet Jams Reductor Gear..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, j, 3);
                            FM.AS.setEngineSpecificDamage(shot.initiator, j, 4);
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Reductor Gear Damaged, Prop Governor Failed..");
                        }
                } else
                if(s.endsWith("supc"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Supercharger Disabled..");
                    }
                } else
                if(s.endsWith("feed"))
                {
                    if(getEnergyPastArmor(3.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && FM.EI.engines[j].getPowerOutput() > 0.7F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Pressurized Fuel Line Pierced, Fuel Flamed..");
                    }
                } else
                if(s.endsWith("fuel"))
                {
                    if(getEnergyPastArmor(1.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Fuel Line Stalled, Engine Stalled..");
                    }
                } else
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(2.1F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 175000F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Bullet Jams Crank Ball Bearing..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                        {
                            FM.AS.hitEngine(shot.initiator, j, 2);
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Crank Case Hit, Readyness Reduced to " + FM.EI.engines[j].getReadyness() + "..");
                        }
                ...
                if(s.endsWith("cyl1") || s.endsWith("cyl2"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[j].getCylindersRatio() * 1.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Cylinders Hit, " + FM.EI.engines[j].getCylindersOperable() + "/" + FM.EI.engines[j].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 24000F)
                        {
                            FM.AS.hitEngine(shot.initiator, j, 3);
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Cylinders Hit, Engine Fires..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F)
                        {
                            FM.AS.setEngineStuck(shot.initiator, j);
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Bullet Jams Piston Head..");
                        }
                        getEnergyPastArmor(22.5F, shot);
                    }
                } else
                if(s.endsWith("mag1") || s.endsWith("mag2"))
                {
                    ...
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Magneto " + j1 + " Destroyed..");
                } else
                if(s.endsWith("sync"))
                {
                ...
                if(s.endsWith("oil1"))
                {
                    ...
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + j + ": Oil Radiator Hit..");
                }
                return;
            }
            if(s.startsWith("xxoil"))
            {
                if(getEnergyPastArmor(2.2F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Engine" + k + ": Oil Tank Pierced..");
                }
                return;
            }
            if(s.startsWith("xxtank"))
            {
                ...
                case 2: // '\002'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                    {
                        ...
                        {
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Fuel Tank: Pierced..");
                        ...
                        if(shot.powerType == 3 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Fuel Tank: Hit..");
                        }
                    }
                    break;
            ...
            if(s.startsWith("xxcannon"))
            {
                if(getEnergyPastArmor(4.6F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.BF_109Z.debugprintln(this, "*** Cannon(" + i1 + "): Disabled..");
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.BF_109Z.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 1, 1, 9, 9, 9, 3, 3, 
            3, 3
        });
        com.maddox.il2.objects.air.BF_109Z.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109Z.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMK108ki 65", "MGunMK108ki 65", "MGunMK108ki 35", null, "MGunMK108ki 35", null, null, null, null, null, 
            null, null
        });
        com.maddox.il2.objects.air.BF_109Z.weaponsRegister(class1, "mk103", new java.lang.String[] {
            "MGunMK108ki 65", "MGunMK108ki 65", "MGunMK108ki 35", "MGunMK103ki 35", "MGunMK108ki 35", null, "PylonMk103", null, null, null, 
            null, null
        });
        com.maddox.il2.objects.air.BF_109Z.weaponsRegister(class1, "sc500", new java.lang.String[] {
            "MGunMK108ki 65", "MGunMK108ki 65", "MGunMK108ki 35", null, "MGunMK108ki 35", null, "PylonETC900", null, "BombGunSC500", null, 
            null, null
        });
        com.maddox.il2.objects.air.BF_109Z.weaponsRegister(class1, "sc500sc250", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.BF_109Z.weaponsRegister(class1, "none", new java.lang.String[] {
