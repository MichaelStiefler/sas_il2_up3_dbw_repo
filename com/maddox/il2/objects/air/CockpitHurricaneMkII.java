...
public class CockpitHurricaneMkII extends CockpitPilot
{
  ...
  public CockpitHurricaneMkII()
  {
    super("3DO/Cockpit/HurricaneMkII/HURRICANE2.him", "bf109");
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitHurricaneMkII.this.bNeedSetUp)
      {
        CockpitHurricaneMkII.this.reflectPlaneMats();
        CockpitHurricaneMkII.access$002(CockpitHurricaneMkII.this, false);
      }
      if (CockpitHurricaneMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitHurricaneMkII.access$102(CockpitHurricaneMkII.this, CockpitHurricaneMkII.this.setOld);
        CockpitHurricaneMkII.access$202(CockpitHurricaneMkII.this, CockpitHurricaneMkII.this.setNew);
        CockpitHurricaneMkII.access$302(CockpitHurricaneMkII.this, CockpitHurricaneMkII.this.setTmp);
        CockpitHurricaneMkII.this.setNew.throttle = ((10.0F * CockpitHurricaneMkII.this.setOld.throttle + CockpitHurricaneMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitHurricaneMkII.this.setNew.altimeter = CockpitHurricaneMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitHurricaneMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
          CockpitHurricaneMkII.this.setNew.azimuth = ((35.0F * CockpitHurricaneMkII.this.setOld.azimuth + -CockpitHurricaneMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        if ((CockpitHurricaneMkII.this.setOld.azimuth > 270.0F) && (CockpitHurricaneMkII.this.setNew.azimuth < 90.0F))
          CockpitHurricaneMkII.this.setOld.azimuth -= 360.0F;
        if ((CockpitHurricaneMkII.this.setOld.azimuth < 90.0F) && (CockpitHurricaneMkII.this.setNew.azimuth > 270.0F))
          CockpitHurricaneMkII.this.setOld.azimuth += 360.0F;
        CockpitHurricaneMkII.this.setNew.waypointAzimuth = ((10.0F * CockpitHurricaneMkII.this.setOld.waypointAzimuth + (CockpitHurricaneMkII.this.waypointAzimuth() - CockpitHurricaneMkII.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitHurricaneMkII.this.setNew.vspeed = ((199.0F * CockpitHurricaneMkII.this.setOld.vspeed + CockpitHurricaneMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitHurricaneMkII this$0;
    ...
    Variables(CockpitHurricaneMkII.1 arg2)
    {
      this();
    }
  }
