...
public class RocketHVAR5AP extends Rocket
{
  static
  {
    Class localClass = RocketHVAR5AP.class;
    Property.set(localClass, "mesh", "3DO/Arms/HVAR-5inch-AP/mono.sim");
    ...
    Property.set(localClass, "radius", 6.0F);
