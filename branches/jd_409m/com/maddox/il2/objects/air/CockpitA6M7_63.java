...
public class CockpitA6M7_63 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitA6M7_63.access$102(CockpitA6M7_63.this, CockpitA6M7_63.this.setOld); CockpitA6M7_63.access$202(CockpitA6M7_63.this, CockpitA6M7_63.this.setNew); CockpitA6M7_63.access$302(CockpitA6M7_63.this, CockpitA6M7_63.this.setTmp);

        if (CockpitA6M7_63.this.cockpitDimControl) {
          if (CockpitA6M7_63.this.setNew.dimPosition > 0.0F) CockpitA6M7_63.this.setNew.dimPosition = (CockpitA6M7_63.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitA6M7_63.this.setNew.dimPosition < 1.0F) CockpitA6M7_63.this.setNew.dimPosition = (CockpitA6M7_63.this.setOld.dimPosition + 0.05F);

        if ((CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) {
          if (CockpitA6M7_63.this.setNew.stbyPosition > 0.0F) CockpitA6M7_63.this.setNew.stbyPosition = (CockpitA6M7_63.this.setOld.stbyPosition - 0.025F);
        }
        else if (CockpitA6M7_63.this.setNew.stbyPosition < 1.0F) CockpitA6M7_63.this.setNew.stbyPosition = (CockpitA6M7_63.this.setOld.stbyPosition + 0.025F);

        CockpitA6M7_63.this.setNew.throttle = (0.9F * CockpitA6M7_63.this.setOld.throttle + 0.1F * CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitA6M7_63.this.setNew.prop = (0.9F * CockpitA6M7_63.this.setOld.prop + 0.1F * CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitA6M7_63.this.setNew.mix = (0.8F * CockpitA6M7_63.this.setOld.mix + 0.2F * CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitA6M7_63.this.setNew.man = (0.92F * CockpitA6M7_63.this.setOld.man + 0.08F * CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitA6M7_63.this.setNew.altimeter = CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitA6M7_63.this.setNew.azimuth.setDeg(CockpitA6M7_63.this.setOld.azimuth.getDeg(1.0F), CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitA6M7_63.this.setNew.vspeed = ((199.0F * CockpitA6M7_63.this.setOld.vspeed + CockpitA6M7_63.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        float f = CockpitA6M7_63.this.waypointAzimuth();

        CockpitA6M7_63.this.setNew.waypointAzimuth.setDeg(CockpitA6M7_63.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M7_63.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-5.0F, 5.0F));

        CockpitA6M7_63.this.setNew.waypointDirection.setDeg(CockpitA6M7_63.this.setOld.waypointDirection.getDeg(1.0F), f);
      }
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float stbyPosition;
    private final CockpitA6M7_63 this$0;
    ...
    Variables(CockpitA6M7_63.1 arg2)
    {
      this();
    }
  }
