...
public class CockpitBF_109F4x extends CockpitPilot
{
  private float tmp;
  ...
  public CockpitBF_109F4x()
  {
    super("3do/cockpit/Bf-109F-2/f4pit.him", "bf109");
  ...
  private class Variables
  {
    ...
    float mix;
    private final CockpitBF_109F4x this$0;
    ...
    Variables(CockpitBF_109F4x.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitBF_109F4x.this.bNeedSetUp)
      {
        CockpitBF_109F4x.this.reflectPlaneMats();
        CockpitBF_109F4x.access$002(CockpitBF_109F4x.this, false);
      }
      CockpitBF_109F4x.access$102(CockpitBF_109F4x.this, CockpitBF_109F4x.this.setOld);
      CockpitBF_109F4x.access$202(CockpitBF_109F4x.this, CockpitBF_109F4x.this.setNew);
      CockpitBF_109F4x.access$302(CockpitBF_109F4x.this, CockpitBF_109F4x.this.setTmp);
      CockpitBF_109F4x.this.setNew.altimeter = CockpitBF_109F4x.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_109F4x.this.cockpitDimControl)
      {
        if (CockpitBF_109F4x.this.setNew.dimPosition > 0.0F)
          CockpitBF_109F4x.this.setNew.dimPosition = (CockpitBF_109F4x.this.setOld.dimPosition - 0.05F);
      }
      else if (CockpitBF_109F4x.this.setNew.dimPosition < 1.0F)
        CockpitBF_109F4x.this.setNew.dimPosition = (CockpitBF_109F4x.this.setOld.dimPosition + 0.05F);
      CockpitBF_109F4x.this.setNew.throttle = ((10.0F * CockpitBF_109F4x.this.setOld.throttle + CockpitBF_109F4x.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109F4x.this.setNew.mix = ((8.0F * CockpitBF_109F4x.this.setOld.mix + CockpitBF_109F4x.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109F4x.this.setNew.azimuth = CockpitBF_109F4x.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109F4x.this.setOld.azimuth > 270.0F) && (CockpitBF_109F4x.this.setNew.azimuth < 90.0F))
        CockpitBF_109F4x.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_109F4x.this.setOld.azimuth < 90.0F) && (CockpitBF_109F4x.this.setNew.azimuth > 270.0F))
        CockpitBF_109F4x.this.setOld.azimuth += 360.0F;
      CockpitBF_109F4x.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_109F4x.this.setOld.waypointAzimuth + (CockpitBF_109F4x.this.waypointAzimuth() - CockpitBF_109F4x.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitBF_109F4x.this.buzzerFX((CockpitBF_109F4x.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.999999F) && (CockpitBF_109F4x.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.0F));
      return true;
    }
