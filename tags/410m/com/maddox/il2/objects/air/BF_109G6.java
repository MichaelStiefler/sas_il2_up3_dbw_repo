    ...
    implements com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    public void update(float f)
    {
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL_D0", 0.0F, com.maddox.il2.objects.air.BF_109G6.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F), 0.0F);
            hierMesh().chunkSetAngles("SlatR_D0", 0.0F, com.maddox.il2.objects.air.BF_109G6.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F), 0.0F);
        }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "U4R3-MK108", new java.lang.String[] {
