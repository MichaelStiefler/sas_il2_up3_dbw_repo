...
public class BF_109F2 extends BF_109
{
  ...
  static
  {
    Class localClass = BF_109F2.class;
    new NetAircraft.SPAWN(localClass);

    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3DO/Plane/Bf-109F-2/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar03());
    Property.set(localClass, "meshName_hu", "3DO/Plane/Bf-109F-2(hu)/hier.him");
    Property.set(localClass, "PaintScheme_hu", new PaintSchemeFMPar03());

    Property.set(localClass, "yearService", 1941.0F);
    Property.set(localClass, "yearExpired", 1944.5F);

    Property.set(localClass, "FlightModel", "FlightModels/Bf-109F-2.fmd");
    Property.set(localClass, "cockpitClass", CockpitBF_109F2.class);
    Property.set(localClass, "LOSElevation", 0.74205F);

    Aircraft.weaponTriggersRegister(localClass, new int[] { 0, 0, 1, 9, 9, 3, 3, 3, 3, 3 });

    Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_CANNON01", "_ExternalDev01", "_ExternalDev01", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05" });

    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG151ki 200", null, null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "1sc250", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG151ki 200", "PylonETC900 1", null, "BombGunSC250 1", null, null, null, null });

    Aircraft.weaponsRegister(localClass, "4sc50", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG151ki 200", "PylonETC50Bf109 1", null, null, "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1" });

    Aircraft.weaponsRegister(localClass, "droptank", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG151ki 200", "PylonETC900 1", "FuelTankGun_Type_D 1", null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "field_mod", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15120MGki 200", null, null, null, null, null, null, null });
