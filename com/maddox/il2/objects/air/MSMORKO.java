...
public class MSMORKO extends com.maddox.il2.objects.air.MS400X
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MSMORKO.weaponTriggersRegister(class1, new int[] {
            0, 0, 1
        });
        com.maddox.il2.objects.air.MSMORKO.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_CANNON01"
        });
        com.maddox.il2.objects.air.MSMORKO.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMAC1934 300", "MGunMAC1934 300", "MGunMG15120MGki 150"
        });
        com.maddox.il2.objects.air.MSMORKO.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
}
