...
// Source File Name:   CockpitHS123.java
...
//            CockpitPilot, HS123, Aircraft, Cockpit

public class CockpitHS123 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(((com.maddox.il2.objects.air.HS123)aircraft()).bChangedPit)
            {
                reflectPlaneToModel();
                ((com.maddox.il2.objects.air.HS123)aircraft()).bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetLocate("Z_Column_but", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.015F * fm.CT.getTrimAileronControl();
        mesh.chunkSetLocate("Z_Trim1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
