...
// Source File Name:   AGCIGeneric.java
...
public abstract class AGCIGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.AGCIGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.AGCIGeneric.Rnd(30F, 50F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.AGCIGeneric agcigeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.AGCIGeneric.constr_arg2 = actorspawnarg;
                agcigeneric = (com.maddox.il2.objects.vehicles.stationary.AGCIGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.AGCIGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create AGCIGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (agcigeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.AGCIGeneric.mesh_name);
            cls = class1;
    ...
    private AGCIGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    public void startMove()
    {
        if(!interpEnd("move"))
        {
            ...
            engineSTimer = -(int)com.maddox.il2.objects.vehicles.stationary.AGCIGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.AGCIGeneric.Rnd(30F, 30F));
        }
    }
    ...
    private boolean danger()
    {
        ...
        boolean flag = false;
        float f = 1000F;
        com.maddox.il2.objects.air.Aircraft aircraft = com.maddox.il2.ai.War.GetNearestEnemyAircraft(((com.maddox.il2.engine.Actor) (com.maddox.il2.ai.World.getPlayerAircraft())), 1000F, 9);
        for(int i = 0; aircraft == null && i < 100; i++)
        {
            aircraft = com.maddox.il2.ai.War.GetNearestEnemyAircraft(((com.maddox.il2.engine.Actor) (com.maddox.il2.ai.World.getPlayerAircraft())), 1000F + f, 9);
            f += 1000F;
        }

        boolean flag1 = false;
        if(((com.maddox.il2.engine.Actor) (aircraft)).getSpeed(vector3d) > 20D && ((com.maddox.il2.engine.Actor) (aircraft)).pos.getAbsPoint().distance(point3d) < 100000D && ((com.maddox.il2.engine.Actor) (aircraft)).pos.getAbsPoint().z >= 150D && aircraft != com.maddox.il2.ai.World.getPlayerAircraft() && ((com.maddox.il2.engine.Actor) (aircraft)).getArmy() != myArmy)
        {
            pos.getAbs(point3d);
            ...
            if(d4 > 260D)
                ...
                s = "" + c1;
            new String();
            int j = (int)(java.lang.Math.floor(((com.maddox.il2.engine.Actor) (aircraft)).pos.getAbsPoint().z * 3.2808399000000001D * 0.10000000000000001D) * 10D);
            int k = (int)(java.lang.Math.floor((((com.maddox.il2.engine.Actor) (aircraft)).getSpeed(vector3d) * 0.62137119200000002D * 60D * 60D) / 10000D) * 10D);
            new String();
            ...
            if(i1 < 0)
                i1 = 360 + i1;
            int j1 = (int)(java.lang.Math.ceil(java.lang.Math.sqrt(d14 * d14 + d13 * d13)) * 0.62137119200000002D);
            if(flag)
            {
                if(j1 > 4)
                    com.maddox.il2.game.HUD.logCenter("                                          Target bearing " + l + "\260" + ", range " + j1 + " miles, height " + j + "ft, heading " + i1 + "\260");
                else
                    com.maddox.il2.game.HUD.logCenter(" ");
            } else
            {
                com.maddox.il2.game.HUD.logCenter("                                                                             Target at " + s + "-" + d9 + ", height " + j + "ft, heading " + i1 + "\260");
            }
        }
        return true;
    }
