...
public class NetFileServerNoseart extends NetFileServerDef
{
  public int compressMethod()
  {
    return 2; } 
  public int compressBlockSize() { return 32768; } 
  public String primaryPath() { return "PaintSchemes/Noseart"; } 
  ...
  public NetFileServerNoseart(int paramInt) {
    super(paramInt);
  }
}