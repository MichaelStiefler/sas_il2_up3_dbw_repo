...
//            CockpitPilot, Aircraft, Cockpit, BF_110C4B

public class CockpitBF_110C4B extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if((com.maddox.il2.objects.air.BF_110C4B)aircraft() != null);
            if(com.maddox.il2.objects.air.BF_110C4B.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.BF_110C4B)aircraft() != null);
                com.maddox.il2.objects.air.BF_110C4B.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
