// Source File Name: CockpitB17G.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB17G.this.fm != null) {
				...
				CockpitB17G.this.setNew.throttle1 = (0.85F * CockpitB17G.this.setOld.throttle1)
						+ (CockpitB17G.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitB17G.this.setNew.throttle2 = (0.85F * CockpitB17G.this.setOld.throttle2)
						+ (CockpitB17G.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitB17G.this.setNew.prop1 = (0.85F * CockpitB17G.this.setOld.prop1)
						+ (CockpitB17G.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitB17G.this.setNew.prop2 = (0.85F * CockpitB17G.this.setOld.prop2)
						+ (CockpitB17G.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitB17G.this.setNew.altimeter = CockpitB17G.this.fm
						.getAltitude();
				float f = CockpitB17G.this.waypointAzimuth();
				CockpitB17G.this.setNew.azimuth.setDeg(
						CockpitB17G.this.setOld.azimuth.getDeg(1.0F),
						CockpitB17G.this.fm.Or.azimut());
				CockpitB17G.this.setNew.waypointAzimuth
						.setDeg(CockpitB17G.this.setOld.waypointAzimuth
								.getDeg(1.0F), f);
				CockpitB17G.this.setNew.waypointDeviation.setDeg(
						CockpitB17G.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitB17G.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitB17G.this.setNew.vspeed = ((199F * CockpitB17G.this.setOld.vspeed) + CockpitB17G.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
