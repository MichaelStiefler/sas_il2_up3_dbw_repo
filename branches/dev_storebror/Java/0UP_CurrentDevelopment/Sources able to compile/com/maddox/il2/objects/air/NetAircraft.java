...
public abstract class NetAircraft extends SndAircraft
{
	...
	private void netCockpitAuto(Actor actor, int i, boolean bool, short[] is, NetChannel netchannel)
	{
		...
		if (object != null)
		{
			...
			if (!(class$com$maddox$il2$objects$air$CockpitPilot == null ? (class$com$maddox$il2$objects$air$CockpitPilot = class$ZutiNetAircraft("CockpitPilot")) : class$com$maddox$il2$objects$air$CockpitPilot)
    ...
    {
        return NetAircraft.isOnCarrierDeck(airportcarrier, loc.getPoint());
    }
