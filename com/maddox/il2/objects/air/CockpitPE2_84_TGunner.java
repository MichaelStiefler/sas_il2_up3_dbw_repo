...
public class CockpitPE2_84_TGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurrelA", -paramOrient.getYaw(), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurrelB", -paramOrient.getTangage(), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurrelQ", -cvt(paramOrient.getYaw(), -45.0F, 12.0F, -45.0F, 12.0F), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurrelC", -cvt(paramOrient.getTangage(), -1.0F, 45.0F, -1.0F, 45.0F), 0.0F, 0.0F);
    resetYPRmodifier();
    Cockpit.xyz[0] = cvt(paramOrient.getYaw(), 0.0F, 12.0F, 0.0F, -0.14F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetLocate("TurrelD", Cockpit.xyz, Cockpit.ypr);
  }
  ...
  public CockpitPE2_84_TGunner()
  {
    super("3DO/Cockpit/Pe-2series84-TGun/hier.him", "he111");
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitPE2_84_TGunner.access$102(CockpitPE2_84_TGunner.this, CockpitPE2_84_TGunner.this.setOld); CockpitPE2_84_TGunner.access$202(CockpitPE2_84_TGunner.this, CockpitPE2_84_TGunner.this.setNew); CockpitPE2_84_TGunner.access$302(CockpitPE2_84_TGunner.this, CockpitPE2_84_TGunner.this.setTmp);
        if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3] != null) {
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 0) {
            CockpitPE2_84_TGunner.this.bBombs[1] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][0].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 1) {
            CockpitPE2_84_TGunner.this.bBombs[0] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][1].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 2) {
            CockpitPE2_84_TGunner.this.bBombs[3] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][2].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 3) {
            CockpitPE2_84_TGunner.this.bBombs[2] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][3].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 4) {
            CockpitPE2_84_TGunner.this.bBombs[5] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][4].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 5) {
            CockpitPE2_84_TGunner.this.bBombs[4] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][5].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 6) {
            CockpitPE2_84_TGunner.this.bBombs[5] = ((CockpitPE2_84_TGunner.this.bBombs[5] != 0) || (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 7) {
            CockpitPE2_84_TGunner.this.bBombs[4] = ((CockpitPE2_84_TGunner.this.bBombs[4] != 0) || (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 8) {
            CockpitPE2_84_TGunner.this.bBombs[7] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][8].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 9) {
            CockpitPE2_84_TGunner.this.bBombs[6] = (!CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][9].haveBullets() ? 1 : 0);
          }

        }

        CockpitPE2_84_TGunner.this.setNew.man1 = (0.92F * CockpitPE2_84_TGunner.this.setOld.man1 + 0.08F * CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());

        CockpitPE2_84_TGunner.this.setNew.man2 = (0.92F * CockpitPE2_84_TGunner.this.setOld.man2 + 0.08F * CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitPE2_84_TGunner.this.setNew.altimeter = CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitPE2_84_TGunner.this.setNew.azimuth.setDeg(CockpitPE2_84_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitPE2_84_TGunner.this.setNew.vspeed = ((100.0F * CockpitPE2_84_TGunner.this.setOld.vspeed + CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);

        float f = CockpitPE2_84_TGunner.this.waypointAzimuth();

        CockpitPE2_84_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE2_84_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitPE2_84_TGunner.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitPE2_84_TGunner.this.setNew.waypointDirection.setDeg(CockpitPE2_84_TGunner.this.setOld.waypointDirection.getDeg(1.0F), f);

        CockpitPE2_84_TGunner.this.setNew.inert = (0.999F * CockpitPE2_84_TGunner.this.setOld.inert + 0.001F * (CockpitPE2_84_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitPE2_84_TGunner this$0;
    ...
    Variables(CockpitPE2_84_TGunner.1 arg2)
    {
      this();
    }
  }
