...
public class CockpitF6F5 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF6F5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitF6F5.this.setNew.throttle = (0.85F * CockpitF6F5.this.setOld.throttle + CockpitF6F5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitF6F5.this.setNew.prop = (0.85F * CockpitF6F5.this.setOld.prop + CockpitF6F5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitF6F5.this.setNew.mix = (0.85F * CockpitF6F5.this.setOld.mix + CockpitF6F5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix() * 0.15F);
        CockpitF6F5.this.setNew.altimeter = CockpitF6F5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitF6F5.this.waypointAzimuth();
        CockpitF6F5.this.setNew.azimuth.setDeg(CockpitF6F5.this.setOld.azimuth.getDeg(1.0F), CockpitF6F5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitF6F5.this.setNew.waypointAzimuth.setDeg(CockpitF6F5.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitF6F5.this.setNew.vspeed = ((199.0F * CockpitF6F5.this.setOld.vspeed + CockpitF6F5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
