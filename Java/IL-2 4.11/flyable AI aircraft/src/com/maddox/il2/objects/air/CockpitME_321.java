	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitME_321.this.fm != null) {
				...
				CockpitME_321.this.setNew.altimeter = CockpitME_321.this.fm
						.getAltitude();
				CockpitME_321.this.setNew.azimuth.setDeg(
						CockpitME_321.this.setOld.azimuth.getDeg(1.0F),
						CockpitME_321.this.fm.Or.azimut());
				CockpitME_321.this.setNew.vspeed = ((199F * CockpitME_321.this.setOld.vspeed) + CockpitME_321.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
