...
public class BF_109G4T extends BF_109
  implements TypeBNZFighter
{
  ...
  static
  {
    Class localClass = BF_109G4T.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3DO/Plane/Bf-109G-4T/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar03());
    Property.set(localClass, "yearService", 1942.0F);
    Property.set(localClass, "yearExpired", 1945.5F);
    Property.set(localClass, "FlightModel", "FlightModels/Bf-109G-4.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitBF_109G2.class });
