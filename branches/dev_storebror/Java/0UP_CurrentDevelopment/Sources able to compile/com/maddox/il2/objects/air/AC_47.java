    ...
    implements TypeTransport
{
    ...
    {
        AC_47.moveGear(hierMesh(), f);
    }

    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        setShot(shot);
        if(shot.chunkName.startsWith("WingLOut") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Aircraft.Pd.y) < 6D)
            FM.AS.hitTank(shot.initiator, 0, 1);
        if(shot.chunkName.startsWith("WingROut") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Aircraft.Pd.y) < 6D)
            FM.AS.hitTank(shot.initiator, 3, 1);
        if(shot.chunkName.startsWith("WingLIn") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Aircraft.Pd.y) < 1.940000057220459D)
            FM.AS.hitTank(shot.initiator, 1, 1);
        if(shot.chunkName.startsWith("WingRIn") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Aircraft.Pd.y) < 1.940000057220459D)
        ...
        if(shot.chunkName.startsWith("Nose") && Aircraft.Pd.x > 4.9000000953674316D && Aircraft.Pd.z > -0.090000003576278687D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F)
    ...
    static 
    {
        java.lang.Class class1 = AC_47.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "Douglas");
        com.maddox.rts.Property.set(class1, "meshNameDemo", "3DO/Plane/AC-47/hier.him");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/AC-47/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/C-47B.fmd");
        ...
        Aircraft.weaponsRegister(class1, "3000rpm", new java.lang.String[] {
