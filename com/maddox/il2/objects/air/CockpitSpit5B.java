...
// Source File Name:   CockpitSpit5B.java
...
//            CockpitPilot, SPITFIRE5B12LBS, SPITFIRE5B, SPITFIRE5BLF, 
//            SPITFIRE5BLFCLP

public class CockpitSpit5B extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitSpit5B()
    {
        ...
        tmpP = new Point3d();
        tmpV = new Vector3d();
        if(aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE5B12LBS)
        {
            mesh.materialReplace("BORT2", "BORT2b");
            mesh.materialReplace("text14", "text14b");
        } else
        if(aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE5B)
        {
            mesh.materialReplace("BORT2", "BORT2a");
            mesh.materialReplace("text14", "text14a");
        } else
        if((aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE5BLF) || (aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE5BLFCLP))
        {
