...
// Source File Name:   CockpitYAK_9.java
...
public class CockpitYAK_9 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(fm == null)
            return;
        mesh.chunkSetAngles("richag", 0.0F, fm.CT.getAileron() * 15F, fm.CT.getElevator() * 10F);
