// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 2/04/2011 12:50:48 PM
...
public class CockpitBF_109F2 extends CockpitPilot
{
    ...
    {
        if(Actor.isValid(fm.actor) && ((fm.actor instanceof BF_109F4)||(fm.actor instanceof BF_109F4Z)||
        (fm.actor instanceof BF_109F3)||(fm.actor instanceof BF_109F4MSTL)||(fm.actor instanceof BF_109F413ATA)))
            mesh.chunkVisible("Z_ArmorGlass1", true);
        else if(Actor.isValid(fm.actor) && ((fm.actor instanceof BF_109F0)||(fm.actor instanceof BF_109F1)||
                (fm.actor instanceof BF_109F2)||(fm.actor instanceof BF_109F2U))){
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitBF_109F2.class, "normZN", 0.8F);
        Property.set(com.maddox.il2.objects.air.CockpitBF_109F2.class, "gsZN", 0.85F);
    }
}