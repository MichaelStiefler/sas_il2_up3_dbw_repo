  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_9T.this.fm != null) {
        ...
        CockpitYAK_9T.this.setNew.throttle = ((10.0F * CockpitYAK_9T.this.setOld.throttle + CockpitYAK_9T.this.fm.CT.PowerControl) / 11.0F);
        CockpitYAK_9T.this.setNew.prop = ((10.0F * CockpitYAK_9T.this.setOld.prop + CockpitYAK_9T.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_9T.this.setNew.altimeter = CockpitYAK_9T.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_9T.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_9T.this.setNew.azimuth = ((35.0F * CockpitYAK_9T.this.setOld.azimuth + CockpitYAK_9T.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitYAK_9T.this.setNew.vspeed = ((199.0F * CockpitYAK_9T.this.setOld.vspeed + CockpitYAK_9T.this.fm.getVertSpeed()) / 200.0F);
      }
