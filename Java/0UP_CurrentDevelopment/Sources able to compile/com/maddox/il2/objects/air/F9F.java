    ...
    implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker
{
    ...
    {
        F9F.moveGear(hierMesh(), f);
    }

    public void moveWheelSink()
    {
        float f = Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.gWheelSinking[2], 0.0F, 0.19075F, 0.0F, 1.0F);
        resetYPRmodifier();
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p1"))
                {
                    getEnergyPastArmor(13.350000381469727D / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).x) + 9.9999997473787516E-005D), shot);
                    if(shot.power <= 0.0F)
                        doRicochetBack(shot);
                } else
                if(s.endsWith("p2"))
                ...
                if(s.endsWith("g1"))
                {
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(40F, 60F) / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).x) + 9.9999997473787516E-005D), shot);
            ...
            if(s.startsWith("xxeng1"))
            {
                ...
                if(s.endsWith("bloc"))
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 60F) / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).x) + 9.9999997473787516E-005D), shot);
    ...
    public void update(float f)
    {
        ...
        if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getArrestor() > 0.9F)
            ...
            {
                arrestor2 = Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.arrestorVAngle, -65F, 3F, 45F, -23F);
    ...
    public void moveCockpitDoor(float paramFloat)
    {
        ...
        float f = (float)java.lang.Math.sin(Aircraft.cvt(paramFloat, 0.4F, 0.99F, 0.0F, 3.141593F));
...
;
    ...
    static 
    {
        java.lang.Class class1 = F9F.class;
