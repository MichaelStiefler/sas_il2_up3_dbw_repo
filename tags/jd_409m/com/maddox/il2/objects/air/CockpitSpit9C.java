...
public class CockpitSpit9C extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit9C.this.bNeedSetUp) {
        ...
        CockpitSpit9C.access$102(CockpitSpit9C.this, false);
      }
      if (CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitSpit9C.access$202(CockpitSpit9C.this, CockpitSpit9C.this.setOld); CockpitSpit9C.access$302(CockpitSpit9C.this, CockpitSpit9C.this.setNew); CockpitSpit9C.access$402(CockpitSpit9C.this, CockpitSpit9C.this.setTmp);

        CockpitSpit9C.this.setNew.throttle = (0.92F * CockpitSpit9C.this.setOld.throttle + 0.08F * CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitSpit9C.this.setNew.prop = (0.92F * CockpitSpit9C.this.setOld.prop + 0.08F * CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitSpit9C.this.setNew.mix = (0.92F * CockpitSpit9C.this.setOld.mix + 0.08F * CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitSpit9C.this.setNew.altimeter = CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitSpit9C.this.setNew.azimuth = (0.97F * CockpitSpit9C.this.setOld.azimuth + 0.03F * -CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw());
        }
        if ((CockpitSpit9C.this.setOld.azimuth > 270.0F) && (CockpitSpit9C.this.setNew.azimuth < 90.0F)) CockpitSpit9C.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit9C.this.setOld.azimuth < 90.0F) && (CockpitSpit9C.this.setNew.azimuth > 270.0F)) CockpitSpit9C.this.setOld.azimuth += 360.0F;
        CockpitSpit9C.this.setNew.waypointAzimuth = (0.91F * CockpitSpit9C.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit9C.this.waypointAzimuth() - CockpitSpit9C.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitSpit9C.this.setNew.vspeed = (0.99F * CockpitSpit9C.this.setOld.vspeed + 0.01F * CockpitSpit9C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed());
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    private final CockpitSpit9C this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitSpit9C.1 arg2) { this();
    }
  }
}