...
public class CockpitI_16TYPE24 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick() { if (CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        if (CockpitI_16TYPE24.this.bNeedSetUp) {
          CockpitI_16TYPE24.this.reflectPlaneMats();
          CockpitI_16TYPE24.access$102(CockpitI_16TYPE24.this, false);
        }
        CockpitI_16TYPE24.access$202(CockpitI_16TYPE24.this, CockpitI_16TYPE24.this.setOld); CockpitI_16TYPE24.access$302(CockpitI_16TYPE24.this, CockpitI_16TYPE24.this.setNew); CockpitI_16TYPE24.access$402(CockpitI_16TYPE24.this, CockpitI_16TYPE24.this.setTmp);

        CockpitI_16TYPE24.this.setNew.throttle = ((10.0F * CockpitI_16TYPE24.this.setOld.throttle + CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        CockpitI_16TYPE24.this.setNew.prop = ((10.0F * CockpitI_16TYPE24.this.setOld.prop + CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitI_16TYPE24.this.setNew.altimeter = CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitI_16TYPE24.this.setNew.azimuth = ((35.0F * CockpitI_16TYPE24.this.setOld.azimuth + -CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        if ((CockpitI_16TYPE24.this.setOld.azimuth > 270.0F) && (CockpitI_16TYPE24.this.setNew.azimuth < 90.0F)) CockpitI_16TYPE24.this.setOld.azimuth -= 360.0F;
        if ((CockpitI_16TYPE24.this.setOld.azimuth < 90.0F) && (CockpitI_16TYPE24.this.setNew.azimuth > 270.0F)) CockpitI_16TYPE24.this.setOld.azimuth += 360.0F;
        CockpitI_16TYPE24.this.setNew.waypointAzimuth = ((10.0F * CockpitI_16TYPE24.this.setOld.waypointAzimuth + (CockpitI_16TYPE24.this.waypointAzimuth() - CockpitI_16TYPE24.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);
        CockpitI_16TYPE24.this.setNew.vspeed = ((199.0F * CockpitI_16TYPE24.this.setOld.vspeed + CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);

        boolean bool = false;

        if (CockpitI_16TYPE24.this.setNew.gCrankAngle < CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() - 0.005F) {
          if (Math.abs(CockpitI_16TYPE24.this.setNew.gCrankAngle - CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) < 0.33F) {
            CockpitI_16TYPE24.this.setNew.gCrankAngle += 0.0025F;
            bool = true;
          } else {
            CockpitI_16TYPE24.this.setNew.gCrankAngle = CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear();
            CockpitI_16TYPE24.this.setOld.gCrankAngle = CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear();
          }
        }
        if (CockpitI_16TYPE24.this.setNew.gCrankAngle > CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() + 0.005F) {
          if (Math.abs(CockpitI_16TYPE24.this.setNew.gCrankAngle - CockpitI_16TYPE24.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear()) < 0.33F) {
        ...
        if (bool != this.sfxPlaying) {
          if (bool) CockpitI_16TYPE24.this.sfxStart(16); else
  ...
  private class Variables
  {
    ...
    float gCrankAngle;
    private final CockpitI_16TYPE24 this$0;
    ...
    Variables(CockpitI_16TYPE24.1 arg2)
    {
      this();
    }
  }
