...
public class CockpitF84G2 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f = ((com.maddox.il2.objects.air.F84G2)aircraft()).k14Distance;
                setNew.k14w = (5F * com.maddox.il2.objects.air.CockpitF84G2.k14TargetWingspanScale[((com.maddox.il2.objects.air.F84G2)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * com.maddox.il2.objects.air.CockpitF84G2.k14TargetMarkScale[((com.maddox.il2.objects.air.F84G2)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((com.maddox.il2.objects.air.F84G2)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, com.maddox.il2.objects.air.CockpitF84G2.k14BulletDrop) - com.maddox.il2.objects.air.CockpitF84G2.k14BulletDrop[0];
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            int i = ((com.maddox.il2.objects.air.F84G2)aircraft()).k14Mode;
            boolean flag = i < 2;
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.0F, 0.2F, 0.0F, 0.625F);
        ...
        if(tgun[0] == null)
            tgun[0] = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalDev07");
        if(tgun[0] != null)
        ...
        if(gun[0] == null)
            gun[0] = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getGunByHookName("_MGUN06");
        if(bgun[0] == null)
        {
            bgun[0] = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalBomb01");
            bgun[1] = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalBomb03");
        }
        if(rgun[0] == null)
        {
            rgun[0] = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalRock02");
            rgun[1] = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalRock22");
            rgun[2] = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalRock09");
        }
        if(gun[0] != null)
