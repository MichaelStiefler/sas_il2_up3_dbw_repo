    ...
    protected void moveFan(float f)
    {
        ...
        if(FM.Gears.onGround() && FM.CT.getGear() > 0.9F && FM.getSpeed() > 5F)
        {
            if(FM.Gears.gWheelSinking[0] > 0.0F)
                hierMesh().chunkSetAngles("GearL11_D0", com.maddox.il2.ai.World.Rnd().nextFloat(-1F, 1.0F) + f1, com.maddox.il2.ai.World.Rnd().nextFloat(-1F, 1.0F), com.maddox.il2.ai.World.Rnd().nextFloat(-1F, 1.0F));
            else
                hierMesh().chunkSetAngles("GearL11_D0", f1, 0.0F, 0.0F);
            ...
            hierMesh().chunkSetAngles("GearC11_D0", com.maddox.il2.objects.air.Aircraft.cvt(FM.Or.getTangage(), -20F, 20F, -20F, 20F), 0.0F, 0.0F);
        } else
        {
            hierMesh().chunkSetAngles("GearL11_D0", f1, 0.0F, 0.0F);
            hierMesh().chunkSetAngles("GearR11_D0", 0.0F, 0.0F, -f1);
