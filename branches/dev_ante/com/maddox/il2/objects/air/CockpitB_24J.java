...
public class CockpitB_24J extends CockpitPilot
{
  ...
  public CockpitB_24J()
  {
    super("3DO/Cockpit/B-25J/CockpitB24Jnew.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if ((this.fm.AS.astateCockpitState & 0x40) == 0)
    {
      ...
      this.mesh.chunkSetAngles("Z_Pres1", 0.0F, this.pictManf1 = 0.9F * this.pictManf1 + 0.1F * cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.338638F, 2.539784F, 0.0F, 346.5F), 0.0F);
      this.mesh.chunkSetAngles("Z_Pres2", 0.0F, this.pictManf2 = 0.9F * this.pictManf2 + 0.1F * cvt(this.fm.EI.engines[1].getManifoldPressure(), 0.338638F, 2.539784F, 0.0F, 346.5F), 0.0F);
    }
    this.mesh.chunkSetAngles("Z_FuelPres1", 0.0F, cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270.0F), 0.0F);
    this.mesh.chunkSetAngles("Z_FuelPres2", 0.0F, cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270.0F), 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitB_24J.this.fm != null)
      {
        CockpitB_24J.access$002(CockpitB_24J.this, CockpitB_24J.this.setOld);
        CockpitB_24J.access$102(CockpitB_24J.this, CockpitB_24J.this.setNew);
        CockpitB_24J.access$202(CockpitB_24J.this, CockpitB_24J.this.setTmp);
        CockpitB_24J.this.setNew.throttle1 = (0.85F * CockpitB_24J.this.setOld.throttle1 + CockpitB_24J.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
        CockpitB_24J.this.setNew.throttle2 = (0.85F * CockpitB_24J.this.setOld.throttle2 + CockpitB_24J.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
        CockpitB_24J.this.setNew.prop1 = (0.85F * CockpitB_24J.this.setOld.prop1 + CockpitB_24J.this.fm.EI.engines[0].getControlProp() * 0.15F);
        CockpitB_24J.this.setNew.prop2 = (0.85F * CockpitB_24J.this.setOld.prop2 + CockpitB_24J.this.fm.EI.engines[1].getControlProp() * 0.15F);
        CockpitB_24J.this.setNew.altimeter = CockpitB_24J.this.fm.getAltitude();
        float f = CockpitB_24J.this.waypointAzimuth();
        CockpitB_24J.this.setNew.azimuth.setDeg(CockpitB_24J.this.setOld.azimuth.getDeg(1.0F), CockpitB_24J.this.fm.Or.azimut());
        CockpitB_24J.this.setNew.waypointAzimuth.setDeg(CockpitB_24J.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitB_24J.this.setNew.waypointDeviation.setDeg(CockpitB_24J.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB_24J.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitB_24J.this.setNew.vspeed = ((199.0F * CockpitB_24J.this.setOld.vspeed + CockpitB_24J.this.fm.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitB_24J this$0;
