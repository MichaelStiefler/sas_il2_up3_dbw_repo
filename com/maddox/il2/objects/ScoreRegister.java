...
import com.maddox.il2.objects.ships.Ship.Barge0;
import com.maddox.il2.objects.ships.Ship.Barge1;
import com.maddox.il2.objects.ships.Ship.Boat;
...
import com.maddox.il2.objects.ships.Ship.Destroyer0;
import com.maddox.il2.objects.ships.Ship.Destroyer1;
import com.maddox.il2.objects.ships.Ship.Destroyer2;
import com.maddox.il2.objects.ships.Ship.DestroyerKM;
import com.maddox.il2.objects.ships.Ship.DestroyerRN;
...
import com.maddox.il2.objects.ships.Ship.Fisherman;
import com.maddox.il2.objects.ships.Ship.Fisherman1;
import com.maddox.il2.objects.ships.Ship.Fisherman2;
import com.maddox.il2.objects.ships.Ship.HMSDukeOfYorkBB;
import com.maddox.il2.objects.ships.Ship.HMSFiji;
import com.maddox.il2.objects.ships.Ship.HMSFormidableCV;
...
import com.maddox.il2.objects.ships.Ship.HMSTribal;
import com.maddox.il2.objects.ships.Ship.HospitalShip;
...
import com.maddox.il2.objects.ships.Ship.IJNHiryuCV;
import com.maddox.il2.objects.ships.Ship.IJNKagaCV;
...
import com.maddox.il2.objects.ships.Ship.IJNSoryuCV;
...
import com.maddox.il2.objects.ships.Ship.Italia0;
import com.maddox.il2.objects.ships.Ship.Italia1;
...
import com.maddox.il2.objects.ships.Ship.Littorio;
...
import com.maddox.il2.objects.ships.Ship.Soldati;
import com.maddox.il2.objects.ships.Ship.Tanker;
import com.maddox.il2.objects.ships.Ship.Tanker1;
import com.maddox.il2.objects.ships.Ship.Tanker2;
import com.maddox.il2.objects.ships.Ship.Tral;
import com.maddox.il2.objects.ships.Ship.Tramp;
import com.maddox.il2.objects.ships.Ship.Transport1;
import com.maddox.il2.objects.ships.Ship.Transport2;
import com.maddox.il2.objects.ships.Ship.TroopTrans0;
import com.maddox.il2.objects.ships.Ship.TroopTrans1;
...
import com.maddox.il2.objects.ships.Ship.USSMcKean;
...
import com.maddox.il2.objects.vehicles.artillery.Artillery.AxisBazooka;
import com.maddox.il2.objects.vehicles.artillery.Artillery.AxisInfantry;
import com.maddox.il2.objects.vehicles.artillery.Artillery.AxisPnzrInfantry;
import com.maddox.il2.objects.vehicles.artillery.Artillery.GBBazooka;
import com.maddox.il2.objects.vehicles.artillery.Artillery.GBInfantry;
import com.maddox.il2.objects.vehicles.artillery.Artillery.IS2;
import com.maddox.il2.objects.vehicles.artillery.Artillery.JapBazooka;
import com.maddox.il2.objects.vehicles.artillery.Artillery.JapInfantry;
...
import com.maddox.il2.objects.vehicles.artillery.Artillery.RusBazooka;
import com.maddox.il2.objects.vehicles.artillery.Artillery.RusInfantry;
...
import com.maddox.il2.objects.vehicles.artillery.Artillery.USBazooka;
import com.maddox.il2.objects.vehicles.artillery.Artillery.USInfantry;
...
import com.maddox.il2.objects.vehicles.lights.Searchlight;
import com.maddox.il2.objects.vehicles.planes.PlaneGeneric;
import com.maddox.il2.objects.vehicles.stationary.RadarGeneric;
...
import com.maddox.il2.objects.vehicles.stationary.Stationary.RadarChainHomeHigh;
import com.maddox.il2.objects.vehicles.stationary.Stationary.RadarChainHomeLow;
...
import com.maddox.il2.objects.vehicles.tanks.Tank.AxisBazooka;
import com.maddox.il2.objects.vehicles.tanks.Tank.AxisInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.AxisInfantryNW;
import com.maddox.il2.objects.vehicles.tanks.Tank.AxisPnzrInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.AxisSMGInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.GBBazooka;
import com.maddox.il2.objects.vehicles.tanks.Tank.GBInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.GBInfantryNW;
import com.maddox.il2.objects.vehicles.tanks.Tank.IS2;
import com.maddox.il2.objects.vehicles.tanks.Tank.JapBazooka;
import com.maddox.il2.objects.vehicles.tanks.Tank.JapInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.JapInfantryNW;
...
import com.maddox.il2.objects.vehicles.tanks.Tank.RusBazooka;
import com.maddox.il2.objects.vehicles.tanks.Tank.RusInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.RusInfantryNW;
import com.maddox.il2.objects.vehicles.tanks.Tank.RusSMGInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.T34;
import com.maddox.il2.objects.vehicles.tanks.Tank.T34_85;
import com.maddox.il2.objects.vehicles.tanks.Tank.USBazooka;
import com.maddox.il2.objects.vehicles.tanks.Tank.USInfantry;
import com.maddox.il2.objects.vehicles.tanks.Tank.USInfantryNW;
...
public class ScoreRegister
{
  ...
  static
  {
    ...
    ScoreCounter.register(Searchlight.class, 4, 10.0D, 100.0D);
    ScoreCounter.register(AeroanchoredGeneric.class, 4, 10.0D, 100.0D);
    ...
    ScoreCounter.register(Ship.HMSFormidableCV.class, 7, 700.0D, 1400.0D);
    ...
    ScoreCounter.register(Ship.HMSFiji.class, 7, 500.0D, 1000.0D);
    ScoreCounter.register(Ship.HMSTribal.class, 7, 300.0D, 800.0D);
    ...
    ScoreCounter.register(Ship.IJNHiryuCV.class, 7, 700.0D, 1400.0D);
    ScoreCounter.register(Ship.IJNKagaCV.class, 7, 700.0D, 1400.0D);
    ScoreCounter.register(Ship.IJNSoryuCV.class, 7, 700.0D, 1400.0D);
    ...
    ScoreCounter.register(Ship.HospitalShip.class, 7, -10000.0D, 20000.0D);
    ScoreCounter.register(Ship.Carrier0.class, 7, 700.0D, 1400.0D);
    ScoreCounter.register(Ship.Carrier1.class, 7, 500.0D, 1000.0D);
    ScoreCounter.register(Ship.Tanker1.class, 7, 220.0D, 440.0D);
    ScoreCounter.register(Ship.Tanker2.class, 7, 230.0D, 460.0D);
    ScoreCounter.register(Ship.Barge0.class, 7, 30.0D, 100.0D);
    ScoreCounter.register(Ship.Barge1.class, 7, 30.0D, 100.0D);
    ScoreCounter.register(Ship.Fisherman.class, 7, 150.0D, 300.0D);
    ScoreCounter.register(Ship.Fisherman1.class, 7, 150.0D, 300.0D);
    ScoreCounter.register(Ship.Fisherman2.class, 7, 150.0D, 300.0D);
    ScoreCounter.register(Ship.Transport1.class, 7, 220.0D, 440.0D);
    ScoreCounter.register(Ship.Transport2.class, 7, 230.0D, 460.0D);
    ScoreCounter.register(Ship.DestroyerRN.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.DestroyerKM.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.Boat.class, 7, 10.0D, 100.0D);
    ScoreCounter.register(Ship.Italia0.class, 7, 700.0D, 1400.0D);
    ScoreCounter.register(Ship.Italia1.class, 7, 700.0D, 1400.0D);
    ScoreCounter.register(Ship.Soldati.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.Littorio.class, 7, 700.0D, 1400.0D);
    ScoreCounter.register(Ship.Destroyer0.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.Destroyer1.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.Destroyer2.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.USSMcKean.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.USSBelleauWoodCVL24.class, 7, 600.0D, 1200.0D);
    ScoreCounter.register(Ship.USSPrincetonCVL23.class, 7, 600.0D, 1200.0D);
    ScoreCounter.register(Ship.USSSanJacintoCVL30.class, 7, 600.0D, 1200.0D);
    ScoreCounter.register(Ship.TroopTrans0.class, 7, 300.0D, 800.0D);
    ScoreCounter.register(Ship.TroopTrans1.class, 7, 600.0D, 1200.0D);
    ScoreCounter.register(Tank.USBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.GBBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.RusBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.AxisBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.JapBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.AxisInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.AxisSMGInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.AxisInfantryNW.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.AxisPnzrInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.GBInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.GBInfantryNW.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.JapInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.JapInfantryNW.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.RusInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.RusSMGInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.RusInfantryNW.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.USInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Tank.USInfantryNW.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.USBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.GBBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.RusBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.AxisBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.JapBazooka.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.AxisInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.AxisPnzrInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.GBInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.USInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.RusInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(Artillery.JapInfantry.class, 2, 10.0D, 100.0D);
    ScoreCounter.register(RadarGeneric.class, 5, 100.0D, 500.0D);
    ScoreCounter.register(Stationary.RadarChainHomeHigh.class, 5, 10.0D, 100.0D);
    ScoreCounter.register(Stationary.RadarChainHomeLow.class, 5, 10.0D, 100.0D);
  }
}