  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_39N1.this.fm != null) {
        ...
        CockpitP_39N1.this.setNew.throttle = ((10.0F * CockpitP_39N1.this.setOld.throttle + CockpitP_39N1.this.fm.CT.PowerControl) / 11.0F);
        CockpitP_39N1.this.setNew.altimeter = CockpitP_39N1.this.fm.getAltitude();

        if (Math.abs(CockpitP_39N1.this.fm.Or.getKren()) < 45.0F) {
          CockpitP_39N1.this.setNew.azimuthMag = ((349.0F * CockpitP_39N1.this.setOld.azimuthMag + CockpitP_39N1.this.fm.Or.azimut()) / 350.0F);
        }
        ...
        CockpitP_39N1.this.setNew.vspeed = ((499.0F * CockpitP_39N1.this.setOld.vspeed + CockpitP_39N1.this.fm.getVertSpeed()) / 500.0F);
        CockpitP_39N1.this.setNew.waypointAzimuth = ((10.0F * CockpitP_39N1.this.setOld.waypointAzimuth + CockpitP_39N1.this.waypointAzimuth(30.0F)) / 11.0F);
      }
