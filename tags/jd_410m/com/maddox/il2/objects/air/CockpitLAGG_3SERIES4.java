  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLAGG_3SERIES4.this.fm != null) {
        ...
        CockpitLAGG_3SERIES4.this.setNew.throttle = ((10.0F * CockpitLAGG_3SERIES4.this.setOld.throttle + CockpitLAGG_3SERIES4.this.fm.CT.PowerControl) / 11.0F);
        CockpitLAGG_3SERIES4.this.setNew.prop = ((10.0F * CockpitLAGG_3SERIES4.this.setOld.prop + CockpitLAGG_3SERIES4.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitLAGG_3SERIES4.this.setNew.altimeter = CockpitLAGG_3SERIES4.this.fm.getAltitude();
        if (Math.abs(CockpitLAGG_3SERIES4.this.fm.Or.getKren()) < 30.0F) {
          CockpitLAGG_3SERIES4.this.setNew.azimuth = ((35.0F * CockpitLAGG_3SERIES4.this.setOld.azimuth + -CockpitLAGG_3SERIES4.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        {
          CockpitLAGG_3SERIES4.this.setNew.waypointAzimuth = 0.0F;
        }
        else
        {
          CockpitLAGG_3SERIES4.this.setNew.waypointAzimuth = ((10.0F * CockpitLAGG_3SERIES4.this.setOld.waypointAzimuth + (CockpitLAGG_3SERIES4.this.waypointAzimuth() - CockpitLAGG_3SERIES4.this.setOld.azimuth)) / 11.0F);
        }

        CockpitLAGG_3SERIES4.this.setNew.vspeed = ((199.0F * CockpitLAGG_3SERIES4.this.setOld.vspeed + CockpitLAGG_3SERIES4.this.fm.getVertSpeed()) / 200.0F);
      }
