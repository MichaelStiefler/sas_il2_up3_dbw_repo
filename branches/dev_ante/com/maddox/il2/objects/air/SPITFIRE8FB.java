...
public class SPITFIRE8FB extends SPITFIRE9
{
  ...
  static
  {
    Class localClass = SPITFIRE8FB.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Spit");
    Property.set(localClass, "meshName", "3DO/Plane/SpitfireMkVIIIFB(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());
    Property.set(localClass, "yearService", 1943.0F);
    Property.set(localClass, "yearExpired", 1946.5F);
    Property.set(localClass, "FlightModel", "FlightModels/SpitfireVIIIfb.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitSpit8SL.class });
