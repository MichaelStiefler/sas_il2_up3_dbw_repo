...
public class PlMapLabel extends com.maddox.il2.builder.Plugin
{
    ...
    {
        com.maddox.il2.builder.PlMapLabel plmaplabel = (com.maddox.il2.builder.PlMapLabel)com.maddox.il2.builder.Plugin.getPlugin("MapLabel");
    ...
    {
        com.maddox.il2.builder.Plugin.builder.align(actorlabel);
        ...
        if(flag)
            com.maddox.il2.builder.Plugin.builder.setSelected(actorlabel);
    }
    ...
    public void renderMap2D()
    {
        ...
        for(int i = 0; i < allActors.size(); i++)
        {
            ...
            if(com.maddox.il2.builder.Plugin.builder.project2d(actor.pos.getAbsPoint(), p2d))
    ...
    private void fillComboBox2(int i)
    {
        ...
        if(com.maddox.il2.builder.Plugin.builder.wSelect.curFilledType != i)
        {
            ...
            com.maddox.il2.builder.Plugin.builder.wSelect.comboBox2.add("Label");
    ...
    public void createGUI()
    {
        ...
        com.maddox.il2.builder.Plugin.builder.wSelect.comboBox1.add("Label");
