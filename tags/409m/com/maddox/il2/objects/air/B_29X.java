        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("prop") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine (" + k + ") Module: Prop Governor Fails..");
                }
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine1 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine2 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine3 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine4 Spars Damaged..");
