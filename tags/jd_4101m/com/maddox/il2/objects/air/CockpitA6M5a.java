  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M5a.this.fm != null) {
        ...
        if ((CockpitA6M5a.this.fm.AS.astateCockpitState & 0x2) != 0) {
        ...
        CockpitA6M5a.this.setNew.vspeed = ((199.0F * CockpitA6M5a.this.setOld.vspeed + CockpitA6M5a.this.fm.getVertSpeed()) / 200.0F);
        ...
        else
        {
          ...
          CockpitA6M5a.this.setNew.waypointDirection.setDeg(CockpitA6M5a.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M5a.this.fm.Or.azimut() + 90.0F);
        }
