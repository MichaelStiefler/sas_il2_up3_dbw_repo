    ...
    public void load(java.lang.String s, boolean flag, boolean flag1)
    {
        ...
        try
        {
            ...
            for(int k1 = 0; k1 < j; k1++)
            {
                ...
                if(flag && !flag1)
                {
                    com.maddox.il2.objects.bridges.Bridge bridge = new Bridge(j1++, k4, i2, j3, i4, j4, f10);
            ...
            if(flag2)
            {
                ...
                if(k > 0)
                {
                    ...
                    do
                    {
                        ...
                        loc.set(f, f1, f3, f6, f9, f11);
                        com.maddox.il2.engine.ActorSpawn actorspawn = (com.maddox.il2.engine.ActorSpawn)com.maddox.rts.Spawn.get(l1);
                        if(actorspawn != null)
                            if(flag1)
                            {
            ...
            } else
            {
                ...
                if(l > 0)
                {
                    com.maddox.il2.engine.ActorSpawn aactorspawn[] = new com.maddox.il2.engine.ActorSpawn[l];
                    for(int j2 = 0; j2 < l; j2++)
                    {
                        java.lang.String s3 = datainputstream.readUTF();
                        aactorspawn[j2] = (com.maddox.il2.engine.ActorSpawn)com.maddox.rts.Spawn.get_WithSoftClass(s3);
                    }
                    ...
                    do
                    {
                        ...
                        loc.set(f2, f4, 0.0D, f7, 0.0F, 0.0F);
                        if(k2 < aactorspawn.length && aactorspawn[k2] != null)
                            if(flag1)
                            {
                                com.maddox.il2.engine.Loc loc1 = new Loc(loc);
                                _clipSpawns.add(aactorspawn[k2]);
                                _clipLoc.add(loc1);
                                _clipP0.add(loc1.getPoint());
                                i++;
                            } else
                            {
                                insert(aactorspawn[k2], loc, false);
                            }
                    } while(true);
                }
                l = datainputstream.readInt();
                if(l > 0)
                {
                    com.maddox.il2.engine.ActorSpawn aactorspawn1[] = new com.maddox.il2.engine.ActorSpawn[l];
                    for(int l2 = 0; l2 < l; l2++)
                    {
                        java.lang.String s4 = datainputstream.readUTF();
                        aactorspawn1[l2] = (com.maddox.il2.engine.ActorSpawn)com.maddox.rts.Spawn.get_WithSoftClass(s4);
                    }

                    for(int i3 = datainputstream.readInt(); i3-- > 0;)
                    {
                        int k3 = datainputstream.readInt();
                        float f5 = (float)(k3 & 0xffff) * 200F;
                        float f8 = (float)(k3 >> 16 & 0xffff) * 200F;
                        ...
                        while(l4-- > 0) 
                        {
                            ...
                            int i6 = j5 & 0x7fff;
                            if(i6 < aactorspawn1.length && aactorspawn1[i6] != null)
                            {
                                int j6 = (short)(j5 >> 16);
                                int k6 = (short)(l5 & 0xffff);
                                int l6 = (short)(l5 >> 16 & 0xffff);
                                float f12 = ((float)j6 * 360F) / 32000F;
                                float f13 = ((float)k6 * 200F) / 32000F + f5;
                                float f14 = ((float)l6 * 200F) / 32000F + f8;
                                loc.set(f13, f14, 0.0D, -f12, 0.0F, 0.0F);
                                if(flag1)
                                {
                                    com.maddox.il2.engine.Loc loc3 = new Loc(loc);
                                    _clipSpawns.add(aactorspawn1[i6]);
                                    _clipLoc.add(loc3);
                                    _clipP0.add(loc3.getPoint());
                                    i++;
                                } else
                                {
                                    insert(aactorspawn1[i6], loc, false);
                                }
                            }
                        }
                    }
            ...
            {
                com.maddox.il2.builder.PlMapAirdrome plmapairdrome = (com.maddox.il2.builder.PlMapAirdrome)com.maddox.il2.builder.PlMapActors.getPlugin("MapAirdrome");
...
label0:
                for(int l3 = 0; l3 < 3; l3++)
                {
                    ...
                    do
                    {
                        if(i1-- <= 0)
                            continue label0;
                        com.maddox.il2.builder.PathAirdrome pathairdrome = new PathAirdrome(com.maddox.il2.builder.Plugin.builder.pathes, l3);
                        ...
                        for(int k5 = 0; k5 < i5; k5++)
                        {
                            ...
                            obj1 = new PAirdrome(pathairdrome, ((com.maddox.il2.builder.PPoint) (obj1)), point3d, l3);
...
label0:
            ...
            java.lang.String s1 = "maps/" + com.maddox.il2.builder.PlMapLoad.mapDirName() + "/" + com.maddox.il2.ai.World.land().config.typeMap;
            try
            {
                teximage.SaveTGA(s1);
                bTMapChanged = false;
            ...
            {
                java.lang.String s3 = "Type map '" + s1 + "' save FAILED: " + exception1.getMessage();
        ...
        if(bHMapChanged)
        {
            ...
            {
                java.lang.String s2 = "Height map '" + s + "' save FAILED: " + exception.getMessage();
                java.lang.System.out.println(s2);
                builder.tip(s2);
            }
        }
        com.maddox.il2.builder.PlMapActors.doSave((com.maddox.rts.SectFile)null);
    }
    ...
    public void save(java.lang.String s, boolean flag)
    {
        ...
        try
        {
            ...
            for(int j2 = 0; j2 < 3; j2++)
            {
                ...
                java.lang.Object aobj1[] = builder.pathes.getOwnerAttached();
...
label0:
    ...
    public void renderMap2D()
    {
        if(!builder.isFreeView())
        {
            ...
            com.maddox.il2.engine.Actor aactor[] = builder.selectedActors();
            ...
            for(int k = 0; k < aactor.length; k++)
            {
                ...
                if(actor1 == null)
                    break;
                if(!builder.project2d(actor1.pos.getAbsPoint(), p2d))
                    continue;
                if(actor1 == actor)
                {
        ...
        if(i == type.length - 2 && matLabel != null)
        {
            ...
            if(builder.isFreeView())
            {
                com.maddox.il2.engine.Actor actor2 = builder.selectedActor();
                if(!com.maddox.il2.engine.Actor.isValid(actor2))
                    return;
                point3d = actor2.pos.getAbsPoint();
            } else
            {
                point3d = builder.posScreenToLand(builder.mousePosX, builder.mousePosY, 0.0D, 0.10000000000000001D);
            }
    ...
    public void changeType(boolean flag, boolean flag1)
    {
        ...
        int k = com.maddox.il2.builder.PlMapActors.getFingerOfFullClassName(builder.selectedActor());
        if(i < 0 || i >= type.length - 4)
            i = 0;
        if(j < 0 || j >= type[i].item.length || type[i].item[j].fingerOfFullClassName != k)
        {
            ...
            do
            {
                if(l >= type.length)
                    break;
                for(i1 = 0; i1 < type[l].item.length && type[l].item[i1].fingerOfFullClassName != k; i1++);
    ...
    {
        int l = builder.wSelect.comboBox1.getSelected();
        int i1 = builder.wSelect.comboBox2.getSelected();
        ...
        if(l == type.length - 2)
        {
            ...
            if(builder.isFreeView())
            {
                com.maddox.il2.engine.Actor actor1 = builder.selectedActor();
                if(com.maddox.il2.engine.Actor.isValid(actor1))
                {
                    com.maddox.JGP.Point3d point3d1 = actor1.pos.getAbsPoint();
                    if(i1 == 0)
    ...
    public void cut()
    {
        ...
        for(int i = 0; i < aactor.length; i++)
        {
            ...
            if(actor == null)
                break;
            if(!com.maddox.il2.engine.Actor.isValid(actor) || !builder.isMiltiSelected(actor))
                continue;
    ...
    public void paste()
    {
        ...
        if(i == 0 && _clipAirdroms.size() == 0)
            return;
        com.maddox.JGP.Point3d point3d = builder.mouseWorldPos();
        com.maddox.il2.engine.Loc loc = new Loc();
...
;
    ...
    private void fillComboBox1()
    {
        ...
        for(int i = 0; i < type.length; i++)
            builder.wSelect.comboBox1.add(type[i].name);
    ...
    private void fillComboBox2(int i, int j)
    {
        ...
        if(builder.wSelect.curFilledType != i)
        {
            ...
            for(int k = 0; k < type[i].item.length; k++)
                builder.wSelect.comboBox2.add(type[i].item[k].name);
    ...
    void viewUpdate()
    {
        ...
        if(com.maddox.il2.engine.Actor.isValid(builder.selectedActor()) && !builder.selectedActor().isDrawing())
    ...
    public void createGUI()
    {
        ...
        for(int i = 0; i < type.length - 4; i++)
        {
            com.maddox.il2.builder.ViewItem viewitem = (com.maddox.il2.builder.ViewItem)builder.mDisplayFilter.subMenu.addItem(new ViewItem(i, builder.mDisplayFilter.subMenu, "show " + type[i].name, null));
        ...
        viewBridge = builder.mDisplayFilter.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(builder.mDisplayFilter.subMenu, "show Bridge", null) {
        ...
        viewBridge.bChecked = builder.conf.bViewBridge;
        viewRunaway = builder.mDisplayFilter.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(builder.mDisplayFilter.subMenu, "show Runway", null) {
        ...
        viewRunaway.bChecked = builder.conf.bViewRunaway;
        builder.mDisplayFilter.subMenu.addItem("-", null);
        builder.mDisplayFilter.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(builder.mDisplayFilter.subMenu, "&Show All", null) {
        ...
        builder.mDisplayFilter.subMenu.addItem(new com.maddox.gwindow.GWindowMenuItem(builder.mDisplayFilter.subMenu, "&Hide All", null) {
        ...
        mLoad = builder.mFile.subMenu.addItem(1, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Load", null) {
        ...
        mSave = builder.mFile.subMenu.addItem(2, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Save", null) {
        ...
        mLoadAs = builder.mFile.subMenu.addItem(4, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Load As ...", null) {
...
;
        ...
        mLoadSpawn = builder.mFile.subMenu.addItem(5, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Load Spawn ...", null) {
...
;
        ...
        mSaveAs = builder.mFile.subMenu.addItem(6, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Save As ...", null) {
...
;
        ...
        mSaveSpawn = builder.mFile.subMenu.addItem(7, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Save As Spawn ...", null) {
...
;
        ...
        mCreateBridges = builder.mFile.subMenu.addItem(9, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "CreateBridges ...", null) {
...
;
        ...
        builder.mFile.subMenu.addItem(11, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Clear Roads ...", null) {
...
;
        ...
        builder.mFile.subMenu.addItem(12, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Remove Roads ...", null) {
...
;
        ...
        builder.mFile.subMenu.addItem(13, new com.maddox.gwindow.GWindowMenuItem(builder.mFile.subMenu, "Clear Water ...", null) {
...
;
    ...
    {
        if(builder.selectedActor() == null || !(builder.selectedActor() instanceof com.maddox.il2.objects.bridges.Bridge))
            return false;
        curBridge = (com.maddox.il2.objects.bridges.Bridge)builder.selectedActor();
    ...
    private void doRemoveRoads()
    {
        ...
        for(int k = 1; k < j - 1; k++)
        {
            ...
            {
                int k1 = landMapT.intI(i1, l);
                if((k1 & 0xe0) != 0)
                {
                    k1 &= 0xffffff1f;
                    landMapT.I(i1, l, k1);
                    com.maddox.il2.ai.World.land();
                    com.maddox.il2.engine.Landscape.setPixelMapT(i1, l, k1);
                }
            }
    ...
    private void doClearRoads()
    {
        ...
        for(int k = 1; k < j - 1; k++)
        {
            ...
            {
                int j1 = j - 1 - k;
                int k1 = landMapT.intI(l, j1) & 0xe0;
                if(k1 != 0)
                {
            ...
            {
                int i1 = (k * 100) / j;
                com.maddox.rts.RTSConf.cur.mainWindow.setTitle("" + i1 + "%");
            }
        }
    ...
    private void changePattern(boolean flag, java.lang.String s)
    {
        ...
        for(int l = 1; l < k - 1; l++)
        {
            for(int i1 = 1; i1 < j - 1; i1++)
            {
                ...
                int l1 = com.maddox.il2.engine.Landscape.getPixelMapT(i1, k1) & 0x1f;
            ...
            {
                int j1 = (l * 100) / k;
                com.maddox.rts.RTSConf.cur.mainWindow.setTitle("" + j1 + "% " + i);
            }
        }
            ...
            } else
            {
                ...
                if(j > 0)
                {
                    ...
                    while(j-- > 0) 
                    {
                        ...
                        float f4 = datainputstream.readFloat();
                        float f7 = datainputstream.readFloat();
                        addPattern(ai[l1], f2, f4, f7, aarraylist);
                    }
                }
                j = datainputstream.readInt();
                k += j;
                if(j > 0)
                {
                    ...
                    {
                        java.lang.String s4 = datainputstream.readUTF();
                        ai1[i2] = com.maddox.rts.Finger.Int(s4);
