...
public class CockpitJU_88A4_BGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.mesh.chunkSetAngles("zTurret4A", 0.0F, -f1, 0.0F);
    this.mesh.chunkSetAngles("zTurret4B", 0.0F, f2, 0.0F);
  ...
  static
  {
    ...
    Property.set(CockpitJU_88A4_BGunner.class, "normZN", 0.2F);
    Property.set(CockpitJU_88A4_BGunner.class, "gsZN", 0.2F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A4_BGunner.this.fm != null) {
        ...
        CockpitJU_88A4_BGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.throttle1 + CockpitJU_88A4_BGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_BGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.prop1 + CockpitJU_88A4_BGunner.this.fm.EI.engines[0].getControlProp() * 0.15F);

        CockpitJU_88A4_BGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.throttle2 + CockpitJU_88A4_BGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_BGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.prop2 + CockpitJU_88A4_BGunner.this.fm.EI.engines[1].getControlProp() * 0.15F);

        CockpitJU_88A4_BGunner.this.setNew.altimeter = CockpitJU_88A4_BGunner.this.fm.getAltitude();

        float f1 = CockpitJU_88A4_BGunner.this.waypointAzimuth();
        if (CockpitJU_88A4_BGunner.this.useRealisticNavigationInstruments())
        {
          CockpitJU_88A4_BGunner.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4_BGunner.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4_BGunner.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A4_BGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A4_BGunner.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A4_BGunner.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
        ...
        CockpitJU_88A4_BGunner.this.setNew.azimuth.setDeg(CockpitJU_88A4_BGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4_BGunner.this.fm.Or.azimut());

        CockpitJU_88A4_BGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_BGunner.this.setOld.vspeed + CockpitJU_88A4_BGunner.this.fm.getVertSpeed()) / 200.0F);
        ...
        float f2 = CockpitJU_88A4_BGunner.this.prevFuel - CockpitJU_88A4_BGunner.this.fm.M.fuel;
        CockpitJU_88A4_BGunner.access$402(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        ...
        if (CockpitJU_88A4_BGunner.this.buzzerFX != null) {
          if ((CockpitJU_88A4_BGunner.this.fm.Loc.z < ((JU_88A4)CockpitJU_88A4_BGunner.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4)(JU_88A4)CockpitJU_88A4_BGunner.this.fm.actor).diveMechStage == 1))
