  ...
  implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeStormovikArmored, TypeX4Carrier
{
  ...
  static
  {
    Class localClass = ME_410B.class;

    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Me-410");
    Property.set(localClass, "meshName", "3DO/Plane/ME-410-B/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar05());
    Property.set(localClass, "yearService", 1943.0F);
    Property.set(localClass, "yearExpired", 1945.5F);
    Property.set(localClass, "FlightModel", "FlightModels/Me-410B.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitME_410B.class, Cockpit410B_Bombardier.class });
