...
public class CockpitSU_2 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitSU_2 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSU_2.this.fm != null) {
        CockpitSU_2.access$102(CockpitSU_2.this, CockpitSU_2.this.setOld);
        CockpitSU_2.access$202(CockpitSU_2.this, CockpitSU_2.this.setNew);
        CockpitSU_2.access$302(CockpitSU_2.this, CockpitSU_2.this.setTmp);
        CockpitSU_2.this.setNew.throttle = ((10.0F * CockpitSU_2.this.setOld.throttle + CockpitSU_2.this.fm.CT.PowerControl) / 11.0F);

        CockpitSU_2.this.setNew.prop = ((10.0F * CockpitSU_2.this.setOld.prop + CockpitSU_2.this.fm.EI.engines[0].getControlProp()) / 11.0F);

        CockpitSU_2.this.setNew.altimeter = CockpitSU_2.this.fm.getAltitude();
        if (Math.abs(CockpitSU_2.this.fm.Or.getKren()) < 30.0F) {
          CockpitSU_2.this.setNew.azimuth = ((35.0F * CockpitSU_2.this.setOld.azimuth + CockpitSU_2.this.fm.Or.azimut()) / 36.0F);
        }
        if ((CockpitSU_2.this.setOld.azimuth > 270.0F) && (CockpitSU_2.this.setNew.azimuth < 90.0F))
          CockpitSU_2.this.setOld.azimuth -= 360.0F;
        if ((CockpitSU_2.this.setOld.azimuth < 90.0F) && (CockpitSU_2.this.setNew.azimuth > 270.0F))
          CockpitSU_2.this.setOld.azimuth += 360.0F;
        CockpitSU_2.this.setNew.vspeed = ((199.0F * CockpitSU_2.this.setOld.vspeed + CockpitSU_2.this.fm.getVertSpeed()) / 200.0F);
      }
