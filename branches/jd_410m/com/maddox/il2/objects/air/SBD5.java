  ...
  implements TypeStormovik, TypeDiveBomber
{
  ...
  static
  {
    Class localClass = SBD5.class;
    new NetAircraft.SPAWN(localClass);

    Property.set(localClass, "iconFar_shortClassName", "SBD");
    Property.set(localClass, "meshName", "3DO/Plane/SBD-5(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar05());
    Property.set(localClass, "meshName_us", "3DO/Plane/SBD-5(USA)/hier.him");
    Property.set(localClass, "PaintScheme_us", new PaintSchemeFMPar05());
    Property.set(localClass, "meshName_rz", "3DO/Plane/SBD-5(RZ)/hier.him");
    Property.set(localClass, "PaintScheme_rz", new PaintSchemeFMPar05());

    Property.set(localClass, "yearService", 1943.0F);
    Property.set(localClass, "yearExpired", 1946.5F);

    Property.set(localClass, "FlightModel", "FlightModels/SBD-5.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitSBD5.class, CockpitSBD3_TGunner.class });
