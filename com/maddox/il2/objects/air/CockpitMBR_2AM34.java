...
public class CockpitMBR_2AM34 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitMBR_2AM34.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitMBR_2AM34.access$002(CockpitMBR_2AM34.this, CockpitMBR_2AM34.this.setOld);
        CockpitMBR_2AM34.access$102(CockpitMBR_2AM34.this, CockpitMBR_2AM34.this.setNew);
        CockpitMBR_2AM34.access$202(CockpitMBR_2AM34.this, CockpitMBR_2AM34.this.setTmp);
        CockpitMBR_2AM34.this.setNew.throttle1 = (0.85F * CockpitMBR_2AM34.this.setOld.throttle1 + CockpitMBR_2AM34.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitMBR_2AM34.this.setNew.prop1 = (0.85F * CockpitMBR_2AM34.this.setOld.prop1 + CockpitMBR_2AM34.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitMBR_2AM34.this.setNew.altimeter = CockpitMBR_2AM34.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitMBR_2AM34.this.waypointAzimuth();
        CockpitMBR_2AM34.this.setNew.azimuth.setDeg(CockpitMBR_2AM34.this.setOld.azimuth.getDeg(1.0F), CockpitMBR_2AM34.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitMBR_2AM34.this.setNew.waypointAzimuth.setDeg(CockpitMBR_2AM34.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitMBR_2AM34.this.setNew.waypointDeviation.setDeg(CockpitMBR_2AM34.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitMBR_2AM34.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitMBR_2AM34.this.setNew.vspeed = ((199.0F * CockpitMBR_2AM34.this.setOld.vspeed + CockpitMBR_2AM34.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitMBR_2AM34 this$0;
    ...
    Variables(CockpitMBR_2AM34.1 arg2)
    {
      this();
    }
  }
