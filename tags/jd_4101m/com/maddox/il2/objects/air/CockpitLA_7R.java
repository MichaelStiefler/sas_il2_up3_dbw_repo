  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_7R.this.fm != null) {
        ...
        {
          CockpitLA_7R.this.setNew.waypointAzimuth.setDeg(CockpitLA_7R.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitLA_7R.this.waypointAzimuth() - CockpitLA_7R.this.fm.Or.azimut());
        }
