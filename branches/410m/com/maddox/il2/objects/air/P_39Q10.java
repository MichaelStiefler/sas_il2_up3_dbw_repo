...
public class P_39Q10 extends com.maddox.il2.objects.air.P_39
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.P_39Q10.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 3
        });
        com.maddox.il2.objects.air.P_39Q10.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_CANNON01", "_ExternalBomb01"
        });
        com.maddox.il2.objects.air.P_39Q10.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning50si 200", "MGunBrowning50si 200", "MGunM4ki 30", null
        });
        com.maddox.il2.objects.air.P_39Q10.weaponsRegister(class1, "1xFAB250", new java.lang.String[] {
            "MGunBrowning50si 200", "MGunBrowning50si 200", "MGunM4ki 30", "BombGunFAB250 1"
        });
        com.maddox.il2.objects.air.P_39Q10.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
