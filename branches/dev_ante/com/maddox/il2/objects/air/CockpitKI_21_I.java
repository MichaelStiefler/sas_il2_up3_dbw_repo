...
public class CockpitKI_21_I extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitKI_21_I.access$002(CockpitKI_21_I.this, CockpitKI_21_I.this.setOld);
        CockpitKI_21_I.access$102(CockpitKI_21_I.this, CockpitKI_21_I.this.setNew);
        CockpitKI_21_I.access$202(CockpitKI_21_I.this, CockpitKI_21_I.this.setTmp);
        CockpitKI_21_I.this.setNew.throttle1 = (0.9F * CockpitKI_21_I.this.setOld.throttle1 + 0.1F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitKI_21_I.this.setNew.prop1 = (0.9F * CockpitKI_21_I.this.setOld.prop1 + 0.1F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitKI_21_I.this.setNew.mix1 = (0.8F * CockpitKI_21_I.this.setOld.mix1 + 0.2F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitKI_21_I.this.setNew.throttle2 = (0.9F * CockpitKI_21_I.this.setOld.throttle2 + 0.1F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitKI_21_I.this.setNew.prop2 = (0.9F * CockpitKI_21_I.this.setOld.prop2 + 0.1F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
        CockpitKI_21_I.this.setNew.mix2 = (0.8F * CockpitKI_21_I.this.setOld.mix2 + 0.2F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
        CockpitKI_21_I.this.setNew.man1 = (0.92F * CockpitKI_21_I.this.setOld.man1 + 0.08F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitKI_21_I.this.setNew.man2 = (0.92F * CockpitKI_21_I.this.setOld.man2 + 0.08F * CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitKI_21_I.this.setNew.altimeter = CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitKI_21_I.this.setNew.azimuth.setDeg(CockpitKI_21_I.this.setOld.azimuth.getDeg(1.0F), CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitKI_21_I.this.setNew.vspeed = ((199.0F * CockpitKI_21_I.this.setOld.vspeed + CockpitKI_21_I.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    AnglesFork azimuth;
    float vspeed;
    private final CockpitKI_21_I this$0;
    ...
    Variables(CockpitKI_21_I.1 arg2)
    {
      this();
    }
  }
