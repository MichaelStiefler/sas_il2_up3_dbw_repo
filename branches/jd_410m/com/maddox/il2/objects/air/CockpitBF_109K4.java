...
public class CockpitBF_109K4 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_EngTemp1", 0.0F, cvt(this.fm.EI.engines[0].tOilOut, 20.0F, 120.0F, 13.0F, 53.0F), 0.0F);

    this.mesh.chunkSetAngles("Z_EngTemp2", 0.0F, cvt(this.fm.EI.engines[0].tWaterOut, 20.0F, 120.0F, 13.0F, 53.0F), 0.0F);

    this.mesh.chunkSetAngles("Z_FuelPress1", cvt(this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3.0F, 0.0F, 120.0F), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_OilPress1", cvt(1.0F + 0.05F * this.fm.EI.engines[0].tOilOut, 0.0F, 15.0F, 0.0F, 120.0F), 0.0F, 0.0F);

    this.mesh.chunkSetAngles("Z_Variometr", 0.0F, 0.0F, -floatindex(cvt(this.setNew.vspeed, -30.0F, 30.0F, 0.0F, 12.0F), variometerScale));
    ...
    if (this.gun[2] != null) {
      this.mesh.chunkSetAngles("Z_AmmoCounter2", cvt(this.gun[2].countBullets(), 0.0F, 500.0F, 15.0F, 0.0F), 0.0F, 0.0F);
    }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitBF_109K4.this.setNew.throttle = ((10.0F * CockpitBF_109K4.this.setOld.throttle + CockpitBF_109K4.this.fm.CT.PowerControl) / 11.0F);
      CockpitBF_109K4.this.setNew.mix = ((8.0F * CockpitBF_109K4.this.setOld.mix + CockpitBF_109K4.this.fm.EI.engines[0].getControlMix()) / 9.0F);

      float f = CockpitBF_109K4.this.waypointAzimuth();
      if (CockpitBF_109K4.this.useRealisticNavigationInstruments())
      {
        CockpitBF_109K4.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
        CockpitBF_109K4.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
      }
      else
      {
      ...
      CockpitBF_109K4.this.setNew.turn = ((12.0F * CockpitBF_109K4.this.setOld.turn + CockpitBF_109K4.this.w.z) / 13.0F);

      CockpitBF_109K4.this.setNew.vspeed = ((199.0F * CockpitBF_109K4.this.setOld.vspeed + CockpitBF_109K4.this.fm.getVertSpeed()) / 200.0F);

      CockpitBF_109K4.this.buzzerFX((CockpitBF_109K4.this.fm.CT.getGear() < 0.999999F) && (CockpitBF_109K4.this.fm.CT.getFlap() > 0.0F));

      CockpitBF_109K4.this.setNew.beaconDirection = ((10.0F * CockpitBF_109K4.this.setOld.beaconDirection + CockpitBF_109K4.this.getBeaconDirection()) / 11.0F);
      CockpitBF_109K4.this.setNew.beaconRange = ((10.0F * CockpitBF_109K4.this.setOld.beaconRange + CockpitBF_109K4.this.getBeaconRange()) / 11.0F);
