// Source File Name: CockpitKI_45_TEI.java
...
public class CockpitKI_45_TEI extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitKI_45_TEI.this.fm != null) {
				CockpitKI_45_TEI.this.setTmp = CockpitKI_45_TEI.this.setOld;
				CockpitKI_45_TEI.this.setOld = CockpitKI_45_TEI.this.setNew;
				CockpitKI_45_TEI.this.setNew = CockpitKI_45_TEI.this.setTmp;
				CockpitKI_45_TEI.this.setNew.flap = (0.88F * CockpitKI_45_TEI.this.setOld.flap)
						+ (0.12F * CockpitKI_45_TEI.this.fm.CT.FlapsControl);
				CockpitKI_45_TEI.this.setNew.tlock = (0.7F * CockpitKI_45_TEI.this.setOld.tlock)
						+ (0.3F * (CockpitKI_45_TEI.this.fm.Gears.bTailwheelLocked ? 1.0F
								: 0.0F));
				if (CockpitKI_45_TEI.this.cockpitDimControl) {
					if (CockpitKI_45_TEI.this.setNew.dimPosition > 0.0F) {
						CockpitKI_45_TEI.this.setNew.dimPosition = CockpitKI_45_TEI.this.setOld.dimPosition - 0.05F;
					}
				} else if (CockpitKI_45_TEI.this.setNew.dimPosition < 1.0F) {
					CockpitKI_45_TEI.this.setNew.dimPosition = CockpitKI_45_TEI.this.setOld.dimPosition + 0.05F;
				}
				if ((CockpitKI_45_TEI.this.fm.CT.GearControl < 0.5F)
						&& (CockpitKI_45_TEI.this.setNew.gear < 1.0F)) {
					CockpitKI_45_TEI.this.setNew.gear = CockpitKI_45_TEI.this.setOld.gear + 0.02F;
				}
				if ((CockpitKI_45_TEI.this.fm.CT.GearControl > 0.5F)
						&& (CockpitKI_45_TEI.this.setNew.gear > 0.0F)) {
					CockpitKI_45_TEI.this.setNew.gear = CockpitKI_45_TEI.this.setOld.gear - 0.02F;
				}
				CockpitKI_45_TEI.this.setNew.throttle = (0.9F * CockpitKI_45_TEI.this.setOld.throttle)
						+ (0.1F * CockpitKI_45_TEI.this.fm.CT.PowerControl);
				CockpitKI_45_TEI.this.setNew.manifold = (0.8F * CockpitKI_45_TEI.this.setOld.manifold)
						+ (0.2F * CockpitKI_45_TEI.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitKI_45_TEI.this.setNew.pitch = (0.9F * CockpitKI_45_TEI.this.setOld.pitch)
						+ (0.1F * CockpitKI_45_TEI.this.fm.EI.engines[0]
								.getControlProp());
				CockpitKI_45_TEI.this.setNew.mix = (0.9F * CockpitKI_45_TEI.this.setOld.mix)
						+ (0.1F * CockpitKI_45_TEI.this.fm.EI.engines[0]
								.getControlMix());
				CockpitKI_45_TEI.this.setNew.altimeter = CockpitKI_45_TEI.this.fm
						.getAltitude();
				CockpitKI_45_TEI.this.setNew.azimuth.setDeg(
						CockpitKI_45_TEI.this.setOld.azimuth.getDeg(1.0F),
						CockpitKI_45_TEI.this.fm.Or.azimut());
				CockpitKI_45_TEI.this.setNew.vspeed = ((199F * CockpitKI_45_TEI.this.setOld.vspeed) + CockpitKI_45_TEI.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public CockpitKI_45_TEI() {
		super("3DO/Cockpit/Ki-45/CockpitKI_45_TEI.him", "bf109");
