...
public abstract class N1K extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    public void update(float f)
    {
        ...
        {
            if(this == com.maddox.il2.ai.World.getPlayerAircraft() && !autoEng)
            {
                com.maddox.il2.game.HUD.log("FlapsAuto");
                autoEng = true;
            }
            ...
            if(mBar < 315F && FM.getOverload() > 0.0F && f1 < 128F)
            {
                ...
                if(curFlaps < desiredPosition)
                    curFlaps = flapsMovement(f, desiredPosition, curFlaps, 999F, com.maddox.il2.objects.air.N1K.cvt(FM.getSpeedKMH(), 150F, 280F, 0.15F, 0.08F));
                else
                    curFlaps = flapsMovement(f, desiredPosition, curFlaps, 999F, com.maddox.il2.objects.air.N1K.cvt(FM.getSpeedKMH(), 150F, 280F, 0.15F, 0.25F));
            ...
            if(java.lang.Math.abs(desiredPosition - curFlaps) >= 0.02F)
                sfxFlaps(true);
            else
                sfxFlaps(false);
        } else
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.75F, 0.95F, 0.0F, -60F), 0.0F);
        hiermesh.chunkSetAngles("GearC3_D0", 0.0F, 0.0F, 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.95F, 0.0F, -85F), 0.0F);
        xyz[1] = com.maddox.il2.objects.air.N1K.cvt(f, 0.4F, 0.75F, 0.0F, -0.205F);
        hiermesh.chunkSetLocate("GearL3_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.N1K.cvt(f, 0.75F, 0.94F, 0.0F, -0.05F);
        hiermesh.chunkSetLocate("GearL4_D0", xyz, ypr);
        if(f > 0.75F)
            hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.75F, 0.95F, -45F, -65F), 0.0F);
        else
            hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.4F, 0.75F, 0.0F, -45F), 0.0F);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.95F, 0.0F, -130F), 0.0F);
        if(f > 0.75F)
            hiermesh.chunkSetAngles("GearL7_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.725F, 0.95F, -86F, -133F), 0.0F);
        else
            hiermesh.chunkSetAngles("GearL7_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.725F, 0.0F, -86F), 0.0F);
        xyz[1] = com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.95F, 0.0F, -0.1F);
        hiermesh.chunkSetLocate("GearL8_D0", xyz, ypr);
        hiermesh.chunkSetAngles("GearL9_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.115F, 0.0F, -85F), 0.0F);
        hiermesh.chunkSetAngles("GearL10_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.85F, 0.0F, -85F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.95F, 0.0F, -85F), 0.0F);
        xyz[1] = com.maddox.il2.objects.air.N1K.cvt(f, 0.4F, 0.75F, 0.0F, -0.205F);
        hiermesh.chunkSetLocate("GearR3_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.N1K.cvt(f, 0.75F, 0.94F, 0.0F, -0.05F);
        hiermesh.chunkSetLocate("GearR4_D0", xyz, ypr);
        if(f > 0.75F)
            hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.75F, 0.95F, -45F, -65F), 0.0F);
        else
            hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.4F, 0.75F, 0.0F, -45F), 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.95F, 0.0F, -130F), 0.0F);
        if(f > 0.75F)
            hiermesh.chunkSetAngles("GearR7_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.725F, 0.95F, -86F, -133F), 0.0F);
        else
            hiermesh.chunkSetAngles("GearR7_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.725F, 0.0F, -86F), 0.0F);
        xyz[1] = com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.95F, 0.0F, -0.1F);
        hiermesh.chunkSetLocate("GearR8_D0", xyz, ypr);
        hiermesh.chunkSetAngles("GearR9_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.115F, 0.0F, -85F), 0.0F);
        hiermesh.chunkSetAngles("GearR10_D0", 0.0F, com.maddox.il2.objects.air.N1K.cvt(f, 0.05F, 0.85F, 0.0F, -85F), 0.0F);
    }

    protected void moveGear(float f)
    {
        com.maddox.il2.objects.air.N1K.moveGear(hierMesh(), f);
    }
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.N1K.cvt(f, 0.1F, 0.99F, 0.0F, -0.61F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p3"))
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(8.7F, 9.81F) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 8: // '\b'
                    ...
                    {
                        com.maddox.il2.objects.air.N1K.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        FM.AS.setControlsDamage(shot.initiator, 1);
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                ...
                case 9: // '\t'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.N1K.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                    }
                    break;
                }
                return;
            ...
            if(s.startsWith("xxeng1"))
            {
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.N1K.debugprintln(this, "*** Engine Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.N1K.debugprintln(this, "*** Engine Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.N1K.debugprintln(this, "*** Engine Crank Case Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.N1K.debugprintln(this, "*** Engine Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.N1K.debugprintln(this, "*** Engine Cylinders Hit - Engine Fires..");
                        }
                    }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.N1K.class;
