    ...
    implements com.maddox.il2.engine.MsgOwnerListener
{
        ...
        throws java.lang.Exception
    {
        ...
        try
        {
            ...
            if((com.maddox.il2.game.Mission.isSingle() || com.maddox.il2.game.Mission.isCoop() && com.maddox.il2.game.Mission.isServer()) && !com.maddox.il2.net.NetMissionTrack.isPlaying())
            {
    ...
    private void setPosAndSpeed(com.maddox.il2.objects.air.Aircraft aircraft, com.maddox.il2.ai.Way way1)
    {
        ...
        } else
        {
            ...
            tmpSpeed.normalize();
            com.maddox.il2.engine.Actor._tmpOrient.setAT0(tmpSpeed);
            tmpSpeed.scale(waypoint1.Speed);
            aircraft.pos.setAbs(tmpPoint0, com.maddox.il2.engine.Actor._tmpOrient);
            aircraft.setSpeed(tmpSpeed);
        }
        aircraft.pos.reset();
    }
