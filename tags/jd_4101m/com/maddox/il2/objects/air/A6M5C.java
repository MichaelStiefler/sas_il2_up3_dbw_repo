...
public class A6M5C extends A6M
{
  ...
  static
  {
    ...
    weaponsRegister(localClass, "default", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, null, null, null, null });

    weaponsRegister(localClass, "2x150dt", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, "FuelTankGun_Tank0Underwing", "FuelTankGun_Tank0Underwing", null, null, null, null });

    weaponsRegister(localClass, "1xwdt4s", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", "FuelTankGun_Tank0Centre", null, null, null, null, null, null, null, null });

    weaponsRegister(localClass, "4xtype3", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27" });

    weaponsRegister(localClass, "1x250", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, "PylonA6MPLN1", "BombGun250kg", null, null, null, null, null, null });
