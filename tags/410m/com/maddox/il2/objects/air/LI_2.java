    ...
    implements com.maddox.il2.objects.air.TypeTransport, com.maddox.il2.objects.air.TypeBomber
{
    ...
    {
        setShot(shot);
        if(shot.chunkName.startsWith("WingLOut") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Pd.y) < 6D)
            FM.AS.hitTank(shot.initiator, 0, 1);
        if(shot.chunkName.startsWith("WingROut") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Pd.y) < 6D)
            FM.AS.hitTank(shot.initiator, 3, 1);
        if(shot.chunkName.startsWith("WingLIn") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Pd.y) < 1.940000057220459D)
            FM.AS.hitTank(shot.initiator, 1, 1);
        if(shot.chunkName.startsWith("WingRIn") && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F && java.lang.Math.abs(Pd.y) < 1.940000057220459D)
        ...
        if(shot.chunkName.startsWith("Nose") && Pd.x > 4.9000000953674316D && Pd.z > -0.090000003576278687D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F)
            if(Pd.y > 0.0D)
            {
        ...
        if(shot.chunkName.startsWith("Turret1"))
        {
            ...
            if(Pd.z > 1.3350000381469727D && shot.initiator == com.maddox.il2.ai.World.getPlayerAircraft() && com.maddox.il2.ai.World.cur().isArcade())
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.LI_2.weaponTriggersRegister(class1, new int[] {
            10, 11, 12, 13, 3, 3, 3, 3, 3
        });
        com.maddox.il2.objects.air.LI_2.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01"
        });
        com.maddox.il2.objects.air.LI_2.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunUBt 350", "MGunShKASt 150", "MGunShKASt 150", "MGunShKASt 950", null, null, null, null, null
        });
        com.maddox.il2.objects.air.LI_2.weaponsRegister(class1, "4xFAB250", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.LI_2.weaponsRegister(class1, "12xPara", new java.lang.String[] {
            "MGunUBt 350", "MGunShKASt 150", "MGunShKASt 150", "MGunShKASt 950", null, null, null, null, "BombGunPara 12"
        });
        com.maddox.il2.objects.air.LI_2.weaponsRegister(class1, "5xCargoA", new java.lang.String[] {
            "MGunUBt 350", "MGunShKASt 150", "MGunShKASt 150", "MGunShKASt 950", null, null, null, null, "BombGunCargoA 5"
        });
        com.maddox.il2.objects.air.LI_2.weaponsRegister(class1, "none", new java.lang.String[] {
