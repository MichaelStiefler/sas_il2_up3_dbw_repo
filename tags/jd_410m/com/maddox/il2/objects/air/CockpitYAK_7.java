  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_7.this.fm != null) {
        ...
        CockpitYAK_7.this.setNew.throttle = ((10.0F * CockpitYAK_7.this.setOld.throttle + CockpitYAK_7.this.fm.CT.PowerControl) / 11.0F);
        CockpitYAK_7.this.setNew.prop = ((10.0F * CockpitYAK_7.this.setOld.prop + CockpitYAK_7.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_7.this.setNew.altimeter = CockpitYAK_7.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_7.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_7.this.setNew.azimuth = ((35.0F * CockpitYAK_7.this.setOld.azimuth + CockpitYAK_7.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitYAK_7.this.setNew.vspeed = ((199.0F * CockpitYAK_7.this.setOld.vspeed + CockpitYAK_7.this.fm.getVertSpeed()) / 200.0F);
      }
