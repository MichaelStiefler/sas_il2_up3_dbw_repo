...
// Source File Name:   CockpitA6M2N.java
...
public class CockpitA6M2N extends com.maddox.il2.objects.air.CockpitPilot
{
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                } else
                {
                    ...
                    setNew.waypointDirection.setDeg(setOld.waypointDirection.getDeg(0.1F), fm.Or.azimut() + 90F);
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.6F);
        mesh.chunkSetLocate("Blister_D0", xyz, ypr);
        ...
        mesh.chunkSetAngles("Turn3", 0.0F, 68F * interp(setNew.mix, setOld.mix, f), 0.0F);
        mesh.chunkSetAngles("Turn3_rod", 0.0F, -68F * interp(setNew.mix, setOld.mix, f), 0.0F);
        ...
        mesh.chunkSetAngles("Z_Azimuth1a", 0.0F, -setNew.waypointDirection.getDeg(f * 0.1F), 0.0F);
        mesh.chunkSetAngles("Z_Navigation", 0.0F, cvt(setNew.waypointAzimuth.getDeg(f * 0.2F), -25F, 25F, -45F, 45F), 0.0F);
        ...
        mesh.chunkSetAngles("Z_AirSpeed", 0.0F, floatindex(cvt(com.maddox.il2.fm.Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 814.8798F, 0.0F, 11F), speedometerScale), 0.0F);
        ...
        if((fm.AS.astateCockpitState & 4) != 0)
            f1 = 2100F;
        mesh.chunkSetAngles("Z_Revolution", 0.0F, cvt(f1, 500F, 4500F, 0.0F, 720F), 0.0F);
        if((fm.AS.astateCockpitState & 4) == 0)
    ...
    private static final float speedometerScale[] = {
        0.0F, 7.5F, 32.5F, 80.5F, 147.5F, 212F, 288F, 370.5F, 450.5F, 533.5F, 
        594F, 673.5F
    };
