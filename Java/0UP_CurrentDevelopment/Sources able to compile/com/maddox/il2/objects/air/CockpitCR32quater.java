...
public class CockpitCR32quater extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(((CR_32quater)aircraft()).bChangedPit)
        {
            reflectPlaneToModel();
            ((CR_32quater)aircraft()).bChangedPit = false;
        }
        if(gun[0] == null)
        {
        ...
        super.mesh.chunkSetLocate("Z_Column_but", Cockpit.xyz, Cockpit.ypr);
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = 0.015F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getTrimAileronControl();
        super.mesh.chunkSetLocate("Z_Trim1", Cockpit.xyz, Cockpit.ypr);
