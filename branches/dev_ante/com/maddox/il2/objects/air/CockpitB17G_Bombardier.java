...
public class CockpitB17G_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    if (this.bEntered) {
      this.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_17G)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);

      boolean bool = ((B_17G)aircraft()).fSightCurReadyness > 0.93F;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      float f1 = ((B_17G)CockpitB17G_Bombardier.this.aircraft()).fSightCurForwardAngle;

      float f2 = ((B_17G)CockpitB17G_Bombardier.this.aircraft()).fSightCurSideslip;

      CockpitB17G_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitB17G_Bombardier.this.bEntered) {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitB17G_Bombardier.this.aAim + f2, CockpitB17G_Bombardier.this.tAim + f1, 0.0F);
      }
      CockpitB17G_Bombardier.this.mesh.chunkSetAngles("TurretA", 0.0F, CockpitB17G_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);

      CockpitB17G_Bombardier.this.mesh.chunkSetAngles("TurretB", 0.0F, CockpitB17G_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
