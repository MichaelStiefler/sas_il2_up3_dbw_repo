      ...
      if (CockpitPE3bis.this.fm != null) {
        ...
        if (CockpitPE3bis.this.fm.CT.Weapons[3] != null) {
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 0) {
            CockpitPE3bis.this.bBombs[1] = (!CockpitPE3bis.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 1) {
            CockpitPE3bis.this.bBombs[0] = (!CockpitPE3bis.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 2) {
            CockpitPE3bis.this.bBombs[3] = (!CockpitPE3bis.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 3) {
            CockpitPE3bis.this.bBombs[2] = (!CockpitPE3bis.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 4) {
            CockpitPE3bis.this.bBombs[5] = (!CockpitPE3bis.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 5) {
            CockpitPE3bis.this.bBombs[4] = (!CockpitPE3bis.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 6) {
            CockpitPE3bis.this.bBombs[5] = ((CockpitPE3bis.this.bBombs[5] != 0) || (!CockpitPE3bis.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 7) {
            CockpitPE3bis.this.bBombs[4] = ((CockpitPE3bis.this.bBombs[4] != 0) || (!CockpitPE3bis.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 8) {
            CockpitPE3bis.this.bBombs[7] = (!CockpitPE3bis.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 9) {
            CockpitPE3bis.this.bBombs[6] = (!CockpitPE3bis.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
          }
        }
        ...
        CockpitPE3bis.this.setNew.vspeed = ((100.0F * CockpitPE3bis.this.setOld.vspeed + CockpitPE3bis.this.fm.getVertSpeed()) / 101.0F);
        ...
        CockpitPE3bis.this.setNew.inert = (0.999F * CockpitPE3bis.this.setOld.inert + 0.001F * (CockpitPE3bis.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
