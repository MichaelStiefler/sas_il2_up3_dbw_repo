  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      if (CockpitP_38J.this.fm != null) {
        ...
        {
          CockpitP_38J.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
          CockpitP_38J.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
        }
        else
        {
          CockpitP_38J.this.setNew.waypointAzimuth.setDeg(CockpitP_38J.this.setOld.waypointAzimuth.getDeg(0.1F), f);
        }
        CockpitP_38J.this.setNew.vspeed = ((199.0F * CockpitP_38J.this.setOld.vspeed + CockpitP_38J.this.fm.getVertSpeed()) / 200.0F);
      }
