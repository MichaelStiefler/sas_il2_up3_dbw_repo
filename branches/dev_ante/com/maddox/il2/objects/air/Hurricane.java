  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  {
    hierMesh().chunkSetAngles("Water1_D0", 0.0F, -22.5F * this.kangle, 0.0F);
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxarmor")) {
        if (paramString.endsWith("p1"))
          ...
          getEnergyPastArmor(8.0F / (1.0E-005F + (float)Math.abs(Aircraft.v1.x)), paramShot);
        }
      ...
      if ((paramString.startsWith("xxammol4")) && (paramShot.power > 27000.0F) && (World.Rnd().nextFloat() < 0.1F))
      {
      ...
      if ((paramString.startsWith("xxammor4")) && (paramShot.power > 27000.0F) && (World.Rnd().nextFloat() < 0.1F))
      {
      ...
      if ((paramString.startsWith("xxammol2")) && (paramShot.power > 27000.0F) && (World.Rnd().nextFloat() < 0.1F))
      {
        this.FM.AS.setJamBullets(0, 8);
        this.FM.AS.setJamBullets(0, 10);
      }
      if ((paramString.startsWith("xxammor2")) && (paramShot.power > 27000.0F) && (World.Rnd().nextFloat() < 0.1F))
      {
      ...
      if (paramString.startsWith("xxshkas2"))
        this.FM.AS.setJamBullets(0, 1);
    } else if ((paramString.startsWith("xcf")) || (paramString.startsWith("xoil"))) {
      ...
      if (paramPoint3d.x > -2.200000047683716D) {
        ...
        if ((Aircraft.v1.x < -0.800000011920929D) && (World.Rnd().nextFloat() < 0.2F))
        {
          this.FM.AS.setCockpitState(paramShot.initiator, this.FM.AS.astateCockpitState | 0x2);
        }
        if ((Aircraft.v1.x < -0.8999999761581421D) && (World.Rnd().nextFloat() < 0.2F))
        {
