// Source File Name: CockpitME_210CA1.java
...
public class CockpitME_210CA1 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			CockpitME_210CA1.this.setNew.altimeter = CockpitME_210CA1.this.fm
					.getAltitude();
			...
			CockpitME_210CA1.this.setNew.throttle1 = (0.91F * CockpitME_210CA1.this.setOld.throttle1)
					+ (0.09F * CockpitME_210CA1.this.fm.EI.engines[0]
							.getControlThrottle());
			CockpitME_210CA1.this.setNew.throttle2 = (0.91F * CockpitME_210CA1.this.setOld.throttle2)
					+ (0.09F * CockpitME_210CA1.this.fm.EI.engines[1]
							.getControlThrottle());
			CockpitME_210CA1.this.setNew.mix1 = (0.88F * CockpitME_210CA1.this.setOld.mix1)
					+ (0.12F * CockpitME_210CA1.this.fm.EI.engines[0]
							.getControlMix());
			CockpitME_210CA1.this.setNew.mix2 = (0.88F * CockpitME_210CA1.this.setOld.mix2)
					+ (0.12F * CockpitME_210CA1.this.fm.EI.engines[1]
							.getControlMix());
			CockpitME_210CA1.this.setNew.azimuth = CockpitME_210CA1.this.fm.Or
					.getYaw();
			if ((CockpitME_210CA1.this.setOld.azimuth > 270F)
					&& (CockpitME_210CA1.this.setNew.azimuth < 90F)) {
				CockpitME_210CA1.this.setOld.azimuth -= 360F;
			}
			if ((CockpitME_210CA1.this.setOld.azimuth < 90F)
					&& (CockpitME_210CA1.this.setNew.azimuth > 270F)) {
				CockpitME_210CA1.this.setOld.azimuth += 360F;
			}
			CockpitME_210CA1.this.setNew.waypointAzimuth = ((10F * CockpitME_210CA1.this.setOld.waypointAzimuth)
					+ (CockpitME_210CA1.this.waypointAzimuth() - CockpitME_210CA1.this.setOld.azimuth) + World
			...
			variables.radioalt = f
					+ (f1 * (f2 - Landscape.HQ_Air(
							(float) CockpitME_210CA1.this.fm.Loc.x,
							(float) CockpitME_210CA1.this.fm.Loc.y)));
			CockpitME_210CA1.this.setNew.vspeed = ((199F * CockpitME_210CA1.this.setOld.vspeed) + CockpitME_210CA1.this.fm
					.getVertSpeed()) / 200F;
			CockpitME_210CA1.this.middleAngle = (CockpitME_210CA1.this.middleAngleTarget * 0.05F)
					+ (0.95F * CockpitME_210CA1.this.middleAngle);
			return true;
		}
	}
