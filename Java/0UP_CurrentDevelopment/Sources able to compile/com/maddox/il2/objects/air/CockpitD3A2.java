...
public class CockpitD3A2 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        D3A2 d3a2 = (D3A2)aircraft();
        if(D3A2.bChangedPit)
        {
            reflectPlaneToModel();
            D3A2 d3a2_1 = (D3A2)aircraft();
            D3A2.bChangedPit = false;
        }
        resetYPRmodifier();
        Cockpit.xyz[2] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.44F);
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = cvt(setNew.vspeed, -15F, 15F, -0.053F, 0.053F);
