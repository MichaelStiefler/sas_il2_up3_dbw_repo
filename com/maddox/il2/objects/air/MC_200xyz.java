    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.05F, 0.78F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.05F, 0.1376F, 0.0F, -80F), 0.0F);
        float f1 = com.maddox.il2.objects.air.Aircraft.cvt(f, 0.05F, 0.1376F, 0.0F, 1.0F);
        f1 = (float)java.lang.Math.sqrt(f1);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, -103F * f1, 0.0F);
        hiermesh.chunkSetAngles("GearL9_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.05F, 0.78F, 0.0F, -129F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.25F, 0.98F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.25F, 0.3376F, 0.0F, -80F), 0.0F);
        f1 = com.maddox.il2.objects.air.Aircraft.cvt(f, 0.25F, 0.3376F, 0.0F, 1.0F);
        f1 = (float)java.lang.Math.sqrt(f1);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, -103F * f1, 0.0F);
        hiermesh.chunkSetAngles("GearR9_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.25F, 0.98F, 0.0F, -129F), 0.0F);
    }
    ...
    {
        float f1 = com.maddox.il2.objects.air.Aircraft.cvt(FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 0.0F, -32.2F);
