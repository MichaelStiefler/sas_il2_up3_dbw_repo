...
public class CockpitB29 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitB29.access$002(CockpitB29.this, CockpitB29.this.setOld);
        CockpitB29.access$102(CockpitB29.this, CockpitB29.this.setNew);
        CockpitB29.access$202(CockpitB29.this, CockpitB29.this.setTmp);
        CockpitB29.this.setNew.throttle1 = (0.85F * CockpitB29.this.setOld.throttle1 + CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitB29.this.setNew.throttle2 = (0.85F * CockpitB29.this.setOld.throttle2 + CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitB29.this.setNew.prop1 = (0.85F * CockpitB29.this.setOld.prop1 + CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitB29.this.setNew.prop2 = (0.85F * CockpitB29.this.setOld.prop2 + CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitB29.this.setNew.altimeter = CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitB29.this.waypointAzimuth();
        CockpitB29.this.setNew.azimuth.setDeg(CockpitB29.this.setOld.azimuth.getDeg(1.0F), CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitB29.this.setNew.waypointAzimuth.setDeg(CockpitB29.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitB29.this.setNew.waypointDeviation.setDeg(CockpitB29.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB29.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitB29.this.setNew.vspeed = ((199.0F * CockpitB29.this.setOld.vspeed + CockpitB29.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitB29 this$0;
