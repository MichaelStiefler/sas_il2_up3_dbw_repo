...
// Source File Name:   CockpitSea2.java
...
//            CockpitPilot, SEAFIRE1, SEAFIRE2C, SEAFIRE2C4, 
//            Cockpit, Aircraft

public class CockpitSea2 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(aircraft() instanceof com.maddox.il2.objects.air.SEAFIRE1)
        {
            com.maddox.il2.objects.air.SEAFIRE1 seafire1 = (com.maddox.il2.objects.air.SEAFIRE1)aircraft();
            if(com.maddox.il2.objects.air.SEAFIRE1.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.SEAFIRE1 seafire1_1 = (com.maddox.il2.objects.air.SEAFIRE1)aircraft();
                com.maddox.il2.objects.air.SEAFIRE1.bChangedPit = false;
            }
        } else
        if(aircraft() instanceof com.maddox.il2.objects.air.SEAFIRE2C)
        {
            com.maddox.il2.objects.air.SEAFIRE2C seafire2c = (com.maddox.il2.objects.air.SEAFIRE2C)aircraft();
            if(com.maddox.il2.objects.air.SEAFIRE2C.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.SEAFIRE2C seafire2c1 = (com.maddox.il2.objects.air.SEAFIRE2C)aircraft();
                com.maddox.il2.objects.air.SEAFIRE2C.bChangedPit = false;
            }
        } else
        if(aircraft() instanceof com.maddox.il2.objects.air.SEAFIRE2C4)
        {
            com.maddox.il2.objects.air.SEAFIRE2C4 seafire2c4 = (com.maddox.il2.objects.air.SEAFIRE2C4)aircraft();
            if(com.maddox.il2.objects.air.SEAFIRE2C4.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.SEAFIRE2C4 seafire2c4_1 = (com.maddox.il2.objects.air.SEAFIRE2C4)aircraft();
                com.maddox.il2.objects.air.SEAFIRE2C4.bChangedPit = false;
            }
        }
        resetYPRmodifier();
