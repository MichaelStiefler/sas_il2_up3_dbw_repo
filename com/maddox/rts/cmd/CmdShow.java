        ...
        for(com.maddox.rts.CmdEnv cmdenv2 = cmdenv; cmdenv2 != null; cmdenv2 = cmdenv2.parent())
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    {
                        int i;
                        for(i = 0; i < list1.size() && !com.maddox.util.StrMath.simple((java.lang.String)list1.get(i), obj3.toString()); i++);
                        if(i == list1.size())
                            obj3 = null;
                    }
                } while(obj3 == null || !com.maddox.rts.CmdEnv.validAtomName(obj3.toString()));
