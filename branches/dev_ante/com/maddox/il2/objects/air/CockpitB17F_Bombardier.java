...
public class CockpitB17F_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    if (this.bEntered) {
      this.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_17F)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);

      boolean bool = ((B_17F)aircraft()).fSightCurReadyness > 0.93F;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      float f1 = ((B_17F)CockpitB17F_Bombardier.this.aircraft()).fSightCurForwardAngle;

      float f2 = ((B_17F)CockpitB17F_Bombardier.this.aircraft()).fSightCurSideslip;

      CockpitB17F_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitB17F_Bombardier.this.bEntered) {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitB17F_Bombardier.this.aAim + f2, CockpitB17F_Bombardier.this.tAim + f1, 0.0F);
      }
      CockpitB17F_Bombardier.this.mesh.chunkSetAngles("TurretA", 0.0F, CockpitB17F_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);

      CockpitB17F_Bombardier.this.mesh.chunkSetAngles("TurretB", 0.0F, CockpitB17F_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
