...
public abstract class B5N extends com.maddox.il2.objects.air.Scheme1
{
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxcontrols"))
            {
                if((s.endsWith("1") || s.endsWith("2")) && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.35F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Aileron Controls Out..");
                }
                if(s.endsWith("3") && getEnergyPastArmor(0.2F, shot) > 0.0F)
                {
                    FM.AS.setEngineSpecificDamage(shot.initiator, 0, 1);
                    FM.AS.setEngineSpecificDamage(shot.initiator, 0, 6);
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                }
                if(s.endsWith("4") && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.1F, shot) > 0.0F)
                {
                    FM.AS.setControlsDamage(shot.initiator, 1);
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Evelator Controls Out..");
                }
                if(s.endsWith("5") && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(2.2F, shot) > 0.0F)
                {
                    FM.AS.setControlsDamage(shot.initiator, 2);
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Rudder Controls Out..");
                }
                return;
            }
            if(s.startsWith("xxeng1"))
            {
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Engine Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Engine Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Engine Crank Case Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(6.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Engine Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Engine Cylinders Hit - Engine Fires..");
                        }
                    }
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** StabL Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** StabR Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B5N.debugprintln(this, "*** Keel1 Spars Damaged..");
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.B5N.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.21F, 0.0F, -0.21F);
        hierMesh().chunkSetLocate("GearL25_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.B5N.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.21F, 0.0F, -0.21F);
    ...
    public void update(float f)
    {
        ...
        {
            float f1 = com.maddox.il2.objects.air.B5N.cvt(FM.Gears.arrestorVAngle, -44F, 9F, 1.0F, 0.0F);
