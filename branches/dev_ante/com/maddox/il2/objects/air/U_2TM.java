  ...
  implements TypeScout, TypeTransport
{
  ...
  static
  {
    Class localClass = U_2TM.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "U-2TM");
    Property.set(localClass, "meshName", "3do/plane/U-2TM/PlaneU2TM.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/U-2TM.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitU2TM.class });
