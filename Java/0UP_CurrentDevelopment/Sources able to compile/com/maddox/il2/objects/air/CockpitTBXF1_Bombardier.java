...
public class CockpitTBXF1_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((TBF1)aircraft()).fSightCurForwardAngle;
            float f1 = ((TBF1)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            ...
            boolean flag = ((TBF1)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitTBXF1_Bombardier.class, "astatePilotIndx", 0);
    }
