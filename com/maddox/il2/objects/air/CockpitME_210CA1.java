...
public class CockpitME_210CA1 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (((ME_210CA1)CockpitME_210CA1.this.aircraft() == null) || 
        (ME_210CA1.bChangedPit))
      {
        CockpitME_210CA1.this.reflectPlaneToModel();
        if ((ME_210CA1)CockpitME_210CA1.this.aircraft() != null);
        ME_210CA1.bChangedPit = false;
      }
      CockpitME_210CA1.access$002(CockpitME_210CA1.this, CockpitME_210CA1.this.setOld);
      CockpitME_210CA1.access$102(CockpitME_210CA1.this, CockpitME_210CA1.this.setNew);
      CockpitME_210CA1.access$202(CockpitME_210CA1.this, CockpitME_210CA1.this.setTmp);
      CockpitME_210CA1.this.setNew.altimeter = CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitME_210CA1.this.cockpitDimControl)
      {
        if (CockpitME_210CA1.this.setNew.dimPosition > 0.0F)
          CockpitME_210CA1.this.setNew.dimPosition -= 0.05F;
      }
      else if (CockpitME_210CA1.this.setNew.dimPosition < 1.0F)
        CockpitME_210CA1.this.setNew.dimPosition += 0.05F;
      CockpitME_210CA1.this.setNew.throttle1 = (0.91F * CockpitME_210CA1.this.setOld.throttle1 + 0.09F * CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitME_210CA1.this.setNew.throttle2 = (0.91F * CockpitME_210CA1.this.setOld.throttle2 + 0.09F * CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitME_210CA1.this.setNew.mix1 = (0.88F * CockpitME_210CA1.this.setOld.mix1 + 0.12F * CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitME_210CA1.this.setNew.mix2 = (0.88F * CockpitME_210CA1.this.setOld.mix2 + 0.12F * CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitME_210CA1.this.setNew.azimuth = CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitME_210CA1.this.setOld.azimuth > 270.0F) && (CockpitME_210CA1.this.setNew.azimuth < 90.0F))
        CockpitME_210CA1.this.setOld.azimuth -= 360.0F;
      if ((CockpitME_210CA1.this.setOld.azimuth < 90.0F) && (CockpitME_210CA1.this.setNew.azimuth > 270.0F))
        CockpitME_210CA1.this.setOld.azimuth += 360.0F;
      CockpitME_210CA1.this.setNew.waypointAzimuth = ((10.0F * CockpitME_210CA1.this.setOld.waypointAzimuth + (CockpitME_210CA1.this.waypointAzimuth() - CockpitME_210CA1.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitME_210CA1.Variables localVariables = CockpitME_210CA1.this.setNew;
      float f1 = 0.9F * CockpitME_210CA1.this.setOld.radioalt;
      float f2 = 0.1F;
      float f3 = CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      World.cur();
      World.land();
      localVariables.radioalt = (f1 + f2 * (f3 - Landscape.HQ_Air((float)CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.x, (float)CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y)));
      CockpitME_210CA1.this.setNew.vspeed = ((199.0F * CockpitME_210CA1.this.setOld.vspeed + CockpitME_210CA1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitME_210CA1.access$302(CockpitME_210CA1.this, CockpitME_210CA1.this.middleAngleTarget * 0.05F + 0.95F * CockpitME_210CA1.this.middleAngle);
      return true;
    }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float radioalt;
    private final CockpitME_210CA1 this$0;
    ...
    Variables(CockpitME_210CA1.1 arg2)
    {
      this();
    }
  }
