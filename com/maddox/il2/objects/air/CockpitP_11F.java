...
// Source File Name:   CockpitP_11F.java
...
//            CockpitPilot, Cockpit, Aircraft, P_11F

public class CockpitP_11F extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            com.maddox.il2.objects.air.P_11F p_11f = (com.maddox.il2.objects.air.P_11F)aircraft();
            if(com.maddox.il2.objects.air.P_11F.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.P_11F p_11f1 = (com.maddox.il2.objects.air.P_11F)aircraft();
                com.maddox.il2.objects.air.P_11F.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
    ...
    public CockpitP_11F()
    {
        super("3DO/Cockpit/P-11f/hier.him", "i16");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("zFuelPrs", 0.0F, cvt(fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 8F, 0.0F, 270F), 0.0F);
    ...
    {
        if(com.maddox.il2.engine.Actor.isAlive(((com.maddox.il2.engine.Actor) (aircraft()))))
