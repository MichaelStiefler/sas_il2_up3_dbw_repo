...
public class CockpitJU_88A4_NGunner extends CockpitGunner
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    resetYPRmodifier();
    float tmp385_384 = (0.85F * this.pictFlap + 0.00948F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.FlapsControl); this.pictFlap = tmp385_384; Cockpit.xyz[2] = tmp385_384;
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetLocate("zFlaps1", Cockpit.xyz, Cockpit.ypr);
    float tmp431_430 = (0.85F * this.pictGear + 0.007095F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl); this.pictGear = tmp431_430; Cockpit.xyz[2] = tmp431_430;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitJU_88A4_NGunner.access$102(CockpitJU_88A4_NGunner.this, CockpitJU_88A4_NGunner.this.setOld); CockpitJU_88A4_NGunner.access$202(CockpitJU_88A4_NGunner.this, CockpitJU_88A4_NGunner.this.setNew); CockpitJU_88A4_NGunner.access$302(CockpitJU_88A4_NGunner.this, CockpitJU_88A4_NGunner.this.setTmp);

        CockpitJU_88A4_NGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.throttle1 + CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_NGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.prop1 + CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);

        CockpitJU_88A4_NGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.throttle2 + CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_NGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A4_NGunner.this.setOld.prop2 + CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);

        CockpitJU_88A4_NGunner.this.setNew.altimeter = CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f1 = CockpitJU_88A4_NGunner.this.waypointAzimuth();
        CockpitJU_88A4_NGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4_NGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A4_NGunner.this.setOld.azimuth.getDeg(1.0F));
        CockpitJU_88A4_NGunner.this.setNew.azimuth.setDeg(CockpitJU_88A4_NGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitJU_88A4_NGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_NGunner.this.setOld.vspeed + CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitJU_88A4_NGunner.this.cockpitDimControl) {
          if (CockpitJU_88A4_NGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88A4_NGunner.this.setNew.dimPosition = (CockpitJU_88A4_NGunner.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitJU_88A4_NGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88A4_NGunner.this.setNew.dimPosition = (CockpitJU_88A4_NGunner.this.setOld.dimPosition + 0.05F);

        float f2 = CockpitJU_88A4_NGunner.this.prevFuel - CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel;
        CockpitJU_88A4_NGunner.access$402(CockpitJU_88A4_NGunner.this, CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A4_NGunner.this.setNew.cons = (0.91F * CockpitJU_88A4_NGunner.this.setOld.cons + 0.09F * f2);

        if (CockpitJU_88A4_NGunner.this.buzzerFX != null) {
          if ((CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < ((JU_88A4)CockpitJU_88A4_NGunner.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4)CockpitJU_88A4_NGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1))
            CockpitJU_88A4_NGunner.this.buzzerFX.play();
          else if (CockpitJU_88A4_NGunner.this.buzzerFX.isPlaying()) {
            CockpitJU_88A4_NGunner.this.buzzerFX.stop();
          }
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float cons;
    private final CockpitJU_88A4_NGunner this$0;
    ...
    Variables(CockpitJU_88A4_NGunner.1 arg2)
    {
      this();
    }
  }
