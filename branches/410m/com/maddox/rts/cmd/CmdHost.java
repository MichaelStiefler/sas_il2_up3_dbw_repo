...
public class CmdHost extends com.maddox.rts.Cmd
{
    ...
    {
        if(com.maddox.rts.cmd.CmdHost.nargs(map, "_$$") == 1 && cmdenv.levelAccess() == 0)
        {
            java.lang.String s = com.maddox.rts.cmd.CmdHost.arg(map, "_$$", 0);
        ...
        boolean flag = com.maddox.rts.cmd.CmdHost.exist(map, "PATH");
