  ...
  implements TypeFighter, TypeBNZFighter, TypeStormovik
{
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxarmor")) {
        ...
        if (paramString.endsWith("p1")) {
          ...
          getEnergyPastArmor(World.Rnd().nextFloat(20.0F, 40.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-005D), paramShot);
        ...
        case 8:
        case 9:
          if (getEnergyPastArmor(World.Rnd().nextFloat(0.5F, 2.93F), paramShot) <= 0.0F) {
            break;
          }
        ...
        if ((paramString.endsWith("prop")) && (getEnergyPastArmor(0.1F, paramShot) > 0.0F))
        {
        ...
        if ((paramString.endsWith("cyls")) && (getEnergyPastArmor(0.45F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < this.FM.EI.engines[0].getCylindersRatio() * 1.75F))
        {
        ...
        if ((paramString.endsWith("wat1")) && (World.Rnd().nextFloat() < 0.05F))
          this.FM.AS.hitOil(paramShot.initiator, 0);
  ...
  static
  {
    Class localClass = P_51Mustang.class;
