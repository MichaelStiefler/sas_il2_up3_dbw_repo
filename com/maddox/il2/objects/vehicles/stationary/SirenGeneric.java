...
// Source File Name:   SirenGeneric.java
...
public abstract class SirenGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.SirenGeneric sirengeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.SirenGeneric.constr_arg2 = actorspawnarg;
                sirengeneric = (com.maddox.il2.objects.vehicles.stationary.SirenGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.SirenGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create SirenGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return sirengeneric;
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(class1, "meshName", com.maddox.il2.objects.vehicles.stationary.SirenGeneric.mesh_name);
            cls = class1;
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.SirenGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SirenGeneric.Rnd(30F, 50F));
                        if(!danger())
                        {
                            engineSFX.stop();
    ...
    private SirenGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    public void startMove()
    {
        if(!interpEnd("move"))
        {
            ...
            engineSTimer = -(int)com.maddox.il2.objects.vehicles.stationary.SirenGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SirenGeneric.Rnd(3F, 10F));
        }
    }
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(null); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if((actor instanceof com.maddox.il2.objects.air.Aircraft) && actor.getArmy() != myArmy && actor.getSpeed(vector3d) > 20D && actor.pos.getAbsPoint().distance(point3d) < 18000D)
                return true;
        }
