...
public class BLENHEIM1 extends BLENHEIM
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = BLENHEIM1.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= BLENHEIM1.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / BLENHEIM1.toMeters(fSightCurAltitude)));
            calibDistance = BLENHEIM1.toMetersPerSecond(fSightCurSpeed) * floatindex(Aircraft.cvt(BLENHEIM1.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)BLENHEIM1.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(BLENHEIM1.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = BLENHEIM1.class;
        ...
        BLENHEIM1.weaponTriggersRegister(class1, new int[] {
            0, 10, 3, 3
        });
        BLENHEIM1.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_BombSpawn01", "_BombSpawn02"
        });
        BLENHEIM1.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning303k 500", "MGunVikkersKt 2600", null, null
        });
        BLENHEIM1.weaponsRegister(class1, "4x250", new java.lang.String[] {
            "MGunBrowning303k 500", "MGunVikkersKt 2600", "BombGun250lbs 2", "BombGun250lbs 2"
        });
        BLENHEIM1.weaponsRegister(class1, "2x500", new java.lang.String[] {
            "MGunBrowning303k 500", "MGunVikkersKt 2600", "BombGun500lbs 1", "BombGun500lbs 1"
        });
        BLENHEIM1.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
