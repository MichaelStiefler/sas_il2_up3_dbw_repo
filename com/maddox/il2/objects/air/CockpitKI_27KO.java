...
// Source File Name:   CockpitKI_27KO.java
...
//            CockpitPilot, KI_27, Aircraft

public class CockpitKI_27KO extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.05F, 0.95F, 0.0F, 0.55F);
        ...
        resetYPRmodifier();
        xyz[1] = cvt(setNew.mix, 0.0F, 1.2F, 0.03675F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Speedometer1", -floatindex(cvt(0.539957F * com.maddox.il2.fm.Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), speedometerScale), 0.0F, 0.0F);
        w.set(fm.getW());
        fm.Or.transform(w);
