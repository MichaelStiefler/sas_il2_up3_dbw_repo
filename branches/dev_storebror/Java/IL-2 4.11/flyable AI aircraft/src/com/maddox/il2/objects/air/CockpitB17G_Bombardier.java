...
public class CockpitB17G_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			float f = ((B_17G) CockpitB17G_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((B_17G) CockpitB17G_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitB17G_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F,
					-f1, f);
			if (CockpitB17G_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitB17G_Bombardier.this.aAim
						+ f1, CockpitB17G_Bombardier.this.tAim + f, 0.0F);
			}
			CockpitB17G_Bombardier.this.mesh.chunkSetAngles("TurretA", 0.0F,
					CockpitB17G_Bombardier.this.aircraft().FM.turret[0].tu[0],
					0.0F);
			CockpitB17G_Bombardier.this.mesh.chunkSetAngles("TurretB", 0.0F,
					CockpitB17G_Bombardier.this.aircraft().FM.turret[0].tu[1],
					0.0F);
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(
					((B_17G) this.aircraft()).fSightCurForwardAngle, 7F, 140F,
					0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((B_17G) this.aircraft()).fSightCurReadyness > 0.93F;
