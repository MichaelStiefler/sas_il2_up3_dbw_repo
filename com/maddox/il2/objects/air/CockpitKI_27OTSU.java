...
public class CockpitKI_27OTSU extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitKI_27OTSU.this.setNew.manifold = (0.8F * CockpitKI_27OTSU.this.setOld.manifold + 0.2F * CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitKI_27OTSU.this.setNew.throttle = (0.8F * CockpitKI_27OTSU.this.setOld.throttle + 0.2F * CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitKI_27OTSU.this.setNew.prop = (0.8F * CockpitKI_27OTSU.this.setOld.prop + 0.2F * CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitKI_27OTSU.this.setNew.mix = (0.8F * CockpitKI_27OTSU.this.setOld.mix + 0.2F * CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());

        CockpitKI_27OTSU.this.setNew.man = (0.92F * CockpitKI_27OTSU.this.setOld.man + 0.08F * CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitKI_27OTSU.this.setNew.altimeter = CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        float f = CockpitKI_27OTSU.this.waypointAzimuth();
        CockpitKI_27OTSU.this.setNew.azimuth.setDeg(CockpitKI_27OTSU.this.setOld.azimuth.getDeg(1.0F), CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        ...
        CockpitKI_27OTSU.this.setNew.vspeed = (0.5F * CockpitKI_27OTSU.this.setOld.vspeed + 0.5F * CockpitKI_27OTSU.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed());
      }
