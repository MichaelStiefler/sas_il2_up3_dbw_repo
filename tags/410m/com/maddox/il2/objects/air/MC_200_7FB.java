...
public class MC_200_7FB extends com.maddox.il2.objects.air.MC_200xyz
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MC_200_7FB.weaponTriggersRegister(class1, new int[] {
            0, 0, 3, 3
        });
        com.maddox.il2.objects.air.MC_200_7FB.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02"
        });
        com.maddox.il2.objects.air.MC_200_7FB.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBredaSAFAT127siMC200 350", "MGunBredaSAFAT127siMC200 350", null, null
        });
        com.maddox.il2.objects.air.MC_200_7FB.weaponsRegister(class1, "2x50", new java.lang.String[] {
            "MGunBredaSAFAT127siMC200 350", "MGunBredaSAFAT127siMC200 350", "BombGun50kg 1", "BombGun50kg 1"
        });
        com.maddox.il2.objects.air.MC_200_7FB.weaponsRegister(class1, "2x100", new java.lang.String[] {
            "MGunBredaSAFAT127siMC200 350", "MGunBredaSAFAT127siMC200 350", "BombGun100kg 1", "BombGun100kg 1"
        });
        com.maddox.il2.objects.air.MC_200_7FB.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
