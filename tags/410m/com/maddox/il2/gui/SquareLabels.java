        ...
        for(int j1 = 0; j1 < 2; j1++)
        {
            for(int k1 = 0; k1 <= l; k1++)
            {
                ...
                if(k1 > 0 && f5 - f7 / 2.0F < f4)
                    continue;
                f4 = f5 + f7 / 2.0F + 2.0F;
                float f9 = (cameraortho2d.top - cameraortho2d.bottom - f3) + (float)_squareLabelsFont.descender();
                if(j1 == 0)
                    com.maddox.il2.engine.Render.drawTile(f5 - f7, f9 + (float)_squareLabelsFont.descender(), 2.0F * f7, f3, 0.0F, _squareLabelsMat, 0xffc0c0c0, 0.0F, 0.0F, 1.0F, 1.0F);
                else
                    _squareLabelsFont.output(0xff000000, f5 - f7 / 2.0F, f9, 0.0F, s);
            }
            ...
            for(int l1 = 0; l1 <= i1; l1++)
            {
                ...
                float f8 = _squareLabelsFont.width(s1);
                if(l1 > 0 && f6 < f4)
                    continue;
                f4 = f6 + f3;
                float f10 = (cameraortho2d.right - cameraortho2d.left - 2.0F - f8) + (float)_squareLabelsFont.descender();
                if(j1 == 0)
                    com.maddox.il2.engine.Render.drawTile(f10 - f8 / 2.0F, f6 + (float)_squareLabelsFont.descender(), 2.0F * f8, f3, 0.0F, _squareLabelsMat, 0xffc0c0c0, 0.0F, 0.0F, 1.0F, 1.0F);
                else
