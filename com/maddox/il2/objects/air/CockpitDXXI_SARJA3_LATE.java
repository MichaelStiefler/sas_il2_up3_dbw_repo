...
public class CockpitDXXI_SARJA3_LATE extends CockpitPilot
{
  ...
  private DXXI_SARJA3_LATE ac = null;
  ...
  public CockpitDXXI_SARJA3_LATE()
  {
    ...
    this.ac = ((DXXI_SARJA3_LATE)aircraft());
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (((DXXI_SARJA3_LATE)aircraft()).jdField_bChangedPit_of_type_Boolean)
    {
      reflectPlaneToModel();
      ((DXXI_SARJA3_LATE)aircraft()).jdField_bChangedPit_of_type_Boolean = false;
    }
  ...
  private class Variables
  {
    ...
    Vector3d[] cP;
    private final CockpitDXXI_SARJA3_LATE this$0;
    ...
    Variables(CockpitDXXI_SARJA3_LATE.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitDXXI_SARJA3_LATE.this.bNeedSetUp)
      {
        ...
        CockpitDXXI_SARJA3_LATE.access$102(CockpitDXXI_SARJA3_LATE.this, false);
      }
      if ((CockpitDXXI_SARJA3_LATE.this.ac != null) && (CockpitDXXI_SARJA3_LATE.this.ac.jdField_bChangedPit_of_type_Boolean))
      {
        CockpitDXXI_SARJA3_LATE.this.reflectPlaneToModel();
        CockpitDXXI_SARJA3_LATE.this.ac.jdField_bChangedPit_of_type_Boolean = false;
      }
      CockpitDXXI_SARJA3_LATE.access$302(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.setOld);
      CockpitDXXI_SARJA3_LATE.access$402(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.setNew);
      CockpitDXXI_SARJA3_LATE.access$502(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.setTmp);
      if (((CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) && (CockpitDXXI_SARJA3_LATE.this.setNew.stbyPosition < 1.0F))
      {
      ...
      CockpitDXXI_SARJA3_LATE.this.setNew.altimeter = CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

      CockpitDXXI_SARJA3_LATE.this.setNew.azimuth.setDeg(CockpitDXXI_SARJA3_LATE.this.setOld.azimuth.getDeg(1.0F), CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut());

      CockpitDXXI_SARJA3_LATE.this.setNew.throttle = ((10.0F * CockpitDXXI_SARJA3_LATE.this.setOld.throttle + CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle()) / 11.0F);

      CockpitDXXI_SARJA3_LATE.this.setNew.mix = ((10.0F * CockpitDXXI_SARJA3_LATE.this.setOld.mix + CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix()) / 11.0F);

      CockpitDXXI_SARJA3_LATE.this.setNew.prop = CockpitDXXI_SARJA3_LATE.this.setOld.prop;
      if (CockpitDXXI_SARJA3_LATE.this.setNew.prop < CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() - 0.01F)
        CockpitDXXI_SARJA3_LATE.this.setNew.prop += 0.0025F;
      if (CockpitDXXI_SARJA3_LATE.this.setNew.prop > CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() + 0.01F)
        CockpitDXXI_SARJA3_LATE.this.setNew.prop -= 0.0025F;
      CockpitDXXI_SARJA3_LATE.this.w.set(CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getW());
      CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transform(CockpitDXXI_SARJA3_LATE.this.w);
      CockpitDXXI_SARJA3_LATE.this.setNew.turn = ((12.0F * CockpitDXXI_SARJA3_LATE.this.setOld.turn + CockpitDXXI_SARJA3_LATE.this.w.z) / 13.0F);
      CockpitDXXI_SARJA3_LATE.this.setNew.vspeed = ((299.0F * CockpitDXXI_SARJA3_LATE.this.setOld.vspeed + CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 300.0F);
      CockpitDXXI_SARJA3_LATE.access$702(CockpitDXXI_SARJA3_LATE.this, 0.8F * CockpitDXXI_SARJA3_LATE.this.pictSupc + 0.2F * CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor());
      ...
      if (CockpitDXXI_SARJA3_LATE.this.flaps == CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap())
      {
        CockpitDXXI_SARJA3_LATE.access$902(CockpitDXXI_SARJA3_LATE.this, 0);
        CockpitDXXI_SARJA3_LATE.this.sfxStop(16);
      }
      else if (CockpitDXXI_SARJA3_LATE.this.flaps < CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap())
      {
        if (CockpitDXXI_SARJA3_LATE.this.flapsDirection == 0)
          CockpitDXXI_SARJA3_LATE.this.sfxStart(16);
        CockpitDXXI_SARJA3_LATE.access$802(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap());
        CockpitDXXI_SARJA3_LATE.access$1002(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.flapsPump + CockpitDXXI_SARJA3_LATE.this.flapsPumpIncrement);
        CockpitDXXI_SARJA3_LATE.access$902(CockpitDXXI_SARJA3_LATE.this, 1);
        if ((CockpitDXXI_SARJA3_LATE.this.flapsPump < 0.0F) || (CockpitDXXI_SARJA3_LATE.this.flapsPump > 1.0F))
          CockpitDXXI_SARJA3_LATE.access$1102(CockpitDXXI_SARJA3_LATE.this, -CockpitDXXI_SARJA3_LATE.this.flapsPumpIncrement);
      }
      else if (CockpitDXXI_SARJA3_LATE.this.flaps > CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap())
      {
        if (CockpitDXXI_SARJA3_LATE.this.flapsDirection == 0)
      ...
      if ((!CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.bTailwheelLocked) && (CockpitDXXI_SARJA3_LATE.this.tailWheelLock < 1.0F))
      {
        CockpitDXXI_SARJA3_LATE.access$1202(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.tailWheelLock + 0.05F);
      }
      else if ((CockpitDXXI_SARJA3_LATE.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.bTailwheelLocked) && (CockpitDXXI_SARJA3_LATE.this.tailWheelLock > 0.0F))
      {
        CockpitDXXI_SARJA3_LATE.access$1202(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.tailWheelLock - 0.05F);
      }
