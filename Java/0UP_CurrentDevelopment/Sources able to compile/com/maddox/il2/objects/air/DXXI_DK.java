...
public class DXXI_DK extends DXXI
{
    ...
    protected void moveFan(float f)
    {
        if(com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            ...
            hierMesh().chunkSetAngles("Stick_D0", 0.0F, 9F * f1, DXXI_DK.cvt(f2, -1F, 1.0F, -8F, 9.5F));
            hierMesh().chunkSetAngles("pilotarm2_d0", DXXI_DK.cvt(f1, -1F, 1.0F, 14F, -16F), 0.0F, DXXI_DK.cvt(f1, -1F, 1.0F, 6F, -8F) - DXXI_DK.cvt(f2, -1F, 1.0F, -37F, 35F));
            hierMesh().chunkSetAngles("pilotarm1_d0", 0.0F, 0.0F, DXXI_DK.cvt(f1, -1F, 1.0F, -16F, 14F) + DXXI_DK.cvt(f2, -1F, 0.0F, -61F, 0.0F) + DXXI_DK.cvt(f2, 0.0F, 1.0F, 0.0F, 43F));
        }
    }
    ...
    static 
    {
        java.lang.Class class1 = DXXI_DK.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "D.XXI");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/DXXI_DK/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/FokkerDK.fmd");
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            CockpitDXXI_SARJA4.class
        });
        com.maddox.rts.Property.set(class1, "LOSElevation", 0.8472F);
        com.maddox.rts.Property.set(class1, "originCountry", PaintScheme.countryNoName);
        ...
        DXXI_DK.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning303sipzl 500", "MGunBrowning303sipzl 500", null, null
        });
        DXXI_DK.weaponsRegister(class1, "madsen", new java.lang.String[] {
            "MGunBrowning303sipzl 500", "MGunBrowning303sipzl 500", "MGunMadsen20 60", "MGunMadsen20 60"
        });
        DXXI_DK.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
