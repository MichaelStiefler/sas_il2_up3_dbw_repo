...
public class CockpitB25J15 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitB25J15 this$0;
    ...
    Variables(CockpitB25J15.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB25J15.this.fm != null) {
        CockpitB25J15.access$102(CockpitB25J15.this, CockpitB25J15.this.setOld);
        CockpitB25J15.access$202(CockpitB25J15.this, CockpitB25J15.this.setNew);
        CockpitB25J15.access$302(CockpitB25J15.this, CockpitB25J15.this.setTmp);
        ...
        CockpitB25J15.this.setNew.waypointAzimuth.setDeg(CockpitB25J15.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitB25J15.this.setNew.waypointDeviation.setDeg(CockpitB25J15.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB25J15.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitB25J15.this.setNew.vspeed = ((199.0F * CockpitB25J15.this.setOld.vspeed + CockpitB25J15.this.fm.getVertSpeed()) / 200.0F);
      }
