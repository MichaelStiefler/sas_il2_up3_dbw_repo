...
public class CockpitDB3T_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((IL_4_DB3T)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((IL_4_DB3T)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitDB3T_Bombardier.this.bEntered) {
        float f1 = ((IL_4_DB3T)CockpitDB3T_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((IL_4_DB3T)CockpitDB3T_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitDB3T_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitDB3T_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
