...
public abstract class KI_61 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.KI_61.cvt(f, 0.16F, 0.99F, 0.0F, -0.54F);
    ...
    {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.KI_61.cvt(f, 0.1F, 0.82F, 0.0F, -82F), 0.0F);
        hiermesh.chunkSetAngles("GearL7_D0", 0.0F, com.maddox.il2.objects.air.KI_61.cvt(f, 0.1F, 0.82F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, com.maddox.il2.objects.air.KI_61.cvt(f, 0.1F, 0.16F, 0.0F, 86F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.KI_61.cvt(f, 0.34F, 0.91F, 0.0F, -82F), 0.0F);
        hiermesh.chunkSetAngles("GearR7_D0", 0.0F, com.maddox.il2.objects.air.KI_61.cvt(f, 0.34F, 0.91F, 0.0F, 90F), 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, com.maddox.il2.objects.air.KI_61.cvt(f, 0.34F, 0.4F, 0.0F, -86F), 0.0F);
    }

    protected void moveGear(float f)
    {
        com.maddox.il2.objects.air.KI_61.moveGear(hierMesh(), f);
    }

    public void moveWheelSink()
    {
        float f = com.maddox.il2.objects.air.KI_61.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.245F, 0.0F, 0.245F);
        resetYPRmodifier();
        xyz[1] = f;
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.KI_61.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.245F, 0.0F, 37F);
        hierMesh().chunkSetAngles("GearL4_D0", 0.0F, f, 0.0F);
        hierMesh().chunkSetAngles("GearL5_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.KI_61.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.245F, 0.0F, 0.245F);
        resetYPRmodifier();
        xyz[1] = f;
        hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.KI_61.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.245F, 0.0F, 37F);
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 10: // '\n'
                    ...
                    {
                        com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        FM.AS.setControlsDamage(shot.initiator, 1);
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                ...
                case 11: // '\013'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                    }
                    break;
                }
                return;
            ...
            {
                com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Hit..");
                if(s.endsWith("pipe"))
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && FM.CT.Weapons[1] != null && FM.CT.Weapons[1].length != 2)
                    {
                        FM.AS.setJamBullets(1, 0);
                        com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Nose Nozzle Pipe Bent..");
                    }
                ...
                if(s.endsWith("prop"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.8F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Prop Governor Hit, Disabled..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 4);
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Prop Governor Hit, Damaged..");
                        }
                } else
                if(s.endsWith("gear"))
                {
                    if(getEnergyPastArmor(4.6F, shot) > 0.0F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Bullet Jams Reductor Gear..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 3);
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 4);
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Reductor Gear Damaged, Prop Governor Failed..");
                        }
                } else
                if(s.endsWith("supc"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Supercharger Disabled..");
                    }
                } else
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(2.1F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 175000F)
                        {
                            ...
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Bullet Jams Crank Ball Bearing..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Crank Case Hit, Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                        }
                ...
                if(s.startsWith("xxeng1cyl"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 1.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 24000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 3);
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Cylinders Hit, Engine Fires..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F)
                        {
                            FM.AS.setEngineStuck(shot.initiator, 0);
                            com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Bullet Jams Piston Head..");
                        }
                        getEnergyPastArmor(22.5F, shot);
                    }
                } else
                if(s.endsWith("sync"))
                {
                    ...
                    {
                        com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Gun Synchronized Hit, Nose Guns Lose Authority..");
                ...
                if(s.startsWith("xxeng1oil"))
                {
                    ...
                    com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Engine Module: Oil Radiator Hit..");
                }
                return;
            }
            ...
            {
                com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.KI_61.debugprintln(this, "*** WingROut Spars Damaged..");
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.KI_61.class;
