...
public class CockpitSEAHURRICANE1 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    resetYPRmodifier();
    Cockpit.xyz[1] = cvt(this.fm.CT.arrestorControl, 0.01F, 0.99F, 0.0F, 0.03F);
    ...
    this.mesh.chunkSetAngles("STRELKA_BOOST", 0.0F, 0.0F, -cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.7242097F, 1.620528F, -111.5F, 221.0F));
  ...
  private class Variables
  {
    ...
    private final CockpitSEAHURRICANE1 this$0;
    ...
    Variables(CockpitSEAHURRICANE1.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSEAHURRICANE1.this.bNeedSetUp) {
        ...
        CockpitSEAHURRICANE1.access$102(CockpitSEAHURRICANE1.this, false);
      }
      if (CockpitSEAHURRICANE1.this.fm != null) {
        CockpitSEAHURRICANE1.access$202(CockpitSEAHURRICANE1.this, CockpitSEAHURRICANE1.this.setOld);
        CockpitSEAHURRICANE1.access$302(CockpitSEAHURRICANE1.this, CockpitSEAHURRICANE1.this.setNew);
        CockpitSEAHURRICANE1.access$402(CockpitSEAHURRICANE1.this, CockpitSEAHURRICANE1.this.setTmp);
        CockpitSEAHURRICANE1.this.setNew.throttle = ((10.0F * CockpitSEAHURRICANE1.this.setOld.throttle + CockpitSEAHURRICANE1.this.fm.CT.PowerControl) / 11.0F);

        CockpitSEAHURRICANE1.this.setNew.altimeter = CockpitSEAHURRICANE1.this.fm.getAltitude();
        if (Math.abs(CockpitSEAHURRICANE1.this.fm.Or.getKren()) < 30.0F) {
          CockpitSEAHURRICANE1.this.setNew.azimuth = ((35.0F * CockpitSEAHURRICANE1.this.setOld.azimuth + -CockpitSEAHURRICANE1.this.fm.Or.getYaw()) / 36.0F);
        }
        if ((CockpitSEAHURRICANE1.this.setOld.azimuth > 270.0F) && (CockpitSEAHURRICANE1.this.setNew.azimuth < 90.0F))
          CockpitSEAHURRICANE1.this.setOld.azimuth -= 360.0F;
        if ((CockpitSEAHURRICANE1.this.setOld.azimuth < 90.0F) && (CockpitSEAHURRICANE1.this.setNew.azimuth > 270.0F))
          CockpitSEAHURRICANE1.this.setOld.azimuth += 360.0F;
        CockpitSEAHURRICANE1.this.setNew.waypointAzimuth = ((10.0F * CockpitSEAHURRICANE1.this.setOld.waypointAzimuth + (CockpitSEAHURRICANE1.this.waypointAzimuth() - CockpitSEAHURRICANE1.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

        CockpitSEAHURRICANE1.this.setNew.vspeed = ((199.0F * CockpitSEAHURRICANE1.this.setOld.vspeed + CockpitSEAHURRICANE1.this.fm.getVertSpeed()) / 200.0F);
      }
