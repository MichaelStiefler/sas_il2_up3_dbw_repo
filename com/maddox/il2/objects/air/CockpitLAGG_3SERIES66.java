...
public class CockpitLAGG_3SERIES66 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLAGG_3SERIES66.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitLAGG_3SERIES66.this.setNew.throttle = ((10.0F * CockpitLAGG_3SERIES66.this.setOld.throttle + CockpitLAGG_3SERIES66.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitLAGG_3SERIES66.this.setNew.prop = ((10.0F * CockpitLAGG_3SERIES66.this.setOld.prop + CockpitLAGG_3SERIES66.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitLAGG_3SERIES66.this.setNew.altimeter = CockpitLAGG_3SERIES66.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitLAGG_3SERIES66.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitLAGG_3SERIES66.this.setNew.azimuth = ((35.0F * CockpitLAGG_3SERIES66.this.setOld.azimuth + -CockpitLAGG_3SERIES66.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        ...
        CockpitLAGG_3SERIES66.this.setNew.waypointAzimuth = ((10.0F * CockpitLAGG_3SERIES66.this.setOld.waypointAzimuth + (CockpitLAGG_3SERIES66.this.waypointAzimuth() - CockpitLAGG_3SERIES66.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);

        CockpitLAGG_3SERIES66.this.setNew.vspeed = ((199.0F * CockpitLAGG_3SERIES66.this.setOld.vspeed + CockpitLAGG_3SERIES66.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
