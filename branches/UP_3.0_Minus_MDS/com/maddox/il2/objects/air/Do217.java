...
public abstract class Do217 extends com.maddox.il2.objects.air.Scheme2
    implements com.maddox.il2.objects.air.TypeBomber, com.maddox.il2.objects.air.TypeTransport
{
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            ...
            calibDistance = (fSightCurSpeed / 3.6F) * floatindex(com.maddox.il2.objects.air.Aircraft.cvt(fSightCurAltitude, 0.0F, 7000F, 0.0F, 7F), calibrationScale);
    ...
    protected boolean cutFM(int i, int j, com.maddox.il2.engine.Actor actor)
    {
        ...
        case 35: // '#'
            FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 0, 3);
            if(com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 66)
                FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 0, 1);
            break;

        case 38: // '&'
            FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 1, 3);
            if(com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 66)
                FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), 1, 1);
            break;
        ...
        case 13: // '\r'
            ...
            killPilot(((com.maddox.il2.engine.Actor) (this)), 3);
            return false;
        }
    ...
    {
        hierMesh().chunkSetAngles("GearC3_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, -65F, 65F, 65F, -65F), 0.0F);
    }
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if((s.endsWith("cf1") || s.endsWith("cf2")) && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("CF") > 1 && getEnergyPastArmor(15.9F / (float)java.lang.Math.sqrt(com.maddox.il2.objects.air.Aircraft.v1.y * com.maddox.il2.objects.air.Aircraft.v1.y + com.maddox.il2.objects.air.Aircraft.v1.z * com.maddox.il2.objects.air.Aircraft.v1.z), shot) > 0.0F)
                {
                    ...
                    msgCollision(((com.maddox.il2.engine.Actor) (this)), "WingLIn_D0", "WingLIn_D0");
                    msgCollision(((com.maddox.il2.engine.Actor) (this)), "WingRIn_D0", "WingRIn_D0");
                }
                ...
                if((s.endsWith("k1") || s.endsWith("k2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) && chunkDamageVisible("WingROut") > 1 && getEnergyPastArmor(8.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
                    nextDMGLevels(1, 2, "Keel1_D0", shot.initiator);
                if((s.endsWith("sr1") || s.endsWith("sr2")) && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) && chunkDamageVisible("WingROut") > 1 && getEnergyPastArmor(8.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
            ...
            if(s.startsWith("xxbomb") && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F && FM.CT.Weapons[3] != null && FM.CT.Weapons[3][0].haveBullets())
            {
                ...
                msgCollision(((com.maddox.il2.engine.Actor) (this)), "CF_D0", "CF_D0");
            }
    ...
    {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, -107F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, -107F), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, -19F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, -19F), 0.0F);
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, 60F), 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, 60F), 0.0F);
        ...
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 0.3F, 0.0F, -60F), 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 0.2F, 0.0F, 75F), 0.0F);
        hiermesh.chunkSetAngles("GearC5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 0.2F, 0.0F, 75F), 0.0F);
    }

    protected void moveGear(float f)
    {
        com.maddox.il2.objects.air.Do217.moveGear(hierMesh(), f);
    }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.Do217.class;
