...
public class CockpitP_38J extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (((P_38)aircraft()).bChangedPit) {
      reflectPlaneToModel();
      ((P_38)aircraft()).bChangedPit = false;
    }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_38J.this.bNeedSetUp) {
        ...
        CockpitP_38J.access$102(CockpitP_38J.this, false);
      }
      ...
      if (CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitP_38J.access$202(CockpitP_38J.this, CockpitP_38J.this.setOld); CockpitP_38J.access$302(CockpitP_38J.this, CockpitP_38J.this.setNew); CockpitP_38J.access$402(CockpitP_38J.this, CockpitP_38J.this.setTmp);

        CockpitP_38J.this.setNew.trim = (0.92F * CockpitP_38J.this.setOld.trim + 0.08F * CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.getTrimElevatorControl());
        CockpitP_38J.this.setNew.throttle1 = (0.85F * CockpitP_38J.this.setOld.throttle1 + CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitP_38J.this.setNew.throttle2 = (0.85F * CockpitP_38J.this.setOld.throttle2 + CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitP_38J.this.setNew.prop1 = (0.85F * CockpitP_38J.this.setOld.prop1 + CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitP_38J.this.setNew.prop2 = (0.85F * CockpitP_38J.this.setOld.prop2 + CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);

        CockpitP_38J.this.setNew.mix1 = (0.85F * CockpitP_38J.this.setOld.mix1 + CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix() * 0.15F);
        CockpitP_38J.this.setNew.mix2 = (0.85F * CockpitP_38J.this.setOld.mix2 + CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix() * 0.15F);
        CockpitP_38J.this.setNew.altimeter = CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitP_38J.this.waypointAzimuth();
        CockpitP_38J.this.setNew.azimuth.setDeg(CockpitP_38J.this.setOld.azimuth.getDeg(1.0F), CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitP_38J.this.setNew.waypointAzimuth.setDeg(CockpitP_38J.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitP_38J.this.setNew.vspeed = ((199.0F * CockpitP_38J.this.setOld.vspeed + CockpitP_38J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float trim;
    private final CockpitP_38J this$0;
