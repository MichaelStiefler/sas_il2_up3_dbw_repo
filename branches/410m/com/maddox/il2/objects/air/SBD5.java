...
//            SBD, PaintSchemeFMPar05, TypeStormovik, TypeDiveBomber, 
//            NetAircraft

public class SBD5 extends com.maddox.il2.objects.air.SBD
    implements com.maddox.il2.objects.air.TypeStormovik, com.maddox.il2.objects.air.TypeDiveBomber
{
    ...
    public boolean turretAngles(int i, float af[])
    {
        ...
        case 0: // '\0'
            ...
            if(f1 < -com.maddox.il2.objects.air.SBD5.floatindex(com.maddox.il2.objects.air.SBD5.cvt(f2, 0.0F, 180F, 0.0F, 36F), af))
                f1 = -com.maddox.il2.objects.air.SBD5.floatindex(com.maddox.il2.objects.air.SBD5.cvt(f2, 0.0F, 180F, 0.0F, 36F), af);
            break;
        }
        af[0] = -f;
        af[1] = f1;
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.SBD5.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "SBD");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/SBD-5(Multi1)/hier.him");
        com.maddox.rts.Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        com.maddox.rts.Property.set(class1, "meshName_us", "3DO/Plane/SBD-5(USA)/hier.him");
        com.maddox.rts.Property.set(class1, "PaintScheme_us", new PaintSchemeFMPar05());
        com.maddox.rts.Property.set(class1, "meshName_rz", "3DO/Plane/SBD-5(RZ)/hier.him");
        com.maddox.rts.Property.set(class1, "PaintScheme_rz", new PaintSchemeFMPar05());
        com.maddox.rts.Property.set(class1, "yearService", 1943F);
        com.maddox.rts.Property.set(class1, "yearExpired", 1946.5F);
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/SBD-5.fmd");
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitSBD5.class, com.maddox.il2.objects.air.CockpitSBD3_TGunner.class
        });
        com.maddox.rts.Property.set(class1, "LOSElevation", 1.1058F);
        com.maddox.il2.objects.air.SBD5.weaponTriggersRegister(class1, new int[] {
            0, 0, 10, 10, 3, 3, 3
        });
        com.maddox.il2.objects.air.SBD5.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb01"
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning50s 350", "MGunBrowning50s 350", "MGunBrowning303t 500", "MGunBrowning303t 500", null, null, null
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "1x250", new java.lang.String[] {
            "MGunBrowning50s 350", "MGunBrowning50s 350", "MGunBrowning303t 500", "MGunBrowning303t 500", null, null, "BombGun250lbs"
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "2x250", new java.lang.String[] {
            "MGunBrowning50s 350", "MGunBrowning50s 350", "MGunBrowning303t 500", "MGunBrowning303t 500", "BombGun250lbs", "BombGun250lbs", null
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "3x250", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "1x500", new java.lang.String[] {
            "MGunBrowning50s 350", "MGunBrowning50s 350", "MGunBrowning303t 500", "MGunBrowning303t 500", null, null, "BombGun500lbs"
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "2x500", new java.lang.String[] {
            "MGunBrowning50s 350", "MGunBrowning50s 350", "MGunBrowning303t 500", "MGunBrowning303t 500", "BombGun500lbs", "BombGun500lbs", null
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "3x500", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "1x1000", new java.lang.String[] {
            "MGunBrowning50s 350", "MGunBrowning50s 350", "MGunBrowning303t 500", "MGunBrowning303t 500", null, null, "BombGun1000lbs"
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "1x1600", new java.lang.String[] {
            "MGunBrowning50s 350", "MGunBrowning50s 350", "MGunBrowning303t 500", "MGunBrowning303t 500", null, null, "BombGun1600lbs"
        });
        com.maddox.il2.objects.air.SBD5.weaponsRegister(class1, "none", new java.lang.String[] {
