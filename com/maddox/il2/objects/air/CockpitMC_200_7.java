...
public class CockpitMC_200_7 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    private final CockpitMC_200_7 this$0;
    ...
    Variables(CockpitMC_200_7.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMC_200_7.this.fm != null) {
        CockpitMC_200_7.access$102(CockpitMC_200_7.this, CockpitMC_200_7.this.setOld);
        CockpitMC_200_7.access$202(CockpitMC_200_7.this, CockpitMC_200_7.this.setNew);
        CockpitMC_200_7.access$302(CockpitMC_200_7.this, CockpitMC_200_7.this.setTmp);
        CockpitMC_200_7.this.setNew.throttle = (0.85F * CockpitMC_200_7.this.setOld.throttle + CockpitMC_200_7.this.fm.CT.PowerControl * 0.15F);

        CockpitMC_200_7.this.setNew.prop = (0.85F * CockpitMC_200_7.this.setOld.prop + CockpitMC_200_7.this.fm.CT.getStepControl() * 0.15F);

        CockpitMC_200_7.this.setNew.altimeter = CockpitMC_200_7.this.fm.getAltitude();
        float f = CockpitMC_200_7.this.waypointAzimuth();
        CockpitMC_200_7.this.setNew.waypointAzimuth.setDeg(CockpitMC_200_7.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitMC_200_7.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitMC_200_7.this.setNew.azimuth.setDeg(CockpitMC_200_7.this.setOld.azimuth.getDeg(1.0F), CockpitMC_200_7.this.fm.Or.azimut());

        CockpitMC_200_7.this.setNew.vspeed = ((199.0F * CockpitMC_200_7.this.setOld.vspeed + CockpitMC_200_7.this.fm.getVertSpeed()) / 200.0F);
      }
