...
// Source File Name:   CockpitF2A2.java
...
//            CockpitPilot, F2A2, Aircraft

public class CockpitF2A2 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    protected void doFocusLeave()
    {
        ...
        {
            leave();
            ((com.maddox.il2.objects.air.F2A2)aircraft()).bChangedExts = true;
            ((com.maddox.il2.objects.air.F2A2)aircraft()).doFixBellyDoor();
            super.doFocusLeave();
            return;
        }
    }
    ...
    {
        com.maddox.il2.objects.air.F2A2 _tmp = (com.maddox.il2.objects.air.F2A2)aircraft();
        if(com.maddox.il2.objects.air.F2A2.bChangedPit)
        {
            aircraft().hierMesh().chunkVisible("CF1_D0", false);
            aircraft().hierMesh().chunkVisible("CF1_D1", false);
            aircraft().hierMesh().chunkVisible("CF1_D2", false);
            ...
            aircraft().hierMesh().chunkVisible("Engine11_D1", false);
            aircraft().hierMesh().chunkVisible("Engine11_D2", false);
            ((com.maddox.il2.objects.air.F2A2)aircraft()).bChangedExts = false;
            com.maddox.il2.objects.air.F2A2 _tmp1 = (com.maddox.il2.objects.air.F2A2)aircraft();
            com.maddox.il2.objects.air.F2A2.bChangedPit = false;
        }
        if(gun[0] == null)
        {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.725F);
        ...
        resetYPRmodifier();
        xyz[0] = cvt(pictAiler, -1F, 1.0F, -0.054F, 0.054F);
        mesh.chunkSetLocate("Z_ColumnR", xyz, ypr);
        mesh.chunkSetLocate("Z_ColumnL", xyz, ypr);
        resetYPRmodifier();
        xyz[0] = cvt(fm.CT.getRudder(), -1F, 1.0F, -0.0575F, 0.0575F);
        mesh.chunkSetLocate("Z_Pedal_L", xyz, ypr);
        resetYPRmodifier();
        xyz[0] = cvt(fm.CT.getRudder(), -1F, 1.0F, 0.0575F, -0.0575F);
        mesh.chunkSetLocate("Z_Pedal_R", xyz, ypr);
        resetYPRmodifier();
        if(fm.EI.engines[0].getStage() > 0 && fm.EI.engines[0].getStage() < 3)
            xyz[1] = 0.02825F;
        mesh.chunkSetLocate("Z_Starter", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[1] = cvt(pictProp = 0.9F * pictProp + 0.1F * fm.EI.engines[0].getControlProp(), 0.0F, 1.0F, 0.0F, -0.035F);
        mesh.chunkSetLocate("Z_Pitch", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[0] = cvt(fm.CT.getGear(), 0.0F, 1.0F, 0.0F, -0.135F);
        mesh.chunkSetLocate("Z_Gear", xyz, ypr);
        resetYPRmodifier();
        xyz[0] = cvt(fm.CT.getFlap(), 0.0F, 1.0F, -0.04155F, 0.0211F);
        mesh.chunkSetLocate("Z_Flap", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.Or.getTangage(), -45F, 45F, 0.019F, -0.019F);
        mesh.chunkSetLocate("Z_Hor_Handle2", xyz, ypr);
