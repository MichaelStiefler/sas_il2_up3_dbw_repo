...
public class CmdRadio extends com.maddox.rts.Cmd
{
    ...
    public java.lang.Object exec(com.maddox.rts.CmdEnv cmdenv, java.util.Map map)
    {
        if(com.maddox.il2.game.Main.cur().netServerParams == null)
            return null;
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "_$$"))
        {
            java.lang.String s = com.maddox.il2.game.cmd.CmdRadio.args(map, "_$$");
            ((com.maddox.il2.net.NetUser)com.maddox.rts.NetEnv.host()).setRadio(s, com.maddox.sound.RadioChannel.getCurrentCodec());
        } else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "NONE"))
            ((com.maddox.il2.net.NetUser)com.maddox.rts.NetEnv.host()).setRadio(null, 0);
        else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "COMMON"))
            ((com.maddox.il2.net.NetUser)com.maddox.rts.NetEnv.host()).setRadio(" 0", 1);
        else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "ARMY"))
        ...
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "LIST"))
        {
        ...
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "TEST"))
        {
            if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "TEST", 0) == null)
                java.lang.System.out.println("  Test mode now " + (com.maddox.sound.RadioChannel.tstLoop ? "ON" : "OFF"));
            else
            if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "TEST", 0).compareToIgnoreCase("on") == 0)
            {
                com.maddox.sound.RadioChannel.tstLoop = true;
                java.lang.System.out.println("  Warning : radio chatter now in test mode!");
            } else
            if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "TEST", 0).compareToIgnoreCase("off") == 0)
            {
                com.maddox.sound.RadioChannel.tstLoop = false;
                java.lang.System.out.println("  Radio chatter test mode now OFF");
            } else
            {
                java.lang.System.out.println("  Invalid argument : " + com.maddox.il2.game.cmd.CmdRadio.arg(map, "LEVEL", 0));
            }
        } else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "LEVEL"))
        {
            if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "LEVEL", 0) == null)
            {
            ...
            } else
            {
                try
                {
                    int i = java.lang.Integer.parseInt(com.maddox.il2.game.cmd.CmdRadio.arg(map, "LEVEL", 0));
                    if(i < 10 && i > 100)
                        throw new Error();
                ...
                {
                    java.lang.System.out.println("  ERROR: invalid argument (" + com.maddox.il2.game.cmd.CmdRadio.arg(map, "LEVEL", 0) + ") : number 10..100 expected");
                }
            }
        } else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "LATENCY"))
        {
            if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "LATENCY", 0) == null)
            {
            ...
            } else
            {
                try
                {
                    int j = java.lang.Integer.parseInt(com.maddox.il2.game.cmd.CmdRadio.arg(map, "LATENCY", 0));
                    if(j < 1 && j > 20)
                        throw new Error();
                ...
                {
                    java.lang.System.out.println("  ERROR: invalid argument (" + com.maddox.il2.game.cmd.CmdRadio.arg(map, "LATENCY", 0) + ") : number 1..20 expected");
                }
            }
        } else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "CODEC"))
        {
            if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "CODEC", 0) == null)
                java.lang.System.out.println("  Current codec is " + com.maddox.sound.RadioChannel.getCurrentCodecName());
            else
                try
                {
                    byte byte0 = 0;
                    if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "CODEC", 0).compareToIgnoreCase("lpc") == 0)
                        byte0 = 1;
                    else
                    if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "CODEC", 0).compareToIgnoreCase("hq") == 0)
                        byte0 = 2;
                    else
                        throw new Error();
                ...
                {
                    java.lang.System.out.println("  ERROR: invalid argument (" + com.maddox.il2.game.cmd.CmdRadio.arg(map, "CODEC", 0) + ") : 'lpc' or 'hq' expected");
                }
        } else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "MODE"))
        {
            if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "MODE", 0) == null)
                java.lang.System.out.println("  Radio PTT mode is " + (com.maddox.sound.AudioDevice.getPTTMode() ? "auto" : "manual"));
            else
                try
                {
                    if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "MODE", 0).compareToIgnoreCase("auto") == 0)
                        com.maddox.sound.AudioDevice.setPTTMode(true);
                    else
                    if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "MODE", 0).compareToIgnoreCase("manual") == 0)
                ...
                {
                    java.lang.System.out.println("  ERROR: invalid argument (" + com.maddox.il2.game.cmd.CmdRadio.arg(map, "MODE", 0) + ") : 'auto' or 'manual' expected");
                }
        } else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "PTT"))
            try
            {
                if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "PTT", 0) != null)
                    if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "PTT", 0).compareToIgnoreCase("on") == 0)
                        com.maddox.sound.AudioDevice.setPTT(true);
                    else
                    if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "PTT", 0).compareToIgnoreCase("off") == 0)
            ...
            {
                java.lang.System.out.println("  ERROR: invalid argument (" + com.maddox.il2.game.cmd.CmdRadio.arg(map, "PTT", 0) + ") : 'on' or 'off' expected");
            }
        else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "AGC"))
            try
            {
                if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "AGC", 0) == null)
                    java.lang.System.out.println("  Microphone AGC is " + (com.maddox.sound.AudioDevice.getAGC() ? "on" : "off"));
                else
                if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "AGC", 0).compareToIgnoreCase("on") == 0)
                    com.maddox.sound.AudioDevice.setAGC(true);
                else
                if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "AGC", 0).compareToIgnoreCase("off") == 0)
            ...
            {
                java.lang.System.out.println("  ERROR: invalid argument (" + com.maddox.il2.game.cmd.CmdRadio.arg(map, "AGC", 0) + ") : 'on' or 'off' expected");
            }
        else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "HRCH"))
            try
            {
                if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "HRCH", 0) == null)
                    java.lang.System.out.println("High baudrate channels : " + (com.maddox.sound.RadioChannelSpawn.getUseHRChannels() ? "enabled" : "disabled"));
                else
                if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "HRCH", 0).compareToIgnoreCase("on") == 0)
                    com.maddox.sound.RadioChannelSpawn.useHRChannels(true);
                else
                if(com.maddox.il2.game.cmd.CmdRadio.arg(map, "HRCH", 0).compareToIgnoreCase("off") == 0)
            ...
            {
                java.lang.System.out.println("  ERROR: invalid argument (" + com.maddox.il2.game.cmd.CmdRadio.arg(map, "HRCH", 0) + ") : 'on' or 'off' expected");
            }
        else
        if(com.maddox.il2.game.cmd.CmdRadio.exist(map, "HELP"))
        {
