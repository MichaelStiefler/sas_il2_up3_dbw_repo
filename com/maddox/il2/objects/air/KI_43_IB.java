...
public class KI_43_IB extends KI_43
{
  ...
  static
  {
    Class localClass = KI_43_IB.class;
    new NetAircraft.SPAWN(localClass);

    Property.set(localClass, "iconFar_shortClassName", "Ki-43");

    Property.set(localClass, "meshName", "3DO/Plane/Ki-43-Ib(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar05());
    Property.set(localClass, "meshName_ja", "3DO/Plane/Ki-43-Ib(ja)/hier.him");
