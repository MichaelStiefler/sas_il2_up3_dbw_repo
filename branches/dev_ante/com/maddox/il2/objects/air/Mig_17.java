  ...
  implements TypeFighter, TypeBNZFighter
{
  ...
  public Mig_17()
  {
    ...
    this.$1 = new Object(0.0F, 14000.0F, 0.65F, 1.0F, 0.05F, 1.0F, 0.4F, 1.0F, 0.46F, 0.55F, 0.65F, null)
    {
      private float lal;
      private float tal;
      private float bef;
      ...
      private float lef;
      private float ftl;
      private final Mig_17 this$0;

      public void rs(int ii)
      {
        if ((ii == 0) || (ii == 1)) Mig_17.access$234(this.this$0, 0.6800000000000001D);
        if ((ii == 31) || (ii == 32)) Mig_17.access$334(this.this$0, 0.6800000000000001D);
        if ((ii == 15) || (ii == 16)) Mig_17.access$434(this.this$0, 0.6800000000000001D); 
      }
      ...
      private void $1()
      {
        if (this.this$0.ts) {
          ...
          float f2 = Aircraft.cvt(this.this$0.mn, this.this$0.mn < Mig_17.mteb ? Mig_17.lteb : Mig_17.uteb, this.this$0.mn < Mig_17.mteb ? Mig_17.uteb : Mig_17.lteb, this.this$0.mn < Mig_17.mteb ? this.bhef : this.thef, this.this$0.mn < Mig_17.mteb ? this.thef : this.phef);

          float f3 = Aircraft.cvt(this.this$0.mn, this.this$0.mn < Mig_17.mteb ? Mig_17.lteb : Mig_17.uteb, this.this$0.mn < Mig_17.mteb ? Mig_17.uteb : Mig_17.lteb, this.this$0.mn < Mig_17.mteb ? this.mef : this.wef / f1, this.this$0.mn < Mig_17.mteb ? this.wef / f1 : this.lef / f1);
          ...
          if (f2 > 0.6F) Mig_17.access$1002(this.this$0, true); else {
            Mig_17.access$1002(this.this$0, false);
          }
          if (this.ftl > 0.0F) {
  ...
  public void doSetSootState(int paramInt1, int paramInt2)
  {
    ...
    case 4:
      break;
    case 5:
      this.FM.AS.astateSootEffects[paramInt1][1] = Eff3DActor.New(this, findHook("_Engine" + (paramInt1 + 1) + "EF_01"), null, 3.0F, "3DO/Effects/Aircraft/AfterBurner.eff", -1.0F);
    case 2:
