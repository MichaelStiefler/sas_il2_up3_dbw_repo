  ...
  implements TypeStormovikArmored
{
  ...
  public void moveWheelSink() {
    resetYPRmodifier();
    Aircraft.xyz[2] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.08F, 0.0F, 0.08F);
    hierMesh().chunkSetLocate("GearL9_D0", Aircraft.xyz, Aircraft.ypr);
    Aircraft.xyz[2] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.08F, 0.0F, 0.08F);
  ...
  public void doMurderPilot(int paramInt) {
    ...
    case 1:
      ...
      localVector3d.set(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.Vwld); localWreckage.setSpeed(localVector3d);
    }

    if (paramInt == 1) {
      if (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret == null) return;
      hierMesh().chunkVisible("Pilot2_D0", false);
      hierMesh().chunkVisible("Pilot2_D1", true);
      hierMesh().chunkVisible("Turret1A_D0", false);
      hierMesh().chunkVisible("Turret1B_D0", false);
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx"))
    {
      if (paramString.startsWith("xxarmor")) {
        ...
        if (paramString.startsWith("xxarmorp")) {
          ...
          switch (i) {
          case 1:
            getEnergyPastArmor(7.070000171661377D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot);
            paramShot.powerType = 0;
            break;
          case 2:
          case 3:
            getEnergyPastArmor(5.050000190734863D / (Math.abs(Aircraft.v1.jdField_y_of_type_Double) + 9.999999747378752E-005D), paramShot);
            paramShot.powerType = 0;
          ...
          case 4:
            if (paramPoint3d.jdField_x_of_type_Double > -1.35D) {
              getEnergyPastArmor(5.050000190734863D / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
              paramShot.powerType = 0;
              if ((paramShot.power > 0.0F) || (Math.abs(Aircraft.v1.jdField_x_of_type_Double) <= 0.8659999966621399D)) break;
              doRicochet(paramShot);
            }
            else {
              getEnergyPastArmor(5.050000190734863D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot);
            }
            break;
          case 5:
          case 6:
            getEnergyPastArmor(20.200000762939453D / (Math.abs(Aircraft.v1.jdField_y_of_type_Double) + 9.999999747378752E-005D), paramShot);
        ...
        if (paramString.startsWith("xxarmort1")) {
          getEnergyPastArmor(6.059999942779541D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot);
        }
        return;
      }
      ...
      if (paramString.startsWith("xxspar")) {
        ...
        if ((paramString.startsWith("xxspark")) && 
          (chunkDamageVisible("Keel1") > 1) && (World.Rnd().nextFloat() > Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 0.1000000014901161D) && (getEnergyPastArmor(3.400000095367432D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot) > 0.0F)) {
        ...
        if (paramString.startsWith("xxsparlm")) {
          ...
          else if ((chunkDamageVisible("WingLMid") > 2) && (World.Rnd().nextFloat() > Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 0.119999997317791D) && (getEnergyPastArmor(6.960000038146973D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot) > 0.0F)) {
        ...
        if (paramString.startsWith("xxsparrm")) {
          ...
          else if ((chunkDamageVisible("WingRMid") > 2) && (World.Rnd().nextFloat() > Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 0.119999997317791D) && (getEnergyPastArmor(6.960000038146973D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot) > 0.0F)) {
        ...
        if (paramString.startsWith("xxsparlo")) {
          ...
          else if ((chunkDamageVisible("WingLOut") > 2) && (World.Rnd().nextFloat() > Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 0.119999997317791D) && (getEnergyPastArmor(6.960000038146973D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot) > 0.0F)) {
        ...
        if (paramString.startsWith("xxsparro")) {
          ...
          else if ((chunkDamageVisible("WingROut") > 2) && (World.Rnd().nextFloat() > Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 0.119999997317791D) && (getEnergyPastArmor(6.960000038146973D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot) > 0.0F)) {
        ...
        if ((paramString.startsWith("xxsparsl")) && 
          (chunkDamageVisible("StabL") > 1) && (getEnergyPastArmor(6.5D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot) > 0.0F)) {
        ...
        if ((paramString.startsWith("xxsparsr")) && 
          (chunkDamageVisible("StabR") > 1) && (getEnergyPastArmor(6.5D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot) > 0.0F)) {
          debuggunnery("Spar Construction: StabL Spar Hit, Breaking in Half..");
      ...
      if ((paramString.startsWith("xxbomb")) && 
        (World.Rnd().nextFloat() < 0.00345F) && (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3] != null) && (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][0].haveBullets())) {
    ...
    {
      if (paramPoint3d.jdField_z_of_type_Double > 0.473D) {
    ...
    if (paramString.startsWith("xcf")) {
      if (paramPoint3d.jdField_x_of_type_Double < -1.94D) {
        if (chunkDamageVisible("Tail1") < 3)
          hitChunk("Tail1", paramShot);
      }
      else {
        if (paramPoint3d.jdField_x_of_type_Double <= 1.342D)
        {
          if ((paramPoint3d.jdField_z_of_type_Double < -0.591D) || ((paramPoint3d.jdField_z_of_type_Double > 0.4079999923706055D) && (paramPoint3d.jdField_x_of_type_Double > 0.0D))) {
            getEnergyPastArmor(5.050000190734863D / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
      ...
      if (paramPoint3d.jdField_z_of_type_Double < -0.981D) {
        getEnergyPastArmor(5.050000190734863D / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
        if (paramShot.power <= 0.0F)
          doRicochet(paramShot);
      }
      else if ((paramPoint3d.jdField_x_of_type_Double > 0.537D) || (paramPoint3d.jdField_x_of_type_Double < -0.1D))
      {
        getEnergyPastArmor(0.2000000029802322D / (Math.abs(Aircraft.v1.jdField_x_of_type_Double) + 9.999999747378752E-005D), paramShot);
        if (paramShot.power <= 0.0F)
          doRicochetBack(paramShot);
      }
      else {
      ...
      if (paramPoint3d.jdField_z_of_type_Double > 0.159D)
        getEnergyPastArmor(1.25F * World.Rnd().nextFloat(0.95F, 1.12F) / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
      else if ((paramPoint3d.jdField_x_of_type_Double > 1.335D) && (paramPoint3d.jdField_x_of_type_Double < 2.386D) && (paramPoint3d.jdField_z_of_type_Double > -0.06D) && (paramPoint3d.jdField_z_of_type_Double < 0.064D))
        getEnergyPastArmor(0.5D / (Math.abs(Aircraft.v1.jdField_y_of_type_Double) + 9.999999747378752E-005D), paramShot);
      else if ((paramPoint3d.jdField_x_of_type_Double > 2.53D) && (paramPoint3d.jdField_x_of_type_Double < 2.992D) && (paramPoint3d.jdField_z_of_type_Double > -0.235D) && (paramPoint3d.jdField_z_of_type_Double < 0.011D))
        getEnergyPastArmor(4.039999961853027D / (Math.abs(Aircraft.v1.jdField_y_of_type_Double) + 9.999999747378752E-005D), paramShot);
      else if ((paramPoint3d.jdField_x_of_type_Double > 2.559D) && (paramPoint3d.jdField_z_of_type_Double < -0.595D))
        getEnergyPastArmor(4.039999961853027D / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
      else if ((paramPoint3d.jdField_x_of_type_Double > 1.849D) && (paramPoint3d.jdField_x_of_type_Double < 2.251D) && (paramPoint3d.jdField_z_of_type_Double < -0.71D))
        getEnergyPastArmor(4.039999961853027D / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
      else if (paramPoint3d.jdField_x_of_type_Double > 3.003D)
        getEnergyPastArmor(World.Rnd().nextFloat(2.3F, 3.2F), paramShot);
      else if (paramPoint3d.jdField_z_of_type_Double < -0.6060000061988831D)
        getEnergyPastArmor(5.050000190734863D / (Math.abs(Aircraft.v1.jdField_z_of_type_Double) + 9.999999747378752E-005D), paramShot);
      else {
        getEnergyPastArmor(5.050000190734863D / (Math.abs(Aircraft.v1.jdField_y_of_type_Double) + 9.999999747378752E-005D), paramShot);
      }
