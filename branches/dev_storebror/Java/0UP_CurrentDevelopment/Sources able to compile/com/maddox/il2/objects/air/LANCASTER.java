    ...
    implements TypeTransport, TypeBomber
{
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("case"))
                {
                    ...
                    } else
                    {
                        ...
                        Aircraft.debugprintln(this, "*** Engine (" + l + ") Crank Case Hit - Readyness Reduced to " + ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[l].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[l].getCylindersRatio() * 0.75F)
                    {
                        ...
                        Aircraft.debugprintln(this, "*** Engine (" + l + ") Cylinders Hit, " + ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[l].getCylindersOperable() + "/" + ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[l].getCylinders() + " Left..");
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        {
            if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).x > 4.5500001907348633D && ((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).x < 7.1500000953674316D && ((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > 0.57999998331069946D)
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.233F)
                    if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > 1.2100000381469727D)
                    {
            ...
            if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).x > 9.5299997329711914D && ((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z < 0.14000000059604645D && ((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > -0.62999999523162842D)
                ((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.hitPilot(shot.initiator, 2, (int)(shot.power * 0.002F));
            if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).x > 2.4749999046325684D && ((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).x < 4.4899997711181641D && ((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > 0.61000001430511475D && (double)shot.power * java.lang.Math.sqrt(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).y * ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).y + ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z * ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z) > 11900D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.45F)
            {
                for(int i = 0; i < 4; i++)
        ...
        {
            if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > 0.033449999988079071D)
            {
        ...
        {
            if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > 0.30445000529289246D)
            {
        ...
        {
            if(((com.maddox.JGP.Tuple3d) (Aircraft.Pd)).z > -0.99540001153945923D)
            {
    ...
    static 
    {
        java.lang.Class class1 = LANCASTER.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "Lancaster");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/Lancaster/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Lancaster.fmd");
        ...
        Aircraft.weaponsRegister(class1, "16x250", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "24x250", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "12x500", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "6x1000", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "1x4000", new java.lang.String[] {
            "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", null, null, 
            null, null, "BombGunHC4000 1", null, null, null
        });
        Aircraft.weaponsRegister(class1, "1x12000", new java.lang.String[] {
            "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", "MGunBrowning303t 2000", null, null, 
            null, null, "BombGun12000Tallboy 1", null, null, null
        });
        Aircraft.weaponsRegister(class1, "PathfinderRed", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "PathfinderGreen", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "PathfinderYellow", new java.lang.String[] {
