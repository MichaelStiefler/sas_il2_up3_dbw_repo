...
public class CockpitIL_2_1942 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitIL_2_1942.this.setNew.throttle = ((10.0F * CockpitIL_2_1942.this.setOld.throttle + CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        if (CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Gears.isHydroOperable()) CockpitIL_2_1942.this.setNew.undercarriage = ((10.0F * CockpitIL_2_1942.this.setOld.undercarriage + CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl) / 11.0F);
        CockpitIL_2_1942.this.setNew.flaps = ((10.0F * CockpitIL_2_1942.this.setOld.flaps + (CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.FlapsControl > 0.0F ? 0.0F : 1.0F)) / 11.0F);

        CockpitIL_2_1942.this.setNew.altimeter = CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitIL_2_1942.this.setNew.azimuth = ((35.0F * CockpitIL_2_1942.this.setOld.azimuth + CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        ...
        CockpitIL_2_1942.this.setNew.vspeed = ((199.0F * CockpitIL_2_1942.this.setOld.vspeed + CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);

        if (CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.saveWeaponControl[2] != 0) {
        ...
        if (CockpitIL_2_1942.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.saveWeaponControl[3] != 0) {
