...
// Source File Name:   CockpitG4M1_11_Bombardier.java
...
//            CockpitPilot, G4M, Aircraft

public class CockpitG4M1_11_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.G4M)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitG4M1_11_Bombardier.class, "astatePilotIndx", 0);
    }
