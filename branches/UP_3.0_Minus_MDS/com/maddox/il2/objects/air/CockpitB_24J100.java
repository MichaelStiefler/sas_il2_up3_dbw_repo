...
public class CockpitB_24J100 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_FuelPres3", 0.0F, cvt(fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        mesh.chunkSetAngles("Z_FuelPres4", 0.0F, cvt(fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
    ...
    public void reflectCockpitState()
    {
        ...
        if((fm.AS.astateCockpitState & 0x40) != 0)
        {
            ...
            mesh.chunkVisible("Z_FuelPres3", false);
            mesh.chunkVisible("Z_FuelPres4", false);
            mesh.chunkVisible("Z_Oilpres1", false);
            mesh.chunkVisible("Z_Oilpres2", false);
            mesh.chunkVisible("Z_Oilpres3", false);
            mesh.chunkVisible("Z_Oilpres4", false);
