...
public abstract class AR_196T extends Scheme1
    implements TypeScout, TypeStormovik
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p2"))
                    getEnergyPastArmor(5.25D / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).y) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p3"))
                    getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(5F, 10F), shot);
                return;
    ...
    static 
    {
        java.lang.Class class1 = AR_196T.class;
