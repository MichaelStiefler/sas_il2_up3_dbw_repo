...
public abstract class G4M extends com.maddox.il2.objects.air.Scheme2
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.G4M.cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.G4M.cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, -90F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.G4M.cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.G4M.cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
    }
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.G4M.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.2375F, 0.0F, 0.2375F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.G4M.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.2375F, 0.0F, 0.2375F);
    ...
    public boolean turretAngles(int i, float af[])
    {
        ...
        case 2: // '\002'
            ...
            if(f1 > com.maddox.il2.objects.air.G4M.cvt(java.lang.Math.abs(f), 0.0F, 50F, 40F, 25F))
                f1 = com.maddox.il2.objects.air.G4M.cvt(java.lang.Math.abs(f), 0.0F, 50F, 40F, 25F);
            if(f1 < com.maddox.il2.objects.air.G4M.cvt(java.lang.Math.abs(f), 0.0F, 50F, -10F, -3.5F))
                f1 = com.maddox.il2.objects.air.G4M.cvt(java.lang.Math.abs(f), 0.0F, 50F, -10F, -3.5F);
            break;
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                if(s.startsWith("xxpark") && chunkDamageVisible("Keel1") > 1 && getEnergyPastArmor(10.699999809265137D / (1.0001000165939331D - java.lang.Math.abs(v1.y)), shot) > 0.0F)
                {
                ...
                if(s.startsWith("xxparlm") && chunkDamageVisible("WingLMid") > 2 && getEnergyPastArmor(10.800000190734863D / (1.0001000165939331D - java.lang.Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if(s.startsWith("xxparrm") && chunkDamageVisible("WingRMid") > 2 && getEnergyPastArmor(10.800000190734863D / (1.0001000165939331D - java.lang.Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingRMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if(s.startsWith("xxparlo") && chunkDamageVisible("WingLOut") > 2 && getEnergyPastArmor(8.8000001907348633D / (1.0001000165939331D - java.lang.Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLOut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if(s.startsWith("xxparro") && chunkDamageVisible("WingROut") > 2 && getEnergyPastArmor(8.8000001907348633D / (1.0001000165939331D - java.lang.Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingROut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if(s.startsWith("xxparrs") && chunkDamageVisible("StabL") > 1 && getEnergyPastArmor(8.8000001907348633D / (1.0001000165939331D - java.lang.Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** StabL Spars Damaged..");
                    nextDMGLevels(1, 2, "StabL_D2", shot.initiator);
                }
                if(s.startsWith("xxparls") && chunkDamageVisible("StabR") > 1 && getEnergyPastArmor(8.8000001907348633D / (1.0001000165939331D - java.lang.Math.abs(v1.y)), shot) > 0.0F)
                {
