// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 20/01/2011 10:23:26 AM
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   CockpitMB339_RGunner.java
...
//            CockpitGunner, MB339, Aircraft, Cockpit

public class CockpitMB339_RGunner extends CockpitGunner
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f = ((MB339)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitMB339_RGunner.k14TargetWingspanScale[((MB339)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitMB339_RGunner.k14TargetMarkScale[((MB339)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((MB339)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, CockpitMB339_RGunner.k14BulletDrop) - CockpitMB339_RGunner.k14BulletDrop[0];
    ...
    protected boolean doFocusEnter()
    {
        ...
        {
            aircraft().hierMesh().chunkVisible("Internal_D0", false);
            return true;
        } else
        {
            return false;
    ...
    {
        aircraft().hierMesh().chunkVisible("Internal_D0", true);
        super.doFocusLeave();
    }
    ...
    public CockpitMB339_RGunner()
    {
        super("3DO/Cockpit/YP-80/339hier.him", "bf109");
        pictBall = 0.0D;
        oldBallTime = 0L;
    ...
    protected float getBall(double d)
    {
        ...
        {
            double d2 = Math.toDegrees(Math.atan2(fm.getBallAccel().y, -fm.getBallAccel().z));
            if(d2 > 20D)
                d2 = 20D;
            else
            if(d2 < -20D)
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitMB339_RGunner.class, "aiTuretNum", 0);
        Property.set(com.maddox.il2.objects.air.CockpitMB339_RGunner.class, "weaponControlNum", 10);
        Property.set(com.maddox.il2.objects.air.CockpitMB339_RGunner.class, "astatePilotIndx", 1);
    }
