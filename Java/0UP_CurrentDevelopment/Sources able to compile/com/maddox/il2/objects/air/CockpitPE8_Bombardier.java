...
public class CockpitPE8_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((PE_8)aircraft()).fSightCurForwardAngle;
                float f1 = -((PE_8)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((PE_8)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((PE_8)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
