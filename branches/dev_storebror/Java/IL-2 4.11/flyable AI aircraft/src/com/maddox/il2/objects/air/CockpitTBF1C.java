// Source File Name: CockpitTBF1C.java
...
public class CockpitTBF1C extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitTBF1C.this.fm != null) {
				CockpitTBF1C.this.setTmp = CockpitTBF1C.this.setOld;
				CockpitTBF1C.this.setOld = CockpitTBF1C.this.setNew;
				CockpitTBF1C.this.setNew = CockpitTBF1C.this.setTmp;
				CockpitTBF1C.this.setNew.throttle = ((10F * CockpitTBF1C.this.setOld.throttle) + CockpitTBF1C.this.fm.CT.PowerControl) / 11F;
				CockpitTBF1C.this.setNew.altimeter = CockpitTBF1C.this.fm
						.getAltitude();
				if (Math.abs(CockpitTBF1C.this.fm.Or.getKren()) < 30F) {
					CockpitTBF1C.this.setNew.azimuth = ((35F * CockpitTBF1C.this.setOld.azimuth) + -CockpitTBF1C.this.fm.Or
							.getYaw()) / 36F;
				}
				if ((CockpitTBF1C.this.setOld.azimuth > 270F)
						&& (CockpitTBF1C.this.setNew.azimuth < 90F)) {
					CockpitTBF1C.this.setOld.azimuth -= 360F;
				}
				if ((CockpitTBF1C.this.setOld.azimuth < 90F)
						&& (CockpitTBF1C.this.setNew.azimuth > 270F)) {
					CockpitTBF1C.this.setOld.azimuth += 360F;
				}
				CockpitTBF1C.this.setNew.waypointAzimuth = ((10F * CockpitTBF1C.this.setOld.waypointAzimuth)
						+ (CockpitTBF1C.this.waypointAzimuth() - CockpitTBF1C.this.setOld.azimuth) + World
						.Rnd().nextFloat(-30F, 30F)) / 11F;
				CockpitTBF1C.this.setNew.vspeed = ((199F * CockpitTBF1C.this.setOld.vspeed) + CockpitTBF1C.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public CockpitTBF1C() {
		super("3DO/Cockpit/F2A-1/CockpitTBF1C.him", "bf109");
