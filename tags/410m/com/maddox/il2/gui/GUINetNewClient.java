...
// Source File Name:   GUINetNewClient.java
...
//            GUIButton, GUIDialogClient, GUISeparate, GUI, 
//            GUIChatDialog

public class GUINetNewClient extends com.maddox.il2.game.GameState
    implements com.maddox.il2.net.NetChannelListener, com.maddox.rts.MsgNetExtListener
{
    ...
    public class DialogClient extends com.maddox.il2.gui.GUIDialogClient
    {
            ...
            if(gwindow == bSearch)
            {
                if(!bExistSearch)
                {
                    ...
                    if(com.maddox.rts.NetEnv.socketsBlock().size() + com.maddox.rts.NetEnv.socketsNoBlock().size() <= 0)
                        return true;
                    if(com.maddox.il2.gui.GUINetNewClient.broadcastAdr == null)
                        try
                        {
        ...
        public void setPosSize()
        {
            ...
            if(bExistSearch)
            {
                ...
                wZutiServersList.setPosSize(x1024(352F), y1024(304F), x1024(256F), y1024(32F));
                bJoin.setPosC(x1024(904F), y1024(424F));
                bExit.setPosC(x1024(56F), y1024(424F));
            } else
            {
                bSearch.setPosC(x1024(56F), y1024(56F));
                wZutiServersList.setPosSize(x1024(144F), y1024(144F), x1024(256F), y1024(32F));
    ...
    public class Table extends com.maddox.gwindow.GWindowTable
    {
        ...
        public void renderCell(int i, int j, boolean flag, float f, float f1)
        {
            ...
            com.maddox.il2.gui.Item item = (com.maddox.il2.gui.Item)serverMap.get(s);
    ...
    public void _enter()
    {
        ...
        if(com.maddox.il2.net.USGS.isUsed() || com.maddox.il2.game.Main.cur().netGameSpy != null)
            new com.maddox.rts.MsgAction(64, com.maddox.rts.Time.real() + 500L) {
...
;
    ...
    public void _leave()
    {
        ...
        if(bExistSearch)
            com.maddox.rts.MsgRemoveListener.post(64, com.maddox.rts.NetEnv.cur(), this, null);
    }
...
;
    ...
    public void netChannelRequest(java.lang.String s)
    {
        ...
        if(com.maddox.il2.net.USGS.isUsed() && "NM".equals(s1))
            ((com.maddox.rts.NetControl)com.maddox.rts.NetEnv.cur().control).doAnswer("NM \"" + com.maddox.rts.NetEnv.host().shortName() + '"');
    }
    ...
    {
        if(!bExistSearch || com.maddox.il2.game.Main.state() != this)
            return;
        if(com.maddox.rts.NetEnv.socketsBlock().size() + com.maddox.rts.NetEnv.socketsNoBlock().size() <= 0)
        {
            java.lang.String s = "socket udp CREATE LOCALPORT " + com.maddox.il2.engine.Config.cur.netLocalPort;
    ...
    public void doJoin()
    {
        ...
        com.maddox.il2.engine.Config.cur.zutiAddServerName(wZutiServersList.getValue());
        doStartWaitDlg();
    }
...
;
    ...
    public GUINetNewClient(com.maddox.gwindow.GWindowRoot gwindowroot)
    {
        ...
        wZutiServersList.list = com.maddox.il2.engine.Config.cur.zutiGetServerNames();
    ...
    com.maddox.gwindow.GWindowComboControl wZutiServersList;
