...
public abstract class B6N extends com.maddox.il2.objects.air.Scheme1
{
    ...
    {
        hiermesh.chunkSetAngles("WingLMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, -135F), 0.0F);
        hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, -135F), 0.0F);
    }
    ...
    {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 0.7F, 0.0F, -83.5F), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 0.15F, 0.0F, -88F), 0.0F);
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 0.7F, 0.0F, -56F), 0.0F);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.1F, 0.7F, 0.0F, -180F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.9F, 0.0F, -83.5F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.35F, 0.0F, -88F), 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.9F, 0.0F, -56F), 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.9F, 0.0F, -180F), 0.0F);
    }
    ...
    public void update(float f)
    {
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Aircraft.xyz[0] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.0F, 0.15F, 0.43105F, 0.0F);
        com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.0F, 0.15F, 0.396F, 0.0F);
        com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.0F, 0.15F, -0.7906F, 0.0F);
        hierMesh().chunkSetLocate("Gun_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        hierMesh().chunkSetAngles("Blister4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.25F, 0.35F, -30F, 0.0F), 0.0F);
        hierMesh().chunkSetAngles("Blister5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.25F, 0.35F, -180F, 0.0F), 0.0F);
        hierMesh().chunkSetAngles("Blister3_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.4F, 0.5F, -32F, 0.0F), 0.0F);
        hierMesh().chunkSetAngles("Blister6_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.4F, 0.5F, -40F, 0.0F), 0.0F);
        if(FM.AS.astatePilotStates[2] < 90)
        {
            hierMesh().chunkVisible("Pilot4_D0", curTopGunnerPosition <= 0.75F);
            resetYPRmodifier();
            com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.5F, 0.75F, 0.0F, -0.45715F);
            com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.5F, 0.75F, 0.0F, 0.239F);
            com.maddox.il2.objects.air.Aircraft.ypr[2] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.5F, 0.75F, 0.0F, -40F);
            hierMesh().chunkSetLocate("Pilot4_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        }
        if(FM.AS.astatePilotStates[2] < 90)
        {
            hierMesh().chunkVisible("Pilot3_D0", curTopGunnerPosition > 0.75F);
            resetYPRmodifier();
            com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.75F, 1.0F, 0.0443F, 0.0F);
            com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.75F, 1.0F, -0.1485F, 0.0F);
            com.maddox.il2.objects.air.Aircraft.ypr[2] = com.maddox.il2.objects.air.Aircraft.cvt(curTopGunnerPosition, 0.75F, 1.0F, -45F, 0.0F);
            hierMesh().chunkSetLocate("Pilot3_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        }
        if(FM.Gears.arrestorVAngle != 0.0F)
        {
            float f1 = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.arrestorVAngle, -51F, 5F, 1.0F, 0.0F);
