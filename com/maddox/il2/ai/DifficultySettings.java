...
public class DifficultySettings
{
    ...
    public void set(int i)
    {
        ...
        Reliability = (i & 0x2000000) != 0;
        G_Limits = (i & 0x4000000) != 0;
        RealisticPilotVulnerability = (i & 0x8000000) != 0;
        RealisticNavigationInstruments = (i & 0x10000000) != 0;
        No_Player_Icon = (i & 0x20000000) != 0;
        No_Fog_Of_War_Icons = (i & 0x40000000) != 0;
    }
    ...
    public int get()
    {
        ...
        if(G_Limits)
            i |= 0x4000000;
        if(RealisticPilotVulnerability)
            i |= 0x8000000;
        if(RealisticNavigationInstruments)
            i |= 0x10000000;
        if(No_Player_Icon)
            i |= 0x20000000;
        if(No_Fog_Of_War_Icons)
            i |= 0x40000000;
        return i;
    }
    ...
    public static final int REALISTIC_MASK = java.lang.Integer.parseInt("1111111111111111111111111111111", 2);
    public static final int EASY_MASK = java.lang.Integer.parseInt("1000001000000101000000000000000", 2);
    public static final int NORMAL_MASK = java.lang.Integer.parseInt("0001111100101101111110011111111", 2);
