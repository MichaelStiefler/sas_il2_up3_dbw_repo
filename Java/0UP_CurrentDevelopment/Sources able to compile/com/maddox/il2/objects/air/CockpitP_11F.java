...
public class CockpitP_11F extends CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            P_11F p_11f = (P_11F)aircraft();
            if(P_11F.bChangedPit)
            {
                reflectPlaneToModel();
                P_11F p_11f1 = (P_11F)aircraft();
                P_11F.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        Cockpit.xyz[0] = cvt(fm.Or.getTangage(), -20F, 20F, 0.0385F, -0.0385F);
        mesh.chunkSetLocate("zPitch", Cockpit.xyz, Cockpit.ypr);
