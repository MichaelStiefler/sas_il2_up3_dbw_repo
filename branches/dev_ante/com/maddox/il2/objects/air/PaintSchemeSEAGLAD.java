...
public class PaintSchemeSEAGLAD extends PaintScheme
{
  ...
  public void prepareNum(Class paramClass, HierMesh paramHierMesh, Regiment paramRegiment, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    else
    {
      ...
      if (paramRegiment.country() == PaintScheme.countryBritain) {
        if (("ra".equals(paramRegiment.branch())) || ("rz".equals(paramRegiment.branch())))
        {
          paramInt3 = clampToLiteral(paramInt3);
          ...
          paramInt3 = clampToLiteral(paramInt3);
          changeMat(paramHierMesh, "Overlay2", "psSEAGLADBRILNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "British/" + (char)(65 + paramInt3 - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 1.0F, 1.0F, 1.0F);

          changeMat(paramHierMesh, "Overlay3", "psSEAGLADBRIRNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "null.tga", "British/" + (char)(65 + paramInt3 - 1) + ".tga", 1.0F, 1.0F, 1.0F, 0.1F, 0.1F, 0.1F);

          if (paramClass.isAssignableFrom(SEAGLADIATOR2.class))
          {
        ...
        if ("rn".equals(paramRegiment.branch())) {
          paramInt3 = clampToLiteral(paramInt3);
          changeMat(paramHierMesh, "Overlay2", "psSEAGLADBRINAVYLNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "British/" + (char)(65 + paramInt3 - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 1.0F, 1.0F, 1.0F);

          changeMat(paramHierMesh, "Overlay3", "psSEAGLADBRINAVYRNUM" + i + paramInt1 + (paramInt3 < 10 ? "0" + paramInt3 : new StringBuffer().append("").append(paramInt3).toString()), "null.tga", "British/" + (char)(65 + paramInt3 - 1) + ".tga", 1.0F, 1.0F, 1.0F, 0.1F, 0.1F, 0.1F);
