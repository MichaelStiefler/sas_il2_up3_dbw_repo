...
public class CockpitMC_202 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMC_202.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitMC_202.this.setNew.throttle = (0.85F * CockpitMC_202.this.setOld.throttle + CockpitMC_202.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitMC_202.this.setNew.prop = (0.85F * CockpitMC_202.this.setOld.prop + CockpitMC_202.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitMC_202.this.setNew.altimeter = CockpitMC_202.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        ...
        CockpitMC_202.this.setNew.azimuth.setDeg(CockpitMC_202.this.setOld.azimuth.getDeg(1.0F), CockpitMC_202.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitMC_202.this.setNew.vspeed = ((199.0F * CockpitMC_202.this.setOld.vspeed + CockpitMC_202.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
