...
public class Landscape
{
        ...
        throws java.lang.Exception
    {
        ...
        bNoWater = "WINTER".equals(config.camouflage);
        com.maddox.il2.ai.World.Sun().setAstronomic(config.declin, config.month, 15, com.maddox.il2.ai.World.getTimeofDay());
        if(com.maddox.il2.engine.Config.isUSE_RENDER())
            com.maddox.il2.engine.Landscape.setAstronomic(config.declin, config.month, 15, com.maddox.il2.ai.World.getTimeofDay(), com.maddox.il2.ai.World.Sun().MoonPhase);
        if(!com.maddox.il2.engine.Landscape.cLoadMap(s, ai, i, flag))
    ...
    public void preRender(float f, boolean flag)
    {
        ...
        {
            sun.setAstronomic(config.declin, config.month, 15, com.maddox.il2.ai.World.getTimeofDay());
            com.maddox.il2.engine.Landscape.setAstronomic(config.declin, config.month, 15, com.maddox.il2.ai.World.getTimeofDay(), sun.MoonPhase);
        }
        ...
        com.maddox.il2.engine.Landscape.cPreRender(f, flag, _sunmoon);
    }
