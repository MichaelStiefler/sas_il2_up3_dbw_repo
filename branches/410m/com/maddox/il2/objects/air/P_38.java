    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeStormovik
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC8_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(f, 0.01F, 0.11F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, -80F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL7_D0", 0.0F, -40F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL8_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(f, 0.01F, 0.11F, 0.0F, -80F), 0.0F);
        hiermesh.chunkSetAngles("GearL9_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(f, 0.01F, 0.11F, 0.0F, -80F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, -80F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR7_D0", 0.0F, -40F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR8_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(f, 0.01F, 0.11F, 0.0F, -80F), 0.0F);
        hiermesh.chunkSetAngles("GearR9_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(f, 0.01F, 0.11F, 0.0F, -80F), 0.0F);
    ...
    {
        steera = 0.9F * steera + 0.1F * com.maddox.il2.objects.air.P_38.cvt(f, -50F, 50F, 50F, -50F);
        moveWheelSink();
    }
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.24F, 0.0F, 0.2406F);
        ypr[1] = steera;
        hierMesh().chunkSetLocate("GearC3_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.24F, 0.0F, -50F), 0.0F);
        hierMesh().chunkSetAngles("GearC5_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.24F, 0.0F, -105F), 0.0F);
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -0.3206F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -60F), 0.0F);
        hierMesh().chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -117.5F), 0.0F);
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, 0.3206F);
        hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -60F), 0.0F);
        hierMesh().chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.P_38.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -117.5F), 0.0F);
    }
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                if(s.endsWith("1"))
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Armor Glass: Hit..");
                    if(shot.power <= 0.0F)
                    {
                        com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
                ...
                if(s.endsWith("3"))
                    getEnergyPastArmor(12.7F / (1E-005F + (float)java.lang.Math.abs(v1.x)), shot);
                if(s.endsWith("4"))
                    getEnergyPastArmor(8.9F / (1E-005F + (float)java.lang.Math.abs(v1.x)), shot);
                if(s.endsWith("5"))
                    getEnergyPastArmor(8.9F / (1E-005F + (float)java.lang.Math.abs(v1.z)), shot);
                return;
            }
            if(s.startsWith("xxarcon"))
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.1F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Ailerones Controls Out..");
                }
                return;
            }
            if(s.startsWith("xxvatcon"))
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.1F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Elevators Controls Out..");
                }
                return;
            }
            if(s.startsWith("xxrudcon"))
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.1F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Rudder Controls Out..");
                }
                return;
            }
            if(s.startsWith("xxeng1"))
            {
                if(getEnergyPastArmor(4.45F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 0.75F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine 0 Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                    ...
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                    {
                        ...
                        com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine 0 Cylinders Hit - Engine Fires..");
                    }
            ...
            if(s.startsWith("xxeng2"))
            {
                if(getEnergyPastArmor(4.45F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[1].getCylindersRatio() * 0.75F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine 1 Cylinders Hit, " + FM.EI.engines[1].getCylindersOperable() + "/" + FM.EI.engines[1].getCylinders() + " Left..");
                    ...
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                    {
                        ...
                        com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine 1 Cylinders Hit - Engine Fires..");
                    }
                    getEnergyPastArmor(25F, shot);
                }
                return;
            ...
            if(s.startsWith("xxoilradiat1"))
            {
                if(getEnergyPastArmor(0.45F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine Module 0: Oil Radiator Hit..");
                }
                return;
            }
            if(s.startsWith("xxoilradiat2"))
            {
                if(getEnergyPastArmor(0.45F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine Module 1: Oil Radiator Hit..");
                }
                return;
            }
            ...
            if(s.startsWith("xxmagneto1"))
            {
                ...
                com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine Module 0: Magneto " + i + " Destroyed..");
                return;
            }
            if(s.startsWith("xxmagneto2"))
            {
                ...
                com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine Module 1: Magneto " + j + " Destroyed..");
                return;
            }
            if(s.startsWith("xxturbo1"))
            {
                if(getEnergyPastArmor(1.23F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine Module 0: Supercharger Destroyed..");
                }
                return;
            }
            if(s.startsWith("xxturbo2"))
            {
                if(getEnergyPastArmor(1.23F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Engine Module 1: Supercharger Destroyed..");
                }
                return;
            }
            ...
            {
                com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Keel1 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Keel2 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Stab Spars Damaged..");
            ...
            {
                com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Lock Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Rudder1 Lock Shot Off..");
                ...
                {
                    com.maddox.il2.objects.air.P_38.debugprintln(this, "*** Rudder2 Lock Shot Off..");
