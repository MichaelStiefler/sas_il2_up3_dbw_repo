...
public class CockpitYAK_3R extends CockpitPilot
{
  ...
  {
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zKerosin", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.nitro, 0.0F, 250.0F, 0.0F, -270.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAzotKislota", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.nitro, 0.0F, 250.0F, 0.0F, -270.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zPVRD_Temp", 0.0F, cvt(this.setNew.preved, 0.0F, 900.0F, 0.0F, -118.0F), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("SW_PVRD", 0.0F, this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getStage() > 0 ? -45.0F : 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_Red2", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getRPM() < 650.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitYAK_3R.access$102(CockpitYAK_3R.this, CockpitYAK_3R.this.setOld); CockpitYAK_3R.access$202(CockpitYAK_3R.this, CockpitYAK_3R.this.setNew); CockpitYAK_3R.access$302(CockpitYAK_3R.this, CockpitYAK_3R.this.setTmp);

        CockpitYAK_3R.this.setNew.throttle = ((10.0F * CockpitYAK_3R.this.setOld.throttle + CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_3R.this.setNew.prop = ((10.0F * CockpitYAK_3R.this.setOld.prop + CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_3R.this.setNew.altimeter = CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_3R.this.setNew.azimuth = ((35.0F * CockpitYAK_3R.this.setOld.azimuth + CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitYAK_3R.this.setOld.azimuth > 270.0F) && (CockpitYAK_3R.this.setNew.azimuth < 90.0F)) CockpitYAK_3R.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_3R.this.setOld.azimuth < 90.0F) && (CockpitYAK_3R.this.setNew.azimuth > 270.0F)) CockpitYAK_3R.this.setOld.azimuth += 360.0F;
        CockpitYAK_3R.this.setNew.vspeed = ((199.0F * CockpitYAK_3R.this.setOld.vspeed + CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        CockpitYAK_3R.this.setNew.preved = (0.99F * CockpitYAK_3R.this.setOld.preved + 0.01F * (CockpitYAK_3R.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getStage() == 6 ? 800.0F : 55.0F));
      }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float preved;
    private final CockpitYAK_3R this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitYAK_3R.1 arg2) { this();
    }
  }
}