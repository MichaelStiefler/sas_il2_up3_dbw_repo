...
// Source File Name:   CockpitKI_43_IIKAI.java
...
public class CockpitKI_43_IIKAI extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bNeedSetUp)
            bNeedSetUp = false;
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.59F);
        ...
        if(fm.CT.saveWeaponControl[0])
            com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.0036F;
        mesh.chunkSetLocate("Z_Trigger1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.0F;
        if(fm.CT.saveWeaponControl[1])
            com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.00675F;
        mesh.chunkSetLocate("Z_Trigger2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        ...
        mesh.chunkSetAngles("Z_RPM1", cvt(fm.EI.engines[0].getRPM(), 0.0F, 3200F, 0.0F, 360F), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Fuel4", cvt(fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 1.0F, 0.0F, -330F), 0.0F, 0.0F);
