...
public class CockpitRWD_8 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("lever", 30F - 57F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
        mesh.chunkSetAngles("Prop", interp(setNew.prop, setOld.prop, f) * -57F + 30F, 0.0F, 0.0F);
        mesh.chunkSetAngles("lev_tross", -30F + 57F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
