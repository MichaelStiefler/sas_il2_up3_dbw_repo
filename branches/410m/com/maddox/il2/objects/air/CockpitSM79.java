...
public class CockpitSM79 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    {
        return waypointAzimuthInvertMinus(5F);
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(useRealisticNavigationInstruments())
        {
            float f7 = -cvt(setNew.beaconDirection, -55F, 55F, -55F, 55F);
            mesh.chunkSetAngles("Zcourse", 0.0F, f7, 0.0F);
        } else
        {
            float f8 = -cvt(setNew.waypointAzimuth.getDeg(f * 0.1F), -55F, 55F, -55F, 55F);
            mesh.chunkSetAngles("Zcourse", 0.0F, f8, 0.0F);
        }
    }
