	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB17F.this.fm != null) {
				...
				CockpitB17F.this.setNew.throttle1 = (0.85F * CockpitB17F.this.setOld.throttle1)
						+ (CockpitB17F.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitB17F.this.setNew.throttle2 = (0.85F * CockpitB17F.this.setOld.throttle2)
						+ (CockpitB17F.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitB17F.this.setNew.prop1 = (0.85F * CockpitB17F.this.setOld.prop1)
						+ (CockpitB17F.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitB17F.this.setNew.prop2 = (0.85F * CockpitB17F.this.setOld.prop2)
						+ (CockpitB17F.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitB17F.this.setNew.altimeter = CockpitB17F.this.fm
						.getAltitude();
				float f = CockpitB17F.this.waypointAzimuth();
				CockpitB17F.this.setNew.azimuth.setDeg(
						CockpitB17F.this.setOld.azimuth.getDeg(1.0F),
						CockpitB17F.this.fm.Or.azimut());
				CockpitB17F.this.setNew.waypointAzimuth
						.setDeg(CockpitB17F.this.setOld.waypointAzimuth
								.getDeg(1.0F), f);
				CockpitB17F.this.setNew.waypointDeviation.setDeg(
						CockpitB17F.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitB17F.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitB17F.this.setNew.vspeed = ((199F * CockpitB17F.this.setOld.vspeed) + CockpitB17F.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
