// Source File Name: CockpitC47.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitC47.this.fm != null) {
				...
				CockpitC47.this.setNew.throttle1 = (0.85F * CockpitC47.this.setOld.throttle1)
						+ (CockpitC47.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitC47.this.setNew.throttle2 = (0.85F * CockpitC47.this.setOld.throttle2)
						+ (CockpitC47.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitC47.this.setNew.prop1 = (0.85F * CockpitC47.this.setOld.prop1)
						+ (CockpitC47.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitC47.this.setNew.prop2 = (0.85F * CockpitC47.this.setOld.prop2)
						+ (CockpitC47.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitC47.this.setNew.altimeter = CockpitC47.this.fm
						.getAltitude();
				float f = CockpitC47.this.waypointAzimuth();
				CockpitC47.this.setNew.azimuth.setDeg(
						CockpitC47.this.setOld.azimuth.getDeg(1.0F),
						CockpitC47.this.fm.Or.azimut());
				CockpitC47.this.setNew.waypointAzimuth.setDeg(
						CockpitC47.this.setOld.waypointAzimuth.getDeg(1.0F), f);
				CockpitC47.this.setNew.waypointDeviation.setDeg(
						CockpitC47.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitC47.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitC47.this.setNew.vspeed = ((199F * CockpitC47.this.setOld.vspeed) + CockpitC47.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
