...
public class CockpitDB3T extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitDB3T this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitDB3T.this.fm != null) {
        CockpitDB3T.access$102(CockpitDB3T.this, CockpitDB3T.this.setOld);
        CockpitDB3T.access$202(CockpitDB3T.this, CockpitDB3T.this.setNew);
        CockpitDB3T.access$302(CockpitDB3T.this, CockpitDB3T.this.setTmp);
        if (CockpitDB3T.this.fm.CT.Weapons[3] != null) {
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 0)
            CockpitDB3T.this.bBombs[1] = (!CockpitDB3T.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 1)
            CockpitDB3T.this.bBombs[0] = (!CockpitDB3T.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 2)
            CockpitDB3T.this.bBombs[3] = (!CockpitDB3T.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 3)
            CockpitDB3T.this.bBombs[2] = (!CockpitDB3T.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 4)
            CockpitDB3T.this.bBombs[5] = (!CockpitDB3T.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 5)
            CockpitDB3T.this.bBombs[4] = (!CockpitDB3T.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 6) {
            CockpitDB3T.this.bBombs[5] = ((CockpitDB3T.this.bBombs[5] != 0) || (!CockpitDB3T.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 7) {
            CockpitDB3T.this.bBombs[4] = ((CockpitDB3T.this.bBombs[4] != 0) || (!CockpitDB3T.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 8)
            CockpitDB3T.this.bBombs[7] = (!CockpitDB3T.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitDB3T.this.fm.CT.Weapons[3].length > 9)
            CockpitDB3T.this.bBombs[6] = (!CockpitDB3T.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        ...
        CockpitDB3T.this.setNew.vspeed = ((100.0F * CockpitDB3T.this.setOld.vspeed + CockpitDB3T.this.fm.getVertSpeed()) / 101.0F);

        float f = CockpitDB3T.this.waypointAzimuth();
        CockpitDB3T.this.setNew.waypointAzimuth.setDeg(CockpitDB3T.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitDB3T.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitDB3T.this.setNew.waypointDirection.setDeg(CockpitDB3T.this.setOld.waypointDirection.getDeg(1.0F), f);
