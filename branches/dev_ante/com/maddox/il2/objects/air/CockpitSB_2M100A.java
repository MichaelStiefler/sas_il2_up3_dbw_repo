...
public class CockpitSB_2M100A extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitSB_2M100A this$0;
    ...
    Variables(CockpitSB_2M100A.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSB_2M100A.this.fm != null) {
        CockpitSB_2M100A.access$102(CockpitSB_2M100A.this, CockpitSB_2M100A.this.setOld);
        CockpitSB_2M100A.access$202(CockpitSB_2M100A.this, CockpitSB_2M100A.this.setNew);
        CockpitSB_2M100A.access$302(CockpitSB_2M100A.this, CockpitSB_2M100A.this.setTmp);
        if (CockpitSB_2M100A.this.fm.CT.Weapons[3] != null) {
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 0)
            CockpitSB_2M100A.this.bBombs[1] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 1)
            CockpitSB_2M100A.this.bBombs[0] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 2)
            CockpitSB_2M100A.this.bBombs[3] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 3)
            CockpitSB_2M100A.this.bBombs[2] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 4)
            CockpitSB_2M100A.this.bBombs[5] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 5)
            CockpitSB_2M100A.this.bBombs[4] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 6) {
            CockpitSB_2M100A.this.bBombs[5] = ((CockpitSB_2M100A.this.bBombs[5] != 0) || (!CockpitSB_2M100A.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 7) {
            CockpitSB_2M100A.this.bBombs[4] = ((CockpitSB_2M100A.this.bBombs[4] != 0) || (!CockpitSB_2M100A.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 8)
            CockpitSB_2M100A.this.bBombs[7] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 9)
            CockpitSB_2M100A.this.bBombs[6] = (!CockpitSB_2M100A.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        ...
        CockpitSB_2M100A.this.setNew.vspeed = ((100.0F * CockpitSB_2M100A.this.setOld.vspeed + CockpitSB_2M100A.this.fm.getVertSpeed()) / 101.0F);

        float f = CockpitSB_2M100A.this.waypointAzimuth();
        CockpitSB_2M100A.this.setNew.waypointAzimuth.setDeg(CockpitSB_2M100A.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitSB_2M100A.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        ...
        CockpitSB_2M100A.this.setNew.inert = (0.999F * CockpitSB_2M100A.this.setOld.inert + 0.001F * (CockpitSB_2M100A.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
