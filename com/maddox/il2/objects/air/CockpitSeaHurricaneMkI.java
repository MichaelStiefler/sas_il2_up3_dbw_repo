...
public class CockpitSeaHurricaneMkI extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("STRELKA_BOOST", 0.0F, 0.0F, -cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure(), 0.7242097F, 1.620528F, -111.5F, 221.0F));
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitSeaHurricaneMkI.this.bNeedSetUp)
      {
        CockpitSeaHurricaneMkI.this.reflectPlaneMats();
        CockpitSeaHurricaneMkI.access$002(CockpitSeaHurricaneMkI.this, false);
      }
      if (CockpitSeaHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitSeaHurricaneMkI.access$102(CockpitSeaHurricaneMkI.this, CockpitSeaHurricaneMkI.this.setOld);
        CockpitSeaHurricaneMkI.access$202(CockpitSeaHurricaneMkI.this, CockpitSeaHurricaneMkI.this.setNew);
        CockpitSeaHurricaneMkI.access$302(CockpitSeaHurricaneMkI.this, CockpitSeaHurricaneMkI.this.setTmp);
        CockpitSeaHurricaneMkI.this.setNew.throttle = ((10.0F * CockpitSeaHurricaneMkI.this.setOld.throttle + CockpitSeaHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitSeaHurricaneMkI.this.setNew.altimeter = CockpitSeaHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitSeaHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
          CockpitSeaHurricaneMkI.this.setNew.azimuth = ((35.0F * CockpitSeaHurricaneMkI.this.setOld.azimuth + -CockpitSeaHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        if ((CockpitSeaHurricaneMkI.this.setOld.azimuth > 270.0F) && (CockpitSeaHurricaneMkI.this.setNew.azimuth < 90.0F))
          CockpitSeaHurricaneMkI.this.setOld.azimuth -= 360.0F;
        if ((CockpitSeaHurricaneMkI.this.setOld.azimuth < 90.0F) && (CockpitSeaHurricaneMkI.this.setNew.azimuth > 270.0F))
          CockpitSeaHurricaneMkI.this.setOld.azimuth += 360.0F;
        CockpitSeaHurricaneMkI.this.setNew.waypointAzimuth = ((10.0F * CockpitSeaHurricaneMkI.this.setOld.waypointAzimuth + (CockpitSeaHurricaneMkI.this.waypointAzimuth() - CockpitSeaHurricaneMkI.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitSeaHurricaneMkI.this.setNew.vspeed = ((199.0F * CockpitSeaHurricaneMkI.this.setOld.vspeed + CockpitSeaHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitSeaHurricaneMkI this$0;
    ...
    Variables(CockpitSeaHurricaneMkI.1 arg2)
    {
      this();
    }
  }
