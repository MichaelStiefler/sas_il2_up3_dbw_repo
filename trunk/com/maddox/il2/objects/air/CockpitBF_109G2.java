...
public class CockpitBF_109G2 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitBF_109G2.this.setNew.throttle = ((10.0F * CockpitBF_109G2.this.setOld.throttle + CockpitBF_109G2.this.fm.CT.PowerControl) / 11.0F);
      CockpitBF_109G2.this.setNew.mix = ((8.0F * CockpitBF_109G2.this.setOld.mix + CockpitBF_109G2.this.fm.EI.engines[0].getControlMix()) / 9.0F);

      float f = CockpitBF_109G2.this.waypointAzimuth();
      if (CockpitBF_109G2.this.useRealisticNavigationInstruments())
      {
        CockpitBF_109G2.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
        CockpitBF_109G2.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
      }
      else
      {
      ...
      CockpitBF_109G2.this.setNew.turn = ((12.0F * CockpitBF_109G2.this.setOld.turn + CockpitBF_109G2.this.w.z) / 13.0F);
