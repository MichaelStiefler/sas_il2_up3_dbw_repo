...
// Source File Name:   BF_109F3.java
...
//            BF_109, CockpitBF_109F2, PaintSchemeFMPar03, TypeBNZFighter, 
//            Aircraft, Cockpit, NetAircraft

public class BF_109F3 extends com.maddox.il2.objects.air.BF_109
    implements com.maddox.il2.objects.air.TypeBNZFighter
{
                ...
                if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.WeaponControl[i])
                {
                    for(int j = 0; j < 1; j++)
                    {
                        ...
                        if(l < burst_fire[j][1])
                        {
                            burst_fire[j][0]++;
                            burst_fire[j][1] = l;
                            int i1 = java.lang.Math.abs(random.nextInt()) % 5000;
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.BF_109F3.class;
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG17si 500", "MGunMG17si 500", "MGunMGFFki 200"
        });
