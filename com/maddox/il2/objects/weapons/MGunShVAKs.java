...
// Source File Name:   MGunShVAKs.java
...
public class MGunShVAKs extends com.maddox.il2.objects.weapons.MGunAircraftGeneric
{
    ...
    public int nextIndexBulletType()
    {
        ...
        if(i % 4 == 0)
            i = (double)bulletNum <= (double)bullets() * 0.80000000000000004D ? com.maddox.il2.ai.World.Rnd().nextInt(0, 4) * 4 : 16;
        return i;
    }
}
