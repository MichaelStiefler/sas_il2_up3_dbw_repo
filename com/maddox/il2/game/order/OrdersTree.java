...
//            OrderRequest_For_Takeoff, OrderAnyone_Help_Me, OrderGT
...
public class OrdersTree
{
    ...
    public void setFrequency(boolean flag)
    {
        frequency = flag;
    }
    ...
    private void missionLoaded(com.maddox.il2.objects.air.Aircraft aircraft)
    {
        ...
        for(int i1 = 0; i1 < PlayerSquad.wing.length; i1++)
        {
...
, null, new OrderBack()
        ...
        ToGroundControl = new Orders(new com.maddox.il2.game.order.Order[] {
            new Order("GroundControl"), new OrderRequest_Assistance(), new OrderVector_To_Home_Base(), new OrderVector_To_Target(), new OrderRequest_For_Landing(), new OrderRequest_For_Takeoff(), null, new OrderBack()
        });
        Frequency = new Orders(new com.maddox.il2.game.order.Order[] {
            new Order("Frequency"), new com.maddox.il2.game.order.Order("Friendly") {
                ...
                public void preRun()
                {
                    com.maddox.il2.game.order.OrdersTree.curOrdersTree.frequency = true;
                }
...
, new com.maddox.il2.game.order.Order("Enemy") {
                ...
                public void preRun()
                {
                    com.maddox.il2.game.order.OrdersTree.curOrdersTree.frequency = false;
                }
