...
public abstract class Halifax extends com.maddox.il2.objects.air.Scheme4
    implements com.maddox.il2.objects.air.TypeTransport
{
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxammo"))
            {
                ...
                if(getEnergyPastArmor(6.87F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.05F)
                {
                    ...
                    FM.AS.setJamBullets(i, ((int) (byte0)));
                    return;
                }
            }
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("mag2"))
                {
                    ...
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + k + ") Module: Magneto #1 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
        ...
        if(!s.startsWith("xturret"))
            if(s.startsWith("xmgun"))
            {
                ...
                if(getEnergyPastArmor(6.45F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.35F)
                {
                    ...
                    FM.AS.setJamBullets(j1, ((int) (byte0)));
                }
            } else
    ...
    {
        com.maddox.il2.objects.air.Halifax.moveGear(hierMesh(), f);
    }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.Halifax.class;
