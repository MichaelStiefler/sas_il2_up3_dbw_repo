...
public class CockpitHalifaxBMkIII_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((HalifaxBMkIII)aircraft()).fSightCurForwardAngle;
            float f1 = ((HalifaxBMkIII)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((HalifaxBMkIII)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((HalifaxBMkIII)aircraft()).fSightCurReadyness > 0.93F;
