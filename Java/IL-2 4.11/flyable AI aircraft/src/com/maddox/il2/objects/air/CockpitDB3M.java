// Source File Name: CockpitDB3M.java
			...
			if (CockpitDB3M.this.fm != null) {
				...
				if (CockpitDB3M.this.fm.CT.Weapons[3] != null) {
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 0) {
						CockpitDB3M.this.bBombs[1] = !CockpitDB3M.this.fm.CT.Weapons[3][0]
								.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 1) {
						CockpitDB3M.this.bBombs[0] = !CockpitDB3M.this.fm.CT.Weapons[3][1]
								.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 2) {
						CockpitDB3M.this.bBombs[3] = !CockpitDB3M.this.fm.CT.Weapons[3][2]
								.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 3) {
						CockpitDB3M.this.bBombs[2] = !CockpitDB3M.this.fm.CT.Weapons[3][3]
								.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 4) {
						CockpitDB3M.this.bBombs[5] = !CockpitDB3M.this.fm.CT.Weapons[3][4]
								.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 5) {
						CockpitDB3M.this.bBombs[4] = !CockpitDB3M.this.fm.CT.Weapons[3][5]
								.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 6) {
						CockpitDB3M.this.bBombs[5] = CockpitDB3M.this.bBombs[5]
								|| !CockpitDB3M.this.fm.CT.Weapons[3][6]
										.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 7) {
						CockpitDB3M.this.bBombs[4] = CockpitDB3M.this.bBombs[4]
								|| !CockpitDB3M.this.fm.CT.Weapons[3][7]
										.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 8) {
						CockpitDB3M.this.bBombs[7] = !CockpitDB3M.this.fm.CT.Weapons[3][8]
								.haveBullets();
					}
					if (CockpitDB3M.this.fm.CT.Weapons[3].length > 9) {
						CockpitDB3M.this.bBombs[6] = !CockpitDB3M.this.fm.CT.Weapons[3][9]
								.haveBullets();
					}
				}
				CockpitDB3M.this.setNew.throttle1 = (0.9F * CockpitDB3M.this.setOld.throttle1)
						+ (0.1F * CockpitDB3M.this.fm.EI.engines[0]
								.getControlThrottle());
				CockpitDB3M.this.setNew.prop1 = (0.9F * CockpitDB3M.this.setOld.prop1)
						+ (0.1F * CockpitDB3M.this.fm.EI.engines[0]
								.getControlProp());
				CockpitDB3M.this.setNew.mix1 = (0.8F * CockpitDB3M.this.setOld.mix1)
						+ (0.2F * CockpitDB3M.this.fm.EI.engines[0]
								.getControlMix());
				CockpitDB3M.this.setNew.man1 = (0.92F * CockpitDB3M.this.setOld.man1)
						+ (0.08F * CockpitDB3M.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitDB3M.this.setNew.throttle2 = (0.9F * CockpitDB3M.this.setOld.throttle2)
						+ (0.1F * CockpitDB3M.this.fm.EI.engines[1]
								.getControlThrottle());
				CockpitDB3M.this.setNew.prop2 = (0.9F * CockpitDB3M.this.setOld.prop2)
						+ (0.1F * CockpitDB3M.this.fm.EI.engines[1]
								.getControlProp());
				CockpitDB3M.this.setNew.mix2 = (0.8F * CockpitDB3M.this.setOld.mix2)
						+ (0.2F * CockpitDB3M.this.fm.EI.engines[1]
								.getControlMix());
				CockpitDB3M.this.setNew.man2 = (0.92F * CockpitDB3M.this.setOld.man2)
						+ (0.08F * CockpitDB3M.this.fm.EI.engines[1]
								.getManifoldPressure());
				CockpitDB3M.this.setNew.altimeter = CockpitDB3M.this.fm
						.getAltitude();
				CockpitDB3M.this.setNew.azimuth.setDeg(
						CockpitDB3M.this.setOld.azimuth.getDeg(1.0F),
						CockpitDB3M.this.fm.Or.azimut());
				CockpitDB3M.this.setNew.vspeed = ((100F * CockpitDB3M.this.setOld.vspeed) + CockpitDB3M.this.fm
						.getVertSpeed()) / 101F;
				float f = CockpitDB3M.this.waypointAzimuth();
				CockpitDB3M.this.setNew.waypointAzimuth.setDeg(
						CockpitDB3M.this.setOld.waypointAzimuth.getDeg(0.1F),
						(f - CockpitDB3M.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitDB3M.this.setNew.waypointDirection.setDeg(
						CockpitDB3M.this.setOld.waypointDirection.getDeg(1.0F),
						f);
				CockpitDB3M.this.mesh.chunkSetAngles("Z_RTurret",
						CockpitDB3M.this.aircraft().FM.turret[0].tu[0], 0.0F,
						0.0F);
				CockpitDB3M.this.mesh.chunkSetAngles("Z_RGun",
						-CockpitDB3M.this.aircraft().FM.turret[0].tu[1], 0.0F,
						0.0F);
				CockpitDB3M.this.setNew.inert = (0.999F * CockpitDB3M.this.setOld.inert)
						+ (0.001F * (CockpitDB3M.this.fm.EI.engines[0]
