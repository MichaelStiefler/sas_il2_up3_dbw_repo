...
// Source File Name:   CockpitJ2M5_mod.java
...
public class CockpitJ2M5_mod extends com.maddox.il2.objects.air.CockpitPilot
{
            ...
            if(fm != null)
            {
                ...
                if(fm.EI.engines[0].getStage() > 0)
                {
                    if(fm.AS.astateSootStates[0] == 0)
                        pictT = 0.993F * pictT + 0.007F * com.maddox.il2.ai.World.Rnd().nextFloat(600F, 900F + fm.CT.getPowerControl() * 100F);
                    else
                        pictT = 0.993F * pictT + 0.007F * com.maddox.il2.ai.World.Rnd().nextFloat(500F, 600F + fm.CT.getPowerControl() * 100F);
                } else
                {
                    pictT = 0.9992F * pictT + 0.0008F * (com.maddox.il2.fm.Atmosphere.temperature((float)fm.Loc.z) - 200F);
                }
            }
            return true;
        }

        final com.maddox.il2.objects.air.CockpitJ2M5_mod this$0;

        Interpolater()
        {
            _fld0 = com.maddox.il2.objects.air.CockpitJ2M5_mod.this;
            super();
        }
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(interp(setNew.dimPosition, setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 0.07F);
        ...
        if(fm.CT.GearControl == 1.0F && fm.CT.getGear() != 1.0F)
            ...
            f_0_ = 0.0F;
        mesh.chunkSetAngles("Z_Gear1", pictGear = 0.8F * pictGear + 0.2F * f_0_, 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Temp1", cvt(pictT, 500F, 900F, 0.0F, -65F), 0.0F, 0.0F);
        ...
        pictMetl = 0.9F * pictMetl + 0.1F * f_0_;
        ...
        mesh.chunkSetAngles("Z_Trim1a", 27F * fm.CT.getTrimElevatorControl(), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Trim2a", 27F * fm.CT.getTrimRudderControl(), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Hour1", cvt(com.maddox.il2.ai.World.getTimeofDay(), 0.0F, 24F, 0.0F, -720F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Minute1", cvt(com.maddox.il2.ai.World.getTimeofDay() % 1.0F, 0.0F, 1.0F, 0.0F, -360F), 0.0F, 0.0F);
