...
public class CockpitTA_152C extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if((fm.AS.astateCockpitState & 0x40) == 0 && (fm.AS.astateCockpitState & 8) == 0 && (fm.AS.astateCockpitState & 0x10) == 0)
            if(useRealisticNavigationInstruments())
            {
                mesh.chunkSetAngles("RepeaterPlane", -setNew.azimuth.getDeg(f1) + setNew.waypointAzimuth.getDeg(f1), 0.0F, 0.0F);
                mesh.chunkSetAngles("RepeaterOuter", setNew.waypointAzimuth.getDeg(f1), 0.0F, 0.0F);
            } else
            {
                mesh.chunkSetAngles("RepeaterOuter", setNew.azimuth.getDeg(f1), 0.0F, 0.0F);
                mesh.chunkSetAngles("RepeaterPlane", -setNew.waypointAzimuth.getDeg(f1 * 0.1F), 0.0F, 0.0F);
            }
        if((fm.AS.astateCockpitState & 0x40) == 0 && (fm.AS.astateCockpitState & 8) == 0 && (fm.AS.astateCockpitState & 0x10) == 0)
        ...
        if(gun[1] != null)
        {
            xyz[0] = cvt(gun[1].countBullets(), 0.0F, 500F, -0.046F, 0.0F);
            mesh.chunkSetLocate("RC_MG17_L", xyz, ypr);
        }
        if(gun[2] != null)
        {
            xyz[0] = cvt(gun[2].countBullets(), 0.0F, 500F, -0.046F, 0.0F);
            mesh.chunkSetLocate("RC_MG17_R", xyz, ypr);
        }
        if(gun[0] != null)
        {
            xyz[0] = cvt(gun[0].countBullets(), 0.0F, 500F, -0.019F, 0.024F);
            mesh.chunkSetLocate("RC_MG151_L", xyz, ypr);
        }
        if(gun[3] != null)
        {
            xyz[0] = cvt(gun[3].countBullets(), 0.0F, 500F, -0.019F, 0.024F);
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitTA_152C.class, "normZN", 0.74F);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitTA_152C.class, "gsZN", 0.66F);
    }
