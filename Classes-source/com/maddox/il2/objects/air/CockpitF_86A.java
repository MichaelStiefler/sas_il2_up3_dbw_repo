...
public class CockpitF_86A extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    {
        return ((com.maddox.il2.objects.air.F_86A)super.aircraft()).calculateMach();
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        if((((com.maddox.il2.fm.FlightModelMain) (super.fm)).AS.astateCockpitState & 2) == 0)
        {
            ...
            int i = ((com.maddox.il2.objects.air.F_86A)aircraft()).k14Mode;
        ...
        super.mesh.chunkSetAngles("Z_G-Factor", cvt(super.fm.getOverload() + 1.0F, -4F, 12F, -80.5F, 241.5F), 0.0F, 0.0F);
        ...
        if(setNew.stbyPosition < 0.8F)
            super.mesh.chunkVisible("Z_HydroLamp", true);
        else
            super.mesh.chunkVisible("Z_HydroLamp", false);
