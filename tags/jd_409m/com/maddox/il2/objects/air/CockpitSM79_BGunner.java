...
public class CockpitSM79_BGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Zturret2A", 0.0F, paramOrient.getYaw(), 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Zturret2B", 0.0F, paramOrient.getTangage(), 0.0F);
  }
  ...
  protected void interpTick()
  {
    ...
    {
      if (this.hook1 == null)
        this.hook1 = new HookNamed(aircraft(), "_12,7_03");
      doHitMasterAircraft(aircraft(), this.hook1, "_12,7_03");
    }
    if (this.jdField_emitter_of_type_ComMaddoxIl2AiBulletEmitter != null)
    {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("ZTurret3B-Bullet0", bool);
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("ZTurret3B-Bullet1", !bool);
    }
  }
