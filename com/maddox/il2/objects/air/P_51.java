  ...
  implements TypeFighter, TypeBNZFighter, TypeStormovik
{
  ...
  {
    float f = paramFloat > 0.5F ? Aircraft.cvt(paramFloat, 0.8F, 1.0F, 95.0F, 0.0F) : Aircraft.cvt(paramFloat, 0.0F, 0.2F, 0.0F, 95.0F);
  ...
  protected void moveGear(float paramFloat) {
    ...
    resetYPRmodifier();
    Aircraft.xyz[1] = Aircraft.cvt(paramFloat, 0.0F, 0.4F, 0.0F, -0.1F);
    ...
    if (paramString.startsWith("xx")) {
      ...
      if (paramString.startsWith("xxeng1")) {
        ...
        if ((paramString.endsWith("case")) && 
          ...
          debuggunnery("Engine Module: Engine Crank Case Hit - Readyness Reduced to " + this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getReadyness() + "..");
        }
        ...
        if ((paramString.endsWith("cyls")) && 
          ...
          debuggunnery("Engine Module: Engine Cylinders Hit, " + this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getCylindersOperable() + "/" + this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getCylinders() + " Left..");
