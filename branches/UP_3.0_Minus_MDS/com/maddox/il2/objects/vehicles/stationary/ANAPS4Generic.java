...
// Source File Name:   ANAPS4Generic.java
...
public abstract class ANAPS4Generic extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.ANAPS4Generic.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.ANAPS4Generic.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.ANAPS4Generic anaps4generic = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.ANAPS4Generic.constr_arg2 = actorspawnarg;
                anaps4generic = (com.maddox.il2.objects.vehicles.stationary.ANAPS4Generic)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.ANAPS4Generic.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create ANAPS4Generic object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (anaps4generic));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.ANAPS4Generic.mesh_name);
            cls = class1;
    ...
    private ANAPS4Generic(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if(((actor instanceof com.maddox.il2.objects.air.Aircraft) && actor.getSpeed(vector3d) > 20D || (actor instanceof com.maddox.il2.objects.ships.BigshipGeneric) || (actor instanceof com.maddox.il2.objects.ships.ShipGeneric)) && actor.getArmy() != myArmy && actor != com.maddox.il2.ai.World.getPlayerAircraft())
            {
                pos.getAbs(point3d);
                ...
                int j2 = (int)java.lang.Math.ceil((double)k1 * 0.62137119200000002D);
                java.lang.String s1 = "Surface Contact";
                byte byte0 = 9;
                ...
                if((actor instanceof com.maddox.il2.objects.ships.Ship.SubTypeVIIC_Srf) || (actor instanceof com.maddox.il2.objects.ships.Ship.USSGatoSS212_Srf) || (actor instanceof com.maddox.il2.objects.ships.Ship.USSGreenlingSS213_Srf))
                    byte0 = 30;
                if(k1 <= byte0 && i2 >= 255 && i2 <= 285 && java.lang.Math.sqrt(j1 * j1) <= 35D)
                    com.maddox.il2.game.HUD.logCenter("                                              " + s1 + " bearing " + i1 + "\260" + ", range " + j2 + " miles" + s);
            }
        }
