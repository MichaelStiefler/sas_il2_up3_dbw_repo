...
public class SPITFIRE1 extends SPITFIRE
{
  ...
  static
  {
    Class localClass = SPITFIRE1.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Spit");
    Property.set(localClass, "meshName", "3DO/Plane/SpitfireMk1(Multi1)/hier.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/SpitfireIa.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitSpit1.class });
