...
public class RealFlightModel extends Pilot
{
  ...
  private void dangerEM()
  {
    ...
    this.TmpVd.set(localAircraft.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d); this.TmpVd.sub(this.jdField_Loc_of_type_ComMaddoxJGPPoint3d); this.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transformInv(this.TmpVd); this.TmpVd.normalize();
    if (this.TmpVd.jdField_x_of_type_Double < 0.98D) return;
    if (!(localAircraft.jdField_FM_of_type_ComMaddoxIl2FmFlightModel instanceof Pilot)) return;
  ...
  private void dangerEMAces()
  {
    ...
    Aircraft localAircraft = (Aircraft)localActor;
    this.TmpVd.set(localAircraft.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d); this.TmpVd.sub(this.jdField_Loc_of_type_ComMaddoxJGPPoint3d); this.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transformInv(this.TmpVd); this.TmpVd.normalize();
    if (this.TmpV.jdField_x_of_type_Double < 0.98D) return;
    if (!(localAircraft.jdField_FM_of_type_ComMaddoxIl2FmFlightModel instanceof Pilot)) return;
    Pilot localPilot = (Pilot)localAircraft.jdField_FM_of_type_ComMaddoxIl2FmFlightModel;
    localPilot.setAsDanger(this.jdField_actor_of_type_ComMaddoxIl2EngineActor);
  }
  ...
  public void setRealMode(boolean paramBoolean) { if (this.RealMode == paramBoolean) return;
    ...
    if (this.RealMode) this.jdField_AP_of_type_ComMaddoxIl2FmAutopilotage.setStabAll(false);
  }

  private void checkAirborneState()
  {
    if (World.getPlayerFM() != this) return;
    if (!Actor.isAlive(this.jdField_actor_of_type_ComMaddoxIl2EngineActor)) return;
  ...
  public void update(float paramFloat)
  {
    ...
    if (this.jdField_V_of_type_Float * paramFloat > 5.0F) { update(paramFloat * 0.5F); update(paramFloat * 0.5F); return;
    }

    float f2 = 0.0F; float f3 = 0.0F;
    float f4 = 0.0F;
    ...
    if ((!isOk()) && (this.jdField_Group_of_type_ComMaddoxIl2AiAirAirGroup != null)) this.jdField_Group_of_type_ComMaddoxIl2AiAirAirGroup.delAircraft((Aircraft)this.jdField_actor_of_type_ComMaddoxIl2EngineActor);
    float f7;
    if ((Config.isUSE_RENDER()) && 
      (Maneuver.showFM) && (this.jdField_actor_of_type_ComMaddoxIl2EngineActor == Main3D.cur3D().viewActor())) {
      f5 = (float)this.jdField_W_of_type_ComMaddoxJGPVector3d.jdField_x_of_type_Double / (this.jdField_CT_of_type_ComMaddoxIl2FmControls.getAileron() * 111.111F * this.jdField_SensRoll_of_type_Float) * this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.squareWing / 0.8F;
      if (Math.abs(f5) > 50.0F) f5 = 0.0F;
      f6 = (float)this.jdField_W_of_type_ComMaddoxJGPVector3d.jdField_y_of_type_Double / (-this.jdField_CT_of_type_ComMaddoxIl2FmControls.getElevator() * 111.111F * this.jdField_SensPitch_of_type_Float) * this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.squareWing / 0.27F;
      if (Math.abs(f6) > 50.0F) f6 = 0.0F;
      f7 = (float)this.jdField_W_of_type_ComMaddoxJGPVector3d.jdField_z_of_type_Double / ((this.jdField_AOS_of_type_Float - this.jdField_CT_of_type_ComMaddoxIl2FmControls.getRudder() * 12.0F) * 111.111F * this.jdField_SensYaw_of_type_Float) * this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.squareWing / 0.15F;
    ...
    float f5 = (float)(this.jdField_Vflow_of_type_ComMaddoxJGPVector3d.jdField_x_of_type_Double * this.jdField_Vflow_of_type_ComMaddoxJGPVector3d.jdField_x_of_type_Double) / 11000.0F; if (f5 > 1.0F) f5 = 1.0F;
    ...
    if (this.Realism.Wind_N_Turbulence) World.wind().getVector(this.jdField_Loc_of_type_ComMaddoxJGPPoint3d, this.jdField_Vwind_of_type_ComMaddoxJGPVector3d); else
    ...
    double d2 = this.jdField_Loc_of_type_ComMaddoxJGPPoint3d.jdField_z_of_type_Double - this.jdField_Gears_of_type_ComMaddoxIl2FmGear.screenHQ;
    if (d2 < 0.0D) d2 = 0.0D;

    float f1 = this.jdField_CT_of_type_ComMaddoxIl2FmControls.getAileron() * 14.0F;
    f1 = this.jdField_Arms_of_type_ComMaddoxIl2FmArm.WING_V * (float)Math.sin(FMMath.DEG2RAD(this.jdField_AOS_of_type_Float)) + this.jdField_SensRoll_of_type_Float * this.ailerInfluence * (1.0F - 0.1F * this.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap()) * f1;

    double d3 = 0.0D;
    double d4 = 0.0D;
    if (this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getType() < 2) {
      d3 = this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].addVflow;

      if (this.Realism.Torque_N_Gyro_Effects) d4 = 0.5D * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].addVside;
    }
    ...
    float f8 = f1 - FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_z_of_type_Double, this.Vn.jdField_x_of_type_Double));
    this.Vn.jdField_x_of_type_Double += 0.07000000000000001D * d3;

    double d1 = this.Vn.lengthSquared();
    d1 *= 0.5F * this.jdField_Density_of_type_Float;

    f5 = f1 - FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_z_of_type_Double + 0.07000000000000001D * d4 * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPropDirSign(), this.Vn.jdField_x_of_type_Double));
    float f10 = 0.015F * f1;
    if (f10 < 0.0F) f10 *= 0.18F;

    this.Cwl.jdField_x_of_type_Double = (-d1 * (this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.new_Cx(f5) + f10 + this.jdField_GearCX_of_type_Float * this.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() + this.jdField_radiatorCX_of_type_Float * (this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getRadiatorPos() + this.jdField_CT_of_type_ComMaddoxIl2FmControls.getCockpitDoor()) + this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.dragAirbrakeCx * this.jdField_CT_of_type_ComMaddoxIl2FmControls.getAirBrake()));

    this.Cwl.jdField_z_of_type_Double = (d1 * this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.new_Cy(f5) * this.jdField_Kq_of_type_Float);
    ...
    this.Vn.cross(this.jdField_W_of_type_ComMaddoxJGPVector3d, this.Vn);
    this.Vn.add(this.jdField_Vflow_of_type_ComMaddoxJGPVector3d);
    float f9 = -f1 - FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_z_of_type_Double, this.Vn.jdField_x_of_type_Double));
    this.Vn.jdField_x_of_type_Double += 0.07000000000000001D * d3;

    d1 = this.Vn.lengthSquared();
    d1 *= 0.5F * this.jdField_Density_of_type_Float;

    float f6 = -f1 - FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_z_of_type_Double - 0.07000000000000001D * d4 * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPropDirSign(), this.Vn.jdField_x_of_type_Double));
    f10 = -0.015F * f1;
    if (f10 < 0.0F) f10 *= 0.18F;

    this.Cwr.jdField_x_of_type_Double = (-d1 * (this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.new_Cx(f6) + f10 + this.jdField_GearCX_of_type_Float * this.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() + this.jdField_radiatorCX_of_type_Float * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getRadiatorPos() + this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.dragAirbrakeCx * this.jdField_CT_of_type_ComMaddoxIl2FmControls.getAirBrake()));

    this.Cwr.jdField_z_of_type_Double = (d1 * this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.new_Cy(f6) * this.jdField_Kq_of_type_Float);
    if (this.jdField_fmsfxCurrentType_of_type_Int != 0) {
      if (this.jdField_fmsfxCurrentType_of_type_Int == 1) {
    ...
    this.Cwl.jdField_y_of_type_Double = (-d1 * this.jdField_Fusel_of_type_ComMaddoxIl2FmPolares.new_Cy(this.jdField_AOS_of_type_Float));
    this.Cwl.jdField_x_of_type_Double -= d1 * this.jdField_Fusel_of_type_ComMaddoxIl2FmPolares.new_Cx(this.jdField_AOS_of_type_Float);

    this.Cwr.jdField_y_of_type_Double = (-d1 * this.jdField_Fusel_of_type_ComMaddoxIl2FmPolares.new_Cy(this.jdField_AOS_of_type_Float));
    this.Cwr.jdField_x_of_type_Double -= d1 * this.jdField_Fusel_of_type_ComMaddoxIl2FmPolares.new_Cx(this.jdField_AOS_of_type_Float);

    float f11 = this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.get_AOA_CRYT();

    double d6 = 1.0D;
    double d7 = 0.5D + 0.4D * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPowerOutput();
    double d8 = 1.2D + 0.4D * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPowerOutput();
    ...
    if ((!this.Realism.Stalls_N_Spins) || (this.jdField_Gears_of_type_ComMaddoxIl2FmGear.isUnderDeck()))
    {
      double d5;
      if (f5 > f6) {
        if (this.Cwl.jdField_z_of_type_Double < this.Cwr.jdField_z_of_type_Double) { d5 = this.Cwl.jdField_z_of_type_Double; this.Cwl.jdField_z_of_type_Double = this.Cwr.jdField_z_of_type_Double; this.Cwr.jdField_z_of_type_Double = d5; }
      }
      else if (this.Cwl.jdField_z_of_type_Double > this.Cwr.jdField_z_of_type_Double) { d5 = this.Cwl.jdField_z_of_type_Double; this.Cwl.jdField_z_of_type_Double = this.Cwr.jdField_z_of_type_Double; this.Cwr.jdField_z_of_type_Double = d5;
      }
    }
    else if ((f5 > f11) || (f6 > f11)) {
      this.spinCoeff += 0.2D * paramFloat;
      if ((this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.squareRudders > 0.0D) && 
        (Math.abs(this.jdField_CT_of_type_ComMaddoxIl2FmControls.RudderControl) > 0.5D) && (this.jdField_CT_of_type_ComMaddoxIl2FmControls.RudderControl * this.jdField_W_of_type_ComMaddoxJGPVector3d.jdField_z_of_type_Double > 0.0D))
        this.spinCoeff -= 0.3D * paramFloat;
      float f12;
      if (f5 > f6) f12 = f5; else f12 = f6;
      this.jdField_turbCoeff_of_type_Float = (0.8F * (f12 - f11));
      if (this.jdField_turbCoeff_of_type_Float < 1.0F) this.jdField_turbCoeff_of_type_Float = 1.0F;
      if (this.jdField_turbCoeff_of_type_Float > 15.0F) this.jdField_turbCoeff_of_type_Float = 15.0F;
      d6 = 1.0D - 0.2D * (f12 - f11);
      if (d6 < 0.2D) d6 = 0.2D;
      d6 /= this.jdField_turbCoeff_of_type_Float;
      double d10 = d1 * this.jdField_turbCoeff_of_type_Float * this.spinCoeff;
      float f13 = getAltitude() - (float)Engine.land().HQ_Air(this.jdField_Loc_of_type_ComMaddoxJGPPoint3d.jdField_x_of_type_Double, this.jdField_Loc_of_type_ComMaddoxJGPPoint3d.jdField_y_of_type_Double);
    ...
    if (d2 < 0.4D * this.jdField_Length_of_type_Float) {
      d9 = 1.0D - d2 / (0.4D * this.jdField_Length_of_type_Float);
      d11 = 1.0D + 0.2D * d9;
      d12 = 1.0D + 0.2D * d9;
    ...
    f1 = this.jdField_CT_of_type_ComMaddoxIl2FmControls.getElevator() * (this.jdField_CT_of_type_ComMaddoxIl2FmControls.getElevator() > 0.0F ? 28.0F : 20.0F);
    ...
    if (this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getType() < 2) {
      ...
      d13 = 1.0D - 1.5D * d9 / d12;
      if (d13 < 0.0D) d13 = 0.0D;
      d3 = d13 * d11 * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].addVflow;
      this.Vn.jdField_x_of_type_Double += d3;
      d14 = Math.min(0.0011D * this.Vn.jdField_x_of_type_Double * this.Vn.jdField_x_of_type_Double, 1.0D);
      if (this.Vn.jdField_x_of_type_Double < 0.0D) d14 = 0.0D;

      if (this.Realism.Torque_N_Gyro_Effects) {
        d4 = d13 * d14 * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].addVside;
      }
    }
    ...
    if ((this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getNum() == 1) && (this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getType() < 2)) {
      f5 = -FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_z_of_type_Double - 0.36D * d4 * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPropDirSign(), this.Vn.jdField_x_of_type_Double)) - 2.0F - 0.002F * this.jdField_V_of_type_Float - this.jdField_SensPitch_of_type_Float * f1;

      f6 = -FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_z_of_type_Double + 0.36D * d4 * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPropDirSign(), this.Vn.jdField_x_of_type_Double)) - 2.0F - 0.002F * this.jdField_V_of_type_Float - this.jdField_SensPitch_of_type_Float * f1;
    }
    else {
      f5 = f6 = -FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_z_of_type_Double, this.Vn.jdField_x_of_type_Double)) - 2.0F - 0.002F * this.jdField_V_of_type_Float - this.jdField_SensPitch_of_type_Float * f1;
    }

    this.Chl.jdField_x_of_type_Double = (-d11 * this.jdField_Tail_of_type_ComMaddoxIl2FmPolares.new_Cx(f5));
    this.Chl.jdField_z_of_type_Double = (d11 * this.jdField_Tail_of_type_ComMaddoxIl2FmPolares.new_Cy(f5));
    this.Chr.jdField_x_of_type_Double = (-d11 * this.jdField_Tail_of_type_ComMaddoxIl2FmPolares.new_Cx(f6));
    this.Chr.jdField_z_of_type_Double = (d11 * this.jdField_Tail_of_type_ComMaddoxIl2FmPolares.new_Cy(f6));
    this.Chl.jdField_y_of_type_Double = (this.Chr.jdField_y_of_type_Double = 0.0D);

    f1 = this.jdField_CT_of_type_ComMaddoxIl2FmControls.getRudder() * (this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.squareRudders < 0.05F ? 0.0F : 28.0F);

    if (this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getType() < 2) {
      f7 = -FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_y_of_type_Double - 0.5D * d4 * this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPropDirSign(), this.Vn.jdField_x_of_type_Double)) + this.jdField_SensYaw_of_type_Float * this.rudderInfluence * f1;
    }
    else
    {
      f7 = -FMMath.RAD2DEG((float)Math.atan2(this.Vn.jdField_y_of_type_Double, this.Vn.jdField_x_of_type_Double)) + this.jdField_SensYaw_of_type_Float * this.rudderInfluence * f1;
    }

    this.Cv.jdField_x_of_type_Double = (-d11 * this.jdField_Tail_of_type_ComMaddoxIl2FmPolares.new_Cx(f7));
    this.Cv.jdField_y_of_type_Double = (d11 * this.jdField_Tail_of_type_ComMaddoxIl2FmPolares.new_Cy(f7));
    this.Cv.jdField_z_of_type_Double = 0.0D;

    if (!this.Realism.Stalls_N_Spins) this.Cv.jdField_y_of_type_Double += this.Cv.jdField_y_of_type_Double;

    this.Vn.set(this.jdField_Vflow_of_type_ComMaddoxJGPVector3d);
    d1 = this.jdField_Density_of_type_Float * this.Vn.lengthSquared() * 0.5D;
    ...
    this.Fwl.jdField_x_of_type_Double -= d1 * (this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.dragParasiteCx + this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.dragProducedCx) * 0.5D;
    this.Fwr.jdField_x_of_type_Double -= d1 * (this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.dragParasiteCx + this.jdField_Sq_of_type_ComMaddoxIl2FmSquares.dragProducedCx) * 0.5D;
    ...
    if (FMMath.isNAN(this.jdField_AF_of_type_ComMaddoxJGPVector3d)) { this.jdField_AF_of_type_ComMaddoxJGPVector3d.set(0.0D, 0.0D, 0.0D); flutter(); if (World.cur().isDebugFM()) System.out.println("AF isNAN"); 
    }
    ...
    {
      if ((getOverload() > 13.5F) && (!this.jdField_Gears_of_type_ComMaddoxIl2FmGear.onGround()) && (World.Rnd().nextInt(0, 100) > 98)) cutWing();
      if ((this.indSpeed > 112.5F) && (World.Rnd().nextInt(0, 100) > 98) && 
        (this.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() > 0.3F) && (this.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl == 1.0F)) {
      ...
      {
        if ((World.getPlayerAircraft() == this.jdField_actor_of_type_ComMaddoxIl2EngineActor) && 
          (this.jdField_CT_of_type_ComMaddoxIl2FmControls.bHasFlapsControl)) HUD.log("FailedFlaps");
    ...
    if (Math.abs(this.jdField_AOA_of_type_Float) < 12.0F) {
      ...
      f1 = (float)(f1 * (Math.min(this.jdField_Vflow_of_type_ComMaddoxJGPVector3d.jdField_x_of_type_Double - 50.0D, 50.0D) * 0.003000000026077032D));
      this.jdField_AM_of_type_ComMaddoxJGPVector3d.add(-f1 * 0.01F * this.jdField_Gravity_of_type_Float, 0.0D, 0.0D);
    }
    ...
    double d12 = this.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() * 3.0D;
    if (d12 > 1.0D) d12 = 1.0D;
    double d13 = 0.0111D * Math.abs(this.jdField_AOA_of_type_Float);
    if ((this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.AOACritL < this.jdField_AOA_of_type_Float) && (this.jdField_AOA_of_type_Float < this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.AOACritH)) d13 = 0.0D;
    else if (this.jdField_AOA_of_type_Float >= this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.AOACritH) d13 = Math.min(d13, 0.3D * (this.jdField_AOA_of_type_Float - this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.AOACritH));
    else if (this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.AOACritL <= this.jdField_AOA_of_type_Float) d13 = Math.min(d13, 0.3D * (this.jdField_Wing_of_type_ComMaddoxIl2FmPolares.AOACritL - this.jdField_AOA_of_type_Float));
    double d14 = this.jdField_Arms_of_type_ComMaddoxIl2FmArm.GCENTER + this.jdField_Arms_of_type_ComMaddoxIl2FmArm.GC_FLAPS_SHIFT * d12 * (1.0D - d13) + this.jdField_Arms_of_type_ComMaddoxIl2FmArm.GC_AOA_SHIFT * d13;

    this.TmpV.set(-d14, this.jdField_Arms_of_type_ComMaddoxIl2FmArm.WING_MIDDLE * (1.3D + 1.0D * Math.sin(FMMath.DEG2RAD(this.jdField_AOS_of_type_Float))), -this.jdField_Arms_of_type_ComMaddoxIl2FmArm.GCENTER_Z);
    ...
    double d15 = 1.0D - 1.E-005D * this.indSpeed;
    if (d15 < 0.8D) d15 = 0.8D;
    this.jdField_W_of_type_ComMaddoxJGPVector3d.scale(d15);
    ...
    if (World.cur().diffCur.Torque_N_Gyro_Effects) {
      ...
      this.jdField_GM_of_type_ComMaddoxJGPVector3d.scale(d6);
    ...
    if (Time.tickCounter() % 2 != 0) this.jdField_Gears_of_type_ComMaddoxIl2FmGear.roughness = this.jdField_Gears_of_type_ComMaddoxIl2FmGear.plateFriction(this);
    this.jdField_Gears_of_type_ComMaddoxIl2FmGear.ground(this, true);
    int k = 5;
    if ((this.jdField_GF_of_type_ComMaddoxJGPVector3d.lengthSquared() == 0.0D) && (this.jdField_GM_of_type_ComMaddoxJGPVector3d.lengthSquared() == 0.0D)) k = 1;
    ...
    double d16 = 1.0D / this.jdField_M_of_type_ComMaddoxIl2FmMass.mass;
    this.LocalAccel.scale(d16, this.jdField_SummF_of_type_ComMaddoxJGPVector3d);
    ...
    if (Math.abs(getRollAcceleration()) > 50000.5F) {
      ...
      if (World.cur().isDebugFM()) System.out.println("Punched (Axial = " + this.jdField_SummM_of_type_ComMaddoxJGPVector3d.jdField_x_of_type_Double + ")");
    }
    ...
    if (FMMath.isNAN(this.jdField_AM_of_type_ComMaddoxJGPVector3d)) { this.jdField_AM_of_type_ComMaddoxJGPVector3d.set(0.0D, 0.0D, 0.0D); flutter(); if (World.cur().isDebugFM()) System.out.println("AM isNAN"); 
    }
    ...
    float f14 = 4.0F * (0.25F - this.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.getPowerOutput());
    if (f14 < 0.0F) f14 = 0.0F;
    f14 *= f14;
    f14 *= this.jdField_dryFriction_of_type_Float;
    float f15 = f14 * this.jdField_M_of_type_ComMaddoxIl2FmMass.mass * this.jdField_M_of_type_ComMaddoxIl2FmMass.mass;
    if ((!this.brakeShoe) && (
      ((this.jdField_Gears_of_type_ComMaddoxIl2FmGear.nOfPoiOnGr == 0) && (this.jdField_Gears_of_type_ComMaddoxIl2FmGear.nOfGearsOnGr < 3)) || (f14 == 0.0F) || (this.jdField_SummM_of_type_ComMaddoxJGPVector3d.lengthSquared() > 2.0F * f15) || (this.jdField_SummF_of_type_ComMaddoxJGPVector3d.lengthSquared() > 80.0F * f15) || (this.jdField_W_of_type_ComMaddoxJGPVector3d.lengthSquared() > 0.00014F * f14) || (this.jdField_Vwld_of_type_ComMaddoxJGPVector3d.lengthSquared() > 0.09F * f14)))
    {
      double d17 = 1.0D / k;
      for (int m = 0; m < k; m++) {
        this.jdField_SummF_of_type_ComMaddoxJGPVector3d.add(this.jdField_AF_of_type_ComMaddoxJGPVector3d, this.jdField_GF_of_type_ComMaddoxJGPVector3d);
        ...
        this.TmpV.scale(d17 * paramFloat, this.jdField_AW_of_type_ComMaddoxJGPVector3d);
        ...
        this.TmpV.scale(d17 * paramFloat, this.jdField_W_of_type_ComMaddoxJGPVector3d);
        ...
        this.TmpV.scale(d16, this.jdField_SummF_of_type_ComMaddoxJGPVector3d);
        this.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transform(this.TmpV);
        this.Accel.set(this.TmpV);
        this.TmpV.scale(d17 * paramFloat);
        this.jdField_Vwld_of_type_ComMaddoxJGPVector3d.add(this.TmpV);

        this.TmpV.scale(d17 * paramFloat, this.jdField_Vwld_of_type_ComMaddoxJGPVector3d);
    ...
    float f16;
    if ((this.jdField_Leader_of_type_ComMaddoxIl2FmFlightModel != null) && (isTick(128, 97)) && 
      (Actor.isAlive(this.jdField_Leader_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor)) && (!this.jdField_Gears_of_type_ComMaddoxIl2FmGear.onGround)) {
      f16 = (float)this.jdField_Loc_of_type_ComMaddoxJGPPoint3d.distance(this.jdField_Leader_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d);
      if (f16 > 3000.0F) Voice.speakDeviateBig((Aircraft)this.jdField_Leader_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor);
      else if (f16 > 1700.0F) Voice.speakDeviateSmall((Aircraft)this.jdField_Leader_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor);
    ...
    if (this.jdField_Gears_of_type_ComMaddoxIl2FmGear.onGround())
    {
      ...
      if (this.indSpeed > 10.0F) {
        f16 = (float)Math.sin(Math.toRadians(Math.abs(this.jdField_AOA_of_type_Float)));
        if (f16 > 0.02F) {
          f16 *= f16;
          this.shakeLevel += 0.07F * (f16 - 0.0004F) * (this.indSpeed - 10.0F);
      ...
      if (this.indSpeed > 35.0F) {
        ...
        if (this.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.0F) this.shakeLevel += 0.004F * this.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() * (this.indSpeed - 35.0F);
      }
    }

    if (this.indSpeed > this.jdField_VmaxAllowed_of_type_Float * 0.8F) this.shakeLevel = (0.01F * (this.indSpeed - this.jdField_VmaxAllowed_of_type_Float * 0.8F));
  ...
  private void calcOverLoad(float paramFloat, boolean paramBoolean)
  {
    ...
    if ((this.jdField_Gears_of_type_ComMaddoxIl2FmGear.onGround()) || (!paramBoolean)) { this.plAccel.set(0.0D, 0.0D, 0.0D);
    } else {
    ...
    if (this.saveDeep > 0.8F) {
      ...
      if (this.jdField_CT_of_type_ComMaddoxIl2FmControls.Sensitivity < 0.0F) this.jdField_CT_of_type_ComMaddoxIl2FmControls.Sensitivity = 0.0F;
    }
