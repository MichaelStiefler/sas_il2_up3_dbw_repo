...
public class PaintSchemeFCSPar01 extends com.maddox.il2.objects.air.PaintSchemeFMPar01
{
    ...
    public void prepareNum(java.lang.Class class1, com.maddox.il2.engine.HierMesh hiermesh, com.maddox.il2.ai.Regiment regiment, int i, int j, int k)
    {
        ...
        if(regiment.country() == com.maddox.il2.objects.air.PaintScheme.countryItaly)
        {
            if(k < 10)
            {
                changeMat(hiermesh, "Overlay2", "psFCS01ITALNUM" + l + i + k, "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F);
        ...
        {
            if(k < 10)
                changeMat(hiermesh, "Overlay1", "psFCS01POLCNUM" + l + i + "0" + k, "Russian/1" + k + ".tga", 1.0F, 1.0F, 1.0F);
            else
                changeMat(hiermesh, "Overlay1", "psFCS01POLCNUM" + l + i + k, "Russian/1" + k / 10 + ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
            changeMat(hiermesh, "Overlay6", "polishcheckerboard", "Polish/checkerboard.tga", 1.0F, 1.0F, 1.0F);
        ...
        {
            if(k < 10)
                changeMat(hiermesh, "Overlay1", "psFCS01RUSCNUM" + l + i + "0" + k, "Russian/0" + k + ".tga", 1.0F, 1.0F, 1.0F);
            else
        ...
        {
            changeMat(hiermesh, "Overlay1", "psFCS01USACNUM" + k % 10, "States/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F);
            return;
        } else
        {
            return;
