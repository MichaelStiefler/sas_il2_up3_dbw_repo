...
//            Hurricane, PaintSchemeFMPar02, NetAircraft
...
public class HurricaneMkIIc extends com.maddox.il2.objects.air.Hurricane
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.HurricaneMkIIc.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 0
        });
        com.maddox.il2.objects.air.HurricaneMkIIc.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04"
        });
        com.maddox.il2.objects.air.HurricaneMkIIc.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunHispanoMkIk 91", "MGunHispanoMkIk 91", "MGunHispanoMkIk 91", "MGunHispanoMkIk 91"
        });
        com.maddox.il2.objects.air.HurricaneMkIIc.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
