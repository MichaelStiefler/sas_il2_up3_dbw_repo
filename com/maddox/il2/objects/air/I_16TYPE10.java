  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int paramInt)
  {
    ...
    try
    {
      arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(1, "MGunShKASk", 750);
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(1, "MGunShKASk", 750);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(0, "MGunShKASk", 650);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(0, "MGunShKASk", 650);
    }
  ...
  static
  {
    Class localClass = I_16TYPE10.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "I-16");

    Property.set(localClass, "meshName", "3DO/Plane/I-16type10/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar01());
    Property.set(localClass, "meshName_ru", "3DO/Plane/I-16type10(ru)/hier.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/I-16type10.fmd");
