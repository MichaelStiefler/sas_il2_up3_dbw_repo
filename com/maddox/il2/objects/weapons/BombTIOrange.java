...
public class BombTIOrange extends Bomb
{
  private long t1;
  private int charge;
    ...
    if (this.charge < 1.01D) {
      ...
      if (Actor.isValid(localActor)) {
        ...
        for (int i = 0; i < 60; i++) {
          ...
          BombTiOn localBombTiOn = new BombTiOn();
          localBombTiOn.pos.setUpdateEnable(true);
          localBombTiOn.pos.setAbs(localPoint3d, localOrient);
          localBombTiOn.pos.reset();
          localBombTiOn.start();
          localBombTiOn.setOwner(localActor, false, false, false);
          localBombTiOn.setSpeed(localVector3d1);
        }
  ...
  static
  {
    Class localClass = BombTIOrange.class;
