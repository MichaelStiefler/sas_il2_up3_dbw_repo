...
public class CockpitPBY_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((PBY)aircraft()).fSightCurForwardAngle;
                float f1 = -((PBY)aircraft()).fSightCurSideslip;
    ...
    {
        super.mesh.chunkSetAngles("zMark1", ((PBY)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((PBY)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
