// Source File Name: CockpitSEAGLADIATOR.java
...
public class CockpitSEAGLADIATOR extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (((CockpitSEAGLADIATOR.this.fm.AS.astateCockpitState & 2) != 0)
					&& (CockpitSEAGLADIATOR.this.setNew.stbyPosition < 1.0F)) {
			...
			CockpitSEAGLADIATOR.this.setNew.altimeter = CockpitSEAGLADIATOR.this.fm
					.getAltitude();
			if (Math.abs(CockpitSEAGLADIATOR.this.fm.Or.getKren()) < 30F) {
				CockpitSEAGLADIATOR.this.setNew.azimuth = ((21F * CockpitSEAGLADIATOR.this.setOld.azimuth) + CockpitSEAGLADIATOR.this.fm.Or
						.azimut()) / 22F;
			}
			if ((CockpitSEAGLADIATOR.this.setOld.azimuth > 270F)
					&& (CockpitSEAGLADIATOR.this.setNew.azimuth < 90F)) {
				CockpitSEAGLADIATOR.this.setOld.azimuth -= 360F;
			}
			if ((CockpitSEAGLADIATOR.this.setOld.azimuth < 90F)
					&& (CockpitSEAGLADIATOR.this.setNew.azimuth > 270F)) {
				CockpitSEAGLADIATOR.this.setOld.azimuth += 360F;
			}
			CockpitSEAGLADIATOR.this.setNew.throttle = ((10F * CockpitSEAGLADIATOR.this.setOld.throttle) + CockpitSEAGLADIATOR.this.fm.EI.engines[0]
					.getControlThrottle()) / 11F;
			CockpitSEAGLADIATOR.this.setNew.mix = ((10F * CockpitSEAGLADIATOR.this.setOld.mix) + CockpitSEAGLADIATOR.this.fm.EI.engines[0]
					.getControlMix()) / 11F;
			CockpitSEAGLADIATOR.this.setNew.prop = CockpitSEAGLADIATOR.this.setOld.prop;
			if (CockpitSEAGLADIATOR.this.setNew.prop < (CockpitSEAGLADIATOR.this.fm.EI.engines[0]
			...
			CockpitSEAGLADIATOR.this.fm.Or
					.transform(CockpitSEAGLADIATOR.this.w);
			CockpitSEAGLADIATOR.this.setNew.turn = ((12F * CockpitSEAGLADIATOR.this.setOld.turn) + CockpitSEAGLADIATOR.this.w.z) / 13F;
			CockpitSEAGLADIATOR.this.setNew.vspeed = ((199F * CockpitSEAGLADIATOR.this.setOld.vspeed) + CockpitSEAGLADIATOR.this.fm
					.getVertSpeed()) / 200F;
			CockpitSEAGLADIATOR.this.pictSupc = (0.8F * CockpitSEAGLADIATOR.this.pictSupc)
					+ (0.2F * CockpitSEAGLADIATOR.this.fm.EI.engines[0]
