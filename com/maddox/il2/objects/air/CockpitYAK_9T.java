...
public class CockpitYAK_9T extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_9T.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitYAK_9T.access$102(CockpitYAK_9T.this, CockpitYAK_9T.this.setOld); CockpitYAK_9T.access$202(CockpitYAK_9T.this, CockpitYAK_9T.this.setNew); CockpitYAK_9T.access$302(CockpitYAK_9T.this, CockpitYAK_9T.this.setTmp);

        CockpitYAK_9T.this.setNew.throttle = ((10.0F * CockpitYAK_9T.this.setOld.throttle + CockpitYAK_9T.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_9T.this.setNew.prop = ((10.0F * CockpitYAK_9T.this.setOld.prop + CockpitYAK_9T.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_9T.this.setNew.altimeter = CockpitYAK_9T.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_9T.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_9T.this.setNew.azimuth = ((35.0F * CockpitYAK_9T.this.setOld.azimuth + CockpitYAK_9T.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitYAK_9T.this.setOld.azimuth > 270.0F) && (CockpitYAK_9T.this.setNew.azimuth < 90.0F)) CockpitYAK_9T.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_9T.this.setOld.azimuth < 90.0F) && (CockpitYAK_9T.this.setNew.azimuth > 270.0F)) CockpitYAK_9T.this.setOld.azimuth += 360.0F;
        CockpitYAK_9T.this.setNew.vspeed = ((199.0F * CockpitYAK_9T.this.setOld.vspeed + CockpitYAK_9T.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_9T this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitYAK_9T.1 arg2) { this();
    }
  }
}