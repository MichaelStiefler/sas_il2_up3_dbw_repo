    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(fm != null)
            {
                ...
                if(buzzerFX != null)
                    if(fm.Loc.z < (double)((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveRecoveryAlt && ((com.maddox.il2.objects.air.JU_87)fm.actor).diveMechStage == 1)
                        buzzerFX.play();
                    else
                    if(buzzerFX.isPlaying())
                        buzzerFX.stop();
                float f = ((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveRecoveryAlt;
                float f1 = -(((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.sin(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveAngle))) * 0.1019F;
                f1 += (float)java.lang.Math.sqrt(f1 * f1 + 2.0F * f * 0.1019F);
                float f2 = ((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.cos(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveAngle));
                float f3 = (f2 * f1 + 10F) - 10F;
                setNew.alpha = 90F - ((com.maddox.il2.objects.air.JU_87D5)aircraft()).fDiveAngle - (float)java.lang.Math.toDegrees(java.lang.Math.atan(f3 / f));
            }
            return true;
        }
