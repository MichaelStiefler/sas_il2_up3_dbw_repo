...
// Source File Name:   CockpitG4M1_11.java
...
public class CockpitG4M1_11 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, -0.03F, 0.03F);
        mesh.chunkSetLocate("Z_AH2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        mesh.chunkSetAngles("Z_AH3", 0.0F, 0.0F, fm.Or.getKren());
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, -0.03F, 0.03F);
        mesh.chunkSetLocate("Z_AH4", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        w.set(fm.getW());
        fm.Or.transform(w);
        float f2 = getBall(7D);
        mesh.chunkSetAngles("Z_TurnBank1", cvt(f2, -5F, 5F, 8.5F, -8.5F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_TurnBank2", cvt(w.z, -0.23562F, 0.23562F, 22F, -22F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_TurnBank3", cvt(f2, -7F, 7F, 16F, -16F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_TurnBank4", cvt(w.z, -0.23562F, 0.23562F, 22F, -22F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_TurnBank5", cvt(f2, -7F, 7F, 16F, -16F), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Speedometer2", floatindex(cvt(com.maddox.il2.fm.Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), speedometerScale), 0.0F, 0.0F);
        ...
        float f1 = (com.maddox.il2.fm.Atmosphere.temperature((float)fm.Loc.z) - 273.09F) + 44.4F * fm.EI.engines[0].getPowerOutput();
        if(f1 < 0.0F)
            mesh.chunkSetAngles("Z_Temp5", cvt(f1, -40F, 0.0F, 0.0F, 45F), 0.0F, 0.0F);
        else
            mesh.chunkSetAngles("Z_Temp5", cvt(f1, 0.0F, 60F, 45F, 90F), 0.0F, 0.0F);
        f1 = (com.maddox.il2.fm.Atmosphere.temperature((float)fm.Loc.z) - 273.09F) + 44.4F * fm.EI.engines[1].getPowerOutput();
        if(f1 < 0.0F)
            mesh.chunkSetAngles("Z_Temp6", cvt(f1, -40F, 0.0F, 0.0F, 45F), 0.0F, 0.0F);
        else
            mesh.chunkSetAngles("Z_Temp6", cvt(f1, 0.0F, 60F, 45F, 90F), 0.0F, 0.0F);
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(setNew.vspeed, -15F, 15F, -0.055F, 0.055F);
