  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMIG_3.this.fm != null) {
        ...
        CockpitMIG_3.this.setNew.throttle = ((10.0F * CockpitMIG_3.this.setOld.throttle + CockpitMIG_3.this.fm.CT.PowerControl) / 11.0F);
        CockpitMIG_3.this.setNew.prop = ((10.0F * CockpitMIG_3.this.setOld.prop + CockpitMIG_3.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitMIG_3.this.setNew.altimeter = CockpitMIG_3.this.fm.getAltitude();
        if (Math.abs(CockpitMIG_3.this.fm.Or.getKren()) < 30.0F) {
          CockpitMIG_3.this.setNew.azimuth = ((35.0F * CockpitMIG_3.this.setOld.azimuth + CockpitMIG_3.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitMIG_3.this.setNew.vspeed = ((199.0F * CockpitMIG_3.this.setOld.vspeed + CockpitMIG_3.this.fm.getVertSpeed()) / 200.0F);
      }
