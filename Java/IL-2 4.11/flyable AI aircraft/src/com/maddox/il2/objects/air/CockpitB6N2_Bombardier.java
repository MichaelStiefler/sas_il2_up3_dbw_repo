// Source File Name: CockpitB6N2_Bombardier.java
...
public class CockpitB6N2_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB6N2_Bombardier.this.bEntered) {
				float f = ((B6N2) CockpitB6N2_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((B6N2) CockpitB6N2_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitB6N2_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1,
						0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitB6N2_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((B6N2) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F,
				0.0F);
		float f1 = this.cvt(((B6N2) this.aircraft()).fSightSetForwardAngle,
				-15F, 75F, -15F, 75F);
