...
public class HS123 extends Scheme1
    implements TypeFighter, TypeTNBFighter
{
        ...
        if(s.startsWith("xx"))
        {
            ...
            } else
            {
                ...
                if(s.startsWith("xxspar"))
                {
                    ...
                    if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(3.5F / (float)java.lang.Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z), shot) > 0.0F)
                    {
    ...
    static 
    {
        java.lang.Class class1 = HS123.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "HS123");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/Hs123/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/HS123.fmd");
        ...
        Aircraft.weaponsRegister(class1, "1xDroptanks+4xSC-50", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "2xMG-FF", new java.lang.String[] {
            "MGunMG17si 500", "MGunMG17si 500", "MGunMGFFt 90", "MGunMGFFt 90", "PylonMG 1", "PylonMG 1", null, null, null, null, 
            null, null, null
        });
        Aircraft.weaponsRegister(class1, "1xDroptanks+4xSC-70", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "1xSC-250+4xSC-50", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "1xSC-250", new java.lang.String[] {
            "MGunMG17si 500", "MGunMG17si 500", null, null, null, null, null, null, null, null, 
