  ...
  implements TypeTransport, TypeBomber
{
  ...
  public void msgShot(Shot paramShot) {
    ...
    }if ((paramShot.chunkName.startsWith("Engine3")) && (World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F))
    {
      this.FM.AS.hitEngine(paramShot.initiator, 2, 1);
    }if ((paramShot.chunkName.startsWith("Engine4")) && (World.Rnd().nextFloat(0.0F, 1.0F) < 0.1F))
    {
      this.FM.AS.hitEngine(paramShot.initiator, 3, 1);
    }if (paramShot.chunkName.startsWith("CF")) {
      if ((Aircraft.Pd.x > 4.550000190734863D) && (Aircraft.Pd.x < 7.150000095367432D) && (Aircraft.Pd.z > 0.5799999833106995D))
      {
        if (World.Rnd().nextFloat() < 0.233F) {
          if (Aircraft.Pd.z > 1.210000038146973D) {
      ...
      if ((Aircraft.Pd.x > 9.529999732971191D) && (Aircraft.Pd.z < 0.1400000005960465D) && (Aircraft.Pd.z > -0.6299999952316284D))
      {
        this.FM.AS.hitPilot(paramShot.initiator, 2, (int)(paramShot.power * 0.002F));
      }
      if ((Aircraft.Pd.x > 2.474999904632568D) && (Aircraft.Pd.x < 4.489999771118164D) && (Aircraft.Pd.z > 0.6100000143051148D) && (paramShot.power * Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z) > 11900.0D) && (World.Rnd().nextFloat() < 0.45F))
      {
        for (int i = 0; i < 4; i++)
    ...
    if (paramShot.chunkName.startsWith("Turret1")) {
      if (Aircraft.Pd.z > 0.03344999998807907D) {
    ...
    if (paramShot.chunkName.startsWith("Turret3")) {
      if (Aircraft.Pd.z > 0.3044500052928925D) {
    ...
    if (paramShot.chunkName.startsWith("Turret4")) {
      if (Aircraft.Pd.z > -0.9954000115394592D) {
    ...
    } else if (paramShot.chunkName.startsWith("Turret5")) {
      if (Aircraft.Pd.z > -0.9954000115394592D) {
  ...
  public boolean turretAngles(int paramInt, float[] paramArrayOfFloat) {
    ...
    case 1:
      ...
      if (f3 < 1.0F) {
        ...
        if (f2 >= 0.71429F - 0.71429F * f3) break;
        f2 = 0.71429F - 0.71429F * f3;
        bool = false;
      }
      else if (f3 < 29.5F) {
        if (f2 >= -2.5F) break;
        ...
        if (f2 >= 52.0303F - 1.84848F * f3) break;
        f2 = 52.0303F - 1.84848F * f3;
        bool = false;
      }
      else if (f3 < 89.0F) {
        if (f2 >= -70.735184F + 0.80232F * f3) break;
        f2 = -70.735184F + 0.80232F * f3;
        bool = false;
      }
      else if (f3 < 147.0F) {
        if (f2 >= 1.5F) break;
    ...
    case 3:
      ...
      if (f1 < -60.0F) {
        ...
        if (f2 <= 3.9836F + 0.25806F * f1) break;
        f2 = 3.9836F + 0.25806F * f1;
        bool = false;
      }
      else if (f1 < -10.5F) {
        if (f2 <= 16.25005F + 1.16667F * f1) break;
        f2 = 16.25005F + 1.16667F * f1;
        bool = false;
      }
      else if (f1 < 14.0F) {
        if (f2 <= 5.0F) break;
    ...
    case 4:
      ...
      if (f1 < -60.0F) {
        ...
        if (f2 > 3.9836F + 0.25806F * f1) {
          f2 = 3.9836F + 0.25806F * f1;
          bool = false;
        }
      } else if (f1 < -10.5F) {
        if (f2 > 16.25005F + 1.16667F * f1) {
          f2 = 16.25005F + 1.16667F * f1;
          bool = false;
        }
      } else if (f1 < 14.0F) {
  ...
  static
  {
    ...
    Property.set(localClass, "cockpitClass", new Class[] { CockpitPE8.class, CockpitPE8_Bombardier.class, CockpitPE8_FGunner.class, CockpitPE8_TGunner.class, CockpitPE8_AGunner.class, CockpitPE8_RGunner.class, CockpitPE8_LGunner.class });
