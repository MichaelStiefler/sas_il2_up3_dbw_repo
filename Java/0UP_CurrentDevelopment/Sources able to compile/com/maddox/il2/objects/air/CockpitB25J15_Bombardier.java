...
public class CockpitB25J15_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            setOld = setNew;
            setNew = setTmp;
            float f = ((B_25J15)aircraft()).fSightCurForwardAngle;
            float f1 = ((B_25J15)aircraft()).fSightCurSideslip;
            CockpitB25J15_Bombardier.calibrAngle = 360F - fm.Or.getPitch();
            mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, CockpitB25J15_Bombardier.calibrAngle + f);
            if(bEntered)
            {
                com.maddox.il2.engine.hotkey.HookPilot hookpilot = com.maddox.il2.engine.hotkey.HookPilot.current;
                hookpilot.setSimpleAimOrient(aAim + 10F * f1, tAim + CockpitB25J15_Bombardier.calibrAngle + f, 0.0F);
            }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_25J15)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((B_25J15)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitB25J15_Bombardier.class, "astatePilotIndx", 0);
    }
