...
public class CockpitSU_2_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitSU_2_Bombardier.this.bEntered) {
				float f = ((SU_2) CockpitSU_2_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((SU_2) CockpitSU_2_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitSU_2_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1,
						0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitSU_2_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((SU_2) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F,
				0.0F);
		float f1 = this.cvt(((SU_2) this.aircraft()).fSightSetForwardAngle,
				-15F, 75F, -15F, 75F);
