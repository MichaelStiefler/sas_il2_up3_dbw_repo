...
public class CockpitA6M5c extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, floatindex(cvt(Pitot.Indicator((float)this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 629.67981F, 0.0F, 17.0F), speedometerScale), 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitA6M5c.this.fm != null) {
        ...
        if ((CockpitA6M5c.this.fm.AS.astateCockpitState & 0x2) != 0) {
        ...
        CockpitA6M5c.this.setNew.vspeed = ((199.0F * CockpitA6M5c.this.setOld.vspeed + CockpitA6M5c.this.fm.getVertSpeed()) / 200.0F);
        ...
        else
        {
          ...
          CockpitA6M5c.this.setNew.waypointDirection.setDeg(CockpitA6M5c.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M5c.this.fm.Or.azimut() + 90.0F);
        }
