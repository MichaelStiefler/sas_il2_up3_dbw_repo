...
public class CockpitIAR80 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetLocate("Fire1", Cockpit.xyz, Cockpit.ypr);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Brake", 0.0F, 0.0F, 11.2F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getBrake());
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitIAR80.this.setNew.throttle = ((10.0F * CockpitIAR80.this.setOld.throttle + CockpitIAR80.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
      CockpitIAR80.this.setNew.vspeed = ((199.0F * CockpitIAR80.this.setOld.vspeed + CockpitIAR80.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitIAR80.this.setNew.azimuth = CockpitIAR80.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitIAR80.this.setOld.azimuth > 270.0F) && (CockpitIAR80.this.setNew.azimuth < 90.0F)) CockpitIAR80.this.setOld.azimuth -= 360.0F;
      if ((CockpitIAR80.this.setOld.azimuth < 90.0F) && (CockpitIAR80.this.setNew.azimuth > 270.0F)) CockpitIAR80.this.setOld.azimuth += 360.0F;
      CockpitIAR80.this.setNew.waypointAzimuth = ((10.0F * CockpitIAR80.this.setOld.waypointAzimuth + (CockpitIAR80.this.waypointAzimuth() - CockpitIAR80.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitIAR80.1 arg2) { this();
    }
  }
}