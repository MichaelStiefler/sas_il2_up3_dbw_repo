...
public class CockpitAR_234B2NJ_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((AR_234B2NJ)aircraft()).fSightCurForwardAngle;
            float f1 = ((AR_234B2NJ)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bBAiming)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((AR_234B2NJ)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((AR_234B2NJ)aircraft()).fSightCurReadyness > 0.93F;
