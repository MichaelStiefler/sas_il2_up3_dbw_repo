...
public class CockpitFW200 extends CockpitPilot
{
  ...
  public CockpitFW200() {
    super("3DO/Cockpit/B-25J/CockpitFW200.him", "bf109");
  ...
  private class Variables
  {
    ...
    private final CockpitFW200 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW200.this.fm != null) {
        CockpitFW200.access$102(CockpitFW200.this, CockpitFW200.this.setOld);
        CockpitFW200.access$202(CockpitFW200.this, CockpitFW200.this.setNew);
        CockpitFW200.access$302(CockpitFW200.this, CockpitFW200.this.setTmp);
        ...
        CockpitFW200.this.setNew.waypointAzimuth.setDeg(CockpitFW200.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitFW200.this.setNew.waypointDeviation.setDeg(CockpitFW200.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitFW200.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitFW200.this.setNew.vspeed = ((199.0F * CockpitFW200.this.setOld.vspeed + CockpitFW200.this.fm.getVertSpeed()) / 200.0F);
      }
