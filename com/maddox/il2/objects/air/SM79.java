...
public abstract class SM79 extends com.maddox.il2.objects.air.Scheme6
{
    ...
    public void update(float f)
    {
        ...
        if(bPitUnfocused && com.maddox.il2.engine.Config.isUSE_RENDER())
        {
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
                ...
                if(s.endsWith("a1") || s.endsWith("a3") || s.endsWith("a4"))
                    if(com.maddox.il2.objects.air.Aircraft.v1.x > 0.70710676908493042D)
                        getEnergyPastArmor((0.80000000000000004D / com.maddox.il2.objects.air.Aircraft.v1.x) * (double)com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot);
                    else
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("cyls"))
                {
                    ...
                    if(getEnergyPastArmor(1.4F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[byte1].getCylindersRatio() * 0.6F)
                    {
                        FM.EI.engines[byte1].setCyliderKnockOut(shot.initiator, com.maddox.il2.ai.World.Rnd().nextInt(1, (int)(shot.power / 5000F)));
                ...
                if(s.endsWith("supc") && getEnergyPastArmor(0.3F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.79F)
                {
            ...
            if(s.startsWith("xxtank"))
            {
                ...
                if(getEnergyPastArmor(1.3F, shot) > 0.0F)
                    if(shot.power < 14100F)
                    {
                        ...
                        if(shot.powerType == 3 && FM.AS.astateTankStates[i] > 0 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.07F)
                        {
        ...
        if(s.startsWith("xwinglin"))
        {
            ...
            if(com.maddox.il2.ai.World.Rnd().nextFloat() > 0.7F)
                getEnergyPastArmor(5F, shot);
        } else
