...
public class CockpitFW200_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitFW200_Bombardier.this.bEntered) {
				float f = ((FW_200C3U4) CockpitFW200_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((FW_200C3U4) CockpitFW200_Bombardier.this
						.aircraft()).fSightCurSideslip;
				CockpitFW200_Bombardier.this.mesh.chunkSetAngles("BlackBox",
						f1, 0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitFW200_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((FW_200C3U4) this.aircraft()).fSightCurForwardAngle * 3.675F,
				0.0F, 0.0F);
		float f1 = this.cvt(
				((FW_200C3U4) this.aircraft()).fSightSetForwardAngle, -15F,
				75F, -15F, 75F);
