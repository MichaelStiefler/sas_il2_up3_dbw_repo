...
// Source File Name:   CockpitB29SP_Bombardier.java
...
//            CockpitPilot, B_29SP, Cockpit

public class CockpitB29SP_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.B_29SP)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.B_29SP)aircraft()).fSightCurSideslip;
    ...
    {
        super("3DO/Cockpit/B-29-SP-Bombardier/BombardierB29SP.him", "he111");
        bEntered = false;
        try
        {
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.B_29SP)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.B_29SP)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
