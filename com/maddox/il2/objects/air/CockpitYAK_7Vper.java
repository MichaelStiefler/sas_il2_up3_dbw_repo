...
public class CockpitYAK_7Vper extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_7Vper this$0;
    ...
    Variables(CockpitYAK_7Vper.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_7Vper.this.fm != null) {
        CockpitYAK_7Vper.access$102(CockpitYAK_7Vper.this, CockpitYAK_7Vper.this.setOld);
        CockpitYAK_7Vper.access$202(CockpitYAK_7Vper.this, CockpitYAK_7Vper.this.setNew);
        CockpitYAK_7Vper.access$302(CockpitYAK_7Vper.this, CockpitYAK_7Vper.this.setTmp);
        CockpitYAK_7Vper.this.setNew.throttle = ((10.0F * CockpitYAK_7Vper.this.setOld.throttle + CockpitYAK_7Vper.this.fm.CT.PowerControl) / 11.0F);

        CockpitYAK_7Vper.this.setNew.prop = ((10.0F * CockpitYAK_7Vper.this.setOld.prop + CockpitYAK_7Vper.this.fm.EI.engines[0].getControlProp()) / 11.0F);

        CockpitYAK_7Vper.this.setNew.altimeter = CockpitYAK_7Vper.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_7Vper.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_7Vper.this.setNew.azimuth = ((35.0F * CockpitYAK_7Vper.this.setOld.azimuth + CockpitYAK_7Vper.this.fm.Or.azimut()) / 36.0F);
        }
        if ((CockpitYAK_7Vper.this.setOld.azimuth > 270.0F) && (CockpitYAK_7Vper.this.setNew.azimuth < 90.0F))
          CockpitYAK_7Vper.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_7Vper.this.setOld.azimuth < 90.0F) && (CockpitYAK_7Vper.this.setNew.azimuth > 270.0F))
          CockpitYAK_7Vper.this.setOld.azimuth += 360.0F;
        CockpitYAK_7Vper.this.setNew.vspeed = ((199.0F * CockpitYAK_7Vper.this.setOld.vspeed + CockpitYAK_7Vper.this.fm.getVertSpeed()) / 200.0F);
      }
