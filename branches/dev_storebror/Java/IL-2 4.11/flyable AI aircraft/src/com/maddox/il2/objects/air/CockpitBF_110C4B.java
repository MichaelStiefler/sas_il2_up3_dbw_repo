// Source File Name: CockpitBF_110C4B.java
...
public class CockpitBF_110C4B extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			CockpitBF_110C4B.this.setTmp = CockpitBF_110C4B.this.setOld;
			CockpitBF_110C4B.this.setOld = CockpitBF_110C4B.this.setNew;
			CockpitBF_110C4B.this.setNew = CockpitBF_110C4B.this.setTmp;
			CockpitBF_110C4B.this.setNew.altimeter = CockpitBF_110C4B.this.fm
					.getAltitude();
			if (CockpitBF_110C4B.this.cockpitDimControl) {
				if (CockpitBF_110C4B.this.setNew.dimPosition > 0.0F) {
					CockpitBF_110C4B.this.setNew.dimPosition = CockpitBF_110C4B.this.setNew.dimPosition - 0.05F;
				}
			} else if (CockpitBF_110C4B.this.setNew.dimPosition < 1.0F) {
				CockpitBF_110C4B.this.setNew.dimPosition = CockpitBF_110C4B.this.setNew.dimPosition + 0.05F;
			}
			CockpitBF_110C4B.this.setNew.throttle1 = (0.91F * CockpitBF_110C4B.this.setOld.throttle1)
					+ (0.09F * CockpitBF_110C4B.this.fm.EI.engines[0]
							.getControlThrottle());
			CockpitBF_110C4B.this.setNew.throttle2 = (0.91F * CockpitBF_110C4B.this.setOld.throttle2)
					+ (0.09F * CockpitBF_110C4B.this.fm.EI.engines[1]
							.getControlThrottle());
			CockpitBF_110C4B.this.setNew.mix1 = (0.88F * CockpitBF_110C4B.this.setOld.mix1)
					+ (0.12F * CockpitBF_110C4B.this.fm.EI.engines[0]
							.getControlMix());
			CockpitBF_110C4B.this.setNew.mix2 = (0.88F * CockpitBF_110C4B.this.setOld.mix2)
					+ (0.12F * CockpitBF_110C4B.this.fm.EI.engines[1]
							.getControlMix());
			CockpitBF_110C4B.this.setNew.azimuth = CockpitBF_110C4B.this.fm.Or
					.getYaw();
			if ((CockpitBF_110C4B.this.setOld.azimuth > 270F)
					&& (CockpitBF_110C4B.this.setNew.azimuth < 90F)) {
				CockpitBF_110C4B.this.setOld.azimuth -= 360F;
			}
			if ((CockpitBF_110C4B.this.setOld.azimuth < 90F)
					&& (CockpitBF_110C4B.this.setNew.azimuth > 270F)) {
				CockpitBF_110C4B.this.setOld.azimuth += 360F;
			}
			CockpitBF_110C4B.this.setNew.waypointAzimuth = ((10F * CockpitBF_110C4B.this.setOld.waypointAzimuth)
					+ (CockpitBF_110C4B.this.waypointAzimuth() - CockpitBF_110C4B.this.setOld.azimuth) + World
					.Rnd().nextFloat(-30F, 30F)) / 11F;
			Variables variables = CockpitBF_110C4B.this.setNew;
			float f = 0.9F * CockpitBF_110C4B.this.setOld.radioalt;
			float f1 = 0.1F;
			float f2 = CockpitBF_110C4B.this.fm.getAltitude();
			World.cur();
			World.land();
			variables.radioalt = f
					+ (f1 * (f2 - Landscape.HQ_Air(
							(float) CockpitBF_110C4B.this.fm.Loc.x,
							(float) CockpitBF_110C4B.this.fm.Loc.y)));
			CockpitBF_110C4B.this.setNew.vspeed = ((199F * CockpitBF_110C4B.this.setOld.vspeed) + CockpitBF_110C4B.this.fm
					.getVertSpeed()) / 200F;
			return true;
		}
	}
