// Source File Name: CockpitKI_46_OTSU.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitKI_46_OTSU.this.fm != null) {
				...
				CockpitKI_46_OTSU.this.setNew.flap = (0.88F * CockpitKI_46_OTSU.this.setOld.flap)
						+ (0.12F * CockpitKI_46_OTSU.this.fm.CT.FlapsControl);
				CockpitKI_46_OTSU.this.setNew.tlock = (0.7F * CockpitKI_46_OTSU.this.setOld.tlock)
						+ (0.3F * (CockpitKI_46_OTSU.this.fm.Gears.bTailwheelLocked ? 1.0F
								: 0.0F));
				...
				if ((CockpitKI_46_OTSU.this.fm.CT.GearControl < 0.5F)
						&& (CockpitKI_46_OTSU.this.setNew.gear < 1.0F)) {
					CockpitKI_46_OTSU.this.setNew.gear = CockpitKI_46_OTSU.this.setOld.gear + 0.02F;
				}
				if ((CockpitKI_46_OTSU.this.fm.CT.GearControl > 0.5F)
						&& (CockpitKI_46_OTSU.this.setNew.gear > 0.0F)) {
					CockpitKI_46_OTSU.this.setNew.gear = CockpitKI_46_OTSU.this.setOld.gear - 0.02F;
				}
				CockpitKI_46_OTSU.this.setNew.throttle = (0.9F * CockpitKI_46_OTSU.this.setOld.throttle)
						+ (0.1F * CockpitKI_46_OTSU.this.fm.CT.PowerControl);
				CockpitKI_46_OTSU.this.setNew.manifold = (0.8F * CockpitKI_46_OTSU.this.setOld.manifold)
						+ (0.2F * CockpitKI_46_OTSU.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitKI_46_OTSU.this.setNew.pitch = (0.9F * CockpitKI_46_OTSU.this.setOld.pitch)
						+ (0.1F * CockpitKI_46_OTSU.this.fm.EI.engines[0]
								.getControlProp());
				CockpitKI_46_OTSU.this.setNew.mix = (0.9F * CockpitKI_46_OTSU.this.setOld.mix)
						+ (0.1F * CockpitKI_46_OTSU.this.fm.EI.engines[0]
								.getControlMix());
				CockpitKI_46_OTSU.this.setNew.altimeter = CockpitKI_46_OTSU.this.fm
						.getAltitude();
				CockpitKI_46_OTSU.this.setNew.azimuth.setDeg(
						CockpitKI_46_OTSU.this.setOld.azimuth.getDeg(1.0F),
						CockpitKI_46_OTSU.this.fm.Or.azimut());
				CockpitKI_46_OTSU.this.setNew.vspeed = ((199F * CockpitKI_46_OTSU.this.setOld.vspeed) + CockpitKI_46_OTSU.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
