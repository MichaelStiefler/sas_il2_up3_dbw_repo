...
public class CockpitCR32quater extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        super.mesh.chunkSetAngles("Z_Column", 4F * (pictAiler = 0.85F * pictAiler + 0.15F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.AileronControl), 0.0F, 2.0F * (pictElev = 0.85F * pictElev + 0.15F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.ElevatorControl));
        resetYPRmodifier();
        if(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.saveWeaponControl[0])
            com.maddox.il2.objects.air.Cockpit.xyz[2] = -0.01115F;
        super.mesh.chunkSetLocate("Z_Column_but", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        super.mesh.chunkSetAngles("Pedals", 15F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getRudder(), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Ped_trossL", -15F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getRudder(), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Ped_trossR", -15F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getRudder(), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Throttle", 100F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_MagnetoSwitch", 27F * (float)((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getControlMagnetos(), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Mix", 100F * interp(setNew.mix, setOld.mix, f), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_PropPitch1", 90F * interp(setNew.prop, setOld.prop, f), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Flap", -180F * (pictFlap = 0.85F * pictFlap + 0.15F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.FlapsControl), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Trim", 1444F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getTrimAileronControl(), 0.0F, 0.0F);
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.015F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getTrimAileronControl();
        super.mesh.chunkSetLocate("Z_Trim1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        super.mesh.chunkSetAngles("Z_OilRad", 70F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getControlRadiator(), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_OverPres", 70F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getControlRadiator(), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Speedometer1", floatindex(cvt(com.maddox.il2.fm.Pitot.Indicator((float)((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (super.fm)).Loc)).z, super.fm.getSpeedKMH()), 0.0F, 500F, 0.0F, 10F), speedometerScale), 0.0F, 0.0F);
        float f1 = interp(setNew.altimeter, setOld.altimeter, f);
        if(f1 < 5000F)
            super.mesh.chunkSetAngles("Z_Altimeter1", cvt(f1, 0.0F, 5000F, 0.0F, 360F), 0.0F, 0.0F);
        else
            super.mesh.chunkSetAngles("Z_Altimeter1", cvt(f1, 5000F, 11000F, 360F, 720F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Climb1", cvt(setNew.vspeed, -10F, 10F, -180F, 180F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Compass1", -interp(setNew.azimuth, setOld.azimuth, f), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_RPM1", cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 360F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_EngTemp1", cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tWaterOut, 0.0F, 150F, 0.0F, 305.5F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_OilTemp1", floatindex(cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tOilOut, 0.0F, 150F, 0.0F, 5F), oilScale), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_FuelPress1", cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).M.fuel > 1.0F ? 3F : 0.0F, 0.0F, 6F, 0.0F, 297F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_FuelQuantity1", cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).M.fuel, 0.0F, 252F, 0.0F, -316.5F), 0.0F, 0.0F);
        ...
        if(gun[0] != null)
            super.mesh.chunkSetAngles("Z_AmmoCounter1", cvt(gun[0].countBullets(), 0.0F, 600F, 0.0F, 338F), 0.0F, 0.0F);
        if(gun[1] != null)
            super.mesh.chunkSetAngles("Z_AmmoCounter2", cvt(gun[1].countBullets(), 0.0F, 600F, 0.0F, 338F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Turn1", cvt(setNew.turn, -0.2F, 0.2F, 35F, -35F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Turn2", 0.0F, cvt(getBall(8D), -8F, 8F, -16.4F, 16.4F), 0.0F);
        super.mesh.chunkSetAngles("Z_ManfoldPress", cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getManifoldPressure(), 0.533288F, 1.33322F, 0.0F, 330F), 0.0F, 0.0F);
    }
    ...
    public void reflectCockpitState()
    {
        if((((com.maddox.il2.fm.FlightModelMain) (super.fm)).AS.astateCockpitState & 0x80) != 0)
        {
            ...
            super.mesh.chunkVisible("glass_d1", true);
        }
        ...
        if((((com.maddox.il2.fm.FlightModelMain) (super.fm)).AS.astateCockpitState & 0x40) != 0)
        {
            ...
            super.mesh.chunkVisible("Turn1", false);
    ...
    protected void reflectPlaneToModel()
    {
        ...
        super.mesh.chunkVisible("WingLMid_CAP", hiermesh.isChunkVisible("WingLMid_CAP"));
        ...
        super.mesh.chunkVisible("WingRMid_CAP", hiermesh.isChunkVisible("WingRMid_CAP"));
