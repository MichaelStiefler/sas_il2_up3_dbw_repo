...
public class PaintSchemeBMPar09 extends PaintScheme
{
  ...
  public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k)
  {
    ...
    if (regiment.country() == PaintScheme.countryGermany)
    {
      ...
      changeMat(hiermesh, "Overlay2", "psBM02GERCNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "German/" + (char)(65 + (k - 1)) + ".tga", "German/" + PaintScheme.psGermanBomberLetter[l][i] + ".tga", PaintScheme.psGermanBomberColor[i][0], PaintScheme.psGermanBomberColor[i][1], PaintScheme.psGermanBomberColor[i][2], 0.1F, 0.1F, 0.1F);
      changeMat(hiermesh, "Overlay4", "psBM02GERCNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "German/" + (char)(65 + (k - 1)) + ".tga", "German/" + PaintScheme.psGermanBomberLetter[l][i] + ".tga", PaintScheme.psGermanBomberColor[i][0], PaintScheme.psGermanBomberColor[i][1], PaintScheme.psGermanBomberColor[i][2], 0.1F, 0.1F, 0.1F);
    ...
    else if (regiment.country() == PaintScheme.countryFinland)
    {
      ...
      if (k < 10)
      {
        changeMat(hiermesh, "Overlay8", "psBM02FINANUM" + l + i + "0" + k, "Finnish/0" + k + ".tga", PaintScheme.psFinnishFighterColor[i][0], PaintScheme.psFinnishFighterColor[i][1], PaintScheme.psFinnishFighterColor[i][2]);
      }
      else {
      ...
      if (regiment.country() == PaintScheme.countryBritain)
      {
        if (("ra".equals(regiment.branch())) || ("rz".equals(regiment.branch())) || ("rn".equals(regiment.branch())))
        {
          ...
          changeMat(hiermesh, "Overlay2", "psBM02BRINAVYLNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "British/" + (char)(65 + k - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
          changeMat(hiermesh, "Overlay3", "psBM02BRINAVYRNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "null.tga", "British/" + (char)(65 + k - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
          ...
          changeMat(hiermesh, "Overlay2", "psBM02BRILNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "British/" + (char)(65 + k - 1) + ".tga", "null.tga", PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2], 1.0F, 1.0F, 1.0F);
          changeMat(hiermesh, "Overlay3", "psBM02BRIRNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "null.tga", "British/" + (char)(65 + k - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2]);
      ...
      else if (regiment.country() == PaintScheme.countryHungary)
      {
        ...
        changeMat(hiermesh, "Overlay2", "psBM02HUNCNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
        changeMat(hiermesh, "Overlay4", "psBM02HUNCNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
        ...
        if (regiment.country() == PaintScheme.countryItaly)
        {
          if (k < 10)
          {
            changeMat(hiermesh, "Overlay2", "psFB02ITALNUM" + l + i + k + regiment.aid()[1], "Italian/" + k % 10 + regiment.aid()[1] + ".tga", 1.0F, 1.0F, 1.0F);
        ...
        if (regiment.country() == PaintScheme.countryPoland)
        {
          changeMat(hiermesh, "Overlay1", "psBM02POLCNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "Russian/1" + k / 10 + ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
          changeMat(hiermesh, "Overlay4", "psBM02POLCNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "Russian/1" + k / 10 + ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
        ...
        {
          changeMat(hiermesh, "Overlay8", "psFB02ROMCNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "Russian/1" + k / 10 + ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
        ...
        else if (regiment.country() == PaintScheme.countryRussia)
        {
          if (k < 10)
          {
            changeMat(hiermesh, "Overlay2", "psBM02RUSLNUM" + l + i + "0" + k, "Russian/0" + k + ".tga", PaintScheme.psRussianBomberColor[i][0], PaintScheme.psRussianBomberColor[i][1], PaintScheme.psRussianBomberColor[i][2]);
        ...
        else if (regiment.country() == PaintScheme.countryNewZealand)
        {
          ...
          changeMat(hiermesh, "Overlay2", "psBM00RZLNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "British/" + (char)(65 + k - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
          changeMat(hiermesh, "Overlay3", "psBM00RZRNUM" + l + i + (k >= 10 ? k : new StringBuffer("0").append(k).toString()), "null.tga", "British/" + (char)(65 + k - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
