...
public class CockpitB29_Bombardier extends CockpitPilot
{
  ...
  {
    super("3DO/Cockpit/A-20C-Bombardier/BombardierBLENHEIM1.him", "he111");
    this.w = new Vector3f();
    this.bEntered = false;
    try
    {
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bEntered)
    {
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_29)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);
      boolean bool = ((B_29)aircraft()).fSightCurReadyness > 0.93F;
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      float f1 = ((B_29)CockpitB29_Bombardier.this.aircraft()).fSightCurForwardAngle;
      float f2 = ((B_29)CockpitB29_Bombardier.this.aircraft()).fSightCurSideslip;
      CockpitB29_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitB29_Bombardier.this.bEntered)
      {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitB29_Bombardier.this.aAim + f2, CockpitB29_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
