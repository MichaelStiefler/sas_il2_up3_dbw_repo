...
public class CockpitHE_162C extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitHE_162C.this.setNew.vspeed = ((299.0F * CockpitHE_162C.this.setOld.vspeed + CockpitHE_162C.this.fm.getVertSpeed()) / 300.0F);
      ...
      CockpitHE_162C.this.setNew.throttle = ((10.0F * CockpitHE_162C.this.setOld.throttle + CockpitHE_162C.this.fm.CT.PowerControl) / 11.0F);
      CockpitHE_162C.this.setNew.mix = ((8.0F * CockpitHE_162C.this.setOld.mix + CockpitHE_162C.this.fm.EI.engines[0].getControlMix()) / 9.0F);
      CockpitHE_162C.this.setNew.azimuth = CockpitHE_162C.this.fm.Or.getYaw();
      ...
      CockpitHE_162C.this.setNew.beaconDirection = ((10.0F * CockpitHE_162C.this.setOld.beaconDirection + CockpitHE_162C.this.getBeaconDirection()) / 11.0F);
      CockpitHE_162C.this.setNew.beaconRange = ((10.0F * CockpitHE_162C.this.setOld.beaconRange + CockpitHE_162C.this.getBeaconRange()) / 11.0F);
