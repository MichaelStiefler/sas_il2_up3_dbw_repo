...
public class CockpitBF_109F2 extends CockpitPilot
{
    ...
    {
        if(com.maddox.il2.engine.Actor.isValid(((com.maddox.il2.engine.Interpolate) (super.fm)).actor) && ((((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F4) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F4Z) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F3) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F4MSTL) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F413ATA)))
            super.mesh.chunkVisible("Z_ArmorGlass1", true);
        else
        if(com.maddox.il2.engine.Actor.isValid(((com.maddox.il2.engine.Interpolate) (super.fm)).actor) && ((((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F0) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F1) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F2) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof BF_109F2U)))
            super.mesh.chunkVisible("Z_ArmorGlass1", false);
    }
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitBF_109F2.class, "normZN", 0.8F);
        com.maddox.rts.Property.set(CockpitBF_109F2.class, "gsZN", 0.85F);
    }
