...
public class CockpitTBM1_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bEntered)
    {
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((TBM1)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);
      boolean bool = ((TBM1)aircraft()).fSightCurReadyness > 0.93F;
  ...
  static
  {
    Property.set(CockpitTBM1_Bombardier.class, "astatePilotIndx", 0);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      float f1 = ((TBM1)CockpitTBM1_Bombardier.this.aircraft()).fSightCurForwardAngle;
      float f2 = ((TBM1)CockpitTBM1_Bombardier.this.aircraft()).fSightCurSideslip;
      CockpitTBM1_Bombardier.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitTBM1_Bombardier.this.bEntered)
      {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitTBM1_Bombardier.this.aAim + f2, CockpitTBM1_Bombardier.this.tAim + f1, 0.0F);
      }
      CockpitTBM1_Bombardier.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretA", 0.0F, CockpitTBM1_Bombardier.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[0], 0.0F);
      CockpitTBM1_Bombardier.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretB", 0.0F, CockpitTBM1_Bombardier.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[1], 0.0F);
      return true;
    }
