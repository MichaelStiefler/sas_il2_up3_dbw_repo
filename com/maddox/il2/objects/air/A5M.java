    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    public void update(float f)
    {
        ...
        {
            float f1 = com.maddox.il2.objects.air.A5M.cvt(FM.Gears.arrestorVAngle, -56F, 4F, 1.0F, 0.0F);
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.A5M.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.09F, 0.0F, 0.09F);
        hierMesh().chunkSetLocate("GearC99_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.A5M.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.145F, 0.0F, 0.145F);
        hierMesh().chunkSetLocate("GearL2_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.A5M.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.145F, 0.0F, 0.145F);
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 6: // '\006'
                    ...
                    {
                        com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        FM.AS.setControlsDamage(shot.initiator, 1);
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                ...
                case 7: // '\007'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        FM.AS.setEngineSpecificDamage(shot.initiator, 0, 1);
                        FM.AS.setEngineSpecificDamage(shot.initiator, 0, 6);
                        com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                    }
                    break;
                }
                return;
            ...
            if(s.startsWith("xxeng1"))
            {
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Crank Case Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Cylinders Hit - Engine Fires..");
                        }
                    }
                ...
                if(s.endsWith("mag1"))
                {
                    ...
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Module: Magneto #0 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
                if(s.endsWith("mag2"))
                {
                    FM.EI.engines[0].setMagnetoKnockOut(shot.initiator, 1);
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Module: Magneto #1 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
                if(s.endsWith("oil1"))
                {
                    FM.AS.hitOil(shot.initiator, 0);
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Engine Module: Oil Radiator Hit..");
                }
                return;
            }
            ...
            {
                com.maddox.il2.objects.air.A5M.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** WingLIn Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** WingRIn Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** WingLMid Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** WingRMid Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** WingLOut Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.A5M.debugprintln(this, "*** WingROut Spar Damaged..");
