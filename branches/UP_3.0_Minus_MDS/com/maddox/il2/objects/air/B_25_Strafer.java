...
// Source File Name:   B_25_Strafer.java
...
public abstract class B_25_Strafer extends com.maddox.il2.objects.air.B_25
{
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("a6") || s.endsWith("a7"))
                    getEnergyPastArmor(6.3499999999999996D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("r1"))
