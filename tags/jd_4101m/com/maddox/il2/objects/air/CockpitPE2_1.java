...
public class CockpitPE2_1 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_SupL", 0.0F, -65.0F * this.setNew.stage1, 0.0F);
    this.mesh.chunkSetAngles("Z_SupR", 0.0F, -65.0F * this.setNew.stage2, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_1.this.fm != null) {
        ...
        CockpitPE2_1.this.setNew.vspeed = ((100.0F * CockpitPE2_1.this.setOld.vspeed + CockpitPE2_1.this.fm.getVertSpeed()) / 101.0F);
        ...
        CockpitPE2_1.this.setNew.inert = (0.999F * CockpitPE2_1.this.setOld.inert + 0.001F * (CockpitPE2_1.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
