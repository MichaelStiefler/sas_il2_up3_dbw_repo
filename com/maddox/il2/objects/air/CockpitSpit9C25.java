...
public class CockpitSpit9C25 extends CockpitPilot
{
  ...
  public CockpitSpit9C25() {
    super("3DO/Cockpit/SpitfireMkIXc/spit25.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    int i = ((SPITFIRE925LBS)aircraft()).k14Mode;
    boolean bool = i < 2;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitSpit9C25 this$0;
    ...
    Variables(CockpitSpit9C25.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit9C25.this.bNeedSetUp) {
        CockpitSpit9C25.this.reflectPlaneMats();
        CockpitSpit9C25.access$102(CockpitSpit9C25.this, false);
      }
      if (CockpitSpit9C25.this.fm != null) {
        CockpitSpit9C25.access$202(CockpitSpit9C25.this, CockpitSpit9C25.this.setOld);
        CockpitSpit9C25.access$302(CockpitSpit9C25.this, CockpitSpit9C25.this.setNew);
        CockpitSpit9C25.access$402(CockpitSpit9C25.this, CockpitSpit9C25.this.setTmp);
        CockpitSpit9C25.this.setNew.throttle = (0.92F * CockpitSpit9C25.this.setOld.throttle + 0.08F * CockpitSpit9C25.this.fm.CT.PowerControl);

        CockpitSpit9C25.this.setNew.prop = (0.92F * CockpitSpit9C25.this.setOld.prop + 0.08F * CockpitSpit9C25.this.fm.EI.engines[0].getControlProp());

        CockpitSpit9C25.this.setNew.mix = (0.92F * CockpitSpit9C25.this.setOld.mix + 0.08F * CockpitSpit9C25.this.fm.EI.engines[0].getControlMix());

        CockpitSpit9C25.this.setNew.altimeter = CockpitSpit9C25.this.fm.getAltitude();
        if (Math.abs(CockpitSpit9C25.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit9C25.this.setNew.azimuth = (0.97F * CockpitSpit9C25.this.setOld.azimuth + 0.03F * -CockpitSpit9C25.this.fm.Or.getYaw());
        }
        if ((CockpitSpit9C25.this.setOld.azimuth > 270.0F) && (CockpitSpit9C25.this.setNew.azimuth < 90.0F))
          CockpitSpit9C25.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit9C25.this.setOld.azimuth < 90.0F) && (CockpitSpit9C25.this.setNew.azimuth > 270.0F))
          CockpitSpit9C25.this.setOld.azimuth += 360.0F;
        CockpitSpit9C25.this.setNew.waypointAzimuth = (0.91F * CockpitSpit9C25.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit9C25.this.waypointAzimuth() - CockpitSpit9C25.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitSpit9C25.this.setNew.vspeed = (0.99F * CockpitSpit9C25.this.setOld.vspeed + 0.01F * CockpitSpit9C25.this.fm.getVertSpeed());

        float f1 = ((SPITFIRE925LBS)CockpitSpit9C25.this.aircraft()).k14Distance;

        CockpitSpit9C25.this.setNew.k14w = (5.0F * CockpitSpit9C25.k14TargetWingspanScale[((SPITFIRE925LBS)CockpitSpit9C25.this.aircraft()).k14WingspanType] / f1);

        CockpitSpit9C25.this.setNew.k14w = (0.9F * CockpitSpit9C25.this.setOld.k14w + 0.1F * CockpitSpit9C25.this.setNew.k14w);
        CockpitSpit9C25.this.setNew.k14wingspan = (0.9F * CockpitSpit9C25.this.setOld.k14wingspan + 0.1F * CockpitSpit9C25.k14TargetMarkScale[((SPITFIRE925LBS)CockpitSpit9C25.this.aircraft()).k14WingspanType]);

        CockpitSpit9C25.this.setNew.k14mode = (0.8F * CockpitSpit9C25.this.setOld.k14mode + 0.2F * ((SPITFIRE925LBS)CockpitSpit9C25.this.aircraft()).k14Mode);

        Vector3d localVector3d = CockpitSpit9C25.this.aircraft().FM.getW();

        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitSpit9C25.this.floatindex((f1 - 200.0F) * 0.04F, CockpitSpit9C25.k14BulletDrop) - CockpitSpit9C25.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitSpit9C25.this.setNew.k14x = (0.92F * CockpitSpit9C25.this.setOld.k14x + 0.08F * f2);
        CockpitSpit9C25.this.setNew.k14y = (0.92F * CockpitSpit9C25.this.setOld.k14y + 0.08F * f3);
        if (CockpitSpit9C25.this.setNew.k14x > 7.0F)
          CockpitSpit9C25.this.setNew.k14x = 7.0F;
        if (CockpitSpit9C25.this.setNew.k14x < -7.0F)
          CockpitSpit9C25.this.setNew.k14x = -7.0F;
        if (CockpitSpit9C25.this.setNew.k14y > 7.0F)
          CockpitSpit9C25.this.setNew.k14y = 7.0F;
        if (CockpitSpit9C25.this.setNew.k14y < -7.0F)
          CockpitSpit9C25.this.setNew.k14y = -7.0F;
      }
      return true;
