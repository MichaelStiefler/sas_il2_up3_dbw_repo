...
public class CockpitLI2 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitLI2.access$002(CockpitLI2.this, CockpitLI2.this.setOld);
        CockpitLI2.access$102(CockpitLI2.this, CockpitLI2.this.setNew);
        CockpitLI2.access$202(CockpitLI2.this, CockpitLI2.this.setTmp);
        CockpitLI2.this.setNew.throttle1 = (0.85F * CockpitLI2.this.setOld.throttle1 + CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitLI2.this.setNew.throttle2 = (0.85F * CockpitLI2.this.setOld.throttle2 + CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitLI2.this.setNew.prop1 = (0.85F * CockpitLI2.this.setOld.prop1 + CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitLI2.this.setNew.prop2 = (0.85F * CockpitLI2.this.setOld.prop2 + CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitLI2.this.setNew.altimeter = CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitLI2.this.waypointAzimuth();
        CockpitLI2.this.setNew.azimuth.setDeg(CockpitLI2.this.setOld.azimuth.getDeg(1.0F), CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitLI2.this.setNew.waypointAzimuth.setDeg(CockpitLI2.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitLI2.this.setNew.waypointDeviation.setDeg(CockpitLI2.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitLI2.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitLI2.this.setNew.vspeed = ((199.0F * CockpitLI2.this.setOld.vspeed + CockpitLI2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitLI2 this$0;
