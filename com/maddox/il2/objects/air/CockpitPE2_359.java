...
public class CockpitPE2_359 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitPE2_359.access$102(CockpitPE2_359.this, CockpitPE2_359.this.setOld); CockpitPE2_359.access$202(CockpitPE2_359.this, CockpitPE2_359.this.setNew); CockpitPE2_359.access$302(CockpitPE2_359.this, CockpitPE2_359.this.setTmp);
        if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3] != null) {
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 0) {
            CockpitPE2_359.this.bBombs[1] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][0].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 1) {
            CockpitPE2_359.this.bBombs[0] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][1].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 2) {
            CockpitPE2_359.this.bBombs[3] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][2].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 3) {
            CockpitPE2_359.this.bBombs[2] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][3].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 4) {
            CockpitPE2_359.this.bBombs[5] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][4].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 5) {
            CockpitPE2_359.this.bBombs[4] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][5].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 6) {
            CockpitPE2_359.this.bBombs[5] = ((CockpitPE2_359.this.bBombs[5] != 0) || (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 7) {
            CockpitPE2_359.this.bBombs[4] = ((CockpitPE2_359.this.bBombs[4] != 0) || (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 8) {
            CockpitPE2_359.this.bBombs[7] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][8].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 9) {
            CockpitPE2_359.this.bBombs[6] = (!CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][9].haveBullets() ? 1 : 0);
          }
        }

        CockpitPE2_359.this.setNew.throttle1 = (0.9F * CockpitPE2_359.this.setOld.throttle1 + 0.1F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitPE2_359.this.setNew.prop1 = (0.9F * CockpitPE2_359.this.setOld.prop1 + 0.1F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitPE2_359.this.setNew.mix1 = (0.8F * CockpitPE2_359.this.setOld.mix1 + 0.2F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitPE2_359.this.setNew.man1 = (0.92F * CockpitPE2_359.this.setOld.man1 + 0.08F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitPE2_359.this.setNew.throttle2 = (0.9F * CockpitPE2_359.this.setOld.throttle2 + 0.1F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitPE2_359.this.setNew.prop2 = (0.9F * CockpitPE2_359.this.setOld.prop2 + 0.1F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
        CockpitPE2_359.this.setNew.mix2 = (0.8F * CockpitPE2_359.this.setOld.mix2 + 0.2F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
        CockpitPE2_359.this.setNew.man2 = (0.92F * CockpitPE2_359.this.setOld.man2 + 0.08F * CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitPE2_359.this.setNew.altimeter = CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitPE2_359.this.setNew.azimuth.setDeg(CockpitPE2_359.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitPE2_359.this.setNew.vspeed = ((100.0F * CockpitPE2_359.this.setOld.vspeed + CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);

        float f = CockpitPE2_359.this.waypointAzimuth();

        CockpitPE2_359.this.setNew.waypointAzimuth.setDeg(CockpitPE2_359.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitPE2_359.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitPE2_359.this.setNew.waypointDirection.setDeg(CockpitPE2_359.this.setOld.waypointDirection.getDeg(1.0F), f);

        CockpitPE2_359.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RTurret", CockpitPE2_359.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[0], 0.0F, 0.0F);
        CockpitPE2_359.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RGun", -CockpitPE2_359.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[1], 0.0F, 0.0F);

        CockpitPE2_359.this.setNew.inert = (0.999F * CockpitPE2_359.this.setOld.inert + 0.001F * (CockpitPE2_359.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitPE2_359 this$0;
    ...
    Variables(CockpitPE2_359.1 arg2)
    {
      this();
    }
  }
