...
public class CockpitP_38G10LO extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    if (((P_38G10LO)aircraft()).bChangedPit) {
      reflectPlaneToModel();
      ((P_38G10LO)aircraft()).bChangedPit = false;
    }
  ...
  private class Variables
  {
    ...
    float trim;
    private final CockpitP_38G10LO this$0;
    ...
    Variables(CockpitP_38G10LO.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_38G10LO.this.bNeedSetUp) {
        CockpitP_38G10LO.this.reflectPlaneMats();
        CockpitP_38G10LO.access$102(CockpitP_38G10LO.this, false);
      }
      if (((P_38G10LO)CockpitP_38G10LO.this.aircraft()).bChangedPit) {
        CockpitP_38G10LO.this.reflectPlaneToModel();
        ((P_38G10LO)CockpitP_38G10LO.this.aircraft()).bChangedPit = false;
      }
      if (CockpitP_38G10LO.this.fm != null) {
        CockpitP_38G10LO.access$202(CockpitP_38G10LO.this, CockpitP_38G10LO.this.setOld);
        CockpitP_38G10LO.access$302(CockpitP_38G10LO.this, CockpitP_38G10LO.this.setNew);
        CockpitP_38G10LO.access$402(CockpitP_38G10LO.this, CockpitP_38G10LO.this.setTmp);
        CockpitP_38G10LO.this.setNew.trim = (0.92F * CockpitP_38G10LO.this.setOld.trim + 0.08F * CockpitP_38G10LO.this.fm.CT.getTrimElevatorControl());

        CockpitP_38G10LO.this.setNew.throttle1 = (0.85F * CockpitP_38G10LO.this.setOld.throttle1 + CockpitP_38G10LO.this.fm.EI.engines[0].getControlThrottle() * 0.15F);

        CockpitP_38G10LO.this.setNew.throttle2 = (0.85F * CockpitP_38G10LO.this.setOld.throttle2 + CockpitP_38G10LO.this.fm.EI.engines[1].getControlThrottle() * 0.15F);

        CockpitP_38G10LO.this.setNew.prop1 = (0.85F * CockpitP_38G10LO.this.setOld.prop1 + CockpitP_38G10LO.this.fm.EI.engines[0].getControlProp() * 0.15F);

        CockpitP_38G10LO.this.setNew.prop2 = (0.85F * CockpitP_38G10LO.this.setOld.prop2 + CockpitP_38G10LO.this.fm.EI.engines[1].getControlProp() * 0.15F);

        CockpitP_38G10LO.this.setNew.mix1 = (0.85F * CockpitP_38G10LO.this.setOld.mix1 + CockpitP_38G10LO.this.fm.EI.engines[0].getControlMix() * 0.15F);

        CockpitP_38G10LO.this.setNew.mix2 = (0.85F * CockpitP_38G10LO.this.setOld.mix2 + CockpitP_38G10LO.this.fm.EI.engines[1].getControlMix() * 0.15F);

        CockpitP_38G10LO.this.setNew.altimeter = CockpitP_38G10LO.this.fm.getAltitude();
        float f = CockpitP_38G10LO.this.waypointAzimuth();
        CockpitP_38G10LO.this.setNew.azimuth.setDeg(CockpitP_38G10LO.this.setOld.azimuth.getDeg(1.0F), CockpitP_38G10LO.this.fm.Or.azimut());

        CockpitP_38G10LO.this.setNew.waypointAzimuth.setDeg(CockpitP_38G10LO.this.setOld.waypointAzimuth.getDeg(1.0F), f);

        CockpitP_38G10LO.this.setNew.vspeed = ((199.0F * CockpitP_38G10LO.this.setOld.vspeed + CockpitP_38G10LO.this.fm.getVertSpeed()) / 200.0F);
      }
