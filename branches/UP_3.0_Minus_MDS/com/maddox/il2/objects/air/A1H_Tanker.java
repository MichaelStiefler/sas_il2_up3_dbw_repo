    ...
    implements com.maddox.il2.objects.air.TypeDockable
{
    ...
    public A1H_Tanker()
    {
        drones = new com.maddox.il2.engine.Actor[2];
    }
    ...
    public void typeDockableDoAttachToDrone(com.maddox.il2.engine.Actor actor, int i)
    {
        if(!com.maddox.il2.engine.Actor.isValid(drones[i]))
        {
            ...
            super.pos.getAbs(loc1);
            hooknamed.computePos(((com.maddox.il2.engine.Actor) (this)), loc1, loc);
            com.maddox.il2.engine.HookNamed hooknamed1 = new HookNamed((com.maddox.il2.engine.ActorMesh)actor, "_Probe");
            com.maddox.il2.engine.Loc loc2 = new Loc();
            hooknamed1.computePos(((com.maddox.il2.engine.Actor) (this)), loc, loc2);
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", "3DO/Plane/A1H_Tanker(multi1)/hier.him");
