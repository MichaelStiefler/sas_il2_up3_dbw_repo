...
public class CockpitBF_109G2 extends CockpitPilot
{
  ...
  static
  {
    Property.set(CockpitBF_109G2.class, "normZN", 0.4F);
    Property.set(CockpitBF_109G2.class, "gsZN", 0.4F);
  }
  ...
  private class Variables
  {
    ...
    float mix;
    private final CockpitBF_109G2 this$0;
    ...
    Variables(CockpitBF_109G2.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      CockpitBF_109G2.access$002(CockpitBF_109G2.this, CockpitBF_109G2.this.setOld);
      CockpitBF_109G2.access$102(CockpitBF_109G2.this, CockpitBF_109G2.this.setNew);
      CockpitBF_109G2.access$202(CockpitBF_109G2.this, CockpitBF_109G2.this.setTmp);
      CockpitBF_109G2.this.setNew.altimeter = CockpitBF_109G2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_109G2.this.cockpitDimControl)
      {
        if (CockpitBF_109G2.this.setOld.dimPosition > 0.0F)
          CockpitBF_109G2.this.setOld.dimPosition = (CockpitBF_109G2.this.setTmp.dimPosition - 0.05F);
      }
      else if (CockpitBF_109G2.this.setOld.dimPosition < 1.0F)
        CockpitBF_109G2.this.setOld.dimPosition = (CockpitBF_109G2.this.setTmp.dimPosition + 0.05F);
      CockpitBF_109G2.this.setOld.throttle = ((10.0F * CockpitBF_109G2.this.setTmp.throttle + CockpitBF_109G2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109G2.this.setOld.mix = ((8.0F * CockpitBF_109G2.this.setTmp.mix + CockpitBF_109G2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109G2.this.setOld.azimuth = CockpitBF_109G2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109G2.this.setTmp.azimuth > 270.0F) && (CockpitBF_109G2.this.setOld.azimuth < 90.0F))
        CockpitBF_109G2.this.setTmp.azimuth -= 360.0F;
      if ((CockpitBF_109G2.this.setTmp.azimuth < 90.0F) && (CockpitBF_109G2.this.setOld.azimuth > 270.0F))
        CockpitBF_109G2.this.setTmp.azimuth += 360.0F;
      CockpitBF_109G2.this.setOld.waypointAzimuth = ((10.0F * CockpitBF_109G2.this.setTmp.waypointAzimuth + (CockpitBF_109G2.this.waypointAzimuth() - CockpitBF_109G2.this.setTmp.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitBF_109G2.this.buzzerFX((CockpitBF_109G2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.999999F) && (CockpitBF_109G2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.0F));
      return true;
    }
