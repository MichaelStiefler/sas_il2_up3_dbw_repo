    ...
    implements com.maddox.opengl.MsgGLContextListener
{
    ...
    public void render()
    {
        ...
        if(!(com.maddox.il2.ai.World.getPlayerFM() instanceof com.maddox.il2.fm.RealFlightModel))
        {
            ...
            {
                float f = 1.0F;
                f = com.maddox.il2.ai.World.getPlayerFM().AS.getPilotHealth(com.maddox.il2.game.Main3D.cur3D().cockpitCur.astatePilotIndx());
                float f1 = 1.0F - f;
        ...
        if(com.maddox.il2.game.Main3D.cur3D().cockpitCur != null)
            f2 = realflightmodel.AS.getPilotHealth(com.maddox.il2.game.Main3D.cur3D().cockpitCur.astatePilotIndx());
        float f3 = 1.0F - f2;
    ...
    private void renderPlus(float f)
    {
        ...
        for(int i = 0; i <= 16; i++)
        {
            com.maddox.opengl.gl.TexCoord2f(tnts[i].x, tnts[i].y);
