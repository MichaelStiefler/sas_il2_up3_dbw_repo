...
public class CockpitF4F3 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, floatindex(cvt(Pitot.Indicator((float)this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 692.01801F, 0.0F, 11.0F), speedometerScale), 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick() { if (CockpitF4F3.this.fm != null) {
        ...
        float f = CockpitF4F3.this.waypointAzimuth(10.0F);
        ...
        CockpitF4F3.this.setNew.vspeed = ((199.0F * CockpitF4F3.this.setOld.vspeed + CockpitF4F3.this.fm.getVertSpeed()) / 200.0F);
      }
