...
public class TYPHOON1BLate extends TEMPEST
{
  ...
  static
  {
    Class localClass = TYPHOON1BLate.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Typhoon");
    Property.set(localClass, "meshName", "3DO/Plane/TyphoonMkIBLate(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar05());
    Property.set(localClass, "yearService", 1942.0F);
    Property.set(localClass, "yearExpired", 1946.5F);
    Property.set(localClass, "FlightModel", "FlightModels/Typhoon1BLate.fmd");
