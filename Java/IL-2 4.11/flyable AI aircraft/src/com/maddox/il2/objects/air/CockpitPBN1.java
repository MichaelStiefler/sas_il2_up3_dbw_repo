// Source File Name: CockpitPBN1.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitPBN1.this.fm != null) {
				...
				CockpitPBN1.this.setNew.throttle1 = (0.85F * CockpitPBN1.this.setOld.throttle1)
						+ (CockpitPBN1.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitPBN1.this.setNew.throttle2 = (0.85F * CockpitPBN1.this.setOld.throttle2)
						+ (CockpitPBN1.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitPBN1.this.setNew.prop1 = (0.85F * CockpitPBN1.this.setOld.prop1)
						+ (CockpitPBN1.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitPBN1.this.setNew.prop2 = (0.85F * CockpitPBN1.this.setOld.prop2)
						+ (CockpitPBN1.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitPBN1.this.setNew.altimeter = CockpitPBN1.this.fm
						.getAltitude();
				float f = CockpitPBN1.this.waypointAzimuth();
				CockpitPBN1.this.setNew.azimuth.setDeg(
						CockpitPBN1.this.setOld.azimuth.getDeg(1.0F),
						CockpitPBN1.this.fm.Or.azimut());
				CockpitPBN1.this.setNew.waypointAzimuth
						.setDeg(CockpitPBN1.this.setOld.waypointAzimuth
								.getDeg(1.0F), f);
				CockpitPBN1.this.setNew.waypointDeviation.setDeg(
						CockpitPBN1.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitPBN1.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitPBN1.this.setNew.vspeed = ((199F * CockpitPBN1.this.setOld.vspeed) + CockpitPBN1.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
