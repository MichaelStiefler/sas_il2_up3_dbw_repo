...
public class CockpitFulmar extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitFulmar.this.bNeedSetUp)
      {
        ...
        CockpitFulmar.access$002(CockpitFulmar.this, false);
      }
      if (CockpitFulmar.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitFulmar.access$102(CockpitFulmar.this, CockpitFulmar.this.setOld);
        CockpitFulmar.access$202(CockpitFulmar.this, CockpitFulmar.this.setNew);
        CockpitFulmar.access$302(CockpitFulmar.this, CockpitFulmar.this.setTmp);
        CockpitFulmar.this.setNew.throttle = ((10.0F * CockpitFulmar.this.setOld.throttle + CockpitFulmar.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitFulmar.this.setNew.altimeter = CockpitFulmar.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitFulmar.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
          CockpitFulmar.this.setNew.azimuth = ((35.0F * CockpitFulmar.this.setOld.azimuth + -CockpitFulmar.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        if ((CockpitFulmar.this.setOld.azimuth > 270.0F) && (CockpitFulmar.this.setNew.azimuth < 90.0F))
          CockpitFulmar.this.setOld.azimuth -= 360.0F;
        if ((CockpitFulmar.this.setOld.azimuth < 90.0F) && (CockpitFulmar.this.setNew.azimuth > 270.0F))
          CockpitFulmar.this.setOld.azimuth += 360.0F;
        CockpitFulmar.this.setNew.waypointAzimuth = ((10.0F * CockpitFulmar.this.setOld.waypointAzimuth + (CockpitFulmar.this.waypointAzimuth() - CockpitFulmar.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitFulmar.this.setNew.vspeed = ((199.0F * CockpitFulmar.this.setOld.vspeed + CockpitFulmar.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitFulmar this$0;
    ...
    Variables(CockpitFulmar.1 arg2)
    {
      this();
    }
  }
