    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    {
        hierMesh().chunkSetAngles("GearC2_D0", com.maddox.il2.objects.air.Aircraft.cvt(f, -125F, 125F, -125F, 125F), 0.0F, 0.0F);
    }
    ...
    {
        float f1 = com.maddox.il2.objects.air.Aircraft.cvt(FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, -10F, 0.0F);
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.startsWith("xxeng1mag"))
                {
                    ...
                    com.maddox.il2.objects.air.Aircraft.debugprintln(this, "*** Engine Module: Magneto " + k + " Destroyed..");
                } else
                if(s.endsWith("sync"))
                {
