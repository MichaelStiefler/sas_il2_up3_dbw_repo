...
public class CockpitBF_109Z extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x8) == 0) {
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Throttle", interp(this.setNew.throttle1, this.setOld.throttle1, paramFloat) * 68.181816F, 0.0F, 0.0F);
    }
    if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x8) == 0) {
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Throttle2", interp(this.setNew.throttle2, this.setOld.throttle2, paramFloat) * 68.181816F, 0.0F, 0.0F);
    }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitBF_109Z.access$102(CockpitBF_109Z.this, CockpitBF_109Z.this.setOld); CockpitBF_109Z.access$202(CockpitBF_109Z.this, CockpitBF_109Z.this.setNew); CockpitBF_109Z.access$302(CockpitBF_109Z.this, CockpitBF_109Z.this.setTmp);
      ...
      if (CockpitBF_109Z.this.cockpitDimControl) {
        if (CockpitBF_109Z.this.setNew.dimPosition > 0.0F) CockpitBF_109Z.this.setNew.dimPosition = (CockpitBF_109Z.this.setOld.dimPosition - 0.05F);
      }
      else if (CockpitBF_109Z.this.setNew.dimPosition < 1.0F) CockpitBF_109Z.this.setNew.dimPosition = (CockpitBF_109Z.this.setOld.dimPosition + 0.05F);

      CockpitBF_109Z.this.setNew.throttle1 = (0.91F * CockpitBF_109Z.this.setOld.throttle1 + 0.09F * CockpitBF_109Z.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitBF_109Z.this.setNew.throttle2 = (0.91F * CockpitBF_109Z.this.setOld.throttle2 + 0.09F * CockpitBF_109Z.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitBF_109Z.this.setNew.mix1 = (0.88F * CockpitBF_109Z.this.setOld.mix1 + 0.12F * CockpitBF_109Z.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitBF_109Z.this.setNew.mix2 = (0.88F * CockpitBF_109Z.this.setOld.mix2 + 0.12F * CockpitBF_109Z.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitBF_109Z.this.setNew.azimuth = CockpitBF_109Z.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109Z.this.setOld.azimuth > 270.0F) && (CockpitBF_109Z.this.setNew.azimuth < 90.0F)) CockpitBF_109Z.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_109Z.this.setOld.azimuth < 90.0F) && (CockpitBF_109Z.this.setNew.azimuth > 270.0F)) CockpitBF_109Z.this.setOld.azimuth += 360.0F;
      CockpitBF_109Z.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_109Z.this.setOld.waypointAzimuth + (CockpitBF_109Z.this.waypointAzimuth() - CockpitBF_109Z.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitBF_109Z.1 arg2) { this();
    }
  }
}