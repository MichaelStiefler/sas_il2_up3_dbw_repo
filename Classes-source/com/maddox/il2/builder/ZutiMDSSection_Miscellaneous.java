...
public class ZutiMDSSection_Miscellaneous extends GWindowFramed
{
	...
	private int zutiMisc_MissionFlyDelay;
	...
	private GWindowEditControl wZutiMisc_MissionFlyDelay;
	...
	{
		doNew(Plugin.builder.clientWindow, 2.0F, 2.0F, 37.0F, 34.5F, true);
		bSizable = false;
	}
	...
	public void created()
	{
		...
		bSeparate_Refly = new GWindowBoxSeparate(gwindowdialogclient, 1.0F, 18.0F, 34.0F, 13.0F);
		...
		//wZutiMisc_MissionFlyDelay
		gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 2.0F, 29.0F, 33.0F, 1.3F, Plugin.i18n("mds.refly.flyDelay"), null));
		gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 33.5F, 29.0F, 33.0F, 1.3F, Plugin.i18n("mds.second"), null));
		gwindowdialogclient.addControl(wZutiMisc_MissionFlyDelay = new GWindowEditControl(gwindowdialogclient, 29.0F, 29.0F, 4.0F, 1.3F, "")
		{
			public void afterCreated()
			{
				super.afterCreated();
	...
	private void setUIVariables()
	{
		...
		wZutiMisc_MissionFlyDelay.setValue(new Integer(zutiMisc_MissionFlyDelay).toString(), false);
	}
	...
	private void setMDSVariables()
	{
		...
		zutiMisc_MissionFlyDelay = Integer.parseInt(wZutiMisc_MissionFlyDelay.getValue());
	...
	public void loadVariables(SectFile sectfile)
	{
		try
		{
			...
			zutiMisc_MissionFlyDelay = sectfile.get(SECTION_ID, "ZutiMisc_MissionFlyDelay", 0, 0, 99999);
	...
	public void saveVariables(SectFile sectfile)
	{
		try
		{
			...
			sectfile.lineAdd(sectionIndex, "ZutiMisc_MissionFlyDelay", new Integer(zutiMisc_MissionFlyDelay).toString());
		}
		catch(Exception ex)
		{
			ex.printStackTrace();
