...
// Source File Name:   OBSGeneric.java
...
public abstract class OBSGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.OBSGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.OBSGeneric.Rnd(30F, 30F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.OBSGeneric obsgeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.OBSGeneric.constr_arg2 = actorspawnarg;
                obsgeneric = (com.maddox.il2.objects.vehicles.stationary.OBSGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.OBSGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create OBSGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (obsgeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.OBSGeneric.mesh_name);
            cls = class1;
    ...
    private OBSGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry1 = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry1 != null; entry1 = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry1))
        {
            ...
            if(com.maddox.il2.engine.Actor.isAlive(actor1) && (actor1 instanceof com.maddox.il2.objects.air.Aircraft) && actor1.getArmy() != myArmy && actor1.pos.getAbsPoint().distance(point3d) < 15000D)
            {
                pos.getAbs(point3d);
                ...
                if(actor1 instanceof com.maddox.il2.objects.air.TypeBomber)
                    s1 = "bombers";
                else
                if(actor1 instanceof com.maddox.il2.objects.air.TypeFighter)
                    s1 = "fighters";
                if(!flag)
                    com.maddox.il2.game.HUD.logCenter("                                                                     Enemy " + s1 + " at map grid " + s + "-" + d7 + ", altitude " + d5 + "m");
            }
        }
