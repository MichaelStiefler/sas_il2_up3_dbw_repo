...
public class CockpitSpit9ECLP extends CockpitPilot
{
  ...
  public CockpitSpit9ECLP() {
    super("3DO/Cockpit/SpitfireMkIXc/spitECLP.him", "bf109");
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    int i = ((SPITFIRE9ECLP)aircraft()).k14Mode;
    boolean bool = i < 2;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitSpit9ECLP this$0;
    ...
    Variables(CockpitSpit9ECLP.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit9ECLP.this.bNeedSetUp) {
        CockpitSpit9ECLP.this.reflectPlaneMats();
        CockpitSpit9ECLP.access$102(CockpitSpit9ECLP.this, false);
      }
      if (CockpitSpit9ECLP.this.fm != null) {
        CockpitSpit9ECLP.access$202(CockpitSpit9ECLP.this, CockpitSpit9ECLP.this.setOld);
        CockpitSpit9ECLP.access$302(CockpitSpit9ECLP.this, CockpitSpit9ECLP.this.setNew);
        CockpitSpit9ECLP.access$402(CockpitSpit9ECLP.this, CockpitSpit9ECLP.this.setTmp);
        CockpitSpit9ECLP.this.setNew.throttle = (0.92F * CockpitSpit9ECLP.this.setOld.throttle + 0.08F * CockpitSpit9ECLP.this.fm.CT.PowerControl);

        CockpitSpit9ECLP.this.setNew.prop = (0.92F * CockpitSpit9ECLP.this.setOld.prop + 0.08F * CockpitSpit9ECLP.this.fm.EI.engines[0].getControlProp());

        CockpitSpit9ECLP.this.setNew.mix = (0.92F * CockpitSpit9ECLP.this.setOld.mix + 0.08F * CockpitSpit9ECLP.this.fm.EI.engines[0].getControlMix());

        CockpitSpit9ECLP.this.setNew.altimeter = CockpitSpit9ECLP.this.fm.getAltitude();
        if (Math.abs(CockpitSpit9ECLP.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit9ECLP.this.setNew.azimuth = (0.97F * CockpitSpit9ECLP.this.setOld.azimuth + 0.03F * -CockpitSpit9ECLP.this.fm.Or.getYaw());
        }
        if ((CockpitSpit9ECLP.this.setOld.azimuth > 270.0F) && (CockpitSpit9ECLP.this.setNew.azimuth < 90.0F))
          CockpitSpit9ECLP.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit9ECLP.this.setOld.azimuth < 90.0F) && (CockpitSpit9ECLP.this.setNew.azimuth > 270.0F))
          CockpitSpit9ECLP.this.setOld.azimuth += 360.0F;
        CockpitSpit9ECLP.this.setNew.waypointAzimuth = (0.91F * CockpitSpit9ECLP.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit9ECLP.this.waypointAzimuth() - CockpitSpit9ECLP.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitSpit9ECLP.this.setNew.vspeed = (0.99F * CockpitSpit9ECLP.this.setOld.vspeed + 0.01F * CockpitSpit9ECLP.this.fm.getVertSpeed());

        float f1 = ((SPITFIRE9ECLP)CockpitSpit9ECLP.this.aircraft()).k14Distance;

        CockpitSpit9ECLP.this.setNew.k14w = (5.0F * CockpitSpit9ECLP.k14TargetWingspanScale[((SPITFIRE9ECLP)CockpitSpit9ECLP.this.aircraft()).k14WingspanType] / f1);

        CockpitSpit9ECLP.this.setNew.k14w = (0.9F * CockpitSpit9ECLP.this.setOld.k14w + 0.1F * CockpitSpit9ECLP.this.setNew.k14w);
        CockpitSpit9ECLP.this.setNew.k14wingspan = (0.9F * CockpitSpit9ECLP.this.setOld.k14wingspan + 0.1F * CockpitSpit9ECLP.k14TargetMarkScale[((SPITFIRE9ECLP)CockpitSpit9ECLP.this.aircraft()).k14WingspanType]);

        CockpitSpit9ECLP.this.setNew.k14mode = (0.8F * CockpitSpit9ECLP.this.setOld.k14mode + 0.2F * ((SPITFIRE9ECLP)CockpitSpit9ECLP.this.aircraft()).k14Mode);

        Vector3d localVector3d = CockpitSpit9ECLP.this.aircraft().FM.getW();

        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitSpit9ECLP.this.floatindex((f1 - 200.0F) * 0.04F, CockpitSpit9ECLP.k14BulletDrop) - CockpitSpit9ECLP.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitSpit9ECLP.this.setNew.k14x = (0.92F * CockpitSpit9ECLP.this.setOld.k14x + 0.08F * f2);
        CockpitSpit9ECLP.this.setNew.k14y = (0.92F * CockpitSpit9ECLP.this.setOld.k14y + 0.08F * f3);
        if (CockpitSpit9ECLP.this.setNew.k14x > 7.0F)
          CockpitSpit9ECLP.this.setNew.k14x = 7.0F;
        if (CockpitSpit9ECLP.this.setNew.k14x < -7.0F)
          CockpitSpit9ECLP.this.setNew.k14x = -7.0F;
        if (CockpitSpit9ECLP.this.setNew.k14y > 7.0F)
          CockpitSpit9ECLP.this.setNew.k14y = 7.0F;
        if (CockpitSpit9ECLP.this.setNew.k14y < -7.0F)
          CockpitSpit9ECLP.this.setNew.k14y = -7.0F;
      }
      return true;
