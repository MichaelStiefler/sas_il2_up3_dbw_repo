...
public class CockpitPBN1 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitPBN1.access$002(CockpitPBN1.this, CockpitPBN1.this.setOld);
        CockpitPBN1.access$102(CockpitPBN1.this, CockpitPBN1.this.setNew);
        CockpitPBN1.access$202(CockpitPBN1.this, CockpitPBN1.this.setTmp);
        CockpitPBN1.this.setNew.throttle1 = (0.85F * CockpitPBN1.this.setOld.throttle1 + CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitPBN1.this.setNew.throttle2 = (0.85F * CockpitPBN1.this.setOld.throttle2 + CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitPBN1.this.setNew.prop1 = (0.85F * CockpitPBN1.this.setOld.prop1 + CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitPBN1.this.setNew.prop2 = (0.85F * CockpitPBN1.this.setOld.prop2 + CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitPBN1.this.setNew.altimeter = CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitPBN1.this.waypointAzimuth();
        CockpitPBN1.this.setNew.azimuth.setDeg(CockpitPBN1.this.setOld.azimuth.getDeg(1.0F), CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitPBN1.this.setNew.waypointAzimuth.setDeg(CockpitPBN1.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitPBN1.this.setNew.waypointDeviation.setDeg(CockpitPBN1.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitPBN1.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitPBN1.this.setNew.vspeed = ((199.0F * CockpitPBN1.this.setOld.vspeed + CockpitPBN1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitPBN1 this$0;
