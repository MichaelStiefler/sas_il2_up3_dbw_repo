...
public class CockpitP_36 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Pres1", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure(), 0.338638F, 1.71F, 0.0F, 343.5F), 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_FuelPres", 0.0F, cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 4.0F, 0.0F, -180.0F), 0.0F);
  ...
  private class Variables
  {
    ...
    private final CockpitP_36 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitP_36.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitP_36.access$002(CockpitP_36.this, CockpitP_36.this.setOld);
        CockpitP_36.access$102(CockpitP_36.this, CockpitP_36.this.setNew);
        CockpitP_36.access$202(CockpitP_36.this, CockpitP_36.this.setTmp);
        CockpitP_36.this.setNew.throttle = ((10.0F * CockpitP_36.this.setOld.throttle + CockpitP_36.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
        CockpitP_36.this.setNew.prop = ((8.0F * CockpitP_36.this.setOld.prop + CockpitP_36.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl()) / 9.0F);
        CockpitP_36.this.setNew.altimeter = CockpitP_36.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitP_36.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 45.0F)
          CockpitP_36.this.setNew.azimuth = ((35.0F * CockpitP_36.this.setOld.azimuth + -CockpitP_36.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        if ((CockpitP_36.this.setOld.azimuth > 270.0F) && (CockpitP_36.this.setNew.azimuth < 90.0F))
          CockpitP_36.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_36.this.setOld.azimuth < 90.0F) && (CockpitP_36.this.setNew.azimuth > 270.0F))
          CockpitP_36.this.setOld.azimuth += 360.0F;
        CockpitP_36.this.setNew.waypointAzimuth = ((10.0F * CockpitP_36.this.setOld.waypointAzimuth + (CockpitP_36.this.waypointAzimuth() - CockpitP_36.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitP_36.this.setNew.vspeed = ((199.0F * CockpitP_36.this.setOld.vspeed + CockpitP_36.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
