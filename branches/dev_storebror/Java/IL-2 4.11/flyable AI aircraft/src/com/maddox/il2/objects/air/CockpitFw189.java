// Source File Name: CockpitFw189.java
...
public class CockpitFw189 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			CockpitFw189.this.setNew.altimeter = CockpitFw189.this.fm
					.getAltitude();
			CockpitFw189.this.setNew.throttlel = ((10F * CockpitFw189.this.setOld.throttlel) + CockpitFw189.this.fm.EI.engines[0]
					.getControlThrottle()) / 11F;
			CockpitFw189.this.setNew.throttler = ((10F * CockpitFw189.this.setOld.throttler) + CockpitFw189.this.fm.EI.engines[1]
					.getControlThrottle()) / 11F;
			CockpitFw189.this.setNew.azimuth = CockpitFw189.this.fm.Or.getYaw();
			if ((CockpitFw189.this.setOld.azimuth > 270F)
					&& (CockpitFw189.this.setNew.azimuth < 90F)) {
				CockpitFw189.this.setOld.azimuth -= 360F;
			}
			if ((CockpitFw189.this.setOld.azimuth < 90F)
					&& (CockpitFw189.this.setNew.azimuth > 270F)) {
				CockpitFw189.this.setOld.azimuth += 360F;
			}
			CockpitFw189.this.setNew.waypointAzimuth = ((10F * CockpitFw189.this.setOld.waypointAzimuth)
					+ (CockpitFw189.this.waypointAzimuth() - CockpitFw189.this.setOld.azimuth) + World
					.Rnd().nextFloat(-30F, 30F)) / 11F;
			CockpitFw189.this.setNew.vspeed = ((499F * CockpitFw189.this.setOld.vspeed) + CockpitFw189.this.fm
					.getVertSpeed()) / 500F;
			if (CockpitFw189.this.fm.isTick(12, 0)) {
				Airport airport = Airport.nearest(CockpitFw189.this.fm.Loc, -1,
						1);
				if ((airport != null)
						&& airport.nearestRunway(CockpitFw189.this.fm.Loc,
								CockpitFw189.this.tmpLoc)) {
					CockpitFw189.this.tmpLoc.transformInv(
							CockpitFw189.this.fm.Loc, CockpitFw189.this.tmpP);
					...
					CockpitFw189.this.tmpV.z -= 0.034899000078439713D;
					if (CockpitFw189.this.tmpV.x > 0.95999997854232788D) {
						if (CockpitFw189.this.tmpV.y > 0.0D) {
							CockpitFw189.this.setNew.blindDotX = 1.889F * (float) Math
									.sqrt(CockpitFw189.this.tmpV.y);
						} else {
							CockpitFw189.this.setNew.blindDotX = -1.889F
									* (float) Math
											.sqrt(-CockpitFw189.this.tmpV.y);
						}
						if (CockpitFw189.this.tmpV.z > 0.0D) {
							CockpitFw189.this.setNew.blindDotY = 1.889F * (float) Math
									.sqrt(CockpitFw189.this.tmpV.z);
						} else {
							CockpitFw189.this.setNew.blindDotY = -1.889F
									* (float) Math
											.sqrt(-CockpitFw189.this.tmpV.z);
						}
					} else {
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("zFuel1",
				this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 330F, 0.0F, 140F), 0.0F,
				0.0F);
