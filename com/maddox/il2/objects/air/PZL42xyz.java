...
// Source File Name:   PZL42xyz.java
...
public abstract class PZL42xyz extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeStormovik
{
    ...
    {
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("Rudder1_D0", 0.0F, -20F * f, 0.0F);
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("Rudder2_D0", 0.0F, -20F * f, 0.0F);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxlock"))
            {
                ...
                if(s.startsWith("xxlockr1") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.5F), shot) > 0.0F)
                {
                ...
                if(s.startsWith("xxlockr2") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.5F), shot) > 0.0F)
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Lock Construction: Rudder2 Lock Shot Off..");
                    ((com.maddox.il2.objects.air.Aircraft)this).nextDMGLevels(3, 2, "Rudder2_D" + ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Rudder2"), shot.initiator);
                }
                if(s.startsWith("xxlockvl") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.5F), shot) > 0.0F)
                {
                ...
                if(s.startsWith("xxlockvr") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.5F), shot) > 0.0F)
                {
        ...
        if(!s.startsWith("xblister"))
            ...
            {
                if(s.startsWith("xkeel1") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Keel1") < 2)
                    ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Keel1", shot);
                if(s.startsWith("xkeel2") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Keel2") < 2)
                    ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Keel2", shot);
            } else
            if(s.startsWith("xrudder"))
            {
                if(s.startsWith("xrudder1") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Rudder1") < 2)
                    ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Rudder1", shot);
                if(s.startsWith("xrudder2") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Rudder2") < 2)
                    ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Rudder2", shot);
            } else
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.PZL42xyz.class;
