  ...
  implements TypeFighter
{
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    paramHierMesh.chunkSetAngles("GearR8_D0", 0.0F, 0.0F, -90.0F * paramFloat);
  }
  ...
  public void moveWheelSink() { resetYPRmodifier();
    ...
    hierMesh().chunkSetAngles("GearL5_D0", 0.0F, cvt(xyz[1], 0.0F, 0.15F, 0.0F, -30.0F), 0.0F);
    hierMesh().chunkSetAngles("GearL4_D0", 0.0F, cvt(xyz[1], 0.0F, 0.15F, 0.0F, -60.0F), 0.0F);
    xyz[1] = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.15F, 0.0F, 0.15F);
    hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
    hierMesh().chunkSetAngles("GearR5_D0", 0.0F, cvt(xyz[1], 0.0F, 0.15F, 0.0F, -30.0F), 0.0F);
    hierMesh().chunkSetAngles("GearR4_D0", 0.0F, cvt(xyz[1], 0.0F, 0.15F, 0.0F, -60.0F), 0.0F);
  }
  ...
  public void update(float paramFloat)
  {
    if (this.FM.getSpeed() > 5.0F) {
      resetYPRmodifier();
      xyz[0] = cvt(this.FM.getAOA(), 6.8F, 11.0F, 0.0F, -0.025F);
      xyz[2] = cvt(this.FM.getAOA(), 6.8F, 11.0F, 0.0F, 0.0125F);
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxarmor")) {
        if (paramString.endsWith("p1"))
          ...
          getEnergyPastArmor(8.05F / (1.0E-005F + (float)Math.abs(v1.x)), paramShot);
        }
        return;
      }
      if (paramString.startsWith("xxcontrols")) {
        if (getEnergyPastArmor(3.276F, paramShot) > 0.0F) {
