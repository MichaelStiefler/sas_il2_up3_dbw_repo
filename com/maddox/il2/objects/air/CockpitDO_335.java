...
public class CockpitDO_335 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitDO_335.access$102(CockpitDO_335.this, CockpitDO_335.this.setOld); CockpitDO_335.access$202(CockpitDO_335.this, CockpitDO_335.this.setNew); CockpitDO_335.access$302(CockpitDO_335.this, CockpitDO_335.this.setTmp);

        CockpitDO_335.this.setNew.throttle1 = (0.85F * CockpitDO_335.this.setOld.throttle1 + CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitDO_335.this.setNew.prop1 = (0.85F * CockpitDO_335.this.setOld.prop1 + CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitDO_335.this.setNew.mix1 = (0.85F * CockpitDO_335.this.setOld.mix1 + CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix() * 0.15F);
        CockpitDO_335.this.setNew.throttle2 = (0.85F * CockpitDO_335.this.setOld.throttle2 + CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitDO_335.this.setNew.prop2 = (0.85F * CockpitDO_335.this.setOld.prop2 + CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitDO_335.this.setNew.mix2 = (0.85F * CockpitDO_335.this.setOld.mix2 + CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix() * 0.15F);
        CockpitDO_335.this.setNew.altimeter = CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitDO_335.this.waypointAzimuth();
        CockpitDO_335.this.setNew.waypointAzimuth.setDeg(CockpitDO_335.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitDO_335.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-2.0F, 2.0F));
        CockpitDO_335.this.setNew.azimuth.setDeg(CockpitDO_335.this.setOld.azimuth.getDeg(1.0F), CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitDO_335.this.setNew.vspeed = ((199.0F * CockpitDO_335.this.setOld.vspeed + CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitDO_335.this.cockpitDimControl) {
          if (CockpitDO_335.this.setNew.dimPosition > 0.0F) CockpitDO_335.this.setNew.dimPosition = (CockpitDO_335.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitDO_335.this.setNew.dimPosition < 1.0F) CockpitDO_335.this.setNew.dimPosition = (CockpitDO_335.this.setOld.dimPosition + 0.05F);

        World.cur(); World.land(); CockpitDO_335.this.setNew.radioalt = (0.9F * CockpitDO_335.this.setOld.radioalt + 0.1F * (CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude() - Landscape.HQ_Air((float)CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.x, (float)CockpitDO_335.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y)));
      }
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float radioalt;
    private final CockpitDO_335 this$0;
    ...
    Variables(CockpitDO_335.1 arg2)
    {
      this();
    }
  }
