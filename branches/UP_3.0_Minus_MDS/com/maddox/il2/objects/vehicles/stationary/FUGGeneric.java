...
// Source File Name:   FUGGeneric.java
...
public abstract class FUGGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.FUGGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.FUGGeneric.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.FUGGeneric fuggeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.FUGGeneric.constr_arg2 = actorspawnarg;
                fuggeneric = (com.maddox.il2.objects.vehicles.stationary.FUGGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.FUGGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create FUGGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (fuggeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.FUGGeneric.mesh_name);
            cls = class1;
    ...
    private FUGGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
            ...
            for(int l = 0; l < k; l++)
            {
                ...
                if((actor instanceof com.maddox.il2.objects.air.Aircraft) && actor != com.maddox.il2.ai.World.getPlayerAircraft() && actor.getArmy() != myArmy)
                {
                    ...
                    if(l1 < 0)
                        l1 = 360 + l1;
                    int i2 = l1 - j;
                    if((float)k1 <= f && (double)k1 >= 200D && i2 >= 235 && i2 <= 305 && java.lang.Math.sqrt(j1 * j1) <= 35D && actor.getSpeed(vector3d) > 20D)
                    {
