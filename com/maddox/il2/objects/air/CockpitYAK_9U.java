...
public class CockpitYAK_9U extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_9U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitYAK_9U.access$102(CockpitYAK_9U.this, CockpitYAK_9U.this.setOld); CockpitYAK_9U.access$202(CockpitYAK_9U.this, CockpitYAK_9U.this.setNew); CockpitYAK_9U.access$302(CockpitYAK_9U.this, CockpitYAK_9U.this.setTmp);

        CockpitYAK_9U.this.setNew.throttle = ((10.0F * CockpitYAK_9U.this.setOld.throttle + CockpitYAK_9U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_9U.this.setNew.prop = ((10.0F * CockpitYAK_9U.this.setOld.prop + CockpitYAK_9U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_9U.this.setNew.altimeter = CockpitYAK_9U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_9U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_9U.this.setNew.azimuth = ((35.0F * CockpitYAK_9U.this.setOld.azimuth + CockpitYAK_9U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitYAK_9U.this.setOld.azimuth > 270.0F) && (CockpitYAK_9U.this.setNew.azimuth < 90.0F)) CockpitYAK_9U.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_9U.this.setOld.azimuth < 90.0F) && (CockpitYAK_9U.this.setNew.azimuth > 270.0F)) CockpitYAK_9U.this.setOld.azimuth += 360.0F;
        CockpitYAK_9U.this.setNew.vspeed = ((199.0F * CockpitYAK_9U.this.setOld.vspeed + CockpitYAK_9U.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_9U this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitYAK_9U.1 arg2) { this();
    }
  }
}