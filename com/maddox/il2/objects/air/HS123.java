  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  static
  {
    Class localClass = HS123.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "HS123");
    Property.set(localClass, "meshName", "3DO/Plane/Hs123/hier.him");
    ...
    Property.set(localClass, "cockpitClass", new Class[] { CockpitHS123.class });
    Property.set(localClass, "FlightModel", "FlightModels/HS123.fmd");
    ...
    try
    {
      ...
      for (int j = 0; j < 2; j++) arrayOf_WeaponSlot[j] = new Aircraft._WeaponSlot(0, "MGunMG17si", 500);
      for (j = 2; j < i; j++) arrayOf_WeaponSlot[j] = null;
      ...
      for (j = 0; j < 2; j++) arrayOf_WeaponSlot[j] = new Aircraft._WeaponSlot(0, "MGunMG17si", 500);
      for (j = 2; j < i; j++) arrayOf_WeaponSlot[j] = new Aircraft._WeaponSlot(3, "BombGunSC50", 2);
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
