...
public class CockpitTB_3_Bombardier3 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitTB_3_Bombardier3.this.mesh.chunkSetAngles("zScaleKM", 0.04F * CockpitTB_3_Bombardier3.this.curAlt, 0.0F, 0.0F);
      CockpitTB_3_Bombardier3.this.mesh.chunkSetAngles("zScaleM", 0.36F * CockpitTB_3_Bombardier3.this.curAlt, 0.0F, 0.0F);
      CockpitTB_3_Bombardier3.this.mesh.chunkSetAngles("zScaleKMH", -0.8F * (CockpitTB_3_Bombardier3.this.curSpd - 50.0F), 0.0F, 0.0F);
      ...
      CockpitTB_3_Bombardier3.this.mesh.chunkSetLocate("zScaleCurve", Cockpit.xyz, Cockpit.ypr);
      if (Math.abs(CockpitTB_3_Bombardier3.this.fm.Or.getKren()) < 30.0D) {
        CockpitTB_3_Bombardier3.this.mesh.chunkSetAngles("Z_Compass1", 0.0F, -CockpitTB_3_Bombardier3.this.fm.Or.getYaw(), 0.0F);
      }
      if (Math.abs(CockpitTB_3_Bombardier3.this.fm.Or.getKren()) > 3.5D) {
        CockpitTB_3_Bombardier3.access$224(CockpitTB_3_Bombardier3.this, 0.0004F * CockpitTB_3_Bombardier3.this.fm.Or.getKren());
        ...
        CockpitTB_3_Bombardier3.this.mesh.chunkSetLocate("Z_Pencil1", Cockpit.xyz, Cockpit.ypr);
        CockpitTB_3_Bombardier3.this.mesh.chunkSetAngles("Z_Pencilrot1", 0.0F, 11459.156F * CockpitTB_3_Bombardier3.this.pencilDisp, 0.0F);
      }

      CockpitTB_3_Bombardier3.this.mesh.chunkSetAngles("Z_ANO1", 0.0F, CockpitTB_3_Bombardier3.this.fm.AS.bNavLightsOn ? -50.0F : 0.0F, 0.0F);
      CockpitTB_3_Bombardier3.this.mesh.chunkSetAngles("Z_CockpLight1", 0.0F, CockpitTB_3_Bombardier3.this.cockpitLightControl ? -50.0F : 0.0F, 0.0F);
      return true;
    }
  }
}