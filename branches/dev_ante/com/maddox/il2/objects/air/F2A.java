  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  public void moveWheelSink() {
    resetYPRmodifier();
    Aircraft.xyz[2] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[0], 0.0F, 0.2225F, 0.0F, 0.2225F);
    hierMesh().chunkSetLocate("GearL15_D0", Aircraft.xyz, Aircraft.ypr);
    Aircraft.xyz[2] = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.gWheelSinking[1], 0.0F, 0.2225F, 0.0F, 0.2225F);
    hierMesh().chunkSetLocate("GearR15_D0", Aircraft.xyz, Aircraft.ypr);
  }
  public void moveArrestorHook(float paramFloat) {
    resetYPRmodifier();
    Aircraft.xyz[2] = (1.61F * paramFloat);
    Aircraft.ypr[1] = (-6.0F * paramFloat + this.arrestor);
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
      ...
      if (paramString.startsWith("xxeng1")) {
        ...
        if (paramString.endsWith("case")) {
          if (getEnergyPastArmor(0.2F, paramShot) > 0.0F) {
            ...
            this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].setReadyness(paramShot.initiator, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getReadyness() - 0.02F);
        ...
        if (paramString.endsWith("cyls")) {
          if ((getEnergyPastArmor(0.85F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getCylindersRatio() * 1.75F)) {
    ...
    if (paramString.startsWith("xcf")) {
      ...
      if ((paramPoint3d.jdField_x_of_type_Double > -1.35D) && (paramPoint3d.jdField_x_of_type_Double < 0.0D)) {
        if (paramPoint3d.z > 0.636D) {
          if (paramPoint3d.jdField_x_of_type_Double < -0.367D)
        ...
        if ((paramPoint3d.jdField_x_of_type_Double > -0.419D) && (paramPoint3d.jdField_x_of_type_Double < -0.209D))
          this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.setCockpitState(paramShot.initiator, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState | 0x40);
      }
    }
  ...
  public void update(float paramFloat)
  {
    ...
    float f2 = this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.CT.getArrestor();
    ...
    if (f2 > 0.01F)
    {
      if (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.arrestorVAngle != 0.0F) { this.arrestor = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.arrestorVAngle, -f3, f3, -f3, f3);
        ...
        float f1 = 58.0F * this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.arrestorVSink;
