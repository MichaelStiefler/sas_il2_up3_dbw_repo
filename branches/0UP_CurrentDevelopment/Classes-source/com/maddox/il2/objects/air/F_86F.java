...
//            TypeFighterAceMaker, TypeStormovik, TypeGSuit, Aircraft, 
//            Cockpit, AircraftLH, PaintScheme, EjectionSeat
    ...
    implements com.maddox.il2.objects.air.TypeSupersonic, com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeFighterAceMaker, com.maddox.il2.objects.air.TypeStormovik, com.maddox.il2.objects.air.TypeGSuit
{
    ...
    public void rareAction(float paramFloat, boolean paramBoolean)
    {
        ...
        if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.isMaster() && com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            ...
            f_86f.mn = f / com.maddox.il2.fm.Atmosphere.sonicSpeed((float)((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (super.FM)).Loc)).z);
...
;
    ...
    {
        com.maddox.il2.objects.air.F_86F.moveGear(hierMesh(), paramFloat);
    }
    ...
    public void update(float paramFloat)
    {
        ...
        if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).AS.isMaster() && com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            ...
            {
                if(((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getPowerOutput() > 0.65F)
