...
// Source File Name:   CockpitSM79_LGunner.java
...
public class CockpitSM79_LGunner extends com.maddox.il2.objects.air.CockpitGunner
{
    ...
    protected void interpTick()
    {
        ...
        {
            if(hook1 == null)
                hook1 = new HookNamed(aircraft(), "_12,7_04");
            doHitMasterAircraft(aircraft(), hook1, "_12,7_04");
            if(iCocking > 0)
                iCocking = 0;
            else
                iCocking = 1;
        ...
        if(emitter != null)
        {
            ...
            mesh.chunkVisible("ZTurret4B-Bullet0", flag);
            mesh.chunkVisible("ZTurret4B-Bullet1", !flag);
        }
    }
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitSM79_LGunner.class, "aiTuretNum", 2);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitSM79_LGunner.class, "weaponControlNum", 12);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitSM79_LGunner.class, "astatePilotIndx", 4);
    }
}
