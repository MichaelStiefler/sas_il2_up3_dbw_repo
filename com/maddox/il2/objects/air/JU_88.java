...
public abstract class JU_88 extends Scheme2
{
  ...
  public boolean turretAngles(int paramInt, float[] paramArrayOfFloat) {
    ...
    case 2:
      ...
      if (f1 < -2.0F) {
        ...
        f2 = Aircraft.cvt(f1, 0.5F, 5.3F, -2.3F, -2.3F); } else {
  ...
  public void rareAction(float paramFloat, boolean paramBoolean) {
    ...
    if ((paramBoolean) && (World.Rnd().nextFloat() < 0.8F)) {
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx"))
    {
      ...
      if (paramString.startsWith("xxengine"))
      {
        ...
        {
          mydebuggunnery("*** Engine " + i + " " + paramString + " hit");
          if ((getEnergyPastArmor(1.0F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < this.FM.EI.engines[i].getCylindersRatio() * 3.0F))
          {
      ...
      if (paramString.startsWith("xxtank"))
      {
        ...
        if (getEnergyPastArmor(0.5F, paramShot) > 0.0F)
        {
          if (paramShot.power < 14100.0F)
          {
            ...
            if ((this.FM.AS.astateTankStates[i] < 4) && (World.Rnd().nextFloat() < 0.2F))
              this.FM.AS.hitTank(paramShot.initiator, i, 1);
    ...
    else if (paramString.startsWith("xengine1"))
    {
      ...
      {
        this.FM.EI.engines[0].setReadyness(paramShot.initiator, this.FM.EI.engines[0].getReadyness() - World.Rnd().nextFloat(0.0F, paramShot.power / 70000.0F));
    ...
    else if (paramString.startsWith("xengine2"))
    {
      ...
      if (getEnergyPastArmor(0.2F, paramShot) > 800.0F)
      {
        this.FM.EI.engines[1].setReadyness(paramShot.initiator, this.FM.EI.engines[1].getReadyness() - World.Rnd().nextFloat(0.0F, paramShot.power / 70000.0F));
    ...
    else if ((paramString.startsWith("GearR")) || (paramString.startsWith("GearL")))
    {
      if (World.Rnd().nextFloat() < 0.1F)
      {
