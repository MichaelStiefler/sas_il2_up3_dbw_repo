...
public class Pathes extends com.maddox.il2.engine.Actor
{
    ...
    public void renderMap2D(boolean flag, int i)
    {
        ...
        for(int j1 = 0; j1 < pathes.length; j1++)
        {
            ...
            com.maddox.il2.builder.PPoint ppoint1 = null;
            boolean flag1 = false;
            ...
            for(int i3 = 0; i3 < points.length; i3++)
            {
                ...
                {
                    boolean flag3;
                    for(flag3 = ppoint3.screenQuad == 8 || ppoint1.screenQuad == 8; !flag3 && ppoint3.screenQuad != ppoint1.screenQuad && ppoint3.screenQuad != (ppoint1.screenQuad + 1 & 7) && ppoint1.screenQuad != (ppoint3.screenQuad + 1 & 7) && ((ppoint3.screenQuad & 1) != 0 || (ppoint1.screenQuad & 1) != 0 || ppoint3.screenQuad != (ppoint1.screenQuad + 2 & 7) && ppoint1.screenQuad != (ppoint3.screenQuad + 2 & 7)); flag3 = true);
                    if(flag3)
                    {
                        if(!flag1)
                        {
                            ...
                            lineNXYZ[lineNCounter * 3 + 0] = (float)ppoint1.screenX;
                            lineNXYZ[lineNCounter * 3 + 1] = (float)ppoint1.screenY;
                            lineNXYZ[lineNCounter * 3 + 2] = 0.0F;
                            lineNCounter++;
                        }
        ...
        if(j != 0)
        {
            ...
            for(int k1 = 0; k1 < pathes.length; k1++)
            {
                ...
                {
                    com.maddox.il2.builder.PPoint ppoint2 = (com.maddox.il2.builder.PPoint)points[k2];
                    points[k2] = null;
                    if(ppoint2 == null)
                        break;
        ...
        for(int l1 = 0; l1 < pathes.length; l1++)
        {
            ...
            {
                com.maddox.il2.builder.PAir pair = (com.maddox.il2.builder.PAir)points[l2];
                points[l2] = null;
                if(pair == null)
                    break;
        ...
        if(j != 0 && com.maddox.il2.engine.Actor.isValid(com.maddox.il2.builder.Path.player) && com.maddox.il2.builder.Path.player.renderPoints != 0)
        {
            ...
            do
            {
                if(i2 >= points.length)
                    break;
                com.maddox.il2.builder.PPoint ppoint = (com.maddox.il2.builder.PPoint)points[i2];
                if(ppoint == null)
                    break;
                if(ppoint.screenQuad == 8)
                {
                    com.maddox.il2.engine.Render.drawTile((float)ppoint.screenX, (float)ppoint.screenY, i, i, 0.0F, com.maddox.il2.builder.Plugin.playerIcon, com.maddox.il2.ai.Army.color(com.maddox.il2.builder.Path.player.getArmy()), 0.0F, 1.0F, 1.0F, -1F);
                    break;
                }
                i2++;
            } while(true);
