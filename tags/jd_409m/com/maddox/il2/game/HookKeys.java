...
public class HookKeys
{
  ...
  private void initSnapKeys() {
    ...
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_0_0", "01") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, 0, 0); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, 0, 0);  } 
      public void created() {
        setRecordId(61);
      }
    });
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_0_1", "02") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, 0, 1); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, 0, 1);  } 
      public void created() {
        setRecordId(62);
      }
    });
    ...
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_m1_0", "04") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, -1, 0); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, -1, 0);  } 
      public void created() {
        setRecordId(64);
      }
    });
    ...
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_m1_1", "06") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, -1, 1); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, -1, 1);  } 
      public void created() {
        setRecordId(66);
      }
    });
    ...
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_m3_0", "10") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, -3, 0); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, -3, 0);  } 
      public void created() {
        setRecordId(70);
      }
    });
    ...
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_m3_1", "12") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, -3, 1); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, -3, 1);  } 
      public void created() {
        setRecordId(72);
      }
    });
    ...
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_0_2", "16") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, 10, 2); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, 10, 2);  } 
      public void created() {
        setRecordId(76);
      }
    });
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_m2_2", "17") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, -2, 2); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, -2, 2);  } 
      public void created() {
        setRecordId(77);
      }
    });
    ...
    HotKeyCmdEnv.addCmd(str, new HotKeyCmdSnap(true, "Snap_m2_0", "22") {
      public void begin() { this.jdField_b_of_type_Boolean = HookKeys.this.snapSet(true, -2, 0); } 
      public void end() { if (this.jdField_b_of_type_Boolean) HookKeys.this.snapSet(false, -2, 0);  } 
      public void created() {
        setRecordId(82);
      }
    });
