...
public class CockpitPE2_84_TGunner extends CockpitGunner
{
  ...
  public void moveGun(Orient paramOrient)
  {
    ...
    this.mesh.chunkSetAngles("TurrelQ", -cvt(paramOrient.getYaw(), -45.0F, 12.0F, -45.0F, 12.0F), 0.0F, 0.0F);
    this.mesh.chunkSetAngles("TurrelC", -cvt(paramOrient.getTangage(), -1.0F, 45.0F, -1.0F, 45.0F), 0.0F, 0.0F);
    resetYPRmodifier();
    xyz[0] = cvt(paramOrient.getYaw(), 0.0F, 12.0F, 0.0F, -0.14F);
    this.mesh.chunkSetLocate("TurrelD", xyz, ypr);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_84_TGunner.this.fm != null)
      {
        ...
        if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3] != null) {
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 0) {
            CockpitPE2_84_TGunner.this.bBombs[1] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 1) {
            CockpitPE2_84_TGunner.this.bBombs[0] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 2) {
            CockpitPE2_84_TGunner.this.bBombs[3] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 3) {
            CockpitPE2_84_TGunner.this.bBombs[2] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 4) {
            CockpitPE2_84_TGunner.this.bBombs[5] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 5) {
            CockpitPE2_84_TGunner.this.bBombs[4] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 6) {
            CockpitPE2_84_TGunner.this.bBombs[5] = ((CockpitPE2_84_TGunner.this.bBombs[5] != 0) || (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 7) {
            CockpitPE2_84_TGunner.this.bBombs[4] = ((CockpitPE2_84_TGunner.this.bBombs[4] != 0) || (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 8) {
            CockpitPE2_84_TGunner.this.bBombs[7] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          }
          if (CockpitPE2_84_TGunner.this.fm.CT.Weapons[3].length > 9) {
            CockpitPE2_84_TGunner.this.bBombs[6] = (!CockpitPE2_84_TGunner.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
          }

        }

        CockpitPE2_84_TGunner.this.setNew.man1 = (0.92F * CockpitPE2_84_TGunner.this.setOld.man1 + 0.08F * CockpitPE2_84_TGunner.this.fm.EI.engines[0].getManifoldPressure());

        CockpitPE2_84_TGunner.this.setNew.man2 = (0.92F * CockpitPE2_84_TGunner.this.setOld.man2 + 0.08F * CockpitPE2_84_TGunner.this.fm.EI.engines[1].getManifoldPressure());
        CockpitPE2_84_TGunner.this.setNew.altimeter = CockpitPE2_84_TGunner.this.fm.getAltitude();

        CockpitPE2_84_TGunner.this.setNew.azimuth.setDeg(CockpitPE2_84_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_84_TGunner.this.fm.Or.azimut());

        CockpitPE2_84_TGunner.this.setNew.vspeed = ((100.0F * CockpitPE2_84_TGunner.this.setOld.vspeed + CockpitPE2_84_TGunner.this.fm.getVertSpeed()) / 101.0F);

        if (CockpitPE2_84_TGunner.this.useRealisticNavigationInstruments())
        {
          CockpitPE2_84_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE2_84_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_84_TGunner.this.getBeaconDirection());
        }
        else
        {
          CockpitPE2_84_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE2_84_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_84_TGunner.this.waypointAzimuth() - CockpitPE2_84_TGunner.this.setOld.azimuth.getDeg(1.0F));
        }

        CockpitPE2_84_TGunner.this.setNew.inert = (0.999F * CockpitPE2_84_TGunner.this.setOld.inert + 0.001F * (CockpitPE2_84_TGunner.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
