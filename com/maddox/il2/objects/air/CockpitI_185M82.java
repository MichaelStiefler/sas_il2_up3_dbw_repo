...
// Source File Name:   CockpitI_185M82.java
...
public class CockpitI_185M82 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitI_185M82()
    {
        ...
        cockpitNightMats = (new java.lang.String[] {
            "Prib_One-T", "Prib_Two", "Prib_Three", "Prib_Four", "Prib_Five"
        });
        setNightMats(false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        if(fm.Gears.rgear)
            com.maddox.il2.objects.air.Cockpit.xyz[0] = 0.08F * fm.CT.getGear();
        mesh.chunkSetLocate("zRGear_ind", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        if(fm.Gears.lgear)
            com.maddox.il2.objects.air.Cockpit.xyz[0] = 0.08F * fm.CT.getGear();
        mesh.chunkSetLocate("zLGear_ind", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        float f1 = 25F;
