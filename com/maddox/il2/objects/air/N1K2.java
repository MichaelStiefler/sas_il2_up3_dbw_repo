...
public abstract class N1K2 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    public void update(float f)
    {
        ...
        if(FM.CT.FlapsControl <= 0.29F && FM.CT.FlapsControl >= 0.05F)
        {
            ...
            if(FM.CT.getFlap() != kuusen_flap)
                ...
                {
                    ((com.maddox.il2.objects.sounds.SndAircraft)this).sfxFlaps(false);
    ...
    {
        com.maddox.il2.objects.air.N1K2.moveGear(((com.maddox.il2.engine.ActorHMesh)this).hierMesh(), f);
    }
    ...
    protected void moveAileron(float f)
    {
        if(f > 0.0F)
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("AroneL_D0", 0.0F, -16F * f, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("AroneR_D0", 0.0F, -28.5F * f, 0.0F);
        } else
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("AroneR_D0", 0.0F, -16F * f, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("AroneL_D0", 0.0F, -28.5F * f, 0.0F);
        }
    }
    ...
    protected void moveElevator(float f)
    {
        if(f > 0.0F)
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("VatorL_D0", 0.0F, -35F * f, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("VatorR_D0", 0.0F, -35F * f, 0.0F);
        } else
        {
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("VatorL_D0", 0.0F, -24.5F * f, 0.0F);
            ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("VatorR_D0", 0.0F, -24.5F * f, 0.0F);
        }
    }

    protected void moveFlap(float f)
    {
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("Flap01_D0", 0.0F, -30F * f, 0.0F);
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("Flap02_D0", 0.0F, -30F * f, 0.0F);
    }

    protected void moveRudder(float f)
    {
        ((com.maddox.il2.engine.ActorHMesh)this).hierMesh().chunkSetAngles("Rudder1_D0", 0.0F, -33F * f, 0.0F);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                if(s.endsWith("p1"))
                {
                    ...
                    if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(32.5F, 65F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) < 0.0F)
                        ((com.maddox.il2.objects.air.Aircraft)this).doRicochetBack(shot);
                } else
                if(s.endsWith("p2"))
                    ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(13.130000114440918D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p3"))
                    ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(8.7F, 9.81F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 3: // '\003'
                case 4: // '\004'
                    if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(0.99F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.175F)
                    {
                ...
                case 5: // '\005'
                case 6: // '\006'
                    if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(0.22F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.275F)
                    {
                ...
                case 7: // '\007'
                    if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(4.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.175F)
                    {
            ...
            if(s.startsWith("xxeng1"))
            {
                ...
                if(s.endsWith("gear"))
                {
                    ...
                    ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.0F, shot);
                }
                if(s.endsWith("prop") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
            ...
            if(s.startsWith("xxlock"))
            {
                ...
                if(s.startsWith("xxlockr") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.5F, shot) > 0.0F)
                {
            ...
            if(s.startsWith("xxmgun0"))
            {
                ...
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Armament: Machine Gun (" + k + ") Disabled..");
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if(s.startsWith("xxsparli") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("WingLIn") > 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Spar Construction: WingLIn Spar Hit, Breaking in Half..");
                    ((com.maddox.il2.objects.air.Aircraft)this).nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparri") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("WingRIn") > 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Spar Construction: WingRIn Spar Hit, Breaking in Half..");
                    ((com.maddox.il2.objects.air.Aircraft)this).nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlm") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("WingLMid") > 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Spar Construction: WingLMid Spar Hit, Breaking in Half..");
                    ((com.maddox.il2.objects.air.Aircraft)this).nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparrm") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("WingRMid") > 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Spar Construction: WingRMid Spar Hit, Breaking in Half..");
                    ((com.maddox.il2.objects.air.Aircraft)this).nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlo") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("WingLOut") > 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Spar Construction: WingLOut Spar Hit, Breaking in Half..");
                    ((com.maddox.il2.objects.air.Aircraft)this).nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if(s.startsWith("xxsparro") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("WingROut") > 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    ((com.maddox.il2.objects.air.Aircraft)this).debuggunnery("Spar Construction: WingROut Spar Hit, Breaking in Half..");
                    ((com.maddox.il2.objects.air.Aircraft)this).nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if(s.startsWith("xxspart") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Tail1") > 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(3.86F / (float)java.lang.Math.sqrt(com.maddox.il2.objects.air.Aircraft.v1.y * com.maddox.il2.objects.air.Aircraft.v1.y + com.maddox.il2.objects.air.Aircraft.v1.z * com.maddox.il2.objects.air.Aircraft.v1.z), shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                {
            ...
            if(s.startsWith("xxtank"))
            {
                ...
                if(l > 3)
                    return;
                if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(0.8F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.45F)
                {
        ...
        {
            if(((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Engine1") < 2 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Engine1", shot);
        } else
        if(s.startsWith("xtail"))
        {
            if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 5000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Tail1", shot);
        } else
        if(s.startsWith("xkeel"))
        {
            if(((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Keel1", shot);
        } else
        if(s.startsWith("xrudder"))
        {
            if(((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("Rudder1") < 1 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("Rudder1", shot);
        } else
        if(s.startsWith("xstab"))
        {
            if(s.startsWith("xstabl") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("StabL", shot);
            if(s.startsWith("xstabr") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("StabR", shot);
        } else
        if(s.startsWith("xvator"))
        {
            if(s.startsWith("xvatorl") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("VatorL") < 1 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("VatorL", shot);
            if(s.startsWith("xvatorr") && ((com.maddox.il2.objects.air.Aircraft)this).chunkDamageVisible("VatorR") < 1 && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("VatorR", shot);
        } else
        if(s.startsWith("xwing"))
        {
            if(s.startsWith("xwinglin") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.5F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 5000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("WingLIn", shot);
            if(s.startsWith("xwingrin") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.5F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 5000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("WingRIn", shot);
            if(s.startsWith("xwinglmid") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 4000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("WingLMid", shot);
            if(s.startsWith("xwingrmid") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(2.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 4000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("WingRMid", shot);
            if(s.startsWith("xwinglout") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                ((com.maddox.il2.objects.air.Aircraft)this).hitChunk("WingLOut", shot);
            if(s.startsWith("xwingrout") && ((com.maddox.il2.objects.air.Aircraft)this).getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
    ...
    protected void InitFlapMgr()
    {
        ...
        {
            KuusenFlapCtrl = new KuusenFlapControl(((com.maddox.il2.fm.FlightModelMain) (FM)), -5);
            IsInitFlapMgr = true;
            return;
        }
    }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.N1K2.class;
