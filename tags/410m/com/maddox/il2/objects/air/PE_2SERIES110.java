...
// Source File Name:   PE_2SERIES110.java
...
//            PE_2, PaintSchemeBMPar03, TypeBomber, TypeDiveBomber, 
//            TypeTransport, NetAircraft

public class PE_2SERIES110 extends com.maddox.il2.objects.air.PE_2
    implements com.maddox.il2.objects.air.TypeBomber, com.maddox.il2.objects.air.TypeDiveBomber, com.maddox.il2.objects.air.TypeTransport
{
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.PE_2SERIES110.class;
        ...
        com.maddox.rts.Property.set(class1, "yearService", 1942.7F);
        com.maddox.rts.Property.set(class1, "yearExpired", 1945.5F);
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Pe-2series110.fmd");
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitPE2_110.class, com.maddox.il2.objects.air.CockpitPE2_Bombardier.class, com.maddox.il2.objects.air.CockpitPE2_110_TGunner.class
        });
        com.maddox.rts.Property.set(class1, "LOSElevation", 0.76315F);
        com.maddox.il2.objects.air.PE_2SERIES110.weaponTriggersRegister(class1, new int[] {
            0, 1, 10, 11, 12, 13, 3, 3, 3, 3, 
            3, 3, 3, 3, 3, 3
        });
        com.maddox.il2.objects.air.PE_2SERIES110.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShKASki 450", "MGunUBki 150", "MGunUBt 200", "MGunUBt 200", "MGunShKASt 450", "MGunShKASt 450", null, null, null, null, 
            null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "6fab50", new java.lang.String[] {
            "MGunShKASki 450", "MGunUBki 150", "MGunUBt 200", "MGunUBt 200", "MGunShKASt 450", "MGunShKASt 450", null, null, null, null, 
            "BombGunFAB50", "BombGunFAB50", "BombGunFAB50", "BombGunFAB50", "BombGunFAB50", "BombGunFAB50"
        });
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "6fab100", new java.lang.String[] {
            "MGunShKASki 450", "MGunUBki 150", "MGunUBt 200", "MGunUBt 200", "MGunShKASt 450", "MGunShKASt 450", null, null, null, null, 
            "BombGunFAB100", "BombGunFAB100", "BombGunFAB100", "BombGunFAB100", "BombGunFAB100", "BombGunFAB100"
        });
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "2fab250", new java.lang.String[] {
            "MGunShKASki 450", "MGunUBki 150", "MGunUBt 200", "MGunUBt 200", "MGunShKASt 450", "MGunShKASt 450", null, null, "BombGunFAB250", "BombGunFAB250", 
            null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "2fab2502fab100", new java.lang.String[] {
            "MGunShKASki 450", "MGunUBki 150", "MGunUBt 200", "MGunUBt 200", "MGunShKASt 450", "MGunShKASt 450", null, null, "BombGunFAB250", "BombGunFAB250", 
            null, null, null, null, "BombGunFAB100", "BombGunFAB100"
        });
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "4fab250", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "2fab500", new java.lang.String[] {
            "MGunShKASki 450", "MGunUBki 150", "MGunUBt 200", "MGunUBt 200", "MGunShKASt 450", "MGunShKASt 450", "BombGunFAB500", "BombGunFAB500", null, null, 
            null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "2fab5002fab250", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_2SERIES110.weaponsRegister(class1, "none", new java.lang.String[] {
