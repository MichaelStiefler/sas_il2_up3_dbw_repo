...
//            Scheme2, SB_2M100A, TypeBomber, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeBomber
{
    ...
    public void update(float f)
    {
        ...
        if(curTopGunnerPosition > 0.05F)
            ...
            {
                resetYPRmodifier();
                xyz[1] = com.maddox.il2.objects.air.SB.cvt(curTopGunnerPosition, 0.05F, 0.5F, 0.0F, -1.16F);
                xyz[2] = com.maddox.il2.objects.air.SB.cvt(curTopGunnerPosition, 0.05F, 0.5F, 0.0F, 0.1F);
                hierMesh().chunkSetLocate("Blister3_D0", xyz, ypr);
                hierMesh().chunkSetAngles("Turret2M1_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.SB.cvt(curTopGunnerPosition, 0.6F, 0.9F, 0.0F, -40F));
                hierMesh().chunkSetAngles("Turret2M2_D0", 0.0F, com.maddox.il2.objects.air.SB.cvt(curTopGunnerPosition, 0.6F, 0.9F, 0.0F, -40F), 0.0F);
                ...
                resetYPRmodifier();
                xyz[1] = com.maddox.il2.objects.air.SB.cvt(curTopGunnerPosition, 0.6F, 0.9F, 0.0F, -0.115F);
                xyz[2] = com.maddox.il2.objects.air.SB.cvt(curTopGunnerPosition, 0.6F, 0.9F, 0.0F, 0.229F);
                hierMesh().chunkSetLocate("Pilot3_D0", xyz, ypr);
            } else
            {
                resetYPRmodifier();
                xyz[2] = com.maddox.il2.objects.air.SB.cvt(curTopGunnerPosition, 0.6F, 0.9F, 0.0F, 0.3F);
                hierMesh().chunkSetLocate("Pilot3_D0", xyz, ypr);
            }
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, com.maddox.il2.objects.air.SB.cvt(f, 0.0F, 0.05F, 0.0F, 70F), 0.0F);
        hiermesh.chunkSetAngles("GearL7_D0", 0.0F, com.maddox.il2.objects.air.SB.cvt(f, 0.0F, 0.05F, 0.0F, -70F), 0.0F);
        ...
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, com.maddox.il2.objects.air.SB.cvt(f, 0.0F, 0.05F, 0.0F, -70F), 0.0F);
        hiermesh.chunkSetAngles("GearR7_D0", 0.0F, com.maddox.il2.objects.air.SB.cvt(f, 0.0F, 0.05F, 0.0F, 70F), 0.0F);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 3: // '\003'
                    ...
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.12F)
                    {
                        ...
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Evelator Controls Out..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.12F)
                    {
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Rudder Controls Out..");
                    }
                    break;
                }
            }
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** Tail1 Spars Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** WingRMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlo") && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingLOut") > 2 && getEnergyPastArmor(9.1F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** WingLOut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if(s.startsWith("xxsparro") && (double)com.maddox.il2.ai.World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * java.lang.Math.abs(v1.x) && chunkDamageVisible("WingROut") > 2 && getEnergyPastArmor(9.1F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** StabL Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** StabR Spars Damaged..");
                    nextDMGLevels(1, 2, "StabR_D2", shot.initiator);
                }
                if(s.startsWith("xxspare1") && getEnergyPastArmor(28F, shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine1 Suspension Broken in Half..");
                    nextDMGLevels(3, 2, "Engine1_D0", shot.initiator);
                }
                if(s.startsWith("xxspare2") && getEnergyPastArmor(28F, shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine2 Suspension Broken in Half..");
            ...
            {
                com.maddox.il2.objects.air.SB.debugprintln(this, "*** Bomb Payload Detonates..");
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("prop") && getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 0.4F), shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Prop Governor Failed..");
                }
                if(s.endsWith("gear") && getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 1.1F), shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Prop Governor Damaged..");
                }
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(0.0F, 6.8F), shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 200000F)
                        {
                            ...
                            com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                        {
                            FM.AS.hitEngine(shot.initiator, j, 2);
                            com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Crank Case Hit - Engine Damaged..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 28000F)
                        {
                            FM.EI.engines[j].setCyliderKnockOut(shot.initiator, 1);
                            com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Crank Case Hit - Cylinder Feed Out, " + FM.EI.engines[j].getCylindersOperable() + "/" + FM.EI.engines[j].getCylinders() + " Left..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.08F)
                        {
                            FM.EI.engines[j].setEngineStuck(shot.initiator);
                            com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Crank Case Hit - Ball Bearing Jammed - Engine Stuck..");
                        }
                        ...
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Crank Case Hit - Readyness Reduced to " + FM.EI.engines[j].getReadyness() + "..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F)
                    {
                        FM.EI.engines[j].setEngineStops(shot.initiator);
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Crank Case Hit - Engine Stalled..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F)
                    {
                        FM.AS.hitEngine(shot.initiator, j, 10);
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Crank Case Hit - Fuel Feed Hit - Engine Flamed..");
                    }
                ...
                if((s.endsWith("cyl1") || s.endsWith("cyl2")) && getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(0.5F, 2.542F), shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[j].getCylindersRatio() * 1.72F)
                {
                    ...
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Cylinders Hit, " + FM.EI.engines[j].getCylindersOperable() + "/" + FM.EI.engines[j].getCylinders() + " Left..");
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F)
                    {
                        FM.EI.engines[j].setEngineStuck(shot.initiator);
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Cylinder Case Broken - Engine Stuck..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 24000F)
                    {
                        FM.AS.hitEngine(shot.initiator, j, 3);
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Cylinders Hit - Engine Fires..");
                    }
                ...
                if(s.endsWith("supc") && getEnergyPastArmor(0.05F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.89F)
                {
                    ...
                    com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Supercharger Out..");
                }
                if(s.endsWith("eqpt") && getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(0.001F, 0.2F), shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.89F)
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.11F)
                    {
                        ...
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Magneto Out..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.11F)
                    {
                        FM.EI.engines[j].setKillCompressor(shot.initiator);
                        com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine" + (j + 1) + " Compressor Feed Out..");
                    }
                }
            }
        ...
        if(s.startsWith("xengine1"))
        {
            ...
            com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine1 Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
        } else
        if(s.startsWith("xengine2"))
        {
            ...
            com.maddox.il2.objects.air.SB.debugprintln(this, "*** Engine2 Hit - Readyness Reduced to " + FM.EI.engines[1].getReadyness() + "..");
        } else
        if(s.startsWith("xgear"))
        {
            if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F)
            {
                com.maddox.il2.objects.air.SB.debugprintln(this, "*** Gear Hydro Failed..");
