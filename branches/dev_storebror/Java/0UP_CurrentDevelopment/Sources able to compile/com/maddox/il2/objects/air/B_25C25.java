    ...
    implements TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = B_25C25.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= B_25C25.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / B_25C25.toMeters(fSightCurAltitude)));
            calibDistance = B_25C25.toMetersPerSecond(fSightCurSpeed) * floatindex(Aircraft.cvt(B_25C25.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)B_25C25.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(B_25C25.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = B_25C25.class;
        ...
        B_25C25.weaponTriggersRegister(class1, new int[] {
            0, 10, 11, 11, 12, 12, 3, 3, 3
        });
        B_25C25.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03"
        });
        B_25C25.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "12x100lbs", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "6x250lbs", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "4x500lbs", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "2x1000lbs", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "1x2000lbs", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "10x50kg", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "8x100kg", new java.lang.String[] {
        ...
        B_25C25.weaponsRegister(class1, "none", new java.lang.String[] {
