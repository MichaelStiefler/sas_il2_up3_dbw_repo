...
public class CockpitME_262NJR extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(gun[0] == null)
        {
            ...
            gun[2] = ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON02");
            gun[3] = ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON04");
            gun[4] = ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON05");
            gun[5] = ((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON06");
        }
        if(super.fm.isTick(44, 0))
        {
            ...
            if(!(((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON05") instanceof com.maddox.il2.objects.weapons.GunEmpty))
                super.mesh.chunkVisible("Z_GunLamp02", !gun[4].haveBullets());
            else
                super.mesh.chunkVisible("Z_GunLamp02", !gun[1].haveBullets());
            if(!(((com.maddox.il2.objects.air.Aircraft)((com.maddox.il2.engine.Interpolate) (super.fm)).actor).getGunByHookName("_CANNON06") instanceof com.maddox.il2.objects.weapons.GunEmpty))
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.GearControl == 0.0F && ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGear() != 0.0F ? -0.0107F : 0.0F;
        super.mesh.chunkSetLocate("Z_GearEin", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[1] = ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.GearControl == 1.0F && ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGear() != 1.0F ? -0.0107F : 0.0F;
        super.mesh.chunkSetLocate("Z_GearAus", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.FlapsControl < ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getFlap() ? -0.0107F : 0.0F;
        super.mesh.chunkSetLocate("Z_FlapEin", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        com.maddox.il2.objects.air.Cockpit.xyz[1] = ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.FlapsControl > ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getFlap() ? -0.0107F : 0.0F;
        super.mesh.chunkSetLocate("Z_FlapAus", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        ...
        super.mesh.chunkSetLocate("Z_Columnbutton1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = 0.03675F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getTrimElevatorControl();
        super.mesh.chunkSetLocate("Z_TailTrim", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
