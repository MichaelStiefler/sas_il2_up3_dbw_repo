...
// Source File Name:   BF_109K14.java
...
//            BF_109, CockpitBF_109K4, PaintSchemeFMPar06, TypeFighter, 
//            TypeBNZFighter, TypeStormovik, Aircraft, Cockpit, 
//            NetAircraft

public class BF_109K14 extends com.maddox.il2.objects.air.BF_109
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeStormovik
{
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.BF_109K14.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "Bf109");
        com.maddox.rts.Property.set(class1, "meshName", "3do/plane/Bf-109K-14/hier.him");
        com.maddox.rts.Property.set(class1, "PaintScheme", new PaintSchemeFMPar06());
        com.maddox.rts.Property.set(class1, "yearService", 1944.11F);
        com.maddox.rts.Property.set(class1, "yearExpired", 1955F);
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Bf-109K-14.fmd");
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 67", "MGunMK108ki 57", "MGunMK108ki 57", null, null, null, null, null, 
            null
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "1xMG151", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMG15120MGki 200", "MGunMK108ki 57", "MGunMK108ki 57", null, null, null, null, null, 
            null
        });
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "1xSC250", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 67", "MGunMK108ki 57", "MGunMK108ki 57", "PylonETC900 1", "BombGunSC250 1", null, null, null, 
            null
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "1xSC500", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 67", "MGunMK108ki 57", "MGunMK108ki 57", "PylonETC900 1", "BombGunSC500 1", null, null, null, 
            null
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "1xAB250", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 67", "MGunMK108ki 57", "MGunMK108ki 57", "PylonETC900 1", "BombGunAB250 1", null, null, null, 
            null
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "1xAB500", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 67", "MGunMK108ki 57", "MGunMK108ki 57", "PylonETC900 1", "BombGunAB500 1", null, null, null, 
            null
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "1xSD500", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMK108ki 67", "MGunMK108ki 57", "MGunMK108ki 57", "PylonETC900 1", "BombGunSD500 1", null, null, null, 
            null
        });
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "light", new java.lang.String[] {
            "MGunMG131si 300", "MGunMG131si 300", "MGunMG15120MGki 200", "MGunMG15120MGki 60", "MGunMG15120MGki 60", null, null, null, null, null, 
            null
        });
