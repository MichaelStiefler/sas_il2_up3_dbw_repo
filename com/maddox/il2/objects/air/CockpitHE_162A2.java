...
// Source File Name:   CockpitHE_162A2.java
...
public class CockpitHE_162A2 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(aircraft().FM.CT.getGear() > 0.99F)
        {
            ...
            ypr[1] = 40F * aircraft().FM.CT.getRudder();
            mesh.chunkSetLocate("GearC25_D0", xyz, ypr);
        ...
        {
            resetYPRmodifier();
            xyz[1] = cvt(fm.CT.Weapons[0][0].countBullets(), 0.0F, 120F, 0.0F, 0.0415F);
            mesh.chunkSetLocate("Zammo_counter1", xyz, ypr);
            xyz[1] = cvt(fm.CT.Weapons[0][1].countBullets(), 0.0F, 120F, 0.0F, 0.0415F);
