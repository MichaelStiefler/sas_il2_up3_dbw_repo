...
public class CockpitHURRI extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bFAF)
    {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -floatindex(cvt(Pitot.Indicator((float)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.jdField_z_of_type_Double, this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getSpeed()), 0.0F, 180.05551F, 0.0F, 35.0F), speedometerScale));
    }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitHURRI.this.bNeedSetUp) {
        ...
        CockpitHURRI.access$102(CockpitHURRI.this, false);
      }
      if (CockpitHURRI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitHURRI.access$202(CockpitHURRI.this, CockpitHURRI.this.setOld); CockpitHURRI.access$302(CockpitHURRI.this, CockpitHURRI.this.setNew); CockpitHURRI.access$402(CockpitHURRI.this, CockpitHURRI.this.setTmp);

        CockpitHURRI.this.setNew.throttle = ((10.0F * CockpitHURRI.this.setOld.throttle + CockpitHURRI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitHURRI.this.setNew.altimeter = CockpitHURRI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitHURRI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitHURRI.this.setNew.azimuth = ((35.0F * CockpitHURRI.this.setOld.azimuth + -CockpitHURRI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        if ((CockpitHURRI.this.setOld.azimuth > 270.0F) && (CockpitHURRI.this.setNew.azimuth < 90.0F)) CockpitHURRI.this.setOld.azimuth -= 360.0F;
        if ((CockpitHURRI.this.setOld.azimuth < 90.0F) && (CockpitHURRI.this.setNew.azimuth > 270.0F)) CockpitHURRI.this.setOld.azimuth += 360.0F;
        CockpitHURRI.this.setNew.waypointAzimuth = ((10.0F * CockpitHURRI.this.setOld.waypointAzimuth + (CockpitHURRI.this.waypointAzimuth() - CockpitHURRI.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitHURRI.this.setNew.vspeed = ((199.0F * CockpitHURRI.this.setOld.vspeed + CockpitHURRI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    private final CockpitHURRI this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitHURRI.1 arg2) { this();
    }
  }
}