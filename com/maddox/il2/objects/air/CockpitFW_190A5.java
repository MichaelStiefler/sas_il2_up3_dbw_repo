...
public class CockpitFW_190A5 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bomb[0] == null) {
      ...
      if (((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb05") != GunEmpty.get()) {
        this.bomb[1] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb05");
        this.bomb[2] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb05");
      } else if (((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalDev02") != GunEmpty.get()) {
        this.bomb[1] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalDev02");
        this.bomb[2] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalDev02");
      }
      if (((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalRock01") != GunEmpty.get()) {
        this.bomb[0] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalRock01");
        this.bomb[3] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalRock02");
      } else if (((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb03") != GunEmpty.get()) {
        this.bomb[0] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb03");
        this.bomb[3] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb04");
      } else if (((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalDev05") != GunEmpty.get()) {
        this.bomb[0] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalDev05");
        this.bomb[3] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalDev06");
      }
      this.t1 = Time.current();
    }

    if (((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x20) == 0) && ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x80) == 0))
    {
    ...
    if (this.t1 < Time.current()) {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampBombL", this.bomb[0].haveBullets());

      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampBombCL", this.bomb[1].haveBullets());
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampBombCR", this.bomb[2].haveBullets());
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampBombR", this.bomb[3].haveBullets());
    }
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampFlapLPos_3", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.9F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampFlapLPos_2", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.1F) && (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() < 0.5F));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampFlapLPos_1", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() < 0.1F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampFlapRPos_3", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.9F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampFlapRPos_2", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.1F) && (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() < 0.5F));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampFlapRPos_1", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() < 0.1F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("XLampGearC_2", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() > 0.95F);
  }
  ...
  public void reflectCockpitState()
  {
    if (((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x2) != 0) || ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x1) != 0) || ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x4) != 0))
    {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A4GP1", "DA5GP1");
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A4GP1_night", "DA5GP1_night");
    ...
    if (((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x40) != 0) || ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x8) != 0) || ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x10) != 0))
    {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A4GP2", "DA5GP2");
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A4GP2_night", "DA5GP2_night");
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A5GP4", "DA5GP4");
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A5GP4_night", "DA5GP4_night");
    ...
    if (((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x20) != 0) || ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x80) != 0))
    {
      ...
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A5GP3", "DA5GP3");
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.materialReplace("A5GP3_night", "DA5GP3_night");
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW_190A5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitFW_190A5.access$102(CockpitFW_190A5.this, CockpitFW_190A5.this.setOld); CockpitFW_190A5.access$202(CockpitFW_190A5.this, CockpitFW_190A5.this.setNew); CockpitFW_190A5.access$302(CockpitFW_190A5.this, CockpitFW_190A5.this.setTmp);

        CockpitFW_190A5.this.setNew.altimeter = CockpitFW_190A5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        ...
        CockpitFW_190A5.this.setNew.throttle = ((10.0F * CockpitFW_190A5.this.setOld.throttle + CockpitFW_190A5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitFW_190A5.this.setNew.vspeed = ((499.0F * CockpitFW_190A5.this.setOld.vspeed + CockpitFW_190A5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 500.0F);

        CockpitFW_190A5.this.setNew.azimuth = CockpitFW_190A5.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
        if ((CockpitFW_190A5.this.setOld.azimuth > 270.0F) && (CockpitFW_190A5.this.setNew.azimuth < 90.0F)) CockpitFW_190A5.this.setOld.azimuth -= 360.0F;
        if ((CockpitFW_190A5.this.setOld.azimuth < 90.0F) && (CockpitFW_190A5.this.setNew.azimuth > 270.0F)) CockpitFW_190A5.this.setOld.azimuth += 360.0F;
        CockpitFW_190A5.this.setNew.waypointAzimuth = ((10.0F * CockpitFW_190A5.this.setOld.waypointAzimuth + (CockpitFW_190A5.this.waypointAzimuth() - CockpitFW_190A5.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    float vspeed;
    private final CockpitFW_190A5 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitFW_190A5.1 arg2) { this();
    }
  }
}