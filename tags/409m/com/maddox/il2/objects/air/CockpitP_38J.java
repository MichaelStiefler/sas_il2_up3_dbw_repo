...
// Source File Name:   CockpitP_38J.java
...
//            CockpitPilot, P_38, Cockpit, Aircraft

public class CockpitP_38J extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(((com.maddox.il2.objects.air.P_38)aircraft()).bChangedPit)
            {
                reflectPlaneToModel();
                ((com.maddox.il2.objects.air.P_38)aircraft()).bChangedPit = false;
            }
            if(fm != null)
            {
                setTmp = setOld;
