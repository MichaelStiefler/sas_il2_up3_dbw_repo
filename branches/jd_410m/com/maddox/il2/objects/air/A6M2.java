...
public class A6M2 extends A6M
{
  static
  {
    Class localClass = A6M2.class;
    new NetAircraft.SPAWN(localClass);

    Property.set(localClass, "iconFar_shortClassName", "A6M");
    Property.set(localClass, "meshNameDemo", "3DO/Plane/A6M2(ja)/hier.him");
    Property.set(localClass, "meshName", "3DO/Plane/A6M2(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar01());
    Property.set(localClass, "meshName_ja", "3DO/Plane/A6M2(ja)/hier.him");
    Property.set(localClass, "PaintScheme_ja", new PaintSchemeFCSPar01());

    Property.set(localClass, "yearService", 1940.5F);
    Property.set(localClass, "yearExpired", 1945.5F);

    Property.set(localClass, "FlightModel", "FlightModels/A6M2.fmd");
