...
public class CockpitJU_88A4_BGunner extends CockpitGunner
{
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float cons;
    private final CockpitJU_88A4_BGunner this$0;
    ...
    Variables(CockpitJU_88A4_BGunner.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitJU_88A4_BGunner.access$002(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.setOld);
        CockpitJU_88A4_BGunner.access$102(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.setNew);
        CockpitJU_88A4_BGunner.access$202(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.setTmp);
        CockpitJU_88A4_BGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.throttle1 + CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_BGunner.this.setNew.prop1 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.prop1 + CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitJU_88A4_BGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.throttle2 + CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_BGunner.this.setNew.prop2 = (0.85F * CockpitJU_88A4_BGunner.this.setOld.prop2 + CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitJU_88A4_BGunner.this.setNew.altimeter = CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f1 = CockpitJU_88A4_BGunner.this.waypointAzimuth();
        CockpitJU_88A4_BGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4_BGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A4_BGunner.this.setOld.azimuth.getDeg(1.0F));
        CockpitJU_88A4_BGunner.this.setNew.azimuth.setDeg(CockpitJU_88A4_BGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitJU_88A4_BGunner.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_BGunner.this.setOld.vspeed + CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitJU_88A4_BGunner.this.cockpitDimControl)
        {
          if (CockpitJU_88A4_BGunner.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A4_BGunner.this.setNew.dimPosition = (CockpitJU_88A4_BGunner.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitJU_88A4_BGunner.this.setNew.dimPosition < 1.0F)
          CockpitJU_88A4_BGunner.this.setNew.dimPosition = (CockpitJU_88A4_BGunner.this.setOld.dimPosition + 0.05F);
        float f2 = CockpitJU_88A4_BGunner.this.prevFuel - CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel;
        CockpitJU_88A4_BGunner.access$302(CockpitJU_88A4_BGunner.this, CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A4_BGunner.this.setNew.cons = (0.91F * CockpitJU_88A4_BGunner.this.setOld.cons + 0.09F * f2);
        if (CockpitJU_88A4_BGunner.this.buzzerFX != null)
          if ((CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < ((JU_88A4)CockpitJU_88A4_BGunner.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4)CockpitJU_88A4_BGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1)) {
            CockpitJU_88A4_BGunner.this.buzzerFX.play();
          }
          else if (CockpitJU_88A4_BGunner.this.buzzerFX.isPlaying())
            CockpitJU_88A4_BGunner.this.buzzerFX.stop();
      }
      return true;
    }
