...
public class Polares extends com.maddox.il2.fm.FMMath
{
    ...
    protected final void polares2(float f)
    {
        float f1 = new_Cxa(f);
        float f2 = new_Cya(f);
        float f3 = (float)java.lang.Math.cos(com.maddox.il2.fm.Polares.DEG2RAD(f));
        float f4 = (float)java.lang.Math.sin(com.maddox.il2.fm.Polares.DEG2RAD(f));
        lastAOA = f;
        lastCx = f1 * f3 - f2 * f4;
        lastCy = f2 * f3 + f1 * f4;
    }
...
label0:
                ...
                for(int k = 0; k < 100; k++)
                {
                    ...
                    for(int l = 0; l <= 20; l++)
                    {
                        ...
                        do
                        {
                            ...
                            float f30 = ((float)f12 * (normP[f12] - f27)) / G;
                            if(f2 >= f30)
                                break;
                            f2 = f30;
                            f3 = f12;
                        ...
                        for(f12 = 125; f12 > 40; f12--)
                        {
                            ...
                            float f31 = (float)java.lang.Math.sqrt(f28 * f28 - 1.0F);
                        ...
                        byte0 = 6;
                        f12 = K_max - f1;
                        f12 = java.lang.Math.abs(f12);
                        float f16 = Vz_climb - f2;
                        f16 = java.lang.Math.abs(f16);
    ...
    public final float new_Cxa(float f)
    {
        ...
        if(f <= AOACritL)
            f2 += 0.03F * (AOACritL - f);
        float f3 = 0.2F + 1.2F * (float)java.lang.Math.abs(java.lang.Math.sin(com.maddox.il2.fm.Polares.DEG2RAD(f)));
        return java.lang.Math.min(f2, f3);
    }

    public final float new_Cz(float f)
    {
        return 0.7F * (float)java.lang.Math.sin(com.maddox.il2.fm.Polares.DEG2RAD(f));
    }
