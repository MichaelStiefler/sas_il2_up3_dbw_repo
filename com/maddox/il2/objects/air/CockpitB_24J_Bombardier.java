...
public class CockpitB_24J_Bombardier extends CockpitPilot
{
  ...
  public CockpitB_24J_Bombardier()
  {
    super("3DO/Cockpit/B-25J-Bombardier/BombardierB24Jnew.him", "bf109");
    this.bEntered = false;
    try
    {
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bEntered)
    {
      this.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_24J)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);
      boolean bool = ((B_24J)aircraft()).fSightCurReadyness > 0.93F;
  ...
  static
  {
    Property.set(CockpitB_24J_Bombardier.class, "astatePilotIndx", 0);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      float f1 = ((B_24J)CockpitB_24J_Bombardier.this.aircraft()).fSightCurForwardAngle;
      float f2 = ((B_24J)CockpitB_24J_Bombardier.this.aircraft()).fSightCurSideslip;
      CockpitB_24J_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitB_24J_Bombardier.this.bEntered)
      {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitB_24J_Bombardier.this.aAim + f2, CockpitB_24J_Bombardier.this.tAim + f1, 0.0F);
      }
      CockpitB_24J_Bombardier.this.mesh.chunkSetAngles("TurretA", 0.0F, CockpitB_24J_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);
      CockpitB_24J_Bombardier.this.mesh.chunkSetAngles("TurretB", 0.0F, CockpitB_24J_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
      return true;
    }
