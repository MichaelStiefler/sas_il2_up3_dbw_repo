...
public class BF_109F4MSTL extends com.maddox.il2.objects.air.BF_109
    implements com.maddox.il2.objects.air.TypeDockable
{
    ...
    protected void moveFan(float f)
    {
        ...
        for(int j = 0; j < 1; j++)
        {
            if(super.oldProp[j] < 2)
            {
                ...
                {
                    hierMesh().chunkVisible(com.maddox.il2.objects.air.Aircraft.Props[j][super.oldProp[j]], false);
                    super.oldProp[j] = i;
            ...
            hierMesh().chunkSetAngles(com.maddox.il2.objects.air.Aircraft.Props[j][0], 0.0F, -super.propPos[j], 0.0F);
        }
    ...
    protected void moveGear(float f)
    {
        if(typeDockableIsDocked())
            com.maddox.il2.objects.air.BF_109F4MSTL.moveGear(hierMesh(), 0.0F);
        else
            com.maddox.il2.objects.air.BF_109F4MSTL.moveGear(hierMesh(), f);
    }
    ...
    public void onAircraftLoaded()
    {
        ...
        if(com.maddox.il2.game.Mission.isCoop() && !com.maddox.il2.game.Mission.isServer() && !isSpawnFromMission() && super.net.isMaster())
            new com.maddox.rts.MsgAction(64, 0.0D, ((java.lang.Object) (this))) {
...
;
    ...
    private void onCoopMasterSpawned()
    {
        ...
        if(com.maddox.il2.engine.Actor.isValid(actor) && (actor instanceof com.maddox.il2.objects.air.JU_88MSTL))
            try
            {
                ...
                java.lang.String s1 = "spawn " + ((java.lang.Object) (actor)).getClass().getName() + " NAME net" + actor.name() + " FUEL " + f + " WEAPONS " + ((com.maddox.il2.objects.air.NetAircraft) (aircraft)).thisWeaponsName + (((com.maddox.il2.objects.air.NetAircraft) (aircraft)).bPaintShemeNumberOn ? "" : " NUMBEROFF") + " OVR";
    ...
    private void checkAsDrone()
    {
        ...
        if(com.maddox.il2.engine.Actor.isValid(target_) && (target_ instanceof com.maddox.il2.objects.air.JU_88MSTL) && isNetMaster())
            ((com.maddox.il2.objects.air.TypeDockable)target_).typeDockableRequestAttach(((com.maddox.il2.engine.Actor) (this)), 0, true);
        bNeedSetup = false;
        target_ = null;
    }
    ...
    public void typeDockableDoAttachToQueen(com.maddox.il2.engine.Actor actor, int i)
    {
        ...
        moveGear(0.0F);
        ((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.GearControl = ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)actor)).FM)).CT.GearControl;
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.BF_109F4MSTL.class;
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "FlightModel", "FlightModels/Bf-109F-4_Mod.fmd");
        ...
        com.maddox.il2.objects.air.BF_109F4MSTL.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_CANNON01"
        });
        com.maddox.il2.objects.air.BF_109F4MSTL.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG17si 500", "MGunMG17si 500", "MGunMG15120MGki 200"
        });
        com.maddox.il2.objects.air.BF_109F4MSTL.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
