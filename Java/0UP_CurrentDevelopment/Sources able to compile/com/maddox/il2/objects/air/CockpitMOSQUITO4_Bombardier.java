...
public class CockpitMOSQUITO4_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(bEntered)
            {
                ...
                hookpilot.setSimpleAimOrient(aAim + 10F * f1, tAim + CockpitMOSQUITO4_Bombardier.calibrAngle + f, 0.0F);
            }
            return true;
        }
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitMOSQUITO4_Bombardier.class, "astatePilotIndx", 0);
    }
