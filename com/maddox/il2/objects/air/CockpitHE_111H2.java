...
public class CockpitHE_111H2 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    if (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.isTick(44, 0)) {
      ...
      if ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState & 0x40) == 0) {
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("zFuelWarning1", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel < 600.0F);
        this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("zFuelWarning2", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel < 600.0F);
      }
    }
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zTurretA", 0.0F, this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[0], 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zTurretB", 0.0F, this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[1], 0.0F);
    ...
    if (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() >= 0.0F) this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zPitch1", 0.0F, 0.0F, -65.0F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
    if (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() >= 0.0F) this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zPitch2", 0.0F, 0.0F, -65.0F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
    ...
    if ((Math.abs(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 20.0F) && (Math.abs(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getTangage()) < 20.0F)) this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zMagnetic", interp(this.setNew.azimuth, this.setOld.azimuth, paramFloat), 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zFuel1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel / 0.72F, 0.0F, 2000.0F, 0.0F, 140.0F), 0.0F, 0.0F);

    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("zFuel2", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel / 0.72F, 0.0F, 2000.0F, 0.0F, 140.0F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitHE_111H2.access$102(CockpitHE_111H2.this, CockpitHE_111H2.this.setOld); CockpitHE_111H2.access$202(CockpitHE_111H2.this, CockpitHE_111H2.this.setNew); CockpitHE_111H2.access$302(CockpitHE_111H2.this, CockpitHE_111H2.this.setTmp);

      CockpitHE_111H2.this.setNew.altimeter = CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      CockpitHE_111H2.this.setNew.throttlel = ((10.0F * CockpitHE_111H2.this.setOld.throttlel + CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle()) / 11.0F);
      CockpitHE_111H2.this.setNew.throttler = ((10.0F * CockpitHE_111H2.this.setOld.throttler + CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle()) / 11.0F);
      CockpitHE_111H2.this.setNew.azimuth = CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitHE_111H2.this.setOld.azimuth > 270.0F) && (CockpitHE_111H2.this.setNew.azimuth < 90.0F)) CockpitHE_111H2.this.setOld.azimuth -= 360.0F;
      if ((CockpitHE_111H2.this.setOld.azimuth < 90.0F) && (CockpitHE_111H2.this.setNew.azimuth > 270.0F)) CockpitHE_111H2.this.setOld.azimuth += 360.0F;
      CockpitHE_111H2.this.setNew.waypointAzimuth = ((10.0F * CockpitHE_111H2.this.setOld.waypointAzimuth + (CockpitHE_111H2.this.waypointAzimuth() - CockpitHE_111H2.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitHE_111H2.this.setNew.vspeed = ((499.0F * CockpitHE_111H2.this.setOld.vspeed + CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 500.0F);
      if (CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.isTick(12, 0)) {
        Airport localAirport = Airport.nearest(CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d, -1, 1);
        if ((localAirport != null) && (localAirport.nearestRunway(CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d, CockpitHE_111H2.this.tmpLoc))) {
          CockpitHE_111H2.this.tmpLoc.transformInv(CockpitHE_111H2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d, CockpitHE_111H2.this.tmpP);
          CockpitHE_111H2.this.tmpV.jdField_x_of_type_Double = CockpitHE_111H2.this.tmpP.jdField_x_of_type_Double;
          CockpitHE_111H2.this.tmpV.jdField_y_of_type_Double = CockpitHE_111H2.this.tmpP.jdField_y_of_type_Double;
          CockpitHE_111H2.this.tmpV.jdField_z_of_type_Double = CockpitHE_111H2.this.tmpP.jdField_z_of_type_Double;
          CockpitHE_111H2.this.tmpV.normalize();

          CockpitHE_111H2.this.tmpV.jdField_z_of_type_Double -= 0.03489900007843971D;
          if (CockpitHE_111H2.this.tmpV.jdField_x_of_type_Double > 0.9599999785423279D)
          {
            if (CockpitHE_111H2.this.tmpV.jdField_y_of_type_Double > 0.0D)
              CockpitHE_111H2.this.setNew.blindDotX = (1.889F * (float)Math.sqrt(CockpitHE_111H2.this.tmpV.jdField_y_of_type_Double));
            else {
              CockpitHE_111H2.this.setNew.blindDotX = (-1.889F * (float)Math.sqrt(-CockpitHE_111H2.this.tmpV.jdField_y_of_type_Double));
            }
            if (CockpitHE_111H2.this.tmpV.jdField_z_of_type_Double > 0.0D)
              CockpitHE_111H2.this.setNew.blindDotY = (1.889F * (float)Math.sqrt(CockpitHE_111H2.this.tmpV.jdField_z_of_type_Double));
            else
              CockpitHE_111H2.this.setNew.blindDotY = (-1.889F * (float)Math.sqrt(-CockpitHE_111H2.this.tmpV.jdField_z_of_type_Double));
          }
          else {
            CockpitHE_111H2.this.setNew.blindDotX = 0.0F;
            CockpitHE_111H2.this.setNew.blindDotY = 0.0F;
          }
        }
      }
  ...
  private class Variables
  {
    ...
    float blindDotY;
    float vspeed;
    private final CockpitHE_111H2 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitHE_111H2.1 arg2) { this();
    }
  }
}