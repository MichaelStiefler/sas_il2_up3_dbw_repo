...
public class CockpitSEAHURRICANE2 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitSEAHURRICANE2 this$0;
    ...
    Variables(CockpitSEAHURRICANE2.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSEAHURRICANE2.this.bNeedSetUp) {
        ...
        CockpitSEAHURRICANE2.access$102(CockpitSEAHURRICANE2.this, false);
      }
      if (CockpitSEAHURRICANE2.this.fm != null) {
        CockpitSEAHURRICANE2.access$202(CockpitSEAHURRICANE2.this, CockpitSEAHURRICANE2.this.setOld);
        CockpitSEAHURRICANE2.access$302(CockpitSEAHURRICANE2.this, CockpitSEAHURRICANE2.this.setNew);
        CockpitSEAHURRICANE2.access$402(CockpitSEAHURRICANE2.this, CockpitSEAHURRICANE2.this.setTmp);
        CockpitSEAHURRICANE2.this.setNew.throttle = ((10.0F * CockpitSEAHURRICANE2.this.setOld.throttle + CockpitSEAHURRICANE2.this.fm.CT.PowerControl) / 11.0F);

        CockpitSEAHURRICANE2.this.setNew.altimeter = CockpitSEAHURRICANE2.this.fm.getAltitude();
        if (Math.abs(CockpitSEAHURRICANE2.this.fm.Or.getKren()) < 30.0F) {
          CockpitSEAHURRICANE2.this.setNew.azimuth = ((35.0F * CockpitSEAHURRICANE2.this.setOld.azimuth + -CockpitSEAHURRICANE2.this.fm.Or.getYaw()) / 36.0F);
        }
        if ((CockpitSEAHURRICANE2.this.setOld.azimuth > 270.0F) && (CockpitSEAHURRICANE2.this.setNew.azimuth < 90.0F))
          CockpitSEAHURRICANE2.this.setOld.azimuth -= 360.0F;
        if ((CockpitSEAHURRICANE2.this.setOld.azimuth < 90.0F) && (CockpitSEAHURRICANE2.this.setNew.azimuth > 270.0F))
          CockpitSEAHURRICANE2.this.setOld.azimuth += 360.0F;
        CockpitSEAHURRICANE2.this.setNew.waypointAzimuth = ((10.0F * CockpitSEAHURRICANE2.this.setOld.waypointAzimuth + (CockpitSEAHURRICANE2.this.waypointAzimuth() - CockpitSEAHURRICANE2.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

        CockpitSEAHURRICANE2.this.setNew.vspeed = ((199.0F * CockpitSEAHURRICANE2.this.setOld.vspeed + CockpitSEAHURRICANE2.this.fm.getVertSpeed()) / 200.0F);
      }
