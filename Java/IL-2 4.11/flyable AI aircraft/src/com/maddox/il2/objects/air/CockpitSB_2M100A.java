// Source File Name: CockpitSB_2M100A.java
			...
			if (CockpitSB_2M100A.this.fm != null) {
				...
				if (CockpitSB_2M100A.this.fm.CT.Weapons[3] != null) {
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 0) {
						CockpitSB_2M100A.this.bBombs[1] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][0]
								.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 1) {
						CockpitSB_2M100A.this.bBombs[0] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][1]
								.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 2) {
						CockpitSB_2M100A.this.bBombs[3] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][2]
								.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 3) {
						CockpitSB_2M100A.this.bBombs[2] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][3]
								.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 4) {
						CockpitSB_2M100A.this.bBombs[5] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][4]
								.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 5) {
						CockpitSB_2M100A.this.bBombs[4] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][5]
								.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 6) {
						CockpitSB_2M100A.this.bBombs[5] = CockpitSB_2M100A.this.bBombs[5]
								|| !CockpitSB_2M100A.this.fm.CT.Weapons[3][6]
										.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 7) {
						CockpitSB_2M100A.this.bBombs[4] = CockpitSB_2M100A.this.bBombs[4]
								|| !CockpitSB_2M100A.this.fm.CT.Weapons[3][7]
										.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 8) {
						CockpitSB_2M100A.this.bBombs[7] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][8]
								.haveBullets();
					}
					if (CockpitSB_2M100A.this.fm.CT.Weapons[3].length > 9) {
						CockpitSB_2M100A.this.bBombs[6] = !CockpitSB_2M100A.this.fm.CT.Weapons[3][9]
								.haveBullets();
					}
				}
				CockpitSB_2M100A.this.setNew.throttle1 = (0.9F * CockpitSB_2M100A.this.setOld.throttle1)
						+ (0.1F * CockpitSB_2M100A.this.fm.EI.engines[0]
								.getControlThrottle());
				CockpitSB_2M100A.this.setNew.prop1 = (0.9F * CockpitSB_2M100A.this.setOld.prop1)
						+ (0.1F * CockpitSB_2M100A.this.fm.EI.engines[0]
								.getControlProp());
				CockpitSB_2M100A.this.setNew.mix1 = (0.8F * CockpitSB_2M100A.this.setOld.mix1)
						+ (0.2F * CockpitSB_2M100A.this.fm.EI.engines[0]
								.getControlMix());
				CockpitSB_2M100A.this.setNew.man1 = (0.92F * CockpitSB_2M100A.this.setOld.man1)
						+ (0.08F * CockpitSB_2M100A.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitSB_2M100A.this.setNew.throttle2 = (0.9F * CockpitSB_2M100A.this.setOld.throttle2)
						+ (0.1F * CockpitSB_2M100A.this.fm.EI.engines[1]
								.getControlThrottle());
				CockpitSB_2M100A.this.setNew.prop2 = (0.9F * CockpitSB_2M100A.this.setOld.prop2)
						+ (0.1F * CockpitSB_2M100A.this.fm.EI.engines[1]
								.getControlProp());
				CockpitSB_2M100A.this.setNew.mix2 = (0.8F * CockpitSB_2M100A.this.setOld.mix2)
						+ (0.2F * CockpitSB_2M100A.this.fm.EI.engines[1]
								.getControlMix());
				CockpitSB_2M100A.this.setNew.man2 = (0.92F * CockpitSB_2M100A.this.setOld.man2)
						+ (0.08F * CockpitSB_2M100A.this.fm.EI.engines[1]
								.getManifoldPressure());
				CockpitSB_2M100A.this.setNew.altimeter = CockpitSB_2M100A.this.fm
						.getAltitude();
				CockpitSB_2M100A.this.setNew.azimuth.setDeg(
						CockpitSB_2M100A.this.setOld.azimuth.getDeg(1.0F),
						CockpitSB_2M100A.this.fm.Or.azimut());
				CockpitSB_2M100A.this.setNew.vspeed = ((100F * CockpitSB_2M100A.this.setOld.vspeed) + CockpitSB_2M100A.this.fm
						.getVertSpeed()) / 101F;
				float f = CockpitSB_2M100A.this.waypointAzimuth();
				CockpitSB_2M100A.this.setNew.waypointAzimuth.setDeg(
						CockpitSB_2M100A.this.setOld.waypointAzimuth
								.getDeg(0.1F),
						(f - CockpitSB_2M100A.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitSB_2M100A.this.setNew.waypointDirection.setDeg(
						CockpitSB_2M100A.this.setOld.waypointDirection
								.getDeg(1.0F), f);
				CockpitSB_2M100A.this.mesh.chunkSetAngles("Z_RTurret",
						CockpitSB_2M100A.this.aircraft().FM.turret[0].tu[0],
						0.0F, 0.0F);
				CockpitSB_2M100A.this.mesh.chunkSetAngles("Z_RGun",
						-CockpitSB_2M100A.this.aircraft().FM.turret[0].tu[1],
						0.0F, 0.0F);
				CockpitSB_2M100A.this.setNew.inert = (0.999F * CockpitSB_2M100A.this.setOld.inert)
						+ (0.001F * (CockpitSB_2M100A.this.fm.EI.engines[0]
