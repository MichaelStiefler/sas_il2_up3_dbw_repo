...
//            Scheme1, TypeBomber, TypeStormovik, TypeScout, 
//            Aircraft, NetAircraft, PaintScheme

public abstract class Swordfish extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeBomber, com.maddox.il2.objects.air.TypeStormovik, com.maddox.il2.objects.air.TypeScout
{
    ...
    public void rareAction(float f, boolean flag)
    {
        ...
        if(!bTAGKilled)
        {
            ...
            com.maddox.il2.engine.Actor actor = com.maddox.il2.ai.War.GetNearestEnemy(((com.maddox.il2.engine.Actor) (this)), 16, 6000F);
            com.maddox.il2.ai.War war2 = war;
            com.maddox.il2.objects.air.Aircraft aircraft = com.maddox.il2.ai.War.getNearestEnemy(((com.maddox.il2.objects.air.Aircraft) (this)), 5000F);
    ...
    public void moveAirBrake(float f)
    {
        ...
        } else
        {
            ...
            resetYPRmodifier();
            com.maddox.il2.objects.air.Aircraft.xyz[2] = 0.45F * f;
            hierMesh().chunkSetLocate("Pilot3_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
    ...
    public void moveWheelSink()
    {
        ...
        hierMesh().chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(wheel1, 0.0F, 0.04F, 0.0F, 9F), 0.0F);
        hierMesh().chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(wheel1, 0.0F, 0.04F, 0.0F, 5F), 0.0F);
        hierMesh().chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(wheel2, 0.0F, 0.04F, 0.0F, -9F), 0.0F);
        hierMesh().chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(wheel2, 0.0F, 0.04F, 0.0F, -5F), 0.0F);
    }
    ...
    public void update(float f)
    {
        ...
        if(FM.CT.getArrestor() > 0.2F)
            ...
            {
                float f3 = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.arrestorVAngle, -26F, 11F, 1.0F, 0.0F);
        ...
        if(FM.EI.engines[0].getRPM() > 100F)
            slat = 0.96F * slat + 0.04F * com.maddox.il2.objects.air.Aircraft.cvt(FM.getSpeedKMH(), 80F, 110F, -0.18F, 0.0F);
        else
            slat = 0.995F * slat;
        com.maddox.il2.objects.air.Aircraft.xyz[1] = slat;
        ...
        if(TAGMove < TAGMoveTot && !bTAGKilled && !FM.AS.isPilotParatrooper(2))
        {
            if(TAGMove < 0.2F || TAGMove > TAGMoveTot - 0.2F)
                TAGMove += ((float) (0.29999999999999999D * (double)f));
            else
            if(TAGMove < 0.1F || TAGMove > TAGMoveTot - 0.1F)
                TAGMove += 0.15F;
            else
                TAGMove += ((float) (1.2D * (double)f));
            TAGLookAzimuth = com.maddox.il2.objects.air.Aircraft.cvt(TAGMove, 0.0F, TAGMoveTot, TAGAzimuthOld, TAGAzimuth);
            TAGLookElevation = com.maddox.il2.objects.air.Aircraft.cvt(TAGMove, 0.0F, TAGMoveTot, TAGElevationOld, TAGElevation);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        {
            getEnergyPastArmor(20.760000228881836D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
            if(shot.power <= 0.0F)
                doRicochetBack(shot);
        } else
