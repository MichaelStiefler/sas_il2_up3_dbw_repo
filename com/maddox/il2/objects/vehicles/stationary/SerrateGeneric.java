...
// Source File Name:   SerrateGeneric.java
...
public abstract class SerrateGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.SerrateGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SerrateGeneric.Rnd(15F, 15F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.SerrateGeneric serrategeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.SerrateGeneric.constr_arg2 = actorspawnarg;
                serrategeneric = (com.maddox.il2.objects.vehicles.stationary.SerrateGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.SerrateGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create SerrateGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (serrategeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.SerrateGeneric.mesh_name);
            cls = class1;
    ...
    private SerrateGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    public void startMove()
    {
        if(!interpEnd("move"))
        {
            ...
            engineSTimer = -(int)com.maddox.il2.objects.vehicles.stationary.SerrateGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SerrateGeneric.Rnd(5F, 5F));
        }
    }
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if((actor instanceof com.maddox.il2.objects.air.TypeFighter) && actor.getArmy() != myArmy && actor != com.maddox.il2.ai.World.getPlayerAircraft() && actor.getSpeed(vector3d) > 20D)
            {
                pos.getAbs(point3d);
                ...
                int l1 = k1 - j;
                int i2 = 16000;
                if(l1 >= 220 && l1 <= 320 && java.lang.Math.sqrt(i1 * i1) <= 60D)
                    i2 = 0x13880;
                if(j1 <= i2)
                    com.maddox.il2.game.HUD.logCenter("                                         Serrate: Target bearing " + l + "\260");
            }
        }
