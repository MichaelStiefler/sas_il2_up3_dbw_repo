// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 8/2/2011 11:06:30 PM
...
//            BF_109E7, BF_109E4B, BF_109E7NZ, AircraftLH, Aircraft
...
public class CockpitBF_109Ex extends com.maddox.il2.objects.air.CockpitPilot
{
    private class Variables
    {
        ...
        Variables(com.maddox.il2.objects.air.CockpitBF_109Ex.Variables variables)
        {
            this();
        }
    }
    ...
    protected void reflectPlaneMats()
    {
        ...
        {
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.BF_109E4)
                type = 0;
            else
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.BF_109E4N)
                type = 1;
            else
            if((((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.BF_109E7N) || (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.BF_109E7))
                type = 2;
            else
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.BF_109E4B)
                type = 3;
            else
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.BF_109E7NZ)
                type = 4;
            switch(type)
            {
            case 0: // '\0'
    ...
    boolean hasCanopy;
    private com.maddox.il2.objects.air.CockpitBF_109Ex.Variables setOld;
    private com.maddox.il2.objects.air.CockpitBF_109Ex.Variables setNew;
    private com.maddox.il2.objects.air.CockpitBF_109Ex.Variables setTmp;
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitBF_109Ex.class, "normZN", 0.5F);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitBF_109Ex.class, "gsZN", 0.5F);
    }
