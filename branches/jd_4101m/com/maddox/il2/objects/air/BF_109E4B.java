...
public class BF_109E4B extends BF_109
{
  ...
  static
  {
    ...
    weaponsRegister(localClass, "default", new String[] { "MGunMG17si 1000", "MGunMG17si 1000", "MGunMGFFk 60", "MGunMGFFk 60", null, null, null, null, null });

    weaponsRegister(localClass, "4xSC50", new String[] { "MGunMG17si 1000", "MGunMG17si 1000", "MGunMGFFk 60", "MGunMGFFk 60", null, "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1" });

    weaponsRegister(localClass, "1xSC250", new String[] { "MGunMG17si 1000", "MGunMG17si 1000", "MGunMGFFk 60", "MGunMGFFk 60", "BombGunSC250 1", null, null, null, null });
