...
//            TypeTNBFighter, NetAircraft, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.G50.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.2F, 0.0F, 0.2F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        xyz[1] = com.maddox.il2.objects.air.G50.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.2F, 0.0F, 0.2F);
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.G50.weaponTriggersRegister(class1, new int[] {
            0, 0
        });
        com.maddox.il2.objects.air.G50.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02"
        });
        com.maddox.il2.objects.air.G50.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBredaSAFAT127siG50 300", "MGunBredaSAFAT127siG50 300"
        });
        com.maddox.il2.objects.air.G50.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
