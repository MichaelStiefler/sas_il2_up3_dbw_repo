  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitI_185M82.this.fm != null) {
        ...
        CockpitI_185M82.this.setNew.throttle = ((10.0F * CockpitI_185M82.this.setOld.throttle + CockpitI_185M82.this.fm.CT.PowerControl) / 11.0F);
        ...
        if (Math.abs(CockpitI_185M82.this.fm.Or.getKren()) < 30.0F) {
          CockpitI_185M82.this.setNew.azimuth = ((35.0F * CockpitI_185M82.this.setOld.azimuth + -CockpitI_185M82.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        {
          CockpitI_185M82.this.setNew.waypointAzimuth = 0.0F;
        }
        else
        {
          CockpitI_185M82.this.setNew.waypointAzimuth = ((10.0F * CockpitI_185M82.this.setOld.waypointAzimuth + (CockpitI_185M82.this.waypointAzimuth() - CockpitI_185M82.this.setOld.azimuth)) / 11.0F);
        }

        CockpitI_185M82.this.setNew.vspeed = ((199.0F * CockpitI_185M82.this.setOld.vspeed + CockpitI_185M82.this.fm.getVertSpeed()) / 200.0F);
        if (CockpitI_185M82.this.fm.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitI_185M82.this.cvt(CockpitI_185M82.this.fm.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitI_185M82.this.cvt(CockpitI_185M82.this.fm.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
        ...
        CockpitI_185M82.access$602(CockpitI_185M82.this, 0.8F * CockpitI_185M82.this.pictStage + 0.1F * CockpitI_185M82.this.fm.EI.engines[0].getControlCompressor());
      }
      return true;
    }
  }
