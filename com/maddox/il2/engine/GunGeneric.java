...
public abstract class GunGeneric extends com.maddox.il2.engine.Actor
{
        ...
        public int preRender(com.maddox.il2.engine.Actor actor)
        {
            if(bLighting && light != null)
                ...
                } else
                {
                    ...
                    {
                        float f = 0.525F - com.maddox.il2.ai.World.Sun().Ambient;
                        float f1 = prop.emitI * f;
                        if(l > lastShotTime)
                        {
                            float f2 = (2.0F * (float)(l - lastShotTime)) / (float)(l1 - lastShotTime);
                            if(f2 < 1.0F)
                                f1 *= f2;
                        }
                        light.light.setEmit(f1, prop.emitR * f);
    ...
    public void set(com.maddox.il2.engine.Actor actor, java.lang.String s)
    {
        ...
        if(prop.shells != null)
        {
            if(prop.shells.equals("3DO/Effects/GunShells/GunShells.eff") && prop.bullet[0].kalibr > 0.0002F)
                prop.shells = "3DO/Effects/GunShells/MediumShells.eff";
