...
//            Scheme4, TypeBomber, TypeTransport, Aircraft, 
//            PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeBomber, com.maddox.il2.objects.air.TypeTransport
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Nose Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Tail Spar Damaged..");
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, i, 2);
                            com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Crank Case Hit - Readyness Reduced to " + FM.EI.engines[i].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[i].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Cylinders Hit, " + FM.EI.engines[i].getCylindersOperable() + "/" + FM.EI.engines[i].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                        {
                            FM.AS.hitEngine(shot.initiator, i, 2);
                            com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Cylinders Hit - Engine Fires..");
                        }
                    }
                ...
                if(s.endsWith("prop") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Module: Prop Governor Fails..");
                }
                if(s.endsWith("oil1") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Module: Oil Filter Pierced..");
                }
                if(s.endsWith("supc") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + i + ") Module: Compressor Stops..");
        ...
        if(s.startsWith("xoil"))
        {
            ...
            if(getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
            {
                ...
                com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine (" + k + ") Module: Oil Filter Pierced (E)..");
            }
            return;
        }
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL8_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, -80F));
        hiermesh.chunkSetAngles("GearL9_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, 80F));
        hiermesh.chunkSetAngles("GearL10_D0", 0.0F, 0.0F, f < 0.5F ? com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, -80F) : com.maddox.il2.objects.air.Aircraft.cvt(f, 0.93F, 0.99F, 80F, 0.0F));
        hiermesh.chunkSetAngles("GearL11_D0", 0.0F, 0.0F, f < 0.5F ? com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, 80F) : com.maddox.il2.objects.air.Aircraft.cvt(f, 0.93F, 0.99F, -80F, 0.0F));
        ...
        hiermesh.chunkSetAngles("GearR8_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, 80F), 0.0F);
        hiermesh.chunkSetAngles("GearR9_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, -80F), 0.0F);
        hiermesh.chunkSetAngles("GearR10_D0", 0.0F, f < 0.5F ? com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, 80F) : com.maddox.il2.objects.air.Aircraft.cvt(f, 0.93F, 0.99F, 80F, 0.0F), 0.0F);
        hiermesh.chunkSetAngles("GearR11_D0", 0.0F, f < 0.5F ? com.maddox.il2.objects.air.Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, -80F) : com.maddox.il2.objects.air.Aircraft.cvt(f, 0.93F, 0.99F, -80F, 0.0F), 0.0F);
    }
    ...
    {
        float f = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.4615F, 0.0F, -26.5F);
        hierMesh().chunkSetAngles("GearL3_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.4615F, 0.0F, 21.5F);
        hierMesh().chunkSetAngles("GearL12_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.4615F, 0.0F, 3.5F);
        hierMesh().chunkSetAngles("GearL13_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.4615F, 0.0F, -26.5F);
        hierMesh().chunkSetAngles("GearR3_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.4615F, 0.0F, 21.5F);
        hierMesh().chunkSetAngles("GearR12_D0", 0.0F, f, 0.0F);
        f = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.4615F, 0.0F, 3.5F);
