...
public class PaintSchemeFCSPar02 extends PaintSchemeFMPar02
{
  ...
  public void prepareNum(Class paramClass, HierMesh paramHierMesh, Regiment paramRegiment, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramRegiment.country() == PaintScheme.countryFinland) {
      ...
      if (paramInt1 == 3) {
        changeMat(paramHierMesh, "Overlay1", "psFCS02FINCNUM" + i + paramInt1 + "_" + (char)(65 + (paramInt3 % 10 - 1)), "Finnish/" + (char)(65 + (paramInt3 % 10 - 1)) + ".tga", PaintScheme.psFinnishFighterColor[paramInt1][0], PaintScheme.psFinnishFighterColor[paramInt1][1], PaintScheme.psFinnishFighterColor[paramInt1][2]);

        changeMat(paramHierMesh, "Overlay4", "psFCS02FINCNUM" + i + paramInt1 + "_" + (char)(65 + (paramInt3 % 10 - 1)), "Finnish/" + (char)(65 + (paramInt3 % 10 - 1)) + ".tga", PaintScheme.psFinnishFighterColor[paramInt1][0], PaintScheme.psFinnishFighterColor[paramInt1][1], PaintScheme.psFinnishFighterColor[paramInt1][2]);
      }
      else if (paramInt3 < 10) {
        changeMat(paramHierMesh, "Overlay1", "psFCS02FINLNUM" + i + paramInt1 + "0" + paramInt3, "null.tga", PaintScheme.psFinnishFighterPrefix[0][paramInt1] + paramInt3 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);

        changeMat(paramHierMesh, "Overlay4", "psFCS02FINRNUM" + i + paramInt1 + "0" + paramInt3, PaintScheme.psFinnishFighterPrefix[0][paramInt1] + paramInt3 + ".tga", "null.tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
      }
      else
      {
        changeMat(paramHierMesh, "Overlay1", "psFCS02FINCNUM" + i + paramInt1 + paramInt3, PaintScheme.psFinnishFighterPrefix[0][paramInt1] + paramInt3 / 10 + ".tga", PaintScheme.psFinnishFighterPrefix[0][paramInt1] + paramInt3 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);

        changeMat(paramHierMesh, "Overlay4", "psFCS02FINCNUM" + i + paramInt1 + paramInt3, PaintScheme.psFinnishFighterPrefix[0][paramInt1] + paramInt3 / 10 + ".tga", PaintScheme.psFinnishFighterPrefix[0][paramInt1] + paramInt3 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
      }
    ...
    if (paramRegiment.country() == PaintScheme.countryItaly) {
      if (paramInt3 < 10) {
        changeMat(paramHierMesh, "Overlay2", "psFCS02ITALNUM" + i + paramInt1 + paramInt3, "Russian/1" + paramInt3 % 10 + ".tga", PaintScheme.psGermanBomberColor[1][0], PaintScheme.psGermanBomberColor[1][1], PaintScheme.psGermanBomberColor[1][2]);

        changeMat(paramHierMesh, "Overlay3", "psFCS02ITARNUM" + i + paramInt1 + paramInt3, "null.tga", "Russian/1" + paramInt3 % 10 + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psGermanBomberColor[1][0], PaintScheme.psGermanBomberColor[1][1], PaintScheme.psGermanBomberColor[1][2]);
      }
      else
      {
        changeMat(paramHierMesh, "Overlay2", "psFCS02ITACNUM" + i + paramInt1 + paramInt3, "Russian/1" + paramInt3 / 10 + ".tga", "Russian/1" + paramInt3 % 10 + ".tga", PaintScheme.psGermanBomberColor[1][0], PaintScheme.psGermanBomberColor[1][1], PaintScheme.psGermanBomberColor[1][2], PaintScheme.psGermanBomberColor[1][0], PaintScheme.psGermanBomberColor[1][1], PaintScheme.psGermanBomberColor[1][2]);

        changeMat(paramHierMesh, "Overlay3", "psFCS02ITACNUM" + i + paramInt1 + paramInt3, "Russian/1" + paramInt3 / 10 + ".tga", "Russian/1" + paramInt3 % 10 + ".tga", PaintScheme.psGermanBomberColor[1][0], PaintScheme.psGermanBomberColor[1][1], PaintScheme.psGermanBomberColor[1][2], PaintScheme.psGermanBomberColor[1][0], PaintScheme.psGermanBomberColor[1][1], PaintScheme.psGermanBomberColor[1][2]);
      }
