...
// Source File Name:   NaxosGeneric.java
...
public abstract class NaxosGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.NaxosGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.NaxosGeneric.Rnd(15F, 15F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.NaxosGeneric naxosgeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.NaxosGeneric.constr_arg2 = actorspawnarg;
                naxosgeneric = (com.maddox.il2.objects.vehicles.stationary.NaxosGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.NaxosGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create NaxosGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (naxosgeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.NaxosGeneric.mesh_name);
            cls = class1;
    ...
    private NaxosGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    public void startMove()
    {
        if(!interpEnd("move"))
        {
            ...
            engineSTimer = -(int)com.maddox.il2.objects.vehicles.stationary.NaxosGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.NaxosGeneric.Rnd(5F, 5F));
        }
    }
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if((actor instanceof com.maddox.il2.objects.air.TypeBomber) && actor.getArmy() != myArmy && actor != com.maddox.il2.ai.World.getPlayerAircraft() && actor.getSpeed(vector3d) > 20D)
            {
                pos.getAbs(point3d);
                ...
                if(l1 < 0)
                    l1 = 360 + l1;
                int i2 = l1 - j;
                if((double)k1 <= 50000D && (double)k1 >= 100D && d6 < 0.0D)
                    com.maddox.il2.game.HUD.logCenter("                                          Naxos: Target bearing " + i1 + "\260");
            }
        }
