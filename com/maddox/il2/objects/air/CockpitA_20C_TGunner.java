...
// Source File Name:   CockpitA_20C_TGunner.java
...
public class CockpitA_20C_TGunner extends com.maddox.il2.objects.air.CockpitGunner
{
    ...
    public void moveGun(com.maddox.il2.engine.Orient orient)
    {
        ...
        resetYPRmodifier();
        if(f < 0.0F)
            xyz[0] = cvt(f, -45F, 0.0F, 0.25F, 0.0F);
        else
            xyz[0] = cvt(f, 0.0F, 45F, 0.0F, 0.25F);
        mesh.chunkSetLocate("Turret1E", xyz, ypr);
    }
