...
public class F_86D extends Scheme1 implements TypeSupersonic, TypeBNZFighter,
        TypeFighterAceMaker, TypeFighter, TypeGSuit {
  ...
  public void update(float paramFloat) {
    ...
    if (FM.AS.isMaster() && Config.isUSE_RENDER()) {
      if (FM.EI.engines[0].getPowerOutput() > 0.45F
        ...
        } else if (FM.EI.engines[0].getPowerOutput() > 0.65F
                && FM.EI.engines[0].getPowerOutput() < 1.001F) {
