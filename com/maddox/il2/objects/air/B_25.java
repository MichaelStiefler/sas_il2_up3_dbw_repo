...
//            Scheme2a, PaintScheme

public abstract class B_25 extends com.maddox.il2.objects.air.Scheme2a
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC6_D0", 0.0F, com.maddox.il2.objects.air.B_25.floatindex(com.maddox.il2.objects.air.B_25.cvt(f, 0.0F, 1.0F, 0.0F, 10F), anglesc6), 0.0F);
        hiermesh.chunkSetAngles("GearC7_D0", 0.0F, com.maddox.il2.objects.air.B_25.floatindex(com.maddox.il2.objects.air.B_25.cvt(f, 0.0F, 1.0F, 0.0F, 10F), anglesc7), 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.0F, 0.1F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, 0.0F, -89.5F * f);
        if(f < 0.5F)
        {
            hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.01F, 0.1F, 0.0F, -45F), 0.0F);
            hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.01F, 0.1F, 0.0F, 45F), 0.0F);
        } else
        {
            hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.9F, 0.99F, -45F, 0.0F), 0.0F);
            hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.9F, 0.99F, 45F, 0.0F), 0.0F);
        }
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.0F, 0.1F, 0.0F, 60F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 0.0F, -89.5F * f);
        if(f < 0.5F)
        {
            hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.01F, 0.1F, 0.0F, -45F), 0.0F);
            hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.01F, 0.1F, 0.0F, 45F), 0.0F);
        } else
        {
            hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.9F, 0.99F, -45F, 0.0F), 0.0F);
            hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.9F, 0.99F, 45F, 0.0F), 0.0F);
        }
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, com.maddox.il2.objects.air.B_25.cvt(f, 0.0F, 0.1F, 0.0F, -60F), 0.0F);
    }

    protected void moveGear(float f)
    {
        com.maddox.il2.objects.air.B_25.moveGear(hierMesh(), f);
    }

    public void moveWheelSink()
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.B_25.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.33F, 0.0F, 0.33F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.B_25.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.33F, 0.0F, 0.33F);
        hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.B_25.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.154F, 0.0F, 0.154F);
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                if(s.endsWith("p1") || s.endsWith("p2"))
                    if(java.lang.Math.abs(v1.x) > 0.5D)
                        getEnergyPastArmor(7.940000057220459D / java.lang.Math.abs(v1.x), shot);
                    else
                        getEnergyPastArmor(9.5299997329711914D / (1.0D - java.lang.Math.abs(v1.x)), shot);
                if(s.endsWith("p3"))
                    getEnergyPastArmor(7.940000057220459D / (java.lang.Math.abs(v1.z) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("p4"))
                    getEnergyPastArmor(9.5299997329711914D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("p5") || s.endsWith("p6"))
                    getEnergyPastArmor(9.5299997329711914D / (java.lang.Math.abs(v1.y) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("p7"))
                    getEnergyPastArmor(0.5D / (java.lang.Math.abs(v1.z) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("p8"))
                    getEnergyPastArmor(9.5299997329711914D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("a1"))
                    getEnergyPastArmor(9.5299997329711914D / (java.lang.Math.abs(v1.y) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("a2"))
                    getEnergyPastArmor(9.5299997329711914D / (java.lang.Math.abs(v1.y) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("a3"))
                    getEnergyPastArmor(6.3499999046325684D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("a4") || s.endsWith("a5"))
                    getEnergyPastArmor(12.699999809265137D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("a6") || s.endsWith("a7"))
                    getEnergyPastArmor(6.3499999046325684D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("r1"))
                    getEnergyPastArmor(3.1700000762939453D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("r2") || s.endsWith("r3"))
                    getEnergyPastArmor(9.5299997329711914D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if(s.endsWith("c1") || s.endsWith("c2"))
                    getEnergyPastArmor(8.7299995422363281D / (java.lang.Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                return;
            }
            ...
            {
                if(s.startsWith("xxspart") && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(19.9F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F)
                {
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.B_25.class;
