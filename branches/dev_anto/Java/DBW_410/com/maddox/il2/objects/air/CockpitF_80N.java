// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 21/07/2011 10:40:46 PM
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   CockpitF_80N.java
...
//            CockpitPilot, Cockpit, AircraftLH, F_80N, 
//            P_80

public class CockpitF_80N extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f4 = ((P_80) ((F_80N)aircraft())).k14Distance;
                setNew.k14w = (5F * CockpitF_80N.k14TargetWingspanScale[((P_80) ((F_80N)aircraft())).k14WingspanType]) / f4;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitF_80N.k14TargetMarkScale[((P_80) ((F_80N)aircraft())).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((P_80) ((F_80N)aircraft())).k14Mode;
                ...
                float f3 = floatindex((f4 - 200F) * 0.04F, CockpitF_80N.k14BulletDrop) - CockpitF_80N.k14BulletDrop[0];
    ...
    public CockpitF_80N()
    {
        super("3DO/Cockpit/YP-80N/hier.him", "bf109");
    ...
    {
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.625F);
        Cockpit.xyz[2] = cvt(((FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.06845F);
        Cockpit.ypr[2] = cvt(((FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 1.0F);
        super.mesh.chunkSetLocate("Canopy", Cockpit.xyz, Cockpit.ypr);
        if((((FlightModelMain) (super.fm)).AS.astateCockpitState & 2) == 0)
        {
            int i = ((P_80) ((F_80N)aircraft())).k14Mode;
            boolean flag = i < 2;
