...
public class CockpitCant_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            float f = ((CantZ1007)aircraft()).fSightCurForwardAngle;
            float f1 = 0.0F;
            if(bEntered)
            {
    ...
    protected boolean doFocusEnter()
    {
        if(super.doFocusEnter())
        {
            ...
            ((CantZ1007)fm.actor).bPitUnfocused = false;
    ...
    protected void doFocusLeave()
    {
        if(isFocused())
        {
            ((CantZ1007)fm.actor).bPitUnfocused = true;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(!aircraft().thisWeaponsName.startsWith("1x"))
        {
            ...
            if(f2 > 360F)
                f2 -= 360F;
            f2 *= 0.00872664F;
            float f3 = ((CantZ1007)aircraft()).fSightSetForwardAngle - (float)java.lang.Math.toRadians(f2);
            ...
            mesh.chunkSetAngles("Cylinder", 0.0F, ((CantZ1007)aircraft()).fSightCurSideslip, 0.0F);
        }
    }
