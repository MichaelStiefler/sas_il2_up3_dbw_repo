...
public class CockpitYAK_9 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("richag", 0.0F, this.fm.CT.getAileron() * 15.0F, this.fm.CT.getElevator() * 10.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      if (CockpitYAK_9.this.fm != null) {
        ...
        CockpitYAK_9.this.setNew.throttle = ((10.0F * CockpitYAK_9.this.setOld.throttle + CockpitYAK_9.this.fm.CT.PowerControl) / 11.0F);
        CockpitYAK_9.this.setNew.prop = ((10.0F * CockpitYAK_9.this.setOld.prop + CockpitYAK_9.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_9.this.setNew.altimeter = CockpitYAK_9.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_9.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_9.this.setNew.azimuth = ((35.0F * CockpitYAK_9.this.setOld.azimuth + CockpitYAK_9.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitYAK_9.this.setNew.vspeed = ((199.0F * CockpitYAK_9.this.setOld.vspeed + CockpitYAK_9.this.fm.getVertSpeed()) / 200.0F);
      }
