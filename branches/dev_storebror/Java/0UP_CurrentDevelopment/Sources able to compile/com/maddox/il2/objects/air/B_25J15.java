    ...
    implements TypeBomber, TypeStormovikArmored
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = B_25J15.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= B_25J15.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / B_25J15.toMeters(fSightCurAltitude)));
            calibDistance = B_25J15.toMetersPerSecond(fSightCurSpeed) * floatindex(Aircraft.cvt(B_25J15.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)B_25J15.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(B_25J15.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = B_25J15.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "B-25");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/B-25J-15(Multi1)/hier.him");
        com.maddox.rts.Property.set(class1, "PaintScheme", new PaintSchemeBMPar03());
        com.maddox.rts.Property.set(class1, "meshName_us", "3DO/Plane/B-25J-15(USA)/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/B-25J15.fmd");
        ...
        B_25J15.weaponTriggersRegister(class1, new int[] {
        ...
        B_25J15.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        B_25J15.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        B_25J15.weaponsRegister(class1, "40xParaF", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "12x100lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "3x250lbs3x500lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "6x250lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "4x500lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "4x500lbs1x1000lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "6x500lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "2x1000lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "3x1000lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "4x1000lbs", new java.lang.String[] {
            "MGunBrowning50kiAPI 400", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 450", "MGunBrowning50tAPI 400", "MGunBrowning50tAPI 400", null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        B_25J15.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
