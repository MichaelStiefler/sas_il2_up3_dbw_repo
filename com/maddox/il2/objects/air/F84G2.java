...
public class F84G2 extends DO_335
  implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker
{
  ...
  public void doFireBoosters() {
    Eff3DActor.New(this, findHook("_Booster1"), null, 1.0F, "3DO/Effects/Rocket/RocketSmokeWhite.eff", 30.0F);

    Eff3DActor.New(this, findHook("_Booster2"), null, 1.0F, "3DO/Effects/Rocket/RocketSmokeWhite.eff", 30.0F);
  }
  ...
  public void update(float paramFloat)
  {
    ...
    if (((this.FM instanceof Pilot)) && 
      ...
      if ((this.bHasBoosters) && (this.boosterFireOutTime == -1L) && (this.FM.Gears.onGround()) && (this.FM.EI.getPowerOutput() > 0.8F) && (this.FM.getSpeedKMH() > 20.0F))
      {
  ...
  static
  {
    ...
    Property.set(localClass, "cockpitClass", new Class[] { CockpitF84G2.class });
