...
public class Explosions
{
  ...
  public static void HouseExplode(int paramInt, Loc paramLoc, float[] paramArrayOfFloat) {
    if (Config.isUSE_RENDER()) {
      ...
      SfxExplosion.building(paramLoc.getPoint(), k, paramArrayOfFloat);
    }
  }
  ...
  private static void fontain(Point3d paramPoint3d, float paramFloat1, float paramFloat2, int paramInt1, int paramInt2)
  {
    ...
    case 0:
      ...
      SurfaceLight(paramInt1, f3, 2.0F);
      SurfaceCrater(paramInt1, f4, 80.0F);
      o.set(0.0F, 90.0F, 0.0F);
      l.set(paramPoint3d, o);
      ...
      localLightPointActor.light.setEmit(1.0F, f3 * 2.0F);
  ...
  public static void ExplodeFuel(Point3d paramPoint3d) {
    if (Config.isUSE_RENDER()) {
      ...
      double d = paramPoint3d.z;
      World.cur();
      if (d - World.land().HQ(paramPoint3d.x, paramPoint3d.y) > 3.0D) {
        SfxExplosion.crashAir(paramPoint3d, 1);
      } else {
        World.cur();
        if (World.land().isWater(paramPoint3d.x, paramPoint3d.y))
          SfxExplosion.crashAir(paramPoint3d, 2);
        else
          SfxExplosion.crashAir(paramPoint3d, 0);
      }
  ...
  private static void LinearExplode(Point3d paramPoint3d1, Point3d paramPoint3d2, float paramFloat1, float paramFloat2, String paramString1, String paramString2)
  {
    ...
    int i = (int)(2.0D * d / paramFloat1 * paramFloat2);
    if (i < 2)
      i = 2;
    Point3d localPoint3d = new Point3d();
    float f1 = 4.0F;
  ...
  public static void bombFatMan_land(Point3d paramPoint3d, float paramFloat1, float paramFloat2)
  {
    if (!Config.isUSE_RENDER())
    {
      return;
    ...
    SurfaceCrater(0, 312.10001F, 900.0F);
  ...
  public static void bombFatMan_water(Point3d paramPoint3d, float paramFloat1, float paramFloat2)
  {
    if (!Config.isUSE_RENDER())
    {
      return;
  ...
  public static void bombFatMan_object(Point3d paramPoint3d, float paramFloat1, float paramFloat2)
  {
    if (!Config.isUSE_RENDER())
      return;
  }
  ...
  {
    generate(paramActor, paramPoint3d, paramFloat1, paramInt, paramFloat2, 0);
  }

  public static void generate(Actor paramActor, Point3d paramPoint3d, float paramFloat1, int paramInt1, float paramFloat2, int paramInt2)
  {
    if ((Config.isUSE_RENDER()) && 
      (paramActor != null)) {
      generateSound(paramActor, paramPoint3d, paramFloat1, paramInt1, paramFloat2);
      rel.set(paramPoint3d);
      paramActor.pos.getAbs(tmpLoc);
      paramActor.pos.getCurrent(l);
      ...
      else if ((paramActor instanceof ActorLand))
      {
        if (paramInt2 > 0)
        {
          if (paramInt2 == 1) {
            if (Engine.land().isWater(paramPoint3d.x, paramPoint3d.y))
              bombFatMan_water(paramPoint3d, -1.0F, 1.0F);
            else {
              bombFatMan_land(paramPoint3d, -1.0F, 1.0F);
            }
          }
  ...
  public static void generateShot(Actor paramActor, Shot paramShot) {
    if (Config.isUSE_RENDER()) {
      ...
      paramActor.pos.getAbs(tmpLoc);
      paramActor.pos.getCurrent(l);
      l.interpolate(tmpLoc, paramShot.tickOffset);
      rel.sub(l);
  ...
  public static void generateExplosion(Actor paramActor, Point3d paramPoint3d, float paramFloat1, int paramInt, float paramFloat2, double paramDouble)
  {
    if (Config.isUSE_RENDER()) {
      ...
      if (paramActor != null) {
        paramActor.pos.getAbs(tmpLoc);
        paramActor.pos.getCurrent(l);
        l.interpolate(tmpLoc, paramDouble);
        rel.sub(l);
      }
      if (paramActor != null)
        if ((paramActor instanceof ActorLand)) {
