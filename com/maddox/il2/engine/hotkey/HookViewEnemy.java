...
public class HookViewEnemy extends com.maddox.il2.engine.hotkey.HookView
{
    ...
    public void computePos(com.maddox.il2.engine.Actor actor, com.maddox.il2.engine.Loc loc, com.maddox.il2.engine.Loc loc1, boolean flag)
    {
        ...
        if(bUse)
        {
            ...
            o.setAT0(Ve);
            if(len < 0.0F && flag && -len + com.maddox.il2.engine.hotkey.HookViewEnemy.defaultLen() > f)
                len = -f + com.maddox.il2.engine.hotkey.HookViewEnemy.defaultLen();
            Ve.scale(-len);
            pAbs.add(Ve);
            if(!flag1)
                pAbs.z += 0.20000000000000001D * (double)len;
