  ...
  implements TypeFighter
{
  ...
  public void update(float paramFloat)
  {
    ...
    if (Math.abs(this.flapps - f) > 0.01F) {
      this.flapps = f;
      for (int i = 1; i < 11; i++)
        hierMesh().chunkSetAngles("Water" + i + "_D0", 0.0F, -30.0F * f, 0.0F);
    }
  }
  ...
  {
    resetYPRmodifier();
    Aircraft.xyz[1] = Aircraft.cvt(paramFloat, 0.16F, 0.98F, 0.0F, 0.65F);
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    paramHierMesh.chunkSetAngles("GearL6_D0", 0.0F, Aircraft.cvt(paramFloat, 0.1F, 0.82F, 0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL7_D0", 0.0F, Aircraft.cvt(paramFloat, 0.1F, 0.12F, 0.0F, -86.0F), 0.0F);

    paramHierMesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(paramFloat, 0.34F, 0.91F, 0.0F, -82.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR6_D0", 0.0F, Aircraft.cvt(paramFloat, 0.34F, 0.91F, 0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR7_D0", 0.0F, Aircraft.cvt(paramFloat, 0.34F, 0.36F, 0.0F, -86.0F), 0.0F);
  }
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx")) {
      if (paramString.startsWith("xxammo")) {
        if (paramString.startsWith("xxammo1")) {
          if (getEnergyPastArmor(1.25F, paramShot) > 0.0F) {
        ...
        if (paramString.startsWith("xxammo2")) {
          if ((getEnergyPastArmor(1.25F, paramShot) > 0.0F) && 
        ...
        if (paramString.startsWith("xxammo3")) {
          if ((getEnergyPastArmor(1.25F, paramShot) > 0.0F) && 
            (World.Rnd().nextFloat() < 0.12F)) {
      ...
      if (paramString.startsWith("xxcannon01")) {
        if (getEnergyPastArmor(11.0F, paramShot) > 0.0F) {
      ...
      if (paramString.startsWith("xxcontrols")) {
        ...
        case 2:
          ...
          if (World.Rnd().nextFloat() >= 0.275F) break;
          ...
          Aircraft.debugprintln(this, "*** Throttle Quadrant: Hit, Prop Controls Disabled.."); break;
        case 3:
        case 4:
      ...
      if (paramString.startsWith("xxeng")) {
        ...
        } else if ((paramString.endsWith("sap")) && 
          (getEnergyPastArmor(4.6F, paramShot) > 0.0F) && 
