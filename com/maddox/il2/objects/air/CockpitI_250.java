...
public class CockpitI_250 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(interp(setNew.mix, setOld.mix, f), 0.0F, 1.0F, 0.1035F, 0.0F);
        mesh.chunkSetLocate("MixLvr", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, 0.0204F, -0.0204F);
        mesh.chunkSetLocate("NeedAHCyl", xyz, ypr);
