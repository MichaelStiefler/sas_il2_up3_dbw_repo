...
public class CockpitYAK_3 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitYAK_3.access$102(CockpitYAK_3.this, CockpitYAK_3.this.setOld); CockpitYAK_3.access$202(CockpitYAK_3.this, CockpitYAK_3.this.setNew); CockpitYAK_3.access$302(CockpitYAK_3.this, CockpitYAK_3.this.setTmp);

        CockpitYAK_3.this.setNew.throttle = ((10.0F * CockpitYAK_3.this.setOld.throttle + CockpitYAK_3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_3.this.setNew.prop = ((10.0F * CockpitYAK_3.this.setOld.prop + CockpitYAK_3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_3.this.setNew.altimeter = CockpitYAK_3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_3.this.setNew.azimuth = ((35.0F * CockpitYAK_3.this.setOld.azimuth + CockpitYAK_3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitYAK_3.this.setOld.azimuth > 270.0F) && (CockpitYAK_3.this.setNew.azimuth < 90.0F)) CockpitYAK_3.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_3.this.setOld.azimuth < 90.0F) && (CockpitYAK_3.this.setNew.azimuth > 270.0F)) CockpitYAK_3.this.setOld.azimuth += 360.0F;
        CockpitYAK_3.this.setNew.vspeed = ((199.0F * CockpitYAK_3.this.setOld.vspeed + CockpitYAK_3.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_3 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitYAK_3.1 arg2) { this();
    }
  }
}