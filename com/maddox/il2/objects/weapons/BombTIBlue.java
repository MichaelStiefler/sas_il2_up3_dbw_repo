...
// Source File Name:   BombTIBlue.java
...
public class BombTIBlue extends com.maddox.il2.objects.weapons.Bomb
{
        ...
        if((double)charge < 1.01D)
        {
            ...
            if(com.maddox.il2.engine.Actor.isValid(actor))
            {
                ...
                for(int i = 0; i < 60; i++)
                {
                    ...
                    com.maddox.il2.objects.weapons.BombTiBu bombtibu = new BombTiBu();
                    bombtibu.pos.setUpdateEnable(true);
                    bombtibu.pos.setAbs(point3d, orient);
                    bombtibu.pos.reset();
                    bombtibu.start();
                    bombtibu.setOwner(actor, false, false, false);
                    bombtibu.setSpeed(vector3d);
                }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.weapons.BombTIBlue.class;
