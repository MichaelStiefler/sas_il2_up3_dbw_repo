...
public abstract class P2V extends Scheme2
{
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx"))
    {
      ...
      {
        if ((paramString.startsWith("xxspart")) && (World.Rnd().nextFloat() < 0.1F) && (chunkDamageVisible("Tail1") > 2) && (getEnergyPastArmor(19.9F / (float)Math.sqrt(Aircraft.v1.jdField_y_of_type_Double * Aircraft.v1.jdField_y_of_type_Double + Aircraft.v1.jdField_z_of_type_Double * Aircraft.v1.jdField_z_of_type_Double), paramShot) > 0.0F))
        {
      ...
      else if (paramString.startsWith("xxammo0"))
      {
  ...
  public void update(float paramFloat)
  {
    ...
    if (this.kangle1 > 1.0F)
      this.kangle1 = 1.0F;
    for (int j = 1; j < 14; j++) {
      hierMesh().chunkSetAngles("Waterr" + j + "_D0", 0.0F, -20.0F * this.kangle1, 0.0F);
    }
