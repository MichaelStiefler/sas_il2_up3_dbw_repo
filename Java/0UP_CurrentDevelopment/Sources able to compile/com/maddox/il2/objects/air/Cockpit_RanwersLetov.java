...
public class Cockpit_RanwersLetov extends CockpitPilot
{
    ...
    private class Variables
    {
        ...
        private Variables()
        {
            ...
            compassPoint[0] = new Vector3d(0.0D, java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), Cockpit_RanwersLetov.compassZ);
            compassPoint[1] = new Vector3d(-java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), 0.0D, Cockpit_RanwersLetov.compassZ);
            compassPoint[2] = new Vector3d(0.0D, -java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), Cockpit_RanwersLetov.compassZ);
            compassPoint[3] = new Vector3d(java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), 0.0D, Cockpit_RanwersLetov.compassZ);
            cP[0] = new Vector3d(0.0D, java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), Cockpit_RanwersLetov.compassZ);
            cP[1] = new Vector3d(-java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), 0.0D, Cockpit_RanwersLetov.compassZ);
            cP[2] = new Vector3d(0.0D, -java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), Cockpit_RanwersLetov.compassZ);
            cP[3] = new Vector3d(java.lang.Math.sqrt(1.0D - Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ), 0.0D, Cockpit_RanwersLetov.compassZ);
        }
    ...
    private void updateBullets()
    {
        ...
        if(abulletemitter != null && (gunROK || gunLOK))
        {
            ...
            {
                Aircraft.xyz[2] = hIncrement;
                Aircraft.xyz[0] = 0.0F;
                if(gunROK)
                    mesh.chunkSetLocate("RBullet0" + i1, Aircraft.xyz, Aircraft.ypr);
                if(gunLOK)
                    mesh.chunkSetLocate("LBullet0" + i1, Aircraft.xyz, Aircraft.ypr);
            }

            for(int j1 = 9; j1 >= 6; j1--)
            {
                Aircraft.xyz[0] = hIncrement;
                Aircraft.xyz[2] = 0.0F;
                if(gunROK)
                    mesh.chunkSetLocate("RBullet0" + j1, Aircraft.xyz, Aircraft.ypr);
                if(gunLOK)
                    mesh.chunkSetLocate("LBullet0" + j1, Aircraft.xyz, Aircraft.ypr);
            }
            ...
            if(turningCycle)
            {
                ...
                for(int l2 = 1; l2 <= 6; l2++)
                {
                    ...
                    {
                        int i3 = k1 - (l2 + (l2 - 1));
                        Aircraft.xyz[0] = ((float)i3 * -0.012F + hIncrement) - 0.006F;
                        Aircraft.xyz[2] = 0.01F + vIncrement;
                        if(gunROK)
                            mesh.chunkSetLocate("RBullet" + (byte0 + 1) + l2, Aircraft.xyz, Aircraft.ypr);
                        if(gunLOK)
                            mesh.chunkSetLocate("LBullet" + (byte0 + 1) + l2, Aircraft.xyz, Aircraft.ypr);
                    }
                    if(l2 == i2)
                    {
                        Aircraft.xyz[0] = -0.006F + hIncrement / 2.0F;
                        Aircraft.xyz[2] = 0.01F - hIncrement;
                        if(gunROK)
                            mesh.chunkSetLocate("RBullet" + (byte0 + 1) + i2, Aircraft.xyz, Aircraft.ypr);
                        if(gunLOK)
                            mesh.chunkSetLocate("LBullet" + (byte0 + 1) + i2, Aircraft.xyz, Aircraft.ypr);
                    }
                    if(k1 < 6 && l2 <= 6 && byte0 != 0)
                    {
                        Aircraft.xyz[0] = (float)(k1 + 1) * -0.012F + hIncrement;
                        Aircraft.xyz[2] = 0.0F + vIncrement;
                        if(gunROK)
                            mesh.chunkSetLocate("RBullet" + byte0 + l2, Aircraft.xyz, Aircraft.ypr);
                        if(gunLOK)
                            mesh.chunkSetLocate("LBullet" + byte0 + l2, Aircraft.xyz, Aircraft.ypr);
                    }
                }
            ...
            if(byte0 != 0)
            {
                for(int l1 = 6; l1 >= 1; l1--)
                    if(j + l1 >= 7 && !flag)
                    {
                        ...
                        if(j2 == 0)
                        {
                            Aircraft.xyz[0] = (float)(l1 + j2) * 0.012F;
                            Aircraft.xyz[2] = 0.0F;
                            if(gunROK)
                                mesh.chunkSetLocate("RBullet" + byte0 + l1, Aircraft.xyz, Aircraft.ypr);
                            if(gunLOK)
                                mesh.chunkSetLocate("LBullet" + byte0 + l1, Aircraft.xyz, Aircraft.ypr);
                        } else
                        {
                            Aircraft.xyz[0] = (float)(l1 + j2) * 0.012F + hIncrement;
                            Aircraft.xyz[2] = 0.0F + vIncrement;
                            if(gunROK)
                                mesh.chunkSetLocate("RBullet" + byte0 + l1, Aircraft.xyz, Aircraft.ypr);
                            if(gunLOK)
                    ...
                    {
                        Aircraft.xyz[0] = (float)j * -0.012F + hIncrement;
                        Aircraft.xyz[2] = 0.0F + vIncrement;
                        if(gunROK)
                            mesh.chunkSetLocate("RBullet" + byte0 + l1, Aircraft.xyz, Aircraft.ypr);
                        if(gunLOK)
                ...
                if(byte0 >= 6)
                {
                    Aircraft.xyz[0] = -0.072F + hIncrement;
                    Aircraft.xyz[2] = -0.010742F * (float)(byte0 - 2) + vIncrement;
                    if(gunROK)
                        mesh.chunkSetLocate("RBullet21", Aircraft.xyz, Aircraft.ypr);
                    if(gunLOK)
                        mesh.chunkSetLocate("LBullet21", Aircraft.xyz, Aircraft.ypr);
                }
            }
            previousCycle = j;
        }
