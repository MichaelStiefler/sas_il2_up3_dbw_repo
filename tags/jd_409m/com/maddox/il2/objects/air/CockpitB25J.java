...
public class CockpitB25J extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitB25J.this.setNew.throttle1 = (0.85F * CockpitB25J.this.setOld.throttle1 + CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitB25J.this.setNew.throttle2 = (0.85F * CockpitB25J.this.setOld.throttle2 + CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitB25J.this.setNew.prop1 = (0.85F * CockpitB25J.this.setOld.prop1 + CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitB25J.this.setNew.prop2 = (0.85F * CockpitB25J.this.setOld.prop2 + CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitB25J.this.setNew.altimeter = CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitB25J.this.waypointAzimuth();
        CockpitB25J.this.setNew.azimuth.setDeg(CockpitB25J.this.setOld.azimuth.getDeg(1.0F), CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitB25J.this.setNew.waypointAzimuth.setDeg(CockpitB25J.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitB25J.this.setNew.waypointDeviation.setDeg(CockpitB25J.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB25J.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitB25J.this.setNew.vspeed = ((199.0F * CockpitB25J.this.setOld.vspeed + CockpitB25J.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
