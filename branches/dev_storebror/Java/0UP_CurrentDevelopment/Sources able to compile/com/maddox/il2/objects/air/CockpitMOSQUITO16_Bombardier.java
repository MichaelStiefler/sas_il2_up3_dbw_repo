...
public class CockpitMOSQUITO16_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((MOSQUITO16)aircraft()).fSightCurForwardAngle;
                float f1 = -((MOSQUITO16)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((MOSQUITO16)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((MOSQUITO16)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
        mesh.chunkSetAngles("zMark2", f1 * 3.675F, 0.0F, 0.0F);
        resetYPRmodifier();
        Cockpit.xyz[0] = cvt(fm.Or.getKren() * java.lang.Math.abs(fm.Or.getKren()), -1225F, 1225F, -0.23F, 0.23F);
        Cockpit.xyz[1] = cvt((fm.Or.getTangage() - 1.0F) * java.lang.Math.abs(fm.Or.getTangage() - 1.0F), -1225F, 1225F, 0.23F, -0.23F);
