...
// Source File Name:   RE_2000xyz.java
...
public abstract class RE_2000xyz extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeStormovik
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.11F, 0.67F, 0.0F, -85F), 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 0.09F, 0.0F, -80F), 0.0F);
        hiermesh.chunkSetAngles("GearC5_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 0.09F, 0.0F, 80F), 0.0F);
    }

    protected void moveGear(float f)
    {
        com.maddox.il2.objects.air.RE_2000xyz.moveGear(hierMesh(), f);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        java.lang.System.out.println("HitBone called! " + s1);
        java.lang.System.out.println("IN: " + shot.power);
        if(s1.startsWith("xx"))
        {
        ...
        if(s1.startsWith("xwing"))
        {
            if(s1.startsWith("xwinglin") && chunkDamageVisible("WingLIn") < 3)
            {
                ...
                {
                    int l = 0;
                    if(getEnergyPastArmor(0.12F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.2F)
                    {
        ...
        java.lang.System.out.println("OUT: " + shot.power);
    }
