...
public class CockpitHurricaneMkI extends CockpitPilot
{
  ...
  {
    super("3DO/Cockpit/HurricaneMkI/HURRICANE1.him", "bf109");
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitHurricaneMkI.this.bNeedSetUp)
      {
        CockpitHurricaneMkI.this.reflectPlaneMats();
        CockpitHurricaneMkI.access$002(CockpitHurricaneMkI.this, false);
      }
      if (CockpitHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitHurricaneMkI.access$102(CockpitHurricaneMkI.this, CockpitHurricaneMkI.this.setOld);
        CockpitHurricaneMkI.access$202(CockpitHurricaneMkI.this, CockpitHurricaneMkI.this.setNew);
        CockpitHurricaneMkI.access$302(CockpitHurricaneMkI.this, CockpitHurricaneMkI.this.setTmp);
        CockpitHurricaneMkI.this.setNew.throttle = ((10.0F * CockpitHurricaneMkI.this.setOld.throttle + CockpitHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitHurricaneMkI.this.setNew.altimeter = CockpitHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
          CockpitHurricaneMkI.this.setNew.azimuth = ((35.0F * CockpitHurricaneMkI.this.setOld.azimuth + -CockpitHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        if ((CockpitHurricaneMkI.this.setOld.azimuth > 270.0F) && (CockpitHurricaneMkI.this.setNew.azimuth < 90.0F))
          CockpitHurricaneMkI.this.setOld.azimuth -= 360.0F;
        if ((CockpitHurricaneMkI.this.setOld.azimuth < 90.0F) && (CockpitHurricaneMkI.this.setNew.azimuth > 270.0F))
          CockpitHurricaneMkI.this.setOld.azimuth += 360.0F;
        CockpitHurricaneMkI.this.setNew.waypointAzimuth = ((10.0F * CockpitHurricaneMkI.this.setOld.waypointAzimuth + (CockpitHurricaneMkI.this.waypointAzimuth() - CockpitHurricaneMkI.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitHurricaneMkI.this.setNew.vspeed = ((199.0F * CockpitHurricaneMkI.this.setOld.vspeed + CockpitHurricaneMkI.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitHurricaneMkI this$0;
    ...
    Variables(CockpitHurricaneMkI.1 arg2)
    {
      this();
    }
  }
