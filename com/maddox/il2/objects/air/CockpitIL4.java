...
public class CockpitIL4 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitIL4 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitIL4.this.fm != null) {
        CockpitIL4.access$102(CockpitIL4.this, CockpitIL4.this.setOld);
        CockpitIL4.access$202(CockpitIL4.this, CockpitIL4.this.setNew);
        CockpitIL4.access$302(CockpitIL4.this, CockpitIL4.this.setTmp);
        if (CockpitIL4.this.fm.CT.Weapons[3] != null) {
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 0)
            CockpitIL4.this.bBombs[1] = (!CockpitIL4.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 1)
            CockpitIL4.this.bBombs[0] = (!CockpitIL4.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 2)
            CockpitIL4.this.bBombs[3] = (!CockpitIL4.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 3)
            CockpitIL4.this.bBombs[2] = (!CockpitIL4.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 4)
            CockpitIL4.this.bBombs[5] = (!CockpitIL4.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 5)
            CockpitIL4.this.bBombs[4] = (!CockpitIL4.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 6) {
            CockpitIL4.this.bBombs[5] = ((CockpitIL4.this.bBombs[5] != 0) || (!CockpitIL4.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 7) {
            CockpitIL4.this.bBombs[4] = ((CockpitIL4.this.bBombs[4] != 0) || (!CockpitIL4.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 8)
            CockpitIL4.this.bBombs[7] = (!CockpitIL4.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitIL4.this.fm.CT.Weapons[3].length > 9)
            CockpitIL4.this.bBombs[6] = (!CockpitIL4.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        ...
        CockpitIL4.this.setNew.vspeed = ((100.0F * CockpitIL4.this.setOld.vspeed + CockpitIL4.this.fm.getVertSpeed()) / 101.0F);

        float f = CockpitIL4.this.waypointAzimuth();
        CockpitIL4.this.setNew.waypointAzimuth.setDeg(CockpitIL4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitIL4.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitIL4.this.setNew.waypointDirection.setDeg(CockpitIL4.this.setOld.waypointDirection.getDeg(1.0F), f);
