...
public class CockpitDo217_K1 extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			setNew.throttlel = (10F * setOld.throttlel + fm.EI.engines[0]
					.getControlThrottle()) / 11F;
			setNew.throttler = (10F * setOld.throttler + fm.EI.engines[1]
					.getControlThrottle()) / 11F;
			...
			setNew.propL = 0.85F * setOld.propL
					+ fm.EI.engines[0].getControlProp() * 0.15F;
			setNew.propR = 0.85F * setOld.propR
			...
			if (useRealisticNavigationInstruments()) {
				...
				setNew.radioCompassAzimuth.setDeg(
						setOld.radioCompassAzimuth.getDeg(0.02F),
						radioCompassAzimuthInvertMinus()
								- setOld.azimuth.getDeg(1.0F) - 90F);
			} else {
				setNew.waypointAzimuth.setDeg(
						setOld.waypointAzimuth.getDeg(0.1F), f1
	...
	public void reflectWorldToInstruments(float f) {
		...
		mesh.chunkSetAngles("ZColumn", 0.0F, -7F
		...
		mesh.chunkSetAngles("z_HeightKm", 0.0F,
				cvt(f1, 0.0F, 10000F, 0.0F, 257F), 0.0F);
		mesh.chunkSetAngles("z_Height", 0.0F,
				cvt(f1, 0.0F, 20000F, 0.0F, 7200F), 0.0F);
		mesh.chunkSetAngles("Z_Alt1", 0.0F, cvt(f1, 0.0F, 6000F, 0.0F, 360F),
				0.0F);
		mesh.chunkSetAngles("Z_Alt1Set", 0.0F,
				(((Do217) aircraft()).fSightCurAltitude * 360F) / 6000F, 0.0F);
		Pn.set(fm.Loc);
		Pn.z = (double) f1 - Engine.cur.land.HQ(Pn.x, Pn.y);
		mesh.chunkSetAngles("z_AFN101", 0.0F,
				cvt((float) Pn.z, 0.0F, 750F, 0.0F, 223F), 0.0F);
		mesh.chunkSetAngles(
				"z_Speed",
				0.0F,
				floatindex(
						cvt(Pitot.Indicator((float) fm.Loc.z, fm.getSpeedKMH()),
								50F, 800F, 0.0F, 15F), speedometerScale), 0.0F);
		mesh.chunkSetAngles(
				"z_VelX",
				0.0F,
				floatindex(cvt(fm.getSpeedKMH(), 50F, 800F, 0.0F, 15F),
						speedometerScale), 0.0F);
		float f2 = fm.EI.engines[0].getRPM();
		float f3 = fm.EI.engines[1].getRPM();
		mesh.chunkSetAngles("z_RPM1", 0.0F, cvt(f2, 600F, 3600F, -172F, 151F),
				0.0F);
		mesh.chunkSetAngles("z_RPM2", 0.0F, cvt(f3, 600F, 3600F, -172F, 151F),
				0.0F);
		mesh.chunkSetAngles(
				"z_ATA1",
				0.0F,
				pictManf1 = 0.9F
						* pictManf1
						+ 0.1F
						* cvt(fm.EI.engines[0].getManifoldPressure(), 0.6F,
								1.8F, -162.5F, 162.5F), 0.0F);
		mesh.chunkSetAngles(
				"z_ATA2",
				0.0F,
				pictManf2 = 0.9F
						* pictManf2
						+ 0.1F
						* cvt(fm.EI.engines[1].getManifoldPressure(), 0.6F,
								1.8F, -162.5F, 162.5F), 0.0F);
		mesh.chunkSetAngles("Z_Hours", 0.0F,
				cvt(World.getTimeofDay(), 0.0F, 24F, 0.0F, 720F), 0.0F);
		mesh.chunkSetAngles("Z_Minutes", 0.0F,
				cvt(World.getTimeofDay() % 1.0F, 0.0F, 1.0F, 0.0F, 360F), 0.0F);
		mesh.chunkSetAngles("z_ThrottleL", 0.0F,
				-25F * interp(setNew.throttlel, setOld.throttlel, f), 0.0F);
		mesh.chunkSetAngles("z_ThrottleR", 0.0F,
				-25F * interp(setNew.throttler, setOld.throttler, f), 0.0F);
		float f4 = setNew.vspeed * 9F;
		mesh.chunkSetAngles("Z_Variometer", 0.0F, f4, 0.0F);
		w.set(fm.getW());
		fm.Or.transform(w);
		mesh.chunkSetAngles("Z_Stick", 0.0F,
		...
		mesh.chunkSetAngles(
				"z_ElevTrim",
				0.0F,
				-cvt(interp(setNew.elevTrim, setOld.elevTrim, f), -0.5F, 0.5F,
						-750F, 750F), 0.0F);
		mesh.chunkSetAngles(
				"z_RudderTrim",
				0.0F,
		...
		mesh.chunkSetAngles("z_FuelCons1", 0.0F,
				cvt(f7, 0.0F, 600F, 0.0F, 360F), 0.0F);
		mesh.chunkSetAngles("z_FuelCons2", 0.0F,
				cvt(f8, 0.0F, 600F, 0.0F, 360F), 0.0F);
		float f9 = fm.M.fuel / 0.72F;
		mesh.chunkSetAngles("z_Fuel3", 0.0F, cvt(f9, 0.0F, 1100F, 0.0F, 69F),
				0.0F);
		mesh.chunkSetAngles("z_Fuel1", 0.0F, cvt(f9, 1100F, 2670F, 0.0F, 84F),
				0.0F);
		mesh.chunkSetAngles("z_Fuel2", 0.0F, cvt(f9, 1100F, 2670F, 0.0F, 84F),
				0.0F);
		mesh.chunkSetAngles(
				"z_OilPres1",
				0.0F,
		...
		mesh.chunkSetAngles(
				...
				cvt(interp(setNew.elevTrim, setOld.elevTrim, f), -0.5F, 0.5F,
						40F, -40F), 0.0F);
		mesh.chunkSetAngles("PropPitchLeverL", 0.0F,
				-70F * (1.0F - interp(setNew.propL, setOld.propL, f)), 0.0F);
		mesh.chunkSetAngles("PropPitchLeverR", 0.0F,
				-70F * (1.0F - interp(setNew.propR, setOld.propR, f)), 0.0F);
		...
		mesh.chunkVisible("LK_Start", fm.CT.getFlap() > 0.1F
				&& fm.CT.getFlap() < 0.5F);
		...
		if (useRealisticNavigationInstruments()) {
			...
			mesh.chunkSetAngles("Z_Compass4",
					-setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
			mesh.chunkSetAngles("Z_Compass5",
					setNew.radioCompassAzimuth.getDeg(f * 0.02F) + 90F, 0.0F,
					0.0F);
			mesh.chunkSetAngles("Z_Compass7", setNew.azimuth.getDeg(f), 0.0F,
					0.0F);
			mesh.chunkSetAngles("Z_Compass8",
					setNew.waypointAzimuth.getDeg(f * 0.1F) + 90F, 0.0F, 0.0F);
			mesh.chunkSetAngles("zNavP", -(setNew.waypointAzimuth
					.getDeg(f * 0.1F) - setNew.azimuth.getDeg(f)), 0.0F, 0.0F);
			float f10 = setNew.beaconDirection;
			float f11 = setNew.beaconRange;
			mesh.chunkSetAngles("z_AFN2a", 0.0F,
					cvt(f10, -40F, 40F, -32F, 32F), 0.0F);
			mesh.chunkSetAngles("z_AFN2b", 0.0F, 0.0F,
					cvt(f11, 0.0F, 1.0F, -20F, 15F));
			mesh.chunkVisible("AFN1_RED", isOnBlindLandingMarker());
		} else {
			mesh.chunkSetAngles("Z_Compass1", -setNew.azimuth.getDeg(f) - 90F,
					0.0F, 0.0F);
			mesh.chunkSetAngles("Z_Compass2",
					setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
			mesh.chunkSetAngles("Z_Compass3",
					setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
			mesh.chunkSetAngles("Z_Compass4", -setNew.azimuth.getDeg(f), 0.0F,
					0.0F);
	...
	private static final float speedometerScale[] = { 0.0F, 17F, 41F, 66F, 93F,
			119F, 139F, 164F, 188F, 214F, 239F, 266F, 292F, 317F, 341F, 372F };
