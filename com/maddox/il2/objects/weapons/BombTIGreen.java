...
public class BombTIGreen extends Bomb
{
  private long t1;
  private int charge;
    ...
    if (this.charge < 1.01D) {
      ...
      if (Actor.isValid(localActor)) {
        ...
        for (int i = 0; i < 60; i++) {
          ...
          BombTiGr localBombTiGr = new BombTiGr();
          localBombTiGr.pos.setUpdateEnable(true);
          localBombTiGr.pos.setAbs(localPoint3d, localOrient);
          localBombTiGr.pos.reset();
          localBombTiGr.start();
          localBombTiGr.setOwner(localActor, false, false, false);
          localBombTiGr.setSpeed(localVector3d1);
        }
  ...
  static
  {
    Class localClass = BombTIGreen.class;
