// Source File Name: CockpitTBM3_BGunner.java
...
public class CockpitTBM3_BGunner extends CockpitGunner {
	...
	static {
		Property.set(CockpitTBM3_BGunner.class, "aiTuretNum", 1);
		Property.set(CockpitTBM3_BGunner.class, "weaponControlNum", 11);
		Property.set(CockpitTBM3_BGunner.class, "astatePilotIndx", 1);
	}

	public CockpitTBM3_BGunner() {
		super("3DO/Cockpit/He-111H-2-BGun/BGunnerTBM3.him", "he111_gunner");
		this.hook1 = null;
		this.iCocking = 0;
		this.iOldVisDrums = 2;
		this.iNewVisDrums = 2;
