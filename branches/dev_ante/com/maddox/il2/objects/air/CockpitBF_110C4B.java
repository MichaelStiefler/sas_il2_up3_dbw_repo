...
public class CockpitBF_110C4B extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (((BF_110C4B)CockpitBF_110C4B.this.aircraft() != null) || 
        (BF_110C4B.bChangedPit))
      {
        CockpitBF_110C4B.this.reflectPlaneToModel();
        if ((BF_110C4B)CockpitBF_110C4B.this.aircraft() == null);
        BF_110C4B.bChangedPit = false;
      }
      CockpitBF_110C4B.access$002(CockpitBF_110C4B.this, CockpitBF_110C4B.this.setOld);
      CockpitBF_110C4B.access$102(CockpitBF_110C4B.this, CockpitBF_110C4B.this.setNew);
      CockpitBF_110C4B.access$202(CockpitBF_110C4B.this, CockpitBF_110C4B.this.setTmp);
      CockpitBF_110C4B.this.setNew.altimeter = CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_110C4B.this.cockpitDimControl)
      {
        if (CockpitBF_110C4B.this.setNew.dimPosition > 0.0F)
          CockpitBF_110C4B.this.setNew.dimPosition -= 0.05F;
      }
      else if (CockpitBF_110C4B.this.setNew.dimPosition < 1.0F)
        CockpitBF_110C4B.this.setNew.dimPosition += 0.05F;
      CockpitBF_110C4B.this.setNew.throttle1 = (0.91F * CockpitBF_110C4B.this.setOld.throttle1 + 0.09F * CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitBF_110C4B.this.setNew.throttle2 = (0.91F * CockpitBF_110C4B.this.setOld.throttle2 + 0.09F * CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitBF_110C4B.this.setNew.mix1 = (0.88F * CockpitBF_110C4B.this.setOld.mix1 + 0.12F * CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitBF_110C4B.this.setNew.mix2 = (0.88F * CockpitBF_110C4B.this.setOld.mix2 + 0.12F * CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitBF_110C4B.this.setNew.azimuth = CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_110C4B.this.setOld.azimuth > 270.0F) && (CockpitBF_110C4B.this.setNew.azimuth < 90.0F))
        CockpitBF_110C4B.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_110C4B.this.setOld.azimuth < 90.0F) && (CockpitBF_110C4B.this.setNew.azimuth > 270.0F))
        CockpitBF_110C4B.this.setOld.azimuth += 360.0F;
      CockpitBF_110C4B.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_110C4B.this.setOld.waypointAzimuth + (CockpitBF_110C4B.this.waypointAzimuth() - CockpitBF_110C4B.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitBF_110C4B.Variables localVariables = CockpitBF_110C4B.this.setNew;
      float f1 = 0.9F * CockpitBF_110C4B.this.setOld.radioalt;
      float f2 = 0.1F;
      float f3 = CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      World.cur();
      World.land();
      localVariables.radioalt = (f1 + f2 * (f3 - Landscape.HQ_Air((float)CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.x, (float)CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y)));
      CockpitBF_110C4B.this.setNew.vspeed = ((199.0F * CockpitBF_110C4B.this.setOld.vspeed + CockpitBF_110C4B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      return true;
    }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float radioalt;
    private final CockpitBF_110C4B this$0;
    ...
    Variables(CockpitBF_110C4B.1 arg2)
    {
      this();
    }
  }
