...
public class CockpitKI_43_II extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_RPM1", 0.0F, cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3200.0F, 0.0F, 360.0F), 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_Gunpres1", 0.0F, 148.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitKI_43_II.this.fm != null) {
        ...
        if ((CockpitKI_43_II.this.fm.AS.astateCockpitState & 0x2) != 0) {
