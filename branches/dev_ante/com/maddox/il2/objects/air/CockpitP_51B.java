...
public class CockpitP_51B extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearGreen1", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() > 0.95F) && (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.lgear));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearGreen2", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() > 0.95F) && (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.rgear));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearGreen3", this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() > 0.95F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearRed1", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.05F) || (!this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.lgear));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearRed2", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.05F) || (!this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.rgear));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_GearRed3", (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.05F) || (!this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.lgear) || (!this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Gears_of_type_ComMaddoxIl2FmGear.rgear));
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_Oxywarning1", false);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitP_51B.access$102(CockpitP_51B.this, CockpitP_51B.this.setOld); CockpitP_51B.access$202(CockpitP_51B.this, CockpitP_51B.this.setNew); CockpitP_51B.access$302(CockpitP_51B.this, CockpitP_51B.this.setTmp);

        CockpitP_51B.this.setNew.throttle = (0.85F * CockpitP_51B.this.setOld.throttle + CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitP_51B.this.setNew.prop = (0.85F * CockpitP_51B.this.setOld.prop + CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitP_51B.this.setNew.stage = (0.85F * CockpitP_51B.this.setOld.stage + CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor() * 0.15F);
        CockpitP_51B.this.setNew.mix = (0.85F * CockpitP_51B.this.setOld.mix + CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix() * 0.15F);
        CockpitP_51B.this.setNew.altimeter = CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitP_51B.this.setNew.azimuth = ((35.0F * CockpitP_51B.this.setOld.azimuth + -CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw()) / 36.0F);
        if ((CockpitP_51B.this.setOld.azimuth > 270.0F) && (CockpitP_51B.this.setNew.azimuth < 90.0F)) CockpitP_51B.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_51B.this.setOld.azimuth < 90.0F) && (CockpitP_51B.this.setNew.azimuth > 270.0F)) CockpitP_51B.this.setOld.azimuth += 360.0F;
        CockpitP_51B.this.setNew.waypointAzimuth = ((10.0F * CockpitP_51B.this.setOld.waypointAzimuth + CockpitP_51B.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitP_51B.this.setNew.vspeed = ((199.0F * CockpitP_51B.this.setOld.vspeed + CockpitP_51B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    private final CockpitP_51B this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitP_51B.1 arg2) { this();
    }
  }
}