...
public class CockpitME_323 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitME_323 this$0;
    ...
    Variables(CockpitME_323.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitME_323.this.fm != null) {
        CockpitME_323.access$102(CockpitME_323.this, CockpitME_323.this.setOld);
        CockpitME_323.access$202(CockpitME_323.this, CockpitME_323.this.setNew);
        CockpitME_323.access$302(CockpitME_323.this, CockpitME_323.this.setTmp);
        ...
        CockpitME_323.this.setNew.waypointDeviation.setDeg(CockpitME_323.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitME_323.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitME_323.this.setNew.vspeed = ((199.0F * CockpitME_323.this.setOld.vspeed + CockpitME_323.this.fm.getVertSpeed()) / 200.0F);
      }
