...
public class CockpitIL4_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((IL_4_IL4)aircraft()).fSightCurForwardAngle;
                float f1 = -((IL_4_IL4)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((IL_4_IL4)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((IL_4_IL4)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
