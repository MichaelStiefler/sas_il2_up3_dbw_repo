...
;
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        i = 0;
_L6:
        if(i >= tmpBonesHit) goto _L2; else goto _L1
_L1:
        hierMesh();
        ...
        this;
        33.333F;
        if(i != tmpBonesHit - 1) goto _L4; else goto _L3
_L3:
        0.02F;
          goto _L5
_L4:
...
label0:
    ...
    private void checkLoadingCountry()
    {
        ...
        if(com.maddox.rts.Property.value(class1, "PaintScheme_" + loadingCountry) != null && com.maddox.rts.Property.stringValue(class1, "meshName_" + loadingCountry, null) != null)
...
label0:
            for(int k = 0; k < 4; k++)
            {
                ...
                if(!mat.isValidLayer(k))
                    continue;
                mat.setLayer(k);
                java.lang.String s5 = mat.get('\0');
                int l = 0;
                do
                {
                    if(l >= 3)
                        continue label0;
                    if(s5.regionMatches(true, s5.length() - 10, _curSkin[l], 0, 10))
                    {
                        ai[k] = l;
                        flag = true;
                        continue label0;
            ...
            if(!flag)
                continue;
            java.lang.String s4 = s1 + "/" + _skinMat[i] + ".mat";
            com.maddox.il2.engine.Mat mat1;
            if(com.maddox.il2.engine.FObj.Exist(s4))
            {
                mat1 = (com.maddox.il2.engine.Mat)com.maddox.il2.engine.FObj.Get(s4);
            } else
            {
    ...
    {
        int i;
        for(i = s.length() - 1; i >= 0 && java.lang.Character.isDigit(s.charAt(i)); i--);
        i++;
    ...
    {
        return (int[])(int[])com.maddox.rts.Property.value(class1, "weaponTriggers", null);
    }
    ...
    {
        return (java.lang.String[])(java.lang.String[])com.maddox.rts.Property.value(class1, "weaponHooks", null);
    }
    ...
    {
        com.maddox.util.HashMapInt hashmapint = com.maddox.il2.objects.air.Aircraft.weaponsMapProperty(class1);
        return (com.maddox.il2.objects.air._WeaponSlot[])(com.maddox.il2.objects.air._WeaponSlot[])hashmapint.get(com.maddox.rts.Finger.Int(s));
    }
    ...
    public static boolean isWeaponDateOk(java.lang.Class class1, java.lang.String s)
    {
        ...
        com.maddox.il2.objects.air._WeaponSlot a_lweaponslot[] = (com.maddox.il2.objects.air._WeaponSlot[])(com.maddox.il2.objects.air._WeaponSlot[])hashmapint.get(i);
            ...
            if(aircraft.mesh().hookFind(as[j]) != -1)
            {
                ...
                case 2: // '\002'
                    if(bulletemitter instanceof com.maddox.il2.objects.weapons.RocketGun)
                    {
                        ...
                        ((com.maddox.il2.objects.weapons.RocketGun)bulletemitter).setSpreadRnd(aircraft.armingRnd.nextInt());
                    }
                    break;
...
label0:
    ...
    {
        if(FM.brakeShoeLastCarrier != null && (FM.brakeShoeLastCarrier instanceof com.maddox.il2.objects.ships.BigshipGeneric))
        {
            com.maddox.rts.Property property = com.maddox.rts.Property.get(FM.brakeShoeLastCarrier.getClass(), "speed");
            if(property == null)
            {
                return false;
            } else
            {
                double d = (double)FM.getSpeed() - property.doubleValue();
                return java.lang.Math.abs(d) > 1.0D;
            }
        } else
        {
            return false;
        ...
        if(!wfrGr21dropped)
        {
            ...
            if(wfrGr21dropped)
            {
                for(int j = 0; j < FM.CT.Weapons.length; j++)
                {
                    ...
                    for(int k = 0; k < abulletemitter.length; k++)
                    {
                        java.lang.Object obj = abulletemitter[k];
                        if(obj instanceof com.maddox.il2.objects.weapons.RocketGunWfrGr21)
                        {
                            com.maddox.il2.objects.weapons.RocketGunWfrGr21 rocketgunwfrgr21 = (com.maddox.il2.objects.weapons.RocketGunWfrGr21)obj;
                            FM.CT.Weapons[j][k] = com.maddox.il2.objects.weapons.GunEmpty.get();
                            rocketgunwfrgr21.setHookToRel(true);
                            rocketgunwfrgr21.shots(0);
                            rocketgunwfrgr21.hide(true);
                            obj = com.maddox.il2.objects.weapons.GunEmpty.get();
                            rocketgunwfrgr21.doDestroy();
                        }
                        if((obj instanceof com.maddox.il2.objects.weapons.PylonRO_WfrGr21) || (obj instanceof com.maddox.il2.objects.weapons.PylonRO_WfrGr21Dual))
                        {
                            FM.CT.Weapons[j][k] = com.maddox.il2.objects.weapons.GunEmpty.get();
    ...
    static 
    {
        planesWithZBReceiver = (new java.lang.Class[] {
            ...
            com.maddox.il2.objects.air.P_51.class, com.maddox.il2.objects.air.P_47.class, com.maddox.il2.objects.air.P_40.class, com.maddox.il2.objects.air.P_38.class, com.maddox.il2.objects.air.P_36.class, com.maddox.il2.objects.air.A_20.class, com.maddox.il2.objects.air.C_47.class
        });
    }
}
