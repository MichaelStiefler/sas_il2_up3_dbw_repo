...
public class Centauro extends Centauroxyz
  implements TypeFighter, TypeBNZFighter
{
  ...
  static
  {
    ...
    Property.set(class1, "FlightModel", "FlightModels/centauro.fmd");
  ...
  public void onAircraftLoaded()
  {
    ...
    this.FM.EI.engines[0].setPropReductorValue(World.Rnd().nextFloat(0.7824F, 0.7903F));
