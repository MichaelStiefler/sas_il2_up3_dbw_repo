  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  public void moveCockpitDoor(float paramFloat)
  {
    ...
    hierMesh().chunkSetAngles("blister4_D0", 0.0F, -paramFloat * 177.7F, 0.0F);
    hierMesh().chunkSetAngles("blister3_D0", 0.0F, -paramFloat * 15.6F, 0.0F);

    if ((this.FM.getSpeedKMH() > 314.0F) && (paramFloat < 0.6F) && (!this.blisterRemoved))
    {
      doRemoveBlisters();
    }
  ...
  private final void doRemoveBlisters()
  {
    ...
    if (hierMesh().chunkFindCheck("blister4_D0") != -1)
    {
      ...
      localWreckage = new Wreckage(this, hierMesh().chunkFind("blister4_D0"));
  ...
  public void moveWheelSink()
  {
    ...
    Aircraft.ypr[2] = 0.0F;
    Aircraft.xyz[2] = 0.0F;
    float f = Aircraft.cvt(this.FM.getSpeed(), 0.0F, 25.0F, 0.0F, 1.0F);
    ...
    if (paramString.startsWith("xx"))
    {
      ...
      else
      {
        ...
        if (paramString.startsWith("xxeng"))
        {
          ...
          {
            if ((getEnergyPastArmor(0.449999988079071D / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-005D), paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.05F))
            {
        ...
        if (paramString.startsWith("xxoil"))
        {
          ...
          this.FM.AS.setCockpitState(paramShot.initiator, this.FM.AS.astateCockpitState | 0x80);
        }
        ...
        else if (paramString.startsWith("xxeqpt"))
        {
