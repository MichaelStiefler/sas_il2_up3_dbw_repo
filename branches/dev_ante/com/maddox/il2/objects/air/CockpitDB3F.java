...
public class CockpitDB3F extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitDB3F this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitDB3F.this.fm != null) {
        CockpitDB3F.access$102(CockpitDB3F.this, CockpitDB3F.this.setOld);
        CockpitDB3F.access$202(CockpitDB3F.this, CockpitDB3F.this.setNew);
        CockpitDB3F.access$302(CockpitDB3F.this, CockpitDB3F.this.setTmp);
        if (CockpitDB3F.this.fm.CT.Weapons[3] != null) {
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 0)
            CockpitDB3F.this.bBombs[1] = (!CockpitDB3F.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 1)
            CockpitDB3F.this.bBombs[0] = (!CockpitDB3F.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 2)
            CockpitDB3F.this.bBombs[3] = (!CockpitDB3F.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 3)
            CockpitDB3F.this.bBombs[2] = (!CockpitDB3F.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 4)
            CockpitDB3F.this.bBombs[5] = (!CockpitDB3F.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 5)
            CockpitDB3F.this.bBombs[4] = (!CockpitDB3F.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 6) {
            CockpitDB3F.this.bBombs[5] = ((CockpitDB3F.this.bBombs[5] != 0) || (!CockpitDB3F.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 7) {
            CockpitDB3F.this.bBombs[4] = ((CockpitDB3F.this.bBombs[4] != 0) || (!CockpitDB3F.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 8)
            CockpitDB3F.this.bBombs[7] = (!CockpitDB3F.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitDB3F.this.fm.CT.Weapons[3].length > 9)
            CockpitDB3F.this.bBombs[6] = (!CockpitDB3F.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        ...
        CockpitDB3F.this.setNew.vspeed = ((100.0F * CockpitDB3F.this.setOld.vspeed + CockpitDB3F.this.fm.getVertSpeed()) / 101.0F);

        float f = CockpitDB3F.this.waypointAzimuth();
        CockpitDB3F.this.setNew.waypointAzimuth.setDeg(CockpitDB3F.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitDB3F.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitDB3F.this.setNew.waypointDirection.setDeg(CockpitDB3F.this.setOld.waypointDirection.getDeg(1.0F), f);
