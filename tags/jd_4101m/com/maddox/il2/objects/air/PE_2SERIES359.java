  ...
  implements TypeBomber, TypeDiveBomber, TypeTransport
{
  ...
  static
  {
    Class localClass = PE_2SERIES359.class;
    new NetAircraft.SPAWN(localClass);

    Property.set(localClass, "iconFar_shortClassName", "Pe-2");
    Property.set(localClass, "meshName", "3DO/Plane/Pe-2series359/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeBMPar04());

    Property.set(localClass, "yearService", 1944.0F);
    Property.set(localClass, "yearExpired", 1948.5F);

    Property.set(localClass, "FlightModel", "FlightModels/Pe-2series359.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitPE2_359.class, CockpitPE2_Bombardier.class, CockpitPE2_359_TGunner.class });
