  ...
  implements TypeBomber, TypeDiveBomber, TypeTransport
{
  ...
  public void update(float paramFloat)
  {
    if (Time.current() > this.tme) {
      ...
      if (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[1].target == null) setRadist(0); else
        setRadist(1);
    }
  ...
  static
  {
    ...
    Aircraft.weaponTriggersRegister(localClass, new int[] { 0, 0, 10, 11, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
    Aircraft.weaponHooksRegister(localClass, new String[] { "_CANNON01", "_CANNON02", "_MGUN01", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06" });

    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", null, null, null, null, null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "6fab50", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", null, null, null, null, "BombGunFAB50", "BombGunFAB50", "BombGunFAB50", "BombGunFAB50", "BombGunFAB50", "BombGunFAB50" });

    Aircraft.weaponsRegister(localClass, "6fab100", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", null, null, null, null, "BombGunFAB100", "BombGunFAB100", "BombGunFAB100", "BombGunFAB100", "BombGunFAB100", "BombGunFAB100" });

    Aircraft.weaponsRegister(localClass, "2fab250", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", null, null, "BombGunFAB250", "BombGunFAB250", null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "2fab2502fab100", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", null, null, "BombGunFAB250", "BombGunFAB250", null, null, null, null, "BombGunFAB100", "BombGunFAB100" });

    Aircraft.weaponsRegister(localClass, "4fab250", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", "BombGunFAB250", "BombGunFAB250", "BombGunFAB250", "BombGunFAB250", null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "2fab500", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", "BombGunFAB500", "BombGunFAB500", null, null, null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "2fab5002fab250", new String[] { "MGunShKASki 500", "MGunShKASki 500", "MGunShKASt 750", "MGunShKASt 750", "BombGunFAB500", "BombGunFAB500", "BombGunFAB250", "BombGunFAB250", null, null, null, null, null, null });
