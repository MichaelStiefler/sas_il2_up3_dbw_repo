...
// Source File Name:   CorkscrewGeneric.java
...
public abstract class CorkscrewGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.CorkscrewGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.CorkscrewGeneric.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.CorkscrewGeneric corkscrewgeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.CorkscrewGeneric.constr_arg2 = actorspawnarg;
                corkscrewgeneric = (com.maddox.il2.objects.vehicles.stationary.CorkscrewGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.CorkscrewGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create CorkscrewGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (corkscrewgeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.CorkscrewGeneric.mesh_name);
            cls = class1;
    ...
    private CorkscrewGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if((actor instanceof com.maddox.il2.objects.air.TypeBomber) && actor.getArmy() == myArmy && actor.getSpeed(vector3d) > 20D)
            {
                ...
                if(i < 0)
                    i = 360 + i;
                boolean flag1 = false;
                com.maddox.il2.objects.air.Aircraft aircraft = com.maddox.il2.ai.War.GetNearestEnemyAircraft(actor, 500F, 9);
                if((aircraft instanceof com.maddox.il2.objects.air.TypeFighter) && ((com.maddox.il2.engine.Actor) (aircraft)).getSpeed(vector3d) > 20D)
                {
                    ...
                    if((double)i1 <= 500D && java.lang.Math.sqrt(d6 * d6) <= 500D && flag2 && !flag && l <= 10)
                        ((com.maddox.il2.ai.air.Pilot)((com.maddox.il2.objects.air.Aircraft)actor).FM).set_maneuver(54);
                    if((double)i1 <= 500D && java.lang.Math.sqrt(d6 * d6) <= 500D && flag2 && flag && l <= 10)
                        com.maddox.il2.game.HUD.logCenter("                                          Corkscrew " + s + ", now!");
                }
            }
        }
