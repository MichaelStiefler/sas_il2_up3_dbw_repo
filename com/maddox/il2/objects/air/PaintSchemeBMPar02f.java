...
public class PaintSchemeBMPar02f extends com.maddox.il2.objects.air.PaintScheme
{
        ...
        } else
        {
            ...
            if(regiment.country() == com.maddox.il2.objects.air.PaintScheme.countryBritain)
            {
                if("ra".equals(regiment.branch()) || "rz".equals(regiment.branch()) || "rn".equals(regiment.branch()))
                {
                    ...
                    if(regiment.aid()[0] != '_')
                    {
                        changeMat(hiermesh, "Overlay2", "psBM02BRINAVYLNUM" + regiment.id() + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + regiment.aid()[0] + "f.tga", "British/" + (char)((65 + k) - 1) + ".tga", 0.11F, 0.11F, 0.11F, 0.11F, 0.11F, 0.11F);
                        changeMat(hiermesh, "Overlay3", "psBM02BRINAVYRNUM" + regiment.id() + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + regiment.aid()[0] + "f.tga", "British/" + (char)((65 + k) - 1) + ".tga", 0.11F, 0.11F, 0.11F, 0.11F, 0.11F, 0.11F);
                    } else
                    {
                        changeMat(class1, hiermesh, "Overlay2", "psBM02BRINAVYLNUM" + regiment.id() + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char)((65 + k) - 1) + ".tga", 0.11F, 0.11F, 0.11F);
                        changeMat(hiermesh, "Overlay3", "psBM02BRINAVYRNUM" + regiment.id() + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + regiment.aid()[0] + "f.tga", "British/" + (char)((65 + k) - 1) + ".tga", 0.11F, 0.11F, 0.11F, 0.11F, 0.11F, 0.11F);
                    }
            ...
            } else
            {
                if(regiment.country() == com.maddox.il2.objects.air.PaintScheme.countryItaly)
                {
                    java.lang.System.out.println(" Regiment aid = " + regiment.aid()[0]);
                    if(k < 10)
                    {
