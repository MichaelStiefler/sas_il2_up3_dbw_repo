...
public class CockpitBF_109F2B extends CockpitPilot
{
  private float tmp;
  ...
  public CockpitBF_109F2B()
  {
    super("3do/cockpit/Bf-109F-2/Bf-109F2B.him", "bf109");
  ...
  {
    if ((Actor.isValid(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor)) && ((this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor instanceof BF_109F4B)))
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_ArmorGlass1", true);
  }

  static
  {
    Property.set(CockpitBF_109F2B.class, "normZN", 0.43F);
    Property.set(CockpitBF_109F2B.class, "gsZN", 0.43F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitBF_109F2B.this.bNeedSetUp)
      {
        CockpitBF_109F2B.this.reflectPlaneMats();
        CockpitBF_109F2B.access$002(CockpitBF_109F2B.this, false);
      }
      CockpitBF_109F2B.access$102(CockpitBF_109F2B.this, CockpitBF_109F2B.this.setOld);
      CockpitBF_109F2B.access$202(CockpitBF_109F2B.this, CockpitBF_109F2B.this.setNew);
      CockpitBF_109F2B.access$302(CockpitBF_109F2B.this, CockpitBF_109F2B.this.setTmp);
      CockpitBF_109F2B.this.setOld.altimeter = CockpitBF_109F2B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (CockpitBF_109F2B.this.cockpitDimControl)
      {
        if (CockpitBF_109F2B.this.setOld.dimPosition > 0.0F)
          CockpitBF_109F2B.this.setOld.dimPosition = (CockpitBF_109F2B.this.setTmp.dimPosition - 0.05F);
      }
      else if (CockpitBF_109F2B.this.setOld.dimPosition < 1.0F)
        CockpitBF_109F2B.this.setOld.dimPosition = (CockpitBF_109F2B.this.setTmp.dimPosition + 0.05F);
      CockpitBF_109F2B.this.setOld.throttle = ((10.0F * CockpitBF_109F2B.this.setTmp.throttle + CockpitBF_109F2B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl) / 11.0F);
      CockpitBF_109F2B.this.setOld.mix = ((8.0F * CockpitBF_109F2B.this.setTmp.mix + CockpitBF_109F2B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitBF_109F2B.this.setOld.azimuth = CockpitBF_109F2B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_109F2B.this.setTmp.azimuth > 270.0F) && (CockpitBF_109F2B.this.setOld.azimuth < 90.0F))
        CockpitBF_109F2B.this.setTmp.azimuth -= 360.0F;
      if ((CockpitBF_109F2B.this.setTmp.azimuth < 90.0F) && (CockpitBF_109F2B.this.setOld.azimuth > 270.0F))
        CockpitBF_109F2B.this.setTmp.azimuth += 360.0F;
      CockpitBF_109F2B.this.setOld.waypointAzimuth = ((10.0F * CockpitBF_109F2B.this.setTmp.waypointAzimuth + (CockpitBF_109F2B.this.waypointAzimuth() - CockpitBF_109F2B.this.setTmp.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      CockpitBF_109F2B.this.buzzerFX((CockpitBF_109F2B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getGear() < 0.999999F) && (CockpitBF_109F2B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getFlap() > 0.0F));
      return true;
    }
  ...
  private class Variables
  {
    ...
    float mix;
    private final CockpitBF_109F2B this$0;
    ...
    Variables(CockpitBF_109F2B.1 arg2)
    {
      this();
    }
  }
