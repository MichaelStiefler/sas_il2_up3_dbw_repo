...
public class CockpitP_47D27 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float f)
  {
    ...
    this.mesh.chunkSetAngles("throtle", 0.0F, 62.700001F * this.setNew.throttle, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitP_47D27.this.fm != null)
      {
        CockpitP_47D27.access$002(CockpitP_47D27.this, CockpitP_47D27.this.setOld);
        CockpitP_47D27.access$102(CockpitP_47D27.this, CockpitP_47D27.this.setNew);
        CockpitP_47D27.access$202(CockpitP_47D27.this, CockpitP_47D27.this.setTmp);
        CockpitP_47D27.this.setNew.throttle = (0.85F * CockpitP_47D27.this.setOld.throttle + CockpitP_47D27.this.fm.CT.PowerControl * 0.15F);
        CockpitP_47D27.this.setNew.prop = (0.85F * CockpitP_47D27.this.setOld.prop + CockpitP_47D27.this.fm.CT.getStepControl() * 0.15F);
        CockpitP_47D27.this.setNew.stage = (0.85F * CockpitP_47D27.this.setOld.stage + CockpitP_47D27.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
        CockpitP_47D27.this.setNew.mix = (0.85F * CockpitP_47D27.this.setOld.mix + CockpitP_47D27.this.fm.EI.engines[0].getControlMix() * 0.15F);
        CockpitP_47D27.this.setNew.altimeter = CockpitP_47D27.this.fm.getAltitude();
        if (Math.abs(CockpitP_47D27.this.fm.Or.getKren()) < 45.0F)
          CockpitP_47D27.this.setNew.azimuth = ((35.0F * CockpitP_47D27.this.setOld.azimuth + -CockpitP_47D27.this.fm.Or.getYaw()) / 36.0F);
        if ((CockpitP_47D27.this.setOld.azimuth > 270.0F) && (CockpitP_47D27.this.setNew.azimuth < 90.0F))
          CockpitP_47D27.this.setOld.azimuth -= 360.0F;
        if ((CockpitP_47D27.this.setOld.azimuth < 90.0F) && (CockpitP_47D27.this.setNew.azimuth > 270.0F))
          CockpitP_47D27.this.setOld.azimuth += 360.0F;
        CockpitP_47D27.this.setNew.waypointAzimuth = ((10.0F * CockpitP_47D27.this.setOld.waypointAzimuth + (CockpitP_47D27.this.waypointAzimuth() - CockpitP_47D27.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
        CockpitP_47D27.this.setNew.vspeed = ((199.0F * CockpitP_47D27.this.setOld.vspeed + CockpitP_47D27.this.fm.getVertSpeed()) / 200.0F);
        CockpitP_47D27.access$302(CockpitP_47D27.this, 0.97F * CockpitP_47D27.this.pictTurba + 0.03F * (0.5F * CockpitP_47D27.this.fm.EI.engines[0].getPowerOutput() + 0.5F * CockpitP_47D27.this.cvt(CockpitP_47D27.this.fm.EI.engines[0].getRPM(), 0.0F, 2000.0F, 0.0F, 1.0F)));
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitP_47D27 this$0;
