    ...
    implements TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = B_29SP.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= B_29SP.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / B_29SP.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)B_29SP.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(B_29SP.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = B_29SP.class;
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/B-29SP.fmd");
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            CockpitB29SP.class, CockpitB29SP_Bombardier.class, CockpitB29SP_AGunner.class
        });
        B_29SP.weaponTriggersRegister(class1, new int[] {
            14, 14, 3, 3
        });
        B_29SP.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN11", "_MGUN12", "_BombSpawn01", "_BombSpawn02"
        });
        B_29SP.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning50t 500", "MGunBrowning50t 500", null, null
        });
        B_29SP.weaponsRegister(class1, "LittleBoy", new java.lang.String[] {
            "MGunBrowning50t 500", "MGunBrowning50t 500", "BombGunLittleBoy 1", null
        });
        B_29SP.weaponsRegister(class1, "FatMan", new java.lang.String[] {
            "MGunBrowning50t 500", "MGunBrowning50t 500", null, "BombGunFatMan 1"
        });
        B_29SP.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
