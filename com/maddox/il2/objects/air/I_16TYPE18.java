    ...
    implements com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.I_16TYPE18.weaponTriggersRegister(class1, new int[] {
            1, 1, 0, 0, 3, 3, 9, 9
        });
        com.maddox.il2.objects.air.I_16TYPE18.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalDev07", "_ExternalDev08"
        });
        com.maddox.il2.objects.air.I_16TYPE18.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShKASk 650", "MGunShKASk 650", "MGunShKASk 750", "MGunShKASk 750", null, null, null, null
        });
        com.maddox.il2.objects.air.I_16TYPE18.weaponsRegister(class1, "2fab50", new java.lang.String[] {
            "MGunShKASk 650", "MGunShKASk 650", "MGunShKASk 750", "MGunShKASk 750", "BombGunFAB50", "BombGunFAB50", null, null
        });
        com.maddox.il2.objects.air.I_16TYPE18.weaponsRegister(class1, "2fab100", new java.lang.String[] {
            "MGunShKASk 650", "MGunShKASk 650", "MGunShKASk 750", "MGunShKASk 750", "BombGunFAB100", "BombGunFAB100", null, null
        });
        com.maddox.il2.objects.air.I_16TYPE18.weaponsRegister(class1, "2tank100", new java.lang.String[] {
            "MGunShKASk 650", "MGunShKASk 650", "MGunShKASk 750", "MGunShKASk 750", null, null, "FuelTankGun_Tank100i16", "FuelTankGun_Tank100i16"
        });
        com.maddox.il2.objects.air.I_16TYPE18.weaponsRegister(class1, "none", new java.lang.String[] {
