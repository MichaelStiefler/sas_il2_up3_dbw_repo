...
//            TypeBNZFighter, TypeStormovik, Aircraft, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeStormovik
{
    ...
    {
        float f1 = f <= 0.5F ? com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 0.2F, 0.0F, 95F) : com.maddox.il2.objects.air.Aircraft.cvt(f, 0.8F, 1.0F, 95F, 0.0F);
    ...
    protected void moveGear(float f)
    {
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.cvt(f, 0.0F, 0.4F, 0.0F, -0.1F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p3"))
                {
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(20F, 40F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
