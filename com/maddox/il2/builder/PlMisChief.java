...
public class PlMisChief extends com.maddox.il2.builder.Plugin
{
    ...
    {
        com.maddox.il2.builder.PlMisChief plmischief = (com.maddox.il2.builder.PlMisChief)com.maddox.il2.builder.PlMisChief.getPlugin("MisChief");
    ...
    public void load(com.maddox.rts.SectFile sectfile)
    {
        ...
        for(int k = 0; k < j; k++)
        {
            ...
            com.maddox.il2.builder.PathChief pathchief = new PathChief(builder.pathes, type[k1].moveType, k1, l1, fSectsUnits, type[k1].item[l1].iSectUnits, p);
            pathchief.setName(s);
            pathchief.setArmy(l);
            ...
            {
                pnodes = (com.maddox.il2.builder.PNodes)pathchief.point(k2);
                p.set(pnodes.posXYZ[0], pnodes.posXYZ[1], pnodes.posXYZ[2]);
                pnodes.pos.setAbs(p);
            }

            pnodes = (com.maddox.il2.builder.PNodes)pathchief.point(j2 - 2);
            int l2 = pnodes.posXYZ.length / 4 - 1;
            p.set(pnodes.posXYZ[l2 * 4 + 0], pnodes.posXYZ[l2 * 4 + 1], pnodes.posXYZ[l2 * 4 + 2]);
            pnodes = (com.maddox.il2.builder.PNodes)pathchief.point(j2 - 1);
            pnodes.pos.setAbs(p);
    ...
    public boolean save(com.maddox.rts.SectFile sectfile)
    {
        ...
        for(int j = 0; j < aobj.length; j++)
        {
            ...
            {
                com.maddox.il2.builder.PNodes pnodes1 = (com.maddox.il2.builder.PNodes)pathchief.point(j1);
            ...
            com.maddox.il2.builder.PNodes pnodes = (com.maddox.il2.builder.PNodes)pathchief.point(k - 2);
    ...
    public void changeType()
    {
        ...
        com.maddox.il2.builder.PathChief pathchief = (com.maddox.il2.builder.PathChief)builder.selectedPath();
    ...
    {
        if(com.maddox.il2.builder.PlMisChief.getPlugin("Mission") == null)
            throw new RuntimeException("PlMisChief: plugin 'Mission' not found");
        pluginMission = (com.maddox.il2.builder.PlMission)com.maddox.il2.builder.PlMisChief.getPlugin("Mission");
        if(sectFile == null)
    ...
    void viewUpdate()
    {
        ...
        for(int i = 0; i < aobj.length; i++)
        {
            ...
            if(actor instanceof com.maddox.il2.builder.PathChief)
            {
                com.maddox.il2.builder.PathChief pathchief1 = (com.maddox.il2.builder.PathChief)actor;
    ...
    private void fillComboBox2(int i, int j)
    {
        ...
        if(builder.wSelect.curFilledType != i)
        {
            ...
            for(int k = 0; k < type[i - startComboBox1].item.length; k++)
                builder.wSelect.comboBox2.add(com.maddox.il2.game.I18N.technic(type[i - startComboBox1].item[k].name));
    ...
    public java.lang.String[] actorInfo(com.maddox.il2.engine.Actor actor)
    {
        ...
        if(pnodes.timeoutMin > 0.0D)
            _actorInfo[1] = "(" + i + ") in:" + com.maddox.il2.builder.PlMisChief.timeSecToString(pnodes.time + (double)(int)(com.maddox.il2.ai.World.getTimeofDay() * 60F * 60F)) + " out:" + com.maddox.il2.builder.PlMisChief.timeSecToString(pnodes.time + (double)(int)(com.maddox.il2.ai.World.getTimeofDay() * 60F * 60F) + pnodes.timeoutMin * 60D);
        else
            _actorInfo[1] = "(" + i + ") " + com.maddox.il2.builder.PlMisChief.timeSecToString(pnodes.time + (double)(int)(com.maddox.il2.ai.World.getTimeofDay() * 60F * 60F));
        return _actorInfo;
    }
    ...
    public void createGUI()
    {
        ...
        if(--i >= 0)
        {
            ...
            for(; i >= 0; i--)
            {
                ...
                if("de".equals(com.maddox.rts.RTSConf.cur.locale.getLanguage()))
                    viewitem = (com.maddox.il2.builder.ViewItem)builder.mDisplayFilter.subMenu.addItem(j, new ViewItem(i, builder.mDisplayFilter.subMenu, com.maddox.il2.game.I18N.technic(type[i].name) + " " + com.maddox.il2.builder.PlMisChief.i18n("show"), null));
                else
                    viewitem = (com.maddox.il2.builder.ViewItem)builder.mDisplayFilter.subMenu.addItem(j, new ViewItem(i, builder.mDisplayFilter.subMenu, com.maddox.il2.builder.PlMisChief.i18n("show") + " " + com.maddox.il2.game.I18N.technic(type[i].name), null));
        ...
        tabActor = builder.wSelect.tabsClient.createTab(com.maddox.il2.builder.PlMisChief.i18n("ChiefActor"), gwindowdialogclient);
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 1.0F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("Name"), null));
        gwindowdialogclient.addLabel(wName = new GWindowLabel(gwindowdialogclient, 9F, 1.0F, 7F, 1.3F, "", null));
        gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 1.0F, 3F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("Army"), null));
        ...
        gwindowdialogclient.addLabel(wLSleepM = new GWindowLabel(gwindowdialogclient, 1.0F, 5F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("Sleep"), null));
        ...
        gwindowdialogclient.addLabel(wLSkill = new GWindowLabel(gwindowdialogclient, 1.0F, 7F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("Skill"), null));
        ...
        gwindowdialogclient.addLabel(wLSlowfire = new GWindowLabel(gwindowdialogclient, 1.0F, 9F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("Slowfire"), null));
    ...
    {
        com.maddox.il2.builder.PNodes pnodes = (com.maddox.il2.builder.PNodes)builder.selectedPoint();
        com.maddox.il2.builder.PathChief pathchief = (com.maddox.il2.builder.PathChief)builder.selectedPath();
        int i = pathchief.pointIndx(pnodes);
        wCur.cap = new GCaption("" + i + "(" + pathchief.points() + ")");
        wTime.cap = new GCaption(com.maddox.il2.builder.PlMisChief.timeSecToString(pnodes.time + (double)(com.maddox.il2.ai.World.getTimeofDay() * 60F * 60F)));
        wPrev.setEnable(i > 0);
    ...
    public void initEditWay()
    {
        ...
        tabWay = builder.wSelect.tabsClient.createTab(com.maddox.il2.builder.PlMisChief.i18n("Waypoint"), gwindowdialogclient);
        gwindowdialogclient.addControl(wPrev = new com.maddox.gwindow.GWindowButton(gwindowdialogclient, 1.0F, 1.0F, 5F, 1.6F, com.maddox.il2.builder.PlMisChief.i18n("&Prev"), null) {
        ...
        gwindowdialogclient.addControl(wNext = new com.maddox.gwindow.GWindowButton(gwindowdialogclient, 9F, 1.0F, 5F, 1.6F, com.maddox.il2.builder.PlMisChief.i18n("&Next"), null) {
        ...
        gwindowdialogclient.addLabel(wLTime = new GWindowLabel(gwindowdialogclient, 1.0F, 3F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("Time"), null));
        gwindowdialogclient.addLabel(wTime = new GWindowLabel(gwindowdialogclient, 9F, 3F, 6F, 1.3F, "0:00", null));
        gwindowdialogclient.addLabel(wLTimeOutH = new GWindowLabel(gwindowdialogclient, 1.0F, 5F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("TimeOut"), null));
        ...
        gwindowdialogclient.addLabel(wLSpeed0 = new GWindowLabel(gwindowdialogclient, 1.0F, 7F, 7F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("Speed"), null));
        gwindowdialogclient.addLabel(wLSpeed1 = new GWindowLabel(gwindowdialogclient, 15F, 7F, 4F, 1.3F, com.maddox.il2.builder.PlMisChief.i18n("[kM/H]"), null));
