  ...
  implements Serializable
{
  ...
  public void setCellSize(double paramDouble)
  {
    this.cellSize = paramDouble;
  }
  ...
  public void shrinkWidth(int paramInt)
  {
    for (int i = getWidth() - paramInt; i < getWidth(); i++)
      for (int j = 0; j < getHeight(); j++)
        this.cells[i][j] = this;
  }

  public void shrinkHeight(int paramInt)
  {
    for (int i = getHeight() - paramInt; i < getHeight(); i++)
