...
public class BF_109E4_Trop extends BF_109
{
  private float kangle;

  public BF_109E4_Trop()
  {
    this.kangle = 0.0F;
  }
  ...
  private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int paramInt)
  {
    ...
    try { arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(0, "MGunMG17si", 1000); arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(0, "MGunMG17si", 1000); arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMGFFk", 60); arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMGFFk", 60);
    }
  ...
  static
  {
    Class localClass = BF_109E4_Trop.class; new NetAircraft.SPAWN(localClass); Property.set(localClass, "iconFar_shortClassName", "Bf109"); Property.set(localClass, "meshName", "3DO/Plane/Bf-109E-4_Trop/hier.him"); Property.set(localClass, "PaintScheme", new PaintSchemeFMPar01()); Property.set(localClass, "yearService", 1940.0F);

    Property.set(localClass, "yearExpired", 1944.0F); Property.set(localClass, "FlightModel", "FlightModels/Bf-109E-4_BoB.fmd"); Property.set(localClass, "cockpitClass", new Class[] { CockpitBF_109Ex.class }); Property.set(localClass, "LOSElevation", 0.74985F); Aircraft.weaponTriggersRegister(localClass, new int[] { 0, 0, 1, 1 }); Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON02" });
    try { ArrayList localArrayList = new ArrayList(); Property.set(localClass, "weaponsList", localArrayList); HashMapInt localHashMapInt = new HashMapInt(); Property.set(localClass, "weaponsMap", localHashMapInt); int i = 4; String str = "default"; Aircraft._WeaponSlot[] arrayOf_WeaponSlot = GenerateDefaultConfig(i); for (int j = 4; j < i; j++) arrayOf_WeaponSlot[j] = null; localArrayList.add(str); localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot); str = "none"; arrayOf_WeaponSlot = new Aircraft._WeaponSlot[i]; for (int k = 0; k < i; k++) arrayOf_WeaponSlot[k] = null; localArrayList.add(str); localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
    }
    catch (Exception localException)
    {
    }
