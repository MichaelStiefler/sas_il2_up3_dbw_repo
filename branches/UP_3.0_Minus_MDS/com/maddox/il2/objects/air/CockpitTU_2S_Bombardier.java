...
// Source File Name:   CockpitTU_2S_Bombardier.java
...
//            CockpitPilot, TU_2S, Cockpit

public class CockpitTU_2S_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.TU_2S)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.TU_2S)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.TU_2S)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.TU_2S)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
