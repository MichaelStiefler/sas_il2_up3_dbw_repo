...
// Source File Name:   CockpitD3A1.java
...
//            CockpitPilot, D3A1, AircraftLH, Aircraft

public class CockpitD3A1 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        com.maddox.il2.objects.air.D3A1 _tmp = (com.maddox.il2.objects.air.D3A1)aircraft();
        if(com.maddox.il2.objects.air.D3A1.bChangedPit)
        {
            reflectPlaneToModel();
            com.maddox.il2.objects.air.D3A1 _tmp1 = (com.maddox.il2.objects.air.D3A1)aircraft();
            com.maddox.il2.objects.air.D3A1.bChangedPit = false;
        }
        resetYPRmodifier();
        xyz[2] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.44F);
        ...
        mesh.chunkSetAngles("Z_Compass4", -90F, 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Compass5", setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Compass6", cvt(setNew.waypointDeviation.getDeg(f * 0.2F), -25F, 25F, -45F, 45F), 0.0F, 0.0F);
        resetYPRmodifier();
        xyz[2] = cvt(setNew.vspeed, -15F, 15F, -0.053F, 0.053F);
        ...
        mesh.chunkSetAngles("Z_fuelpress1", cvt(fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 2.0F, 0.0F, 180F), 0.0F, 0.0F);
