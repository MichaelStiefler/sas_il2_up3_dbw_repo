...
// Source File Name:   CockpitJ2M5.java
...
public class CockpitJ2M5 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[0] = cvt(interp(setNew.dimPosition, setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 0.07F);
        mesh.chunkSetLocate("Z_SightTint", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.Or.getTangage(), -45F, 45F, 0.02705F, -0.02705F);
        mesh.chunkSetLocate("Z_TurnBank1a", xyz, ypr);
        w.set(fm.getW());
        fm.Or.transform(w);
