...
public class CockpitF4 extends CockpitPilot {
  ...
  class Interpolater extends InterpolateRef {
    ...
    public boolean tick() {
      if (fm != null) {
        ...
        float f = ((F4_Phantom) aircraft()).k14Distance;
        setNew.k14w = (5F * CockpitF4.k14TargetWingspanScale[((F4_Phantom) aircraft()).k14WingspanType])
                / f;
        setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
        setNew.k14wingspan = 0.9F
                * setOld.k14wingspan
                + 0.1F
                * CockpitF4.k14TargetMarkScale[((F4_Phantom) aircraft()).k14WingspanType];
        setNew.k14mode = 0.8F * setOld.k14mode + 0.2F
                * (float) ((F4_Phantom) aircraft()).k14Mode;
        ...
        float f3 = floatindex((f - 200F) * 0.04F,
                CockpitF4.k14BulletDrop)
                - CockpitF4.k14BulletDrop[0];
