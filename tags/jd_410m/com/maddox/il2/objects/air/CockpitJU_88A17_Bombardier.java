...
public class CockpitJU_88A17_Bombardier extends CockpitPilot
{
  ...
  public CockpitJU_88A17_Bombardier()
  {
    super("3DO/Cockpit/Ju-88A-4-Bombardier/A17hier.him", "he111");
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    resetYPRmodifier();
    float tmp425_424 = (0.85F * this.pictFlap + 0.00948F * this.fm.CT.FlapsControl); this.pictFlap = tmp425_424; Cockpit.xyz[2] = tmp425_424;

    this.mesh.chunkSetLocate("zFlaps1", Cockpit.xyz, Cockpit.ypr);
    float tmp471_470 = (0.85F * this.pictGear + 0.007095F * this.fm.CT.GearControl); this.pictGear = tmp471_470; Cockpit.xyz[2] = tmp471_470;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A17_Bombardier.this.fm != null) {
        CockpitJU_88A17_Bombardier.access$102(CockpitJU_88A17_Bombardier.this, CockpitJU_88A17_Bombardier.this.setOld);
        CockpitJU_88A17_Bombardier.access$202(CockpitJU_88A17_Bombardier.this, CockpitJU_88A17_Bombardier.this.setNew);
        CockpitJU_88A17_Bombardier.access$302(CockpitJU_88A17_Bombardier.this, CockpitJU_88A17_Bombardier.this.setTmp);
        CockpitJU_88A17_Bombardier.this.setNew.throttle1 = (0.85F * CockpitJU_88A17_Bombardier.this.setOld.throttle1 + CockpitJU_88A17_Bombardier.this.fm.EI.engines[0].getControlThrottle() * 0.15F);

        CockpitJU_88A17_Bombardier.this.setNew.prop1 = (0.85F * CockpitJU_88A17_Bombardier.this.setOld.prop1 + CockpitJU_88A17_Bombardier.this.fm.EI.engines[0].getControlProp() * 0.15F);

        CockpitJU_88A17_Bombardier.this.setNew.throttle2 = (0.85F * CockpitJU_88A17_Bombardier.this.setOld.throttle2 + CockpitJU_88A17_Bombardier.this.fm.EI.engines[1].getControlThrottle() * 0.15F);

        CockpitJU_88A17_Bombardier.this.setNew.prop2 = (0.85F * CockpitJU_88A17_Bombardier.this.setOld.prop2 + CockpitJU_88A17_Bombardier.this.fm.EI.engines[1].getControlProp() * 0.15F);

        CockpitJU_88A17_Bombardier.this.setNew.altimeter = CockpitJU_88A17_Bombardier.this.fm.getAltitude();
        float f1 = CockpitJU_88A17_Bombardier.this.waypointAzimuth();
        if (CockpitJU_88A17_Bombardier.this.useRealisticNavigationInstruments())
        {
          CockpitJU_88A17_Bombardier.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A17_Bombardier.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A17_Bombardier.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A17_Bombardier.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A17_Bombardier.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A17_Bombardier.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
          CockpitJU_88A17_Bombardier.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A17_Bombardier.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A17_Bombardier.this.setOld.azimuth.getDeg(1.0F));
        }
        CockpitJU_88A17_Bombardier.this.setNew.azimuth.setDeg(CockpitJU_88A17_Bombardier.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A17_Bombardier.this.fm.Or.azimut());

        CockpitJU_88A17_Bombardier.this.setNew.vspeed = ((199.0F * CockpitJU_88A17_Bombardier.this.setOld.vspeed + CockpitJU_88A17_Bombardier.this.fm.getVertSpeed()) / 200.0F);

        if (CockpitJU_88A17_Bombardier.this.cockpitDimControl)
        {
          if (CockpitJU_88A17_Bombardier.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A17_Bombardier.this.setNew.dimPosition -= 0.05F;
        }
        else if (CockpitJU_88A17_Bombardier.this.setNew.dimPosition < 1.0F)
          CockpitJU_88A17_Bombardier.this.setNew.dimPosition += 0.05F;
        float f2 = CockpitJU_88A17_Bombardier.this.prevFuel - CockpitJU_88A17_Bombardier.this.fm.M.fuel;
        CockpitJU_88A17_Bombardier.access$402(CockpitJU_88A17_Bombardier.this, CockpitJU_88A17_Bombardier.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A17_Bombardier.this.setNew.cons = (0.91F * CockpitJU_88A17_Bombardier.this.setOld.cons + 0.09F * f2);
      }
  ...
  private class Variables
  {
    ...
    float beaconRange;
    private final CockpitJU_88A17_Bombardier this$0;
    ...
    Variables(CockpitJU_88A17_Bombardier.1 arg2)
    {
      this();
    }
  }
