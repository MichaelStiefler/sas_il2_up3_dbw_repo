...
public class CmdSFS extends com.maddox.rts.Cmd
{
    ...
    {
        boolean flag = false;
        if(com.maddox.rts.Cmd.nargs(map, "MOUNT") > 0)
        {
            java.lang.String s = com.maddox.rts.Cmd.arg(map, "MOUNT", 0);
            java.lang.String s2 = null;
            if(com.maddox.rts.Cmd.nargs(map, "MOUNT") > 1)
                s2 = com.maddox.rts.Cmd.arg(map, "MOUNT", 1);
            try
            {
                if(s2 != null)
        ...
        if(com.maddox.rts.Cmd.nargs(map, "UNMOUNT") > 0)
        {
            java.lang.String s1 = com.maddox.rts.Cmd.arg(map, "UNMOUNT", 0);
            try
            {
