...
// Source File Name:   Cockpit_BombsightOPB.java
...
//            CockpitPilot, BombsightOPB, Cockpit

public class Cockpit_BombsightOPB extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = com.maddox.il2.objects.air.BombsightOPB.fSightCurForwardAngle;
                float f1 = com.maddox.il2.objects.air.BombsightOPB.fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", com.maddox.il2.objects.air.BombsightOPB.fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(com.maddox.il2.objects.air.BombsightOPB.fSightSetForwardAngle, -15F, 75F, -15F, 75F);
        mesh.chunkSetAngles("zMark2", f1 * 3.675F, 0.0F, 0.0F);
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[0] = cvt(-fm.Or.getKren(), -13F, 13F, -0.23F, 0.23F);
        com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(-fm.Or.getTangage(), -13F, 13F, 0.23F, -0.23F);
