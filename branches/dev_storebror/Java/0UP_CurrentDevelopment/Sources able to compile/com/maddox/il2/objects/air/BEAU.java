...
public abstract class BEAU extends Scheme2
{
    ...
    public boolean turretAngles(int i, float af[])
    {
        ...
        case 0: // '\0'
            ...
            if(f1 > Aircraft.cvt(java.lang.Math.abs(f), 0.0F, 50F, 40F, 25F))
                f1 = Aircraft.cvt(java.lang.Math.abs(f), 0.0F, 50F, 40F, 25F);
            if(f1 < Aircraft.cvt(java.lang.Math.abs(f), 0.0F, 50F, -10F, -3.5F))
                f1 = Aircraft.cvt(java.lang.Math.abs(f), 0.0F, 50F, -10F, -3.5F);
            break;
        }
        af[0] = -f;
        af[1] = f1;
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                if(s.endsWith("e1"))
                    getEnergyPastArmor(12.100000381469727D / (java.lang.Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                if(s.endsWith("e2"))
                    getEnergyPastArmor(12.100000381469727D / (java.lang.Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                if(s.endsWith("p1"))
    ...
    static 
    {
        java.lang.Class class1 = BEAU.class;
