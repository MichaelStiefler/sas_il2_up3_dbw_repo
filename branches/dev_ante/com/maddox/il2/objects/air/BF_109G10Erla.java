  ...
  implements TypeBNZFighter
{
  ...
  static
  {
    Class localClass = BF_109G10Erla.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3DO/Plane/Bf-109G-10Erla/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());
    Property.set(localClass, "yearService", 1944.0F);
    Property.set(localClass, "yearExpired", 1946.0F);
    Property.set(localClass, "FlightModel", "FlightModels/Bf-109G-10Erla.fmd");
    Property.set(localClass, "cockpitClass", new Class[] { CockpitBF_109G10.class });
