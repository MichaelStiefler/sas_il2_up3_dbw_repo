    ...
    implements com.maddox.il2.engine.Accumulator
{
    ...
    public static com.maddox.il2.engine.Actor getAFoundEnemy(com.maddox.JGP.Point3d point3d, double d, int i)
    {
        ...
        for(int k = 0; k < j; k++)
        {
            ...
            if((actor instanceof com.maddox.il2.objects.ships.Ship.RwyTransp) || (actor instanceof com.maddox.il2.objects.ships.Ship.RwyTranspWide) || (actor instanceof com.maddox.il2.objects.ships.Ship.RwyTranspSqr) || (((com.maddox.il2.ai.ground.Prey)actor).HitbyMask() & usedWeaponsMask) == 0)
                continue;
        ...
        if(!flag || (nearAct[0] instanceof com.maddox.il2.objects.air.Paratrooper))
            return nearAct[nearNUsed != 1 ? com.maddox.il2.ai.World.Rnd().nextInt(nearNUsed) : 0];
        int l;
        for(l = 1; l < nearNUsed && !(nearAct[l] instanceof com.maddox.il2.objects.air.Paratrooper); l++);
