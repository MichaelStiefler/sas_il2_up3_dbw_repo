...
//            CockpitPilot, P_80A, Cockpit, Aircraft

public class CockpitYP_80 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f3 = ((com.maddox.il2.objects.air.P_80A)aircraft()).k14Distance;
                setNew.k14w = (5F * com.maddox.il2.objects.air.CockpitYP_80.k14TargetWingspanScale[((com.maddox.il2.objects.air.P_80A)aircraft()).k14WingspanType]) / f3;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * com.maddox.il2.objects.air.CockpitYP_80.k14TargetMarkScale[((com.maddox.il2.objects.air.P_80A)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((com.maddox.il2.objects.air.P_80A)aircraft()).k14Mode;
                com.maddox.JGP.Vector3d vector3d = aircraft().FM.getW();
                double d = 0.00125D * (double)f3;
                float f = (float)java.lang.Math.toDegrees(d * vector3d.z);
                float f1 = -(float)java.lang.Math.toDegrees(d * vector3d.y);
                float f2 = floatindex((f3 - 200F) * 0.04F, com.maddox.il2.objects.air.CockpitYP_80.k14BulletDrop) - com.maddox.il2.objects.air.CockpitYP_80.k14BulletDrop[0];
                f1 += (float)java.lang.Math.toDegrees(java.lang.Math.atan(f2 / f3));
                setNew.k14x = 0.92F * setOld.k14x + 0.08F * f;
                setNew.k14y = 0.92F * setOld.k14y + 0.08F * f1;
                if(setNew.k14x > 7F)
                    setNew.k14x = 7F;
                if(setNew.k14x < -7F)
                    setNew.k14x = -7F;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            int i = ((com.maddox.il2.objects.air.P_80A)aircraft()).k14Mode;
            boolean flag = i < 2;
