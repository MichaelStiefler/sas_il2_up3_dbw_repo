  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_9U.this.fm != null) {
        ...
        CockpitYAK_9U.this.setNew.throttle = ((10.0F * CockpitYAK_9U.this.setOld.throttle + CockpitYAK_9U.this.fm.CT.PowerControl) / 11.0F);
        CockpitYAK_9U.this.setNew.prop = ((10.0F * CockpitYAK_9U.this.setOld.prop + CockpitYAK_9U.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_9U.this.setNew.altimeter = CockpitYAK_9U.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_9U.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_9U.this.setNew.azimuth = ((35.0F * CockpitYAK_9U.this.setOld.azimuth + CockpitYAK_9U.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitYAK_9U.this.setNew.vspeed = ((199.0F * CockpitYAK_9U.this.setOld.vspeed + CockpitYAK_9U.this.fm.getVertSpeed()) / 200.0F);
      }
