// Source File Name: CockpitB25G1.java
...
public class CockpitB25G1 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB25G1.this.fm != null) {
				...
				CockpitB25G1.this.setNew.throttle1 = (0.85F * CockpitB25G1.this.setOld.throttle1)
						+ (CockpitB25G1.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitB25G1.this.setNew.throttle2 = (0.85F * CockpitB25G1.this.setOld.throttle2)
						+ (CockpitB25G1.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitB25G1.this.setNew.prop1 = (0.85F * CockpitB25G1.this.setOld.prop1)
						+ (CockpitB25G1.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitB25G1.this.setNew.prop2 = (0.85F * CockpitB25G1.this.setOld.prop2)
						+ (CockpitB25G1.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitB25G1.this.setNew.altimeter = CockpitB25G1.this.fm
						.getAltitude();
				float f = CockpitB25G1.this.waypointAzimuth();
				CockpitB25G1.this.setNew.azimuth.setDeg(
						CockpitB25G1.this.setOld.azimuth.getDeg(1.0F),
						CockpitB25G1.this.fm.Or.azimut());
				CockpitB25G1.this.setNew.waypointAzimuth.setDeg(
						CockpitB25G1.this.setOld.waypointAzimuth.getDeg(1.0F),
						f);
				CockpitB25G1.this.setNew.waypointDeviation
						.setDeg(CockpitB25G1.this.setOld.waypointDeviation
								.getDeg(0.1F),
								(f - CockpitB25G1.this.setOld.azimuth
										.getDeg(1.0F))
										+ World.Rnd().nextFloat(-10F, 10F));
				CockpitB25G1.this.setNew.vspeed = ((199F * CockpitB25G1.this.setOld.vspeed) + CockpitB25G1.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public CockpitB25G1() {
		super("3DO/Cockpit/B-25J/CockpitB25G1.him", "bf109");
