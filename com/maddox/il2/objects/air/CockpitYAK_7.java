...
public class CockpitYAK_7 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitYAK_7.access$102(CockpitYAK_7.this, CockpitYAK_7.this.setOld); CockpitYAK_7.access$202(CockpitYAK_7.this, CockpitYAK_7.this.setNew); CockpitYAK_7.access$302(CockpitYAK_7.this, CockpitYAK_7.this.setTmp);

        CockpitYAK_7.this.setNew.throttle = ((10.0F * CockpitYAK_7.this.setOld.throttle + CockpitYAK_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_7.this.setNew.prop = ((10.0F * CockpitYAK_7.this.setOld.prop + CockpitYAK_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_7.this.setNew.altimeter = CockpitYAK_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_7.this.setNew.azimuth = ((35.0F * CockpitYAK_7.this.setOld.azimuth + CockpitYAK_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitYAK_7.this.setOld.azimuth > 270.0F) && (CockpitYAK_7.this.setNew.azimuth < 90.0F)) CockpitYAK_7.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_7.this.setOld.azimuth < 90.0F) && (CockpitYAK_7.this.setNew.azimuth > 270.0F)) CockpitYAK_7.this.setOld.azimuth += 360.0F;
        CockpitYAK_7.this.setNew.vspeed = ((199.0F * CockpitYAK_7.this.setOld.vspeed + CockpitYAK_7.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_7 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitYAK_7.1 arg2) { this();
    }
  }
}