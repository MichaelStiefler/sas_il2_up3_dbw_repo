...
public class CockpitPE2_1 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitPE2_1.access$102(CockpitPE2_1.this, CockpitPE2_1.this.setOld); CockpitPE2_1.access$202(CockpitPE2_1.this, CockpitPE2_1.this.setNew); CockpitPE2_1.access$302(CockpitPE2_1.this, CockpitPE2_1.this.setTmp);
        ...
        for (int i = 0; i < 10; i++) {
          CockpitPE2_1.this.bBombs[i] = (!CockpitPE2_1.this.eBombs[i].haveBullets() ? 1 : 0);
        }

        CockpitPE2_1.this.setNew.throttle1 = (0.9F * CockpitPE2_1.this.setOld.throttle1 + 0.1F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitPE2_1.this.setNew.prop1 = (0.9F * CockpitPE2_1.this.setOld.prop1 + 0.1F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitPE2_1.this.setNew.mix1 = (0.8F * CockpitPE2_1.this.setOld.mix1 + 0.2F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitPE2_1.this.setNew.man1 = (0.92F * CockpitPE2_1.this.setOld.man1 + 0.08F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitPE2_1.this.setNew.throttle2 = (0.9F * CockpitPE2_1.this.setOld.throttle2 + 0.1F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitPE2_1.this.setNew.prop2 = (0.9F * CockpitPE2_1.this.setOld.prop2 + 0.1F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
        CockpitPE2_1.this.setNew.mix2 = (0.8F * CockpitPE2_1.this.setOld.mix2 + 0.2F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
        CockpitPE2_1.this.setNew.man2 = (0.92F * CockpitPE2_1.this.setOld.man2 + 0.08F * CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitPE2_1.this.setNew.altimeter = CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitPE2_1.this.setNew.stage1 = (0.85F * CockpitPE2_1.this.setOld.stage1 + CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor() * 0.15F);
        CockpitPE2_1.this.setNew.stage2 = (0.85F * CockpitPE2_1.this.setOld.stage2 + CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlCompressor() * 0.15F);

        CockpitPE2_1.this.setNew.azimuth.setDeg(CockpitPE2_1.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitPE2_1.this.setNew.vspeed = ((100.0F * CockpitPE2_1.this.setOld.vspeed + CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);

        float f = CockpitPE2_1.this.waypointAzimuth();

        CockpitPE2_1.this.setNew.waypointAzimuth.setDeg(CockpitPE2_1.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitPE2_1.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitPE2_1.this.setNew.waypointDirection.setDeg(CockpitPE2_1.this.setOld.waypointDirection.getDeg(1.0F), f);

        CockpitPE2_1.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RTurret", CockpitPE2_1.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[0], 0.0F, 0.0F);
        CockpitPE2_1.this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_RGun", CockpitPE2_1.this.aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[0].tu[1], 0.0F, 0.0F);

        CockpitPE2_1.this.setNew.inert = (0.999F * CockpitPE2_1.this.setOld.inert + 0.001F * (CockpitPE2_1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
  ...
  private class Variables
  {
    ...
    float stage1;
    float stage2;
    private final CockpitPE2_1 this$0;
