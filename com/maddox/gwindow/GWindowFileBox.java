...
public class GWindowFileBox extends GWindowFramed
{
  ...
  public boolean bIncludeHomeNameToResult = false;
  ...
  protected TreeMap _scanMap = new TreeMap();

  public float minFullDX = 24.0F;
  public float minFullDY = 16.0F;

  public float defFullDX = 30.0F;
  public float defFullDY = 24.0F;

  public float spaceLeft = 0.2F;
  public float spaceRight = 0.2F;

  public float titleSpaceUP = 0.2F;
  public float titleDY = 1.6F;
  public float dirDX = 8.0F;
  public float separateDX = 0.2F;
  public float dirDXMin = this.dirDX;
  public float areaDXMin = 4.0F;

  public float areaSpaceDOWN = 4.6F;
  public float fileSpaceDOWN = 4.0F;
  public float typeSpaceDOWN = 2.0F;

  public float buttonDX = 6.0F;
  public float buttonDY = 1.8F;
  public float spaceDX = 1.0F;
  public float textDX = 8.0F;
  ...
  public void doResult(String paramString) {
    if (paramString != null) this.resultFileName = makeResultName(paramString); else
  ...
  protected void scanFiles()
  {
    ...
    for (int i = 0; i < arrayOfFile.length; i++) {
      if ((this.filter != null) && (this.wCFilter != null)) {
        localObject = this.filter[this.wCFilter.getSelected()];
        if ((arrayOfFile[i].isFile()) && (!arrayOfFile[i].isHidden()) && (((GFileFilter)localObject).accept(arrayOfFile[i])))
    ...
    while (((Iterator)localObject).hasNext()) {
      this.files.add(this._scanMap.get(((Iterator)localObject).next()));
    }
    this._scanMap.clear();
    this.wArea.updateFiles(true);
  }
  ...
  public float m(float paramFloat) { return paramFloat / lookAndFeel().metric(); }
  ...
  public void computeWin() {
    ...
    if (this.wFolders != null) { computeFolders(_reg, localGRegion); _setWin(this.wFolders, _reg); }
    if (this.wContents != null) { computeContents(_reg, localGRegion); _setWin(this.wContents, _reg); }
    if (this.wDir != null) { computeDir(_reg, localGRegion); _setWin(this.wDir, _reg); }
    if (this.wSeparate != null) { computeSeparate(_reg, localGRegion); _setWin(this.wSeparate, _reg); }
    if (this.wArea != null) { computeArea(_reg, localGRegion); _setWin(this.wArea, _reg); }
    if (this.wFile != null) { computeFile(_reg, localGRegion); _setWin(this.wFile, _reg); }
    if (this.wFilter != null) { computeFilter(_reg, localGRegion); _setWin(this.wFilter, _reg); }
    if (this.wEdit != null) { computeEdit(_reg, localGRegion); _setWin(this.wEdit, _reg); }
    if (this.wCFilter != null) { computeCFilter(_reg, localGRegion); _setWin(this.wCFilter, _reg); }
    if (this.wOk != null) { computeOk(_reg, localGRegion); _setWin(this.wOk, _reg); }
    if (this.wCancel != null) { computeCancel(_reg, localGRegion); _setWin(this.wCancel, _reg);
    }
  }
  ...
  public void createDir(GWindowDialogClient paramGWindowDialogClient) {
    ...
    this.wDir.jdField_metricWin_of_type_ComMaddoxGwindowGRegion = null;
  ...
  public void createFile(GWindowDialogClient paramGWindowDialogClient) {
    ...
    this.wFile.jdField_metricWin_of_type_ComMaddoxGwindowGRegion = null;
  }
  public void createFilter(GWindowDialogClient paramGWindowDialogClient) {
    ...
    this.wFilter.jdField_metricWin_of_type_ComMaddoxGwindowGRegion = null;
  }
  public void createEdit(GWindowDialogClient paramGWindowDialogClient) {
    ...
    this.wEdit.jdField_metricWin_of_type_ComMaddoxGwindowGRegion = null;
  ...
  public void createCFilter(GWindowDialogClient paramGWindowDialogClient) {
    ...
    this.wCFilter.jdField_metricWin_of_type_ComMaddoxGwindowGRegion = null;
  ...
  public void createOk(GWindowDialogClient paramGWindowDialogClient) {
    ...
    this.wOk.jdField_metricWin_of_type_ComMaddoxGwindowGRegion = null;
  }
  public void createCancel(GWindowDialogClient paramGWindowDialogClient) {
    ...
    this.wCancel.jdField_metricWin_of_type_ComMaddoxGwindowGRegion = null;
  }
  ...
  public void afterCreated() {
    ...
    if (this.bModal)
      showModal();
    if (this.jdField_root_of_type_ComMaddoxGwindowGWindowRoot == this.parentWindow)
  ...
  public class Label extends GWindow
  {
    ...
    public void render()
    {
      ...
      localGWin95LookAndFeel.drawBevel(this, 0.0F, 0.0F, this.jdField_win_of_type_ComMaddoxGwindowGRegion.dx, this.jdField_win_of_type_ComMaddoxGwindowGRegion.dy, localGWin95LookAndFeel.bevelDOWN, localGWin95LookAndFeel.elements, true);
      if (this.title != null) {
        setCanvasColorBLACK();
        setCanvasFont(0);
        GFont localGFont = this.root.textFonts[0];
        float f = (this.jdField_win_of_type_ComMaddoxGwindowGRegion.dy - localGWin95LookAndFeel.bevelDOWN.TL.dy - localGWin95LookAndFeel.bevelDOWN.BL.dy - localGFont.height) / 2.0F;
        draw(localGWin95LookAndFeel.bevelDOWN.TL.dx + GWindowFileBox.this.M(0.5F), localGWin95LookAndFeel.bevelDOWN.TL.dy + f, this.jdField_win_of_type_ComMaddoxGwindowGRegion.dx - GWindowFileBox.this.M(0.5F) - localGWin95LookAndFeel.bevelDOWN.TL.dx - localGWin95LookAndFeel.bevelDOWN.TR.dx, localGFont.height, 0, this.title);
      }
    }
  ...
  public class Area extends GWindowDialogControl
  {
    ...
    public int spaceDY = 4;
    public int spaceDX = 6;
    float maxDX;
    int cols;
    int rows;
    int firstView;
    ...
    public void updateFiles(boolean paramBoolean) {
      ...
      for (int i = 0; i < GWindowFileBox.this.files.size(); i++) {
        File localFile = (File)GWindowFileBox.this.files.get(i);
        localObject = localGFont.size(localFile.getName());
        if (((GSize)localObject).dx > this.maxDX)
          this.maxDX = ((GSize)localObject).dx;
      }
      ...
      if (GWindowFileBox.this.files.size() % this.rows > 0) this.cols += 1;
      if (this.cols * this.maxDX + (this.cols - 1) * this.spaceDX + this.spaceDX / 2 > ((GRegion)localObject).dx) {
        ...
        if (this.colsVisible == 0) this.colsVisible = 1;
    ...
    public void render() {
      setCanvasColorWHITE();
      GWin95LookAndFeel localGWin95LookAndFeel = (GWin95LookAndFeel)lookAndFeel();
      draw(localGWin95LookAndFeel.bevelDOWN.L.dx, localGWin95LookAndFeel.bevelDOWN.T.dy, this.jdField_win_of_type_ComMaddoxGwindowGRegion.dx - localGWin95LookAndFeel.bevelDOWN.R.dx - localGWin95LookAndFeel.bevelDOWN.L.dx, this.jdField_win_of_type_ComMaddoxGwindowGRegion.dy - localGWin95LookAndFeel.bevelDOWN.B.dy - localGWin95LookAndFeel.bevelDOWN.T.dy, localGWin95LookAndFeel.elements, 5.0F, 17.0F, 1.0F, 1.0F);
      ...
      setCanvasColorWHITE();
      localGWin95LookAndFeel.drawBevel(this, 0.0F, 0.0F, this.jdField_win_of_type_ComMaddoxGwindowGRegion.dx, this.jdField_win_of_type_ComMaddoxGwindowGRegion.dy, localGWin95LookAndFeel.bevelDOWN, localGWin95LookAndFeel.elements, false);
    }
    ...
    public GRegion getClientRegion(GRegion paramGRegion, float paramFloat) {
      ...
      paramGRegion.dx = (this.jdField_win_of_type_ComMaddoxGwindowGRegion.dx - paramGRegion.x - this.look.bevelDOWN.R.dx - paramFloat);
      paramGRegion.dy = (this.jdField_win_of_type_ComMaddoxGwindowGRegion.dy - paramGRegion.y - this.look.bevelDOWN.B.dy - paramFloat);
      return paramGRegion;
    }
    ...
    public boolean notify(GWindow paramGWindow, int paramInt1, int paramInt2) {
      if (paramInt1 == 2) {
        ...
        if (paramGWindow == GWindowFileBox.this.wOk) {
          if (GWindowFileBox.this.wEdit != null) GWindowFileBox.this.doResult(GWindowFileBox.this.wEdit.getValue()); else
