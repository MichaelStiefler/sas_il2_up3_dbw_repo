...
public class CockpitTA_152C3 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    private final CockpitTA_152C3 this$0;
    ...
    Variables(CockpitTA_152C3.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      ...
      {
        CockpitTA_152C3.access$002(CockpitTA_152C3.this, CockpitTA_152C3.this.setOld);
        CockpitTA_152C3.access$102(CockpitTA_152C3.this, CockpitTA_152C3.this.setNew);
        CockpitTA_152C3.access$202(CockpitTA_152C3.this, CockpitTA_152C3.this.setTmp);
        ...
        if (CockpitTA_152C3.this.cockpitDimControl)
        {
          ...
          CockpitTA_152C3.this.setNew.dimPosition = (CockpitTA_152C3.this.setOld.dimPosition + 0.05F);
        CockpitTA_152C3.this.setNew.throttle = ((10.0F * CockpitTA_152C3.this.setOld.throttle + CockpitTA_152C3.this.fm.CT.PowerControl) / 11.0F);
        CockpitTA_152C3.this.setNew.vspeed = ((499.0F * CockpitTA_152C3.this.setOld.vspeed + CockpitTA_152C3.this.fm.getVertSpeed()) / 500.0F);
        CockpitTA_152C3.this.setNew.azimuth = CockpitTA_152C3.this.fm.Or.getYaw();
        if ((CockpitTA_152C3.this.setOld.azimuth > 270.0F) && (CockpitTA_152C3.this.setNew.azimuth < 90.0F))
          CockpitTA_152C3.this.setOld.azimuth -= 360.0F;
        if ((CockpitTA_152C3.this.setOld.azimuth < 90.0F) && (CockpitTA_152C3.this.setNew.azimuth > 270.0F))
          CockpitTA_152C3.this.setOld.azimuth += 360.0F;
        CockpitTA_152C3.this.setNew.waypointAzimuth = ((10.0F * CockpitTA_152C3.this.setOld.waypointAzimuth + (CockpitTA_152C3.this.waypointAzimuth() - CockpitTA_152C3.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      }
      return true;
    }
