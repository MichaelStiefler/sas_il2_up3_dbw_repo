    ...
    implements com.maddox.il2.objects.air.TypeTransport, com.maddox.il2.objects.air.TypeBomber
{
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        {
            if(Pd.x > 4.5500001907348633D && Pd.x < 7.1500000953674316D && Pd.z > 0.57999998331069946D)
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.233F)
                    if(Pd.z > 1.2100000381469727D)
                    {
            ...
            if(Pd.x > 9.5299997329711914D && Pd.z < 0.14000000059604645D && Pd.z > -0.62999999523162842D)
                FM.AS.hitPilot(shot.initiator, 2, (int)(shot.power * 0.002F));
            if(Pd.x > 2.4749999046325684D && Pd.x < 4.4899997711181641D && Pd.z > 0.61000001430511475D && (double)shot.power * java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z) > 11900D && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.45F)
            {
                for(int i = 0; i < 4; i++)
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.PE_8.weaponTriggersRegister(class1, new int[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "40fab100", new java.lang.String[] {
            "MGunShKASt 1500", "MGunShKASt 1500", "MGunShVAKt 750", "MGunShVAKt 750", "MGunUBt 1200", "MGunUBt 1200", null, null, null, null, 
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "12fab250", new java.lang.String[] {
            "MGunShKASt 1500", "MGunShKASt 1500", "MGunShVAKt 750", "MGunShVAKt 750", "MGunUBt 1200", "MGunUBt 1200", null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "6fab500", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "4fab1000", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "1fab2000", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "1fab20002fab1000", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "1fab5000", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.PE_8.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
