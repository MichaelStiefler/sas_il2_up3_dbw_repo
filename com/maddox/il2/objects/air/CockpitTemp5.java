...
public class CockpitTemp5 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    this.mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, 90.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitTemp5.this.fm != null) {
        CockpitTemp5.access$102(CockpitTemp5.this, CockpitTemp5.this.setOld);
        CockpitTemp5.access$202(CockpitTemp5.this, CockpitTemp5.this.setNew);
        CockpitTemp5.access$302(CockpitTemp5.this, CockpitTemp5.this.setTmp);
        ...
        CockpitTemp5.this.setNew.azimuth = (0.97F * CockpitTemp5.this.setOld.azimuth + 0.03F * -CockpitTemp5.this.fm.Or.getYaw());

        if ((CockpitTemp5.this.setOld.azimuth > 270.0F) && (CockpitTemp5.this.setNew.azimuth < 90.0F))
          CockpitTemp5.this.setOld.azimuth -= 360.0F;
        if ((CockpitTemp5.this.setOld.azimuth < 90.0F) && (CockpitTemp5.this.setNew.azimuth > 270.0F))
          CockpitTemp5.this.setOld.azimuth += 360.0F;
