...
public class CockpitYAK_15 extends com.maddox.il2.objects.air.CockpitPilot
{
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(java.lang.Math.abs(fm.Or.getKren()) < 30F)
                    setNew.azimuth.setDeg(setOld.azimuth.getDeg(0.1F), fm.Or.azimut());
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.M.fuel, 72F, 360F, 0.0F, 0.0312F);
        mesh.chunkSetLocate("zFuelL", xyz, ypr);
        xyz[1] = cvt(fm.M.fuel, 72F, 360F, 0.0F, 0.0312F);
        mesh.chunkSetLocate("zFuelR", xyz, ypr);
        xyz[1] = cvt(fm.M.fuel, 0.0F, 72F, 0.0F, 0.0312F);
        mesh.chunkSetLocate("zFuelC", xyz, ypr);
        ...
        mesh.chunkSetAngles("zAzimuth1b", 0.0F, -setNew.azimuth.getDeg(f * 0.1F) - 90F, 0.0F);
