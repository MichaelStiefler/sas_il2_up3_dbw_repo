    ...
    implements TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = B_17F.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= B_17F.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / B_17F.toMeters(fSightCurAltitude)));
            calibDistance = B_17F.toMetersPerSecond(fSightCurSpeed) * floatindex(Aircraft.cvt(B_17F.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)B_17F.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(B_17F.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = B_17F.class;
        ...
        B_17F.weaponTriggersRegister(class1, new int[] {
            10, 11, 12, 13, 13, 14, 14, 15, 16, 17, 
            17, 3, 3
        });
        B_17F.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_MGUN10", "_MGUN11", 
            "_MGUN12", "_BombSpawn01", "_BombSpawn02"
        });
        B_17F.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        B_17F.weaponsRegister(class1, "16x500", new java.lang.String[] {
            "MGunBrowning50t 610", "MGunBrowning50t 610", "MGunBrowning50t 610", "MGunBrowning50t 375", "MGunBrowning50t 375", "MGunBrowning50t 500", "MGunBrowning50t 500", "MGunBrowning50t 600", "MGunBrowning50t 600", "MGunBrowning50t 500", 
            "MGunBrowning50t 500", "BombGun500lbs 8", "BombGun500lbs 8"
        });
        B_17F.weaponsRegister(class1, "8x1000", new java.lang.String[] {
            "MGunBrowning50t 610", "MGunBrowning50t 610", "MGunBrowning50t 610", "MGunBrowning50t 375", "MGunBrowning50t 375", "MGunBrowning50t 500", "MGunBrowning50t 500", "MGunBrowning50t 600", "MGunBrowning50t 600", "MGunBrowning50t 500", 
            "MGunBrowning50t 500", "BombGun1000lbs 4", "BombGun1000lbs 4"
        });
        B_17F.weaponsRegister(class1, "none", new java.lang.String[] {
