...
public class CockpitMosquito4 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float wiper;
    private final CockpitMosquito4 this$0;
    ...
    Variables(CockpitMosquito4.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMosquito4.this.fm != null) {
        CockpitMosquito4.access$102(CockpitMosquito4.this, CockpitMosquito4.this.setOld);
        CockpitMosquito4.access$202(CockpitMosquito4.this, CockpitMosquito4.this.setNew);
        CockpitMosquito4.access$302(CockpitMosquito4.this, CockpitMosquito4.this.setTmp);
        ...
        CockpitMosquito4.this.setNew.waypointAzimuth.setDeg(CockpitMosquito4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitMosquito4.this.setOld.azimuth.getDeg(1.0F));
        ...
        case 0:
          if ((Mission.curCloudsType() <= 4) || (CockpitMosquito4.this.fm.getSpeedKMH() >= 220.0F) || (CockpitMosquito4.this.fm.getAltitude() >= Mission.curCloudsHeight() + 300.0F))
          {
            break;
          }
          CockpitMosquito4.access$402(CockpitMosquito4.this, 1); break;
        case 1:
          CockpitMosquito4.this.setNew.wiper = (CockpitMosquito4.this.setOld.wiper - 0.05F);
          if (CockpitMosquito4.this.setNew.wiper < -1.03F)
            CockpitMosquito4.access$408(CockpitMosquito4.this);
          if (CockpitMosquito4.this.wiState >= 2) break;
          if (CockpitMosquito4.this.wiState == 0) {
            if (CockpitMosquito4.this.fxw == null) {
              CockpitMosquito4.access$602(CockpitMosquito4.this, CockpitMosquito4.this.aircraft().newSound("aircraft.wiper", false));
          ...
          if (CockpitMosquito4.this.fxw == null) break;
          CockpitMosquito4.this.fxw.play(CockpitMosquito4.this.wiRun);
          CockpitMosquito4.access$502(CockpitMosquito4.this, 2); break;
        case 2:
          CockpitMosquito4.this.setNew.wiper = (CockpitMosquito4.this.setOld.wiper + 0.05F);
          if (CockpitMosquito4.this.setNew.wiper > 1.03F)
            CockpitMosquito4.access$408(CockpitMosquito4.this);
          if (CockpitMosquito4.this.wiState <= 1) break;
          CockpitMosquito4.access$502(CockpitMosquito4.this, 1); break;
        case 3:
          CockpitMosquito4.this.setNew.wiper = (CockpitMosquito4.this.setOld.wiper - 0.05F);
          if (CockpitMosquito4.this.setNew.wiper >= 0.02F) break;
          if ((CockpitMosquito4.this.fm.getSpeedKMH() > 250.0F) || (CockpitMosquito4.this.fm.getAltitude() > Mission.curCloudsHeight() + 400.0F))
          {
            CockpitMosquito4.access$408(CockpitMosquito4.this);
          }
          else CockpitMosquito4.access$402(CockpitMosquito4.this, 1); break;
        case 4:
          CockpitMosquito4.this.setNew.wiper = CockpitMosquito4.this.setOld.wiper;
          CockpitMosquito4.access$402(CockpitMosquito4.this, 0);
          CockpitMosquito4.access$502(CockpitMosquito4.this, 0);
          if (CockpitMosquito4.this.fxw == null) break;
