...
public class ZutiSupportMethods_NetSend_ToClients
{
	...
	public static void refuelAircraft_ToClient(float fuel, String user)
	{
		try
		{
			if( user == null || Mission.isSingle() )
			{
				...
				fuel = ZutiSupportMethods_ResourcesManagement.getAvailableFuelAtLocation(fuel, pos.x, pos.y);
	...
	{		
		try
		{
			if( user == null || Mission.isSingle() )
			{
				...
				Aircraft userAircraft = World.getPlayerAircraft();
				Point3d pos = userAircraft.pos.getAbsPoint();
				bullets = ZutiSupportMethods_ResourcesManagement.getAvailableBulletsAtLocation(bullets, pos.x, pos.y);
	...
	{		
		try
		{
			if( user == null || Mission.isSingle() )
			{
				...
				Aircraft userAircraft = World.getPlayerAircraft();
				Point3d pos = userAircraft.pos.getAbsPoint();
				bombs = ZutiSupportMethods_ResourcesManagement.getAvailableBombsAtLocation(bombs, pos.x, pos.y);
	...
	{		
		try
		{
			if( user == null || Mission.isSingle() )
			{
				...
				Aircraft userAircraft = World.getPlayerAircraft();
				Point3d pos = userAircraft.pos.getAbsPoint();
				rockets = ZutiSupportMethods_ResourcesManagement.getAvailableRocketsAtLocation(rockets, pos.x, pos.y);
	...
	{		
		try
		{
			if( user == null || Mission.isSingle() )
			{
				...
				Aircraft userAircraft = World.getPlayerAircraft();
				Point3d pos = userAircraft.pos.getAbsPoint();
				engines = (int)ZutiSupportMethods_ResourcesManagement.getAvailableEnginesAtLocation(engines, pos.x, pos.y);
	...
	{		
		try
		{
			if( user == null || Mission.isSingle() )
			{
				...
				Aircraft userAircraft = World.getPlayerAircraft();
				Point3d pos = userAircraft.pos.getAbsPoint();
				requestedKits = ZutiSupportMethods_ResourcesManagement.getAvailableRepairKitsAtLocation(requestedKits, pos.x, pos.y);
				if( requestedKits <= 0 )
	 ...
	 * @param user
	 */
	public static void getAvailablePayloadResourcesAndSendThemToUser(long bullets, int[] bombs, long rockets, float fuel, long cargo, String user)
	{
		try
		{
			...
			if( user == null || Mission.isSingle() )
			{
				...
				long availableBullets = ZutiSupportMethods_ResourcesManagement.getAvailableBulletsAtLocation(bullets, pos.x, pos.y);
				int[] availableBombs = ZutiSupportMethods_ResourcesManagement.getAvailableBombsAtLocation(tmpBombs, pos.x, pos.y);
				long availableRockets = ZutiSupportMethods_ResourcesManagement.getAvailableRocketsAtLocation(rockets, pos.x, pos.y);
				long availableFuel = ZutiSupportMethods_ResourcesManagement.getAvailableFuelAtLocation(fuel, pos.x, pos.y);
				long availableCargo = ZutiSupportMethods_ResourcesManagement.getAvailableCargoAtLocation(cargo, pos.x, pos.y);
	 ...
	 * @param sender
	 */
	public static void updateNetPlace_ToClients_DISABLED(NetUser sender)
	{
		/*
		try
		{
