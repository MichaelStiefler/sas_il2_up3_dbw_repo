...
public class CockpitPZL37_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((PZL37B)aircraft()).fSightCurForwardAngle;
                float f1 = -((PZL37B)aircraft()).fSightCurSideslip;
    ...
    {
        super.mesh.chunkSetAngles("zMark1", ((PZL37B)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((PZL37B)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
        super.mesh.chunkSetAngles("zMark2", f1 * 3.675F, 0.0F, 0.0F);
        resetYPRmodifier();
        Cockpit.xyz[0] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getKren() * java.lang.Math.abs(((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getKren()), -1225F, 1225F, -0.23F, 0.23F);
        Cockpit.xyz[1] = cvt((((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getTangage() - 1.0F) * java.lang.Math.abs(((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getTangage() - 1.0F), -1225F, 1225F, 0.23F, -0.23F);
        Cockpit.ypr[0] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getKren(), -45F, 45F, -180F, 180F);
        super.mesh.chunkSetLocate("zBulb", Cockpit.xyz, Cockpit.ypr);
        resetYPRmodifier();
        Cockpit.xyz[0] = cvt(Cockpit.xyz[0], -0.23F, 0.23F, 0.0095F, -0.0095F);
        Cockpit.xyz[1] = cvt(Cockpit.xyz[1], -0.23F, 0.23F, 0.0095F, -0.0095F);
        super.mesh.chunkSetLocate("zRefraction", Cockpit.xyz, Cockpit.ypr);
    }
