...
public class Formation
{
    ...
    {
        com.maddox.il2.ai.Formation.gather(flightmodel, byte0, vector3d, com.maddox.il2.game.Mission.curYear());
    }

    public static final void gather(com.maddox.il2.fm.FlightModel flightmodel, byte byte0, com.maddox.JGP.Vector3d vector3d, int i)
    {
        ...
        int j = ((com.maddox.il2.ai.air.Maneuver)flightmodel).Group.numInGroup(aircraft);
        ...
        case 0: // '\0'
            if((aircraft instanceof com.maddox.il2.objects.air.BF_109) || (aircraft instanceof com.maddox.il2.objects.air.BF_110) || (aircraft instanceof com.maddox.il2.objects.air.FW_190) || (aircraft instanceof com.maddox.il2.objects.air.SPITFIRE) && i > 1941 || (aircraft instanceof com.maddox.il2.objects.air.Hurricane) && i > 1941 || (aircraft instanceof com.maddox.il2.objects.air.P_38) || (aircraft instanceof com.maddox.il2.objects.air.P_47) || (aircraft instanceof com.maddox.il2.objects.air.P_51) || (aircraft instanceof com.maddox.il2.objects.air.TEMPEST))
            {
    ...
    public static final void leaderOffset(com.maddox.il2.fm.FlightModel flightmodel, byte byte0, com.maddox.JGP.Vector3d vector3d)
    {
        ...
        if(wing != null)
            ...
            i = 0;
        if((aircraft instanceof com.maddox.il2.objects.air.B_17) || (aircraft instanceof com.maddox.il2.objects.air.B_24) || (aircraft instanceof com.maddox.il2.objects.air.B_29))
            switch(i)
            {
            case 0: // '\0'
