...
public class MIG_3UB extends com.maddox.il2.objects.air.MIG_3
{
    ...
    public void update(float f)
    {
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL_D0", 0.0F, com.maddox.il2.objects.air.MIG_3UB.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.9F), 0.0F);
            hierMesh().chunkSetAngles("SlatR_D0", 0.0F, com.maddox.il2.objects.air.MIG_3UB.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.9F), 0.0F);
        }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MIG_3UB.weaponTriggersRegister(class1, new int[] {
            0, 0, 9, 9, 2, 2, 2, 2, 2, 2
        });
        com.maddox.il2.objects.air.MIG_3UB.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.MIG_3UB.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunUBs 350", "MGunUBs 350", null, null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.MIG_3UB.weaponsRegister(class1, "6xRS-82", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.MIG_3UB.weaponsRegister(class1, "none", new java.lang.String[] {
