...
public class CockpitBF_109G6 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitBF_109G6.this.setNew.throttle = ((10.0F * CockpitBF_109G6.this.setOld.throttle + CockpitBF_109G6.this.fm.CT.PowerControl) / 11.0F);
      CockpitBF_109G6.this.setNew.mix = ((8.0F * CockpitBF_109G6.this.setOld.mix + CockpitBF_109G6.this.fm.EI.engines[0].getControlMix()) / 9.0F);

      float f = CockpitBF_109G6.this.waypointAzimuth();
      if (CockpitBF_109G6.this.useRealisticNavigationInstruments())
      {
        CockpitBF_109G6.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
        CockpitBF_109G6.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
      }
      else
      {
      ...
      CockpitBF_109G6.this.setNew.turn = ((12.0F * CockpitBF_109G6.this.setOld.turn + CockpitBF_109G6.this.w.z) / 13.0F);

      CockpitBF_109G6.this.buzzerFX((CockpitBF_109G6.this.fm.CT.getGear() < 0.999999F) && (CockpitBF_109G6.this.fm.CT.getFlap() > 0.0F));

      CockpitBF_109G6.this.setNew.beaconDirection = ((10.0F * CockpitBF_109G6.this.setOld.beaconDirection + CockpitBF_109G6.this.getBeaconDirection()) / 11.0F);
      CockpitBF_109G6.this.setNew.beaconRange = ((10.0F * CockpitBF_109G6.this.setOld.beaconRange + CockpitBF_109G6.this.getBeaconRange()) / 11.0F);
