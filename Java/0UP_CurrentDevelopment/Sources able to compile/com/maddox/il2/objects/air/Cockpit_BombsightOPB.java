...
public class Cockpit_BombsightOPB extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = BombsightOPB.fSightCurForwardAngle;
                float f1 = BombsightOPB.fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", BombsightOPB.fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(BombsightOPB.fSightSetForwardAngle, -15F, 75F, -15F, 75F);
        mesh.chunkSetAngles("zMark2", f1 * 3.675F, 0.0F, 0.0F);
        resetYPRmodifier();
        Cockpit.xyz[0] = cvt(-fm.Or.getKren(), -13F, 13F, -0.23F, 0.23F);
        Cockpit.xyz[1] = cvt(-fm.Or.getTangage(), -13F, 13F, 0.23F, -0.23F);
