// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 21/07/2011 10:40:38 PM
...
//            CockpitPilot, Cockpit, AircraftLH, F_80C, 
//            P_80
...
public class CockpitF_80C extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f4 = ((P_80) ((F_80C)aircraft())).k14Distance;
                setNew.k14w = (5F * CockpitF_80C.k14TargetWingspanScale[((P_80) ((F_80C)aircraft())).k14WingspanType]) / f4;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitF_80C.k14TargetMarkScale[((P_80) ((F_80C)aircraft())).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((P_80) ((F_80C)aircraft())).k14Mode;
                ...
                float f3 = floatindex((f4 - 200F) * 0.04F, CockpitF_80C.k14BulletDrop) - CockpitF_80C.k14BulletDrop[0];
    ...
    public CockpitF_80C()
    {
        super("3DO/Cockpit/YP-80N/hierC.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            int i = ((P_80) ((F_80C)aircraft())).k14Mode;
            boolean flag = i < 2;
