...
public class CockpitG4M2E_LGunner extends com.maddox.il2.objects.air.CockpitGunner
{
    ...
    public void moveGun(com.maddox.il2.engine.Orient orient)
    {
        ...
        super.mesh.chunkSetAngles("Turret5A", 0.0F, f, 0.0F);
        super.mesh.chunkSetAngles("Turret5B", 0.0F, f1, 0.0F);
    }
    ...
    {
        super.mesh.chunkSetAngles("Turret4A", 0.0F, -((com.maddox.il2.objects.sounds.SndAircraft) (aircraft())).FM.turret[3].tu[0], 0.0F);
        super.mesh.chunkSetAngles("Turret4B", 0.0F, ((com.maddox.il2.objects.sounds.SndAircraft) (aircraft())).FM.turret[3].tu[1], 0.0F);
        if(!isRealMode())
            return;
        ...
        super.mesh.chunkSetLocate("Turret5C", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
    }
