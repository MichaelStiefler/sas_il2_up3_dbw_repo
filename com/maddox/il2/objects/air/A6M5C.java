...
public class A6M5C extends A6M
{
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    if (paramString.startsWith("xx")) {
      ...
      if (paramString.startsWith("xxarmorg2")) {
        getEnergyPastArmor(World.Rnd().nextFloat(49.0F, 51.0F), paramShot);
        this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.setCockpitState(paramShot.initiator, this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.astateCockpitState | 0x2);
        Aircraft.debugprintln(this, "*** Armor Glass: Hit..");
        if (paramShot.power <= 0.0F) {
          Aircraft.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
  ...
  static
  {
    Class localClass = A6M5C.class;
    new NetAircraft.SPAWN(localClass);

    Property.set(localClass, "iconFar_shortClassName", "A6M");
    Property.set(localClass, "meshName", "3DO/Plane/A6M5c(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar03());
    Property.set(localClass, "meshName_ja", "3DO/Plane/A6M5c(ja)/hier.him");
    Property.set(localClass, "PaintScheme_ja", new PaintSchemeFCSPar02());

    Property.set(localClass, "yearService", 1943.5F);
    Property.set(localClass, "yearExpired", 1945.5F);

    Property.set(localClass, "FlightModel", "FlightModels/A6M5c.fmd");
    Property.set(localClass, "cockpitClass", CockpitA6M5c.class);
    ...
    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "2x150dt", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, "FuelTankGun_Tank0Underwing", "FuelTankGun_Tank0Underwing", null, null, null, null });

    Aircraft.weaponsRegister(localClass, "1xwdt4s", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", "FuelTankGun_Tank0Centre", null, null, null, null, null, null, null, null });

    Aircraft.weaponsRegister(localClass, "4xtype3", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27" });

    Aircraft.weaponsRegister(localClass, "1x250", new String[] { "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, "PylonA6MPLN1", "BombGun250kg", null, null, null, null, null, null });
