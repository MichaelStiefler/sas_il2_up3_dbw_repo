    ...
    case 1:
      if ((this instanceof SB_2M100A)) {
        ...
        if (f3 < 6.0F) {
          ...
          if (f2 < -1.291667F * f3 + 3.25F) {
            f2 = -1.291667F * f3 + 3.25F;
            bool = false;
          }
        } else if (f3 < 42.0F) {
          if (f2 < -1.666667F * f2 + 10.0F) {
            f2 = -1.666667F * f2 + 10.0F;
            bool = false;
          }
        } else if (f3 < 100.0F) {
          if (f2 < -60.0F) {
          ...
          if (f2 < 1.518519F * f3 - 233.05556F) {
            f2 = 1.518519F * f3 - 233.05556F;
            bool = false;
          }
        } else if (f2 < 1.5F * f3 - 230.0F) {
          f2 = 1.5F * f3 - 230.0F;
          bool = false;
        }
      }
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx")) {
      ...
      if (paramString.startsWith("xxcontrols")) {
        ...
        switch (i) {
        case 1:
          if ((World.Rnd().nextFloat() >= 0.05F) && ((paramShot.mass <= 0.092F) || (World.Rnd().nextFloat() >= 0.1F))) {
            break;
          }
      ...
      if (paramString.startsWith("xxspar")) {
        if ((paramString.startsWith("xxspart")) && (World.Rnd().nextFloat() < 0.36F) && (chunkDamageVisible("Tail1") > 2) && (getEnergyPastArmor(6.8F, paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** Tail1 Spars Broken in Half..");

          msgCollision(this, "Tail1_D0", "Tail1_D0");
        }
        if ((paramString.startsWith("xxsparli")) && (chunkDamageVisible("WingLIn") > 2) && (getEnergyPastArmor(14.8F * World.Rnd().nextFloat(1.0F, 3.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** WingLIn Spars Damaged..");
          nextDMGLevels(1, 2, "WingLIn_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparri")) && (chunkDamageVisible("WingRIn") > 2) && (getEnergyPastArmor(14.8F * World.Rnd().nextFloat(1.0F, 3.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** WingRIn Spars Damaged..");
          nextDMGLevels(1, 2, "WingRIn_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparlm")) && (chunkDamageVisible("WingLMid") > 2) && (getEnergyPastArmor(12.8F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");

          nextDMGLevels(1, 2, "WingLMid_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparrm")) && (chunkDamageVisible("WingRMid") > 2) && (getEnergyPastArmor(12.8F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");

          nextDMGLevels(1, 2, "WingRMid_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparlo")) && (World.Rnd().nextFloat() < 1.0D - 0.7900000214576721D * Math.abs(Aircraft.v1.x)) && (chunkDamageVisible("WingLOut") > 2) && (getEnergyPastArmor(9.1F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");

          nextDMGLevels(1, 2, "WingLOut_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparro")) && (World.Rnd().nextFloat() < 1.0D - 0.7900000214576721D * Math.abs(Aircraft.v1.x)) && (chunkDamageVisible("WingROut") > 2) && (getEnergyPastArmor(9.1F * World.Rnd().nextFloat(1.0F, 2.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** WingROut Spars Damaged..");

          nextDMGLevels(1, 2, "WingROut_D3", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparsl")) && (chunkDamageVisible("StabL") > 1) && (getEnergyPastArmor(5.2F * World.Rnd().nextFloat(1.0F, 3.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** StabL Spars Damaged..");
          nextDMGLevels(1, 2, "StabL_D2", paramShot.initiator);
        }
        if ((paramString.startsWith("xxsparsr")) && (chunkDamageVisible("StabR") > 1) && (getEnergyPastArmor(5.2F * World.Rnd().nextFloat(1.0F, 3.0F), paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** StabR Spars Damaged..");
          nextDMGLevels(1, 2, "StabR_D2", paramShot.initiator);
        }
        if ((paramString.startsWith("xxspare1")) && (getEnergyPastArmor(28.0F, paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** Engine1 Suspension Broken in Half..");

          nextDMGLevels(3, 2, "Engine1_D0", paramShot.initiator);
        }
        if ((paramString.startsWith("xxspare2")) && (getEnergyPastArmor(28.0F, paramShot) > 0.0F))
        {
      ...
      if ((paramString.startsWith("xxbmb")) && (World.Rnd().nextFloat() < 0.01F) && (this.FM.CT.Weapons[3] != null) && (this.FM.CT.Weapons[3][0].haveBullets()))
      {
      ...
      if (paramString.startsWith("xxeng")) {
        ...
        if ((paramString.endsWith("prop")) && (getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 0.4F), paramShot) > 0.0F))
        {
        ...
        if ((paramString.endsWith("gear")) && (getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 1.1F), paramShot) > 0.0F))
        {
        ...
        if (paramString.endsWith("case")) {
          if (getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 6.8F), paramShot) > 0.0F)
          {
            ...
            if (World.Rnd().nextFloat() < paramShot.power / 28000.0F) {
              ...
              Aircraft.debugprintln(this, "*** Engine" + (i + 1) + " Crank Case Hit - Cylinder Feed Out, " + this.FM.EI.engines[i].getCylindersOperable() + "/" + this.FM.EI.engines[i].getCylinders() + " Left..");
            }
            ...
            Aircraft.debugprintln(this, "*** Engine" + (i + 1) + " Crank Case Hit - Readyness Reduced to " + this.FM.EI.engines[i].getReadyness() + "..");
          }
        ...
        if (((paramString.endsWith("cyl1")) || (paramString.endsWith("cyl2"))) && (getEnergyPastArmor(World.Rnd().nextFloat(0.5F, 2.542F), paramShot) > 0.0F) && (World.Rnd().nextFloat() < this.FM.EI.engines[i].getCylindersRatio() * 1.72F))
        {
          this.FM.EI.engines[i].setCyliderKnockOut(paramShot.initiator, World.Rnd().nextInt(1, (int)(paramShot.power / 4800.0F)));

          Aircraft.debugprintln(this, "*** Engine" + (i + 1) + " Cylinders Hit, " + this.FM.EI.engines[i].getCylindersOperable() + "/" + this.FM.EI.engines[i].getCylinders() + " Left..");
        ...
        if ((paramString.endsWith("eqpt")) && (getEnergyPastArmor(World.Rnd().nextFloat(0.001F, 0.2F), paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.89F))
        {
      ...
      if (paramString.startsWith("xxtank")) {
        ...
        if (getEnergyPastArmor(0.03F, paramShot) > 0.0F) {
          ...
          if (paramShot.powerType == 3) {
            ...
            } else this.FM.AS.hitTank(paramShot.initiator, i, World.Rnd().nextInt(0, (int)(paramShot.power / 28200.0F)));
          }
      ...
      if (((this.FM.AS.astateTankStates[0] > 1) || (this.FM.AS.astateTankStates[1] > 1)) && (paramShot.powerType == 3) && (getEnergyPastArmor(0.45F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.33F) && (World.Rnd().nextFloat() < this.curTakeem))
      {
        this.FM.AS.hitTank(paramShot.initiator, World.Rnd().nextInt(0, 1), 3);
      }if (chunkDamageVisible("WingLIn") < 3)
        hitChunk("WingLIn", paramShot);
    } else if (paramString.startsWith("xwingrin")) {
      if (((this.FM.AS.astateTankStates[2] > 1) || (this.FM.AS.astateTankStates[3] > 1)) && (paramShot.powerType == 3) && (getEnergyPastArmor(0.45F, paramShot) > 0.0F) && (World.Rnd().nextFloat() < 0.33F) && (World.Rnd().nextFloat() < this.curTakeem))
      {
    ...
    if (Time.current() > this.tme) {
      ...
      if (this.FM.turret.length != 0) {
        ...
        if (this.FM.turret[1].bIsOperable) {
          localActor = this.FM.turret[1].target;
          if ((localActor != null) && (Actor.isValid(localActor))) {
            this.pos.getAbs(Aircraft.tmpLoc2);
            localActor.pos.getAbs(Aircraft.tmpLoc3);
