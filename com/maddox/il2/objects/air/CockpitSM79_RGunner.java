...
// Source File Name:   CockpitSM79_RGunner.java
...
public class CockpitSM79_RGunner extends com.maddox.il2.objects.air.CockpitGunner
{
    ...
    protected void doFocusLeave()
    {
        if(isFocused())
        {
            ...
            if(aircraft().thisWeaponsName.startsWith("6"))
            {
                for(int j = 1; j <= 6; j++)
                {
                    mesh.chunkVisible("BombRack" + j, false);
                    aircraft().hierMesh().chunkVisible("BombRack" + j + "_D0", true);
                }
            ...
            if(aircraft().thisWeaponsName.startsWith("5"))
            {
                for(int k = 1; k <= 5; k++)
                {
                    mesh.chunkVisible("BombRack250_" + k, false);
                    aircraft().hierMesh().chunkVisible("BombRack250_" + k + "_D0", true);
                }
    ...
    protected void interpTick()
    {
        ...
        {
            if(hook1 == null)
                hook1 = new HookNamed(aircraft(), "_12,7_00");
            doHitMasterAircraft(aircraft(), hook1, "_12,7_00");
            if(iCocking > 0)
                iCocking = 0;
            else
                iCocking = 1;
        ...
        if(emitter != null)
        {
            ...
            mesh.chunkVisible("ZTurret1B-Bullet0", flag);
            mesh.chunkVisible("ZTurret1B-Bullet1", !flag);
        }
    }
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitSM79_RGunner.class, "aiTuretNum", 3);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitSM79_RGunner.class, "weaponControlNum", 13);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitSM79_RGunner.class, "astatePilotIndx", 5);
    }
}
