...
// Source File Name:   BombsightNordenCockpitLogic.java
...
//            BombsightNorden, Cockpit, Aircraft
...
public class BombsightNordenCockpitLogic
{
    ...
    public BombsightNordenCockpitLogic(com.maddox.il2.objects.air.Cockpit cockpit)
    {
        m_Pit = cockpit;
        m_aAim = 0.0F;
        m_tAim = 0.0F;
    ...
    public void OnTick(boolean flag)
    {
        if(null == m_Pit)
            return;
        float f = com.maddox.il2.objects.air.BombsightNorden.fSightCurForwardAngle;
        float f1 = com.maddox.il2.objects.air.BombsightNorden.fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(boolean flag)
    {
        ...
        if(flag)
        {
            m_Pit.mesh.chunkSetAngles("zAngleMark", -m_Pit.floatindex(m_Pit.cvt(com.maddox.il2.objects.air.BombsightNorden.fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag1 = com.maddox.il2.objects.air.BombsightNorden.fSightCurReadyness > 0.93F;
    ...
    private com.maddox.il2.objects.air.Cockpit m_Pit;
