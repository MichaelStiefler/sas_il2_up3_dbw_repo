...
//            A6M, PaintSchemeFMPar03, PaintSchemeFCSPar02, NetAircraft
...
public class A6M5C extends com.maddox.il2.objects.air.A6M
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.equals("xxarmorg"))
            {
                ...
                com.maddox.il2.objects.air.A6M5C.debugprintln(this, "*** Armor Glass: Hit..");
                if(shot.power <= 0.0F)
                {
                    com.maddox.il2.objects.air.A6M5C.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "cockpitClass", com.maddox.il2.objects.air.CockpitA6M5c.class);
        com.maddox.rts.Property.set(class1, "LOSElevation", 1.01885F);
        com.maddox.il2.objects.air.A6M5C.weaponTriggersRegister(class1, new int[] {
            0, 0, 0, 1, 1, 9, 9, 3, 9, 9, 
            2, 2, 2, 2
        });
        com.maddox.il2.objects.air.A6M5C.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.A6M5C.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, 
            null, null, null, null
        });
        com.maddox.il2.objects.air.A6M5C.weaponsRegister(class1, "2x150dt", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, "FuelTankGun_Tank0Underwing", "FuelTankGun_Tank0Underwing", 
            null, null, null, null
        });
        com.maddox.il2.objects.air.A6M5C.weaponsRegister(class1, "1xwdt4s", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", "FuelTankGun_Tank0Centre", null, null, null, null, 
            null, null, null, null
        });
        com.maddox.il2.objects.air.A6M5C.weaponsRegister(class1, "4xtype3", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, null, null, null, null, 
            "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27", "RocketGunType3Mk27"
        });
        com.maddox.il2.objects.air.A6M5C.weaponsRegister(class1, "1x250", new java.lang.String[] {
            "MGunMG131s 230", "MGunMG131k 240", "MGunMG131k 240", "MGunMGFFk 125", "MGunMGFFk 125", null, "PylonA6MPLN1", "BombGun250kg", null, null, 
            null, null, null, null
        });
        com.maddox.il2.objects.air.A6M5C.weaponsRegister(class1, "none", new java.lang.String[] {
