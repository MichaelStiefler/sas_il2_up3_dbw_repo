...
public class CockpitB6N2 extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    float vspeed;
    float dimPosition;
    private final CockpitB6N2 this$0;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitB6N2.this.fm != null) {
        CockpitB6N2.access$102(CockpitB6N2.this, CockpitB6N2.this.setOld);
        CockpitB6N2.access$202(CockpitB6N2.this, CockpitB6N2.this.setNew);
        CockpitB6N2.access$302(CockpitB6N2.this, CockpitB6N2.this.setTmp);
        ...
        CockpitB6N2.this.setNew.waypointAzimuth.setDeg(CockpitB6N2.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitB6N2.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-3.0F, 3.0F));

        CockpitB6N2.this.setNew.vspeed = ((199.0F * CockpitB6N2.this.setOld.vspeed + CockpitB6N2.this.fm.getVertSpeed()) / 200.0F);
      }
