...
public class CockpitTU_2S_TGunner extends CockpitGunner
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitTU_2S_TGunner.access$002(CockpitTU_2S_TGunner.this, CockpitTU_2S_TGunner.this.setOld);
        CockpitTU_2S_TGunner.access$102(CockpitTU_2S_TGunner.this, CockpitTU_2S_TGunner.this.setNew);
        CockpitTU_2S_TGunner.access$202(CockpitTU_2S_TGunner.this, CockpitTU_2S_TGunner.this.setTmp);
        if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3] != null)
        {
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 0)
            CockpitTU_2S_TGunner.this.bBombs[1] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][0].haveBullets() ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 1)
            CockpitTU_2S_TGunner.this.bBombs[0] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][1].haveBullets() ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 2)
            CockpitTU_2S_TGunner.this.bBombs[3] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][2].haveBullets() ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 3)
            CockpitTU_2S_TGunner.this.bBombs[2] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][3].haveBullets() ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 4)
            CockpitTU_2S_TGunner.this.bBombs[5] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][4].haveBullets() ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 5)
            CockpitTU_2S_TGunner.this.bBombs[4] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][5].haveBullets() ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 6)
            CockpitTU_2S_TGunner.this.bBombs[5] = ((CockpitTU_2S_TGunner.this.bBombs[5] != 0) || (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][6].haveBullets()) ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 7)
            CockpitTU_2S_TGunner.this.bBombs[4] = ((CockpitTU_2S_TGunner.this.bBombs[4] != 0) || (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][7].haveBullets()) ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 8)
            CockpitTU_2S_TGunner.this.bBombs[7] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][8].haveBullets() ? 1 : 0);
          if (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3].length > 9)
            CockpitTU_2S_TGunner.this.bBombs[6] = (!CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.Weapons[3][9].haveBullets() ? 1 : 0);
        }
        CockpitTU_2S_TGunner.this.setNew.man1 = (0.92F * CockpitTU_2S_TGunner.this.setOld.man1 + 0.08F * CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitTU_2S_TGunner.this.setNew.man2 = (0.92F * CockpitTU_2S_TGunner.this.setOld.man2 + 0.08F * CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitTU_2S_TGunner.this.setNew.altimeter = CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitTU_2S_TGunner.this.setNew.azimuth.setDeg(CockpitTU_2S_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitTU_2S_TGunner.this.setNew.vspeed = ((100.0F * CockpitTU_2S_TGunner.this.setOld.vspeed + CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 101.0F);
        float f = CockpitTU_2S_TGunner.this.waypointAzimuth();
        CockpitTU_2S_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitTU_2S_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitTU_2S_TGunner.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitTU_2S_TGunner.this.setNew.waypointDirection.setDeg(CockpitTU_2S_TGunner.this.setOld.waypointDirection.getDeg(1.0F), f);
        CockpitTU_2S_TGunner.this.setNew.inert = (0.999F * CockpitTU_2S_TGunner.this.setOld.inert + 0.001F * (CockpitTU_2S_TGunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getStage() != 6 ? 0.0F : 0.867F));
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    float vspeed;
    float inert;
    private final CockpitTU_2S_TGunner this$0;
    ...
    Variables(CockpitTU_2S_TGunner.1 arg2)
    {
      this();
    }
  }
