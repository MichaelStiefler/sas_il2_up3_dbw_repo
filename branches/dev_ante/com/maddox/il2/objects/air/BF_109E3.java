...
public class BF_109E3 extends BF_109
{
  ...
  static
  {
    ...
    try
    {
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMGFFs", 60);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMGFFs", 60);
      ...
      arrayOf_WeaponSlot[0] = new Aircraft._WeaponSlot(0, "MGunMG17si", 1000);
      arrayOf_WeaponSlot[1] = new Aircraft._WeaponSlot(0, "MGunMG17si", 1000);
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(0, "MGunMGFFs", 60);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(0, "MGunMGFFs", 60);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(1, "MGunMGFFki", 60);
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
      str = "none";
      arrayOf_WeaponSlot = new Aircraft._WeaponSlot[i];
