...
public class Mig_15F extends Scheme1 implements TypeSupersonic, TypeFighter, TypeBNZFighter, TypeFighterAceMaker {
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat) {
    ...
    paramHierMesh.chunkSetAngles("GearC2_D0", 0.0F, -127.0F * paramFloat,
            0.0F);
    paramHierMesh.chunkSetAngles("GearC4_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 0.15F,
            0.0F, -90.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC5_D0", 0.0F, Aircraft.cvt(paramFloat, 0.0F, 0.15F,
            0.0F, -95.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL2_D0", -90.0F * paramFloat,
            -38.0F * paramFloat, 90.0F * paramFloat);
    paramHierMesh.chunkSetAngles("GearR2_D0", 90.0F * paramFloat,
            -38.0F * paramFloat, -90.0F * paramFloat);
    paramHierMesh.chunkSetAngles("GearL4_D0", 0.0F, -115.0F * paramFloat,
            0.0F);
    paramHierMesh.chunkSetAngles("GearR4_D0", 0.0F, -115.0F * paramFloat,
            0.0F);
  ...
  protected void hitBone(String paramString, Shot paramShot,
    ...
    if (paramString.startsWith("xx")) {
      ...
      if (paramString.startsWith("xcf")) {
        ...
        if (paramString.endsWith("2") && World.Rnd().nextFloat() < 0.1F
