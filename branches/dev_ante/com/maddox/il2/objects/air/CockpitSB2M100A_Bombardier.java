...
public class CockpitSB2M100A_Bombardier extends CockpitPilot
{
  ...
  public CockpitSB2M100A_Bombardier() {
    super("3DO/Cockpit/Pe-2-Bombardier/BombardierSB2M100A.him", "he111");
    try {
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((SB_2M100A)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((SB_2M100A)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSB2M100A_Bombardier.this.bEntered) {
        float f1 = ((SB_2M100A)CockpitSB2M100A_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((SB_2M100A)CockpitSB2M100A_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitSB2M100A_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitSB2M100A_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
