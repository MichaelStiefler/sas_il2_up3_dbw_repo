...
public class CockpitHE_162A2 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitHE_162A2.this.setNew.vspeed = ((299.0F * CockpitHE_162A2.this.setOld.vspeed + CockpitHE_162A2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 300.0F);
      CockpitHE_162A2.this.setNew.altimeter = CockpitHE_162A2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      ...
      CockpitHE_162A2.this.setNew.throttle = ((10.0F * CockpitHE_162A2.this.setOld.throttle + CockpitHE_162A2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
      CockpitHE_162A2.this.setNew.mix = ((8.0F * CockpitHE_162A2.this.setOld.mix + CockpitHE_162A2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlMix()) / 9.0F);
      CockpitHE_162A2.this.setNew.azimuth = CockpitHE_162A2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      ...
      CockpitHE_162A2.this.setNew.waypointAzimuth = ((10.0F * CockpitHE_162A2.this.setOld.waypointAzimuth + (CockpitHE_162A2.this.waypointAzimuth() - CockpitHE_162A2.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
