...
public class CockpitTemp5 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    resetYPRmodifier();
    xyz[2] = cvt(this.pictAiler, -1.0F, 1.0F, -0.027F, 0.027F);
    this.mesh.chunkSetLocate("Z_Shlang01", xyz, ypr);
    xyz[2] = (-xyz[2]);
    this.mesh.chunkSetLocate("Z_Shlang02", xyz, ypr);
    ...
    resetYPRmodifier();
    xyz[1] = cvt(this.fm.Or.getTangage(), -45.0F, 45.0F, 0.022F, -0.022F);
