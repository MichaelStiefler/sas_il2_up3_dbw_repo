...
public class CockpitLAGG_3SERIES4 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("VISH", 0.0F, interp(this.setNew.prop, this.setOld.prop, paramFloat) * 90.0F - 45.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLAGG_3SERIES4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitLAGG_3SERIES4.access$102(CockpitLAGG_3SERIES4.this, CockpitLAGG_3SERIES4.this.setOld); CockpitLAGG_3SERIES4.access$202(CockpitLAGG_3SERIES4.this, CockpitLAGG_3SERIES4.this.setNew); CockpitLAGG_3SERIES4.access$302(CockpitLAGG_3SERIES4.this, CockpitLAGG_3SERIES4.this.setTmp);

        CockpitLAGG_3SERIES4.this.setNew.throttle = ((10.0F * CockpitLAGG_3SERIES4.this.setOld.throttle + CockpitLAGG_3SERIES4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitLAGG_3SERIES4.this.setNew.prop = ((10.0F * CockpitLAGG_3SERIES4.this.setOld.prop + CockpitLAGG_3SERIES4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitLAGG_3SERIES4.this.setNew.altimeter = CockpitLAGG_3SERIES4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitLAGG_3SERIES4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitLAGG_3SERIES4.this.setNew.azimuth = ((35.0F * CockpitLAGG_3SERIES4.this.setOld.azimuth + -CockpitLAGG_3SERIES4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw()) / 36.0F);
        }
        if ((CockpitLAGG_3SERIES4.this.setOld.azimuth > 270.0F) && (CockpitLAGG_3SERIES4.this.setNew.azimuth < 90.0F)) CockpitLAGG_3SERIES4.this.setOld.azimuth -= 360.0F;
        if ((CockpitLAGG_3SERIES4.this.setOld.azimuth < 90.0F) && (CockpitLAGG_3SERIES4.this.setNew.azimuth > 270.0F)) CockpitLAGG_3SERIES4.this.setOld.azimuth += 360.0F;
        CockpitLAGG_3SERIES4.this.setNew.waypointAzimuth = ((10.0F * CockpitLAGG_3SERIES4.this.setOld.waypointAzimuth + (CockpitLAGG_3SERIES4.this.waypointAzimuth() - CockpitLAGG_3SERIES4.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F)) / 11.0F);

        CockpitLAGG_3SERIES4.this.setNew.vspeed = ((199.0F * CockpitLAGG_3SERIES4.this.setOld.vspeed + CockpitLAGG_3SERIES4.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    private final CockpitLAGG_3SERIES4 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitLAGG_3SERIES4.1 arg2) { this();
    }
  }
}