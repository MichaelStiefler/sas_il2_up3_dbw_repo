    ...
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(class1, "meshName", com.maddox.il2.objects.vehicles.stationary.FACGeneric.mesh_name);
            cls = class1;
                ...
                if(flag)
                {
                    if(!flag2)
                    {
                        if(!flag3)
                        {
                            ...
                            com.maddox.il2.engine.Eff3DActor.New(this, null, new Loc(0.0D, 0.0D, 0.0D, 0.0F, 90F, 0.0F), 1.0F, "Effects/Smokes/Redsmoke.eff", -1F);
                        } else
                        {
                            com.maddox.il2.game.HUD.logCenter("                                                                             Popping Flare!");
                            com.maddox.il2.engine.Eff3DActor.New(this, null, new Loc(0.0D, 0.0D, 0.0D, 0.0F, 90F, 0.0F), 1.0F, "3DO/Effects/Fireworks/FlareWhiteWide.eff", -1F);
                        }
                        flag2 = true;
                    } else
                    {
                        ...
                        if(!flag1)
                        {
                            ...
                            com.maddox.il2.engine.Eff3DActor.New(this, null, new Loc(l + spread, i1 + spread, d6, 0.0F, 90F, 0.0F), 1.0F, "Effects/Smokes/SmokeWhite.eff", 60F);
                            flag1 = true;
                        }
                    }
                } else
