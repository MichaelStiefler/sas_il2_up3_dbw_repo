...
// Source File Name:   BombTIRed.java
...
public class BombTIRed extends com.maddox.il2.objects.weapons.Bomb
{
        ...
        if((double)charge < 1.01D)
        {
            ...
            if(com.maddox.il2.engine.Actor.isValid(actor))
            {
                ...
                for(int i = 0; i < 60; i++)
                {
                    ...
                    com.maddox.il2.objects.weapons.BombTiRd bombtird = new BombTiRd();
                    bombtird.pos.setUpdateEnable(true);
                    bombtird.pos.setAbs(point3d, orient);
                    bombtird.pos.reset();
                    bombtird.start();
                    bombtird.setOwner(actor, false, false, false);
                    bombtird.setSpeed(vector3d);
                }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.weapons.BombTIRed.class;
