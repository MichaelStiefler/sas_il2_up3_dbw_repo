...
public class CockpitIL_10 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    private class Variables
    {
        ...
        com.maddox.il2.ai.AnglesFork compassRim;
        float vspeed;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, 0.0241F, -0.0241F);
        mesh.chunkSetLocate("zHorizon1b", xyz, ypr);
        ...
        if(useRealisticNavigationInstruments())
        {
            mesh.chunkSetAngles("zAzimuth1b", 0.0F, setNew.azimuth.getDeg(f) - setNew.compassRim.getDeg(f), 0.0F);
            mesh.chunkSetAngles("zAzimuth1a", 0.0F, -setNew.compassRim.getDeg(f), 0.0F);
        } else
        {
        ...
        mesh.chunkSetAngles("Z_Course", 0.0F, cvt(setNew.waypointAzimuth.getDeg(f * 0.2F), -90F, 90F, -20.5F, 20.5F), 0.0F);
