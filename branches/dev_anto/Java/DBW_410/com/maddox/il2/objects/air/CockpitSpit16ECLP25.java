...
// Source File Name:   CockpitSpit16ECLP25.java
...
//            CockpitPilot, SPITFIRE16E25, Cockpit, Aircraft

public class CockpitSpit16ECLP25 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(fm != null)
            {
                ...
                float f = ((com.maddox.il2.objects.air.SPITFIRE16ECLP25)aircraft()).k14Distance;
                setNew.k14w = (5F * com.maddox.il2.objects.air.CockpitSpit16ECLP25.k14TargetWingspanScale[((com.maddox.il2.objects.air.SPITFIRE16ECLP25)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * com.maddox.il2.objects.air.CockpitSpit16ECLP25.k14TargetMarkScale[((com.maddox.il2.objects.air.SPITFIRE16ECLP25)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((com.maddox.il2.objects.air.SPITFIRE16ECLP25)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, com.maddox.il2.objects.air.CockpitSpit16ECLP25.k14BulletDrop) - com.maddox.il2.objects.air.CockpitSpit16ECLP25.k14BulletDrop[0];
    ...
    {
        int i = ((com.maddox.il2.objects.air.SPITFIRE16ECLP25)aircraft()).k14Mode;
        boolean flag = i < 2;
