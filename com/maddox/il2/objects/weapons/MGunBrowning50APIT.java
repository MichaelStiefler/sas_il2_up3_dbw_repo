...
public class MGunBrowning50APIT extends MGunUBs
{
  public GunProperties createProperties()
  {
    ...
    localGunProperties.bullet[0].kalibr = 0.000110506F;
    ...
    localGunProperties.bullet[1].kalibr = 0.000110506F;
    localGunProperties.bullet[1].speed = 870.0F;
    localGunProperties.bullet[1].power = 0.000115F;
    ...
    localGunProperties.bullet[1].timeLife = 6.5F;
    localGunProperties.bullet[2].massa = 0.0485F;
    localGunProperties.bullet[2].kalibr = 0.000110506F;
    ...
    localGunProperties.bullet[3].kalibr = 0.000110506F;
    localGunProperties.bullet[3].speed = 870.0F;
    localGunProperties.bullet[3].power = 0.000115F;
    ...
    localGunProperties.bullet[3].timeLife = 6.5F;
