...
public class CockpitF_80A extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF_80A.this.fm != null) {
        CockpitF_80A.access$102(CockpitF_80A.this, CockpitF_80A.this.setOld);
        CockpitF_80A.access$202(CockpitF_80A.this, CockpitF_80A.this.setNew);
        CockpitF_80A.access$302(CockpitF_80A.this, CockpitF_80A.this.setTmp);
        ...
        CockpitF_80A.this.setNew.azimuth = ((35.0F * CockpitF_80A.this.setOld.azimuth + -CockpitF_80A.this.fm.Or.getYaw()) / 36.0F);

        if ((CockpitF_80A.this.setOld.azimuth > 270.0F) && (CockpitF_80A.this.setNew.azimuth < 90.0F))
          CockpitF_80A.this.setOld.azimuth -= 360.0F;
        if ((CockpitF_80A.this.setOld.azimuth < 90.0F) && (CockpitF_80A.this.setNew.azimuth > 270.0F))
          CockpitF_80A.this.setOld.azimuth += 360.0F;
        CockpitF_80A.this.setNew.waypointAzimuth = ((10.0F * CockpitF_80A.this.setOld.waypointAzimuth + CockpitF_80A.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

        CockpitF_80A.this.setNew.vspeed = ((199.0F * CockpitF_80A.this.setOld.vspeed + CockpitF_80A.this.fm.getVertSpeed()) / 200.0F);

        float f1 = ((F_80A)CockpitF_80A.this.aircraft()).k14Distance;
        CockpitF_80A.this.setNew.k14w = (5.0F * CockpitF_80A.k14TargetWingspanScale[((F_80A)CockpitF_80A.this.aircraft()).k14WingspanType] / f1);
        ...
        Vector3d localVector3d = CockpitF_80A.this.aircraft().FM.getW();
        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitF_80A.this.floatindex((f1 - 200.0F) * 0.04F, CockpitF_80A.k14BulletDrop) - CockpitF_80A.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitF_80A.this.setNew.k14x = (0.92F * CockpitF_80A.this.setOld.k14x + 0.08F * f2);
        CockpitF_80A.this.setNew.k14y = (0.92F * CockpitF_80A.this.setOld.k14y + 0.08F * f3);
        if (CockpitF_80A.this.setNew.k14x > 7.0F)
          CockpitF_80A.this.setNew.k14x = 7.0F;
        if (CockpitF_80A.this.setNew.k14x < -7.0F)
          CockpitF_80A.this.setNew.k14x = -7.0F;
        if (CockpitF_80A.this.setNew.k14y > 7.0F)
          CockpitF_80A.this.setNew.k14y = 7.0F;
        if (CockpitF_80A.this.setNew.k14y < -7.0F)
          CockpitF_80A.this.setNew.k14y = -7.0F;
      }
      return true;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitF_80A this$0;
