...
public class CockpitYAK_7B_late extends CockpitPilot
{
  ...
  public CockpitYAK_7B_late()
  {
    super("3DO/Cockpit/Yak-7B_late/hierLate.him", "bf109");
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_7B_late this$0;
    ...
    Variables(CockpitYAK_7B_late.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_7B_late.this.fm != null) {
        CockpitYAK_7B_late.access$102(CockpitYAK_7B_late.this, CockpitYAK_7B_late.this.setOld);
        CockpitYAK_7B_late.access$202(CockpitYAK_7B_late.this, CockpitYAK_7B_late.this.setNew);
        CockpitYAK_7B_late.access$302(CockpitYAK_7B_late.this, CockpitYAK_7B_late.this.setTmp);
        CockpitYAK_7B_late.this.setNew.throttle = ((10.0F * CockpitYAK_7B_late.this.setOld.throttle + CockpitYAK_7B_late.this.fm.CT.PowerControl) / 11.0F);

        CockpitYAK_7B_late.this.setNew.prop = ((10.0F * CockpitYAK_7B_late.this.setOld.prop + CockpitYAK_7B_late.this.fm.EI.engines[0].getControlProp()) / 11.0F);

        CockpitYAK_7B_late.this.setNew.altimeter = CockpitYAK_7B_late.this.fm.getAltitude();
        if (Math.abs(CockpitYAK_7B_late.this.fm.Or.getKren()) < 30.0F) {
          CockpitYAK_7B_late.this.setNew.azimuth = ((35.0F * CockpitYAK_7B_late.this.setOld.azimuth + CockpitYAK_7B_late.this.fm.Or.azimut()) / 36.0F);
        }
        if ((CockpitYAK_7B_late.this.setOld.azimuth > 270.0F) && (CockpitYAK_7B_late.this.setNew.azimuth < 90.0F))
          CockpitYAK_7B_late.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_7B_late.this.setOld.azimuth < 90.0F) && (CockpitYAK_7B_late.this.setNew.azimuth > 270.0F))
          CockpitYAK_7B_late.this.setOld.azimuth += 360.0F;
        CockpitYAK_7B_late.this.setNew.vspeed = ((199.0F * CockpitYAK_7B_late.this.setOld.vspeed + CockpitYAK_7B_late.this.fm.getVertSpeed()) / 200.0F);
      }
