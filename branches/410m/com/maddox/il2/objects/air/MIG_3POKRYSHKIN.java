...
//            MIG_3, PaintSchemeSpecial, TypeAcePlane, NetAircraft
    ...
    implements com.maddox.il2.objects.air.TypeAcePlane
{
    ...
    public void update(float f)
    {
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL_D0", com.maddox.il2.objects.air.MIG_3POKRYSHKIN.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.9F), 0.0F, 0.0F);
            hierMesh().chunkSetAngles("SlatR_D0", com.maddox.il2.objects.air.MIG_3POKRYSHKIN.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.9F), 0.0F, 0.0F);
        }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 1, 1, 3, 3, 3, 3, 9, 
            9, 9, 9, 2, 2, 2, 2, 2, 2
        });
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShKASs 1450", "MGunShKASs 1450", "MGunUBk 600", null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponsRegister(class1, "2xBK", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponsRegister(class1, "6xRS-82", new java.lang.String[] {
            "MGunShKASs 1450", "MGunShKASs 1450", "MGunUBk 600", null, null, null, null, null, null, null, 
        ...
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponsRegister(class1, "4xFAB-50", new java.lang.String[] {
            "MGunShKASs 1450", "MGunShKASs 1450", "MGunUBk 600", null, null, "BombGunFAB50 1", "BombGunFAB50 1", "BombGunFAB50 1", "BombGunFAB50 1", null, 
            null, null, null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponsRegister(class1, "2xFAB-100", new java.lang.String[] {
            "MGunShKASs 1450", "MGunShKASs 1450", "MGunUBk 600", null, null, null, "BombGunFAB100 1", "BombGunFAB100 1", null, null, 
            null, null, null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponsRegister(class1, "4xAO-10", new java.lang.String[] {
            "MGunShKASs 1450", "MGunShKASs 1450", "MGunUBk 600", null, null, "BombGunAO10 1", "BombGunAO10 1", "BombGunAO10 1", "BombGunAO10 1", null, 
            null, null, null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.MIG_3POKRYSHKIN.weaponsRegister(class1, "none", new java.lang.String[] {
