...
// Source File Name:   CockpitSpit9C.java
...
//            CockpitPilot, SPITFIRE9M61, SPITFIRE9M63, SPITFIRE925LBS, 
//            SPITFIRE925LBSCW, Aircraft

public class CockpitSpit9C extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitSpit9C()
    {
        ...
        tmpP = new Point3d();
        tmpV = new Vector3d();
        if(aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE9M61)
        {
            mesh.materialReplace("BORT2", "BORT2a");
            mesh.materialReplace("text14", "text14a");
        } else
        if(aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE9M63)
        {
            mesh.materialReplace("BORT2", "BORT2b");
            mesh.materialReplace("text14", "text14b");
        } else
        if((aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE925LBS) || (aircraft() instanceof com.maddox.il2.objects.air.SPITFIRE925LBSCW))
        {
            mesh.materialReplace("BORT2", "BORT2c");
            mesh.materialReplace("text14", "text14c");
        }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, 0.032F, -0.032F);
        mesh.chunkSetLocate("STRELKA_GOS", xyz, ypr);
