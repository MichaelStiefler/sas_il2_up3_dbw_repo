...
public class BF_109E1B extends BF_109
{
  ...
  static
  {
    Class localClass = BF_109E1B.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3DO/Plane/Bf-109E-1/Bf109E1B.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/Bf-109E-1.fmd");
    Aircraft.weaponTriggersRegister(localClass, new int[] { 0, 0, 1, 1, 9, 3, 3, 3, 3, 3 });

    Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON02", "_ExternalDev01", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05" });
    try
    {
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMG17k", 750);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMG17k", 750);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(9, "PylonETC900", 1);
      ...
      arrayOf_WeaponSlot[2] = new Aircraft._WeaponSlot(1, "MGunMG17k", 750);
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMG17k", 750);
      arrayOf_WeaponSlot[4] = new Aircraft._WeaponSlot(9, "PylonETC50", 1);
      arrayOf_WeaponSlot[5] = null;
      ...
      arrayOf_WeaponSlot[9] = new Aircraft._WeaponSlot(3, "BombGunSC50", 1);
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
      str = "none";
      arrayOf_WeaponSlot = new Aircraft._WeaponSlot[i];
