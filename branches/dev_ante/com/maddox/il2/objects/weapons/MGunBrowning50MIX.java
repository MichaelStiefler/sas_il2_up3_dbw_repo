...
public class MGunBrowning50MIX extends MGunAircraftGeneric
{
  public GunProperties createProperties()
  {
    ...
    localGunProperties.bullet[4].massa = 0.0485F;
    localGunProperties.bullet[4].kalibr = 0.000125806F;
    localGunProperties.bullet[4].speed = 870.0F;
    localGunProperties.bullet[4].power = 0.0009768F;
    localGunProperties.bullet[4].powerType = 0;
    localGunProperties.bullet[4].powerRadius = 0.15F;
    ...
    localGunProperties.bullet[4].timeLife = 6.5F;
