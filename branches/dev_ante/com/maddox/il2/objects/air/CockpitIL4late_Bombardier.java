...
public class CockpitIL4late_Bombardier extends CockpitPilot
{
  ...
  public CockpitIL4late_Bombardier()
  {
    super("3DO/Cockpit/Pe-2-Bombardier/BombardierIL4.him", "he111");
    this.bEntered = false;
    try
    {
  ...
  {
    this.mesh.chunkSetAngles("zMark1", ((IL_4_IL4late)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
    float f = cvt(((IL_4_IL4late)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitIL4late_Bombardier.this.bEntered)
      {
        float f1 = ((IL_4_IL4late)CockpitIL4late_Bombardier.this.aircraft()).fSightCurForwardAngle;
        float f2 = -((IL_4_IL4late)CockpitIL4late_Bombardier.this.aircraft()).fSightCurSideslip;
        CockpitIL4late_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitIL4late_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
