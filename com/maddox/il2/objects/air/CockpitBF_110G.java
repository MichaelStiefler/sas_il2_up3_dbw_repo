...
public class CockpitBF_110G extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitBF_110G.this.setNew.altimeter = CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      ...
      CockpitBF_110G.this.setNew.throttle1 = (0.91F * CockpitBF_110G.this.setOld.throttle1 + 0.09F * CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
      CockpitBF_110G.this.setNew.throttle2 = (0.91F * CockpitBF_110G.this.setOld.throttle2 + 0.09F * CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
      CockpitBF_110G.this.setNew.mix1 = (0.88F * CockpitBF_110G.this.setOld.mix1 + 0.12F * CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
      CockpitBF_110G.this.setNew.mix2 = (0.88F * CockpitBF_110G.this.setOld.mix2 + 0.12F * CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
      CockpitBF_110G.this.setNew.azimuth = CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
      if ((CockpitBF_110G.this.setOld.azimuth > 270.0F) && (CockpitBF_110G.this.setNew.azimuth < 90.0F)) CockpitBF_110G.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_110G.this.setOld.azimuth < 90.0F) && (CockpitBF_110G.this.setNew.azimuth > 270.0F)) CockpitBF_110G.this.setOld.azimuth += 360.0F;
      CockpitBF_110G.this.setNew.waypointAzimuth = ((10.0F * CockpitBF_110G.this.setOld.waypointAzimuth + (CockpitBF_110G.this.waypointAzimuth() - CockpitBF_110G.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

      World.cur(); World.land(); CockpitBF_110G.this.setNew.radioalt = (0.9F * CockpitBF_110G.this.setOld.radioalt + 0.1F * (CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude() - Landscape.HQ_Air((float)CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.x, (float)CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.y)));

      CockpitBF_110G.this.setNew.vspeed = ((199.0F * CockpitBF_110G.this.setOld.vspeed + CockpitBF_110G.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitBF_110G.1 arg2) { this();
    }
  }
}