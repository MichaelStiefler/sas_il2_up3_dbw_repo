...
public class CockpitB_24J100_LGunner extends CockpitGunner
{
  ...
  {
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretRA", 0.0F, aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[4].tu[0], 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretRB", 0.0F, aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[4].tu[1], 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("TurretRC", 0.0F, aircraft().jdField_FM_of_type_ComMaddoxIl2FmFlightModel.turret[4].tu[1], 0.0F);
