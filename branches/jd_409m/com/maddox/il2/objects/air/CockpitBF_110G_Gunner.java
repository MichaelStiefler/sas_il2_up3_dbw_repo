...
public class CockpitBF_110G_Gunner extends CockpitGunner
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitBF_110G_Gunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel = World.getPlayerFM();
      if (CockpitBF_110G_Gunner.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel == null) return true;
      if (CockpitBF_110G_Gunner.this.bNeedSetUp) {
        CockpitBF_110G_Gunner.this.reflectPlaneMats();
        CockpitBF_110G_Gunner.access$002(CockpitBF_110G_Gunner.this, false);
      }
