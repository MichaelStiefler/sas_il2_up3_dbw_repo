...
// Source File Name:   CockpitA_20B_Bombardier.java
...
public class CockpitA_20B_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((com.maddox.il2.objects.air.A_20B)aircraft()).fSightCurForwardAngle;
            float f1 = ((com.maddox.il2.objects.air.A_20B)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((com.maddox.il2.objects.air.A_20B)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((com.maddox.il2.objects.air.A_20B)aircraft()).fSightCurReadyness > 0.93F;
