...
public class LA_7 extends LA_X
{
  static
  {
    ...
    weaponsRegister(localClass, "default", new String[] { "MGunShVAKs 200", "MGunShVAKs 200", null, null, null, null });

    weaponsRegister(localClass, "2xFAB50", new String[] { "MGunShVAKs 170", "MGunShVAKs 170", "BombGunFAB50 1", "BombGunFAB50 1", null, null });

    weaponsRegister(localClass, "2xFAB100", new String[] { "MGunShVAKs 170", "MGunShVAKs 170", "BombGunFAB100 1", "BombGunFAB100 1", null, null });

    weaponsRegister(localClass, "2xDROPTANK", new String[] { "MGunShVAKs 170", "MGunShVAKs 170", null, null, "FuelTankGun_Tank80", "FuelTankGun_Tank80" });
