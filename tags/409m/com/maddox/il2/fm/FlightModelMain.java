...
//            Gear, Polares, Atmosphere, Turret, 
//            Motor, Autopilotage
...
public class FlightModelMain extends com.maddox.il2.fm.FMMath
{
    ...
    public void load(java.lang.String s)
    {
        ...
        turnFile = s.substring(0, s.length() - 4) + "_turn.txt";
        speedFile = s.substring(0, s.length() - 4) + "_speed.txt";
    }
        ...
        try
        {
            ...
            for(int i = 0; i <= 10000; i += 100)
            {
                ...
                for(int j = 50; j < 1500; j++)
                {
                    ...
                    float f3 = Wing.getClimb((float)j * 0.27778F, i, f2);
                    if(f3 > f)
                        f = f3;
                    if(f3 >= 0.0F || f3 >= f)
                        continue;
                ...
                {
                    float f4 = EI.forcePropAOA((float)k * 0.27778F, i, 1.0F, false);
                    float f5 = Wing.getClimb((float)k * 0.27778F, i, f4);
                    if(f5 > f)
                        f = f5;
                    if(f5 >= 0.0F || f5 >= f)
                        continue;
    ...
    public static com.maddox.rts.SectFile sectFile(java.lang.String s)
    {
        ...
        try
        {
            ...
            } else
            {
                ...
                inputstream = fmDir.openStream("" + com.maddox.rts.Finger.Int(s1 + "d2w0"));
            }
            inputstream.mark(0);
