...
public class BF_109F2Btrop extends BF_109
  implements TypeBNZFighter
{
  ...
  public void update(float paramFloat)
  {
    ...
    {
      localObject = (Aircraft)this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.actor;
      if ((this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.cockpitDoorControl > 0.5F) && (this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getCockpitDoor() > 0.99F))
      {
        this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_AS_of_type_ComMaddoxIl2FmAircraftState.setCockpitDoor((Actor)localObject, 0);
  ...
  static
  {
    Class localClass = BF_109F2Btrop.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Bf109");
    Property.set(localClass, "meshName", "3DO/Plane/Bf-109F-2trop/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeBMPar03());
    Property.set(localClass, "yearService", 1941.0F);
    Property.set(localClass, "yearExpired", 1944.5F);
    Property.set(localClass, "FlightModel", "FlightModels/bf-109f-2_Db601N_oc.fmd");
    ...
    try
    {
      ...
      arrayOf_WeaponSlot[3] = new Aircraft._WeaponSlot(1, "MGunMG151ki", 200);
