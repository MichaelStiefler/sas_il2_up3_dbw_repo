...
// Source File Name:   CockpitP_40C.java
...
public class CockpitP_40C extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.63F);
        ...
        resetYPRmodifier();
        xyz[2] = cvt(fm.Or.getTangage(), -45F, 45F, 0.03015F, -0.03015F);
        mesh.chunkSetLocate("Z_TurnBank3", xyz, ypr);
        ...
        mesh.chunkSetAngles("Z_Pres1", 0.0F, cvt(fm.EI.engines[0].getManifoldPressure(), 0.3386378F, 1.693189F, 0.0F, 343.5F), 0.0F);
