...
public class MissileKS1 extends Missile implements MissileInterceptable/*, MsgCollisionRequestListener, MsgCollisionListener, MsgExplosionListener, MsgShotListener, Prey*/
{
  static
  {
    Class class1 = MissileKS1.class;
    Property.set(class1, "mesh", "3do/arms/KS-1/mono.sim");
//    Property.set(class1, "mesh", "3do/Rocketry/Fi-103_V-1_rocket/hier.him");
    ...
    Property.set(class1, "power", 1010.5F); // RL Data: 1015kg HE warhead, for realism reduced to 1/10th of it's RL weight
