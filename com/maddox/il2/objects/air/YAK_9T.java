...
public class YAK_9T extends com.maddox.il2.objects.air.YAK_9TX
{
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.YAK_9T.class;
        ...
        com.maddox.il2.objects.air.YAK_9T.weaponTriggersRegister(class1, new int[] {
            0, 1
        });
        com.maddox.il2.objects.air.YAK_9T.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_CANNON01"
        });
        com.maddox.il2.objects.air.YAK_9T.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunUBsi 220", "MGunNS37ki 30"
        });
        com.maddox.il2.objects.air.YAK_9T.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null
        });
    }
}
