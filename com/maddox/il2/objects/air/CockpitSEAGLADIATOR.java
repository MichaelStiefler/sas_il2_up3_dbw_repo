...
public class CockpitSEAGLADIATOR extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (((SEAGLADIATOR2)aircraft()).jdField_bChangedPit_of_type_Boolean)
    {
      reflectPlaneToModel();
      ((SEAGLADIATOR2)aircraft()).jdField_bChangedPit_of_type_Boolean = false;
    }
    resetYPRmodifier();
    Cockpit.xyz[1] = cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.65F);
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitSEAGLADIATOR.this.bNeedSetUp)
      {
        ...
        CockpitSEAGLADIATOR.access$002(CockpitSEAGLADIATOR.this, false);
      }
      if (((SEAGLADIATOR2)CockpitSEAGLADIATOR.this.aircraft()).jdField_bChangedPit_of_type_Boolean)
      {
        CockpitSEAGLADIATOR.this.reflectPlaneToModel();
        ((SEAGLADIATOR2)CockpitSEAGLADIATOR.this.aircraft()).jdField_bChangedPit_of_type_Boolean = false;
      }
      CockpitSEAGLADIATOR.access$102(CockpitSEAGLADIATOR.this, CockpitSEAGLADIATOR.this.setOld);
      CockpitSEAGLADIATOR.access$202(CockpitSEAGLADIATOR.this, CockpitSEAGLADIATOR.this.setNew);
      CockpitSEAGLADIATOR.access$302(CockpitSEAGLADIATOR.this, CockpitSEAGLADIATOR.this.setTmp);
      if (((CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) && (CockpitSEAGLADIATOR.this.setNew.stbyPosition < 1.0F))
      {
      ...
      CockpitSEAGLADIATOR.this.setNew.altimeter = CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (Math.abs(CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
        CockpitSEAGLADIATOR.this.setNew.azimuth = ((21.0F * CockpitSEAGLADIATOR.this.setOld.azimuth + CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 22.0F);
      if ((CockpitSEAGLADIATOR.this.setOld.azimuth > 270.0F) && (CockpitSEAGLADIATOR.this.setNew.azimuth < 90.0F))
        CockpitSEAGLADIATOR.this.setOld.azimuth -= 360.0F;
      if ((CockpitSEAGLADIATOR.this.setOld.azimuth < 90.0F) && (CockpitSEAGLADIATOR.this.setNew.azimuth > 270.0F))
        CockpitSEAGLADIATOR.this.setOld.azimuth += 360.0F;
      CockpitSEAGLADIATOR.this.setNew.throttle = ((10.0F * CockpitSEAGLADIATOR.this.setOld.throttle + CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle()) / 11.0F);
      CockpitSEAGLADIATOR.this.setNew.mix = ((10.0F * CockpitSEAGLADIATOR.this.setOld.mix + CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix()) / 11.0F);
      CockpitSEAGLADIATOR.this.setNew.prop = CockpitSEAGLADIATOR.this.setOld.prop;
      if (CockpitSEAGLADIATOR.this.setNew.prop < CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() - 0.01F)
        CockpitSEAGLADIATOR.this.setNew.prop += 0.0025F;
      if (CockpitSEAGLADIATOR.this.setNew.prop > CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() + 0.01F)
        CockpitSEAGLADIATOR.this.setNew.prop -= 0.0025F;
      CockpitSEAGLADIATOR.this.w.set(CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getW());
      CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transform(CockpitSEAGLADIATOR.this.w);
      CockpitSEAGLADIATOR.this.setNew.turn = ((12.0F * CockpitSEAGLADIATOR.this.setOld.turn + CockpitSEAGLADIATOR.this.w.z) / 13.0F);
      CockpitSEAGLADIATOR.this.setNew.vspeed = ((199.0F * CockpitSEAGLADIATOR.this.setOld.vspeed + CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitSEAGLADIATOR.access$502(CockpitSEAGLADIATOR.this, 0.8F * CockpitSEAGLADIATOR.this.pictSupc + 0.2F * CockpitSEAGLADIATOR.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor());
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitSEAGLADIATOR this$0;
    ...
    Variables(CockpitSEAGLADIATOR.1 arg2)
    {
      this();
    }
  }
