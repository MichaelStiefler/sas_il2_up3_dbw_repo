...
public class BF_109E7NZ extends com.maddox.il2.objects.air.BF_109
{
    ...
    public void update(float f)
    {
        if(FM.getSpeed() > 5F)
        {
            hierMesh().chunkSetAngles("SlatL_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.BF_109E7NZ.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F));
            hierMesh().chunkSetAngles("SlatR_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.BF_109E7NZ.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 1.5F));
        }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.BF_109E7NZ.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 1
        });
        com.maddox.il2.objects.air.BF_109E7NZ.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON02"
        });
        com.maddox.il2.objects.air.BF_109E7NZ.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG17si 1000", "MGunMG17si 1000", "MGunMGFFk 60", "MGunMGFFk 60"
        });
        com.maddox.il2.objects.air.BF_109E7NZ.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
