...
// Source File Name:   CockpitU2UT.java
...
public class CockpitU2UT extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if((fm.AS.astateCockpitState & 4) == 0 && (fm.AS.astateCockpitState & 0x10) == 0)
        {
            ...
            mesh.chunkSetAngles("zGasPrsxx1a", 0.0F, cvt(fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 10F, 0.0F, 275F), 0.0F);
        }
