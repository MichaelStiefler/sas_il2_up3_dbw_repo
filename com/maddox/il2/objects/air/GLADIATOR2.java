...
public class GLADIATOR2 extends com.maddox.il2.objects.air.GLADIATOR
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.GLADIATOR2.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 1
        });
        com.maddox.il2.objects.air.GLADIATOR2.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04"
        });
        com.maddox.il2.objects.air.GLADIATOR2.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBrowning303sipzl 600", "MGunBrowning303sipzl 600", "MGunBrowning303k 400", "MGunBrowning303k 400"
        });
        com.maddox.il2.objects.air.GLADIATOR2.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
