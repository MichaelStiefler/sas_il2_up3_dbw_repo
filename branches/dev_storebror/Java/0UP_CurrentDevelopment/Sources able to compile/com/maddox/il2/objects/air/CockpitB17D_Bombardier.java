...
public class CockpitB17D_Bombardier extends CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(bEntered)
            {
                ...
                hookpilot.setSimpleAimOrient(aAim + 10F * f1, tAim + CockpitB17D_Bombardier.calibrAngle + f, 0.0F);
            }
    ...
    static 
    {
        com.maddox.rts.Property.set(CockpitB17D_Bombardier.class, "astatePilotIndx", 0);
    }
