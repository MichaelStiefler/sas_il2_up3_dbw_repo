...
public class SPITFIRE5C4 extends com.maddox.il2.objects.air.SPITFIRE5
{
    ...
    {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.SPITFIRE5C4.cvt(f, 0.0F, 0.6F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.SPITFIRE5C4.cvt(f, 0.2F, 1.0F, 0.0F, -95F), 0.0F);
    }
    ...
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.SPITFIRE5C4.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.247F, 0.0F, -0.247F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        xyz[2] = com.maddox.il2.objects.air.SPITFIRE5C4.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.247F, 0.0F, 0.247F);
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/Spitfire-F-Vc-4H-M45-12-trop.fmd");
        ...
        com.maddox.il2.objects.air.SPITFIRE5C4.weaponTriggersRegister(class1, new int[] {
            1, 1, 1, 1
        });
        com.maddox.il2.objects.air.SPITFIRE5C4.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04"
        });
        com.maddox.il2.objects.air.SPITFIRE5C4.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunHispanoMkIki 120", "MGunHispanoMkIki 120", "MGunHispanoMkIki 120", "MGunHispanoMkIki 120"
        });
        com.maddox.il2.objects.air.SPITFIRE5C4.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
