// Source File Name: CockpitKI_46_RECCE.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitKI_46_RECCE.this.fm != null) {
				...
				CockpitKI_46_RECCE.this.setNew.flap = (0.88F * CockpitKI_46_RECCE.this.setOld.flap)
						+ (0.12F * CockpitKI_46_RECCE.this.fm.CT.FlapsControl);
				CockpitKI_46_RECCE.this.setNew.tlock = (0.7F * CockpitKI_46_RECCE.this.setOld.tlock)
						+ (0.3F * (CockpitKI_46_RECCE.this.fm.Gears.bTailwheelLocked ? 1.0F
								: 0.0F));
				...
				if ((CockpitKI_46_RECCE.this.fm.CT.GearControl < 0.5F)
						&& (CockpitKI_46_RECCE.this.setNew.gear < 1.0F)) {
					CockpitKI_46_RECCE.this.setNew.gear = CockpitKI_46_RECCE.this.setOld.gear + 0.02F;
				}
				if ((CockpitKI_46_RECCE.this.fm.CT.GearControl > 0.5F)
						&& (CockpitKI_46_RECCE.this.setNew.gear > 0.0F)) {
					CockpitKI_46_RECCE.this.setNew.gear = CockpitKI_46_RECCE.this.setOld.gear - 0.02F;
				}
				CockpitKI_46_RECCE.this.setNew.throttle = (0.9F * CockpitKI_46_RECCE.this.setOld.throttle)
						+ (0.1F * CockpitKI_46_RECCE.this.fm.CT.PowerControl);
				CockpitKI_46_RECCE.this.setNew.manifold = (0.8F * CockpitKI_46_RECCE.this.setOld.manifold)
						+ (0.2F * CockpitKI_46_RECCE.this.fm.EI.engines[0]
								.getManifoldPressure());
				CockpitKI_46_RECCE.this.setNew.pitch = (0.9F * CockpitKI_46_RECCE.this.setOld.pitch)
						+ (0.1F * CockpitKI_46_RECCE.this.fm.EI.engines[0]
								.getControlProp());
				CockpitKI_46_RECCE.this.setNew.mix = (0.9F * CockpitKI_46_RECCE.this.setOld.mix)
						+ (0.1F * CockpitKI_46_RECCE.this.fm.EI.engines[0]
								.getControlMix());
				CockpitKI_46_RECCE.this.setNew.altimeter = CockpitKI_46_RECCE.this.fm
						.getAltitude();
				CockpitKI_46_RECCE.this.setNew.azimuth.setDeg(
						CockpitKI_46_RECCE.this.setOld.azimuth.getDeg(1.0F),
						CockpitKI_46_RECCE.this.fm.Or.azimut());
				CockpitKI_46_RECCE.this.setNew.vspeed = ((199F * CockpitKI_46_RECCE.this.setOld.vspeed) + CockpitKI_46_RECCE.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
