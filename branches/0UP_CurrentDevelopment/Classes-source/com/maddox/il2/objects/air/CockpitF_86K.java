...
//            CockpitPilot, TypeGuidedMissileCarrier, F_86D, Cockpit
...
public class CockpitF_86K extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f = ((com.maddox.il2.objects.air.F_86D)aircraft()).k14Distance;
                setNew.k14w = (5F * com.maddox.il2.objects.air.CockpitF_86K.k14TargetWingspanScale[((com.maddox.il2.objects.air.F_86D)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * com.maddox.il2.objects.air.CockpitF_86K.k14TargetMarkScale[((com.maddox.il2.objects.air.F_86D)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((com.maddox.il2.objects.air.F_86D)aircraft()).k14Mode;
    ...
    {
        if(!(super.aircraft() instanceof com.maddox.il2.objects.air.TypeGuidedMissileCarrier))
            return 0;
        else
            return ((com.maddox.il2.objects.air.TypeGuidedMissileCarrier)super.aircraft()).getMissileLockState();
    }

    private float machNumber()
    {
        return ((com.maddox.il2.objects.air.F_86D)super.aircraft()).calculateMach();
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            if(com.maddox.il2.objects.air.F_86D.hunted != null)
                super.mesh.chunkVisible("Z_RadarTarget", true);
            else
                super.mesh.chunkVisible("Z_RadarTarget", false);
            int i = ((com.maddox.il2.objects.air.F_86D)aircraft()).k14Mode;
        ...
        resetYPRmodifier();
        super.mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, 45F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getCockpitDoor());
        ...
        if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.TypeGuidedMissileCarrier)
