...
public class I_185M71 extends com.maddox.il2.objects.air.I_185
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.I_185M71.weaponTriggersRegister(class1, new int[] {
            1, 1, 1
        });
        com.maddox.il2.objects.air.I_185M71.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02", "_CANNON03"
        });
        com.maddox.il2.objects.air.I_185M71.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShVAKsi 220", "MGunShVAKsi 220", "MGunShVAKsi 220"
        });
        com.maddox.il2.objects.air.I_185M71.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
}
