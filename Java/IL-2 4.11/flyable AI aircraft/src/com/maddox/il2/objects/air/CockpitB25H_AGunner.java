...
public class CockpitB25H_AGunner extends CockpitGunner {
	...
	static {
		...
		Property.set(CockpitB25H_AGunner.class, "astatePilotIndx", 4);
	}
	...
	protected void reflectPlaneToModel() {
		HierMesh hiermesh = this.aircraft().hierMesh();
		this.mesh.chunkVisible("VatorL_D0",
				hiermesh.isChunkVisible("VatorL_D0"));
		this.mesh.chunkVisible("VatorL_D1",
				hiermesh.isChunkVisible("VatorL_D1"));
		this.mesh.chunkVisible("VatorL_CAP",
				hiermesh.isChunkVisible("VatorL_CAP"));
		this.mesh.chunkVisible("VatorR_D0",
				hiermesh.isChunkVisible("VatorR_D0"));
		this.mesh.chunkVisible("VatorR_D1",
				hiermesh.isChunkVisible("VatorR_D1"));
		this.mesh.chunkVisible("VatorR_CAP",
				hiermesh.isChunkVisible("VatorR_CAP"));
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		if ((B_25H1) this.aircraft() == null) {
			;
		}
		if (B_25H1.bChangedPit) {
			this.reflectPlaneToModel();
			if ((B_25H1) this.aircraft() == null) {
				;
			}
