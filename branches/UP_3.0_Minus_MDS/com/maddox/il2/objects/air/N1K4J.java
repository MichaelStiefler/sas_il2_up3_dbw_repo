...
//            N1K3, PaintSchemeFMPar01, PaintSchemeFCSPar05, Aircraft, 
//            NetAircraft

public class N1K4J extends com.maddox.il2.objects.air.N1K3
{
    ...
    {
        com.maddox.il2.objects.air.N1K4J.moveGear(hierMesh(), f);
    }
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.N1K4J.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "iconFar_shortClassName", "N1K");
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", "3DO/Plane/N1K3-J(Multi1)/hier.him");
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "PaintScheme", ((java.lang.Object) (new PaintSchemeFMPar01())));
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName_ja", "3DO/Plane/N1K3-J(ja)/hier.him");
        ...
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "FlightModel", "FlightModels/N1K4-J.fmd");
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "cockpitClass", ((java.lang.Object) (new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitN1K3.class
        })));
        com.maddox.rts.Property.set(((java.lang.Object) (class1)), "LOSElevation", 1.1716F);
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "20mmx900+4xtype3", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "20mmx900+4xtype3+1x400dt", new java.lang.String[] {
            "MGunMG131s 300", "MGunMG131s 300", "MGunType99No2s 250", "MGunType99No2s 200", "MGunType99No2s 200", "MGunType99No2s 250", "RocketGunType3Mk27 1", "RocketGunType3Mk27 1", "RocketGunType3Mk27 1", "RocketGunType3Mk27 1", 
            "PylonN1K1PLN1 1", "FuelTankGun_TankN1K1 1", null, null, null, null
        });
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "20mmx900+2x60+1x400dt", new java.lang.String[] {
            "MGunMG131s 300", "MGunMG131s 300", "MGunType99No2s 250", "MGunType99No2s 200", "MGunType99No2s 200", "MGunType99No2s 250", null, null, null, null, 
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "20mmx900+4x60+1x400dt", new java.lang.String[] {
            "MGunMG131s 300", "MGunMG131s 300", "MGunType99No2s 250", "MGunType99No2s 200", "MGunType99No2s 200", "MGunType99No2s 250", null, null, null, null, 
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "20mmx900+2x100+1x400dt", new java.lang.String[] {
            "MGunMG131s 300", "MGunMG131s 300", "MGunType99No2s 250", "MGunType99No2s 200", "MGunType99No2s 200", "MGunType99No2s 250", null, null, null, null, 
        ...
        com.maddox.il2.objects.air.Aircraft.weaponsRegister(class1, "20mmx900+4x100+1x400dt", new java.lang.String[] {
            "MGunMG131s 300", "MGunMG131s 300", "MGunHo5k 250", "MGunHo5k 200", "MGunHo5k 200", "MGunHo5k 250", null, null, null, null, 
