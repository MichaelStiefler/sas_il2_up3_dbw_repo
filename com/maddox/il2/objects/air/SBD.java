...
public abstract class SBD extends com.maddox.il2.objects.air.Scheme1
{
    ...
    {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.SBD.cvt(f, 0.01F, 0.99F, 0.0F, -102F), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.SBD.cvt(f, 0.01F, 0.99F, 0.0F, -117F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.SBD.cvt(f, 0.21F, 0.99F, 0.0F, -102F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.SBD.cvt(f, 0.21F, 0.99F, 0.0F, -117F), 0.0F);
    }
    ...
    {
        resetYPRmodifier();
        float f = com.maddox.il2.objects.air.SBD.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.252F, 0.0F, -0.231F);
        xyz[1] = f;
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.SBD.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.252F, 0.0F, -0.231F);
        xyz[1] = f;
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.SBD.cvt(f, 0.01F, 0.99F, 0.0F, -0.7F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("t2"))
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(12.2F, 12.9F) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("t3"))
            ...
            if(s.startsWith("xxcontrols"))
            {
                if((s.endsWith("s1") || s.endsWith("s2")) && getEnergyPastArmor(4.8F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                {
                    ...
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** Elevator Cables: Hit, Controls Destroyed..");
                }
                if(s.endsWith("s3") && getEnergyPastArmor(3.2F, shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                ...
                if(s.endsWith("s4") && getEnergyPastArmor(0.2F, shot) > 0.0F)
                {
                    ...
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                }
                ...
                {
                    FM.AS.setControlsDamage(shot.initiator, 0);
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** Aileron Controls Out..");
                }
                return;
            }
            ...
            {
                com.maddox.il2.objects.air.SBD.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.SBD.debugprintln(this, "*** WingROut Spars Damaged..");
    ...
    public void update(float f)
    {
        ...
        if(FM.CT.getArrestor() > 0.001F)
            ...
            {
                float f1 = com.maddox.il2.objects.air.SBD.cvt(FM.Gears.arrestorVAngle, -73.5F, 3.5F, 1.0F, 0.0F);
