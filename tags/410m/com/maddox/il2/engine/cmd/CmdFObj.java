...
label0:
                for(; i != 0; i = com.maddox.il2.engine.FObj.NextFObj(i))
                {
                    ...
                    do
                    {
                        ...
                        {
                            flag = true;
                            com.maddox.il2.engine.FObj fobj = (com.maddox.il2.engine.FObj)(com.maddox.il2.engine.FObj)com.maddox.il2.engine.GObj.getJavaObject(i);
                            if(fobj != null)
                            {
                                if(fobj.ReLoad())
