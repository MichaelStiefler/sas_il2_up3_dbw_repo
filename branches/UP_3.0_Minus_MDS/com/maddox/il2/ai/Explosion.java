...
public class Explosion
{
    ...
    public float receivedPower(com.maddox.il2.engine.ActorMesh actormesh)
    {
        ...
        float f1 = (float)((com.maddox.il2.engine.Actor) (actormesh)).pos.getAbsPoint().distance(p);
        f1 -= f;
        if(f1 >= radius)
            return 0.0F;
    ...
    {
        float f = (float)((com.maddox.il2.engine.Actor) (actormesh)).pos.getAbsPoint().distance(p) - actormesh.collisionR();
    ...
    {
        float f = actormesh.collisionR();
        float f1 = (float)((com.maddox.il2.engine.Actor) (actormesh)).pos.getAbsPoint().distance(p) - f;
        if(f1 <= 0.0F)
            return 0.5F * power;
