    ...
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        public com.maddox.il2.engine.Actor actorSpawn(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
        {
            ...
            return ((com.maddox.il2.engine.Actor) (dzgeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.DZGeneric.mesh_name);
            cls = class1;
    ...
    private boolean danger()
    {
        ...
        for(java.util.Map.Entry entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(((java.util.Map.Entry) (null))); entry != null; entry = com.maddox.il2.engine.Engine.name2Actor().nextEntry(entry))
        {
            ...
            if(com.maddox.il2.engine.Actor.isAlive(actor) && actor != com.maddox.il2.ai.World.getPlayerAircraft() && (actor instanceof com.maddox.il2.objects.air.Aircraft) && actor.getArmy() == myArmy)
            {
                ...
                if(i <= 1000)
                    com.maddox.rts.ObjState.destroy(((com.maddox.rts.Destroy) (actor)));
            }
        }
