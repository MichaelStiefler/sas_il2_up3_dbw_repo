    ...
    implements TypeBomber, TypeX4Carrier, TypeGuidedBombCarrier
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = B_29.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            ...
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / B_29.toMeters(fSightCurAltitude)));
            ...
            if((double)fSightCurDistance < (double)calibDistance + (double)B_29.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(B_29.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = B_29.class;
        ...
        B_29.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        B_29.weaponsRegister(class1, "default", new java.lang.String[] {
