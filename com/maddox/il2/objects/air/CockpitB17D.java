...
public class CockpitB17D extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitB17D.access$002(CockpitB17D.this, CockpitB17D.this.setOld);
        CockpitB17D.access$102(CockpitB17D.this, CockpitB17D.this.setNew);
        CockpitB17D.access$202(CockpitB17D.this, CockpitB17D.this.setTmp);
        CockpitB17D.this.setNew.throttle1 = (0.85F * CockpitB17D.this.setOld.throttle1 + CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitB17D.this.setNew.throttle2 = (0.85F * CockpitB17D.this.setOld.throttle2 + CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitB17D.this.setNew.prop1 = (0.85F * CockpitB17D.this.setOld.prop1 + CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitB17D.this.setNew.prop2 = (0.85F * CockpitB17D.this.setOld.prop2 + CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitB17D.this.setNew.altimeter = CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitB17D.this.waypointAzimuth();
        CockpitB17D.this.setNew.azimuth.setDeg(CockpitB17D.this.setOld.azimuth.getDeg(1.0F), CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitB17D.this.setNew.waypointAzimuth.setDeg(CockpitB17D.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitB17D.this.setNew.waypointDeviation.setDeg(CockpitB17D.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitB17D.this.setOld.azimuth.getDeg(1.0F) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitB17D.this.setNew.vspeed = ((199.0F * CockpitB17D.this.setOld.vspeed + CockpitB17D.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitB17D this$0;
