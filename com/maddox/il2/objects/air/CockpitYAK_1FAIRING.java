...
public class CockpitYAK_1FAIRING extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitYAK_1FAIRING.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitYAK_1FAIRING.access$102(CockpitYAK_1FAIRING.this, CockpitYAK_1FAIRING.this.setOld); CockpitYAK_1FAIRING.access$202(CockpitYAK_1FAIRING.this, CockpitYAK_1FAIRING.this.setNew); CockpitYAK_1FAIRING.access$302(CockpitYAK_1FAIRING.this, CockpitYAK_1FAIRING.this.setTmp);

        CockpitYAK_1FAIRING.this.setNew.throttle = ((10.0F * CockpitYAK_1FAIRING.this.setOld.throttle + CockpitYAK_1FAIRING.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_1FAIRING.this.setNew.prop = ((10.0F * CockpitYAK_1FAIRING.this.setOld.prop + CockpitYAK_1FAIRING.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_1FAIRING.this.setNew.altimeter = CockpitYAK_1FAIRING.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_1FAIRING.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_1FAIRING.this.setNew.azimuth = ((35.0F * CockpitYAK_1FAIRING.this.setOld.azimuth + CockpitYAK_1FAIRING.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitYAK_1FAIRING.this.setOld.azimuth > 270.0F) && (CockpitYAK_1FAIRING.this.setNew.azimuth < 90.0F)) CockpitYAK_1FAIRING.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_1FAIRING.this.setOld.azimuth < 90.0F) && (CockpitYAK_1FAIRING.this.setNew.azimuth > 270.0F)) CockpitYAK_1FAIRING.this.setOld.azimuth += 360.0F;
        CockpitYAK_1FAIRING.this.setNew.vspeed = ((199.0F * CockpitYAK_1FAIRING.this.setOld.vspeed + CockpitYAK_1FAIRING.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_1FAIRING this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitYAK_1FAIRING.1 arg2) { this();
    }
  }
}