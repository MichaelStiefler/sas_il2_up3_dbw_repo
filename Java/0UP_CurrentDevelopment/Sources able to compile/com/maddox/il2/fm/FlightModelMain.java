...
public class FlightModelMain extends com.maddox.il2.fm.FMMath
{
    ...
    public void load(java.lang.String s)
    {
        ...
        Sq.load(sectfile);
        Arms.load(sectfile);
        com.maddox.il2.objects.air.Aircraft.debugprintln(super.actor, "Calling engines interface to resolve file '" + sectfile.toString() + "'....");
    ...
    {
        ((com.maddox.il2.objects.air.Aircraft)super.actor).update(f);
    }
    ...
    public boolean tick()
    {
        ...
        {
            if(super.actor.pos.base() instanceof com.maddox.il2.objects.air.Aircraft)
            {
                Vwld.set(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)super.actor.pos.base())).FM)).Vwld);
            } else
            {
    ...
    {
        return super.actor != null && super.actor == com.maddox.il2.ai.World.getPlayerAircraft();
    }
    ...
    private void checkDamaged()
    {
        if(!bDamaged && com.maddox.il2.engine.Actor.isValid(damagedInitiator) && (!isCapableOfBMP() || isTakenMortalDamage()))
        {
            ...
            if(super.actor != damagedInitiator)
                com.maddox.il2.ai.EventLog.onDamaged(super.actor, damagedInitiator);
            damagedInitiator = null;
        }
        ...
        {
            bDamagedGround = true;
            com.maddox.il2.ai.EventLog.onDamagedGround(super.actor);
        }
    }
    ...
    public final void setCapableOfBMP(boolean flag, com.maddox.il2.engine.Actor actor)
    {
        ...
        if(isCapableOfBMP() && com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 25)
            com.maddox.il2.objects.sounds.Voice.speakMayday((com.maddox.il2.objects.air.Aircraft)super.actor);
        if(flag)
        {
            flags0 |= 16L;
        } else
    ...
    public final void setReadyToDie(boolean flag)
    {
        ...
        if(!isReadyToDie())
        {
            if(com.maddox.il2.ai.World.Rnd().nextInt(0, 99) < 75)
                com.maddox.il2.objects.sounds.Voice.speakMayday((com.maddox.il2.objects.air.Aircraft)super.actor);
            com.maddox.il2.objects.effects.Explosions.generateComicBulb(super.actor, "OnFire", 9F);
        }
        if(flag)
        {
            flags0 |= 4L;
    ...
    public final void setReadyToReturn(boolean flag)
    {
        if(isReadyToReturn() == flag)
            return;
        if(!isReadyToReturn())
            com.maddox.il2.objects.effects.Explosions.generateComicBulb(super.actor, "RTB", 9F);
        if(flag)
            flags0 |= 2L;
        else
            flags0 &= -3L;
        com.maddox.il2.objects.sounds.Voice.speakToReturn((com.maddox.il2.objects.air.Aircraft)super.actor);
    }
    ...
    public final void setTakenMortalDamage(boolean flag, com.maddox.il2.engine.Actor actor)
    {
        ...
        if(flag && super.actor != com.maddox.il2.ai.World.getPlayerAircraft() && ((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)super.actor)).FM.turret.length > 0)
        {
            for(int i = 0; i < ((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)super.actor)).FM.turret.length; i++)
                ((com.maddox.il2.objects.sounds.SndAircraft) ((com.maddox.il2.objects.air.Aircraft)super.actor)).FM.turret[i].bIsOperable = false;
    ...
    public final void setStationedOnGround(boolean flag)
    {
        ...
        {
            flags0 |= 128L;
            com.maddox.il2.ai.EventLog.onAirLanded((com.maddox.il2.objects.air.Aircraft)super.actor);
            checkDamaged();
        } else
        {
            flags0 &= -129L;
    ...
    {
        com.maddox.il2.objects.air.Aircraft.debugprintln(super.actor, "Detected NDL in " + com.maddox.il2.objects.air.Aircraft.partNames()[i] + "..");
        if(i < 0 || i >= 44)
            return;
    ...
    public void cut(int i, int j, com.maddox.il2.engine.Actor actor)
    {
        if(i < 0 || i >= 44)
            return;
        com.maddox.il2.objects.air.Aircraft.debugprintln(super.actor, "cutting part #" + i + " (" + com.maddox.il2.objects.air.Aircraft.partNames()[i] + ")");
        if(!getOp(i))
        {
            com.maddox.il2.objects.air.Aircraft.debugprintln(super.actor, "part #" + i + " (" + com.maddox.il2.objects.air.Aircraft.partNames()[i] + ") already cut off");
            return;
        }
        cutOp(i);
        switch(i)
        ...
        case 11: // '\013'
            ...
            if(com.maddox.il2.ai.World.Rnd().nextInt(-1, 16) < Skill)
                setReadyToDie(true);
            if((super.actor instanceof com.maddox.il2.objects.air.Scheme2a) || (super.actor instanceof com.maddox.il2.objects.air.Scheme5) || (super.actor instanceof com.maddox.il2.objects.air.Scheme7))
        ...
        case 33: // '!'
            ...
            ((com.maddox.il2.engine.ActorHMesh)super.actor).destroyChildFiltered(com.maddox.il2.objects.weapons.BombGun.class);
            ((com.maddox.il2.engine.ActorHMesh)super.actor).destroyChildFiltered(com.maddox.il2.objects.weapons.RocketBombGun.class);
            cut(9, j, actor);
            cutOp(34);
            // fall through
        ...
        case 34: // '"'
            ...
            Sq.liftWingLIn *= 0.9F;
            ((com.maddox.il2.engine.ActorHMesh)super.actor).destroyChildFiltered(com.maddox.il2.objects.weapons.RocketGun.class);
            cutOp(35);
            // fall through
        ...
        case 3: // '\003'
            if(EI.engines.length <= 0)
                break;
            setCapableOfTaxiing(false);
            if(!(super.actor instanceof com.maddox.il2.objects.air.Scheme1))
                setReadyToDie(true);
