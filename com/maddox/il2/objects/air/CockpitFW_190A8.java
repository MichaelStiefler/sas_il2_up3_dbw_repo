...
public class CockpitFW_190A8 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bomb[0] == null)
    {
      ...
      if (((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).getBulletEmitterByHookName("_ExternalBomb01") != GunEmpty.get())
      {
        this.bomb[1] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).getBulletEmitterByHookName("_ExternalBomb01");
        this.bomb[2] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).getBulletEmitterByHookName("_ExternalBomb01");
      }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      ...
      {
        CockpitFW_190A8.access$002(CockpitFW_190A8.this, CockpitFW_190A8.this.setOld);
        CockpitFW_190A8.access$102(CockpitFW_190A8.this, CockpitFW_190A8.this.setNew);
        CockpitFW_190A8.access$202(CockpitFW_190A8.this, CockpitFW_190A8.this.setTmp);
        ...
        if ((CockpitFW_190A8.this.setOld.azimuth > 270.0F) && (CockpitFW_190A8.this.setNew.azimuth < 90.0F))
          CockpitFW_190A8.this.setOld.azimuth -= 360.0F;
        if ((CockpitFW_190A8.this.setOld.azimuth < 90.0F) && (CockpitFW_190A8.this.setNew.azimuth > 270.0F))
          CockpitFW_190A8.this.setOld.azimuth += 360.0F;
