...
// Source File Name:   CockpitJU_88A17.java
...
//            CockpitPilot, JU_88A17, Aircraft, AircraftLH, 
//            Cockpit

public class CockpitJU_88A17 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(com.maddox.il2.objects.air.JU_88A17.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.JU_88A17.bChangedPit = false;
            }
            if(fm != null)
            {
                setTmp = setOld;
    ...
    public CockpitJU_88A17()
    {
        ...
        cockpitNightMats = (new java.lang.String[] {
            ...
            "Peil1", "skala", "Pedal", "alt4", "TorpBox", "Z_Angle"
        });
        setNightMats(false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("zAlt3", (((com.maddox.il2.objects.air.JU_88A17)aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        ...
        float f1 = ((com.maddox.il2.objects.air.JU_88A17)aircraft()).fAOB;
        float f2 = ((com.maddox.il2.objects.air.JU_88A17)aircraft()).fShipSpeed;
        float f3 = ((com.maddox.il2.objects.air.JU_88A17)aircraft()).FM.AS.getGyroAngle();
