...
// Source File Name:   CockpitME_410DNJ.java
...
//            CockpitPilot, Aircraft, Cockpit, ME_410DNJ

public class CockpitME_410DNJ extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if((com.maddox.il2.objects.air.ME_410DNJ)aircraft() != null);
            if(com.maddox.il2.objects.air.ME_410DNJ.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.ME_410DNJ)aircraft() != null);
                com.maddox.il2.objects.air.ME_410DNJ.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
