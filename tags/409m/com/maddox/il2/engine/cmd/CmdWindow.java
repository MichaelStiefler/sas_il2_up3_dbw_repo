...
public class CmdWindow extends com.maddox.rts.Cmd
{
    ...
    public java.lang.Object exec(com.maddox.rts.CmdEnv cmdenv, java.util.Map map)
    {
        ...
        if(map.containsKey("_$$") || map.containsKey("FULL") || map.containsKey("PROVIDER") || map.containsKey("NOFULL"))
        {
            ...
            if(com.maddox.rts.Cmd.nargs(map, "PROVIDER") > 0)
            {
                s = com.maddox.rts.Cmd.arg(map, "PROVIDER", 0);
            ...
            if(map.containsKey("_$$"))
            {
                ...
                i = com.maddox.rts.Cmd.arg(map, "_$$", 0, 640, 160, j1);
            } else
            {
            ...
            if(com.maddox.rts.Cmd.nargs(map, "_$$") > 1)
            {
                ...
                j = com.maddox.rts.Cmd.arg(map, "_$$", 1, 480, 120, 1820);
            } else
            {
                j = (i * 3) / 4;
            }
            int k;
            if(com.maddox.rts.Cmd.nargs(map, "_$$") > 2)
            {
                if(flag1)
                    k = com.maddox.rts.Cmd.arg(map, "_$$", 2, 16, 16, 32);
                else
            ...
            if(flag1)
                ...
                k = com.maddox.rts.ScreenMode.startup().colourBits();
            int l;
            if(com.maddox.rts.Cmd.nargs(map, "_$$") > 3)
                l = com.maddox.rts.Cmd.arg(map, "_$$", 3, 16, 16, 32);
            else
            if(k == com.maddox.il2.engine.Config.cur.windowColourBits)
                ...
                l = k;
            int i1;
            if(com.maddox.rts.Cmd.nargs(map, "_$$") > 4)
                i1 = com.maddox.rts.Cmd.arg(map, "_$$", 4, 0, 0, 8);
            else
