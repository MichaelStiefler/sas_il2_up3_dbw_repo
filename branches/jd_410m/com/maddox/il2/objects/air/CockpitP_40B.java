  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitP_40B.this.fm != null) {
        ...
        CockpitP_40B.this.setNew.throttle = ((10.0F * CockpitP_40B.this.setOld.throttle + CockpitP_40B.this.fm.CT.PowerControl) / 11.0F);
        CockpitP_40B.this.setNew.prop = ((8.0F * CockpitP_40B.this.setOld.prop + CockpitP_40B.this.fm.CT.getStepControl()) / 9.0F);
        CockpitP_40B.this.setNew.altimeter = CockpitP_40B.this.fm.getAltitude();
        if (Math.abs(CockpitP_40B.this.fm.Or.getKren()) < 45.0F) {
          CockpitP_40B.this.setNew.azimuth = ((35.0F * CockpitP_40B.this.setOld.azimuth + -CockpitP_40B.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        CockpitP_40B.this.setNew.vspeed = ((199.0F * CockpitP_40B.this.setOld.vspeed + CockpitP_40B.this.fm.getVertSpeed()) / 200.0F);
      }
      return true;
    }
  }
