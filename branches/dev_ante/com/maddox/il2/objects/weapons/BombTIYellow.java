...
public class BombTIYellow extends Bomb
{
  private long t1;
  private int charge;
    ...
    if (this.charge < 1.01D) {
      ...
      if (Actor.isValid(localActor)) {
        ...
        for (int i = 0; i < 60; i++) {
          ...
          BombTiYw localBombTiYw = new BombTiYw();
          localBombTiYw.pos.setUpdateEnable(true);
          localBombTiYw.pos.setAbs(localPoint3d, localOrient);
          localBombTiYw.pos.reset();
          localBombTiYw.start();
          localBombTiYw.setOwner(localActor, false, false, false);
          localBombTiYw.setSpeed(localVector3d1);
        }
  ...
  static
  {
    Class localClass = BombTIYellow.class;
