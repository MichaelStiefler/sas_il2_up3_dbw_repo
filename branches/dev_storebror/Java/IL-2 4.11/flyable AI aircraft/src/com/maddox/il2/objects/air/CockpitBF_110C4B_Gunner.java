// Source File Name: CockpitBF_110C4B_Gunner.java
...
public class CockpitBF_110C4B_Gunner extends CockpitGunner {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			CockpitBF_110C4B_Gunner.this.fm = World.getPlayerFM();
			if (CockpitBF_110C4B_Gunner.this.fm == null) {
				return true;
			}
			if (CockpitBF_110C4B_Gunner.this.bNeedSetUp) {
				CockpitBF_110C4B_Gunner.this.reflectPlaneMats();
				CockpitBF_110C4B_Gunner.this.bNeedSetUp = false;
			}
			return true;
		}
	}
	...
	public CockpitBF_110C4B_Gunner() {
		super("3DO/Cockpit/Bf-110C4B-Gun/hier.him", "bf109");
