...
//            AR_234, PaintScheme, EjectionSeat

public abstract class AR_234F extends com.maddox.il2.objects.air.Scheme2
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, com.maddox.il2.objects.air.AR_234F.floatindex(com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear6), 0.0F);
        com.maddox.il2.objects.air.Aircraft.ypr[0] = com.maddox.il2.objects.air.Aircraft.ypr[1] = com.maddox.il2.objects.air.Aircraft.ypr[2] = com.maddox.il2.objects.air.Aircraft.xyz[0] = com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.xyz[2] = 0.0F;
        com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.AR_234F.floatindex(com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear7);
        ...
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, com.maddox.il2.objects.air.AR_234F.floatindex(com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear6), 0.0F);
        com.maddox.il2.objects.air.Aircraft.ypr[0] = com.maddox.il2.objects.air.Aircraft.ypr[1] = com.maddox.il2.objects.air.Aircraft.ypr[2] = com.maddox.il2.objects.air.Aircraft.xyz[0] = com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.Aircraft.xyz[2] = 0.0F;
        com.maddox.il2.objects.air.Aircraft.xyz[1] = com.maddox.il2.objects.air.AR_234F.floatindex(com.maddox.il2.objects.air.Aircraft.cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear7);
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 9: // '\t'
                    ...
                    {
                        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Aileron Controls Crank: Disabled..");
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                    break;
            ...
            if(s.startsWith("xxEng"))
            {
                ...
                if(point3d.x > 0.0D)
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        com.maddox.il2.objects.air.Aircraft.debugprintln(((com.maddox.il2.engine.Actor) (this)), "*** Engine Module(s): Supercharger Disabled..");
    ...
    public void rareAction(float f, boolean flag)
    {
        ...
        if(flag && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.04F)
        {
            ...
            {
                FM.AS.explodeEngine(((com.maddox.il2.engine.Actor) (this)), 0);
                msgCollision(((com.maddox.il2.engine.Actor) (this)), "WingLIn_D0", "WingLIn_D0");
                if(com.maddox.il2.ai.World.Rnd().nextBoolean())
                    FM.AS.hitTank(((com.maddox.il2.engine.Actor) (this)), 0, com.maddox.il2.ai.World.Rnd().nextInt(1, 8));
                else
                    FM.AS.hitTank(((com.maddox.il2.engine.Actor) (this)), 1, com.maddox.il2.ai.World.Rnd().nextInt(1, 8));
            }
            if(FM.AS.astateEngineStates[1] > 3 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.12F)
            {
                FM.AS.explodeEngine(((com.maddox.il2.engine.Actor) (this)), 1);
            ...
            for(int i = 0; i < 2; i++)
                ...
                } else
                {
                    ...
                    if((curctl[i] - oldctl[i]) / f > 3F && FM.EI.engines[i].getRPM() < 2400F && FM.EI.engines[i].getStage() == 6 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                        FM.AS.hitEngine(((com.maddox.il2.engine.Actor) (this)), i, 100);
                    if((curctl[i] - oldctl[i]) / f < -3F && FM.EI.engines[i].getRPM() < 2400F && FM.EI.engines[i].getStage() == 6)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F && (FM instanceof com.maddox.il2.fm.RealFlightModel) && ((com.maddox.il2.fm.RealFlightModel)FM).isRealMode())
                            FM.EI.engines[i].setEngineStops(((com.maddox.il2.engine.Actor) (this)));
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.75F && (FM instanceof com.maddox.il2.fm.RealFlightModel) && ((com.maddox.il2.fm.RealFlightModel)FM).isRealMode())
                            FM.EI.engines[i].setKillCompressor(((com.maddox.il2.engine.Actor) (this)));
                    }
                    oldctl[i] = curctl[i];
                }
            ...
            if(com.maddox.il2.engine.Config.isUSE_RENDER())
            {
                ...
                if(FM.EI.engines[1].getPowerOutput() > 0.8F && FM.EI.engines[1].getStage() == 6)
                {
                    if(FM.EI.engines[1].getPowerOutput() > 0.95F)
                        FM.AS.setSootState(((com.maddox.il2.engine.Actor) (this)), 1, 3);
                    else
                        FM.AS.setSootState(((com.maddox.il2.engine.Actor) (this)), 1, 2);
                } else
                {
                    FM.AS.setSootState(((com.maddox.il2.engine.Actor) (this)), 1, 0);
                }
            }
        }
        super.update(f);
