...
//            Scheme1, TypeStormovik, TypeBomber, Aircraft, 
//            PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeStormovik, com.maddox.il2.objects.air.TypeBomber
{
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.equals("xxarmorc1"))
                    getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(10F, 15F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.startsWith("xxarmorrt"))
                {
                    if(s.endsWith("1"))
                        getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(10F, 60F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                    if(s.endsWith("2"))
                        getEnergyPastArmor(19.100000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.z) + 9.9999997473787516E-005D), shot);
                    if(s.endsWith("3"))
                    ...
                    if(s.endsWith("4") || s.endsWith("5"))
                        getEnergyPastArmor(9.5D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.y) + 9.9999997473787516E-005D), shot);
                } else
                if(s.startsWith("xxarmort"))
                {
                    if(s.endsWith("1"))
                        getEnergyPastArmor(9.5D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                    if(s.endsWith("2"))
                        getEnergyPastArmor(19.100000381469727D / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                    if(s.endsWith("3"))
                        getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(9.5F, 19.1F) / (java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                }
                return;
            }
    ...
    {
        resetYPRmodifier();
        com.maddox.il2.objects.air.Aircraft.xyz[0] = -1.45F * f;
