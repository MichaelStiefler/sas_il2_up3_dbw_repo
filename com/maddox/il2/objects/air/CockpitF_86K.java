...
//            CockpitPilot, Cockpit, TypeGuidedMissileCarrier, F_86F, 
//            F_86K

public class CockpitF_86K extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                setNew.k14w = (5F * com.maddox.il2.objects.air.CockpitF_86K.k14TargetWingspanScale[((com.maddox.il2.objects.air.F_86F) ((com.maddox.il2.objects.air.F_86K)aircraft())).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * com.maddox.il2.objects.air.CockpitF_86K.k14TargetMarkScale[((com.maddox.il2.objects.air.F_86F)aircraft()).k14WingspanType];
                ...
                float f3 = floatindex((f - 200F) * 0.04F, com.maddox.il2.objects.air.CockpitF_86K.k14BulletDrop) - com.maddox.il2.objects.air.CockpitF_86K.k14BulletDrop[0];
    ...
    {
        if(!(((com.maddox.il2.objects.air.Cockpit)this).aircraft() instanceof com.maddox.il2.objects.air.TypeGuidedMissileCarrier))
            return 0;
        else
            return ((com.maddox.il2.objects.air.TypeGuidedMissileCarrier)((com.maddox.il2.objects.air.Cockpit)this).aircraft()).getMissileLockState();
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        ((com.maddox.il2.objects.air.Cockpit)this).resetYPRmodifier();
        ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, 45F * ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.air.Cockpit)this).fm)).CT.getCockpitDoor());
        ...
        if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.TypeGuidedMissileCarrier)
            ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("MissileControl", true);
        else
            ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("MissileControl", false);
        if(((com.maddox.il2.engine.Interpolate) (((com.maddox.il2.objects.air.Cockpit)this).fm)).actor instanceof com.maddox.il2.objects.air.TypeGuidedMissileCarrier)
        {
            if(iLockState() == 2)
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_Locked", true);
            else
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_Locked", false);
            if(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.air.Cockpit)this).fm)).getOverload() > 2.0F || ((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.air.Cockpit)this).fm)).getOverload() < 0.0F)
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_OverG", true);
            else
                ((com.maddox.il2.objects.air.Cockpit)this).mesh.chunkVisible("Z_OverG", false);
        }
    }
