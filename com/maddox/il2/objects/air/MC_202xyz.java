  ...
  implements TypeFighter
{
  ...
  public void moveSteering(float paramFloat) {
    hierMesh().chunkSetAngles("GearC2_D0", Aircraft.cvt(paramFloat, -125.0F, 125.0F, -125.0F, 125.0F), 0.0F, 0.0F);
  }
  ...
  {
    float f = Aircraft.cvt(this.jdField_FM_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlRadiator(), 0.0F, 1.0F, -10.0F, 0.0F);
