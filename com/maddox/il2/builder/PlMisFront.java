...
public class PlMisFront extends com.maddox.il2.builder.Plugin
{
    ...
    public void renderMap2DAfter()
    {
        ...
        if(!viewType.bChecked)
            return;
        com.maddox.il2.ai.Front.render(builder.isView3D());
        com.maddox.il2.engine.IconDraw.setScrSize(builder.conf.iconSize * 2, builder.conf.iconSize * 2);
        ...
        for(int j = 0; j < i; j++)
        {
            ...
            if(!builder.project2d(actorfrontmarker.pos.getAbsPoint(), p2d))
                continue;
            ...
            com.maddox.il2.engine.IconDraw.render(actorfrontmarker, p2d.x + (double)((builder.conf.iconSize * 2) / 3), p2d.y + (double)((builder.conf.iconSize * 2) / 3));
        }

        com.maddox.il2.engine.IconDraw.setScrSize(builder.conf.iconSize, builder.conf.iconSize);
    }
    ...
    private com.maddox.il2.builder.ActorFrontMarker insert(com.maddox.JGP.Point3d point3d, boolean flag, int i)
    {
        ...
        java.lang.String s = com.maddox.il2.builder.PlMisFront.i18n("FrontMarker") + " " + com.maddox.il2.game.I18N.army(com.maddox.il2.ai.Army.name(i));
        ...
        if(flag)
            builder.setSelected(actorfrontmarker);
    ...
    {
        if(com.maddox.il2.builder.PlMisFront.getPlugin("Mission") == null)
        {
            throw new RuntimeException("PlMisFront: plugin 'Mission' not found");
        } else
        {
            pluginMission = (com.maddox.il2.builder.PlMission)com.maddox.il2.builder.PlMisFront.getPlugin("Mission");
            return;
        }
    }
    ...
    private void fillComboBox2(int i)
    {
        ...
        if(builder.wSelect.curFilledType != i)
        {
            ...
            for(int j = 0; j < item.length; j++)
                builder.wSelect.comboBox2.add(com.maddox.il2.builder.PlMisFront.i18n("FrontMarker") + " " + com.maddox.il2.game.I18N.army(com.maddox.il2.ai.Army.name(item[j].army)));
    ...
    {
        com.maddox.il2.builder.ActorFrontMarker actorfrontmarker = (com.maddox.il2.builder.ActorFrontMarker)builder.selectedActor();
        fillComboBox2(startComboBox1);
        builder.wSelect.comboBox2.setSelected(actorfrontmarker.getArmy() - 1, true, false);
    }

    public void createGUI()
    {
        startComboBox1 = builder.wSelect.comboBox1.size();
        builder.wSelect.comboBox1.add(com.maddox.il2.builder.PlMisFront.i18n("FrontMarker"));
        ...
        if(--i >= 0)
        {
            viewType = builder.mDisplayFilter.subMenu.addItem(i, new com.maddox.gwindow.GWindowMenuItem(builder.mDisplayFilter.subMenu, com.maddox.il2.builder.PlMisFront.i18n("showFrontMarker"), null) {
