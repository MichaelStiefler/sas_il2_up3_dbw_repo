    ...
    implements TypeBNZFighter
{
        ...
        if((double)((com.maddox.il2.fm.FlightModelMain) (super.FM)).CT.getCockpitDoor() > 0.20000000000000001D && bHasBlister && super.FM.getSpeedKMH() > fMaxKMHSpeedForOpenCanopy && hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
                if(this == com.maddox.il2.ai.World.getPlayerAircraft())
                    ((CockpitS_199)com.maddox.il2.game.Main3D.cur3D().cockpitCur).removeCanopy();
            }
    ...
    static 
    {
        java.lang.Class class1 = S_199.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "S199");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/S-199/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "yearExpired", 1958F);
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/S-199.fmd");
        ...
        Aircraft.weaponsRegister(class1, "2xSC50", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "2xSC70", new java.lang.String[] {
