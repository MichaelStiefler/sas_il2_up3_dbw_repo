// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 7/27/2011 2:59:01 AM
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   CockpitBF_109E3.java
...
//            CockpitPilot, BF_109E3, Aircraft, AircraftLH, 
//            Cockpit

public class CockpitBF_109E3 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    private class Variables
    {
        ...
        Variables(com.maddox.il2.objects.air.CockpitBF_109E3.Variables variables)
        {
            this();
        }
    }
    ...
    protected void reflectPlaneMats()
    {
        ...
        if(!ac.bHasArmor)
          mesh.chunkVisible("Z_ArmorGlass1", false);
        else
        ...
        {
            if(((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof com.maddox.il2.objects.air.BF_109E1)
            {
            	mesh.chunkVisible("TopE1", true);
            	mesh.chunkVisible("TopE3", false);
            }
            else
            {
            	mesh.chunkVisible("TopE1", false);
            	mesh.chunkVisible("TopE3", true);
            }
        }
    }

    public CockpitBF_109E3()
    {
        super("3DO/Cockpit/Bf-109E-7/E3hier.him", "bf109");
        hasCanopy = true;
        ...
        ac = (com.maddox.il2.objects.air.BF_109E3)aircraft();
        ac.registerPit(this);
    }
    ...
    public void removeCanopy()
    {
        ...
        if(mesh.chunkFindCheck("TopE1") >= 0)
            mesh.chunkVisible("TopE1", false);
        else if(mesh.chunkFindCheck("TopE3") >= 0)
            mesh.chunkVisible("TopE3", false);
        doToggleUp(false);
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(ac.tiltCanopyOpened)
        {
            ...
            mesh.chunkSetAngles("Top", 0.0F, cvt(fm.CT.getCockpitDoor(), 0.1F, 1.0F, 0.0F, 100F), 0.0F);
        } else
        {
            resetYPRmodifier();
    ...
    protected boolean doFocusEnter()
    {
        if(super.doFocusEnter())
        {
            ...
            if(ac.bHasArmor)
            	aircraft().hierMesh().chunkVisible("Armor1_D0", false);
            return true;
        } else
        {
            return false;
    ...
    protected void doFocusLeave()
    {
        if(isFocused() && hasCanopy)
        {
            ...
            if(ac.bHasArmor)
            	aircraft().hierMesh().chunkVisible("Armor1_D0", true);
            super.doFocusLeave();
        }
        else if(isFocused())
        {
    ...
    boolean hasCanopy;
    private com.maddox.il2.objects.air.CockpitBF_109E3.Variables setOld;
    private com.maddox.il2.objects.air.CockpitBF_109E3.Variables setNew;
    private com.maddox.il2.objects.air.CockpitBF_109E3.Variables setTmp;
    ...
    com.maddox.il2.objects.air.BF_109E3 ac;
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitBF_109E3.class, "normZN", 0.5F);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitBF_109E3.class, "gsZN", 0.5F);
    }
}