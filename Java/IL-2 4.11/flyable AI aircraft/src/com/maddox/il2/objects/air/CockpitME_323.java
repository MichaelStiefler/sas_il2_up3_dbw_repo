// Source File Name: CockpitME_323.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitME_323.this.fm != null) {
				...
				CockpitME_323.this.setNew.throttle1 = (0.85F * CockpitME_323.this.setOld.throttle1)
						+ (CockpitME_323.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitME_323.this.setNew.throttle2 = (0.85F * CockpitME_323.this.setOld.throttle2)
						+ (CockpitME_323.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitME_323.this.setNew.prop1 = (0.85F * CockpitME_323.this.setOld.prop1)
						+ (CockpitME_323.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitME_323.this.setNew.prop2 = (0.85F * CockpitME_323.this.setOld.prop2)
						+ (CockpitME_323.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitME_323.this.setNew.altimeter = CockpitME_323.this.fm
						.getAltitude();
				float f = CockpitME_323.this.waypointAzimuth();
				CockpitME_323.this.setNew.azimuth.setDeg(
						CockpitME_323.this.setOld.azimuth.getDeg(1.0F),
						CockpitME_323.this.fm.Or.azimut());
				CockpitME_323.this.setNew.waypointAzimuth.setDeg(
						CockpitME_323.this.setOld.waypointAzimuth.getDeg(1.0F),
						f);
				CockpitME_323.this.setNew.waypointDeviation.setDeg(
						CockpitME_323.this.setOld.waypointDeviation
								.getDeg(0.1F),
						(f - CockpitME_323.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitME_323.this.setNew.vspeed = ((199F * CockpitME_323.this.setOld.vspeed) + CockpitME_323.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
