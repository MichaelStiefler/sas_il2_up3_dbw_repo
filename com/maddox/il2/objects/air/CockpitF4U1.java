...
public class CockpitF4U1 extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF4U1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitF4U1.access$102(CockpitF4U1.this, CockpitF4U1.this.setOld); CockpitF4U1.access$202(CockpitF4U1.this, CockpitF4U1.this.setNew); CockpitF4U1.access$302(CockpitF4U1.this, CockpitF4U1.this.setTmp);

        CockpitF4U1.this.setNew.throttle = (0.85F * CockpitF4U1.this.setOld.throttle + CockpitF4U1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl * 0.15F);
        CockpitF4U1.this.setNew.prop = (0.85F * CockpitF4U1.this.setOld.prop + CockpitF4U1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getStepControl() * 0.15F);
        CockpitF4U1.this.setNew.altimeter = CockpitF4U1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f = CockpitF4U1.this.waypointAzimuth();
        CockpitF4U1.this.setNew.azimuth.setDeg(CockpitF4U1.this.setOld.azimuth.getDeg(1.0F), CockpitF4U1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitF4U1.this.setNew.waypointAzimuth.setDeg(CockpitF4U1.this.setOld.waypointAzimuth.getDeg(1.0F), f);
        CockpitF4U1.this.setNew.vspeed = ((199.0F * CockpitF4U1.this.setOld.vspeed + CockpitF4U1.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float vspeed;
    private final CockpitF4U1 this$0;
