...
public class CockpitPZL23B extends CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            PZL23B pzl23b = (PZL23B)aircraft();
            if(PZL23B.bChangedPit)
            {
                reflectPlaneToModel();
                PZL23B pzl23b1 = (PZL23B)aircraft();
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        Cockpit.xyz[0] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).Or.getTangage(), -20F, 20F, 0.0485F, -0.0485F);
        super.mesh.chunkSetLocate("zPitch", Cockpit.xyz, Cockpit.ypr);
