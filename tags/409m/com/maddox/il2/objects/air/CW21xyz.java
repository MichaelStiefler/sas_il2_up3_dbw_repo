    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    protected void moveFan(float f)
    {
        if(com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            ...
            hierMesh().chunkSetAngles("Stick_D0", 0.0F, com.maddox.il2.objects.air.Aircraft.cvt(f1, -1F, 1.0F, -10F, 10.5F), com.maddox.il2.objects.air.Aircraft.cvt(f2, -1F, 1.0F, -11.5F, 9.5F));
