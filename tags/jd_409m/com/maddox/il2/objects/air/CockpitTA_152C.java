...
public class CockpitTA_152C extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    if (this.gun[0] == null) {
      ...
      this.gun[1] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getGunByHookName("_CANNON04");
      this.gun[2] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getGunByHookName("_CANNON05");
      this.gun[3] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getGunByHookName("_CANNON06");
    }
    if (this.bomb[0] == null) {
    ...
    resetYPRmodifier();
    float f1;
    if (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl == 0.0F)
      f1 = 0.0205F;
    else {
      f1 = 0.0F;
    }
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("NeedleManPress", -cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure(), 0.6F, 1.8F, 15.0F, 345.0F), 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("NeedleWaterTemp", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].tWaterOut, 0.0F, 120.0F, 0.0F, 60.0F), 0.0F, 0.0F);

    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("NeedleOilTemp", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].tOilOut, 0.0F, 120.0F, 0.0F, 60.0F), 0.0F, 0.0F);
    ...
    resetYPRmodifier();
    Cockpit.xyz[2] = (this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl < 0.5F ? 0.02F : 0.0F);
  }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitTA_152C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitTA_152C.access$102(CockpitTA_152C.this, CockpitTA_152C.this.setOld); CockpitTA_152C.access$202(CockpitTA_152C.this, CockpitTA_152C.this.setNew); CockpitTA_152C.access$302(CockpitTA_152C.this, CockpitTA_152C.this.setTmp);
        ...
        if (CockpitTA_152C.this.cockpitDimControl) {
          if (CockpitTA_152C.this.setNew.dimPosition > 0.0F) CockpitTA_152C.this.setNew.dimPosition = (CockpitTA_152C.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitTA_152C.this.setNew.dimPosition < 1.0F) CockpitTA_152C.this.setNew.dimPosition = (CockpitTA_152C.this.setOld.dimPosition + 0.05F);
        ...
        if ((CockpitTA_152C.this.setOld.azimuth > 270.0F) && (CockpitTA_152C.this.setNew.azimuth < 90.0F)) CockpitTA_152C.this.setOld.azimuth -= 360.0F;
        if ((CockpitTA_152C.this.setOld.azimuth < 90.0F) && (CockpitTA_152C.this.setNew.azimuth > 270.0F)) CockpitTA_152C.this.setOld.azimuth += 360.0F;
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitTA_152C.1 arg2) { this();
    }
  }
}