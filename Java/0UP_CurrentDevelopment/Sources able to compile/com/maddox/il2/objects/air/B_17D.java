    ...
    implements TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = B_17D.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= B_17D.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / B_17D.toMeters(fSightCurAltitude)));
            calibDistance = B_17D.toMetersPerSecond(fSightCurSpeed) * floatindex(Aircraft.cvt(B_17D.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)B_17D.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(B_17D.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = B_17D.class;
        ...
        B_17D.weaponTriggersRegister(class1, new int[] {
            10, 11, 12, 13, 13, 14, 15, 3, 3
        });
        B_17D.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_BombSpawn01", "_BombSpawn02"
        });
        B_17D.weaponsRegister(class1, "default", new java.lang.String[] {
        ...
        B_17D.weaponsRegister(class1, "20x100", new java.lang.String[] {
        ...
        B_17D.weaponsRegister(class1, "14x300", new java.lang.String[] {
        ...
        B_17D.weaponsRegister(class1, "4x1000", new java.lang.String[] {
        ...
        B_17D.weaponsRegister(class1, "none", new java.lang.String[] {
