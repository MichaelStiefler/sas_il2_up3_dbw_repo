...
public class NetHost extends com.maddox.rts.NetObj
{
    ...
    private java.lang.String getCleanedString(java.lang.String s)
    {
        if(com.maddox.il2.game.Main.cur().netServerParams == null || !com.maddox.il2.game.Main.cur().netServerParams.filterUserNames)
            return s;
    ...
    public void setShortName(java.lang.String s)
    {
        ...
        if(isMaster())
        {
            ...
            if(isMirrored())
                ...
                {
                    com.maddox.rts.NetHost.printDebug(exception);
                }
        }
    }
        ...
        throws java.io.IOException
    {
        ...
        shortName = getCleanedString(shortName);
