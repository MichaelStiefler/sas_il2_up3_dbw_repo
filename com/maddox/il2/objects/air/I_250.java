...
//            TypeFighter, TypeBNZFighter, Cockpit, NetAircraft, 
//            PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter
{
    ...
    {
        hiermesh.chunkSetAngles("GearC99_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.15F, 0.45F, 0.0F, -50F), 0.0F);
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 0.0F, 0.0F);
        ypr[0] = ypr[1] = ypr[2] = xyz[0] = xyz[1] = xyz[2] = 0.0F;
        ypr[2] = com.maddox.il2.objects.air.I_250.cvt(f, 0.05F, 0.25F, 0.0F, -45F);
        xyz[1] = com.maddox.il2.objects.air.I_250.cvt(f, 0.05F, 0.25F, 0.0F, 0.3F);
        xyz[2] = com.maddox.il2.objects.air.I_250.cvt(f, 0.05F, 0.25F, 0.0F, 0.125F);
        hiermesh.chunkSetLocate("GearC3_D0", xyz, ypr);
        hiermesh.chunkSetLocate("GearC4_D0", xyz, ypr);
        if(f < 0.5F)
            hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.02F, 0.4F, 0.0F, -90F), 0.0F);
        else
            hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.72F, 0.98F, -90F, 0.0F), 0.0F);
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.05F, 0.95F, 0.0F, -82F), 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.05F, 0.95F, 0.0F, -82F), 0.0F);
        if(f < 0.5F)
            hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.02F, 0.4F, 0.0F, -90F), 0.0F);
        else
            hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.72F, 0.98F, -90F, 0.0F), 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.25F, 0.9F, 0.0F, -82F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, com.maddox.il2.objects.air.I_250.cvt(f, 0.25F, 0.9F, 0.0F, -82F), 0.0F);
    }
    ...
    {
        hierMesh().chunkSetAngles("GearC2_D0", 0.0F, -com.maddox.il2.objects.air.I_250.cvt(f, -78F, 78F, -78F, 78F), 0.0F);
    }
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                {
                    getEnergyPastArmor(33.959999084472656D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    if(shot.power <= 0.0F)
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 3: // '\003'
                    ...
                    {
                        com.maddox.il2.objects.air.I_250.debugprintln(this, "*** Aileron Controls Crank: Disabled..");
                ...
                case 4: // '\004'
                    ...
                    {
                        com.maddox.il2.objects.air.I_250.debugprintln(this, "*** Aileron Controls: Disabled..");
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                    break;
                ...
                case 6: // '\006'
                    ...
                    {
                        com.maddox.il2.objects.air.I_250.debugprintln(this, "*** Rudder Controls: Disabled / Strings Broken..");
                ...
                case 8: // '\b'
                    ...
                    {
                        com.maddox.il2.objects.air.I_250.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                ...
                case 9: // '\t'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.I_250.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                    }
                    break;
                }
                return;
            ...
            if(s.startsWith("xxeng2"))
            {
                ...
                {
                    com.maddox.il2.objects.air.I_250.debugprintln(this, "*** Engine Module(s): Supercharger Disabled..");
    ...
    protected boolean cutFM(int i, int j, com.maddox.il2.engine.Actor actor)
    {
        ...
        case 19: // '\023'
            ...
            return cut(com.maddox.il2.objects.air.I_250.partNames()[i]);
    ...
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.I_250.cvt(f, 0.01F, 0.99F, 0.0F, -0.6F);
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.I_250.weaponTriggersRegister(class1, new int[] {
            0, 1, 1
        });
        com.maddox.il2.objects.air.I_250.weaponHooksRegister(class1, new java.lang.String[] {
            "_CANNON01", "_CANNON02", "_CANNON03"
        });
        com.maddox.il2.objects.air.I_250.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunB20ki 100", "MGunB20s 100", "MGunB20s 100"
        });
        com.maddox.il2.objects.air.I_250.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null
        });
    }
}
