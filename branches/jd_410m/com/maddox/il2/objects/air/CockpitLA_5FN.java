  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_5FN.this.fm != null) {
        ...
        CockpitLA_5FN.this.setNew.throttle = ((10.0F * CockpitLA_5FN.this.setOld.throttle + CockpitLA_5FN.this.fm.CT.PowerControl) / 11.0F);
        CockpitLA_5FN.this.setNew.prop = ((8.0F * CockpitLA_5FN.this.setOld.prop + CockpitLA_5FN.this.fm.CT.getStepControl()) / 9.0F);
        CockpitLA_5FN.this.setNew.altimeter = CockpitLA_5FN.this.fm.getAltitude();
        if (Math.abs(CockpitLA_5FN.this.fm.Or.getKren()) < 30.0F) {
          CockpitLA_5FN.this.setNew.azimuth = ((35.0F * CockpitLA_5FN.this.setOld.azimuth + -CockpitLA_5FN.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        if (CockpitLA_5FN.this.fm.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitLA_5FN.this.cvt(CockpitLA_5FN.this.fm.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitLA_5FN.this.cvt(CockpitLA_5FN.this.fm.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
        ...
        CockpitLA_5FN.access$502(CockpitLA_5FN.this, 0.8F * CockpitLA_5FN.this.pictStage + 0.1F * CockpitLA_5FN.this.fm.EI.engines[0].getControlCompressor());
      }
      return true;
    }
  }
