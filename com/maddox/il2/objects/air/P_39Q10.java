...
public class P_39Q10 extends P_39
{
  static
  {
    ...
    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunBrowning50si 200", "MGunBrowning50si 200", "MGunM4ki 30", null });

    Aircraft.weaponsRegister(localClass, "1xFAB250", new String[] { "MGunBrowning50si 200", "MGunBrowning50si 200", "MGunM4ki 30", "BombGunFAB250 1" });
