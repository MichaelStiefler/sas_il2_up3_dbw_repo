...
public class PlMisBorn extends Plugin
{
		...
		if (i != 0)
		{
			...
			for (int bpCount = 0; bpCount < i; bpCount++)
			{
				...
				sectfile.lineAdd(bpSectionId, (	"" + 
											...
											ZutiSupportMethods.boolToInt(actorborn.zutiSpawnAcWithFoldedWings) + " " +
			...
			for (int i_19_ = 0; i_19_ < i_18_; i_19_++)
			{
				...
				try
				{
					...
					if(numbertokenizer.next(0, 0, 1) == 0 )
						actorborn.zutiSpawnAcWithFoldedWings = false;
					if(numbertokenizer.next(0, 0, 1) == 1 )
	...
	public void createGUI()
	{
		...
		gwindowdialogclient.addLabel(new GWindowLabel(gwindowdialogclient, 2.0F, 18.0F, 36.0F, 1.3F, Plugin.i18n("mds.properties.showHomeBaseTaxiways"), null));
