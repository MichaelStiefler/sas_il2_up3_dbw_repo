...
public class CockpitFW200_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((FW_200C3U4)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((FW_200C3U4)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW200_Bombardier.this.bEntered) {
        float f1 = ((FW_200C3U4)CockpitFW200_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((FW_200C3U4)CockpitFW200_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitFW200_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitFW200_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
