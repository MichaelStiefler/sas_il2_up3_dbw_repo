// Source File Name: CockpitB17E.java
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB17E.this.fm != null) {
				...
				CockpitB17E.this.setNew.throttle1 = (0.85F * CockpitB17E.this.setOld.throttle1)
						+ (CockpitB17E.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitB17E.this.setNew.throttle2 = (0.85F * CockpitB17E.this.setOld.throttle2)
						+ (CockpitB17E.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitB17E.this.setNew.prop1 = (0.85F * CockpitB17E.this.setOld.prop1)
						+ (CockpitB17E.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitB17E.this.setNew.prop2 = (0.85F * CockpitB17E.this.setOld.prop2)
						+ (CockpitB17E.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitB17E.this.setNew.altimeter = CockpitB17E.this.fm
						.getAltitude();
				float f = CockpitB17E.this.waypointAzimuth();
				CockpitB17E.this.setNew.azimuth.setDeg(
						CockpitB17E.this.setOld.azimuth.getDeg(1.0F),
						CockpitB17E.this.fm.Or.azimut());
				CockpitB17E.this.setNew.waypointAzimuth
						.setDeg(CockpitB17E.this.setOld.waypointAzimuth
								.getDeg(1.0F), f);
				CockpitB17E.this.setNew.waypointDeviation.setDeg(
						CockpitB17E.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitB17E.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitB17E.this.setNew.vspeed = ((199F * CockpitB17E.this.setOld.vspeed) + CockpitB17E.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
