...
public class CockpitMBR_2AM34_Bombardier extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    this.mesh.chunkSetAngles("zMark1", ((MBR_2AM34)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);

    float f = cvt(((MBR_2AM34)aircraft()).fSightSetForwardAngle, -15.0F, 75.0F, -15.0F, 75.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMBR_2AM34_Bombardier.this.bEntered) {
        float f1 = ((MBR_2AM34)CockpitMBR_2AM34_Bombardier.this.aircraft()).fSightCurForwardAngle;

        float f2 = -((MBR_2AM34)CockpitMBR_2AM34_Bombardier.this.aircraft()).fSightCurSideslip;

        CockpitMBR_2AM34_Bombardier.this.mesh.chunkSetAngles("BlackBox", f2, 0.0F, -f1);
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(-f2, CockpitMBR_2AM34_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
  }
