...
public class CockpitG4M1_11 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_TurnBank1", cvt(f2, -5.0F, 5.0F, 8.5F, -8.5F), 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_TurnBank3", cvt(f2, -7.0F, 7.0F, 16.0F, -16.0F), 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_TurnBank5", cvt(f2, -7.0F, 7.0F, 16.0F, -16.0F), 0.0F, 0.0F);
    ...
    float f1 = Atmosphere.temperature((float)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.jdField_z_of_type_Double) - 273.09F + 44.400002F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getPowerOutput();
    if (f1 < 0.0F)
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Temp5", cvt(f1, -40.0F, 0.0F, 0.0F, 45.0F), 0.0F, 0.0F);
    else {
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Temp5", cvt(f1, 0.0F, 60.0F, 45.0F, 90.0F), 0.0F, 0.0F);
    }
    f1 = Atmosphere.temperature((float)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Loc_of_type_ComMaddoxJGPPoint3d.jdField_z_of_type_Double) - 273.09F + 44.400002F * this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getPowerOutput();
    if (f1 < 0.0F)
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Temp6", cvt(f1, -40.0F, 0.0F, 0.0F, 45.0F), 0.0F, 0.0F);
    else {
      this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Temp6", cvt(f1, 0.0F, 60.0F, 45.0F, 90.0F), 0.0F, 0.0F);
    }
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_fuelpress1", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.5F, 0.0F, 180.0F), 0.0F, 0.0F);
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_fuelpress2", cvt(this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.5F, 0.0F, 180.0F), 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitG4M1_11.this.setNew.throttle1 = (0.9F * CockpitG4M1_11.this.setOld.throttle1 + 0.1F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle());
        CockpitG4M1_11.this.setNew.prop1 = (0.9F * CockpitG4M1_11.this.setOld.prop1 + 0.1F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitG4M1_11.this.setNew.mix1 = (0.8F * CockpitG4M1_11.this.setOld.mix1 + 0.2F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitG4M1_11.this.setNew.throttle2 = (0.9F * CockpitG4M1_11.this.setOld.throttle2 + 0.1F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle());
        CockpitG4M1_11.this.setNew.prop2 = (0.9F * CockpitG4M1_11.this.setOld.prop2 + 0.1F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp());
        CockpitG4M1_11.this.setNew.mix2 = (0.8F * CockpitG4M1_11.this.setOld.mix2 + 0.2F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlMix());
        CockpitG4M1_11.this.setNew.man1 = (0.92F * CockpitG4M1_11.this.setOld.man1 + 0.08F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getManifoldPressure());
        CockpitG4M1_11.this.setNew.man2 = (0.92F * CockpitG4M1_11.this.setOld.man2 + 0.08F * CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getManifoldPressure());
        CockpitG4M1_11.this.setNew.altimeter = CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();

        CockpitG4M1_11.this.setNew.azimuth.setDeg(CockpitG4M1_11.this.setOld.azimuth.getDeg(1.0F), CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());

        CockpitG4M1_11.this.setNew.vspeed = ((199.0F * CockpitG4M1_11.this.setOld.vspeed + CockpitG4M1_11.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
