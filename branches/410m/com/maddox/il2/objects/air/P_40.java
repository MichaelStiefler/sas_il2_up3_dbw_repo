    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    protected void moveGear(float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, f1, 0.0F);
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 90F * f, 0.0F);
        float f2 = com.maddox.il2.objects.air.P_40.cvt(f, 0.0F, 0.7F, 0.0F, 1.0F);
        ...
        f2 = com.maddox.il2.objects.air.P_40.cvt(f, 0.2F, 1.0F, 0.0F, 1.0F);
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.P_40.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.17F, 0.0F, -0.1689F);
            ...
            if(s.startsWith("xxcontrols"))
                if(s.endsWith("1"))
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.3F)
                    {
                        ...
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Engine Controls Out..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.3F)
                    {
                ...
                if(s.endsWith("2"))
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Evelator Controls Out..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        FM.AS.setControlsDamage(shot.initiator, 0);
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Ailerones Controls Out..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Rudder Controls Out..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.3F)
                    {
                        FM.AS.setEngineSpecificDamage(shot.initiator, 0, 6);
            ...
            if(s.startsWith("xxeng1"))
            {
                ...
                if(s.endsWith("cas") && getEnergyPastArmor(0.7F, shot) > 0.0F)
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat(20000F, 200000F) < shot.power)
                    {
                        ...
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Engine Crank Case Hit - Engine Stucks..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat(10000F, 50000F) < shot.power)
                    {
                        FM.AS.hitEngine(shot.initiator, 0, 2);
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Engine Crank Case Hit - Engine Damaged..");
                    }
                    if(com.maddox.il2.ai.World.Rnd().nextFloat(8000F, 28000F) < shot.power)
                    {
                        FM.EI.engines[0].setCyliderKnockOut(shot.initiator, 1);
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Engine Crank Case Hit - Cylinder Feed Out, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                    }
                    ...
                    com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Engine Crank Case Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                }
                if(s.endsWith("cyl") && getEnergyPastArmor(0.45F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 1.75F)
                {
                    ...
                    com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Engine Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                    if(FM.AS.astateEngineStates[0] < 1)
                        FM.AS.hitEngine(shot.initiator, 0, 1);
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 24000F)
                    {
                        FM.AS.hitEngine(shot.initiator, 0, 3);
                        com.maddox.il2.objects.air.P_40.debugprintln(this, "*** Engine Cylinders Hit - Engine Fires..");
                    }
    ...
    {
        float f1 = com.maddox.il2.objects.air.P_40.cvt(FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 27F, -11F);
