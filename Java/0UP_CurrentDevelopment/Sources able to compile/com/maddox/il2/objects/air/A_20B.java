    ...
    implements TypeBomber, TypeStormovik
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = A_20B.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= A_20B.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / A_20B.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)A_20B.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(A_20B.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = A_20B.class;
        ...
        Aircraft.weaponsRegister(class1, "8x100lbs", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "6x250lbs", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "4x500lbs", new java.lang.String[] {
        ...
        Aircraft.weaponsRegister(class1, "1x1000lbs", new java.lang.String[] {
            "MGunBrowning303kipzl 500", "MGunBrowning303kipzl 500", "MGunBrowning303kipzl 500", "MGunBrowning303kipzl 500", "MGunBrowning303t 500", "MGunBrowning303t 500", null, null, null, null, 
            "BombGun1000lbs 1"
        });
