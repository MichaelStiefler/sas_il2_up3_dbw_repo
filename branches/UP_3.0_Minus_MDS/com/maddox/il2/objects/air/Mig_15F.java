...
;
    ...
    {
        com.maddox.il2.objects.air.Mig_15F.moveGear(((com.maddox.il2.engine.ActorHMesh)this).hierMesh(), paramFloat);
    }
    ...
    public void soundbarier()
    {
        ...
        if(((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).VmaxAllowed > 1300F)
            ((com.maddox.il2.objects.sounds.SndAircraft)this).FM.VmaxAllowed = 1300F;
    ...
    private final void umnr()
    {
        ...
        Mig_15F.mn = f / com.maddox.il2.fm.Atmosphere.sonicSpeed((float)((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft)this).FM)).Loc)).z);
        if(mn >= lteb)
            ts = true;
        else
            ts = false;
