...
public class CockpitBattleMkII extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (((BattleMkII)aircraft()).jdField_bChangedPit_of_type_Boolean)
    {
      reflectPlaneToModel();
      ((BattleMkII)aircraft()).jdField_bChangedPit_of_type_Boolean = false;
    }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitBattleMkII.this.bNeedSetUp)
      {
        CockpitBattleMkII.this.reflectPlaneMats();
        CockpitBattleMkII.access$002(CockpitBattleMkII.this, false);
      }
      if (((BattleMkII)CockpitBattleMkII.this.aircraft()).jdField_bChangedPit_of_type_Boolean)
      {
        CockpitBattleMkII.this.reflectPlaneToModel();
        ((BattleMkII)CockpitBattleMkII.this.aircraft()).jdField_bChangedPit_of_type_Boolean = false;
      }
      CockpitBattleMkII.access$102(CockpitBattleMkII.this, CockpitBattleMkII.this.setOld);
      CockpitBattleMkII.access$202(CockpitBattleMkII.this, CockpitBattleMkII.this.setNew);
      CockpitBattleMkII.access$302(CockpitBattleMkII.this, CockpitBattleMkII.this.setTmp);
      if (((CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.AS.astateCockpitState & 0x2) != 0) && (CockpitBattleMkII.this.setNew.stbyPosition < 1.0F))
      {
        CockpitBattleMkII.this.setNew.stbyPosition = (CockpitBattleMkII.this.setOld.stbyPosition + 0.0125F);
        CockpitBattleMkII.this.setOld.stbyPosition = CockpitBattleMkII.this.setNew.stbyPosition;
      }
      CockpitBattleMkII.this.setNew.altimeter = CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
      if (Math.abs(CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F)
        CockpitBattleMkII.this.setNew.azimuth = ((21.0F * CockpitBattleMkII.this.setOld.azimuth + CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 22.0F);
      if ((CockpitBattleMkII.this.setOld.azimuth > 270.0F) && (CockpitBattleMkII.this.setNew.azimuth < 90.0F))
        CockpitBattleMkII.this.setOld.azimuth -= 360.0F;
      if ((CockpitBattleMkII.this.setOld.azimuth < 90.0F) && (CockpitBattleMkII.this.setNew.azimuth > 270.0F))
        CockpitBattleMkII.this.setOld.azimuth += 360.0F;
      CockpitBattleMkII.this.setNew.throttle = ((10.0F * CockpitBattleMkII.this.setOld.throttle + CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle()) / 11.0F);
      CockpitBattleMkII.this.setNew.mix = ((10.0F * CockpitBattleMkII.this.setOld.mix + CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix()) / 11.0F);
      CockpitBattleMkII.this.setNew.prop = CockpitBattleMkII.this.setOld.prop;
      if (CockpitBattleMkII.this.setNew.prop < CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() - 0.01F)
        CockpitBattleMkII.this.setNew.prop += 0.0025F;
      if (CockpitBattleMkII.this.setNew.prop > CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() + 0.01F)
        CockpitBattleMkII.this.setNew.prop -= 0.0025F;
      CockpitBattleMkII.this.w.set(CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getW());
      CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.transform(CockpitBattleMkII.this.w);
      CockpitBattleMkII.this.setNew.turn = ((12.0F * CockpitBattleMkII.this.setOld.turn + CockpitBattleMkII.this.w.z) / 13.0F);
      CockpitBattleMkII.this.setNew.vspeed = ((199.0F * CockpitBattleMkII.this.setOld.vspeed + CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      CockpitBattleMkII.access$502(CockpitBattleMkII.this, 0.8F * CockpitBattleMkII.this.pictSupc + 0.2F * CockpitBattleMkII.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlCompressor());
      return true;
    }
  ...
  private class Variables
  {
    ...
    private final CockpitBattleMkII this$0;
    ...
    Variables(CockpitBattleMkII.1 arg2)
    {
      this();
    }
  }
