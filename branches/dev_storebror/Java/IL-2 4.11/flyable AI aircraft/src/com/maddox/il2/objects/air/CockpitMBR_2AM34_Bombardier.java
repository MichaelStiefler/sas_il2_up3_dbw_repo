...
public class CockpitMBR_2AM34_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitMBR_2AM34_Bombardier.this.bEntered) {
				float f = ((MBR_2AM34) CockpitMBR_2AM34_Bombardier.this
						.aircraft()).fSightCurForwardAngle;
				float f1 = -((MBR_2AM34) CockpitMBR_2AM34_Bombardier.this
						.aircraft()).fSightCurSideslip;
				CockpitMBR_2AM34_Bombardier.this.mesh.chunkSetAngles(
						"BlackBox", f1, 0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitMBR_2AM34_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((MBR_2AM34) this.aircraft()).fSightCurForwardAngle * 3.675F,
				0.0F, 0.0F);
		float f1 = this.cvt(
				((MBR_2AM34) this.aircraft()).fSightSetForwardAngle, -15F, 75F,
				-15F, 75F);
