...
// Source File Name:   CockpitAT6.java
...
public class CockpitAT6 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    {
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.7F);
        ...
        mesh.chunkSetAngles("Z_FuelPres1", 0.0F, cvt(fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.3F, 0.0F, -180F), 0.0F);
        ...
        {
            resetYPRmodifier();
            com.maddox.il2.objects.air.Cockpit.xyz[0] = -0.133F * fm.CT.getGear();
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[0] = -0.118F * fm.CT.getFlap();
        mesh.chunkSetLocate("Z_Flap1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        mesh.chunkSetAngles("Z_EnginePrim", 0.0F, fm.EI.engines[0].getStage() > 0 ? -36F : 0.0F, 0.0F);
