...
// Source File Name:   CockpitI_15.java
...
//            CockpitPilot, I_153P, Aircraft, I_153_M62

public class CockpitI_15 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if((com.maddox.il2.objects.air.I_153_M62)aircraft() == null);
            if(com.maddox.il2.objects.air.I_153_M62.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.I_153_M62)aircraft() == null);
                com.maddox.il2.objects.air.I_153_M62.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
    ...
    public CockpitI_15()
    {
        ...
        for(int i = 0; i < 4; i++)
        {
            com.maddox.il2.engine.HookNamed hooknamed = new HookNamed(((com.maddox.il2.engine.Mesh) (mesh)), "_light0" + (i + 1));
            ...
            pos.base().draw.lightMap().put(((java.lang.Object) ("_light0" + (i + 1))), ((java.lang.Object) (lights[i])));
        }
    ...
    protected void reflectPlaneMats()
    {
        ...
        if(aircraft() instanceof com.maddox.il2.objects.air.I_153P)
