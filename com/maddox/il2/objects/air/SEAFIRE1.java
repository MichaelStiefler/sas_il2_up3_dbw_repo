...
public class SEAFIRE1 extends SPITFIRE
{
  ...
  static
  {
    Class localClass = SEAFIRE1.class;
    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Seafire");
    Property.set(localClass, "meshName", "3DO/Plane/SeafireMkI(Multi1)/hier.him");
    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar03());
    Property.set(localClass, "meshName_gb", "3DO/Plane/SeafireMkI(GB)/hier.him");
    ...
    Property.set(localClass, "FlightModel", "FlightModels/SeafireI.fmd");
    ...
    Aircraft.weaponHooksRegister(localClass, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02", "_ExternalDev01" });
    try
    {
