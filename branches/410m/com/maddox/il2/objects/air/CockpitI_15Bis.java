...
//            CockpitPilot, Aircraft, I_15xyz

public class CockpitI_15Bis extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if((com.maddox.il2.objects.air.I_15xyz)aircraft() == null);
            if(com.maddox.il2.objects.air.I_15xyz.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.I_15xyz)aircraft() == null);
                com.maddox.il2.objects.air.I_15xyz.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
            ...
            if(((com.maddox.il2.objects.air.I_15xyz)aircraft()).blisterRemoved)
            {
    ...
    {
        com.maddox.il2.engine.hotkey.HookPilot hookpilot = com.maddox.il2.engine.hotkey.HookPilot.current;
        hookpilot.setAim(new Point3d(0.18400000035762787D, -0.0043999999761581421D, 0.84810000658035278D));
        hookpilot.doAim(true);
        bEntered = true;
    ...
    static 
    {
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitHS_129.class, "normZN", 0.95F);
        com.maddox.rts.Property.set(com.maddox.il2.objects.air.CockpitHS_129.class, "gsZN", 0.95F);
    }
