...
public class RocketRS132 extends Rocket
{
  ...
  protected void doExplosion(Actor paramActor, String paramString)
  {
    ...
    MsgExplosion.send(paramActor, paramString, p, getOwner(), 10.1F, 2.1F, 1, 500.0F);
    super.doExplosion(paramActor, paramString);
  }
  protected void doExplosionAir() {
    this.jdField_pos_of_type_ComMaddoxIl2EngineActorPos.getTime(Time.current(), p);
    MsgExplosion.send(null, null, p, getOwner(), 10.1F, 2.1F, 1, 500.0F);
    super.doExplosionAir();
  }

  static
  {
    Class localClass = RocketRS132.class;
