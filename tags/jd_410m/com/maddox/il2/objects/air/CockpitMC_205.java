...
public class CockpitMC_205 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_Throttle", -49.540001F * interp(this.setNew.throttle, this.setOld.throttle, paramFloat), 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_PropPitch1", -61.5F * interp(this.setNew.prop, this.setOld.prop, paramFloat), 0.0F, 0.0F);
    ...
    if (f < 0.0F) f += 360.0F;
    this.mesh.chunkSetAngles("Z_Compass1", f, 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_ManfoldPress", -(this.pictManf = 0.9F * this.pictManf + 0.1F * cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.5F, 2.0F, 0.0F, -300.0F)), 0.0F, 0.0F);
    ...
    resetYPRmodifier();
    xyz[1] = cvt(this.fm.M.fuel, 0.0F, 252.0F, 0.0F, 0.3661F);
    this.mesh.chunkSetLocate("Z_FuelQuantity1", xyz, ypr);
    resetYPRmodifier();
    ...
    this.mesh.chunkVisible("XLampSPIA", this.fm.EI.engines[0].getRPM() < 1200.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMC_205.this.fm != null) {
        ...
        CockpitMC_205.this.setNew.vspeed = ((199.0F * CockpitMC_205.this.setOld.vspeed + CockpitMC_205.this.fm.getVertSpeed()) / 200.0F);
      }
