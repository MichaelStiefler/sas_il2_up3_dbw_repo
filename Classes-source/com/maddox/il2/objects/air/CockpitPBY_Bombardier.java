...
public class CockpitPBY_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    {
        super.mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.PBY)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.PBY)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
