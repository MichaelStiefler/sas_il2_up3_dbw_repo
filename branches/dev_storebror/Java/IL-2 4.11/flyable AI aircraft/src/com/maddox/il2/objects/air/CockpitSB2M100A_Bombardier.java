...
public class CockpitSB2M100A_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitSB2M100A_Bombardier.this.bEntered) {
				float f = ((SB_2M100A) CockpitSB2M100A_Bombardier.this
						.aircraft()).fSightCurForwardAngle;
				float f1 = -((SB_2M100A) CockpitSB2M100A_Bombardier.this
						.aircraft()).fSightCurSideslip;
				CockpitSB2M100A_Bombardier.this.mesh.chunkSetAngles("BlackBox",
						f1, 0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitSB2M100A_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((SB_2M100A) this.aircraft()).fSightCurForwardAngle * 3.675F,
				0.0F, 0.0F);
		float f1 = this.cvt(
				((SB_2M100A) this.aircraft()).fSightSetForwardAngle, -15F, 75F,
				-15F, 75F);
