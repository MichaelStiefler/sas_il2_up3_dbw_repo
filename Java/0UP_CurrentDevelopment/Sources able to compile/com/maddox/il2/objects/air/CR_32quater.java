    ...
    implements TypeFighter, TypeTNBFighter
{
        ...
        if(s.startsWith("xx"))
        {
            ...
            } else
            {
                ...
                if(s.startsWith("xxspar"))
                {
                    ...
                    if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(3.5F / (float)java.lang.Math.sqrt(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).y * ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).y + ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z * ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z), shot) > 0.0F)
                    {
    ...
    static 
    {
        java.lang.Class class1 = CR_32quater.class;
        ...
        Aircraft.weaponsRegister(class1, "2x50Kg_Bombs", new java.lang.String[] {
            "MGunBredaSAFAT127si 350", "MGunBredaSAFAT127si 350", "BombGun50kg 1", "BombGun50kg 1"
        });
        Aircraft.weaponsRegister(class1, "1x100Kg_Bomb", new java.lang.String[] {
            "MGunBredaSAFAT127si 350", "MGunBredaSAFAT127si 350", "BombGun100kg 1", null
        });
        Aircraft.weaponsRegister(class1, "2_Cassette", new java.lang.String[] {
