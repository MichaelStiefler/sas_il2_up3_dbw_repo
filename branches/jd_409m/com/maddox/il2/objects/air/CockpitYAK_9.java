...
public class CockpitYAK_9 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("richag", 0.0F, this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getAileron() * 15.0F, this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.getElevator() * 10.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkVisible("Z_Green1", false);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel = World.getPlayerFM();
      if (CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitYAK_9.access$102(CockpitYAK_9.this, CockpitYAK_9.this.setOld); CockpitYAK_9.access$202(CockpitYAK_9.this, CockpitYAK_9.this.setNew); CockpitYAK_9.access$302(CockpitYAK_9.this, CockpitYAK_9.this.setTmp);

        CockpitYAK_9.this.setNew.throttle = ((10.0F * CockpitYAK_9.this.setOld.throttle + CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitYAK_9.this.setNew.prop = ((10.0F * CockpitYAK_9.this.setOld.prop + CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.EI.engines[0].getControlProp()) / 11.0F);
        CockpitYAK_9.this.setNew.altimeter = CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitYAK_9.this.setNew.azimuth = ((35.0F * CockpitYAK_9.this.setOld.azimuth + CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.azimut()) / 36.0F);
        }
        if ((CockpitYAK_9.this.setOld.azimuth > 270.0F) && (CockpitYAK_9.this.setNew.azimuth < 90.0F)) CockpitYAK_9.this.setOld.azimuth -= 360.0F;
        if ((CockpitYAK_9.this.setOld.azimuth < 90.0F) && (CockpitYAK_9.this.setNew.azimuth > 270.0F)) CockpitYAK_9.this.setOld.azimuth += 360.0F;
        CockpitYAK_9.this.setNew.vspeed = ((199.0F * CockpitYAK_9.this.setOld.vspeed + CockpitYAK_9.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
      }
  ...
  private class Variables
  {
    ...
    float azimuth;
    float vspeed;
    private final CockpitYAK_9 this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitYAK_9.1 arg2) { this();
    }
  }
}