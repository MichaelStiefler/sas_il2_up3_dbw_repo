...
public class CockpitBF_109Ex extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Throttle", interp(this.setNew.throttle, this.setOld.throttle, paramFloat) * 57.727272F, 0.0F, 0.0F);
    ...
    this.jdField_mesh_of_type_ComMaddoxIl2EngineHierMesh.chunkSetAngles("Z_Throttle_tube", -interp(this.setNew.throttle, this.setOld.throttle, paramFloat) * 57.727272F, 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      if ((CockpitBF_109Ex.this.setOld.azimuth > 270.0F) && (CockpitBF_109Ex.this.setNew.azimuth < 90.0F)) CockpitBF_109Ex.this.setOld.azimuth -= 360.0F;
      if ((CockpitBF_109Ex.this.setOld.azimuth < 90.0F) && (CockpitBF_109Ex.this.setNew.azimuth > 270.0F)) CockpitBF_109Ex.this.setOld.azimuth += 360.0F;
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitBF_109Ex.1 arg2) { this();
    }
  }
}