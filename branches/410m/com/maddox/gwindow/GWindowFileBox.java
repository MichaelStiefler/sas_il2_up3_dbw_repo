...
//            GSize, GWindowDialogControl, GWin95LookAndFeel, GWindowHScrollBar, 
//            GBevel, GFont
...
public class GWindowFileBox extends com.maddox.gwindow.GWindowFramed
{
    ...
    public GWindowFileBox(com.maddox.gwindow.GWindow gwindow, boolean flag, java.lang.String s, java.lang.String s1, com.maddox.gwindow.GFileFilter agfilefilter[])
    {
        ...
        iResult = -1;
        com.maddox.rts.SectFile sectfile = new SectFile("bldconf.ini");
        java.lang.String s2 = sectfile.get("builder config", "defFullDX");
        if(s2 != null)
            defFullDX = java.lang.Float.parseFloat(s2);
        s2 = sectfile.get("builder config", "defFullDY");
        if(s2 != null)
            defFullDY = java.lang.Float.parseFloat(s2);
