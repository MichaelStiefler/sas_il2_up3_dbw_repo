...
public class CR_42 extends CR_42X
{
  static
  {
    ...
    Aircraft.weaponsRegister(localClass, "default", new String[] { "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", null, null });

    Aircraft.weaponsRegister(localClass, "2sc50", new String[] { "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGunSC50 1", "BombGunSC50 1" });

    Aircraft.weaponsRegister(localClass, "2sc70", new String[] { "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGunSC70 1", "BombGunSC70 1" });

    Aircraft.weaponsRegister(localClass, "2x50", new String[] { "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGun50kg 1", "BombGun50kg 1" });

    Aircraft.weaponsRegister(localClass, "2x100", new String[] { "MGunBredaSAFAT127si 400", "MGunBredaSAFAT127si 400", "BombGun100kg 1", "BombGun100kg 1" });
