...
public class CockpitBLENHEIM4_Bombardier extends CockpitPilot
{
    ...
    {
        mesh.chunkSetAngles("zMark1", ((BLENHEIM4)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((BLENHEIM4)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
