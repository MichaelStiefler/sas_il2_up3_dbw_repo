...
// Source File Name:   CockpitLA_5FN.java
...
public class CockpitLA_5FN extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("CStick5FN", 0.0F, (pictAiler = 0.85F * pictAiler + 0.15F * fm.CT.AileronControl) * 15F, (pictElev = 0.85F * pictElev + 0.15F * fm.CT.ElevatorControl) * 10F);
        mesh.chunkSetAngles("PriTrigger", fm.CT.WeaponControl[1] ? -30F : 0.0F, 0.0F, 0.0F);
        mesh.chunkSetAngles("SecTrigger", fm.CT.WeaponControl[0] ? -30F : 0.0F, 0.0F, 0.0F);
        mesh.chunkSetAngles("WheelBrake", 20F * fm.CT.BrakeControl, 0.0F, 0.0F);
    ...
    public void reflectCockpitState()
    {
        ...
        {
            mesh.chunkVisible("PBP-1", false);
            mesh.chunkVisible("PBP-1_D0", true);
