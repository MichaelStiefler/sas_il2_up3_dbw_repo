...
// Source File Name:   SN2bGeneric.java
...
public abstract class SN2bGeneric extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.SN2bGeneric.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SN2bGeneric.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.SN2bGeneric sn2bgeneric = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.SN2bGeneric.constr_arg2 = actorspawnarg;
                sn2bgeneric = (com.maddox.il2.objects.vehicles.stationary.SN2bGeneric)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.SN2bGeneric.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create SN2bGeneric object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (sn2bgeneric));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.SN2bGeneric.mesh_name);
            cls = class1;
    ...
    private SN2bGeneric(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
    ...
    private boolean danger()
    {
        ...
        for(int k = 100; !flag && k <= 4000; k += 100)
        {
            ...
            {
                actor2 = (com.maddox.il2.engine.Actor)entry.getValue();
                if((actor2 instanceof com.maddox.il2.objects.air.Aircraft) && actor2 != com.maddox.il2.ai.World.getPlayerAircraft() && actor2.getArmy() != myArmy && actor2.getSpeed(vector3d) > 20D)
                {
                    double d3 = com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsX() + actor2.pos.getAbsPoint().x;
                    double d4 = com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsY() + actor2.pos.getAbsPoint().y;
                    double d5 = com.maddox.il2.game.Main3D.cur3D().land2D.worldOfsY() + actor2.pos.getAbsPoint().z;
                    double d6 = d3 - d;
                    double d7 = d4 - d1;
                    double d8 = (int)(java.lang.Math.ceil((d2 - d5) / 10D) * 10D);
                    float f = 57.32484F * (float)java.lang.Math.atan2(d7, -d6);
                    int l = (int)(java.lang.Math.floor((int)f) - 90D);
                    if(l < 0)
                        l = 360 + l;
                    int i1 = l - i;
                    double d9 = d - d3;
                    ...
                    int j1 = (int)(java.lang.Math.ceil(java.lang.Math.sqrt(d10 * d10 + d9 * d9) / 10D) * 10D);
                    float f1 = 57.32484F * (float)java.lang.Math.atan2(j1, d11);
                    int k1 = (int)(java.lang.Math.floor((int)f1) - 90D);
                    if(k1 < 0)
                        k1 = 360 + k1;
                    int l1 = k1 - j;
                    if(j1 <= k && (double)j1 >= 200D && l1 >= 220 && l1 <= 320 && java.lang.Math.sqrt(i1 * i1) <= 60D)
                    {
                        ...
                        if((d2 - d5) + 200D < 0.0D)
                            s = "above us";
                        int i2 = j1;
                        java.lang.String s1 = "m";
                        if(i2 >= 1000)
                        {
                            i2 = (int)java.lang.Math.floor(i2 / 1000);
                            s1 = "km";
                        }
                        com.maddox.il2.game.HUD.logCenter("                                          RO: Target bearing " + l + "\260" + ", range " + i2 + s1 + ", " + s);
                        flag = true;
                    }
                }
            }
    ...
    private static com.maddox.il2.engine.Actor actor2 = null;
