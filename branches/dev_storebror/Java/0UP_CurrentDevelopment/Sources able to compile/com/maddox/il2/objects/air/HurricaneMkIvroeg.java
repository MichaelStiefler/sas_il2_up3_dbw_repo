    ...
    implements TypeFighter
{
    ...
    {
        HurricaneMkIvroeg.moveGear(hierMesh(), f);
    }
    ...
    {
        resetYPRmodifier();
        Aircraft.xyz[2] = -Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.gWheelSinking[0], 0.0F, 0.25F, 0.0F, 0.25F);
        hierMesh().chunkSetLocate("GearL10_D0", Aircraft.xyz, Aircraft.ypr);
        Aircraft.xyz[2] = Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, 0.25F);
    ...
    static 
    {
        java.lang.Class class1 = HurricaneMkIvroeg.class;
