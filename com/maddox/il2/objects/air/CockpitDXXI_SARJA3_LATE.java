...
public class CockpitDXXI_SARJA3_LATE extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (((DXXI_SARJA3_LATE)aircraft()).bChangedPit)
    {
      reflectPlaneToModel();
      ((DXXI_SARJA3_LATE)aircraft()).bChangedPit = false;
    }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      if (((CockpitDXXI_SARJA3_LATE.this.fm.AS.astateCockpitState & 0x2) != 0) && (CockpitDXXI_SARJA3_LATE.this.setNew.stbyPosition < 1.0F))
      {
      ...
      CockpitDXXI_SARJA3_LATE.this.setNew.throttle = ((10.0F * CockpitDXXI_SARJA3_LATE.this.setOld.throttle + CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlThrottle()) / 11.0F);

      CockpitDXXI_SARJA3_LATE.this.setNew.mix = ((10.0F * CockpitDXXI_SARJA3_LATE.this.setOld.mix + CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlMix()) / 11.0F);
      ...
      CockpitDXXI_SARJA3_LATE.this.setNew.vspeed = ((299.0F * CockpitDXXI_SARJA3_LATE.this.setOld.vspeed + CockpitDXXI_SARJA3_LATE.this.fm.getVertSpeed()) / 300.0F);
      CockpitDXXI_SARJA3_LATE.access$702(CockpitDXXI_SARJA3_LATE.this, 0.8F * CockpitDXXI_SARJA3_LATE.this.pictSupc + 0.2F * CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlCompressor());
      ...
      else if (CockpitDXXI_SARJA3_LATE.this.flaps < CockpitDXXI_SARJA3_LATE.this.fm.CT.getFlap())
      {
        ...
        CockpitDXXI_SARJA3_LATE.access$802(CockpitDXXI_SARJA3_LATE.this, CockpitDXXI_SARJA3_LATE.this.fm.CT.getFlap());
