...
public class CockpitSpit5C extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        CockpitSpit5C.access$102(CockpitSpit5C.this, CockpitSpit5C.this.setOld); CockpitSpit5C.access$202(CockpitSpit5C.this, CockpitSpit5C.this.setNew); CockpitSpit5C.access$302(CockpitSpit5C.this, CockpitSpit5C.this.setTmp);

        CockpitSpit5C.this.setNew.throttle = (0.92F * CockpitSpit5C.this.setOld.throttle + 0.08F * CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl);
        CockpitSpit5C.this.setNew.prop = (0.92F * CockpitSpit5C.this.setOld.prop + 0.08F * CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitSpit5C.this.setNew.mix = (0.92F * CockpitSpit5C.this.setOld.mix + 0.08F * CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitSpit5C.this.setNew.altimeter = CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        if (Math.abs(CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getKren()) < 30.0F) {
          CockpitSpit5C.this.setNew.azimuth = (0.97F * CockpitSpit5C.this.setOld.azimuth + 0.03F * -CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_Or_of_type_ComMaddoxIl2EngineOrientation.getYaw());
        }
        if ((CockpitSpit5C.this.setOld.azimuth > 270.0F) && (CockpitSpit5C.this.setNew.azimuth < 90.0F)) CockpitSpit5C.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit5C.this.setOld.azimuth < 90.0F) && (CockpitSpit5C.this.setNew.azimuth > 270.0F)) CockpitSpit5C.this.setOld.azimuth += 360.0F;
        CockpitSpit5C.this.setNew.waypointAzimuth = (0.91F * CockpitSpit5C.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit5C.this.waypointAzimuth() - CockpitSpit5C.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitSpit5C.this.setNew.vspeed = (0.99F * CockpitSpit5C.this.setOld.vspeed + 0.01F * CockpitSpit5C.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed());
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    private final CockpitSpit5C this$0;

    private Variables()
    {
      this.this$0 = this$1; } 
    Variables(CockpitSpit5C.1 arg2) { this();
    }
  }
}