...
public class CockpitDB3M_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitDB3M_Bombardier.this.bEntered) {
				float f = ((IL_4_DB3M) CockpitDB3M_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((IL_4_DB3M) CockpitDB3M_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitDB3M_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1,
						0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitDB3M_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((IL_4_DB3M) this.aircraft()).fSightCurForwardAngle * 3.675F,
				0.0F, 0.0F);
		float f1 = this.cvt(
				((IL_4_DB3M) this.aircraft()).fSightSetForwardAngle, -15F, 75F,
				-15F, 75F);
