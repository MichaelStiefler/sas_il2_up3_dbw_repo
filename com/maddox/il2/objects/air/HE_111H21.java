...
public class HE_111H21 extends HE_111
{
  ...
  static
  {
    Class localClass = HE_111H21.class;
    ...
    Property.set(localClass, "FlightModel", "FlightModels/He-111H-21.fmd");
    ...
    try
    {
      ...
      arrayOf_WeaponSlot[6] = null;
      arrayOf_WeaponSlot[7] = null;
      arrayOf_WeaponSlot[8] = new Aircraft._WeaponSlot(3, "RocketGunPC1000RS", 1);
      arrayOf_WeaponSlot[9] = null;
      localArrayList.add(str);
      localHashMapInt.put(Finger.Int(str), arrayOf_WeaponSlot);
      str = "2xTorp";
