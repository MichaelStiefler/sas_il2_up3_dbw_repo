...
//            TypeStormovikArmored, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeStormovikArmored
{
    ...
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.IL_2.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.08F, 0.0F, 0.08F);
        hierMesh().chunkSetLocate("GearL9_D0", xyz, ypr);
        xyz[2] = com.maddox.il2.objects.air.IL_2.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.08F, 0.0F, 0.08F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.startsWith("xxarmorp"))
                {
                    ...
                    case 1: // '\001'
                        getEnergyPastArmor(7.070000171661377D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                        shot.powerType = 0;
                        break;

                    case 2: // '\002'
                    case 3: // '\003'
                        getEnergyPastArmor(5.0500001907348633D / (java.lang.Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
                        shot.powerType = 0;
                    ...
                    case 4: // '\004'
                        ...
                        {
                            getEnergyPastArmor(5.0500001907348633D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                            shot.powerType = 0;
                            if(shot.power <= 0.0F && java.lang.Math.abs(v1.x) > 0.86599999666213989D)
                                doRicochet(shot);
                        } else
                        {
                            getEnergyPastArmor(5.0500001907348633D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                        }
                        break;

                    case 5: // '\005'
                    case 6: // '\006'
                        getEnergyPastArmor(20.200000762939453D / (java.lang.Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
                        if(shot.power > 0.0F)
                            break;
                ...
                if(s.startsWith("xxarmort1"))
                    getEnergyPastArmor(6.059999942779541D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if(s.startsWith("xxsparlm"))
                    ...
                    if(chunkDamageVisible("WingLMid") > 2 && (double)com.maddox.il2.ai.World.Rnd().nextFloat() > java.lang.Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                    {
                ...
                if(s.startsWith("xxsparrm"))
                    ...
                    if(chunkDamageVisible("WingRMid") > 2 && (double)com.maddox.il2.ai.World.Rnd().nextFloat() > java.lang.Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                    {
                ...
                if(s.startsWith("xxsparlo"))
                    ...
                    if(chunkDamageVisible("WingLOut") > 2 && (double)com.maddox.il2.ai.World.Rnd().nextFloat() > java.lang.Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                    {
                ...
                if(s.startsWith("xxsparro"))
                    ...
                    if(chunkDamageVisible("WingROut") > 2 && (double)com.maddox.il2.ai.World.Rnd().nextFloat() > java.lang.Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                    {
                        debuggunnery("Spar Construction: WingROut Spar Hit, Breaking in Half..");
                        nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                    }
                if(s.startsWith("xxsparsl") && chunkDamageVisible("StabL") > 1 && getEnergyPastArmor(6.5D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    debuggunnery("Spar Construction: StabL Spar Hit, Breaking in Half..");
                    nextDMGLevels(1, 2, "StabL_D2", shot.initiator);
                }
                if(s.startsWith("xxsparsr") && chunkDamageVisible("StabR") > 1 && getEnergyPastArmor(6.5D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    debuggunnery("Spar Construction: StabL Spar Hit, Breaking in Half..");
        ...
        if(s.startsWith("xoil"))
        {
            ...
            {
                getEnergyPastArmor(0.20000000298023224D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                if(shot.power <= 0.0F)
                    doRicochetBack(shot);
            } else
            {
        ...
        {
            if(point3d.z > 0.159D)
                getEnergyPastArmor((double)(1.25F * com.maddox.il2.ai.World.Rnd().nextFloat(0.95F, 1.12F)) / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
            else
            if(point3d.x > 1.335D && point3d.x < 2.3860000000000001D && point3d.z > -0.059999999999999998D && point3d.z < 0.064000000000000001D)
                getEnergyPastArmor(0.5D / (java.lang.Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
            else
            if(point3d.x > 2.5299999999999998D && point3d.x < 2.992D && point3d.z > -0.23499999999999999D && point3d.z < 0.010999999999999999D)
                getEnergyPastArmor(4.0399999618530273D / (java.lang.Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
            else
            if(point3d.x > 2.5590000000000002D && point3d.z < -0.59499999999999997D)
                getEnergyPastArmor(4.0399999618530273D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
            else
