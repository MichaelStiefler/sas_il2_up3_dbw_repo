...
public class CockpitF9F2 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.99F, -0.52F, 0.0F);
        ...
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getRudder(), -1F, 1.0F, -0.035F, 0.035F);
        super.mesh.chunkSetLocate("Pedal_L", Cockpit.xyz, Cockpit.ypr);
        ...
        super.mesh.chunkSetLocate("Throttle", Cockpit.xyz, Cockpit.ypr);
        if(((com.maddox.il2.fm.FlightModelMain) (super.fm)).AS.astateEngineStates[0] > 2 && (((com.maddox.il2.engine.Interpolate) (super.fm)).actor instanceof CockpitF9F2))
        {
