...
//            Scheme1, MIG_3U, TypeFighter, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Armor: Hit..");
                if(s.endsWith("p1"))
                    getEnergyPastArmor(9.1000003814697266D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p2"))
                    getEnergyPastArmor(9.1000003814697266D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else
                ...
                if(s.endsWith("t3"))
                    getEnergyPastArmor(6.1999998092651367D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-006D), shot);
                else
                if(s.endsWith("t4"))
                    getEnergyPastArmor(6.1999998092651367D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-006D), shot);
                return;
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 1: // '\001'
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                ...
                case 3: // '\003'
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Rudder Controls: Disabled / Strings Broken..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                    }
                    break;
                ...
                case 4: // '\004'
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Elevator Controls: Disabled..");
                        FM.AS.setControlsDamage(shot.initiator, 1);
                    }
                    break;
                ...
                case 7: // '\007'
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Aileron Controls: Disabled..");
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                    break;
                ...
                case 8: // '\b'
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Aileron Controls: Control Crank Link Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                    break;
                }
            ...
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** WingLMid Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** WingRMid Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** WingLOut Spar Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** WingROut Spar Damaged..");
                    nextDMGLevels(1, 2, "WingROut_D" + chunkDamageVisible("WingROut"), shot.initiator);
                }
                if(s.startsWith("xxsparsl") && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor((double)(6.8F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.5F)) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** StabL Spars Damaged..");
                    nextDMGLevels(1, 2, "StabL_D" + chunkDamageVisible("StabL"), shot.initiator);
                }
                if(s.startsWith("xxsparsr") && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor((double)(6.8F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.5F)) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** StabR Spars Damaged..");
                    nextDMGLevels(1, 2, "StabR_D" + chunkDamageVisible("StabR"), shot.initiator);
                }
            }
            if(s.startsWith("xxlock"))
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Lock Construction: Hit..");
                if(s.startsWith("xxlockr") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Rudder Lock Shot Off..");
                    nextDMGLevels(3, 2, "Rudder1_D" + chunkDamageVisible("Rudder1"), shot.initiator);
                }
                if(s.startsWith("xxlockvl") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** VatorL Lock Shot Off..");
                    nextDMGLevels(3, 2, "VatorL_D" + chunkDamageVisible("VatorL"), shot.initiator);
                }
                if(s.startsWith("xxlockvr") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** VatorR Lock Shot Off..");
                    nextDMGLevels(3, 2, "VatorR_D" + chunkDamageVisible("VatorR"), shot.initiator);
                }
            }
            if(s.startsWith("xxeng"))
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Hit..");
                if(s.endsWith("prop"))
                {
                    if(getEnergyPastArmor(3.6F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.8F)
                        ...
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Prop Governor Hit, Disabled..");
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 3);
                        } else
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Prop Governor Hit, Damaged..");
                ...
                if(s.endsWith("gear"))
                {
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Bullet Jams Reductor Gear..");
                ...
                if(s.endsWith("supc"))
                {
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Supercharger Disabled..");
                ...
                if(s.endsWith("fue1"))
                {
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Fuel Line Pierced, Engine Fired..");
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(2.2F, shot) > 0.0F)
                    {
                        ...
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Bullet Jams Crank Ball Bearing..");
                            FM.AS.setEngineStuck(shot.initiator, 0);
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Crank Case Hit, Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                ...
                if(s.endsWith("cyl1"))
                {
                    if(getEnergyPastArmor(1.3F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 1.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 48000F)
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Cylinders Hit, Engine Fires..");
                            FM.AS.hitEngine(shot.initiator, 0, 3);
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F)
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Bullet Jams Piston Head..");
                            FM.AS.setEngineStuck(shot.initiator, 0);
                        }
                        getEnergyPastArmor(22.5F, shot);
                    }
                    if(java.lang.Math.abs(point3d.y) < 0.1379999965429306D && getEnergyPastArmor(3.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                    {
                        ...
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Feed Gear Hit, Engine Stalled..");
                            FM.EI.engines[0].setEngineStops(shot.initiator);
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.05F)
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Feed Gear Hit, Engine Jams..");
                            FM.AS.setEngineStuck(shot.initiator, 0);
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F)
                        {
                            com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Feed Gear Hit, Cylinders Feed Cut..");
                ...
                {
                    int j = s.charAt(9) - 49;
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Magneto " + j + " Destroyed..");
                    FM.EI.engines[0].setMagnetoKnockOut(shot.initiator, j);
                } else
                if(s.startsWith("xxeng1oil") && getEnergyPastArmor(0.5F, shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Oil Radiator Hit..");
                    FM.AS.hitOil(shot.initiator, 0);
                }
            }
            if(s.startsWith("xxoil") && getEnergyPastArmor(2.1F, shot) > 0.0F)
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Oil Tank Pierced..");
                FM.AS.hitOil(shot.initiator, 0);
                getEnergyPastArmor(4.96F, shot);
            }
            if(s.startsWith("xxw1") && getEnergyPastArmor(0.1F, shot) > 0.0F)
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Engine Module: Water Filter Pierced..");
                FM.AS.hitOil(shot.initiator, 0);
                getEnergyPastArmor(4.96F, shot);
            }
            if(s.startsWith("xxtank"))
            {
                ...
                if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.32F)
                {
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Fuel Tank" + k + ": Pierced..");
                    ...
                    {
                        com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Fuel Tank" + k + ": Hit..");
                        FM.AS.hitTank(shot.initiator, k, 2);
                    }
                }
            }
            if(s.startsWith("xxmgun"))
            {
                if(s.endsWith("01"))
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Cowling Gun: Disabled..");
            ...
            if(s.startsWith("xxcannon"))
            {
                if(s.endsWith("01"))
                {
                    com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Cowling Cannon: Disabled..");
                    FM.AS.setJamBullets(1, 0);
                }
                if(s.endsWith("02"))
                {
            ...
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Pneumo System: Off-Line..");
                FM.AS.setInternalDamage(shot.initiator, 1);
            }
            if(s.startsWith("xxhyd") && getEnergyPastArmor(4.8F, shot) > 0.0F)
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Hydro System: Off-Line..");
        ...
        if(s.startsWith("xgear"))
        {
            ...
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Hydro System (Wheel): Off-Line..");
                FM.AS.setInternalDamage(shot.initiator, 0);
            }
            if(s.endsWith("2") && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F)
            {
                com.maddox.il2.objects.air.MIG_3.debugprintln(this, "*** Gears: Stuck..");
