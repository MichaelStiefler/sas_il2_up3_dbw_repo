...
public class CockpitSea2 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            SEAFIRE1 seafire1 = (SEAFIRE1)aircraft();
            if(SEAFIRE1.bChangedPit)
            {
                reflectPlaneToModel();
                SEAFIRE1 seafire1_1 = (SEAFIRE1)aircraft();
                SEAFIRE1.bChangedPit = false;
            }
        } else
        if(aircraft() instanceof SEAFIRE2C)
        {
            SEAFIRE2C seafire2c = (SEAFIRE2C)aircraft();
            if(SEAFIRE2C.bChangedPit)
            {
                reflectPlaneToModel();
                SEAFIRE2C seafire2c1 = (SEAFIRE2C)aircraft();
                SEAFIRE2C.bChangedPit = false;
            }
        } else
        if(aircraft() instanceof SEAFIRE2C4)
        {
            SEAFIRE2C4 seafire2c4 = (SEAFIRE2C4)aircraft();
            if(SEAFIRE2C4.bChangedPit)
            {
                reflectPlaneToModel();
                SEAFIRE2C4 seafire2c4_1 = (SEAFIRE2C4)aircraft();
