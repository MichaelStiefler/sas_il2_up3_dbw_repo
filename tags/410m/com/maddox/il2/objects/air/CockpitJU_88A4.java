...
// Source File Name:   CockpitJU_88A4.java
...
//            CockpitPilot, JU_88A4, Aircraft, AircraftLH

public class CockpitJU_88A4 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            com.maddox.il2.objects.air.JU_88A4 _tmp = (com.maddox.il2.objects.air.JU_88A4)aircraft();
            if(com.maddox.il2.objects.air.JU_88A4.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.JU_88A4 _tmp1 = (com.maddox.il2.objects.air.JU_88A4)aircraft();
                com.maddox.il2.objects.air.JU_88A4.bChangedPit = false;
            }
            if(fm != null)
            {
                setTmp = setOld;
                ...
                if(buzzerFX != null)
                    ...
                    if(buzzerFX.isPlaying())
                        buzzerFX.stop();
                f1 = ((com.maddox.il2.objects.air.JU_88A4)aircraft()).fDiveRecoveryAlt;
                float f2 = -(((com.maddox.il2.objects.air.JU_88A4)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.sin(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_88A4)aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float)java.lang.Math.sqrt(f2 * f2 + 2.0F * f1 * 0.1019F);
                float f3 = ((com.maddox.il2.objects.air.JU_88A4)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.cos(java.lang.Math.toRadians(((com.maddox.il2.objects.air.JU_88A4)aircraft()).fDiveAngle));
                float f4 = (f3 * f2 + 10F) - 10F;
                setNew.alpha = 90F - ((com.maddox.il2.objects.air.JU_88A4)aircraft()).fDiveAngle - (float)java.lang.Math.toDegrees(java.lang.Math.atan(f4 / f1));
