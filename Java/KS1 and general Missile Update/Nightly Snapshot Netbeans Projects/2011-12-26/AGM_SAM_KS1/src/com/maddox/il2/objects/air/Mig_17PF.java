  ...
  implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit
{
  ...
  private boolean sirenaWarning()
  {
    ...
    if (((actor instanceof Aircraft)) && (actor.getArmy() != World.getPlayerArmy()) && ((actor instanceof TypeFighterAceMaker)) && (((actor instanceof TypeSupersonic)) || ((actor instanceof TypeFastJet))) && (actor != World.getPlayerAircraft()) && (actor.getSpeed(vector3d) > 20.0D))
    {
      this.pos.getAbs(point3d);
  ...
  {
    theGFactors.setGFactors(1.0F, 1.0F, 
      1.0F, 1.8F, 
      1.5F, 1.0F);
  }
