...
//            CockpitPilot, AircraftLH, Cockpit, Aircraft

public class CockpitMosquito4 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Compass2", setNew.azimuth.getDeg(f) + setNew.waypointAzimuth.getDeg(f * 0.1F) + 90F, 0.0F, 0.0F);
