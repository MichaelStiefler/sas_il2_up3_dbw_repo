...
public class CockpitF_51D30K14 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    int i = ((F_51D30NA)aircraft()).k14Mode;
    boolean bool = i < 2;
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitF_51D30K14.this.fm != null) {
        CockpitF_51D30K14.access$102(CockpitF_51D30K14.this, CockpitF_51D30K14.this.setOld);
        CockpitF_51D30K14.access$202(CockpitF_51D30K14.this, CockpitF_51D30K14.this.setNew);
        CockpitF_51D30K14.access$302(CockpitF_51D30K14.this, CockpitF_51D30K14.this.setTmp);
        ...
        CockpitF_51D30K14.this.setNew.azimuth = ((35.0F * CockpitF_51D30K14.this.setOld.azimuth + -CockpitF_51D30K14.this.fm.Or.getYaw()) / 36.0F);

        if ((CockpitF_51D30K14.this.setOld.azimuth > 270.0F) && (CockpitF_51D30K14.this.setNew.azimuth < 90.0F))
          CockpitF_51D30K14.this.setOld.azimuth -= 360.0F;
        if ((CockpitF_51D30K14.this.setOld.azimuth < 90.0F) && (CockpitF_51D30K14.this.setNew.azimuth > 270.0F))
          CockpitF_51D30K14.this.setOld.azimuth += 360.0F;
        CockpitF_51D30K14.this.setNew.waypointAzimuth = ((10.0F * CockpitF_51D30K14.this.setOld.waypointAzimuth + CockpitF_51D30K14.this.waypointAzimuth() + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);

        CockpitF_51D30K14.this.setNew.vspeed = ((199.0F * CockpitF_51D30K14.this.setOld.vspeed + CockpitF_51D30K14.this.fm.getVertSpeed()) / 200.0F);

        float f1 = ((F_51D30NA)CockpitF_51D30K14.this.aircraft()).k14Distance;

        CockpitF_51D30K14.this.setNew.k14w = (5.0F * CockpitF_51D30K14.k14TargetWingspanScale[((F_51D30NA)CockpitF_51D30K14.this.aircraft()).k14WingspanType] / f1);
        ...
        Vector3d localVector3d = CockpitF_51D30K14.this.aircraft().FM.getW();

        double d = 0.00125D * f1;
        float f2 = (float)Math.toDegrees(d * localVector3d.z);
        float f3 = -(float)Math.toDegrees(d * localVector3d.y);
        float f4 = CockpitF_51D30K14.this.floatindex((f1 - 200.0F) * 0.04F, CockpitF_51D30K14.k14BulletDrop) - CockpitF_51D30K14.k14BulletDrop[0];

        f3 += (float)Math.toDegrees(Math.atan(f4 / f1));
        CockpitF_51D30K14.this.setNew.k14x = (0.92F * CockpitF_51D30K14.this.setOld.k14x + 0.08F * f2);
        CockpitF_51D30K14.this.setNew.k14y = (0.92F * CockpitF_51D30K14.this.setOld.k14y + 0.08F * f3);
        if (CockpitF_51D30K14.this.setNew.k14x > 7.0F)
          CockpitF_51D30K14.this.setNew.k14x = 7.0F;
        if (CockpitF_51D30K14.this.setNew.k14x < -7.0F)
          CockpitF_51D30K14.this.setNew.k14x = -7.0F;
        if (CockpitF_51D30K14.this.setNew.k14y > 7.0F)
          CockpitF_51D30K14.this.setNew.k14y = 7.0F;
        if (CockpitF_51D30K14.this.setNew.k14y < -7.0F)
          CockpitF_51D30K14.this.setNew.k14y = -7.0F;
      }
      return true;
  ...
  private class Variables
  {
    ...
    float k14y;
    float k14w;
    private final CockpitF_51D30K14 this$0;
    ...
    Variables(CockpitF_51D30K14.1 arg2)
    {
      this();
    }
  }
