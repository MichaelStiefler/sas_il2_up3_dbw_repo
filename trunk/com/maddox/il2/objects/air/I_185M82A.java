...
public class I_185M82A extends I_185
{
  ...
  public static void moveGear(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    paramHierMesh.chunkSetAngles("GearC3_D0", 0.0F, cvt(paramFloat, 0.02F, 0.1F, 0.0F, -65.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC4_D0", 0.0F, cvt(paramFloat, 0.02F, 0.1F, 0.0F, -65.0F), 0.0F);

    paramHierMesh.chunkSetAngles("GearL2_D0", 0.0F, 87.0F * paramFloat, 0.0F);
    paramHierMesh.chunkSetAngles("GearL7_D0", 0.0F, cvt(paramFloat, 0.02F, 0.1F, 0.0F, -85.0F), 0.0F);
    ...
    paramHierMesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(paramFloat, 0.02F, 0.1F, 0.0F, -85.0F), 0.0F);
  ...
  static
  {
    ...
    weaponTriggersRegister(localClass, new int[] { 1, 1, 1, 3, 3, 3, 3, 9, 9, 2, 2, 2, 2, 2, 2 });
    weaponHooksRegister(localClass, new String[] { "_CANNON01", "_CANNON02", "_CANNON03", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalDev01", "_ExternalDev02", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_ExternalRock05", "_ExternalRock06" });

    weaponsRegister(localClass, "default", new String[] { "MGunShVAKsi 220", "MGunShVAKsi 220", "MGunShVAKsi 220", null, null, null, null, null, null, null, null, null, null, null, null });

    weaponsRegister(localClass, "4fab100", new String[] { "MGunShVAKsi 220", "MGunShVAKsi 220", "MGunShVAKsi 220", "BombGunFAB100 1", "BombGunFAB100 1", "BombGunFAB100 1", "BombGunFAB100 1", null, null, null, null, null, null, null, null });

    weaponsRegister(localClass, "2fab250", new String[] { "MGunShVAKsi 220", "MGunShVAKsi 220", "MGunShVAKsi 220", "BombGunFAB250 1", "BombGunFAB250 1", null, null, null, null, null, null, null, null, null, null });

    weaponsRegister(localClass, "6rs82", new String[] { "MGunShVAKsi 220", "MGunShVAKsi 220", "MGunShVAKsi 220", null, null, null, null, "PylonRO_82_3", "PylonRO_82_3", "RocketGunRS82 1", "RocketGunRS82 1", "RocketGunRS82 1", "RocketGunRS82 1", "RocketGunRS82 1", "RocketGunRS82 1" });
