    ...
    implements TypeScout, TypeTransport, TypeStormovik
{
        ...
        if(s.startsWith("xx"))
        {
            ...
            } else
            {
                ...
                if(s.startsWith("xxspar"))
                {
                    ...
                    if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(9.5F / (float)java.lang.Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z), shot) > 0.0F)
                    {
    ...
    static 
    {
        java.lang.Class class1 = H19D.class;
        ...
        Aircraft.weaponsRegister(class1, "02x.50cal.MG", new java.lang.String[] {
            "MGunBrowning50k 210", "MGunBrowning50k 210", "PylonH19D 1", "PylonMGH19D 1", null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null
        });
        Aircraft.weaponsRegister(class1, "02x.50cal.MG+24x2.75.Rocket", new java.lang.String[] {
