...
public class SPITFIRE12 extends SPITFIRE
{
  ...
  static
  {
    Class localClass = SPITFIRE12.class;

    new NetAircraft.SPAWN(localClass);
    Property.set(localClass, "iconFar_shortClassName", "Spit");
    Property.set(localClass, "meshName", "3DO/Plane/SpitfireMkXII(Multi1)/hier.him");

    Property.set(localClass, "PaintScheme", new PaintSchemeFMPar04());
    Property.set(localClass, "yearService", 1943.0F);
    Property.set(localClass, "yearExpired", 1946.5F);
    Property.set(localClass, "FlightModel", "FlightModels/SpitfireXII.fmd");

    Property.set(localClass, "cockpitClass", CockpitSpit12.class);
