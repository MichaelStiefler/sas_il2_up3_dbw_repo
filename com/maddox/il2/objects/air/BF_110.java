    ...
    implements com.maddox.il2.objects.air.TypeFighter, com.maddox.il2.objects.air.TypeBNZFighter, com.maddox.il2.objects.air.TypeStormovik
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p1"))
                {
                    if(java.lang.Math.abs(point3d.y) > 0.23100000000000001D)
                        getEnergyPastArmor(8.5850000381469727D / (java.lang.Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
                    else
                ...
                if(s.endsWith("p3"))
                {
                    ...
                    {
                        getEnergyPastArmor(8.5850000381469727D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    } else
                    {
                        ...
                        if(point3d.z > 0.28799999999999998D && java.lang.Math.abs(point3d.y) < 0.076999999999999999D)
                            getEnergyPastArmor((double)com.maddox.il2.ai.World.Rnd().nextFloat(8.5F, 12.46F) / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                        else
                            getEnergyPastArmor(10.510000228881836D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    }
                } else
                if(s.endsWith("p4"))
                {
                ...
                if(s.endsWith("p5"))
                    getEnergyPastArmor(5.5100002288818359D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p6"))
                {
                    if(point3d.z > 0.44800000000000001D)
                    {
                        ...
                        getEnergyPastArmor(10.604999542236328D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    } else
                    if(java.lang.Math.abs(point3d.y) > 0.26400000000000001D)
                    {
                        if(point3d.z > 0.021000000000000001D)
                        {
                            getEnergyPastArmor(8.5100002288818359D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                        } else
                        {
                            debuggunnery("Armor: Bullet Went Through a Pilofacturing Hole..");
                            return;
                    ...
                    } else
                    {
                        ...
                        getEnergyPastArmor(8.0600004196166992D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    }
                } else
                if(s.endsWith("p7"))
                    getEnergyPastArmor(6.059999942779541D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p8"))
                {
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(3.5F / (float)java.lang.Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.75F)
                {
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, com.maddox.il2.objects.air.BF_110.cvt(f, 0.0F, 0.1F, 0.0F, -50.5F), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, com.maddox.il2.objects.air.BF_110.cvt(f, 0.0F, 0.1F, 0.0F, -50.5F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 120F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, com.maddox.il2.objects.air.BF_110.cvt(f, 0.0F, 0.1F, 0.0F, -50.5F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, com.maddox.il2.objects.air.BF_110.cvt(f, 0.0F, 0.1F, 0.0F, -50.5F), 0.0F);
    }
    ...
    public void onAircraftLoaded()
    {
        ...
        if(this instanceof com.maddox.il2.objects.air.BF_110G2)
        {
            ...
            for(int i = 0; i < aobj.length; i++)
            {
                ...
                if(aobj[i] instanceof com.maddox.il2.objects.weapons.MGunMK108k)
                {
