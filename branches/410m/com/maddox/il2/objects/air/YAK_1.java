    ...
    implements com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.YAK_1.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 9, 9, 9, 9, 9, 9, 2, 
            2, 2, 2, 2, 2, 3, 3
        });
        com.maddox.il2.objects.air.YAK_1.weaponHooksRegister(class1, new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.YAK_1.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShKASsi 750", "MGunShKASsi 750", "MGunShVAKki 120", null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null
        });
        com.maddox.il2.objects.air.YAK_1.weaponsRegister(class1, "6rs82", new java.lang.String[] {
        ...
        com.maddox.il2.objects.air.YAK_1.weaponsRegister(class1, "2fab100", new java.lang.String[] {
            "MGunShKASsi 750", "MGunShKASsi 750", "MGunShVAKki 120", null, null, null, null, null, null, null, 
            null, null, null, null, null, "BombGunFAB100 1", "BombGunFAB100 1"
        });
        com.maddox.il2.objects.air.YAK_1.weaponsRegister(class1, "none", new java.lang.String[] {
