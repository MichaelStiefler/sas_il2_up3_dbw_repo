...
public class CockpitJU_88C6 extends CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            JU_88C6 ju_88c6 = (JU_88C6)aircraft();
            if(JU_88C6.bChangedPit)
            {
                reflectPlaneToModel();
                JU_88C6 ju_88c6_1 = (JU_88C6)aircraft();
            ...
            if(fm != null)
            {
                ...
                if(buzzerFX != null)
                    ...
                    if(buzzerFX.isPlaying())
                        buzzerFX.stop();
                f1 = ((JU_88C6)aircraft()).fDiveRecoveryAlt;
                float f2 = -(((JU_88C6)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.sin(java.lang.Math.toRadians(((JU_88C6)aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float)java.lang.Math.sqrt(f2 * f2 + 2.0F * f1 * 0.1019F);
                float f3 = ((JU_88C6)aircraft()).fDiveVelocity * 0.27777F * (float)java.lang.Math.cos(java.lang.Math.toRadians(((JU_88C6)aircraft()).fDiveAngle));
                float f4 = (f3 * f2 + 10F) - 10F;
                setNew.alpha = 90F - ((JU_88C6)aircraft()).fDiveAngle - (float)java.lang.Math.toDegrees(java.lang.Math.atan(f4 / f1));
            }
            return true;
        }
