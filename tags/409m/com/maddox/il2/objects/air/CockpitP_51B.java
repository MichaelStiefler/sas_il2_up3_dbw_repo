...
// Source File Name:   CockpitP_51B.java
...
public class CockpitP_51B extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkVisible("Z_GearGreen1", fm.CT.getGear() > 0.95F && fm.Gears.lgear);
        mesh.chunkVisible("Z_GearGreen2", fm.CT.getGear() > 0.95F && fm.Gears.rgear);
        mesh.chunkVisible("Z_GearGreen3", fm.CT.getGear() > 0.95F);
        mesh.chunkVisible("Z_GearRed1", fm.CT.getGear() < 0.05F || !fm.Gears.lgear);
        mesh.chunkVisible("Z_GearRed2", fm.CT.getGear() < 0.05F || !fm.Gears.rgear);
        mesh.chunkVisible("Z_GearRed3", fm.CT.getGear() < 0.05F || !fm.Gears.lgear || !fm.Gears.rgear);
        mesh.chunkVisible("Z_Oxywarning1", false);
