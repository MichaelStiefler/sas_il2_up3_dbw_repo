...
//            Scheme1, JU_87D5, TypeDiveBomber, Aircraft, 
//            PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeDiveBomber
{
    ...
    {
        resetYPRmodifier();
        com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.35F, 0.0F, 0.3F);
        hierMesh().chunkSetLocate("GearL33_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
        com.maddox.il2.objects.air.Aircraft.xyz[2] = com.maddox.il2.objects.air.Aircraft.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.35F, 0.0F, 0.3F);
        hierMesh().chunkSetLocate("GearR33_D0", com.maddox.il2.objects.air.Aircraft.xyz, com.maddox.il2.objects.air.Aircraft.ypr);
    }
    ...
    public void msgShot(com.maddox.il2.ai.Shot shot)
    {
        ...
        {
            if(com.maddox.il2.objects.air.Aircraft.Pd.z > 0.75999999046325684D && com.maddox.il2.objects.air.Aircraft.v1.x < 0.0D)
            {
            ...
            if((double)shot.power * java.lang.Math.abs(com.maddox.il2.objects.air.Aircraft.v1.x) > 10370D)
