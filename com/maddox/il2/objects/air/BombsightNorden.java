...
// Source File Name:   BombsightNorden.java
...
public class BombsightNorden
{
    ...
    {
        com.maddox.il2.objects.air.BombsightNorden.ResetAll(0, ((com.maddox.il2.objects.air.Aircraft) (null)));
    }
    ...
    private static void SetCurrentBombIndex()
    {
        ...
        {
            if(!BombDescs[i].sBombName.equals(((java.lang.Object) (ActiveBombNames[nCurrentBombStringIndex]))))
                continue;
            nCurrentBombIndex = i;
            break;
        }
    ...
    public static void ResetAll(int i, com.maddox.il2.objects.air.Aircraft aircraft)
    {
        TypeCurrent = i;
        switch(TypeCurrent)
        {
        ...
        nCurrentBombIndex = 0;
        nCurrentBombStringIndex = 0;
        com.maddox.il2.objects.air.BombsightNorden.SetCurrentBombIndex();
        com.maddox.il2.objects.air.BombsightNorden.RecalculateDistance();
    }
    ...
    public static void AdjDistancePlus()
    {
        ...
        com.maddox.il2.objects.air.BombsightNorden.RecalculateDistance();
        if(bSightAutomation)
            com.maddox.il2.objects.air.BombsightNorden.ToggleAutomation();
    }
    ...
    {
        fSightCurDistance = com.maddox.il2.objects.air.BombsightNorden.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    }

    public static void OnCCIP(float f, float f1)
    {
        fSightCurSpeed = com.maddox.il2.objects.air.BombsightNorden.fromMetersPerSecond(f);
        fSightCurAltitude = com.maddox.il2.objects.air.BombsightNorden.fromMeters(f1);
        com.maddox.il2.objects.air.BombsightNorden.RecalculateDistance();
    }
    ...
    public static void Update(float f)
    {
        ...
        if(bSightAutomation)
        {
            double d = com.maddox.il2.objects.air.BombsightNorden.toMetersPerSecond(fSightCurSpeed);
            double d1 = com.maddox.il2.objects.air.BombsightNorden.toMeters(fSightCurAltitude);
    ...
    private static com.maddox.il2.objects.air.Aircraft currentCraft;
