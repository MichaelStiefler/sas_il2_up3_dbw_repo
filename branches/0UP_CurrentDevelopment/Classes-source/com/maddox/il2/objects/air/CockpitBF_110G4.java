...
// Source File Name:   CockpitBF_110G4.java
...
public class CockpitBF_110G4 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            com.maddox.il2.objects.air.BF_110G4 bf_110g4 = (com.maddox.il2.objects.air.BF_110G4)aircraft();
            if(com.maddox.il2.objects.air.BF_110G4.bChangedPit)
            {
                reflectPlaneToModel();
                com.maddox.il2.objects.air.BF_110G4 bf_110g4_1 = (com.maddox.il2.objects.air.BF_110G4)aircraft();
                com.maddox.il2.objects.air.BF_110G4.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
            ...
            variables.radioalt = f1 + f2 * (f3 - com.maddox.il2.engine.Landscape.HQ_Air((float)fm.Loc.x, (float)fm.Loc.y));
            return true;
        }
    ...
    {
        super("3DO/Cockpit/Bf-110G4NG/BF_110G4.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Z_RETICLE2", 0.0F, 0.0F, -45F);
        resetYPRmodifier();
        if(fm.CT.saveWeaponControl[1])
            com.maddox.il2.objects.air.Cockpit.xyz[2] = 0.00545F;
