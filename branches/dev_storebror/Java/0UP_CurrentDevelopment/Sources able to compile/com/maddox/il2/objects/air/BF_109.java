    ...
    implements TypeFighter
{
    ...
    {
        resetYPRmodifier();
        Aircraft.xyz[2] = Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.gWheelSinking[0], 0.0F, 0.3F, 0.0F, 0.3F);
        hierMesh().chunkSetLocate("GearL99_D0", Aircraft.xyz, Aircraft.ypr);
        Aircraft.xyz[2] = Aircraft.cvt(((com.maddox.il2.fm.FlightModelMain) (super.FM)).Gears.gWheelSinking[1], 0.0F, 0.3F, 0.0F, 0.3F);
        ...
        if(string.startsWith("xx"))
        {
            if(string.startsWith("xxarmor"))
            {
                ...
                if(string.endsWith("p3"))
                {
                    if(((com.maddox.JGP.Tuple3d) (point3d)).z < -0.27000000000000002D)
                        getEnergyPastArmor(4.0999999046325684D / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z) + 9.9999997473787516E-006D), shot);
                    else
                        getEnergyPastArmor(8.1000003814697266D / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).x) + 9.9999997473787516E-006D), shot);
                } else
                if(string.endsWith("p4"))
                    getEnergyPastArmor(9D / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z) + 9.9999997473787516E-006D), shot);
                else
                if(string.endsWith("p5"))
                    getEnergyPastArmor(9D / (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).x) + 9.9999997473787516E-006D), shot);
                else
            ...
            } else
            {
                ...
                if(string.startsWith("xxspar"))
                {
                    ...
                    if(string.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(3.5F / (float)java.lang.Math.sqrt(((com.maddox.JGP.Tuple3d) (Aircraft.v1)).y * ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).y + ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z * ((com.maddox.JGP.Tuple3d) (Aircraft.v1)).z), shot) > 0.0F)
                    {
                ...
                if(string.startsWith("xxeng"))
                {
                    ...
                    if(string.endsWith("case"))
                    {
                        if(getEnergyPastArmor(2.1F, shot) > 0.0F)
                        {
                            ...
                            if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                            {
                                ...
                                Aircraft.debugprintln(this, "*** Engine Module: Crank Case Hit, Readyness Reduced to " + ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getReadyness() + "..");
                            }
                    ...
                    if(string.startsWith("xxeng1cyl"))
                    {
                        if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getCylindersRatio() * 1.75F)
                        {
                            ...
                            Aircraft.debugprintln(this, "*** Engine Module: Cylinders Hit, " + ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getCylindersOperable() + "/" + ((com.maddox.il2.fm.FlightModelMain) (super.FM)).EI.engines[0].getCylinders() + " Left..");
    ...
    static 
    {
        java.lang.Class var_class = BF_109.class;
        com.maddox.rts.Property.set(var_class, "originCountry", PaintScheme.countryGermany);
    }
}
