...
//            Scheme4, TypeSailPlane, TypeTransport, PaintScheme
    ...
    implements com.maddox.il2.objects.air.TypeSailPlane, com.maddox.il2.objects.air.TypeTransport
{
    ...
    public void update(float f)
    {
        ...
        {
            for(int k = 0; k < 2; k++)
                if(FM.Gears.clpGearEff[i][k] != null)
                {
                    tmpp.set(FM.Gears.clpGearEff[i][k].pos.getAbsPoint());
                    tmpp.z = 0.01D;
                    FM.Gears.clpGearEff[i][k].pos.setAbs(tmpp);
                    FM.Gears.clpGearEff[i][k].pos.reset();
                }
        ...
        for(int j = 0; j < 4; j++)
        {
            float f1 = FM.EI.engines[j].getControlRadiator();
            if(java.lang.Math.abs(flapps[j] - f1) <= 0.01F)
                continue;
            flapps[j] = f1;
            for(int l = 1; l < 9; l++)
                hierMesh().chunkSetAngles("Water" + (j * 8 + l) + "_D0", 0.0F, -40F * f1, 0.0F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 3: // '\003'
                    if(getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                    {
                        ...
                        com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Aileron Controls Out..");
                    }
                    break;
            ...
            if(s.startsWith("xxengine"))
            {
                ...
                if(s.endsWith("base"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Engine (" + k + ") Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, k, 2);
                            com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Engine (" + k + ") Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Engine (" + k + ") Crank Case Hit - Readyness Reduced to " + FM.EI.engines[k].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyl"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[k].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Engine (" + k + ") Cylinders Hit, " + FM.EI.engines[k].getCylindersOperable() + "/" + FM.EI.engines[k].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 18000F)
                        {
                            FM.AS.hitEngine(shot.initiator, k, 2);
                            com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Engine (" + k + ") Cylinders Hit - Engine Fires..");
                        }
                    }
                ...
                if(s.endsWith("sup") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Engine (" + k + ") Module: Compressor Stops..");
            ...
            if(s.startsWith("xxoil"))
            {
                ...
                com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Engine (" + i1 + ") Module: Oil Tank Pierced..");
                return;
            }
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Keel1 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** StabL: Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** StabR: Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.H8K.debugprintln(this, "*** Tail1: Spars Damaged..");
