...
public class CockpitG50 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(setOld.azimuth < 90F && setNew.azimuth > 270F)
                setOld.azimuth += 360F;
            setNew.waypointAzimuth = (10F * setOld.waypointAzimuth + (waypointAzimuth(30F) - setOld.azimuth)) / 11F;
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        xyz[2] = cvt(gun[0].countBullets(), 0.0F, 150F, 0.0F, 0.06025F);
        mesh.chunkSetLocate("Z_AmmoCounter1", xyz, ypr);
        xyz[2] = cvt(gun[1].countBullets(), 0.0F, 150F, 0.0F, 0.06025F);
    ...
    public void doToggleAim(boolean flag)
    {
        ...
        if(flag && sightDamaged)
        {
            ...
            hookpilot.setAim(new Point3d(-1.3999999761581421D, 0.0D, 0.9583200216293335D));
        }
    }
