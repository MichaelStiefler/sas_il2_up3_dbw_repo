...
public abstract class B_29X extends com.maddox.il2.objects.air.Scheme4
    implements com.maddox.il2.objects.air.TypeTransport
{
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 3: // '\003'
                    if(getEnergyPastArmor(1.0F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                    {
                        ...
                        com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Aileron Controls Out..");
                    }
                    break;
            ...
            if(s.startsWith("xxeng"))
            {
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(0.2F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 140000F)
                        {
                            ...
                            com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Crank Case Hit - Engine Stucks..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 85000F)
                        {
                            FM.AS.hitEngine(shot.initiator, k, 2);
                            com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Crank Case Hit - Engine Damaged..");
                        }
                    } else
                    ...
                    } else
                    {
                        ...
                        com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Crank Case Hit - Readyness Reduced to " + FM.EI.engines[k].getReadyness() + "..");
                    }
                ...
                if(s.endsWith("cyls"))
                {
                    if(getEnergyPastArmor(5.85F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[k].getCylindersRatio() * 0.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Cylinders Hit, " + FM.EI.engines[k].getCylindersOperable() + "/" + FM.EI.engines[k].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 18000F)
                        {
                            FM.AS.hitEngine(shot.initiator, k, 2);
                            com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Cylinders Hit - Engine Fires..");
                        }
                    }
                ...
                if(s.endsWith("mag1"))
                {
                    ...
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Module: Magneto #0 Destroyed..");
                    getEnergyPastArmor(25F, shot);
                }
                if(s.endsWith("prop") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Module: Prop Governor Fails..");
                }
                if(s.endsWith("oil") && getEnergyPastArmor(0.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                {
                    ...
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine (" + k + ") Module: Oil Filter Pierced..");
                }
                return;
            }
            if(s.startsWith("xxspar"))
            {
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine1 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine2 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine3 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Engine4 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** WingROut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Keel1 Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** StabL: Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** StabR: Spars Damaged..");
                    nextDMGLevels(1, 2, "StabR_D" + chunkDamageVisible("StabR"), shot.initiator);
                }
                if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2)
                    if(getEnergyPastArmor(16.6F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 2.0F), shot) <= 0.125F);
                return;
            }
        ...
        if(s.startsWith("xgear"))
        {
            ...
            {
                com.maddox.il2.objects.air.B_29X.debugprintln(this, "*** Gear Hydro Failed..");
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.06F, 0.0F, 93F));
        hiermesh.chunkSetAngles("GearC5_D0", 0.0F, 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.06F, 0.0F, 93F));
        ...
        hiermesh.chunkSetAngles("GearL7_D0", 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.12F, 0.0F, 67F), 0.0F);
        hiermesh.chunkSetAngles("GearL8_D0", 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.12F, 0.0F, -67F), 0.0F);
        hiermesh.chunkSetAngles("GearL9_D0", 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.12F, 0.0F, 84F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, -81F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR7_D0", 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.12F, 0.0F, -67F), 0.0F);
        hiermesh.chunkSetAngles("GearR8_D0", 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.12F, 0.0F, 67F), 0.0F);
        hiermesh.chunkSetAngles("GearR9_D0", 0.0F, com.maddox.il2.objects.air.B_29X.cvt(f, 0.01F, 0.12F, 0.0F, -84F), 0.0F);
    }

    protected void moveGear(float f)
    {
        com.maddox.il2.objects.air.B_29X.moveGear(hierMesh(), f);
    }

    public void moveWheelSink()
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.B_29X.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.325F, 0.0F, 0.325F);
        hierMesh().chunkSetLocate("GearC3_D0", xyz, ypr);
        resetYPRmodifier();
        xyz[0] = com.maddox.il2.objects.air.B_29X.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.325F, 0.0F, -0.325F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        resetYPRmodifier();
        xyz[0] = com.maddox.il2.objects.air.B_29X.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.325F, 0.0F, -0.325F);
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.B_29X.class;
