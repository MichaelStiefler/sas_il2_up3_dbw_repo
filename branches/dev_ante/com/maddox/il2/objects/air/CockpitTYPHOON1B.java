...
public class CockpitTYPHOON1B extends CockpitPilot
{
  ...
  private class Variables
  {
    ...
    private final CockpitTYPHOON1B this$0;
    ...
    Variables(CockpitTYPHOON1B.1 arg2)
    {
      this();
    }
  }
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      if (CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitTYPHOON1B.access$002(CockpitTYPHOON1B.this, CockpitTYPHOON1B.this.setOld);
        CockpitTYPHOON1B.access$102(CockpitTYPHOON1B.this, CockpitTYPHOON1B.this.setNew);
        CockpitTYPHOON1B.access$202(CockpitTYPHOON1B.this, CockpitTYPHOON1B.this.setTmp);
        CockpitTYPHOON1B.this.setNew.throttle = (0.92F * CockpitTYPHOON1B.this.setOld.throttle + 0.08F * CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.PowerControl);
        CockpitTYPHOON1B.this.setNew.prop = (0.92F * CockpitTYPHOON1B.this.setOld.prop + 0.08F * CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp());
        CockpitTYPHOON1B.this.setNew.mix = (0.92F * CockpitTYPHOON1B.this.setOld.mix + 0.08F * CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlMix());
        CockpitTYPHOON1B.this.setNew.altimeter = CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        CockpitTYPHOON1B.this.setNew.azimuth = (0.97F * CockpitTYPHOON1B.this.setOld.azimuth + 0.03F * -CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw());
        if ((CockpitTYPHOON1B.this.setOld.azimuth > 270.0F) && (CockpitTYPHOON1B.this.setNew.azimuth < 90.0F))
          CockpitTYPHOON1B.this.setOld.azimuth -= 360.0F;
        if ((CockpitTYPHOON1B.this.setOld.azimuth < 90.0F) && (CockpitTYPHOON1B.this.setNew.azimuth > 270.0F))
          CockpitTYPHOON1B.this.setOld.azimuth += 360.0F;
        CockpitTYPHOON1B.this.setNew.waypointAzimuth = (0.91F * CockpitTYPHOON1B.this.setOld.waypointAzimuth + 0.09F * (CockpitTYPHOON1B.this.waypointAzimuth() - CockpitTYPHOON1B.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));
        CockpitTYPHOON1B.this.setNew.vspeed = (0.99F * CockpitTYPHOON1B.this.setOld.vspeed + 0.01F * CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed());
        if (CockpitTYPHOON1B.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_CT_of_type_ComMaddoxIl2FmControls.GearControl < 0.5F)
        {
