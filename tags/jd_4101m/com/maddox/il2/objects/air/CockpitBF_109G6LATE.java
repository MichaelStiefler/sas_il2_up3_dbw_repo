...
public class CockpitBF_109G6LATE extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      ...
      CockpitBF_109G6LATE.this.setNew.throttle = ((10.0F * CockpitBF_109G6LATE.this.setOld.throttle + CockpitBF_109G6LATE.this.fm.CT.PowerControl) / 11.0F);
      CockpitBF_109G6LATE.this.setNew.mix = ((8.0F * CockpitBF_109G6LATE.this.setOld.mix + CockpitBF_109G6LATE.this.fm.EI.engines[0].getControlMix()) / 9.0F);

      float f = CockpitBF_109G6LATE.this.waypointAzimuth();
      if (CockpitBF_109G6LATE.this.useRealisticNavigationInstruments())
      {
        CockpitBF_109G6LATE.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
        CockpitBF_109G6LATE.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
      }
      else
      {
      ...
      CockpitBF_109G6LATE.this.setNew.turn = ((12.0F * CockpitBF_109G6LATE.this.setOld.turn + CockpitBF_109G6LATE.this.w.z) / 13.0F);
      ...
      CockpitBF_109G6LATE.this.setNew.beaconDirection = ((10.0F * CockpitBF_109G6LATE.this.setOld.beaconDirection + CockpitBF_109G6LATE.this.getBeaconDirection()) / 11.0F);
      CockpitBF_109G6LATE.this.setNew.beaconRange = ((10.0F * CockpitBF_109G6LATE.this.setOld.beaconRange + CockpitBF_109G6LATE.this.getBeaconRange()) / 11.0F);
