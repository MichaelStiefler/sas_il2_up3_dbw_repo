...
public class CockpitPE3bis_TGunner extends CockpitGunner
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE3bis_TGunner.this.fm != null)
      {
        ...
        if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3] != null) {
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 0) {
            CockpitPE3bis_TGunner.this.bBombs[1] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][0].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 1) {
            CockpitPE3bis_TGunner.this.bBombs[0] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][1].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 2) {
            CockpitPE3bis_TGunner.this.bBombs[3] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][2].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 3) {
            CockpitPE3bis_TGunner.this.bBombs[2] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][3].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 4) {
            CockpitPE3bis_TGunner.this.bBombs[5] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][4].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 5) {
            CockpitPE3bis_TGunner.this.bBombs[4] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][5].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 6) {
            CockpitPE3bis_TGunner.this.bBombs[5] = ((CockpitPE3bis_TGunner.this.bBombs[5] != 0) || (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][6].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 7) {
            CockpitPE3bis_TGunner.this.bBombs[4] = ((CockpitPE3bis_TGunner.this.bBombs[4] != 0) || (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][7].haveBullets()) ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 8) {
            CockpitPE3bis_TGunner.this.bBombs[7] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][8].haveBullets() ? 1 : 0);
          }
          if (CockpitPE3bis_TGunner.this.fm.CT.Weapons[3].length > 9) {
            CockpitPE3bis_TGunner.this.bBombs[6] = (!CockpitPE3bis_TGunner.this.fm.CT.Weapons[3][9].haveBullets() ? 1 : 0);
          }

        }

        CockpitPE3bis_TGunner.this.setNew.man1 = (0.92F * CockpitPE3bis_TGunner.this.setOld.man1 + 0.08F * CockpitPE3bis_TGunner.this.fm.EI.engines[0].getManifoldPressure());

        CockpitPE3bis_TGunner.this.setNew.man2 = (0.92F * CockpitPE3bis_TGunner.this.setOld.man2 + 0.08F * CockpitPE3bis_TGunner.this.fm.EI.engines[1].getManifoldPressure());
        CockpitPE3bis_TGunner.this.setNew.altimeter = CockpitPE3bis_TGunner.this.fm.getAltitude();

        CockpitPE3bis_TGunner.this.setNew.azimuth.setDeg(CockpitPE3bis_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitPE3bis_TGunner.this.fm.Or.azimut());

        CockpitPE3bis_TGunner.this.setNew.vspeed = ((100.0F * CockpitPE3bis_TGunner.this.setOld.vspeed + CockpitPE3bis_TGunner.this.fm.getVertSpeed()) / 101.0F);

        if (CockpitPE3bis_TGunner.this.useRealisticNavigationInstruments())
        {
          CockpitPE3bis_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE3bis_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE3bis_TGunner.this.getBeaconDirection());
        }
        else
        {
          CockpitPE3bis_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE3bis_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE3bis_TGunner.this.waypointAzimuth() - CockpitPE3bis_TGunner.this.setOld.azimuth.getDeg(1.0F));
        }

        CockpitPE3bis_TGunner.this.setNew.inert = (0.999F * CockpitPE3bis_TGunner.this.setOld.inert + 0.001F * (CockpitPE3bis_TGunner.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
