...
public class CockpitP_38DS_Bombardier extends CockpitPilot
{
  public Vector3f w;
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bEntered)
    {
      this.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((P_38DroopSnoot)aircraft()).fSightCurForwardAngle, 7.0F, 140.0F, 0.7F, 14.0F), angleScale), 0.0F, 0.0F);
      boolean bool = ((P_38DroopSnoot)aircraft()).fSightCurReadyness > 0.93F;
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      float f1 = ((P_38DroopSnoot)CockpitP_38DS_Bombardier.this.aircraft()).fSightCurForwardAngle;
      float f2 = ((P_38DroopSnoot)CockpitP_38DS_Bombardier.this.aircraft()).fSightCurSideslip;
      CockpitP_38DS_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitP_38DS_Bombardier.this.bEntered)
      {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitP_38DS_Bombardier.this.aAim + f2, CockpitP_38DS_Bombardier.this.tAim + f1, 0.0F);
      }
      return true;
    }
