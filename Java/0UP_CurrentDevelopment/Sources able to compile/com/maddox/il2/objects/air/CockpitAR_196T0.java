...
public class CockpitAR_196T0 extends CockpitPilot
{
    ...
    {
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.6F);
        super.mesh.chunkSetLocate("Blister1_D0", Cockpit.xyz, Cockpit.ypr);
        if(super.fm == null)
            return;
        ...
        super.mesh.chunkSetLocate("zBoostCrank1", Cockpit.xyz, Cockpit.ypr);
    }
