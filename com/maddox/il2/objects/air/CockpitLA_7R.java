...
// Source File Name:   CockpitLA_7R.java
...
public class CockpitLA_7R extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitLA_7R()
    {
        ...
        cockpitNightMats = (new java.lang.String[] {
            "Prib_One", "Prib_Two", "Prib_Three", "Prib_Four", "Prib_Five", "Prib_Seven", "Shkala128"
        });
        setNightMats(false);
    ...
    {
        mesh.chunkSetAngles("zKerosin", cvt(fm.M.nitro, 0.0F, 250F, 0.0F, 270F), 0.0F, 0.0F);
        mesh.chunkSetAngles("zAzotKislota", cvt(fm.M.nitro, 0.0F, 250F, 0.0F, 270F), 0.0F, 0.0F);
        mesh.chunkSetAngles("zPVRD_Temp", cvt(setNew.preved, 0.0F, 900F, 0.0F, 118F), 0.0F, 0.0F);
        mesh.chunkSetAngles("SW_PVRD", fm.EI.engines[1].getStage() <= 0 ? 0.0F : 45F, 0.0F, 0.0F);
        ...
        mesh.chunkSetLocate("zBlinkerUp", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        mesh.chunkSetLocate("zBlinkerDn", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        ...
        {
            com.maddox.il2.ai.BulletEmitter bulletemitter = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalBomb01");
            ...
            bulletemitter = ((com.maddox.il2.objects.air.Aircraft)fm.actor).getBulletEmitterByHookName("_ExternalBomb02");
            if(bulletemitter != com.maddox.il2.objects.weapons.GunEmpty.get())
