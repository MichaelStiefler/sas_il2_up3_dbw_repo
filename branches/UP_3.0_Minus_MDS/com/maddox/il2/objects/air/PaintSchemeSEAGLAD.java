...
public class PaintSchemeSEAGLAD extends com.maddox.il2.objects.air.PaintScheme
{
    ...
    public void prepareNum(java.lang.Class class1, com.maddox.il2.engine.HierMesh hiermesh, com.maddox.il2.ai.Regiment regiment, int i, int j, int k)
    {
        ...
        } else
        {
            ...
            if(regiment.country() == com.maddox.il2.objects.air.PaintScheme.countryBritain)
            {
                if("ra".equals(((java.lang.Object) (regiment.branch()))) || "rz".equals(((java.lang.Object) (regiment.branch()))))
                {
                    k = clampToLiteral(k);
                ...
                {
                    k = clampToLiteral(k);
                    changeMat(hiermesh, "Overlay2", "psSEAGLADBRILNUM" + l + i + (k < 10 ? "0" + k : "" + k), "British/" + (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 1.0F, 1.0F, 1.0F);
                    changeMat(hiermesh, "Overlay3", "psSEAGLADBRIRNUM" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/" + (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, 0.1F, 0.1F, 0.1F);
                ...
                if("rn".equals(((java.lang.Object) (regiment.branch()))))
                {
                    k = clampToLiteral(k);
                    changeMat(hiermesh, "Overlay2", "psSEAGLADBRINAVYLNUM" + l + i + (k < 10 ? "0" + k : "" + k), "British/" + (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 1.0F, 1.0F, 1.0F);
                    changeMat(hiermesh, "Overlay3", "psSEAGLADBRINAVYRNUM" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/" + (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, 0.1F, 0.1F, 0.1F);
                    if(class1.isAssignableFrom(com.maddox.il2.objects.air.SEAGLADIATOR2.class))
                    {
                        changeMat(class1, hiermesh, "Overlay6", "null", "null.tga", 1.0F, 1.0F, 1.0F);
                        changeMat(class1, hiermesh, "Overlay7", "null", "null.tga", 1.0F, 1.0F, 1.0F);
