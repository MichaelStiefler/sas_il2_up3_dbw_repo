  ...
  implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeStormovik
{
  ...
  public F_86A()
  {
    ...
    this.$1 = new Object(0.0F, 9000.0F, 0.8F, 1.0F, 0.01F, 1.0F, 0.2F, 1.0F, 0.45F, 0.58F, 0.0F, null)
    {
      private float lal;
      private float tal;
      private float bef;
      ...
      private float lef;
      private float ftl;
      private final F_86A this$0;

      public void rs(int ii)
      {
        if ((ii == 0) || (ii == 1)) F_86A.access$234(this.this$0, 0.6800000000000001D);
        if ((ii == 31) || (ii == 32)) F_86A.access$334(this.this$0, 0.6800000000000001D);
        if ((ii == 15) || (ii == 16)) F_86A.access$434(this.this$0, 0.6800000000000001D); 
      }
      ...
      private void $1()
      {
        if (this.this$0.ts) {
          ...
          float f2 = Aircraft.cvt(this.this$0.mn, this.this$0.mn < F_86A.mteb ? F_86A.lteb : F_86A.uteb, this.this$0.mn < F_86A.mteb ? F_86A.uteb : F_86A.lteb, this.this$0.mn < F_86A.mteb ? this.bhef : this.thef, this.this$0.mn < F_86A.mteb ? this.thef : this.phef);

          float f3 = Aircraft.cvt(this.this$0.mn, this.this$0.mn < F_86A.mteb ? F_86A.lteb : F_86A.uteb, this.this$0.mn < F_86A.mteb ? F_86A.uteb : F_86A.lteb, this.this$0.mn < F_86A.mteb ? this.mef : this.wef / f1, this.this$0.mn < F_86A.mteb ? this.wef / f1 : this.lef / f1);
          ...
          if (f2 > 0.6F) F_86A.access$1002(this.this$0, true); else {
            F_86A.access$1002(this.this$0, false);
          }
          if (this.ftl > 0.0F) {
  ...
  public void moveWheelSink()
  {
    ...
    {
      if (this.curctl - this.oldctl < -0.03F)
        this.curctl = (this.oldctl - 0.03F);
  ...
  public void update(float paramFloat)
  {
    ...
    if (this.FM.getSpeed() > 5.0F) { moveSlats(paramFloat); this.bSlatsOff = false; } else {
      slatsOff();
    }if ((this.isLoaded) && 
