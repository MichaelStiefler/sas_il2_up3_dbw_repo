...
public class CockpitSNJ extends CockpitPilot
{
    ...
    {
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.7F);
        ...
        {
            resetYPRmodifier();
            Cockpit.xyz[0] = -0.133F * fm.CT.getGear();
        ...
        resetYPRmodifier();
        Cockpit.xyz[0] = -0.118F * fm.CT.getFlap();
        mesh.chunkSetLocate("Z_Flap1", Cockpit.xyz, Cockpit.ypr);
