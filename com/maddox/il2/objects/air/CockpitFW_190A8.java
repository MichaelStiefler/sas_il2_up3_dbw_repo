...
public class CockpitFW_190A8 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.bomb[0] == null) {
      ...
      if (((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb01") != GunEmpty.get()) {
        this.bomb[1] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb01");
        this.bomb[2] = ((Aircraft)this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_actor_of_type_ComMaddoxIl2EngineActor).getBulletEmitterByHookName("_ExternalBomb01");
      }
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW_190A8.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null) {
        ...
        CockpitFW_190A8.this.setNew.altimeter = CockpitFW_190A8.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        ...
        CockpitFW_190A8.this.setNew.throttle = ((10.0F * CockpitFW_190A8.this.setOld.throttle + CockpitFW_190A8.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.CT.PowerControl) / 11.0F);
        CockpitFW_190A8.this.setNew.vspeed = ((499.0F * CockpitFW_190A8.this.setOld.vspeed + CockpitFW_190A8.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 500.0F);

        CockpitFW_190A8.this.setNew.azimuth = CockpitFW_190A8.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.getYaw();
        if ((CockpitFW_190A8.this.setOld.azimuth > 270.0F) && (CockpitFW_190A8.this.setNew.azimuth < 90.0F)) CockpitFW_190A8.this.setOld.azimuth -= 360.0F;
        if ((CockpitFW_190A8.this.setOld.azimuth < 90.0F) && (CockpitFW_190A8.this.setNew.azimuth > 270.0F)) CockpitFW_190A8.this.setOld.azimuth += 360.0F;
        CockpitFW_190A8.this.setNew.waypointAzimuth = ((10.0F * CockpitFW_190A8.this.setOld.waypointAzimuth + (CockpitFW_190A8.this.waypointAzimuth() - CockpitFW_190A8.this.setOld.azimuth) + World.Rnd().nextFloat(-30.0F, 30.0F)) / 11.0F);
      }
      return true;
    }
  }
  ...
  private class Variables
  {
    ...
    {
      this.this$0 = this$1; } 
    Variables(CockpitFW_190A8.1 arg2) { this();
    }
  }
}