...
public class CockpitJU_88A4_Bombardier2 extends CockpitPilot
{
  ...
  public CockpitJU_88A4_Bombardier2()
  {
    super("3DO/Cockpit/Ju-88A-4-Bombardier/Bombardier2.him", "he111");
  ...
  class Interpolater extends InterpolateRef
  {
    public boolean tick()
    {
      float f1 = ((JU_88A4)CockpitJU_88A4_Bombardier2.this.aircraft()).fSightCurForwardAngle;
      float f2 = ((JU_88A4)CockpitJU_88A4_Bombardier2.this.aircraft()).fSightCurSideslip;
      CockpitJU_88A4_Bombardier2.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f2, f1);
      if (CockpitJU_88A4_Bombardier2.this.bEntered)
      {
        HookPilot localHookPilot = HookPilot.current;
        localHookPilot.setSimpleAimOrient(CockpitJU_88A4_Bombardier2.this.aAim + f2, CockpitJU_88A4_Bombardier2.this.tAim + f1, 0.0F);
      }
      if (CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel != null)
      {
        CockpitJU_88A4_Bombardier2.access$302(CockpitJU_88A4_Bombardier2.this, CockpitJU_88A4_Bombardier2.this.setOld);
        CockpitJU_88A4_Bombardier2.access$402(CockpitJU_88A4_Bombardier2.this, CockpitJU_88A4_Bombardier2.this.setNew);
        CockpitJU_88A4_Bombardier2.access$502(CockpitJU_88A4_Bombardier2.this, CockpitJU_88A4_Bombardier2.this.setTmp);
        CockpitJU_88A4_Bombardier2.this.setNew.throttle1 = (0.85F * CockpitJU_88A4_Bombardier2.this.setOld.throttle1 + CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlThrottle() * 0.15F);
        CockpitJU_88A4_Bombardier2.this.setNew.prop1 = (0.85F * CockpitJU_88A4_Bombardier2.this.setOld.prop1 + CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[0].getControlProp() * 0.15F);
        CockpitJU_88A4_Bombardier2.this.setNew.throttle2 = (0.85F * CockpitJU_88A4_Bombardier2.this.setOld.throttle2 + CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlThrottle() * 0.15F);
        CockpitJU_88A4_Bombardier2.this.setNew.prop2 = (0.85F * CockpitJU_88A4_Bombardier2.this.setOld.prop2 + CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_EI_of_type_ComMaddoxIl2FmEnginesInterface.engines[1].getControlProp() * 0.15F);
        CockpitJU_88A4_Bombardier2.this.setNew.altimeter = CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getAltitude();
        float f3 = CockpitJU_88A4_Bombardier2.this.waypointAzimuth();
        CockpitJU_88A4_Bombardier2.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4_Bombardier2.this.setOld.waypointAzimuth.getDeg(0.1F), f3 - CockpitJU_88A4_Bombardier2.this.setOld.azimuth.getDeg(1.0F));
        CockpitJU_88A4_Bombardier2.this.setNew.azimuth.setDeg(CockpitJU_88A4_Bombardier2.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Or.azimut());
        CockpitJU_88A4_Bombardier2.this.setNew.vspeed = ((199.0F * CockpitJU_88A4_Bombardier2.this.setOld.vspeed + CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.getVertSpeed()) / 200.0F);
        if (CockpitJU_88A4_Bombardier2.this.cockpitDimControl)
        {
          if (CockpitJU_88A4_Bombardier2.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A4_Bombardier2.this.setNew.dimPosition = (CockpitJU_88A4_Bombardier2.this.setOld.dimPosition - 0.05F);
        }
        else if (CockpitJU_88A4_Bombardier2.this.setNew.dimPosition < 1.0F)
          CockpitJU_88A4_Bombardier2.this.setNew.dimPosition = (CockpitJU_88A4_Bombardier2.this.setOld.dimPosition + 0.05F);
        float f4 = CockpitJU_88A4_Bombardier2.this.prevFuel - CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel;
        CockpitJU_88A4_Bombardier2.access$602(CockpitJU_88A4_Bombardier2.this, CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.jdField_M_of_type_ComMaddoxIl2FmMass.fuel);
        f4 /= 0.72F;
        f4 /= Time.tickLenFs();
        f4 *= 3600.0F;
        CockpitJU_88A4_Bombardier2.this.setNew.cons = (0.91F * CockpitJU_88A4_Bombardier2.this.setOld.cons + 0.09F * f4);
        if (CockpitJU_88A4_Bombardier2.this.buzzerFX != null)
          if ((CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.Loc.z < ((JU_88A4)CockpitJU_88A4_Bombardier2.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4)CockpitJU_88A4_Bombardier2.this.jdField_fm_of_type_ComMaddoxIl2FmFlightModel.actor).diveMechStage == 1)) {
            CockpitJU_88A4_Bombardier2.this.buzzerFX.play();
          }
          else if (CockpitJU_88A4_Bombardier2.this.buzzerFX.isPlaying())
            CockpitJU_88A4_Bombardier2.this.buzzerFX.stop();
      }
      return true;
    }
  ...
  private class Variables
  {
    ...
    float dimPosition;
    float cons;
    private final CockpitJU_88A4_Bombardier2 this$0;
    ...
    Variables(CockpitJU_88A4_Bombardier2.1 arg2)
    {
      this();
    }
  }
