...
public class MC_205_1 extends com.maddox.il2.objects.air.MC_202xyz
{
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, com.maddox.il2.objects.air.MC_205_1.cvt(f, 0.11F, 0.67F, 0.0F, -38F), 0.0F);
        hiermesh.chunkSetAngles("GearC3_D0", 0.0F, 0.0F, 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, com.maddox.il2.objects.air.MC_205_1.cvt(f, 0.01F, 0.09F, 0.0F, -80F), 0.0F);
        hiermesh.chunkSetAngles("GearC5_D0", 0.0F, com.maddox.il2.objects.air.MC_205_1.cvt(f, 0.01F, 0.09F, 0.0F, -80F), 0.0F);
    }
    ...
    public void moveSteering(float f)
    {
        ...
        {
            hierMesh().chunkSetAngles("GearC3_D0", 0.0F, com.maddox.il2.objects.air.MC_205_1.cvt(f, -30F, 30F, 30F, -30F), 0.0F);
            return;
        }
    }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.MC_205_1.weaponTriggersRegister(class1, new int[] {
            0, 0, 1, 1
        });
        com.maddox.il2.objects.air.MC_205_1.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04"
        });
        com.maddox.il2.objects.air.MC_205_1.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunBredaSAFAT127siMC205 370", "MGunBredaSAFAT127siMC205 370", "MGunBredaSAFAT77k 500", "MGunBredaSAFAT77k 500"
        });
        com.maddox.il2.objects.air.MC_205_1.weaponsRegister(class1, "none", new java.lang.String[] {
            null, null, null, null
        });
    }
}
