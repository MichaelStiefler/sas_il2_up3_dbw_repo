...
// Source File Name:   SN2Generic.java
...
public abstract class SN2Generic extends com.maddox.il2.engine.ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
        ...
        public boolean tick()
        {
            if(engineSFX != null)
                if(engineSTimer >= 0)
                {
                    if(--engineSTimer <= 0)
                    {
                        engineSTimer = (int)com.maddox.il2.objects.vehicles.stationary.SN2Generic.SecsToTicks(com.maddox.il2.objects.vehicles.stationary.SN2Generic.Rnd(5F, 5F));
                        if(!danger())
        ...
        implements com.maddox.il2.engine.ActorSpawn
    {
        ...
        {
            com.maddox.il2.objects.vehicles.stationary.SN2Generic sn2generic = null;
            try
            {
                com.maddox.il2.objects.vehicles.stationary.SN2Generic.constr_arg2 = actorspawnarg;
                sn2generic = (com.maddox.il2.objects.vehicles.stationary.SN2Generic)cls.newInstance();
                com.maddox.il2.objects.vehicles.stationary.SN2Generic.constr_arg2 = null;
            }
            catch(java.lang.Exception exception)
            {
                ...
                java.lang.System.out.println("SPAWN: Can't create SN2Generic object [class:" + cls.getName() + "]");
                return null;
            }
            return ((com.maddox.il2.engine.Actor) (sn2generic));
        }
        ...
        public SPAWN(java.lang.Class class1)
        {
            ...
            com.maddox.rts.Property.set(((java.lang.Object) (class1)), "meshName", com.maddox.il2.objects.vehicles.stationary.SN2Generic.mesh_name);
            cls = class1;
    ...
    private SN2Generic(com.maddox.il2.engine.ActorSpawnArg actorspawnarg)
    {
        super(mesh_name);
        engineSFX = null;
            ...
            for(int l = 0; l < k; l++)
            {
                ...
                if((actor instanceof com.maddox.il2.objects.air.Aircraft) && actor != com.maddox.il2.ai.World.getPlayerAircraft() && actor.getArmy() != myArmy)
                {
                    ...
                    if(l1 < 0)
                        l1 = 360 + l1;
                    int i2 = l1 - j;
                    if((float)k1 <= f && (double)k1 >= 400D && i2 >= 220 && i2 <= 320 && java.lang.Math.sqrt(j1 * j1) <= 60D && actor.getSpeed(vector3d) > 20D)
                    {
