...
public class CockpitSB2M100A_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((SB_2M100A)aircraft()).fSightCurForwardAngle;
                float f1 = -((SB_2M100A)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((SB_2M100A)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((SB_2M100A)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
