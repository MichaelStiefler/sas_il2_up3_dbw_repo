...
public class CmdConsole extends com.maddox.rts.Cmd
{
    ...
    {
        if(com.maddox.rts.Cmd.exist(map, "WRAP"))
            if(com.maddox.rts.Cmd.nargs(map, "WRAP") == 1)
            {
                java.lang.String s = com.maddox.rts.Cmd.arg(map, "WRAP", 0);
        ...
        if(com.maddox.rts.Cmd.exist(map, "PAUSE"))
            if(com.maddox.rts.Cmd.nargs(map, "PAUSE") == 1)
            {
                java.lang.String s1 = com.maddox.rts.Cmd.arg(map, "PAUSE", 0);
        ...
        if(com.maddox.rts.Cmd.exist(map, "LOG"))
            ...
            {
                java.lang.String s2 = com.maddox.rts.Cmd.arg(map, "LOG", 0);
        ...
        if(com.maddox.rts.Cmd.exist(map, "LOGTIME"))
            if(com.maddox.rts.Cmd.nargs(map, "LOGTIME") == 1)
            {
                java.lang.String s3 = com.maddox.rts.Cmd.arg(map, "LOGTIME", 0);
        ...
        if(com.maddox.rts.Cmd.exist(map, "LOGFILE"))
            ...
            {
                java.lang.String s4 = com.maddox.rts.Cmd.arg(map, "LOGFILE", 0);
        ...
        if(com.maddox.rts.Cmd.exist(map, "LOAD"))
            if(com.maddox.rts.Cmd.nargs(map, "LOAD") == 1)
            {
                java.lang.String s5 = com.maddox.rts.Cmd.arg(map, "LOAD", 0);
                com.maddox.rts.RTSConf.cur.console.load(s5);
            } else
            {
                ERR_HARD((java.lang.String)_properties.get("NAME") + " " + "LOAD" + " ???");
            }
        if(com.maddox.rts.Cmd.exist(map, "SAVE"))
            if(com.maddox.rts.Cmd.nargs(map, "SAVE") == 1)
            {
                java.lang.String s6 = com.maddox.rts.Cmd.arg(map, "SAVE", 0);
                com.maddox.rts.RTSConf.cur.console.save(s6);
            } else
            {
                ERR_HARD((java.lang.String)_properties.get("NAME") + " " + "SAVE" + " ???");
            }
        if(com.maddox.rts.Cmd.exist(map, "HISTORY"))
            if(com.maddox.rts.Cmd.nargs(map, "HISTORY") == 1)
            {
                int i = com.maddox.rts.Cmd.arg(map, "HISTORY", 0, 128, 0, 10000);
        ...
        if(com.maddox.rts.Cmd.exist(map, "HISTORYCMD"))
            if(com.maddox.rts.Cmd.nargs(map, "HISTORYCMD") == 1)
            {
                int j = com.maddox.rts.Cmd.arg(map, "HISTORYCMD", 0, 128, 0, 10000);
        ...
        if(com.maddox.rts.Cmd.exist(map, "PAGE"))
            if(com.maddox.rts.Cmd.nargs(map, "PAGE") == 1)
            {
                int k = com.maddox.rts.Cmd.arg(map, "PAGE", 0, 20, 1, 100);
        ...
        if(com.maddox.rts.Cmd.exist(map, "CLEAR"))
