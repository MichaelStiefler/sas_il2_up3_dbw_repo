  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitLA_7.this.fm != null) {
        ...
        CockpitLA_7.this.setNew.throttle = ((10.0F * CockpitLA_7.this.setOld.throttle + CockpitLA_7.this.fm.CT.PowerControl) / 11.0F);
        CockpitLA_7.this.setNew.prop = ((8.0F * CockpitLA_7.this.setOld.prop + CockpitLA_7.this.fm.CT.getStepControl()) / 9.0F);
        CockpitLA_7.this.setNew.altimeter = CockpitLA_7.this.fm.getAltitude();
        if (Math.abs(CockpitLA_7.this.fm.Or.getKren()) < 30.0F) {
          CockpitLA_7.this.setNew.azimuth = ((35.0F * CockpitLA_7.this.setOld.azimuth + -CockpitLA_7.this.fm.Or.getYaw()) / 36.0F);
        }
        ...
        {
          CockpitLA_7.this.setNew.waypointAzimuth = 0.0F;
        }
        else
        {
          CockpitLA_7.this.setNew.waypointAzimuth = ((10.0F * CockpitLA_7.this.setOld.waypointAzimuth + (CockpitLA_7.this.waypointAzimuth() - CockpitLA_7.this.setOld.azimuth)) / 11.0F);
        }

        CockpitLA_7.this.setNew.vspeed = ((199.0F * CockpitLA_7.this.setOld.vspeed + CockpitLA_7.this.fm.getVertSpeed()) / 200.0F);
        if (CockpitLA_7.this.fm.getAltitude() > 3000.0F) {
          float f = (float)Math.sin(1.0F * CockpitLA_7.this.cvt(CockpitLA_7.this.fm.getOverload(), 1.0F, 8.0F, 1.0F, 0.45F) * CockpitLA_7.this.cvt(CockpitLA_7.this.fm.AS.astatePilotStates[0], 0.0F, 100.0F, 1.0F, 0.1F) * (0.001F * (float)Time.current()));
          if (f > 0.0F) {
        ...
        CockpitLA_7.access$502(CockpitLA_7.this, 0.8F * CockpitLA_7.this.pictStage + 0.1F * CockpitLA_7.this.fm.EI.engines[0].getControlCompressor());
      }
      return true;
    }
  }
