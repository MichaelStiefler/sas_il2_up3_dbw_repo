...
public abstract class KI_46 extends Scheme2
{
  public static void moveGear(HierMesh paramHierMesh, float paramFloat)
  {
    ...
    xyz[1] = (0.415F * paramFloat);
    paramHierMesh.chunkSetLocate("GearC2_D0", xyz, ypr);
    paramHierMesh.chunkSetAngles("GearC3_D0", 0.0F, cvt(paramFloat, 0.01F, 0.05F, 0.0F, -50.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearC4_D0", 0.0F, cvt(paramFloat, 0.01F, 0.05F, 0.0F, -50.0F), 0.0F);

    paramHierMesh.chunkSetAngles("GearL2_D0", 0.0F, cvt(paramFloat, 0.05F, 0.88F, 0.0F, -120.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL4_D0", 0.0F, cvt(paramFloat, 0.05F, 0.11F, 0.0F, -70.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearL5_D0", 0.0F, cvt(paramFloat, 0.05F, 0.11F, 0.0F, -70.0F), 0.0F);

    paramHierMesh.chunkSetAngles("GearR2_D0", 0.0F, cvt(paramFloat, 0.18F, 0.98F, 0.0F, -120.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR4_D0", 0.0F, cvt(paramFloat, 0.18F, 0.24F, 0.0F, -70.0F), 0.0F);
    paramHierMesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(paramFloat, 0.18F, 0.24F, 0.0F, -70.0F), 0.0F);
  }
  ...
  public void moveWheelSink() {
    ...
    hierMesh().chunkSetAngles("GearL6_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.16F, 0.0F, -32.0F), 0.0F);
    hierMesh().chunkSetAngles("GearL7_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.16F, 0.0F, -64.0F), 0.0F);
    resetYPRmodifier();
    xyz[1] = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.16F, 0.0F, 0.16F);
    hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
    hierMesh().chunkSetAngles("GearR6_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.16F, 0.0F, -32.0F), 0.0F);
    hierMesh().chunkSetAngles("GearR7_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.16F, 0.0F, -64.0F), 0.0F);
  }
  ...
  protected boolean cutFM(int paramInt1, int paramInt2, Actor paramActor)
  {
    ...
    case 37:
      ...
      if (World.Rnd().nextInt(0, 99) >= 66) break; this.FM.AS.hitEngine(this, 1, 1);
    case 35:
    }
    ...
    if (paramString.startsWith("xx")) {
      ...
      if (paramString.startsWith("xxpar")) {
        if ((paramString.startsWith("xxpark")) && 
          (chunkDamageVisible("Keel1") > 1) && (getEnergyPastArmor(12.699999809265137D / (1.000100016593933D - Math.abs(v1.y)), paramShot) > 0.0F)) {
        ...
        if ((paramString.startsWith("xxparlm")) && 
          (chunkDamageVisible("WingLMid") > 2) && (getEnergyPastArmor(12.800000190734863D / (1.000100016593933D - Math.abs(v1.y)), paramShot) > 0.0F)) {
          debuggunnery("*** WingLMid Spars Damaged..");
          nextDMGLevels(1, 2, "WingLMid_D3", paramShot.initiator);
        }

        if ((paramString.startsWith("xxparrm")) && 
          (chunkDamageVisible("WingRMid") > 2) && (getEnergyPastArmor(12.800000190734863D / (1.000100016593933D - Math.abs(v1.y)), paramShot) > 0.0F)) {
          debuggunnery("*** WingRMid Spars Damaged..");
          nextDMGLevels(1, 2, "WingRMid_D3", paramShot.initiator);
        }

        if ((paramString.startsWith("xxparlo")) && 
          (chunkDamageVisible("WingLOut") > 2) && (getEnergyPastArmor(12.800000190734863D / (1.000100016593933D - Math.abs(v1.y)), paramShot) > 0.0F)) {
          debuggunnery("*** WingLOut Spars Damaged..");
          nextDMGLevels(1, 2, "WingLOut_D3", paramShot.initiator);
        }

        if ((paramString.startsWith("xxparro")) && 
          (chunkDamageVisible("WingROut") > 2) && (getEnergyPastArmor(12.800000190734863D / (1.000100016593933D - Math.abs(v1.y)), paramShot) > 0.0F)) {
          debuggunnery("*** WingROut Spars Damaged..");
          nextDMGLevels(1, 2, "WingROut_D3", paramShot.initiator);
        }

        if ((paramString.startsWith("xxparrs")) && 
          (chunkDamageVisible("StabL") > 1) && (getEnergyPastArmor(12.800000190734863D / (1.000100016593933D - Math.abs(v1.y)), paramShot) > 0.0F)) {
          debuggunnery("*** StabL Spars Damaged..");
          nextDMGLevels(1, 2, "StabL_D2", paramShot.initiator);
        }

        if ((paramString.startsWith("xxparls")) && 
          (chunkDamageVisible("StabR") > 1) && (getEnergyPastArmor(12.800000190734863D / (1.000100016593933D - Math.abs(v1.y)), paramShot) > 0.0F)) {
