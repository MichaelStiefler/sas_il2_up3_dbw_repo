// Source File Name: CockpitGLADIATOR1.java
...
public class CockpitGLADIATOR1 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (((CockpitGLADIATOR1.this.fm.AS.astateCockpitState & 2) != 0)
					&& (CockpitGLADIATOR1.this.setNew.stbyPosition < 1.0F)) {
			...
			CockpitGLADIATOR1.this.setNew.altimeter = CockpitGLADIATOR1.this.fm
					.getAltitude();
			if (Math.abs(CockpitGLADIATOR1.this.fm.Or.getKren()) < 30F) {
				CockpitGLADIATOR1.this.setNew.azimuth = ((21F * CockpitGLADIATOR1.this.setOld.azimuth) + CockpitGLADIATOR1.this.fm.Or
						.azimut()) / 22F;
			}
			if ((CockpitGLADIATOR1.this.setOld.azimuth > 270F)
					&& (CockpitGLADIATOR1.this.setNew.azimuth < 90F)) {
				CockpitGLADIATOR1.this.setOld.azimuth -= 360F;
			}
			if ((CockpitGLADIATOR1.this.setOld.azimuth < 90F)
					&& (CockpitGLADIATOR1.this.setNew.azimuth > 270F)) {
				CockpitGLADIATOR1.this.setOld.azimuth += 360F;
			}
			CockpitGLADIATOR1.this.setNew.throttle = ((10F * CockpitGLADIATOR1.this.setOld.throttle) + CockpitGLADIATOR1.this.fm.EI.engines[0]
					.getControlThrottle()) / 11F;
			CockpitGLADIATOR1.this.setNew.mix = ((10F * CockpitGLADIATOR1.this.setOld.mix) + CockpitGLADIATOR1.this.fm.EI.engines[0]
					.getControlMix()) / 11F;
			CockpitGLADIATOR1.this.setNew.prop = CockpitGLADIATOR1.this.setOld.prop;
			if (CockpitGLADIATOR1.this.setNew.prop < (CockpitGLADIATOR1.this.fm.EI.engines[0]
			...
			CockpitGLADIATOR1.this.setNew.vspeed = ((199F * CockpitGLADIATOR1.this.setOld.vspeed) + CockpitGLADIATOR1.this.fm
					.getVertSpeed()) / 200F;
			CockpitGLADIATOR1.this.pictSupc = (0.8F * CockpitGLADIATOR1.this.pictSupc)
					+ (0.2F * CockpitGLADIATOR1.this.fm.EI.engines[0]
