// Source File Name: CockpitB29.java
...
public class CockpitB29 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitB29.this.fm != null) {
				...
				CockpitB29.this.setNew.throttle1 = (0.85F * CockpitB29.this.setOld.throttle1)
						+ (CockpitB29.this.fm.EI.engines[0]
								.getControlThrottle() * 0.15F);
				CockpitB29.this.setNew.throttle2 = (0.85F * CockpitB29.this.setOld.throttle2)
						+ (CockpitB29.this.fm.EI.engines[1]
								.getControlThrottle() * 0.15F);
				CockpitB29.this.setNew.prop1 = (0.85F * CockpitB29.this.setOld.prop1)
						+ (CockpitB29.this.fm.EI.engines[0].getControlProp() * 0.15F);
				CockpitB29.this.setNew.prop2 = (0.85F * CockpitB29.this.setOld.prop2)
						+ (CockpitB29.this.fm.EI.engines[1].getControlProp() * 0.15F);
				CockpitB29.this.setNew.altimeter = CockpitB29.this.fm
						.getAltitude();
				float f = CockpitB29.this.waypointAzimuth();
				CockpitB29.this.setNew.azimuth.setDeg(
						CockpitB29.this.setOld.azimuth.getDeg(1.0F),
						CockpitB29.this.fm.Or.azimut());
				CockpitB29.this.setNew.waypointAzimuth.setDeg(
						CockpitB29.this.setOld.waypointAzimuth.getDeg(1.0F), f);
				CockpitB29.this.setNew.waypointDeviation.setDeg(
						CockpitB29.this.setOld.waypointDeviation.getDeg(0.1F),
						(f - CockpitB29.this.setOld.azimuth.getDeg(1.0F))
								+ World.Rnd().nextFloat(-10F, 10F));
				CockpitB29.this.setNew.vspeed = ((199F * CockpitB29.this.setOld.vspeed) + CockpitB29.this.fm
						.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_FuelPres1", 0.0F, this.cvt(
				this.fm.M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270F),
				0.0F);
		this.mesh.chunkSetAngles("Z_FuelPres2", 0.0F, this.cvt(
				this.fm.M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270F),
				0.0F);
