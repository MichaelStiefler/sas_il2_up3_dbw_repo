...
// Source File Name:   CockpitKI_44_II_ko.java
...
public class CockpitKI_44_II_ko extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    private void leave()
    {
        if(bEntered)
        {
            ...
            boolean bool = com.maddox.rts.HotKeyEnv.isEnabled("aircraftView");
            com.maddox.rts.HotKeyEnv.enable("PanView", bool);
            com.maddox.rts.HotKeyEnv.enable("SnapView", bool);
            bEntered = false;
