...
// Source File Name:   CockpitBF_110C1.java
...
//            CockpitPilot, Aircraft, Cockpit, BF_110C1

public class CockpitBF_110C1 extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if((com.maddox.il2.objects.air.BF_110C1)aircraft() != null);
            if(com.maddox.il2.objects.air.BF_110C1.bChangedPit)
            {
                reflectPlaneToModel();
                if((com.maddox.il2.objects.air.BF_110C1)aircraft() != null);
                com.maddox.il2.objects.air.BF_110C1.bChangedPit = false;
            }
            setTmp = setOld;
            setOld = setNew;
            setNew = setTmp;
