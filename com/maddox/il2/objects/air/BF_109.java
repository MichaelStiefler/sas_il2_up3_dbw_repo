    ...
    implements com.maddox.il2.objects.air.TypeFighter
{
    ...
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.BF_109.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.3F, 0.0F, 0.3F);
        hierMesh().chunkSetLocate("GearL99_D0", xyz, ypr);
        xyz[2] = com.maddox.il2.objects.air.BF_109.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.3F, 0.0F, 0.3F);
    ...
    protected void hitBone(java.lang.String s, com.maddox.il2.ai.Shot shot, com.maddox.JGP.Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Armor: Hit..");
                if(s.endsWith("p1"))
                {
                    getEnergyPastArmor(com.maddox.il2.ai.World.Rnd().nextFloat(20F, 30F), shot);
                    FM.AS.setCockpitState(shot.initiator, FM.AS.astateCockpitState | 2);
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Armor Glass: Hit..");
                    if(shot.power <= 0.0F)
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
                ...
                if(s.endsWith("p4"))
                    getEnergyPastArmor(9D / (java.lang.Math.abs(v1.z) + 9.9999997473787516E-006D), shot);
                else
                if(s.endsWith("p5"))
                    getEnergyPastArmor(9D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
                else
                if(s.endsWith("p6"))
                    getEnergyPastArmor(9D / (java.lang.Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
                else
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 4: // '\004'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Aileron Controls: Control Crank Destroyed..");
                    }
                    break;
                ...
                case 3: // '\003'
                    ...
                    {
                        FM.AS.setControlsDamage(shot.initiator, 0);
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Aileron Controls: Disabled..");
                    }
                    break;
                ...
                case 6: // '\006'
                    if(getEnergyPastArmor(0.002F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Elevator Controls: Disabled / Strings Broken..");
                    }
                    break;
                ...
                case 7: // '\007'
                    if(getEnergyPastArmor(2.3F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.2F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Rudder Controls: Disabled..");
                    }
                    break;
                ...
                case 8: // '\b'
                    ...
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                        FM.AS.setControlsDamage(shot.initiator, 2);
                        FM.AS.setControlsDamage(shot.initiator, 1);
                        FM.AS.setControlsDamage(shot.initiator, 0);
                    }
                ...
                case 9: // '\t'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Throttle Quadrant: Hit, Engine Controls Disabled..");
                    }
                    break;
                }
            }
            ...
            {
                com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Spar Construction: Hit..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Tail1 Spars Broken in Half..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingLIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingRIn Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingLMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingRMid Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingLOut Spars Damaged..");
                ...
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingROut Spars Damaged..");
            ...
            if(s.startsWith("xxwj") && getEnergyPastArmor(12.5F, shot) > 0.0F)
                if(s.endsWith("l"))
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingL Console Lock Destroyed..");
                    nextDMGLevels(4, 2, "WingLIn_D" + chunkDamageVisible("WingLIn"), shot.initiator);
                } else
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** WingR Console Lock Destroyed..");
                    nextDMGLevels(4, 2, "WingRIn_D" + chunkDamageVisible("WingRIn"), shot.initiator);
                }
            if(s.startsWith("xxlock"))
            {
                com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Lock Construction: Hit..");
                if(s.startsWith("xxlockr") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Rudder Lock Shot Off..");
                    nextDMGLevels(3, 2, "Rudder1_D" + chunkDamageVisible("Rudder1"), shot.initiator);
                }
                if(s.startsWith("xxlockvl") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** VatorL Lock Shot Off..");
                    nextDMGLevels(3, 2, "VatorL_D" + chunkDamageVisible("VatorL"), shot.initiator);
                }
                if(s.startsWith("xxlockvr") && getEnergyPastArmor(5.5F * com.maddox.il2.ai.World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** VatorR Lock Shot Off..");
                    nextDMGLevels(3, 2, "VatorR_D" + chunkDamageVisible("VatorR"), shot.initiator);
                }
            }
            if(s.startsWith("xxeng"))
            {
                com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Hit..");
                if(s.endsWith("pipe"))
                {
                    if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.1F && FM.CT.Weapons[1] != null && FM.CT.Weapons[1].length != 2)
                    {
                        FM.AS.setJamBullets(1, 0);
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Nose Nozzle Pipe Bent..");
                    }
                ...
                if(s.endsWith("prop"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.8F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Prop Governor Hit, Disabled..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 4);
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Prop Governor Hit, Damaged..");
                        }
                } else
                if(s.endsWith("gear"))
                {
                    if(getEnergyPastArmor(4.6F, shot) > 0.0F)
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Bullet Jams Reductor Gear..");
                        } else
                        {
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 3);
                            FM.AS.setEngineSpecificDamage(shot.initiator, 0, 4);
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Reductor Gear Damaged, Prop Governor Failed..");
                        }
                } else
                if(s.endsWith("supc"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Supercharger Disabled..");
                    }
                } else
                if(s.endsWith("feed"))
                {
                    if(getEnergyPastArmor(3.2F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F && FM.EI.engines[0].getPowerOutput() > 0.7F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Pressurized Fuel Line Pierced, Fuel Flamed..");
                    }
                } else
                if(s.endsWith("fuel"))
                {
                    if(getEnergyPastArmor(1.1F, shot) > 0.0F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Fuel Line Stalled, Engine Stalled..");
                    }
                } else
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(2.1F, shot) > 0.0F)
                    {
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 175000F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Bullet Jams Crank Ball Bearing..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 50000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 2);
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Crank Case Hit, Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                        }
                ...
                if(s.startsWith("xxeng1cyl"))
                {
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 1.75F)
                    {
                        ...
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < shot.power / 24000F)
                        {
                            FM.AS.hitEngine(shot.initiator, 0, 3);
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Cylinders Hit, Engine Fires..");
                        }
                        if(com.maddox.il2.ai.World.Rnd().nextFloat() < 0.01F)
                        {
                            FM.AS.setEngineStuck(shot.initiator, 0);
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Bullet Jams Piston Head..");
                        }
                        getEnergyPastArmor(22.5F, shot);
                    }
                } else
                if(s.startsWith("xxeng1mag"))
                {
                    ...
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Magneto " + j + " Destroyed..");
                } else
                if(s.endsWith("sync"))
                {
                    if(getEnergyPastArmor(2.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Gun Synchronized Hit, Nose Guns Lose Authority..");
                ...
                if(s.endsWith("oil1"))
                {
                    ...
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Oil Radiator Hit..");
                }
            }
            if(s.startsWith("xxoil"))
            {
                ...
                com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Engine Module: Oil Tank Pierced..");
            }
            if(s.startsWith("xxtank"))
            {
                ...
                case 2: // '\002'
                    if(getEnergyPastArmor(0.1F, shot) > 0.0F && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.25F)
                    {
                        ...
                        {
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Fuel Tank: Pierced..");
                        ...
                        if(shot.powerType == 3 && com.maddox.il2.ai.World.Rnd().nextFloat() < 0.5F)
                        {
                            ...
                            com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Fuel Tank: Hit..");
                        }
                    }
                    break;
                ...
                case 3: // '\003'
                    ...
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** MW50 Tank: Pierced..");
                ...
                case 4: // '\004'
                    ...
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Nitrogen Oxyde Tank: Pierced, Nitros Flamed..");
            ...
            if(s.startsWith("xxmgun"))
            {
                if(s.endsWith("01"))
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Cowling Gun: Disabled..");
                    FM.AS.setJamBullets(0, 0);
                }
                if(s.endsWith("02"))
                {
                ...
                if(s.endsWith("l"))
                {
                    com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Wing Gun (L): Disabled..");
                    FM.AS.setJamBullets(1, 0);
                }
                if(s.endsWith("r"))
                {
            ...
            {
                com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Nose Cannon: Disabled..");
                FM.AS.setJamBullets(1, 0);
            ...
            if(s.startsWith("xxammo"))
            {
                if(com.maddox.il2.ai.World.Rnd().nextFloat(3800F, 30000F) < shot.power)
                {
                    if(s.endsWith("01"))
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Cowling Gun: Ammo Feed Chain Broken..");
                        FM.AS.setJamBullets(0, 0);
                    }
                    if(s.endsWith("02"))
                    {
                    ...
                    if(s.endsWith("l"))
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Wing Gun (L): Ammo Feed Drum Damaged..");
                        FM.AS.setJamBullets(1, 0);
                    }
                    if(s.endsWith("r"))
                    {
                        com.maddox.il2.objects.air.BF_109.debugprintln(this, "*** Wing Gun (R): Ammo Feed Drum Damaged..");
                        FM.AS.setJamBullets(1, 1);
                    }
                }
