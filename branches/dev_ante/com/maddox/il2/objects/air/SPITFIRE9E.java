  ...
  implements TypeFighterAceMaker
{
  ...
  static
  {
    Class localClass = SPITFIRE9E.class;
    ...
    Property.set(localClass, "FlightModel", "FlightModels/SpitfireLF_IXC.fmd");

    Property.set(localClass, "cockpitClass", CockpitSpit9E.class);
