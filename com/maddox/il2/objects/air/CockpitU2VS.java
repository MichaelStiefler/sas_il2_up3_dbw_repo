...
public class CockpitU2VS extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("thrtl", 30F - 57F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
        mesh.chunkSetAngles("Prop", interp(setNew.prop, setOld.prop, f) * -57F + 30F, 0.0F, 0.0F);
        mesh.chunkSetAngles("thr_tross", -30F + 57F * interp(setNew.throttle, setOld.throttle, f), 0.0F, 0.0F);
