...
public class TableFunction2
{
    ...
    private static com.maddox.util.TableFunction2 find(java.lang.String s)
    {
        for(int i = 0; i < functions.size(); i++)
            if(s.equalsIgnoreCase(((com.maddox.util.TableFunction2)(com.maddox.util.TableFunction2)functions.get(i)).name))
                return (com.maddox.util.TableFunction2)(com.maddox.util.TableFunction2)functions.get(i);
    ...
    private TableFunction2(java.lang.String s, com.maddox.rts.SectFile sectfile, java.lang.String s1)
    {
        ...
        for(int i1 = 0; i1 < k; i1++)
        {
            ...
            for(int l1 = 0; l1 < j; l1++)
                val[i1][l1] = numbertokenizer2.nextFloat();

        }

        for(int j1 = 1; j1 < j; j1++)
            if(arg0[j1 - 1] >= arg0[j1])
                TableError("arg0 non-increasing");

        for(int k1 = 1; k1 < k; k1++)
            if(arg1[k1 - 1] >= arg1[k1])
