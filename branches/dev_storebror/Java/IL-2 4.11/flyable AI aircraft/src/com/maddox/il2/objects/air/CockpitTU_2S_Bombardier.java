...
public class CockpitTU_2S_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitTU_2S_Bombardier.this.bEntered) {
				float f = ((TU_2S) CockpitTU_2S_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((TU_2S) CockpitTU_2S_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitTU_2S_Bombardier.this.mesh.chunkSetAngles("BlackBox",
						f1, 0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1,
						CockpitTU_2S_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	}
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1",
				((TU_2S) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F,
				0.0F);
		float f1 = this.cvt(((TU_2S) this.aircraft()).fSightSetForwardAngle,
				-15F, 75F, -15F, 75F);
