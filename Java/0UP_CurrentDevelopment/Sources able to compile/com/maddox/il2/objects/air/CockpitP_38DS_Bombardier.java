...
public class CockpitP_38DS_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((P_38DroopSnoot)aircraft()).fSightCurForwardAngle;
            float f1 = ((P_38DroopSnoot)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((P_38DroopSnoot)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((P_38DroopSnoot)aircraft()).fSightCurReadyness > 0.93F;
