...
public class CockpitMIG_3U extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    if (this.fm.Gears.isHydroOperable()) this.mesh.chunkSetAngles("zGearLever1a", 30.0F - 60.0F * this.fm.CT.GearControl, 0.0F, 0.0F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitMIG_3U.this.fm != null) {
        ...
        CockpitMIG_3U.this.setNew.throttle = ((10.0F * CockpitMIG_3U.this.setOld.throttle + CockpitMIG_3U.this.fm.CT.PowerControl) / 11.0F);
        CockpitMIG_3U.this.setNew.prop = ((10.0F * CockpitMIG_3U.this.setOld.prop + CockpitMIG_3U.this.fm.EI.engines[0].getControlProp()) / 11.0F);
        CockpitMIG_3U.this.setNew.altimeter = CockpitMIG_3U.this.fm.getAltitude();
        if (Math.abs(CockpitMIG_3U.this.fm.Or.getKren()) < 30.0F) {
          CockpitMIG_3U.this.setNew.azimuth = ((35.0F * CockpitMIG_3U.this.setOld.azimuth + CockpitMIG_3U.this.fm.Or.azimut()) / 36.0F);
        }
        ...
        CockpitMIG_3U.this.setNew.vspeed = ((199.0F * CockpitMIG_3U.this.setOld.vspeed + CockpitMIG_3U.this.fm.getVertSpeed()) / 200.0F);
      }
