...
public class CockpitPE3_1_TGunner extends CockpitGunner
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitPE3_1_TGunner.this.fm != null)
      {
        ...
        CockpitPE3_1_TGunner.this.setNew.man1 = (0.92F * CockpitPE3_1_TGunner.this.setOld.man1 + 0.08F * CockpitPE3_1_TGunner.this.fm.EI.engines[0].getManifoldPressure());

        CockpitPE3_1_TGunner.this.setNew.man2 = (0.92F * CockpitPE3_1_TGunner.this.setOld.man2 + 0.08F * CockpitPE3_1_TGunner.this.fm.EI.engines[1].getManifoldPressure());
        CockpitPE3_1_TGunner.this.setNew.altimeter = CockpitPE3_1_TGunner.this.fm.getAltitude();

        CockpitPE3_1_TGunner.this.setNew.azimuth.setDeg(CockpitPE3_1_TGunner.this.setOld.azimuth.getDeg(1.0F), CockpitPE3_1_TGunner.this.fm.Or.azimut());

        CockpitPE3_1_TGunner.this.setNew.vspeed = ((100.0F * CockpitPE3_1_TGunner.this.setOld.vspeed + CockpitPE3_1_TGunner.this.fm.getVertSpeed()) / 101.0F);

        if (CockpitPE3_1_TGunner.this.useRealisticNavigationInstruments())
        {
          CockpitPE3_1_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE3_1_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE3_1_TGunner.this.getBeaconDirection());
        }
        else
        {
          CockpitPE3_1_TGunner.this.setNew.waypointAzimuth.setDeg(CockpitPE3_1_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE3_1_TGunner.this.waypointAzimuth() - CockpitPE3_1_TGunner.this.setOld.azimuth.getDeg(1.0F));
        }

        CockpitPE3_1_TGunner.this.setNew.inert = (0.999F * CockpitPE3_1_TGunner.this.setOld.inert + 0.001F * (CockpitPE3_1_TGunner.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
      }
