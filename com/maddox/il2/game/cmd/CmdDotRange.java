...
public class CmdDotRange extends com.maddox.rts.Cmd
{
    ...
    public java.lang.Object exec(com.maddox.rts.CmdEnv cmdenv, java.util.Map map)
    {
        ...
        if(com.maddox.il2.game.Main.cur().netServerParams != null && com.maddox.il2.game.Main.cur().netServerParams.isMaster())
        {
            ...
            {
                double d = com.maddox.il2.game.cmd.CmdDotRange.arg(map, "DOT", 0, -1D) * 1000D;
                double d1 = com.maddox.il2.game.cmd.CmdDotRange.arg(map, "COLOR", 0, -1D) * 1000D;
                double d2 = com.maddox.il2.game.cmd.CmdDotRange.arg(map, "TYPE", 0, -1D) * 1000D;
                double d3 = com.maddox.il2.game.cmd.CmdDotRange.arg(map, "NAME", 0, -1D) * 1000D;
                double d4 = com.maddox.il2.game.cmd.CmdDotRange.arg(map, "ID", 0, -1D) * 1000D;
                double d5 = com.maddox.il2.game.cmd.CmdDotRange.arg(map, "RANGE", 0, -1D) * 1000D;
                if(flag)
                {
