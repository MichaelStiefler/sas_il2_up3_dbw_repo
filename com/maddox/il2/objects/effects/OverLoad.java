    ...
    implements com.maddox.opengl.MsgGLContextListener
{
    ...
    public void destroy()
    {
        com.maddox.il2.engine.Camera camera = ((com.maddox.il2.engine.Render)this).getCamera();
        if(com.maddox.il2.engine.Actor.isValid(((com.maddox.il2.engine.Actor) (camera))))
            ((com.maddox.il2.engine.Actor) (camera)).destroy();
        super.destroy();
    }
    ...
    public OverLoad(int i, float f)
    {
        ...
        _indx = 0;
        _indx = i;
        ((com.maddox.il2.engine.Render)this).useClearDepth(false);
        ((com.maddox.il2.engine.Render)this).useClearColor(false);
        if(_indx == 0)
            ((com.maddox.il2.engine.Actor)this).setName("renderOverLoad");
        com.maddox.opengl.GLContext.getCurrent().msgAddListener(((java.lang.Object) (this)), ((java.lang.Object) (null)));
        if(i != 0)
