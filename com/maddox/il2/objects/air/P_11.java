  ...
  implements TypeFighter, TypeTNBFighter
{
  ...
  protected void hitBone(String paramString, Shot paramShot, Point3d paramPoint3d)
  {
    ...
    if (paramString.startsWith("xx"))
    {
      ...
      if (paramString.startsWith("xxspar"))
      {
        ...
        if ((paramString.startsWith("xxstabl")) && (getEnergyPastArmor(5.5F, paramShot) > 0.0F))
        {
          Aircraft.debugprintln(this, "*** StabL Spars Damaged..");
          nextDMGLevels(1, 2, "StabL_D" + chunkDamageVisible("StabL"), paramShot.initiator);
        }
        if ((paramString.startsWith("xxstabr")) && (getEnergyPastArmor(5.5F, paramShot) > 0.0F))
        {
  ...
  public void moveWheelSink()
  {
    ...
    hierMesh().chunkSetAngles("GearL2_D0", 0.0F, 20.0F * f, 0.0F);
    Aircraft.xyz[2] = (-0.21F * f);
    f = Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, 0.35F);
    hierMesh().chunkSetAngles("GearR2_D0", 0.0F, -20.0F * f, 0.0F);
    Aircraft.xyz[2] = (-0.21F * f);
  }

  static
  {
    Class localClass = P_11.class;
