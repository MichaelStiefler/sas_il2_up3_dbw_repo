...
;
    ...
    public static void moveGear(com.maddox.il2.engine.HierMesh hiermesh, float f)
    {
        ...
        xyz[2] = com.maddox.il2.objects.air.HE_162.cvt(f, 0.0F, 1.0F, -0.0833F, 0.0F);
    ...
    {
        resetYPRmodifier();
        xyz[1] = com.maddox.il2.objects.air.HE_162.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.0632F, 0.0F, 0.0632F);
        if(FM.CT.getGear() > 0.99F)
            ypr[1] = 40F * FM.CT.getRudder();
        hierMesh().chunkSetLocate("GearC25_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearC27_D0", 0.0F, com.maddox.il2.objects.air.HE_162.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.0632F, 0.0F, -15F), 0.0F);
        hierMesh().chunkSetAngles("GearC28_D0", 0.0F, com.maddox.il2.objects.air.HE_162.cvt(FM.Gears.gWheelSinking[2], 0.0F, 0.0632F, 0.0F, 30F), 0.0F);
    }
