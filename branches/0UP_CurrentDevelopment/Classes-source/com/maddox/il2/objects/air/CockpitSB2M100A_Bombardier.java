...
// Source File Name:   CockpitSB2M100A_Bombardier.java
...
//            CockpitPilot, SB_2M100A, Cockpit

public class CockpitSB2M100A_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((com.maddox.il2.objects.air.SB_2M100A)aircraft()).fSightCurForwardAngle;
                float f1 = -((com.maddox.il2.objects.air.SB_2M100A)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((com.maddox.il2.objects.air.SB_2M100A)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((com.maddox.il2.objects.air.SB_2M100A)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
