...
public class CockpitJ2M3 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.mesh.chunkSetAngles("Z_Gear2", this.pictGear > 0.0F ? 5.0F : 0.0F, 0.0F, 0.0F);
    ...
    this.mesh.chunkSetAngles("Z_Trigger", (this.fm.CT.saveWeaponControl[0] != 0) || (this.fm.CT.saveWeaponControl[1] != 0) ? -16.5F : 0.0F, 0.0F, 0.0F);
    ...
    resetYPRmodifier();
    xyz[0] = cvt(this.fm.CT.getFlap(), 0.0F, 1.0F, 0.0F, 0.045F);
    this.mesh.chunkSetLocate("Z_Flap_Ind", xyz, ypr);
    ...
    this.mesh.chunkSetAngles("Z_Trim1a", 0.0F, 0.0F, 27.0F * this.fm.CT.getTrimElevatorControl());
    this.mesh.chunkSetAngles("Z_Trim2a", 0.0F, 0.0F, 27.0F * this.fm.CT.getTrimRudderControl());
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJ2M3.this.fm != null) {
        ...
        CockpitJ2M3.this.setNew.vspeed = ((199.0F * CockpitJ2M3.this.setOld.vspeed + CockpitJ2M3.this.fm.getVertSpeed()) / 200.0F);
