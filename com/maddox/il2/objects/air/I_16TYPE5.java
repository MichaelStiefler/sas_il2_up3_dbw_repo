    ...
    implements com.maddox.il2.objects.air.TypeTNBFighter
{
    ...
    protected void moveFan(float f)
    {
        if(com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            ...
            hierMesh().chunkSetAngles("Stick_D0", 0.0F, 12F * f1, com.maddox.il2.objects.air.I_16TYPE5.cvt(f2, -1F, 1.0F, -12F, 18F));
            hierMesh().chunkSetAngles("pilotarm2_d0", com.maddox.il2.objects.air.I_16TYPE5.cvt(f1, -1F, 1.0F, 14F, -16F), 0.0F, com.maddox.il2.objects.air.I_16TYPE5.cvt(f1, -1F, 1.0F, 6F, -8F) - (com.maddox.il2.objects.air.I_16TYPE5.cvt(f2, -1F, 0.0F, -36F, 0.0F) + com.maddox.il2.objects.air.I_16TYPE5.cvt(f2, 0.0F, 1.0F, 0.0F, 32F)));
            hierMesh().chunkSetAngles("pilotarm1_d0", 0.0F, 0.0F, com.maddox.il2.objects.air.I_16TYPE5.cvt(f1, -1F, 1.0F, -16F, 14F) + com.maddox.il2.objects.air.I_16TYPE5.cvt(f2, -1F, 0.0F, -62F, 0.0F) + com.maddox.il2.objects.air.I_16TYPE5.cvt(f2, 0.0F, 1.0F, 0.0F, 44F));
        }
    }
    ...
    static 
    {
        ...
        com.maddox.il2.objects.air.I_16TYPE5.weaponTriggersRegister(class1, new int[] {
            0, 0, 3, 3, 9, 9
        });
        com.maddox.il2.objects.air.I_16TYPE5.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalDev07", "_ExternalDev08"
        });
        com.maddox.il2.objects.air.I_16TYPE5.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunShKASk 900", "MGunShKASk 900", null, null, null, null
        });
        com.maddox.il2.objects.air.I_16TYPE5.weaponsRegister(class1, "2x50kg", new java.lang.String[] {
            "MGunShKASk 900", "MGunShKASk 900", "BombGunFAB50 1", "BombGunFAB50 1", null, null
        });
        com.maddox.il2.objects.air.I_16TYPE5.weaponsRegister(class1, "2x100kg", new java.lang.String[] {
            "MGunShKASk 900", "MGunShKASk 900", "BombGunFAB100 1", "BombGunFAB100 1", null, null
        });
        com.maddox.il2.objects.air.I_16TYPE5.weaponsRegister(class1, "PV-1", new java.lang.String[] {
            "MGunPV1 900", "MGunPV1 900", null, null, null, null
        });
        com.maddox.il2.objects.air.I_16TYPE5.weaponsRegister(class1, "none", new java.lang.String[] {
