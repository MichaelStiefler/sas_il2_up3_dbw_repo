...
public class CockpitJU_88A4torp_Observer extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    float f1 = ((JU_88A4torp)aircraft()).fAOB;
    float f2 = ((JU_88A4torp)aircraft()).fShipSpeed;
    float f3 = ((JU_88A4torp)aircraft()).FM.AS.getGyroAngle();
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitJU_88A4torp_Observer.this.fm != null) {
        CockpitJU_88A4torp_Observer.access$102(CockpitJU_88A4torp_Observer.this, CockpitJU_88A4torp_Observer.this.setOld);
        CockpitJU_88A4torp_Observer.access$202(CockpitJU_88A4torp_Observer.this, CockpitJU_88A4torp_Observer.this.setNew);
        CockpitJU_88A4torp_Observer.access$302(CockpitJU_88A4torp_Observer.this, CockpitJU_88A4torp_Observer.this.setTmp);
        ...
        float f1 = CockpitJU_88A4torp_Observer.this.waypointAzimuth();
        if (CockpitJU_88A4torp_Observer.this.useRealisticNavigationInstruments())
        {
          CockpitJU_88A4torp_Observer.this.setNew.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4torp_Observer.this.setOld.waypointAzimuth.setDeg(f1 - 90.0F);
          CockpitJU_88A4torp_Observer.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A4torp_Observer.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A4torp_Observer.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A4torp_Observer.this.setOld.azimuth.getDeg(1.0F) - 90.0F);
        }
        else
        {
          CockpitJU_88A4torp_Observer.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4torp_Observer.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitJU_88A4torp_Observer.this.setOld.azimuth.getDeg(1.0F));
        }
        ...
        CockpitJU_88A4torp_Observer.this.setNew.vspeed = ((199.0F * CockpitJU_88A4torp_Observer.this.setOld.vspeed + CockpitJU_88A4torp_Observer.this.fm.getVertSpeed()) / 200.0F);

        if (CockpitJU_88A4torp_Observer.this.cockpitDimControl)
        {
          if (CockpitJU_88A4torp_Observer.this.setNew.dimPosition > 0.0F)
            CockpitJU_88A4torp_Observer.this.setNew.dimPosition -= 0.05F;
        }
        else if (CockpitJU_88A4torp_Observer.this.setNew.dimPosition < 1.0F) {
          CockpitJU_88A4torp_Observer.this.setNew.dimPosition += 0.05F;
        }
        float f2 = CockpitJU_88A4torp_Observer.this.prevFuel - CockpitJU_88A4torp_Observer.this.fm.M.fuel;
        CockpitJU_88A4torp_Observer.access$402(CockpitJU_88A4torp_Observer.this, CockpitJU_88A4torp_Observer.this.fm.M.fuel);
        f2 /= 0.72F;
        f2 /= Time.tickLenFs();
        f2 *= 3600.0F;
        CockpitJU_88A4torp_Observer.this.setNew.cons = (0.91F * CockpitJU_88A4torp_Observer.this.setOld.cons + 0.09F * f2);
      }
  ...
  private class Variables
  {
    ...
    float beaconRange;
    private final CockpitJU_88A4torp_Observer this$0;
    ...
    Variables(CockpitJU_88A4torp_Observer.1 arg2)
    {
      this();
    }
  }
