...
//            CockpitPilot, B_25J1, AircraftLH, Aircraft
...
public class CockpitB25J_Bombardier extends com.maddox.il2.objects.air.CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            com.maddox.il2.objects.air.CockpitB25J_Bombardier.calibrAngle = 360F - fm.Or.getPitch();
            mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, com.maddox.il2.objects.air.CockpitB25J_Bombardier.calibrAngle + f);
            if(bEntered)
            {
                com.maddox.il2.engine.hotkey.HookPilot hookpilot = com.maddox.il2.engine.hotkey.HookPilot.current;
                hookpilot.setSimpleAimOrient(aAim + 10F * f1, tAim + com.maddox.il2.objects.air.CockpitB25J_Bombardier.calibrAngle + f, 0.0F);
            }
    ...
    public CockpitB25J_Bombardier()
    {
        ...
        try
        {
            ...
            ((com.maddox.il2.engine.Hook) (hooknamed)).computePos(((com.maddox.il2.engine.Actor) (this)), pos.getAbs(), loc);
    ...
    static 
    {
        com.maddox.rts.Property.set(((java.lang.Object) (((java.lang.Object) (com.maddox.il2.objects.air.CockpitB25J_Bombardier.class)))), "astatePilotIndx", 0);
    }
