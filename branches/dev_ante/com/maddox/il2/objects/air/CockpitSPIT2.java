...
public class CockpitSPIT2 extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat) {
    ...
    this.mesh.chunkVisible("Z_Button_Gun", this.fm.CT.WeaponControl[0] == 0);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSPIT2.this.fm != null) {
        CockpitSPIT2.access$102(CockpitSPIT2.this, CockpitSPIT2.this.setOld);
        CockpitSPIT2.access$202(CockpitSPIT2.this, CockpitSPIT2.this.setNew);
        CockpitSPIT2.access$302(CockpitSPIT2.this, CockpitSPIT2.this.setTmp);
        CockpitSPIT2.this.setNew.throttle = (0.92F * CockpitSPIT2.this.setOld.throttle + 0.08F * CockpitSPIT2.this.fm.CT.PowerControl);

        CockpitSPIT2.this.setNew.prop = (0.92F * CockpitSPIT2.this.setOld.prop + 0.08F * CockpitSPIT2.this.fm.EI.engines[0].getControlProp());

        CockpitSPIT2.this.setNew.mix = (0.92F * CockpitSPIT2.this.setOld.mix + 0.08F * CockpitSPIT2.this.fm.EI.engines[0].getControlMix());

        CockpitSPIT2.this.setNew.altimeter = CockpitSPIT2.this.fm.getAltitude();
        if (Math.abs(CockpitSPIT2.this.fm.Or.getKren()) < 30.0F) {
          CockpitSPIT2.this.setNew.azimuth = (0.97F * CockpitSPIT2.this.setOld.azimuth + 0.03F * -CockpitSPIT2.this.fm.Or.getYaw());
        }
        if ((CockpitSPIT2.this.setOld.azimuth > 270.0F) && (CockpitSPIT2.this.setNew.azimuth < 90.0F))
          CockpitSPIT2.this.setOld.azimuth -= 360.0F;
        if ((CockpitSPIT2.this.setOld.azimuth < 90.0F) && (CockpitSPIT2.this.setNew.azimuth > 270.0F))
          CockpitSPIT2.this.setOld.azimuth += 360.0F;
        CockpitSPIT2.this.setNew.waypointAzimuth = (0.91F * CockpitSPIT2.this.setOld.waypointAzimuth + 0.09F * (CockpitSPIT2.this.waypointAzimuth() - CockpitSPIT2.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));

        CockpitSPIT2.this.setNew.vspeed = (0.99F * CockpitSPIT2.this.setOld.vspeed + 0.01F * CockpitSPIT2.this.fm.getVertSpeed());
      }
  ...
  private class Variables
  {
    ...
    private final CockpitSPIT2 this$0;
