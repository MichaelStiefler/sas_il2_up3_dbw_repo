...
public class CockpitSpit14C extends CockpitPilot
{
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitSpit14C.this.fm != null) {
        CockpitSpit14C.access$102(CockpitSpit14C.this, CockpitSpit14C.this.setOld);
        CockpitSpit14C.access$202(CockpitSpit14C.this, CockpitSpit14C.this.setNew);
        CockpitSpit14C.access$302(CockpitSpit14C.this, CockpitSpit14C.this.setTmp);
        ...
        if (Math.abs(CockpitSpit14C.this.fm.Or.getKren()) < 30.0F) {
          CockpitSpit14C.this.setNew.azimuth = (0.97F * CockpitSpit14C.this.setOld.azimuth + 0.03F * -CockpitSpit14C.this.fm.Or.getYaw());
        }
        if ((CockpitSpit14C.this.setOld.azimuth > 270.0F) && (CockpitSpit14C.this.setNew.azimuth < 90.0F))
          CockpitSpit14C.this.setOld.azimuth -= 360.0F;
        if ((CockpitSpit14C.this.setOld.azimuth < 90.0F) && (CockpitSpit14C.this.setNew.azimuth > 270.0F))
          CockpitSpit14C.this.setOld.azimuth += 360.0F;
        CockpitSpit14C.this.setNew.waypointAzimuth = (0.91F * CockpitSpit14C.this.setOld.waypointAzimuth + 0.09F * (CockpitSpit14C.this.waypointAzimuth() - CockpitSpit14C.this.setOld.azimuth) + World.Rnd().nextFloat(-10.0F, 10.0F));
  ...
  private class Variables
  {
    ...
    private final CockpitSpit14C this$0;
    ...
    Variables(CockpitSpit14C.1 arg2)
    {
      this();
    }
  }
