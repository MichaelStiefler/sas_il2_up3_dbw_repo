...
//            Scheme1, PaintSchemeBMPar02, TypeScout, NetAircraft, 
//            PaintScheme

public class SU_26M2 extends com.maddox.il2.objects.air.Scheme1
    implements com.maddox.il2.objects.air.TypeScout
{
    ...
    {
        resetYPRmodifier();
        xyz[2] = com.maddox.il2.objects.air.SU_26M2.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.5F, 0.0F, 0.5F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        float f = com.maddox.il2.objects.air.SU_26M2.cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.5F, 0.0F, 5F);
        ...
        xyz[2] = com.maddox.il2.objects.air.SU_26M2.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.5F, 0.0F, 0.5F);
        hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
        f = com.maddox.il2.objects.air.SU_26M2.cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.5F, 0.0F, 5F);
    ...
    static 
    {
        ...
        com.maddox.rts.Property.set(class1, "yearExpired", 3000F);
        ...
        com.maddox.il2.objects.air.SU_26M2.weaponTriggersRegister(class1, new int[] {
            10
        });
        com.maddox.il2.objects.air.SU_26M2.weaponHooksRegister(class1, new java.lang.String[] {
            "_MGUN01"
        });
        com.maddox.il2.objects.air.SU_26M2.weaponsRegister(class1, "default", new java.lang.String[] {
            "MGunMG15t 750"
        });
        com.maddox.il2.objects.air.SU_26M2.weaponsRegister(class1, "none", new java.lang.String[] {
            null
        });
    }
}
