...
public class CmdServer extends com.maddox.rts.Cmd
{
    ...
    public java.lang.Object exec(com.maddox.rts.CmdEnv cmdenv, java.util.Map map)
    {
        ...
        if(!com.maddox.il2.game.Main.cur().netServerParams.isDedicated())
            return null;
        boolean flag = true;
        if(!com.maddox.il2.net.USGS.isUsed() && com.maddox.il2.game.cmd.CmdServer.nargs(map, "NAME") > 0)
        {
            java.lang.String s = com.maddox.il2.game.cmd.CmdServer.args(map, "NAME");
        ...
        {
            flag = false;
            if(com.maddox.il2.game.cmd.CmdServer.nargs(map, "PWD") > 0)
            {
                java.lang.String s1 = com.maddox.il2.game.cmd.CmdServer.args(map, "PWD");
        ...
        if(com.maddox.il2.game.cmd.CmdServer.nargs(map, "DESCRIPTION") > 0)
        {
            java.lang.String s2 = com.maddox.il2.game.cmd.CmdServer.args(map, "DESCRIPTION");
