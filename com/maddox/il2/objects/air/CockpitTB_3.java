...
public class CockpitTB_3 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(fm.Or.getTangage(), -35F, 35F, 0.028F, -0.028F);
        mesh.chunkSetLocate("Z_Tangage1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        mesh.chunkSetLocate("Z_Tangage2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
    ...
    protected boolean doFocusEnter()
    {
        ...
        {
            ((com.maddox.il2.engine.ActorHMesh)fm.actor).hierMesh().chunkVisible("Windscreen_D0", false);
            return true;
        } else
        {
            return false;
    ...
    {
        ((com.maddox.il2.engine.ActorHMesh)fm.actor).hierMesh().chunkVisible("Windscreen_D0", true);
        super.doFocusLeave();
    }
