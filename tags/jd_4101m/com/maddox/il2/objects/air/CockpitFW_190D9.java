  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitFW_190D9.this.fm != null) {
        ...
        CockpitFW_190D9.this.setNew.throttle = ((10.0F * CockpitFW_190D9.this.setOld.throttle + CockpitFW_190D9.this.fm.CT.PowerControl) / 11.0F);
        CockpitFW_190D9.this.setNew.vspeed = ((499.0F * CockpitFW_190D9.this.setOld.vspeed + CockpitFW_190D9.this.fm.getVertSpeed()) / 500.0F);

        float f = CockpitFW_190D9.this.waypointAzimuth();
        if (CockpitFW_190D9.this.useRealisticNavigationInstruments())
        {
          CockpitFW_190D9.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
          CockpitFW_190D9.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
        }
        else
        {
        ...
        CockpitFW_190D9.this.setNew.turn = ((12.0F * CockpitFW_190D9.this.setOld.turn + CockpitFW_190D9.this.w.z) / 13.0F);

        CockpitFW_190D9.this.setNew.beaconDirection = ((10.0F * CockpitFW_190D9.this.setOld.beaconDirection + CockpitFW_190D9.this.getBeaconDirection()) / 11.0F);
        CockpitFW_190D9.this.setNew.beaconRange = ((10.0F * CockpitFW_190D9.this.setOld.beaconRange + CockpitFW_190D9.this.getBeaconRange()) / 11.0F);
      }
      return true;
    }
  }
