...
public class Marker
{
    ...
    public static void cube(float f, float f1, float f2, float f3)
    {
        boolean flag = false;
        ...
        {
            int k = codes[j];
            com.maddox.opengl.gl.Vertex3f(xx[k], yy[k], zz[k]);
        }
    ...
    public static void cubeXYZ(float f, float f1, float f2, float f3)
    {
        boolean flag = false;
        f3 = (float)((double)f3 * 0.5D);
        for(int i = 0; i < 8; i++)
    ...
    public static void triangleZ(float f, float f1, float f2, float f3)
    {
        boolean flag = false;
        f3 = (float)((double)f3 * 0.5D);
        float f4 = f3 * 0.5F;
        ...
        com.maddox.opengl.gl.Vertex3f(f, f1 + f3, f2);
