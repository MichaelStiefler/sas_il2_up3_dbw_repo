...
public class CockpitTA_152C extends CockpitPilot
{
  ...
  public void reflectWorldToInstruments(float paramFloat)
  {
    ...
    this.pictGear = (0.93F * this.pictGear + 0.07F * f);
    xyz[2] = this.pictGear;
    ...
    resetYPRmodifier();
    if (this.gun[1] != null) {
      xyz[0] = cvt(this.gun[1].countBullets(), 0.0F, 500.0F, -0.046F, 0.0F);
      this.mesh.chunkSetLocate("RC_MG17_L", xyz, ypr);
    }
    if (this.gun[2] != null) {
      xyz[0] = cvt(this.gun[2].countBullets(), 0.0F, 500.0F, -0.046F, 0.0F);
      this.mesh.chunkSetLocate("RC_MG17_R", xyz, ypr);
    }
    if (this.gun[0] != null) {
      xyz[0] = cvt(this.gun[0].countBullets(), 0.0F, 500.0F, -0.019F, 0.024F);
      this.mesh.chunkSetLocate("RC_MG151_L", xyz, ypr);
    }
    if (this.gun[3] != null) {
      xyz[0] = cvt(this.gun[3].countBullets(), 0.0F, 500.0F, -0.019F, 0.024F);
  ...
  static
  {
    Property.set(CockpitTA_152C.class, "normZN", 0.74F);
  ...
  class Interpolater extends InterpolateRef
  {
    ...
    public boolean tick()
    {
      if (CockpitTA_152C.this.fm != null) {
        ...
        CockpitTA_152C.this.setNew.throttle = ((10.0F * CockpitTA_152C.this.setOld.throttle + CockpitTA_152C.this.fm.CT.PowerControl) / 11.0F);
        CockpitTA_152C.this.setNew.vspeed = ((499.0F * CockpitTA_152C.this.setOld.vspeed + CockpitTA_152C.this.fm.getVertSpeed()) / 500.0F);

        float f = CockpitTA_152C.this.waypointAzimuth();
        if (CockpitTA_152C.this.useRealisticNavigationInstruments())
        {
          CockpitTA_152C.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
          CockpitTA_152C.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
        }
        else
        {
        ...
        CockpitTA_152C.this.setNew.turn = ((12.0F * CockpitTA_152C.this.setOld.turn + CockpitTA_152C.this.w.z) / 13.0F);

        CockpitTA_152C.this.setNew.beaconDirection = ((10.0F * CockpitTA_152C.this.setOld.beaconDirection + CockpitTA_152C.this.getBeaconDirection()) / 11.0F);
        CockpitTA_152C.this.setNew.beaconRange = ((10.0F * CockpitTA_152C.this.setOld.beaconRange + CockpitTA_152C.this.getBeaconRange()) / 11.0F);
      }
      return true;
    }
  }
