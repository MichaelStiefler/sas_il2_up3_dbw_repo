// Source File Name: CockpitMorane.java
	...
	private class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitMorane.this.fm != null) {
				...
				CockpitMorane.this.setNew.throttle = (0.92F * CockpitMorane.this.setOld.throttle)
						+ (0.08F * CockpitMorane.this.fm.CT.PowerControl);
				CockpitMorane.this.setNew.prop = (0.92F * CockpitMorane.this.setOld.prop)
						+ (0.08F * CockpitMorane.this.fm.EI.engines[0]
								.getControlProp());
				CockpitMorane.this.setNew.mix = (0.92F * CockpitMorane.this.setOld.mix)
						+ (0.08F * CockpitMorane.this.fm.EI.engines[0]
								.getControlMix());
				CockpitMorane.this.setNew.altimeter = CockpitMorane.this.fm
						.getAltitude();
				CockpitMorane.this.setNew.azimuth = (0.97F * CockpitMorane.this.setOld.azimuth)
						+ (0.03F * -CockpitMorane.this.fm.Or.getYaw());
				if ((CockpitMorane.this.setOld.azimuth > 270F)
						&& (CockpitMorane.this.setNew.azimuth < 90F)) {
					CockpitMorane.this.setOld.azimuth -= 360F;
				}
				if ((CockpitMorane.this.setOld.azimuth < 90F)
						&& (CockpitMorane.this.setNew.azimuth > 270F)) {
					CockpitMorane.this.setOld.azimuth += 360F;
				}
				CockpitMorane.this.setNew.waypointAzimuth = (0.91F * CockpitMorane.this.setOld.waypointAzimuth)
						+ (0.09F * (CockpitMorane.this.waypointAzimuth() - CockpitMorane.this.setOld.azimuth))
						+ World.Rnd().nextFloat(-10F, 10F);
				CockpitMorane.this.setNew.vspeed = (0.99F * CockpitMorane.this.setOld.vspeed)
						+ (0.01F * CockpitMorane.this.fm.getVertSpeed());
