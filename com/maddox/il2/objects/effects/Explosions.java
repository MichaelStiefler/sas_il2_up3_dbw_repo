...
;
    ...
    private static void fontain(com.maddox.JGP.Point3d point3d, float f, float f1, int i, int j)
    {
        ...
        case 0: // '\0'
            ...
            {
                float f7 = (float)(360D * java.lang.Math.random());
                float f8 = 90F + (2.0F * (float)java.lang.Math.random() - 1.0F) * f2;
                o.set(f7, f8, 0.0F);
                l.set(point3d, o);
            ...
            com.maddox.il2.objects.effects.Explosions.SurfaceCrater(i, f4, 80F);
            o.set(0.0F, 90F, 0.0F);
            l.set(point3d, o);
    ...
    public static void AirDrop_Land(com.maddox.JGP.Point3d point3d)
    {
        ...
        com.maddox.il2.objects.effects.Explosions.fontain(point3d, f, f1, 0, 0);
    ...
    public static void AirDrop_Water(com.maddox.JGP.Point3d point3d)
    {
        ...
        } else
        {
            float f = 4F;
            float f1 = 1.0F;
            com.maddox.il2.objects.effects.Explosions.fontain(point3d, f, f1, 1, 0);
    ...
    public static void WreckageDrop_Water(com.maddox.JGP.Point3d point3d)
    {
        ...
        } else
        {
            float f = 3F;
            float f1 = 1.0F;
            com.maddox.il2.objects.effects.Explosions.fontain(point3d, f, f1, 1, 1);
    ...
    public static void BOMB250_Land(com.maddox.JGP.Point3d point3d, float f, float f1)
    {
        if(!com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            return;
    ...
    public static void BOMB1000a_Land(com.maddox.JGP.Point3d point3d, float f, float f1)
    {
        if(!com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            return;
        ...
        {
            com.maddox.il2.objects.effects.Explosions.fontain(point3d, f, f1, 0, 2);
            return;
        }
    }
    ...
    public static void BOMB1000a_Water(com.maddox.JGP.Point3d point3d, float f, float f1)
    {
        ...
        {
            com.maddox.il2.objects.effects.Explosions.fontain(point3d, f, f1, 1, 2);
            return;
        }
    }
    ...
    public static void bomb1000_land(com.maddox.JGP.Point3d point3d, float f, float f1)
    {
        if(!com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            return;
    ...
    public static void RS82_Land(com.maddox.JGP.Point3d point3d, float f, float f1)
    {
        if(!com.maddox.il2.engine.Config.isUSE_RENDER())
        {
            return;
        ...
        {
            com.maddox.il2.objects.effects.Explosions.fontain(point3d, f, f1, 0, 1);
            return;
        }
    }
    ...
    {
        com.maddox.il2.objects.effects.Explosions.generate(actor, point3d, f <= 15F ? 15F : f, i, f1);
    }

    public static void generate(com.maddox.il2.engine.Actor actor, com.maddox.JGP.Point3d point3d, float f, int i, float f1)
    {
        if(!com.maddox.il2.engine.Config.isUSE_RENDER())
            return;
        if(actor != null)
            ...
            if(actor instanceof com.maddox.il2.objects.ActorLand)
            {
                ...
                if(f < 50F)
                {
                    if(com.maddox.il2.engine.Engine.land().isWater(point3d.x, point3d.y))
                        ...
                        com.maddox.il2.objects.effects.Explosions.RS82_Land(point3d, 4F, 1.0F);
                } else
                if(f < 450F)
                {
                    if(com.maddox.il2.engine.Engine.land().isWater(point3d.x, point3d.y))
                        ...
                        com.maddox.il2.objects.effects.Explosions.BOMB250_Land(point3d, 4F, 1.0F);
                } else
                if(f < 3000F)
                {
                    if(com.maddox.il2.engine.Engine.land().isWater(point3d.x, point3d.y))
                        ...
                        com.maddox.il2.objects.effects.Explosions.BOMB1000a_Land(point3d, 4F, 1.0F);
                } else
                if(com.maddox.il2.engine.Engine.land().isWater(point3d.x, point3d.y))
                    com.maddox.il2.objects.effects.Explosions.bomb1000_water(point3d, -1F, 1.0F);
                else
                    com.maddox.il2.objects.effects.Explosions.bomb1000_land(point3d, -1F, 1.0F);
            } else
            if(f < 50F)
            {
    ...
    public static void generateShot(com.maddox.il2.engine.Actor actor, com.maddox.il2.ai.Shot shot1)
    {
        ...
        case 0: // '\0'
            ...
            if(f < 50F)
                com.maddox.il2.objects.effects.Explosions.RS82_Land(shot1.p, 4F, 1.0F);
            else
                com.maddox.il2.objects.effects.Explosions.BOMB250_Land(shot1.p, 4F, 1.0F);
            break;
