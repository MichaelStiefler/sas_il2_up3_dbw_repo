  ...
  implements TypeScout, TypeBomber
{
  ...
  public void msgShot(Shot paramShot) {
    ...
    if (paramShot.chunkName.startsWith("WingLIn")) {
      ...
      if ((Aircraft.v1.x < 0.25D) && (World.Rnd().nextFloat() < 0.25F) && (World.Rnd().nextFloat(0.01F, 0.121F) < paramShot.mass))
      {
    ...
    if (paramShot.chunkName.startsWith("Engine1")) {
      if (World.Rnd().nextFloat(0.0F, 1.0F) < 0.5F) {
        this.FM.AS.hitEngine(paramShot.initiator, 0, (int)(1.0F + paramShot.mass * 20.700001F));
      }
    ...
    if (paramShot.chunkName.startsWith("Engine2")) {
      if (World.Rnd().nextFloat(0.0F, 1.0F) < 0.5F) {
        this.FM.AS.hitEngine(paramShot.initiator, 1, (int)(1.0F + paramShot.mass * 20.700001F));
      }
      if (World.Rnd().nextFloat() < 0.01F)
        this.FM.AS.hitEngine(paramShot.initiator, 1, 5);
    }
    if (paramShot.chunkName.startsWith("Pilot1")) {
      if ((Aircraft.v1.x > -0.5D) || (paramShot.power * -Aircraft.v1.x > 12800.0D))
      {
        killPilot(paramShot.initiator, 0);
        this.FM.setCapableOfBMP(false, paramShot.initiator);
        if ((Aircraft.Pd.z > 0.5D) && (paramShot.initiator == World.getPlayerAircraft()) && (World.cur().isArcade()))
        {
    ...
    if ((paramShot.chunkName.startsWith("Tail1")) && (World.Rnd().nextFloat() < 0.05F))
    {
      this.FM.AS.hitTank(paramShot.initiator, 0, (int)(1.0F + paramShot.mass * 26.08F));
    }
    if ((paramShot.chunkName.startsWith("Tail2")) && (World.Rnd().nextFloat() < 0.05F))
    {
      this.FM.AS.hitTank(paramShot.initiator, 1, (int)(1.0F + paramShot.mass * 26.08F));
    }
  ...
  static
  {
    ...
    Property.set(localClass, "cockpitClass", new Class[] { CockpitFw189.class, CockpitFw189_RGunner.class });
