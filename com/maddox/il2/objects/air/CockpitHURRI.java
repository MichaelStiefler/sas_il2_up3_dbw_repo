...
public class CockpitHURRI extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        xyz[2] = 0.01625F * fm.CT.getAileron();
        mesh.chunkSetLocate("RUS_TAND_L", xyz, ypr);
        xyz[2] = -xyz[2];
        mesh.chunkSetLocate("RUS_TAND_R", xyz, ypr);
        ...
        mesh.chunkSetLocate("SHAS_RUCH_T", xyz, ypr);
        ...
        resetYPRmodifier();
        xyz[2] = 0.05865F * fm.EI.engines[0].getControlRadiator();
        mesh.chunkSetLocate("zRadFlap", xyz, ypr);
        w.set(fm.getW());
        fm.Or.transform(w);
        ...
        mesh.chunkSetLocate("STRELKA_GOR_RAF", xyz, ypr);
